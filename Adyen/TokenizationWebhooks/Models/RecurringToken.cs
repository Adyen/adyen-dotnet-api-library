...
namespace Adyen.TokenizationWebhooks.Models
{
    ...
    /// RecurringToken.
    /// </summary>
    [JsonConverter(typeof(RecurringTokenJsonConverter))]
    public partial class RecurringToken
    {
        /// <summary>
    ...
    public class RecurringTokenJsonConverter : JsonConverter<RecurringToken>
    {
        ...
        public override RecurringToken Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            var recurringToken = new RecurringToken();
            if (merchantAccount.IsSet)
                recurringToken.MerchantAccount = merchantAccount.Value!;
            if (shopperReference.IsSet)
                recurringToken.ShopperReference = shopperReference.Value!;
            if (storedPaymentMethodId.IsSet)
                recurringToken.StoredPaymentMethodId = storedPaymentMethodId.Value!;
            if (type.IsSet)
                recurringToken.Type = type.Value!;
