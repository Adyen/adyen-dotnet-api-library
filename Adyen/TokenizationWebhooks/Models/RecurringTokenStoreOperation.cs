    ...
    public class RecurringTokenStoreOperationJsonConverter : JsonConverter<RecurringTokenStoreOperation>
    {
        ...
        public override RecurringTokenStoreOperation Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (merchantAccount.IsSet && merchantAccount.Value == null)
                throw new ArgumentNullException(nameof(merchantAccount), "Property is not nullable for class RecurringTokenStoreOperation.");

            if (operation.IsSet && operation.Value == null)
                throw new ArgumentNullException(nameof(operation), "Property is not nullable for class RecurringTokenStoreOperation.");

            if (shopperReference.IsSet && shopperReference.Value == null)
                throw new ArgumentNullException(nameof(shopperReference), "Property is not nullable for class RecurringTokenStoreOperation.");

            if (storedPaymentMethodId.IsSet && storedPaymentMethodId.Value == null)
                throw new ArgumentNullException(nameof(storedPaymentMethodId), "Property is not nullable for class RecurringTokenStoreOperation.");

            if (type.IsSet && type.Value == null)
                throw new ArgumentNullException(nameof(type), "Property is not nullable for class RecurringTokenStoreOperation.");
        ...
        public void WriteProperties(Utf8JsonWriter writer, RecurringTokenStoreOperation recurringTokenStoreOperation, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (recurringTokenStoreOperation.MerchantAccount == null)
                throw new ArgumentNullException(nameof(recurringTokenStoreOperation.MerchantAccount), "Property is required for class RecurringTokenStoreOperation.");

            if (recurringTokenStoreOperation.Operation == null)
                throw new ArgumentNullException(nameof(recurringTokenStoreOperation.Operation), "Property is required for class RecurringTokenStoreOperation.");

            if (recurringTokenStoreOperation.ShopperReference == null)
                throw new ArgumentNullException(nameof(recurringTokenStoreOperation.ShopperReference), "Property is required for class RecurringTokenStoreOperation.");

            if (recurringTokenStoreOperation.StoredPaymentMethodId == null)
                throw new ArgumentNullException(nameof(recurringTokenStoreOperation.StoredPaymentMethodId), "Property is required for class RecurringTokenStoreOperation.");

            if (recurringTokenStoreOperation.Type == null)
                throw new ArgumentNullException(nameof(recurringTokenStoreOperation.Type), "Property is required for class RecurringTokenStoreOperation.");
