...
namespace Adyen.ConfigurationWebhooks.Models
{
    ...
    /// </summary>
    [JsonConverter(typeof(NetworkTokenTransactionRulesResultJsonConverter))]
    ...
    public class NetworkTokenTransactionRulesResultJsonConverter : JsonConverter<NetworkTokenTransactionRulesResult>
    {
        ...
        public override NetworkTokenTransactionRulesResult Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (allHardBlockRulesPassed.IsSet)
                networkTokenTransactionRulesResult.AllHardBlockRulesPassed = allHardBlockRulesPassed.Value;
            if (score.IsSet)
                networkTokenTransactionRulesResult.Score = score.Value;
            if (triggeredTransactionRules.IsSet)
                networkTokenTransactionRulesResult.TriggeredTransactionRules = triggeredTransactionRules.Value;
            return networkTokenTransactionRulesResult;
        }
