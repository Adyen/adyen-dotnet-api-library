    ...
    public class MandateJsonConverter : JsonConverter<Mandate>
    {
        ...
        public override Mandate Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (counterparty.IsSet)
                mandate.Counterparty = counterparty.Value;
            if (createdAt.IsSet)
                mandate.CreatedAt = createdAt.Value;
            if (id.IsSet)
                mandate.Id = id.Value;
            if (paymentInstrumentId.IsSet)
                mandate.PaymentInstrumentId = paymentInstrumentId.Value;
            if (status.IsSet)
                mandate.Status = status.Value;
            if (type.IsSet)
                mandate.Type = type.Value;
            if (updatedAt.IsSet)
                mandate.UpdatedAt = updatedAt.Value;
            return mandate;
        }
