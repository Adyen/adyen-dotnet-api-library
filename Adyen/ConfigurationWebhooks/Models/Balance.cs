    ...
    public class BalanceJsonConverter : JsonConverter<Balance>
    {
        ...
        public override Balance Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (available.IsSet && available.Value == null)
                throw new ArgumentNullException(nameof(available), "Property is not nullable for class Balance.");
            ...
            if (reserved.IsSet && reserved.Value == null)
                throw new ArgumentNullException(nameof(reserved), "Property is not nullable for class Balance.");

            if (pending.IsSet && pending.Value == null)
                throw new ArgumentNullException(nameof(pending), "Property is not nullable for class Balance.");
        ...
        public void WriteProperties(Utf8JsonWriter writer, Balance balance, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (balance.Currency == null)
                throw new ArgumentNullException(nameof(balance.Currency), "Property is required for class Balance.");
