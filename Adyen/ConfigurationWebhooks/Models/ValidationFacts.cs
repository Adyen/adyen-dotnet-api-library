    ...
    public class ValidationFactsJsonConverter : JsonConverter<ValidationFacts>
    {
        ...
        public override ValidationFacts Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (reasons.IsSet && reasons.Value == null)
                throw new ArgumentNullException(nameof(reasons), "Property is not nullable for class ValidationFacts.");

            if (result.IsSet && result.Value == null)
                throw new ArgumentNullException(nameof(result), "Property is not nullable for class ValidationFacts.");

            if (type.IsSet && type.Value == null)
                throw new ArgumentNullException(nameof(type), "Property is not nullable for class ValidationFacts.");
        ...
        {
            /*
            if (validationFacts._ReasonsOption.IsSet && validationFacts.Reasons == null)
                throw new ArgumentNullException(nameof(validationFacts.Reasons), "Property is required for class ValidationFacts.");

            if (validationFacts._TypeOption.IsSet && validationFacts.Type == null)
                throw new ArgumentNullException(nameof(validationFacts.Type), "Property is required for class ValidationFacts.");
