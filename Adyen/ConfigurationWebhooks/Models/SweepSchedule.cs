    ...
    public class SweepScheduleJsonConverter : JsonConverter<SweepSchedule>
    {
        ...
        public override SweepSchedule Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (type.IsSet && type.Value == null)
                throw new ArgumentNullException(nameof(type), "Property is not nullable for class SweepSchedule.");

            if (cronExpression.IsSet && cronExpression.Value == null)
                throw new ArgumentNullException(nameof(cronExpression), "Property is not nullable for class SweepSchedule.");
        ...
        {
            /*
            if (sweepSchedule._CronExpressionOption.IsSet && sweepSchedule.CronExpression == null)
                throw new ArgumentNullException(nameof(sweepSchedule.CronExpression), "Property is required for class SweepSchedule.");
