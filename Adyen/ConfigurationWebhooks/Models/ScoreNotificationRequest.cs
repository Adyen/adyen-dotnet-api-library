...
namespace Adyen.ConfigurationWebhooks.Models
{
    ...
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ScoreNotificationRequest" /> class.
        /// </summary>
        ...
        [JsonConstructor]
        public ScoreNotificationRequest(BankScoreSignalTriggeredData data, string environment, TypeEnum type, Option<DateTimeOffset?> timestamp = default)
        {
            Data = data;
        ...
        public class TypeEnum: IEnum
        {
            ...
            /// <summary>
            /// TypeEnum.BalancePlatformScoreTriggered - balancePlatform.score.triggered
            /// </summary>
            public static readonly TypeEnum BalancePlatformScoreTriggered = new("balancePlatform.score.triggered");
            ...
            {
                return value switch {
                    "balancePlatform.score.triggered" => TypeEnum.BalancePlatformScoreTriggered,
                    _ => null,
                };
            }
    ...
    /// <summary>
    /// A Json converter for type <see cref="ScoreNotificationRequest" />
    /// </summary>
    public class ScoreNotificationRequestJsonConverter : JsonConverter<ScoreNotificationRequest>
    {
        /// <summary>
        ...
        /// <summary>
        /// Deserializes json to <see cref="ScoreNotificationRequest"/>.
        /// </summary>
        /// <param name="utf8JsonReader"><see cref="Utf8JsonReader"/></param>
        /// <param name="typeToConvert"><see cref="Type"/></param>
        /// <param name="jsonSerializerOptions">The <see cref="JsonSerializerOptions"/>, initialized from <see cref="HostConfiguration"/>.</param>
        /// <returns><see cref="ScoreNotificationRequest"/></returns>
        /// <exception cref="JsonException"></exception>
        public override ScoreNotificationRequest Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            Option<BankScoreSignalTriggeredData?> data = default;
            Option<string?> environment = default;
            Option<ScoreNotificationRequest.TypeEnum?> type = default;
            ...
            while (utf8JsonReader.Read())
            {
                ...
                if (utf8JsonReader.TokenType == JsonTokenType.PropertyName && currentDepth == utf8JsonReader.CurrentDepth - 1)
                {
                    ...
                    {
                        case "data":
                            data = new Option<BankScoreSignalTriggeredData?>(JsonSerializer.Deserialize<BankScoreSignalTriggeredData>(ref utf8JsonReader, jsonSerializerOptions)!);
                            break;
                        case "environment":
            ...
            if (data.IsSet && data.Value == null)
                throw new ArgumentNullException(nameof(data), "Property is not nullable for class ScoreNotificationRequest.");

            if (environment.IsSet && environment.Value == null)
                throw new ArgumentNullException(nameof(environment), "Property is not nullable for class ScoreNotificationRequest.");

            if (type.IsSet && type.Value == null)
                throw new ArgumentNullException(nameof(type), "Property is not nullable for class ScoreNotificationRequest.");

            if (timestamp.IsSet && timestamp.Value == null)
                throw new ArgumentNullException(nameof(timestamp), "Property is not nullable for class ScoreNotificationRequest.");

            return new ScoreNotificationRequest(data.Value!, environment.Value!, type.Value!.Value!, timestamp);
        }

        /// <summary>
        /// Serializes a <see cref="ScoreNotificationRequest"/>.
        /// </summary>
        /// <param name="writer"><see cref="Utf8JsonWriter"/></param>
        /// <param name="scoreNotificationRequest"></param>
        /// <param name="jsonSerializerOptions"><see cref="JsonSerializerOptions"/></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, ScoreNotificationRequest scoreNotificationRequest, JsonSerializerOptions jsonSerializerOptions)
        {
            
            writer.WriteStartObject();
            
            WriteProperties(writer, scoreNotificationRequest, jsonSerializerOptions);
        ...
        /// <summary>
        /// Serializes the properties of <see cref="ScoreNotificationRequest"/>.
        /// </summary>
        /// <param name="writer"><see creft="Utf8JsonWriter"/></param>
        /// <param name="scoreNotificationRequest"></param>
        /// <param name="jsonSerializerOptions"><see cref="JsonSerializerOptions"/></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, ScoreNotificationRequest scoreNotificationRequest, JsonSerializerOptions jsonSerializerOptions)
        {
            /*
            if (scoreNotificationRequest.Data == null)
                throw new ArgumentNullException(nameof(scoreNotificationRequest.Data), "Property is required for class ScoreNotificationRequest.");

            if (scoreNotificationRequest.Environment == null)
                throw new ArgumentNullException(nameof(scoreNotificationRequest.Environment), "Property is required for class ScoreNotificationRequest.");

            */
            
            writer.WritePropertyName("data");
            JsonSerializer.Serialize(writer, scoreNotificationRequest.Data, jsonSerializerOptions);
            writer.WriteString("environment", scoreNotificationRequest.Environment);

            if (scoreNotificationRequest.Type != null) 
            {
                string? typeRawValue = ScoreNotificationRequest.TypeEnum.ToJsonValue(scoreNotificationRequest.Type);
