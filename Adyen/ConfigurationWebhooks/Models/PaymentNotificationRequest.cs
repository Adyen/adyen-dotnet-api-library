...
namespace Adyen.ConfigurationWebhooks.Models
{
    ...
    /// </summary>
    public partial class PaymentNotificationRequest : IValidatableObject
    {
        /// <summary>
        ...
        [JsonConstructor]
        public PaymentNotificationRequest(PaymentInstrumentNotificationData data, string environment, TypeEnum type, Option<DateTimeOffset?> timestamp = default)
        {
            Data = data;
        ...
        public class TypeEnum: IEnum
        {
            ...
            /// </summary>
            public static readonly TypeEnum BalancePlatformPaymentInstrumentCreated = new("balancePlatform.paymentInstrument.created");

            /// <summary>
            /// TypeEnum.BalancePlatformPaymentInstrumentUpdated - balancePlatform.paymentInstrument.updated
            /// </summary>
            public static readonly TypeEnum BalancePlatformPaymentInstrumentUpdated = new("balancePlatform.paymentInstrument.updated");
            ...
            {
                return value switch {
                    "balancePlatform.paymentInstrument.created" => TypeEnum.BalancePlatformPaymentInstrumentCreated,
                    "balancePlatform.paymentInstrument.updated" => TypeEnum.BalancePlatformPaymentInstrumentUpdated,
                    _ => null,
                };
            }
            ...
            public static string? ToJsonValue(TypeEnum? value)
            {
                ...
                if (value == TypeEnum.BalancePlatformPaymentInstrumentCreated)
                    return "balancePlatform.paymentInstrument.created";
    ...
    /// <summary>
    /// A Json converter for type <see cref="PaymentNotificationRequest" />
    /// </summary>
    public class PaymentNotificationRequestJsonConverter : JsonConverter<PaymentNotificationRequest>
    {
        /// <summary>
        ...
        /// <summary>
        /// Deserializes json to <see cref="PaymentNotificationRequest"/>.
        /// </summary>
        /// <param name="utf8JsonReader"><see cref="Utf8JsonReader"/></param>
        /// <param name="typeToConvert"><see cref="Type"/></param>
        /// <param name="jsonSerializerOptions">The <see cref="JsonSerializerOptions"/>, initialized from <see cref="HostConfiguration"/>.</param>
        /// <returns><see cref="PaymentNotificationRequest"/></returns>
        /// <exception cref="JsonException"></exception>
        public override PaymentNotificationRequest Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            Option<PaymentInstrumentNotificationData?> data = default;
            Option<string?> environment = default;
            Option<PaymentNotificationRequest.TypeEnum?> type = default;
            ...
            while (utf8JsonReader.Read())
            {
                ...
                if (utf8JsonReader.TokenType == JsonTokenType.PropertyName && currentDepth == utf8JsonReader.CurrentDepth - 1)
                {
                    ...
                    {
                        case "data":
                            data = new Option<PaymentInstrumentNotificationData?>(JsonSerializer.Deserialize<PaymentInstrumentNotificationData>(ref utf8JsonReader, jsonSerializerOptions)!);
                            break;
                        case "environment":
            ...
            if (data.IsSet && data.Value == null)
                throw new ArgumentNullException(nameof(data), "Property is not nullable for class PaymentNotificationRequest.");

            if (environment.IsSet && environment.Value == null)
                throw new ArgumentNullException(nameof(environment), "Property is not nullable for class PaymentNotificationRequest.");

            if (type.IsSet && type.Value == null)
                throw new ArgumentNullException(nameof(type), "Property is not nullable for class PaymentNotificationRequest.");

            if (timestamp.IsSet && timestamp.Value == null)
                throw new ArgumentNullException(nameof(timestamp), "Property is not nullable for class PaymentNotificationRequest.");

            return new PaymentNotificationRequest(data.Value!, environment.Value!, type.Value!.Value!, timestamp);
        }

        /// <summary>
        /// Serializes a <see cref="PaymentNotificationRequest"/>.
        /// </summary>
        /// <param name="writer"><see cref="Utf8JsonWriter"/></param>
        /// <param name="paymentNotificationRequest"></param>
        /// <param name="jsonSerializerOptions"><see cref="JsonSerializerOptions"/></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, PaymentNotificationRequest paymentNotificationRequest, JsonSerializerOptions jsonSerializerOptions)
        {
            
            writer.WriteStartObject();
            
            WriteProperties(writer, paymentNotificationRequest, jsonSerializerOptions);
        ...
        /// <summary>
        /// Serializes the properties of <see cref="PaymentNotificationRequest"/>.
        /// </summary>
        /// <param name="writer"><see creft="Utf8JsonWriter"/></param>
        /// <param name="paymentNotificationRequest"></param>
        /// <param name="jsonSerializerOptions"><see cref="JsonSerializerOptions"/></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, PaymentNotificationRequest paymentNotificationRequest, JsonSerializerOptions jsonSerializerOptions)
        {
            /*
            if (paymentNotificationRequest.Data == null)
                throw new ArgumentNullException(nameof(paymentNotificationRequest.Data), "Property is required for class PaymentNotificationRequest.");

            if (paymentNotificationRequest.Environment == null)
                throw new ArgumentNullException(nameof(paymentNotificationRequest.Environment), "Property is required for class PaymentNotificationRequest.");

            */
            
            writer.WritePropertyName("data");
            JsonSerializer.Serialize(writer, paymentNotificationRequest.Data, jsonSerializerOptions);
            writer.WriteString("environment", paymentNotificationRequest.Environment);

            if (paymentNotificationRequest.Type != null) 
            {
                string? typeRawValue = PaymentNotificationRequest.TypeEnum.ToJsonValue(paymentNotificationRequest.Type);
                writer.WriteString("type", typeRawValue);
            }
            
            if (paymentNotificationRequest._TimestampOption.IsSet)
                writer.WriteString("timestamp", paymentNotificationRequest._TimestampOption.Value!.Value.ToString(TimestampFormat));
        }
    }
}
