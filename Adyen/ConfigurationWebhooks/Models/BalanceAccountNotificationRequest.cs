    ...
    public class BalanceAccountNotificationRequestJsonConverter : JsonConverter<BalanceAccountNotificationRequest>
    {
        ...
        public override BalanceAccountNotificationRequest Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (data.IsSet && data.Value == null)
                throw new ArgumentNullException(nameof(data), "Property is not nullable for class BalanceAccountNotificationRequest.");

            if (environment.IsSet && environment.Value == null)
                throw new ArgumentNullException(nameof(environment), "Property is not nullable for class BalanceAccountNotificationRequest.");

            if (type.IsSet && type.Value == null)
                throw new ArgumentNullException(nameof(type), "Property is not nullable for class BalanceAccountNotificationRequest.");

            if (timestamp.IsSet && timestamp.Value == null)
                throw new ArgumentNullException(nameof(timestamp), "Property is not nullable for class BalanceAccountNotificationRequest.");
        ...
        {
            /*
            if (balanceAccountNotificationRequest.Data == null)
                throw new ArgumentNullException(nameof(balanceAccountNotificationRequest.Data), "Property is required for class BalanceAccountNotificationRequest.");

            if (balanceAccountNotificationRequest.Environment == null)
                throw new ArgumentNullException(nameof(balanceAccountNotificationRequest.Environment), "Property is required for class BalanceAccountNotificationRequest.");
