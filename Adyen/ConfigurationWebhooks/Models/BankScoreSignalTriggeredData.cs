...
namespace Adyen.ConfigurationWebhooks.Models
{
    ...
    /// </summary>
    [JsonConverter(typeof(BankScoreSignalTriggeredDataJsonConverter))]
    public partial class BankScoreSignalTriggeredData
    {
        /// <summary>
    ...
    public class BankScoreSignalTriggeredDataJsonConverter : JsonConverter<BankScoreSignalTriggeredData>
    {
        ...
        public override BankScoreSignalTriggeredData Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (accountHolderStatus.IsSet)
                bankScoreSignalTriggeredData.AccountHolderStatus = accountHolderStatus.Value;
            if (automatedActions.IsSet)
                bankScoreSignalTriggeredData.AutomatedActions = automatedActions.Value;
            if (balancePlatform.IsSet)
                bankScoreSignalTriggeredData.BalancePlatform = balancePlatform.Value;
            if (creationDate.IsSet)
                bankScoreSignalTriggeredData.CreationDate = creationDate.Value;
            if (id.IsSet)
                bankScoreSignalTriggeredData.Id = id.Value;
            if (riskScore.IsSet)
                bankScoreSignalTriggeredData.RiskScore = riskScore.Value;
            if (scoreSignalsTriggered.IsSet)
                bankScoreSignalTriggeredData.ScoreSignalsTriggered = scoreSignalsTriggered.Value;
            if (signalSourceTypes.IsSet)
                bankScoreSignalTriggeredData.SignalSourceTypes = signalSourceTypes.Value;
            return bankScoreSignalTriggeredData;
        }
