...
namespace Adyen.ConfigurationWebhooks.Models
{
    ...
    /// </summary>
    public partial class SweepConfigurationNotificationRequest : IValidatableObject
    {
        /// <summary>
    ...
    public class SweepConfigurationNotificationRequestJsonConverter : JsonConverter<SweepConfigurationNotificationRequest>
    {
        ...
        public override SweepConfigurationNotificationRequest Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (data.IsSet && data.Value == null)
                throw new ArgumentNullException(nameof(data), "Property is not nullable for class SweepConfigurationNotificationRequest.");

            if (environment.IsSet && environment.Value == null)
                throw new ArgumentNullException(nameof(environment), "Property is not nullable for class SweepConfigurationNotificationRequest.");

            if (type.IsSet && type.Value == null)
                throw new ArgumentNullException(nameof(type), "Property is not nullable for class SweepConfigurationNotificationRequest.");

            if (timestamp.IsSet && timestamp.Value == null)
                throw new ArgumentNullException(nameof(timestamp), "Property is not nullable for class SweepConfigurationNotificationRequest.");
        ...
        {
            /*
            if (sweepConfigurationNotificationRequest.Data == null)
                throw new ArgumentNullException(nameof(sweepConfigurationNotificationRequest.Data), "Property is required for class SweepConfigurationNotificationRequest.");

            if (sweepConfigurationNotificationRequest.Environment == null)
                throw new ArgumentNullException(nameof(sweepConfigurationNotificationRequest.Environment), "Property is required for class SweepConfigurationNotificationRequest.");
