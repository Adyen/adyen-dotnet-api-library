...
namespace Adyen.ConfigurationWebhooks.Models
{
    ...
    /// </summary>
    public partial class NetworkTokenNotificationRequest : IValidatableObject
    {
        /// <summary>
        ...
        [JsonConstructor]
        public NetworkTokenNotificationRequest(NetworkTokenNotificationDataV2 data, string environment, TypeEnum type, Option<DateTimeOffset?> timestamp = default)
        {
            Data = data;
    ...
    public class NetworkTokenNotificationRequestJsonConverter : JsonConverter<NetworkTokenNotificationRequest>
    {
        ...
        public override NetworkTokenNotificationRequest Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (data.IsSet && data.Value == null)
                throw new ArgumentNullException(nameof(data), "Property is not nullable for class NetworkTokenNotificationRequest.");

            if (environment.IsSet && environment.Value == null)
                throw new ArgumentNullException(nameof(environment), "Property is not nullable for class NetworkTokenNotificationRequest.");

            if (type.IsSet && type.Value == null)
                throw new ArgumentNullException(nameof(type), "Property is not nullable for class NetworkTokenNotificationRequest.");

            if (timestamp.IsSet && timestamp.Value == null)
                throw new ArgumentNullException(nameof(timestamp), "Property is not nullable for class NetworkTokenNotificationRequest.");
        ...
        {
            /*
            if (networkTokenNotificationRequest.Data == null)
                throw new ArgumentNullException(nameof(networkTokenNotificationRequest.Data), "Property is required for class NetworkTokenNotificationRequest.");

            if (networkTokenNotificationRequest.Environment == null)
                throw new ArgumentNullException(nameof(networkTokenNotificationRequest.Environment), "Property is required for class NetworkTokenNotificationRequest.");
