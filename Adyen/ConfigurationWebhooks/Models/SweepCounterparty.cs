...
namespace Adyen.ConfigurationWebhooks.Models
{
    ...
    /// SweepCounterparty.
    /// </summary>
    [JsonConverter(typeof(SweepCounterpartyJsonConverter))]
    ...
    public class SweepCounterpartyJsonConverter : JsonConverter<SweepCounterparty>
    {
        ...
        public override SweepCounterparty Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (merchantAccount.IsSet)
                sweepCounterparty.MerchantAccount = merchantAccount.Value;
            if (transferInstrumentId.IsSet)
                sweepCounterparty.TransferInstrumentId = transferInstrumentId.Value;
            return sweepCounterparty;
        }
