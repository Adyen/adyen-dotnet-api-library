    ...
    public class SweepCounterpartyJsonConverter : JsonConverter<SweepCounterparty>
    {
        ...
        public override SweepCounterparty Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (balanceAccountId.IsSet && balanceAccountId.Value == null)
                throw new ArgumentNullException(nameof(balanceAccountId), "Property is not nullable for class SweepCounterparty.");

            if (merchantAccount.IsSet && merchantAccount.Value == null)
                throw new ArgumentNullException(nameof(merchantAccount), "Property is not nullable for class SweepCounterparty.");

            if (transferInstrumentId.IsSet && transferInstrumentId.Value == null)
                throw new ArgumentNullException(nameof(transferInstrumentId), "Property is not nullable for class SweepCounterparty.");
        ...
        {
            /*
            if (sweepCounterparty._BalanceAccountIdOption.IsSet && sweepCounterparty.BalanceAccountId == null)
                throw new ArgumentNullException(nameof(sweepCounterparty.BalanceAccountId), "Property is required for class SweepCounterparty.");

            if (sweepCounterparty._MerchantAccountOption.IsSet && sweepCounterparty.MerchantAccount == null)
                throw new ArgumentNullException(nameof(sweepCounterparty.MerchantAccount), "Property is required for class SweepCounterparty.");

            if (sweepCounterparty._TransferInstrumentIdOption.IsSet && sweepCounterparty.TransferInstrumentId == null)
                throw new ArgumentNullException(nameof(sweepCounterparty.TransferInstrumentId), "Property is required for class SweepCounterparty.");
