    ...
    public class CardOrderItemDeliveryStatusJsonConverter : JsonConverter<CardOrderItemDeliveryStatus>
    {
        ...
        public override CardOrderItemDeliveryStatus Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (errorMessage.IsSet && errorMessage.Value == null)
                throw new ArgumentNullException(nameof(errorMessage), "Property is not nullable for class CardOrderItemDeliveryStatus.");

            if (status.IsSet && status.Value == null)
                throw new ArgumentNullException(nameof(status), "Property is not nullable for class CardOrderItemDeliveryStatus.");

            if (trackingNumber.IsSet && trackingNumber.Value == null)
                throw new ArgumentNullException(nameof(trackingNumber), "Property is not nullable for class CardOrderItemDeliveryStatus.");
        ...
        {
            /*
            if (cardOrderItemDeliveryStatus._ErrorMessageOption.IsSet && cardOrderItemDeliveryStatus.ErrorMessage == null)
                throw new ArgumentNullException(nameof(cardOrderItemDeliveryStatus.ErrorMessage), "Property is required for class CardOrderItemDeliveryStatus.");

            if (cardOrderItemDeliveryStatus._TrackingNumberOption.IsSet && cardOrderItemDeliveryStatus.TrackingNumber == null)
                throw new ArgumentNullException(nameof(cardOrderItemDeliveryStatus.TrackingNumber), "Property is required for class CardOrderItemDeliveryStatus.");
