...
namespace Adyen.ConfigurationWebhooks.Models
{
    ...
    /// </summary>
    [JsonConverter(typeof(NetworkTokenRiskRuleDataJsonConverter))]
    ...
    public class NetworkTokenRiskRuleDataJsonConverter : JsonConverter<NetworkTokenRiskRuleData>
    {
        ...
        public override NetworkTokenRiskRuleData Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (id.IsSet)
                networkTokenRiskRuleData.Id = id.Value;
            if (outcomeType.IsSet)
                networkTokenRiskRuleData.OutcomeType = outcomeType.Value;
            if (reference.IsSet)
                networkTokenRiskRuleData.Reference = reference.Value;
            if (score.IsSet)
                networkTokenRiskRuleData.Score = score.Value;
            return networkTokenRiskRuleData;
        }
