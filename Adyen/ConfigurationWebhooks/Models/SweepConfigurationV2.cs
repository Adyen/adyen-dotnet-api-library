    ...
    public class SweepConfigurationV2JsonConverter : JsonConverter<SweepConfigurationV2>
    {
        ...
        public override SweepConfigurationV2 Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (counterparty.IsSet && counterparty.Value == null)
                throw new ArgumentNullException(nameof(counterparty), "Property is not nullable for class SweepConfigurationV2.");

            if (currency.IsSet && currency.Value == null)
                throw new ArgumentNullException(nameof(currency), "Property is not nullable for class SweepConfigurationV2.");

            if (id.IsSet && id.Value == null)
                throw new ArgumentNullException(nameof(id), "Property is not nullable for class SweepConfigurationV2.");

            if (schedule.IsSet && schedule.Value == null)
                throw new ArgumentNullException(nameof(schedule), "Property is not nullable for class SweepConfigurationV2.");

            if (category.IsSet && category.Value == null)
                throw new ArgumentNullException(nameof(category), "Property is not nullable for class SweepConfigurationV2.");

            if (description.IsSet && description.Value == null)
                throw new ArgumentNullException(nameof(description), "Property is not nullable for class SweepConfigurationV2.");

            if (priorities.IsSet && priorities.Value == null)
                throw new ArgumentNullException(nameof(priorities), "Property is not nullable for class SweepConfigurationV2.");

            if (reason.IsSet && reason.Value == null)
                throw new ArgumentNullException(nameof(reason), "Property is not nullable for class SweepConfigurationV2.");

            if (reasonDetail.IsSet && reasonDetail.Value == null)
                throw new ArgumentNullException(nameof(reasonDetail), "Property is not nullable for class SweepConfigurationV2.");

            if (reference.IsSet && reference.Value == null)
                throw new ArgumentNullException(nameof(reference), "Property is not nullable for class SweepConfigurationV2.");

            if (referenceForBeneficiary.IsSet && referenceForBeneficiary.Value == null)
                throw new ArgumentNullException(nameof(referenceForBeneficiary), "Property is not nullable for class SweepConfigurationV2.");

            if (status.IsSet && status.Value == null)
                throw new ArgumentNullException(nameof(status), "Property is not nullable for class SweepConfigurationV2.");

            if (sweepAmount.IsSet && sweepAmount.Value == null)
                throw new ArgumentNullException(nameof(sweepAmount), "Property is not nullable for class SweepConfigurationV2.");

            if (targetAmount.IsSet && targetAmount.Value == null)
                throw new ArgumentNullException(nameof(targetAmount), "Property is not nullable for class SweepConfigurationV2.");

            if (triggerAmount.IsSet && triggerAmount.Value == null)
                throw new ArgumentNullException(nameof(triggerAmount), "Property is not nullable for class SweepConfigurationV2.");

            if (type.IsSet && type.Value == null)
                throw new ArgumentNullException(nameof(type), "Property is not nullable for class SweepConfigurationV2.");
        ...
        {
            /*
            if (sweepConfigurationV2.Counterparty == null)
                throw new ArgumentNullException(nameof(sweepConfigurationV2.Counterparty), "Property is required for class SweepConfigurationV2.");

            if (sweepConfigurationV2.Currency == null)
                throw new ArgumentNullException(nameof(sweepConfigurationV2.Currency), "Property is required for class SweepConfigurationV2.");

            if (sweepConfigurationV2.Id == null)
                throw new ArgumentNullException(nameof(sweepConfigurationV2.Id), "Property is required for class SweepConfigurationV2.");

            if (sweepConfigurationV2.Schedule == null)
                throw new ArgumentNullException(nameof(sweepConfigurationV2.Schedule), "Property is required for class SweepConfigurationV2.");

            if (sweepConfigurationV2._DescriptionOption.IsSet && sweepConfigurationV2.Description == null)
                throw new ArgumentNullException(nameof(sweepConfigurationV2.Description), "Property is required for class SweepConfigurationV2.");

            if (sweepConfigurationV2._PrioritiesOption.IsSet && sweepConfigurationV2.Priorities == null)
                throw new ArgumentNullException(nameof(sweepConfigurationV2.Priorities), "Property is required for class SweepConfigurationV2.");

            if (sweepConfigurationV2._ReasonDetailOption.IsSet && sweepConfigurationV2.ReasonDetail == null)
                throw new ArgumentNullException(nameof(sweepConfigurationV2.ReasonDetail), "Property is required for class SweepConfigurationV2.");

            if (sweepConfigurationV2._ReferenceOption.IsSet && sweepConfigurationV2.Reference == null)
                throw new ArgumentNullException(nameof(sweepConfigurationV2.Reference), "Property is required for class SweepConfigurationV2.");

            if (sweepConfigurationV2._ReferenceForBeneficiaryOption.IsSet && sweepConfigurationV2.ReferenceForBeneficiary == null)
                throw new ArgumentNullException(nameof(sweepConfigurationV2.ReferenceForBeneficiary), "Property is required for class SweepConfigurationV2.");

            if (sweepConfigurationV2._SweepAmountOption.IsSet && sweepConfigurationV2.SweepAmount == null)
                throw new ArgumentNullException(nameof(sweepConfigurationV2.SweepAmount), "Property is required for class SweepConfigurationV2.");

            if (sweepConfigurationV2._TargetAmountOption.IsSet && sweepConfigurationV2.TargetAmount == null)
                throw new ArgumentNullException(nameof(sweepConfigurationV2.TargetAmount), "Property is required for class SweepConfigurationV2.");

            if (sweepConfigurationV2._TriggerAmountOption.IsSet && sweepConfigurationV2.TriggerAmount == null)
                throw new ArgumentNullException(nameof(sweepConfigurationV2.TriggerAmount), "Property is required for class SweepConfigurationV2.");
