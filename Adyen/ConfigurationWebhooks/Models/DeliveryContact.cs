...
namespace Adyen.ConfigurationWebhooks.Models
{
    ...
    /// DeliveryContact.
    /// </summary>
    [JsonConverter(typeof(DeliveryContactJsonConverter))]
    ...
    public class DeliveryContactJsonConverter : JsonConverter<DeliveryContact>
    {
        ...
        public override DeliveryContact Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (email.IsSet)
                deliveryContact.Email = email.Value;
            if (fullPhoneNumber.IsSet)
                deliveryContact.FullPhoneNumber = fullPhoneNumber.Value;
            if (phoneNumber.IsSet)
                deliveryContact.PhoneNumber = phoneNumber.Value;
            if (webAddress.IsSet)
                deliveryContact.WebAddress = webAddress.Value;
