    ...
    public class CardOrderNotificationRequestJsonConverter : JsonConverter<CardOrderNotificationRequest>
    {
        ...
        public override CardOrderNotificationRequest Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (data.IsSet && data.Value == null)
                throw new ArgumentNullException(nameof(data), "Property is not nullable for class CardOrderNotificationRequest.");

            if (environment.IsSet && environment.Value == null)
                throw new ArgumentNullException(nameof(environment), "Property is not nullable for class CardOrderNotificationRequest.");

            if (type.IsSet && type.Value == null)
                throw new ArgumentNullException(nameof(type), "Property is not nullable for class CardOrderNotificationRequest.");

            if (timestamp.IsSet && timestamp.Value == null)
                throw new ArgumentNullException(nameof(timestamp), "Property is not nullable for class CardOrderNotificationRequest.");
        ...
        {
            /*
            if (cardOrderNotificationRequest.Data == null)
                throw new ArgumentNullException(nameof(cardOrderNotificationRequest.Data), "Property is required for class CardOrderNotificationRequest.");

            if (cardOrderNotificationRequest.Environment == null)
                throw new ArgumentNullException(nameof(cardOrderNotificationRequest.Environment), "Property is required for class CardOrderNotificationRequest.");
