...
namespace Adyen.RelayedAuthorizationWebhooks.Models
{
    ...
    /// </summary>
    [JsonConverter(typeof(TransactionRuleReferenceJsonConverter))]
    public partial class TransactionRuleReference
    {
        /// <summary>
    ...
    public class TransactionRuleReferenceJsonConverter : JsonConverter<TransactionRuleReference>
    {
        ...
        public override TransactionRuleReference Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (id.IsSet)
                transactionRuleReference.Id = id.Value;
            if (outcomeType.IsSet)
                transactionRuleReference.OutcomeType = outcomeType.Value;
            if (reference.IsSet)
                transactionRuleReference.Reference = reference.Value;
            if (score.IsSet)
                transactionRuleReference.Score = score.Value;
            return transactionRuleReference;
        }
