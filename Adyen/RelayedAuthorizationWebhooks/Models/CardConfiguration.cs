...
namespace Adyen.RelayedAuthorizationWebhooks.Models
{
    ...
    /// CardConfiguration.
    /// </summary>
    [JsonConverter(typeof(CardConfigurationJsonConverter))]
    public partial class CardConfiguration
    {
        ...
        /// <summary>
        /// This is used to track if an optional field is set. If set, <see cref="Languages"/> will be populated.
        /// </summary>
        [JsonIgnore]
        [global::System.ComponentModel.EditorBrowsable(global::System.ComponentModel.EditorBrowsableState.Never)]
        public Option<List<string>?> _LanguagesOption { get; private set; }
        ...
        /// </summary>
        /// <value>A list of two-letter [ISO-639-1](https://en.wikipedia.org/wiki/List_of_ISO_639-1_codes) language codes of the card. For example, **[en,es]**.</value>
        [JsonPropertyName("languages")]
        public List<string>? Languages { get { return this._LanguagesOption; } set { this._LanguagesOption = new(value); } }
    ...
    public class CardConfigurationJsonConverter : JsonConverter<CardConfiguration>
    {
        ...
        public override CardConfiguration Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (activationUrl.IsSet)
                cardConfiguration.ActivationUrl = activationUrl.Value;
            if (bulkAddress.IsSet)
                cardConfiguration.BulkAddress = bulkAddress.Value;
            if (cardImageId.IsSet)
                cardConfiguration.CardImageId = cardImageId.Value;
            if (carrier.IsSet)
                cardConfiguration.Carrier = carrier.Value;
            if (carrierImageId.IsSet)
                cardConfiguration.CarrierImageId = carrierImageId.Value;
            if (currency.IsSet)
                cardConfiguration.Currency = currency.Value;
            if (envelope.IsSet)
                cardConfiguration.Envelope = envelope.Value;
            if (insert.IsSet)
                cardConfiguration.Insert = insert.Value;
            if (languages.IsSet)
                cardConfiguration.Languages = languages.Value;
            if (logoImageId.IsSet)
                cardConfiguration.LogoImageId = logoImageId.Value;
            if (pinMailer.IsSet)
                cardConfiguration.PinMailer = pinMailer.Value;
            if (printLine.IsSet)
                cardConfiguration.PrintLine = printLine.Value;
            if (shipmentMethod.IsSet)
                cardConfiguration.ShipmentMethod = shipmentMethod.Value;
        ...
        public void WriteProperties(Utf8JsonWriter writer, CardConfiguration cardConfiguration, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (cardConfiguration._LanguagesOption.IsSet)
            {
                writer.WritePropertyName("languages");
                JsonSerializer.Serialize(writer, cardConfiguration.Languages, jsonSerializerOptions);
            }
