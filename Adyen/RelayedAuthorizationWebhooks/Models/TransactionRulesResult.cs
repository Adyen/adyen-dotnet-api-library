...
namespace Adyen.RelayedAuthorizationWebhooks.Models
{
    ...
    /// </summary>
    [JsonConverter(typeof(TransactionRulesResultJsonConverter))]
    ...
    public class TransactionRulesResultJsonConverter : JsonConverter<TransactionRulesResult>
    {
        ...
        public override TransactionRulesResult Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (allHardBlockRulesPassed.IsSet)
                transactionRulesResult.AllHardBlockRulesPassed = allHardBlockRulesPassed.Value;
            if (score.IsSet)
                transactionRulesResult.Score = score.Value;
            if (triggeredTransactionRules.IsSet)
                transactionRulesResult.TriggeredTransactionRules = triggeredTransactionRules.Value;
