...
namespace Adyen.RelayedAuthorizationWebhooks.Models
{
    ...
    public class MerchantDataJsonConverter : JsonConverter<MerchantData>
    {
        ...
        public override MerchantData Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (mcc.IsSet)
                merchantData.Mcc = mcc.Value;
            if (merchantId.IsSet)
                merchantData.MerchantId = merchantId.Value;
            if (nameLocation.IsSet)
                merchantData.NameLocation = nameLocation.Value;
            if (postalCode.IsSet)
                merchantData.PostalCode = postalCode.Value;
            return merchantData;
        }
