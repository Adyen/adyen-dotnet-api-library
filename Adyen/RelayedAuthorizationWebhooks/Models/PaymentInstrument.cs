...
namespace Adyen.RelayedAuthorizationWebhooks.Models
{
    ...
    public partial class PaymentInstrument
    {
        ...
        /* Deprecated since Authorization webhooks v2: Please use `bankAccount` object instead */
        [Obsolete("Deprecated since Authorization webhooks v2.")]
    ...
    public class PaymentInstrumentJsonConverter : JsonConverter<PaymentInstrument>
    {
        ...
        public void WriteProperties(Utf8JsonWriter writer, PaymentInstrument paymentInstrument, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (paymentInstrument._PaymentInstrumentGroupIdOption.IsSet)
                if (paymentInstrument.PaymentInstrumentGroupId != null)
            ...
            if (paymentInstrument._StatusCommentOption.IsSet)
                if (paymentInstrument.StatusComment != null)
