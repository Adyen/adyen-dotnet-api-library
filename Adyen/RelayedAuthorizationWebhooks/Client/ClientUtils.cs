...
using Adyen.Core;
#endif
using Models = Adyen.RelayedAuthorizationWebhooks.Models;
...
namespace Adyen.RelayedAuthorizationWebhooks.Client
{
    ...
    public static partial class ClientUtils
    {
        ...
        public static string? ParameterToString(object? obj, string? format = ISO8601_DATETIME_FORMAT)
        {
            ...
            if (obj is Models.AuthorisationDecisionResponse.StatusEnum authorisationDecisionResponseStatusEnum)
                return Models.AuthorisationDecisionResponse.StatusEnum.ToJsonValue(authorisationDecisionResponseStatusEnum);
            ...
            if (obj is Models.RelayedAuthorisationRequest.TypeEnum relayedAuthorisationRequestTypeEnum)
                return Models.RelayedAuthorisationRequest.TypeEnum.ToJsonValue(relayedAuthorisationRequestTypeEnum);
