...
namespace Adyen.Management.Services
{
    ...
    /// <summary>
    /// The <see cref="IGetApplePayDomainsApiResponse"/>, wraps <see cref="Adyen.Management.Models.ApplePayResponseInfo"/>.
    /// </summary>
    public interface IGetApplePayDomainsApiResponse : Adyen.Core.Client.IApiResponse, IOk<Adyen.Management.Models.ApplePayResponseInfo?>, IBadRequest<Adyen.Management.Models.RestServiceError?>, IUnauthorized<Adyen.Management.Models.RestServiceError?>, IForbidden<Adyen.Management.Models.RestServiceError?>, IUnprocessableContent<Adyen.Management.Models.RestServiceError?>, IInternalServerError<Adyen.Management.Models.RestServiceError?>
    {
        /// <summary>
        /// Returns true if the response is 200 Ok.
        /// </summary>
    ...
    public sealed partial class PaymentMethodsMerchantLevelService : IPaymentMethodsMerchantLevelService
    {
        ...
        /// <param name="requestOptions"><see cref="RequestOptions"/>.</param>
        /// <param name="cancellationToken"><see cref="CancellationToken"/>.</param>
        /// <returns><see cref="Task"/> of <see cref="IGetApplePayDomainsApiResponse"/> - If 200 OK response, wraps the <see cref="Adyen.Management.Models.ApplePayResponseInfo"/> when `TryDeserializeOk(...)` is called.</returns>
        ...
        public partial class GetApplePayDomainsApiResponse : Adyen.Core.Client.ApiResponse, IGetApplePayDomainsApiResponse
        {
            ...
            /// </summary>
            /// <returns></returns>
            public Adyen.Management.Models.ApplePayResponseInfo? Ok()
            {
                return IsOk
                    ? System.Text.Json.JsonSerializer.Deserialize<Adyen.Management.Models.ApplePayResponseInfo>(RawContent, _jsonSerializerOptions)
                    : null;
            }
            ...
            /// <param name="result"></param>
            /// <returns></returns>
            public bool TryDeserializeOkResponse([NotNullWhen(true)]out Adyen.Management.Models.ApplePayResponseInfo? result)
            {
                result = null;
