...
namespace Adyen.Management.Services
{
    ...
    public sealed partial class APICredentialsMerchantLevelService : IAPICredentialsMerchantLevelService
    {
        ...
        /// if (response.TryDeserializeOk(out <see cref="Adyen.Management.Models.CreateApiCredentialResponse"/> result));
        /// </code>
        /// <exception cref="ApiException">Thrown when fails to make API call.</exception>
        /// <param name="merchantId">The unique identifier of the merchant account.</param>
        /// <param name="createMerchantApiCredentialRequest"><see cref="CreateMerchantApiCredentialRequest"/> (optional)</param>
        /// <param name="requestOptions"><see cref="RequestOptions"/>.</param>
        /// <param name="cancellationToken"><see cref="CancellationToken"/>.</param>
        ...
        /// if (response.TryDeserializeOk(out <see cref="Adyen.Management.Models.ApiCredential"/> result));
        /// </code>
        /// <exception cref="ApiException">Thrown when fails to make API call.</exception>
        /// <param name="merchantId">The unique identifier of the merchant account.</param>
        /// <param name="apiCredentialId">Unique identifier of the API credential.</param>
        ...
        /// if (response.TryDeserializeOk(out <see cref="Adyen.Management.Models.ListMerchantApiCredentialsResponse"/> result));
        /// </code>
        /// <exception cref="ApiException">Thrown when fails to make API call.</exception>
        /// <param name="merchantId">The unique identifier of the merchant account.</param>
        ...
        /// <param name="merchantId">The unique identifier of the merchant account.</param>
        /// <param name="apiCredentialId">Unique identifier of the API credential.</param>
        /// <param name="updateMerchantApiCredentialRequest"><see cref="UpdateMerchantApiCredentialRequest"/> (optional)</param>
        /// <param name="requestOptions"><see cref="RequestOptions"/>.</param>
        /// <param name="cancellationToken"><see cref="CancellationToken"/>.</param>
