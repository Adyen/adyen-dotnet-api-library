...
namespace Adyen.Management.Services
{
    ...
    public sealed partial class AllowedOriginsCompanyLevelService : IAllowedOriginsCompanyLevelService
    {
        ...
        /// <code>
        /// // Usage:
        /// var response = await CreateAllowedOriginAsync(...);
        ...
        /// <code>
        /// // Usage:
        /// var response = await DeleteAllowedOriginAsync(...);
        ...
        /// <code>
        /// // Usage:
        /// var response = await GetAllowedOriginAsync(...);
        /// if (response.TryDeserializeOk(out <see cref="Adyen.Management.Models.AllowedOrigin"/> result));
        /// </code>
        /// <exception cref="ApiException">Thrown when fails to make API call.</exception>
        /// <param name="companyId">The unique identifier of the company account.</param>
        ...
        /// <code>
        /// // Usage:
        /// var response = await ListAllowedOriginsAsync(...);
