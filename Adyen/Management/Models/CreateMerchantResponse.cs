...
namespace Adyen.Management.Models
{
    ...
    /// </summary>
    [JsonConverter(typeof(CreateMerchantResponseJsonConverter))]
    ...
    public class CreateMerchantResponseJsonConverter : JsonConverter<CreateMerchantResponse>
    {
        ...
        public override CreateMerchantResponse Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (companyId.IsSet)
                createMerchantResponse.CompanyId = companyId.Value;
            if (description.IsSet)
                createMerchantResponse.Description = description.Value;
            if (id.IsSet)
                createMerchantResponse.Id = id.Value;
            if (legalEntityId.IsSet)
                createMerchantResponse.LegalEntityId = legalEntityId.Value;
            if (pricingPlan.IsSet)
                createMerchantResponse.PricingPlan = pricingPlan.Value;
            if (reference.IsSet)
                createMerchantResponse.Reference = reference.Value;
