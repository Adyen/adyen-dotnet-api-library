...
namespace Adyen.Management.Models
{
    ...
    /// ForceRebootDetails.
    /// </summary>
    [JsonConverter(typeof(ForceRebootDetailsJsonConverter))]
    public partial class ForceRebootDetails
    {
        ...
        {
            _TypeOption = TypeEnum.ForceReboot;
            OnCreated();
        }
    ...
    /// <summary>
    /// A Json converter for type <see cref="ForceRebootDetails" />
    /// </summary>
    public class ForceRebootDetailsJsonConverter : JsonConverter<ForceRebootDetails>
    {
        /// <summary>
        /// Deserializes json to <see cref="ForceRebootDetails"/>.
        /// </summary>
        /// <param name="utf8JsonReader"><see cref="Utf8JsonReader"/>.</param>
        /// <param name="typeToConvert"><see cref="Type"/>.</param>
        /// <param name="jsonSerializerOptions">The <see cref="JsonSerializerOptions"/>, initialized from <see cref="HostConfiguration"/>.</param>
        /// <returns><see cref="ForceRebootDetails"/>.</returns>
        /// <exception cref="JsonException"></exception>
        public override ForceRebootDetails Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            Option<ForceRebootDetails.TypeEnum?> type = default;
            ...
            return forceRebootDetails;
        }

        /// <summary>
        /// Serializes a <see cref="ForceRebootDetails"/>.
        /// </summary>
        /// <param name="writer"><see cref="Utf8JsonWriter"/></param>
        /// <param name="forceRebootDetails"></param>
        /// <param name="jsonSerializerOptions"><see cref="JsonSerializerOptions"/></param>
        public override void Write(Utf8JsonWriter writer, ForceRebootDetails forceRebootDetails, JsonSerializerOptions jsonSerializerOptions)
        {
            
            writer.WriteStartObject();
            
            WriteProperties(writer, forceRebootDetails, jsonSerializerOptions);
        ...
        /// <param name="forceRebootDetails"></param>
        /// <param name="jsonSerializerOptions"><see cref="JsonSerializerOptions"/></param>
        public void WriteProperties(Utf8JsonWriter writer, ForceRebootDetails forceRebootDetails, JsonSerializerOptions jsonSerializerOptions)
        {
            
            if (forceRebootDetails._TypeOption.IsSet && forceRebootDetails.Type != null) 
            {
                string? typeRawValue = ForceRebootDetails.TypeEnum.ToJsonValue(forceRebootDetails._TypeOption.Value!.Value);
