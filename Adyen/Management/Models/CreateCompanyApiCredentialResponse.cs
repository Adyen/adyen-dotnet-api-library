...
namespace Adyen.Management.Models
{
    ...
    /// </summary>
    public partial class CreateCompanyApiCredentialResponse
    {
        /// <summary>
    ...
    public class CreateCompanyApiCredentialResponseJsonConverter : JsonConverter<CreateCompanyApiCredentialResponse>
    {
        ...
        public override CreateCompanyApiCredentialResponse Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            return new CreateCompanyApiCredentialResponse(active.Value!.Value!, allowedIpAddresses.Value!, apiKey.Value!, associatedMerchantAccounts.Value!, clientKey.Value!, id.Value!, password.Value!, roles.Value!, username.Value!, links, allowedOrigins, description, subjectDN);
        }
        ...
        public void WriteProperties(Utf8JsonWriter writer, CreateCompanyApiCredentialResponse createCompanyApiCredentialResponse, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (createCompanyApiCredentialResponse._DescriptionOption.IsSet)
                if (createCompanyApiCredentialResponse.Description != null)
                    writer.WriteString("description", createCompanyApiCredentialResponse.Description);

            if (createCompanyApiCredentialResponse._SubjectDNOption.IsSet)
                if (createCompanyApiCredentialResponse.SubjectDN != null)
                    writer.WriteString("subjectDN", createCompanyApiCredentialResponse.SubjectDN);
        }
    }
}
