...
namespace Adyen.Management.Models
{
    ...
    /// </summary>
    public partial class CreateCompanyApiCredentialResponse : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CreateCompanyApiCredentialResponse" /> class.
        /// </summary>
        ...
        /// <param name="apiKey">The API key for the API credential that was created.</param>
        ...
        /// <param name="password">The password for the API credential that was created.</param>
        ...
        [JsonConstructor]
        public CreateCompanyApiCredentialResponse(bool active, List<string> allowedIpAddresses, string apiKey, List<string> associatedMerchantAccounts, string clientKey, string id, string password, List<string> roles, string username, Option<ApiCredentialLinks?> links = default, Option<List<AllowedOrigin>?> allowedOrigins = default, Option<string?> description = default)
        {
            Active = active;
    ...
    /// <summary>
    /// A Json converter for type <see cref="CreateCompanyApiCredentialResponse" />
    /// </summary>
    public class CreateCompanyApiCredentialResponseJsonConverter : JsonConverter<CreateCompanyApiCredentialResponse>
    {
        /// <summary>
        /// Deserializes json to <see cref="CreateCompanyApiCredentialResponse"/>.
        /// </summary>
        ...
        public override CreateCompanyApiCredentialResponse Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (active.IsSet && active.Value == null)
                throw new ArgumentNullException(nameof(active), "Property is not nullable for class CreateCompanyApiCredentialResponse.");

            if (allowedIpAddresses.IsSet && allowedIpAddresses.Value == null)
                throw new ArgumentNullException(nameof(allowedIpAddresses), "Property is not nullable for class CreateCompanyApiCredentialResponse.");

            if (apiKey.IsSet && apiKey.Value == null)
                throw new ArgumentNullException(nameof(apiKey), "Property is not nullable for class CreateCompanyApiCredentialResponse.");

            if (associatedMerchantAccounts.IsSet && associatedMerchantAccounts.Value == null)
                throw new ArgumentNullException(nameof(associatedMerchantAccounts), "Property is not nullable for class CreateCompanyApiCredentialResponse.");

            if (clientKey.IsSet && clientKey.Value == null)
                throw new ArgumentNullException(nameof(clientKey), "Property is not nullable for class CreateCompanyApiCredentialResponse.");

            if (id.IsSet && id.Value == null)
                throw new ArgumentNullException(nameof(id), "Property is not nullable for class CreateCompanyApiCredentialResponse.");

            if (password.IsSet && password.Value == null)
                throw new ArgumentNullException(nameof(password), "Property is not nullable for class CreateCompanyApiCredentialResponse.");

            if (roles.IsSet && roles.Value == null)
                throw new ArgumentNullException(nameof(roles), "Property is not nullable for class CreateCompanyApiCredentialResponse.");

            if (username.IsSet && username.Value == null)
                throw new ArgumentNullException(nameof(username), "Property is not nullable for class CreateCompanyApiCredentialResponse.");

            if (links.IsSet && links.Value == null)
                throw new ArgumentNullException(nameof(links), "Property is not nullable for class CreateCompanyApiCredentialResponse.");

            if (allowedOrigins.IsSet && allowedOrigins.Value == null)
                throw new ArgumentNullException(nameof(allowedOrigins), "Property is not nullable for class CreateCompanyApiCredentialResponse.");

            if (description.IsSet && description.Value == null)
                throw new ArgumentNullException(nameof(description), "Property is not nullable for class CreateCompanyApiCredentialResponse.");
        ...
        /// <summary>
        /// Serializes a <see cref="CreateCompanyApiCredentialResponse"/>.
        /// </summary>
        ...
        /// <summary>
        /// Serializes the properties of <see cref="CreateCompanyApiCredentialResponse"/>.
        /// </summary>
        ...
        {
            /*
            if (createCompanyApiCredentialResponse.AllowedIpAddresses == null)
                throw new ArgumentNullException(nameof(createCompanyApiCredentialResponse.AllowedIpAddresses), "Property is required for class CreateCompanyApiCredentialResponse.");

            if (createCompanyApiCredentialResponse.ApiKey == null)
                throw new ArgumentNullException(nameof(createCompanyApiCredentialResponse.ApiKey), "Property is required for class CreateCompanyApiCredentialResponse.");

            if (createCompanyApiCredentialResponse.AssociatedMerchantAccounts == null)
                throw new ArgumentNullException(nameof(createCompanyApiCredentialResponse.AssociatedMerchantAccounts), "Property is required for class CreateCompanyApiCredentialResponse.");

            if (createCompanyApiCredentialResponse.ClientKey == null)
                throw new ArgumentNullException(nameof(createCompanyApiCredentialResponse.ClientKey), "Property is required for class CreateCompanyApiCredentialResponse.");

            if (createCompanyApiCredentialResponse.Id == null)
                throw new ArgumentNullException(nameof(createCompanyApiCredentialResponse.Id), "Property is required for class CreateCompanyApiCredentialResponse.");

            if (createCompanyApiCredentialResponse.Password == null)
                throw new ArgumentNullException(nameof(createCompanyApiCredentialResponse.Password), "Property is required for class CreateCompanyApiCredentialResponse.");

            if (createCompanyApiCredentialResponse.Roles == null)
                throw new ArgumentNullException(nameof(createCompanyApiCredentialResponse.Roles), "Property is required for class CreateCompanyApiCredentialResponse.");

            if (createCompanyApiCredentialResponse.Username == null)
                throw new ArgumentNullException(nameof(createCompanyApiCredentialResponse.Username), "Property is required for class CreateCompanyApiCredentialResponse.");

            if (createCompanyApiCredentialResponse._LinksOption.IsSet && createCompanyApiCredentialResponse.Links == null)
                throw new ArgumentNullException(nameof(createCompanyApiCredentialResponse.Links), "Property is required for class CreateCompanyApiCredentialResponse.");

            if (createCompanyApiCredentialResponse._AllowedOriginsOption.IsSet && createCompanyApiCredentialResponse.AllowedOrigins == null)
                throw new ArgumentNullException(nameof(createCompanyApiCredentialResponse.AllowedOrigins), "Property is required for class CreateCompanyApiCredentialResponse.");

            if (createCompanyApiCredentialResponse._DescriptionOption.IsSet && createCompanyApiCredentialResponse.Description == null)
                throw new ArgumentNullException(nameof(createCompanyApiCredentialResponse.Description), "Property is required for class CreateCompanyApiCredentialResponse.");

            */
            
            writer.WriteBoolean("active", createCompanyApiCredentialResponse.Active);

            writer.WritePropertyName("allowedIpAddresses");
            JsonSerializer.Serialize(writer, createCompanyApiCredentialResponse.AllowedIpAddresses, jsonSerializerOptions);
            writer.WriteString("apiKey", createCompanyApiCredentialResponse.ApiKey);

            writer.WritePropertyName("associatedMerchantAccounts");
            JsonSerializer.Serialize(writer, createCompanyApiCredentialResponse.AssociatedMerchantAccounts, jsonSerializerOptions);
            writer.WriteString("clientKey", createCompanyApiCredentialResponse.ClientKey);

            writer.WriteString("id", createCompanyApiCredentialResponse.Id);

            writer.WriteString("password", createCompanyApiCredentialResponse.Password);

            writer.WritePropertyName("roles");
            JsonSerializer.Serialize(writer, createCompanyApiCredentialResponse.Roles, jsonSerializerOptions);
            writer.WriteString("username", createCompanyApiCredentialResponse.Username);

            if (createCompanyApiCredentialResponse._LinksOption.IsSet)
            {
                writer.WritePropertyName("_links");
                JsonSerializer.Serialize(writer, createCompanyApiCredentialResponse.Links, jsonSerializerOptions);
            }
            if (createCompanyApiCredentialResponse._AllowedOriginsOption.IsSet)
            {
                writer.WritePropertyName("allowedOrigins");
                JsonSerializer.Serialize(writer, createCompanyApiCredentialResponse.AllowedOrigins, jsonSerializerOptions);
            }
            if (createCompanyApiCredentialResponse._DescriptionOption.IsSet)
                writer.WriteString("description", createCompanyApiCredentialResponse.Description);
        }
    }
}
