...
namespace Adyen.Management.Models
{
    ...
    /// </summary>
    [JsonConverter(typeof(CreateCompanyApiCredentialResponseJsonConverter))]
    ...
    public class CreateCompanyApiCredentialResponseJsonConverter : JsonConverter<CreateCompanyApiCredentialResponse>
    {
        ...
        public override CreateCompanyApiCredentialResponse Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (allowedOrigins.IsSet)
                createCompanyApiCredentialResponse.AllowedOrigins = allowedOrigins.Value;
            if (description.IsSet)
                createCompanyApiCredentialResponse.Description = description.Value;
            if (subjectDN.IsSet)
                createCompanyApiCredentialResponse.SubjectDN = subjectDN.Value;
