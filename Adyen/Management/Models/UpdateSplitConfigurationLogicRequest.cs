...
namespace Adyen.Management.Models
{
    ...
    /// </summary>
    [JsonConverter(typeof(UpdateSplitConfigurationLogicRequestJsonConverter))]
    public partial class UpdateSplitConfigurationLogicRequest
    {
        /// <summary>
    ...
    public class UpdateSplitConfigurationLogicRequestJsonConverter : JsonConverter<UpdateSplitConfigurationLogicRequest>
    {
        ...
        public override UpdateSplitConfigurationLogicRequest Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            var updateSplitConfigurationLogicRequest = new UpdateSplitConfigurationLogicRequest();
            if (commission.IsSet)
                updateSplitConfigurationLogicRequest.Commission = commission.Value!;
            if (acquiringFees.IsSet)
                updateSplitConfigurationLogicRequest.AcquiringFees = acquiringFees.Value;
            if (additionalCommission.IsSet)
                updateSplitConfigurationLogicRequest.AdditionalCommission = additionalCommission.Value;
            if (adyenCommission.IsSet)
                updateSplitConfigurationLogicRequest.AdyenCommission = adyenCommission.Value;
            if (adyenFees.IsSet)
                updateSplitConfigurationLogicRequest.AdyenFees = adyenFees.Value;
            if (adyenMarkup.IsSet)
                updateSplitConfigurationLogicRequest.AdyenMarkup = adyenMarkup.Value;
            if (chargeback.IsSet)
                updateSplitConfigurationLogicRequest.Chargeback = chargeback.Value;
            if (chargebackCostAllocation.IsSet)
                updateSplitConfigurationLogicRequest.ChargebackCostAllocation = chargebackCostAllocation.Value;
            if (dcc.IsSet)
                updateSplitConfigurationLogicRequest.Dcc = dcc.Value;
            if (interchange.IsSet)
                updateSplitConfigurationLogicRequest.Interchange = interchange.Value;
            if (paymentFee.IsSet)
                updateSplitConfigurationLogicRequest.PaymentFee = paymentFee.Value;
            if (refund.IsSet)
                updateSplitConfigurationLogicRequest.Refund = refund.Value;
            if (refundCostAllocation.IsSet)
                updateSplitConfigurationLogicRequest.RefundCostAllocation = refundCostAllocation.Value;
            if (remainder.IsSet)
                updateSplitConfigurationLogicRequest.Remainder = remainder.Value;
            if (schemeFee.IsSet)
                updateSplitConfigurationLogicRequest.SchemeFee = schemeFee.Value;
            if (splitLogicId.IsSet)
                updateSplitConfigurationLogicRequest.SplitLogicId = splitLogicId.Value;
            if (surcharge.IsSet)
                updateSplitConfigurationLogicRequest.Surcharge = surcharge.Value;
            if (tip.IsSet)
                updateSplitConfigurationLogicRequest.Tip = tip.Value;
            return updateSplitConfigurationLogicRequest;
        }
        ...
        public void WriteProperties(Utf8JsonWriter writer, UpdateSplitConfigurationLogicRequest updateSplitConfigurationLogicRequest, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (updateSplitConfigurationLogicRequest._DccOption.IsSet)
            {
                writer.WritePropertyName("dcc");
                JsonSerializer.Serialize(writer, updateSplitConfigurationLogicRequest.Dcc, jsonSerializerOptions);
            }
            ...
            if (updateSplitConfigurationLogicRequest._SplitLogicIdOption.IsSet)
                if (updateSplitConfigurationLogicRequest.SplitLogicId != null)
