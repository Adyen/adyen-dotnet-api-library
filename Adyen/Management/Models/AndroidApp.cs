    ...
    public class AndroidAppJsonConverter : JsonConverter<AndroidApp>
    {
        ...
        public override AndroidApp Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (id.IsSet && id.Value == null)
                throw new ArgumentNullException(nameof(id), "Property is not nullable for class AndroidApp.");

            if (status.IsSet && status.Value == null)
                throw new ArgumentNullException(nameof(status), "Property is not nullable for class AndroidApp.");

            if (description.IsSet && description.Value == null)
                throw new ArgumentNullException(nameof(description), "Property is not nullable for class AndroidApp.");

            if (errorCode.IsSet && errorCode.Value == null)
                throw new ArgumentNullException(nameof(errorCode), "Property is not nullable for class AndroidApp.");

            if (errors.IsSet && errors.Value == null)
                throw new ArgumentNullException(nameof(errors), "Property is not nullable for class AndroidApp.");

            if (label.IsSet && label.Value == null)
                throw new ArgumentNullException(nameof(label), "Property is not nullable for class AndroidApp.");

            if (packageName.IsSet && packageName.Value == null)
                throw new ArgumentNullException(nameof(packageName), "Property is not nullable for class AndroidApp.");

            if (versionCode.IsSet && versionCode.Value == null)
                throw new ArgumentNullException(nameof(versionCode), "Property is not nullable for class AndroidApp.");

            if (versionName.IsSet && versionName.Value == null)
                throw new ArgumentNullException(nameof(versionName), "Property is not nullable for class AndroidApp.");
        ...
        public void WriteProperties(Utf8JsonWriter writer, AndroidApp androidApp, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (androidApp.Id == null)
                throw new ArgumentNullException(nameof(androidApp.Id), "Property is required for class AndroidApp.");

            if (androidApp._DescriptionOption.IsSet && androidApp.Description == null)
                throw new ArgumentNullException(nameof(androidApp.Description), "Property is required for class AndroidApp.");

            if (androidApp._ErrorCodeOption.IsSet && androidApp.ErrorCode == null)
                throw new ArgumentNullException(nameof(androidApp.ErrorCode), "Property is required for class AndroidApp.");

            if (androidApp._ErrorsOption.IsSet && androidApp.Errors == null)
                throw new ArgumentNullException(nameof(androidApp.Errors), "Property is required for class AndroidApp.");

            if (androidApp._LabelOption.IsSet && androidApp.Label == null)
                throw new ArgumentNullException(nameof(androidApp.Label), "Property is required for class AndroidApp.");

            if (androidApp._PackageNameOption.IsSet && androidApp.PackageName == null)
                throw new ArgumentNullException(nameof(androidApp.PackageName), "Property is required for class AndroidApp.");

            if (androidApp._VersionNameOption.IsSet && androidApp.VersionName == null)
                throw new ArgumentNullException(nameof(androidApp.VersionName), "Property is required for class AndroidApp.");
