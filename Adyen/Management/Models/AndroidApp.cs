...
namespace Adyen.Management.Models
{
    ...
    /// AndroidApp.
    /// </summary>
    [JsonConverter(typeof(AndroidAppJsonConverter))]
    ...
    public class AndroidAppJsonConverter : JsonConverter<AndroidApp>
    {
        ...
        public override AndroidApp Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (errorCode.IsSet)
                androidApp.ErrorCode = errorCode.Value;
            if (errors.IsSet)
                androidApp.Errors = errors.Value;
            if (label.IsSet)
                androidApp.Label = label.Value;
            if (packageName.IsSet)
                androidApp.PackageName = packageName.Value;
            if (versionCode.IsSet)
                androidApp.VersionCode = versionCode.Value;
            if (versionName.IsSet)
                androidApp.VersionName = versionName.Value;
            return androidApp;
        }
