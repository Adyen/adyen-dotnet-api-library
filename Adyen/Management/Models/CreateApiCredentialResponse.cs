...
namespace Adyen.Management.Models
{
    ...
    /// </summary>
    public partial class CreateApiCredentialResponse : IValidatableObject
    {
        /// <summary>
        ...
        [JsonConstructor]
        public CreateApiCredentialResponse(bool active, List<string> allowedIpAddresses, string apiKey, string clientKey, string id, string password, List<string> roles, string username, Option<ApiCredentialLinks?> links = default, Option<List<AllowedOrigin>?> allowedOrigins = default, Option<string?> description = default)
        {
            Active = active;
    ...
    public class CreateApiCredentialResponseJsonConverter : JsonConverter<CreateApiCredentialResponse>
    {
        ...
        public override CreateApiCredentialResponse Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (active.IsSet && active.Value == null)
                throw new ArgumentNullException(nameof(active), "Property is not nullable for class CreateApiCredentialResponse.");

            if (allowedIpAddresses.IsSet && allowedIpAddresses.Value == null)
                throw new ArgumentNullException(nameof(allowedIpAddresses), "Property is not nullable for class CreateApiCredentialResponse.");

            if (apiKey.IsSet && apiKey.Value == null)
                throw new ArgumentNullException(nameof(apiKey), "Property is not nullable for class CreateApiCredentialResponse.");

            if (clientKey.IsSet && clientKey.Value == null)
                throw new ArgumentNullException(nameof(clientKey), "Property is not nullable for class CreateApiCredentialResponse.");

            if (id.IsSet && id.Value == null)
                throw new ArgumentNullException(nameof(id), "Property is not nullable for class CreateApiCredentialResponse.");

            if (password.IsSet && password.Value == null)
                throw new ArgumentNullException(nameof(password), "Property is not nullable for class CreateApiCredentialResponse.");

            if (roles.IsSet && roles.Value == null)
                throw new ArgumentNullException(nameof(roles), "Property is not nullable for class CreateApiCredentialResponse.");

            if (username.IsSet && username.Value == null)
                throw new ArgumentNullException(nameof(username), "Property is not nullable for class CreateApiCredentialResponse.");

            if (links.IsSet && links.Value == null)
                throw new ArgumentNullException(nameof(links), "Property is not nullable for class CreateApiCredentialResponse.");

            if (allowedOrigins.IsSet && allowedOrigins.Value == null)
                throw new ArgumentNullException(nameof(allowedOrigins), "Property is not nullable for class CreateApiCredentialResponse.");

            if (description.IsSet && description.Value == null)
                throw new ArgumentNullException(nameof(description), "Property is not nullable for class CreateApiCredentialResponse.");
        ...
        {
            /*
            if (createApiCredentialResponse.AllowedIpAddresses == null)
                throw new ArgumentNullException(nameof(createApiCredentialResponse.AllowedIpAddresses), "Property is required for class CreateApiCredentialResponse.");

            if (createApiCredentialResponse.ApiKey == null)
                throw new ArgumentNullException(nameof(createApiCredentialResponse.ApiKey), "Property is required for class CreateApiCredentialResponse.");

            if (createApiCredentialResponse.ClientKey == null)
                throw new ArgumentNullException(nameof(createApiCredentialResponse.ClientKey), "Property is required for class CreateApiCredentialResponse.");

            if (createApiCredentialResponse.Id == null)
                throw new ArgumentNullException(nameof(createApiCredentialResponse.Id), "Property is required for class CreateApiCredentialResponse.");

            if (createApiCredentialResponse.Password == null)
                throw new ArgumentNullException(nameof(createApiCredentialResponse.Password), "Property is required for class CreateApiCredentialResponse.");

            if (createApiCredentialResponse.Roles == null)
                throw new ArgumentNullException(nameof(createApiCredentialResponse.Roles), "Property is required for class CreateApiCredentialResponse.");

            if (createApiCredentialResponse.Username == null)
                throw new ArgumentNullException(nameof(createApiCredentialResponse.Username), "Property is required for class CreateApiCredentialResponse.");

            if (createApiCredentialResponse._LinksOption.IsSet && createApiCredentialResponse.Links == null)
                throw new ArgumentNullException(nameof(createApiCredentialResponse.Links), "Property is required for class CreateApiCredentialResponse.");

            if (createApiCredentialResponse._AllowedOriginsOption.IsSet && createApiCredentialResponse.AllowedOrigins == null)
                throw new ArgumentNullException(nameof(createApiCredentialResponse.AllowedOrigins), "Property is required for class CreateApiCredentialResponse.");

            if (createApiCredentialResponse._DescriptionOption.IsSet && createApiCredentialResponse.Description == null)
                throw new ArgumentNullException(nameof(createApiCredentialResponse.Description), "Property is required for class CreateApiCredentialResponse.");
