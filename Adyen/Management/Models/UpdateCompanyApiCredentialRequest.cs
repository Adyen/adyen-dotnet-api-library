...
namespace Adyen.Management.Models
{
    ...
    /// </summary>
    [JsonConverter(typeof(UpdateCompanyApiCredentialRequestJsonConverter))]
    ...
    public class UpdateCompanyApiCredentialRequestJsonConverter : JsonConverter<UpdateCompanyApiCredentialRequest>
    {
        ...
        public override UpdateCompanyApiCredentialRequest Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (allowedOrigins.IsSet)
                updateCompanyApiCredentialRequest.AllowedOrigins = allowedOrigins.Value;
            if (associatedMerchantAccounts.IsSet)
                updateCompanyApiCredentialRequest.AssociatedMerchantAccounts = associatedMerchantAccounts.Value;
            if (description.IsSet)
                updateCompanyApiCredentialRequest.Description = description.Value;
            if (roles.IsSet)
                updateCompanyApiCredentialRequest.Roles = roles.Value;
            if (subjectDN.IsSet)
                updateCompanyApiCredentialRequest.SubjectDN = subjectDN.Value;
            return updateCompanyApiCredentialRequest;
        }
