...
namespace Adyen.Management.Models
{
    ...
    public partial class UpdateCompanyApiCredentialRequest
    {
        ...
        public UpdateCompanyApiCredentialRequest(Option<bool?> active = default, Option<List<string>?> allowedOrigins = default, Option<List<string>?> associatedMerchantAccounts = default, Option<string?> description = default, Option<List<string>?> roles = default, Option<string?> subjectDN = default)
        {
    ...
    public class UpdateCompanyApiCredentialRequestJsonConverter : JsonConverter<UpdateCompanyApiCredentialRequest>
    {
        ...
        public override UpdateCompanyApiCredentialRequest Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            return new UpdateCompanyApiCredentialRequest(active, allowedOrigins, associatedMerchantAccounts, description, roles, subjectDN);
        }
        ...
        public void WriteProperties(Utf8JsonWriter writer, UpdateCompanyApiCredentialRequest updateCompanyApiCredentialRequest, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (updateCompanyApiCredentialRequest._DescriptionOption.IsSet)
                if (updateCompanyApiCredentialRequest.Description != null)
            ...
            if (updateCompanyApiCredentialRequest._SubjectDNOption.IsSet)
                if (updateCompanyApiCredentialRequest.SubjectDN != null)
                    writer.WriteString("subjectDN", updateCompanyApiCredentialRequest.SubjectDN);
        }
    }
}
