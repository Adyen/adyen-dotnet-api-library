...
namespace Adyen.Management.Models
{
    ...
    public partial class AffirmInfo : IValidatableObject
    {
        ...
        [JsonConstructor]
        public AffirmInfo(string supportEmail)
        {
    ...
    public class AffirmInfoJsonConverter : JsonConverter<AffirmInfo>
    {
        ...
        public override AffirmInfo Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (supportEmail.IsSet && supportEmail.Value == null)
                throw new ArgumentNullException(nameof(supportEmail), "Property is not nullable for class AffirmInfo.");

            return new AffirmInfo(supportEmail.Value!);
        }
        ...
        public void WriteProperties(Utf8JsonWriter writer, AffirmInfo affirmInfo, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (affirmInfo.SupportEmail == null)
                throw new ArgumentNullException(nameof(affirmInfo.SupportEmail), "Property is required for class AffirmInfo.");
