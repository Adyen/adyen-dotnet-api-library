...
namespace Adyen.Management.Models
{
    ...
    /// </summary>
    [JsonConverter(typeof(ReleaseUpdateDetailsJsonConverter))]
    public partial class ReleaseUpdateDetails
    {
        /// <summary>
        ...
        {
            _TypeOption = TypeEnum.ReleaseUpdate;
            OnCreated();
        }
    ...
    public class ReleaseUpdateDetailsJsonConverter : JsonConverter<ReleaseUpdateDetails>
    {
        ...
        public override ReleaseUpdateDetails Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (updateAtFirstMaintenanceCall.IsSet)
                releaseUpdateDetails.UpdateAtFirstMaintenanceCall = updateAtFirstMaintenanceCall.Value;
            return releaseUpdateDetails;
        }
