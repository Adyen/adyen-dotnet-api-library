...
namespace Adyen.Management.Models
{
    ...
    public partial class ReleaseUpdateDetails : IValidatableObject
    {
        ...
        /// <summary>
        /// Used to track the state of UpdateAtFirstMaintenanceCall
        /// </summary>
        [JsonIgnore]
        [global::System.ComponentModel.EditorBrowsable(global::System.ComponentModel.EditorBrowsableState.Never)]
    ...
    public class ReleaseUpdateDetailsJsonConverter : JsonConverter<ReleaseUpdateDetails>
    {
        ...
        public override ReleaseUpdateDetails Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (type.IsSet && type.Value == null)
                throw new ArgumentNullException(nameof(type), "Property is not nullable for class ReleaseUpdateDetails.");

            if (updateAtFirstMaintenanceCall.IsSet && updateAtFirstMaintenanceCall.Value == null)
                throw new ArgumentNullException(nameof(updateAtFirstMaintenanceCall), "Property is not nullable for class ReleaseUpdateDetails.");
