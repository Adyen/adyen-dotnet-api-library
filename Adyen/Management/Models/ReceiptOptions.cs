    ...
    public class ReceiptOptionsJsonConverter : JsonConverter<ReceiptOptions>
    {
        ...
        public override ReceiptOptions Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (logo.IsSet && logo.Value == null)
                throw new ArgumentNullException(nameof(logo), "Property is not nullable for class ReceiptOptions.");

            if (promptBeforePrinting.IsSet && promptBeforePrinting.Value == null)
                throw new ArgumentNullException(nameof(promptBeforePrinting), "Property is not nullable for class ReceiptOptions.");

            if (qrCodeData.IsSet && qrCodeData.Value == null)
                throw new ArgumentNullException(nameof(qrCodeData), "Property is not nullable for class ReceiptOptions.");
        ...
        {
            /*
            if (receiptOptions._LogoOption.IsSet && receiptOptions.Logo == null)
                throw new ArgumentNullException(nameof(receiptOptions.Logo), "Property is required for class ReceiptOptions.");

            if (receiptOptions._QrCodeDataOption.IsSet && receiptOptions.QrCodeData == null)
                throw new ArgumentNullException(nameof(receiptOptions.QrCodeData), "Property is required for class ReceiptOptions.");
