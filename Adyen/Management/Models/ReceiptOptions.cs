...
namespace Adyen.Management.Models
{
    ...
    /// ReceiptOptions.
    /// </summary>
    [JsonConverter(typeof(ReceiptOptionsJsonConverter))]
    ...
    public class ReceiptOptionsJsonConverter : JsonConverter<ReceiptOptions>
    {
        ...
        public override ReceiptOptions Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (headerLine2.IsSet)
                receiptOptions.HeaderLine2 = headerLine2.Value;
            if (logo.IsSet)
                receiptOptions.Logo = logo.Value;
            if (promptBeforePrinting.IsSet)
                receiptOptions.PromptBeforePrinting = promptBeforePrinting.Value;
            if (qrCodeData.IsSet)
                receiptOptions.QrCodeData = qrCodeData.Value;
