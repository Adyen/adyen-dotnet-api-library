...
namespace Adyen.Management.Models
{
    ...
    public partial class ReceiptOptions
    {
        ...
        /// </summary>
        /// <param name="headerLine1">The text of the first header line to be shown on the receipt.</param>
        /// <param name="headerLine2">The text of the second header line to be shown on the receipt.</param>
        ...
        public ReceiptOptions(Option<string?> headerLine1 = default, Option<string?> headerLine2 = default, Option<string?> logo = default, Option<bool?> promptBeforePrinting = default, Option<string?> qrCodeData = default)
        {
            _HeaderLine1Option = headerLine1;
            _HeaderLine2Option = headerLine2;
            _LogoOption = logo;
        ...
        /// <summary>
        /// This is used to track if an optional field is set. If set, <see cref="HeaderLine1"/> will be populated.
        /// </summary>
        [JsonIgnore]
        [global::System.ComponentModel.EditorBrowsable(global::System.ComponentModel.EditorBrowsableState.Never)]
        public Option<string?> _HeaderLine1Option { get; private set; }

        /// <summary>
        /// The text of the first header line to be shown on the receipt.
        /// </summary>
        /// <value>The text of the first header line to be shown on the receipt.</value>
        [JsonPropertyName("headerLine1")]
        public string? HeaderLine1 { get { return this._HeaderLine1Option; } set { this._HeaderLine1Option = new(value); } }

        /// <summary>
        /// This is used to track if an optional field is set. If set, <see cref="HeaderLine2"/> will be populated.
        /// </summary>
        [JsonIgnore]
        [global::System.ComponentModel.EditorBrowsable(global::System.ComponentModel.EditorBrowsableState.Never)]
        public Option<string?> _HeaderLine2Option { get; private set; }

        /// <summary>
        /// The text of the second header line to be shown on the receipt.
        /// </summary>
        /// <value>The text of the second header line to be shown on the receipt.</value>
        [JsonPropertyName("headerLine2")]
        public string? HeaderLine2 { get { return this._HeaderLine2Option; } set { this._HeaderLine2Option = new(value); } }
        ...
        public override string ToString()
        {
            ...
            sb.Append("  HeaderLine1: ").Append(HeaderLine1).Append("\n");
            sb.Append("  HeaderLine2: ").Append(HeaderLine2).Append("\n");
    ...
    public class ReceiptOptionsJsonConverter : JsonConverter<ReceiptOptions>
    {
        ...
        public override ReceiptOptions Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            Option<string?> headerLine1 = default;
            Option<string?> headerLine2 = default;
            ...
            while (utf8JsonReader.Read())
            {
                ...
                if (utf8JsonReader.TokenType == JsonTokenType.PropertyName && currentDepth == utf8JsonReader.CurrentDepth - 1)
                {
                    ...
                    {
                        case "headerLine1":
                            headerLine1 = new Option<string?>(utf8JsonReader.GetString()!);
                            break;
                        case "headerLine2":
                            headerLine2 = new Option<string?>(utf8JsonReader.GetString()!);
                            break;
                        case "logo":
            ...
            return new ReceiptOptions(headerLine1, headerLine2, logo, promptBeforePrinting, qrCodeData);
        }
        ...
        public void WriteProperties(Utf8JsonWriter writer, ReceiptOptions receiptOptions, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (receiptOptions._HeaderLine1Option.IsSet)
                if (receiptOptions.HeaderLine1 != null)
                    writer.WriteString("headerLine1", receiptOptions.HeaderLine1);

            if (receiptOptions._HeaderLine2Option.IsSet)
                if (receiptOptions.HeaderLine2 != null)
                    writer.WriteString("headerLine2", receiptOptions.HeaderLine2);
