    ...
    public class MinorUnitsMonetaryValueJsonConverter : JsonConverter<MinorUnitsMonetaryValue>
    {
        ...
        public override MinorUnitsMonetaryValue Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (amount.IsSet && amount.Value == null)
                throw new ArgumentNullException(nameof(amount), "Property is not nullable for class MinorUnitsMonetaryValue.");

            if (currencyCode.IsSet && currencyCode.Value == null)
                throw new ArgumentNullException(nameof(currencyCode), "Property is not nullable for class MinorUnitsMonetaryValue.");
        ...
        {
            /*
            if (minorUnitsMonetaryValue._CurrencyCodeOption.IsSet && minorUnitsMonetaryValue.CurrencyCode == null)
                throw new ArgumentNullException(nameof(minorUnitsMonetaryValue.CurrencyCode), "Property is required for class MinorUnitsMonetaryValue.");
