...
namespace Adyen.Management.Models
{
    ...
    /// </summary>
    [JsonConverter(typeof(TerminalReassignmentTargetJsonConverter))]
    ...
    public class TerminalReassignmentTargetJsonConverter : JsonConverter<TerminalReassignmentTarget>
    {
        ...
        public override TerminalReassignmentTarget Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            var terminalReassignmentTarget = new TerminalReassignmentTarget();
            terminalReassignmentTarget.Inventory = inventory.Value!.Value;
            if (companyId.IsSet)
                terminalReassignmentTarget.CompanyId = companyId.Value;
            if (merchantId.IsSet)
                terminalReassignmentTarget.MerchantId = merchantId.Value;
            if (storeId.IsSet)
                terminalReassignmentTarget.StoreId = storeId.Value;
            return terminalReassignmentTarget;
        }
