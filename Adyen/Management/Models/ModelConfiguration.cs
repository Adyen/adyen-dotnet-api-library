    ...
    public class ModelConfigurationJsonConverter : JsonConverter<ModelConfiguration>
    {
        ...
        public override ModelConfiguration Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (brand.IsSet && brand.Value == null)
                throw new ArgumentNullException(nameof(brand), "Property is not nullable for class ModelConfiguration.");

            if (currencies.IsSet && currencies.Value == null)
                throw new ArgumentNullException(nameof(currencies), "Property is not nullable for class ModelConfiguration.");

            if (commercial.IsSet && commercial.Value == null)
                throw new ArgumentNullException(nameof(commercial), "Property is not nullable for class ModelConfiguration.");

            if (country.IsSet && country.Value == null)
                throw new ArgumentNullException(nameof(country), "Property is not nullable for class ModelConfiguration.");

            if (sources.IsSet && sources.Value == null)
                throw new ArgumentNullException(nameof(sources), "Property is not nullable for class ModelConfiguration.");
        ...
        public void WriteProperties(Utf8JsonWriter writer, ModelConfiguration modelConfiguration, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (modelConfiguration.Brand == null)
                throw new ArgumentNullException(nameof(modelConfiguration.Brand), "Property is required for class ModelConfiguration.");

            if (modelConfiguration.Currencies == null)
                throw new ArgumentNullException(nameof(modelConfiguration.Currencies), "Property is required for class ModelConfiguration.");

            if (modelConfiguration._CountryOption.IsSet && modelConfiguration.Country == null)
                throw new ArgumentNullException(nameof(modelConfiguration.Country), "Property is required for class ModelConfiguration.");

            if (modelConfiguration._SourcesOption.IsSet && modelConfiguration.Sources == null)
                throw new ArgumentNullException(nameof(modelConfiguration.Sources), "Property is required for class ModelConfiguration.");
