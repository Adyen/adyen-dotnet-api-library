...
namespace Adyen.Management.Models
{
    ...
    /// TerminalAssignment.
    /// </summary>
    public partial class TerminalAssignment : IValidatableObject
    {
        /// <summary>
    ...
    public class TerminalAssignmentJsonConverter : JsonConverter<TerminalAssignment>
    {
        ...
        public override TerminalAssignment Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (companyId.IsSet && companyId.Value == null)
                throw new ArgumentNullException(nameof(companyId), "Property is not nullable for class TerminalAssignment.");

            if (status.IsSet && status.Value == null)
                throw new ArgumentNullException(nameof(status), "Property is not nullable for class TerminalAssignment.");

            if (merchantId.IsSet && merchantId.Value == null)
                throw new ArgumentNullException(nameof(merchantId), "Property is not nullable for class TerminalAssignment.");

            if (reassignmentTarget.IsSet && reassignmentTarget.Value == null)
                throw new ArgumentNullException(nameof(reassignmentTarget), "Property is not nullable for class TerminalAssignment.");

            if (storeId.IsSet && storeId.Value == null)
                throw new ArgumentNullException(nameof(storeId), "Property is not nullable for class TerminalAssignment.");
        ...
        public void WriteProperties(Utf8JsonWriter writer, TerminalAssignment terminalAssignment, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (terminalAssignment.CompanyId == null)
                throw new ArgumentNullException(nameof(terminalAssignment.CompanyId), "Property is required for class TerminalAssignment.");

            if (terminalAssignment._MerchantIdOption.IsSet && terminalAssignment.MerchantId == null)
                throw new ArgumentNullException(nameof(terminalAssignment.MerchantId), "Property is required for class TerminalAssignment.");

            if (terminalAssignment._ReassignmentTargetOption.IsSet && terminalAssignment.ReassignmentTarget == null)
                throw new ArgumentNullException(nameof(terminalAssignment.ReassignmentTarget), "Property is required for class TerminalAssignment.");

            if (terminalAssignment._StoreIdOption.IsSet && terminalAssignment.StoreId == null)
                throw new ArgumentNullException(nameof(terminalAssignment.StoreId), "Property is required for class TerminalAssignment.");
