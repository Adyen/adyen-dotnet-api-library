...
namespace Adyen.Management.Models
{
    ...
    /// TerminalAssignment.
    /// </summary>
    [JsonConverter(typeof(TerminalAssignmentJsonConverter))]
    ...
    public class TerminalAssignmentJsonConverter : JsonConverter<TerminalAssignment>
    {
        ...
        public override TerminalAssignment Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (reassignmentTarget.IsSet)
                terminalAssignment.ReassignmentTarget = reassignmentTarget.Value;
            if (storeId.IsSet)
                terminalAssignment.StoreId = storeId.Value;
