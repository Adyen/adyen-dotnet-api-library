...
namespace Adyen.Management.Models
{
    ...
    public class TerminalSettingsJsonConverter : JsonConverter<TerminalSettings>
    {
        ...
        public override TerminalSettings Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            return new TerminalSettings(cardholderReceipt, connectivity, dcc, gratuities, hardware, homeScreen, kioskMode, localization, moto, nexo, offlineProcessing, opi, passcodes, payAtTable, payment, receiptOptions, receiptPrinting, refunds, signature, standalone, storeAndForward, surcharge, tapToPay, terminalInstructions, timeouts, wifiProfiles);
        }
