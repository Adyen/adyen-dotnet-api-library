...
namespace Adyen.Management.Models
{
    ...
    public class PaymentJsonConverter : JsonConverter<Payment>
    {
        ...
        public override Payment Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (contactlessCurrency.IsSet && contactlessCurrency.Value == null)
                throw new ArgumentNullException(nameof(contactlessCurrency), "Property is not nullable for class Payment.");

            if (hideMinorUnitsInCurrencies.IsSet && hideMinorUnitsInCurrencies.Value == null)
                throw new ArgumentNullException(nameof(hideMinorUnitsInCurrencies), "Property is not nullable for class Payment.");
        ...
        {
            /*
            if (payment._ContactlessCurrencyOption.IsSet && payment.ContactlessCurrency == null)
                throw new ArgumentNullException(nameof(payment.ContactlessCurrency), "Property is required for class Payment.");

            if (payment._HideMinorUnitsInCurrenciesOption.IsSet && payment.HideMinorUnitsInCurrencies == null)
                throw new ArgumentNullException(nameof(payment.HideMinorUnitsInCurrencies), "Property is required for class Payment.");
