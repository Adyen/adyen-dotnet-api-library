    ...
    public class ProfileJsonConverter : JsonConverter<Profile>
    {
        ...
        public override Profile Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (authType.IsSet && authType.Value == null)
                throw new ArgumentNullException(nameof(authType), "Property is not nullable for class Profile.");

            if (bssType.IsSet && bssType.Value == null)
                throw new ArgumentNullException(nameof(bssType), "Property is not nullable for class Profile.");

            if (ssid.IsSet && ssid.Value == null)
                throw new ArgumentNullException(nameof(ssid), "Property is not nullable for class Profile.");

            if (wsec.IsSet && wsec.Value == null)
                throw new ArgumentNullException(nameof(wsec), "Property is not nullable for class Profile.");

            if (autoWifi.IsSet && autoWifi.Value == null)
                throw new ArgumentNullException(nameof(autoWifi), "Property is not nullable for class Profile.");

            if (channel.IsSet && channel.Value == null)
                throw new ArgumentNullException(nameof(channel), "Property is not nullable for class Profile.");

            if (defaultProfile.IsSet && defaultProfile.Value == null)
                throw new ArgumentNullException(nameof(defaultProfile), "Property is not nullable for class Profile.");

            if (domainSuffix.IsSet && domainSuffix.Value == null)
                throw new ArgumentNullException(nameof(domainSuffix), "Property is not nullable for class Profile.");

            if (eap.IsSet && eap.Value == null)
                throw new ArgumentNullException(nameof(eap), "Property is not nullable for class Profile.");

            if (eapCaCert.IsSet && eapCaCert.Value == null)
                throw new ArgumentNullException(nameof(eapCaCert), "Property is not nullable for class Profile.");

            if (eapClientCert.IsSet && eapClientCert.Value == null)
                throw new ArgumentNullException(nameof(eapClientCert), "Property is not nullable for class Profile.");

            if (eapClientKey.IsSet && eapClientKey.Value == null)
                throw new ArgumentNullException(nameof(eapClientKey), "Property is not nullable for class Profile.");

            if (eapClientPwd.IsSet && eapClientPwd.Value == null)
                throw new ArgumentNullException(nameof(eapClientPwd), "Property is not nullable for class Profile.");

            if (eapIdentity.IsSet && eapIdentity.Value == null)
                throw new ArgumentNullException(nameof(eapIdentity), "Property is not nullable for class Profile.");

            if (eapIntermediateCert.IsSet && eapIntermediateCert.Value == null)
                throw new ArgumentNullException(nameof(eapIntermediateCert), "Property is not nullable for class Profile.");

            if (eapPwd.IsSet && eapPwd.Value == null)
                throw new ArgumentNullException(nameof(eapPwd), "Property is not nullable for class Profile.");

            if (hiddenSsid.IsSet && hiddenSsid.Value == null)
                throw new ArgumentNullException(nameof(hiddenSsid), "Property is not nullable for class Profile.");

            if (name.IsSet && name.Value == null)
                throw new ArgumentNullException(nameof(name), "Property is not nullable for class Profile.");

            if (psk.IsSet && psk.Value == null)
                throw new ArgumentNullException(nameof(psk), "Property is not nullable for class Profile.");
        ...
        public void WriteProperties(Utf8JsonWriter writer, Profile profile, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (profile.AuthType == null)
                throw new ArgumentNullException(nameof(profile.AuthType), "Property is required for class Profile.");

            if (profile.BssType == null)
                throw new ArgumentNullException(nameof(profile.BssType), "Property is required for class Profile.");

            if (profile.Ssid == null)
                throw new ArgumentNullException(nameof(profile.Ssid), "Property is required for class Profile.");

            if (profile.Wsec == null)
                throw new ArgumentNullException(nameof(profile.Wsec), "Property is required for class Profile.");

            if (profile._DomainSuffixOption.IsSet && profile.DomainSuffix == null)
                throw new ArgumentNullException(nameof(profile.DomainSuffix), "Property is required for class Profile.");

            if (profile._EapOption.IsSet && profile.Eap == null)
                throw new ArgumentNullException(nameof(profile.Eap), "Property is required for class Profile.");

            if (profile._EapCaCertOption.IsSet && profile.EapCaCert == null)
                throw new ArgumentNullException(nameof(profile.EapCaCert), "Property is required for class Profile.");

            if (profile._EapClientCertOption.IsSet && profile.EapClientCert == null)
                throw new ArgumentNullException(nameof(profile.EapClientCert), "Property is required for class Profile.");

            if (profile._EapClientKeyOption.IsSet && profile.EapClientKey == null)
                throw new ArgumentNullException(nameof(profile.EapClientKey), "Property is required for class Profile.");

            if (profile._EapClientPwdOption.IsSet && profile.EapClientPwd == null)
                throw new ArgumentNullException(nameof(profile.EapClientPwd), "Property is required for class Profile.");

            if (profile._EapIdentityOption.IsSet && profile.EapIdentity == null)
                throw new ArgumentNullException(nameof(profile.EapIdentity), "Property is required for class Profile.");

            if (profile._EapIntermediateCertOption.IsSet && profile.EapIntermediateCert == null)
                throw new ArgumentNullException(nameof(profile.EapIntermediateCert), "Property is required for class Profile.");

            if (profile._EapPwdOption.IsSet && profile.EapPwd == null)
                throw new ArgumentNullException(nameof(profile.EapPwd), "Property is required for class Profile.");

            if (profile._NameOption.IsSet && profile.Name == null)
                throw new ArgumentNullException(nameof(profile.Name), "Property is required for class Profile.");

            if (profile._PskOption.IsSet && profile.Psk == null)
                throw new ArgumentNullException(nameof(profile.Psk), "Property is required for class Profile.");
