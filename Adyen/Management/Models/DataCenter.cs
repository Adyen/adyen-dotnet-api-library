...
namespace Adyen.Management.Models
{
    ...
    public class DataCenterJsonConverter : JsonConverter<DataCenter>
    {
        ...
        public override DataCenter Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (livePrefix.IsSet && livePrefix.Value == null)
                throw new ArgumentNullException(nameof(livePrefix), "Property is not nullable for class DataCenter.");
        ...
        {
            /*
            if (dataCenter._LivePrefixOption.IsSet && dataCenter.LivePrefix == null)
                throw new ArgumentNullException(nameof(dataCenter.LivePrefix), "Property is required for class DataCenter.");

            if (dataCenter._NameOption.IsSet && dataCenter.Name == null)
