...
namespace Adyen.Management.Models
{
    ...
    /// StarInfo.
    /// </summary>
    public partial class StarInfo : IValidatableObject
    {
        /// <summary>
        ...
        [JsonConstructor]
        public StarInfo(ProcessingTypeEnum processingType, Option<TransactionDescriptionInfo?> transactionDescription = default)
        {
    ...
    /// <summary>
    /// A Json converter for type <see cref="StarInfo" />
    /// </summary>
    public class StarInfoJsonConverter : JsonConverter<StarInfo>
    {
        /// <summary>
        /// Deserializes json to <see cref="StarInfo"/>.
        /// </summary>
        /// <param name="utf8JsonReader"><see cref="Utf8JsonReader"/></param>
        /// <param name="typeToConvert"><see cref="Type"/></param>
        /// <param name="jsonSerializerOptions">The <see cref="JsonSerializerOptions"/>, initialized from <see cref="HostConfiguration"/>.</param>
        /// <returns><see cref="StarInfo"/></returns>
        /// <exception cref="JsonException"></exception>
        public override StarInfo Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            Option<StarInfo.ProcessingTypeEnum?> processingType = default;
            ...
            if (processingType.IsSet && processingType.Value == null)
                throw new ArgumentNullException(nameof(processingType), "Property is not nullable for class StarInfo.");

            if (transactionDescription.IsSet && transactionDescription.Value == null)
                throw new ArgumentNullException(nameof(transactionDescription), "Property is not nullable for class StarInfo.");

            return new StarInfo(processingType.Value!.Value!, transactionDescription);
        }

        /// <summary>
        /// Serializes a <see cref="StarInfo"/>.
        /// </summary>
        /// <param name="writer"><see cref="Utf8JsonWriter"/></param>
        /// <param name="starInfo"></param>
        /// <param name="jsonSerializerOptions"><see cref="JsonSerializerOptions"/></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, StarInfo starInfo, JsonSerializerOptions jsonSerializerOptions)
        {
            
            writer.WriteStartObject();
            
            WriteProperties(writer, starInfo, jsonSerializerOptions);
        ...
        /// <summary>
        /// Serializes the properties of <see cref="StarInfo"/>.
        /// </summary>
        /// <param name="writer"><see creft="Utf8JsonWriter"/></param>
        /// <param name="starInfo"></param>
        /// <param name="jsonSerializerOptions"><see cref="JsonSerializerOptions"/></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, StarInfo starInfo, JsonSerializerOptions jsonSerializerOptions)
        {
            /*
            if (starInfo._TransactionDescriptionOption.IsSet && starInfo.TransactionDescription == null)
                throw new ArgumentNullException(nameof(starInfo.TransactionDescription), "Property is required for class StarInfo.");

            */
            
            if (starInfo.ProcessingType != null) 
            {
                string? processingTypeRawValue = StarInfo.ProcessingTypeEnum.ToJsonValue(starInfo.ProcessingType);
                writer.WriteString("processingType", processingTypeRawValue);
            }
            
            if (starInfo._TransactionDescriptionOption.IsSet)
            {
                writer.WritePropertyName("transactionDescription");
                JsonSerializer.Serialize(writer, starInfo.TransactionDescription, jsonSerializerOptions);
            }
        }
    }
}
