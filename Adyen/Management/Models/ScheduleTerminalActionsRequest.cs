...
namespace Adyen.Management.Models
{
    ...
    /// </summary>
    [JsonConverter(typeof(ScheduleTerminalActionsRequestJsonConverter))]
    ...
    public class ScheduleTerminalActionsRequestJsonConverter : JsonConverter<ScheduleTerminalActionsRequest>
    {
        ...
        public override ScheduleTerminalActionsRequest Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (scheduledAt.IsSet)
                scheduleTerminalActionsRequest.ScheduledAt = scheduledAt.Value;
            if (storeId.IsSet)
                scheduleTerminalActionsRequest.StoreId = storeId.Value;
            if (terminalIds.IsSet)
                scheduleTerminalActionsRequest.TerminalIds = terminalIds.Value;
            return scheduleTerminalActionsRequest;
        }
