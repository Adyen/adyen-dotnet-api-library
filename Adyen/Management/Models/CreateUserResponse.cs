...
namespace Adyen.Management.Models
{
    ...
    public class CreateUserResponseJsonConverter : JsonConverter<CreateUserResponse>
    {
        ...
        public override CreateUserResponse Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (email.IsSet)
                createUserResponse.Email = email.Value!;
            if (id.IsSet)
                createUserResponse.Id = id.Value!;
            if (roles.IsSet)
                createUserResponse.Roles = roles.Value!;
            if (timeZoneCode.IsSet)
                createUserResponse.TimeZoneCode = timeZoneCode.Value!;
            if (username.IsSet)
                createUserResponse.Username = username.Value!;
            if (links.IsSet)
                createUserResponse.Links = links.Value;
            if (accountGroups.IsSet)
                createUserResponse.AccountGroups = accountGroups.Value;
            if (active.IsSet)
                createUserResponse.Active = active.Value;
            if (apps.IsSet)
                createUserResponse.Apps = apps.Value;
            if (name.IsSet)
                createUserResponse.Name = name.Value;
        ...
        public void WriteProperties(Utf8JsonWriter writer, CreateUserResponse createUserResponse, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (createUserResponse._ActiveOption.IsSet)
                if (createUserResponse._ActiveOption.Value != null)
