    ...
    public class TerminalJsonConverter : JsonConverter<Terminal>
    {
        ...
        public override Terminal Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (assignment.IsSet && assignment.Value == null)
                throw new ArgumentNullException(nameof(assignment), "Property is not nullable for class Terminal.");

            if (connectivity.IsSet && connectivity.Value == null)
                throw new ArgumentNullException(nameof(connectivity), "Property is not nullable for class Terminal.");

            if (firmwareVersion.IsSet && firmwareVersion.Value == null)
                throw new ArgumentNullException(nameof(firmwareVersion), "Property is not nullable for class Terminal.");

            if (id.IsSet && id.Value == null)
                throw new ArgumentNullException(nameof(id), "Property is not nullable for class Terminal.");

            if (lastActivityAt.IsSet && lastActivityAt.Value == null)
                throw new ArgumentNullException(nameof(lastActivityAt), "Property is not nullable for class Terminal.");

            if (lastTransactionAt.IsSet && lastTransactionAt.Value == null)
                throw new ArgumentNullException(nameof(lastTransactionAt), "Property is not nullable for class Terminal.");

            if (model.IsSet && model.Value == null)
                throw new ArgumentNullException(nameof(model), "Property is not nullable for class Terminal.");

            if (restartLocalTime.IsSet && restartLocalTime.Value == null)
                throw new ArgumentNullException(nameof(restartLocalTime), "Property is not nullable for class Terminal.");

            if (serialNumber.IsSet && serialNumber.Value == null)
                throw new ArgumentNullException(nameof(serialNumber), "Property is not nullable for class Terminal.");
        ...
        {
            /*
            if (terminal._AssignmentOption.IsSet && terminal.Assignment == null)
                throw new ArgumentNullException(nameof(terminal.Assignment), "Property is required for class Terminal.");

            if (terminal._ConnectivityOption.IsSet && terminal.Connectivity == null)
                throw new ArgumentNullException(nameof(terminal.Connectivity), "Property is required for class Terminal.");

            if (terminal._FirmwareVersionOption.IsSet && terminal.FirmwareVersion == null)
                throw new ArgumentNullException(nameof(terminal.FirmwareVersion), "Property is required for class Terminal.");

            if (terminal._IdOption.IsSet && terminal.Id == null)
                throw new ArgumentNullException(nameof(terminal.Id), "Property is required for class Terminal.");

            if (terminal._ModelOption.IsSet && terminal.Model == null)
                throw new ArgumentNullException(nameof(terminal.Model), "Property is required for class Terminal.");

            if (terminal._RestartLocalTimeOption.IsSet && terminal.RestartLocalTime == null)
                throw new ArgumentNullException(nameof(terminal.RestartLocalTime), "Property is required for class Terminal.");

            if (terminal._SerialNumberOption.IsSet && terminal.SerialNumber == null)
                throw new ArgumentNullException(nameof(terminal.SerialNumber), "Property is required for class Terminal.");
