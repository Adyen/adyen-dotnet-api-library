...
namespace Adyen.Management.Models
{
    ...
    public partial class Terminal
    {
        ...
        /// <param name="cloudDeviceApiEndpoint">The [regional base URL](https://docs.adyen.com/api-explorer/terminal-api/1/overview#endpoints-for-cloud-communications) to use for sending Terminal API requests when using cloud communications.</param>
        ...
        public Terminal(Option<TerminalAssignment?> assignment = default, Option<string?> cloudDeviceApiEndpoint = default, Option<TerminalConnectivity?> connectivity = default, Option<string?> countryCode = default, Option<string?> firmwareVersion = default, Option<string?> id = default, Option<List<InstalledAPKs>?> installedAPKs = default, Option<DateTimeOffset?> lastActivityAt = default, Option<DateTimeOffset?> lastTransactionAt = default, Option<string?> model = default, Option<string?> restartLocalTime = default, Option<string?> serialNumber = default)
        {
            _AssignmentOption = assignment;
            _CloudDeviceApiEndpointOption = cloudDeviceApiEndpoint;
    ...
    public class TerminalJsonConverter : JsonConverter<Terminal>
    {
        ...
        public override Terminal Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            return new Terminal(assignment, cloudDeviceApiEndpoint, connectivity, countryCode, firmwareVersion, id, installedAPKs, lastActivityAt, lastTransactionAt, model, restartLocalTime, serialNumber);
        }
