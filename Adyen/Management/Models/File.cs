    ...
    public class FileJsonConverter : JsonConverter<File>
    {
        ...
        public override File Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (data.IsSet && data.Value == null)
                throw new ArgumentNullException(nameof(data), "Property is not nullable for class File.");

            if (name.IsSet && name.Value == null)
                throw new ArgumentNullException(nameof(name), "Property is not nullable for class File.");
        ...
        public void WriteProperties(Utf8JsonWriter writer, File file, JsonSerializerOptions jsonSerializerOptions)
        {
            /*
            if (file.Data == null)
                throw new ArgumentNullException(nameof(file.Data), "Property is required for class File.");

            if (file.Name == null)
                throw new ArgumentNullException(nameof(file.Name), "Property is required for class File.");
