...
namespace Adyen.Management.Models
{
    ...
    /// </summary>
    [JsonConverter(typeof(CreateCompanyUserResponseJsonConverter))]
    ...
    public class CreateCompanyUserResponseJsonConverter : JsonConverter<CreateCompanyUserResponse>
    {
        ...
        public override CreateCompanyUserResponse Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            var createCompanyUserResponse = new CreateCompanyUserResponse();
            createCompanyUserResponse.Email = email.Value!;
            createCompanyUserResponse.Id = id.Value!;
            createCompanyUserResponse.Roles = roles.Value!;
            createCompanyUserResponse.TimeZoneCode = timeZoneCode.Value!;
            createCompanyUserResponse.Username = username.Value!;
            if (links.IsSet)
                createCompanyUserResponse.Links = links.Value;
            if (accountGroups.IsSet)
                createCompanyUserResponse.AccountGroups = accountGroups.Value;
            if (active.IsSet)
                createCompanyUserResponse.Active = active.Value;
            if (apps.IsSet)
                createCompanyUserResponse.Apps = apps.Value;
            if (associatedMerchantAccounts.IsSet)
                createCompanyUserResponse.AssociatedMerchantAccounts = associatedMerchantAccounts.Value;
            if (name.IsSet)
                createCompanyUserResponse.Name = name.Value;
        ...
        public void WriteProperties(Utf8JsonWriter writer, CreateCompanyUserResponse createCompanyUserResponse, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (createCompanyUserResponse._ActiveOption.IsSet)
                if (createCompanyUserResponse._ActiveOption.Value != null)
