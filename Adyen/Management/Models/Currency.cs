    ...
    public class CurrencyJsonConverter : JsonConverter<Currency>
    {
        ...
        public override Currency Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (currencyCode.IsSet && currencyCode.Value == null)
                throw new ArgumentNullException(nameof(currencyCode), "Property is not nullable for class Currency.");

            if (amount.IsSet && amount.Value == null)
                throw new ArgumentNullException(nameof(amount), "Property is not nullable for class Currency.");

            if (maxAmount.IsSet && maxAmount.Value == null)
                throw new ArgumentNullException(nameof(maxAmount), "Property is not nullable for class Currency.");

            if (percentage.IsSet && percentage.Value == null)
                throw new ArgumentNullException(nameof(percentage), "Property is not nullable for class Currency.");
        ...
        public void WriteProperties(Utf8JsonWriter writer, Currency currency, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (currency.CurrencyCode == null)
                throw new ArgumentNullException(nameof(currency.CurrencyCode), "Property is required for class Currency.");
