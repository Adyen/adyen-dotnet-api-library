    ...
    public class PayPalInfoJsonConverter : JsonConverter<PayPalInfo>
    {
        ...
        public override PayPalInfo Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (payerId.IsSet && payerId.Value == null)
                throw new ArgumentNullException(nameof(payerId), "Property is not nullable for class PayPalInfo.");

            if (subject.IsSet && subject.Value == null)
                throw new ArgumentNullException(nameof(subject), "Property is not nullable for class PayPalInfo.");

            if (directCapture.IsSet && directCapture.Value == null)
                throw new ArgumentNullException(nameof(directCapture), "Property is not nullable for class PayPalInfo.");
        ...
        public void WriteProperties(Utf8JsonWriter writer, PayPalInfo payPalInfo, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (payPalInfo.PayerId == null)
                throw new ArgumentNullException(nameof(payPalInfo.PayerId), "Property is required for class PayPalInfo.");

            if (payPalInfo.Subject == null)
                throw new ArgumentNullException(nameof(payPalInfo.Subject), "Property is required for class PayPalInfo.");
