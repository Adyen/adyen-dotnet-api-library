...
namespace Adyen.Management.Models
{
    ...
    /// NyceResponseInfo.
    /// </summary>
    public partial class NyceResponseInfo
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="NyceResponseInfo" /> class.
        /// </summary>
        ...
        public NyceResponseInfo(ProcessingTypeEnum processingType, Option<TransactionDescriptionResponseInfo?> transactionDescription = default)
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class NyceResponseInfo {\n");
    ...
    /// <summary>
    /// A Json converter for type <see cref="NyceResponseInfo" />
    /// </summary>
    public class NyceResponseInfoJsonConverter : JsonConverter<NyceResponseInfo>
    {
        /// <summary>
        /// Deserializes json to <see cref="NyceResponseInfo"/>.
        /// </summary>
        /// <param name="utf8JsonReader"><see cref="Utf8JsonReader"/>.</param>
        /// <param name="typeToConvert"><see cref="Type"/>.</param>
        /// <param name="jsonSerializerOptions">The <see cref="JsonSerializerOptions"/>, initialized from <see cref="HostConfiguration"/>.</param>
        /// <returns><see cref="NyceResponseInfo"/>.</returns>
        /// <exception cref="JsonException"></exception>
        public override NyceResponseInfo Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            Option<NyceResponseInfo.ProcessingTypeEnum?> processingType = default;
                ...
                if (utf8JsonReader.TokenType == JsonTokenType.PropertyName && currentDepth == utf8JsonReader.CurrentDepth - 1)
                {
                    ...
                    switch (jsonPropertyName)
                    {
                        case "processingType":
                            ...
                            processingType = new Option<NyceResponseInfo.ProcessingTypeEnum?>(NyceResponseInfo.ProcessingTypeEnum.FromStringOrDefault(processingTypeRawValue));
                            break;
            ...
            return new NyceResponseInfo(processingType.Value!.Value!, transactionDescription);
        }

        /// <summary>
        /// Serializes a <see cref="NyceResponseInfo"/>.
        /// </summary>
        /// <param name="writer"><see cref="Utf8JsonWriter"/></param>
        /// <param name="nyceResponseInfo"></param>
        /// <param name="jsonSerializerOptions"><see cref="JsonSerializerOptions"/></param>
        public override void Write(Utf8JsonWriter writer, NyceResponseInfo nyceResponseInfo, JsonSerializerOptions jsonSerializerOptions)
        {
            
            writer.WriteStartObject();
            
            WriteProperties(writer, nyceResponseInfo, jsonSerializerOptions);
        ...
        /// <summary>
        /// Serializes the properties of <see cref="NyceResponseInfo"/>.
        /// </summary>
        /// <param name="writer"><see cref="Utf8JsonWriter"/></param>
        /// <param name="nyceResponseInfo"></param>
        /// <param name="jsonSerializerOptions"><see cref="JsonSerializerOptions"/></param>
        public void WriteProperties(Utf8JsonWriter writer, NyceResponseInfo nyceResponseInfo, JsonSerializerOptions jsonSerializerOptions)
        {
            
            if (nyceResponseInfo.ProcessingType != null) 
            {
                string? processingTypeRawValue = NyceResponseInfo.ProcessingTypeEnum.ToJsonValue(nyceResponseInfo.ProcessingType);
                writer.WriteString("processingType", processingTypeRawValue);
            }
            
            if (nyceResponseInfo._TransactionDescriptionOption.IsSet)
            {
                writer.WritePropertyName("transactionDescription");
                JsonSerializer.Serialize(writer, nyceResponseInfo.TransactionDescription, jsonSerializerOptions);
            }
        }
    }
}
