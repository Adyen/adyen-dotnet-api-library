    ...
    public class SofortInfoJsonConverter : JsonConverter<SofortInfo>
    {
        ...
        public override SofortInfo Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (currencyCode.IsSet && currencyCode.Value == null)
                throw new ArgumentNullException(nameof(currencyCode), "Property is not nullable for class SofortInfo.");

            if (logo.IsSet && logo.Value == null)
                throw new ArgumentNullException(nameof(logo), "Property is not nullable for class SofortInfo.");
        ...
        public void WriteProperties(Utf8JsonWriter writer, SofortInfo sofortInfo, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (sofortInfo.CurrencyCode == null)
                throw new ArgumentNullException(nameof(sofortInfo.CurrencyCode), "Property is required for class SofortInfo.");

            if (sofortInfo.Logo == null)
                throw new ArgumentNullException(nameof(sofortInfo.Logo), "Property is required for class SofortInfo.");
