...
namespace Adyen.Management.Models
{
    ...
    public partial class TransactionDescriptionResponseInfo
    {
        ...
        public TransactionDescriptionResponseInfo(Option<string?> doingBusinessAsName = default, Option<TypeEnum?> type = default)
        {
    ...
    public class TransactionDescriptionResponseInfoJsonConverter : JsonConverter<TransactionDescriptionResponseInfo>
    {
        ...
        public override TransactionDescriptionResponseInfo Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            return new TransactionDescriptionResponseInfo(doingBusinessAsName, type);
        }
