...
namespace Adyen.Management.Models
{
    ...
    /// </summary>
    public partial class UpdatePayoutSettingsRequest : IValidatableObject
    {
        /// <summary>
    ...
    public class UpdatePayoutSettingsRequestJsonConverter : JsonConverter<UpdatePayoutSettingsRequest>
    {
        ...
        public override UpdatePayoutSettingsRequest Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (enabled.IsSet && enabled.Value == null)
                throw new ArgumentNullException(nameof(enabled), "Property is not nullable for class UpdatePayoutSettingsRequest.");

            return new UpdatePayoutSettingsRequest(enabled);
        }
