...
namespace Adyen.Management.Models
{
    ...
    /// </summary>
    [JsonConverter(typeof(UpdatePayoutSettingsRequestJsonConverter))]
    public partial class UpdatePayoutSettingsRequest
    {
        /// <summary>
    ...
    /// <summary>
    /// A Json converter for type <see cref="UpdatePayoutSettingsRequest" />
    /// </summary>
    public class UpdatePayoutSettingsRequestJsonConverter : JsonConverter<UpdatePayoutSettingsRequest>
    {
        /// <summary>
        /// Deserializes json to <see cref="UpdatePayoutSettingsRequest"/>.
        /// </summary>
        /// <param name="utf8JsonReader"><see cref="Utf8JsonReader"/>.</param>
        /// <param name="typeToConvert"><see cref="Type"/>.</param>
        /// <param name="jsonSerializerOptions">The <see cref="JsonSerializerOptions"/>, initialized from <see cref="HostConfiguration"/>.</param>
        /// <returns><see cref="UpdatePayoutSettingsRequest"/>.</returns>
        /// <exception cref="JsonException"></exception>
        public override UpdatePayoutSettingsRequest Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            var updatePayoutSettingsRequest = new UpdatePayoutSettingsRequest();
            if (enabled.IsSet)
                updatePayoutSettingsRequest.Enabled = enabled.Value;
            return updatePayoutSettingsRequest;
        }

        /// <summary>
        /// Serializes a <see cref="UpdatePayoutSettingsRequest"/>.
        /// </summary>
        ...
        public override void Write(Utf8JsonWriter writer, UpdatePayoutSettingsRequest updatePayoutSettingsRequest, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            WriteProperties(writer, updatePayoutSettingsRequest, jsonSerializerOptions);
        ...
        /// <summary>
        /// Serializes the properties of <see cref="UpdatePayoutSettingsRequest"/>.
        /// </summary>
        /// <param name="writer"><see cref="Utf8JsonWriter"/></param>
        /// <param name="updatePayoutSettingsRequest"></param>
        /// <param name="jsonSerializerOptions"><see cref="JsonSerializerOptions"/></param>
