    ...
    public class ExternalTerminalActionJsonConverter : JsonConverter<ExternalTerminalAction>
    {
        ...
        public override ExternalTerminalAction Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (actionType.IsSet && actionType.Value == null)
                throw new ArgumentNullException(nameof(actionType), "Property is not nullable for class ExternalTerminalAction.");

            if (config.IsSet && config.Value == null)
                throw new ArgumentNullException(nameof(config), "Property is not nullable for class ExternalTerminalAction.");

            if (confirmedAt.IsSet && confirmedAt.Value == null)
                throw new ArgumentNullException(nameof(confirmedAt), "Property is not nullable for class ExternalTerminalAction.");

            if (id.IsSet && id.Value == null)
                throw new ArgumentNullException(nameof(id), "Property is not nullable for class ExternalTerminalAction.");

            if (result.IsSet && result.Value == null)
                throw new ArgumentNullException(nameof(result), "Property is not nullable for class ExternalTerminalAction.");

            if (scheduledAt.IsSet && scheduledAt.Value == null)
                throw new ArgumentNullException(nameof(scheduledAt), "Property is not nullable for class ExternalTerminalAction.");

            if (status.IsSet && status.Value == null)
                throw new ArgumentNullException(nameof(status), "Property is not nullable for class ExternalTerminalAction.");

            if (terminalId.IsSet && terminalId.Value == null)
                throw new ArgumentNullException(nameof(terminalId), "Property is not nullable for class ExternalTerminalAction.");
        ...
        {
            /*
            if (externalTerminalAction._ActionTypeOption.IsSet && externalTerminalAction.ActionType == null)
                throw new ArgumentNullException(nameof(externalTerminalAction.ActionType), "Property is required for class ExternalTerminalAction.");

            if (externalTerminalAction._ConfigOption.IsSet && externalTerminalAction.Config == null)
                throw new ArgumentNullException(nameof(externalTerminalAction.Config), "Property is required for class ExternalTerminalAction.");

            if (externalTerminalAction._IdOption.IsSet && externalTerminalAction.Id == null)
                throw new ArgumentNullException(nameof(externalTerminalAction.Id), "Property is required for class ExternalTerminalAction.");

            if (externalTerminalAction._ResultOption.IsSet && externalTerminalAction.Result == null)
                throw new ArgumentNullException(nameof(externalTerminalAction.Result), "Property is required for class ExternalTerminalAction.");

            if (externalTerminalAction._StatusOption.IsSet && externalTerminalAction.Status == null)
                throw new ArgumentNullException(nameof(externalTerminalAction.Status), "Property is required for class ExternalTerminalAction.");

            if (externalTerminalAction._TerminalIdOption.IsSet && externalTerminalAction.TerminalId == null)
                throw new ArgumentNullException(nameof(externalTerminalAction.TerminalId), "Property is required for class ExternalTerminalAction.");
