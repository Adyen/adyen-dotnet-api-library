...
namespace Adyen.Management.Models
{
    ...
    /// </summary>
    [JsonConverter(typeof(CreateCompanyApiCredentialRequestJsonConverter))]
    public partial class CreateCompanyApiCredentialRequest
    {
        /// <summary>
    ...
    public class CreateCompanyApiCredentialRequestJsonConverter : JsonConverter<CreateCompanyApiCredentialRequest>
    {
        ...
        public override CreateCompanyApiCredentialRequest Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            var createCompanyApiCredentialRequest = new CreateCompanyApiCredentialRequest();
            if (allowedOrigins.IsSet)
                createCompanyApiCredentialRequest.AllowedOrigins = allowedOrigins.Value;
            if (associatedMerchantAccounts.IsSet)
                createCompanyApiCredentialRequest.AssociatedMerchantAccounts = associatedMerchantAccounts.Value;
            if (description.IsSet)
                createCompanyApiCredentialRequest.Description = description.Value;
            if (roles.IsSet)
                createCompanyApiCredentialRequest.Roles = roles.Value;
            return createCompanyApiCredentialRequest;
        }
