...
namespace Adyen.Management.Models
{
    ...
    /// </summary>
    [JsonConverter(typeof(UpdateCompanyUserRequestJsonConverter))]
    public partial class UpdateCompanyUserRequest
    {
        /// <summary>
        ...
        /// </summary>
        /// <value>The requested login method for the user. To use SSO, you must already have SSO configured with Adyen before creating the user.  Possible values: **Email** or **SSO** </value>
    ...
    public class UpdateCompanyUserRequestJsonConverter : JsonConverter<UpdateCompanyUserRequest>
    {
        ...
        public override UpdateCompanyUserRequest Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (active.IsSet)
                updateCompanyUserRequest.Active = active.Value;
            if (associatedMerchantAccounts.IsSet)
                updateCompanyUserRequest.AssociatedMerchantAccounts = associatedMerchantAccounts.Value;
            if (email.IsSet)
                updateCompanyUserRequest.Email = email.Value;
            if (loginMethod.IsSet)
                updateCompanyUserRequest.LoginMethod = loginMethod.Value;
            if (name.IsSet)
                updateCompanyUserRequest.Name = name.Value;
            if (roles.IsSet)
                updateCompanyUserRequest.Roles = roles.Value;
            if (timeZoneCode.IsSet)
                updateCompanyUserRequest.TimeZoneCode = timeZoneCode.Value;
        ...
        public void WriteProperties(Utf8JsonWriter writer, UpdateCompanyUserRequest updateCompanyUserRequest, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (updateCompanyUserRequest._TimeZoneCodeOption.IsSet)
                if (updateCompanyUserRequest.TimeZoneCode != null)
