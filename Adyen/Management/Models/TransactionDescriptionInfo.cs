...
namespace Adyen.Management.Models
{
    ...
    /// </summary>
    [JsonConverter(typeof(TransactionDescriptionInfoJsonConverter))]
    ...
    public class TransactionDescriptionInfoJsonConverter : JsonConverter<TransactionDescriptionInfo>
    {
        ...
        public override TransactionDescriptionInfo Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
                ...
                if (utf8JsonReader.TokenType == JsonTokenType.PropertyName && currentDepth == utf8JsonReader.CurrentDepth - 1)
                {
                    ...
                    switch (jsonPropertyName)
                    {
                        ...
                        case "type":
                            ...
                            type = new Option<TransactionDescriptionInfo.TypeEnum?>(TransactionDescriptionInfo.TypeEnum.FromStringOrDefault(typeRawValue) ?? (TransactionDescriptionInfo.TypeEnum)typeRawValue);
                            break;
                        default:
                            break;
                    }
            ...
            var transactionDescriptionInfo = new TransactionDescriptionInfo();
            if (doingBusinessAsName.IsSet)
                transactionDescriptionInfo.DoingBusinessAsName = doingBusinessAsName.Value;
            if (type.IsSet)
                transactionDescriptionInfo.Type = type.Value;
