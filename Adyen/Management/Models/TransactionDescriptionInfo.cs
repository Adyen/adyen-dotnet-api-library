...
namespace Adyen.Management.Models
{
    ...
    public partial class TransactionDescriptionInfo : IValidatableObject
    {
        ...
        /// <summary>
        /// Used to track the state of DoingBusinessAsName
        /// </summary>
        [JsonIgnore]
        [global::System.ComponentModel.EditorBrowsable(global::System.ComponentModel.EditorBrowsableState.Never)]
    ...
    public class TransactionDescriptionInfoJsonConverter : JsonConverter<TransactionDescriptionInfo>
    {
        ...
        public override TransactionDescriptionInfo Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (doingBusinessAsName.IsSet && doingBusinessAsName.Value == null)
                throw new ArgumentNullException(nameof(doingBusinessAsName), "Property is not nullable for class TransactionDescriptionInfo.");

            if (type.IsSet && type.Value == null)
                throw new ArgumentNullException(nameof(type), "Property is not nullable for class TransactionDescriptionInfo.");
        ...
        {
            /*
            if (transactionDescriptionInfo._DoingBusinessAsNameOption.IsSet && transactionDescriptionInfo.DoingBusinessAsName == null)
                throw new ArgumentNullException(nameof(transactionDescriptionInfo.DoingBusinessAsName), "Property is required for class TransactionDescriptionInfo.");
