    ...
    public class UpdateSplitConfigurationRuleRequestJsonConverter : JsonConverter<UpdateSplitConfigurationRuleRequest>
    {
        ...
        public override UpdateSplitConfigurationRuleRequest Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (currency.IsSet && currency.Value == null)
                throw new ArgumentNullException(nameof(currency), "Property is not nullable for class UpdateSplitConfigurationRuleRequest.");

            if (fundingSource.IsSet && fundingSource.Value == null)
                throw new ArgumentNullException(nameof(fundingSource), "Property is not nullable for class UpdateSplitConfigurationRuleRequest.");

            if (paymentMethod.IsSet && paymentMethod.Value == null)
                throw new ArgumentNullException(nameof(paymentMethod), "Property is not nullable for class UpdateSplitConfigurationRuleRequest.");

            if (shopperInteraction.IsSet && shopperInteraction.Value == null)
                throw new ArgumentNullException(nameof(shopperInteraction), "Property is not nullable for class UpdateSplitConfigurationRuleRequest.");
        ...
        public void WriteProperties(Utf8JsonWriter writer, UpdateSplitConfigurationRuleRequest updateSplitConfigurationRuleRequest, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (updateSplitConfigurationRuleRequest.Currency == null)
                throw new ArgumentNullException(nameof(updateSplitConfigurationRuleRequest.Currency), "Property is required for class UpdateSplitConfigurationRuleRequest.");

            if (updateSplitConfigurationRuleRequest.FundingSource == null)
                throw new ArgumentNullException(nameof(updateSplitConfigurationRuleRequest.FundingSource), "Property is required for class UpdateSplitConfigurationRuleRequest.");

            if (updateSplitConfigurationRuleRequest.PaymentMethod == null)
                throw new ArgumentNullException(nameof(updateSplitConfigurationRuleRequest.PaymentMethod), "Property is required for class UpdateSplitConfigurationRuleRequest.");

            if (updateSplitConfigurationRuleRequest.ShopperInteraction == null)
                throw new ArgumentNullException(nameof(updateSplitConfigurationRuleRequest.ShopperInteraction), "Property is required for class UpdateSplitConfigurationRuleRequest.");
