...
namespace Adyen.Management.Models
{
    ...
    /// </summary>
    [JsonConverter(typeof(CreateMerchantApiCredentialRequestJsonConverter))]
    ...
    public class CreateMerchantApiCredentialRequestJsonConverter : JsonConverter<CreateMerchantApiCredentialRequest>
    {
        ...
        public override CreateMerchantApiCredentialRequest Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (description.IsSet)
                createMerchantApiCredentialRequest.Description = description.Value;
            if (roles.IsSet)
                createMerchantApiCredentialRequest.Roles = roles.Value;
            return createMerchantApiCredentialRequest;
        }
