...
namespace Adyen.Management.Models
{
    ...
    public class SignatureJsonConverter : JsonConverter<Signature>
    {
        ...
        public override Signature Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (askSignatureOnScreen.IsSet && askSignatureOnScreen.Value == null)
                throw new ArgumentNullException(nameof(askSignatureOnScreen), "Property is not nullable for class Signature.");

            if (deviceName.IsSet && deviceName.Value == null)
                throw new ArgumentNullException(nameof(deviceName), "Property is not nullable for class Signature.");

            if (deviceSlogan.IsSet && deviceSlogan.Value == null)
                throw new ArgumentNullException(nameof(deviceSlogan), "Property is not nullable for class Signature.");

            if (skipSignature.IsSet && skipSignature.Value == null)
                throw new ArgumentNullException(nameof(skipSignature), "Property is not nullable for class Signature.");
        ...
        {
            /*
            if (signature._DeviceNameOption.IsSet && signature.DeviceName == null)
                throw new ArgumentNullException(nameof(signature.DeviceName), "Property is required for class Signature.");

            if (signature._DeviceSloganOption.IsSet && signature.DeviceSlogan == null)
                throw new ArgumentNullException(nameof(signature.DeviceSlogan), "Property is required for class Signature.");
