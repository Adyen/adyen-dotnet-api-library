...
namespace Adyen.Management.Models
{
    ...
    /// </summary>
    [JsonConverter(typeof(StoreCreationRequestJsonConverter))]
    ...
    public class StoreCreationRequestJsonConverter : JsonConverter<StoreCreationRequest>
    {
        ...
        public override StoreCreationRequest Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (externalReferenceId.IsSet)
                storeCreationRequest.ExternalReferenceId = externalReferenceId.Value;
            if (localizedInformation.IsSet)
                storeCreationRequest.LocalizedInformation = localizedInformation.Value;
            if (reference.IsSet)
                storeCreationRequest.Reference = reference.Value;
            if (splitConfiguration.IsSet)
                storeCreationRequest.SplitConfiguration = splitConfiguration.Value;
            if (subMerchantData.IsSet)
                storeCreationRequest.SubMerchantData = subMerchantData.Value;
