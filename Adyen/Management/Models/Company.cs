    ...
    public class CompanyJsonConverter : JsonConverter<Company>
    {
        ...
        public override Company Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (links.IsSet && links.Value == null)
                throw new ArgumentNullException(nameof(links), "Property is not nullable for class Company.");

            if (dataCenters.IsSet && dataCenters.Value == null)
                throw new ArgumentNullException(nameof(dataCenters), "Property is not nullable for class Company.");

            if (description.IsSet && description.Value == null)
                throw new ArgumentNullException(nameof(description), "Property is not nullable for class Company.");
            ...
            if (reference.IsSet && reference.Value == null)
                throw new ArgumentNullException(nameof(reference), "Property is not nullable for class Company.");

            if (status.IsSet && status.Value == null)
                throw new ArgumentNullException(nameof(status), "Property is not nullable for class Company.");
        ...
        {
            /*
            if (company._LinksOption.IsSet && company.Links == null)
                throw new ArgumentNullException(nameof(company.Links), "Property is required for class Company.");

            if (company._DataCentersOption.IsSet && company.DataCenters == null)
                throw new ArgumentNullException(nameof(company.DataCenters), "Property is required for class Company.");

            if (company._DescriptionOption.IsSet && company.Description == null)
                throw new ArgumentNullException(nameof(company.Description), "Property is required for class Company.");

            if (company._IdOption.IsSet && company.Id == null)
                throw new ArgumentNullException(nameof(company.Id), "Property is required for class Company.");

            if (company._NameOption.IsSet && company.Name == null)
                throw new ArgumentNullException(nameof(company.Name), "Property is required for class Company.");

            if (company._ReferenceOption.IsSet && company.Reference == null)
                throw new ArgumentNullException(nameof(company.Reference), "Property is required for class Company.");

            if (company._StatusOption.IsSet && company.Status == null)
                throw new ArgumentNullException(nameof(company.Status), "Property is required for class Company.");
