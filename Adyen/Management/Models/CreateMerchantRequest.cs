...
namespace Adyen.Management.Models
{
    ...
    /// </summary>
    [JsonConverter(typeof(CreateMerchantRequestJsonConverter))]
    ...
    public class CreateMerchantRequestJsonConverter : JsonConverter<CreateMerchantRequest>
    {
        ...
        public override CreateMerchantRequest Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (description.IsSet)
                createMerchantRequest.Description = description.Value;
            if (legalEntityId.IsSet)
                createMerchantRequest.LegalEntityId = legalEntityId.Value;
            if (pricingPlan.IsSet)
                createMerchantRequest.PricingPlan = pricingPlan.Value;
            if (reference.IsSet)
                createMerchantRequest.Reference = reference.Value;
            if (salesChannels.IsSet)
                createMerchantRequest.SalesChannels = salesChannels.Value;
