    ...
    public class CreateMerchantRequestJsonConverter : JsonConverter<CreateMerchantRequest>
    {
        ...
        public override CreateMerchantRequest Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (companyId.IsSet && companyId.Value == null)
                throw new ArgumentNullException(nameof(companyId), "Property is not nullable for class CreateMerchantRequest.");

            if (businessLineId.IsSet && businessLineId.Value == null)
                throw new ArgumentNullException(nameof(businessLineId), "Property is not nullable for class CreateMerchantRequest.");

            if (description.IsSet && description.Value == null)
                throw new ArgumentNullException(nameof(description), "Property is not nullable for class CreateMerchantRequest.");

            if (legalEntityId.IsSet && legalEntityId.Value == null)
                throw new ArgumentNullException(nameof(legalEntityId), "Property is not nullable for class CreateMerchantRequest.");

            if (pricingPlan.IsSet && pricingPlan.Value == null)
                throw new ArgumentNullException(nameof(pricingPlan), "Property is not nullable for class CreateMerchantRequest.");

            if (reference.IsSet && reference.Value == null)
                throw new ArgumentNullException(nameof(reference), "Property is not nullable for class CreateMerchantRequest.");

            if (salesChannels.IsSet && salesChannels.Value == null)
                throw new ArgumentNullException(nameof(salesChannels), "Property is not nullable for class CreateMerchantRequest.");
        ...
        public void WriteProperties(Utf8JsonWriter writer, CreateMerchantRequest createMerchantRequest, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (createMerchantRequest.CompanyId == null)
                throw new ArgumentNullException(nameof(createMerchantRequest.CompanyId), "Property is required for class CreateMerchantRequest.");

            if (createMerchantRequest._BusinessLineIdOption.IsSet && createMerchantRequest.BusinessLineId == null)
                throw new ArgumentNullException(nameof(createMerchantRequest.BusinessLineId), "Property is required for class CreateMerchantRequest.");

            if (createMerchantRequest._DescriptionOption.IsSet && createMerchantRequest.Description == null)
                throw new ArgumentNullException(nameof(createMerchantRequest.Description), "Property is required for class CreateMerchantRequest.");

            if (createMerchantRequest._LegalEntityIdOption.IsSet && createMerchantRequest.LegalEntityId == null)
                throw new ArgumentNullException(nameof(createMerchantRequest.LegalEntityId), "Property is required for class CreateMerchantRequest.");

            if (createMerchantRequest._PricingPlanOption.IsSet && createMerchantRequest.PricingPlan == null)
                throw new ArgumentNullException(nameof(createMerchantRequest.PricingPlan), "Property is required for class CreateMerchantRequest.");

            if (createMerchantRequest._ReferenceOption.IsSet && createMerchantRequest.Reference == null)
                throw new ArgumentNullException(nameof(createMerchantRequest.Reference), "Property is required for class CreateMerchantRequest.");

            if (createMerchantRequest._SalesChannelsOption.IsSet && createMerchantRequest.SalesChannels == null)
                throw new ArgumentNullException(nameof(createMerchantRequest.SalesChannels), "Property is required for class CreateMerchantRequest.");
