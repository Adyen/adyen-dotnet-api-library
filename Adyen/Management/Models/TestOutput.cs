...
namespace Adyen.Management.Models
{
    ...
    /// TestOutput.
    /// </summary>
    [JsonConverter(typeof(TestOutputJsonConverter))]
    ...
    public class TestOutputJsonConverter : JsonConverter<TestOutput>
    {
        ...
        public override TestOutput Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (output.IsSet)
                testOutput.Output = output.Value;
            if (requestSent.IsSet)
                testOutput.RequestSent = requestSent.Value;
            if (responseCode.IsSet)
                testOutput.ResponseCode = responseCode.Value;
            if (responseTime.IsSet)
                testOutput.ResponseTime = responseTime.Value;
            return testOutput;
        }
