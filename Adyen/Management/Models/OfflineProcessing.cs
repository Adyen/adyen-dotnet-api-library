...
namespace Adyen.Management.Models
{
    ...
    /// OfflineProcessing.
    /// </summary>
    public partial class OfflineProcessing : IValidatableObject
    {
        /// <summary>
    ...
    public class OfflineProcessingJsonConverter : JsonConverter<OfflineProcessing>
    {
        ...
        public override OfflineProcessing Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (chipFloorLimit.IsSet && chipFloorLimit.Value == null)
                throw new ArgumentNullException(nameof(chipFloorLimit), "Property is not nullable for class OfflineProcessing.");

            if (offlineSwipeLimits.IsSet && offlineSwipeLimits.Value == null)
                throw new ArgumentNullException(nameof(offlineSwipeLimits), "Property is not nullable for class OfflineProcessing.");
        ...
        {
            /*
            if (offlineProcessing._OfflineSwipeLimitsOption.IsSet && offlineProcessing.OfflineSwipeLimits == null)
                throw new ArgumentNullException(nameof(offlineProcessing.OfflineSwipeLimits), "Property is required for class OfflineProcessing.");
