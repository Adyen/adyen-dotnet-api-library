...
namespace Adyen.Management.Models
{
    ...
    /// </summary>
    [JsonConverter(typeof(InstallAndroidCertificateDetailsJsonConverter))]
    public partial class InstallAndroidCertificateDetails
    {
        /// <summary>
        ...
        {
            _TypeOption = TypeEnum.InstallAndroidCertificate;
            OnCreated();
        }
    ...
    public class InstallAndroidCertificateDetailsJsonConverter : JsonConverter<InstallAndroidCertificateDetails>
    {
        ...
        public override InstallAndroidCertificateDetails Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (type.IsSet)
                installAndroidCertificateDetails.Type = type.Value;
            return installAndroidCertificateDetails;
        }
