    ...
    public class LinksJsonConverter : JsonConverter<Links>
    {
        ...
        public override Links Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (self.IsSet && self.Value == null)
                throw new ArgumentNullException(nameof(self), "Property is not nullable for class Links.");
        ...
        public void WriteProperties(Utf8JsonWriter writer, Links links, JsonSerializerOptions jsonSerializerOptions)
        {
            /*
            if (links.Self == null)
                throw new ArgumentNullException(nameof(links.Self), "Property is required for class Links.");

            */
            
            writer.WritePropertyName("self");
            JsonSerializer.Serialize(writer, links.Self, jsonSerializerOptions);
        }
    }
}
