    ...
    public class ApplePayInfoJsonConverter : JsonConverter<ApplePayInfo>
    {
        ...
        public override ApplePayInfo Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (domains.IsSet && domains.Value == null)
                throw new ArgumentNullException(nameof(domains), "Property is not nullable for class ApplePayInfo.");
        ...
        {
            /*
            if (applePayInfo.Domains == null)
                throw new ArgumentNullException(nameof(applePayInfo.Domains), "Property is required for class ApplePayInfo.");
