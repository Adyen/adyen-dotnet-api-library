...
namespace Adyen.Management.Models
{
    ...
    /// </summary>
    public partial class PayoutSettingsRequest : IValidatableObject
    {
        /// <summary>
    ...
    public class PayoutSettingsRequestJsonConverter : JsonConverter<PayoutSettingsRequest>
    {
        ...
        public override PayoutSettingsRequest Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (transferInstrumentId.IsSet && transferInstrumentId.Value == null)
                throw new ArgumentNullException(nameof(transferInstrumentId), "Property is not nullable for class PayoutSettingsRequest.");

            if (enabled.IsSet && enabled.Value == null)
                throw new ArgumentNullException(nameof(enabled), "Property is not nullable for class PayoutSettingsRequest.");

            if (enabledFromDate.IsSet && enabledFromDate.Value == null)
                throw new ArgumentNullException(nameof(enabledFromDate), "Property is not nullable for class PayoutSettingsRequest.");
        ...
        public void WriteProperties(Utf8JsonWriter writer, PayoutSettingsRequest payoutSettingsRequest, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (payoutSettingsRequest.TransferInstrumentId == null)
                throw new ArgumentNullException(nameof(payoutSettingsRequest.TransferInstrumentId), "Property is required for class PayoutSettingsRequest.");

            if (payoutSettingsRequest._EnabledFromDateOption.IsSet && payoutSettingsRequest.EnabledFromDate == null)
                throw new ArgumentNullException(nameof(payoutSettingsRequest.EnabledFromDate), "Property is required for class PayoutSettingsRequest.");
