...
namespace Adyen.Management.Models
{
    ...
    /// StoreLocation.
    /// </summary>
    public partial class StoreLocation : IValidatableObject
    {
        /// <summary>
    ...
    public class StoreLocationJsonConverter : JsonConverter<StoreLocation>
    {
        ...
        public override StoreLocation Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (country.IsSet && country.Value == null)
                throw new ArgumentNullException(nameof(country), "Property is not nullable for class StoreLocation.");

            if (city.IsSet && city.Value == null)
                throw new ArgumentNullException(nameof(city), "Property is not nullable for class StoreLocation.");

            if (line1.IsSet && line1.Value == null)
                throw new ArgumentNullException(nameof(line1), "Property is not nullable for class StoreLocation.");

            if (line2.IsSet && line2.Value == null)
                throw new ArgumentNullException(nameof(line2), "Property is not nullable for class StoreLocation.");

            if (line3.IsSet && line3.Value == null)
                throw new ArgumentNullException(nameof(line3), "Property is not nullable for class StoreLocation.");

            if (postalCode.IsSet && postalCode.Value == null)
                throw new ArgumentNullException(nameof(postalCode), "Property is not nullable for class StoreLocation.");

            if (stateOrProvince.IsSet && stateOrProvince.Value == null)
                throw new ArgumentNullException(nameof(stateOrProvince), "Property is not nullable for class StoreLocation.");
        ...
        public void WriteProperties(Utf8JsonWriter writer, StoreLocation storeLocation, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (storeLocation.Country == null)
                throw new ArgumentNullException(nameof(storeLocation.Country), "Property is required for class StoreLocation.");

            if (storeLocation._CityOption.IsSet && storeLocation.City == null)
                throw new ArgumentNullException(nameof(storeLocation.City), "Property is required for class StoreLocation.");

            if (storeLocation._Line1Option.IsSet && storeLocation.Line1 == null)
                throw new ArgumentNullException(nameof(storeLocation.Line1), "Property is required for class StoreLocation.");

            if (storeLocation._Line2Option.IsSet && storeLocation.Line2 == null)
                throw new ArgumentNullException(nameof(storeLocation.Line2), "Property is required for class StoreLocation.");

            if (storeLocation._Line3Option.IsSet && storeLocation.Line3 == null)
                throw new ArgumentNullException(nameof(storeLocation.Line3), "Property is required for class StoreLocation.");

            if (storeLocation._PostalCodeOption.IsSet && storeLocation.PostalCode == null)
                throw new ArgumentNullException(nameof(storeLocation.PostalCode), "Property is required for class StoreLocation.");

            if (storeLocation._StateOrProvinceOption.IsSet && storeLocation.StateOrProvince == null)
                throw new ArgumentNullException(nameof(storeLocation.StateOrProvince), "Property is required for class StoreLocation.");
