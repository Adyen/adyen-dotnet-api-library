...
namespace Adyen.Management.Models
{
    ...
    /// StoreLocation.
    /// </summary>
    [JsonConverter(typeof(StoreLocationJsonConverter))]
    ...
    public class StoreLocationJsonConverter : JsonConverter<StoreLocation>
    {
        ...
        public override StoreLocation Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (line1.IsSet)
                storeLocation.Line1 = line1.Value;
            if (line2.IsSet)
                storeLocation.Line2 = line2.Value;
            if (line3.IsSet)
                storeLocation.Line3 = line3.Value;
            if (postalCode.IsSet)
                storeLocation.PostalCode = postalCode.Value;
            if (stateOrProvince.IsSet)
                storeLocation.StateOrProvince = stateOrProvince.Value;
