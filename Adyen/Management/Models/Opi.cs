...
namespace Adyen.Management.Models
{
    ...
    /// Opi.
    /// </summary>
    [JsonConverter(typeof(OpiJsonConverter))]
    ...
    public class OpiJsonConverter : JsonConverter<Opi>
    {
        ...
        public override Opi Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (payAtTableStoreNumber.IsSet)
                opi.PayAtTableStoreNumber = payAtTableStoreNumber.Value;
            if (payAtTableURL.IsSet)
                opi.PayAtTableURL = payAtTableURL.Value;
            return opi;
        }
