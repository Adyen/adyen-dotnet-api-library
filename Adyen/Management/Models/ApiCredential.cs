...
namespace Adyen.Management.Models
{
    ...
    /// ApiCredential.
    /// </summary>
    [JsonConverter(typeof(ApiCredentialJsonConverter))]
    ...
    public class ApiCredentialJsonConverter : JsonConverter<ApiCredential>
    {
        ...
        public override ApiCredential Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (allowedOrigins.IsSet)
                apiCredential.AllowedOrigins = allowedOrigins.Value;
            if (description.IsSet)
                apiCredential.Description = description.Value;
            if (subjectDN.IsSet)
                apiCredential.SubjectDN = subjectDN.Value;
