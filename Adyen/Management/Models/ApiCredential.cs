...
namespace Adyen.Management.Models
{
    ...
    public partial class ApiCredential
    {
        ...
        public ApiCredential(bool active, List<string> allowedIpAddresses, string clientKey, string id, List<string> roles, string username, Option<ApiCredentialLinks?> links = default, Option<List<AllowedOrigin>?> allowedOrigins = default, Option<string?> description = default, Option<string?> subjectDN = default)
        {
            Active = active;
    ...
    public class ApiCredentialJsonConverter : JsonConverter<ApiCredential>
    {
        ...
        public override ApiCredential Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            return new ApiCredential(active.Value!.Value!, allowedIpAddresses.Value!, clientKey.Value!, id.Value!, roles.Value!, username.Value!, links, allowedOrigins, description, subjectDN);
        }
        ...
        public void WriteProperties(Utf8JsonWriter writer, ApiCredential apiCredential, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (apiCredential._DescriptionOption.IsSet)
                if (apiCredential.Description != null)
                    writer.WriteString("description", apiCredential.Description);

            if (apiCredential._SubjectDNOption.IsSet)
                if (apiCredential.SubjectDN != null)
                    writer.WriteString("subjectDN", apiCredential.SubjectDN);
        }
    }
}
