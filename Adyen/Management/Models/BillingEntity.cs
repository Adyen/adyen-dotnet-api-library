...
namespace Adyen.Management.Models
{
    ...
    /// BillingEntity.
    /// </summary>
    [JsonConverter(typeof(BillingEntityJsonConverter))]
    ...
    public class BillingEntityJsonConverter : JsonConverter<BillingEntity>
    {
        ...
        public override BillingEntity Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (email.IsSet)
                billingEntity.Email = email.Value;
            if (id.IsSet)
                billingEntity.Id = id.Value;
            if (name.IsSet)
                billingEntity.Name = name.Value;
            if (taxId.IsSet)
                billingEntity.TaxId = taxId.Value;
