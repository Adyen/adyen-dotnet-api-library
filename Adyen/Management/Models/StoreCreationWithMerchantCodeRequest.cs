...
namespace Adyen.Management.Models
{
    ...
    /// </summary>
    [JsonConverter(typeof(StoreCreationWithMerchantCodeRequestJsonConverter))]
    public partial class StoreCreationWithMerchantCodeRequest
    {
        /// <summary>
    ...
    public class StoreCreationWithMerchantCodeRequestJsonConverter : JsonConverter<StoreCreationWithMerchantCodeRequest>
    {
        ...
        public override StoreCreationWithMerchantCodeRequest Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (externalReferenceId.IsSet)
                storeCreationWithMerchantCodeRequest.ExternalReferenceId = externalReferenceId.Value;
            if (localizedInformation.IsSet)
                storeCreationWithMerchantCodeRequest.LocalizedInformation = localizedInformation.Value;
            if (reference.IsSet)
                storeCreationWithMerchantCodeRequest.Reference = reference.Value;
            if (splitConfiguration.IsSet)
                storeCreationWithMerchantCodeRequest.SplitConfiguration = splitConfiguration.Value;
            if (subMerchantData.IsSet)
                storeCreationWithMerchantCodeRequest.SubMerchantData = subMerchantData.Value;
            return storeCreationWithMerchantCodeRequest;
        }
