    ...
    public class StoreCreationWithMerchantCodeRequestJsonConverter : JsonConverter<StoreCreationWithMerchantCodeRequest>
    {
        ...
        public override StoreCreationWithMerchantCodeRequest Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (address.IsSet && address.Value == null)
                throw new ArgumentNullException(nameof(address), "Property is not nullable for class StoreCreationWithMerchantCodeRequest.");

            if (description.IsSet && description.Value == null)
                throw new ArgumentNullException(nameof(description), "Property is not nullable for class StoreCreationWithMerchantCodeRequest.");

            if (merchantId.IsSet && merchantId.Value == null)
                throw new ArgumentNullException(nameof(merchantId), "Property is not nullable for class StoreCreationWithMerchantCodeRequest.");

            if (phoneNumber.IsSet && phoneNumber.Value == null)
                throw new ArgumentNullException(nameof(phoneNumber), "Property is not nullable for class StoreCreationWithMerchantCodeRequest.");

            if (shopperStatement.IsSet && shopperStatement.Value == null)
                throw new ArgumentNullException(nameof(shopperStatement), "Property is not nullable for class StoreCreationWithMerchantCodeRequest.");

            if (businessLineIds.IsSet && businessLineIds.Value == null)
                throw new ArgumentNullException(nameof(businessLineIds), "Property is not nullable for class StoreCreationWithMerchantCodeRequest.");

            if (externalReferenceId.IsSet && externalReferenceId.Value == null)
                throw new ArgumentNullException(nameof(externalReferenceId), "Property is not nullable for class StoreCreationWithMerchantCodeRequest.");

            if (reference.IsSet && reference.Value == null)
                throw new ArgumentNullException(nameof(reference), "Property is not nullable for class StoreCreationWithMerchantCodeRequest.");

            if (splitConfiguration.IsSet && splitConfiguration.Value == null)
                throw new ArgumentNullException(nameof(splitConfiguration), "Property is not nullable for class StoreCreationWithMerchantCodeRequest.");

            if (subMerchantData.IsSet && subMerchantData.Value == null)
                throw new ArgumentNullException(nameof(subMerchantData), "Property is not nullable for class StoreCreationWithMerchantCodeRequest.");
        ...
        {
            /*
            if (storeCreationWithMerchantCodeRequest.Address == null)
                throw new ArgumentNullException(nameof(storeCreationWithMerchantCodeRequest.Address), "Property is required for class StoreCreationWithMerchantCodeRequest.");

            if (storeCreationWithMerchantCodeRequest.Description == null)
                throw new ArgumentNullException(nameof(storeCreationWithMerchantCodeRequest.Description), "Property is required for class StoreCreationWithMerchantCodeRequest.");

            if (storeCreationWithMerchantCodeRequest.MerchantId == null)
                throw new ArgumentNullException(nameof(storeCreationWithMerchantCodeRequest.MerchantId), "Property is required for class StoreCreationWithMerchantCodeRequest.");

            if (storeCreationWithMerchantCodeRequest.PhoneNumber == null)
                throw new ArgumentNullException(nameof(storeCreationWithMerchantCodeRequest.PhoneNumber), "Property is required for class StoreCreationWithMerchantCodeRequest.");

            if (storeCreationWithMerchantCodeRequest.ShopperStatement == null)
                throw new ArgumentNullException(nameof(storeCreationWithMerchantCodeRequest.ShopperStatement), "Property is required for class StoreCreationWithMerchantCodeRequest.");

            if (storeCreationWithMerchantCodeRequest._BusinessLineIdsOption.IsSet && storeCreationWithMerchantCodeRequest.BusinessLineIds == null)
                throw new ArgumentNullException(nameof(storeCreationWithMerchantCodeRequest.BusinessLineIds), "Property is required for class StoreCreationWithMerchantCodeRequest.");

            if (storeCreationWithMerchantCodeRequest._ExternalReferenceIdOption.IsSet && storeCreationWithMerchantCodeRequest.ExternalReferenceId == null)
                throw new ArgumentNullException(nameof(storeCreationWithMerchantCodeRequest.ExternalReferenceId), "Property is required for class StoreCreationWithMerchantCodeRequest.");

            if (storeCreationWithMerchantCodeRequest._ReferenceOption.IsSet && storeCreationWithMerchantCodeRequest.Reference == null)
                throw new ArgumentNullException(nameof(storeCreationWithMerchantCodeRequest.Reference), "Property is required for class StoreCreationWithMerchantCodeRequest.");

            if (storeCreationWithMerchantCodeRequest._SplitConfigurationOption.IsSet && storeCreationWithMerchantCodeRequest.SplitConfiguration == null)
                throw new ArgumentNullException(nameof(storeCreationWithMerchantCodeRequest.SplitConfiguration), "Property is required for class StoreCreationWithMerchantCodeRequest.");

            if (storeCreationWithMerchantCodeRequest._SubMerchantDataOption.IsSet && storeCreationWithMerchantCodeRequest.SubMerchantData == null)
                throw new ArgumentNullException(nameof(storeCreationWithMerchantCodeRequest.SubMerchantData), "Property is required for class StoreCreationWithMerchantCodeRequest.");
