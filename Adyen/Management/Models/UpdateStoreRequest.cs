...
namespace Adyen.Management.Models
{
    ...
    /// UpdateStoreRequest.
    /// </summary>
    [JsonConverter(typeof(UpdateStoreRequestJsonConverter))]
    ...
    public class UpdateStoreRequestJsonConverter : JsonConverter<UpdateStoreRequest>
    {
        ...
        public override UpdateStoreRequest Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
                ...
                if (utf8JsonReader.TokenType == JsonTokenType.PropertyName && currentDepth == utf8JsonReader.CurrentDepth - 1)
                {
                    ...
                    switch (jsonPropertyName)
                    {
                        ...
                        case "status":
                            ...
                            status = new Option<UpdateStoreRequest.StatusEnum?>(UpdateStoreRequest.StatusEnum.FromStringOrDefault(statusRawValue) ?? (UpdateStoreRequest.StatusEnum)statusRawValue);
                            break;
            ...
            if (businessLineIds.IsSet)
                updateStoreRequest.BusinessLineIds = businessLineIds.Value;
            if (description.IsSet)
                updateStoreRequest.Description = description.Value;
            if (externalReferenceId.IsSet)
                updateStoreRequest.ExternalReferenceId = externalReferenceId.Value;
            if (phoneNumber.IsSet)
                updateStoreRequest.PhoneNumber = phoneNumber.Value;
            if (splitConfiguration.IsSet)
                updateStoreRequest.SplitConfiguration = splitConfiguration.Value;
            if (status.IsSet)
                updateStoreRequest.Status = status.Value;
            if (subMerchantData.IsSet)
                updateStoreRequest.SubMerchantData = subMerchantData.Value;
