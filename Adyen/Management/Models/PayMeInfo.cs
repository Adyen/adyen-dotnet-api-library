...
namespace Adyen.Management.Models
{
    ...
    /// PayMeInfo.
    /// </summary>
    [JsonConverter(typeof(PayMeInfoJsonConverter))]
    public partial class PayMeInfo
    {
        /// <summary>
    ...
    public class PayMeInfoJsonConverter : JsonConverter<PayMeInfo>
    {
        ...
        public override PayMeInfo Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            var payMeInfo = new PayMeInfo();
            if (displayName.IsSet)
                payMeInfo.DisplayName = displayName.Value!;
            if (logo.IsSet)
                payMeInfo.Logo = logo.Value!;
            if (supportEmail.IsSet)
                payMeInfo.SupportEmail = supportEmail.Value!;
            return payMeInfo;
        }
