...
namespace Adyen.Management.Models
{
    ...
    public class SurchargeJsonConverter : JsonConverter<Surcharge>
    {
        ...
        public override Surcharge Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (askConfirmation.IsSet && askConfirmation.Value == null)
                throw new ArgumentNullException(nameof(askConfirmation), "Property is not nullable for class Surcharge.");

            if (configurations.IsSet && configurations.Value == null)
                throw new ArgumentNullException(nameof(configurations), "Property is not nullable for class Surcharge.");

            if (excludeGratuityFromSurcharge.IsSet && excludeGratuityFromSurcharge.Value == null)
                throw new ArgumentNullException(nameof(excludeGratuityFromSurcharge), "Property is not nullable for class Surcharge.");
        ...
        {
            /*
            if (surcharge._ConfigurationsOption.IsSet && surcharge.Configurations == null)
                throw new ArgumentNullException(nameof(surcharge.Configurations), "Property is required for class Surcharge.");
