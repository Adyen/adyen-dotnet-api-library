    ...
    public class AddressJsonConverter : JsonConverter<Address>
    {
        ...
        public override Address Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (companyName.IsSet && companyName.Value == null)
                throw new ArgumentNullException(nameof(companyName), "Property is not nullable for class Address.");
        ...
        public void WriteProperties(Utf8JsonWriter writer, Address address, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (address._CompanyNameOption.IsSet && address.CompanyName == null)
                throw new ArgumentNullException(nameof(address.CompanyName), "Property is required for class Address.");

            if (address._CountryOption.IsSet && address.Country == null)
