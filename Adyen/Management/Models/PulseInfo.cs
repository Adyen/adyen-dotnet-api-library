    ...
    public class PulseInfoJsonConverter : JsonConverter<PulseInfo>
    {
        ...
        public override PulseInfo Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (processingType.IsSet && processingType.Value == null)
                throw new ArgumentNullException(nameof(processingType), "Property is not nullable for class PulseInfo.");

            if (transactionDescription.IsSet && transactionDescription.Value == null)
                throw new ArgumentNullException(nameof(transactionDescription), "Property is not nullable for class PulseInfo.");
        ...
        {
            /*
            if (pulseInfo._TransactionDescriptionOption.IsSet && pulseInfo.TransactionDescription == null)
                throw new ArgumentNullException(nameof(pulseInfo.TransactionDescription), "Property is required for class PulseInfo.");
