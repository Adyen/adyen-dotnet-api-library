...
namespace Adyen.Management.Models
{
    ...
    /// </summary>
    public partial class SplitConfigurationLogic : IValidatableObject
    {
        /// <summary>
    ...
    public class SplitConfigurationLogicJsonConverter : JsonConverter<SplitConfigurationLogic>
    {
        ...
        public override SplitConfigurationLogic Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (commission.IsSet && commission.Value == null)
                throw new ArgumentNullException(nameof(commission), "Property is not nullable for class SplitConfigurationLogic.");

            if (acquiringFees.IsSet && acquiringFees.Value == null)
                throw new ArgumentNullException(nameof(acquiringFees), "Property is not nullable for class SplitConfigurationLogic.");

            if (additionalCommission.IsSet && additionalCommission.Value == null)
                throw new ArgumentNullException(nameof(additionalCommission), "Property is not nullable for class SplitConfigurationLogic.");

            if (adyenCommission.IsSet && adyenCommission.Value == null)
                throw new ArgumentNullException(nameof(adyenCommission), "Property is not nullable for class SplitConfigurationLogic.");

            if (adyenFees.IsSet && adyenFees.Value == null)
                throw new ArgumentNullException(nameof(adyenFees), "Property is not nullable for class SplitConfigurationLogic.");

            if (adyenMarkup.IsSet && adyenMarkup.Value == null)
                throw new ArgumentNullException(nameof(adyenMarkup), "Property is not nullable for class SplitConfigurationLogic.");

            if (chargeback.IsSet && chargeback.Value == null)
                throw new ArgumentNullException(nameof(chargeback), "Property is not nullable for class SplitConfigurationLogic.");

            if (chargebackCostAllocation.IsSet && chargebackCostAllocation.Value == null)
                throw new ArgumentNullException(nameof(chargebackCostAllocation), "Property is not nullable for class SplitConfigurationLogic.");

            if (interchange.IsSet && interchange.Value == null)
                throw new ArgumentNullException(nameof(interchange), "Property is not nullable for class SplitConfigurationLogic.");

            if (paymentFee.IsSet && paymentFee.Value == null)
                throw new ArgumentNullException(nameof(paymentFee), "Property is not nullable for class SplitConfigurationLogic.");

            if (refund.IsSet && refund.Value == null)
                throw new ArgumentNullException(nameof(refund), "Property is not nullable for class SplitConfigurationLogic.");

            if (refundCostAllocation.IsSet && refundCostAllocation.Value == null)
                throw new ArgumentNullException(nameof(refundCostAllocation), "Property is not nullable for class SplitConfigurationLogic.");

            if (remainder.IsSet && remainder.Value == null)
                throw new ArgumentNullException(nameof(remainder), "Property is not nullable for class SplitConfigurationLogic.");

            if (schemeFee.IsSet && schemeFee.Value == null)
                throw new ArgumentNullException(nameof(schemeFee), "Property is not nullable for class SplitConfigurationLogic.");

            if (splitLogicId.IsSet && splitLogicId.Value == null)
                throw new ArgumentNullException(nameof(splitLogicId), "Property is not nullable for class SplitConfigurationLogic.");

            if (surcharge.IsSet && surcharge.Value == null)
                throw new ArgumentNullException(nameof(surcharge), "Property is not nullable for class SplitConfigurationLogic.");

            if (tip.IsSet && tip.Value == null)
                throw new ArgumentNullException(nameof(tip), "Property is not nullable for class SplitConfigurationLogic.");
        ...
        {
            /*
            if (splitConfigurationLogic.Commission == null)
                throw new ArgumentNullException(nameof(splitConfigurationLogic.Commission), "Property is required for class SplitConfigurationLogic.");

            if (splitConfigurationLogic._AdditionalCommissionOption.IsSet && splitConfigurationLogic.AdditionalCommission == null)
                throw new ArgumentNullException(nameof(splitConfigurationLogic.AdditionalCommission), "Property is required for class SplitConfigurationLogic.");

            if (splitConfigurationLogic._SplitLogicIdOption.IsSet && splitConfigurationLogic.SplitLogicId == null)
                throw new ArgumentNullException(nameof(splitConfigurationLogic.SplitLogicId), "Property is required for class SplitConfigurationLogic.");
