    ...
    public class UserJsonConverter : JsonConverter<User>
    {
        ...
        public override User Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (timeZoneCode.IsSet && timeZoneCode.Value == null)
                throw new ArgumentNullException(nameof(timeZoneCode), "Property is not nullable for class User.");
            ...
            if (links.IsSet && links.Value == null)
                throw new ArgumentNullException(nameof(links), "Property is not nullable for class User.");

            if (accountGroups.IsSet && accountGroups.Value == null)
                throw new ArgumentNullException(nameof(accountGroups), "Property is not nullable for class User.");

            if (active.IsSet && active.Value == null)
                throw new ArgumentNullException(nameof(active), "Property is not nullable for class User.");

            if (apps.IsSet && apps.Value == null)
                throw new ArgumentNullException(nameof(apps), "Property is not nullable for class User.");
        ...
        public void WriteProperties(Utf8JsonWriter writer, User user, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (user.TimeZoneCode == null)
                throw new ArgumentNullException(nameof(user.TimeZoneCode), "Property is required for class User.");

            if (user.Username == null)
                throw new ArgumentNullException(nameof(user.Username), "Property is required for class User.");

            if (user._LinksOption.IsSet && user.Links == null)
                throw new ArgumentNullException(nameof(user.Links), "Property is required for class User.");

            if (user._AccountGroupsOption.IsSet && user.AccountGroups == null)
                throw new ArgumentNullException(nameof(user.AccountGroups), "Property is required for class User.");

            if (user._AppsOption.IsSet && user.Apps == null)
                throw new ArgumentNullException(nameof(user.Apps), "Property is required for class User.");

            if (user._NameOption.IsSet && user.Name == null)
