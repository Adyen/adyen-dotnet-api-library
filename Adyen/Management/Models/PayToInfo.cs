...
namespace Adyen.Management.Models
{
    ...
    /// PayToInfo.
    /// </summary>
    [JsonConverter(typeof(PayToInfoJsonConverter))]
    ...
    public class PayToInfoJsonConverter : JsonConverter<PayToInfo>
    {
        ...
        public override PayToInfo Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            var payToInfo = new PayToInfo();
            payToInfo.MerchantName = merchantName.Value!;
            payToInfo.PayToPurpose = payToPurpose.Value!;
            return payToInfo;
        }
