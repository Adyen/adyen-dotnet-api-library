...
namespace Adyen.Management.Models
{
    ...
    /// </summary>
    [JsonConverter(typeof(AdditionalCommissionJsonConverter))]
    public partial class AdditionalCommission
    {
        /// <summary>
    ...
    public class AdditionalCommissionJsonConverter : JsonConverter<AdditionalCommission>
    {
        ...
        public override AdditionalCommission Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (fixedAmount.IsSet)
                additionalCommission.FixedAmount = fixedAmount.Value;
            if (variablePercentage.IsSet)
                additionalCommission.VariablePercentage = variablePercentage.Value;
