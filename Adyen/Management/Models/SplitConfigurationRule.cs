...
namespace Adyen.Management.Models
{
    ...
    /// </summary>
    [JsonConverter(typeof(SplitConfigurationRuleJsonConverter))]
    public partial class SplitConfigurationRule
    {
        ...
        /// </summary>
        /// <value>The card region condition that determines whether the [split logic](https://docs.adyen.com/api-explorer/Management/latest/post/merchants/(merchantId)/splitConfigurations#request-rules-splitLogic) applies to the transaction.  Possible values: * **domestic**: The card issuer and the store where the transaction is processed are registered in the same country. * **international**: The card issuer and the store where the transaction is processed are registered in different countries or regions. Includes all **interRegional** and **intraRegional** transactions. * **interRegional**: The card issuer and the store where the transaction is processed are registered in different regions. * **intraRegional**: The card issuer and the store where the transaction is processed are registered in different countries, but in the same region. * **intraEEA**: The card issuer and the store where the transaction is processed are registered in different countries, but in the European Economic Area (EEA). * **ANY**: Applies to all transactions, regardless of the processing and issuing country/region.</value>
        ...
        public class CardRegionEnum : IEnum
        {
            ...
            /// <summary>
            /// CardRegionEnum.IntraEEA - intraEEA
            /// </summary>
            public static readonly CardRegionEnum IntraEEA = new("intraEEA");
            ...
            /// <summary>
            /// Compares two <see cref="CardRegionEnum"/> instances for equality.
            /// </summary>
            ...
            /// <summary>
            /// Compares two <see cref="CardRegionEnum"/> instances for inequality.
            /// </summary>
            public static bool operator !=(CardRegionEnum? left, CardRegionEnum? right) => !string.Equals(left?.Value, right?.Value, StringComparison.OrdinalIgnoreCase);

            /// <summary>
            /// Returns true if the given object is equal to this <see cref="CardRegionEnum"/> instance.
            /// </summary>
            ...
            /// <summary>
            /// Returns a hash code for this <see cref="CardRegionEnum"/> instance.
            /// </summary>
            public override int GetHashCode() => Value?.GetHashCode() ?? 0;

            /// <summary>
            /// Returns the string value of the <see cref="CardRegionEnum"/> instance.
            /// </summary>
            public override string ToString() => Value ?? string.Empty;
            ...
            public static CardRegionEnum? FromStringOrDefault(string value)
            {
                return value switch {
                    ...
                    "intraEEA" => CardRegionEnum.IntraEEA,
            ...
            public static string? ToJsonValue(CardRegionEnum? value)
            {
                ...
                if (value == CardRegionEnum.IntraEEA)
                    return "intraEEA";
            ...
            {
                /// <summary>
                /// Deserializes a <see cref="CardRegionEnum"/> from JSON.
                /// </summary>
                ...
                /// <summary>
                /// Serializes a <see cref="CardRegionEnum"/> to JSON.
                /// </summary>
        ...
        [JsonIgnore]
        [global::System.ComponentModel.EditorBrowsable(global::System.ComponentModel.EditorBrowsableState.Never)]
        public Option<string?> _RuleIdOption { get; private set; }
    ...
    public class SplitConfigurationRuleJsonConverter : JsonConverter<SplitConfigurationRule>
    {
        ...
        public override SplitConfigurationRule Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            Option<SplitConfigurationRule.CardUsageTypeEnum?> cardUsageType = default;
                ...
                if (utf8JsonReader.TokenType == JsonTokenType.PropertyName && currentDepth == utf8JsonReader.CurrentDepth - 1)
                {
                    ...
                    switch (jsonPropertyName)
                    {
                        ...
                        case "cardUsageType":
                            ...
                            cardUsageType = new Option<SplitConfigurationRule.CardUsageTypeEnum?>(SplitConfigurationRule.CardUsageTypeEnum.FromStringOrDefault(cardUsageTypeRawValue) ?? (SplitConfigurationRule.CardUsageTypeEnum)cardUsageTypeRawValue);
                            break;
                        case "ruleId":
            ...
            if (cardUsageType.IsSet)
                splitConfigurationRule.CardUsageType = cardUsageType.Value;
            if (ruleId.IsSet)
                splitConfigurationRule.RuleId = ruleId.Value;
        ...
        public void WriteProperties(Utf8JsonWriter writer, SplitConfigurationRule splitConfigurationRule, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (splitConfigurationRule._CardUsageTypeOption.IsSet && splitConfigurationRule.CardUsageType != null) 
            {
                string? cardUsageTypeRawValue = SplitConfigurationRule.CardUsageTypeEnum.ToJsonValue(splitConfigurationRule._CardUsageTypeOption.Value!.Value);
