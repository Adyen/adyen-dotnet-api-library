...
namespace Adyen.Management.Models
{
    ...
    public partial class SplitConfigurationRule : IValidatableObject
    {
        ...
        /// <summary>
        /// Used to track whether CardRegion is set or not.
        /// </summary>
        [JsonIgnore]
    ...
    public class SplitConfigurationRuleJsonConverter : JsonConverter<SplitConfigurationRule>
    {
        ...
        public override SplitConfigurationRule Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (currency.IsSet && currency.Value == null)
                throw new ArgumentNullException(nameof(currency), "Property is not nullable for class SplitConfigurationRule.");

            if (fundingSource.IsSet && fundingSource.Value == null)
                throw new ArgumentNullException(nameof(fundingSource), "Property is not nullable for class SplitConfigurationRule.");

            if (paymentMethod.IsSet && paymentMethod.Value == null)
                throw new ArgumentNullException(nameof(paymentMethod), "Property is not nullable for class SplitConfigurationRule.");

            if (shopperInteraction.IsSet && shopperInteraction.Value == null)
                throw new ArgumentNullException(nameof(shopperInteraction), "Property is not nullable for class SplitConfigurationRule.");

            if (splitLogic.IsSet && splitLogic.Value == null)
                throw new ArgumentNullException(nameof(splitLogic), "Property is not nullable for class SplitConfigurationRule.");

            if (cardRegion.IsSet && cardRegion.Value == null)
                throw new ArgumentNullException(nameof(cardRegion), "Property is not nullable for class SplitConfigurationRule.");

            if (ruleId.IsSet && ruleId.Value == null)
                throw new ArgumentNullException(nameof(ruleId), "Property is not nullable for class SplitConfigurationRule.");
        ...
        public void WriteProperties(Utf8JsonWriter writer, SplitConfigurationRule splitConfigurationRule, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (splitConfigurationRule.Currency == null)
                throw new ArgumentNullException(nameof(splitConfigurationRule.Currency), "Property is required for class SplitConfigurationRule.");

            if (splitConfigurationRule.PaymentMethod == null)
                throw new ArgumentNullException(nameof(splitConfigurationRule.PaymentMethod), "Property is required for class SplitConfigurationRule.");

            if (splitConfigurationRule.SplitLogic == null)
                throw new ArgumentNullException(nameof(splitConfigurationRule.SplitLogic), "Property is required for class SplitConfigurationRule.");

            if (splitConfigurationRule._RuleIdOption.IsSet && splitConfigurationRule.RuleId == null)
                throw new ArgumentNullException(nameof(splitConfigurationRule.RuleId), "Property is required for class SplitConfigurationRule.");
