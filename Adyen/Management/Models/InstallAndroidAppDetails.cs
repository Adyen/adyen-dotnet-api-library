...
namespace Adyen.Management.Models
{
    ...
    /// </summary>
    public partial class InstallAndroidAppDetails : IValidatableObject
    {
        /// <summary>
    ...
    /// <summary>
    /// A Json converter for type <see cref="InstallAndroidAppDetails" />
    /// </summary>
    public class InstallAndroidAppDetailsJsonConverter : JsonConverter<InstallAndroidAppDetails>
    {
        /// <summary>
        /// Deserializes json to <see cref="InstallAndroidAppDetails"/>.
        /// </summary>
        /// <param name="utf8JsonReader"><see cref="Utf8JsonReader"/></param>
        /// <param name="typeToConvert"><see cref="Type"/></param>
        /// <param name="jsonSerializerOptions">The <see cref="JsonSerializerOptions"/>, initialized from <see cref="HostConfiguration"/>.</param>
        /// <returns><see cref="InstallAndroidAppDetails"/></returns>
        /// <exception cref="JsonException"></exception>
        public override InstallAndroidAppDetails Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            Option<InstallAndroidAppDetails.TypeEnum?> type = default;
            ...
            if (appId.IsSet && appId.Value == null)
                throw new ArgumentNullException(nameof(appId), "Property is not nullable for class InstallAndroidAppDetails.");

            if (type.IsSet && type.Value == null)
                throw new ArgumentNullException(nameof(type), "Property is not nullable for class InstallAndroidAppDetails.");

            return new InstallAndroidAppDetails(appId, type);
        }

        /// <summary>
        /// Serializes a <see cref="InstallAndroidAppDetails"/>.
        /// </summary>
        /// <param name="writer"><see cref="Utf8JsonWriter"/></param>
        /// <param name="installAndroidAppDetails"></param>
        /// <param name="jsonSerializerOptions"><see cref="JsonSerializerOptions"/></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, InstallAndroidAppDetails installAndroidAppDetails, JsonSerializerOptions jsonSerializerOptions)
        {
            
            writer.WriteStartObject();
            
            WriteProperties(writer, installAndroidAppDetails, jsonSerializerOptions);
        ...
        /// <summary>
        /// Serializes the properties of <see cref="InstallAndroidAppDetails"/>.
        /// </summary>
        /// <param name="writer"><see creft="Utf8JsonWriter"/></param>
        /// <param name="installAndroidAppDetails"></param>
        /// <param name="jsonSerializerOptions"><see cref="JsonSerializerOptions"/></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, InstallAndroidAppDetails installAndroidAppDetails, JsonSerializerOptions jsonSerializerOptions)
        {
            /*
            if (installAndroidAppDetails._AppIdOption.IsSet && installAndroidAppDetails.AppId == null)
                throw new ArgumentNullException(nameof(installAndroidAppDetails.AppId), "Property is required for class InstallAndroidAppDetails.");

            */
            
            if (installAndroidAppDetails._AppIdOption.IsSet)
                writer.WriteString("appId", installAndroidAppDetails.AppId);

            if (installAndroidAppDetails._TypeOption.IsSet && installAndroidAppDetails.Type != null) 
            {
                string? typeRawValue = InstallAndroidAppDetails.TypeEnum.ToJsonValue(installAndroidAppDetails._TypeOption.Value!.Value);
