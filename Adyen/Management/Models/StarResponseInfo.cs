...
namespace Adyen.Management.Models
{
    ...
    /// StarResponseInfo.
    /// </summary>
    public partial class StarResponseInfo
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="StarResponseInfo" /> class.
        /// </summary>
        ...
        public StarResponseInfo(ProcessingTypeEnum processingType, Option<TransactionDescriptionResponseInfo?> transactionDescription = default)
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class StarResponseInfo {\n");
    ...
    /// <summary>
    /// A Json converter for type <see cref="StarResponseInfo" />
    /// </summary>
    public class StarResponseInfoJsonConverter : JsonConverter<StarResponseInfo>
    {
        /// <summary>
        /// Deserializes json to <see cref="StarResponseInfo"/>.
        /// </summary>
        /// <param name="utf8JsonReader"><see cref="Utf8JsonReader"/>.</param>
        /// <param name="typeToConvert"><see cref="Type"/>.</param>
        /// <param name="jsonSerializerOptions">The <see cref="JsonSerializerOptions"/>, initialized from <see cref="HostConfiguration"/>.</param>
        /// <returns><see cref="StarResponseInfo"/>.</returns>
        /// <exception cref="JsonException"></exception>
        public override StarResponseInfo Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            Option<StarResponseInfo.ProcessingTypeEnum?> processingType = default;
                ...
                if (utf8JsonReader.TokenType == JsonTokenType.PropertyName && currentDepth == utf8JsonReader.CurrentDepth - 1)
                {
                    ...
                    switch (jsonPropertyName)
                    {
                        case "processingType":
                            ...
                            processingType = new Option<StarResponseInfo.ProcessingTypeEnum?>(StarResponseInfo.ProcessingTypeEnum.FromStringOrDefault(processingTypeRawValue));
                            break;
            ...
            return new StarResponseInfo(processingType.Value!.Value!, transactionDescription);
        }

        /// <summary>
        /// Serializes a <see cref="StarResponseInfo"/>.
        /// </summary>
        /// <param name="writer"><see cref="Utf8JsonWriter"/></param>
        /// <param name="starResponseInfo"></param>
        /// <param name="jsonSerializerOptions"><see cref="JsonSerializerOptions"/></param>
        public override void Write(Utf8JsonWriter writer, StarResponseInfo starResponseInfo, JsonSerializerOptions jsonSerializerOptions)
        {
            
            writer.WriteStartObject();
            
            WriteProperties(writer, starResponseInfo, jsonSerializerOptions);
        ...
        /// <summary>
        /// Serializes the properties of <see cref="StarResponseInfo"/>.
        /// </summary>
        /// <param name="writer"><see cref="Utf8JsonWriter"/></param>
        /// <param name="starResponseInfo"></param>
        /// <param name="jsonSerializerOptions"><see cref="JsonSerializerOptions"/></param>
        public void WriteProperties(Utf8JsonWriter writer, StarResponseInfo starResponseInfo, JsonSerializerOptions jsonSerializerOptions)
        {
            
            if (starResponseInfo.ProcessingType != null) 
            {
                string? processingTypeRawValue = StarResponseInfo.ProcessingTypeEnum.ToJsonValue(starResponseInfo.ProcessingType);
                writer.WriteString("processingType", processingTypeRawValue);
            }
            
            if (starResponseInfo._TransactionDescriptionOption.IsSet)
            {
                writer.WritePropertyName("transactionDescription");
                JsonSerializer.Serialize(writer, starResponseInfo.TransactionDescription, jsonSerializerOptions);
            }
        }
    }
}
