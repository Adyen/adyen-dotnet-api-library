...
namespace Adyen.Management.Models
{
    ...
    /// StarResponseInfo.
    /// </summary>
    [JsonConverter(typeof(StarResponseInfoJsonConverter))]
    ...
    public class StarResponseInfoJsonConverter : JsonConverter<StarResponseInfo>
    {
                ...
                if (utf8JsonReader.TokenType == JsonTokenType.PropertyName && currentDepth == utf8JsonReader.CurrentDepth - 1)
                {
                    ...
                    switch (jsonPropertyName)
                    {
                        case "processingType":
                            ...
                            processingType = new Option<StarResponseInfo.ProcessingTypeEnum?>(StarResponseInfo.ProcessingTypeEnum.FromStringOrDefault(processingTypeRawValue) ?? (StarResponseInfo.ProcessingTypeEnum)processingTypeRawValue);
                            break;
        ...
        public void WriteProperties(Utf8JsonWriter writer, StarResponseInfo starResponseInfo, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (starResponseInfo._ProcessingTypeOption.IsSet && starResponseInfo.ProcessingType != null) 
            {
                string? processingTypeRawValue = StarResponseInfo.ProcessingTypeEnum.ToJsonValue(starResponseInfo._ProcessingTypeOption.Value!.Value);
