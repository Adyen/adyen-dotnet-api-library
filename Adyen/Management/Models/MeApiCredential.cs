...
namespace Adyen.Management.Models
{
    ...
    /// MeApiCredential.
    /// </summary>
    [JsonConverter(typeof(MeApiCredentialJsonConverter))]
    public partial class MeApiCredential
    {
        /// <summary>
        ...
        /// <summary>
        /// This is used to track if an optional field is set. If set, <see cref="CompanyName"/> will be populated.
        /// </summary>
        [JsonIgnore]
        [global::System.ComponentModel.EditorBrowsable(global::System.ComponentModel.EditorBrowsableState.Never)]
    ...
    public class MeApiCredentialJsonConverter : JsonConverter<MeApiCredential>
    {
        ...
        public override MeApiCredential Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            var meApiCredential = new MeApiCredential();
            meApiCredential.Active = active.Value!.Value;
            meApiCredential.AllowedIpAddresses = allowedIpAddresses.Value!;
            meApiCredential.ClientKey = clientKey.Value!;
            meApiCredential.Id = id.Value!;
            meApiCredential.Roles = roles.Value!;
            meApiCredential.Username = username.Value!;
            if (links.IsSet)
                meApiCredential.Links = links.Value;
            if (allowedOrigins.IsSet)
                meApiCredential.AllowedOrigins = allowedOrigins.Value;
            if (companyName.IsSet)
                meApiCredential.CompanyName = companyName.Value;
            if (description.IsSet)
                meApiCredential.Description = description.Value;
            if (subjectDN.IsSet)
                meApiCredential.SubjectDN = subjectDN.Value;
        ...
        public void WriteProperties(Utf8JsonWriter writer, MeApiCredential meApiCredential, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (meApiCredential._CompanyNameOption.IsSet)
                if (meApiCredential.CompanyName != null)
                    writer.WriteString("companyName", meApiCredential.CompanyName);

            if (meApiCredential._DescriptionOption.IsSet)
                if (meApiCredential.Description != null)
                    writer.WriteString("description", meApiCredential.Description);

            if (meApiCredential._SubjectDNOption.IsSet)
                if (meApiCredential.SubjectDN != null)
                    writer.WriteString("subjectDN", meApiCredential.SubjectDN);
        }
    }
}
