...
namespace Adyen.Management.Models
{
    ...
    public partial class MeApiCredential : IValidatableObject
    {
        ...
        [JsonConstructor]
        public MeApiCredential(bool active, List<string> allowedIpAddresses, string clientKey, string id, List<string> roles, string username, Option<ApiCredentialLinks?> links = default, Option<List<AllowedOrigin>?> allowedOrigins = default, Option<string?> companyName = default, Option<string?> description = default)
        {
            Active = active;
    ...
    /// <summary>
    /// A Json converter for type <see cref="MeApiCredential" />
    /// </summary>
    public class MeApiCredentialJsonConverter : JsonConverter<MeApiCredential>
    {
        /// <summary>
        /// Deserializes json to <see cref="MeApiCredential"/>.
        /// </summary>
        ...
        public override MeApiCredential Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (active.IsSet && active.Value == null)
                throw new ArgumentNullException(nameof(active), "Property is not nullable for class MeApiCredential.");

            if (allowedIpAddresses.IsSet && allowedIpAddresses.Value == null)
                throw new ArgumentNullException(nameof(allowedIpAddresses), "Property is not nullable for class MeApiCredential.");

            if (clientKey.IsSet && clientKey.Value == null)
                throw new ArgumentNullException(nameof(clientKey), "Property is not nullable for class MeApiCredential.");

            if (id.IsSet && id.Value == null)
                throw new ArgumentNullException(nameof(id), "Property is not nullable for class MeApiCredential.");

            if (roles.IsSet && roles.Value == null)
                throw new ArgumentNullException(nameof(roles), "Property is not nullable for class MeApiCredential.");

            if (username.IsSet && username.Value == null)
                throw new ArgumentNullException(nameof(username), "Property is not nullable for class MeApiCredential.");

            if (links.IsSet && links.Value == null)
                throw new ArgumentNullException(nameof(links), "Property is not nullable for class MeApiCredential.");

            if (allowedOrigins.IsSet && allowedOrigins.Value == null)
                throw new ArgumentNullException(nameof(allowedOrigins), "Property is not nullable for class MeApiCredential.");

            if (companyName.IsSet && companyName.Value == null)
                throw new ArgumentNullException(nameof(companyName), "Property is not nullable for class MeApiCredential.");

            if (description.IsSet && description.Value == null)
                throw new ArgumentNullException(nameof(description), "Property is not nullable for class MeApiCredential.");
        ...
        /// <summary>
        /// Serializes a <see cref="MeApiCredential"/>.
        /// </summary>
        /// <param name="writer"><see cref="Utf8JsonWriter"/></param>
        /// <param name="meApiCredential"></param>
        /// <param name="jsonSerializerOptions"><see cref="JsonSerializerOptions"/></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, MeApiCredential meApiCredential, JsonSerializerOptions jsonSerializerOptions)
        {
        ...
        /// <summary>
        /// Serializes the properties of <see cref="MeApiCredential"/>.
        /// </summary>
        /// <param name="writer"><see creft="Utf8JsonWriter"/></param>
        /// <param name="meApiCredential"></param>
        /// <param name="jsonSerializerOptions"><see cref="JsonSerializerOptions"/></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, MeApiCredential meApiCredential, JsonSerializerOptions jsonSerializerOptions)
        {
            /*
            if (meApiCredential.AllowedIpAddresses == null)
                throw new ArgumentNullException(nameof(meApiCredential.AllowedIpAddresses), "Property is required for class MeApiCredential.");

            if (meApiCredential.ClientKey == null)
                throw new ArgumentNullException(nameof(meApiCredential.ClientKey), "Property is required for class MeApiCredential.");

            if (meApiCredential.Id == null)
                throw new ArgumentNullException(nameof(meApiCredential.Id), "Property is required for class MeApiCredential.");

            if (meApiCredential.Roles == null)
                throw new ArgumentNullException(nameof(meApiCredential.Roles), "Property is required for class MeApiCredential.");

            if (meApiCredential.Username == null)
                throw new ArgumentNullException(nameof(meApiCredential.Username), "Property is required for class MeApiCredential.");

            if (meApiCredential._LinksOption.IsSet && meApiCredential.Links == null)
                throw new ArgumentNullException(nameof(meApiCredential.Links), "Property is required for class MeApiCredential.");

            if (meApiCredential._AllowedOriginsOption.IsSet && meApiCredential.AllowedOrigins == null)
                throw new ArgumentNullException(nameof(meApiCredential.AllowedOrigins), "Property is required for class MeApiCredential.");

            if (meApiCredential._CompanyNameOption.IsSet && meApiCredential.CompanyName == null)
                throw new ArgumentNullException(nameof(meApiCredential.CompanyName), "Property is required for class MeApiCredential.");

            if (meApiCredential._DescriptionOption.IsSet && meApiCredential.Description == null)
                throw new ArgumentNullException(nameof(meApiCredential.Description), "Property is required for class MeApiCredential.");

            */
            
            writer.WriteBoolean("active", meApiCredential.Active);

            writer.WritePropertyName("allowedIpAddresses");
            JsonSerializer.Serialize(writer, meApiCredential.AllowedIpAddresses, jsonSerializerOptions);
            writer.WriteString("clientKey", meApiCredential.ClientKey);

            writer.WriteString("id", meApiCredential.Id);

            writer.WritePropertyName("roles");
            JsonSerializer.Serialize(writer, meApiCredential.Roles, jsonSerializerOptions);
            writer.WriteString("username", meApiCredential.Username);

            if (meApiCredential._LinksOption.IsSet)
            {
                writer.WritePropertyName("_links");
                JsonSerializer.Serialize(writer, meApiCredential.Links, jsonSerializerOptions);
            }
            if (meApiCredential._AllowedOriginsOption.IsSet)
            {
                writer.WritePropertyName("allowedOrigins");
                JsonSerializer.Serialize(writer, meApiCredential.AllowedOrigins, jsonSerializerOptions);
            }
            if (meApiCredential._CompanyNameOption.IsSet)
                writer.WriteString("companyName", meApiCredential.CompanyName);

            if (meApiCredential._DescriptionOption.IsSet)
                writer.WriteString("description", meApiCredential.Description);
        }
    }
}
