...
namespace Adyen.Management.Models
{
    ...
    /// </summary>
    [JsonConverter(typeof(TerminalReassignmentRequestJsonConverter))]
    public partial class TerminalReassignmentRequest
    {
        /// <summary>
    ...
    public class TerminalReassignmentRequestJsonConverter : JsonConverter<TerminalReassignmentRequest>
    {
        ...
        public override TerminalReassignmentRequest Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (inventory.IsSet)
                terminalReassignmentRequest.Inventory = inventory.Value;
            if (merchantId.IsSet)
                terminalReassignmentRequest.MerchantId = merchantId.Value;
            if (storeId.IsSet)
                terminalReassignmentRequest.StoreId = storeId.Value;
            return terminalReassignmentRequest;
        }
