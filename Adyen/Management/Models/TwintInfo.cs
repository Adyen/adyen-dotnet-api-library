    ...
    public class TwintInfoJsonConverter : JsonConverter<TwintInfo>
    {
        ...
        public override TwintInfo Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (logo.IsSet && logo.Value == null)
                throw new ArgumentNullException(nameof(logo), "Property is not nullable for class TwintInfo.");
        ...
        public void WriteProperties(Utf8JsonWriter writer, TwintInfo twintInfo, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (twintInfo.Logo == null)
                throw new ArgumentNullException(nameof(twintInfo.Logo), "Property is required for class TwintInfo.");
