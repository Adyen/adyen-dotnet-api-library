...
namespace Adyen.Management.Models
{
    ...
    /// AccelInfo.
    /// </summary>
    public partial class AccelInfo : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AccelInfo" /> class.
        /// </summary>
    ...
    /// <summary>
    /// A Json converter for type <see cref="AccelInfo" />
    /// </summary>
    public class AccelInfoJsonConverter : JsonConverter<AccelInfo>
    {
        /// <summary>
        /// Deserializes json to <see cref="AccelInfo"/>.
        /// </summary>
        /// <param name="utf8JsonReader"><see cref="Utf8JsonReader"/></param>
        /// <param name="typeToConvert"><see cref="Type"/></param>
        /// <param name="jsonSerializerOptions">The <see cref="JsonSerializerOptions"/>, initialized from <see cref="HostConfiguration"/>.</param>
        /// <returns><see cref="AccelInfo"/></returns>
        /// <exception cref="JsonException"></exception>
        public override AccelInfo Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            Option<AccelInfo.ProcessingTypeEnum?> processingType = default;
                ...
                if (utf8JsonReader.TokenType == JsonTokenType.PropertyName && currentDepth == utf8JsonReader.CurrentDepth - 1)
                {
                    ...
                    switch (jsonPropertyName)
                    {
                        case "processingType":
                            ...
                            processingType = new Option<AccelInfo.ProcessingTypeEnum?>(AccelInfo.ProcessingTypeEnum.FromStringOrDefault(processingTypeRawValue));
                            break;
            ...
            if (processingType.IsSet && processingType.Value == null)
                throw new ArgumentNullException(nameof(processingType), "Property is not nullable for class AccelInfo.");

            if (transactionDescription.IsSet && transactionDescription.Value == null)
                throw new ArgumentNullException(nameof(transactionDescription), "Property is not nullable for class AccelInfo.");

            return new AccelInfo(processingType.Value!.Value!, transactionDescription);
        }

        /// <summary>
        /// Serializes a <see cref="AccelInfo"/>.
        /// </summary>
        /// <param name="writer"><see cref="Utf8JsonWriter"/></param>
        /// <param name="accelInfo"></param>
        /// <param name="jsonSerializerOptions"><see cref="JsonSerializerOptions"/></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, AccelInfo accelInfo, JsonSerializerOptions jsonSerializerOptions)
        {
            
            writer.WriteStartObject();
            
            WriteProperties(writer, accelInfo, jsonSerializerOptions);
        ...
        /// <summary>
        /// Serializes the properties of <see cref="AccelInfo"/>.
        /// </summary>
        /// <param name="writer"><see creft="Utf8JsonWriter"/></param>
        /// <param name="accelInfo"></param>
        /// <param name="jsonSerializerOptions"><see cref="JsonSerializerOptions"/></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, AccelInfo accelInfo, JsonSerializerOptions jsonSerializerOptions)
        {
            /*
            if (accelInfo._TransactionDescriptionOption.IsSet && accelInfo.TransactionDescription == null)
                throw new ArgumentNullException(nameof(accelInfo.TransactionDescription), "Property is required for class AccelInfo.");

            */
            
            if (accelInfo.ProcessingType != null) 
            {
                string? processingTypeRawValue = AccelInfo.ProcessingTypeEnum.ToJsonValue(accelInfo.ProcessingType);
                writer.WriteString("processingType", processingTypeRawValue);
            }
            
            if (accelInfo._TransactionDescriptionOption.IsSet)
            {
                writer.WritePropertyName("transactionDescription");
                JsonSerializer.Serialize(writer, accelInfo.TransactionDescription, jsonSerializerOptions);
            }
        }
    }
}
