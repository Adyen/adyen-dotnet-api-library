...
namespace Adyen.Management.Models
{
    ...
    /// UpdatableAddress.
    /// </summary>
    [JsonConverter(typeof(UpdatableAddressJsonConverter))]
    ...
    public class UpdatableAddressJsonConverter : JsonConverter<UpdatableAddress>
    {
        ...
        public override UpdatableAddress Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (line1.IsSet)
                updatableAddress.Line1 = line1.Value;
            if (line2.IsSet)
                updatableAddress.Line2 = line2.Value;
            if (line3.IsSet)
                updatableAddress.Line3 = line3.Value;
            if (postalCode.IsSet)
                updatableAddress.PostalCode = postalCode.Value;
            if (stateOrProvince.IsSet)
                updatableAddress.StateOrProvince = stateOrProvince.Value;
