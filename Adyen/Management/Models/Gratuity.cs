...
namespace Adyen.Management.Models
{
    ...
    /// Gratuity.
    /// </summary>
    [JsonConverter(typeof(GratuityJsonConverter))]
    ...
    public class GratuityJsonConverter : JsonConverter<Gratuity>
    {
        ...
        public override Gratuity Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (currency.IsSet)
                gratuity.Currency = currency.Value;
            if (predefinedTipEntries.IsSet)
                gratuity.PredefinedTipEntries = predefinedTipEntries.Value;
            if (usePredefinedTipEntries.IsSet)
                gratuity.UsePredefinedTipEntries = usePredefinedTipEntries.Value;
            return gratuity;
        }
