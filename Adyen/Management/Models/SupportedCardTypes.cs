...
namespace Adyen.Management.Models
{
    ...
    /// SupportedCardTypes.
    /// </summary>
    [JsonConverter(typeof(SupportedCardTypesJsonConverter))]
    public partial class SupportedCardTypes
    {
        /// <summary>
    ...
    public class SupportedCardTypesJsonConverter : JsonConverter<SupportedCardTypes>
    {
        ...
        public override SupportedCardTypes Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (debit.IsSet)
                supportedCardTypes.Debit = debit.Value;
            if (deferredDebit.IsSet)
                supportedCardTypes.DeferredDebit = deferredDebit.Value;
            if (prepaid.IsSet)
                supportedCardTypes.Prepaid = prepaid.Value;
            if (unknown.IsSet)
                supportedCardTypes.Unknown = unknown.Value;
