...
namespace Adyen.Management.Models
{
    ...
    /// </summary>
    public partial class UninstallAndroidAppDetails : IValidatableObject
    {
        /// <summary>
    ...
    /// <summary>
    /// A Json converter for type <see cref="UninstallAndroidAppDetails" />
    /// </summary>
    public class UninstallAndroidAppDetailsJsonConverter : JsonConverter<UninstallAndroidAppDetails>
    {
        /// <summary>
        /// Deserializes json to <see cref="UninstallAndroidAppDetails"/>.
        /// </summary>
        /// <param name="utf8JsonReader"><see cref="Utf8JsonReader"/></param>
        /// <param name="typeToConvert"><see cref="Type"/></param>
        /// <param name="jsonSerializerOptions">The <see cref="JsonSerializerOptions"/>, initialized from <see cref="HostConfiguration"/>.</param>
        /// <returns><see cref="UninstallAndroidAppDetails"/></returns>
        /// <exception cref="JsonException"></exception>
        public override UninstallAndroidAppDetails Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            Option<UninstallAndroidAppDetails.TypeEnum?> type = default;
            ...
            if (appId.IsSet && appId.Value == null)
                throw new ArgumentNullException(nameof(appId), "Property is not nullable for class UninstallAndroidAppDetails.");

            if (type.IsSet && type.Value == null)
                throw new ArgumentNullException(nameof(type), "Property is not nullable for class UninstallAndroidAppDetails.");

            return new UninstallAndroidAppDetails(appId, type);
        }

        /// <summary>
        /// Serializes a <see cref="UninstallAndroidAppDetails"/>.
        /// </summary>
        /// <param name="writer"><see cref="Utf8JsonWriter"/></param>
        /// <param name="uninstallAndroidAppDetails"></param>
        /// <param name="jsonSerializerOptions"><see cref="JsonSerializerOptions"/></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, UninstallAndroidAppDetails uninstallAndroidAppDetails, JsonSerializerOptions jsonSerializerOptions)
        {
        ...
        /// <summary>
        /// Serializes the properties of <see cref="UninstallAndroidAppDetails"/>.
        /// </summary>
        /// <param name="writer"><see creft="Utf8JsonWriter"/></param>
        /// <param name="uninstallAndroidAppDetails"></param>
        /// <param name="jsonSerializerOptions"><see cref="JsonSerializerOptions"/></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, UninstallAndroidAppDetails uninstallAndroidAppDetails, JsonSerializerOptions jsonSerializerOptions)
        {
            /*
            if (uninstallAndroidAppDetails._AppIdOption.IsSet && uninstallAndroidAppDetails.AppId == null)
                throw new ArgumentNullException(nameof(uninstallAndroidAppDetails.AppId), "Property is required for class UninstallAndroidAppDetails.");

            */
            
            if (uninstallAndroidAppDetails._AppIdOption.IsSet)
                writer.WriteString("appId", uninstallAndroidAppDetails.AppId);

            if (uninstallAndroidAppDetails._TypeOption.IsSet && uninstallAndroidAppDetails.Type != null) 
            {
                string? typeRawValue = UninstallAndroidAppDetails.TypeEnum.ToJsonValue(uninstallAndroidAppDetails._TypeOption.Value!.Value);
