    ...
    public class CompanyApiCredentialJsonConverter : JsonConverter<CompanyApiCredential>
    {
        ...
        public override CompanyApiCredential Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (active.IsSet && active.Value == null)
                throw new ArgumentNullException(nameof(active), "Property is not nullable for class CompanyApiCredential.");

            if (allowedIpAddresses.IsSet && allowedIpAddresses.Value == null)
                throw new ArgumentNullException(nameof(allowedIpAddresses), "Property is not nullable for class CompanyApiCredential.");

            if (clientKey.IsSet && clientKey.Value == null)
                throw new ArgumentNullException(nameof(clientKey), "Property is not nullable for class CompanyApiCredential.");

            if (id.IsSet && id.Value == null)
                throw new ArgumentNullException(nameof(id), "Property is not nullable for class CompanyApiCredential.");

            if (roles.IsSet && roles.Value == null)
                throw new ArgumentNullException(nameof(roles), "Property is not nullable for class CompanyApiCredential.");

            if (username.IsSet && username.Value == null)
                throw new ArgumentNullException(nameof(username), "Property is not nullable for class CompanyApiCredential.");

            if (links.IsSet && links.Value == null)
                throw new ArgumentNullException(nameof(links), "Property is not nullable for class CompanyApiCredential.");

            if (allowedOrigins.IsSet && allowedOrigins.Value == null)
                throw new ArgumentNullException(nameof(allowedOrigins), "Property is not nullable for class CompanyApiCredential.");

            if (associatedMerchantAccounts.IsSet && associatedMerchantAccounts.Value == null)
                throw new ArgumentNullException(nameof(associatedMerchantAccounts), "Property is not nullable for class CompanyApiCredential.");

            if (description.IsSet && description.Value == null)
                throw new ArgumentNullException(nameof(description), "Property is not nullable for class CompanyApiCredential.");
        ...
        {
            /*
            if (companyApiCredential.AllowedIpAddresses == null)
                throw new ArgumentNullException(nameof(companyApiCredential.AllowedIpAddresses), "Property is required for class CompanyApiCredential.");

            if (companyApiCredential.ClientKey == null)
                throw new ArgumentNullException(nameof(companyApiCredential.ClientKey), "Property is required for class CompanyApiCredential.");

            if (companyApiCredential.Id == null)
                throw new ArgumentNullException(nameof(companyApiCredential.Id), "Property is required for class CompanyApiCredential.");

            if (companyApiCredential.Roles == null)
                throw new ArgumentNullException(nameof(companyApiCredential.Roles), "Property is required for class CompanyApiCredential.");

            if (companyApiCredential.Username == null)
                throw new ArgumentNullException(nameof(companyApiCredential.Username), "Property is required for class CompanyApiCredential.");

            if (companyApiCredential._LinksOption.IsSet && companyApiCredential.Links == null)
                throw new ArgumentNullException(nameof(companyApiCredential.Links), "Property is required for class CompanyApiCredential.");

            if (companyApiCredential._AllowedOriginsOption.IsSet && companyApiCredential.AllowedOrigins == null)
                throw new ArgumentNullException(nameof(companyApiCredential.AllowedOrigins), "Property is required for class CompanyApiCredential.");

            if (companyApiCredential._AssociatedMerchantAccountsOption.IsSet && companyApiCredential.AssociatedMerchantAccounts == null)
                throw new ArgumentNullException(nameof(companyApiCredential.AssociatedMerchantAccounts), "Property is required for class CompanyApiCredential.");

            if (companyApiCredential._DescriptionOption.IsSet && companyApiCredential.Description == null)
                throw new ArgumentNullException(nameof(companyApiCredential.Description), "Property is required for class CompanyApiCredential.");
