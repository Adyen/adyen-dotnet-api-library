...
namespace Adyen.Management.Models
{
    ...
    /// </summary>
    [JsonConverter(typeof(CompanyApiCredentialJsonConverter))]
    ...
    public class CompanyApiCredentialJsonConverter : JsonConverter<CompanyApiCredential>
    {
        ...
        public override CompanyApiCredential Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            var companyApiCredential = new CompanyApiCredential();
            companyApiCredential.Active = active.Value!.Value;
            companyApiCredential.AllowedIpAddresses = allowedIpAddresses.Value!;
            companyApiCredential.ClientKey = clientKey.Value!;
            companyApiCredential.Id = id.Value!;
            companyApiCredential.Roles = roles.Value!;
            companyApiCredential.Username = username.Value!;
            if (links.IsSet)
                companyApiCredential.Links = links.Value;
            if (allowedOrigins.IsSet)
                companyApiCredential.AllowedOrigins = allowedOrigins.Value;
            if (associatedMerchantAccounts.IsSet)
                companyApiCredential.AssociatedMerchantAccounts = associatedMerchantAccounts.Value;
            if (description.IsSet)
                companyApiCredential.Description = description.Value;
            if (subjectDN.IsSet)
                companyApiCredential.SubjectDN = subjectDN.Value;
        ...
        public void WriteProperties(Utf8JsonWriter writer, CompanyApiCredential companyApiCredential, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (companyApiCredential._SubjectDNOption.IsSet)
                if (companyApiCredential.SubjectDN != null)
                    writer.WriteString("subjectDN", companyApiCredential.SubjectDN);
        }
    }
}
