...
namespace Adyen.Management.Models
{
    ...
    public partial class PulseResponseInfo
    {
        ...
        public PulseResponseInfo(ProcessingTypeEnum processingType, Option<TransactionDescriptionResponseInfo?> transactionDescription = default)
        {
    ...
    public class PulseResponseInfoJsonConverter : JsonConverter<PulseResponseInfo>
    {
        ...
        public override PulseResponseInfo Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
                ...
                if (utf8JsonReader.TokenType == JsonTokenType.PropertyName && currentDepth == utf8JsonReader.CurrentDepth - 1)
                {
                    ...
                    switch (jsonPropertyName)
                    {
                        case "processingType":
                            ...
                            processingType = new Option<PulseResponseInfo.ProcessingTypeEnum?>(PulseResponseInfo.ProcessingTypeEnum.FromStringOrDefault(processingTypeRawValue));
                            break;
            ...
            return new PulseResponseInfo(processingType.Value!.Value!, transactionDescription);
        }
