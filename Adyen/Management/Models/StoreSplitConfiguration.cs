...
namespace Adyen.Management.Models
{
    ...
    /// </summary>
    public partial class StoreSplitConfiguration : IValidatableObject
    {
        /// <summary>
    ...
    public class StoreSplitConfigurationJsonConverter : JsonConverter<StoreSplitConfiguration>
    {
        ...
        public override StoreSplitConfiguration Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (balanceAccountId.IsSet && balanceAccountId.Value == null)
                throw new ArgumentNullException(nameof(balanceAccountId), "Property is not nullable for class StoreSplitConfiguration.");

            if (splitConfigurationId.IsSet && splitConfigurationId.Value == null)
                throw new ArgumentNullException(nameof(splitConfigurationId), "Property is not nullable for class StoreSplitConfiguration.");
        ...
        {
            /*
            if (storeSplitConfiguration._BalanceAccountIdOption.IsSet && storeSplitConfiguration.BalanceAccountId == null)
                throw new ArgumentNullException(nameof(storeSplitConfiguration.BalanceAccountId), "Property is required for class StoreSplitConfiguration.");

            if (storeSplitConfiguration._SplitConfigurationIdOption.IsSet && storeSplitConfiguration.SplitConfigurationId == null)
                throw new ArgumentNullException(nameof(storeSplitConfiguration.SplitConfigurationId), "Property is required for class StoreSplitConfiguration.");
