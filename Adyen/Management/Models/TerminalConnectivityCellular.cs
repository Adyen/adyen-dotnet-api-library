    ...
    public class TerminalConnectivityCellularJsonConverter : JsonConverter<TerminalConnectivityCellular>
    {
        ...
        public override TerminalConnectivityCellular Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (iccid.IsSet && iccid.Value == null)
                throw new ArgumentNullException(nameof(iccid), "Property is not nullable for class TerminalConnectivityCellular.");

            if (iccid2.IsSet && iccid2.Value == null)
                throw new ArgumentNullException(nameof(iccid2), "Property is not nullable for class TerminalConnectivityCellular.");

            if (status.IsSet && status.Value == null)
                throw new ArgumentNullException(nameof(status), "Property is not nullable for class TerminalConnectivityCellular.");
        ...
        {
            /*
            if (terminalConnectivityCellular._IccidOption.IsSet && terminalConnectivityCellular.Iccid == null)
                throw new ArgumentNullException(nameof(terminalConnectivityCellular.Iccid), "Property is required for class TerminalConnectivityCellular.");

            if (terminalConnectivityCellular._Iccid2Option.IsSet && terminalConnectivityCellular.Iccid2 == null)
                throw new ArgumentNullException(nameof(terminalConnectivityCellular.Iccid2), "Property is required for class TerminalConnectivityCellular.");
