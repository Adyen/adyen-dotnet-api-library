...
namespace Adyen.Management.Models
{
    ...
    public class SodexoInfoJsonConverter : JsonConverter<SodexoInfo>
    {
        ...
        public override SodexoInfo Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (merchantContactPhone.IsSet && merchantContactPhone.Value == null)
                throw new ArgumentNullException(nameof(merchantContactPhone), "Property is not nullable for class SodexoInfo.");
        ...
        public void WriteProperties(Utf8JsonWriter writer, SodexoInfo sodexoInfo, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (sodexoInfo.MerchantContactPhone == null)
                throw new ArgumentNullException(nameof(sodexoInfo.MerchantContactPhone), "Property is required for class SodexoInfo.");
