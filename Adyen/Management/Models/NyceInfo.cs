...
namespace Adyen.Management.Models
{
    ...
    /// NyceInfo.
    /// </summary>
    [JsonConverter(typeof(NyceInfoJsonConverter))]
    public partial class NyceInfo
    {
        /// <summary>
    ...
    /// <summary>
    /// A Json converter for type <see cref="NyceInfo" />
    /// </summary>
    public class NyceInfoJsonConverter : JsonConverter<NyceInfo>
    {
        /// <summary>
        /// Deserializes json to <see cref="NyceInfo"/>.
        /// </summary>
        /// <param name="utf8JsonReader"><see cref="Utf8JsonReader"/>.</param>
        /// <param name="typeToConvert"><see cref="Type"/>.</param>
        /// <param name="jsonSerializerOptions">The <see cref="JsonSerializerOptions"/>, initialized from <see cref="HostConfiguration"/>.</param>
        /// <returns><see cref="NyceInfo"/>.</returns>
        /// <exception cref="JsonException"></exception>
        public override NyceInfo Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            Option<NyceInfo.ProcessingTypeEnum?> processingType = default;
                ...
                if (utf8JsonReader.TokenType == JsonTokenType.PropertyName && currentDepth == utf8JsonReader.CurrentDepth - 1)
                {
                    ...
                    switch (jsonPropertyName)
                    {
                        case "processingType":
                            ...
                            processingType = new Option<NyceInfo.ProcessingTypeEnum?>(NyceInfo.ProcessingTypeEnum.FromStringOrDefault(processingTypeRawValue) ?? (NyceInfo.ProcessingTypeEnum)processingTypeRawValue);
                            break;
            ...
            var nyceInfo = new NyceInfo();
            nyceInfo.ProcessingType = processingType.Value!;
            if (transactionDescription.IsSet)
                nyceInfo.TransactionDescription = transactionDescription.Value;
            return nyceInfo;
        }

        /// <summary>
        /// Serializes a <see cref="NyceInfo"/>.
        /// </summary>
        ...
        /// <summary>
        /// Serializes the properties of <see cref="NyceInfo"/>.
        /// </summary>
        /// <param name="writer"><see cref="Utf8JsonWriter"/></param>
        /// <param name="nyceInfo"></param>
        /// <param name="jsonSerializerOptions"><see cref="JsonSerializerOptions"/></param>
        public void WriteProperties(Utf8JsonWriter writer, NyceInfo nyceInfo, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (nyceInfo.ProcessingType != null) 
            {
                string? processingTypeRawValue = NyceInfo.ProcessingTypeEnum.ToJsonValue(nyceInfo.ProcessingType);
                writer.WriteString("processingType", processingTypeRawValue);
            }
            
            if (nyceInfo._TransactionDescriptionOption.IsSet)
            {
                writer.WritePropertyName("transactionDescription");
                JsonSerializer.Serialize(writer, nyceInfo.TransactionDescription, jsonSerializerOptions);
            }
        }
    }
}
