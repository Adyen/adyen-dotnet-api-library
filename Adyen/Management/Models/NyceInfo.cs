...
namespace Adyen.Management.Models
{
    ...
    /// NyceInfo.
    /// </summary>
    public partial class NyceInfo : IValidatableObject
    {
        /// <summary>
        ...
        [JsonConstructor]
        public NyceInfo(ProcessingTypeEnum processingType, Option<TransactionDescriptionInfo?> transactionDescription = default)
        {
    ...
    public class NyceInfoJsonConverter : JsonConverter<NyceInfo>
    {
        ...
        public override NyceInfo Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
                ...
                if (utf8JsonReader.TokenType == JsonTokenType.PropertyName && currentDepth == utf8JsonReader.CurrentDepth - 1)
                {
                    ...
                    switch (jsonPropertyName)
                    {
                        case "processingType":
                            ...
                            processingType = new Option<NyceInfo.ProcessingTypeEnum?>(NyceInfo.ProcessingTypeEnum.FromStringOrDefault(processingTypeRawValue));
                            break;
            ...
            if (processingType.IsSet && processingType.Value == null)
                throw new ArgumentNullException(nameof(processingType), "Property is not nullable for class NyceInfo.");

            if (transactionDescription.IsSet && transactionDescription.Value == null)
                throw new ArgumentNullException(nameof(transactionDescription), "Property is not nullable for class NyceInfo.");
        ...
        {
            /*
            if (nyceInfo._TransactionDescriptionOption.IsSet && nyceInfo.TransactionDescription == null)
                throw new ArgumentNullException(nameof(nyceInfo.TransactionDescription), "Property is required for class NyceInfo.");
