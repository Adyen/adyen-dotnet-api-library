...
namespace Adyen.Management.Models
{
    ...
    /// </summary>
    [JsonConverter(typeof(UpdateMerchantApiCredentialRequestJsonConverter))]
    ...
    public class UpdateMerchantApiCredentialRequestJsonConverter : JsonConverter<UpdateMerchantApiCredentialRequest>
    {
        ...
        public override UpdateMerchantApiCredentialRequest Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (allowedOrigins.IsSet)
                updateMerchantApiCredentialRequest.AllowedOrigins = allowedOrigins.Value;
            if (description.IsSet)
                updateMerchantApiCredentialRequest.Description = description.Value;
            if (roles.IsSet)
                updateMerchantApiCredentialRequest.Roles = roles.Value;
            if (subjectDN.IsSet)
                updateMerchantApiCredentialRequest.SubjectDN = subjectDN.Value;
            return updateMerchantApiCredentialRequest;
        }
