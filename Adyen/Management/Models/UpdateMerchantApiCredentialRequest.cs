...
namespace Adyen.Management.Models
{
    ...
    public partial class UpdateMerchantApiCredentialRequest
    {
        ...
        public UpdateMerchantApiCredentialRequest(Option<bool?> active = default, Option<List<string>?> allowedOrigins = default, Option<string?> description = default, Option<List<string>?> roles = default, Option<string?> subjectDN = default)
        {
    ...
    public class UpdateMerchantApiCredentialRequestJsonConverter : JsonConverter<UpdateMerchantApiCredentialRequest>
    {
        ...
        public override UpdateMerchantApiCredentialRequest Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            return new UpdateMerchantApiCredentialRequest(active, allowedOrigins, description, roles, subjectDN);
        }
        ...
        public void WriteProperties(Utf8JsonWriter writer, UpdateMerchantApiCredentialRequest updateMerchantApiCredentialRequest, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (updateMerchantApiCredentialRequest._DescriptionOption.IsSet)
                if (updateMerchantApiCredentialRequest.Description != null)
            ...
            if (updateMerchantApiCredentialRequest._SubjectDNOption.IsSet)
                if (updateMerchantApiCredentialRequest.SubjectDN != null)
                    writer.WriteString("subjectDN", updateMerchantApiCredentialRequest.SubjectDN);
        }
    }
}
