...
namespace Adyen.Management.Models
{
    ...
    /// </summary>
    [JsonConverter(typeof(CreateCompanyUserRequestJsonConverter))]
    ...
    public class CreateCompanyUserRequestJsonConverter : JsonConverter<CreateCompanyUserRequest>
    {
        ...
        public override CreateCompanyUserRequest Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (associatedMerchantAccounts.IsSet)
                createCompanyUserRequest.AssociatedMerchantAccounts = associatedMerchantAccounts.Value;
            if (loginMethod.IsSet)
                createCompanyUserRequest.LoginMethod = loginMethod.Value;
            if (roles.IsSet)
                createCompanyUserRequest.Roles = roles.Value;
            if (timeZoneCode.IsSet)
                createCompanyUserRequest.TimeZoneCode = timeZoneCode.Value;
