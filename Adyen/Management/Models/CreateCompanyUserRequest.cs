    ...
    public class CreateCompanyUserRequestJsonConverter : JsonConverter<CreateCompanyUserRequest>
    {
        ...
        public override CreateCompanyUserRequest Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (email.IsSet && email.Value == null)
                throw new ArgumentNullException(nameof(email), "Property is not nullable for class CreateCompanyUserRequest.");

            if (name.IsSet && name.Value == null)
                throw new ArgumentNullException(nameof(name), "Property is not nullable for class CreateCompanyUserRequest.");

            if (username.IsSet && username.Value == null)
                throw new ArgumentNullException(nameof(username), "Property is not nullable for class CreateCompanyUserRequest.");

            if (accountGroups.IsSet && accountGroups.Value == null)
                throw new ArgumentNullException(nameof(accountGroups), "Property is not nullable for class CreateCompanyUserRequest.");

            if (associatedMerchantAccounts.IsSet && associatedMerchantAccounts.Value == null)
                throw new ArgumentNullException(nameof(associatedMerchantAccounts), "Property is not nullable for class CreateCompanyUserRequest.");

            if (loginMethod.IsSet && loginMethod.Value == null)
                throw new ArgumentNullException(nameof(loginMethod), "Property is not nullable for class CreateCompanyUserRequest.");

            if (roles.IsSet && roles.Value == null)
                throw new ArgumentNullException(nameof(roles), "Property is not nullable for class CreateCompanyUserRequest.");

            if (timeZoneCode.IsSet && timeZoneCode.Value == null)
                throw new ArgumentNullException(nameof(timeZoneCode), "Property is not nullable for class CreateCompanyUserRequest.");
        ...
        public void WriteProperties(Utf8JsonWriter writer, CreateCompanyUserRequest createCompanyUserRequest, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (createCompanyUserRequest.Email == null)
                throw new ArgumentNullException(nameof(createCompanyUserRequest.Email), "Property is required for class CreateCompanyUserRequest.");

            if (createCompanyUserRequest.Name == null)
                throw new ArgumentNullException(nameof(createCompanyUserRequest.Name), "Property is required for class CreateCompanyUserRequest.");

            if (createCompanyUserRequest.Username == null)
                throw new ArgumentNullException(nameof(createCompanyUserRequest.Username), "Property is required for class CreateCompanyUserRequest.");

            if (createCompanyUserRequest._AccountGroupsOption.IsSet && createCompanyUserRequest.AccountGroups == null)
                throw new ArgumentNullException(nameof(createCompanyUserRequest.AccountGroups), "Property is required for class CreateCompanyUserRequest.");

            if (createCompanyUserRequest._AssociatedMerchantAccountsOption.IsSet && createCompanyUserRequest.AssociatedMerchantAccounts == null)
                throw new ArgumentNullException(nameof(createCompanyUserRequest.AssociatedMerchantAccounts), "Property is required for class CreateCompanyUserRequest.");

            if (createCompanyUserRequest._LoginMethodOption.IsSet && createCompanyUserRequest.LoginMethod == null)
                throw new ArgumentNullException(nameof(createCompanyUserRequest.LoginMethod), "Property is required for class CreateCompanyUserRequest.");

            if (createCompanyUserRequest._RolesOption.IsSet && createCompanyUserRequest.Roles == null)
                throw new ArgumentNullException(nameof(createCompanyUserRequest.Roles), "Property is required for class CreateCompanyUserRequest.");

            if (createCompanyUserRequest._TimeZoneCodeOption.IsSet && createCompanyUserRequest.TimeZoneCode == null)
                throw new ArgumentNullException(nameof(createCompanyUserRequest.TimeZoneCode), "Property is required for class CreateCompanyUserRequest.");
