...
namespace Adyen.Management.Models
{
    ...
    /// </summary>
    [JsonConverter(typeof(ScheduleTerminalActionsResponseJsonConverter))]
    public partial class ScheduleTerminalActionsResponse
    {
        /// <summary>
    ...
    public class ScheduleTerminalActionsResponseJsonConverter : JsonConverter<ScheduleTerminalActionsResponse>
    {
        ...
        public override ScheduleTerminalActionsResponse Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            var scheduleTerminalActionsResponse = new ScheduleTerminalActionsResponse();
            if (actionDetails.IsSet)
                scheduleTerminalActionsResponse.ActionDetails = actionDetails.Value;
            if (items.IsSet)
                scheduleTerminalActionsResponse.Items = items.Value;
            if (scheduledAt.IsSet)
                scheduleTerminalActionsResponse.ScheduledAt = scheduledAt.Value;
            if (storeId.IsSet)
                scheduleTerminalActionsResponse.StoreId = storeId.Value;
            if (terminalsWithErrors.IsSet)
                scheduleTerminalActionsResponse.TerminalsWithErrors = terminalsWithErrors.Value;
            if (totalErrors.IsSet)
                scheduleTerminalActionsResponse.TotalErrors = totalErrors.Value;
            if (totalScheduled.IsSet)
                scheduleTerminalActionsResponse.TotalScheduled = totalScheduled.Value;
