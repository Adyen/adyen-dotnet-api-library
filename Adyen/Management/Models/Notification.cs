    ...
    public class NotificationJsonConverter : JsonConverter<Notification>
    {
        ...
        public override Notification Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (category.IsSet && category.Value == null)
                throw new ArgumentNullException(nameof(category), "Property is not nullable for class Notification.");

            if (details.IsSet && details.Value == null)
                throw new ArgumentNullException(nameof(details), "Property is not nullable for class Notification.");
            ...
            if (showButton.IsSet && showButton.Value == null)
                throw new ArgumentNullException(nameof(showButton), "Property is not nullable for class Notification.");
        ...
        {
            /*
            if (notification._DetailsOption.IsSet && notification.Details == null)
                throw new ArgumentNullException(nameof(notification.Details), "Property is required for class Notification.");

            if (notification._TitleOption.IsSet && notification.Title == null)
