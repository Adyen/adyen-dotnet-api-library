...
namespace Adyen.Management.Models
{
    ...
    public class HardwareJsonConverter : JsonConverter<Hardware>
    {
        ...
        public override Hardware Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (displayMaximumBackLight.IsSet && displayMaximumBackLight.Value == null)
                throw new ArgumentNullException(nameof(displayMaximumBackLight), "Property is not nullable for class Hardware.");

            if (resetTotalsHour.IsSet && resetTotalsHour.Value == null)
                throw new ArgumentNullException(nameof(resetTotalsHour), "Property is not nullable for class Hardware.");

            if (restartHour.IsSet && restartHour.Value == null)
                throw new ArgumentNullException(nameof(restartHour), "Property is not nullable for class Hardware.");
