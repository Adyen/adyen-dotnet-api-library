...
namespace Adyen.Management.Models
{
    ...
    /// </summary>
    [JsonConverter(typeof(UpdateMerchantUserRequestJsonConverter))]
    ...
    public class UpdateMerchantUserRequestJsonConverter : JsonConverter<UpdateMerchantUserRequest>
    {
        ...
        public override UpdateMerchantUserRequest Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (active.IsSet)
                updateMerchantUserRequest.Active = active.Value;
            if (email.IsSet)
                updateMerchantUserRequest.Email = email.Value;
            if (loginMethod.IsSet)
                updateMerchantUserRequest.LoginMethod = loginMethod.Value;
            if (name.IsSet)
                updateMerchantUserRequest.Name = name.Value;
            if (roles.IsSet)
                updateMerchantUserRequest.Roles = roles.Value;
            if (timeZoneCode.IsSet)
                updateMerchantUserRequest.TimeZoneCode = timeZoneCode.Value;
