...
namespace Adyen.Management.Extensions
{
    ...
    public static class ServiceCollectionExtensions
    {
        ...
        {            
            ...
            services.AddClientCertificatesCompanyLevelService(serviceLifetime, httpClientOptions, httpClientBuilderOptions);
            ...
            services.AddTerminalThemesCompanyLevelService(serviceLifetime, httpClientOptions, httpClientBuilderOptions);
            services.AddTerminalThemesMerchantLevelService(serviceLifetime, httpClientOptions, httpClientBuilderOptions);
            services.AddTerminalThemesStoreLevelService(serviceLifetime, httpClientOptions, httpClientBuilderOptions);
            services.AddTerminalThemesTerminalLevelService(serviceLifetime, httpClientOptions, httpClientBuilderOptions);
        ...
        /// <summary>
        /// Add <see cref="ClientCertificatesCompanyLevelService"/> as the implementation of <see cref="IClientCertificatesCompanyLevelService"/> to the Dependency Injection container <see cref="IServiceCollection"/>. 
        /// </summary>
        /// <param name="services"><see cref="IServiceCollection"/>.</param>
        /// <param name="serviceLifetime">Configures the <see cref="ServiceLifetime"/>, defaults to <see cref="ServiceLifetime.Singleton"/>.</param>
        /// <returns><see cref="IServiceCollection"/>.</returns>
        public static IServiceCollection AddClientCertificatesCompanyLevelService(this IServiceCollection services, ServiceLifetime serviceLifetime = ServiceLifetime.Singleton, Action<System.Net.Http.HttpClient>? httpClientOptions = null, Action<IHttpClientBuilder>? httpClientBuilderOptions = null)
        {
            services.AddSingleton<ClientCertificatesCompanyLevelServiceEvents>();

            services.Add(new ServiceDescriptor(typeof(IClientCertificatesCompanyLevelService), typeof(ClientCertificatesCompanyLevelService), serviceLifetime));

            IHttpClientBuilder builder = services.AddHttpClient<IClientCertificatesCompanyLevelService, ClientCertificatesCompanyLevelService>(typeof(IClientCertificatesCompanyLevelService).FullName!, httpClient =>
            {
                httpClientOptions?.Invoke(httpClient);
            });
        ...
        /// <summary>
        /// Add <see cref="TerminalThemesCompanyLevelService"/> as the implementation of <see cref="ITerminalThemesCompanyLevelService"/> to the Dependency Injection container <see cref="IServiceCollection"/>. 
        /// </summary>
        /// <param name="services"><see cref="IServiceCollection"/>.</param>
        /// <param name="serviceLifetime">Configures the <see cref="ServiceLifetime"/>, defaults to <see cref="ServiceLifetime.Singleton"/>.</param>
        /// <returns><see cref="IServiceCollection"/>.</returns>
        public static IServiceCollection AddTerminalThemesCompanyLevelService(this IServiceCollection services, ServiceLifetime serviceLifetime = ServiceLifetime.Singleton, Action<System.Net.Http.HttpClient>? httpClientOptions = null, Action<IHttpClientBuilder>? httpClientBuilderOptions = null)
        {
            services.AddSingleton<TerminalThemesCompanyLevelServiceEvents>();

            services.Add(new ServiceDescriptor(typeof(ITerminalThemesCompanyLevelService), typeof(TerminalThemesCompanyLevelService), serviceLifetime));

            IHttpClientBuilder builder = services.AddHttpClient<ITerminalThemesCompanyLevelService, TerminalThemesCompanyLevelService>(typeof(ITerminalThemesCompanyLevelService).FullName!, httpClient =>
            {
                httpClientOptions?.Invoke(httpClient);
            });
        ...
        /// <summary>
        /// Add <see cref="TerminalThemesMerchantLevelService"/> as the implementation of <see cref="ITerminalThemesMerchantLevelService"/> to the Dependency Injection container <see cref="IServiceCollection"/>. 
        /// </summary>
        /// <param name="services"><see cref="IServiceCollection"/>.</param>
        /// <param name="serviceLifetime">Configures the <see cref="ServiceLifetime"/>, defaults to <see cref="ServiceLifetime.Singleton"/>.</param>
        /// <returns><see cref="IServiceCollection"/>.</returns>
        public static IServiceCollection AddTerminalThemesMerchantLevelService(this IServiceCollection services, ServiceLifetime serviceLifetime = ServiceLifetime.Singleton, Action<System.Net.Http.HttpClient>? httpClientOptions = null, Action<IHttpClientBuilder>? httpClientBuilderOptions = null)
        {
            services.AddSingleton<TerminalThemesMerchantLevelServiceEvents>();

            services.Add(new ServiceDescriptor(typeof(ITerminalThemesMerchantLevelService), typeof(TerminalThemesMerchantLevelService), serviceLifetime));

            IHttpClientBuilder builder = services.AddHttpClient<ITerminalThemesMerchantLevelService, TerminalThemesMerchantLevelService>(typeof(ITerminalThemesMerchantLevelService).FullName!, httpClient =>
            {
                httpClientOptions?.Invoke(httpClient);
            });
        ...
        /// <summary>
        /// Add <see cref="TerminalThemesStoreLevelService"/> as the implementation of <see cref="ITerminalThemesStoreLevelService"/> to the Dependency Injection container <see cref="IServiceCollection"/>. 
        /// </summary>
        /// <param name="services"><see cref="IServiceCollection"/>.</param>
        /// <param name="serviceLifetime">Configures the <see cref="ServiceLifetime"/>, defaults to <see cref="ServiceLifetime.Singleton"/>.</param>
        /// <returns><see cref="IServiceCollection"/>.</returns>
        public static IServiceCollection AddTerminalThemesStoreLevelService(this IServiceCollection services, ServiceLifetime serviceLifetime = ServiceLifetime.Singleton, Action<System.Net.Http.HttpClient>? httpClientOptions = null, Action<IHttpClientBuilder>? httpClientBuilderOptions = null)
        {
            services.AddSingleton<TerminalThemesStoreLevelServiceEvents>();

            services.Add(new ServiceDescriptor(typeof(ITerminalThemesStoreLevelService), typeof(TerminalThemesStoreLevelService), serviceLifetime));

            IHttpClientBuilder builder = services.AddHttpClient<ITerminalThemesStoreLevelService, TerminalThemesStoreLevelService>(typeof(ITerminalThemesStoreLevelService).FullName!, httpClient =>
            {
                httpClientOptions?.Invoke(httpClient);
            });
        ...
        /// <summary>
        /// Add <see cref="TerminalThemesTerminalLevelService"/> as the implementation of <see cref="ITerminalThemesTerminalLevelService"/> to the Dependency Injection container <see cref="IServiceCollection"/>. 
        /// </summary>
        /// <param name="services"><see cref="IServiceCollection"/>.</param>
        /// <param name="serviceLifetime">Configures the <see cref="ServiceLifetime"/>, defaults to <see cref="ServiceLifetime.Singleton"/>.</param>
        /// <returns><see cref="IServiceCollection"/>.</returns>
        public static IServiceCollection AddTerminalThemesTerminalLevelService(this IServiceCollection services, ServiceLifetime serviceLifetime = ServiceLifetime.Singleton, Action<System.Net.Http.HttpClient>? httpClientOptions = null, Action<IHttpClientBuilder>? httpClientBuilderOptions = null)
        {
            services.AddSingleton<TerminalThemesTerminalLevelServiceEvents>();

            services.Add(new ServiceDescriptor(typeof(ITerminalThemesTerminalLevelService), typeof(TerminalThemesTerminalLevelService), serviceLifetime));

            IHttpClientBuilder builder = services.AddHttpClient<ITerminalThemesTerminalLevelService, TerminalThemesTerminalLevelService>(typeof(ITerminalThemesTerminalLevelService).FullName!, httpClient =>
            {
                httpClientOptions?.Invoke(httpClient);
            });
