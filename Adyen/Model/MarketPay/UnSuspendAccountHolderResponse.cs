...
namespace Adyen.Model.MarketPay
{
    ...
    /// </summary>
    [DataContract]
        public partial class UnSuspendAccountHolderResponse :  IEquatable<UnSuspendAccountHolderResponse>, IValidatableObject
    {
        /// <summary>
        ...
        public UnSuspendAccountHolderResponse(AccountHolderStatus accountHolderStatus = default(AccountHolderStatus), List<ErrorFieldType> invalidFields = default(List<ErrorFieldType>), string pspReference = default(string), string resultCode = default(string))
        {
            ...
            {
                throw new InvalidDataException("accountHolderStatus is a required property for UnSuspendAccountHolderResponse and cannot be null");
            }
            else
            {
        ...
        {
            return this.Equals(input as UnSuspendAccountHolderResponse);
        }
