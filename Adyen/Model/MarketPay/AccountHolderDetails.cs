...
namespace Adyen.Model.MarketPay
{
        ...
        public partial class AccountHolderDetails :  IEquatable<AccountHolderDetails>, IValidatableObject
    {
        ...
        /// <param name="bankAccountDetails">Array of bank accounts associated with the account holder. For details about the required &#x60;BankAccountDetail&#x60; fields, refer to [Bank account check](https://docs.adyen.com/platforms/verification-checks/bank-account-check)..</param>
        ...
        /// <param name="legalArrangements">An array containing information about the account holder&#x27;s [legal arrangements](https://docs.adyen.com/platforms/verification-checks/legal-arrangements)..</param>
        ...
        /// <param name="payoutMethods">Array of tokenized card details associated with the account holder. For details about how you can use the tokens to pay out, refer to [Pay out to cards](https://docs.adyen.com/platforms/payout-to-cards)..</param>
        /// <param name="principalBusinessAddress">principalBusinessAddress.</param>
        /// <param name="storeDetails">Array of stores associated with the account holder. Required when onboarding account holders that have an Adyen [point of sale](https://docs.adyen.com/platforms/platforms-for-pos)..</param>
        ...
        public AccountHolderDetails(ViasAddress address = default(ViasAddress), List<BankAccountDetail> bankAccountDetails = default(List<BankAccountDetail>), string bankAggregatorDataReference = default(string), BusinessDetails businessDetails = default(BusinessDetails), string email = default(string), string fullPhoneNumber = default(string), IndividualDetails individualDetails = default(IndividualDetails), string lastReviewDate = default(string), List<LegalArrangementDetail> legalArrangements = default(List<LegalArrangementDetail>), string merchantCategoryCode = default(string), Dictionary<string, string> metadata = default(Dictionary<string, string>), List<PayoutMethod> payoutMethods = default(List<PayoutMethod>), ViasAddress principalBusinessAddress = default(ViasAddress), List<StoreDetail> storeDetails = default(List<StoreDetail>), string webAddress = default(string))
        {
            ...
            // to ensure "fullPhoneNumber" is required (not null)
            if (fullPhoneNumber == null)
            {
                throw new InvalidDataException("fullPhoneNumber is a required property for AccountHolderDetails and cannot be null");
            }
            else
            {
                this.FullPhoneNumber = fullPhoneNumber;
            }
            // to ensure "webAddress" is required (not null)
            if (webAddress == null)
            {
                throw new InvalidDataException("webAddress is a required property for AccountHolderDetails and cannot be null");
            }
            else
            {
        ...
        /// </summary>
        /// <value>Array of bank accounts associated with the account holder. For details about the required &#x60;BankAccountDetail&#x60; fields, refer to [Bank account check](https://docs.adyen.com/platforms/verification-checks/bank-account-check).</value>
        ...
        /// </summary>
        /// <value>An array containing information about the account holder&#x27;s [legal arrangements](https://docs.adyen.com/platforms/verification-checks/legal-arrangements).</value>
        ...
        /// </summary>
        /// <value>Array of tokenized card details associated with the account holder. For details about how you can use the tokens to pay out, refer to [Pay out to cards](https://docs.adyen.com/platforms/payout-to-cards).</value>
        ...
        /// </summary>
        /// <value>Array of stores associated with the account holder. Required when onboarding account holders that have an Adyen [point of sale](https://docs.adyen.com/platforms/platforms-for-pos).</value>
