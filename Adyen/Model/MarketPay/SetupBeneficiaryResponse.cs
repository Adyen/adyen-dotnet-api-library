...
namespace Adyen.Model.MarketPay
{
    ...
    /// </summary>
    [DataContract]
    public class SetupBeneficiaryResponse : IEquatable<SetupBeneficiaryResponse>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SetupBeneficiaryResponse" /> class.
        /// </summary>
        ...
        public SetupBeneficiaryResponse(List<ErrorFieldType> invalidFields = default(List<ErrorFieldType>), string pspReference = default(string), string resultCode = default(string))
        {
            // to ensure "pspReference" is required (not null)
            if (pspReference == null)
            {
                throw new InvalidDataException("pspReference is a required property for SetupBeneficiaryResponse and cannot be null");
            }
            else
            {
        ...
        {
            return this.Equals(input as SetupBeneficiaryResponse);
        }

        /// <summary>
        /// Returns true if SetupBeneficiaryResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of SetupBeneficiaryResponse to be compared</param>
        /// <returns>Boolean</returns>
