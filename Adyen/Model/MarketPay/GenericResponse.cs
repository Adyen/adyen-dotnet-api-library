...
namespace Adyen.Model.MarketPay
{
    ...
    /// </summary>
    [DataContract]
        public class GenericResponse :  IEquatable<GenericResponse>, IValidatableObject
    {
        /// <summary>
        ...
        public GenericResponse(List<ErrorFieldType> invalidFields = default(List<ErrorFieldType>), string pspReference = default(string), string resultCode = default(string))
        {
            // to ensure "pspReference" is required (not null)
            if (pspReference == null)
            {
                throw new InvalidDataException("pspReference is a required property for GenericResponse and cannot be null");
            }
        ...
        {
            return Equals(input as GenericResponse);
        }
