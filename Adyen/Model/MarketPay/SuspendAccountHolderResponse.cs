...
namespace Adyen.Model.MarketPay
{
    ...
    /// </summary>
    [DataContract]
        public partial class SuspendAccountHolderResponse :  IEquatable<SuspendAccountHolderResponse>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SuspendAccountHolderResponse" /> class.
        /// </summary>
        ...
        public SuspendAccountHolderResponse(AccountHolderStatus accountHolderStatus = default(AccountHolderStatus), List<ErrorFieldType> invalidFields = default(List<ErrorFieldType>), string pspReference = default(string), string resultCode = default(string))
        {
            ...
            {
                throw new InvalidDataException("pspReference is a required property for SuspendAccountHolderResponse and cannot be null");
            }
            else
            {
        ...
        {
            return this.Equals(input as SuspendAccountHolderResponse);
        }

        /// <summary>
        /// Returns true if SuspendAccountHolderResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of SuspendAccountHolderResponse to be compared</param>
        /// <returns>Boolean</returns>
