...
namespace Adyen.Model.MarketPay
{
    ...
    /// </summary>
    [DataContract]
        public class SuspendAccountHolderResponse :  IEquatable<SuspendAccountHolderResponse>, IValidatableObject
    {
        /// <summary>
        ...
        {
            return Equals(input as SuspendAccountHolderResponse);
        }
