...
namespace Adyen.Model.Transfers
{
    ...
    public partial class UltimatePartyIdentification : IEquatable<UltimatePartyIdentification>, IValidatableObject
    {
        ...
        public UltimatePartyIdentification(Address address = default(Address), DateTime dateOfBirth = default(DateTime), string email = default(string), string firstName = default(string), string fullName = default(string), string lastName = default(string), string reference = default(string), TypeEnum? type = TypeEnum.Unknown, string url = default(string))
        {
