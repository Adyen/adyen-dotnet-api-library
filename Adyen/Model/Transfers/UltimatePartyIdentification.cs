...
namespace Adyen.Model.Transfers
{
    ...
    public partial class UltimatePartyIdentification : IEquatable<UltimatePartyIdentification>, IValidatableObject
    {
        ...
        public UltimatePartyIdentification(Address2 address = default(Address2), DateTime dateOfBirth = default(DateTime), string firstName = default(string), string fullName = default(string), string lastName = default(string), string reference = default(string), TypeEnum? type = TypeEnum.Unknown)
        {
