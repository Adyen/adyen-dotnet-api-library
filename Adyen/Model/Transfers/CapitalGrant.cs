...
namespace Adyen.Model.Transfers
{
    ...
    public partial class CapitalGrant : IEquatable<CapitalGrant>, IValidatableObject
    {
        ...
        public CapitalGrant(Amount amount = default(Amount), CapitalBalance balances = default(CapitalBalance), Counterparty2 counterparty = default(Counterparty2), Fee fee = default(Fee), string grantAccountId = default(string), string grantOfferId = default(string), string id = default(string), Repayment repayment = default(Repayment), StatusEnum status = default(StatusEnum))
        {
