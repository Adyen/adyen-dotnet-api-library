...
namespace Adyen.Model.TransferNotification
{
    ...
    public partial class TransferNotificationRequest : IEquatable<TransferNotificationRequest>, IValidatableObject
    {
        ...
        public TransferNotificationRequest(TransferNotificationData data = default(TransferNotificationData), string environment = default(string), TypeEnum? type = default(TypeEnum?))
        {
            this.Data = data;
        ...
        public TransferNotificationData Data { get; set; }
