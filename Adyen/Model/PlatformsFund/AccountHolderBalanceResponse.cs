...
namespace Adyen.Model.PlatformsFund
{
    ...
    /// </summary>
    [DataContract(Name = "AccountHolderBalanceResponse")]
    public partial class AccountHolderBalanceResponse : IEquatable<AccountHolderBalanceResponse>, IValidatableObject
    {
        ...
        /// </summary>
        /// <param name="balancePerAccount">A list of each account and their balances..</param>
        ...
        public AccountHolderBalanceResponse(List<AccountDetailBalance> balancePerAccount = default(List<AccountDetailBalance>), List<ErrorFieldType> invalidFields = default(List<ErrorFieldType>), string pspReference = default(string), string resultCode = default(string), DetailBalance totalBalance = default(DetailBalance))
        {
