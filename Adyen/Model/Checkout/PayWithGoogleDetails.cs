...
namespace Adyen.Model.Checkout
{
    ...
    public partial class PayWithGoogleDetails : IEquatable<PayWithGoogleDetails>, IValidatableObject
    {
        ...
        public PayWithGoogleDetails(FundingSourceEnum? fundingSource = default(FundingSourceEnum?), string googlePayToken = default(string), string recurringDetailReference = default(string), string storedPaymentMethodId = default(string), TypeEnum? type = TypeEnum.Paywithgoogle)
        {
