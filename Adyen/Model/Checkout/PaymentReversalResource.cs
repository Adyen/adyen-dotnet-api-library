...
namespace Adyen.Model.Checkout
{
    ...
    /// </summary>
    [DataContract(Name = "PaymentReversalResource")]
    public partial class PaymentReversalResource : IEquatable<PaymentReversalResource>, IValidatableObject
    {
        ...
        protected PaymentReversalResource() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="PaymentReversalResource" /> class.
        /// </summary>
        ...
        public PaymentReversalResource(string merchantAccount = default(string), string paymentPspReference = default(string), string pspReference = default(string), string reference = default(string), StatusEnum status = default(StatusEnum))
        {
