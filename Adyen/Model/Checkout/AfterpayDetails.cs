...
namespace Adyen.Model.Checkout
{
    ...
    public partial class AfterpayDetails : IEquatable<AfterpayDetails>, IValidatableObject
    {
        ...
        public AfterpayDetails(string billingAddress = default(string), string deliveryAddress = default(string), string personalDetails = default(string), string recurringDetailReference = default(string), string storedPaymentMethodId = default(string), TypeEnum type = TypeEnum.AfterpayDefault)
        {
            this.Type = type;
