...
namespace Adyen.Model.Checkout
{
    ...
    public partial class PixDetails : IEquatable<PixDetails>, IValidatableObject
    {
        ...
        public PixDetails(string checkoutAttemptId = default(string), PixRecurring pixRecurring = default(PixRecurring), string recurringDetailReference = default(string), string sdkData = default(string), string storedPaymentMethodId = default(string), TypeEnum? type = default(TypeEnum?))
        {
