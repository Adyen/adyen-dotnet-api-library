...
namespace Adyen.Model.Checkout
{
    ...
    public partial class PaymentAmountUpdateResource : IEquatable<PaymentAmountUpdateResource>, IValidatableObject
    {
        ...
        public PaymentAmountUpdateResource(Amount amount = default(Amount), string merchantAccount = default(string), string paymentPspReference = default(string), string pspReference = default(string), ReasonEnum? reason = default(ReasonEnum?), string reference = default(string), List<Split> splits = default(List<Split>), StatusEnum status = default(StatusEnum))
        {
            this.Amount = amount;
