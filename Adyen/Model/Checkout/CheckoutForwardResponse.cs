...
namespace Adyen.Model.Checkout
{
    ...
    public partial class CheckoutForwardResponse : IEquatable<CheckoutForwardResponse>, IValidatableObject
    {
        ...
        public CheckoutForwardResponse(string merchantReference = default(string), string pspReference = default(string), CheckoutForwardResponseFromUrl response = default(CheckoutForwardResponseFromUrl), string storedPaymentMethodId = default(string))
        {
