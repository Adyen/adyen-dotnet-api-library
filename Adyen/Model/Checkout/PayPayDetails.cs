...
namespace Adyen.Model.Checkout
{
    ...
    /// PayPayDetails
    /// </summary>
    [DataContract(Name = "PayPayDetails")]
    public partial class PayPayDetails : IEquatable<PayPayDetails>, IValidatableObject
    {
        /// <summary>
        /// **paypay**
        /// </summary>
        ...
        public PayPayDetails(string checkoutAttemptId = default(string), string recurringDetailReference = default(string), string sdkData = default(string), string storedPaymentMethodId = default(string), TypeEnum? type = TypeEnum.Paypay)
        {
        ...
        {
            return this.Equals(input as PayPayDetails);
        }

        /// <summary>
        /// Returns true if PayPayDetails instances are equal
        /// </summary>
        /// <param name="input">Instance of PayPayDetails to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PayPayDetails input)
        {
            if (input == null)
            {
                return false;
