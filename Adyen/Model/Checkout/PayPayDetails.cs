...
namespace Adyen.Model.Checkout
{
    ...
    public partial class PayPayDetails : IEquatable<PayPayDetails>, IValidatableObject
    {
        ...
        public PayPayDetails(string checkoutAttemptId = default(string), string recurringDetailReference = default(string), string storedPaymentMethodId = default(string), TypeEnum? type = TypeEnum.Paypay)
        {
