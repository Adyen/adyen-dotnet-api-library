...
namespace IO.Swagger.Model
{
        ...
        public partial class UpiDetails :  IEquatable<UpiDetails>, IValidatableObject
    {
        ...
        public UpiDetails(string recurringDetailReference = default(string), string shopperNotificationReference = default(string), string storedPaymentMethodId = default(string), SubscriptionDetails subscriptionDetails = default(SubscriptionDetails), string type = "upi", string virtualPaymentAddress = default(string))
        {
