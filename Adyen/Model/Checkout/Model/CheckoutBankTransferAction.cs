...
namespace IO.Swagger.Model
{
        ...
        public partial class CheckoutBankTransferAction :  IEquatable<CheckoutBankTransferAction>, IValidatableObject
    {
        ...
        public CheckoutBankTransferAction(string beneficiary = default(string), string bic = default(string), string downloadUrl = default(string), string iban = default(string), string paymentData = default(string), string paymentMethodType = default(string), string reference = default(string), string shopperEmail = default(string), Amount totalAmount = default(Amount), string type = default(string), string url = default(string))
        {
