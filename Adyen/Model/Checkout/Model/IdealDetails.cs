...
namespace IO.Swagger.Model
{
        ...
        public partial class IdealDetails :  IEquatable<IdealDetails>, IValidatableObject
    {
        ...
        public IdealDetails(string issuer = default(string), string recurringDetailReference = default(string), string storedPaymentMethodId = default(string), string type = "ideal")
        {
