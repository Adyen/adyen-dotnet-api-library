...
namespace IO.Swagger.Model
{
        ...
        public partial class PayUUpiDetails :  IEquatable<PayUUpiDetails>, IValidatableObject
    {
        ...
        public PayUUpiDetails(string recurringDetailReference = default(string), string shopperNotificationReference = default(string), string storedPaymentMethodId = default(string), SubscriptionDetails subscriptionDetails = default(SubscriptionDetails), string type = "payu_IN_upi", string virtualPaymentAddress = default(string))
        {
