...
namespace IO.Swagger.Model
{
        ...
        public partial class PaymentMethodsRequest :  IEquatable<PaymentMethodsRequest>, IValidatableObject
    {
        ...
        public PaymentMethodsRequest(AnyOfPaymentMethodsRequestAdditionalData additionalData = default(AnyOfPaymentMethodsRequestAdditionalData), List<string> allowedPaymentMethods = default(List<string>), Amount amount = default(Amount), List<string> blockedPaymentMethods = default(List<string>), ChannelEnum? channel = default(ChannelEnum?), string countryCode = default(string), string merchantAccount = default(string), CheckoutOrder order = default(CheckoutOrder), string shopperLocale = default(string), string shopperReference = default(string), bool? splitCardFundingSources = false, string store = default(string))
        {
