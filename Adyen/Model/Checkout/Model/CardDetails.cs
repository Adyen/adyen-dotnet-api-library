...
namespace IO.Swagger.Model
{
        ...
        public partial class CardDetails :  IEquatable<CardDetails>, IValidatableObject
    {
        ...
        public CardDetails(string brand = default(string), string cupsecureplusSmscode = default(string), string cvc = default(string), string encryptedCardNumber = default(string), string encryptedExpiryMonth = default(string), string encryptedExpiryYear = default(string), string expiryMonth = default(string), string expiryYear = default(string), FundingSourceEnum? fundingSource = default(FundingSourceEnum?), string holderName = default(string), string number = default(string), string recurringDetailReference = default(string), string storedPaymentMethodId = default(string), string type = "scheme")
        {
            // to ensure "encryptedCardNumber" is required (not null)
            if (encryptedCardNumber == null)
            {
                throw new InvalidDataException("encryptedCardNumber is a required property for CardDetails and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("encryptedExpiryMonth is a required property for CardDetails and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("encryptedExpiryYear is a required property for CardDetails and cannot be null");
            }
            else
            {
