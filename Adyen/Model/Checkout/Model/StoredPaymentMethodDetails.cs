...
namespace IO.Swagger.Model
{
        ...
        public partial class StoredPaymentMethodDetails :  IEquatable<StoredPaymentMethodDetails>, IValidatableObject
    {
        ...
        public StoredPaymentMethodDetails(string recurringDetailReference = default(string), string storedPaymentMethodId = default(string), string type = default(string))
        {
