...
namespace IO.Swagger.Model
{
        ...
        public partial class ResponseAdditionalDataCommon :  IEquatable<ResponseAdditionalDataCommon>, IValidatableObject
    {
        ...
        public ResponseAdditionalDataCommon(string acquirerAccountCode = default(string), string acquirerCode = default(string), string acquirerReference = default(string), string alias = default(string), string aliasType = default(string), string authCode = default(string), string authorisedAmountCurrency = default(string), string authorisedAmountValue = default(string), string avsResult = default(string), string avsResultRaw = default(string), string bic = default(string), string dsTransID = default(string), string eci = default(string), string expiryDate = default(string), string extraCostsCurrency = default(string), string extraCostsValue = default(string), string fraudCheckItemNrFraudCheckname = default(string), string fundingSource = default(string), string fundsAvailability = default(string), string inferredRefusalReason = default(string), string issuerCountry = default(string), string mcBankNetReferenceNumber = default(string), string networkTxReference = default(string), string ownerName = default(string), string paymentAccountReference = default(string), string paymentMethodVariant = default(string), string payoutEligible = default(string), string realtimeAccountUpdaterStatus = default(string), string receiptFreeText = default(string), string recurringFirstPspReference = default(string), string recurringRecurringDetailReference = default(string), string referred = default(string), string refusalReasonRaw = default(string), string shopperInteraction = default(string), string shopperReference = default(string), string terminalId = default(string), string threeDAuthenticated = default(string), string threeDAuthenticatedResponse = default(string), string threeDOffered = default(string), string threeDOfferedResponse = default(string), string threeDSVersion = default(string), string visaTransactionId = default(string), string xid = default(string))
        {
