...
namespace IO.Swagger.Model
{
        ...
        public partial class CheckoutBalanceCheckResponse :  IEquatable<CheckoutBalanceCheckResponse>, IValidatableObject
    {
        ...
        public CheckoutBalanceCheckResponse(AnyOfCheckoutBalanceCheckResponseAdditionalData additionalData = default(AnyOfCheckoutBalanceCheckResponseAdditionalData), Amount balance = default(Amount), FraudResult fraudResult = default(FraudResult), string pspReference = default(string), string refusalReason = default(string), ResultCodeEnum? resultCode = default(ResultCodeEnum?), Amount transactionLimit = default(Amount))
        {
            // to ensure "balance" is required (not null)
            if (balance == null)
            {
                throw new InvalidDataException("balance is a required property for CheckoutBalanceCheckResponse and cannot be null");
            }
            else
            {
