...
namespace IO.Swagger.Model
{
        ...
        public partial class ResponseAdditionalDataPayPal :  IEquatable<ResponseAdditionalDataPayPal>, IValidatableObject
    {
        ...
        public ResponseAdditionalDataPayPal(string paypalEmail = default(string), string paypalPayerId = default(string), string paypalPayerResidenceCountry = default(string), string paypalPayerStatus = default(string), string paypalProtectionEligibility = default(string))
        {
