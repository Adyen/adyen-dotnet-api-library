...
namespace IO.Swagger.Model
{
        ...
        public partial class OpenInvoiceDetails :  IEquatable<OpenInvoiceDetails>, IValidatableObject
    {
        ...
        public OpenInvoiceDetails(string bankAccount = default(string), string billingAddress = default(string), string deliveryAddress = default(string), string installmentConfigurationKey = default(string), string personalDetails = default(string), string recurringDetailReference = default(string), string separateDeliveryAddress = default(string), string storedPaymentMethodId = default(string), string type = "openinvoice")
        {
