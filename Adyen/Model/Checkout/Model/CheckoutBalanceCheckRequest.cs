...
namespace IO.Swagger.Model
{
        ...
        public partial class CheckoutBalanceCheckRequest :  IEquatable<CheckoutBalanceCheckRequest>, IValidatableObject
    {
        ...
        public CheckoutBalanceCheckRequest(AccountInfo accountInfo = default(AccountInfo), Amount additionalAmount = default(Amount), AnyOfCheckoutBalanceCheckRequestAdditionalData additionalData = default(AnyOfCheckoutBalanceCheckRequestAdditionalData), Amount amount = default(Amount), ApplicationInfo applicationInfo = default(ApplicationInfo), Address billingAddress = default(Address), BrowserInfo browserInfo = default(BrowserInfo), int? captureDelayHours = default(int?), DateTime? dateOfBirth = default(DateTime?), ForexQuote dccQuote = default(ForexQuote), Address deliveryAddress = default(Address), DateTime? deliveryDate = default(DateTime?), string deviceFingerprint = default(string), int? fraudOffset = default(int?), Installments installments = default(Installments), string mcc = default(string), string merchantAccount = default(string), string merchantOrderReference = default(string), MerchantRiskIndicator merchantRiskIndicator = default(MerchantRiskIndicator), Dictionary<string, string> metadata = default(Dictionary<string, string>), string orderReference = default(string), Dictionary<string, string> paymentMethod = default(Dictionary<string, string>), Recurring recurring = default(Recurring), RecurringProcessingModelEnum? recurringProcessingModel = default(RecurringProcessingModelEnum?), string reference = default(string), string selectedBrand = default(string), string selectedRecurringDetailReference = default(string), string sessionId = default(string), string shopperEmail = default(string), string shopperIP = default(string), ShopperInteractionEnum? shopperInteraction = default(ShopperInteractionEnum?), string shopperLocale = default(string), Name shopperName = default(Name), string shopperReference = default(string), string shopperStatement = default(string), string socialSecurityNumber = default(string), List<Split> splits = default(List<Split>), string store = default(string), string telephoneNumber = default(string), ThreeDS2RequestData threeDS2RequestData = default(ThreeDS2RequestData), bool? threeDSAuthenticationOnly = false, string totalsGroup = default(string), bool? trustedShopper = default(bool?))
        {
            ...
            {
                throw new InvalidDataException("merchantAccount is a required property for CheckoutBalanceCheckRequest and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("paymentMethod is a required property for CheckoutBalanceCheckRequest and cannot be null");
            }
            else
            {
            ...
            if (reference == null)
            {
                throw new InvalidDataException("reference is a required property for CheckoutBalanceCheckRequest and cannot be null");
            }
            else
            {
