...
namespace IO.Swagger.Model
{
        ...
        public partial class PaymentVerificationResponse :  IEquatable<PaymentVerificationResponse>, IValidatableObject
    {
        ...
        public PaymentVerificationResponse(AnyOfPaymentVerificationResponseAdditionalData additionalData = default(AnyOfPaymentVerificationResponseAdditionalData), FraudResult fraudResult = default(FraudResult), string merchantReference = default(string), CheckoutOrderResponse order = default(CheckoutOrderResponse), string paymentMethod = default(string), string pspReference = default(string), string refusalReason = default(string), string refusalReasonCode = default(string), ResultCodeEnum? resultCode = default(ResultCodeEnum?), ServiceError serviceError = default(ServiceError), string shopperLocale = default(string))
        {
