...
namespace IO.Swagger.Model
{
        ...
        public partial class ApplePayDetails :  IEquatable<ApplePayDetails>, IValidatableObject
    {
        ...
        public ApplePayDetails(string applePayToken = default(string), FundingSourceEnum? fundingSource = default(FundingSourceEnum?), string recurringDetailReference = default(string), string storedPaymentMethodId = default(string), string type = "applepay")
        {
            // to ensure "applePayToken" is required (not null)
            if (applePayToken == null)
            {
                throw new InvalidDataException("applePayToken is a required property for ApplePayDetails and cannot be null");
            }
            else
            {
