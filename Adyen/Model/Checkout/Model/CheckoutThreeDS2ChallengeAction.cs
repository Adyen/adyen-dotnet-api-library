...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class CheckoutThreeDS2ChallengeAction :  IEquatable<CheckoutThreeDS2ChallengeAction>, IValidatableObject
    {
        /// <summary>
        ...
        public CheckoutThreeDS2ChallengeAction(string paymentData = default(string), string paymentMethodType = default(string), string token = default(string), string url = default(string))
        {
