...
namespace IO.Swagger.Model
{
        ...
        public partial class PayPalDetails :  IEquatable<PayPalDetails>, IValidatableObject
    {
        ...
        public PayPalDetails(string orderID = default(string), string payerID = default(string), string recurringDetailReference = default(string), string storedPaymentMethodId = default(string), SubtypeEnum? subtype = default(SubtypeEnum?), string type = "paypal")
        {
