...
namespace IO.Swagger.Model
{
        ...
        public partial class CheckoutCreateOrderResponse :  IEquatable<CheckoutCreateOrderResponse>, IValidatableObject
    {
        ...
        public CheckoutCreateOrderResponse(AnyOfCheckoutCreateOrderResponseAdditionalData additionalData = default(AnyOfCheckoutCreateOrderResponseAdditionalData), string expiresAt = default(string), FraudResult fraudResult = default(FraudResult), string orderData = default(string), string pspReference = default(string), string refusalReason = default(string), Amount remainingAmount = default(Amount), ResultCodeEnum? resultCode = default(ResultCodeEnum?))
        {
            // to ensure "expiresAt" is required (not null)
            if (expiresAt == null)
            {
                throw new InvalidDataException("expiresAt is a required property for CheckoutCreateOrderResponse and cannot be null");
            }
            else
            {
            ...
            if (orderData == null)
            {
                throw new InvalidDataException("orderData is a required property for CheckoutCreateOrderResponse and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("remainingAmount is a required property for CheckoutCreateOrderResponse and cannot be null");
            }
            else
            {
