...
namespace IO.Swagger.Model
{
        ...
        public partial class CheckoutThreeDS2Action :  IEquatable<CheckoutThreeDS2Action>, IValidatableObject
    {
        ...
        public CheckoutThreeDS2Action(string authorisationToken = default(string), string paymentData = default(string), string paymentMethodType = default(string), string subtype = default(string), string token = default(string), string url = default(string))
        {
