...
namespace IO.Swagger.Model
{
        ...
        public partial class SubscriptionDetails :  IEquatable<SubscriptionDetails>, IValidatableObject
    {
        ...
        public SubscriptionDetails(string amount = default(string), AmountRuleEnum? amountRule = default(AmountRuleEnum?), BillingAttemptsRuleEnum? billingAttemptsRule = default(BillingAttemptsRuleEnum?), string billingDay = default(string), string endAt = default(string), FrequencyEnum frequency = default(FrequencyEnum), string remarks = default(string), string startAt = default(string))
        {
            // to ensure "amount" is required (not null)
            if (amount == null)
            {
                throw new InvalidDataException("amount is a required property for SubscriptionDetails and cannot be null");
            }
            else
            {
                this.Amount = amount;
            ...
            if (endAt == null)
            {
                throw new InvalidDataException("endAt is a required property for SubscriptionDetails and cannot be null");
            }
            else
            {
                this.EndAt = endAt;
            ...
            if (frequency == null)
            {
                throw new InvalidDataException("frequency is a required property for SubscriptionDetails and cannot be null");
            }
            else
            {
