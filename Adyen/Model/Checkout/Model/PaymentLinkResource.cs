...
namespace IO.Swagger.Model
{
        ...
        public partial class PaymentLinkResource :  IEquatable<PaymentLinkResource>, IValidatableObject
    {
        ...
        public PaymentLinkResource(List<string> allowedPaymentMethods = default(List<string>), Amount amount = default(Amount), ApplicationInfo applicationInfo = default(ApplicationInfo), Address billingAddress = default(Address), List<string> blockedPaymentMethods = default(List<string>), string countryCode = default(string), DateTime? deliverAt = default(DateTime?), Address deliveryAddress = default(Address), string description = default(string), string expiresAt = default(string), List<LineItem> lineItems = default(List<LineItem>), string merchantAccount = default(string), string merchantOrderReference = default(string), RecurringProcessingModelEnum? recurringProcessingModel = default(RecurringProcessingModelEnum?), string reference = default(string), string returnUrl = default(string), bool? reusable = default(bool?), RiskData riskData = default(RiskData), string shopperEmail = default(string), string shopperLocale = default(string), Name shopperName = default(Name), string shopperReference = default(string), List<Split> splits = default(List<Split>), StatusEnum status = default(StatusEnum), string store = default(string), bool? storePaymentMethod = default(bool?))
        {
            // to ensure "amount" is required (not null)
            if (amount == null)
            {
                throw new InvalidDataException("amount is a required property for PaymentLinkResource and cannot be null");
            }
            else
            {
                this.Amount = amount;
            ...
            {
                throw new InvalidDataException("merchantAccount is a required property for PaymentLinkResource and cannot be null");
            }
            else
            {
            ...
            if (reference == null)
            {
                throw new InvalidDataException("reference is a required property for PaymentLinkResource and cannot be null");
            }
            else
            {
            ...
            if (status == null)
            {
                throw new InvalidDataException("status is a required property for PaymentLinkResource and cannot be null");
            }
            else
            {
                this.Status = status;
