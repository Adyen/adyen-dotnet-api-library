...
namespace IO.Swagger.Model
{
        ...
        public partial class DokuDetails :  IEquatable<DokuDetails>, IValidatableObject
    {
        ...
        public DokuDetails(string firstName = default(string), string infix = default(string), string lastName = default(string), string ovoId = default(string), string shopperEmail = default(string), TypeEnum type = default(TypeEnum))
        {
            ...
            {
                throw new InvalidDataException("shopperEmail is a required property for DokuDetails and cannot be null");
            }
            else
            {
