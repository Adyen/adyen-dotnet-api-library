...
namespace IO.Swagger.Model
{
        ...
        public partial class PaymentResponse :  IEquatable<PaymentResponse>, IValidatableObject
    {
        ...
        public PaymentResponse(OneOfPaymentResponseAction action = default(OneOfPaymentResponseAction), AnyOfPaymentResponseAdditionalData additionalData = default(AnyOfPaymentResponseAdditionalData), Amount amount = default(Amount), Dictionary<string, string> authentication = default(Dictionary<string, string>), List<InputDetail> details = default(List<InputDetail>), string donationToken = default(string), FraudResult fraudResult = default(FraudResult), string merchantReference = default(string), CheckoutOrderResponse order = default(CheckoutOrderResponse), Dictionary<string, string> outputDetails = default(Dictionary<string, string>), string paymentData = default(string), string pspReference = default(string), Redirect redirect = default(Redirect), string refusalReason = default(string), string refusalReasonCode = default(string), ResultCodeEnum? resultCode = default(ResultCodeEnum?))
        {
            this.Action = action;
