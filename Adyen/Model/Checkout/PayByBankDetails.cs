...
namespace Adyen.Model.Checkout
{
    ...
    public partial class PayByBankDetails : IEquatable<PayByBankDetails>, IValidatableObject
    {
        ...
        public PayByBankDetails(string checkoutAttemptId = default(string), string issuer = default(string), string sdkData = default(string), TypeEnum type = TypeEnum.Paybybank)
        {
            this.Type = type;
