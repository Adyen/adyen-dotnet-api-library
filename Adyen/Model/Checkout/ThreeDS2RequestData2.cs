...
namespace Adyen.Model.Checkout
{
    ...
    /// </summary>
    [DataContract(Name = "ThreeDS2RequestData-2")]
    public partial class ThreeDS2RequestData2 : IEquatable<ThreeDS2RequestData2>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ThreeDS2RequestData2" /> class.
        /// </summary>
        ...
        {
            return this.Equals(input as ThreeDS2RequestData2);
        }

        /// <summary>
        /// Returns true if ThreeDS2RequestData2 instances are equal
        /// </summary>
        /// <param name="input">Instance of ThreeDS2RequestData2 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ThreeDS2RequestData2 input)
        {
            if (input == null)
            {
                return false;
