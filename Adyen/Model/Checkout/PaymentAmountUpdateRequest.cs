...
namespace Adyen.Model.Checkout
{
    ...
    public partial class PaymentAmountUpdateRequest : IEquatable<PaymentAmountUpdateRequest>, IValidatableObject
    {
        ...
        public PaymentAmountUpdateRequest(Amount amount = default(Amount), IndustryUsageEnum? industryUsage = default(IndustryUsageEnum?), List<LineItem> lineItems = default(List<LineItem>), string merchantAccount = default(string), string reference = default(string), List<Split> splits = default(List<Split>))
        {
            this.Amount = amount;
