...
namespace Adyen.Model.Checkout
{
    ...
    public partial class Recurring : IEquatable<Recurring>, IValidatableObject
    {
        ...
        public enum TokenServiceEnum
        {
            ...
            /// </summary>
            [EnumMember(Value = "VISATOKENSERVICE")] VISATOKENSERVICE = 1,
        ...
        public Recurring(ContractEnum? contract = default(ContractEnum?), string recurringDetailName = default(string),
            DateTime? recurringExpiry = default(DateTime?), string recurringFrequency = default(string),
            TokenServiceEnum? tokenService = default(TokenServiceEnum?))
        {
