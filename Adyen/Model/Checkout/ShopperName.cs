...
namespace Adyen.Model.Checkout
{
    ...
    /// ShopperName
    /// </summary>
    [DataContract(Name = "ShopperName")]
    public partial class ShopperName : IEquatable<ShopperName>, IValidatableObject
    {
        /// <summary>
        ...
        public ShopperName(string firstName = default(string), string lastName = default(string))
        {
        ...
        {
            return this.Equals(input as ShopperName);
        }

        /// <summary>
        /// Returns true if ShopperName instances are equal
        /// </summary>
        /// <param name="input">Instance of ShopperName to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ShopperName input)
        {
            if (input == null)
            {
                return false;
