...
namespace Adyen.Model.Checkout
{
    ...
    public partial class RatepayDetails : IEquatable<RatepayDetails>, IValidatableObject
    {
        ...
        public RatepayDetails(string billingAddress = default(string), string deliveryAddress = default(string), string personalDetails = default(string), string recurringDetailReference = default(string), string storedPaymentMethodId = default(string), TypeEnum type = TypeEnum.Ratepay)
        {
            this.Type = type;
