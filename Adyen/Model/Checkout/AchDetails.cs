...
namespace Adyen.Model.Checkout
{
    ...
    public partial class AchDetails : IEquatable<AchDetails>, IValidatableObject
    {
        ...
        public AchDetails(string bankAccountNumber = default(string), string bankLocationId = default(string), string encryptedBankAccountNumber = default(string), string encryptedBankLocationId = default(string), string ownerName = default(string), string recurringDetailReference = default(string), string storedPaymentMethodId = default(string), TypeEnum? type = TypeEnum.Ach)
        {
