...
namespace Adyen.Model.Checkout
{
    ...
    public partial class ZipDetails : IEquatable<ZipDetails>, IValidatableObject
    {
        ...
        public ZipDetails(string checkoutAttemptId = default(string), string clickAndCollect = default(string), string recurringDetailReference = default(string), string sdkData = default(string), string storedPaymentMethodId = default(string), TypeEnum? type = TypeEnum.Zip)
        {
