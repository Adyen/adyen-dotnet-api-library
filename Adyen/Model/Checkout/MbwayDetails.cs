...
namespace Adyen.Model.Checkout
{
    ...
    /// MbwayDetails
    /// </summary>
    public partial class MbwayDetails : IValidatableObject
    {
        /// <summary>
        ...
        [JsonConstructor]
        public MbwayDetails(string shopperEmail, string telephoneNumber, Option<string> checkoutAttemptId = default, Option<TypeEnum?> type = default)
        {
        ...
        {
            if (value.Equals("mbway"))
                return TypeEnum.Mbway;
    ...
    public class MbwayDetailsJsonConverter : JsonConverter<MbwayDetails>
    {
        ...
        public override MbwayDetails Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
                    ...
                    switch (localVarJsonPropertyName)
                    {
                        ...
                        case "type":
                            ...
                            if (typeRawValue != null)
                                type = new Option<MbwayDetails.TypeEnum?>(MbwayDetails.TypeEnumFromStringOrDefault(typeRawValue));
                            break;
                        default:
                            break;
                    }
            ...
            if (shopperEmail.IsSet && shopperEmail.Value == null)
                throw new ArgumentNullException(nameof(shopperEmail), "Property is not nullable for class MbwayDetails.");

            if (telephoneNumber.IsSet && telephoneNumber.Value == null)
                throw new ArgumentNullException(nameof(telephoneNumber), "Property is not nullable for class MbwayDetails.");

            if (checkoutAttemptId.IsSet && checkoutAttemptId.Value == null)
                throw new ArgumentNullException(nameof(checkoutAttemptId), "Property is not nullable for class MbwayDetails.");

            if (type.IsSet && type.Value == null)
                throw new ArgumentNullException(nameof(type), "Property is not nullable for class MbwayDetails.");

            return new MbwayDetails(shopperEmail.Value, telephoneNumber.Value, checkoutAttemptId, type);
        }
        ...
        public void WriteProperties(Utf8JsonWriter writer, MbwayDetails mbwayDetails, JsonSerializerOptions jsonSerializerOptions)
        {
            if (mbwayDetails.ShopperEmail == null)
                throw new ArgumentNullException(nameof(mbwayDetails.ShopperEmail), "Property is required for class MbwayDetails.");

            if (mbwayDetails.TelephoneNumber == null)
                throw new ArgumentNullException(nameof(mbwayDetails.TelephoneNumber), "Property is required for class MbwayDetails.");

            if (mbwayDetails.CheckoutAttemptIdOption.IsSet && mbwayDetails.CheckoutAttemptId == null)
                throw new ArgumentNullException(nameof(mbwayDetails.CheckoutAttemptId), "Property is required for class MbwayDetails.");

            writer.WriteString("shopperEmail", mbwayDetails.ShopperEmail);

            writer.WriteString("telephoneNumber", mbwayDetails.TelephoneNumber);

            if (mbwayDetails.CheckoutAttemptIdOption.IsSet)
                writer.WriteString("checkoutAttemptId", mbwayDetails.CheckoutAttemptId);

            var typeRawValue = MbwayDetails.TypeEnumToJsonValue(mbwayDetails.TypeOption.Value.Value);
