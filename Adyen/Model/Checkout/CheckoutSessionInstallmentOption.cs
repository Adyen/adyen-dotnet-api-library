...
namespace Adyen.Model.Checkout
{
    ...
    public partial class CheckoutSessionInstallmentOption : IValidatableObject
    {
        ...
        public Option<List<CheckoutSessionInstallmentOption.PlansEnum>> PlansOption { get; private set; }
        ...
        public List<CheckoutSessionInstallmentOption.PlansEnum> Plans { get { return this.PlansOption; } set { this.PlansOption = new Option<List<CheckoutSessionInstallmentOption.PlansEnum>>(value); } }
    ...
    public class CheckoutSessionInstallmentOptionJsonConverter : JsonConverter<CheckoutSessionInstallmentOption>
    {
        ...
        {
            if (checkoutSessionInstallmentOption.PlansOption.IsSet && checkoutSessionInstallmentOption.Plans == null)
            ...
            if (checkoutSessionInstallmentOption.ValuesOption.IsSet && checkoutSessionInstallmentOption.Values == null)
            ...
            if (checkoutSessionInstallmentOption.PlansOption.IsSet)
            {
            ...
            if (checkoutSessionInstallmentOption.PreselectedValueOption.IsSet)
                writer.WriteNumber("preselectedValue", checkoutSessionInstallmentOption.PreselectedValueOption.Value.Value);

            if (checkoutSessionInstallmentOption.ValuesOption.IsSet)
            {
