...
namespace Adyen.Model.Checkout
{
    ...
    /// </summary>
    [DataContract(Name = "PaymentCaptureResource")]
    public partial class PaymentCaptureResource : IEquatable<PaymentCaptureResource>, IValidatableObject
    {
        ...
        protected PaymentCaptureResource() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="PaymentCaptureResource" /> class.
        /// </summary>
        ...
        public PaymentCaptureResource(Amount amount = default(Amount), List<LineItem> lineItems = default(List<LineItem>), string merchantAccount = default(string), string paymentPspReference = default(string), string pspReference = default(string), string reference = default(string), List<Split> splits = default(List<Split>), StatusEnum status = default(StatusEnum))
        {
            this.Amount = amount;
