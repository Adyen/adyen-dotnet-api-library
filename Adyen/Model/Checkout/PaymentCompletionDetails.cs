...
namespace Adyen.Model.Checkout
{
    ...
    public partial class PaymentCompletionDetails : IEquatable<PaymentCompletionDetails>, IValidatableObject
    {
        ...
        public PaymentCompletionDetails(string mD = default(string), string paReq = default(string), string paRes = default(string), string billingToken = default(string), string cupsecureplusSmscode = default(string), string facilitatorAccessToken = default(string), string oneTimePasscode = default(string), string orderID = default(string), string payerID = default(string), string payload = default(string), string paymentID = default(string), string paymentStatus = default(string), string redirectResult = default(string), string resultCode = default(string), string threeDSResult = default(string), string threeds2ChallengeResult = default(string), string threeds2Fingerprint = default(string))
        {
            this.MD = mD;
            this.PaReq = paReq;
            this.PaRes = paRes;
