...
namespace Adyen.Model.Checkout
{
    ...
    public partial class LineItem : IEquatable<LineItem>, IValidatableObject
    {
        ...
        public LineItem(long amountExcludingTax = default(long), long amountIncludingTax = default(long), string description = default(string), string id = default(string), string imageUrl = default(string), string itemCategory = default(string), string productUrl = default(string), long quantity = default(long), long taxAmount = default(long), long taxPercentage = default(long))
        {
