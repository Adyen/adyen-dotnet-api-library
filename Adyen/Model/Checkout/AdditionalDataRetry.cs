...
namespace Adyen.Model.Checkout
{
    ...
    public partial class AdditionalDataRetry : IEquatable<AdditionalDataRetry>, IValidatableObject
    {
        ...
        public AdditionalDataRetry(string retryChainAttemptNumber = default(string),
            string retryOrderAttemptNumber = default(string), string retrySkipRetry = default(string))
        {
