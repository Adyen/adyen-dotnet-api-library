...
namespace Adyen.Model.Checkout
{
    ...
    public partial class ResponseAdditionalDataCard : IEquatable<ResponseAdditionalDataCard>, IValidatableObject
    {
        ...
        /// </summary>
        /// <param name="cardBin">The Bank Identification Number of a credit card, which is the first six digits of a card number.  Example: 521234.</param>
        ...
        public ResponseAdditionalDataCard(string cardBin = default(string), string cardHolderName = default(string),
            string cardIssuingBank = default(string), string cardIssuingCountry = default(string),
            string cardIssuingCurrency = default(string), string cardPaymentMethod = default(string),
            string cardSummary = default(string))
        {
