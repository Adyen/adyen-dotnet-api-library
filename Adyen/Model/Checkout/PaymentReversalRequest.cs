...
namespace Adyen.Model.Checkout
{
    ...
    public partial class PaymentReversalRequest : IValidatableObject
    {
        ...
        [JsonConstructor]
        public PaymentReversalRequest(string merchantAccount, Option<ApplicationInfo> applicationInfo = default, Option<string> reference = default)
        {
    ...
    public class PaymentReversalRequestJsonConverter : JsonConverter<PaymentReversalRequest>
    {
        ...
        public override PaymentReversalRequest Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            return new PaymentReversalRequest(merchantAccount.Value, applicationInfo, reference);
        }
        ...
        public void WriteProperties(Utf8JsonWriter writer, PaymentReversalRequest paymentReversalRequest, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (paymentReversalRequest.ApplicationInfoOption.IsSet && paymentReversalRequest.ApplicationInfo == null)
            ...
            if (paymentReversalRequest.ReferenceOption.IsSet && paymentReversalRequest.Reference == null)
            ...
            if (paymentReversalRequest.ApplicationInfoOption.IsSet)
            {
            ...
            if (paymentReversalRequest.ReferenceOption.IsSet)
