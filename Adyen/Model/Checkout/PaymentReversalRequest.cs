...
namespace Adyen.Model.Checkout
{
    ...
    public partial class PaymentReversalRequest : IEquatable<PaymentReversalRequest>, IValidatableObject
    {
        ...
        public PaymentReversalRequest(ApplicationInfo applicationInfo = default(ApplicationInfo), string merchantAccount = default(string), string reference = default(string))
        {
