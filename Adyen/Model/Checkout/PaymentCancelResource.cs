...
namespace Adyen.Model.Checkout
{
    ...
    /// </summary>
    [DataContract]
    public partial class PaymentCancelResource : IEquatable<PaymentCancelResource>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="PaymentCancelResource" /> class.
        /// </summary>
        ...
        public PaymentCancelResource(string merchantAccount = default(string),
        ...
        {
            return this.Equals(input as PaymentCancelResource);
        }

        /// <summary>
        /// Returns true if PaymentCancelResource instances are equal
        /// </summary>
        /// <param name="input">Instance of PaymentCancelResource to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PaymentCancelResource input)
        {
            if (input == null)
                return false;
