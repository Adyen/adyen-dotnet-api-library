...
namespace Adyen.Model.Checkout
{
    ...
    /// </summary>
    [DataContract(Name = "PaymentCancelResource")]
    public partial class PaymentCancelResource : IEquatable<PaymentCancelResource>, IValidatableObject
    {
        ...
        protected PaymentCancelResource() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="PaymentCancelResource" /> class.
        /// </summary>
        ...
        public PaymentCancelResource(string merchantAccount = default(string), string paymentPspReference = default(string), string pspReference = default(string), string reference = default(string), StatusEnum status = default(StatusEnum))
        {
