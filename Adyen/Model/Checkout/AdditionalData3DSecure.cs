...
namespace Adyen.Model.Checkout
{
    ...
    public partial class AdditionalData3DSecure : IEquatable<AdditionalData3DSecure>, IValidatableObject
    {
        ...
        public AdditionalData3DSecure(string allow3DS2 = default(string), string executeThreeD = default(string),
            string mpiImplementationType = default(string), string scaExemption = default(string),
