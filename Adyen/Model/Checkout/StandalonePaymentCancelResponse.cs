...
namespace Adyen.Model.Checkout
{
    ...
    public class StandalonePaymentCancelResponseJsonConverter : JsonConverter<StandalonePaymentCancelResponse>
    {
                    ...
                    switch (localVarJsonPropertyName)
                    {
                        ...
                        case "status":
                            ...
                            if (statusRawValue != null)
                                status = new Option<StandalonePaymentCancelResponse.StatusEnum?>(StandalonePaymentCancelResponse.StatusEnumFromStringOrDefault(statusRawValue));
                            break;
                        case "reference":
        ...
        public void WriteProperties(Utf8JsonWriter writer, StandalonePaymentCancelResponse standalonePaymentCancelResponse, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (standalonePaymentCancelResponse.ReferenceOption.IsSet && standalonePaymentCancelResponse.Reference == null)
            ...
            var statusRawValue = StandalonePaymentCancelResponse.StatusEnumToJsonValue(standalonePaymentCancelResponse.Status);
            writer.WriteString("status", statusRawValue);
            if (standalonePaymentCancelResponse.ReferenceOption.IsSet)
