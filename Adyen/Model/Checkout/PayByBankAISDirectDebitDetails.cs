...
namespace Adyen.Model.Checkout
{
    ...
    public partial class PayByBankAISDirectDebitDetails : IEquatable<PayByBankAISDirectDebitDetails>, IValidatableObject
    {
        ...
        public PayByBankAISDirectDebitDetails(string checkoutAttemptId = default(string), string recurringDetailReference = default(string), string sdkData = default(string), string storedPaymentMethodId = default(string), TypeEnum type = TypeEnum.PaybybankAISDD)
        {
            this.Type = type;
