...
namespace Adyen.Model.Checkout
{
    ...
    public partial class DeliveryAddress : IEquatable<DeliveryAddress>, IValidatableObject
    {
        ...
        public DeliveryAddress(string city = default(string), string country = default(string), string firstName = default(string), string houseNumberOrName = default(string), string lastName = default(string), string postalCode = default(string), string stateOrProvince = default(string), string street = default(string))
        {
            this.City = city;
