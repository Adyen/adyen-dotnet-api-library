...
namespace Adyen.Model.Checkout
{
    ...
    public partial class PaymentLinkResponse : IEquatable<PaymentLinkResponse>, IValidatableObject
    {
        ...
        [JsonIgnore]
        [global::System.ComponentModel.EditorBrowsable(global::System.ComponentModel.EditorBrowsableState.Never)]
        public Option<List<PaymentLinkResponse.RequiredShopperFieldsEnum>> RequiredShopperFieldsOption { get; private set; }
        ...
        public List<PaymentLinkResponse.RequiredShopperFieldsEnum> RequiredShopperFields { get { return this.RequiredShopperFieldsOption; } set { this.RequiredShopperFieldsOption = new Option<List<PaymentLinkResponse.RequiredShopperFieldsEnum>>(value); } }
    ...
    public class PaymentLinkResponseJsonConverter : JsonConverter<PaymentLinkResponse>
    {
                    ...
                    switch (localVarJsonPropertyName)
                    {
                        ...
                        case "status":
                            ...
                            if (statusRawValue != null)
                                status = new Option<PaymentLinkResponse.StatusEnum?>(PaymentLinkResponse.StatusEnumFromStringOrDefault(statusRawValue));
                            break;
                        case "url":
                        ...
                        case "recurringProcessingModel":
                            ...
                            if (recurringProcessingModelRawValue != null)
                                recurringProcessingModel = new Option<PaymentLinkResponse.RecurringProcessingModelEnum?>(PaymentLinkResponse.RecurringProcessingModelEnumFromStringOrDefault(recurringProcessingModelRawValue));
                            break;
                        ...
                        case "storePaymentMethodMode":
                            ...
                            if (storePaymentMethodModeRawValue != null)
                                storePaymentMethodMode = new Option<PaymentLinkResponse.StorePaymentMethodModeEnum?>(PaymentLinkResponse.StorePaymentMethodModeEnumFromStringOrDefault(storePaymentMethodModeRawValue));
                            break;
        ...
        public void WriteProperties(Utf8JsonWriter writer, PaymentLinkResponse paymentLinkResponse, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (paymentLinkResponse.AllowedPaymentMethodsOption.IsSet && paymentLinkResponse.AllowedPaymentMethods == null)
            ...
            if (paymentLinkResponse.ApplicationInfoOption.IsSet && paymentLinkResponse.ApplicationInfo == null)
            ...
            if (paymentLinkResponse.BillingAddressOption.IsSet && paymentLinkResponse.BillingAddress == null)
            ...
            if (paymentLinkResponse.BlockedPaymentMethodsOption.IsSet && paymentLinkResponse.BlockedPaymentMethods == null)
            ...
            if (paymentLinkResponse.CountryCodeOption.IsSet && paymentLinkResponse.CountryCode == null)
            ...
            if (paymentLinkResponse.DeliveryAddressOption.IsSet && paymentLinkResponse.DeliveryAddress == null)
            ...
            if (paymentLinkResponse.DescriptionOption.IsSet && paymentLinkResponse.Description == null)
            ...
            if (paymentLinkResponse.FundOriginOption.IsSet && paymentLinkResponse.FundOrigin == null)
                throw new ArgumentNullException(nameof(paymentLinkResponse.FundOrigin), "Property is required for class PaymentLinkResponse.");

            if (paymentLinkResponse.FundRecipientOption.IsSet && paymentLinkResponse.FundRecipient == null)
            ...
            if (paymentLinkResponse.InstallmentOptionsOption.IsSet && paymentLinkResponse.InstallmentOptions == null)
            ...
            if (paymentLinkResponse.LineItemsOption.IsSet && paymentLinkResponse.LineItems == null)
                throw new ArgumentNullException(nameof(paymentLinkResponse.LineItems), "Property is required for class PaymentLinkResponse.");

            if (paymentLinkResponse.MccOption.IsSet && paymentLinkResponse.Mcc == null)
                throw new ArgumentNullException(nameof(paymentLinkResponse.Mcc), "Property is required for class PaymentLinkResponse.");

            if (paymentLinkResponse.MerchantOrderReferenceOption.IsSet && paymentLinkResponse.MerchantOrderReference == null)
            ...
            if (paymentLinkResponse.MetadataOption.IsSet && paymentLinkResponse.Metadata == null)
                throw new ArgumentNullException(nameof(paymentLinkResponse.Metadata), "Property is required for class PaymentLinkResponse.");

            if (paymentLinkResponse.PlatformChargebackLogicOption.IsSet && paymentLinkResponse.PlatformChargebackLogic == null)
            ...
            if (paymentLinkResponse.RequiredShopperFieldsOption.IsSet && paymentLinkResponse.RequiredShopperFields == null)
            ...
            if (paymentLinkResponse.ReturnUrlOption.IsSet && paymentLinkResponse.ReturnUrl == null)
                throw new ArgumentNullException(nameof(paymentLinkResponse.ReturnUrl), "Property is required for class PaymentLinkResponse.");

            if (paymentLinkResponse.RiskDataOption.IsSet && paymentLinkResponse.RiskData == null)
                throw new ArgumentNullException(nameof(paymentLinkResponse.RiskData), "Property is required for class PaymentLinkResponse.");

            if (paymentLinkResponse.ShopperEmailOption.IsSet && paymentLinkResponse.ShopperEmail == null)
            ...
            if (paymentLinkResponse.ShopperLocaleOption.IsSet && paymentLinkResponse.ShopperLocale == null)
            ...
            if (paymentLinkResponse.ShopperNameOption.IsSet && paymentLinkResponse.ShopperName == null)
            ...
            if (paymentLinkResponse.ShopperReferenceOption.IsSet && paymentLinkResponse.ShopperReference == null)
            ...
            if (paymentLinkResponse.ShopperStatementOption.IsSet && paymentLinkResponse.ShopperStatement == null)
            ...
            if (paymentLinkResponse.SocialSecurityNumberOption.IsSet && paymentLinkResponse.SocialSecurityNumber == null)
            ...
            if (paymentLinkResponse.SplitsOption.IsSet && paymentLinkResponse.Splits == null)
                throw new ArgumentNullException(nameof(paymentLinkResponse.Splits), "Property is required for class PaymentLinkResponse.");

            if (paymentLinkResponse.StoreOption.IsSet && paymentLinkResponse.Store == null)
                throw new ArgumentNullException(nameof(paymentLinkResponse.Store), "Property is required for class PaymentLinkResponse.");

            if (paymentLinkResponse.TelephoneNumberOption.IsSet && paymentLinkResponse.TelephoneNumber == null)
            ...
            if (paymentLinkResponse.ThemeIdOption.IsSet && paymentLinkResponse.ThemeId == null)
                throw new ArgumentNullException(nameof(paymentLinkResponse.ThemeId), "Property is required for class PaymentLinkResponse.");

            if (paymentLinkResponse.ThreeDS2RequestDataOption.IsSet && paymentLinkResponse.ThreeDS2RequestData == null)
            ...
            var statusRawValue = PaymentLinkResponse.StatusEnumToJsonValue(paymentLinkResponse.Status);
            writer.WriteString("status", statusRawValue);
            writer.WriteString("url", paymentLinkResponse.Url);

            if (paymentLinkResponse.AllowedPaymentMethodsOption.IsSet)
            {
            ...
            if (paymentLinkResponse.ApplicationInfoOption.IsSet)
            {
            ...
            if (paymentLinkResponse.BillingAddressOption.IsSet)
            {
            ...
            if (paymentLinkResponse.BlockedPaymentMethodsOption.IsSet)
            {
            ...
            if (paymentLinkResponse.CaptureDelayHoursOption.IsSet)
                writer.WriteNumber("captureDelayHours", paymentLinkResponse.CaptureDelayHoursOption.Value.Value);

            if (paymentLinkResponse.CountryCodeOption.IsSet)
                writer.WriteString("countryCode", paymentLinkResponse.CountryCode);

            if (paymentLinkResponse.DateOfBirthOption.IsSet)
                writer.WriteString("dateOfBirth", paymentLinkResponse.DateOfBirthOption.Value.Value.ToString(DateOfBirthFormat));

            if (paymentLinkResponse.DeliverAtOption.IsSet)
                writer.WriteString("deliverAt", paymentLinkResponse.DeliverAtOption.Value.Value.ToString(DeliverAtFormat));

            if (paymentLinkResponse.DeliveryAddressOption.IsSet)
            {
            ...
            if (paymentLinkResponse.DescriptionOption.IsSet)
                writer.WriteString("description", paymentLinkResponse.Description);

            if (paymentLinkResponse.ExpiresAtOption.IsSet)
                writer.WriteString("expiresAt", paymentLinkResponse.ExpiresAtOption.Value.Value.ToString(ExpiresAtFormat));

            if (paymentLinkResponse.FundOriginOption.IsSet)
            {
                writer.WritePropertyName("fundOrigin");
                JsonSerializer.Serialize(writer, paymentLinkResponse.FundOrigin, jsonSerializerOptions);
            }
            if (paymentLinkResponse.FundRecipientOption.IsSet)
            {
            ...
            if (paymentLinkResponse.InstallmentOptionsOption.IsSet)
            {
            ...
            if (paymentLinkResponse.LineItemsOption.IsSet)
            {
                writer.WritePropertyName("lineItems");
                JsonSerializer.Serialize(writer, paymentLinkResponse.LineItems, jsonSerializerOptions);
            }
            if (paymentLinkResponse.ManualCaptureOption.IsSet)
                writer.WriteBoolean("manualCapture", paymentLinkResponse.ManualCaptureOption.Value.Value);

            if (paymentLinkResponse.MccOption.IsSet)
                writer.WriteString("mcc", paymentLinkResponse.Mcc);

            if (paymentLinkResponse.MerchantOrderReferenceOption.IsSet)
                writer.WriteString("merchantOrderReference", paymentLinkResponse.MerchantOrderReference);

            if (paymentLinkResponse.MetadataOption.IsSet)
            {
                writer.WritePropertyName("metadata");
                JsonSerializer.Serialize(writer, paymentLinkResponse.Metadata, jsonSerializerOptions);
            }
            if (paymentLinkResponse.PlatformChargebackLogicOption.IsSet)
            {
            ...
            var recurringProcessingModelRawValue = PaymentLinkResponse.RecurringProcessingModelEnumToJsonValue(paymentLinkResponse.RecurringProcessingModelOption.Value.Value);
            writer.WriteString("recurringProcessingModel", recurringProcessingModelRawValue);
            if (paymentLinkResponse.RequiredShopperFieldsOption.IsSet)
            {
            ...
            if (paymentLinkResponse.ReturnUrlOption.IsSet)
                writer.WriteString("returnUrl", paymentLinkResponse.ReturnUrl);

            if (paymentLinkResponse.ReusableOption.IsSet)
                writer.WriteBoolean("reusable", paymentLinkResponse.ReusableOption.Value.Value);

            if (paymentLinkResponse.RiskDataOption.IsSet)
            {
                writer.WritePropertyName("riskData");
                JsonSerializer.Serialize(writer, paymentLinkResponse.RiskData, jsonSerializerOptions);
            }
            if (paymentLinkResponse.ShopperEmailOption.IsSet)
                writer.WriteString("shopperEmail", paymentLinkResponse.ShopperEmail);

            if (paymentLinkResponse.ShopperLocaleOption.IsSet)
                writer.WriteString("shopperLocale", paymentLinkResponse.ShopperLocale);

            if (paymentLinkResponse.ShopperNameOption.IsSet)
            {
            ...
            if (paymentLinkResponse.ShopperReferenceOption.IsSet)
                writer.WriteString("shopperReference", paymentLinkResponse.ShopperReference);

            if (paymentLinkResponse.ShopperStatementOption.IsSet)
                writer.WriteString("shopperStatement", paymentLinkResponse.ShopperStatement);

            if (paymentLinkResponse.ShowRemovePaymentMethodButtonOption.IsSet)
                writer.WriteBoolean("showRemovePaymentMethodButton", paymentLinkResponse.ShowRemovePaymentMethodButtonOption.Value.Value);

            if (paymentLinkResponse.SocialSecurityNumberOption.IsSet)
                writer.WriteString("socialSecurityNumber", paymentLinkResponse.SocialSecurityNumber);

            if (paymentLinkResponse.SplitCardFundingSourcesOption.IsSet)
                writer.WriteBoolean("splitCardFundingSources", paymentLinkResponse.SplitCardFundingSourcesOption.Value.Value);

            if (paymentLinkResponse.SplitsOption.IsSet)
            {
                writer.WritePropertyName("splits");
                JsonSerializer.Serialize(writer, paymentLinkResponse.Splits, jsonSerializerOptions);
            }
            if (paymentLinkResponse.StoreOption.IsSet)
                writer.WriteString("store", paymentLinkResponse.Store);

            var storePaymentMethodModeRawValue = PaymentLinkResponse.StorePaymentMethodModeEnumToJsonValue(paymentLinkResponse.StorePaymentMethodModeOption.Value.Value);
            writer.WriteString("storePaymentMethodMode", storePaymentMethodModeRawValue);
            if (paymentLinkResponse.TelephoneNumberOption.IsSet)
                writer.WriteString("telephoneNumber", paymentLinkResponse.TelephoneNumber);

            if (paymentLinkResponse.ThemeIdOption.IsSet)
                writer.WriteString("themeId", paymentLinkResponse.ThemeId);

            if (paymentLinkResponse.ThreeDS2RequestDataOption.IsSet)
            {
            ...
            if (paymentLinkResponse.UpdatedAtOption.IsSet)
                writer.WriteString("updatedAt", paymentLinkResponse.UpdatedAtOption.Value.Value.ToString(UpdatedAtFormat));
        }
    }
}
