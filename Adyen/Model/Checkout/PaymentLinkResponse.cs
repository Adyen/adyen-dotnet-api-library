...
namespace Adyen.Model.Checkout
{
    ...
    public partial class PaymentLinkResponse : IEquatable<PaymentLinkResponse>, IValidatableObject
    {
        ...
        public enum RequiredShopperFieldsEnum
        {
            ...
            /// </summary>
            [EnumMember(Value = "billingAddress")] BillingAddress = 1,
            ...
            /// </summary>
            [EnumMember(Value = "shopperEmail")] ShopperEmail = 3,

            /// <summary>
            /// Enum ShopperName for value: shopperName
            /// </summary>
            [EnumMember(Value = "shopperName")] ShopperName = 4,
        ...
        public PaymentLinkResponse(List<string> allowedPaymentMethods = default(List<string>),
            ...
            DateTime? dateOfBirth = default(DateTime?), DateTime? deliverAt = default(DateTime?),
            ...
            List<RequiredShopperFieldsEnum> requiredShopperFields = default(List<RequiredShopperFieldsEnum>),
            string returnUrl = default(string), bool? reusable = default(bool?), RiskData riskData = default(RiskData),
            string shopperEmail = default(string), string shopperLocale = default(string),
