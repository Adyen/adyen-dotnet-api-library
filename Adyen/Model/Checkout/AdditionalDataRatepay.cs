...
namespace Adyen.Model.Checkout
{
    ...
    public partial class AdditionalDataRatepay : IEquatable<AdditionalDataRatepay>, IValidatableObject
    {
        ...
        public AdditionalDataRatepay(string ratepayInstallmentAmount = default(string),
            string ratepayInterestRate = default(string), string ratepayLastInstallmentAmount = default(string),
            string ratepayPaymentFirstday = default(string), string ratepaydataDeliveryDate = default(string),
            string ratepaydataDueDate = default(string), string ratepaydataInvoiceDate = default(string),
            string ratepaydataInvoiceId = default(string))
        {
