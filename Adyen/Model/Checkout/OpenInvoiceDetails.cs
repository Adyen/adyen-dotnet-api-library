...
namespace Adyen.Model.Checkout
{
    ...
    public partial class OpenInvoiceDetails : IEquatable<OpenInvoiceDetails>, IValidatableObject
    {
        ...
        public OpenInvoiceDetails(string billingAddress = default(string), string checkoutAttemptId = default(string), string deliveryAddress = default(string), string personalDetails = default(string), string recurringDetailReference = default(string), string sdkData = default(string), string storedPaymentMethodId = default(string), TypeEnum? type = TypeEnum.Openinvoice)
        {
