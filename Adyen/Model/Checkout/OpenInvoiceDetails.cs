...
namespace Adyen.Model.Checkout
{
    ...
    public partial class OpenInvoiceDetails : IEquatable<OpenInvoiceDetails>, IValidatableObject
    {
        ...
        /// <param name="type">**openinvoice** (default to &quot;openinvoice&quot;).</param>
        public OpenInvoiceDetails(string bankAccount = default(string), string billingAddress = default(string),
