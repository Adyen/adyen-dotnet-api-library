...
namespace Adyen.Model.Checkout
{
    ...
    /// </summary>
    [DataContract]
    public partial class UpiDetails : IEquatable<UpiDetails>, IValidatableObject
    {
        /// <summary>
        ...
        /// <param name="type">**upi** (required) (default to &quot;upi&quot;).</param>
        /// <param name="virtualPaymentAddress">The virtual payment address for UPI..</param>
        public UpiDetails(string recurringDetailReference = default(string),
            string shopperNotificationReference = default(string), string storedPaymentMethodId = default(string),
            SubscriptionDetails subscriptionDetails = default(SubscriptionDetails), string type = "upi",
            string virtualPaymentAddress = default(string))
        {
            // to ensure "type" is required (not null)
            if (type == null)
            {
                throw new InvalidDataException("type is a required property for UpiDetails and cannot be null");
            }
            else
            {
                this.Type = type;
