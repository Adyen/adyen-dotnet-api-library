...
namespace Adyen.Model.Checkout
{
    ...
    public partial class BillDeskDetails : IValidatableObject
    {
        ...
        [JsonConstructor]
        public BillDeskDetails(string issuer, TypeEnum type, Option<string> checkoutAttemptId = default)
        {
            Issuer = issuer;
            Type = type;
        ...
        {
            if (value.Equals("billdesk_online"))
                return TypeEnum.BilldeskOnline;

            if (value.Equals("billdesk_wallet"))
                return TypeEnum.BilldeskWallet;
    ...
    public class BillDeskDetailsJsonConverter : JsonConverter<BillDeskDetails>
    {
        ...
        public override BillDeskDetails Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
                    ...
                    switch (localVarJsonPropertyName)
                    {
                        ...
                        case "type":
                            ...
                            if (typeRawValue != null)
                                type = new Option<BillDeskDetails.TypeEnum?>(BillDeskDetails.TypeEnumFromStringOrDefault(typeRawValue));
                            break;
            ...
            if (issuer.IsSet && issuer.Value == null)
                throw new ArgumentNullException(nameof(issuer), "Property is not nullable for class BillDeskDetails.");

            if (type.IsSet && type.Value == null)
                throw new ArgumentNullException(nameof(type), "Property is not nullable for class BillDeskDetails.");

            if (checkoutAttemptId.IsSet && checkoutAttemptId.Value == null)
                throw new ArgumentNullException(nameof(checkoutAttemptId), "Property is not nullable for class BillDeskDetails.");

            return new BillDeskDetails(issuer.Value, type.Value.Value, checkoutAttemptId);
        }
        ...
        public void WriteProperties(Utf8JsonWriter writer, BillDeskDetails billDeskDetails, JsonSerializerOptions jsonSerializerOptions)
        {
            if (billDeskDetails.Issuer == null)
                throw new ArgumentNullException(nameof(billDeskDetails.Issuer), "Property is required for class BillDeskDetails.");

            if (billDeskDetails.CheckoutAttemptIdOption.IsSet && billDeskDetails.CheckoutAttemptId == null)
                throw new ArgumentNullException(nameof(billDeskDetails.CheckoutAttemptId), "Property is required for class BillDeskDetails.");

            writer.WriteString("issuer", billDeskDetails.Issuer);

            var typeRawValue = BillDeskDetails.TypeEnumToJsonValue(billDeskDetails.Type);
            writer.WriteString("type", typeRawValue);
            if (billDeskDetails.CheckoutAttemptIdOption.IsSet)
