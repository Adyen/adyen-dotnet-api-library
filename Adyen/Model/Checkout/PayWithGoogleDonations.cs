...
namespace Adyen.Model.Checkout
{
    ...
    /// </summary>
    public partial class PayWithGoogleDonations : IValidatableObject
    {
        /// <summary>
        ...
        [JsonConstructor]
        public PayWithGoogleDonations(string googlePayToken, Option<string> checkoutAttemptId = default, Option<FundingSourceEnum?> fundingSource = default, Option<string> recurringDetailReference = default, Option<string> storedPaymentMethodId = default, Option<string> threeDS2SdkVersion = default, Option<TypeEnum?> type = default)
        {
    ...
    /// <summary>
    /// A Json converter for type <see cref="PayWithGoogleDonations" />
    /// </summary>
    public class PayWithGoogleDonationsJsonConverter : JsonConverter<PayWithGoogleDonations>
    {
        /// <summary>
        /// Deserializes json to <see cref="PayWithGoogleDonations" />
        /// </summary>
        ...
        public override PayWithGoogleDonations Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            Option<PayWithGoogleDonations.FundingSourceEnum?> fundingSource = default;
            ...
            Option<PayWithGoogleDonations.TypeEnum?> type = default;
                    ...
                    switch (localVarJsonPropertyName)
                    {
                        ...
                        case "fundingSource":
                            ...
                            if (fundingSourceRawValue != null)
                                fundingSource = new Option<PayWithGoogleDonations.FundingSourceEnum?>(PayWithGoogleDonations.FundingSourceEnumFromStringOrDefault(fundingSourceRawValue));
                            break;
                        ...
                        case "type":
                            ...
                            if (typeRawValue != null)
                                type = new Option<PayWithGoogleDonations.TypeEnum?>(PayWithGoogleDonations.TypeEnumFromStringOrDefault(typeRawValue));
                            break;
                        default:
                            break;
                    }
            ...
            if (googlePayToken.IsSet && googlePayToken.Value == null)
                throw new ArgumentNullException(nameof(googlePayToken), "Property is not nullable for class PayWithGoogleDonations.");

            if (checkoutAttemptId.IsSet && checkoutAttemptId.Value == null)
                throw new ArgumentNullException(nameof(checkoutAttemptId), "Property is not nullable for class PayWithGoogleDonations.");

            if (fundingSource.IsSet && fundingSource.Value == null)
                throw new ArgumentNullException(nameof(fundingSource), "Property is not nullable for class PayWithGoogleDonations.");

            if (recurringDetailReference.IsSet && recurringDetailReference.Value == null)
                throw new ArgumentNullException(nameof(recurringDetailReference), "Property is not nullable for class PayWithGoogleDonations.");

            if (storedPaymentMethodId.IsSet && storedPaymentMethodId.Value == null)
                throw new ArgumentNullException(nameof(storedPaymentMethodId), "Property is not nullable for class PayWithGoogleDonations.");

            if (threeDS2SdkVersion.IsSet && threeDS2SdkVersion.Value == null)
                throw new ArgumentNullException(nameof(threeDS2SdkVersion), "Property is not nullable for class PayWithGoogleDonations.");

            if (type.IsSet && type.Value == null)
                throw new ArgumentNullException(nameof(type), "Property is not nullable for class PayWithGoogleDonations.");

            return new PayWithGoogleDonations(googlePayToken.Value, checkoutAttemptId, fundingSource, recurringDetailReference, storedPaymentMethodId, threeDS2SdkVersion, type);
        }

        /// <summary>
        /// Serializes a <see cref="PayWithGoogleDonations" />
        /// </summary>
        ...
        /// <summary>
        /// Serializes the properties of <see cref="PayWithGoogleDonations" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="payWithGoogleDonations"></param>
        /// <param name="jsonSerializerOptions"></param>
        ...
        public void WriteProperties(Utf8JsonWriter writer, PayWithGoogleDonations payWithGoogleDonations, JsonSerializerOptions jsonSerializerOptions)
        {
            if (payWithGoogleDonations.GooglePayToken == null)
                throw new ArgumentNullException(nameof(payWithGoogleDonations.GooglePayToken), "Property is required for class PayWithGoogleDonations.");

            if (payWithGoogleDonations.CheckoutAttemptIdOption.IsSet && payWithGoogleDonations.CheckoutAttemptId == null)
                throw new ArgumentNullException(nameof(payWithGoogleDonations.CheckoutAttemptId), "Property is required for class PayWithGoogleDonations.");

            if (payWithGoogleDonations.RecurringDetailReferenceOption.IsSet && payWithGoogleDonations.RecurringDetailReference == null)
                throw new ArgumentNullException(nameof(payWithGoogleDonations.RecurringDetailReference), "Property is required for class PayWithGoogleDonations.");

            if (payWithGoogleDonations.StoredPaymentMethodIdOption.IsSet && payWithGoogleDonations.StoredPaymentMethodId == null)
                throw new ArgumentNullException(nameof(payWithGoogleDonations.StoredPaymentMethodId), "Property is required for class PayWithGoogleDonations.");

            if (payWithGoogleDonations.ThreeDS2SdkVersionOption.IsSet && payWithGoogleDonations.ThreeDS2SdkVersion == null)
                throw new ArgumentNullException(nameof(payWithGoogleDonations.ThreeDS2SdkVersion), "Property is required for class PayWithGoogleDonations.");

            writer.WriteString("googlePayToken", payWithGoogleDonations.GooglePayToken);

            if (payWithGoogleDonations.CheckoutAttemptIdOption.IsSet)
                writer.WriteString("checkoutAttemptId", payWithGoogleDonations.CheckoutAttemptId);

            var fundingSourceRawValue = PayWithGoogleDonations.FundingSourceEnumToJsonValue(payWithGoogleDonations.FundingSourceOption.Value.Value);
            writer.WriteString("fundingSource", fundingSourceRawValue);
            if (payWithGoogleDonations.RecurringDetailReferenceOption.IsSet)
                writer.WriteString("recurringDetailReference", payWithGoogleDonations.RecurringDetailReference);

            if (payWithGoogleDonations.StoredPaymentMethodIdOption.IsSet)
                writer.WriteString("storedPaymentMethodId", payWithGoogleDonations.StoredPaymentMethodId);

            if (payWithGoogleDonations.ThreeDS2SdkVersionOption.IsSet)
                writer.WriteString("threeDS2SdkVersion", payWithGoogleDonations.ThreeDS2SdkVersion);

            var typeRawValue = PayWithGoogleDonations.TypeEnumToJsonValue(payWithGoogleDonations.TypeOption.Value.Value);
