...
namespace Adyen.Model.Checkout
{
    ...
    public partial class PayPalDetails : IEquatable<PayPalDetails>, IValidatableObject
    {
        ...
        public PayPalDetails(string orderID = default(string), string payerID = default(string), string recurringDetailReference = default(string), string storedPaymentMethodId = default(string), SubtypeEnum? subtype = default(SubtypeEnum?), TypeEnum type = TypeEnum.Paypal)
        {
            this.Type = type;
