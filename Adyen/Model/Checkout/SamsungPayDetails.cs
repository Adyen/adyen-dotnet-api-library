...
namespace Adyen.Model.Checkout
{
    ...
    public partial class SamsungPayDetails : IEquatable<SamsungPayDetails>, IValidatableObject
    {
        ...
        public SamsungPayDetails(FundingSourceEnum? fundingSource = default(FundingSourceEnum?), string recurringDetailReference = default(string), string samsungPayToken = default(string), string storedPaymentMethodId = default(string), TypeEnum? type = TypeEnum.Samsungpay)
        {
