...
namespace Adyen.Model.Checkout
{
    ...
    public partial class SamsungPayDetails : IEquatable<SamsungPayDetails>, IValidatableObject
    {
        ...
        public SamsungPayDetails(FundingSourceEnum? fundingSource = default(FundingSourceEnum?),
            string recurringDetailReference = default(string), string samsungPayToken = default(string),
            string storedPaymentMethodId = default(string), string type = "samsungpay")
        {
            // to ensure "samsungPayToken" is required (not null)
            if (samsungPayToken == null)
            {
                throw new InvalidDataException(
                    "samsungPayToken is a required property for SamsungPayDetails and cannot be null");
            }
            else
            {
