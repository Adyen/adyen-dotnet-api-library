...
namespace Adyen.Model.Checkout
{
    ...
    public partial class StoredPaymentMethodDetails : IEquatable<StoredPaymentMethodDetails>, IValidatableObject
    {
        ...
        public StoredPaymentMethodDetails(string recurringDetailReference = default(string), string storedPaymentMethodId = default(string), TypeEnum? type = default(TypeEnum?))
        {
