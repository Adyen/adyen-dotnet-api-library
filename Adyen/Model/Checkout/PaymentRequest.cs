...
namespace Adyen.Model.Checkout
{
    ...
    public partial class PaymentRequest : IEquatable<PaymentRequest>, IValidatableObject
    {
        ...
        /// <summary>
        /// Gets or Sets ShopperTaxInfo
        /// </summary>
        [DataMember(Name = "shopperTaxInfo", EmitDefaultValue = false)]
        public ShopperTaxInfo ShopperTaxInfo { get; set; }
        ...
        public bool Equals(PaymentRequest input)
        {
            ...
            return 
                ...
                (
                    this.ShopperTaxInfo == input.ShopperTaxInfo ||
                    (this.ShopperTaxInfo != null &&
                    this.ShopperTaxInfo.Equals(input.ShopperTaxInfo))
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.ShopperTaxInfo != null)
                {
                    hashCode = (hashCode * 59) + this.ShopperTaxInfo.GetHashCode();
                }
