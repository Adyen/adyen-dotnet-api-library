...
namespace Adyen.Model.Checkout
{
    ...
    public partial class SepaDirectDebitDetails : IEquatable<SepaDirectDebitDetails>, IValidatableObject
    {
        ...
        public SepaDirectDebitDetails(string iban = default(string), string ownerName = default(string), string recurringDetailReference = default(string), string storedPaymentMethodId = default(string), TypeEnum? type = TypeEnum.Sepadirectdebit)
        {
            this.Iban = iban;
