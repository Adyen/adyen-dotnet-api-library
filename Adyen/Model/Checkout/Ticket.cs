...
namespace Adyen.Model.Checkout
{
    ...
    public partial class Ticket : IValidatableObject
    {
        ...
        [JsonConstructor]
        public Ticket(Option<string> issueAddress = default, Option<DateTime?> issueDate = default, Option<string> number = default)
        {
            IssueAddressOption = issueAddress;
        ...
        public Option<string> IssueAddressOption { get; private set; }
        ...
        public string IssueAddress { get { return this.IssueAddressOption; } set { this.IssueAddressOption = new Option<string>(value); } }
        ...
        public DateTime? IssueDate { get { return this.IssueDateOption; } set { this.IssueDateOption = new Option<DateTime?>(value); } }
    ...
    public class TicketJsonConverter : JsonConverter<Ticket>
    {
        ...
        public override Ticket Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (issueAddress.IsSet && issueAddress.Value == null)
                throw new ArgumentNullException(nameof(issueAddress), "Property is not nullable for class Ticket.");

            if (issueDate.IsSet && issueDate.Value == null)
                throw new ArgumentNullException(nameof(issueDate), "Property is not nullable for class Ticket.");

            if (number.IsSet && number.Value == null)
                throw new ArgumentNullException(nameof(number), "Property is not nullable for class Ticket.");
        ...
        {
            if (ticket.IssueAddressOption.IsSet && ticket.IssueAddress == null)
                throw new ArgumentNullException(nameof(ticket.IssueAddress), "Property is required for class Ticket.");

            if (ticket.NumberOption.IsSet && ticket.Number == null)
                throw new ArgumentNullException(nameof(ticket.Number), "Property is required for class Ticket.");

            if (ticket.IssueAddressOption.IsSet)
                writer.WriteString("issueAddress", ticket.IssueAddress);

            if (ticket.IssueDateOption.IsSet)
                writer.WriteString("issueDate", ticket.IssueDateOption.Value.Value.ToString(IssueDateFormat));

            if (ticket.NumberOption.IsSet)
