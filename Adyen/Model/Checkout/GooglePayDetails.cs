...
namespace Adyen.Model.Checkout
{
    ...
    public class GooglePayDetailsJsonConverter : JsonConverter<GooglePayDetails>
    {
                    ...
                    switch (localVarJsonPropertyName)
                    {
                        ...
                        case "fundingSource":
                            ...
                            if (fundingSourceRawValue != null)
                                fundingSource = new Option<GooglePayDetails.FundingSourceEnum?>(GooglePayDetails.FundingSourceEnumFromStringOrDefault(fundingSourceRawValue));
                            break;
                        ...
                        case "type":
                            ...
                            if (typeRawValue != null)
                                type = new Option<GooglePayDetails.TypeEnum?>(GooglePayDetails.TypeEnumFromStringOrDefault(typeRawValue));
                            break;
                        default:
                            break;
                    }
        ...
        public void WriteProperties(Utf8JsonWriter writer, GooglePayDetails googlePayDetails, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (googlePayDetails.CheckoutAttemptIdOption.IsSet && googlePayDetails.CheckoutAttemptId == null)
            ...
            if (googlePayDetails.GooglePayCardNetworkOption.IsSet && googlePayDetails.GooglePayCardNetwork == null)
            ...
            if (googlePayDetails.RecurringDetailReferenceOption.IsSet && googlePayDetails.RecurringDetailReference == null)
            ...
            if (googlePayDetails.StoredPaymentMethodIdOption.IsSet && googlePayDetails.StoredPaymentMethodId == null)
            ...
            if (googlePayDetails.ThreeDS2SdkVersionOption.IsSet && googlePayDetails.ThreeDS2SdkVersion == null)
            ...
            if (googlePayDetails.CheckoutAttemptIdOption.IsSet)
                writer.WriteString("checkoutAttemptId", googlePayDetails.CheckoutAttemptId);

            var fundingSourceRawValue = GooglePayDetails.FundingSourceEnumToJsonValue(googlePayDetails.FundingSourceOption.Value.Value);
            writer.WriteString("fundingSource", fundingSourceRawValue);
            if (googlePayDetails.GooglePayCardNetworkOption.IsSet)
                writer.WriteString("googlePayCardNetwork", googlePayDetails.GooglePayCardNetwork);

            if (googlePayDetails.RecurringDetailReferenceOption.IsSet)
                writer.WriteString("recurringDetailReference", googlePayDetails.RecurringDetailReference);

            if (googlePayDetails.StoredPaymentMethodIdOption.IsSet)
                writer.WriteString("storedPaymentMethodId", googlePayDetails.StoredPaymentMethodId);

            if (googlePayDetails.ThreeDS2SdkVersionOption.IsSet)
                writer.WriteString("threeDS2SdkVersion", googlePayDetails.ThreeDS2SdkVersion);

            var typeRawValue = GooglePayDetails.TypeEnumToJsonValue(googlePayDetails.TypeOption.Value.Value);
