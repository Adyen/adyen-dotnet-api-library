...
namespace Adyen.Model.Checkout
{
    ...
    /// </summary>
    [DataContract]
        public partial class PaymentDonationRequest :  IEquatable<PaymentDonationRequest>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="PaymentDonationRequest" /> class.
        /// </summary>
        ...
        public PaymentDonationRequest(AccountInfo accountInfo = default(AccountInfo), Dictionary<string, string> additionalData = default(Dictionary<string, string>), Amount amount = default(Amount), ApplicationInfo applicationInfo = default(ApplicationInfo), AuthenticationData authenticationData = default(AuthenticationData), Address billingAddress = default(Address), BrowserInfo browserInfo = default(BrowserInfo), int? captureDelayHours = default(int?), ChannelEnum? channel = default(ChannelEnum?), string checkoutAttemptId = default(string), Company company = default(Company), string conversionId = default(string), string countryCode = default(string), DateTime? dateOfBirth = default(DateTime?), ForexQuote dccQuote = default(ForexQuote), Address deliveryAddress = default(Address), DateTime? deliveryDate = default(DateTime?), string deviceFingerprint = default(string), string donationAccount = default(string), string donationOriginalPspReference = default(string), string donationToken = default(string), bool? enableOneClick = default(bool?), bool? enablePayOut = default(bool?), bool? enableRecurring = default(bool?), EntityTypeEnum? entityType = default(EntityTypeEnum?), int? fraudOffset = default(int?), FundDestination fundDestination = default(FundDestination), Installments installments = default(Installments), List<LineItem> lineItems = default(List<LineItem>), Mandate mandate = default(Mandate), string mcc = default(string), string merchantAccount = default(string), string merchantOrderReference = default(string), MerchantRiskIndicator merchantRiskIndicator = default(MerchantRiskIndicator), Dictionary<string, string> metadata = default(Dictionary<string, string>), ThreeDSecureData mpiData = default(ThreeDSecureData), CheckoutOrder order = default(CheckoutOrder), string orderReference = default(string), string origin = default(string), IPaymentMethodDetails paymentMethod = default(IPaymentMethodDetails), string recurringExpiry = default(string), string recurringFrequency = default(string), RecurringProcessingModelEnum? recurringProcessingModel = default(RecurringProcessingModelEnum?), string redirectFromIssuerMethod = default(string), string redirectToIssuerMethod = default(string), string reference = default(string), string returnUrl = default(string), RiskData riskData = default(RiskData), string sessionValidity = default(string), string shopperEmail = default(string), string shopperIP = default(string), ShopperInteractionEnum? shopperInteraction = default(ShopperInteractionEnum?), string shopperLocale = default(string), Name shopperName = default(Name), string shopperReference = default(string), string shopperStatement = default(string), string socialSecurityNumber = default(string), List<Split> splits = default(List<Split>), string store = default(string), bool? storePaymentMethod = default(bool?), string telephoneNumber = default(string), ThreeDS2RequestData threeDS2RequestData = default(ThreeDS2RequestData), bool? threeDSAuthenticationOnly = false, bool? trustedShopper = default(bool?))
        {
            ...
            {
                throw new InvalidDataException("merchantAccount is a required property for PaymentDonationRequest and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("paymentMethod is a required property for PaymentDonationRequest and cannot be null");
            }
            else
            {
            ...
            if (reference == null)
            {
                throw new InvalidDataException("reference is a required property for PaymentDonationRequest and cannot be null");
            }
            else
            {
            ...
            if (returnUrl == null)
            {
                throw new InvalidDataException("returnUrl is a required property for PaymentDonationRequest and cannot be null");
            }
            else
            {
        ...
        {
            return this.Equals(input as PaymentDonationRequest);
        }

        /// <summary>
        /// Returns true if PaymentDonationRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of PaymentDonationRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PaymentDonationRequest input)
        {
            if (input == null)
                return false;
