...
namespace Adyen.Model.Checkout
{
    ...
    public partial class AdditionalDataRiskStandalone : IEquatable<AdditionalDataRiskStandalone>, IValidatableObject
    {
        ...
        public AdditionalDataRiskStandalone(string payPalCountryCode = default(string),
            string payPalEmailId = default(string), string payPalFirstName = default(string),
            string payPalLastName = default(string), string payPalPayerId = default(string),
            string payPalPhone = default(string), string payPalProtectionEligibility = default(string),
            string payPalTransactionId = default(string), string avsResultRaw = default(string),
            string bin = default(string), string cvcResultRaw = default(string), string riskToken = default(string),
            string threeDAuthenticated = default(string), string threeDOffered = default(string),
