...
namespace Adyen.Model.Checkout
{
    ...
    /// </summary>
    [DataContract(Name = "PaymentReversalResponse")]
    public partial class PaymentReversalResponse : IEquatable<PaymentReversalResponse>, IValidatableObject
    {
        /// <summary>
        ...
        protected PaymentReversalResponse() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="PaymentReversalResponse" /> class.
        /// </summary>
        ...
        public PaymentReversalResponse(string merchantAccount = default(string), string paymentPspReference = default(string), string pspReference = default(string), string reference = default(string), StatusEnum? status = default(StatusEnum?))
        {
        ...
        {
            return this.Equals(input as PaymentReversalResponse);
        }

        /// <summary>
        /// Returns true if PaymentReversalResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of PaymentReversalResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PaymentReversalResponse input)
        {
            if (input == null)
            {
                return false;
