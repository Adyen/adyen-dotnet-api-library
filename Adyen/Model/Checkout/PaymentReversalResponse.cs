...
namespace Adyen.Model.Checkout
{
    ...
    /// </summary>
    public partial class PaymentReversalResponse : IValidatableObject
    {
        /// <summary>
        ...
        /// <param name="paymentPspReference">The [&#x60;pspReference&#x60;](https://docs.adyen.com/api-explorer/#/CheckoutService/latest/post/payments__resParam_pspReference) of the payment to reverse. </param>
    ...
    /// <summary>
    /// A Json converter for type <see cref="PaymentReversalResponse" />
    /// </summary>
    public class PaymentReversalResponseJsonConverter : JsonConverter<PaymentReversalResponse>
    {
        /// <summary>
        /// Deserializes json to <see cref="PaymentReversalResponse" />
        /// </summary>
        ...
        public override PaymentReversalResponse Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            Option<PaymentReversalResponse.StatusEnum?> status = default;
                    ...
                    switch (localVarJsonPropertyName)
                    {
                        ...
                        case "status":
                            ...
                            if (statusRawValue != null)
                                status = new Option<PaymentReversalResponse.StatusEnum?>(PaymentReversalResponse.StatusEnumFromStringOrDefault(statusRawValue));
                            break;
                        case "reference":
            ...
            if (merchantAccount.IsSet && merchantAccount.Value == null)
                throw new ArgumentNullException(nameof(merchantAccount), "Property is not nullable for class PaymentReversalResponse.");

            if (paymentPspReference.IsSet && paymentPspReference.Value == null)
                throw new ArgumentNullException(nameof(paymentPspReference), "Property is not nullable for class PaymentReversalResponse.");

            if (pspReference.IsSet && pspReference.Value == null)
                throw new ArgumentNullException(nameof(pspReference), "Property is not nullable for class PaymentReversalResponse.");

            if (status.IsSet && status.Value == null)
                throw new ArgumentNullException(nameof(status), "Property is not nullable for class PaymentReversalResponse.");

            if (reference.IsSet && reference.Value == null)
                throw new ArgumentNullException(nameof(reference), "Property is not nullable for class PaymentReversalResponse.");
        ...
        /// <summary>
        /// Serializes a <see cref="PaymentReversalResponse" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="paymentReversalResponse"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, PaymentReversalResponse paymentReversalResponse, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            WriteProperties(writer, paymentReversalResponse, jsonSerializerOptions);
        ...
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, PaymentReversalResponse paymentReversalResponse, JsonSerializerOptions jsonSerializerOptions)
        {
            if (paymentReversalResponse.MerchantAccount == null)
                throw new ArgumentNullException(nameof(paymentReversalResponse.MerchantAccount), "Property is required for class PaymentReversalResponse.");

            if (paymentReversalResponse.PaymentPspReference == null)
                throw new ArgumentNullException(nameof(paymentReversalResponse.PaymentPspReference), "Property is required for class PaymentReversalResponse.");

            if (paymentReversalResponse.PspReference == null)
                throw new ArgumentNullException(nameof(paymentReversalResponse.PspReference), "Property is required for class PaymentReversalResponse.");

            if (paymentReversalResponse.ReferenceOption.IsSet && paymentReversalResponse.Reference == null)
                throw new ArgumentNullException(nameof(paymentReversalResponse.Reference), "Property is required for class PaymentReversalResponse.");

            writer.WriteString("merchantAccount", paymentReversalResponse.MerchantAccount);

            writer.WriteString("paymentPspReference", paymentReversalResponse.PaymentPspReference);

            writer.WriteString("pspReference", paymentReversalResponse.PspReference);

            var statusRawValue = PaymentReversalResponse.StatusEnumToJsonValue(paymentReversalResponse.Status);
            writer.WriteString("status", statusRawValue);
            if (paymentReversalResponse.ReferenceOption.IsSet)
                writer.WriteString("reference", paymentReversalResponse.Reference);
        }
    }
}
