...
namespace Adyen.Model.Checkout
{
    ...
    /// </summary>
    public partial class DetailsRequestAuthenticationData : IValidatableObject
    {
        /// <summary>
    ...
    public class DetailsRequestAuthenticationDataJsonConverter : JsonConverter<DetailsRequestAuthenticationData>
    {
        ...
        public override DetailsRequestAuthenticationData Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (authenticationOnly.IsSet && authenticationOnly.Value == null)
                throw new ArgumentNullException(nameof(authenticationOnly), "Property is not nullable for class DetailsRequestAuthenticationData.");
        ...
        {
            if (detailsRequestAuthenticationData.AuthenticationOnlyOption.IsSet)
                writer.WriteBoolean("authenticationOnly", detailsRequestAuthenticationData.AuthenticationOnlyOption.Value.Value);
        }
    }
}
