...
namespace Adyen.Model.Checkout
{
    ...
    public partial class CreatePaymentAmountUpdateRequest : IEquatable<CreatePaymentAmountUpdateRequest>, IValidatableObject
    {
        ...
        public CreatePaymentAmountUpdateRequest(Amount amount = default(Amount), string merchantAccount = default(string), ReasonEnum? reason = default(ReasonEnum?), string reference = default(string), List<Split> splits = default(List<Split>))
        {
            this.Amount = amount;
