...
namespace Adyen.Model.Checkout
{
    ...
    public partial class IdealDonations : IEquatable<IdealDonations>, IValidatableObject
    {
        ...
        public IdealDonations(string checkoutAttemptId = default(string), string issuer = default(string), string recurringDetailReference = default(string), string sdkData = default(string), string storedPaymentMethodId = default(string), TypeEnum? type = TypeEnum.Ideal)
        {
