...
namespace Adyen.Model.Checkout
{
    ...
    /// </summary>
    [DataContract(Name = "ResponseAdditionalDataCommon")]
    public partial class ResponseAdditionalDataCommon : IEquatable<ResponseAdditionalDataCommon>, IValidatableObject
    {
        ...
        /// </summary>
        /// <value>The store operation performed on the token.</value>
        [JsonConverter(typeof(StringEnumConverter))]
        public enum TokenizationStoreOperationTypeEnum
        {
            ...
            /// <summary>
            /// Enum AlreadyStored for value: alreadyStored
            /// </summary>
            [EnumMember(Value = "alreadyStored")]
            AlreadyStored = 3
        ...
        /// <param name="tokenizationShopperReference">The provided reference of the shopper..</param>
        /// <param name="tokenizationStoreOperationType">The store operation performed on the token..</param>
        ...
        /// </summary>
        /// <value>The provided reference of the shopper.</value>
        ...
        public bool Equals(ResponseAdditionalDataCommon input)
        {
            ...
            return 
                ...
                (
                    this.CoBrandedWith == input.CoBrandedWith ||
                    (this.CoBrandedWith != null &&
                    this.CoBrandedWith.Equals(input.CoBrandedWith))
                ) && 
                (
                ...
                (
                    this.FraudManualReview == input.FraudManualReview ||
                    (this.FraudManualReview != null &&
                    this.FraudManualReview.Equals(input.FraudManualReview))
                ) && 
                (
                ...
                (
                    this.LiabilityShift == input.LiabilityShift ||
                    (this.LiabilityShift != null &&
                    this.LiabilityShift.Equals(input.LiabilityShift))
                ) && 
                (
                ...
                (
                    this.MerchantAdviceCode == input.MerchantAdviceCode ||
                    (this.MerchantAdviceCode != null &&
                    this.MerchantAdviceCode.Equals(input.MerchantAdviceCode))
                ) && 
                (
                ...
                (
                    this.RecurringContractTypes == input.RecurringContractTypes ||
                    (this.RecurringContractTypes != null &&
                    this.RecurringContractTypes.Equals(input.RecurringContractTypes))
                ) && 
                (
                ...
                (
                    ...
                    (this.RecurringShopperReference != null &&
                    this.RecurringShopperReference.Equals(input.RecurringShopperReference))
                ) && 
                (
                ...
                (
                    this.RequestCurrencyCode == input.RequestCurrencyCode ||
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.CoBrandedWith != null)
                {
                    hashCode = (hashCode * 59) + this.CoBrandedWith.GetHashCode();
                }
                ...
                if (this.FraudManualReview != null)
                {
                ...
                if (this.LiabilityShift != null)
                {
                    hashCode = (hashCode * 59) + this.LiabilityShift.GetHashCode();
                }
                if (this.McBankNetReferenceNumber != null)
                {
                    hashCode = (hashCode * 59) + this.McBankNetReferenceNumber.GetHashCode();
                }
                if (this.MerchantAdviceCode != null)
                {
                    hashCode = (hashCode * 59) + this.MerchantAdviceCode.GetHashCode();
                }
                ...
                if (this.RecurringContractTypes != null)
                {
                    hashCode = (hashCode * 59) + this.RecurringContractTypes.GetHashCode();
                }
                ...
                if (this.RecurringShopperReference != null)
                {
                ...
                {
                    hashCode = (hashCode * 59) + this.RequestCurrencyCode.GetHashCode();
                }
