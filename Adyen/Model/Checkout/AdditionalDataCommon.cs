...
namespace Adyen.Model.Checkout
{
    ...
    public partial class AdditionalDataCommon : IEquatable<AdditionalDataCommon>, IValidatableObject
    {
        ...
        public enum IndustryUsageEnum
        {
            ...
            /// </summary>
            [EnumMember(Value = "NoShow")] NoShow = 1,

            /// <summary>
            /// Enum DelayedCharge for value: DelayedCharge
            /// </summary>
            [EnumMember(Value = "DelayedCharge")] DelayedCharge = 2
        }
        ...
        /// <param name="authorisationType">Flags a card payment request for either pre-authorisation or final authorisation. For more information, refer to [Authorisation types](https://docs.adyen.com/checkout/adjust-authorisation#authorisation-types).  Allowed values: * **PreAuth** – flags the payment request to be handled as a pre-authorisation. * **FinalAuth** – flags the payment request to be handled as a final authorisation..</param>
        ...
        public AdditionalDataCommon(string requestedTestErrorResponseCode = default(string),
            string authorisationType = default(string), string customRoutingFlag = default(string),
            IndustryUsageEnum? industryUsage = default(IndustryUsageEnum?), string networkTxReference = default(string),
            string overwriteBrand = default(string), string subMerchantCity = default(string),
            string subMerchantCountry = default(string), string subMerchantID = default(string),
            string subMerchantName = default(string), string subMerchantPostalCode = default(string),
            string subMerchantState = default(string), string subMerchantStreet = default(string),
            string subMerchantTaxId = default(string))
        {
