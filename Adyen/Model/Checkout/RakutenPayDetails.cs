...
namespace Adyen.Model.Checkout
{
    ...
    public partial class RakutenPayDetails : IEquatable<RakutenPayDetails>, IValidatableObject
    {
        ...
        public RakutenPayDetails(string checkoutAttemptId = default(string), string recurringDetailReference = default(string), string sdkData = default(string), string storedPaymentMethodId = default(string), TypeEnum? type = TypeEnum.Rakutenpay)
        {
