...
namespace Adyen.Model.Checkout
{
    ...
    public partial class PaymentCaptureResponse : IValidatableObject
    {
        ...
        /// <param name="paymentPspReference">The [&#x60;pspReference&#x60;](https://docs.adyen.com/api-explorer/#/CheckoutService/latest/post/payments__resParam_pspReference) of the payment to capture. </param>
    ...
    public class PaymentCaptureResponseJsonConverter : JsonConverter<PaymentCaptureResponse>
    {
        ...
        public override PaymentCaptureResponse Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
                    ...
                    switch (localVarJsonPropertyName)
                    {
                        ...
                        case "status":
                            ...
                            if (statusRawValue != null)
                                status = new Option<PaymentCaptureResponse.StatusEnum?>(PaymentCaptureResponse.StatusEnumFromStringOrDefault(statusRawValue));
                            break;
                        case "lineItems":
                            if (utf8JsonReader.TokenType != JsonTokenType.Null)
            ...
            if (amount.IsSet && amount.Value == null)
                throw new ArgumentNullException(nameof(amount), "Property is not nullable for class PaymentCaptureResponse.");

            if (merchantAccount.IsSet && merchantAccount.Value == null)
                throw new ArgumentNullException(nameof(merchantAccount), "Property is not nullable for class PaymentCaptureResponse.");

            if (paymentPspReference.IsSet && paymentPspReference.Value == null)
                throw new ArgumentNullException(nameof(paymentPspReference), "Property is not nullable for class PaymentCaptureResponse.");

            if (pspReference.IsSet && pspReference.Value == null)
                throw new ArgumentNullException(nameof(pspReference), "Property is not nullable for class PaymentCaptureResponse.");

            if (status.IsSet && status.Value == null)
                throw new ArgumentNullException(nameof(status), "Property is not nullable for class PaymentCaptureResponse.");

            if (lineItems.IsSet && lineItems.Value == null)
                throw new ArgumentNullException(nameof(lineItems), "Property is not nullable for class PaymentCaptureResponse.");

            if (platformChargebackLogic.IsSet && platformChargebackLogic.Value == null)
                throw new ArgumentNullException(nameof(platformChargebackLogic), "Property is not nullable for class PaymentCaptureResponse.");

            if (reference.IsSet && reference.Value == null)
                throw new ArgumentNullException(nameof(reference), "Property is not nullable for class PaymentCaptureResponse.");

            if (splits.IsSet && splits.Value == null)
                throw new ArgumentNullException(nameof(splits), "Property is not nullable for class PaymentCaptureResponse.");

            if (subMerchants.IsSet && subMerchants.Value == null)
                throw new ArgumentNullException(nameof(subMerchants), "Property is not nullable for class PaymentCaptureResponse.");
        ...
        {
            if (paymentCaptureResponse.Amount == null)
                throw new ArgumentNullException(nameof(paymentCaptureResponse.Amount), "Property is required for class PaymentCaptureResponse.");

            if (paymentCaptureResponse.MerchantAccount == null)
                throw new ArgumentNullException(nameof(paymentCaptureResponse.MerchantAccount), "Property is required for class PaymentCaptureResponse.");

            if (paymentCaptureResponse.PaymentPspReference == null)
                throw new ArgumentNullException(nameof(paymentCaptureResponse.PaymentPspReference), "Property is required for class PaymentCaptureResponse.");

            if (paymentCaptureResponse.PspReference == null)
                throw new ArgumentNullException(nameof(paymentCaptureResponse.PspReference), "Property is required for class PaymentCaptureResponse.");

            if (paymentCaptureResponse.LineItemsOption.IsSet && paymentCaptureResponse.LineItems == null)
                throw new ArgumentNullException(nameof(paymentCaptureResponse.LineItems), "Property is required for class PaymentCaptureResponse.");

            if (paymentCaptureResponse.PlatformChargebackLogicOption.IsSet && paymentCaptureResponse.PlatformChargebackLogic == null)
                throw new ArgumentNullException(nameof(paymentCaptureResponse.PlatformChargebackLogic), "Property is required for class PaymentCaptureResponse.");

            if (paymentCaptureResponse.ReferenceOption.IsSet && paymentCaptureResponse.Reference == null)
                throw new ArgumentNullException(nameof(paymentCaptureResponse.Reference), "Property is required for class PaymentCaptureResponse.");

            if (paymentCaptureResponse.SplitsOption.IsSet && paymentCaptureResponse.Splits == null)
                throw new ArgumentNullException(nameof(paymentCaptureResponse.Splits), "Property is required for class PaymentCaptureResponse.");

            if (paymentCaptureResponse.SubMerchantsOption.IsSet && paymentCaptureResponse.SubMerchants == null)
                throw new ArgumentNullException(nameof(paymentCaptureResponse.SubMerchants), "Property is required for class PaymentCaptureResponse.");
            ...
            var statusRawValue = PaymentCaptureResponse.StatusEnumToJsonValue(paymentCaptureResponse.Status);
            writer.WriteString("status", statusRawValue);
            if (paymentCaptureResponse.LineItemsOption.IsSet)
            {
                writer.WritePropertyName("lineItems");
                JsonSerializer.Serialize(writer, paymentCaptureResponse.LineItems, jsonSerializerOptions);
            }
            if (paymentCaptureResponse.PlatformChargebackLogicOption.IsSet)
            {
