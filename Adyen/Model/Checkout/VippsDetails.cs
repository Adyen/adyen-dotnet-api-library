...
namespace Adyen.Model.Checkout
{
    ...
    public partial class VippsDetails : IEquatable<VippsDetails>, IValidatableObject
    {
        ...
        public VippsDetails(string checkoutAttemptId = default(string), string recurringDetailReference = default(string), string sdkData = default(string), string storedPaymentMethodId = default(string), string telephoneNumber = default(string), TypeEnum? type = TypeEnum.Vipps)
        {
