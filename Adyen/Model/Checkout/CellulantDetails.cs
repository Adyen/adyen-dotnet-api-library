...
namespace Adyen.Model.Checkout
{
    ...
    public partial class CellulantDetails : IEquatable<CellulantDetails>, IValidatableObject
    {
        ...
        public CellulantDetails(string checkoutAttemptId = default(string), string issuer = default(string), string sdkData = default(string), TypeEnum? type = TypeEnum.Cellulant)
        {
