...
namespace Adyen.Model.Checkout
{
    ...
    public partial class IdealDetails : IEquatable<IdealDetails>, IValidatableObject
    {
        ...
        public IdealDetails(string checkoutAttemptId = default(string), string issuer = default(string), string recurringDetailReference = default(string), string storedPaymentMethodId = default(string), TypeEnum? type = null)
        {
