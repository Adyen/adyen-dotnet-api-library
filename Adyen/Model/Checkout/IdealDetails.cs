...
namespace Adyen.Model.Checkout
{
    ...
    public partial class IdealDetails : IEquatable<IdealDetails>, IValidatableObject
    {
        ...
        /// <param name="type">**ideal** (default to &quot;ideal&quot;).</param>
        public IdealDetails(string issuer = default(string), string recurringDetailReference = default(string),
            string storedPaymentMethodId = default(string), string type = "ideal")
        {
            // to ensure "issuer" is required (not null)
            if (issuer == null)
            {
                throw new InvalidDataException("issuer is a required property for IdealDetails and cannot be null");
            }
            else
            {
                this.Issuer = issuer;
