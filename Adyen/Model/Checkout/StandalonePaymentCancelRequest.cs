...
namespace Adyen.Model.Checkout
{
    ...
    public partial class StandalonePaymentCancelRequest : IValidatableObject
    {
        ...
        [JsonConstructor]
        public StandalonePaymentCancelRequest(string merchantAccount, string paymentReference, Option<ApplicationInfo> applicationInfo = default, Option<string> reference = default)
        {
    ...
    public class StandalonePaymentCancelRequestJsonConverter : JsonConverter<StandalonePaymentCancelRequest>
    {
        ...
        public override StandalonePaymentCancelRequest Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            return new StandalonePaymentCancelRequest(merchantAccount.Value, paymentReference.Value, applicationInfo, reference);
        }
        ...
        public void WriteProperties(Utf8JsonWriter writer, StandalonePaymentCancelRequest standalonePaymentCancelRequest, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (standalonePaymentCancelRequest.ApplicationInfoOption.IsSet && standalonePaymentCancelRequest.ApplicationInfo == null)
            ...
            if (standalonePaymentCancelRequest.ReferenceOption.IsSet && standalonePaymentCancelRequest.Reference == null)
            ...
            if (standalonePaymentCancelRequest.ApplicationInfoOption.IsSet)
            {
            ...
            if (standalonePaymentCancelRequest.ReferenceOption.IsSet)
