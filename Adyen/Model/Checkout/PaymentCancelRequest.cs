...
namespace Adyen.Model.Checkout
{
    ...
    public partial class PaymentCancelRequest : IValidatableObject
    {
        ...
        [JsonConstructor]
        public PaymentCancelRequest(string merchantAccount, Option<ApplicationInfo> applicationInfo = default, Option<string> reference = default)
        {
    ...
    public class PaymentCancelRequestJsonConverter : JsonConverter<PaymentCancelRequest>
    {
        ...
        public override PaymentCancelRequest Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            return new PaymentCancelRequest(merchantAccount.Value, applicationInfo, reference);
        }
        ...
        public void WriteProperties(Utf8JsonWriter writer, PaymentCancelRequest paymentCancelRequest, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (paymentCancelRequest.ApplicationInfoOption.IsSet && paymentCancelRequest.ApplicationInfo == null)
            ...
            if (paymentCancelRequest.ReferenceOption.IsSet && paymentCancelRequest.Reference == null)
            ...
            if (paymentCancelRequest.ApplicationInfoOption.IsSet)
            {
            ...
            if (paymentCancelRequest.ReferenceOption.IsSet)
