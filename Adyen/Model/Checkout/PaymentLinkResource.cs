...
namespace Adyen.Model.Checkout
{
    ...
    /// </summary>
    [DataContract]
    public partial class PaymentLinkResource : IEquatable<PaymentLinkResource>, IValidatableObject
    {
        /// <summary>
        ...
        /// </summary>
        /// <value>Status of the payment link. Possible values: * **active**  * **expired** * **completed** (v66 and above)  * **paid** (v65 and below)</value>
        [JsonConverter(typeof(StringEnumConverter))]
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="PaymentLinkResource" /> class.
        /// </summary>
        ...
        /// <param name="deliverAt">The date and time the purchased goods should be delivered. In ISO 8601 format. For example &#x60;2019-11-23T12:25:28Z&#x60;, or &#x60;2020-05-27T20:25:28+08:00&#x60;..</param>
        ...
        /// <param name="status">Status of the payment link. Possible values: * **active**  * **expired** * **completed** (v66 and above)  * **paid** (v65 and below) (required).</param>
        ...
        public PaymentLinkResource(List<string> allowedPaymentMethods = default(List<string>),
            ...
            string expiresAt = default(string), List<LineItem> lineItems = default(List<LineItem>),
            ...
            bool? storePaymentMethod = default(bool?))
        {
            // to ensure "amount" is required (not null)
            if (amount == null)
            {
                throw new InvalidDataException(
                    "amount is a required property for PaymentLinkResource and cannot be null");
            }
            else
            {
                this.Amount = amount;
            ...
            {
                throw new InvalidDataException(
                    "merchantAccount is a required property for PaymentLinkResource and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException(
                    "reference is a required property for PaymentLinkResource and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException(
                    "status is a required property for PaymentLinkResource and cannot be null");
            }
            else
            {
                this.Status = status;
        ...
        /// </summary>
        /// <value>The date and time the purchased goods should be delivered. In ISO 8601 format. For example &#x60;2019-11-23T12:25:28Z&#x60;, or &#x60;2020-05-27T20:25:28+08:00&#x60;.</value>
        ...
        {
            return this.Equals(input as PaymentLinkResource);
        }

        /// <summary>
        /// Returns true if PaymentLinkResource instances are equal
        /// </summary>
        /// <param name="input">Instance of PaymentLinkResource to be compared</param>
        /// <returns>Boolean</returns>
