...
namespace Adyen.Model.Checkout
{
    ...
    public partial class PayUUpiDetails : IEquatable<PayUUpiDetails>, IValidatableObject
    {
        ...
        /// <param name="type">**payu_IN_upi** (required) (default to &quot;payu_IN_upi&quot;).</param>
        /// <param name="virtualPaymentAddress">The virtual payment address for UPI..</param>
        public PayUUpiDetails(string recurringDetailReference = default(string),
            string shopperNotificationReference = default(string), string storedPaymentMethodId = default(string),
            SubscriptionDetails subscriptionDetails = default(SubscriptionDetails), string type = "payu_IN_upi",
            string virtualPaymentAddress = default(string))
        {
            // to ensure "type" is required (not null)
            if (type == null)
            {
                throw new InvalidDataException("type is a required property for PayUUpiDetails and cannot be null");
            }
            else
            {
                this.Type = type;
