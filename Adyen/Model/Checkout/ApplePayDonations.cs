...
namespace Adyen.Model.Checkout
{
    ...
    public class ApplePayDonationsJsonConverter : JsonConverter<ApplePayDonations>
    {
                    ...
                    switch (localVarJsonPropertyName)
                    {
                        ...
                        case "fundingSource":
                            ...
                            if (fundingSourceRawValue != null)
                                fundingSource = new Option<ApplePayDonations.FundingSourceEnum?>(ApplePayDonations.FundingSourceEnumFromStringOrDefault(fundingSourceRawValue));
                            break;
                        ...
                        case "type":
                            ...
                            if (typeRawValue != null)
                                type = new Option<ApplePayDonations.TypeEnum?>(ApplePayDonations.TypeEnumFromStringOrDefault(typeRawValue));
                            break;
                        default:
                            break;
                    }
        ...
        public void WriteProperties(Utf8JsonWriter writer, ApplePayDonations applePayDonations, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (applePayDonations.CheckoutAttemptIdOption.IsSet && applePayDonations.CheckoutAttemptId == null)
            ...
            if (applePayDonations.RecurringDetailReferenceOption.IsSet && applePayDonations.RecurringDetailReference == null)
            ...
            if (applePayDonations.StoredPaymentMethodIdOption.IsSet && applePayDonations.StoredPaymentMethodId == null)
            ...
            if (applePayDonations.CheckoutAttemptIdOption.IsSet)
                writer.WriteString("checkoutAttemptId", applePayDonations.CheckoutAttemptId);

            var fundingSourceRawValue = ApplePayDonations.FundingSourceEnumToJsonValue(applePayDonations.FundingSourceOption.Value.Value);
            writer.WriteString("fundingSource", fundingSourceRawValue);
            if (applePayDonations.RecurringDetailReferenceOption.IsSet)
            ...
            var typeRawValue = ApplePayDonations.TypeEnumToJsonValue(applePayDonations.TypeOption.Value.Value);
