...
namespace Adyen.Model.Checkout
{
    ...
    public partial class ApplePayDonations : IEquatable<ApplePayDonations>, IValidatableObject
    {
        ...
        public ApplePayDonations(string applePayToken = default(string), string checkoutAttemptId = default(string), FundingSourceEnum? fundingSource = default(FundingSourceEnum?), string recurringDetailReference = default(string), string sdkData = default(string), string storedPaymentMethodId = default(string), TypeEnum? type = TypeEnum.Applepay)
        {
