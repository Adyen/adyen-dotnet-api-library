...
namespace Adyen.Model.Checkout
{
    ...
    public partial class MasterpassDetails : IEquatable<MasterpassDetails>, IValidatableObject
    {
        ...
        public MasterpassDetails(FundingSourceEnum? fundingSource = default(FundingSourceEnum?), string masterpassTransactionId = default(string), TypeEnum? type = TypeEnum.Masterpass)
        {
