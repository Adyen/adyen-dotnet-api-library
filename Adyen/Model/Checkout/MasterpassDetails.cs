...
namespace Adyen.Model.Checkout
{
    ...
    public partial class MasterpassDetails : IEquatable<MasterpassDetails>, IValidatableObject
    {
        ...
        public MasterpassDetails(string checkoutAttemptId = default(string), FundingSourceEnum? fundingSource = default(FundingSourceEnum?), string masterpassTransactionId = default(string), string sdkData = default(string), TypeEnum? type = TypeEnum.Masterpass)
        {
