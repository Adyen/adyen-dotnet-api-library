...
namespace Adyen.Model.Checkout
{
    ...
    public partial class PaymentSessionRequest : IEquatable<PaymentSessionRequest>, IValidatableObject
    {
        ...
        /// <param name="Configuration">Specify configurations to enable additional features..</param>
        ...
        /// <param name="Html">Required for the Web integration.  Set this parameter to true to use the default Checkout UI from the SDK..</param>
        ...
        /// <param name="Origin">Required for the Web integration.  Set this parameter to the page URL, on which you are loading the SDK..</param>
        ...
        [System.Runtime.Serialization.DataMember(Name = "splits", EmitDefaultValue = false)]
        public System.Collections.Generic.List<Adyen.Model.Split> Splits { get; set; }
