...
namespace Adyen.Model.Checkout
{
    ...
    public partial class PaymentSessionRequest : IEquatable<PaymentSessionRequest>, IValidatableObject
    {
        ...
        public PaymentSessionRequest(
            ...
            Configuration configuration = default(Configuration), string conversionId = default(string),
            ...
            DateTime? deliveryDate = default(DateTime?), bool? enableOneClick = default(bool?),
            ...
            Installments installments = default(Installments), List<LineItem> lineItems = default(List<LineItem>),
            ...
            RiskData riskData = default(RiskData), string sdkVersion = default(string),
            string sessionValidity = default(string), string shopperEmail = default(string),
            string shopperIP = default(string),
            ...
            bool? threeDSAuthenticationOnly = false, string token = default(string),
