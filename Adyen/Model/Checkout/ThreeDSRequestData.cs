...
namespace Adyen.Model.Checkout
{
    ...
    public partial class ThreeDSRequestData : IEquatable<ThreeDSRequestData>, IValidatableObject
    {
        ...
        public ThreeDSRequestData(ChallengeWindowSizeEnum? challengeWindowSize = default(ChallengeWindowSizeEnum?), NativeThreeDSEnum? nativeThreeDS = default(NativeThreeDSEnum?), ThreeDSVersionEnum? threeDSVersion = default(ThreeDSVersionEnum?))
        {
