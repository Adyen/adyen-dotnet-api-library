...
namespace Adyen.Model.Checkout
{
    ...
    public partial class PaymentMethodsRequest : IEquatable<PaymentMethodsRequest>, IValidatableObject
    {
        ...
        public PaymentMethodsRequest(Dictionary<string, string> additionalData = default(Dictionary<string, string>), List<string> allowedPaymentMethods = default(List<string>), Amount amount = default(Amount), List<string> blockedPaymentMethods = default(List<string>), ChannelEnum? channel = default(ChannelEnum?), string countryCode = default(string), Dictionary<string, string> localizedShopperStatement = default(Dictionary<string, string>), string merchantAccount = default(string), CheckoutOrder order = default(CheckoutOrder), string shopperLocale = default(string), string shopperReference = default(string), bool splitCardFundingSources = false, string store = default(string))
        {
