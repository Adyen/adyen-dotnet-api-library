...
namespace Adyen.Model.Checkout
{
    ...
    public partial class AdditionalDataRisk : IEquatable<AdditionalDataRisk>, IValidatableObject
    {
        ...
        public AdditionalDataRisk(string riskdataCustomFieldName = default(string),
            string riskdataBasketItemItemNrAmountPerItem = default(string),
            string riskdataBasketItemItemNrBrand = default(string),
            string riskdataBasketItemItemNrCategory = default(string),
            string riskdataBasketItemItemNrColor = default(string),
            string riskdataBasketItemItemNrCurrency = default(string),
            string riskdataBasketItemItemNrItemID = default(string),
            string riskdataBasketItemItemNrManufacturer = default(string),
            string riskdataBasketItemItemNrProductTitle = default(string),
            string riskdataBasketItemItemNrQuantity = default(string),
            string riskdataBasketItemItemNrReceiverEmail = default(string),
            string riskdataBasketItemItemNrSize = default(string), string riskdataBasketItemItemNrSku = default(string),
            string riskdataBasketItemItemNrUpc = default(string),
            string riskdataPromotionsPromotionItemNrPromotionCode = default(string),
            string riskdataPromotionsPromotionItemNrPromotionDiscountAmount = default(string),
            string riskdataPromotionsPromotionItemNrPromotionDiscountCurrency = default(string),
            string riskdataPromotionsPromotionItemNrPromotionDiscountPercentage = default(string),
            string riskdataPromotionsPromotionItemNrPromotionName = default(string))
        {
        ...
        [DataMember(Name = "riskdata.promotions.promotion[itemNr].promotionDiscountPercentage",
        ...
        public override string ToString()
        {
            ...
            sb.Append("  RiskdataBasketItemItemNrAmountPerItem: ").Append(RiskdataBasketItemItemNrAmountPerItem)
                .Append("\n");
            ...
            sb.Append("  RiskdataBasketItemItemNrManufacturer: ").Append(RiskdataBasketItemItemNrManufacturer)
                .Append("\n");
            sb.Append("  RiskdataBasketItemItemNrProductTitle: ").Append(RiskdataBasketItemItemNrProductTitle)
                .Append("\n");
            sb.Append("  RiskdataBasketItemItemNrQuantity: ").Append(RiskdataBasketItemItemNrQuantity).Append("\n");
            sb.Append("  RiskdataBasketItemItemNrReceiverEmail: ").Append(RiskdataBasketItemItemNrReceiverEmail)
                .Append("\n");
            ...
            sb.Append("  RiskdataPromotionsPromotionItemNrPromotionCode: ")
                .Append(RiskdataPromotionsPromotionItemNrPromotionCode).Append("\n");
            sb.Append("  RiskdataPromotionsPromotionItemNrPromotionDiscountAmount: ")
                .Append(RiskdataPromotionsPromotionItemNrPromotionDiscountAmount).Append("\n");
            sb.Append("  RiskdataPromotionsPromotionItemNrPromotionDiscountCurrency: ")
                .Append(RiskdataPromotionsPromotionItemNrPromotionDiscountCurrency).Append("\n");
            sb.Append("  RiskdataPromotionsPromotionItemNrPromotionDiscountPercentage: ")
                .Append(RiskdataPromotionsPromotionItemNrPromotionDiscountPercentage).Append("\n");
            sb.Append("  RiskdataPromotionsPromotionItemNrPromotionName: ")
                .Append(RiskdataPromotionsPromotionItemNrPromotionName).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        public bool Equals(AdditionalDataRisk input)
        {
            ...
            return
                ...
                (
                    ...
                    input.RiskdataPromotionsPromotionItemNrPromotionCode ||
                    this.RiskdataPromotionsPromotionItemNrPromotionCode != null &&
                    this.RiskdataPromotionsPromotionItemNrPromotionCode.Equals(input
                        .RiskdataPromotionsPromotionItemNrPromotionCode)
                ) &&
                (
                    this.RiskdataPromotionsPromotionItemNrPromotionDiscountAmount ==
                    input.RiskdataPromotionsPromotionItemNrPromotionDiscountAmount ||
                    this.RiskdataPromotionsPromotionItemNrPromotionDiscountAmount != null &&
                    this.RiskdataPromotionsPromotionItemNrPromotionDiscountAmount.Equals(
                        input.RiskdataPromotionsPromotionItemNrPromotionDiscountAmount)
                ) &&
                (
                    this.RiskdataPromotionsPromotionItemNrPromotionDiscountCurrency ==
                    input.RiskdataPromotionsPromotionItemNrPromotionDiscountCurrency ||
                    this.RiskdataPromotionsPromotionItemNrPromotionDiscountCurrency != null &&
                    this.RiskdataPromotionsPromotionItemNrPromotionDiscountCurrency.Equals(
                        input.RiskdataPromotionsPromotionItemNrPromotionDiscountCurrency)
                ) &&
                (
                    this.RiskdataPromotionsPromotionItemNrPromotionDiscountPercentage ==
                    ...
                    this.RiskdataPromotionsPromotionItemNrPromotionDiscountPercentage.Equals(
                        input.RiskdataPromotionsPromotionItemNrPromotionDiscountPercentage)
                ) &&
                (
                    this.RiskdataPromotionsPromotionItemNrPromotionName ==
                    input.RiskdataPromotionsPromotionItemNrPromotionName ||
                    this.RiskdataPromotionsPromotionItemNrPromotionName != null &&
                    this.RiskdataPromotionsPromotionItemNrPromotionName.Equals(input
            ...
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.RiskdataPromotionsPromotionItemNrPromotionDiscountAmount != null)
                    hashCode = hashCode * 59 +
                               this.RiskdataPromotionsPromotionItemNrPromotionDiscountAmount.GetHashCode();
                if (this.RiskdataPromotionsPromotionItemNrPromotionDiscountCurrency != null)
                    hashCode = hashCode * 59 +
                               this.RiskdataPromotionsPromotionItemNrPromotionDiscountCurrency.GetHashCode();
                if (this.RiskdataPromotionsPromotionItemNrPromotionDiscountPercentage != null)
                    hashCode = hashCode * 59 +
                               this.RiskdataPromotionsPromotionItemNrPromotionDiscountPercentage.GetHashCode();
