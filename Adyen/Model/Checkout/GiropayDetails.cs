...
namespace Adyen.Model.Checkout
{
    ...
    public partial class GiropayDetails : IEquatable<GiropayDetails>, IValidatableObject
    {
        ...
        /// <param name="type">**giropay** (default to &quot;giropay&quot;).</param>
        public GiropayDetails(string recurringDetailReference = default(string),
            string storedPaymentMethodId = default(string), string type = "giropay")
        {
