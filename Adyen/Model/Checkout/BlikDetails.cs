...
namespace Adyen.Model.Checkout
{
    ...
    public partial class BlikDetails : IEquatable<BlikDetails>, IValidatableObject
    {
        ...
        public BlikDetails(string blikCode = default(string), string checkoutAttemptId = default(string), string recurringDetailReference = default(string), string sdkData = default(string), string storedPaymentMethodId = default(string), TypeEnum? type = default(TypeEnum?))
        {
