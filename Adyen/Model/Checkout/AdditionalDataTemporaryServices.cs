...
namespace Adyen.Model.Checkout
{
    ...
    /// </summary>
    [DataContract]
    public partial class AdditionalDataTemporaryServices : IEquatable<AdditionalDataTemporaryServices>,
        IValidatableObject
    {
        /// <summary>
        ...
        public AdditionalDataTemporaryServices(string enhancedSchemeDataCustomerReference = default(string),
            string enhancedSchemeDataEmployeeName = default(string),
            string enhancedSchemeDataJobDescription = default(string),
            string enhancedSchemeDataRegularHoursRate = default(string),
            string enhancedSchemeDataRegularHoursWorked = default(string),
            string enhancedSchemeDataRequestName = default(string),
            string enhancedSchemeDataTempStartDate = default(string),
            string enhancedSchemeDataTempWeekEnding = default(string),
        ...
        public override string ToString()
        {
            ...
            sb.Append("  EnhancedSchemeDataRegularHoursWorked: ").Append(EnhancedSchemeDataRegularHoursWorked)
                .Append("\n");
