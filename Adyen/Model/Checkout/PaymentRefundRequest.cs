...
namespace Adyen.Model.Checkout
{
    ...
    public partial class PaymentRefundRequest : IEquatable<PaymentRefundRequest>, IValidatableObject
    {
        ...
        public PaymentRefundRequest(Amount amount = default(Amount), List<LineItem> lineItems = default(List<LineItem>), string merchantAccount = default(string), MerchantRefundReasonEnum? merchantRefundReason = default(MerchantRefundReasonEnum?), string reference = default(string), List<Split> splits = default(List<Split>))
        {
            this.Amount = amount;
