...
namespace Adyen.Model.Checkout
{
    ...
    public partial class StoredPaymentMethodResource : IEquatable<StoredPaymentMethodResource>, IValidatableObject
    {
        ...
        public StoredPaymentMethodResource(string brand = default(string), string expiryMonth = default(string), string expiryYear = default(string), string externalResponseCode = default(string), string externalTokenReference = default(string), string holderName = default(string), string iban = default(string), string id = default(string), string issuerName = default(string), string lastFour = default(string), string name = default(string), string networkTxReference = default(string), string ownerName = default(string), string shopperEmail = default(string), string shopperReference = default(string), string supportedRecurringProcessingModels = default(string), string type = default(string))
        {
            this.Brand = brand;
