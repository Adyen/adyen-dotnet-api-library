...
namespace Adyen.Model.Checkout
{
    ...
    /// BalanceCheckRequest
    /// </summary>
    [DataContract(Name = "BalanceCheckRequest")]
    public partial class BalanceCheckRequest : IEquatable<BalanceCheckRequest>, IValidatableObject
    {
        /// <summary>
        ...
        {
            return this.Equals(input as BalanceCheckRequest);
        }

        /// <summary>
        /// Returns true if BalanceCheckRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of BalanceCheckRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(BalanceCheckRequest input)
        {
            if (input == null)
            {
                return false;
