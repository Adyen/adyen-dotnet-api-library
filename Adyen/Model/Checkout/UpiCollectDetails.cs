...
namespace Adyen.Model.Checkout
{
    ...
    /// UpiCollectDetails
    /// </summary>
    [DataContract(Name = "UpiCollectDetails")]
    public partial class UpiCollectDetails : IEquatable<UpiCollectDetails>, IValidatableObject
    {
        /// <summary>
        /// **upi_collect**
        /// </summary>
        ...
        public UpiCollectDetails(string billingSequenceNumber = default(string), string recurringDetailReference = default(string), string shopperNotificationReference = default(string), string storedPaymentMethodId = default(string), TypeEnum type = TypeEnum.UpiCollect, string virtualPaymentAddress = default(string))
        {
        ...
        {
            return this.Equals(input as UpiCollectDetails);
        }

        /// <summary>
        /// Returns true if UpiCollectDetails instances are equal
        /// </summary>
        /// <param name="input">Instance of UpiCollectDetails to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(UpiCollectDetails input)
        {
            if (input == null)
            {
                return false;
