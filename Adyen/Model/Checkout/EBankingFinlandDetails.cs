...
namespace Adyen.Model.Checkout
{
    ...
    public partial class EBankingFinlandDetails : IEquatable<EBankingFinlandDetails>, IValidatableObject
    {
        ...
        public EBankingFinlandDetails(string checkoutAttemptId = default(string), string issuer = default(string), string sdkData = default(string), TypeEnum type = TypeEnum.EbankingFI)
        {
            this.Type = type;
