...
namespace Adyen.Model.Checkout
{
    ...
    public partial class AdditionalDataWallets : IEquatable<AdditionalDataWallets>, IValidatableObject
    {
        ...
        public AdditionalDataWallets(string androidpayToken = default(string),
            string masterpassTransactionId = default(string), string paymentToken = default(string),
            string paywithgoogleToken = default(string), string samsungpayToken = default(string),
            string visacheckoutCallId = default(string))
        {
