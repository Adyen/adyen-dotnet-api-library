...
namespace Adyen.Model.Checkout
{
    ...
    /// </summary>
    [DataContract(Name = "ThreeDS2RequestFields")]
    public partial class ThreeDS2RequestFields : IEquatable<ThreeDS2RequestFields>, IValidatableObject
    {
        /// <summary>
        ...
        {
            return this.Equals(input as ThreeDS2RequestFields);
        }

        /// <summary>
        /// Returns true if ThreeDS2RequestFields instances are equal
        /// </summary>
        /// <param name="input">Instance of ThreeDS2RequestFields to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ThreeDS2RequestFields input)
        {
            if (input == null)
            {
                return false;
