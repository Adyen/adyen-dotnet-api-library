...
namespace Adyen.Model.Checkout
{
    ...
    public partial class BankAccount :  IEquatable<BankAccount>, IValidatableObject
    {
        ...
        public BankAccount(string BankAccountNumber = default(string), string BankCity = default(string), string BankLocationId = default(string), string BankName = default(string), string Bic = default(string), string CountryCode = default(string), string Iban = default(string), string OwnerName = default(string), string TaxId = default(string))
        {
