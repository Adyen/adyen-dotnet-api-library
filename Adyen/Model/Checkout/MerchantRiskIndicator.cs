...
namespace Adyen.Model.Checkout
{
    ...
    public partial class MerchantRiskIndicator : IEquatable<MerchantRiskIndicator>, IValidatableObject
    {
        ...
        public MerchantRiskIndicator(bool? addressMatch = default(bool?),
            ...
            string deliveryEmail = default(string), string deliveryEmailAddress = default(string),
            ...
            string giftCardCurr = default(string), DateTime? preOrderDate = default(DateTime?),
            bool? preOrderPurchase = default(bool?), string preOrderPurchaseInd = default(string),
            bool? reorderItems = default(bool?), string reorderItemsInd = default(string),
            string shipIndicator = default(string))
        {
