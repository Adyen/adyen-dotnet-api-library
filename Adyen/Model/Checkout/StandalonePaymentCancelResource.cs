...
namespace Adyen.Model.Checkout
{
    ...
    /// </summary>
    [DataContract(Name = "StandalonePaymentCancelResource")]
    public partial class StandalonePaymentCancelResource : IEquatable<StandalonePaymentCancelResource>, IValidatableObject
    {
        /// <summary>
        ...
        protected StandalonePaymentCancelResource() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="StandalonePaymentCancelResource" /> class.
        /// </summary>
        ...
        public StandalonePaymentCancelResource(string merchantAccount = default(string), string paymentReference = default(string), string pspReference = default(string), string reference = default(string), StatusEnum status = default(StatusEnum))
        {
