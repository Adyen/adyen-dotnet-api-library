...
namespace Adyen.Model.Checkout
{
    ...
    public partial class PaymentLinkRequest : IEquatable<PaymentLinkRequest>, IValidatableObject
    {
        /// <summary>
        ...
        {
            return this.Equals(input as PaymentLinkRequest);
        }

        /// <summary>
        /// Returns true if PaymentLinkRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of PaymentLinkRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PaymentLinkRequest input)
        {
            if (input == null)
            {
                return false;
