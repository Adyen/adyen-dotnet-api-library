...
namespace Adyen.Model.Checkout
{
    ...
    public class ApplePayDetailsJsonConverter : JsonConverter<ApplePayDetails>
    {
                    ...
                    switch (localVarJsonPropertyName)
                    {
                        ...
                        case "fundingSource":
                            ...
                            if (fundingSourceRawValue != null)
                                fundingSource = new Option<ApplePayDetails.FundingSourceEnum?>(ApplePayDetails.FundingSourceEnumFromStringOrDefault(fundingSourceRawValue));
                            break;
                        ...
                        case "type":
                            ...
                            if (typeRawValue != null)
                                type = new Option<ApplePayDetails.TypeEnum?>(ApplePayDetails.TypeEnumFromStringOrDefault(typeRawValue));
                            break;
                        default:
                            break;
                    }
        ...
        public void WriteProperties(Utf8JsonWriter writer, ApplePayDetails applePayDetails, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (applePayDetails.CheckoutAttemptIdOption.IsSet && applePayDetails.CheckoutAttemptId == null)
                throw new ArgumentNullException(nameof(applePayDetails.CheckoutAttemptId), "Property is required for class ApplePayDetails.");

            if (applePayDetails.RecurringDetailReferenceOption.IsSet && applePayDetails.RecurringDetailReference == null)
            ...
            if (applePayDetails.StoredPaymentMethodIdOption.IsSet && applePayDetails.StoredPaymentMethodId == null)
            ...
            if (applePayDetails.CheckoutAttemptIdOption.IsSet)
                writer.WriteString("checkoutAttemptId", applePayDetails.CheckoutAttemptId);

            var fundingSourceRawValue = ApplePayDetails.FundingSourceEnumToJsonValue(applePayDetails.FundingSourceOption.Value.Value);
            writer.WriteString("fundingSource", fundingSourceRawValue);
            if (applePayDetails.RecurringDetailReferenceOption.IsSet)
            ...
            var typeRawValue = ApplePayDetails.TypeEnumToJsonValue(applePayDetails.TypeOption.Value.Value);
