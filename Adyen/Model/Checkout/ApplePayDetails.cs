...
namespace Adyen.Model.Checkout
{
    ...
    public partial class ApplePayDetails : IEquatable<ApplePayDetails>, IValidatableObject
    {
        ...
        public ApplePayDetails(string applePayToken = default(string), FundingSourceEnum? fundingSource = default(FundingSourceEnum?), string recurringDetailReference = default(string), string storedPaymentMethodId = default(string), TypeEnum? type = TypeEnum.Applepay)
        {
