...
namespace Adyen.Model.Checkout
{
    ...
    public partial class ApplicationInfo : IEquatable<ApplicationInfo>, IValidatableObject
    {
        ...
        public ApplicationInfo(CommonField adyenLibrary = default(CommonField),
            ...
            ExternalPlatform externalPlatform = default(ExternalPlatform),
            CommonField merchantApplication = default(CommonField),
            MerchantDevice merchantDevice = default(MerchantDevice),
            ShopperInteractionDevice shopperInteractionDevice = default(ShopperInteractionDevice))
        {
