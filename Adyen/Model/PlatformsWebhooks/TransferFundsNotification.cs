...
namespace Adyen.Model.PlatformsWebhooks
{
    ...
    /// </summary>
    [DataContract(Name = "TransferFundsNotification")]
    public partial class TransferFundsNotification : IEquatable<TransferFundsNotification>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TransferFundsNotification" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected TransferFundsNotification() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="TransferFundsNotification" /> class.
        /// </summary>
        ...
        {
            return this.Equals(input as TransferFundsNotification);
        }

        /// <summary>
        /// Returns true if TransferFundsNotification instances are equal
        /// </summary>
        /// <param name="input">Instance of TransferFundsNotification to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TransferFundsNotification input)
        {
            if (input == null)
            {
                return false;
