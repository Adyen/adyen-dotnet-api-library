...
namespace Adyen.Model.PlatformsWebhooks
{
    ...
    /// </summary>
    [DataContract(Name = "AccountUpdateNotification")]
    public partial class AccountUpdateNotification : IEquatable<AccountUpdateNotification>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AccountUpdateNotification" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected AccountUpdateNotification() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="AccountUpdateNotification" /> class.
        /// </summary>
        ...
        {
            return this.Equals(input as AccountUpdateNotification);
        }

        /// <summary>
        /// Returns true if AccountUpdateNotification instances are equal
        /// </summary>
        /// <param name="input">Instance of AccountUpdateNotification to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AccountUpdateNotification input)
        {
            if (input == null)
            {
                return false;
