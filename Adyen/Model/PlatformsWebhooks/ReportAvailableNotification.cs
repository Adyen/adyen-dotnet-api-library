...
namespace Adyen.Model.PlatformsWebhooks
{
    ...
    /// </summary>
    [DataContract(Name = "ReportAvailableNotification")]
    public partial class ReportAvailableNotification : IEquatable<ReportAvailableNotification>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ReportAvailableNotification" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ReportAvailableNotification() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ReportAvailableNotification" /> class.
        /// </summary>
        ...
        {
            return this.Equals(input as ReportAvailableNotification);
        }

        /// <summary>
        /// Returns true if ReportAvailableNotification instances are equal
        /// </summary>
        /// <param name="input">Instance of ReportAvailableNotification to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ReportAvailableNotification input)
        {
            if (input == null)
            {
                return false;
