...
namespace Adyen.Model.PlatformsWebhooks
{
    ...
    /// </summary>
    [DataContract(Name = "DirectDebitInitiatedNotification")]
    public partial class DirectDebitInitiatedNotification : IEquatable<DirectDebitInitiatedNotification>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DirectDebitInitiatedNotification" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected DirectDebitInitiatedNotification() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="DirectDebitInitiatedNotification" /> class.
        /// </summary>
        ...
        {
            return this.Equals(input as DirectDebitInitiatedNotification);
        }

        /// <summary>
        /// Returns true if DirectDebitInitiatedNotification instances are equal
        /// </summary>
        /// <param name="input">Instance of DirectDebitInitiatedNotification to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(DirectDebitInitiatedNotification input)
        {
            if (input == null)
            {
                return false;
