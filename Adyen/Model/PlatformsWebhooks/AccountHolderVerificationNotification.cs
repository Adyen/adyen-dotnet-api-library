...
namespace Adyen.Model.PlatformsWebhooks
{
    ...
    /// </summary>
    [DataContract(Name = "AccountHolderVerificationNotification")]
    public partial class AccountHolderVerificationNotification : IEquatable<AccountHolderVerificationNotification>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AccountHolderVerificationNotification" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected AccountHolderVerificationNotification() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="AccountHolderVerificationNotification" /> class.
        /// </summary>
        ...
        {
            return this.Equals(input as AccountHolderVerificationNotification);
        }

        /// <summary>
        /// Returns true if AccountHolderVerificationNotification instances are equal
        /// </summary>
        /// <param name="input">Instance of AccountHolderVerificationNotification to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AccountHolderVerificationNotification input)
        {
            if (input == null)
            {
                return false;
