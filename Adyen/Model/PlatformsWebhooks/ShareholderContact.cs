...
namespace Adyen.Model.PlatformsWebhooks
{
    ...
    public partial class ShareholderContact : IEquatable<ShareholderContact>, IValidatableObject
    {
        ...
        public ShareholderContact(ViasAddress address = default(ViasAddress), string email = default(string), string fullPhoneNumber = default(string), string jobTitle = default(string), ViasName name = default(ViasName), ViasPersonalData personalData = default(ViasPersonalData), ViasPhoneNumber phoneNumber = default(ViasPhoneNumber), string shareholderCode = default(string), string shareholderReference = default(string), ShareholderTypeEnum? shareholderType = default(ShareholderTypeEnum?), string webAddress = default(string))
        {
