...
namespace Adyen.Model.PlatformsWebhooks
{
    ...
    /// </summary>
    [DataContract(Name = "AccountHolderStatusChangeNotification")]
    public partial class AccountHolderStatusChangeNotification : IEquatable<AccountHolderStatusChangeNotification>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AccountHolderStatusChangeNotification" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected AccountHolderStatusChangeNotification() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="AccountHolderStatusChangeNotification" /> class.
        /// </summary>
        ...
        {
            return this.Equals(input as AccountHolderStatusChangeNotification);
        }

        /// <summary>
        /// Returns true if AccountHolderStatusChangeNotification instances are equal
        /// </summary>
        /// <param name="input">Instance of AccountHolderStatusChangeNotification to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AccountHolderStatusChangeNotification input)
        {
            if (input == null)
            {
                return false;
