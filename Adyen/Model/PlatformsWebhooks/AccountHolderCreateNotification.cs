...
namespace Adyen.Model.PlatformsWebhooks
{
    ...
    /// </summary>
    [DataContract(Name = "AccountHolderCreateNotification")]
    public partial class AccountHolderCreateNotification : IEquatable<AccountHolderCreateNotification>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AccountHolderCreateNotification" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected AccountHolderCreateNotification() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="AccountHolderCreateNotification" /> class.
        /// </summary>
        ...
        {
            return this.Equals(input as AccountHolderCreateNotification);
        }

        /// <summary>
        /// Returns true if AccountHolderCreateNotification instances are equal
        /// </summary>
        /// <param name="input">Instance of AccountHolderCreateNotification to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AccountHolderCreateNotification input)
        {
            if (input == null)
            {
                return false;
