...
namespace Adyen.Model.PlatformsWebhooks
{
    ...
    /// </summary>
    [DataContract(Name = "BeneficiarySetupNotification")]
    public partial class BeneficiarySetupNotification : IEquatable<BeneficiarySetupNotification>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="BeneficiarySetupNotification" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected BeneficiarySetupNotification() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="BeneficiarySetupNotification" /> class.
        /// </summary>
        ...
        {
            return this.Equals(input as BeneficiarySetupNotification);
        }

        /// <summary>
        /// Returns true if BeneficiarySetupNotification instances are equal
        /// </summary>
        /// <param name="input">Instance of BeneficiarySetupNotification to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(BeneficiarySetupNotification input)
        {
            if (input == null)
            {
                return false;
