...
namespace Adyen.Model.PlatformsWebhooks
{
    ...
    /// </summary>
    [DataContract(Name = "AccountCreateNotification")]
    public partial class AccountCreateNotification : IEquatable<AccountCreateNotification>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AccountCreateNotification" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected AccountCreateNotification() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="AccountCreateNotification" /> class.
        /// </summary>
        ...
        {
            return this.Equals(input as AccountCreateNotification);
        }

        /// <summary>
        /// Returns true if AccountCreateNotification instances are equal
        /// </summary>
        /// <param name="input">Instance of AccountCreateNotification to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AccountCreateNotification input)
        {
            if (input == null)
            {
                return false;
