...
namespace Adyen.Model.PlatformsWebhooks
{
    ...
    /// </summary>
    [DataContract(Name = "AccountHolderUpdateNotification")]
    public partial class AccountHolderUpdateNotification : IEquatable<AccountHolderUpdateNotification>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AccountHolderUpdateNotification" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected AccountHolderUpdateNotification() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="AccountHolderUpdateNotification" /> class.
        /// </summary>
        ...
        {
            return this.Equals(input as AccountHolderUpdateNotification);
        }

        /// <summary>
        /// Returns true if AccountHolderUpdateNotification instances are equal
        /// </summary>
        /// <param name="input">Instance of AccountHolderUpdateNotification to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AccountHolderUpdateNotification input)
        {
            if (input == null)
            {
                return false;
