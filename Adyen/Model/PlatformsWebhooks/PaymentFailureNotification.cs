...
namespace Adyen.Model.PlatformsWebhooks
{
    ...
    /// </summary>
    [DataContract(Name = "PaymentFailureNotification")]
    public partial class PaymentFailureNotification : IEquatable<PaymentFailureNotification>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PaymentFailureNotification" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected PaymentFailureNotification() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="PaymentFailureNotification" /> class.
        /// </summary>
        ...
        {
            return this.Equals(input as PaymentFailureNotification);
        }

        /// <summary>
        /// Returns true if PaymentFailureNotification instances are equal
        /// </summary>
        /// <param name="input">Instance of PaymentFailureNotification to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PaymentFailureNotification input)
        {
            if (input == null)
            {
                return false;
