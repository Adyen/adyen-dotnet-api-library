...
namespace Adyen.Model.PlatformsWebhooks
{
    ...
    /// </summary>
    [DataContract(Name = "AccountHolderPayoutNotification")]
    public partial class AccountHolderPayoutNotification : IEquatable<AccountHolderPayoutNotification>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AccountHolderPayoutNotification" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected AccountHolderPayoutNotification() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="AccountHolderPayoutNotification" /> class.
        /// </summary>
        ...
        {
            return this.Equals(input as AccountHolderPayoutNotification);
        }

        /// <summary>
        /// Returns true if AccountHolderPayoutNotification instances are equal
        /// </summary>
        /// <param name="input">Instance of AccountHolderPayoutNotification to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AccountHolderPayoutNotification input)
        {
            if (input == null)
            {
                return false;
