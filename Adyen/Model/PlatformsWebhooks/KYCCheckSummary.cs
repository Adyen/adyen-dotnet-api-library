...
namespace Adyen.Model.PlatformsWebhooks
{
    ...
    /// KYCCheckSummary
    /// </summary>
    [DataContract(Name = "KYCCheckSummary")]
    public partial class KYCCheckSummary : IEquatable<KYCCheckSummary>, IValidatableObject
    {
        ...
        /// </summary>
        /// <param name="kycCheckCode">The code of the check. For possible values, refer to [Verification codes](https://docs.adyen.com/marketplaces-and-platforms/classic/verification-process/verification-codes)..</param>
        ...
        /// </summary>
        /// <value>The code of the check. For possible values, refer to [Verification codes](https://docs.adyen.com/marketplaces-and-platforms/classic/verification-process/verification-codes).</value>
