...
namespace Adyen.Model.PlatformsWebhooks
{
    ...
    /// </summary>
    [DataContract(Name = "AccountCloseNotification")]
    public partial class AccountCloseNotification : IEquatable<AccountCloseNotification>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AccountCloseNotification" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected AccountCloseNotification() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="AccountCloseNotification" /> class.
        /// </summary>
        ...
        {
            return this.Equals(input as AccountCloseNotification);
        }

        /// <summary>
        /// Returns true if AccountCloseNotification instances are equal
        /// </summary>
        /// <param name="input">Instance of AccountCloseNotification to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AccountCloseNotification input)
        {
            if (input == null)
            {
                return false;
