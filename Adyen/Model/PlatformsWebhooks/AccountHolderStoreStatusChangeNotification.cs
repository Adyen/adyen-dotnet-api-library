...
namespace Adyen.Model.PlatformsWebhooks
{
    ...
    /// </summary>
    [DataContract(Name = "AccountHolderStoreStatusChangeNotification")]
    public partial class AccountHolderStoreStatusChangeNotification : IEquatable<AccountHolderStoreStatusChangeNotification>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AccountHolderStoreStatusChangeNotification" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected AccountHolderStoreStatusChangeNotification() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="AccountHolderStoreStatusChangeNotification" /> class.
        /// </summary>
        ...
        {
            return this.Equals(input as AccountHolderStoreStatusChangeNotification);
        }

        /// <summary>
        /// Returns true if AccountHolderStoreStatusChangeNotification instances are equal
        /// </summary>
        /// <param name="input">Instance of AccountHolderStoreStatusChangeNotification to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AccountHolderStoreStatusChangeNotification input)
        {
            if (input == null)
            {
                return false;
