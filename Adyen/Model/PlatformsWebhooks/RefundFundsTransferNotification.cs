...
namespace Adyen.Model.PlatformsWebhooks
{
    ...
    /// </summary>
    [DataContract(Name = "RefundFundsTransferNotification")]
    public partial class RefundFundsTransferNotification : IEquatable<RefundFundsTransferNotification>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="RefundFundsTransferNotification" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected RefundFundsTransferNotification() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="RefundFundsTransferNotification" /> class.
        /// </summary>
        ...
        {
            return this.Equals(input as RefundFundsTransferNotification);
        }

        /// <summary>
        /// Returns true if RefundFundsTransferNotification instances are equal
        /// </summary>
        /// <param name="input">Instance of RefundFundsTransferNotification to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(RefundFundsTransferNotification input)
        {
            if (input == null)
            {
                return false;
