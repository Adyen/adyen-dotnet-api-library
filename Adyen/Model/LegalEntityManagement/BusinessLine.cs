...
namespace Adyen.Model.LegalEntityManagement
{
    ...
    public partial class BusinessLine : IEquatable<BusinessLine>, IValidatableObject
    {
        ...
        public BusinessLine(string capability = default(string), string industryCode = default(string), string legalEntityId = default(string), List<CapabilityProblem> problems = default(List<CapabilityProblem>), List<string> salesChannels = default(List<string>), ServiceEnum service = default(ServiceEnum), SourceOfFunds sourceOfFunds = default(SourceOfFunds), List<WebData> webData = default(List<WebData>), WebDataExemption webDataExemption = default(WebDataExemption))
        {
