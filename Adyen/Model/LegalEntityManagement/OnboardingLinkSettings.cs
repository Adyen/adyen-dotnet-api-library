...
namespace Adyen.Model.LegalEntityManagement
{
    ...
    public partial class OnboardingLinkSettings : IEquatable<OnboardingLinkSettings>, IValidatableObject
    {
        ...
        /// <param name="allowDebugUi">Default value: **true**  Indicates if the user may press a hidden key combination to open the HO debugging UI..</param>
        ...
        /// </summary>
        /// <value>Default value: **true**  Indicates if the user may press a hidden key combination to open the HO debugging UI.</value>
