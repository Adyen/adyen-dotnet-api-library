...
namespace Adyen.Model.LegalEntityManagement
{
    ...
    public partial class BankAccountInfo : IEquatable<BankAccountInfo>, IValidatableObject
    {
        ...
        /// <summary>
        /// When the account number is a virtual account number, the last four digits of the real account number.
        /// </summary>
        /// <value>When the account number is a virtual account number, the last four digits of the real account number.</value>
        [DataMember(Name = "realLastFour", EmitDefaultValue = false)]
        public string RealLastFour { get; private set; }

        /// <summary>
        /// Returns false as RealLastFour should not be serialized given that it's read-only.
        /// </summary>
        /// <returns>false (boolean)</returns>
        public bool ShouldSerializeRealLastFour()
        {
            return false;
        }
        /// <summary>
        /// Indicates if the account number is a virtual account number.
        /// </summary>
        /// <value>Indicates if the account number is a virtual account number.</value>
        [DataMember(Name = "virtualAccountNumber", EmitDefaultValue = false)]
        public bool VirtualAccountNumber { get; private set; }

        /// <summary>
        /// Returns false as VirtualAccountNumber should not be serialized given that it's read-only.
        /// </summary>
        /// <returns>false (boolean)</returns>
        public bool ShouldSerializeVirtualAccountNumber()
        {
            return false;
        }
        /// <summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("  VirtualAccountNumber: ").Append(VirtualAccountNumber).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        public bool Equals(BankAccountInfo input)
        {
            ...
            return 
                ...
                (
                    this.VirtualAccountNumber == input.VirtualAccountNumber ||
                    this.VirtualAccountNumber.Equals(input.VirtualAccountNumber)
                );
        }
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                hashCode = (hashCode * 59) + this.VirtualAccountNumber.GetHashCode();
                return hashCode;
            }
        }
        /// <summary>
