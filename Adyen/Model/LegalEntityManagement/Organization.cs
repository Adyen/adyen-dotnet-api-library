...
namespace Adyen.Model.LegalEntityManagement
{
    ...
    public partial class Organization : IEquatable<Organization>, IValidatableObject
    {
        ...
        [DataMember(Name = "registrationNumberAbsent", EmitDefaultValue = false)]
        ...
        public bool Equals(Organization input)
        {
            ...
            return 
                ...
                (
                    this.RegistrationNumberAbsent == input.RegistrationNumberAbsent ||
                    (this.RegistrationNumberAbsent != null &&
                    this.RegistrationNumberAbsent.Equals(input.RegistrationNumberAbsent))
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.RegistrationNumberAbsent != null)
                {
