...
namespace Adyen.Model.LegalEntityManagement
{
    ...
    public partial class BusinessLineInfoUpdate : IEquatable<BusinessLineInfoUpdate>, IValidatableObject
    {
        ...
        public BusinessLineInfoUpdate(string capability = default(string), string industryCode = default(string), string legalEntityId = default(string), List<string> salesChannels = default(List<string>), ServiceEnum service = default(ServiceEnum), SourceOfFunds sourceOfFunds = default(SourceOfFunds), List<WebData> webData = default(List<WebData>), WebDataExemption webDataExemption = default(WebDataExemption))
        {
