...
namespace Adyen.Model.LegalEntityManagement
{
    ...
    public partial class VerificationErrorRecursive :  IEquatable<VerificationErrorRecursive>, IValidatableObject
    {
        ...
        public VerificationErrorRecursive(List<CapabilitiesEnum> capabilities = default(List<CapabilitiesEnum>), string code = default(string), string message = default(string), TypeEnum? type = default(TypeEnum?), CapabilityProblemEntity entity = default(CapabilityProblemEntity), List<RemediatingAction> remediatingActions = default(List<RemediatingAction>))
        {
        ...
        public List<VerificationErrorRecursive.CapabilitiesEnum> Capabilities { get; set; }
