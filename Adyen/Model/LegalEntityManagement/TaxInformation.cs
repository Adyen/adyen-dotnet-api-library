...
namespace Adyen.Model.LegalEntityManagement
{
    ...
    public partial class TaxInformation : IEquatable<TaxInformation>, IValidatableObject
    {
        ...
        public TaxInformation(string country = default(string), string number = default(string), bool? numberAbsent = default(bool?), string type = default(string))
        {
        ...
        [DataMember(Name = "numberAbsent", EmitDefaultValue = false)]
        ...
        public bool Equals(TaxInformation input)
        {
            ...
            return 
                ...
                (
                    this.NumberAbsent == input.NumberAbsent ||
                    this.NumberAbsent.Equals(input.NumberAbsent)
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                hashCode = (hashCode * 59) + this.NumberAbsent.GetHashCode();
                if (this.Type != null)
                {
