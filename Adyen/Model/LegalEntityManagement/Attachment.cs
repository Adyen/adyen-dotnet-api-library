...
namespace Adyen.Model.LegalEntityManagement
{
    ...
    public partial class Attachment :  IEquatable<Attachment>, IValidatableObject
    {
        ...
        /// <param name="pageType">Specifies which side of the ID card is uploaded.  * When &#x60;type&#x60; is **driversLicense**, set this to **front** or **back**.  * When omitted, we infer the page number based on the order of attachments..</param>
        ...
        /// </summary>
        /// <value>Specifies which side of the ID card is uploaded.  * When &#x60;type&#x60; is **driversLicense**, set this to **front** or **back**.  * When omitted, we infer the page number based on the order of attachments.</value>
