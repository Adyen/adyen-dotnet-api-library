...
namespace Adyen.Model.BalanceWebhooks
{
    ...
    public partial class BalanceNotificationData : IEquatable<BalanceNotificationData>, IValidatableObject
    {
        ...
        /// <param name="currency">TThe three-character [ISO currency code](https://docs.adyen.com/development-resources/currency-codes). (required).</param>
        ...
        /// </summary>
        /// <value>TThe three-character [ISO currency code](https://docs.adyen.com/development-resources/currency-codes).</value>
