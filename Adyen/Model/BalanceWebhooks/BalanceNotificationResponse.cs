...
{
    /// <summary>
    /// BalanaceNotificationResponse
    /// </summary>
    [DataContract(Name = "BalancePlatformNotificationResponse")]
    public partial class BalanceNotificationResponse : IEquatable<BalanceNotificationResponse>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="BalanceNotificationResponse" /> class.
        /// </summary>
        ...
        public BalanceNotificationResponse(string notificationResponse = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class BalanceNotificationResponse {\n");
        ...
        {
            return this.Equals(input as BalanceNotificationResponse);
        }
        ...
        /// <returns>Boolean</returns>
        public bool Equals(BalanceNotificationResponse input)
        {
            if (input == null)
            {
                return false;
