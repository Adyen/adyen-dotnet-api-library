...
namespace Adyen.Model.ManagementWebhooks
{
    ...
    /// </summary>
    [DataContract(Name = "TerminalAssignmentNotificationResponse")]
    public partial class TerminalAssignmentNotificationResponse : IEquatable<TerminalAssignmentNotificationResponse>, IValidatableObject
    {
        /// <summary>
        ...
        public TerminalAssignmentNotificationResponse(string notificationResponse = default(string))
        {
        ...
        {
            return this.Equals(input as TerminalAssignmentNotificationResponse);
        }

        /// <summary>
        /// Returns true if TerminalAssignmentNotificationResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of TerminalAssignmentNotificationResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TerminalAssignmentNotificationResponse input)
        {
            if (input == null)
            {
                return false;
