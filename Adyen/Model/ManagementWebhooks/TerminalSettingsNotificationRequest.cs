...
namespace Adyen.Model.ManagementWebhooks
{
    ...
    /// </summary>
    [DataContract(Name = "TerminalSettingsNotificationRequest")]
    public partial class TerminalSettingsNotificationRequest : IEquatable<TerminalSettingsNotificationRequest>, IValidatableObject
    {
        /// <summary>
        ...
        {
            /// <summary>
            /// Enum TerminalSettingsModified for value: terminalSettings.modified
            /// </summary>
            [EnumMember(Value = "terminalSettings.modified")]
            TerminalSettingsModified = 1
        ...
        protected TerminalSettingsNotificationRequest() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="TerminalSettingsNotificationRequest" /> class.
        /// </summary>
        ...
        {
            return this.Equals(input as TerminalSettingsNotificationRequest);
        }

        /// <summary>
        /// Returns true if TerminalSettingsNotificationRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of TerminalSettingsNotificationRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TerminalSettingsNotificationRequest input)
        {
            if (input == null)
            {
                return false;
