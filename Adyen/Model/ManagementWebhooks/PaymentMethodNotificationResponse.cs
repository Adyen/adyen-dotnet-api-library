...
namespace Adyen.Model.ManagementWebhooks
{
    ...
    /// </summary>
    [DataContract(Name = "PaymentMethodNotificationResponse")]
    public partial class PaymentMethodNotificationResponse : IEquatable<PaymentMethodNotificationResponse>, IValidatableObject
    {
        /// <summary>
        ...
        {
            return this.Equals(input as PaymentMethodNotificationResponse);
        }

        /// <summary>
        /// Returns true if PaymentMethodNotificationResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of PaymentMethodNotificationResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PaymentMethodNotificationResponse input)
        {
            if (input == null)
            {
                return false;
