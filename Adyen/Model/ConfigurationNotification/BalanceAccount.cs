...
namespace Adyen.Model.ConfigurationNotification
{
    ...
    public partial class BalanceAccount : IEquatable<BalanceAccount>, IValidatableObject
    {
        ...
        public BalanceAccount(string accountHolderId = default(string), List<Balance> balances = default(List<Balance>), string defaultCurrencyCode = default(string), string description = default(string), string id = default(string), List<PaymentInstrumentReference> paymentInstruments = default(List<PaymentInstrumentReference>), string reference = default(string), StatusEnum? status = default(StatusEnum?), Dictionary<string, SweepConfiguration> sweepConfigurations = default(Dictionary<string, SweepConfiguration>), string timeZone = default(string))
        {
