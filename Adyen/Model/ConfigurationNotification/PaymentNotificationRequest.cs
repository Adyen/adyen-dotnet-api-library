...
namespace Adyen.Model.ConfigurationNotification
{
    ...
    /// </summary>
    [DataContract(Name = "PaymentNotificationRequest")]
    public partial class PaymentNotificationRequest : IEquatable<PaymentNotificationRequest>, IValidatableObject
    {
        /// <summary>
        ...
        {
            /// <summary>
            /// Enum Created for value: balancePlatform.paymentInstrument.created
            /// </summary>
            [EnumMember(Value = "balancePlatform.paymentInstrument.created")]
            Created = 1,

            /// <summary>
            /// Enum Updated for value: balancePlatform.paymentInstrument.updated
            /// </summary>
        ...
        protected PaymentNotificationRequest() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="PaymentNotificationRequest" /> class.
        /// </summary>
        ...
        {
            return this.Equals(input as PaymentNotificationRequest);
        }

        /// <summary>
        /// Returns true if PaymentNotificationRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of PaymentNotificationRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PaymentNotificationRequest input)
        {
            if (input == null)
            {
                return false;
