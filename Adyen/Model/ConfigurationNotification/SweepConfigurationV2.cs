...
namespace Adyen.Model.ConfigurationNotification
{
    ...
    public partial class SweepConfigurationV2 : IEquatable<SweepConfigurationV2>, IValidatableObject
    {
        ...
        public SweepConfigurationV2(SweepCounterparty counterparty = default(SweepCounterparty), string currency = default(string), string description = default(string), string id = default(string), ReasonEnum? reason = default(ReasonEnum?), SweepConfigurationSchedule schedule = default(SweepConfigurationSchedule), StatusEnum? status = default(StatusEnum?), Amount sweepAmount = default(Amount), Amount targetAmount = default(Amount), Amount triggerAmount = default(Amount), TypeEnum? type = TypeEnum.Push)
        {
