...
namespace Adyen.Model.ConfigurationNotification
{
    ...
    public partial class AccountHolderCapability : IEquatable<AccountHolderCapability>, IValidatableObject
    {
        ...
        public AccountHolderCapability(bool allowed = default(bool), AllowedLevelEnum? allowedLevel = default(AllowedLevelEnum?), JSONObject allowedSettings = default(JSONObject), bool enabled = default(bool), List<Object> problems = default(List<Object>), bool requested = default(bool), RequestedLevelEnum? requestedLevel = default(RequestedLevelEnum?), JSONObject requestedSettings = default(JSONObject), List<AccountSupportingEntityCapability> transferInstruments = default(List<AccountSupportingEntityCapability>), VerificationStatusEnum? verificationStatus = default(VerificationStatusEnum?))
        {
