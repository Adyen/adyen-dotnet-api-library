...
namespace Adyen.Model.ConfigurationWebhooks
{
    ...
    /// </summary>
    [DataContract(Name = "SweepConfigurationNotificationRequest")]
    public partial class SweepConfigurationNotificationRequest : IEquatable<SweepConfigurationNotificationRequest>, IValidatableObject
    {
        /// <summary>
        /// Type of webhook.
        /// </summary>
        ...
        {
            /// <summary>
            /// Enum Created for value: balancePlatform.balanceAccountSweep.created
            /// </summary>
            [EnumMember(Value = "balancePlatform.balanceAccountSweep.created")]
            Created = 1,

            /// <summary>
            /// Enum Updated for value: balancePlatform.balanceAccountSweep.updated
            /// </summary>
            [EnumMember(Value = "balancePlatform.balanceAccountSweep.updated")]
            Updated = 2,

            /// <summary>
            /// Enum Deleted for value: balancePlatform.balanceAccountSweep.deleted
            /// </summary>
        ...
        protected SweepConfigurationNotificationRequest() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="SweepConfigurationNotificationRequest" /> class.
        /// </summary>
        ...
        {
            return this.Equals(input as SweepConfigurationNotificationRequest);
        }

        /// <summary>
        /// Returns true if SweepConfigurationNotificationRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of SweepConfigurationNotificationRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SweepConfigurationNotificationRequest input)
        {
            if (input == null)
            {
                return false;
