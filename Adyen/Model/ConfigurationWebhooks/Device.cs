...
namespace Adyen.Model.ConfigurationWebhooks
{
    ...
    public partial class Device : IEquatable<Device>, IValidatableObject
    {
        ...
        /// </summary>
        /// <param name="formFactor">The form factor of the device used for provisioning the network token.  Possible values: **virtual**, **physical**..</param>
        ...
        /// </summary>
        /// <value>The form factor of the device used for provisioning the network token.  Possible values: **virtual**, **physical**.</value>
