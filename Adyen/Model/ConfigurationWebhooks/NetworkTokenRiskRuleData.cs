...
namespace Adyen.Model.ConfigurationWebhooks
{
    ...
    /// </summary>
    [DataContract(Name = "NetworkTokenRiskRuleData")]
    public partial class NetworkTokenRiskRuleData : IEquatable<NetworkTokenRiskRuleData>, IValidatableObject
    {
        /// <summary>
        ...
        public NetworkTokenRiskRuleData(string description = default(string), string id = default(string), string outcomeType = default(string), string reference = default(string), int? score = default(int?))
        {
        ...
        {
            return this.Equals(input as NetworkTokenRiskRuleData);
        }

        /// <summary>
        /// Returns true if NetworkTokenRiskRuleData instances are equal
        /// </summary>
        /// <param name="input">Instance of NetworkTokenRiskRuleData to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(NetworkTokenRiskRuleData input)
        {
            if (input == null)
            {
                return false;
