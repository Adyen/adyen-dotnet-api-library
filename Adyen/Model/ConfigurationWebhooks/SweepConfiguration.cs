...
namespace Adyen.Model.ConfigurationWebhooks
{
    ...
    public partial class SweepConfiguration : IEquatable<SweepConfiguration>, IValidatableObject
    {
        ...
        public SweepConfiguration(string balanceAccountId = default(string), string id = default(string), string merchantAccount = default(string), SweepSchedule schedule = default(SweepSchedule), StatusEnum? status = default(StatusEnum?), Amount sweepAmount = default(Amount), Amount targetAmount = default(Amount), string transferInstrumentId = default(string), Amount triggerAmount = default(Amount), TypeEnum? type = TypeEnum.Push)
        {
            this.Id = id;
