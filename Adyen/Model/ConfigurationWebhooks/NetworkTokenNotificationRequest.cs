...
namespace Adyen.Model.ConfigurationWebhooks
{
    ...
    /// </summary>
    [DataContract(Name = "NetworkTokenNotificationRequest")]
    public partial class NetworkTokenNotificationRequest : IEquatable<NetworkTokenNotificationRequest>, IValidatableObject
    {
        /// <summary>
        /// The type of webhook.
        /// </summary>
        ...
        {
            /// <summary>
            /// Enum Created for value: balancePlatform.networkToken.created
            /// </summary>
            [EnumMember(Value = "balancePlatform.networkToken.created")]
            Created = 1,

            /// <summary>
            /// Enum Updated for value: balancePlatform.networkToken.updated
            /// </summary>
        ...
        protected NetworkTokenNotificationRequest() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="NetworkTokenNotificationRequest" /> class.
        /// </summary>
        ...
        {
            return this.Equals(input as NetworkTokenNotificationRequest);
        }

        /// <summary>
        /// Returns true if NetworkTokenNotificationRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of NetworkTokenNotificationRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(NetworkTokenNotificationRequest input)
        {
            if (input == null)
            {
                return false;
