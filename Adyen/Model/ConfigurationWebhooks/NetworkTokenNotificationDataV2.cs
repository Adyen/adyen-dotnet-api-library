...
namespace Adyen.Model.ConfigurationWebhooks
{
    ...
    public partial class NetworkTokenNotificationDataV2 : IEquatable<NetworkTokenNotificationDataV2>, IValidatableObject
    {
        ...
        public NetworkTokenNotificationDataV2(TokenAuthentication authentication = default(TokenAuthentication), bool? authenticationApplied = default(bool?), string balancePlatform = default(string), string decision = default(string), string id = default(string), string paymentInstrumentId = default(string), string status = default(string), string tokenLastFour = default(string), string type = default(string), List<ValidationFacts> validationFacts = default(List<ValidationFacts>), Wallet wallet = default(Wallet))
        {
