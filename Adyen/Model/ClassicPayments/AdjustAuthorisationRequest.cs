...
namespace Adyen.Model.ClassicPayments
{
    ...
    /// </summary>
    [DataContract(Name = "AdjustAuthorisationRequest")]
    public partial class AdjustAuthorisationRequest : IEquatable<AdjustAuthorisationRequest>, IValidatableObject
    {
        /// <summary>
        ...
        {
            return this.Equals(input as AdjustAuthorisationRequest);
        }

        /// <summary>
        /// Returns true if AdjustAuthorisationRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of AdjustAuthorisationRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AdjustAuthorisationRequest input)
        {
            if (input == null)
            {
                return false;
