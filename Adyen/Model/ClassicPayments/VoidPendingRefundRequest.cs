...
namespace Adyen.Model.ClassicPayments
{
    ...
    /// </summary>
    [DataContract(Name = "VoidPendingRefundRequest")]
    public partial class VoidPendingRefundRequest : IEquatable<VoidPendingRefundRequest>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="VoidPendingRefundRequest" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected VoidPendingRefundRequest() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="VoidPendingRefundRequest" /> class.
        /// </summary>
        ...
        public VoidPendingRefundRequest(Dictionary<string, string> additionalData = default(Dictionary<string, string>), string merchantAccount = default(string), Amount modificationAmount = default(Amount), ThreeDSecureData mpiData = default(ThreeDSecureData), string originalMerchantReference = default(string), string originalReference = default(string), string reference = default(string), List<Split> splits = default(List<Split>), string tenderReference = default(string), string uniqueTerminalId = default(string))
        {
        ...
        {
            return this.Equals(input as VoidPendingRefundRequest);
        }

        /// <summary>
        /// Returns true if VoidPendingRefundRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of VoidPendingRefundRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(VoidPendingRefundRequest input)
        {
            if (input == null)
            {
                return false;
