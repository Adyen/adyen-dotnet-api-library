...
namespace Adyen.Model.Payment
{
    ...
    /// PaymentRequest3ds2
    /// </summary>
    [DataContract(Name = "PaymentRequest3ds2")]
    public partial class PaymentRequest3ds2 : IEquatable<PaymentRequest3ds2>, IValidatableObject
    {
        /// <summary>
        ...
        {
            return this.Equals(input as PaymentRequest3ds2);
        }

        /// <summary>
        /// Returns true if PaymentRequest3ds2 instances are equal
        /// </summary>
        /// <param name="input">Instance of PaymentRequest3ds2 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PaymentRequest3ds2 input)
        {
            if (input == null)
            {
                return false;
            ...
            return 
                ...
                (
                    this.ThreeDS2Token == input.ThreeDS2Token ||
                    (this.ThreeDS2Token != null &&
                    this.ThreeDS2Token.Equals(input.ThreeDS2Token))
                ) && 
                (
