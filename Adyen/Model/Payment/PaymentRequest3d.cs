...
namespace Adyen.Model.Payment
{
    ...
    /// PaymentRequest3d
    /// </summary>
    [DataContract(Name = "PaymentRequest3d")]
    public partial class PaymentRequest3d : IEquatable<PaymentRequest3d>, IValidatableObject
    {
        /// <summary>
        ...
        /// <param name="paResponse">Payment authorisation response returned by the card issuer. The &#x60;paResponse&#x60; field holds the PaRes value received from the card issuer. (required).</param>
        ...
        {
            return this.Equals(input as PaymentRequest3d);
        }

        /// <summary>
        /// Returns true if PaymentRequest3d instances are equal
        /// </summary>
        /// <param name="input">Instance of PaymentRequest3d to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PaymentRequest3d input)
        {
            if (input == null)
            {
                return false;
            ...
            return 
                ...
                (
                    this.PaResponse == input.PaResponse ||
                    (this.PaResponse != null &&
                    this.PaResponse.Equals(input.PaResponse))
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                {
                    hashCode = (hashCode * 59) + this.PaResponse.GetHashCode();
                }
