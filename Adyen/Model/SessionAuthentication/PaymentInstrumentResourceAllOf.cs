...
namespace Adyen.Model.SessionAuthentication
{
    ...
    public partial class PaymentInstrumentResourceAllOf : IEquatable<PaymentInstrumentResourceAllOf>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PaymentInstrumentResourceAllOf" /> class.
        /// </summary>
        ...
        {
            return this.Equals(input as PaymentInstrumentResourceAllOf);
        }

        /// <summary>
        /// Returns true if PaymentInstrumentResourceAllOf instances are equal
        /// </summary>
        /// <param name="input">Instance of PaymentInstrumentResourceAllOf to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PaymentInstrumentResourceAllOf input)
        {
            if (input == null)
            {
                return false;
