...
namespace Adyen.Model.BinLookup
{
    ...
    public partial class CardBin :  IEquatable<CardBin>, IValidatableObject
    {
        ...
        public CardBin(string bin = default(string), bool commercial = default(bool), string fundingSource = default(string), string fundsAvailability = default(string), string issuingBank = default(string), string issuingCountry = default(string), string issuingCurrency = default(string), string paymentMethod = default(string), string payoutEligible = default(string), string summary = default(string))
        {
            this.Bin = bin;
