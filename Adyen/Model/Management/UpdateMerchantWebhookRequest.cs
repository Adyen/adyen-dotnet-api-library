...
namespace Adyen.Model.Management
{
    ...
    /// </summary>
    [DataContract(Name = "UpdateMerchantWebhookRequest")]
    public partial class UpdateMerchantWebhookRequest : IEquatable<UpdateMerchantWebhookRequest>, IValidatableObject
    {
        /// <summary>
        ...
        {
            return this.Equals(input as UpdateMerchantWebhookRequest);
        }

        /// <summary>
        /// Returns true if UpdateMerchantWebhookRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of UpdateMerchantWebhookRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(UpdateMerchantWebhookRequest input)
        {
            if (input == null)
            {
                return false;
