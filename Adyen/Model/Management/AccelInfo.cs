...
namespace Adyen.Model.Management
{
    ...
    /// AccelInfo
    /// </summary>
    [DataContract(Name = "AccelInfo")]
    public partial class AccelInfo : IEquatable<AccelInfo>, IValidatableObject
    {
        /// <summary>
        ...
        public AccelInfo(ProcessingTypeEnum processingType = default(ProcessingTypeEnum), TransactionDescriptionInfo transactionDescription = default(TransactionDescriptionInfo))
        {
        ...
        {
            return this.Equals(input as AccelInfo);
        }

        /// <summary>
        /// Returns true if AccelInfo instances are equal
        /// </summary>
        /// <param name="input">Instance of AccelInfo to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AccelInfo input)
        {
            if (input == null)
            {
                return false;
