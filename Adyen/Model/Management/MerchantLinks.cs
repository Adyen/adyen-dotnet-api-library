...
namespace Adyen.Model.Management
{
    ...
    public partial class MerchantLinks : IEquatable<MerchantLinks>, IValidatableObject
    {
        ...
        {
            return this.Equals(input as MerchantLinks);
        }

        /// <summary>
        /// Returns true if MerchantLinks instances are equal
        /// </summary>
        /// <param name="input">Instance of MerchantLinks to be compared</param>
        /// <returns>Boolean</returns>
