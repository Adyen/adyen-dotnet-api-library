...
namespace Adyen.Model.Management
{
    ...
    /// AdditionalSettings
    /// </summary>
    [DataContract(Name = "AdditionalSettings")]
    public partial class AdditionalSettings : IEquatable<AdditionalSettings>, IValidatableObject
    {
        /// <summary>
        ...
        public AdditionalSettings(List<string> includeEventCodes = default(List<string>), Dictionary<string, bool> properties = default(Dictionary<string, bool>))
        {
        ...
        {
            return this.Equals(input as AdditionalSettings);
        }

        /// <summary>
        /// Returns true if AdditionalSettings instances are equal
        /// </summary>
        /// <param name="input">Instance of AdditionalSettings to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AdditionalSettings input)
        {
            if (input == null)
            {
                return false;
