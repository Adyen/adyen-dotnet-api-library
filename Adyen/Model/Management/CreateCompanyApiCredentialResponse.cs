...
namespace Adyen.Model.Management
{
    ...
    /// </summary>
    [DataContract(Name = "CreateCompanyApiCredentialResponse")]
    public partial class CreateCompanyApiCredentialResponse : IEquatable<CreateCompanyApiCredentialResponse>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CreateCompanyApiCredentialResponse" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected CreateCompanyApiCredentialResponse() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="CreateCompanyApiCredentialResponse" /> class.
        /// </summary>
        ...
        /// <param name="apiKey">The API key for the API credential that was created. (required).</param>
        /// <param name="associatedMerchantAccounts">List of merchant accounts that the API credential has access to. (required).</param>
        ...
        /// <param name="password">The password for the API credential that was created. (required).</param>
        ...
        [DataMember(Name = "associatedMerchantAccounts", IsRequired = false, EmitDefaultValue = false)]
        ...
        {
            return this.Equals(input as CreateCompanyApiCredentialResponse);
        }

        /// <summary>
        /// Returns true if CreateCompanyApiCredentialResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of CreateCompanyApiCredentialResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CreateCompanyApiCredentialResponse input)
        {
            if (input == null)
            {
                return false;
