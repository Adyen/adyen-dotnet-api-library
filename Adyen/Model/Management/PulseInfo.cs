...
namespace Adyen.Model.Management
{
    ...
    /// PulseInfo
    /// </summary>
    [DataContract(Name = "PulseInfo")]
    public partial class PulseInfo : IEquatable<PulseInfo>, IValidatableObject
    {
        /// <summary>
        ...
        public PulseInfo(ProcessingTypeEnum? processingType = default(ProcessingTypeEnum?), TransactionDescriptionInfo transactionDescription = default(TransactionDescriptionInfo))
        {
        ...
        {
            return this.Equals(input as PulseInfo);
        }

        /// <summary>
        /// Returns true if PulseInfo instances are equal
        /// </summary>
        /// <param name="input">Instance of PulseInfo to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PulseInfo input)
        {
            if (input == null)
            {
                return false;
