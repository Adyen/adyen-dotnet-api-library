...
namespace Adyen.Model.Management
{
    ...
    public partial class StoreCreationRequest :  IEquatable<StoreCreationRequest>, IValidatableObject
    {
        ...
        public StoreCreationRequest(Address2 address = default(Address2), List<string> businessLineIds = default(List<string>), string description = default(string), string externalReferenceId = default(string), string phoneNumber = default(string), string reference = default(string), string shopperStatement = default(string), StoreSplitConfiguration splitConfiguration = default(StoreSplitConfiguration))
        {
