...
namespace Adyen.Model.Management
{
    ...
    /// </summary>
    [DataContract(Name = "CreateCompanyUserRequest")]
    public partial class CreateCompanyUserRequest : IEquatable<CreateCompanyUserRequest>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CreateCompanyUserRequest" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected CreateCompanyUserRequest() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="CreateCompanyUserRequest" /> class.
        /// </summary>
        ...
        {
            return this.Equals(input as CreateCompanyUserRequest);
        }

        /// <summary>
        /// Returns true if CreateCompanyUserRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of CreateCompanyUserRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CreateCompanyUserRequest input)
        {
            if (input == null)
            {
                return false;
