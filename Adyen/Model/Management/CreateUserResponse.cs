...
namespace Adyen.Model.Management
{
    ...
    public partial class CreateUserResponse :  IEquatable<CreateUserResponse>, IValidatableObject
    {
        ...
        public CreateUserResponse(Links links = default(Links), List<string> accountGroups = default(List<string>), bool active = default(bool), string email = default(string), string id = default(string), Name name = default(Name), List<string> roles = default(List<string>), string timeZoneCode = default(string), string username = default(string))
        {
            this.Links = links;
