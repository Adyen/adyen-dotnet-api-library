...
namespace Adyen.Model.Management
{
    ...
    /// Commission
    /// </summary>
    [DataContract(Name = "Commission")]
    public partial class Commission : IEquatable<Commission>, IValidatableObject
    {
        /// <summary>
        ...
        public Commission(long? fixedAmount = default(long?), long? variablePercentage = default(long?))
        {
        ...
        {
            return this.Equals(input as Commission);
        }

        /// <summary>
        /// Returns true if Commission instances are equal
        /// </summary>
        /// <param name="input">Instance of Commission to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(Commission input)
        {
            if (input == null)
            {
                return false;
