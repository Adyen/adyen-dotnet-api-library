...
namespace Adyen.Model.Management
{
    ...
    /// </summary>
    [DataContract(Name = "UpdateCompanyWebhookRequest")]
    public partial class UpdateCompanyWebhookRequest : IEquatable<UpdateCompanyWebhookRequest>, IValidatableObject
    {
        /// <summary>
        ...
        protected UpdateCompanyWebhookRequest() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="UpdateCompanyWebhookRequest" /> class.
        /// </summary>
        ...
        {
            return this.Equals(input as UpdateCompanyWebhookRequest);
        }

        /// <summary>
        /// Returns true if UpdateCompanyWebhookRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of UpdateCompanyWebhookRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(UpdateCompanyWebhookRequest input)
        {
            if (input == null)
            {
                return false;
