...
namespace Adyen.Model.Management
{
    ...
    public partial class SplitConfigurationLogic : IEquatable<SplitConfigurationLogic>, IValidatableObject
    {
        ...
        public SplitConfigurationLogic(AdditionalCommission additionalCommission = default(AdditionalCommission), ChargebackEnum? chargeback = default(ChargebackEnum?), Commission commission = default(Commission), PaymentFeeEnum paymentFee = default(PaymentFeeEnum), RemainderEnum? remainder = default(RemainderEnum?), SurchargeEnum? surcharge = default(SurchargeEnum?), TipEnum? tip = default(TipEnum?))
        {
