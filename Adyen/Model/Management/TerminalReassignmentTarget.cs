...
namespace Adyen.Model.Management
{
    ...
    public partial class TerminalReassignmentTarget : IEquatable<TerminalReassignmentTarget>, IValidatableObject
    {
        ...
        /// Initializes a new instance of the <see cref="TerminalReassignmentTarget" /> class.
        /// </summary>
        /// <param name="companyId">The unique identifier of the company account after re-assignment.</param>
        /// <param name="inventory">inventory status of the terminal after re-assignment (required).</param>
        /// <param name="merchantId">The unique identifier of the merchant account after re-assignment.</param>
        /// <param name="storeId">The unique identifier of the store after re-assignment.</param>
        ...
        /// <summary>
        /// The unique identifier of the company account after re-assignment
        /// </summary>
        /// <value>The unique identifier of the company account after re-assignment</value>
        [DataMember(Name = "companyId", EmitDefaultValue = false)]
        public string CompanyId { get; set; }

        /// <summary>
        /// inventory status of the terminal after re-assignment
        /// </summary>
        /// <value>inventory status of the terminal after re-assignment</value>
        [DataMember(Name = "inventory", IsRequired = false, EmitDefaultValue = false)]
        public bool? Inventory { get; set; }

        /// <summary>
        /// The unique identifier of the merchant account after re-assignment
        /// </summary>
        /// <value>The unique identifier of the merchant account after re-assignment</value>
        [DataMember(Name = "merchantId", EmitDefaultValue = false)]
        public string MerchantId { get; set; }

        /// <summary>
        /// The unique identifier of the store after re-assignment
        /// </summary>
        /// <value>The unique identifier of the store after re-assignment</value>
