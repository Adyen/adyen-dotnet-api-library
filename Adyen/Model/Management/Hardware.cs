...
namespace Adyen.Model.Management
{
    ...
    public partial class Hardware : IEquatable<Hardware>, IValidatableObject
    {
        ...
        /// <param name="restartHour">The hour (0 - 23) in which the device will reboot, reboot will happen in the timezone of the device.</param>
        ...
        /// </summary>
        /// <value>The hour (0 - 23) in which the device will reboot, reboot will happen in the timezone of the device</value>
