...
namespace Adyen.Model.Management
{
    ...
    public partial class File : IEquatable<File>, IValidatableObject
    {
        ...
        /// Initializes a new instance of the <see cref="File" /> class.
        /// </summary>
        /// <param name="data">The certificate content converted to a Base64-encoded string. (required).</param>
        /// <param name="name">The name of the certificate. Must be unique across Wi-Fi profiles. (required).</param>
        public File(string data = default(string), string name = default(string))
        {
            this.Data = data;
            this.Name = name;
        }
