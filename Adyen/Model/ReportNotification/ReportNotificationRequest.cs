...
namespace Adyen.Model.ReportNotification
{
    ...
    /// </summary>
    [DataContract(Name = "ReportNotificationRequest")]
    public partial class ReportNotificationRequest : IEquatable<ReportNotificationRequest>, IValidatableObject
    {
        /// <summary>
        ...
        {
            /// <summary>
            /// Enum BalancePlatformReportCreated for value: balancePlatform.report.created
            /// </summary>
            [EnumMember(Value = "balancePlatform.report.created")]
            BalancePlatformReportCreated = 1
        ...
        protected ReportNotificationRequest() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ReportNotificationRequest" /> class.
        /// </summary>
        ...
        {
            return this.Equals(input as ReportNotificationRequest);
        }

        /// <summary>
        /// Returns true if ReportNotificationRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of ReportNotificationRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ReportNotificationRequest input)
        {
            if (input == null)
            {
                return false;
