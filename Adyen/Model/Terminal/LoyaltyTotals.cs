...
namespace Adyen.Model.Terminal
{
    ...
    /// </summary>
    [DataContract(Name = "LoyaltyTotals")]
    public partial class LoyaltyTotals : IEquatable<LoyaltyTotals>, IValidatableObject
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="LoyaltyTotals" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected LoyaltyTotals() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="LoyaltyTotals" /> class.
        /// </summary>
        ...
        public LoyaltyTotals(TransactionType transactionType = default(TransactionType), int? transactionCount = default(int?), decimal? transactionAmount = default(decimal?))
        {
        ...
        {
            return this.Equals(input as LoyaltyTotals);
        }

        /// <summary>
        /// Returns true if LoyaltyTotals instances are equal
        /// </summary>
        /// <param name="input">Instance of LoyaltyTotals to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(LoyaltyTotals input)
        {
            if (input == null)
            {
                return false;
