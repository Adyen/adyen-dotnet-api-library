...
namespace Adyen.Model.Terminal
{
    ...
    /// POISoftware
    /// </summary>
    [DataContract(Name = "POISoftware")]
    public partial class POISoftware : IEquatable<POISoftware>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="POISoftware" /> class.
        /// </summary>
        ...
        public POISoftware(string manufacturerID = default(string), string applicationName = default(string), string softwareVersion = default(string), string certificationCode = default(string))
        {
        ...
        {
            return this.Equals(input as POISoftware);
        }

        /// <summary>
        /// Returns true if POISoftware instances are equal
        /// </summary>
        /// <param name="input">Instance of POISoftware to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(POISoftware input)
        {
            if (input == null)
            {
                return false;
