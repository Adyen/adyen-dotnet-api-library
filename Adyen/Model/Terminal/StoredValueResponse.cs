...
namespace Adyen.Model.Terminal
{
    ...
    /// </summary>
    [DataContract(Name = "StoredValueResponse")]
    public partial class StoredValueResponse : IEquatable<StoredValueResponse>, IValidatableObject
    {
        ...
        /// <param name="storedValueResult">storedValueResult.</param>
        /// <param name="paymentReceipt">paymentReceipt.</param>
        public StoredValueResponse(Response response = default(Response), SaleData saleData = default(SaleData), POIData pOIData = default(POIData), List<StoredValueResult> storedValueResult = default(List<StoredValueResult>), List<PaymentReceipt> paymentReceipt = default(List<PaymentReceipt>))
        {
        ...
        /// <summary>
        /// Gets or Sets StoredValueResult
        /// </summary>
        [DataMember(Name = "StoredValueResult", EmitDefaultValue = false)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("  StoredValueResult: ").Append(StoredValueResult).Append("\n");
        ...
        {
            return this.Equals(input as StoredValueResponse);
        }
        ...
        public bool Equals(StoredValueResponse input)
        {
            ...
            return 
                ...
                (
                    this.StoredValueResult == input.StoredValueResult ||
                    this.StoredValueResult != null &&
                    input.StoredValueResult != null &&
                    this.StoredValueResult.SequenceEqual(input.StoredValueResult)
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                {
                    hashCode = (hashCode * 59) + this.StoredValueResult.GetHashCode();
                }
