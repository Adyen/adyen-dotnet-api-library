...
namespace Adyen.Model.ManagementNotificationService
{
    ...
    /// </summary>
    [DataContract(Name = "NotificationDataMessage")]
    public partial class NotificationDataMessage : IEquatable<NotificationDataMessage>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="NotificationDataMessage" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected NotificationDataMessage() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="NotificationDataMessage" /> class.
        /// </summary>
        ...
        public NotificationDataMessage(DateTime createdAt = default(DateTime), MidServiceNotificationData data = default(MidServiceNotificationData), string environment = default(string), string type = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class NotificationDataMessage {\n");
        ...
        {
            return this.Equals(input as NotificationDataMessage);
        }

        /// <summary>
        /// Returns true if NotificationDataMessage instances are equal
        /// </summary>
        /// <param name="input">Instance of NotificationDataMessage to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(NotificationDataMessage input)
        {
            if (input == null)
            {
                return false;
