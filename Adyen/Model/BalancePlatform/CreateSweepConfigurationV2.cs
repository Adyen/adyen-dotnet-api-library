...
namespace Adyen.Model.BalancePlatform
{
    ...
    public partial class CreateSweepConfigurationV2 : IEquatable<CreateSweepConfigurationV2>, IValidatableObject
    {
        ...
        public enum ReasonEnum
        {
            ...
            TransferInstrumentDoesNotExist = 15,
        ...
        public CreateSweepConfigurationV2(CategoryEnum? category = default(CategoryEnum?), SweepCounterparty counterparty = default(SweepCounterparty), string currency = default(string), string description = default(string), List<PrioritiesEnum> priorities = default(List<PrioritiesEnum>), string reference = default(string), string referenceForBeneficiary = default(string), SweepSchedule schedule = default(SweepSchedule), StatusEnum? status = default(StatusEnum?), Amount sweepAmount = default(Amount), Amount targetAmount = default(Amount), Amount triggerAmount = default(Amount), TypeEnum? type = TypeEnum.Push)
        {
