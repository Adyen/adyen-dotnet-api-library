...
namespace Adyen.Model.BalancePlatform
{
    ...
    public partial class AccountHolderCapability : IEquatable<AccountHolderCapability>, IValidatableObject
    {
        ...
        public AccountHolderCapability(JSONObject allowedSettings = default(JSONObject), bool enabled = default(bool), bool requested = default(bool), RequestedLevelEnum? requestedLevel = default(RequestedLevelEnum?), JSONObject requestedSettings = default(JSONObject))
        {
