...
namespace Adyen.Model.BalancePlatform
{
    ...
    /// </summary>
    [DataContract(Name = "PaymentInstrumentInfo")]
    public partial class PaymentInstrumentInfo : IEquatable<PaymentInstrumentInfo>, IValidatableObject
    {
        /// <summary>
        ...
        protected PaymentInstrumentInfo() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="PaymentInstrumentInfo" /> class.
        /// </summary>
        ...
        public PaymentInstrumentInfo(string balanceAccountId = default(string), CardInfo card = default(CardInfo), string description = default(string), string issuingCountryCode = default(string), string paymentInstrumentGroupId = default(string), string reference = default(string), StatusEnum? status = default(StatusEnum?), StatusReasonEnum? statusReason = default(StatusReasonEnum?), TypeEnum type = default(TypeEnum))
        {
        ...
        {
            return this.Equals(input as PaymentInstrumentInfo);
        }

        /// <summary>
        /// Returns true if PaymentInstrumentInfo instances are equal
        /// </summary>
        /// <param name="input">Instance of PaymentInstrumentInfo to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PaymentInstrumentInfo input)
        {
            if (input == null)
            {
                return false;
