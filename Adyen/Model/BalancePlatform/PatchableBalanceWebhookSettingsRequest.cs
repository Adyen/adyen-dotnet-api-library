...
namespace Adyen.Model.BalancePlatform
{
    ...
    /// </summary>
    [DataContract(Name = "PatchableBalanceWebhookSettingsRequest")]
    public partial class PatchableBalanceWebhookSettingsRequest : IEquatable<PatchableBalanceWebhookSettingsRequest>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="PatchableBalanceWebhookSettingsRequest" /> class.
        /// </summary>
        ...
        public PatchableBalanceWebhookSettingsRequest(List<Condition> conditions = default(List<Condition>), string currency = default(string), StatusEnum? status = default(StatusEnum?), PatchableTarget target = default(PatchableTarget), TypeEnum? type = default(TypeEnum?))
        {
        ...
        public PatchableTarget Target { get; set; }
        ...
        {
            return this.Equals(input as PatchableBalanceWebhookSettingsRequest);
        }

        /// <summary>
        /// Returns true if PatchableBalanceWebhookSettingsRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of PatchableBalanceWebhookSettingsRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PatchableBalanceWebhookSettingsRequest input)
        {
            if (input == null)
            {
                return false;
