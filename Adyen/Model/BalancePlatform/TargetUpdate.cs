...
namespace Adyen.Model.BalancePlatform
{
    ...
    /// TargetUpdate
    /// </summary>
    [DataContract(Name = "TargetUpdate")]
    public partial class TargetUpdate : IEquatable<TargetUpdate>, IValidatableObject
    {
        /// <summary>
        ...
        public TargetUpdate(string id = default(string), TypeEnum? type = default(TypeEnum?))
        {
            this.Id = id;
            this.Type = type;
        }
        ...
        {
            return this.Equals(input as TargetUpdate);
        }

        /// <summary>
        /// Returns true if TargetUpdate instances are equal
        /// </summary>
        /// <param name="input">Instance of TargetUpdate to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TargetUpdate input)
        {
            if (input == null)
            {
                return false;
