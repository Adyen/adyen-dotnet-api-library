...
namespace Adyen.Model.BalancePlatform
{
    ...
    public partial class BalanceAccountInfo : IEquatable<BalanceAccountInfo>, IValidatableObject
    {
        ...
        public BalanceAccountInfo(string accountHolderId = default(string), string defaultCurrencyCode = default(string), string description = default(string), Dictionary<string, string> metadata = default(Dictionary<string, string>), string reference = default(string), string timeZone = default(string))
        {
