...
namespace Adyen.Model.NegativeBalanceWarningWebhooks
{
    ...
    /// </summary>
    [DataContract(Name = "NegativeBalanceCompensationWarningNotificationRequest")]
    public partial class NegativeBalanceCompensationWarningNotificationRequest : IEquatable<NegativeBalanceCompensationWarningNotificationRequest>, IValidatableObject
    {
        /// <summary>
        /// Type of webhook.
        /// </summary>
        ...
        {
            /// <summary>
            /// Enum BalancePlatformNegativeBalanceCompensationWarningScheduled for value: balancePlatform.negativeBalanceCompensationWarning.scheduled
            /// </summary>
            [EnumMember(Value = "balancePlatform.negativeBalanceCompensationWarning.scheduled")]
            BalancePlatformNegativeBalanceCompensationWarningScheduled = 1
        ...
        protected NegativeBalanceCompensationWarningNotificationRequest() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="NegativeBalanceCompensationWarningNotificationRequest" /> class.
        /// </summary>
        ...
        {
            return this.Equals(input as NegativeBalanceCompensationWarningNotificationRequest);
        }

        /// <summary>
        /// Returns true if NegativeBalanceCompensationWarningNotificationRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of NegativeBalanceCompensationWarningNotificationRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(NegativeBalanceCompensationWarningNotificationRequest input)
        {
            if (input == null)
            {
                return false;
