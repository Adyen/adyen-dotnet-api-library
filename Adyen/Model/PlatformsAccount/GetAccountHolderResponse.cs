...
namespace Adyen.Model.PlatformsAccount
{
    ...
    /// </summary>
    [DataContract(Name = "GetAccountHolderResponse")]
    public partial class GetAccountHolderResponse : IEquatable<GetAccountHolderResponse>, IValidatableObject
    {
        ...
        /// <param name="accountHolderStatus">accountHolderStatus.</param>
        ...
        /// <param name="legalEntity">The legal entity of the account holder..</param>
        /// <param name="migrationData">migrationData.</param>
        ...
        public GetAccountHolderResponse(string accountHolderCode = default(string), AccountHolderDetails accountHolderDetails = default(AccountHolderDetails), AccountHolderStatus accountHolderStatus = default(AccountHolderStatus), List<Account> accounts = default(List<Account>), string description = default(string), List<ErrorFieldType> invalidFields = default(List<ErrorFieldType>), LegalEntityEnum? legalEntity = default(LegalEntityEnum?), MigrationData migrationData = default(MigrationData), string primaryCurrency = default(string), string pspReference = default(string), string resultCode = default(string), DateTime systemUpToDateTime = default(DateTime), KYCVerificationResult verification = default(KYCVerificationResult), string verificationProfile = default(string))
        {
        ...
        /// <summary>
        /// Gets or Sets MigrationData
        /// </summary>
        [DataMember(Name = "migrationData", EmitDefaultValue = false)]
        public MigrationData MigrationData { get; set; }
        ...
        public bool Equals(GetAccountHolderResponse input)
        {
            ...
            return 
                ...
                (
                    ...
                    this.MigrationData.Equals(input.MigrationData))
                ) && 
                (
