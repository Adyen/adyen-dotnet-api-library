...
namespace Adyen.Model.PlatformsAccount
{
    ...
    /// </summary>
    [DataContract(Name = "CreateAccountHolderResponse")]
    public partial class CreateAccountHolderResponse : IEquatable<CreateAccountHolderResponse>, IValidatableObject
    {
        ...
        /// <param name="accountHolderCode">The code of the new account holder..</param>
        ...
        /// <param name="legalEntity">The type of legal entity of the new account holder..</param>
