...
namespace Adyen.Model.StoredValue
{
    ...
    /// </summary>
    [DataContract(Name = "StoredValueVoidResponse")]
    public partial class StoredValueVoidResponse : IEquatable<StoredValueVoidResponse>, IValidatableObject
    {
        /// <summary>
        ...
        public StoredValueVoidResponse(Amount currentBalance = default(Amount), string pspReference = default(string), string refusalReason = default(string), ResultCodeEnum? resultCode = default(ResultCodeEnum?), string thirdPartyRefusalReason = default(string))
        {
        ...
        {
            return this.Equals(input as StoredValueVoidResponse);
        }

        /// <summary>
        /// Returns true if StoredValueVoidResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of StoredValueVoidResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(StoredValueVoidResponse input)
        {
            if (input == null)
            {
                return false;
