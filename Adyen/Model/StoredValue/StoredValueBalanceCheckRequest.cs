...
namespace Adyen.Model.StoredValue
{
    ...
    /// </summary>
    [DataContract(Name = "StoredValueBalanceCheckRequest")]
    public partial class StoredValueBalanceCheckRequest : IEquatable<StoredValueBalanceCheckRequest>, IValidatableObject
    {
        /// <summary>
        ...
        protected StoredValueBalanceCheckRequest() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="StoredValueBalanceCheckRequest" /> class.
        /// </summary>
        ...
        {
            return this.Equals(input as StoredValueBalanceCheckRequest);
        }

        /// <summary>
        /// Returns true if StoredValueBalanceCheckRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of StoredValueBalanceCheckRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(StoredValueBalanceCheckRequest input)
        {
            if (input == null)
            {
                return false;
