...
namespace Adyen.Model.StoredValue
{
    ...
    /// </summary>
    [DataContract(Name = "StoredValueIssueRequest")]
    public partial class StoredValueIssueRequest : IEquatable<StoredValueIssueRequest>, IValidatableObject
    {
        /// <summary>
        ...
        protected StoredValueIssueRequest() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="StoredValueIssueRequest" /> class.
        /// </summary>
        ...
        {
            return this.Equals(input as StoredValueIssueRequest);
        }

        /// <summary>
        /// Returns true if StoredValueIssueRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of StoredValueIssueRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(StoredValueIssueRequest input)
        {
            if (input == null)
            {
                return false;
