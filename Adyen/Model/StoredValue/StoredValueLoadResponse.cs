...
namespace Adyen.Model.StoredValue
{
    ...
    /// </summary>
    [DataContract(Name = "StoredValueLoadResponse")]
    public partial class StoredValueLoadResponse : IEquatable<StoredValueLoadResponse>, IValidatableObject
    {
        /// <summary>
        ...
        public StoredValueLoadResponse(string authCode = default(string), Amount currentBalance = default(Amount), string pspReference = default(string), string refusalReason = default(string), ResultCodeEnum? resultCode = default(ResultCodeEnum?), string thirdPartyRefusalReason = default(string))
        {
        ...
        {
            return this.Equals(input as StoredValueLoadResponse);
        }

        /// <summary>
        /// Returns true if StoredValueLoadResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of StoredValueLoadResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(StoredValueLoadResponse input)
        {
            if (input == null)
            {
                return false;
