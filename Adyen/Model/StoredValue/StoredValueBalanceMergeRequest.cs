...
namespace Adyen.Model.StoredValue
{
    ...
    /// </summary>
    [DataContract(Name = "StoredValueBalanceMergeRequest")]
    public partial class StoredValueBalanceMergeRequest : IEquatable<StoredValueBalanceMergeRequest>, IValidatableObject
    {
        /// <summary>
        ...
        protected StoredValueBalanceMergeRequest() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="StoredValueBalanceMergeRequest" /> class.
        /// </summary>
        ...
        /// <param name="sourcePaymentMethod">The collection that contains the source payment method and its specific information if available. Note that type should not be included since it is inferred from the (target) payment method (required).</param>
        /// <param name="store">The physical store, for which this payment is processed..</param>
        public StoredValueBalanceMergeRequest(Amount amount = default(Amount), string merchantAccount = default(string), Dictionary<string, string> paymentMethod = default(Dictionary<string, string>), string recurringDetailReference = default(string), string reference = default(string), ShopperInteractionEnum? shopperInteraction = default(ShopperInteractionEnum?), string shopperReference = default(string), Dictionary<string, string> sourcePaymentMethod = default(Dictionary<string, string>), string store = default(string))
        {
        ...
        {
            return this.Equals(input as StoredValueBalanceMergeRequest);
        }

        /// <summary>
        /// Returns true if StoredValueBalanceMergeRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of StoredValueBalanceMergeRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(StoredValueBalanceMergeRequest input)
        {
            if (input == null)
            {
                return false;
            ...
            return 
                ...
                (
                    this.SourcePaymentMethod == input.SourcePaymentMethod ||
                    this.SourcePaymentMethod != null &&
                    input.SourcePaymentMethod != null &&
                    this.SourcePaymentMethod.SequenceEqual(input.SourcePaymentMethod)
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                {
                    hashCode = (hashCode * 59) + this.SourcePaymentMethod.GetHashCode();
                }
                if (this.Store != null)
                {
