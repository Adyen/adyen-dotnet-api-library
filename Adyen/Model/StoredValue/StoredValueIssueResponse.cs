...
namespace Adyen.Model.StoredValue
{
    ...
    /// </summary>
    [DataContract(Name = "StoredValueIssueResponse")]
    public partial class StoredValueIssueResponse : IEquatable<StoredValueIssueResponse>, IValidatableObject
    {
        /// <summary>
        ...
        public StoredValueIssueResponse(string authCode = default(string), Amount currentBalance = default(Amount), Dictionary<string, string> paymentMethod = default(Dictionary<string, string>), string pspReference = default(string), string refusalReason = default(string), ResultCodeEnum? resultCode = default(ResultCodeEnum?), string thirdPartyRefusalReason = default(string))
        {
        ...
        {
            return this.Equals(input as StoredValueIssueResponse);
        }

        /// <summary>
        /// Returns true if StoredValueIssueResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of StoredValueIssueResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(StoredValueIssueResponse input)
        {
            if (input == null)
            {
                return false;
