...
namespace Adyen.Model.TokenizationWebhooks
{
    ...
    /// </summary>
    [DataContract(Name = "TokenizationNotificationResponse")]
    public partial class TokenizationNotificationResponse : IEquatable<TokenizationNotificationResponse>, IValidatableObject
    {
        /// <summary>
        ...
        public TokenizationNotificationResponse(string notificationResponse = default(string))
        {
        ...
        {
            return this.Equals(input as TokenizationNotificationResponse);
        }

        /// <summary>
        /// Returns true if TokenizationNotificationResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of TokenizationNotificationResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TokenizationNotificationResponse input)
        {
            if (input == null)
            {
                return false;
