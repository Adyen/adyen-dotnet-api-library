...
namespace Adyen.Model.TokenizationWebhooks
{
    ...
    /// </summary>
    [DataContract(Name = "RecurringTokenStoreOperation")]
    public partial class RecurringTokenStoreOperation : IEquatable<RecurringTokenStoreOperation>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="RecurringTokenStoreOperation" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected RecurringTokenStoreOperation() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="RecurringTokenStoreOperation" /> class.
        /// </summary>
        ...
        /// <param name="operation">A text description that provides details about the operation, intended for audit purposes. (required).</param>
        ...
        public RecurringTokenStoreOperation(string merchantAccount = default(string), string operation = default(string), string shopperReference = default(string), string storedPaymentMethodId = default(string), string type = default(string))
        {
        ...
        {
            return this.Equals(input as RecurringTokenStoreOperation);
        }

        /// <summary>
        /// Returns true if RecurringTokenStoreOperation instances are equal
        /// </summary>
        /// <param name="input">Instance of RecurringTokenStoreOperation to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(RecurringTokenStoreOperation input)
        {
            if (input == null)
            {
                return false;
