...
namespace Adyen.Model.Disputes
{
    ...
    /// </summary>
    [DataContract(Name = "AcceptDisputeRequest")]
    public partial class AcceptDisputeRequest : IEquatable<AcceptDisputeRequest>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AcceptDisputeRequest" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected AcceptDisputeRequest() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="AcceptDisputeRequest" /> class.
        /// </summary>
        ...
        public AcceptDisputeRequest(string disputePspReference = default(string), string merchantAccountCode = default(string))
        {
        ...
        {
            return this.Equals(input as AcceptDisputeRequest);
        }

        /// <summary>
        /// Returns true if AcceptDisputeRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of AcceptDisputeRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AcceptDisputeRequest input)
        {
            if (input == null)
            {
                return false;
