...
namespace Adyen.Model.Disputes
{
    ...
    /// </summary>
    [DataContract(Name = "DeleteDefenseDocumentRequest")]
    public partial class DeleteDefenseDocumentRequest : IEquatable<DeleteDefenseDocumentRequest>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DeleteDefenseDocumentRequest" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected DeleteDefenseDocumentRequest() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="DeleteDefenseDocumentRequest" /> class.
        /// </summary>
        ...
        public DeleteDefenseDocumentRequest(string defenseDocumentType = default(string), string disputePspReference = default(string), string merchantAccountCode = default(string))
        {
        ...
        {
            return this.Equals(input as DeleteDefenseDocumentRequest);
        }

        /// <summary>
        /// Returns true if DeleteDefenseDocumentRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of DeleteDefenseDocumentRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(DeleteDefenseDocumentRequest input)
        {
            if (input == null)
            {
                return false;
