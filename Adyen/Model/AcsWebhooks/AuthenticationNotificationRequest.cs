...
namespace Adyen.Model.AcsWebhooks
{
    ...
    /// </summary>
    [DataContract(Name = "AuthenticationNotificationRequest")]
    public partial class AuthenticationNotificationRequest : IEquatable<AuthenticationNotificationRequest>, IValidatableObject
    {
        /// <summary>
        ...
        {
            /// <summary>
            /// Enum BalancePlatformAuthenticationCreated for value: balancePlatform.authentication.created
            /// </summary>
            [EnumMember(Value = "balancePlatform.authentication.created")]
            BalancePlatformAuthenticationCreated = 1
        ...
        protected AuthenticationNotificationRequest() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="AuthenticationNotificationRequest" /> class.
        /// </summary>
        ...
        {
            return this.Equals(input as AuthenticationNotificationRequest);
        }

        /// <summary>
        /// Returns true if AuthenticationNotificationRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of AuthenticationNotificationRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AuthenticationNotificationRequest input)
        {
            if (input == null)
            {
                return false;
