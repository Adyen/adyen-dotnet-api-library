...
namespace Adyen.Client
{
    ...
    public class HostConfiguration
    {
        ...
        public HostConfiguration(IServiceCollection services)
        {
            ...
            _services.AddTransient<IDonationsService, DonationsService>();
            _services.AddSingleton<ModificationsServiceEvents>();
            _services.AddTransient<IModificationsService, ModificationsService>();
            _services.AddSingleton<OrdersServiceEvents>();
            _services.AddTransient<IOrdersService, OrdersService>();
            _services.AddSingleton<PaymentLinksServiceEvents>();
            _services.AddTransient<IPaymentLinksService, PaymentLinksService>();
            _services.AddSingleton<PaymentsServiceEvents>();
            _services.AddTransient<IPaymentsService, PaymentsService>();
            _services.AddSingleton<RecurringServiceEvents>();
            _services.AddTransient<IRecurringService, RecurringService>();
            _services.AddSingleton<UtilityServiceEvents>();
            _services.AddTransient<IUtilityService, UtilityService>();
        }
