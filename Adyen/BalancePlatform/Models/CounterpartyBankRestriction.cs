...
namespace Adyen.BalancePlatform.Models
{
    ...
    /// </summary>
    [JsonConverter(typeof(CounterpartyBankRestrictionJsonConverter))]
    public partial class CounterpartyBankRestriction
    {
        /// <summary>
    ...
    public class CounterpartyBankRestrictionJsonConverter : JsonConverter<CounterpartyBankRestriction>
    {
        ...
        public override CounterpartyBankRestriction Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            var counterpartyBankRestriction = new CounterpartyBankRestriction();
            counterpartyBankRestriction.Operation = operation.Value!;
            if (value.IsSet)
                counterpartyBankRestriction.Value = value.Value;
            return counterpartyBankRestriction;
        }
