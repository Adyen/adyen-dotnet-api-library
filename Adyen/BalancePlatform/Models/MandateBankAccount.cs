...
namespace Adyen.BalancePlatform.Models
{
    ...
    public partial class MandateBankAccount
    {
        ...
        [JsonConstructor]
        public MandateBankAccount(MandatePartyIdentification accountHolder, MandateAccountIdentification accountIdentification)
        {
        ...
        public MandateAccountIdentification AccountIdentification { get; set; }
    ...
    public class MandateBankAccountJsonConverter : JsonConverter<MandateBankAccount>
    {
        ...
        public override MandateBankAccount Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            Option<MandateAccountIdentification?> accountIdentification = default;
                ...
                if (utf8JsonReader.TokenType == JsonTokenType.PropertyName && currentDepth == utf8JsonReader.CurrentDepth - 1)
                {
                    ...
                    switch (jsonPropertyName)
                    {
                        ...
                        case "accountIdentification":
                            accountIdentification = new Option<MandateAccountIdentification?>(JsonSerializer.Deserialize<MandateAccountIdentification>(ref utf8JsonReader, jsonSerializerOptions)!);
                            break;
                        default:
                            break;
                    }
