...
namespace Adyen.BalancePlatform.Models
{
    ...
    public class GrantOffersJsonConverter : JsonConverter<GrantOffers>
    {
        ...
        public override GrantOffers Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (varGrantOffers.IsSet && varGrantOffers.Value == null)
                throw new ArgumentNullException(nameof(varGrantOffers), "Property is not nullable for class GrantOffers.");
        ...
        {
            /*
            if (grantOffers.VarGrantOffers == null)
                throw new ArgumentNullException(nameof(grantOffers.VarGrantOffers), "Property is required for class GrantOffers.");
