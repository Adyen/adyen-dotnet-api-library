...
namespace Adyen.BalancePlatform.Models
{
    ...
    /// </summary>
    [JsonConverter(typeof(BrandVariantsRestrictionJsonConverter))]
    public partial class BrandVariantsRestriction
    {
        /// <summary>
    ...
    public class BrandVariantsRestrictionJsonConverter : JsonConverter<BrandVariantsRestriction>
    {
        ...
        public override BrandVariantsRestriction Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            var brandVariantsRestriction = new BrandVariantsRestriction();
            brandVariantsRestriction.Operation = operation.Value!;
            if (value.IsSet)
                brandVariantsRestriction.Value = value.Value;
            return brandVariantsRestriction;
        }
