...
namespace Adyen.BalancePlatform.Models
{
    ...
    /// </summary>
    public partial class BrandVariantsRestriction : IValidatableObject
    {
        /// <summary>
        ...
        [JsonConstructor]
        public BrandVariantsRestriction(string operation, Option<List<string>?> value = default)
        {
            Operation = operation;
            _ValueOption = value;
            OnCreated();
    ...
    /// <summary>
    /// A Json converter for type <see cref="BrandVariantsRestriction" />
    /// </summary>
    public class BrandVariantsRestrictionJsonConverter : JsonConverter<BrandVariantsRestriction>
    {
        /// <summary>
        /// Deserializes json to <see cref="BrandVariantsRestriction"/>.
        /// </summary>
        /// <param name="utf8JsonReader"><see cref="Utf8JsonReader"/></param>
        /// <param name="typeToConvert"><see cref="Type"/></param>
        /// <param name="jsonSerializerOptions">The <see cref="JsonSerializerOptions"/>, initialized from <see cref="HostConfiguration"/>.</param>
        /// <returns><see cref="BrandVariantsRestriction"/></returns>
        /// <exception cref="JsonException"></exception>
        public override BrandVariantsRestriction Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (!operation.IsSet)
                throw new ArgumentException("Property is required for class BrandVariantsRestriction.", nameof(operation));

            if (operation.IsSet && operation.Value == null)
                throw new ArgumentNullException(nameof(operation), "Property is not nullable for class BrandVariantsRestriction.");

            if (value.IsSet && value.Value == null)
                throw new ArgumentNullException(nameof(value), "Property is not nullable for class BrandVariantsRestriction.");

            return new BrandVariantsRestriction(operation.Value!, value);
        }

        /// <summary>
        /// Serializes a <see cref="BrandVariantsRestriction"/>.
        /// </summary>
        /// <param name="writer"><see cref="Utf8JsonWriter"/></param>
        /// <param name="brandVariantsRestriction"></param>
        /// <param name="jsonSerializerOptions"><see cref="JsonSerializerOptions"/></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, BrandVariantsRestriction brandVariantsRestriction, JsonSerializerOptions jsonSerializerOptions)
        {
        ...
        /// <summary>
        /// Serializes the properties of <see cref="BrandVariantsRestriction"/>.
        /// </summary>
        /// <param name="writer"><see creft="Utf8JsonWriter"/></param>
        /// <param name="brandVariantsRestriction"></param>
        /// <param name="jsonSerializerOptions"><see cref="JsonSerializerOptions"/></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, BrandVariantsRestriction brandVariantsRestriction, JsonSerializerOptions jsonSerializerOptions)
        {
            /*
            if (brandVariantsRestriction.Operation == null)
                throw new ArgumentNullException(nameof(brandVariantsRestriction.Operation), "Property is required for class BrandVariantsRestriction.");

            if (brandVariantsRestriction._ValueOption.IsSet && brandVariantsRestriction.Value == null)
                throw new ArgumentNullException(nameof(brandVariantsRestriction.Value), "Property is required for class BrandVariantsRestriction.");

            */
            
            writer.WriteString("operation", brandVariantsRestriction.Operation);

            if (brandVariantsRestriction._ValueOption.IsSet)
            {
                writer.WritePropertyName("value");
                JsonSerializer.Serialize(writer, brandVariantsRestriction.Value, jsonSerializerOptions);
            }
        }
    }
}
