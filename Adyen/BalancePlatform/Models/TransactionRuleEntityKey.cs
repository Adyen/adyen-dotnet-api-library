...
namespace Adyen.BalancePlatform.Models
{
    ...
    /// </summary>
    [JsonConverter(typeof(TransactionRuleEntityKeyJsonConverter))]
    public partial class TransactionRuleEntityKey
    {
        /// <summary>
        ...
        /// <summary>
        /// This is used to track if an optional field is set. If set, <see cref="EntityReference"/> will be populated.
        /// </summary>
        [JsonIgnore]
    ...
    public class TransactionRuleEntityKeyJsonConverter : JsonConverter<TransactionRuleEntityKey>
    {
        ...
        public override TransactionRuleEntityKey Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (entityType.IsSet)
                transactionRuleEntityKey.EntityType = entityType.Value;
            return transactionRuleEntityKey;
        }
        ...
        public void WriteProperties(Utf8JsonWriter writer, TransactionRuleEntityKey transactionRuleEntityKey, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (transactionRuleEntityKey._EntityReferenceOption.IsSet)
                if (transactionRuleEntityKey.EntityReference != null)
            ...
            if (transactionRuleEntityKey._EntityTypeOption.IsSet)
                if (transactionRuleEntityKey.EntityType != null)
