...
namespace Adyen.BalancePlatform.Models
{
    ...
    /// </summary>
    public partial class BalanceWebhookSettingInfo : IValidatableObject
    {
        /// <summary>
    ...
    /// <summary>
    /// A Json converter for type <see cref="BalanceWebhookSettingInfo" />
    /// </summary>
    public class BalanceWebhookSettingInfoJsonConverter : JsonConverter<BalanceWebhookSettingInfo>
    {
        /// <summary>
        /// Deserializes json to <see cref="BalanceWebhookSettingInfo"/>.
        /// </summary>
        /// <param name="utf8JsonReader"><see cref="Utf8JsonReader"/></param>
        /// <param name="typeToConvert"><see cref="Type"/></param>
        /// <param name="jsonSerializerOptions">The <see cref="JsonSerializerOptions"/>, initialized from <see cref="HostConfiguration"/>.</param>
        /// <returns><see cref="BalanceWebhookSettingInfo"/></returns>
        /// <exception cref="JsonException"></exception>
        public override BalanceWebhookSettingInfo Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            Option<BalanceWebhookSettingInfo.StatusEnum?> status = default;
            Option<Target?> target = default;
            Option<BalanceWebhookSettingInfo.TypeEnum?> type = default;
            ...
            if (currency.IsSet && currency.Value == null)
                throw new ArgumentNullException(nameof(currency), "Property is not nullable for class BalanceWebhookSettingInfo.");

            if (status.IsSet && status.Value == null)
                throw new ArgumentNullException(nameof(status), "Property is not nullable for class BalanceWebhookSettingInfo.");

            if (target.IsSet && target.Value == null)
                throw new ArgumentNullException(nameof(target), "Property is not nullable for class BalanceWebhookSettingInfo.");

            if (type.IsSet && type.Value == null)
                throw new ArgumentNullException(nameof(type), "Property is not nullable for class BalanceWebhookSettingInfo.");

            if (conditions.IsSet && conditions.Value == null)
                throw new ArgumentNullException(nameof(conditions), "Property is not nullable for class BalanceWebhookSettingInfo.");

            return new BalanceWebhookSettingInfo(currency.Value!, status.Value!.Value!, target.Value!, type.Value!.Value!, conditions);
        }

        /// <summary>
        /// Serializes a <see cref="BalanceWebhookSettingInfo"/>.
        /// </summary>
        /// <param name="writer"><see cref="Utf8JsonWriter"/></param>
        /// <param name="balanceWebhookSettingInfo"></param>
        /// <param name="jsonSerializerOptions"><see cref="JsonSerializerOptions"/></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, BalanceWebhookSettingInfo balanceWebhookSettingInfo, JsonSerializerOptions jsonSerializerOptions)
        {
            
            writer.WriteStartObject();
            
            WriteProperties(writer, balanceWebhookSettingInfo, jsonSerializerOptions);
        ...
        /// <summary>
        /// Serializes the properties of <see cref="BalanceWebhookSettingInfo"/>.
        /// </summary>
        /// <param name="writer"><see creft="Utf8JsonWriter"/></param>
        /// <param name="balanceWebhookSettingInfo"></param>
        /// <param name="jsonSerializerOptions"><see cref="JsonSerializerOptions"/></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, BalanceWebhookSettingInfo balanceWebhookSettingInfo, JsonSerializerOptions jsonSerializerOptions)
        {
            /*
            if (balanceWebhookSettingInfo.Currency == null)
                throw new ArgumentNullException(nameof(balanceWebhookSettingInfo.Currency), "Property is required for class BalanceWebhookSettingInfo.");

            if (balanceWebhookSettingInfo.Target == null)
                throw new ArgumentNullException(nameof(balanceWebhookSettingInfo.Target), "Property is required for class BalanceWebhookSettingInfo.");

            if (balanceWebhookSettingInfo._ConditionsOption.IsSet && balanceWebhookSettingInfo.Conditions == null)
                throw new ArgumentNullException(nameof(balanceWebhookSettingInfo.Conditions), "Property is required for class BalanceWebhookSettingInfo.");

            */
            
            writer.WriteString("currency", balanceWebhookSettingInfo.Currency);

            if (balanceWebhookSettingInfo.Status != null) 
            {
                string? statusRawValue = BalanceWebhookSettingInfo.StatusEnum.ToJsonValue(balanceWebhookSettingInfo.Status);
                writer.WriteString("status", statusRawValue);
            }
            
            writer.WritePropertyName("target");
            JsonSerializer.Serialize(writer, balanceWebhookSettingInfo.Target, jsonSerializerOptions);
            if (balanceWebhookSettingInfo.Type != null) 
            {
                string? typeRawValue = BalanceWebhookSettingInfo.TypeEnum.ToJsonValue(balanceWebhookSettingInfo.Type);
                writer.WriteString("type", typeRawValue);
            }
            
            if (balanceWebhookSettingInfo._ConditionsOption.IsSet)
            {
                writer.WritePropertyName("conditions");
                JsonSerializer.Serialize(writer, balanceWebhookSettingInfo.Conditions, jsonSerializerOptions);
            }
        }
    }
}
