...
namespace Adyen.BalancePlatform.Models
{
    ...
    /// TargetUpdate.
    /// </summary>
    [JsonConverter(typeof(TargetUpdateJsonConverter))]
                ...
                if (utf8JsonReader.TokenType == JsonTokenType.PropertyName && currentDepth == utf8JsonReader.CurrentDepth - 1)
                {
                    ...
                    switch (jsonPropertyName)
                    {
                        ...
                        case "type":
                            ...
                            type = new Option<TargetUpdate.TypeEnum?>(TargetUpdate.TypeEnum.FromStringOrDefault(typeRawValue) ?? (TargetUpdate.TypeEnum)typeRawValue);
                            break;
                        default:
                            break;
                    }
