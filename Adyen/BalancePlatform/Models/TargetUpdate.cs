...
namespace Adyen.BalancePlatform.Models
{
    ...
    public partial class TargetUpdate : IValidatableObject
    {
        ...
        [JsonConstructor]
        public TargetUpdate(Option<string?> id = default, Option<TypeEnum?> type = default)
        {
            _IdOption = id;
            _TypeOption = type;
            OnCreated();
        ...
        public class TypeEnum: IEnum
        {
            ...
            /// </summary>
            public static readonly TypeEnum AccountHolder = new("accountHolder");
            ...
            public static TypeEnum? FromStringOrDefault(string value)
            {
                return value switch {
                    ...
                    "accountHolder" => TypeEnum.AccountHolder,
            ...
            public static string? ToJsonValue(TypeEnum? value)
            {
                ...
                if (value == TypeEnum.AccountHolder)
    ...
    /// <summary>
    /// A Json converter for type <see cref="TargetUpdate" />
    /// </summary>
    public class TargetUpdateJsonConverter : JsonConverter<TargetUpdate>
    {
        /// <summary>
        /// Deserializes json to <see cref="TargetUpdate"/>.
        /// </summary>
        /// <param name="utf8JsonReader"><see cref="Utf8JsonReader"/></param>
        /// <param name="typeToConvert"><see cref="Type"/></param>
        /// <param name="jsonSerializerOptions">The <see cref="JsonSerializerOptions"/>, initialized from <see cref="HostConfiguration"/>.</param>
        /// <returns><see cref="TargetUpdate"/></returns>
        /// <exception cref="JsonException"></exception>
        public override TargetUpdate Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            Option<TargetUpdate.TypeEnum?> type = default;
                ...
                if (utf8JsonReader.TokenType == JsonTokenType.PropertyName && currentDepth == utf8JsonReader.CurrentDepth - 1)
                {
                    ...
                    switch (jsonPropertyName)
                    {
                        ...
                        case "type":
                            ...
                            type = new Option<TargetUpdate.TypeEnum?>(TargetUpdate.TypeEnum.FromStringOrDefault(typeRawValue));
                            break;
                        default:
                            break;
                    }
            ...
            if (id.IsSet && id.Value == null)
                throw new ArgumentNullException(nameof(id), "Property is not nullable for class TargetUpdate.");

            if (type.IsSet && type.Value == null)
                throw new ArgumentNullException(nameof(type), "Property is not nullable for class TargetUpdate.");

            return new TargetUpdate(id, type);
        }

        /// <summary>
        /// Serializes a <see cref="TargetUpdate"/>.
        /// </summary>
        /// <param name="writer"><see cref="Utf8JsonWriter"/></param>
        /// <param name="targetUpdate"></param>
        /// <param name="jsonSerializerOptions"><see cref="JsonSerializerOptions"/></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, TargetUpdate targetUpdate, JsonSerializerOptions jsonSerializerOptions)
        {
            
            writer.WriteStartObject();
            
            WriteProperties(writer, targetUpdate, jsonSerializerOptions);
        ...
        /// <summary>
        /// Serializes the properties of <see cref="TargetUpdate"/>.
        /// </summary>
        /// <param name="writer"><see creft="Utf8JsonWriter"/></param>
        /// <param name="targetUpdate"></param>
        /// <param name="jsonSerializerOptions"><see cref="JsonSerializerOptions"/></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, TargetUpdate targetUpdate, JsonSerializerOptions jsonSerializerOptions)
        {
            /*
            if (targetUpdate._IdOption.IsSet && targetUpdate.Id == null)
                throw new ArgumentNullException(nameof(targetUpdate.Id), "Property is required for class TargetUpdate.");

            */
            
            if (targetUpdate._IdOption.IsSet)
                writer.WriteString("id", targetUpdate.Id);

            if (targetUpdate._TypeOption.IsSet && targetUpdate.Type != null) 
            {
                string? typeRawValue = TargetUpdate.TypeEnum.ToJsonValue(targetUpdate._TypeOption.Value!.Value);
