    ...
    public class BalanceWebhookSettingInfoUpdateJsonConverter : JsonConverter<BalanceWebhookSettingInfoUpdate>
    {
        ...
        public override BalanceWebhookSettingInfoUpdate Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (conditions.IsSet && conditions.Value == null)
                throw new ArgumentNullException(nameof(conditions), "Property is not nullable for class BalanceWebhookSettingInfoUpdate.");

            if (currency.IsSet && currency.Value == null)
                throw new ArgumentNullException(nameof(currency), "Property is not nullable for class BalanceWebhookSettingInfoUpdate.");

            if (status.IsSet && status.Value == null)
                throw new ArgumentNullException(nameof(status), "Property is not nullable for class BalanceWebhookSettingInfoUpdate.");

            if (target.IsSet && target.Value == null)
                throw new ArgumentNullException(nameof(target), "Property is not nullable for class BalanceWebhookSettingInfoUpdate.");

            if (type.IsSet && type.Value == null)
                throw new ArgumentNullException(nameof(type), "Property is not nullable for class BalanceWebhookSettingInfoUpdate.");
        ...
        {
            /*
            if (balanceWebhookSettingInfoUpdate._ConditionsOption.IsSet && balanceWebhookSettingInfoUpdate.Conditions == null)
                throw new ArgumentNullException(nameof(balanceWebhookSettingInfoUpdate.Conditions), "Property is required for class BalanceWebhookSettingInfoUpdate.");

            if (balanceWebhookSettingInfoUpdate._CurrencyOption.IsSet && balanceWebhookSettingInfoUpdate.Currency == null)
                throw new ArgumentNullException(nameof(balanceWebhookSettingInfoUpdate.Currency), "Property is required for class BalanceWebhookSettingInfoUpdate.");

            if (balanceWebhookSettingInfoUpdate._TargetOption.IsSet && balanceWebhookSettingInfoUpdate.Target == null)
                throw new ArgumentNullException(nameof(balanceWebhookSettingInfoUpdate.Target), "Property is required for class BalanceWebhookSettingInfoUpdate.");
