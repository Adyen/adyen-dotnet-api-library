...
namespace Adyen.BalancePlatform.Models
{
    ...
    /// </summary>
    [JsonConverter(typeof(BalanceWebhookSettingInfoUpdateJsonConverter))]
    ...
    public class BalanceWebhookSettingInfoUpdateJsonConverter : JsonConverter<BalanceWebhookSettingInfoUpdate>
    {
        ...
        public override BalanceWebhookSettingInfoUpdate Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (currency.IsSet)
                balanceWebhookSettingInfoUpdate.Currency = currency.Value;
            if (status.IsSet)
                balanceWebhookSettingInfoUpdate.Status = status.Value;
            if (target.IsSet)
                balanceWebhookSettingInfoUpdate.Target = target.Value;
            if (type.IsSet)
                balanceWebhookSettingInfoUpdate.Type = type.Value;
            return balanceWebhookSettingInfoUpdate;
        }
