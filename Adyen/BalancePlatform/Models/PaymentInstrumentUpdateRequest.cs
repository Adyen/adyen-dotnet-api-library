...
namespace Adyen.BalancePlatform.Models
{
    ...
    /// </summary>
    [JsonConverter(typeof(PaymentInstrumentUpdateRequestJsonConverter))]
    ...
    public class PaymentInstrumentUpdateRequestJsonConverter : JsonConverter<PaymentInstrumentUpdateRequest>
    {
        ...
        public override PaymentInstrumentUpdateRequest Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (card.IsSet)
                paymentInstrumentUpdateRequest.Card = card.Value;
            if (status.IsSet)
                paymentInstrumentUpdateRequest.Status = status.Value;
            if (statusComment.IsSet)
                paymentInstrumentUpdateRequest.StatusComment = statusComment.Value;
            if (statusReason.IsSet)
                paymentInstrumentUpdateRequest.StatusReason = statusReason.Value;
