...
namespace Adyen.BalancePlatform.Models
{
    ...
    public partial class CreateSweepConfigurationV2 : IValidatableObject
    {
        ...
        [JsonIgnore]
        [global::System.ComponentModel.EditorBrowsable(global::System.ComponentModel.EditorBrowsableState.Never)]
        public Option<List<CreateSweepConfigurationV2.PrioritiesEnum>?> _PrioritiesOption { get; private set; }
        ...
        public List<CreateSweepConfigurationV2.PrioritiesEnum>? Priorities { get { return this._PrioritiesOption; } set { this._PrioritiesOption = new(value); } }
    ...
    /// <summary>
    /// A Json converter for type <see cref="CreateSweepConfigurationV2" />
    /// </summary>
    public class CreateSweepConfigurationV2JsonConverter : JsonConverter<CreateSweepConfigurationV2>
    {
        /// <summary>
        /// Deserializes json to <see cref="CreateSweepConfigurationV2"/>.
        /// </summary>
        /// <param name="utf8JsonReader"><see cref="Utf8JsonReader"/></param>
        /// <param name="typeToConvert"><see cref="Type"/></param>
        /// <param name="jsonSerializerOptions">The <see cref="JsonSerializerOptions"/>, initialized from <see cref="HostConfiguration"/>.</param>
        /// <returns><see cref="CreateSweepConfigurationV2"/></returns>
        /// <exception cref="JsonException"></exception>
        public override CreateSweepConfigurationV2 Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            Option<CreateSweepConfigurationV2.CategoryEnum?> category = default;
            Option<string?> description = default;
            Option<List<CreateSweepConfigurationV2.PrioritiesEnum>?> priorities = default;
            Option<CreateSweepConfigurationV2.ReasonEnum?> reason = default;
            Option<string?> reasonDetail = default;
            Option<string?> reference = default;
            Option<string?> referenceForBeneficiary = default;
            Option<CreateSweepConfigurationV2.StatusEnum?> status = default;
            Option<Amount?> sweepAmount = default;
            Option<Amount?> targetAmount = default;
            Option<Amount?> triggerAmount = default;
            Option<CreateSweepConfigurationV2.TypeEnum?> type = default;
                ...
                if (utf8JsonReader.TokenType == JsonTokenType.PropertyName && currentDepth == utf8JsonReader.CurrentDepth - 1)
                {
                    ...
                    switch (jsonPropertyName)
                    {
                        ...
                        case "category":
                            ...
                            category = new Option<CreateSweepConfigurationV2.CategoryEnum?>(CreateSweepConfigurationV2.CategoryEnum.FromStringOrDefault(categoryRawValue));
                            break;
                        case "description":
                            description = new Option<string?>(utf8JsonReader.GetString()!);
                            break;
                        case "priorities":
                            priorities = new Option<List<CreateSweepConfigurationV2.PrioritiesEnum>?>(JsonSerializer.Deserialize<List<CreateSweepConfigurationV2.PrioritiesEnum>>(ref utf8JsonReader, jsonSerializerOptions)!);
                            break;
                        case "reason":
                            string? reasonRawValue = utf8JsonReader.GetString();
                            reason = new Option<CreateSweepConfigurationV2.ReasonEnum?>(CreateSweepConfigurationV2.ReasonEnum.FromStringOrDefault(reasonRawValue));
                            break;
                        case "reasonDetail":
                        ...
                        case "status":
                            ...
                            status = new Option<CreateSweepConfigurationV2.StatusEnum?>(CreateSweepConfigurationV2.StatusEnum.FromStringOrDefault(statusRawValue));
                            break;
                        case "sweepAmount":
                        ...
                        case "type":
                            ...
                            type = new Option<CreateSweepConfigurationV2.TypeEnum?>(CreateSweepConfigurationV2.TypeEnum.FromStringOrDefault(typeRawValue));
                            break;
                        default:
                            break;
                    }
            ...
            if (counterparty.IsSet && counterparty.Value == null)
                throw new ArgumentNullException(nameof(counterparty), "Property is not nullable for class CreateSweepConfigurationV2.");

            if (currency.IsSet && currency.Value == null)
                throw new ArgumentNullException(nameof(currency), "Property is not nullable for class CreateSweepConfigurationV2.");

            if (schedule.IsSet && schedule.Value == null)
                throw new ArgumentNullException(nameof(schedule), "Property is not nullable for class CreateSweepConfigurationV2.");

            if (category.IsSet && category.Value == null)
                throw new ArgumentNullException(nameof(category), "Property is not nullable for class CreateSweepConfigurationV2.");

            if (description.IsSet && description.Value == null)
                throw new ArgumentNullException(nameof(description), "Property is not nullable for class CreateSweepConfigurationV2.");

            if (priorities.IsSet && priorities.Value == null)
                throw new ArgumentNullException(nameof(priorities), "Property is not nullable for class CreateSweepConfigurationV2.");

            if (reason.IsSet && reason.Value == null)
                throw new ArgumentNullException(nameof(reason), "Property is not nullable for class CreateSweepConfigurationV2.");

            if (reasonDetail.IsSet && reasonDetail.Value == null)
                throw new ArgumentNullException(nameof(reasonDetail), "Property is not nullable for class CreateSweepConfigurationV2.");

            if (reference.IsSet && reference.Value == null)
                throw new ArgumentNullException(nameof(reference), "Property is not nullable for class CreateSweepConfigurationV2.");

            if (referenceForBeneficiary.IsSet && referenceForBeneficiary.Value == null)
                throw new ArgumentNullException(nameof(referenceForBeneficiary), "Property is not nullable for class CreateSweepConfigurationV2.");

            if (status.IsSet && status.Value == null)
                throw new ArgumentNullException(nameof(status), "Property is not nullable for class CreateSweepConfigurationV2.");

            if (sweepAmount.IsSet && sweepAmount.Value == null)
                throw new ArgumentNullException(nameof(sweepAmount), "Property is not nullable for class CreateSweepConfigurationV2.");

            if (targetAmount.IsSet && targetAmount.Value == null)
                throw new ArgumentNullException(nameof(targetAmount), "Property is not nullable for class CreateSweepConfigurationV2.");

            if (triggerAmount.IsSet && triggerAmount.Value == null)
                throw new ArgumentNullException(nameof(triggerAmount), "Property is not nullable for class CreateSweepConfigurationV2.");

            if (type.IsSet && type.Value == null)
                throw new ArgumentNullException(nameof(type), "Property is not nullable for class CreateSweepConfigurationV2.");
        ...
        /// <summary>
        /// Serializes a <see cref="CreateSweepConfigurationV2"/>.
        /// </summary>
        ...
        public override void Write(Utf8JsonWriter writer, CreateSweepConfigurationV2 createSweepConfigurationV2, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            WriteProperties(writer, createSweepConfigurationV2, jsonSerializerOptions);
        ...
        /// <summary>
        /// Serializes the properties of <see cref="CreateSweepConfigurationV2"/>.
        /// </summary>
        ...
        {
            /*
            if (createSweepConfigurationV2.Counterparty == null)
                throw new ArgumentNullException(nameof(createSweepConfigurationV2.Counterparty), "Property is required for class CreateSweepConfigurationV2.");

            if (createSweepConfigurationV2.Currency == null)
                throw new ArgumentNullException(nameof(createSweepConfigurationV2.Currency), "Property is required for class CreateSweepConfigurationV2.");

            if (createSweepConfigurationV2.Schedule == null)
                throw new ArgumentNullException(nameof(createSweepConfigurationV2.Schedule), "Property is required for class CreateSweepConfigurationV2.");

            if (createSweepConfigurationV2._DescriptionOption.IsSet && createSweepConfigurationV2.Description == null)
                throw new ArgumentNullException(nameof(createSweepConfigurationV2.Description), "Property is required for class CreateSweepConfigurationV2.");

            if (createSweepConfigurationV2._PrioritiesOption.IsSet && createSweepConfigurationV2.Priorities == null)
                throw new ArgumentNullException(nameof(createSweepConfigurationV2.Priorities), "Property is required for class CreateSweepConfigurationV2.");

            if (createSweepConfigurationV2._ReasonDetailOption.IsSet && createSweepConfigurationV2.ReasonDetail == null)
                throw new ArgumentNullException(nameof(createSweepConfigurationV2.ReasonDetail), "Property is required for class CreateSweepConfigurationV2.");

            if (createSweepConfigurationV2._ReferenceOption.IsSet && createSweepConfigurationV2.Reference == null)
                throw new ArgumentNullException(nameof(createSweepConfigurationV2.Reference), "Property is required for class CreateSweepConfigurationV2.");

            if (createSweepConfigurationV2._ReferenceForBeneficiaryOption.IsSet && createSweepConfigurationV2.ReferenceForBeneficiary == null)
                throw new ArgumentNullException(nameof(createSweepConfigurationV2.ReferenceForBeneficiary), "Property is required for class CreateSweepConfigurationV2.");

            if (createSweepConfigurationV2._SweepAmountOption.IsSet && createSweepConfigurationV2.SweepAmount == null)
                throw new ArgumentNullException(nameof(createSweepConfigurationV2.SweepAmount), "Property is required for class CreateSweepConfigurationV2.");

            if (createSweepConfigurationV2._TargetAmountOption.IsSet && createSweepConfigurationV2.TargetAmount == null)
                throw new ArgumentNullException(nameof(createSweepConfigurationV2.TargetAmount), "Property is required for class CreateSweepConfigurationV2.");

            if (createSweepConfigurationV2._TriggerAmountOption.IsSet && createSweepConfigurationV2.TriggerAmount == null)
                throw new ArgumentNullException(nameof(createSweepConfigurationV2.TriggerAmount), "Property is required for class CreateSweepConfigurationV2.");

            */
            
            writer.WritePropertyName("counterparty");
            JsonSerializer.Serialize(writer, createSweepConfigurationV2.Counterparty, jsonSerializerOptions);
            writer.WriteString("currency", createSweepConfigurationV2.Currency);

            writer.WritePropertyName("schedule");
            JsonSerializer.Serialize(writer, createSweepConfigurationV2.Schedule, jsonSerializerOptions);
            if (createSweepConfigurationV2._CategoryOption.IsSet && createSweepConfigurationV2.Category != null) 
            {
                string? categoryRawValue = CreateSweepConfigurationV2.CategoryEnum.ToJsonValue(createSweepConfigurationV2._CategoryOption.Value!.Value);
                writer.WriteString("category", categoryRawValue);
            }
            
            if (createSweepConfigurationV2._DescriptionOption.IsSet)
                writer.WriteString("description", createSweepConfigurationV2.Description);

            if (createSweepConfigurationV2._PrioritiesOption.IsSet)
            {
                writer.WritePropertyName("priorities");
                JsonSerializer.Serialize(writer, createSweepConfigurationV2.Priorities, jsonSerializerOptions);
            }
            if (createSweepConfigurationV2._ReasonOption.IsSet && createSweepConfigurationV2.Reason != null) 
            {
                string? reasonRawValue = CreateSweepConfigurationV2.ReasonEnum.ToJsonValue(createSweepConfigurationV2._ReasonOption.Value!.Value);
                writer.WriteString("reason", reasonRawValue);
            }
            
            if (createSweepConfigurationV2._ReasonDetailOption.IsSet)
                writer.WriteString("reasonDetail", createSweepConfigurationV2.ReasonDetail);

            if (createSweepConfigurationV2._ReferenceOption.IsSet)
                writer.WriteString("reference", createSweepConfigurationV2.Reference);

            if (createSweepConfigurationV2._ReferenceForBeneficiaryOption.IsSet)
                writer.WriteString("referenceForBeneficiary", createSweepConfigurationV2.ReferenceForBeneficiary);

            if (createSweepConfigurationV2._StatusOption.IsSet && createSweepConfigurationV2.Status != null) 
            {
                string? statusRawValue = CreateSweepConfigurationV2.StatusEnum.ToJsonValue(createSweepConfigurationV2._StatusOption.Value!.Value);
                writer.WriteString("status", statusRawValue);
            }
            
            if (createSweepConfigurationV2._SweepAmountOption.IsSet)
            {
                writer.WritePropertyName("sweepAmount");
                JsonSerializer.Serialize(writer, createSweepConfigurationV2.SweepAmount, jsonSerializerOptions);
            }
            if (createSweepConfigurationV2._TargetAmountOption.IsSet)
            {
                writer.WritePropertyName("targetAmount");
                JsonSerializer.Serialize(writer, createSweepConfigurationV2.TargetAmount, jsonSerializerOptions);
            }
            if (createSweepConfigurationV2._TriggerAmountOption.IsSet)
            {
                writer.WritePropertyName("triggerAmount");
                JsonSerializer.Serialize(writer, createSweepConfigurationV2.TriggerAmount, jsonSerializerOptions);
            }
            if (createSweepConfigurationV2._TypeOption.IsSet && createSweepConfigurationV2.Type != null) 
            {
                string? typeRawValue = CreateSweepConfigurationV2.TypeEnum.ToJsonValue(createSweepConfigurationV2._TypeOption.Value!.Value);
