...
namespace Adyen.BalancePlatform.Models
{
    ...
    /// </summary>
    [JsonConverter(typeof(CreateSweepConfigurationV2JsonConverter))]
    ...
    public class CreateSweepConfigurationV2JsonConverter : JsonConverter<CreateSweepConfigurationV2>
    {
        ...
        public override CreateSweepConfigurationV2 Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
                ...
                if (utf8JsonReader.TokenType == JsonTokenType.PropertyName && currentDepth == utf8JsonReader.CurrentDepth - 1)
                {
                    ...
                    switch (jsonPropertyName)
                    {
                        ...
                        case "category":
                            ...
                            category = new Option<CreateSweepConfigurationV2.CategoryEnum?>(CreateSweepConfigurationV2.CategoryEnum.FromStringOrDefault(categoryRawValue) ?? (CreateSweepConfigurationV2.CategoryEnum)categoryRawValue);
                            break;
                        case "description":
                        ...
                        case "reason":
                            ...
                            reason = new Option<CreateSweepConfigurationV2.ReasonEnum?>(CreateSweepConfigurationV2.ReasonEnum.FromStringOrDefault(reasonRawValue) ?? (CreateSweepConfigurationV2.ReasonEnum)reasonRawValue);
                            break;
                        case "reasonDetail":
                        ...
                        case "status":
                            ...
                            status = new Option<CreateSweepConfigurationV2.StatusEnum?>(CreateSweepConfigurationV2.StatusEnum.FromStringOrDefault(statusRawValue) ?? (CreateSweepConfigurationV2.StatusEnum)statusRawValue);
                            break;
                        case "sweepAmount":
                        ...
                        case "type":
                            ...
                            type = new Option<CreateSweepConfigurationV2.TypeEnum?>(CreateSweepConfigurationV2.TypeEnum.FromStringOrDefault(typeRawValue) ?? (CreateSweepConfigurationV2.TypeEnum)typeRawValue);
                            break;
                        default:
                            break;
                    }
            ...
            if (description.IsSet)
                createSweepConfigurationV2.Description = description.Value;
            if (priorities.IsSet)
                createSweepConfigurationV2.Priorities = priorities.Value;
            if (reason.IsSet)
                createSweepConfigurationV2.Reason = reason.Value;
            if (reasonDetail.IsSet)
                createSweepConfigurationV2.ReasonDetail = reasonDetail.Value;
            if (reference.IsSet)
                createSweepConfigurationV2.Reference = reference.Value;
            if (referenceForBeneficiary.IsSet)
                createSweepConfigurationV2.ReferenceForBeneficiary = referenceForBeneficiary.Value;
            if (status.IsSet)
                createSweepConfigurationV2.Status = status.Value;
            if (sweepAmount.IsSet)
                createSweepConfigurationV2.SweepAmount = sweepAmount.Value;
            if (targetAmount.IsSet)
                createSweepConfigurationV2.TargetAmount = targetAmount.Value;
            if (triggerAmount.IsSet)
                createSweepConfigurationV2.TriggerAmount = triggerAmount.Value;
            if (type.IsSet)
                createSweepConfigurationV2.Type = type.Value;
            return createSweepConfigurationV2;
        }
        ...
        public void WriteProperties(Utf8JsonWriter writer, CreateSweepConfigurationV2 createSweepConfigurationV2, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (createSweepConfigurationV2._DescriptionOption.IsSet)
                if (createSweepConfigurationV2.Description != null)
            ...
            if (createSweepConfigurationV2._ReasonDetailOption.IsSet)
                if (createSweepConfigurationV2.ReasonDetail != null)
            ...
            if (createSweepConfigurationV2._ReferenceOption.IsSet)
                if (createSweepConfigurationV2.Reference != null)
            ...
            if (createSweepConfigurationV2._ReferenceForBeneficiaryOption.IsSet)
                if (createSweepConfigurationV2.ReferenceForBeneficiary != null)
