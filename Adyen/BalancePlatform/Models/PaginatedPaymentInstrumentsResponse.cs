    ...
    public class PaginatedPaymentInstrumentsResponseJsonConverter : JsonConverter<PaginatedPaymentInstrumentsResponse>
    {
        ...
        public override PaginatedPaymentInstrumentsResponse Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (hasNext.IsSet && hasNext.Value == null)
                throw new ArgumentNullException(nameof(hasNext), "Property is not nullable for class PaginatedPaymentInstrumentsResponse.");

            if (hasPrevious.IsSet && hasPrevious.Value == null)
                throw new ArgumentNullException(nameof(hasPrevious), "Property is not nullable for class PaginatedPaymentInstrumentsResponse.");

            if (paymentInstruments.IsSet && paymentInstruments.Value == null)
                throw new ArgumentNullException(nameof(paymentInstruments), "Property is not nullable for class PaginatedPaymentInstrumentsResponse.");
        ...
        {
            /*
            if (paginatedPaymentInstrumentsResponse.PaymentInstruments == null)
                throw new ArgumentNullException(nameof(paginatedPaymentInstrumentsResponse.PaymentInstruments), "Property is required for class PaginatedPaymentInstrumentsResponse.");
