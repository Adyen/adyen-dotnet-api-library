    ...
    public class TransferRouteJsonConverter : JsonConverter<TransferRoute>
    {
        ...
        public override TransferRoute Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (category.IsSet && category.Value == null)
                throw new ArgumentNullException(nameof(category), "Property is not nullable for class TransferRoute.");

            if (country.IsSet && country.Value == null)
                throw new ArgumentNullException(nameof(country), "Property is not nullable for class TransferRoute.");

            if (currency.IsSet && currency.Value == null)
                throw new ArgumentNullException(nameof(currency), "Property is not nullable for class TransferRoute.");

            if (priority.IsSet && priority.Value == null)
                throw new ArgumentNullException(nameof(priority), "Property is not nullable for class TransferRoute.");

            if (requirements.IsSet && requirements.Value == null)
                throw new ArgumentNullException(nameof(requirements), "Property is not nullable for class TransferRoute.");
        ...
        {
            /*
            if (transferRoute._CountryOption.IsSet && transferRoute.Country == null)
                throw new ArgumentNullException(nameof(transferRoute.Country), "Property is required for class TransferRoute.");

            if (transferRoute._CurrencyOption.IsSet && transferRoute.Currency == null)
                throw new ArgumentNullException(nameof(transferRoute.Currency), "Property is required for class TransferRoute.");

            if (transferRoute._RequirementsOption.IsSet && transferRoute.Requirements == null)
                throw new ArgumentNullException(nameof(transferRoute.Requirements), "Property is required for class TransferRoute.");
