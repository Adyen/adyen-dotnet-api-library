...
namespace Adyen.BalancePlatform.Models
{
    ...
    /// TransferRoute.
    /// </summary>
    [JsonConverter(typeof(TransferRouteJsonConverter))]
    ...
    public class TransferRouteJsonConverter : JsonConverter<TransferRoute>
    {
        ...
        public override TransferRoute Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (country.IsSet)
                transferRoute.Country = country.Value;
            if (currency.IsSet)
                transferRoute.Currency = currency.Value;
            if (priority.IsSet)
                transferRoute.Priority = priority.Value;
            if (requirements.IsSet)
                transferRoute.Requirements = requirements.Value;
