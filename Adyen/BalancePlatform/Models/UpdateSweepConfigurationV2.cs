...
namespace Adyen.BalancePlatform.Models
{
    ...
    /// </summary>
    [JsonConverter(typeof(UpdateSweepConfigurationV2JsonConverter))]
    public partial class UpdateSweepConfigurationV2
    {
        /// <summary>
    ...
    public class UpdateSweepConfigurationV2JsonConverter : JsonConverter<UpdateSweepConfigurationV2>
    {
        ...
        public override UpdateSweepConfigurationV2 Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
                ...
                if (utf8JsonReader.TokenType == JsonTokenType.PropertyName && currentDepth == utf8JsonReader.CurrentDepth - 1)
                {
                    ...
                    switch (jsonPropertyName)
                    {
                        case "category":
                            ...
                            category = new Option<UpdateSweepConfigurationV2.CategoryEnum?>(UpdateSweepConfigurationV2.CategoryEnum.FromStringOrDefault(categoryRawValue) ?? (UpdateSweepConfigurationV2.CategoryEnum)categoryRawValue);
                            break;
                        case "counterparty":
                        ...
                        case "reason":
                            ...
                            reason = new Option<UpdateSweepConfigurationV2.ReasonEnum?>(UpdateSweepConfigurationV2.ReasonEnum.FromStringOrDefault(reasonRawValue) ?? (UpdateSweepConfigurationV2.ReasonEnum)reasonRawValue);
                            break;
                        case "reasonDetail":
                        ...
                        case "status":
                            ...
                            status = new Option<UpdateSweepConfigurationV2.StatusEnum?>(UpdateSweepConfigurationV2.StatusEnum.FromStringOrDefault(statusRawValue) ?? (UpdateSweepConfigurationV2.StatusEnum)statusRawValue);
                            break;
                        case "sweepAmount":
                        ...
                        case "type":
                            ...
                            type = new Option<UpdateSweepConfigurationV2.TypeEnum?>(UpdateSweepConfigurationV2.TypeEnum.FromStringOrDefault(typeRawValue) ?? (UpdateSweepConfigurationV2.TypeEnum)typeRawValue);
                            break;
                        default:
                            break;
                    }
            ...
            if (counterparty.IsSet)
                updateSweepConfigurationV2.Counterparty = counterparty.Value;
            if (currency.IsSet)
                updateSweepConfigurationV2.Currency = currency.Value;
            if (description.IsSet)
                updateSweepConfigurationV2.Description = description.Value;
            if (id.IsSet)
                updateSweepConfigurationV2.Id = id.Value;
            if (priorities.IsSet)
                updateSweepConfigurationV2.Priorities = priorities.Value;
            if (reason.IsSet)
                updateSweepConfigurationV2.Reason = reason.Value;
            if (reasonDetail.IsSet)
                updateSweepConfigurationV2.ReasonDetail = reasonDetail.Value;
            if (reference.IsSet)
                updateSweepConfigurationV2.Reference = reference.Value;
            if (referenceForBeneficiary.IsSet)
                updateSweepConfigurationV2.ReferenceForBeneficiary = referenceForBeneficiary.Value;
            if (schedule.IsSet)
                updateSweepConfigurationV2.Schedule = schedule.Value;
            if (status.IsSet)
                updateSweepConfigurationV2.Status = status.Value;
            if (sweepAmount.IsSet)
                updateSweepConfigurationV2.SweepAmount = sweepAmount.Value;
            if (targetAmount.IsSet)
                updateSweepConfigurationV2.TargetAmount = targetAmount.Value;
            if (triggerAmount.IsSet)
                updateSweepConfigurationV2.TriggerAmount = triggerAmount.Value;
            if (type.IsSet)
                updateSweepConfigurationV2.Type = type.Value;
            return updateSweepConfigurationV2;
        }
        ...
        public void WriteProperties(Utf8JsonWriter writer, UpdateSweepConfigurationV2 updateSweepConfigurationV2, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (updateSweepConfigurationV2._ReasonDetailOption.IsSet)
                if (updateSweepConfigurationV2.ReasonDetail != null)
            ...
            if (updateSweepConfigurationV2._ReferenceOption.IsSet)
                if (updateSweepConfigurationV2.Reference != null)
            ...
            if (updateSweepConfigurationV2._ReferenceForBeneficiaryOption.IsSet)
                if (updateSweepConfigurationV2.ReferenceForBeneficiary != null)
