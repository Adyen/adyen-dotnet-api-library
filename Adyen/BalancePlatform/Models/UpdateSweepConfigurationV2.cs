...
namespace Adyen.BalancePlatform.Models
{
    ...
    /// </summary>
    public partial class UpdateSweepConfigurationV2 : IValidatableObject
    {
        /// <summary>
        ...
        [JsonConstructor]
        public UpdateSweepConfigurationV2(Option<CategoryEnum?> category = default, Option<SweepCounterparty?> counterparty = default, Option<string?> currency = default, Option<string?> description = default, Option<string?> id = default, Option<List<UpdateSweepConfigurationV2.PrioritiesEnum>?> priorities = default, Option<ReasonEnum?> reason = default, Option<string?> reasonDetail = default, Option<string?> reference = default, Option<string?> referenceForBeneficiary = default, Option<SweepSchedule?> schedule = default, Option<StatusEnum?> status = default, Option<Amount?> sweepAmount = default, Option<Amount?> targetAmount = default, Option<Amount?> triggerAmount = default, Option<TypeEnum?> type = default)
        {
        ...
        /// <summary>
        /// Used to track whether Category is set or not.
        /// </summary>
        [JsonIgnore]
        ...
        [JsonIgnore]
        [global::System.ComponentModel.EditorBrowsable(global::System.ComponentModel.EditorBrowsableState.Never)]
        public Option<List<UpdateSweepConfigurationV2.PrioritiesEnum>?> _PrioritiesOption { get; private set; }
    ...
    /// <summary>
    /// A Json converter for type <see cref="UpdateSweepConfigurationV2" />
    /// </summary>
    public class UpdateSweepConfigurationV2JsonConverter : JsonConverter<UpdateSweepConfigurationV2>
    {
        /// <summary>
        /// Deserializes json to <see cref="UpdateSweepConfigurationV2"/>.
        /// </summary>
        /// <param name="utf8JsonReader"><see cref="Utf8JsonReader"/></param>
        /// <param name="typeToConvert"><see cref="Type"/></param>
        /// <param name="jsonSerializerOptions">The <see cref="JsonSerializerOptions"/>, initialized from <see cref="HostConfiguration"/>.</param>
        /// <returns><see cref="UpdateSweepConfigurationV2"/></returns>
        /// <exception cref="JsonException"></exception>
        public override UpdateSweepConfigurationV2 Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            Option<UpdateSweepConfigurationV2.CategoryEnum?> category = default;
            Option<SweepCounterparty?> counterparty = default;
            Option<string?> currency = default;
            Option<string?> description = default;
            Option<string?> id = default;
            Option<List<UpdateSweepConfigurationV2.PrioritiesEnum>?> priorities = default;
            Option<UpdateSweepConfigurationV2.ReasonEnum?> reason = default;
            ...
            Option<UpdateSweepConfigurationV2.StatusEnum?> status = default;
            Option<Amount?> sweepAmount = default;
            Option<Amount?> targetAmount = default;
            Option<Amount?> triggerAmount = default;
            Option<UpdateSweepConfigurationV2.TypeEnum?> type = default;
                ...
                if (utf8JsonReader.TokenType == JsonTokenType.PropertyName && currentDepth == utf8JsonReader.CurrentDepth - 1)
                {
                    ...
                    switch (jsonPropertyName)
                    {
                        case "category":
                            ...
                            category = new Option<UpdateSweepConfigurationV2.CategoryEnum?>(UpdateSweepConfigurationV2.CategoryEnum.FromStringOrDefault(categoryRawValue));
                            break;
                        case "counterparty":
                        ...
                        case "id":
                            ...
                            break;
                        case "priorities":
                            priorities = new Option<List<UpdateSweepConfigurationV2.PrioritiesEnum>?>(JsonSerializer.Deserialize<List<UpdateSweepConfigurationV2.PrioritiesEnum>>(ref utf8JsonReader, jsonSerializerOptions)!);
                            break;
                        case "reason":
                            string? reasonRawValue = utf8JsonReader.GetString();
                            reason = new Option<UpdateSweepConfigurationV2.ReasonEnum?>(UpdateSweepConfigurationV2.ReasonEnum.FromStringOrDefault(reasonRawValue));
                            break;
                        case "reasonDetail":
                        ...
                        case "status":
                            ...
                            status = new Option<UpdateSweepConfigurationV2.StatusEnum?>(UpdateSweepConfigurationV2.StatusEnum.FromStringOrDefault(statusRawValue));
                            break;
                        case "sweepAmount":
                        ...
                        case "type":
                            ...
                            type = new Option<UpdateSweepConfigurationV2.TypeEnum?>(UpdateSweepConfigurationV2.TypeEnum.FromStringOrDefault(typeRawValue));
                            break;
                        default:
                            break;
                    }
            ...
            if (category.IsSet && category.Value == null)
                throw new ArgumentNullException(nameof(category), "Property is not nullable for class UpdateSweepConfigurationV2.");

            if (counterparty.IsSet && counterparty.Value == null)
                throw new ArgumentNullException(nameof(counterparty), "Property is not nullable for class UpdateSweepConfigurationV2.");

            if (currency.IsSet && currency.Value == null)
                throw new ArgumentNullException(nameof(currency), "Property is not nullable for class UpdateSweepConfigurationV2.");

            if (description.IsSet && description.Value == null)
                throw new ArgumentNullException(nameof(description), "Property is not nullable for class UpdateSweepConfigurationV2.");

            if (id.IsSet && id.Value == null)
                throw new ArgumentNullException(nameof(id), "Property is not nullable for class UpdateSweepConfigurationV2.");

            if (priorities.IsSet && priorities.Value == null)
                throw new ArgumentNullException(nameof(priorities), "Property is not nullable for class UpdateSweepConfigurationV2.");

            if (reason.IsSet && reason.Value == null)
                throw new ArgumentNullException(nameof(reason), "Property is not nullable for class UpdateSweepConfigurationV2.");

            if (reasonDetail.IsSet && reasonDetail.Value == null)
                throw new ArgumentNullException(nameof(reasonDetail), "Property is not nullable for class UpdateSweepConfigurationV2.");

            if (reference.IsSet && reference.Value == null)
                throw new ArgumentNullException(nameof(reference), "Property is not nullable for class UpdateSweepConfigurationV2.");

            if (referenceForBeneficiary.IsSet && referenceForBeneficiary.Value == null)
                throw new ArgumentNullException(nameof(referenceForBeneficiary), "Property is not nullable for class UpdateSweepConfigurationV2.");

            if (schedule.IsSet && schedule.Value == null)
                throw new ArgumentNullException(nameof(schedule), "Property is not nullable for class UpdateSweepConfigurationV2.");

            if (status.IsSet && status.Value == null)
                throw new ArgumentNullException(nameof(status), "Property is not nullable for class UpdateSweepConfigurationV2.");

            if (sweepAmount.IsSet && sweepAmount.Value == null)
                throw new ArgumentNullException(nameof(sweepAmount), "Property is not nullable for class UpdateSweepConfigurationV2.");

            if (targetAmount.IsSet && targetAmount.Value == null)
                throw new ArgumentNullException(nameof(targetAmount), "Property is not nullable for class UpdateSweepConfigurationV2.");

            if (triggerAmount.IsSet && triggerAmount.Value == null)
                throw new ArgumentNullException(nameof(triggerAmount), "Property is not nullable for class UpdateSweepConfigurationV2.");

            if (type.IsSet && type.Value == null)
                throw new ArgumentNullException(nameof(type), "Property is not nullable for class UpdateSweepConfigurationV2.");

            return new UpdateSweepConfigurationV2(category, counterparty, currency, description, id, priorities, reason, reasonDetail, reference, referenceForBeneficiary, schedule, status, sweepAmount, targetAmount, triggerAmount, type);
        }

        /// <summary>
        /// Serializes a <see cref="UpdateSweepConfigurationV2"/>.
        /// </summary>
        ...
        public override void Write(Utf8JsonWriter writer, UpdateSweepConfigurationV2 updateSweepConfigurationV2, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            WriteProperties(writer, updateSweepConfigurationV2, jsonSerializerOptions);
        ...
        /// <summary>
        /// Serializes the properties of <see cref="UpdateSweepConfigurationV2"/>.
        /// </summary>
        ...
        {
            /*
            if (updateSweepConfigurationV2._CounterpartyOption.IsSet && updateSweepConfigurationV2.Counterparty == null)
                throw new ArgumentNullException(nameof(updateSweepConfigurationV2.Counterparty), "Property is required for class UpdateSweepConfigurationV2.");

            if (updateSweepConfigurationV2._CurrencyOption.IsSet && updateSweepConfigurationV2.Currency == null)
                throw new ArgumentNullException(nameof(updateSweepConfigurationV2.Currency), "Property is required for class UpdateSweepConfigurationV2.");

            if (updateSweepConfigurationV2._DescriptionOption.IsSet && updateSweepConfigurationV2.Description == null)
                throw new ArgumentNullException(nameof(updateSweepConfigurationV2.Description), "Property is required for class UpdateSweepConfigurationV2.");

            if (updateSweepConfigurationV2._IdOption.IsSet && updateSweepConfigurationV2.Id == null)
                throw new ArgumentNullException(nameof(updateSweepConfigurationV2.Id), "Property is required for class UpdateSweepConfigurationV2.");

            if (updateSweepConfigurationV2._PrioritiesOption.IsSet && updateSweepConfigurationV2.Priorities == null)
                throw new ArgumentNullException(nameof(updateSweepConfigurationV2.Priorities), "Property is required for class UpdateSweepConfigurationV2.");

            if (updateSweepConfigurationV2._ReasonDetailOption.IsSet && updateSweepConfigurationV2.ReasonDetail == null)
                throw new ArgumentNullException(nameof(updateSweepConfigurationV2.ReasonDetail), "Property is required for class UpdateSweepConfigurationV2.");

            if (updateSweepConfigurationV2._ReferenceOption.IsSet && updateSweepConfigurationV2.Reference == null)
                throw new ArgumentNullException(nameof(updateSweepConfigurationV2.Reference), "Property is required for class UpdateSweepConfigurationV2.");

            if (updateSweepConfigurationV2._ReferenceForBeneficiaryOption.IsSet && updateSweepConfigurationV2.ReferenceForBeneficiary == null)
                throw new ArgumentNullException(nameof(updateSweepConfigurationV2.ReferenceForBeneficiary), "Property is required for class UpdateSweepConfigurationV2.");

            if (updateSweepConfigurationV2._ScheduleOption.IsSet && updateSweepConfigurationV2.Schedule == null)
                throw new ArgumentNullException(nameof(updateSweepConfigurationV2.Schedule), "Property is required for class UpdateSweepConfigurationV2.");

            if (updateSweepConfigurationV2._SweepAmountOption.IsSet && updateSweepConfigurationV2.SweepAmount == null)
                throw new ArgumentNullException(nameof(updateSweepConfigurationV2.SweepAmount), "Property is required for class UpdateSweepConfigurationV2.");

            if (updateSweepConfigurationV2._TargetAmountOption.IsSet && updateSweepConfigurationV2.TargetAmount == null)
                throw new ArgumentNullException(nameof(updateSweepConfigurationV2.TargetAmount), "Property is required for class UpdateSweepConfigurationV2.");

            if (updateSweepConfigurationV2._TriggerAmountOption.IsSet && updateSweepConfigurationV2.TriggerAmount == null)
                throw new ArgumentNullException(nameof(updateSweepConfigurationV2.TriggerAmount), "Property is required for class UpdateSweepConfigurationV2.");

            */
            
            if (updateSweepConfigurationV2._CategoryOption.IsSet && updateSweepConfigurationV2.Category != null) 
            {
                string? categoryRawValue = UpdateSweepConfigurationV2.CategoryEnum.ToJsonValue(updateSweepConfigurationV2._CategoryOption.Value!.Value);
                writer.WriteString("category", categoryRawValue);
            }
            
            if (updateSweepConfigurationV2._CounterpartyOption.IsSet)
            {
                writer.WritePropertyName("counterparty");
                JsonSerializer.Serialize(writer, updateSweepConfigurationV2.Counterparty, jsonSerializerOptions);
            }
            if (updateSweepConfigurationV2._CurrencyOption.IsSet)
                writer.WriteString("currency", updateSweepConfigurationV2.Currency);

            if (updateSweepConfigurationV2._DescriptionOption.IsSet)
                writer.WriteString("description", updateSweepConfigurationV2.Description);

            if (updateSweepConfigurationV2._IdOption.IsSet)
                writer.WriteString("id", updateSweepConfigurationV2.Id);

            if (updateSweepConfigurationV2._PrioritiesOption.IsSet)
            {
                writer.WritePropertyName("priorities");
                JsonSerializer.Serialize(writer, updateSweepConfigurationV2.Priorities, jsonSerializerOptions);
            }
            if (updateSweepConfigurationV2._ReasonOption.IsSet && updateSweepConfigurationV2.Reason != null) 
            {
                string? reasonRawValue = UpdateSweepConfigurationV2.ReasonEnum.ToJsonValue(updateSweepConfigurationV2._ReasonOption.Value!.Value);
                writer.WriteString("reason", reasonRawValue);
            }
            
            if (updateSweepConfigurationV2._ReasonDetailOption.IsSet)
                writer.WriteString("reasonDetail", updateSweepConfigurationV2.ReasonDetail);

            if (updateSweepConfigurationV2._ReferenceOption.IsSet)
                writer.WriteString("reference", updateSweepConfigurationV2.Reference);

            if (updateSweepConfigurationV2._ReferenceForBeneficiaryOption.IsSet)
                writer.WriteString("referenceForBeneficiary", updateSweepConfigurationV2.ReferenceForBeneficiary);

            if (updateSweepConfigurationV2._ScheduleOption.IsSet)
            {
                writer.WritePropertyName("schedule");
                JsonSerializer.Serialize(writer, updateSweepConfigurationV2.Schedule, jsonSerializerOptions);
            }
            if (updateSweepConfigurationV2._StatusOption.IsSet && updateSweepConfigurationV2.Status != null) 
            {
                string? statusRawValue = UpdateSweepConfigurationV2.StatusEnum.ToJsonValue(updateSweepConfigurationV2._StatusOption.Value!.Value);
                writer.WriteString("status", statusRawValue);
            }
            
            if (updateSweepConfigurationV2._SweepAmountOption.IsSet)
            {
                writer.WritePropertyName("sweepAmount");
                JsonSerializer.Serialize(writer, updateSweepConfigurationV2.SweepAmount, jsonSerializerOptions);
            }
            if (updateSweepConfigurationV2._TargetAmountOption.IsSet)
            {
                writer.WritePropertyName("targetAmount");
                JsonSerializer.Serialize(writer, updateSweepConfigurationV2.TargetAmount, jsonSerializerOptions);
            }
            if (updateSweepConfigurationV2._TriggerAmountOption.IsSet)
            {
                writer.WritePropertyName("triggerAmount");
                JsonSerializer.Serialize(writer, updateSweepConfigurationV2.TriggerAmount, jsonSerializerOptions);
            }
            if (updateSweepConfigurationV2._TypeOption.IsSet && updateSweepConfigurationV2.Type != null) 
            {
                string? typeRawValue = UpdateSweepConfigurationV2.TypeEnum.ToJsonValue(updateSweepConfigurationV2._TypeOption.Value!.Value);
