...
namespace Adyen.BalancePlatform.Models
{
    ...
    /// </summary>
    public partial class PaymentInstrumentRevealResponse : IValidatableObject
    {
        /// <summary>
    ...
    public class PaymentInstrumentRevealResponseJsonConverter : JsonConverter<PaymentInstrumentRevealResponse>
    {
        ...
        public override PaymentInstrumentRevealResponse Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (encryptedData.IsSet && encryptedData.Value == null)
                throw new ArgumentNullException(nameof(encryptedData), "Property is not nullable for class PaymentInstrumentRevealResponse.");
        ...
        public void WriteProperties(Utf8JsonWriter writer, PaymentInstrumentRevealResponse paymentInstrumentRevealResponse, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (paymentInstrumentRevealResponse.EncryptedData == null)
                throw new ArgumentNullException(nameof(paymentInstrumentRevealResponse.EncryptedData), "Property is required for class PaymentInstrumentRevealResponse.");
