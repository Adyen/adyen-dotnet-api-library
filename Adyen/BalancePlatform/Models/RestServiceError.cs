...
namespace Adyen.BalancePlatform.Models
{
    ...
    /// RestServiceError.
    /// </summary>
    [JsonConverter(typeof(RestServiceErrorJsonConverter))]
    ...
    public class RestServiceErrorJsonConverter : JsonConverter<RestServiceError>
    {
        ...
        public override RestServiceError Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
                    ...
                    switch (jsonPropertyName)
                    {
                        ...
                        case "status":
                            if (utf8JsonReader.TokenType == JsonTokenType.Null)
                                throw new JsonException("Property 'status' on 'RestServiceError' cannot be null.");
            ...
            if (invalidFields.IsSet)
                restServiceError.InvalidFields = invalidFields.Value;
            if (requestId.IsSet)
                restServiceError.RequestId = requestId.Value;
            if (response.IsSet)
                restServiceError.Response = response.Value;
