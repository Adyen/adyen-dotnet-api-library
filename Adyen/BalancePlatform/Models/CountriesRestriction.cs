...
namespace Adyen.BalancePlatform.Models
{
    ...
    /// </summary>
    [JsonConverter(typeof(CountriesRestrictionJsonConverter))]
    ...
    public class CountriesRestrictionJsonConverter : JsonConverter<CountriesRestriction>
    {
        ...
        public override CountriesRestriction Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            var countriesRestriction = new CountriesRestriction();
            countriesRestriction.Operation = operation.Value!;
            if (value.IsSet)
                countriesRestriction.Value = value.Value;
            return countriesRestriction;
        }
