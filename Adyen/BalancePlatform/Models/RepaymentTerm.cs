...
namespace Adyen.BalancePlatform.Models
{
    ...
    public class RepaymentTermJsonConverter : JsonConverter<RepaymentTerm>
    {
        ...
        public override RepaymentTerm Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (estimatedDays.IsSet && estimatedDays.Value == null)
                throw new ArgumentNullException(nameof(estimatedDays), "Property is not nullable for class RepaymentTerm.");

            if (maximumDays.IsSet && maximumDays.Value == null)
                throw new ArgumentNullException(nameof(maximumDays), "Property is not nullable for class RepaymentTerm.");
