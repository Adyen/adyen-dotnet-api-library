    ...
    public class BalanceAccountBaseJsonConverter : JsonConverter<BalanceAccountBase>
    {
        ...
        public override BalanceAccountBase Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (accountHolderId.IsSet && accountHolderId.Value == null)
                throw new ArgumentNullException(nameof(accountHolderId), "Property is not nullable for class BalanceAccountBase.");

            if (id.IsSet && id.Value == null)
                throw new ArgumentNullException(nameof(id), "Property is not nullable for class BalanceAccountBase.");

            if (defaultCurrencyCode.IsSet && defaultCurrencyCode.Value == null)
                throw new ArgumentNullException(nameof(defaultCurrencyCode), "Property is not nullable for class BalanceAccountBase.");

            if (description.IsSet && description.Value == null)
                throw new ArgumentNullException(nameof(description), "Property is not nullable for class BalanceAccountBase.");

            if (metadata.IsSet && metadata.Value == null)
                throw new ArgumentNullException(nameof(metadata), "Property is not nullable for class BalanceAccountBase.");

            if (migratedAccountCode.IsSet && migratedAccountCode.Value == null)
                throw new ArgumentNullException(nameof(migratedAccountCode), "Property is not nullable for class BalanceAccountBase.");

            if (platformPaymentConfiguration.IsSet && platformPaymentConfiguration.Value == null)
                throw new ArgumentNullException(nameof(platformPaymentConfiguration), "Property is not nullable for class BalanceAccountBase.");

            if (reference.IsSet && reference.Value == null)
                throw new ArgumentNullException(nameof(reference), "Property is not nullable for class BalanceAccountBase.");

            if (status.IsSet && status.Value == null)
                throw new ArgumentNullException(nameof(status), "Property is not nullable for class BalanceAccountBase.");

            if (timeZone.IsSet && timeZone.Value == null)
                throw new ArgumentNullException(nameof(timeZone), "Property is not nullable for class BalanceAccountBase.");
        ...
        public void WriteProperties(Utf8JsonWriter writer, BalanceAccountBase balanceAccountBase, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (balanceAccountBase.AccountHolderId == null)
                throw new ArgumentNullException(nameof(balanceAccountBase.AccountHolderId), "Property is required for class BalanceAccountBase.");

            if (balanceAccountBase.Id == null)
                throw new ArgumentNullException(nameof(balanceAccountBase.Id), "Property is required for class BalanceAccountBase.");

            if (balanceAccountBase._DefaultCurrencyCodeOption.IsSet && balanceAccountBase.DefaultCurrencyCode == null)
                throw new ArgumentNullException(nameof(balanceAccountBase.DefaultCurrencyCode), "Property is required for class BalanceAccountBase.");

            if (balanceAccountBase._DescriptionOption.IsSet && balanceAccountBase.Description == null)
                throw new ArgumentNullException(nameof(balanceAccountBase.Description), "Property is required for class BalanceAccountBase.");

            if (balanceAccountBase._MetadataOption.IsSet && balanceAccountBase.Metadata == null)
                throw new ArgumentNullException(nameof(balanceAccountBase.Metadata), "Property is required for class BalanceAccountBase.");

            if (balanceAccountBase._MigratedAccountCodeOption.IsSet && balanceAccountBase.MigratedAccountCode == null)
                throw new ArgumentNullException(nameof(balanceAccountBase.MigratedAccountCode), "Property is required for class BalanceAccountBase.");

            if (balanceAccountBase._PlatformPaymentConfigurationOption.IsSet && balanceAccountBase.PlatformPaymentConfiguration == null)
                throw new ArgumentNullException(nameof(balanceAccountBase.PlatformPaymentConfiguration), "Property is required for class BalanceAccountBase.");

            if (balanceAccountBase._ReferenceOption.IsSet && balanceAccountBase.Reference == null)
                throw new ArgumentNullException(nameof(balanceAccountBase.Reference), "Property is required for class BalanceAccountBase.");

            if (balanceAccountBase._TimeZoneOption.IsSet && balanceAccountBase.TimeZone == null)
                throw new ArgumentNullException(nameof(balanceAccountBase.TimeZone), "Property is required for class BalanceAccountBase.");
