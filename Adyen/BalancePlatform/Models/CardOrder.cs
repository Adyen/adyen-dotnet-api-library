...
namespace Adyen.BalancePlatform.Models
{
    ...
    /// CardOrder.
    /// </summary>
    [JsonConverter(typeof(CardOrderJsonConverter))]
    ...
    public class CardOrderJsonConverter : JsonConverter<CardOrder>
    {
        ...
        public override CardOrder Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (cardManufacturingProfileId.IsSet)
                cardOrder.CardManufacturingProfileId = cardManufacturingProfileId.Value;
            if (closedDate.IsSet)
                cardOrder.ClosedDate = closedDate.Value;
            if (endDate.IsSet)
                cardOrder.EndDate = endDate.Value;
            if (id.IsSet)
                cardOrder.Id = id.Value;
            if (lockDate.IsSet)
                cardOrder.LockDate = lockDate.Value;
            if (serviceCenter.IsSet)
                cardOrder.ServiceCenter = serviceCenter.Value;
            if (status.IsSet)
                cardOrder.Status = status.Value;
            return cardOrder;
        }
        ...
        public void WriteProperties(Utf8JsonWriter writer, CardOrder cardOrder, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (cardOrder._BeginDateOption.IsSet)
                if (cardOrder._BeginDateOption.Value != null)
            ...
            if (cardOrder._ClosedDateOption.IsSet)
                if (cardOrder._ClosedDateOption.Value != null)
            ...
            if (cardOrder._EndDateOption.IsSet)
                if (cardOrder._EndDateOption.Value != null)
            ...
            if (cardOrder._LockDateOption.IsSet)
                if (cardOrder._LockDateOption.Value != null)
