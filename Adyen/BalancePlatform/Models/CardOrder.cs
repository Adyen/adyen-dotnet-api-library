    ...
    public class CardOrderJsonConverter : JsonConverter<CardOrder>
    {
        ...
        public override CardOrder Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (beginDate.IsSet && beginDate.Value == null)
                throw new ArgumentNullException(nameof(beginDate), "Property is not nullable for class CardOrder.");

            if (cardManufacturingProfileId.IsSet && cardManufacturingProfileId.Value == null)
                throw new ArgumentNullException(nameof(cardManufacturingProfileId), "Property is not nullable for class CardOrder.");

            if (closedDate.IsSet && closedDate.Value == null)
                throw new ArgumentNullException(nameof(closedDate), "Property is not nullable for class CardOrder.");

            if (endDate.IsSet && endDate.Value == null)
                throw new ArgumentNullException(nameof(endDate), "Property is not nullable for class CardOrder.");

            if (id.IsSet && id.Value == null)
                throw new ArgumentNullException(nameof(id), "Property is not nullable for class CardOrder.");

            if (lockDate.IsSet && lockDate.Value == null)
                throw new ArgumentNullException(nameof(lockDate), "Property is not nullable for class CardOrder.");

            if (serviceCenter.IsSet && serviceCenter.Value == null)
                throw new ArgumentNullException(nameof(serviceCenter), "Property is not nullable for class CardOrder.");

            if (status.IsSet && status.Value == null)
                throw new ArgumentNullException(nameof(status), "Property is not nullable for class CardOrder.");
        ...
        {
            /*
            if (cardOrder._CardManufacturingProfileIdOption.IsSet && cardOrder.CardManufacturingProfileId == null)
                throw new ArgumentNullException(nameof(cardOrder.CardManufacturingProfileId), "Property is required for class CardOrder.");

            if (cardOrder._IdOption.IsSet && cardOrder.Id == null)
                throw new ArgumentNullException(nameof(cardOrder.Id), "Property is required for class CardOrder.");

            if (cardOrder._ServiceCenterOption.IsSet && cardOrder.ServiceCenter == null)
                throw new ArgumentNullException(nameof(cardOrder.ServiceCenter), "Property is required for class CardOrder.");
