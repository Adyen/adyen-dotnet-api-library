...
namespace Adyen.BalancePlatform.Models
{
    ...
    /// </summary>
    public partial class FinishScaDeviceRegistrationResponse : IValidatableObject
    {
        /// <summary>
    ...
    public class FinishScaDeviceRegistrationResponseJsonConverter : JsonConverter<FinishScaDeviceRegistrationResponse>
    {
        ...
        public override FinishScaDeviceRegistrationResponse Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (scaDevice.IsSet && scaDevice.Value == null)
                throw new ArgumentNullException(nameof(scaDevice), "Property is not nullable for class FinishScaDeviceRegistrationResponse.");

            return new FinishScaDeviceRegistrationResponse(scaDevice);
        }
        ...
        {
            /*
            if (finishScaDeviceRegistrationResponse._ScaDeviceOption.IsSet && finishScaDeviceRegistrationResponse.ScaDevice == null)
                throw new ArgumentNullException(nameof(finishScaDeviceRegistrationResponse.ScaDevice), "Property is required for class FinishScaDeviceRegistrationResponse.");
