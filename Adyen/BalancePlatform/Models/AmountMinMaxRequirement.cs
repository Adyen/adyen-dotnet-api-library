...
namespace Adyen.BalancePlatform.Models
{
    ...
    /// </summary>
    public partial class AmountMinMaxRequirement : IValidatableObject
    {
        /// <summary>
        ...
        [JsonIgnore]
        [global::System.ComponentModel.EditorBrowsable(global::System.ComponentModel.EditorBrowsableState.Never)]
        public Option<long?> _MaxOption { get; private set; }
        ...
        public long? Max { get { return this._MaxOption; } set { this._MaxOption = new(value); } }
        ...
        [JsonIgnore]
        [global::System.ComponentModel.EditorBrowsable(global::System.ComponentModel.EditorBrowsableState.Never)]
        public Option<long?> _MinOption { get; private set; }
        ...
        public long? Min { get { return this._MinOption; } set { this._MinOption = new(value); } }
    ...
    /// <summary>
    /// A Json converter for type <see cref="AmountMinMaxRequirement" />
    /// </summary>
    public class AmountMinMaxRequirementJsonConverter : JsonConverter<AmountMinMaxRequirement>
    {
        /// <summary>
        /// Deserializes json to <see cref="AmountMinMaxRequirement"/>.
        /// </summary>
        /// <param name="utf8JsonReader"><see cref="Utf8JsonReader"/></param>
        /// <param name="typeToConvert"><see cref="Type"/></param>
        /// <param name="jsonSerializerOptions">The <see cref="JsonSerializerOptions"/>, initialized from <see cref="HostConfiguration"/>.</param>
        /// <returns><see cref="AmountMinMaxRequirement"/></returns>
        /// <exception cref="JsonException"></exception>
        public override AmountMinMaxRequirement Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            Option<long?> max = default;
            Option<long?> min = default;
            Option<AmountMinMaxRequirement.TypeEnum?> type = default;
                ...
                if (utf8JsonReader.TokenType == JsonTokenType.PropertyName && currentDepth == utf8JsonReader.CurrentDepth - 1)
                {
                    ...
                    switch (jsonPropertyName)
                    {
                        case "description":
                            ...
                            break;
                        case "max":
                            max = new Option<long?>(utf8JsonReader.TokenType == JsonTokenType.Null ? (long?)null : utf8JsonReader.GetInt64());
                            break;
                        case "min":
                            min = new Option<long?>(utf8JsonReader.TokenType == JsonTokenType.Null ? (long?)null : utf8JsonReader.GetInt64());
                            break;
                        case "type":
            ...
            if (description.IsSet && description.Value == null)
                throw new ArgumentNullException(nameof(description), "Property is not nullable for class AmountMinMaxRequirement.");

            if (max.IsSet && max.Value == null)
                throw new ArgumentNullException(nameof(max), "Property is not nullable for class AmountMinMaxRequirement.");

            if (min.IsSet && min.Value == null)
                throw new ArgumentNullException(nameof(min), "Property is not nullable for class AmountMinMaxRequirement.");

            if (type.IsSet && type.Value == null)
                throw new ArgumentNullException(nameof(type), "Property is not nullable for class AmountMinMaxRequirement.");

            return new AmountMinMaxRequirement(description, max, min, type.Value!.Value!);
        }

        /// <summary>
        /// Serializes a <see cref="AmountMinMaxRequirement"/>.
        /// </summary>
        ...
        public override void Write(Utf8JsonWriter writer, AmountMinMaxRequirement amountMinMaxRequirement, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            WriteProperties(writer, amountMinMaxRequirement, jsonSerializerOptions);
        ...
        /// <summary>
        /// Serializes the properties of <see cref="AmountMinMaxRequirement"/>.
        /// </summary>
        ...
        {
            /*
            if (amountMinMaxRequirement._DescriptionOption.IsSet && amountMinMaxRequirement.Description == null)
                throw new ArgumentNullException(nameof(amountMinMaxRequirement.Description), "Property is required for class AmountMinMaxRequirement.");

            */
            
            if (amountMinMaxRequirement._DescriptionOption.IsSet)
                writer.WriteString("description", amountMinMaxRequirement.Description);

            if (amountMinMaxRequirement._MaxOption.IsSet)
                writer.WriteNumber("max", amountMinMaxRequirement._MaxOption.Value!.Value);

            if (amountMinMaxRequirement._MinOption.IsSet)
                writer.WriteNumber("min", amountMinMaxRequirement._MinOption.Value!.Value);

            if (amountMinMaxRequirement.Type != null) 
            {
                string? typeRawValue = AmountMinMaxRequirement.TypeEnum.ToJsonValue(amountMinMaxRequirement.Type);
