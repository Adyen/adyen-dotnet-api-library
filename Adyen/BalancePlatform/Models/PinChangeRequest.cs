...
namespace Adyen.BalancePlatform.Models
{
    ...
    /// PinChangeRequest.
    /// </summary>
    public partial class PinChangeRequest : IValidatableObject
    {
        /// <summary>
    ...
    public class PinChangeRequestJsonConverter : JsonConverter<PinChangeRequest>
    {
        ...
        public override PinChangeRequest Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (encryptedKey.IsSet && encryptedKey.Value == null)
                throw new ArgumentNullException(nameof(encryptedKey), "Property is not nullable for class PinChangeRequest.");

            if (encryptedPinBlock.IsSet && encryptedPinBlock.Value == null)
                throw new ArgumentNullException(nameof(encryptedPinBlock), "Property is not nullable for class PinChangeRequest.");

            if (paymentInstrumentId.IsSet && paymentInstrumentId.Value == null)
                throw new ArgumentNullException(nameof(paymentInstrumentId), "Property is not nullable for class PinChangeRequest.");

            if (token.IsSet && token.Value == null)
                throw new ArgumentNullException(nameof(token), "Property is not nullable for class PinChangeRequest.");
        ...
        public void WriteProperties(Utf8JsonWriter writer, PinChangeRequest pinChangeRequest, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (pinChangeRequest.EncryptedKey == null)
                throw new ArgumentNullException(nameof(pinChangeRequest.EncryptedKey), "Property is required for class PinChangeRequest.");

            if (pinChangeRequest.EncryptedPinBlock == null)
                throw new ArgumentNullException(nameof(pinChangeRequest.EncryptedPinBlock), "Property is required for class PinChangeRequest.");

            if (pinChangeRequest.PaymentInstrumentId == null)
                throw new ArgumentNullException(nameof(pinChangeRequest.PaymentInstrumentId), "Property is required for class PinChangeRequest.");

            if (pinChangeRequest.Token == null)
                throw new ArgumentNullException(nameof(pinChangeRequest.Token), "Property is required for class PinChangeRequest.");
