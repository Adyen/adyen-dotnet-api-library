    ...
    public class ScaEntityJsonConverter : JsonConverter<ScaEntity>
    {
        ...
        public override ScaEntity Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (id.IsSet && id.Value == null)
                throw new ArgumentNullException(nameof(id), "Property is not nullable for class ScaEntity.");

            if (type.IsSet && type.Value == null)
                throw new ArgumentNullException(nameof(type), "Property is not nullable for class ScaEntity.");
        ...
        public void WriteProperties(Utf8JsonWriter writer, ScaEntity scaEntity, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (scaEntity.Id == null)
                throw new ArgumentNullException(nameof(scaEntity.Id), "Property is required for class ScaEntity.");
