...
namespace Adyen.BalancePlatform.Models
{
    ...
    /// </summary>
    [JsonConverter(typeof(PaymentInstrumentRequirementJsonConverter))]
    public partial class PaymentInstrumentRequirement
    {
        /// <summary>
        ...
        public class PaymentInstrumentTypeEnum : IEnum
        {
            ...
            /// <summary>
            /// Compares two <see cref="PaymentInstrumentTypeEnum"/> instances for equality.
            /// </summary>
            ...
            /// <summary>
            /// Compares two <see cref="PaymentInstrumentTypeEnum"/> instances for inequality.
            /// </summary>
            public static bool operator !=(PaymentInstrumentTypeEnum? left, PaymentInstrumentTypeEnum? right) => !string.Equals(left?.Value, right?.Value, StringComparison.OrdinalIgnoreCase);

            /// <summary>
            /// Returns true if the given object is equal to this <see cref="PaymentInstrumentTypeEnum"/> instance.
            /// </summary>
            ...
            /// <summary>
            /// Returns a hash code for this <see cref="PaymentInstrumentTypeEnum"/> instance.
            /// </summary>
            public override int GetHashCode() => Value?.GetHashCode() ?? 0;

            /// <summary>
            /// Returns the string value of the <see cref="PaymentInstrumentTypeEnum"/> instance.
            /// </summary>
            ...
            {
                /// <summary>
                /// Deserializes a <see cref="PaymentInstrumentTypeEnum"/> from JSON.
                /// </summary>
                ...
                /// <summary>
                /// Serializes a <see cref="PaymentInstrumentTypeEnum"/> to JSON.
                /// </summary>
    ...
    public class PaymentInstrumentRequirementJsonConverter : JsonConverter<PaymentInstrumentRequirement>
    {
        ...
        public override PaymentInstrumentRequirement Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (description.IsSet)
                paymentInstrumentRequirement.Description = description.Value;
            if (issuingCountryCode.IsSet)
                paymentInstrumentRequirement.IssuingCountryCode = issuingCountryCode.Value;
            if (issuingCountryCodes.IsSet)
                paymentInstrumentRequirement.IssuingCountryCodes = issuingCountryCodes.Value;
            if (onlyForCrossBalancePlatform.IsSet)
        ...
        public void WriteProperties(Utf8JsonWriter writer, PaymentInstrumentRequirement paymentInstrumentRequirement, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (paymentInstrumentRequirement._OnlyForCrossBalancePlatformOption.IsSet)
                if (paymentInstrumentRequirement._OnlyForCrossBalancePlatformOption.Value != null)
