...
namespace Adyen.BalancePlatform.Models
{
    ...
    /// PinChangeResponse.
    /// </summary>
    public partial class PinChangeResponse : IValidatableObject
    {
        /// <summary>
    ...
    public class PinChangeResponseJsonConverter : JsonConverter<PinChangeResponse>
    {
        ...
        public override PinChangeResponse Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (status.IsSet && status.Value == null)
                throw new ArgumentNullException(nameof(status), "Property is not nullable for class PinChangeResponse.");
