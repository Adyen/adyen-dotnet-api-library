    ...
    public class TransactionRuleJsonConverter : JsonConverter<TransactionRule>
    {
        ...
        public override TransactionRule Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (description.IsSet && description.Value == null)
                throw new ArgumentNullException(nameof(description), "Property is not nullable for class TransactionRule.");

            if (entityKey.IsSet && entityKey.Value == null)
                throw new ArgumentNullException(nameof(entityKey), "Property is not nullable for class TransactionRule.");

            if (interval.IsSet && interval.Value == null)
                throw new ArgumentNullException(nameof(interval), "Property is not nullable for class TransactionRule.");

            if (reference.IsSet && reference.Value == null)
                throw new ArgumentNullException(nameof(reference), "Property is not nullable for class TransactionRule.");

            if (ruleRestrictions.IsSet && ruleRestrictions.Value == null)
                throw new ArgumentNullException(nameof(ruleRestrictions), "Property is not nullable for class TransactionRule.");

            if (type.IsSet && type.Value == null)
                throw new ArgumentNullException(nameof(type), "Property is not nullable for class TransactionRule.");

            if (aggregationLevel.IsSet && aggregationLevel.Value == null)
                throw new ArgumentNullException(nameof(aggregationLevel), "Property is not nullable for class TransactionRule.");

            if (endDate.IsSet && endDate.Value == null)
                throw new ArgumentNullException(nameof(endDate), "Property is not nullable for class TransactionRule.");

            if (id.IsSet && id.Value == null)
                throw new ArgumentNullException(nameof(id), "Property is not nullable for class TransactionRule.");

            if (outcomeType.IsSet && outcomeType.Value == null)
                throw new ArgumentNullException(nameof(outcomeType), "Property is not nullable for class TransactionRule.");

            if (requestType.IsSet && requestType.Value == null)
                throw new ArgumentNullException(nameof(requestType), "Property is not nullable for class TransactionRule.");

            if (score.IsSet && score.Value == null)
                throw new ArgumentNullException(nameof(score), "Property is not nullable for class TransactionRule.");

            if (startDate.IsSet && startDate.Value == null)
                throw new ArgumentNullException(nameof(startDate), "Property is not nullable for class TransactionRule.");

            if (status.IsSet && status.Value == null)
                throw new ArgumentNullException(nameof(status), "Property is not nullable for class TransactionRule.");
        ...
        public void WriteProperties(Utf8JsonWriter writer, TransactionRule transactionRule, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (transactionRule.Description == null)
                throw new ArgumentNullException(nameof(transactionRule.Description), "Property is required for class TransactionRule.");

            if (transactionRule.EntityKey == null)
                throw new ArgumentNullException(nameof(transactionRule.EntityKey), "Property is required for class TransactionRule.");

            if (transactionRule.Interval == null)
                throw new ArgumentNullException(nameof(transactionRule.Interval), "Property is required for class TransactionRule.");

            if (transactionRule.Reference == null)
                throw new ArgumentNullException(nameof(transactionRule.Reference), "Property is required for class TransactionRule.");

            if (transactionRule.RuleRestrictions == null)
                throw new ArgumentNullException(nameof(transactionRule.RuleRestrictions), "Property is required for class TransactionRule.");

            if (transactionRule._AggregationLevelOption.IsSet && transactionRule.AggregationLevel == null)
                throw new ArgumentNullException(nameof(transactionRule.AggregationLevel), "Property is required for class TransactionRule.");

            if (transactionRule._EndDateOption.IsSet && transactionRule.EndDate == null)
                throw new ArgumentNullException(nameof(transactionRule.EndDate), "Property is required for class TransactionRule.");

            if (transactionRule._IdOption.IsSet && transactionRule.Id == null)
                throw new ArgumentNullException(nameof(transactionRule.Id), "Property is required for class TransactionRule.");

            if (transactionRule._StartDateOption.IsSet && transactionRule.StartDate == null)
                throw new ArgumentNullException(nameof(transactionRule.StartDate), "Property is required for class TransactionRule.");
