...
namespace Adyen.BalancePlatform.Models
{
    ...
    /// TransactionRule.
    /// </summary>
    [JsonConverter(typeof(TransactionRuleJsonConverter))]
    ...
    public class TransactionRuleJsonConverter : JsonConverter<TransactionRule>
    {
        ...
        public override TransactionRule Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
                ...
                if (utf8JsonReader.TokenType == JsonTokenType.PropertyName && currentDepth == utf8JsonReader.CurrentDepth - 1)
                {
                    ...
                    switch (jsonPropertyName)
                    {
                        ...
                        case "type":
                            ...
                            type = new Option<TransactionRule.TypeEnum?>(TransactionRule.TypeEnum.FromStringOrDefault(typeRawValue) ?? (TransactionRule.TypeEnum)typeRawValue);
                            break;
                        ...
                        case "outcomeType":
                            ...
                            outcomeType = new Option<TransactionRule.OutcomeTypeEnum?>(TransactionRule.OutcomeTypeEnum.FromStringOrDefault(outcomeTypeRawValue) ?? (TransactionRule.OutcomeTypeEnum)outcomeTypeRawValue);
                            break;
                        case "overridesRule":
                        ...
                        case "purpose":
                            ...
                            purpose = new Option<TransactionRule.PurposeEnum?>(TransactionRule.PurposeEnum.FromStringOrDefault(purposeRawValue) ?? (TransactionRule.PurposeEnum)purposeRawValue);
                            break;
                        case "requestType":
                            string? requestTypeRawValue = utf8JsonReader.GetString();
                            requestType = new Option<TransactionRule.RequestTypeEnum?>(TransactionRule.RequestTypeEnum.FromStringOrDefault(requestTypeRawValue) ?? (TransactionRule.RequestTypeEnum)requestTypeRawValue);
                            break;
                        case "score":
                        ...
                        case "status":
                            ...
                            status = new Option<TransactionRule.StatusEnum?>(TransactionRule.StatusEnum.FromStringOrDefault(statusRawValue) ?? (TransactionRule.StatusEnum)statusRawValue);
                            break;
                        default:
                            break;
                    }
            ...
            var transactionRule = new TransactionRule();
            if (description.IsSet)
                transactionRule.Description = description.Value!;
            if (entityKey.IsSet)
                transactionRule.EntityKey = entityKey.Value!;
            if (interval.IsSet)
            ...
            if (endDate.IsSet)
                transactionRule.EndDate = endDate.Value;
            if (id.IsSet)
                transactionRule.Id = id.Value;
            if (outcomeType.IsSet)
                transactionRule.OutcomeType = outcomeType.Value;
            if (overridesRule.IsSet)
                transactionRule.OverridesRule = overridesRule.Value;
            if (purpose.IsSet)
                transactionRule.Purpose = purpose.Value;
            if (requestType.IsSet)
                transactionRule.RequestType = requestType.Value;
            if (score.IsSet)
                transactionRule.Score = score.Value;
            if (startDate.IsSet)
                transactionRule.StartDate = startDate.Value;
            if (status.IsSet)
                transactionRule.Status = status.Value;
        ...
        public void WriteProperties(Utf8JsonWriter writer, TransactionRule transactionRule, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (transactionRule._OverridesRuleOption.IsSet)
                if (transactionRule.OverridesRule != null)
                    writer.WriteString("overridesRule", transactionRule.OverridesRule);
            ...
            if (transactionRule._ScoreOption.IsSet)
                if (transactionRule._ScoreOption.Value != null)
