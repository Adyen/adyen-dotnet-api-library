...
namespace Adyen.BalancePlatform.Models
{
    ...
    /// </summary>
    public partial class AmountNonZeroDecimalsRequirement : IValidatableObject
    {
        /// <summary>
    ...
    /// <summary>
    /// A Json converter for type <see cref="AmountNonZeroDecimalsRequirement" />
    /// </summary>
    public class AmountNonZeroDecimalsRequirementJsonConverter : JsonConverter<AmountNonZeroDecimalsRequirement>
    {
        /// <summary>
        /// Deserializes json to <see cref="AmountNonZeroDecimalsRequirement"/>.
        /// </summary>
        /// <param name="utf8JsonReader"><see cref="Utf8JsonReader"/></param>
        /// <param name="typeToConvert"><see cref="Type"/></param>
        /// <param name="jsonSerializerOptions">The <see cref="JsonSerializerOptions"/>, initialized from <see cref="HostConfiguration"/>.</param>
        /// <returns><see cref="AmountNonZeroDecimalsRequirement"/></returns>
        /// <exception cref="JsonException"></exception>
        public override AmountNonZeroDecimalsRequirement Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            Option<AmountNonZeroDecimalsRequirement.TypeEnum?> type = default;
            ...
            if (description.IsSet && description.Value == null)
                throw new ArgumentNullException(nameof(description), "Property is not nullable for class AmountNonZeroDecimalsRequirement.");

            if (type.IsSet && type.Value == null)
                throw new ArgumentNullException(nameof(type), "Property is not nullable for class AmountNonZeroDecimalsRequirement.");

            return new AmountNonZeroDecimalsRequirement(description, type.Value!.Value!);
        }

        /// <summary>
        /// Serializes a <see cref="AmountNonZeroDecimalsRequirement"/>.
        /// </summary>
        ...
        public override void Write(Utf8JsonWriter writer, AmountNonZeroDecimalsRequirement amountNonZeroDecimalsRequirement, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            WriteProperties(writer, amountNonZeroDecimalsRequirement, jsonSerializerOptions);
        ...
        /// <summary>
        /// Serializes the properties of <see cref="AmountNonZeroDecimalsRequirement"/>.
        /// </summary>
        ...
        {
            /*
            if (amountNonZeroDecimalsRequirement._DescriptionOption.IsSet && amountNonZeroDecimalsRequirement.Description == null)
                throw new ArgumentNullException(nameof(amountNonZeroDecimalsRequirement.Description), "Property is required for class AmountNonZeroDecimalsRequirement.");

            */
            
            if (amountNonZeroDecimalsRequirement._DescriptionOption.IsSet)
                writer.WriteString("description", amountNonZeroDecimalsRequirement.Description);

            if (amountNonZeroDecimalsRequirement.Type != null) 
            {
                string? typeRawValue = AmountNonZeroDecimalsRequirement.TypeEnum.ToJsonValue(amountNonZeroDecimalsRequirement.Type);
