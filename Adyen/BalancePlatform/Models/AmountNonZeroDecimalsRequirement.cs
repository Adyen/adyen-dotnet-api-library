...
namespace Adyen.BalancePlatform.Models
{
    ...
    /// </summary>
    [JsonConverter(typeof(AmountNonZeroDecimalsRequirementJsonConverter))]
    public partial class AmountNonZeroDecimalsRequirement
    {
        /// <summary>
    ...
    public class AmountNonZeroDecimalsRequirementJsonConverter : JsonConverter<AmountNonZeroDecimalsRequirement>
    {
        ...
        public void WriteProperties(Utf8JsonWriter writer, AmountNonZeroDecimalsRequirement amountNonZeroDecimalsRequirement, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (amountNonZeroDecimalsRequirement._DescriptionOption.IsSet)
                if (amountNonZeroDecimalsRequirement.Description != null)
