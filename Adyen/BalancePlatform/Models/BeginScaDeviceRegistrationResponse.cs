...
namespace Adyen.BalancePlatform.Models
{
    ...
    /// </summary>
    [JsonConverter(typeof(BeginScaDeviceRegistrationResponseJsonConverter))]
    ...
    public class BeginScaDeviceRegistrationResponseJsonConverter : JsonConverter<BeginScaDeviceRegistrationResponse>
    {
        ...
        public override BeginScaDeviceRegistrationResponse Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (sdkInput.IsSet)
                beginScaDeviceRegistrationResponse.SdkInput = sdkInput.Value;
            return beginScaDeviceRegistrationResponse;
        }
