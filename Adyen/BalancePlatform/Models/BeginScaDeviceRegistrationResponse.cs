...
namespace Adyen.BalancePlatform.Models
{
    ...
    public partial class BeginScaDeviceRegistrationResponse : IValidatableObject
    {
        ...
        IEnumerable<ValidationResult> IValidatableObject.Validate(ValidationContext validationContext)
        {
            ...
            {
                yield return new ValidationResult("Invalid value for SdkInput, length must be less than 10000.", new [] { "SdkInput" });
            }
    ...
    /// <summary>
    /// A Json converter for type <see cref="BeginScaDeviceRegistrationResponse" />
    /// </summary>
    public class BeginScaDeviceRegistrationResponseJsonConverter : JsonConverter<BeginScaDeviceRegistrationResponse>
    {
        /// <summary>
        /// Deserializes json to <see cref="BeginScaDeviceRegistrationResponse"/>.
        /// </summary>
        ...
        public override BeginScaDeviceRegistrationResponse Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (scaDevice.IsSet && scaDevice.Value == null)
                throw new ArgumentNullException(nameof(scaDevice), "Property is not nullable for class BeginScaDeviceRegistrationResponse.");

            if (sdkInput.IsSet && sdkInput.Value == null)
                throw new ArgumentNullException(nameof(sdkInput), "Property is not nullable for class BeginScaDeviceRegistrationResponse.");

            return new BeginScaDeviceRegistrationResponse(scaDevice, sdkInput);
        }

        /// <summary>
        /// Serializes a <see cref="BeginScaDeviceRegistrationResponse"/>.
        /// </summary>
        /// <param name="writer"><see cref="Utf8JsonWriter"/></param>
        /// <param name="beginScaDeviceRegistrationResponse"></param>
        /// <param name="jsonSerializerOptions"><see cref="JsonSerializerOptions"/></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, BeginScaDeviceRegistrationResponse beginScaDeviceRegistrationResponse, JsonSerializerOptions jsonSerializerOptions)
        {
            
            writer.WriteStartObject();
            
            WriteProperties(writer, beginScaDeviceRegistrationResponse, jsonSerializerOptions);
        ...
        /// <summary>
        /// Serializes the properties of <see cref="BeginScaDeviceRegistrationResponse"/>.
        /// </summary>
        /// <param name="writer"><see creft="Utf8JsonWriter"/></param>
        /// <param name="beginScaDeviceRegistrationResponse"></param>
        /// <param name="jsonSerializerOptions"><see cref="JsonSerializerOptions"/></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, BeginScaDeviceRegistrationResponse beginScaDeviceRegistrationResponse, JsonSerializerOptions jsonSerializerOptions)
        {
            /*
            if (beginScaDeviceRegistrationResponse._ScaDeviceOption.IsSet && beginScaDeviceRegistrationResponse.ScaDevice == null)
                throw new ArgumentNullException(nameof(beginScaDeviceRegistrationResponse.ScaDevice), "Property is required for class BeginScaDeviceRegistrationResponse.");

            if (beginScaDeviceRegistrationResponse._SdkInputOption.IsSet && beginScaDeviceRegistrationResponse.SdkInput == null)
                throw new ArgumentNullException(nameof(beginScaDeviceRegistrationResponse.SdkInput), "Property is required for class BeginScaDeviceRegistrationResponse.");

            */
            
            if (beginScaDeviceRegistrationResponse._ScaDeviceOption.IsSet)
            {
                writer.WritePropertyName("scaDevice");
                JsonSerializer.Serialize(writer, beginScaDeviceRegistrationResponse.ScaDevice, jsonSerializerOptions);
            }
            if (beginScaDeviceRegistrationResponse._SdkInputOption.IsSet)
                writer.WriteString("sdkInput", beginScaDeviceRegistrationResponse.SdkInput);
        }
    }
}
