...
namespace Adyen.BalancePlatform.Models
{
    ...
    /// </summary>
    [JsonConverter(typeof(CreateScaInformationJsonConverter))]
    ...
    public class CreateScaInformationJsonConverter : JsonConverter<CreateScaInformation>
    {
        ...
        public override CreateScaInformation Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (scaOnApproval.IsSet)
                createScaInformation.ScaOnApproval = scaOnApproval.Value;
            return createScaInformation;
        }
        ...
        public void WriteProperties(Utf8JsonWriter writer, CreateScaInformation createScaInformation, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (createScaInformation._ScaOnApprovalOption.IsSet)
                if (createScaInformation._ScaOnApprovalOption.Value != null)
