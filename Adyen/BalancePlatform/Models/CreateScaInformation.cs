...
namespace Adyen.BalancePlatform.Models
{
    ...
    public partial class CreateScaInformation : IValidatableObject
    {
        ...
        /// <summary>
        /// Used to track whether Exemption is set or not.
        /// </summary>
        [JsonIgnore]
    ...
    /// <summary>
    /// A Json converter for type <see cref="CreateScaInformation" />
    /// </summary>
    public class CreateScaInformationJsonConverter : JsonConverter<CreateScaInformation>
    {
        /// <summary>
        /// Deserializes json to <see cref="CreateScaInformation"/>.
        /// </summary>
        /// <param name="utf8JsonReader"><see cref="Utf8JsonReader"/></param>
        /// <param name="typeToConvert"><see cref="Type"/></param>
        /// <param name="jsonSerializerOptions">The <see cref="JsonSerializerOptions"/>, initialized from <see cref="HostConfiguration"/>.</param>
        /// <returns><see cref="CreateScaInformation"/></returns>
        /// <exception cref="JsonException"></exception>
        public override CreateScaInformation Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (exemption.IsSet && exemption.Value == null)
                throw new ArgumentNullException(nameof(exemption), "Property is not nullable for class CreateScaInformation.");

            if (scaOnApproval.IsSet && scaOnApproval.Value == null)
                throw new ArgumentNullException(nameof(scaOnApproval), "Property is not nullable for class CreateScaInformation.");

            return new CreateScaInformation(exemption, scaOnApproval);
        }

        /// <summary>
        /// Serializes a <see cref="CreateScaInformation"/>.
        /// </summary>
        /// <param name="writer"><see cref="Utf8JsonWriter"/></param>
        /// <param name="createScaInformation"></param>
        /// <param name="jsonSerializerOptions"><see cref="JsonSerializerOptions"/></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, CreateScaInformation createScaInformation, JsonSerializerOptions jsonSerializerOptions)
        {
            
            writer.WriteStartObject();
            
            WriteProperties(writer, createScaInformation, jsonSerializerOptions);
        ...
        /// <summary>
        /// Serializes the properties of <see cref="CreateScaInformation"/>.
        /// </summary>
        /// <param name="writer"><see creft="Utf8JsonWriter"/></param>
        /// <param name="createScaInformation"></param>
        /// <param name="jsonSerializerOptions"><see cref="JsonSerializerOptions"/></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, CreateScaInformation createScaInformation, JsonSerializerOptions jsonSerializerOptions)
        {
            /*
            */
            ...
            if (createScaInformation._ScaOnApprovalOption.IsSet)
                writer.WriteBoolean("scaOnApproval", createScaInformation._ScaOnApprovalOption.Value!.Value);
        }
    }
}
