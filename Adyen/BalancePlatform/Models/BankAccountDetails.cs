    ...
    public class BankAccountDetailsJsonConverter : JsonConverter<BankAccountDetails>
    {
        ...
        public override BankAccountDetails Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (accountNumber.IsSet && accountNumber.Value == null)
                throw new ArgumentNullException(nameof(accountNumber), "Property is not nullable for class BankAccountDetails.");

            if (accountType.IsSet && accountType.Value == null)
                throw new ArgumentNullException(nameof(accountType), "Property is not nullable for class BankAccountDetails.");

            if (branchNumber.IsSet && branchNumber.Value == null)
                throw new ArgumentNullException(nameof(branchNumber), "Property is not nullable for class BankAccountDetails.");

            if (formFactor.IsSet && formFactor.Value == null)
                throw new ArgumentNullException(nameof(formFactor), "Property is not nullable for class BankAccountDetails.");

            if (iban.IsSet && iban.Value == null)
                throw new ArgumentNullException(nameof(iban), "Property is not nullable for class BankAccountDetails.");

            if (routingNumber.IsSet && routingNumber.Value == null)
                throw new ArgumentNullException(nameof(routingNumber), "Property is not nullable for class BankAccountDetails.");

            if (sortCode.IsSet && sortCode.Value == null)
                throw new ArgumentNullException(nameof(sortCode), "Property is not nullable for class BankAccountDetails.");

            if (type.IsSet && type.Value == null)
                throw new ArgumentNullException(nameof(type), "Property is not nullable for class BankAccountDetails.");
        ...
        {
            /*
            if (bankAccountDetails._AccountNumberOption.IsSet && bankAccountDetails.AccountNumber == null)
                throw new ArgumentNullException(nameof(bankAccountDetails.AccountNumber), "Property is required for class BankAccountDetails.");

            if (bankAccountDetails._AccountTypeOption.IsSet && bankAccountDetails.AccountType == null)
                throw new ArgumentNullException(nameof(bankAccountDetails.AccountType), "Property is required for class BankAccountDetails.");

            if (bankAccountDetails._BranchNumberOption.IsSet && bankAccountDetails.BranchNumber == null)
                throw new ArgumentNullException(nameof(bankAccountDetails.BranchNumber), "Property is required for class BankAccountDetails.");

            if (bankAccountDetails._FormFactorOption.IsSet && bankAccountDetails.FormFactor == null)
                throw new ArgumentNullException(nameof(bankAccountDetails.FormFactor), "Property is required for class BankAccountDetails.");

            if (bankAccountDetails._IbanOption.IsSet && bankAccountDetails.Iban == null)
                throw new ArgumentNullException(nameof(bankAccountDetails.Iban), "Property is required for class BankAccountDetails.");

            if (bankAccountDetails._RoutingNumberOption.IsSet && bankAccountDetails.RoutingNumber == null)
                throw new ArgumentNullException(nameof(bankAccountDetails.RoutingNumber), "Property is required for class BankAccountDetails.");

            if (bankAccountDetails._SortCodeOption.IsSet && bankAccountDetails.SortCode == null)
                throw new ArgumentNullException(nameof(bankAccountDetails.SortCode), "Property is required for class BankAccountDetails.");

            if (bankAccountDetails.Type == null)
                throw new ArgumentNullException(nameof(bankAccountDetails.Type), "Property is required for class BankAccountDetails.");
