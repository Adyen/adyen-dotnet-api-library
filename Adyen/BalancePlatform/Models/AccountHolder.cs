    ...
    public class AccountHolderJsonConverter : JsonConverter<AccountHolder>
    {
        ...
        public override AccountHolder Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (id.IsSet && id.Value == null)
                throw new ArgumentNullException(nameof(id), "Property is not nullable for class AccountHolder.");

            if (legalEntityId.IsSet && legalEntityId.Value == null)
                throw new ArgumentNullException(nameof(legalEntityId), "Property is not nullable for class AccountHolder.");

            if (balancePlatform.IsSet && balancePlatform.Value == null)
                throw new ArgumentNullException(nameof(balancePlatform), "Property is not nullable for class AccountHolder.");

            if (capabilities.IsSet && capabilities.Value == null)
                throw new ArgumentNullException(nameof(capabilities), "Property is not nullable for class AccountHolder.");

            if (contactDetails.IsSet && contactDetails.Value == null)
                throw new ArgumentNullException(nameof(contactDetails), "Property is not nullable for class AccountHolder.");

            if (description.IsSet && description.Value == null)
                throw new ArgumentNullException(nameof(description), "Property is not nullable for class AccountHolder.");

            if (metadata.IsSet && metadata.Value == null)
                throw new ArgumentNullException(nameof(metadata), "Property is not nullable for class AccountHolder.");

            if (migratedAccountHolderCode.IsSet && migratedAccountHolderCode.Value == null)
                throw new ArgumentNullException(nameof(migratedAccountHolderCode), "Property is not nullable for class AccountHolder.");

            if (primaryBalanceAccount.IsSet && primaryBalanceAccount.Value == null)
                throw new ArgumentNullException(nameof(primaryBalanceAccount), "Property is not nullable for class AccountHolder.");

            if (reference.IsSet && reference.Value == null)
                throw new ArgumentNullException(nameof(reference), "Property is not nullable for class AccountHolder.");

            if (status.IsSet && status.Value == null)
                throw new ArgumentNullException(nameof(status), "Property is not nullable for class AccountHolder.");

            if (timeZone.IsSet && timeZone.Value == null)
                throw new ArgumentNullException(nameof(timeZone), "Property is not nullable for class AccountHolder.");

            if (verificationDeadlines.IsSet && verificationDeadlines.Value == null)
                throw new ArgumentNullException(nameof(verificationDeadlines), "Property is not nullable for class AccountHolder.");
        ...
        public void WriteProperties(Utf8JsonWriter writer, AccountHolder accountHolder, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (accountHolder.Id == null)
                throw new ArgumentNullException(nameof(accountHolder.Id), "Property is required for class AccountHolder.");

            if (accountHolder.LegalEntityId == null)
                throw new ArgumentNullException(nameof(accountHolder.LegalEntityId), "Property is required for class AccountHolder.");

            if (accountHolder._BalancePlatformOption.IsSet && accountHolder.BalancePlatform == null)
                throw new ArgumentNullException(nameof(accountHolder.BalancePlatform), "Property is required for class AccountHolder.");

            if (accountHolder._CapabilitiesOption.IsSet && accountHolder.Capabilities == null)
                throw new ArgumentNullException(nameof(accountHolder.Capabilities), "Property is required for class AccountHolder.");

            if (accountHolder._ContactDetailsOption.IsSet && accountHolder.ContactDetails == null)
                throw new ArgumentNullException(nameof(accountHolder.ContactDetails), "Property is required for class AccountHolder.");

            if (accountHolder._DescriptionOption.IsSet && accountHolder.Description == null)
                throw new ArgumentNullException(nameof(accountHolder.Description), "Property is required for class AccountHolder.");

            if (accountHolder._MetadataOption.IsSet && accountHolder.Metadata == null)
                throw new ArgumentNullException(nameof(accountHolder.Metadata), "Property is required for class AccountHolder.");

            if (accountHolder._MigratedAccountHolderCodeOption.IsSet && accountHolder.MigratedAccountHolderCode == null)
                throw new ArgumentNullException(nameof(accountHolder.MigratedAccountHolderCode), "Property is required for class AccountHolder.");

            if (accountHolder._PrimaryBalanceAccountOption.IsSet && accountHolder.PrimaryBalanceAccount == null)
                throw new ArgumentNullException(nameof(accountHolder.PrimaryBalanceAccount), "Property is required for class AccountHolder.");

            if (accountHolder._ReferenceOption.IsSet && accountHolder.Reference == null)
                throw new ArgumentNullException(nameof(accountHolder.Reference), "Property is required for class AccountHolder.");

            if (accountHolder._TimeZoneOption.IsSet && accountHolder.TimeZone == null)
                throw new ArgumentNullException(nameof(accountHolder.TimeZone), "Property is required for class AccountHolder.");

            if (accountHolder._VerificationDeadlinesOption.IsSet && accountHolder.VerificationDeadlines == null)
                throw new ArgumentNullException(nameof(accountHolder.VerificationDeadlines), "Property is required for class AccountHolder.");
