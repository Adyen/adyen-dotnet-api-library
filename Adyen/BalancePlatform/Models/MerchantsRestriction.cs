...
namespace Adyen.BalancePlatform.Models
{
    ...
    /// </summary>
    public partial class MerchantsRestriction : IValidatableObject
    {
        /// <summary>
    ...
    public class MerchantsRestrictionJsonConverter : JsonConverter<MerchantsRestriction>
    {
        ...
        public override MerchantsRestriction Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (!operation.IsSet)
                throw new ArgumentException("Property is required for class MerchantsRestriction.", nameof(operation));

            if (operation.IsSet && operation.Value == null)
                throw new ArgumentNullException(nameof(operation), "Property is not nullable for class MerchantsRestriction.");

            if (value.IsSet && value.Value == null)
                throw new ArgumentNullException(nameof(value), "Property is not nullable for class MerchantsRestriction.");

            return new MerchantsRestriction(operation.Value!, value);
        }
        ...
        public void WriteProperties(Utf8JsonWriter writer, MerchantsRestriction merchantsRestriction, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (merchantsRestriction.Operation == null)
                throw new ArgumentNullException(nameof(merchantsRestriction.Operation), "Property is required for class MerchantsRestriction.");

            if (merchantsRestriction._ValueOption.IsSet && merchantsRestriction.Value == null)
                throw new ArgumentNullException(nameof(merchantsRestriction.Value), "Property is required for class MerchantsRestriction.");
