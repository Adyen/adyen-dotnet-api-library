...
namespace Adyen.BalancePlatform.Models
{
    ...
    /// </summary>
    [JsonConverter(typeof(WalletProviderDeviceScoreJsonConverter))]
    public partial class WalletProviderDeviceScore
    {
        /// <summary>
    ...
    public class WalletProviderDeviceScoreJsonConverter : JsonConverter<WalletProviderDeviceScore>
    {
        ...
        public override WalletProviderDeviceScore Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            var walletProviderDeviceScore = new WalletProviderDeviceScore();
            walletProviderDeviceScore.Operation = operation.Value!;
            if (value.IsSet)
                walletProviderDeviceScore.Value = value.Value;
        ...
        public void WriteProperties(Utf8JsonWriter writer, WalletProviderDeviceScore walletProviderDeviceScore, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (walletProviderDeviceScore._ValueOption.IsSet)
                if (walletProviderDeviceScore._ValueOption.Value != null)
