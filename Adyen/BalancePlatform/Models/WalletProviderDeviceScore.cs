...
namespace Adyen.BalancePlatform.Models
{
    ...
    /// </summary>
    public partial class WalletProviderDeviceScore : IValidatableObject
    {
        /// <summary>
        ...
        [JsonConstructor]
        public WalletProviderDeviceScore(string operation, Option<int?> value = default)
        {
            Operation = operation;
            _ValueOption = value;
            OnCreated();
    ...
    /// <summary>
    /// A Json converter for type <see cref="WalletProviderDeviceScore" />
    /// </summary>
    public class WalletProviderDeviceScoreJsonConverter : JsonConverter<WalletProviderDeviceScore>
    {
        /// <summary>
        /// Deserializes json to <see cref="WalletProviderDeviceScore"/>.
        /// </summary>
        /// <param name="utf8JsonReader"><see cref="Utf8JsonReader"/></param>
        /// <param name="typeToConvert"><see cref="Type"/></param>
        /// <param name="jsonSerializerOptions">The <see cref="JsonSerializerOptions"/>, initialized from <see cref="HostConfiguration"/>.</param>
        /// <returns><see cref="WalletProviderDeviceScore"/></returns>
        /// <exception cref="JsonException"></exception>
        public override WalletProviderDeviceScore Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (!operation.IsSet)
                throw new ArgumentException("Property is required for class WalletProviderDeviceScore.", nameof(operation));

            if (operation.IsSet && operation.Value == null)
                throw new ArgumentNullException(nameof(operation), "Property is not nullable for class WalletProviderDeviceScore.");

            if (value.IsSet && value.Value == null)
                throw new ArgumentNullException(nameof(value), "Property is not nullable for class WalletProviderDeviceScore.");

            return new WalletProviderDeviceScore(operation.Value!, value);
        }

        /// <summary>
        /// Serializes a <see cref="WalletProviderDeviceScore"/>.
        /// </summary>
        /// <param name="writer"><see cref="Utf8JsonWriter"/></param>
        /// <param name="walletProviderDeviceScore"></param>
        /// <param name="jsonSerializerOptions"><see cref="JsonSerializerOptions"/></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, WalletProviderDeviceScore walletProviderDeviceScore, JsonSerializerOptions jsonSerializerOptions)
        {
            
            writer.WriteStartObject();
            
            WriteProperties(writer, walletProviderDeviceScore, jsonSerializerOptions);
        ...
        /// <summary>
        /// Serializes the properties of <see cref="WalletProviderDeviceScore"/>.
        /// </summary>
        /// <param name="writer"><see creft="Utf8JsonWriter"/></param>
        /// <param name="walletProviderDeviceScore"></param>
        /// <param name="jsonSerializerOptions"><see cref="JsonSerializerOptions"/></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, WalletProviderDeviceScore walletProviderDeviceScore, JsonSerializerOptions jsonSerializerOptions)
        {
            /*
            if (walletProviderDeviceScore.Operation == null)
                throw new ArgumentNullException(nameof(walletProviderDeviceScore.Operation), "Property is required for class WalletProviderDeviceScore.");

            */
            
            writer.WriteString("operation", walletProviderDeviceScore.Operation);

            if (walletProviderDeviceScore._ValueOption.IsSet)
                writer.WriteNumber("value", walletProviderDeviceScore._ValueOption.Value!.Value);
        }
    }
}
