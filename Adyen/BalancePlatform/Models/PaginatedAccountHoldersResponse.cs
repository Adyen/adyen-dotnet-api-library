...
namespace Adyen.BalancePlatform.Models
{
    ...
    public class PaginatedAccountHoldersResponseJsonConverter : JsonConverter<PaginatedAccountHoldersResponse>
    {
        ...
        public override PaginatedAccountHoldersResponse Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (accountHolders.IsSet && accountHolders.Value == null)
                throw new ArgumentNullException(nameof(accountHolders), "Property is not nullable for class PaginatedAccountHoldersResponse.");

            if (hasNext.IsSet && hasNext.Value == null)
                throw new ArgumentNullException(nameof(hasNext), "Property is not nullable for class PaginatedAccountHoldersResponse.");

            if (hasPrevious.IsSet && hasPrevious.Value == null)
                throw new ArgumentNullException(nameof(hasPrevious), "Property is not nullable for class PaginatedAccountHoldersResponse.");
        ...
        {
            /*
            if (paginatedAccountHoldersResponse.AccountHolders == null)
                throw new ArgumentNullException(nameof(paginatedAccountHoldersResponse.AccountHolders), "Property is required for class PaginatedAccountHoldersResponse.");
