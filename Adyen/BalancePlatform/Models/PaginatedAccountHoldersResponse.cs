...
namespace Adyen.BalancePlatform.Models
{
    ...
    /// </summary>
    [JsonConverter(typeof(PaginatedAccountHoldersResponseJsonConverter))]
    ...
    public class PaginatedAccountHoldersResponseJsonConverter : JsonConverter<PaginatedAccountHoldersResponse>
    {
        ...
        public override PaginatedAccountHoldersResponse Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            var paginatedAccountHoldersResponse = new PaginatedAccountHoldersResponse();
            if (accountHolders.IsSet)
                paginatedAccountHoldersResponse.AccountHolders = accountHolders.Value!;
            if (hasNext.IsSet)
                paginatedAccountHoldersResponse.HasNext = hasNext.Value!.Value;
            if (hasPrevious.IsSet)
                paginatedAccountHoldersResponse.HasPrevious = hasPrevious.Value!.Value;
