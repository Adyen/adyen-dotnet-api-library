    ...
    public class AuthenticationJsonConverter : JsonConverter<Authentication>
    {
        ...
        public override Authentication Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (email.IsSet && email.Value == null)
                throw new ArgumentNullException(nameof(email), "Property is not nullable for class Authentication.");

            if (password.IsSet && password.Value == null)
                throw new ArgumentNullException(nameof(password), "Property is not nullable for class Authentication.");

            if (phone.IsSet && phone.Value == null)
                throw new ArgumentNullException(nameof(phone), "Property is not nullable for class Authentication.");
        ...
        {
            /*
            if (authentication._EmailOption.IsSet && authentication.Email == null)
                throw new ArgumentNullException(nameof(authentication.Email), "Property is required for class Authentication.");

            if (authentication._PasswordOption.IsSet && authentication.Password == null)
                throw new ArgumentNullException(nameof(authentication.Password), "Property is required for class Authentication.");

            if (authentication._PhoneOption.IsSet && authentication.Phone == null)
                throw new ArgumentNullException(nameof(authentication.Phone), "Property is required for class Authentication.");
