...
namespace Adyen.BalancePlatform.Models
{
    ...
    /// </summary>
    [JsonConverter(typeof(DelegatedAuthenticationDataJsonConverter))]
    ...
    public class DelegatedAuthenticationDataJsonConverter : JsonConverter<DelegatedAuthenticationData>
    {
        ...
        public override DelegatedAuthenticationData Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            var delegatedAuthenticationData = new DelegatedAuthenticationData();
            delegatedAuthenticationData.SdkOutput = sdkOutput.Value!;
