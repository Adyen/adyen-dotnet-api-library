...
namespace Adyen.BalancePlatform.Models
{
    ...
    /// </summary>
    public partial class ApproveAssociationResponse : IValidatableObject
    {
        /// <summary>
    ...
    public class ApproveAssociationResponseJsonConverter : JsonConverter<ApproveAssociationResponse>
    {
        ...
        public override ApproveAssociationResponse Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (scaAssociations.IsSet && scaAssociations.Value == null)
                throw new ArgumentNullException(nameof(scaAssociations), "Property is not nullable for class ApproveAssociationResponse.");
        ...
        {
            /*
            if (approveAssociationResponse.ScaAssociations == null)
                throw new ArgumentNullException(nameof(approveAssociationResponse.ScaAssociations), "Property is required for class ApproveAssociationResponse.");
