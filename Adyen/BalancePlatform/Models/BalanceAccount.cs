    ...
    public class BalanceAccountJsonConverter : JsonConverter<BalanceAccount>
    {
        ...
        public override BalanceAccount Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (accountHolderId.IsSet && accountHolderId.Value == null)
                throw new ArgumentNullException(nameof(accountHolderId), "Property is not nullable for class BalanceAccount.");

            if (id.IsSet && id.Value == null)
                throw new ArgumentNullException(nameof(id), "Property is not nullable for class BalanceAccount.");

            if (balances.IsSet && balances.Value == null)
                throw new ArgumentNullException(nameof(balances), "Property is not nullable for class BalanceAccount.");

            if (defaultCurrencyCode.IsSet && defaultCurrencyCode.Value == null)
                throw new ArgumentNullException(nameof(defaultCurrencyCode), "Property is not nullable for class BalanceAccount.");

            if (description.IsSet && description.Value == null)
                throw new ArgumentNullException(nameof(description), "Property is not nullable for class BalanceAccount.");

            if (metadata.IsSet && metadata.Value == null)
                throw new ArgumentNullException(nameof(metadata), "Property is not nullable for class BalanceAccount.");

            if (migratedAccountCode.IsSet && migratedAccountCode.Value == null)
                throw new ArgumentNullException(nameof(migratedAccountCode), "Property is not nullable for class BalanceAccount.");

            if (platformPaymentConfiguration.IsSet && platformPaymentConfiguration.Value == null)
                throw new ArgumentNullException(nameof(platformPaymentConfiguration), "Property is not nullable for class BalanceAccount.");

            if (reference.IsSet && reference.Value == null)
                throw new ArgumentNullException(nameof(reference), "Property is not nullable for class BalanceAccount.");

            if (status.IsSet && status.Value == null)
                throw new ArgumentNullException(nameof(status), "Property is not nullable for class BalanceAccount.");

            if (timeZone.IsSet && timeZone.Value == null)
                throw new ArgumentNullException(nameof(timeZone), "Property is not nullable for class BalanceAccount.");
        ...
        public void WriteProperties(Utf8JsonWriter writer, BalanceAccount balanceAccount, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (balanceAccount.AccountHolderId == null)
                throw new ArgumentNullException(nameof(balanceAccount.AccountHolderId), "Property is required for class BalanceAccount.");

            if (balanceAccount.Id == null)
                throw new ArgumentNullException(nameof(balanceAccount.Id), "Property is required for class BalanceAccount.");

            if (balanceAccount._BalancesOption.IsSet && balanceAccount.Balances == null)
                throw new ArgumentNullException(nameof(balanceAccount.Balances), "Property is required for class BalanceAccount.");

            if (balanceAccount._DefaultCurrencyCodeOption.IsSet && balanceAccount.DefaultCurrencyCode == null)
                throw new ArgumentNullException(nameof(balanceAccount.DefaultCurrencyCode), "Property is required for class BalanceAccount.");

            if (balanceAccount._DescriptionOption.IsSet && balanceAccount.Description == null)
                throw new ArgumentNullException(nameof(balanceAccount.Description), "Property is required for class BalanceAccount.");

            if (balanceAccount._MetadataOption.IsSet && balanceAccount.Metadata == null)
                throw new ArgumentNullException(nameof(balanceAccount.Metadata), "Property is required for class BalanceAccount.");

            if (balanceAccount._MigratedAccountCodeOption.IsSet && balanceAccount.MigratedAccountCode == null)
                throw new ArgumentNullException(nameof(balanceAccount.MigratedAccountCode), "Property is required for class BalanceAccount.");

            if (balanceAccount._PlatformPaymentConfigurationOption.IsSet && balanceAccount.PlatformPaymentConfiguration == null)
                throw new ArgumentNullException(nameof(balanceAccount.PlatformPaymentConfiguration), "Property is required for class BalanceAccount.");

            if (balanceAccount._ReferenceOption.IsSet && balanceAccount.Reference == null)
                throw new ArgumentNullException(nameof(balanceAccount.Reference), "Property is required for class BalanceAccount.");

            if (balanceAccount._TimeZoneOption.IsSet && balanceAccount.TimeZone == null)
                throw new ArgumentNullException(nameof(balanceAccount.TimeZone), "Property is required for class BalanceAccount.");
