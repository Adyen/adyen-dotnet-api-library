    ...
    public class RemoveAssociationRequestJsonConverter : JsonConverter<RemoveAssociationRequest>
    {
        ...
        public override RemoveAssociationRequest Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (entityId.IsSet && entityId.Value == null)
                throw new ArgumentNullException(nameof(entityId), "Property is not nullable for class RemoveAssociationRequest.");

            if (entityType.IsSet && entityType.Value == null)
                throw new ArgumentNullException(nameof(entityType), "Property is not nullable for class RemoveAssociationRequest.");

            if (scaDeviceIds.IsSet && scaDeviceIds.Value == null)
                throw new ArgumentNullException(nameof(scaDeviceIds), "Property is not nullable for class RemoveAssociationRequest.");
        ...
        public void WriteProperties(Utf8JsonWriter writer, RemoveAssociationRequest removeAssociationRequest, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (removeAssociationRequest.EntityId == null)
                throw new ArgumentNullException(nameof(removeAssociationRequest.EntityId), "Property is required for class RemoveAssociationRequest.");

            if (removeAssociationRequest.ScaDeviceIds == null)
                throw new ArgumentNullException(nameof(removeAssociationRequest.ScaDeviceIds), "Property is required for class RemoveAssociationRequest.");
