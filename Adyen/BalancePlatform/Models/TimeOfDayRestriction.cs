...
namespace Adyen.BalancePlatform.Models
{
    ...
    /// </summary>
    [JsonConverter(typeof(TimeOfDayRestrictionJsonConverter))]
    public partial class TimeOfDayRestriction
    {
        /// <summary>
    ...
    public class TimeOfDayRestrictionJsonConverter : JsonConverter<TimeOfDayRestriction>
    {
        ...
        public override TimeOfDayRestriction Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            var timeOfDayRestriction = new TimeOfDayRestriction();
            timeOfDayRestriction.Operation = operation.Value!;
            if (value.IsSet)
                timeOfDayRestriction.Value = value.Value;
