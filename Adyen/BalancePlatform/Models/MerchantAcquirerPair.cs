...
namespace Adyen.BalancePlatform.Models
{
    ...
    /// </summary>
    public partial class MerchantAcquirerPair : IValidatableObject
    {
        /// <summary>
    ...
    public class MerchantAcquirerPairJsonConverter : JsonConverter<MerchantAcquirerPair>
    {
        ...
        public override MerchantAcquirerPair Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (acquirerId.IsSet && acquirerId.Value == null)
                throw new ArgumentNullException(nameof(acquirerId), "Property is not nullable for class MerchantAcquirerPair.");

            if (merchantId.IsSet && merchantId.Value == null)
                throw new ArgumentNullException(nameof(merchantId), "Property is not nullable for class MerchantAcquirerPair.");

            return new MerchantAcquirerPair(acquirerId, merchantId);
        }
        ...
        {
            /*
            if (merchantAcquirerPair._AcquirerIdOption.IsSet && merchantAcquirerPair.AcquirerId == null)
                throw new ArgumentNullException(nameof(merchantAcquirerPair.AcquirerId), "Property is required for class MerchantAcquirerPair.");

            if (merchantAcquirerPair._MerchantIdOption.IsSet && merchantAcquirerPair.MerchantId == null)
                throw new ArgumentNullException(nameof(merchantAcquirerPair.MerchantId), "Property is required for class MerchantAcquirerPair.");
