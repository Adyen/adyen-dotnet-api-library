...
namespace Adyen.BalancePlatform.Models
{
    ...
    /// ScaInformation.
    /// </summary>
    public partial class ScaInformation : IValidatableObject
    {
        /// <summary>
    ...
    public class ScaInformationJsonConverter : JsonConverter<ScaInformation>
    {
        ...
        public override ScaInformation Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (status.IsSet && status.Value == null)
                throw new ArgumentNullException(nameof(status), "Property is not nullable for class ScaInformation.");

            if (exemption.IsSet && exemption.Value == null)
                throw new ArgumentNullException(nameof(exemption), "Property is not nullable for class ScaInformation.");
