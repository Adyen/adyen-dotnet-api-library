...
namespace Adyen.BalancePlatform.Models
{
    ...
    /// </summary>
    public partial class ApproveTransferLimitRequest : IValidatableObject
    {
        /// <summary>
    ...
    public class ApproveTransferLimitRequestJsonConverter : JsonConverter<ApproveTransferLimitRequest>
    {
        ...
        public override ApproveTransferLimitRequest Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (transferLimitIds.IsSet && transferLimitIds.Value == null)
                throw new ArgumentNullException(nameof(transferLimitIds), "Property is not nullable for class ApproveTransferLimitRequest.");
        ...
        {
            /*
            if (approveTransferLimitRequest.TransferLimitIds == null)
                throw new ArgumentNullException(nameof(approveTransferLimitRequest.TransferLimitIds), "Property is required for class ApproveTransferLimitRequest.");
