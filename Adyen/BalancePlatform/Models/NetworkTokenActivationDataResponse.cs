...
namespace Adyen.BalancePlatform.Models
{
    ...
    /// </summary>
    public partial class NetworkTokenActivationDataResponse : IValidatableObject
    {
        /// <summary>
    ...
    public class NetworkTokenActivationDataResponseJsonConverter : JsonConverter<NetworkTokenActivationDataResponse>
    {
        ...
        public override NetworkTokenActivationDataResponse Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (sdkInput.IsSet && sdkInput.Value == null)
                throw new ArgumentNullException(nameof(sdkInput), "Property is not nullable for class NetworkTokenActivationDataResponse.");
        ...
        {
            /*
            if (networkTokenActivationDataResponse._SdkInputOption.IsSet && networkTokenActivationDataResponse.SdkInput == null)
                throw new ArgumentNullException(nameof(networkTokenActivationDataResponse.SdkInput), "Property is required for class NetworkTokenActivationDataResponse.");
