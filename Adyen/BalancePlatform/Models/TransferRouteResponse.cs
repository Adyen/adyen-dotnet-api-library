...
namespace Adyen.BalancePlatform.Models
{
    ...
    /// </summary>
    public partial class TransferRouteResponse : IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Used to track the state of TransferRoutes
        /// </summary>
        [JsonIgnore]
        [global::System.ComponentModel.EditorBrowsable(global::System.ComponentModel.EditorBrowsableState.Never)]
        public Option<List<TransferRoute>?> _TransferRoutesOption { get; private set; }
        ...
        [JsonPropertyName("transferRoutes")]
        public List<TransferRoute>? TransferRoutes { get { return this._TransferRoutesOption; } set { this._TransferRoutesOption = new(value); } }
    ...
    /// <summary>
    /// A Json converter for type <see cref="TransferRouteResponse" />
    /// </summary>
    public class TransferRouteResponseJsonConverter : JsonConverter<TransferRouteResponse>
    {
        /// <summary>
        /// Deserializes json to <see cref="TransferRouteResponse"/>.
        /// </summary>
        ...
        public override TransferRouteResponse Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            Option<List<TransferRoute>?> transferRoutes = default;
            ...
            while (utf8JsonReader.Read())
            {
                ...
                if (utf8JsonReader.TokenType == JsonTokenType.PropertyName && currentDepth == utf8JsonReader.CurrentDepth - 1)
                {
                    ...
                    {
                        case "transferRoutes":
                            transferRoutes = new Option<List<TransferRoute>?>(JsonSerializer.Deserialize<List<TransferRoute>>(ref utf8JsonReader, jsonSerializerOptions)!);
                            break;
                        default:
                            break;
                    }
            ...
            if (transferRoutes.IsSet && transferRoutes.Value == null)
                throw new ArgumentNullException(nameof(transferRoutes), "Property is not nullable for class TransferRouteResponse.");

            return new TransferRouteResponse(transferRoutes);
        }

        /// <summary>
        /// Serializes a <see cref="TransferRouteResponse"/>.
        /// </summary>
        /// <param name="writer"><see cref="Utf8JsonWriter"/></param>
        /// <param name="transferRouteResponse"></param>
        /// <param name="jsonSerializerOptions"><see cref="JsonSerializerOptions"/></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, TransferRouteResponse transferRouteResponse, JsonSerializerOptions jsonSerializerOptions)
        {
        ...
        /// <summary>
        /// Serializes the properties of <see cref="TransferRouteResponse"/>.
        /// </summary>
        /// <param name="writer"><see creft="Utf8JsonWriter"/></param>
        /// <param name="transferRouteResponse"></param>
        /// <param name="jsonSerializerOptions"><see cref="JsonSerializerOptions"/></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, TransferRouteResponse transferRouteResponse, JsonSerializerOptions jsonSerializerOptions)
        {
            /*
            if (transferRouteResponse._TransferRoutesOption.IsSet && transferRouteResponse.TransferRoutes == null)
                throw new ArgumentNullException(nameof(transferRouteResponse.TransferRoutes), "Property is required for class TransferRouteResponse.");

            */
            
            if (transferRouteResponse._TransferRoutesOption.IsSet)
            {
                writer.WritePropertyName("transferRoutes");
                JsonSerializer.Serialize(writer, transferRouteResponse.TransferRoutes, jsonSerializerOptions);
            }
        }
    }
}
