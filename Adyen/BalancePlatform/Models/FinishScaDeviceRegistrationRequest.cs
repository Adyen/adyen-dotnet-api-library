...
namespace Adyen.BalancePlatform.Models
{
    ...
    /// </summary>
    public partial class FinishScaDeviceRegistrationRequest : IValidatableObject
    {
        /// <summary>
    ...
    /// <summary>
    /// A Json converter for type <see cref="FinishScaDeviceRegistrationRequest" />
    /// </summary>
    public class FinishScaDeviceRegistrationRequestJsonConverter : JsonConverter<FinishScaDeviceRegistrationRequest>
    {
        /// <summary>
        /// Deserializes json to <see cref="FinishScaDeviceRegistrationRequest"/>.
        /// </summary>
        /// <param name="utf8JsonReader"><see cref="Utf8JsonReader"/></param>
        /// <param name="typeToConvert"><see cref="Type"/></param>
        /// <param name="jsonSerializerOptions">The <see cref="JsonSerializerOptions"/>, initialized from <see cref="HostConfiguration"/>.</param>
        /// <returns><see cref="FinishScaDeviceRegistrationRequest"/></returns>
        /// <exception cref="JsonException"></exception>
        public override FinishScaDeviceRegistrationRequest Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (sdkOutput.IsSet && sdkOutput.Value == null)
                throw new ArgumentNullException(nameof(sdkOutput), "Property is not nullable for class FinishScaDeviceRegistrationRequest.");

            return new FinishScaDeviceRegistrationRequest(sdkOutput.Value!);
        }

        /// <summary>
        /// Serializes a <see cref="FinishScaDeviceRegistrationRequest"/>.
        /// </summary>
        ...
        public override void Write(Utf8JsonWriter writer, FinishScaDeviceRegistrationRequest finishScaDeviceRegistrationRequest, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            WriteProperties(writer, finishScaDeviceRegistrationRequest, jsonSerializerOptions);
        ...
        /// <summary>
        /// Serializes the properties of <see cref="FinishScaDeviceRegistrationRequest"/>.
        /// </summary>
        ...
        {
            /*
            if (finishScaDeviceRegistrationRequest.SdkOutput == null)
                throw new ArgumentNullException(nameof(finishScaDeviceRegistrationRequest.SdkOutput), "Property is required for class FinishScaDeviceRegistrationRequest.");

            */
            
            writer.WriteString("sdkOutput", finishScaDeviceRegistrationRequest.SdkOutput);
        }
    }
}
