...
namespace Adyen.BalancePlatform.Models
{
    ...
    /// TransactionRuleInfo.
    /// </summary>
    public partial class TransactionRuleInfo : IValidatableObject
    {
        /// <summary>
        ...
        [JsonConstructor]
        public TransactionRuleInfo(string description, TransactionRuleEntityKey entityKey, TransactionRuleInterval interval, string reference, TransactionRuleRestrictions ruleRestrictions, TypeEnum type, Option<string?> aggregationLevel = default, Option<string?> endDate = default, Option<OutcomeTypeEnum?> outcomeType = default, Option<RequestTypeEnum?> requestType = default, Option<int?> score = default, Option<string?> startDate = default, Option<StatusEnum?> status = default)
        {
        ...
        /// <summary>
        /// Used to track whether OutcomeType is set or not.
        /// </summary>
        [JsonIgnore]
        ...
        /// <summary>
        /// Used to track whether RequestType is set or not.
        /// </summary>
        [JsonIgnore]
        [global::System.ComponentModel.EditorBrowsable(global::System.ComponentModel.EditorBrowsableState.Never)]
    ...
    public class TransactionRuleInfoJsonConverter : JsonConverter<TransactionRuleInfo>
    {
        ...
        public override TransactionRuleInfo Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (description.IsSet && description.Value == null)
                throw new ArgumentNullException(nameof(description), "Property is not nullable for class TransactionRuleInfo.");

            if (entityKey.IsSet && entityKey.Value == null)
                throw new ArgumentNullException(nameof(entityKey), "Property is not nullable for class TransactionRuleInfo.");

            if (interval.IsSet && interval.Value == null)
                throw new ArgumentNullException(nameof(interval), "Property is not nullable for class TransactionRuleInfo.");

            if (reference.IsSet && reference.Value == null)
                throw new ArgumentNullException(nameof(reference), "Property is not nullable for class TransactionRuleInfo.");

            if (ruleRestrictions.IsSet && ruleRestrictions.Value == null)
                throw new ArgumentNullException(nameof(ruleRestrictions), "Property is not nullable for class TransactionRuleInfo.");

            if (type.IsSet && type.Value == null)
                throw new ArgumentNullException(nameof(type), "Property is not nullable for class TransactionRuleInfo.");

            if (aggregationLevel.IsSet && aggregationLevel.Value == null)
                throw new ArgumentNullException(nameof(aggregationLevel), "Property is not nullable for class TransactionRuleInfo.");

            if (endDate.IsSet && endDate.Value == null)
                throw new ArgumentNullException(nameof(endDate), "Property is not nullable for class TransactionRuleInfo.");

            if (outcomeType.IsSet && outcomeType.Value == null)
                throw new ArgumentNullException(nameof(outcomeType), "Property is not nullable for class TransactionRuleInfo.");

            if (requestType.IsSet && requestType.Value == null)
                throw new ArgumentNullException(nameof(requestType), "Property is not nullable for class TransactionRuleInfo.");

            if (score.IsSet && score.Value == null)
                throw new ArgumentNullException(nameof(score), "Property is not nullable for class TransactionRuleInfo.");

            if (startDate.IsSet && startDate.Value == null)
                throw new ArgumentNullException(nameof(startDate), "Property is not nullable for class TransactionRuleInfo.");

            if (status.IsSet && status.Value == null)
                throw new ArgumentNullException(nameof(status), "Property is not nullable for class TransactionRuleInfo.");

            return new TransactionRuleInfo(description.Value!, entityKey.Value!, interval.Value!, reference.Value!, ruleRestrictions.Value!, type.Value!.Value!, aggregationLevel, endDate, outcomeType, requestType, score, startDate, status);
        }
        ...
        public void WriteProperties(Utf8JsonWriter writer, TransactionRuleInfo transactionRuleInfo, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (transactionRuleInfo.Description == null)
                throw new ArgumentNullException(nameof(transactionRuleInfo.Description), "Property is required for class TransactionRuleInfo.");

            if (transactionRuleInfo.EntityKey == null)
                throw new ArgumentNullException(nameof(transactionRuleInfo.EntityKey), "Property is required for class TransactionRuleInfo.");

            if (transactionRuleInfo.Interval == null)
                throw new ArgumentNullException(nameof(transactionRuleInfo.Interval), "Property is required for class TransactionRuleInfo.");

            if (transactionRuleInfo.Reference == null)
                throw new ArgumentNullException(nameof(transactionRuleInfo.Reference), "Property is required for class TransactionRuleInfo.");

            if (transactionRuleInfo.RuleRestrictions == null)
                throw new ArgumentNullException(nameof(transactionRuleInfo.RuleRestrictions), "Property is required for class TransactionRuleInfo.");

            if (transactionRuleInfo._AggregationLevelOption.IsSet && transactionRuleInfo.AggregationLevel == null)
                throw new ArgumentNullException(nameof(transactionRuleInfo.AggregationLevel), "Property is required for class TransactionRuleInfo.");

            if (transactionRuleInfo._EndDateOption.IsSet && transactionRuleInfo.EndDate == null)
                throw new ArgumentNullException(nameof(transactionRuleInfo.EndDate), "Property is required for class TransactionRuleInfo.");

            if (transactionRuleInfo._StartDateOption.IsSet && transactionRuleInfo.StartDate == null)
                throw new ArgumentNullException(nameof(transactionRuleInfo.StartDate), "Property is required for class TransactionRuleInfo.");
