    ...
    public class BankAccountJsonConverter : JsonConverter<BankAccount>
    {
        ...
        public override BankAccount Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (accountIdentification.IsSet && accountIdentification.Value == null)
                throw new ArgumentNullException(nameof(accountIdentification), "Property is not nullable for class BankAccount.");
        ...
        {
            /*
            if (bankAccount.AccountIdentification == null)
                throw new ArgumentNullException(nameof(bankAccount.AccountIdentification), "Property is required for class BankAccount.");
