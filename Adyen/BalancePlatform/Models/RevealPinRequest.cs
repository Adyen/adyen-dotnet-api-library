...
namespace Adyen.BalancePlatform.Models
{
    ...
    /// RevealPinRequest.
    /// </summary>
    public partial class RevealPinRequest : IValidatableObject
    {
        /// <summary>
        ...
        [JsonConstructor]
        public RevealPinRequest(string encryptedKey, string paymentInstrumentId)
        {
    ...
    /// <summary>
    /// A Json converter for type <see cref="RevealPinRequest" />
    /// </summary>
    public class RevealPinRequestJsonConverter : JsonConverter<RevealPinRequest>
    {
        /// <summary>
        /// Deserializes json to <see cref="RevealPinRequest"/>.
        /// </summary>
        /// <param name="utf8JsonReader"><see cref="Utf8JsonReader"/></param>
        /// <param name="typeToConvert"><see cref="Type"/></param>
        /// <param name="jsonSerializerOptions">The <see cref="JsonSerializerOptions"/>, initialized from <see cref="HostConfiguration"/>.</param>
        /// <returns><see cref="RevealPinRequest"/></returns>
        /// <exception cref="JsonException"></exception>
        public override RevealPinRequest Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (encryptedKey.IsSet && encryptedKey.Value == null)
                throw new ArgumentNullException(nameof(encryptedKey), "Property is not nullable for class RevealPinRequest.");

            if (paymentInstrumentId.IsSet && paymentInstrumentId.Value == null)
                throw new ArgumentNullException(nameof(paymentInstrumentId), "Property is not nullable for class RevealPinRequest.");

            return new RevealPinRequest(encryptedKey.Value!, paymentInstrumentId.Value!);
        }

        /// <summary>
        /// Serializes a <see cref="RevealPinRequest"/>.
        /// </summary>
        /// <param name="writer"><see cref="Utf8JsonWriter"/></param>
        /// <param name="revealPinRequest"></param>
        /// <param name="jsonSerializerOptions"><see cref="JsonSerializerOptions"/></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, RevealPinRequest revealPinRequest, JsonSerializerOptions jsonSerializerOptions)
        {
        ...
        /// <summary>
        /// Serializes the properties of <see cref="RevealPinRequest"/>.
        /// </summary>
        /// <param name="writer"><see creft="Utf8JsonWriter"/></param>
        /// <param name="revealPinRequest"></param>
        /// <param name="jsonSerializerOptions"><see cref="JsonSerializerOptions"/></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, RevealPinRequest revealPinRequest, JsonSerializerOptions jsonSerializerOptions)
        {
            /*
            if (revealPinRequest.EncryptedKey == null)
                throw new ArgumentNullException(nameof(revealPinRequest.EncryptedKey), "Property is required for class RevealPinRequest.");

            if (revealPinRequest.PaymentInstrumentId == null)
                throw new ArgumentNullException(nameof(revealPinRequest.PaymentInstrumentId), "Property is required for class RevealPinRequest.");

            */
            
            writer.WriteString("encryptedKey", revealPinRequest.EncryptedKey);

            writer.WriteString("paymentInstrumentId", revealPinRequest.PaymentInstrumentId);
        }
    }
}
