...
namespace Adyen.BalancePlatform.Models
{
    ...
    /// RevealPinRequest.
    /// </summary>
    [JsonConverter(typeof(RevealPinRequestJsonConverter))]
    public partial class RevealPinRequest
    {
        /// <summary>
    ...
    public class RevealPinRequestJsonConverter : JsonConverter<RevealPinRequest>
    {
        ...
        public override RevealPinRequest Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (encryptedKey.IsSet)
                revealPinRequest.EncryptedKey = encryptedKey.Value!;
            if (paymentInstrumentId.IsSet)
                revealPinRequest.PaymentInstrumentId = paymentInstrumentId.Value!;
            return revealPinRequest;
        }
