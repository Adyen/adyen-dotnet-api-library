    ...
    public class BalanceAccountInfoJsonConverter : JsonConverter<BalanceAccountInfo>
    {
        ...
        public override BalanceAccountInfo Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (description.IsSet)
                balanceAccountInfo.Description = description.Value;
            if (metadata.IsSet)
                balanceAccountInfo.Metadata = metadata.Value;
            if (migratedAccountCode.IsSet)
                balanceAccountInfo.MigratedAccountCode = migratedAccountCode.Value;
            if (platformPaymentConfiguration.IsSet)
                balanceAccountInfo.PlatformPaymentConfiguration = platformPaymentConfiguration.Value;
            if (reference.IsSet)
                balanceAccountInfo.Reference = reference.Value;
            if (timeZone.IsSet)
                balanceAccountInfo.TimeZone = timeZone.Value;
