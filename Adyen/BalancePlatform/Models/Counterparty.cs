    ...
    public class CounterpartyJsonConverter : JsonConverter<Counterparty>
    {
        ...
        public override Counterparty Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (bankAccount.IsSet && bankAccount.Value == null)
                throw new ArgumentNullException(nameof(bankAccount), "Property is not nullable for class Counterparty.");

            if (transferInstrumentId.IsSet && transferInstrumentId.Value == null)
                throw new ArgumentNullException(nameof(transferInstrumentId), "Property is not nullable for class Counterparty.");
        ...
        {
            /*
            if (counterparty._BankAccountOption.IsSet && counterparty.BankAccount == null)
                throw new ArgumentNullException(nameof(counterparty.BankAccount), "Property is required for class Counterparty.");

            if (counterparty._TransferInstrumentIdOption.IsSet && counterparty.TransferInstrumentId == null)
                throw new ArgumentNullException(nameof(counterparty.TransferInstrumentId), "Property is required for class Counterparty.");
