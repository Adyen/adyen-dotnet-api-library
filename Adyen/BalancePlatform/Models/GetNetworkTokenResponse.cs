...
namespace Adyen.BalancePlatform.Models
{
    ...
    /// </summary>
    public partial class GetNetworkTokenResponse : IValidatableObject
    {
        /// <summary>
    ...
    /// <summary>
    /// A Json converter for type <see cref="GetNetworkTokenResponse" />
    /// </summary>
    public class GetNetworkTokenResponseJsonConverter : JsonConverter<GetNetworkTokenResponse>
    {
        /// <summary>
        /// Deserializes json to <see cref="GetNetworkTokenResponse"/>.
        /// </summary>
        ...
        public override GetNetworkTokenResponse Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            Option<NetworkToken?> token = default;
            ...
            while (utf8JsonReader.Read())
            {
                ...
                if (utf8JsonReader.TokenType == JsonTokenType.PropertyName && currentDepth == utf8JsonReader.CurrentDepth - 1)
                {
                    ...
                    {
                        case "token":
                            token = new Option<NetworkToken?>(JsonSerializer.Deserialize<NetworkToken>(ref utf8JsonReader, jsonSerializerOptions)!);
                            break;
                        default:
                            break;
                    }
            ...
            if (token.IsSet && token.Value == null)
                throw new ArgumentNullException(nameof(token), "Property is not nullable for class GetNetworkTokenResponse.");

            return new GetNetworkTokenResponse(token.Value!);
        }

        /// <summary>
        /// Serializes a <see cref="GetNetworkTokenResponse"/>.
        /// </summary>
        ...
        public override void Write(Utf8JsonWriter writer, GetNetworkTokenResponse getNetworkTokenResponse, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            WriteProperties(writer, getNetworkTokenResponse, jsonSerializerOptions);
        ...
        /// <summary>
        /// Serializes the properties of <see cref="GetNetworkTokenResponse"/>.
        /// </summary>
        ...
        {
            /*
            if (getNetworkTokenResponse.Token == null)
                throw new ArgumentNullException(nameof(getNetworkTokenResponse.Token), "Property is required for class GetNetworkTokenResponse.");

            */
            
            writer.WritePropertyName("token");
            JsonSerializer.Serialize(writer, getNetworkTokenResponse.Token, jsonSerializerOptions);
        }
    }
}
