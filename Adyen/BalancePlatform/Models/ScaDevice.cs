...
namespace Adyen.BalancePlatform.Models
{
    ...
    /// </summary>
    [JsonConverter(typeof(ScaDeviceJsonConverter))]
    ...
    public class ScaDeviceJsonConverter : JsonConverter<ScaDevice>
    {
                ...
                if (utf8JsonReader.TokenType == JsonTokenType.PropertyName && currentDepth == utf8JsonReader.CurrentDepth - 1)
                {
                    ...
                    switch (jsonPropertyName)
                    {
                        ...
                        case "type":
                            ...
                            type = new Option<ScaDeviceType?>(ScaDeviceType.FromStringOrDefault(typeRawValue) ?? (ScaDeviceType)typeRawValue);
                            break;
                        default:
                            break;
                    }
        ...
        public void WriteProperties(Utf8JsonWriter writer, ScaDevice scaDevice, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            var typeRawValue = ScaDeviceType.ToJsonValue(scaDevice.Type);
