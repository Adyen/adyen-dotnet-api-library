...
namespace Adyen.BalancePlatform.Models
{
    ...
    /// GetTaxFormResponse.
    /// </summary>
    public partial class GetTaxFormResponse : IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Used to track whether ContentType is set or not.
        /// </summary>
        [JsonIgnore]
    ...
    public class GetTaxFormResponseJsonConverter : JsonConverter<GetTaxFormResponse>
    {
        ...
        public override GetTaxFormResponse Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (content.IsSet && content.Value == null)
                throw new ArgumentNullException(nameof(content), "Property is not nullable for class GetTaxFormResponse.");

            if (contentType.IsSet && contentType.Value == null)
                throw new ArgumentNullException(nameof(contentType), "Property is not nullable for class GetTaxFormResponse.");
        ...
        {
            /*
            if (getTaxFormResponse.Content == null)
                throw new ArgumentNullException(nameof(getTaxFormResponse.Content), "Property is required for class GetTaxFormResponse.");
