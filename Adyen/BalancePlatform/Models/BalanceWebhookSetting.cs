    ...
    public class BalanceWebhookSettingJsonConverter : JsonConverter<BalanceWebhookSetting>
    {
        ...
        public override BalanceWebhookSetting Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (currency.IsSet && currency.Value == null)
                throw new ArgumentNullException(nameof(currency), "Property is not nullable for class BalanceWebhookSetting.");

            if (id.IsSet && id.Value == null)
                throw new ArgumentNullException(nameof(id), "Property is not nullable for class BalanceWebhookSetting.");

            if (status.IsSet && status.Value == null)
                throw new ArgumentNullException(nameof(status), "Property is not nullable for class BalanceWebhookSetting.");

            if (target.IsSet && target.Value == null)
                throw new ArgumentNullException(nameof(target), "Property is not nullable for class BalanceWebhookSetting.");

            if (type.IsSet && type.Value == null)
                throw new ArgumentNullException(nameof(type), "Property is not nullable for class BalanceWebhookSetting.");

            if (conditions.IsSet && conditions.Value == null)
                throw new ArgumentNullException(nameof(conditions), "Property is not nullable for class BalanceWebhookSetting.");
        ...
        public void WriteProperties(Utf8JsonWriter writer, BalanceWebhookSetting balanceWebhookSetting, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (balanceWebhookSetting.Currency == null)
                throw new ArgumentNullException(nameof(balanceWebhookSetting.Currency), "Property is required for class BalanceWebhookSetting.");

            if (balanceWebhookSetting.Id == null)
                throw new ArgumentNullException(nameof(balanceWebhookSetting.Id), "Property is required for class BalanceWebhookSetting.");

            if (balanceWebhookSetting.Status == null)
                throw new ArgumentNullException(nameof(balanceWebhookSetting.Status), "Property is required for class BalanceWebhookSetting.");

            if (balanceWebhookSetting.Target == null)
                throw new ArgumentNullException(nameof(balanceWebhookSetting.Target), "Property is required for class BalanceWebhookSetting.");

            if (balanceWebhookSetting._ConditionsOption.IsSet && balanceWebhookSetting.Conditions == null)
                throw new ArgumentNullException(nameof(balanceWebhookSetting.Conditions), "Property is required for class BalanceWebhookSetting.");
