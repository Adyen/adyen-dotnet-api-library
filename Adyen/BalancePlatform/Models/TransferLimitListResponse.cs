...
namespace Adyen.BalancePlatform.Models
{
    ...
    /// </summary>
    public partial class TransferLimitListResponse : IValidatableObject
    {
        /// <summary>
    ...
    public class TransferLimitListResponseJsonConverter : JsonConverter<TransferLimitListResponse>
    {
        ...
        public override TransferLimitListResponse Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (transferLimits.IsSet && transferLimits.Value == null)
                throw new ArgumentNullException(nameof(transferLimits), "Property is not nullable for class TransferLimitListResponse.");

            return new TransferLimitListResponse(transferLimits.Value!);
        }
        ...
        {
            /*
            if (transferLimitListResponse.TransferLimits == null)
                throw new ArgumentNullException(nameof(transferLimitListResponse.TransferLimits), "Property is required for class TransferLimitListResponse.");
