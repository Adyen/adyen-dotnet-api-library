...
namespace Adyen.BalancePlatform.Models
{
    ...
    /// </summary>
    [JsonConverter(typeof(MatchingTransactionsRestrictionJsonConverter))]
    public partial class MatchingTransactionsRestriction
    {
        /// <summary>
    ...
    public class MatchingTransactionsRestrictionJsonConverter : JsonConverter<MatchingTransactionsRestriction>
    {
        ...
        public override MatchingTransactionsRestriction Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            var matchingTransactionsRestriction = new MatchingTransactionsRestriction();
            matchingTransactionsRestriction.Operation = operation.Value!;
            if (value.IsSet)
                matchingTransactionsRestriction.Value = value.Value;
            return matchingTransactionsRestriction;
        }
        ...
        public void WriteProperties(Utf8JsonWriter writer, MatchingTransactionsRestriction matchingTransactionsRestriction, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (matchingTransactionsRestriction._ValueOption.IsSet)
                if (matchingTransactionsRestriction._ValueOption.Value != null)
