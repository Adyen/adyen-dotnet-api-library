...
namespace Adyen.BalancePlatform.Models
{
    ...
    /// </summary>
    [JsonConverter(typeof(TotalAmountRestrictionJsonConverter))]
    public partial class TotalAmountRestriction
    {
        /// <summary>
    ...
    public class TotalAmountRestrictionJsonConverter : JsonConverter<TotalAmountRestriction>
    {
        ...
        public override TotalAmountRestriction Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            var totalAmountRestriction = new TotalAmountRestriction();
            totalAmountRestriction.Operation = operation.Value!;
            if (value.IsSet)
                totalAmountRestriction.Value = value.Value;
            return totalAmountRestriction;
        }
