...
namespace Adyen.BalancePlatform.Models
{
    ...
    public partial class Summary
    {
        ...
        public override string ToString()
        {
            ...
            sb.Append("  TaxYears: ").Append(TaxYears).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
    }
    ...
    public class SummaryJsonConverter : JsonConverter<Summary>
    {
        ...
        public override Summary Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            Option<List<int>?> taxYears = default;
                ...
                if (utf8JsonReader.TokenType == JsonTokenType.PropertyName && currentDepth == utf8JsonReader.CurrentDepth - 1)
                {
                    ...
                    switch (jsonPropertyName)
                    {
                        case "legalEntityId":
                            ...
                            break;
                        case "taxYears":
                            taxYears = new Option<List<int>?>(JsonSerializer.Deserialize<List<int>>(ref utf8JsonReader, jsonSerializerOptions)!);
                            break;
                        default:
                            break;
                    }
        ...
        public void WriteProperties(Utf8JsonWriter writer, Summary summary, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (summary.LegalEntityId != null)
                writer.WriteString("legalEntityId", summary.LegalEntityId);

            writer.WritePropertyName("taxYears");
            JsonSerializer.Serialize(writer, summary.TaxYears, jsonSerializerOptions);
        }
    }
}
