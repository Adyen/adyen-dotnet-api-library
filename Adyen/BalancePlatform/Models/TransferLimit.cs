    ...
    public class TransferLimitJsonConverter : JsonConverter<TransferLimit>
    {
        ...
        public override TransferLimit Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (amount.IsSet && amount.Value == null)
                throw new ArgumentNullException(nameof(amount), "Property is not nullable for class TransferLimit.");

            if (id.IsSet && id.Value == null)
                throw new ArgumentNullException(nameof(id), "Property is not nullable for class TransferLimit.");

            if (limitStatus.IsSet && limitStatus.Value == null)
                throw new ArgumentNullException(nameof(limitStatus), "Property is not nullable for class TransferLimit.");

            if (scope.IsSet && scope.Value == null)
                throw new ArgumentNullException(nameof(scope), "Property is not nullable for class TransferLimit.");

            if (startsAt.IsSet && startsAt.Value == null)
                throw new ArgumentNullException(nameof(startsAt), "Property is not nullable for class TransferLimit.");

            if (transferType.IsSet && transferType.Value == null)
                throw new ArgumentNullException(nameof(transferType), "Property is not nullable for class TransferLimit.");

            if (endsAt.IsSet && endsAt.Value == null)
                throw new ArgumentNullException(nameof(endsAt), "Property is not nullable for class TransferLimit.");

            if (reference.IsSet && reference.Value == null)
                throw new ArgumentNullException(nameof(reference), "Property is not nullable for class TransferLimit.");

            if (scaInformation.IsSet && scaInformation.Value == null)
                throw new ArgumentNullException(nameof(scaInformation), "Property is not nullable for class TransferLimit.");
        ...
        {
            /*
            if (transferLimit.Amount == null)
                throw new ArgumentNullException(nameof(transferLimit.Amount), "Property is required for class TransferLimit.");

            if (transferLimit.Id == null)
                throw new ArgumentNullException(nameof(transferLimit.Id), "Property is required for class TransferLimit.");

            if (transferLimit._ReferenceOption.IsSet && transferLimit.Reference == null)
                throw new ArgumentNullException(nameof(transferLimit.Reference), "Property is required for class TransferLimit.");

            if (transferLimit._ScaInformationOption.IsSet && transferLimit.ScaInformation == null)
                throw new ArgumentNullException(nameof(transferLimit.ScaInformation), "Property is required for class TransferLimit.");
