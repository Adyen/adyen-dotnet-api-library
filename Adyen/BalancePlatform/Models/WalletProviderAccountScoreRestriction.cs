...
namespace Adyen.BalancePlatform.Models
{
    ...
    /// </summary>
    public partial class WalletProviderAccountScoreRestriction
    {
        /// <summary>
        ...
        /// </summary>
        public WalletProviderAccountScoreRestriction()
        {
        }
    ...
    public class WalletProviderAccountScoreRestrictionJsonConverter : JsonConverter<WalletProviderAccountScoreRestriction>
    {
        ...
        public void WriteProperties(Utf8JsonWriter writer, WalletProviderAccountScoreRestriction walletProviderAccountScoreRestriction, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (walletProviderAccountScoreRestriction._ValueOption.IsSet)
                if (walletProviderAccountScoreRestriction._ValueOption.Value != null)
