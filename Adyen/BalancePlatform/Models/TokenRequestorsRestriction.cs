...
namespace Adyen.BalancePlatform.Models
{
    ...
    /// </summary>
    [JsonConverter(typeof(TokenRequestorsRestrictionJsonConverter))]
    ...
    public class TokenRequestorsRestrictionJsonConverter : JsonConverter<TokenRequestorsRestriction>
    {
        ...
        public override TokenRequestorsRestriction Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            var tokenRequestorsRestriction = new TokenRequestorsRestriction();
            tokenRequestorsRestriction.Operation = operation.Value!;
            if (value.IsSet)
                tokenRequestorsRestriction.Value = value.Value;
            return tokenRequestorsRestriction;
        }
