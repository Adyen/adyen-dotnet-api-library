...
namespace Adyen.BalancePlatform.Models
{
    ...
    /// </summary>
    public partial class TokenRequestorsRestriction : IValidatableObject
    {
        /// <summary>
    ...
    public class TokenRequestorsRestrictionJsonConverter : JsonConverter<TokenRequestorsRestriction>
    {
        ...
        public override TokenRequestorsRestriction Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (operation.IsSet && operation.Value == null)
                throw new ArgumentNullException(nameof(operation), "Property is not nullable for class TokenRequestorsRestriction.");

            if (value.IsSet && value.Value == null)
                throw new ArgumentNullException(nameof(value), "Property is not nullable for class TokenRequestorsRestriction.");
        ...
        public void WriteProperties(Utf8JsonWriter writer, TokenRequestorsRestriction tokenRequestorsRestriction, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (tokenRequestorsRestriction.Operation == null)
                throw new ArgumentNullException(nameof(tokenRequestorsRestriction.Operation), "Property is required for class TokenRequestorsRestriction.");

            if (tokenRequestorsRestriction._ValueOption.IsSet && tokenRequestorsRestriction.Value == null)
                throw new ArgumentNullException(nameof(tokenRequestorsRestriction.Value), "Property is required for class TokenRequestorsRestriction.");
