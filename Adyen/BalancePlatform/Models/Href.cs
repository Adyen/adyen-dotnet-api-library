...
namespace Adyen.BalancePlatform.Models
{
    ...
    /// Href.
    /// </summary>
    public partial class Href : IValidatableObject
    {
        /// <summary>
    ...
    /// <summary>
    /// A Json converter for type <see cref="Href" />
    /// </summary>
    public class HrefJsonConverter : JsonConverter<Href>
    {
        /// <summary>
        /// Deserializes json to <see cref="Href"/>.
        /// </summary>
        /// <param name="utf8JsonReader"><see cref="Utf8JsonReader"/></param>
        /// <param name="typeToConvert"><see cref="Type"/></param>
        /// <param name="jsonSerializerOptions">The <see cref="JsonSerializerOptions"/>, initialized from <see cref="HostConfiguration"/>.</param>
        /// <returns><see cref="Href"/></returns>
        /// <exception cref="JsonException"></exception>
        public override Href Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            while (utf8JsonReader.Read())
            {
                ...
                if (utf8JsonReader.TokenType == JsonTokenType.PropertyName && currentDepth == utf8JsonReader.CurrentDepth - 1)
                {
                    ...
                    {
                        case "href":
                            varHref = new Option<string?>(utf8JsonReader.GetString()!);
                            break;
                        default:
                            break;
                    }
            ...
            if (varHref.IsSet && varHref.Value == null)
                throw new ArgumentNullException(nameof(varHref), "Property is not nullable for class Href.");

            return new Href(varHref);
        }

        /// <summary>
        /// Serializes a <see cref="Href"/>.
        /// </summary>
        /// <param name="writer"><see cref="Utf8JsonWriter"/></param>
        /// <param name="href"></param>
        /// <param name="jsonSerializerOptions"><see cref="JsonSerializerOptions"/></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, Href href, JsonSerializerOptions jsonSerializerOptions)
        {
            
            writer.WriteStartObject();
            
            WriteProperties(writer, href, jsonSerializerOptions);
        ...
        /// <summary>
        /// Serializes the properties of <see cref="Href"/>.
        /// </summary>
        /// <param name="writer"><see creft="Utf8JsonWriter"/></param>
        /// <param name="href"></param>
        /// <param name="jsonSerializerOptions"><see cref="JsonSerializerOptions"/></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, Href href, JsonSerializerOptions jsonSerializerOptions)
        {
            /*
            if (href._VarHrefOption.IsSet && href.VarHref == null)
                throw new ArgumentNullException(nameof(href.VarHref), "Property is required for class Href.");

            */
            
            if (href._VarHrefOption.IsSet)
                writer.WriteString("href", href.VarHref);
        }
    }
}
