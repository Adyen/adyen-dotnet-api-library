...
namespace Adyen.BalancePlatform.Models
{
    ...
    {
        /// <summary>
        /// Deserializes json to <see cref="Target"/>.
        /// </summary>
        /// <param name="utf8JsonReader"><see cref="Utf8JsonReader"/></param>
        /// <param name="typeToConvert"><see cref="Type"/></param>
        /// <param name="jsonSerializerOptions">The <see cref="JsonSerializerOptions"/>, initialized from <see cref="HostConfiguration"/>.</param>
        /// <returns><see cref="Target"/></returns>
        /// <exception cref="JsonException"></exception>
        public override Target Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            Option<Target.TypeEnum?> type = default;
            ...
            if (id.IsSet && id.Value == null)
                throw new ArgumentNullException(nameof(id), "Property is not nullable for class Target.");

            if (type.IsSet && type.Value == null)
                throw new ArgumentNullException(nameof(type), "Property is not nullable for class Target.");

            return new Target(id.Value!, type.Value!.Value!);
        }

        /// <summary>
        /// Serializes a <see cref="Target"/>.
        /// </summary>
        ...
        public override void Write(Utf8JsonWriter writer, Target target, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            WriteProperties(writer, target, jsonSerializerOptions);
        ...
        /// <summary>
        /// Serializes the properties of <see cref="Target"/>.
        /// </summary>
        ...
        public void WriteProperties(Utf8JsonWriter writer, Target target, JsonSerializerOptions jsonSerializerOptions)
        {
            /*
            if (target.Id == null)
                throw new ArgumentNullException(nameof(target.Id), "Property is required for class Target.");
            ...
            */
            ...
            if (target.Type != null) 
            {
                string? typeRawValue = Target.TypeEnum.ToJsonValue(target.Type);
