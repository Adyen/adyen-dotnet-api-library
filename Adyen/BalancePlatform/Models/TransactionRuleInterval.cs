...
namespace Adyen.BalancePlatform.Models
{
    ...
    /// </summary>
    [JsonConverter(typeof(TransactionRuleIntervalJsonConverter))]
    public partial class TransactionRuleInterval
    {
        /// <summary>
        ...
        public class DayOfWeekEnum : IEnum
        {
            ...
            /// <summary>
            /// Compares two <see cref="DayOfWeekEnum"/> instances for equality.
            /// </summary>
            ...
            /// <summary>
            /// Compares two <see cref="DayOfWeekEnum"/> instances for inequality.
            /// </summary>
            public static bool operator !=(DayOfWeekEnum? left, DayOfWeekEnum? right) => !string.Equals(left?.Value, right?.Value, StringComparison.OrdinalIgnoreCase);

            /// <summary>
            /// Returns true if the given object is equal to this <see cref="DayOfWeekEnum"/> instance.
            /// </summary>
            ...
            /// <summary>
            /// Returns a hash code for this <see cref="DayOfWeekEnum"/> instance.
            /// </summary>
            public override int GetHashCode() => Value?.GetHashCode() ?? 0;

            /// <summary>
            /// Returns the string value of the <see cref="DayOfWeekEnum"/> instance.
            /// </summary>
            public override string ToString() => Value ?? string.Empty;
            ...
            {
                /// <summary>
                /// Deserializes a <see cref="DayOfWeekEnum"/> from JSON.
                /// </summary>
                ...
                /// <summary>
                /// Serializes a <see cref="DayOfWeekEnum"/> to JSON.
                /// </summary>
    ...
    public class TransactionRuleIntervalJsonConverter : JsonConverter<TransactionRuleInterval>
    {
        ...
        public override TransactionRuleInterval Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (dayOfWeek.IsSet)
                transactionRuleInterval.DayOfWeek = dayOfWeek.Value;
            if (duration.IsSet)
                transactionRuleInterval.Duration = duration.Value;
            if (timeOfDay.IsSet)
                transactionRuleInterval.TimeOfDay = timeOfDay.Value;
            if (timeZone.IsSet)
                transactionRuleInterval.TimeZone = timeZone.Value;
            return transactionRuleInterval;
        }
        ...
        public void WriteProperties(Utf8JsonWriter writer, TransactionRuleInterval transactionRuleInterval, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (transactionRuleInterval._DayOfMonthOption.IsSet)
                if (transactionRuleInterval._DayOfMonthOption.Value != null)
