...
namespace Adyen.BalancePlatform.Models
{
    ...
    public partial class TransactionRuleInterval : IValidatableObject
    {
        ...
        /// <summary>
        /// Used to track whether DayOfWeek is set or not.
        /// </summary>
        [JsonIgnore]
    ...
    public class TransactionRuleIntervalJsonConverter : JsonConverter<TransactionRuleInterval>
    {
        ...
        public override TransactionRuleInterval Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (type.IsSet && type.Value == null)
                throw new ArgumentNullException(nameof(type), "Property is not nullable for class TransactionRuleInterval.");

            if (dayOfMonth.IsSet && dayOfMonth.Value == null)
                throw new ArgumentNullException(nameof(dayOfMonth), "Property is not nullable for class TransactionRuleInterval.");

            if (dayOfWeek.IsSet && dayOfWeek.Value == null)
                throw new ArgumentNullException(nameof(dayOfWeek), "Property is not nullable for class TransactionRuleInterval.");

            if (duration.IsSet && duration.Value == null)
                throw new ArgumentNullException(nameof(duration), "Property is not nullable for class TransactionRuleInterval.");

            if (timeOfDay.IsSet && timeOfDay.Value == null)
                throw new ArgumentNullException(nameof(timeOfDay), "Property is not nullable for class TransactionRuleInterval.");

            if (timeZone.IsSet && timeZone.Value == null)
                throw new ArgumentNullException(nameof(timeZone), "Property is not nullable for class TransactionRuleInterval.");
        ...
        {
            /*
            if (transactionRuleInterval._DurationOption.IsSet && transactionRuleInterval.Duration == null)
                throw new ArgumentNullException(nameof(transactionRuleInterval.Duration), "Property is required for class TransactionRuleInterval.");

            if (transactionRuleInterval._TimeOfDayOption.IsSet && transactionRuleInterval.TimeOfDay == null)
                throw new ArgumentNullException(nameof(transactionRuleInterval.TimeOfDay), "Property is required for class TransactionRuleInterval.");

            if (transactionRuleInterval._TimeZoneOption.IsSet && transactionRuleInterval.TimeZone == null)
                throw new ArgumentNullException(nameof(transactionRuleInterval.TimeZone), "Property is required for class TransactionRuleInterval.");
