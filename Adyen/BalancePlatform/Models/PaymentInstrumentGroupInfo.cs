...
namespace Adyen.BalancePlatform.Models
{
    ...
    /// </summary>
    public partial class PaymentInstrumentGroupInfo : IValidatableObject
    {
        /// <summary>
    ...
    public class PaymentInstrumentGroupInfoJsonConverter : JsonConverter<PaymentInstrumentGroupInfo>
    {
        ...
        public override PaymentInstrumentGroupInfo Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (balancePlatform.IsSet && balancePlatform.Value == null)
                throw new ArgumentNullException(nameof(balancePlatform), "Property is not nullable for class PaymentInstrumentGroupInfo.");

            if (txVariant.IsSet && txVariant.Value == null)
                throw new ArgumentNullException(nameof(txVariant), "Property is not nullable for class PaymentInstrumentGroupInfo.");

            if (description.IsSet && description.Value == null)
                throw new ArgumentNullException(nameof(description), "Property is not nullable for class PaymentInstrumentGroupInfo.");

            if (properties.IsSet && properties.Value == null)
                throw new ArgumentNullException(nameof(properties), "Property is not nullable for class PaymentInstrumentGroupInfo.");

            if (reference.IsSet && reference.Value == null)
                throw new ArgumentNullException(nameof(reference), "Property is not nullable for class PaymentInstrumentGroupInfo.");
        ...
        public void WriteProperties(Utf8JsonWriter writer, PaymentInstrumentGroupInfo paymentInstrumentGroupInfo, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (paymentInstrumentGroupInfo.BalancePlatform == null)
                throw new ArgumentNullException(nameof(paymentInstrumentGroupInfo.BalancePlatform), "Property is required for class PaymentInstrumentGroupInfo.");

            if (paymentInstrumentGroupInfo.TxVariant == null)
                throw new ArgumentNullException(nameof(paymentInstrumentGroupInfo.TxVariant), "Property is required for class PaymentInstrumentGroupInfo.");

            if (paymentInstrumentGroupInfo._DescriptionOption.IsSet && paymentInstrumentGroupInfo.Description == null)
                throw new ArgumentNullException(nameof(paymentInstrumentGroupInfo.Description), "Property is required for class PaymentInstrumentGroupInfo.");

            if (paymentInstrumentGroupInfo._PropertiesOption.IsSet && paymentInstrumentGroupInfo.Properties == null)
                throw new ArgumentNullException(nameof(paymentInstrumentGroupInfo.Properties), "Property is required for class PaymentInstrumentGroupInfo.");

            if (paymentInstrumentGroupInfo._ReferenceOption.IsSet && paymentInstrumentGroupInfo.Reference == null)
                throw new ArgumentNullException(nameof(paymentInstrumentGroupInfo.Reference), "Property is required for class PaymentInstrumentGroupInfo.");
