    ...
    public class DifferentCurrenciesRestrictionJsonConverter : JsonConverter<DifferentCurrenciesRestriction>
    {
        ...
        public override DifferentCurrenciesRestriction Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (operation.IsSet && operation.Value == null)
                throw new ArgumentNullException(nameof(operation), "Property is not nullable for class DifferentCurrenciesRestriction.");

            if (value.IsSet && value.Value == null)
                throw new ArgumentNullException(nameof(value), "Property is not nullable for class DifferentCurrenciesRestriction.");
        ...
        public void WriteProperties(Utf8JsonWriter writer, DifferentCurrenciesRestriction differentCurrenciesRestriction, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (differentCurrenciesRestriction.Operation == null)
                throw new ArgumentNullException(nameof(differentCurrenciesRestriction.Operation), "Property is required for class DifferentCurrenciesRestriction.");
