...
namespace Adyen.BalancePlatform.Models
{
    ...
    /// </summary>
    public partial class ActiveNetworkTokensRestriction : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ActiveNetworkTokensRestriction" /> class.
        /// </summary>
        /// <param name="operation">Defines how the condition must be evaluated.</param>
        /// <param name="value">The number of tokens.</param>
        [JsonConstructor]
        public ActiveNetworkTokensRestriction(string operation, Option<int?> value = default)
        {
            Operation = operation;
            _ValueOption = value;
            OnCreated();
    ...
    /// <summary>
    /// A Json converter for type <see cref="ActiveNetworkTokensRestriction" />
    /// </summary>
    public class ActiveNetworkTokensRestrictionJsonConverter : JsonConverter<ActiveNetworkTokensRestriction>
    {
        /// <summary>
        /// Deserializes json to <see cref="ActiveNetworkTokensRestriction"/>.
        /// </summary>
        /// <param name="utf8JsonReader"><see cref="Utf8JsonReader"/></param>
        /// <param name="typeToConvert"><see cref="Type"/></param>
        /// <param name="jsonSerializerOptions">The <see cref="JsonSerializerOptions"/>, initialized from <see cref="HostConfiguration"/>.</param>
        /// <returns><see cref="ActiveNetworkTokensRestriction"/></returns>
        /// <exception cref="JsonException"></exception>
        public override ActiveNetworkTokensRestriction Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (operation.IsSet && operation.Value == null)
                throw new ArgumentNullException(nameof(operation), "Property is not nullable for class ActiveNetworkTokensRestriction.");

            if (value.IsSet && value.Value == null)
                throw new ArgumentNullException(nameof(value), "Property is not nullable for class ActiveNetworkTokensRestriction.");

            return new ActiveNetworkTokensRestriction(operation.Value!, value);
        }

        /// <summary>
        /// Serializes a <see cref="ActiveNetworkTokensRestriction"/>.
        /// </summary>
        ...
        public override void Write(Utf8JsonWriter writer, ActiveNetworkTokensRestriction activeNetworkTokensRestriction, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            WriteProperties(writer, activeNetworkTokensRestriction, jsonSerializerOptions);
        ...
        /// <summary>
        /// Serializes the properties of <see cref="ActiveNetworkTokensRestriction"/>.
        /// </summary>
        ...
        {
            /*
            if (activeNetworkTokensRestriction.Operation == null)
                throw new ArgumentNullException(nameof(activeNetworkTokensRestriction.Operation), "Property is required for class ActiveNetworkTokensRestriction.");

            */
            
            writer.WriteString("operation", activeNetworkTokensRestriction.Operation);

            if (activeNetworkTokensRestriction._ValueOption.IsSet)
                writer.WriteNumber("value", activeNetworkTokensRestriction._ValueOption.Value!.Value);
        }
    }
}
