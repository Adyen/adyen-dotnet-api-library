...
namespace Adyen.BalancePlatform.Models
{
    ...
    /// </summary>
    [JsonConverter(typeof(ActiveNetworkTokensRestrictionJsonConverter))]
    public partial class ActiveNetworkTokensRestriction
    {
        /// <summary>
    ...
    public class ActiveNetworkTokensRestrictionJsonConverter : JsonConverter<ActiveNetworkTokensRestriction>
    {
        ...
        public override ActiveNetworkTokensRestriction Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            var activeNetworkTokensRestriction = new ActiveNetworkTokensRestriction();
            activeNetworkTokensRestriction.Operation = operation.Value!;
            if (value.IsSet)
                activeNetworkTokensRestriction.Value = value.Value;
            return activeNetworkTokensRestriction;
        }
        ...
        public void WriteProperties(Utf8JsonWriter writer, ActiveNetworkTokensRestriction activeNetworkTokensRestriction, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (activeNetworkTokensRestriction._ValueOption.IsSet)
                if (activeNetworkTokensRestriction._ValueOption.Value != null)
