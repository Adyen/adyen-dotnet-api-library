...
namespace Adyen.BalancePlatform.Models
{
    ...
    /// MandateUpdate.
    /// </summary>
    public partial class MandateUpdate
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MandateUpdate" /> class.
        /// </summary>
        /// <param name="paymentInstrumentId">The unique identifier of the payment instrument linked to the mandate.</param>
        public MandateUpdate(Option<Object?> paymentInstrumentId = default)
        {
    ...
    /// <summary>
    /// A Json converter for type <see cref="MandateUpdate" />
    /// </summary>
    public class MandateUpdateJsonConverter : JsonConverter<MandateUpdate>
    {
        /// <summary>
        /// Deserializes json to <see cref="MandateUpdate"/>.
        /// </summary>
        /// <param name="utf8JsonReader"><see cref="Utf8JsonReader"/>.</param>
        /// <param name="typeToConvert"><see cref="Type"/>.</param>
        /// <param name="jsonSerializerOptions">The <see cref="JsonSerializerOptions"/>, initialized from <see cref="HostConfiguration"/>.</param>
        /// <returns><see cref="MandateUpdate"/>.</returns>
        /// <exception cref="JsonException"></exception>
        public override MandateUpdate Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            return new MandateUpdate(paymentInstrumentId);
        }

        /// <summary>
        /// Serializes a <see cref="MandateUpdate"/>.
        /// </summary>
        /// <param name="writer"><see cref="Utf8JsonWriter"/></param>
        /// <param name="mandateUpdate"></param>
        /// <param name="jsonSerializerOptions"><see cref="JsonSerializerOptions"/></param>
        public override void Write(Utf8JsonWriter writer, MandateUpdate mandateUpdate, JsonSerializerOptions jsonSerializerOptions)
        {
            
            writer.WriteStartObject();
            
            WriteProperties(writer, mandateUpdate, jsonSerializerOptions);
        ...
        /// <summary>
        /// Serializes the properties of <see cref="MandateUpdate"/>.
        /// </summary>
        /// <param name="writer"><see cref="Utf8JsonWriter"/></param>
        /// <param name="mandateUpdate"></param>
        /// <param name="jsonSerializerOptions"><see cref="JsonSerializerOptions"/></param>
        public void WriteProperties(Utf8JsonWriter writer, MandateUpdate mandateUpdate, JsonSerializerOptions jsonSerializerOptions)
        {
            
            if (mandateUpdate._PaymentInstrumentIdOption.IsSet)
                if (mandateUpdate._PaymentInstrumentIdOption.Value != null)
                {
                    writer.WritePropertyName("paymentInstrumentId");
                    JsonSerializer.Serialize(writer, mandateUpdate.PaymentInstrumentId, jsonSerializerOptions);
                }
                else
