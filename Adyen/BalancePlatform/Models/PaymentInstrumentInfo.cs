...
namespace Adyen.BalancePlatform.Models
{
    ...
    /// </summary>
    public partial class PaymentInstrumentInfo : IValidatableObject
    {
        /// <summary>
    ...
    public class PaymentInstrumentInfoJsonConverter : JsonConverter<PaymentInstrumentInfo>
    {
        ...
        public override PaymentInstrumentInfo Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (balanceAccountId.IsSet && balanceAccountId.Value == null)
                throw new ArgumentNullException(nameof(balanceAccountId), "Property is not nullable for class PaymentInstrumentInfo.");

            if (issuingCountryCode.IsSet && issuingCountryCode.Value == null)
                throw new ArgumentNullException(nameof(issuingCountryCode), "Property is not nullable for class PaymentInstrumentInfo.");

            if (type.IsSet && type.Value == null)
                throw new ArgumentNullException(nameof(type), "Property is not nullable for class PaymentInstrumentInfo.");

            if (bankAccount.IsSet && bankAccount.Value == null)
                throw new ArgumentNullException(nameof(bankAccount), "Property is not nullable for class PaymentInstrumentInfo.");

            if (card.IsSet && card.Value == null)
                throw new ArgumentNullException(nameof(card), "Property is not nullable for class PaymentInstrumentInfo.");

            if (description.IsSet && description.Value == null)
                throw new ArgumentNullException(nameof(description), "Property is not nullable for class PaymentInstrumentInfo.");

            if (paymentInstrumentGroupId.IsSet && paymentInstrumentGroupId.Value == null)
                throw new ArgumentNullException(nameof(paymentInstrumentGroupId), "Property is not nullable for class PaymentInstrumentInfo.");

            if (reference.IsSet && reference.Value == null)
                throw new ArgumentNullException(nameof(reference), "Property is not nullable for class PaymentInstrumentInfo.");

            if (status.IsSet && status.Value == null)
                throw new ArgumentNullException(nameof(status), "Property is not nullable for class PaymentInstrumentInfo.");

            if (statusComment.IsSet && statusComment.Value == null)
                throw new ArgumentNullException(nameof(statusComment), "Property is not nullable for class PaymentInstrumentInfo.");

            if (statusReason.IsSet && statusReason.Value == null)
                throw new ArgumentNullException(nameof(statusReason), "Property is not nullable for class PaymentInstrumentInfo.");
        ...
        public void WriteProperties(Utf8JsonWriter writer, PaymentInstrumentInfo paymentInstrumentInfo, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (paymentInstrumentInfo.BalanceAccountId == null)
                throw new ArgumentNullException(nameof(paymentInstrumentInfo.BalanceAccountId), "Property is required for class PaymentInstrumentInfo.");

            if (paymentInstrumentInfo.IssuingCountryCode == null)
                throw new ArgumentNullException(nameof(paymentInstrumentInfo.IssuingCountryCode), "Property is required for class PaymentInstrumentInfo.");

            if (paymentInstrumentInfo._BankAccountOption.IsSet && paymentInstrumentInfo.BankAccount == null)
                throw new ArgumentNullException(nameof(paymentInstrumentInfo.BankAccount), "Property is required for class PaymentInstrumentInfo.");

            if (paymentInstrumentInfo._CardOption.IsSet && paymentInstrumentInfo.Card == null)
                throw new ArgumentNullException(nameof(paymentInstrumentInfo.Card), "Property is required for class PaymentInstrumentInfo.");

            if (paymentInstrumentInfo._DescriptionOption.IsSet && paymentInstrumentInfo.Description == null)
                throw new ArgumentNullException(nameof(paymentInstrumentInfo.Description), "Property is required for class PaymentInstrumentInfo.");

            if (paymentInstrumentInfo._PaymentInstrumentGroupIdOption.IsSet && paymentInstrumentInfo.PaymentInstrumentGroupId == null)
                throw new ArgumentNullException(nameof(paymentInstrumentInfo.PaymentInstrumentGroupId), "Property is required for class PaymentInstrumentInfo.");

            if (paymentInstrumentInfo._ReferenceOption.IsSet && paymentInstrumentInfo.Reference == null)
                throw new ArgumentNullException(nameof(paymentInstrumentInfo.Reference), "Property is required for class PaymentInstrumentInfo.");

            if (paymentInstrumentInfo._StatusCommentOption.IsSet && paymentInstrumentInfo.StatusComment == null)
                throw new ArgumentNullException(nameof(paymentInstrumentInfo.StatusComment), "Property is required for class PaymentInstrumentInfo.");
