...
namespace Adyen.BalancePlatform.Models
{
    ...
    /// </summary>
    public partial class RegisterSCAFinalResponse : IValidatableObject
    {
        /// <summary>
    ...
    /// <summary>
    /// A Json converter for type <see cref="RegisterSCAFinalResponse" />
    /// </summary>
    public class RegisterSCAFinalResponseJsonConverter : JsonConverter<RegisterSCAFinalResponse>
    {
        /// <summary>
        /// Deserializes json to <see cref="RegisterSCAFinalResponse"/>.
        /// </summary>
        ...
        public override RegisterSCAFinalResponse Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (success.IsSet && success.Value == null)
                throw new ArgumentNullException(nameof(success), "Property is not nullable for class RegisterSCAFinalResponse.");

            return new RegisterSCAFinalResponse(success);
        }

        /// <summary>
        /// Serializes a <see cref="RegisterSCAFinalResponse"/>.
        /// </summary>
        /// <param name="writer"><see cref="Utf8JsonWriter"/></param>
        /// <param name="registerSCAFinalResponse"></param>
        /// <param name="jsonSerializerOptions"><see cref="JsonSerializerOptions"/></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, RegisterSCAFinalResponse registerSCAFinalResponse, JsonSerializerOptions jsonSerializerOptions)
        {
            
            writer.WriteStartObject();
            
            WriteProperties(writer, registerSCAFinalResponse, jsonSerializerOptions);
        ...
        /// <summary>
        /// Serializes the properties of <see cref="RegisterSCAFinalResponse"/>.
        /// </summary>
        /// <param name="writer"><see creft="Utf8JsonWriter"/></param>
        /// <param name="registerSCAFinalResponse"></param>
        /// <param name="jsonSerializerOptions"><see cref="JsonSerializerOptions"/></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, RegisterSCAFinalResponse registerSCAFinalResponse, JsonSerializerOptions jsonSerializerOptions)
        {
            /*
            */
            
            if (registerSCAFinalResponse._SuccessOption.IsSet)
                writer.WriteBoolean("success", registerSCAFinalResponse._SuccessOption.Value!.Value);
        }
    }
}
