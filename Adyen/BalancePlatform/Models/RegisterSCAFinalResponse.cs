...
namespace Adyen.BalancePlatform.Models
{
    ...
    /// </summary>
    [JsonConverter(typeof(RegisterSCAFinalResponseJsonConverter))]
    public partial class RegisterSCAFinalResponse
    {
        /// <summary>
    ...
    public class RegisterSCAFinalResponseJsonConverter : JsonConverter<RegisterSCAFinalResponse>
    {
        ...
        public override RegisterSCAFinalResponse Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            return registerSCAFinalResponse;
        }
        ...
        public void WriteProperties(Utf8JsonWriter writer, RegisterSCAFinalResponse registerSCAFinalResponse, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (registerSCAFinalResponse._SuccessOption.IsSet)
                if (registerSCAFinalResponse._SuccessOption.Value != null)
