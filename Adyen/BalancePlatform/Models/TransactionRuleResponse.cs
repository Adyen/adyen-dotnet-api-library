    ...
    public class TransactionRuleResponseJsonConverter : JsonConverter<TransactionRuleResponse>
    {
        ...
        public override TransactionRuleResponse Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (transactionRule.IsSet && transactionRule.Value == null)
                throw new ArgumentNullException(nameof(transactionRule), "Property is not nullable for class TransactionRuleResponse.");

            return new TransactionRuleResponse(transactionRule);
        }
        ...
        {
            /*
            if (transactionRuleResponse._TransactionRuleOption.IsSet && transactionRuleResponse.TransactionRule == null)
                throw new ArgumentNullException(nameof(transactionRuleResponse.TransactionRule), "Property is required for class TransactionRuleResponse.");
