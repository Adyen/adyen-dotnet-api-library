...
namespace Adyen.BalancePlatform.Models
{
    ...
    public partial class PublicKeyResponse : IValidatableObject
    {
        ...
        {
            PublicKey = publicKey;
            PublicKeyExpiryDate = publicKeyExpiryDate;
            OnCreated();
        }
    ...
    public class PublicKeyResponseJsonConverter : JsonConverter<PublicKeyResponse>
    {
        ...
        public override PublicKeyResponse Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (publicKey.IsSet && publicKey.Value == null)
                throw new ArgumentNullException(nameof(publicKey), "Property is not nullable for class PublicKeyResponse.");

            if (publicKeyExpiryDate.IsSet && publicKeyExpiryDate.Value == null)
                throw new ArgumentNullException(nameof(publicKeyExpiryDate), "Property is not nullable for class PublicKeyResponse.");
        ...
        public void WriteProperties(Utf8JsonWriter writer, PublicKeyResponse publicKeyResponse, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (publicKeyResponse.PublicKey == null)
                throw new ArgumentNullException(nameof(publicKeyResponse.PublicKey), "Property is required for class PublicKeyResponse.");

            if (publicKeyResponse.PublicKeyExpiryDate == null)
                throw new ArgumentNullException(nameof(publicKeyResponse.PublicKeyExpiryDate), "Property is required for class PublicKeyResponse.");
