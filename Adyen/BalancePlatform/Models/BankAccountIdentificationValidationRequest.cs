...
namespace Adyen.BalancePlatform.Models
{
    ...
    /// </summary>
    public partial class BankAccountIdentificationValidationRequest : IValidatableObject
    {
        /// <summary>
        ...
        [JsonConstructor]
        public BankAccountIdentificationValidationRequest(BankAccountIdentificationValidationRequestAccountIdentification accountIdentification)
        {
    ...
    public class BankAccountIdentificationValidationRequestJsonConverter : JsonConverter<BankAccountIdentificationValidationRequest>
    {
        ...
        public override BankAccountIdentificationValidationRequest Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (accountIdentification.IsSet && accountIdentification.Value == null)
                throw new ArgumentNullException(nameof(accountIdentification), "Property is not nullable for class BankAccountIdentificationValidationRequest.");
        ...
        {
            /*
            if (bankAccountIdentificationValidationRequest.AccountIdentification == null)
                throw new ArgumentNullException(nameof(bankAccountIdentificationValidationRequest.AccountIdentification), "Property is required for class BankAccountIdentificationValidationRequest.");
