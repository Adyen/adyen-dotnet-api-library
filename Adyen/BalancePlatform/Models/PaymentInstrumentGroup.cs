...
namespace Adyen.BalancePlatform.Models
{
    ...
    /// </summary>
    [JsonConverter(typeof(PaymentInstrumentGroupJsonConverter))]
    ...
    public class PaymentInstrumentGroupJsonConverter : JsonConverter<PaymentInstrumentGroup>
    {
        ...
        public override PaymentInstrumentGroup Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            var paymentInstrumentGroup = new PaymentInstrumentGroup();
            if (balancePlatform.IsSet)
                paymentInstrumentGroup.BalancePlatform = balancePlatform.Value!;
            if (txVariant.IsSet)
                paymentInstrumentGroup.TxVariant = txVariant.Value!;
            if (description.IsSet)
                paymentInstrumentGroup.Description = description.Value;
            if (id.IsSet)
                paymentInstrumentGroup.Id = id.Value;
            if (properties.IsSet)
                paymentInstrumentGroup.Properties = properties.Value;
            if (reference.IsSet)
                paymentInstrumentGroup.Reference = reference.Value;
