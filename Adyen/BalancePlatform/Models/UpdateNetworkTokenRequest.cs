...
namespace Adyen.BalancePlatform.Models
{
    ...
    /// </summary>
    [JsonConverter(typeof(UpdateNetworkTokenRequestJsonConverter))]
    public partial class UpdateNetworkTokenRequest
    {
        /// <summary>
    ...
    public class UpdateNetworkTokenRequestJsonConverter : JsonConverter<UpdateNetworkTokenRequest>
    {
        ...
        public override UpdateNetworkTokenRequest Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
                ...
                if (utf8JsonReader.TokenType == JsonTokenType.PropertyName && currentDepth == utf8JsonReader.CurrentDepth - 1)
                {
                    ...
                    switch (jsonPropertyName)
                    {
                        case "status":
                            ...
                            status = new Option<UpdateNetworkTokenRequest.StatusEnum?>(UpdateNetworkTokenRequest.StatusEnum.FromStringOrDefault(statusRawValue) ?? (UpdateNetworkTokenRequest.StatusEnum)statusRawValue);
                            break;
                        default:
                            break;
                    }
            ...
            return updateNetworkTokenRequest;
        }
