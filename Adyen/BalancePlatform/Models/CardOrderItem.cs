    ...
    public class CardOrderItemJsonConverter : JsonConverter<CardOrderItem>
    {
        ...
        public override CardOrderItem Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (balancePlatform.IsSet && balancePlatform.Value == null)
                throw new ArgumentNullException(nameof(balancePlatform), "Property is not nullable for class CardOrderItem.");

            if (card.IsSet && card.Value == null)
                throw new ArgumentNullException(nameof(card), "Property is not nullable for class CardOrderItem.");

            if (cardOrderItemId.IsSet && cardOrderItemId.Value == null)
                throw new ArgumentNullException(nameof(cardOrderItemId), "Property is not nullable for class CardOrderItem.");

            if (creationDate.IsSet && creationDate.Value == null)
                throw new ArgumentNullException(nameof(creationDate), "Property is not nullable for class CardOrderItem.");

            if (id.IsSet && id.Value == null)
                throw new ArgumentNullException(nameof(id), "Property is not nullable for class CardOrderItem.");

            if (paymentInstrumentId.IsSet && paymentInstrumentId.Value == null)
                throw new ArgumentNullException(nameof(paymentInstrumentId), "Property is not nullable for class CardOrderItem.");

            if (pin.IsSet && pin.Value == null)
                throw new ArgumentNullException(nameof(pin), "Property is not nullable for class CardOrderItem.");

            if (shippingMethod.IsSet && shippingMethod.Value == null)
                throw new ArgumentNullException(nameof(shippingMethod), "Property is not nullable for class CardOrderItem.");
        ...
        {
            /*
            if (cardOrderItem._BalancePlatformOption.IsSet && cardOrderItem.BalancePlatform == null)
                throw new ArgumentNullException(nameof(cardOrderItem.BalancePlatform), "Property is required for class CardOrderItem.");

            if (cardOrderItem._CardOption.IsSet && cardOrderItem.Card == null)
                throw new ArgumentNullException(nameof(cardOrderItem.Card), "Property is required for class CardOrderItem.");

            if (cardOrderItem._CardOrderItemIdOption.IsSet && cardOrderItem.CardOrderItemId == null)
                throw new ArgumentNullException(nameof(cardOrderItem.CardOrderItemId), "Property is required for class CardOrderItem.");

            if (cardOrderItem._IdOption.IsSet && cardOrderItem.Id == null)
                throw new ArgumentNullException(nameof(cardOrderItem.Id), "Property is required for class CardOrderItem.");

            if (cardOrderItem._PaymentInstrumentIdOption.IsSet && cardOrderItem.PaymentInstrumentId == null)
                throw new ArgumentNullException(nameof(cardOrderItem.PaymentInstrumentId), "Property is required for class CardOrderItem.");

            if (cardOrderItem._PinOption.IsSet && cardOrderItem.Pin == null)
                throw new ArgumentNullException(nameof(cardOrderItem.Pin), "Property is required for class CardOrderItem.");

            if (cardOrderItem._ShippingMethodOption.IsSet && cardOrderItem.ShippingMethod == null)
                throw new ArgumentNullException(nameof(cardOrderItem.ShippingMethod), "Property is required for class CardOrderItem.");
