    ...
    public class AssociationFinaliseResponseJsonConverter : JsonConverter<AssociationFinaliseResponse>
    {
        ...
        public override AssociationFinaliseResponse Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (type.IsSet && type.Value == null)
                throw new ArgumentNullException(nameof(type), "Property is not nullable for class AssociationFinaliseResponse.");

            if (deviceId.IsSet && deviceId.Value == null)
                throw new ArgumentNullException(nameof(deviceId), "Property is not nullable for class AssociationFinaliseResponse.");

            if (ids.IsSet && ids.Value == null)
                throw new ArgumentNullException(nameof(ids), "Property is not nullable for class AssociationFinaliseResponse.");
        ...
        {
            /*
            if (associationFinaliseResponse._DeviceIdOption.IsSet && associationFinaliseResponse.DeviceId == null)
                throw new ArgumentNullException(nameof(associationFinaliseResponse.DeviceId), "Property is required for class AssociationFinaliseResponse.");

            if (associationFinaliseResponse._IdsOption.IsSet && associationFinaliseResponse.Ids == null)
                throw new ArgumentNullException(nameof(associationFinaliseResponse.Ids), "Property is required for class AssociationFinaliseResponse.");
