...
namespace Adyen.BalancePlatform.Models
{
    ...
    /// </summary>
    public partial class PaymentInstrumentRevealRequest : IValidatableObject
    {
        /// <summary>
    ...
    public class PaymentInstrumentRevealRequestJsonConverter : JsonConverter<PaymentInstrumentRevealRequest>
    {
        ...
        public override PaymentInstrumentRevealRequest Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (encryptedKey.IsSet && encryptedKey.Value == null)
                throw new ArgumentNullException(nameof(encryptedKey), "Property is not nullable for class PaymentInstrumentRevealRequest.");

            if (paymentInstrumentId.IsSet && paymentInstrumentId.Value == null)
                throw new ArgumentNullException(nameof(paymentInstrumentId), "Property is not nullable for class PaymentInstrumentRevealRequest.");
        ...
        public void WriteProperties(Utf8JsonWriter writer, PaymentInstrumentRevealRequest paymentInstrumentRevealRequest, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (paymentInstrumentRevealRequest.EncryptedKey == null)
                throw new ArgumentNullException(nameof(paymentInstrumentRevealRequest.EncryptedKey), "Property is required for class PaymentInstrumentRevealRequest.");

            if (paymentInstrumentRevealRequest.PaymentInstrumentId == null)
                throw new ArgumentNullException(nameof(paymentInstrumentRevealRequest.PaymentInstrumentId), "Property is required for class PaymentInstrumentRevealRequest.");
