...
namespace Adyen.BalancePlatform.Models
{
    ...
    public partial class CapabilitySettings
    {
        ...
        public class IntervalEnum : IEnum
        {
            ...
            /// <summary>
            /// Compares two <see cref="IntervalEnum"/> instances for equality.
            /// </summary>
            ...
            /// <summary>
            /// Compares two <see cref="IntervalEnum"/> instances for inequality.
            /// </summary>
            public static bool operator !=(IntervalEnum? left, IntervalEnum? right) => !string.Equals(left?.Value, right?.Value, StringComparison.OrdinalIgnoreCase);

            /// <summary>
            /// Returns true if the given object is equal to this <see cref="IntervalEnum"/> instance.
            /// </summary>
            ...
            /// <summary>
            /// Returns a hash code for this <see cref="IntervalEnum"/> instance.
            /// </summary>
            public override int GetHashCode() => Value?.GetHashCode() ?? 0;

            /// <summary>
            /// Returns the string value of the <see cref="IntervalEnum"/> instance.
            /// </summary>
            public override string ToString() => Value ?? string.Empty;
            ...
            {
                /// <summary>
                /// Deserializes a <see cref="IntervalEnum"/> from JSON.
                /// </summary>
                ...
                /// <summary>
                /// Serializes a <see cref="IntervalEnum"/> to JSON.
                /// </summary>
    ...
    public class CapabilitySettingsJsonConverter : JsonConverter<CapabilitySettings>
    {
        ...
        public override CapabilitySettings Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (authorizedCardUsers.IsSet)
                capabilitySettings.AuthorizedCardUsers = authorizedCardUsers.Value;
            if (fundingSource.IsSet)
                capabilitySettings.FundingSource = fundingSource.Value;
            if (interval.IsSet)
                capabilitySettings.Interval = interval.Value;
            if (maxAmount.IsSet)
                capabilitySettings.MaxAmount = maxAmount.Value;
