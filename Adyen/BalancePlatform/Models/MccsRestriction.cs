...
namespace Adyen.BalancePlatform.Models
{
    ...
    /// MccsRestriction.
    /// </summary>
    [JsonConverter(typeof(MccsRestrictionJsonConverter))]
    public partial class MccsRestriction
    {
        /// <summary>
    ...
    public class MccsRestrictionJsonConverter : JsonConverter<MccsRestriction>
    {
        ...
        public override MccsRestriction Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            var mccsRestriction = new MccsRestriction();
            if (operation.IsSet)
                mccsRestriction.Operation = operation.Value!;
            if (value.IsSet)
                mccsRestriction.Value = value.Value;
            return mccsRestriction;
        }
