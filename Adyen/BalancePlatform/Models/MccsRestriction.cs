...
namespace Adyen.BalancePlatform.Models
{
    ...
    /// MccsRestriction.
    /// </summary>
    public partial class MccsRestriction : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MccsRestriction" /> class.
        /// </summary>
        ...
        /// </summary>
        /// <value>List of merchant category codes (MCCs).</value>
    ...
    /// <summary>
    /// A Json converter for type <see cref="MccsRestriction" />
    /// </summary>
    public class MccsRestrictionJsonConverter : JsonConverter<MccsRestriction>
    {
        /// <summary>
        /// Deserializes json to <see cref="MccsRestriction"/>.
        /// </summary>
        /// <param name="utf8JsonReader"><see cref="Utf8JsonReader"/></param>
        /// <param name="typeToConvert"><see cref="Type"/></param>
        /// <param name="jsonSerializerOptions">The <see cref="JsonSerializerOptions"/>, initialized from <see cref="HostConfiguration"/>.</param>
        /// <returns><see cref="MccsRestriction"/></returns>
        /// <exception cref="JsonException"></exception>
        public override MccsRestriction Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (operation.IsSet && operation.Value == null)
                throw new ArgumentNullException(nameof(operation), "Property is not nullable for class MccsRestriction.");

            if (value.IsSet && value.Value == null)
                throw new ArgumentNullException(nameof(value), "Property is not nullable for class MccsRestriction.");

            return new MccsRestriction(operation.Value!, value);
        }

        /// <summary>
        /// Serializes a <see cref="MccsRestriction"/>.
        /// </summary>
        ...
        /// <summary>
        /// Serializes the properties of <see cref="MccsRestriction"/>.
        /// </summary>
        ...
        {
            /*
            if (mccsRestriction.Operation == null)
                throw new ArgumentNullException(nameof(mccsRestriction.Operation), "Property is required for class MccsRestriction.");

            if (mccsRestriction._ValueOption.IsSet && mccsRestriction.Value == null)
                throw new ArgumentNullException(nameof(mccsRestriction.Value), "Property is required for class MccsRestriction.");

            */
            
            writer.WriteString("operation", mccsRestriction.Operation);

            if (mccsRestriction._ValueOption.IsSet)
            {
                writer.WritePropertyName("value");
                JsonSerializer.Serialize(writer, mccsRestriction.Value, jsonSerializerOptions);
            }
        }
    }
}
