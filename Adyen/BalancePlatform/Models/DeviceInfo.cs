...
namespace Adyen.BalancePlatform.Models
{
    ...
    public class DeviceInfoJsonConverter : JsonConverter<DeviceInfo>
    {
        ...
        public override DeviceInfo Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (cardCaptureTechnology.IsSet && cardCaptureTechnology.Value == null)
                throw new ArgumentNullException(nameof(cardCaptureTechnology), "Property is not nullable for class DeviceInfo.");

            if (deviceName.IsSet && deviceName.Value == null)
                throw new ArgumentNullException(nameof(deviceName), "Property is not nullable for class DeviceInfo.");

            if (formFactor.IsSet && formFactor.Value == null)
                throw new ArgumentNullException(nameof(formFactor), "Property is not nullable for class DeviceInfo.");

            if (imei.IsSet && imei.Value == null)
                throw new ArgumentNullException(nameof(imei), "Property is not nullable for class DeviceInfo.");

            if (isoDeviceType.IsSet && isoDeviceType.Value == null)
                throw new ArgumentNullException(nameof(isoDeviceType), "Property is not nullable for class DeviceInfo.");

            if (msisdn.IsSet && msisdn.Value == null)
                throw new ArgumentNullException(nameof(msisdn), "Property is not nullable for class DeviceInfo.");

            if (osName.IsSet && osName.Value == null)
                throw new ArgumentNullException(nameof(osName), "Property is not nullable for class DeviceInfo.");

            if (osVersion.IsSet && osVersion.Value == null)
                throw new ArgumentNullException(nameof(osVersion), "Property is not nullable for class DeviceInfo.");

            if (paymentTypes.IsSet && paymentTypes.Value == null)
                throw new ArgumentNullException(nameof(paymentTypes), "Property is not nullable for class DeviceInfo.");

            if (serialNumber.IsSet && serialNumber.Value == null)
                throw new ArgumentNullException(nameof(serialNumber), "Property is not nullable for class DeviceInfo.");

            if (storageTechnology.IsSet && storageTechnology.Value == null)
                throw new ArgumentNullException(nameof(storageTechnology), "Property is not nullable for class DeviceInfo.");
        ...
        {
            /*
            if (deviceInfo._CardCaptureTechnologyOption.IsSet && deviceInfo.CardCaptureTechnology == null)
                throw new ArgumentNullException(nameof(deviceInfo.CardCaptureTechnology), "Property is required for class DeviceInfo.");

            if (deviceInfo._DeviceNameOption.IsSet && deviceInfo.DeviceName == null)
                throw new ArgumentNullException(nameof(deviceInfo.DeviceName), "Property is required for class DeviceInfo.");

            if (deviceInfo._FormFactorOption.IsSet && deviceInfo.FormFactor == null)
                throw new ArgumentNullException(nameof(deviceInfo.FormFactor), "Property is required for class DeviceInfo.");

            if (deviceInfo._ImeiOption.IsSet && deviceInfo.Imei == null)
                throw new ArgumentNullException(nameof(deviceInfo.Imei), "Property is required for class DeviceInfo.");

            if (deviceInfo._IsoDeviceTypeOption.IsSet && deviceInfo.IsoDeviceType == null)
                throw new ArgumentNullException(nameof(deviceInfo.IsoDeviceType), "Property is required for class DeviceInfo.");

            if (deviceInfo._MsisdnOption.IsSet && deviceInfo.Msisdn == null)
                throw new ArgumentNullException(nameof(deviceInfo.Msisdn), "Property is required for class DeviceInfo.");

            if (deviceInfo._OsNameOption.IsSet && deviceInfo.OsName == null)
                throw new ArgumentNullException(nameof(deviceInfo.OsName), "Property is required for class DeviceInfo.");

            if (deviceInfo._OsVersionOption.IsSet && deviceInfo.OsVersion == null)
                throw new ArgumentNullException(nameof(deviceInfo.OsVersion), "Property is required for class DeviceInfo.");

            if (deviceInfo._PaymentTypesOption.IsSet && deviceInfo.PaymentTypes == null)
                throw new ArgumentNullException(nameof(deviceInfo.PaymentTypes), "Property is required for class DeviceInfo.");

            if (deviceInfo._SerialNumberOption.IsSet && deviceInfo.SerialNumber == null)
                throw new ArgumentNullException(nameof(deviceInfo.SerialNumber), "Property is required for class DeviceInfo.");

            if (deviceInfo._StorageTechnologyOption.IsSet && deviceInfo.StorageTechnology == null)
                throw new ArgumentNullException(nameof(deviceInfo.StorageTechnology), "Property is required for class DeviceInfo.");
