...
namespace Adyen.BalancePlatform.Models
{
    ...
    /// CardInfo.
    /// </summary>
    [JsonConverter(typeof(CardInfoJsonConverter))]
    ...
    public class CardInfoJsonConverter : JsonConverter<CardInfo>
    {
        ...
        public override CardInfo Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (configuration.IsSet)
                cardInfo.Configuration = configuration.Value;
            if (deliveryContact.IsSet)
                cardInfo.DeliveryContact = deliveryContact.Value;
            if (threeDSecure.IsSet)
                cardInfo.ThreeDSecure = threeDSecure.Value;
            if (usage.IsSet)
                cardInfo.Usage = usage.Value;
            return cardInfo;
        }
