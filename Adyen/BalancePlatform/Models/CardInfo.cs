    ...
    public class CardInfoJsonConverter : JsonConverter<CardInfo>
    {
        ...
        public override CardInfo Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (brand.IsSet && brand.Value == null)
                throw new ArgumentNullException(nameof(brand), "Property is not nullable for class CardInfo.");

            if (brandVariant.IsSet && brandVariant.Value == null)
                throw new ArgumentNullException(nameof(brandVariant), "Property is not nullable for class CardInfo.");

            if (cardholderName.IsSet && cardholderName.Value == null)
                throw new ArgumentNullException(nameof(cardholderName), "Property is not nullable for class CardInfo.");

            if (formFactor.IsSet && formFactor.Value == null)
                throw new ArgumentNullException(nameof(formFactor), "Property is not nullable for class CardInfo.");

            if (authentication.IsSet && authentication.Value == null)
                throw new ArgumentNullException(nameof(authentication), "Property is not nullable for class CardInfo.");

            if (configuration.IsSet && configuration.Value == null)
                throw new ArgumentNullException(nameof(configuration), "Property is not nullable for class CardInfo.");

            if (deliveryContact.IsSet && deliveryContact.Value == null)
                throw new ArgumentNullException(nameof(deliveryContact), "Property is not nullable for class CardInfo.");

            if (threeDSecure.IsSet && threeDSecure.Value == null)
                throw new ArgumentNullException(nameof(threeDSecure), "Property is not nullable for class CardInfo.");

            if (usage.IsSet && usage.Value == null)
                throw new ArgumentNullException(nameof(usage), "Property is not nullable for class CardInfo.");
        ...
        public void WriteProperties(Utf8JsonWriter writer, CardInfo cardInfo, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (cardInfo.Brand == null)
                throw new ArgumentNullException(nameof(cardInfo.Brand), "Property is required for class CardInfo.");

            if (cardInfo.BrandVariant == null)
                throw new ArgumentNullException(nameof(cardInfo.BrandVariant), "Property is required for class CardInfo.");

            if (cardInfo.CardholderName == null)
                throw new ArgumentNullException(nameof(cardInfo.CardholderName), "Property is required for class CardInfo.");

            if (cardInfo._AuthenticationOption.IsSet && cardInfo.Authentication == null)
                throw new ArgumentNullException(nameof(cardInfo.Authentication), "Property is required for class CardInfo.");

            if (cardInfo._ConfigurationOption.IsSet && cardInfo.Configuration == null)
                throw new ArgumentNullException(nameof(cardInfo.Configuration), "Property is required for class CardInfo.");

            if (cardInfo._DeliveryContactOption.IsSet && cardInfo.DeliveryContact == null)
                throw new ArgumentNullException(nameof(cardInfo.DeliveryContact), "Property is required for class CardInfo.");

            if (cardInfo._ThreeDSecureOption.IsSet && cardInfo.ThreeDSecure == null)
                throw new ArgumentNullException(nameof(cardInfo.ThreeDSecure), "Property is required for class CardInfo.");

            if (cardInfo._UsageOption.IsSet && cardInfo.Usage == null)
                throw new ArgumentNullException(nameof(cardInfo.Usage), "Property is required for class CardInfo.");
