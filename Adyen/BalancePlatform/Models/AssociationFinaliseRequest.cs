...
namespace Adyen.BalancePlatform.Models
{
    ...
    /// </summary>
    [JsonConverter(typeof(AssociationFinaliseRequestJsonConverter))]
    public partial class AssociationFinaliseRequest
    {
        /// <summary>
                ...
                if (utf8JsonReader.TokenType == JsonTokenType.PropertyName && currentDepth == utf8JsonReader.CurrentDepth - 1)
                {
                    ...
                    switch (jsonPropertyName)
                    {
                        ...
                        case "type":
                            ...
                            type = new Option<AssociationFinaliseRequest.TypeEnum?>(AssociationFinaliseRequest.TypeEnum.FromStringOrDefault(typeRawValue) ?? (AssociationFinaliseRequest.TypeEnum)typeRawValue);
                            break;
                        default:
                            break;
                    }
