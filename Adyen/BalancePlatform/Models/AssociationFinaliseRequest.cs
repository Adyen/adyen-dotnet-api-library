    ...
    public class AssociationFinaliseRequestJsonConverter : JsonConverter<AssociationFinaliseRequest>
    {
        ...
        public override AssociationFinaliseRequest Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (ids.IsSet && ids.Value == null)
                throw new ArgumentNullException(nameof(ids), "Property is not nullable for class AssociationFinaliseRequest.");

            if (strongCustomerAuthentication.IsSet && strongCustomerAuthentication.Value == null)
                throw new ArgumentNullException(nameof(strongCustomerAuthentication), "Property is not nullable for class AssociationFinaliseRequest.");

            if (type.IsSet && type.Value == null)
                throw new ArgumentNullException(nameof(type), "Property is not nullable for class AssociationFinaliseRequest.");
        ...
        {
            /*
            if (associationFinaliseRequest.Ids == null)
                throw new ArgumentNullException(nameof(associationFinaliseRequest.Ids), "Property is required for class AssociationFinaliseRequest.");

            if (associationFinaliseRequest.StrongCustomerAuthentication == null)
                throw new ArgumentNullException(nameof(associationFinaliseRequest.StrongCustomerAuthentication), "Property is required for class AssociationFinaliseRequest.");
