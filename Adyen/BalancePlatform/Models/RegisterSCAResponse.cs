    ...
    public class RegisterSCAResponseJsonConverter : JsonConverter<RegisterSCAResponse>
    {
        ...
        public override RegisterSCAResponse Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (id.IsSet && id.Value == null)
                throw new ArgumentNullException(nameof(id), "Property is not nullable for class RegisterSCAResponse.");

            if (paymentInstrumentId.IsSet && paymentInstrumentId.Value == null)
                throw new ArgumentNullException(nameof(paymentInstrumentId), "Property is not nullable for class RegisterSCAResponse.");

            if (sdkInput.IsSet && sdkInput.Value == null)
                throw new ArgumentNullException(nameof(sdkInput), "Property is not nullable for class RegisterSCAResponse.");

            if (success.IsSet && success.Value == null)
                throw new ArgumentNullException(nameof(success), "Property is not nullable for class RegisterSCAResponse.");
        ...
        {
            /*
            if (registerSCAResponse._IdOption.IsSet && registerSCAResponse.Id == null)
                throw new ArgumentNullException(nameof(registerSCAResponse.Id), "Property is required for class RegisterSCAResponse.");

            if (registerSCAResponse._PaymentInstrumentIdOption.IsSet && registerSCAResponse.PaymentInstrumentId == null)
                throw new ArgumentNullException(nameof(registerSCAResponse.PaymentInstrumentId), "Property is required for class RegisterSCAResponse.");

            if (registerSCAResponse._SdkInputOption.IsSet && registerSCAResponse.SdkInput == null)
                throw new ArgumentNullException(nameof(registerSCAResponse.SdkInput), "Property is required for class RegisterSCAResponse.");
