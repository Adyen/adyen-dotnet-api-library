...
namespace Adyen.BalancePlatform.Models
{
    ...
    /// </summary>
    public partial class TransferRouteRequest : IValidatableObject
    {
        /// <summary>
    ...
    public class TransferRouteRequestJsonConverter : JsonConverter<TransferRouteRequest>
    {
        ...
        public override TransferRouteRequest Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (balancePlatform.IsSet && balancePlatform.Value == null)
                throw new ArgumentNullException(nameof(balancePlatform), "Property is not nullable for class TransferRouteRequest.");

            if (category.IsSet && category.Value == null)
                throw new ArgumentNullException(nameof(category), "Property is not nullable for class TransferRouteRequest.");

            if (currency.IsSet && currency.Value == null)
                throw new ArgumentNullException(nameof(currency), "Property is not nullable for class TransferRouteRequest.");

            if (balanceAccountId.IsSet && balanceAccountId.Value == null)
                throw new ArgumentNullException(nameof(balanceAccountId), "Property is not nullable for class TransferRouteRequest.");

            if (counterparty.IsSet && counterparty.Value == null)
                throw new ArgumentNullException(nameof(counterparty), "Property is not nullable for class TransferRouteRequest.");

            if (country.IsSet && country.Value == null)
                throw new ArgumentNullException(nameof(country), "Property is not nullable for class TransferRouteRequest.");

            if (priorities.IsSet && priorities.Value == null)
                throw new ArgumentNullException(nameof(priorities), "Property is not nullable for class TransferRouteRequest.");
        ...
        public void WriteProperties(Utf8JsonWriter writer, TransferRouteRequest transferRouteRequest, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (transferRouteRequest.BalancePlatform == null)
                throw new ArgumentNullException(nameof(transferRouteRequest.BalancePlatform), "Property is required for class TransferRouteRequest.");

            if (transferRouteRequest.Currency == null)
                throw new ArgumentNullException(nameof(transferRouteRequest.Currency), "Property is required for class TransferRouteRequest.");

            if (transferRouteRequest._BalanceAccountIdOption.IsSet && transferRouteRequest.BalanceAccountId == null)
                throw new ArgumentNullException(nameof(transferRouteRequest.BalanceAccountId), "Property is required for class TransferRouteRequest.");

            if (transferRouteRequest._CounterpartyOption.IsSet && transferRouteRequest.Counterparty == null)
                throw new ArgumentNullException(nameof(transferRouteRequest.Counterparty), "Property is required for class TransferRouteRequest.");

            if (transferRouteRequest._CountryOption.IsSet && transferRouteRequest.Country == null)
                throw new ArgumentNullException(nameof(transferRouteRequest.Country), "Property is required for class TransferRouteRequest.");

            if (transferRouteRequest._PrioritiesOption.IsSet && transferRouteRequest.Priorities == null)
                throw new ArgumentNullException(nameof(transferRouteRequest.Priorities), "Property is required for class TransferRouteRequest.");
