...
namespace Adyen.BalancePlatform.Models
{
    ...
    /// </summary>
    [JsonConverter(typeof(TransferRouteRequestJsonConverter))]
    ...
    public class TransferRouteRequestJsonConverter : JsonConverter<TransferRouteRequest>
    {
        ...
        public override TransferRouteRequest Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (counterparty.IsSet)
                transferRouteRequest.Counterparty = counterparty.Value;
            if (country.IsSet)
                transferRouteRequest.Country = country.Value;
            if (priorities.IsSet)
                transferRouteRequest.Priorities = priorities.Value;
            return transferRouteRequest;
        }
