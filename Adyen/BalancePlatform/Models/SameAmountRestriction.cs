...
namespace Adyen.BalancePlatform.Models
{
    ...
    /// </summary>
    public partial class SameAmountRestriction : IValidatableObject
    {
        /// <summary>
        ...
        [JsonConstructor]
        public SameAmountRestriction(string operation, Option<bool?> value = default)
        {
            Operation = operation;
            _ValueOption = value;
            OnCreated();
    ...
    public class SameAmountRestrictionJsonConverter : JsonConverter<SameAmountRestriction>
    {
        ...
        public override SameAmountRestriction Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (operation.IsSet && operation.Value == null)
                throw new ArgumentNullException(nameof(operation), "Property is not nullable for class SameAmountRestriction.");

            if (value.IsSet && value.Value == null)
                throw new ArgumentNullException(nameof(value), "Property is not nullable for class SameAmountRestriction.");
        ...
        public void WriteProperties(Utf8JsonWriter writer, SameAmountRestriction sameAmountRestriction, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (sameAmountRestriction.Operation == null)
                throw new ArgumentNullException(nameof(sameAmountRestriction.Operation), "Property is required for class SameAmountRestriction.");
