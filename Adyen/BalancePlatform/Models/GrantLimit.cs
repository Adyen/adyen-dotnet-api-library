...
namespace Adyen.BalancePlatform.Models
{
    ...
    /// GrantLimit.
    /// </summary>
    public partial class GrantLimit : IValidatableObject
    {
        /// <summary>
    ...
    public class GrantLimitJsonConverter : JsonConverter<GrantLimit>
    {
        ...
        public override GrantLimit Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (amount.IsSet && amount.Value == null)
                throw new ArgumentNullException(nameof(amount), "Property is not nullable for class GrantLimit.");
        ...
        {
            /*
            if (grantLimit._AmountOption.IsSet && grantLimit.Amount == null)
                throw new ArgumentNullException(nameof(grantLimit.Amount), "Property is required for class GrantLimit.");
