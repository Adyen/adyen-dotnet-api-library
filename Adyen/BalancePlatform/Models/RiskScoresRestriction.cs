...
namespace Adyen.BalancePlatform.Models
{
    ...
    /// </summary>
    public partial class RiskScoresRestriction : IValidatableObject
    {
        /// <summary>
        ...
        [JsonConstructor]
        public RiskScoresRestriction(string operation, Option<RiskScores?> value = default)
        {
            Operation = operation;
            _ValueOption = value;
            OnCreated();
    ...
    public class RiskScoresRestrictionJsonConverter : JsonConverter<RiskScoresRestriction>
    {
        ...
        public override RiskScoresRestriction Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (operation.IsSet && operation.Value == null)
                throw new ArgumentNullException(nameof(operation), "Property is not nullable for class RiskScoresRestriction.");

            if (value.IsSet && value.Value == null)
                throw new ArgumentNullException(nameof(value), "Property is not nullable for class RiskScoresRestriction.");
        ...
        public void WriteProperties(Utf8JsonWriter writer, RiskScoresRestriction riskScoresRestriction, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (riskScoresRestriction.Operation == null)
                throw new ArgumentNullException(nameof(riskScoresRestriction.Operation), "Property is required for class RiskScoresRestriction.");

            if (riskScoresRestriction._ValueOption.IsSet && riskScoresRestriction.Value == null)
                throw new ArgumentNullException(nameof(riskScoresRestriction.Value), "Property is required for class RiskScoresRestriction.");
