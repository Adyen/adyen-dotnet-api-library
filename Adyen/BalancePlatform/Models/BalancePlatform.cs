    ...
    public class BalancePlatformJsonConverter : JsonConverter<BalancePlatform>
    {
        ...
        public override BalancePlatform Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (id.IsSet && id.Value == null)
                throw new ArgumentNullException(nameof(id), "Property is not nullable for class BalancePlatform.");

            if (description.IsSet && description.Value == null)
                throw new ArgumentNullException(nameof(description), "Property is not nullable for class BalancePlatform.");

            if (status.IsSet && status.Value == null)
                throw new ArgumentNullException(nameof(status), "Property is not nullable for class BalancePlatform.");
        ...
        public void WriteProperties(Utf8JsonWriter writer, BalancePlatform balancePlatform, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (balancePlatform.Id == null)
                throw new ArgumentNullException(nameof(balancePlatform.Id), "Property is required for class BalancePlatform.");

            if (balancePlatform._DescriptionOption.IsSet && balancePlatform.Description == null)
                throw new ArgumentNullException(nameof(balancePlatform.Description), "Property is required for class BalancePlatform.");

            if (balancePlatform._StatusOption.IsSet && balancePlatform.Status == null)
                throw new ArgumentNullException(nameof(balancePlatform.Status), "Property is required for class BalancePlatform.");
