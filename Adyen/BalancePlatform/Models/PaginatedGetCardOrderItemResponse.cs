    ...
    public class PaginatedGetCardOrderItemResponseJsonConverter : JsonConverter<PaginatedGetCardOrderItemResponse>
    {
        ...
        public override PaginatedGetCardOrderItemResponse Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (data.IsSet && data.Value == null)
                throw new ArgumentNullException(nameof(data), "Property is not nullable for class PaginatedGetCardOrderItemResponse.");

            if (hasNext.IsSet && hasNext.Value == null)
                throw new ArgumentNullException(nameof(hasNext), "Property is not nullable for class PaginatedGetCardOrderItemResponse.");

            if (hasPrevious.IsSet && hasPrevious.Value == null)
                throw new ArgumentNullException(nameof(hasPrevious), "Property is not nullable for class PaginatedGetCardOrderItemResponse.");
        ...
        {
            /*
            if (paginatedGetCardOrderItemResponse.Data == null)
                throw new ArgumentNullException(nameof(paginatedGetCardOrderItemResponse.Data), "Property is required for class PaginatedGetCardOrderItemResponse.");
