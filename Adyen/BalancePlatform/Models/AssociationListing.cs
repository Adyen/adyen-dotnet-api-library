    ...
    public class AssociationListingJsonConverter : JsonConverter<AssociationListing>
    {
        ...
        public override AssociationListing Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (createdAt.IsSet && createdAt.Value == null)
                throw new ArgumentNullException(nameof(createdAt), "Property is not nullable for class AssociationListing.");

            if (entityId.IsSet && entityId.Value == null)
                throw new ArgumentNullException(nameof(entityId), "Property is not nullable for class AssociationListing.");

            if (entityType.IsSet && entityType.Value == null)
                throw new ArgumentNullException(nameof(entityType), "Property is not nullable for class AssociationListing.");

            if (scaDeviceId.IsSet && scaDeviceId.Value == null)
                throw new ArgumentNullException(nameof(scaDeviceId), "Property is not nullable for class AssociationListing.");

            if (scaDeviceType.IsSet && scaDeviceType.Value == null)
                throw new ArgumentNullException(nameof(scaDeviceType), "Property is not nullable for class AssociationListing.");

            if (status.IsSet && status.Value == null)
                throw new ArgumentNullException(nameof(status), "Property is not nullable for class AssociationListing.");

            if (scaDeviceName.IsSet && scaDeviceName.Value == null)
                throw new ArgumentNullException(nameof(scaDeviceName), "Property is not nullable for class AssociationListing.");
        ...
        public void WriteProperties(Utf8JsonWriter writer, AssociationListing associationListing, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (associationListing.EntityId == null)
                throw new ArgumentNullException(nameof(associationListing.EntityId), "Property is required for class AssociationListing.");

            if (associationListing.ScaDeviceId == null)
                throw new ArgumentNullException(nameof(associationListing.ScaDeviceId), "Property is required for class AssociationListing.");

            if (associationListing._ScaDeviceNameOption.IsSet && associationListing.ScaDeviceName == null)
                throw new ArgumentNullException(nameof(associationListing.ScaDeviceName), "Property is required for class AssociationListing.");
