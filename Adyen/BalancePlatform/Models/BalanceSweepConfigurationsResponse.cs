...
namespace Adyen.BalancePlatform.Models
{
    ...
    /// <summary>
    /// A Json converter for type <see cref="BalanceSweepConfigurationsResponse" />
    /// </summary>
    public class BalanceSweepConfigurationsResponseJsonConverter : JsonConverter<BalanceSweepConfigurationsResponse>
    {
        /// <summary>
        /// Deserializes json to <see cref="BalanceSweepConfigurationsResponse"/>.
        /// </summary>
        ...
        public override BalanceSweepConfigurationsResponse Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            Option<List<SweepConfigurationV2>?> sweeps = default;
                ...
                if (utf8JsonReader.TokenType == JsonTokenType.PropertyName && currentDepth == utf8JsonReader.CurrentDepth - 1)
                {
                    ...
                    switch (jsonPropertyName)
                    {
                        ...
                        case "hasPrevious":
                            ...
                            break;
                        case "sweeps":
                            sweeps = new Option<List<SweepConfigurationV2>?>(JsonSerializer.Deserialize<List<SweepConfigurationV2>>(ref utf8JsonReader, jsonSerializerOptions)!);
                            break;
                        default:
                            break;
                    }
            ...
            if (hasNext.IsSet && hasNext.Value == null)
                throw new ArgumentNullException(nameof(hasNext), "Property is not nullable for class BalanceSweepConfigurationsResponse.");

            if (hasPrevious.IsSet && hasPrevious.Value == null)
                throw new ArgumentNullException(nameof(hasPrevious), "Property is not nullable for class BalanceSweepConfigurationsResponse.");

            if (sweeps.IsSet && sweeps.Value == null)
                throw new ArgumentNullException(nameof(sweeps), "Property is not nullable for class BalanceSweepConfigurationsResponse.");

            return new BalanceSweepConfigurationsResponse(hasNext.Value!.Value!, hasPrevious.Value!.Value!, sweeps.Value!);
        }

        /// <summary>
        /// Serializes a <see cref="BalanceSweepConfigurationsResponse"/>.
        /// </summary>
        ...
        public override void Write(Utf8JsonWriter writer, BalanceSweepConfigurationsResponse balanceSweepConfigurationsResponse, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            WriteProperties(writer, balanceSweepConfigurationsResponse, jsonSerializerOptions);
        ...
        /// <summary>
        /// Serializes the properties of <see cref="BalanceSweepConfigurationsResponse"/>.
        /// </summary>
        ...
        {
            /*
            if (balanceSweepConfigurationsResponse.Sweeps == null)
                throw new ArgumentNullException(nameof(balanceSweepConfigurationsResponse.Sweeps), "Property is required for class BalanceSweepConfigurationsResponse.");

            */
            
            writer.WriteBoolean("hasNext", balanceSweepConfigurationsResponse.HasNext);

            writer.WriteBoolean("hasPrevious", balanceSweepConfigurationsResponse.HasPrevious);

            writer.WritePropertyName("sweeps");
            JsonSerializer.Serialize(writer, balanceSweepConfigurationsResponse.Sweeps, jsonSerializerOptions);
        }
    }
}
