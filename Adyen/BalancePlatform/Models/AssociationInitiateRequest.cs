...
namespace Adyen.BalancePlatform.Models
{
    ...
    /// </summary>
    public partial class AssociationInitiateRequest : IValidatableObject
    {
        /// <summary>
        ...
        [JsonConstructor]
        public AssociationInitiateRequest(List<string> ids, TypeEnum type)
        {
            Ids = ids;
            Type = type;
            OnCreated();
    ...
    public class AssociationInitiateRequestJsonConverter : JsonConverter<AssociationInitiateRequest>
    {
        ...
        public override AssociationInitiateRequest Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (ids.IsSet && ids.Value == null)
                throw new ArgumentNullException(nameof(ids), "Property is not nullable for class AssociationInitiateRequest.");

            if (type.IsSet && type.Value == null)
                throw new ArgumentNullException(nameof(type), "Property is not nullable for class AssociationInitiateRequest.");
        ...
        {
            /*
            if (associationInitiateRequest.Ids == null)
                throw new ArgumentNullException(nameof(associationInitiateRequest.Ids), "Property is required for class AssociationInitiateRequest.");
