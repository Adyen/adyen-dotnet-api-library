    ...
    public class InternationalTransactionRestrictionJsonConverter : JsonConverter<InternationalTransactionRestriction>
    {
        ...
        public override InternationalTransactionRestriction Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (operation.IsSet && operation.Value == null)
                throw new ArgumentNullException(nameof(operation), "Property is not nullable for class InternationalTransactionRestriction.");

            if (value.IsSet && value.Value == null)
                throw new ArgumentNullException(nameof(value), "Property is not nullable for class InternationalTransactionRestriction.");
        ...
        public void WriteProperties(Utf8JsonWriter writer, InternationalTransactionRestriction internationalTransactionRestriction, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (internationalTransactionRestriction.Operation == null)
                throw new ArgumentNullException(nameof(internationalTransactionRestriction.Operation), "Property is required for class InternationalTransactionRestriction.");
