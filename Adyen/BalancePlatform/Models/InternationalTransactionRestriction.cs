...
namespace Adyen.BalancePlatform.Models
{
    ...
    /// </summary>
    [JsonConverter(typeof(InternationalTransactionRestrictionJsonConverter))]
    ...
    public class InternationalTransactionRestrictionJsonConverter : JsonConverter<InternationalTransactionRestriction>
    {
        ...
        public override InternationalTransactionRestriction Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            var internationalTransactionRestriction = new InternationalTransactionRestriction();
            internationalTransactionRestriction.Operation = operation.Value!;
            if (value.IsSet)
                internationalTransactionRestriction.Value = value.Value;
            return internationalTransactionRestriction;
        }
        ...
        public void WriteProperties(Utf8JsonWriter writer, InternationalTransactionRestriction internationalTransactionRestriction, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (internationalTransactionRestriction._ValueOption.IsSet)
                if (internationalTransactionRestriction._ValueOption.Value != null)
