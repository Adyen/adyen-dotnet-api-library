...
namespace Adyen.BalancePlatform.Models
{
    ...
    /// </summary>
    public partial class USInternationalAchAddressRequirement : IValidatableObject
    {
        /// <summary>
    ...
    /// <summary>
    /// A Json converter for type <see cref="USInternationalAchAddressRequirement" />
    /// </summary>
    public class USInternationalAchAddressRequirementJsonConverter : JsonConverter<USInternationalAchAddressRequirement>
    {
        /// <summary>
        /// Deserializes json to <see cref="USInternationalAchAddressRequirement"/>.
        /// </summary>
        /// <param name="utf8JsonReader"><see cref="Utf8JsonReader"/></param>
        /// <param name="typeToConvert"><see cref="Type"/></param>
        /// <param name="jsonSerializerOptions">The <see cref="JsonSerializerOptions"/>, initialized from <see cref="HostConfiguration"/>.</param>
        /// <returns><see cref="USInternationalAchAddressRequirement"/></returns>
        /// <exception cref="JsonException"></exception>
        public override USInternationalAchAddressRequirement Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            Option<USInternationalAchAddressRequirement.TypeEnum?> type = default;
            ...
            if (description.IsSet && description.Value == null)
                throw new ArgumentNullException(nameof(description), "Property is not nullable for class USInternationalAchAddressRequirement.");

            if (type.IsSet && type.Value == null)
                throw new ArgumentNullException(nameof(type), "Property is not nullable for class USInternationalAchAddressRequirement.");

            return new USInternationalAchAddressRequirement(description, type.Value!.Value!);
        }

        /// <summary>
        /// Serializes a <see cref="USInternationalAchAddressRequirement"/>.
        /// </summary>
        /// <param name="writer"><see cref="Utf8JsonWriter"/></param>
        /// <param name="uSInternationalAchAddressRequirement"></param>
        /// <param name="jsonSerializerOptions"><see cref="JsonSerializerOptions"/></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, USInternationalAchAddressRequirement uSInternationalAchAddressRequirement, JsonSerializerOptions jsonSerializerOptions)
        {
            
            writer.WriteStartObject();
            
            WriteProperties(writer, uSInternationalAchAddressRequirement, jsonSerializerOptions);
        ...
        /// <summary>
        /// Serializes the properties of <see cref="USInternationalAchAddressRequirement"/>.
        /// </summary>
        /// <param name="writer"><see creft="Utf8JsonWriter"/></param>
        /// <param name="uSInternationalAchAddressRequirement"></param>
        /// <param name="jsonSerializerOptions"><see cref="JsonSerializerOptions"/></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, USInternationalAchAddressRequirement uSInternationalAchAddressRequirement, JsonSerializerOptions jsonSerializerOptions)
        {
            /*
            if (uSInternationalAchAddressRequirement._DescriptionOption.IsSet && uSInternationalAchAddressRequirement.Description == null)
                throw new ArgumentNullException(nameof(uSInternationalAchAddressRequirement.Description), "Property is required for class USInternationalAchAddressRequirement.");

            */
            
            if (uSInternationalAchAddressRequirement._DescriptionOption.IsSet)
                writer.WriteString("description", uSInternationalAchAddressRequirement.Description);

            if (uSInternationalAchAddressRequirement.Type != null) 
            {
                string? typeRawValue = USInternationalAchAddressRequirement.TypeEnum.ToJsonValue(uSInternationalAchAddressRequirement.Type);
