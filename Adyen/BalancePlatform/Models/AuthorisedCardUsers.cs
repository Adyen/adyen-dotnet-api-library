...
namespace Adyen.BalancePlatform.Models
{
    ...
    /// AuthorisedCardUsers.
    /// </summary>
    public partial class AuthorisedCardUsers : IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Used to track the state of LegalEntityIds
        /// </summary>
        [JsonIgnore]
        [global::System.ComponentModel.EditorBrowsable(global::System.ComponentModel.EditorBrowsableState.Never)]
        public Option<List<string>?> _LegalEntityIdsOption { get; private set; }
        ...
        public List<string>? LegalEntityIds { get { return this._LegalEntityIdsOption; } set { this._LegalEntityIdsOption = new(value); } }
    ...
    /// <summary>
    /// A Json converter for type <see cref="AuthorisedCardUsers" />
    /// </summary>
    public class AuthorisedCardUsersJsonConverter : JsonConverter<AuthorisedCardUsers>
    {
        /// <summary>
        /// Deserializes json to <see cref="AuthorisedCardUsers"/>.
        /// </summary>
        ...
        public override AuthorisedCardUsers Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            Option<List<string>?> legalEntityIds = default;
            ...
            while (utf8JsonReader.Read())
            {
                ...
                if (utf8JsonReader.TokenType == JsonTokenType.PropertyName && currentDepth == utf8JsonReader.CurrentDepth - 1)
                {
                    ...
                    {
                        case "legalEntityIds":
                            legalEntityIds = new Option<List<string>?>(JsonSerializer.Deserialize<List<string>>(ref utf8JsonReader, jsonSerializerOptions)!);
                            break;
                        default:
                            break;
                    }
            ...
            if (legalEntityIds.IsSet && legalEntityIds.Value == null)
                throw new ArgumentNullException(nameof(legalEntityIds), "Property is not nullable for class AuthorisedCardUsers.");

            return new AuthorisedCardUsers(legalEntityIds);
        }

        /// <summary>
        /// Serializes a <see cref="AuthorisedCardUsers"/>.
        /// </summary>
        /// <param name="writer"><see cref="Utf8JsonWriter"/></param>
        /// <param name="authorisedCardUsers"></param>
        /// <param name="jsonSerializerOptions"><see cref="JsonSerializerOptions"/></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, AuthorisedCardUsers authorisedCardUsers, JsonSerializerOptions jsonSerializerOptions)
        {
            
            writer.WriteStartObject();
            
            WriteProperties(writer, authorisedCardUsers, jsonSerializerOptions);
        ...
        /// <summary>
        /// Serializes the properties of <see cref="AuthorisedCardUsers"/>.
        /// </summary>
        /// <param name="writer"><see creft="Utf8JsonWriter"/></param>
        /// <param name="authorisedCardUsers"></param>
        /// <param name="jsonSerializerOptions"><see cref="JsonSerializerOptions"/></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, AuthorisedCardUsers authorisedCardUsers, JsonSerializerOptions jsonSerializerOptions)
        {
            /*
            if (authorisedCardUsers._LegalEntityIdsOption.IsSet && authorisedCardUsers.LegalEntityIds == null)
                throw new ArgumentNullException(nameof(authorisedCardUsers.LegalEntityIds), "Property is required for class AuthorisedCardUsers.");

            */
            
            if (authorisedCardUsers._LegalEntityIdsOption.IsSet)
            {
                writer.WritePropertyName("legalEntityIds");
                JsonSerializer.Serialize(writer, authorisedCardUsers.LegalEntityIds, jsonSerializerOptions);
            }
        }
    }
}
