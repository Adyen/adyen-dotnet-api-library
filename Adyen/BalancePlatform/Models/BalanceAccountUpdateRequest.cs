...
namespace Adyen.BalancePlatform.Models
{
    ...
    /// </summary>
    [JsonConverter(typeof(BalanceAccountUpdateRequestJsonConverter))]
    ...
    public class BalanceAccountUpdateRequestJsonConverter : JsonConverter<BalanceAccountUpdateRequest>
    {
        ...
        public override BalanceAccountUpdateRequest Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            var balanceAccountUpdateRequest = new BalanceAccountUpdateRequest();
            if (accountHolderId.IsSet)
                balanceAccountUpdateRequest.AccountHolderId = accountHolderId.Value;
            if (description.IsSet)
                balanceAccountUpdateRequest.Description = description.Value;
            if (metadata.IsSet)
                balanceAccountUpdateRequest.Metadata = metadata.Value;
            if (platformPaymentConfiguration.IsSet)
                balanceAccountUpdateRequest.PlatformPaymentConfiguration = platformPaymentConfiguration.Value;
            if (reference.IsSet)
                balanceAccountUpdateRequest.Reference = reference.Value;
            if (status.IsSet)
                balanceAccountUpdateRequest.Status = status.Value;
            if (timeZone.IsSet)
                balanceAccountUpdateRequest.TimeZone = timeZone.Value;
            return balanceAccountUpdateRequest;
        }
