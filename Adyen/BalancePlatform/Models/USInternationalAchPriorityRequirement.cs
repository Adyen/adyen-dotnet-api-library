    ...
    public class USInternationalAchPriorityRequirementJsonConverter : JsonConverter<USInternationalAchPriorityRequirement>
    {
        ...
        public override USInternationalAchPriorityRequirement Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (description.IsSet && description.Value == null)
                throw new ArgumentNullException(nameof(description), "Property is not nullable for class USInternationalAchPriorityRequirement.");

            if (type.IsSet && type.Value == null)
                throw new ArgumentNullException(nameof(type), "Property is not nullable for class USInternationalAchPriorityRequirement.");
        ...
        {
            /*
            if (uSInternationalAchPriorityRequirement._DescriptionOption.IsSet && uSInternationalAchPriorityRequirement.Description == null)
                throw new ArgumentNullException(nameof(uSInternationalAchPriorityRequirement.Description), "Property is required for class USInternationalAchPriorityRequirement.");
