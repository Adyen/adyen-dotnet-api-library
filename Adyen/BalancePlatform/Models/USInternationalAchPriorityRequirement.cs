...
namespace Adyen.BalancePlatform.Models
{
    ...
    /// </summary>
    [JsonConverter(typeof(USInternationalAchPriorityRequirementJsonConverter))]
    public partial class USInternationalAchPriorityRequirement
    {
        /// <summary>
                ...
                if (utf8JsonReader.TokenType == JsonTokenType.PropertyName && currentDepth == utf8JsonReader.CurrentDepth - 1)
                {
                    ...
                    switch (jsonPropertyName)
                    {
                        ...
                        case "type":
                            ...
                            type = new Option<USInternationalAchPriorityRequirement.TypeEnum?>(USInternationalAchPriorityRequirement.TypeEnum.FromStringOrDefault(typeRawValue) ?? (USInternationalAchPriorityRequirement.TypeEnum)typeRawValue);
                            break;
                        default:
                            break;
                    }
