    ...
    public class PaginatedGetCardOrderResponseJsonConverter : JsonConverter<PaginatedGetCardOrderResponse>
    {
        ...
        public override PaginatedGetCardOrderResponse Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (hasNext.IsSet && hasNext.Value == null)
                throw new ArgumentNullException(nameof(hasNext), "Property is not nullable for class PaginatedGetCardOrderResponse.");

            if (hasPrevious.IsSet && hasPrevious.Value == null)
                throw new ArgumentNullException(nameof(hasPrevious), "Property is not nullable for class PaginatedGetCardOrderResponse.");

            if (cardOrders.IsSet && cardOrders.Value == null)
                throw new ArgumentNullException(nameof(cardOrders), "Property is not nullable for class PaginatedGetCardOrderResponse.");
        ...
        {
            /*
            if (paginatedGetCardOrderResponse._CardOrdersOption.IsSet && paginatedGetCardOrderResponse.CardOrders == null)
                throw new ArgumentNullException(nameof(paginatedGetCardOrderResponse.CardOrders), "Property is required for class PaginatedGetCardOrderResponse.");
