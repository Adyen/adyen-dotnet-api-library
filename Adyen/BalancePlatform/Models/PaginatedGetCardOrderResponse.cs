...
namespace Adyen.BalancePlatform.Models
{
    ...
    /// </summary>
    [JsonConverter(typeof(PaginatedGetCardOrderResponseJsonConverter))]
    public partial class PaginatedGetCardOrderResponse
    {
        ...
        /// <summary>
        /// This is used to track if an optional field is set. If set, <see cref="CardOrders"/> will be populated.
        /// </summary>
        [JsonIgnore]
    ...
    public class PaginatedGetCardOrderResponseJsonConverter : JsonConverter<PaginatedGetCardOrderResponse>
    {
        ...
        public override PaginatedGetCardOrderResponse Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            var paginatedGetCardOrderResponse = new PaginatedGetCardOrderResponse();
            paginatedGetCardOrderResponse.HasNext = hasNext.Value!.Value;
            paginatedGetCardOrderResponse.HasPrevious = hasPrevious.Value!.Value;
            if (cardOrders.IsSet)
                paginatedGetCardOrderResponse.CardOrders = cardOrders.Value;
            return paginatedGetCardOrderResponse;
        }
