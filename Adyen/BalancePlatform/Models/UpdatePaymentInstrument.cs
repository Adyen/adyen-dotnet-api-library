...
namespace Adyen.BalancePlatform.Models
{
    ...
    /// </summary>
    [JsonConverter(typeof(UpdatePaymentInstrumentJsonConverter))]
    ...
    public class UpdatePaymentInstrumentJsonConverter : JsonConverter<UpdatePaymentInstrument>
    {
        ...
        public override UpdatePaymentInstrument Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
                ...
                if (utf8JsonReader.TokenType == JsonTokenType.PropertyName && currentDepth == utf8JsonReader.CurrentDepth - 1)
                {
                    ...
                    switch (jsonPropertyName)
                    {
                        ...
                        case "type":
                            ...
                            type = new Option<UpdatePaymentInstrument.TypeEnum?>(UpdatePaymentInstrument.TypeEnum.FromStringOrDefault(typeRawValue) ?? (UpdatePaymentInstrument.TypeEnum)typeRawValue);
                            break;
                        ...
                        case "status":
                            ...
                            status = new Option<UpdatePaymentInstrument.StatusEnum?>(UpdatePaymentInstrument.StatusEnum.FromStringOrDefault(statusRawValue) ?? (UpdatePaymentInstrument.StatusEnum)statusRawValue);
                            break;
                        case "statusComment":
                        ...
                        case "statusReason":
                            ...
                            statusReason = new Option<UpdatePaymentInstrument.StatusReasonEnum?>(UpdatePaymentInstrument.StatusReasonEnum.FromStringOrDefault(statusReasonRawValue) ?? (UpdatePaymentInstrument.StatusReasonEnum)statusReasonRawValue);
                            break;
                        default:
                            break;
                    }
            ...
            if (bankAccount.IsSet)
                updatePaymentInstrument.BankAccount = bankAccount.Value;
            if (card.IsSet)
                updatePaymentInstrument.Card = card.Value;
            if (description.IsSet)
                updatePaymentInstrument.Description = description.Value;
            if (paymentInstrumentGroupId.IsSet)
                updatePaymentInstrument.PaymentInstrumentGroupId = paymentInstrumentGroupId.Value;
            if (reference.IsSet)
                updatePaymentInstrument.Reference = reference.Value;
            if (replacedById.IsSet)
                updatePaymentInstrument.ReplacedById = replacedById.Value;
            if (replacementOfId.IsSet)
                updatePaymentInstrument.ReplacementOfId = replacementOfId.Value;
            if (status.IsSet)
                updatePaymentInstrument.Status = status.Value;
            if (statusComment.IsSet)
                updatePaymentInstrument.StatusComment = statusComment.Value;
            if (statusReason.IsSet)
                updatePaymentInstrument.StatusReason = statusReason.Value;
