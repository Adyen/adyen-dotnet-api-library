    ...
    public class LinkJsonConverter : JsonConverter<Link>
    {
        ...
        public override Link Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (first.IsSet && first.Value == null)
                throw new ArgumentNullException(nameof(first), "Property is not nullable for class Link.");

            if (last.IsSet && last.Value == null)
                throw new ArgumentNullException(nameof(last), "Property is not nullable for class Link.");

            if (next.IsSet && next.Value == null)
                throw new ArgumentNullException(nameof(next), "Property is not nullable for class Link.");

            if (previous.IsSet && previous.Value == null)
                throw new ArgumentNullException(nameof(previous), "Property is not nullable for class Link.");

            if (self.IsSet && self.Value == null)
                throw new ArgumentNullException(nameof(self), "Property is not nullable for class Link.");
        ...
        {
            /*
            if (link._FirstOption.IsSet && link.First == null)
                throw new ArgumentNullException(nameof(link.First), "Property is required for class Link.");

            if (link._LastOption.IsSet && link.Last == null)
                throw new ArgumentNullException(nameof(link.Last), "Property is required for class Link.");

            if (link._NextOption.IsSet && link.Next == null)
                throw new ArgumentNullException(nameof(link.Next), "Property is required for class Link.");

            if (link._PreviousOption.IsSet && link.Previous == null)
                throw new ArgumentNullException(nameof(link.Previous), "Property is required for class Link.");

            if (link._SelfOption.IsSet && link.Self == null)
                throw new ArgumentNullException(nameof(link.Self), "Property is required for class Link.");
