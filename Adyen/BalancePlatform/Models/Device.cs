    ...
    public class DeviceJsonConverter : JsonConverter<Device>
    {
        ...
        public override Device Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (id.IsSet && id.Value == null)
                throw new ArgumentNullException(nameof(id), "Property is not nullable for class Device.");

            if (name.IsSet && name.Value == null)
                throw new ArgumentNullException(nameof(name), "Property is not nullable for class Device.");

            if (paymentInstrumentId.IsSet && paymentInstrumentId.Value == null)
                throw new ArgumentNullException(nameof(paymentInstrumentId), "Property is not nullable for class Device.");
        ...
        {
            /*
            if (device._IdOption.IsSet && device.Id == null)
                throw new ArgumentNullException(nameof(device.Id), "Property is required for class Device.");

            if (device._NameOption.IsSet && device.Name == null)
                throw new ArgumentNullException(nameof(device.Name), "Property is required for class Device.");

            if (device._PaymentInstrumentIdOption.IsSet && device.PaymentInstrumentId == null)
                throw new ArgumentNullException(nameof(device.PaymentInstrumentId), "Property is required for class Device.");
