...
namespace Adyen.BalancePlatform.Models
{
    ...
    public class PaginatedBalanceAccountsResponseJsonConverter : JsonConverter<PaginatedBalanceAccountsResponse>
    {
        ...
        public override PaginatedBalanceAccountsResponse Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (balanceAccounts.IsSet && balanceAccounts.Value == null)
                throw new ArgumentNullException(nameof(balanceAccounts), "Property is not nullable for class PaginatedBalanceAccountsResponse.");

            if (hasNext.IsSet && hasNext.Value == null)
                throw new ArgumentNullException(nameof(hasNext), "Property is not nullable for class PaginatedBalanceAccountsResponse.");

            if (hasPrevious.IsSet && hasPrevious.Value == null)
                throw new ArgumentNullException(nameof(hasPrevious), "Property is not nullable for class PaginatedBalanceAccountsResponse.");
        ...
        {
            /*
            if (paginatedBalanceAccountsResponse.BalanceAccounts == null)
                throw new ArgumentNullException(nameof(paginatedBalanceAccountsResponse.BalanceAccounts), "Property is required for class PaginatedBalanceAccountsResponse.");
