    ...
    public class CapitalBalanceJsonConverter : JsonConverter<CapitalBalance>
    {
        ...
        public override CapitalBalance Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (currency.IsSet && currency.Value == null)
                throw new ArgumentNullException(nameof(currency), "Property is not nullable for class CapitalBalance.");

            if (fee.IsSet && fee.Value == null)
                throw new ArgumentNullException(nameof(fee), "Property is not nullable for class CapitalBalance.");

            if (principal.IsSet && principal.Value == null)
                throw new ArgumentNullException(nameof(principal), "Property is not nullable for class CapitalBalance.");

            if (total.IsSet && total.Value == null)
                throw new ArgumentNullException(nameof(total), "Property is not nullable for class CapitalBalance.");
        ...
        public void WriteProperties(Utf8JsonWriter writer, CapitalBalance capitalBalance, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (capitalBalance.Currency == null)
                throw new ArgumentNullException(nameof(capitalBalance.Currency), "Property is required for class CapitalBalance.");
