    ...
    public class RevealPinResponseJsonConverter : JsonConverter<RevealPinResponse>
    {
        ...
        public override RevealPinResponse Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (encryptedPinBlock.IsSet && encryptedPinBlock.Value == null)
                throw new ArgumentNullException(nameof(encryptedPinBlock), "Property is not nullable for class RevealPinResponse.");

            if (token.IsSet && token.Value == null)
                throw new ArgumentNullException(nameof(token), "Property is not nullable for class RevealPinResponse.");
        ...
        public void WriteProperties(Utf8JsonWriter writer, RevealPinResponse revealPinResponse, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (revealPinResponse.EncryptedPinBlock == null)
                throw new ArgumentNullException(nameof(revealPinResponse.EncryptedPinBlock), "Property is required for class RevealPinResponse.");

            if (revealPinResponse.Token == null)
                throw new ArgumentNullException(nameof(revealPinResponse.Token), "Property is required for class RevealPinResponse.");
