...
namespace Adyen.BalancePlatform.Models
{
    ...
    /// </summary>
    public partial class AssociationInitiateResponse : IValidatableObject
    {
        /// <summary>
    ...
    public class AssociationInitiateResponseJsonConverter : JsonConverter<AssociationInitiateResponse>
    {
        ...
        public override AssociationInitiateResponse Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (sdkInput.IsSet && sdkInput.Value == null)
                throw new ArgumentNullException(nameof(sdkInput), "Property is not nullable for class AssociationInitiateResponse.");

            return new AssociationInitiateResponse(sdkInput);
        }
        ...
        {
            /*
            if (associationInitiateResponse._SdkInputOption.IsSet && associationInitiateResponse.SdkInput == null)
                throw new ArgumentNullException(nameof(associationInitiateResponse.SdkInput), "Property is required for class AssociationInitiateResponse.");
