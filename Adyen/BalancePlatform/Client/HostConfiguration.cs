...
namespace Adyen.BalancePlatform.Client
{
    ...
    public class HostConfiguration
    {
        ...
        /// </summary>
        public static string RELATIVE_URL = "/bcl/v2";
        ...
        public HostConfiguration AddBalancePlatformHttpClients(Action<System.Net.Http.HttpClient>? clientAction = null, Action<IHttpClientBuilder>? builderAction = null)
        {
            ...
            builders.Add(_services.AddHttpClient<IAccountHoldersService, AccountHoldersService>(clientAction));
            builders.Add(_services.AddHttpClient<IAuthorizedCardUsersService, AuthorizedCardUsersService>(clientAction));
            builders.Add(_services.AddHttpClient<IBalanceAccountsService, BalanceAccountsService>(clientAction));
            builders.Add(_services.AddHttpClient<IBalancesService, BalancesService>(clientAction));
            builders.Add(_services.AddHttpClient<IBankAccountValidationService, BankAccountValidationService>(clientAction));
            builders.Add(_services.AddHttpClient<ICardOrdersService, CardOrdersService>(clientAction));
            builders.Add(_services.AddHttpClient<IGrantAccountsService, GrantAccountsService>(clientAction));
            builders.Add(_services.AddHttpClient<IGrantOffersService, GrantOffersService>(clientAction));
            builders.Add(_services.AddHttpClient<IManageCardPINService, ManageCardPINService>(clientAction));
            builders.Add(_services.AddHttpClient<IManageSCADevicesService, ManageSCADevicesService>(clientAction));
            builders.Add(_services.AddHttpClient<INetworkTokensService, NetworkTokensService>(clientAction));
            builders.Add(_services.AddHttpClient<IPaymentInstrumentGroupsService, PaymentInstrumentGroupsService>(clientAction));
            builders.Add(_services.AddHttpClient<IPaymentInstrumentsService, PaymentInstrumentsService>(clientAction));
            builders.Add(_services.AddHttpClient<IPlatformService, PlatformService>(clientAction));
            builders.Add(_services.AddHttpClient<ISCAAssociationManagementService, SCAAssociationManagementService>(clientAction));
            builders.Add(_services.AddHttpClient<ISCADeviceManagementService, SCADeviceManagementService>(clientAction));
            builders.Add(_services.AddHttpClient<ITransactionRulesService, TransactionRulesService>(clientAction));
            builders.Add(_services.AddHttpClient<ITransferLimitsBalanceAccountLevelService, TransferLimitsBalanceAccountLevelService>(clientAction));
            builders.Add(_services.AddHttpClient<ITransferLimitsBalancePlatformLevelService, TransferLimitsBalancePlatformLevelService>(clientAction));
            builders.Add(_services.AddHttpClient<ITransferRoutesService, TransferRoutesService>(clientAction));
