...
namespace Adyen.BalancePlatform.Services
{
    ...
    public interface ISCAAssociationManagementService : IAdyenApiService
    {
        ...
        /// </remarks>
        /// <exception cref="ApiException">Thrown when fails to make API call.</exception>
        /// <param name="entityType">The type of entity you want to retrieve a list of associations for.   Possible values: **accountHolder**, **legalEntity** or **paymentInstrument**.</param>
    ...
    public sealed partial class SCAAssociationManagementService : ISCAAssociationManagementService
    {
        ...
        /// </summary>
        public SCAAssociationManagementService(AdyenOptionsProvider adyenOptionsProvider, ILogger<SCAAssociationManagementService> logger, ILoggerFactory loggerFactory, System.Net.Http.HttpClient httpClient, JsonSerializerOptionsProvider jsonSerializerOptionsProvider, ITokenProvider<ApiKeyToken> apiKeyProvider, SCAAssociationManagementServiceEvents sCAAssociationManagementServiceEvents = null)
        {
            _jsonSerializerOptions = jsonSerializerOptionsProvider.Options;
            LoggerFactory = loggerFactory;
            Logger = logger ?? Microsoft.Extensions.Logging.Abstractions.NullLogger<SCAAssociationManagementService>.Instance;
