...
namespace Adyen.BalancePlatform.Services
{
    ...
    /// </summary>
    public interface ITransferRoutesService : IAdyenApiService
    {
        /// <summary>
        /// The class containing the events.
        /// </summary>
        TransferRoutesServiceEvents Events { get; }
        ...
        /// <returns><see cref="Task"/>&lt;<see cref="ICalculateTransferRoutesApiResponse"/>&gt;</returns>
        Task<ICalculateTransferRoutesApiResponse> CalculateTransferRoutesAsync(Option<TransferRouteRequest> transferRouteRequest = default, System.Threading.CancellationToken cancellationToken = default);
    ...
    /// Represents a collection of functions to interact with the API endpoints.
    /// </summary>
    public class TransferRoutesServiceEvents
    {
        /// <summary>
        /// The event raised after the server response.
        /// </summary>
        public event EventHandler<ApiResponseEventArgs>? OnCalculateTransferRoutes;

        /// <summary>
        /// The event raised after an error querying the server.
        /// </summary>
        public event EventHandler<ExceptionEventArgs>? OnErrorCalculateTransferRoutes;

        internal void ExecuteOnCalculateTransferRoutes(TransferRoutesService.CalculateTransferRoutesApiResponse apiResponse)
        {
            OnCalculateTransferRoutes?.Invoke(this, new ApiResponseEventArgs(apiResponse));
        }

        internal void ExecuteOnErrorCalculateTransferRoutes(Exception exception)
        {
            OnErrorCalculateTransferRoutes?.Invoke(this, new ExceptionEventArgs(exception));
        }
    }
    ...
    /// Represents a collection of functions to interact with the API endpoints.
    /// </summary>
    public sealed partial class TransferRoutesService : ITransferRoutesService
    {
        ...
        /// The logger.
        /// </summary>
        public ILogger<TransferRoutesService> Logger { get; }
        ...
        /// The class containing the events.
        /// </summary>
        public TransferRoutesServiceEvents Events { get; }
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="TransferRoutesService"/> class.
        /// </summary>
        /// <returns></returns>
        public TransferRoutesService(ILogger<TransferRoutesService> logger, ILoggerFactory loggerFactory, System.Net.Http.HttpClient httpClient, JsonSerializerOptionsProvider jsonSerializerOptionsProvider, TransferRoutesServiceEvents transferRoutesServiceEvents,
            ITokenProvider<ApiKeyToken> apiKeyProvider)
        {
            _jsonSerializerOptions = jsonSerializerOptionsProvider.Options;
            LoggerFactory = loggerFactory;
            Logger = LoggerFactory.CreateLogger<TransferRoutesService>();
            HttpClient = httpClient;
            Events = transferRoutesServiceEvents;
            ApiKeyProvider = apiKeyProvider;
        }

        partial void FormatCalculateTransferRoutes(Option<TransferRouteRequest> transferRouteRequest);
        ...
        /// <returns></returns>
        private void ValidateCalculateTransferRoutes(Option<TransferRouteRequest> transferRouteRequest)
        {
            if (transferRouteRequest.IsSet && transferRouteRequest.Value == null)
                throw new ArgumentNullException(nameof(transferRouteRequest));
        }
        ...
        /// <param name="transferRouteRequest"></param>
        private void AfterCalculateTransferRoutesDefaultImplementation(ICalculateTransferRoutesApiResponse apiResponse, Option<TransferRouteRequest> transferRouteRequest)
        {
            bool suppressDefaultLog = false;
            AfterCalculateTransferRoutes(ref suppressDefaultLog, apiResponse, transferRouteRequest);
        ...
        /// <param name="apiResponse"></param>
        /// <param name="transferRouteRequest"></param>
        partial void AfterCalculateTransferRoutes(ref bool suppressDefaultLog, ICalculateTransferRoutesApiResponse apiResponse, Option<TransferRouteRequest> transferRouteRequest);
        ...
        /// <param name="transferRouteRequest"></param>
        private void OnErrorCalculateTransferRoutesDefaultImplementation(Exception exception, string pathFormat, string path, Option<TransferRouteRequest> transferRouteRequest)
        {
            bool suppressDefaultLog = false;
            OnErrorCalculateTransferRoutes(ref suppressDefaultLog, exception, pathFormat, path, transferRouteRequest);
            if (!suppressDefaultLog)
        ...
        /// <param name="path"></param>
        /// <param name="transferRouteRequest"></param>
        partial void OnErrorCalculateTransferRoutes(ref bool suppressDefaultLog, Exception exception, string pathFormat, string path, Option<TransferRouteRequest> transferRouteRequest);
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns><see cref="Task"/>&lt;<see cref="ICalculateTransferRoutesApiResponse"/>&gt;</returns>
        public async Task<ICalculateTransferRoutesApiResponse> CalculateTransferRoutesAsync(Option<TransferRouteRequest> transferRouteRequest = default, System.Threading.CancellationToken cancellationToken = default)
        {
            UriBuilder uriBuilder = new UriBuilder();

            try
            {
                ValidateCalculateTransferRoutes(transferRouteRequest);

                FormatCalculateTransferRoutes(transferRouteRequest);
                ...
                using (HttpRequestMessage httpRequestMessage = new HttpRequestMessage())
                {
                    ...
                    uriBuilder.Path = HttpClient.BaseAddress.AbsolutePath == "/"
                        ...
                        : string.Concat(HttpClient.BaseAddress.AbsolutePath, "/transferRoutes/calculate");
                    ...
                    {
                        ILogger<CalculateTransferRoutesApiResponse> apiResponseLogger = LoggerFactory.CreateLogger<CalculateTransferRoutesApiResponse>();
                        CalculateTransferRoutesApiResponse apiResponse;
                        ...
                        switch ((int)httpResponseMessage.StatusCode) {
                            default: {
                                ...
                                apiResponse = new(apiResponseLogger, httpRequestMessage, httpResponseMessage, responseContent, "/transferRoutes/calculate", requestedAt, _jsonSerializerOptions);

                                break;
                            }
                        }

                        AfterCalculateTransferRoutesDefaultImplementation(apiResponse, transferRouteRequest);

                        Events.ExecuteOnCalculateTransferRoutes(apiResponse);
            ...
            {
                OnErrorCalculateTransferRoutesDefaultImplementation(e, "/transferRoutes/calculate", uriBuilder.Path, transferRouteRequest);
                Events.ExecuteOnErrorCalculateTransferRoutes(e);
                throw;
            }
        }

        /// <summary>
        /// The <see cref="CalculateTransferRoutesApiResponse"/>.
        /// </summary>
        public partial class CalculateTransferRoutesApiResponse : Adyen.Core.Client.ApiResponse, ICalculateTransferRoutesApiResponse
        {
            /// <summary>
            /// The logger for <see cref="CalculateTransferRoutesApiResponse"/>.
            /// </summary>
            public ILogger<CalculateTransferRoutesApiResponse> Logger { get; }
            ...
            public CalculateTransferRoutesApiResponse(ILogger<CalculateTransferRoutesApiResponse> logger, System.Net.Http.HttpRequestMessage httpRequestMessage, System.Net.Http.HttpResponseMessage httpResponseMessage, string rawContent, string path, DateTime requestedAt, System.Text.Json.JsonSerializerOptions jsonSerializerOptions) : base(httpRequestMessage, httpResponseMessage, rawContent, path, requestedAt, jsonSerializerOptions)
            {
                Logger = logger;
            ...
            /// </summary>
            /// <returns></returns>
            public Adyen.BalancePlatform.Models.TransferRouteResponse? Ok()
            {
                // This logic may be modified with the AsModel.mustache template
                return IsOk
                    ? System.Text.Json.JsonSerializer.Deserialize<Adyen.BalancePlatform.Models.TransferRouteResponse>(RawContent, _jsonSerializerOptions)
                    : null;
            }
            ...
            /// <returns></returns>
            public bool TryDeserializeOkResponse([NotNullWhen(true)]out Adyen.BalancePlatform.Models.TransferRouteResponse? result)
            {
                result = null;
