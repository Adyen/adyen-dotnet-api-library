...
namespace Adyen.PosMobile.Extensions
{
    ...
    {
        /// <summary>
        /// Add the Adyen PosMobile API services to your <see cref="IServiceCollection"/>.
        /// </summary>
        ...
        public static void AddPosMobileServices(this IServiceCollection services, Action<HostConfiguration> hostConfigurationOptions, Action<System.Net.Http.HttpClient>? httpClientOptions = null, Action<IHttpClientBuilder>? httpClientBuilderOptions = null)
        {
            HostConfiguration hostConfiguration = new(services);
            hostConfigurationOptions(hostConfiguration);
            hostConfiguration.AddPosMobileHttpClients(httpClientOptions, httpClientBuilderOptions);
        }
    }
}
