...
namespace Adyen.PosMobile.Models
{
    ...
    /// </summary>
    [JsonConverter(typeof(CreateSessionResponseJsonConverter))]
    public partial class CreateSessionResponse
    {
        ...
        /// <summary>
        /// This is used to track if an optional field is set. If set, <see cref="InstallationId"/> will be populated.
        /// </summary>
        [JsonIgnore]
        [global::System.ComponentModel.EditorBrowsable(global::System.ComponentModel.EditorBrowsableState.Never)]
    ...
    public class CreateSessionResponseJsonConverter : JsonConverter<CreateSessionResponse>
    {
        ...
        public override CreateSessionResponse Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (installationId.IsSet)
                createSessionResponse.InstallationId = installationId.Value;
            if (merchantAccount.IsSet)
                createSessionResponse.MerchantAccount = merchantAccount.Value;
            if (sdkData.IsSet)
                createSessionResponse.SdkData = sdkData.Value;
            if (store.IsSet)
                createSessionResponse.Store = store.Value;
