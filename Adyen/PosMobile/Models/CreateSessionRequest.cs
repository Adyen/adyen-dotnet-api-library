    ...
    public class CreateSessionRequestJsonConverter : JsonConverter<CreateSessionRequest>
    {
        ...
        public override CreateSessionRequest Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (merchantAccount.IsSet && merchantAccount.Value == null)
                throw new ArgumentNullException(nameof(merchantAccount), "Property is not nullable for class CreateSessionRequest.");

            if (setupToken.IsSet && setupToken.Value == null)
                throw new ArgumentNullException(nameof(setupToken), "Property is not nullable for class CreateSessionRequest.");

            if (store.IsSet && store.Value == null)
                throw new ArgumentNullException(nameof(store), "Property is not nullable for class CreateSessionRequest.");
        ...
        public void WriteProperties(Utf8JsonWriter writer, CreateSessionRequest createSessionRequest, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (createSessionRequest.MerchantAccount == null)
                throw new ArgumentNullException(nameof(createSessionRequest.MerchantAccount), "Property is required for class CreateSessionRequest.");

            if (createSessionRequest.SetupToken == null)
                throw new ArgumentNullException(nameof(createSessionRequest.SetupToken), "Property is required for class CreateSessionRequest.");

            if (createSessionRequest._StoreOption.IsSet && createSessionRequest.Store == null)
                throw new ArgumentNullException(nameof(createSessionRequest.Store), "Property is required for class CreateSessionRequest.");
