...
namespace Adyen.PosMobile.Services
{
    ...
    public interface IPosMobileService : IAdyenApiService
    {
        ...
        [Obsolete("Deprecated since POS Mobile API v68. Use POST [/auth/certificate](https://docs.adyen.com/api-explorer/softpos-configuration-api/latest/post/auth/certificate) to establish secure communications.")]
    ...
    public sealed partial class PosMobileService : IPosMobileService
    {
        ...
        /// </summary>
        public PosMobileService(AdyenOptionsProvider adyenOptionsProvider, ILogger<PosMobileService> logger, ILoggerFactory loggerFactory, System.Net.Http.HttpClient httpClient, JsonSerializerOptionsProvider jsonSerializerOptionsProvider, ITokenProvider<ApiKeyToken> apiKeyProvider, PosMobileServiceEvents posMobileServiceEvents = null)
        {
            _jsonSerializerOptions = jsonSerializerOptionsProvider.Options;
            LoggerFactory = loggerFactory;
            Logger = logger ?? Microsoft.Extensions.Logging.Abstractions.NullLogger<PosMobileService>.Instance;
