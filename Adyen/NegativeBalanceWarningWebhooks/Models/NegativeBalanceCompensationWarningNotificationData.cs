...
namespace Adyen.NegativeBalanceWarningWebhooks.Models
{
    ...
    /// </summary>
    public partial class NegativeBalanceCompensationWarningNotificationData : IValidatableObject
    {
        /// <summary>
    ...
    public class NegativeBalanceCompensationWarningNotificationDataJsonConverter : JsonConverter<NegativeBalanceCompensationWarningNotificationData>
    {
        ...
        public override NegativeBalanceCompensationWarningNotificationData Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (accountHolder.IsSet && accountHolder.Value == null)
                throw new ArgumentNullException(nameof(accountHolder), "Property is not nullable for class NegativeBalanceCompensationWarningNotificationData.");

            if (amount.IsSet && amount.Value == null)
                throw new ArgumentNullException(nameof(amount), "Property is not nullable for class NegativeBalanceCompensationWarningNotificationData.");

            if (balancePlatform.IsSet && balancePlatform.Value == null)
                throw new ArgumentNullException(nameof(balancePlatform), "Property is not nullable for class NegativeBalanceCompensationWarningNotificationData.");

            if (creationDate.IsSet && creationDate.Value == null)
                throw new ArgumentNullException(nameof(creationDate), "Property is not nullable for class NegativeBalanceCompensationWarningNotificationData.");

            if (id.IsSet && id.Value == null)
                throw new ArgumentNullException(nameof(id), "Property is not nullable for class NegativeBalanceCompensationWarningNotificationData.");

            if (liableBalanceAccountId.IsSet && liableBalanceAccountId.Value == null)
                throw new ArgumentNullException(nameof(liableBalanceAccountId), "Property is not nullable for class NegativeBalanceCompensationWarningNotificationData.");

            if (negativeBalanceSince.IsSet && negativeBalanceSince.Value == null)
                throw new ArgumentNullException(nameof(negativeBalanceSince), "Property is not nullable for class NegativeBalanceCompensationWarningNotificationData.");

            if (scheduledCompensationAt.IsSet && scheduledCompensationAt.Value == null)
                throw new ArgumentNullException(nameof(scheduledCompensationAt), "Property is not nullable for class NegativeBalanceCompensationWarningNotificationData.");
        ...
        {
            /*
            if (negativeBalanceCompensationWarningNotificationData._AccountHolderOption.IsSet && negativeBalanceCompensationWarningNotificationData.AccountHolder == null)
                throw new ArgumentNullException(nameof(negativeBalanceCompensationWarningNotificationData.AccountHolder), "Property is required for class NegativeBalanceCompensationWarningNotificationData.");

            if (negativeBalanceCompensationWarningNotificationData._AmountOption.IsSet && negativeBalanceCompensationWarningNotificationData.Amount == null)
                throw new ArgumentNullException(nameof(negativeBalanceCompensationWarningNotificationData.Amount), "Property is required for class NegativeBalanceCompensationWarningNotificationData.");

            if (negativeBalanceCompensationWarningNotificationData._BalancePlatformOption.IsSet && negativeBalanceCompensationWarningNotificationData.BalancePlatform == null)
                throw new ArgumentNullException(nameof(negativeBalanceCompensationWarningNotificationData.BalancePlatform), "Property is required for class NegativeBalanceCompensationWarningNotificationData.");

            if (negativeBalanceCompensationWarningNotificationData._IdOption.IsSet && negativeBalanceCompensationWarningNotificationData.Id == null)
                throw new ArgumentNullException(nameof(negativeBalanceCompensationWarningNotificationData.Id), "Property is required for class NegativeBalanceCompensationWarningNotificationData.");

            if (negativeBalanceCompensationWarningNotificationData._LiableBalanceAccountIdOption.IsSet && negativeBalanceCompensationWarningNotificationData.LiableBalanceAccountId == null)
                throw new ArgumentNullException(nameof(negativeBalanceCompensationWarningNotificationData.LiableBalanceAccountId), "Property is required for class NegativeBalanceCompensationWarningNotificationData.");
