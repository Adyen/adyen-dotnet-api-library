...
namespace Adyen.NegativeBalanceWarningWebhooks.Models
{
    ...
    /// </summary>
    [JsonConverter(typeof(NegativeBalanceCompensationWarningNotificationDataJsonConverter))]
    ...
    public class NegativeBalanceCompensationWarningNotificationDataJsonConverter : JsonConverter<NegativeBalanceCompensationWarningNotificationData>
    {
        ...
        public override NegativeBalanceCompensationWarningNotificationData Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (amount.IsSet)
                negativeBalanceCompensationWarningNotificationData.Amount = amount.Value;
            if (balancePlatform.IsSet)
                negativeBalanceCompensationWarningNotificationData.BalancePlatform = balancePlatform.Value;
            if (creationDate.IsSet)
                negativeBalanceCompensationWarningNotificationData.CreationDate = creationDate.Value;
            if (id.IsSet)
                negativeBalanceCompensationWarningNotificationData.Id = id.Value;
            if (liableBalanceAccountId.IsSet)
                negativeBalanceCompensationWarningNotificationData.LiableBalanceAccountId = liableBalanceAccountId.Value;
            if (negativeBalanceSince.IsSet)
                negativeBalanceCompensationWarningNotificationData.NegativeBalanceSince = negativeBalanceSince.Value;
            if (scheduledCompensationAt.IsSet)
                negativeBalanceCompensationWarningNotificationData.ScheduledCompensationAt = scheduledCompensationAt.Value;
            return negativeBalanceCompensationWarningNotificationData;
        }
