    ...
    public class NegativeBalanceCompensationWarningNotificationRequestJsonConverter : JsonConverter<NegativeBalanceCompensationWarningNotificationRequest>
    {
        ...
        public override NegativeBalanceCompensationWarningNotificationRequest Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (data.IsSet && data.Value == null)
                throw new ArgumentNullException(nameof(data), "Property is not nullable for class NegativeBalanceCompensationWarningNotificationRequest.");

            if (environment.IsSet && environment.Value == null)
                throw new ArgumentNullException(nameof(environment), "Property is not nullable for class NegativeBalanceCompensationWarningNotificationRequest.");

            if (type.IsSet && type.Value == null)
                throw new ArgumentNullException(nameof(type), "Property is not nullable for class NegativeBalanceCompensationWarningNotificationRequest.");

            if (timestamp.IsSet && timestamp.Value == null)
                throw new ArgumentNullException(nameof(timestamp), "Property is not nullable for class NegativeBalanceCompensationWarningNotificationRequest.");
        ...
        {
            /*
            if (negativeBalanceCompensationWarningNotificationRequest.Data == null)
                throw new ArgumentNullException(nameof(negativeBalanceCompensationWarningNotificationRequest.Data), "Property is required for class NegativeBalanceCompensationWarningNotificationRequest.");

            if (negativeBalanceCompensationWarningNotificationRequest.Environment == null)
                throw new ArgumentNullException(nameof(negativeBalanceCompensationWarningNotificationRequest.Environment), "Property is required for class NegativeBalanceCompensationWarningNotificationRequest.");
