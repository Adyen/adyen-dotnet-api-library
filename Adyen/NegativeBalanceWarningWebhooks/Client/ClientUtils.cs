...
using Models = Adyen.NegativeBalanceWarningWebhooks.Models;
...
namespace Adyen.NegativeBalanceWarningWebhooks.Client
{
    ...
    public static partial class ClientUtils
    {
        ...
        public static string? ParameterToString(object? obj, string? format = ISO8601_DATETIME_FORMAT)
        {
            ...
            if (obj is Models.NegativeBalanceCompensationWarningNotificationRequest.TypeEnum negativeBalanceCompensationWarningNotificationRequestTypeEnum)
                return Models.NegativeBalanceCompensationWarningNotificationRequest.TypeEnum.ToJsonValue(negativeBalanceCompensationWarningNotificationRequestTypeEnum);
