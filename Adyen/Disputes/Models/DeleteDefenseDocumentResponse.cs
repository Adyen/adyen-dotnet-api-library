...
namespace Adyen.Disputes.Models
{
    ...
    /// </summary>
    public partial class DeleteDefenseDocumentResponse : IValidatableObject
    {
        /// <summary>
    ...
    public class DeleteDefenseDocumentResponseJsonConverter : JsonConverter<DeleteDefenseDocumentResponse>
    {
        ...
        public override DeleteDefenseDocumentResponse Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (disputeServiceResult.IsSet && disputeServiceResult.Value == null)
                throw new ArgumentNullException(nameof(disputeServiceResult), "Property is not nullable for class DeleteDefenseDocumentResponse.");
        ...
        {
            /*
            if (deleteDefenseDocumentResponse.DisputeServiceResult == null)
                throw new ArgumentNullException(nameof(deleteDefenseDocumentResponse.DisputeServiceResult), "Property is required for class DeleteDefenseDocumentResponse.");
