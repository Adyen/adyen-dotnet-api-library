    ...
    public class DisputeServiceResultJsonConverter : JsonConverter<DisputeServiceResult>
    {
        ...
        public override DisputeServiceResult Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (success.IsSet && success.Value == null)
                throw new ArgumentNullException(nameof(success), "Property is not nullable for class DisputeServiceResult.");

            if (errorMessage.IsSet && errorMessage.Value == null)
                throw new ArgumentNullException(nameof(errorMessage), "Property is not nullable for class DisputeServiceResult.");
        ...
        {
            /*
            if (disputeServiceResult._ErrorMessageOption.IsSet && disputeServiceResult.ErrorMessage == null)
                throw new ArgumentNullException(nameof(disputeServiceResult.ErrorMessage), "Property is required for class DisputeServiceResult.");
