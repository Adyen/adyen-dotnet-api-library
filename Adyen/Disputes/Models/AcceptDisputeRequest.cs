    ...
    public class AcceptDisputeRequestJsonConverter : JsonConverter<AcceptDisputeRequest>
    {
        ...
        public override AcceptDisputeRequest Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (disputePspReference.IsSet && disputePspReference.Value == null)
                throw new ArgumentNullException(nameof(disputePspReference), "Property is not nullable for class AcceptDisputeRequest.");

            if (merchantAccountCode.IsSet && merchantAccountCode.Value == null)
                throw new ArgumentNullException(nameof(merchantAccountCode), "Property is not nullable for class AcceptDisputeRequest.");
        ...
        public void WriteProperties(Utf8JsonWriter writer, AcceptDisputeRequest acceptDisputeRequest, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (acceptDisputeRequest.DisputePspReference == null)
                throw new ArgumentNullException(nameof(acceptDisputeRequest.DisputePspReference), "Property is required for class AcceptDisputeRequest.");

            if (acceptDisputeRequest.MerchantAccountCode == null)
                throw new ArgumentNullException(nameof(acceptDisputeRequest.MerchantAccountCode), "Property is required for class AcceptDisputeRequest.");
