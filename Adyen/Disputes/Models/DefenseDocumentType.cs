...
namespace Adyen.Disputes.Models
{
    ...
    /// DefenseDocumentType.
    /// </summary>
    public partial class DefenseDocumentType : IValidatableObject
    {
        /// <summary>
    ...
    public class DefenseDocumentTypeJsonConverter : JsonConverter<DefenseDocumentType>
    {
        ...
        public override DefenseDocumentType Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (available.IsSet && available.Value == null)
                throw new ArgumentNullException(nameof(available), "Property is not nullable for class DefenseDocumentType.");

            if (defenseDocumentTypeCode.IsSet && defenseDocumentTypeCode.Value == null)
                throw new ArgumentNullException(nameof(defenseDocumentTypeCode), "Property is not nullable for class DefenseDocumentType.");

            if (requirementLevel.IsSet && requirementLevel.Value == null)
                throw new ArgumentNullException(nameof(requirementLevel), "Property is not nullable for class DefenseDocumentType.");
        ...
        public void WriteProperties(Utf8JsonWriter writer, DefenseDocumentType defenseDocumentType, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (defenseDocumentType.DefenseDocumentTypeCode == null)
                throw new ArgumentNullException(nameof(defenseDocumentType.DefenseDocumentTypeCode), "Property is required for class DefenseDocumentType.");

            if (defenseDocumentType.RequirementLevel == null)
                throw new ArgumentNullException(nameof(defenseDocumentType.RequirementLevel), "Property is required for class DefenseDocumentType.");
