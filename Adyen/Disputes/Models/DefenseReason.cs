...
namespace Adyen.Disputes.Models
{
    ...
    public class DefenseReasonJsonConverter : JsonConverter<DefenseReason>
    {
        ...
        public override DefenseReason Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (defenseReasonCode.IsSet && defenseReasonCode.Value == null)
                throw new ArgumentNullException(nameof(defenseReasonCode), "Property is not nullable for class DefenseReason.");

            if (satisfied.IsSet && satisfied.Value == null)
                throw new ArgumentNullException(nameof(satisfied), "Property is not nullable for class DefenseReason.");

            if (defenseDocumentTypes.IsSet && defenseDocumentTypes.Value == null)
                throw new ArgumentNullException(nameof(defenseDocumentTypes), "Property is not nullable for class DefenseReason.");
        ...
        public void WriteProperties(Utf8JsonWriter writer, DefenseReason defenseReason, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (defenseReason.DefenseReasonCode == null)
                throw new ArgumentNullException(nameof(defenseReason.DefenseReasonCode), "Property is required for class DefenseReason.");

            if (defenseReason._DefenseDocumentTypesOption.IsSet && defenseReason.DefenseDocumentTypes == null)
                throw new ArgumentNullException(nameof(defenseReason.DefenseDocumentTypes), "Property is required for class DefenseReason.");
