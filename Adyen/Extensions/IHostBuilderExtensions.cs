...
namespace Adyen.Extensions
{
    ...
    public static class IHostBuilderExtensions
    {
        ...
        public static IHostBuilder ConfigureCheckoutApi(this IHostBuilder builder, Action<HostBuilderContext, IServiceCollection, HostConfiguration> options)
        {
            builder.ConfigureServices((context, services) => 
            {
                ...
                IServiceCollectionExtensions.AddCheckoutApiServices(services, config);
            });
