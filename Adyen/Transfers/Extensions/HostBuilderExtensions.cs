...
namespace Adyen.Transfers.Extensions
{
    ...
    {
        /// <summary>
        /// Initializes the <see cref="HostConfiguration"/> *without* adding the Transfers API services defaults to the <see cref="IServiceCollection"/>.
        /// Use <see cref="Adyen.Transfers.Extensions.IServiceCollectionExtensions"/> to add the Transfers API services to the <see cref="IServiceCollection"/>.
        /// </summary>
        ...
        /// <summary>
        /// Initializes the <see cref="HostConfiguration"/> *and* adds the Transfers API services defaults to the <see cref="IServiceCollection"/>.
        ...
        /// <param name="httpClientOptions">Configures the <see cref="System.Net.Http.HttpClient"/>.</param>
        /// <param name="httpClientBuilderOptions">Configures the <see cref="IHttpClientBuilder"/>.</param>
        public static IHostBuilder ConfigureTransfersDefaults(this IHostBuilder hostBuilder, Action<HostBuilderContext, IServiceCollection, HostConfiguration> hostConfigurationOptions, ServiceLifetime serviceLifetime = ServiceLifetime.Singleton, Action<System.Net.Http.HttpClient>? httpClientOptions = null, Action<IHttpClientBuilder>? httpClientBuilderOptions = null)
        {
            hostBuilder.ConfigureServices((context, services) => 
            {
                HostConfiguration hostConfiguration = new HostConfiguration(services);
                ...
                hostConfigurationOptions(context, services, hostConfiguration);
                services.AddAllTransfersServices(serviceLifetime, httpClientOptions, httpClientBuilderOptions);
