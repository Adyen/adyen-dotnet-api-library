...
namespace Adyen.Transfers.Models
{
    ...
    /// </summary>
    public partial class ApproveTransfersRequest : IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Used to track the state of TransferIds
        /// </summary>
        [JsonIgnore]
    ...
    public class ApproveTransfersRequestJsonConverter : JsonConverter<ApproveTransfersRequest>
    {
        ...
        public override ApproveTransfersRequest Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (transferIds.IsSet && transferIds.Value == null)
                throw new ArgumentNullException(nameof(transferIds), "Property is not nullable for class ApproveTransfersRequest.");

            return new ApproveTransfersRequest(transferIds);
        }
        ...
        {
            /*
            if (approveTransfersRequest._TransferIdsOption.IsSet && approveTransfersRequest.TransferIds == null)
                throw new ArgumentNullException(nameof(approveTransfersRequest.TransferIds), "Property is required for class ApproveTransfersRequest.");
