    ...
    public class RestServiceErrorJsonConverter : JsonConverter<RestServiceError>
    {
        ...
        public override RestServiceError Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (detail.IsSet && detail.Value == null)
                throw new ArgumentNullException(nameof(detail), "Property is not nullable for class RestServiceError.");

            if (errorCode.IsSet && errorCode.Value == null)
                throw new ArgumentNullException(nameof(errorCode), "Property is not nullable for class RestServiceError.");

            if (status.IsSet && status.Value == null)
                throw new ArgumentNullException(nameof(status), "Property is not nullable for class RestServiceError.");

            if (title.IsSet && title.Value == null)
                throw new ArgumentNullException(nameof(title), "Property is not nullable for class RestServiceError.");

            if (type.IsSet && type.Value == null)
                throw new ArgumentNullException(nameof(type), "Property is not nullable for class RestServiceError.");

            if (instance.IsSet && instance.Value == null)
                throw new ArgumentNullException(nameof(instance), "Property is not nullable for class RestServiceError.");

            if (invalidFields.IsSet && invalidFields.Value == null)
                throw new ArgumentNullException(nameof(invalidFields), "Property is not nullable for class RestServiceError.");

            if (requestId.IsSet && requestId.Value == null)
                throw new ArgumentNullException(nameof(requestId), "Property is not nullable for class RestServiceError.");

            if (response.IsSet && response.Value == null)
                throw new ArgumentNullException(nameof(response), "Property is not nullable for class RestServiceError.");
        ...
        public void WriteProperties(Utf8JsonWriter writer, RestServiceError restServiceError, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (restServiceError.Detail == null)
                throw new ArgumentNullException(nameof(restServiceError.Detail), "Property is required for class RestServiceError.");

            if (restServiceError.ErrorCode == null)
                throw new ArgumentNullException(nameof(restServiceError.ErrorCode), "Property is required for class RestServiceError.");

            if (restServiceError.Title == null)
                throw new ArgumentNullException(nameof(restServiceError.Title), "Property is required for class RestServiceError.");

            if (restServiceError.Type == null)
                throw new ArgumentNullException(nameof(restServiceError.Type), "Property is required for class RestServiceError.");

            if (restServiceError._InstanceOption.IsSet && restServiceError.Instance == null)
                throw new ArgumentNullException(nameof(restServiceError.Instance), "Property is required for class RestServiceError.");

            if (restServiceError._InvalidFieldsOption.IsSet && restServiceError.InvalidFields == null)
                throw new ArgumentNullException(nameof(restServiceError.InvalidFields), "Property is required for class RestServiceError.");

            if (restServiceError._RequestIdOption.IsSet && restServiceError.RequestId == null)
                throw new ArgumentNullException(nameof(restServiceError.RequestId), "Property is required for class RestServiceError.");

            if (restServiceError._ResponseOption.IsSet && restServiceError.Response == null)
                throw new ArgumentNullException(nameof(restServiceError.Response), "Property is required for class RestServiceError.");
