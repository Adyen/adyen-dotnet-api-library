    ...
    public class LinksJsonConverter : JsonConverter<Links>
    {
        ...
        public override Links Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (next.IsSet && next.Value == null)
                throw new ArgumentNullException(nameof(next), "Property is not nullable for class Links.");

            if (prev.IsSet && prev.Value == null)
                throw new ArgumentNullException(nameof(prev), "Property is not nullable for class Links.");

            return new Links(next, prev);
        }
        ...
        {
            /*
            if (links._NextOption.IsSet && links.Next == null)
                throw new ArgumentNullException(nameof(links.Next), "Property is required for class Links.");

            if (links._PrevOption.IsSet && links.Prev == null)
                throw new ArgumentNullException(nameof(links.Prev), "Property is required for class Links.");
