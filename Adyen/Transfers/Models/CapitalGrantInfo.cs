...
namespace Adyen.Transfers.Models
{
    ...
    /// CapitalGrantInfo.
    /// </summary>
    public partial class CapitalGrantInfo : IValidatableObject
    {
        /// <summary>
    ...
    public class CapitalGrantInfoJsonConverter : JsonConverter<CapitalGrantInfo>
    {
        ...
        public override CapitalGrantInfo Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (grantAccountId.IsSet && grantAccountId.Value == null)
                throw new ArgumentNullException(nameof(grantAccountId), "Property is not nullable for class CapitalGrantInfo.");

            if (grantOfferId.IsSet && grantOfferId.Value == null)
                throw new ArgumentNullException(nameof(grantOfferId), "Property is not nullable for class CapitalGrantInfo.");

            if (counterparty.IsSet && counterparty.Value == null)
                throw new ArgumentNullException(nameof(counterparty), "Property is not nullable for class CapitalGrantInfo.");
        ...
        public void WriteProperties(Utf8JsonWriter writer, CapitalGrantInfo capitalGrantInfo, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (capitalGrantInfo.GrantAccountId == null)
                throw new ArgumentNullException(nameof(capitalGrantInfo.GrantAccountId), "Property is required for class CapitalGrantInfo.");

            if (capitalGrantInfo.GrantOfferId == null)
                throw new ArgumentNullException(nameof(capitalGrantInfo.GrantOfferId), "Property is required for class CapitalGrantInfo.");

            if (capitalGrantInfo._CounterpartyOption.IsSet && capitalGrantInfo.Counterparty == null)
                throw new ArgumentNullException(nameof(capitalGrantInfo.Counterparty), "Property is required for class CapitalGrantInfo.");
