    ...
    public class TransferRequestReviewJsonConverter : JsonConverter<TransferRequestReview>
    {
        ...
        public override TransferRequestReview Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (numberOfApprovalsRequired.IsSet && numberOfApprovalsRequired.Value == null)
                throw new ArgumentNullException(nameof(numberOfApprovalsRequired), "Property is not nullable for class TransferRequestReview.");

            if (scaOnApproval.IsSet && scaOnApproval.Value == null)
                throw new ArgumentNullException(nameof(scaOnApproval), "Property is not nullable for class TransferRequestReview.");
