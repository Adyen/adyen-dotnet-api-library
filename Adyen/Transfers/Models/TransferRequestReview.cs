...
namespace Adyen.Transfers.Models
{
    ...
    /// </summary>
    [JsonConverter(typeof(TransferRequestReviewJsonConverter))]
    ...
    public class TransferRequestReviewJsonConverter : JsonConverter<TransferRequestReview>
    {
        ...
        public override TransferRequestReview Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            var transferRequestReview = new TransferRequestReview();
            if (numberOfApprovalsRequired.IsSet)
                transferRequestReview.NumberOfApprovalsRequired = numberOfApprovalsRequired.Value;
            if (scaOnApproval.IsSet)
                transferRequestReview.ScaOnApproval = scaOnApproval.Value;
            return transferRequestReview;
        }
