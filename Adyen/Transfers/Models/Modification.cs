...
namespace Adyen.Transfers.Models
{
    ...
    /// Modification.
    /// </summary>
    [JsonConverter(typeof(ModificationJsonConverter))]
    ...
    public class ModificationJsonConverter : JsonConverter<Modification>
    {
        ...
        public override Modification Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (id.IsSet)
                modification.Id = id.Value;
            if (reference.IsSet)
                modification.Reference = reference.Value;
            if (status.IsSet)
                modification.Status = status.Value;
            if (type.IsSet)
                modification.Type = type.Value;
            return modification;
        }
