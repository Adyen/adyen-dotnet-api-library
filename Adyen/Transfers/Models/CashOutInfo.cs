...
namespace Adyen.Transfers.Models
{
    ...
    /// CashOutInfo.
    /// </summary>
    [JsonConverter(typeof(CashOutInfoJsonConverter))]
    public partial class CashOutInfo
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CashOutInfo" /> class.
        /// </summary>
        public CashOutInfo()
        {
            OnCreated();
    ...
    /// <summary>
    /// A Json converter for type <see cref="CashOutInfo" />
    /// </summary>
    public class CashOutInfoJsonConverter : JsonConverter<CashOutInfo>
    {
        /// <summary>
        /// Deserializes json to <see cref="CashOutInfo"/>.
        /// </summary>
        /// <param name="utf8JsonReader"><see cref="Utf8JsonReader"/>.</param>
        /// <param name="typeToConvert"><see cref="Type"/>.</param>
        /// <param name="jsonSerializerOptions">The <see cref="JsonSerializerOptions"/>, initialized from <see cref="HostConfiguration"/>.</param>
        /// <returns><see cref="CashOutInfo"/>.</returns>
        /// <exception cref="JsonException"></exception>
        public override CashOutInfo Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (description.IsSet)
                cashOutInfo.Description = description.Value;
            if (fee.IsSet)
                cashOutInfo.Fee = fee.Value;
            if (id.IsSet)
                cashOutInfo.Id = id.Value;
            if (referenceForBeneficiary.IsSet)
                cashOutInfo.ReferenceForBeneficiary = referenceForBeneficiary.Value;
            if (transferInstrumentId.IsSet)
                cashOutInfo.TransferInstrumentId = transferInstrumentId.Value;
            return cashOutInfo;
        }

        /// <summary>
        /// Serializes a <see cref="CashOutInfo"/>.
        /// </summary>
        /// <param name="writer"><see cref="Utf8JsonWriter"/></param>
        /// <param name="cashOutInfo"></param>
        /// <param name="jsonSerializerOptions"><see cref="JsonSerializerOptions"/></param>
        public override void Write(Utf8JsonWriter writer, CashOutInfo cashOutInfo, JsonSerializerOptions jsonSerializerOptions)
        {
            
            writer.WriteStartObject();
            
            WriteProperties(writer, cashOutInfo, jsonSerializerOptions);
        ...
        /// <summary>
        /// Serializes the properties of <see cref="CashOutInfo"/>.
        /// </summary>
        /// <param name="writer"><see cref="Utf8JsonWriter"/></param>
        /// <param name="cashOutInfo"></param>
        /// <param name="jsonSerializerOptions"><see cref="JsonSerializerOptions"/></param>
        public void WriteProperties(Utf8JsonWriter writer, CashOutInfo cashOutInfo, JsonSerializerOptions jsonSerializerOptions)
        {
            
            writer.WritePropertyName("amount");
            JsonSerializer.Serialize(writer, cashOutInfo.Amount, jsonSerializerOptions);
            if (cashOutInfo.InstructingBalanceAccountId != null)
                writer.WriteString("instructingBalanceAccountId", cashOutInfo.InstructingBalanceAccountId);

            if (cashOutInfo._CounterpartyOption.IsSet)
            {
                writer.WritePropertyName("counterparty");
                JsonSerializer.Serialize(writer, cashOutInfo.Counterparty, jsonSerializerOptions);
            }
            if (cashOutInfo._DescriptionOption.IsSet)
                if (cashOutInfo.Description != null)
                    writer.WriteString("description", cashOutInfo.Description);

            if (cashOutInfo._FeeOption.IsSet)
            {
                writer.WritePropertyName("fee");
                JsonSerializer.Serialize(writer, cashOutInfo.Fee, jsonSerializerOptions);
            }
            if (cashOutInfo._IdOption.IsSet)
                if (cashOutInfo.Id != null)
                    writer.WriteString("id", cashOutInfo.Id);

            if (cashOutInfo._ReferenceForBeneficiaryOption.IsSet)
                if (cashOutInfo.ReferenceForBeneficiary != null)
                    writer.WriteString("referenceForBeneficiary", cashOutInfo.ReferenceForBeneficiary);

            if (cashOutInfo._TransferInstrumentIdOption.IsSet)
                if (cashOutInfo.TransferInstrumentId != null)
                    writer.WriteString("transferInstrumentId", cashOutInfo.TransferInstrumentId);
        }
    }
}
