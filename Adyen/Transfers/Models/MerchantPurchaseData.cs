...
namespace Adyen.Transfers.Models
{
    ...
    public class MerchantPurchaseDataJsonConverter : JsonConverter<MerchantPurchaseData>
    {
        ...
        public override MerchantPurchaseData Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (airline.IsSet && airline.Value == null)
                throw new ArgumentNullException(nameof(airline), "Property is not nullable for class MerchantPurchaseData.");

            if (lodging.IsSet && lodging.Value == null)
                throw new ArgumentNullException(nameof(lodging), "Property is not nullable for class MerchantPurchaseData.");

            if (type.IsSet && type.Value == null)
                throw new ArgumentNullException(nameof(type), "Property is not nullable for class MerchantPurchaseData.");
        ...
        {
            /*
            if (merchantPurchaseData._AirlineOption.IsSet && merchantPurchaseData.Airline == null)
                throw new ArgumentNullException(nameof(merchantPurchaseData.Airline), "Property is required for class MerchantPurchaseData.");

            if (merchantPurchaseData._LodgingOption.IsSet && merchantPurchaseData.Lodging == null)
                throw new ArgumentNullException(nameof(merchantPurchaseData.Lodging), "Property is required for class MerchantPurchaseData.");
