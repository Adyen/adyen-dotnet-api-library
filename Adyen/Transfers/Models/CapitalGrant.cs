...
namespace Adyen.Transfers.Models
{
    ...
    /// CapitalGrant.
    /// </summary>
    [JsonConverter(typeof(CapitalGrantJsonConverter))]
    ...
    public class CapitalGrantJsonConverter : JsonConverter<CapitalGrant>
    {
        ...
        public override CapitalGrant Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (counterparty.IsSet)
                capitalGrant.Counterparty = counterparty.Value;
            if (fee.IsSet)
                capitalGrant.Fee = fee.Value;
            if (repayment.IsSet)
                capitalGrant.Repayment = repayment.Value;
            return capitalGrant;
        }
