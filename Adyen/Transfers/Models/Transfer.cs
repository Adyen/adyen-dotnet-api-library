...
namespace Adyen.Transfers.Models
{
    ...
    public partial class Transfer
    {
        ...
        public Transfer(Amount amount, CategoryEnum category, CounterpartyV3 counterparty, StatusEnum status, Option<ResourceReference?> accountHolder = default, Option<ResourceReference?> balanceAccount = default, Option<TransferCategoryData?> categoryData = default, Option<DateTimeOffset?> createdAt = default, Option<DateTimeOffset?> creationDate = default, Option<string?> description = default, Option<DirectDebitInformation?> directDebitInformation = default, Option<DirectionEnum?> direction = default, Option<ExecutionDate?> executionDate = default, Option<string?> id = default, Option<PaymentInstrument?> paymentInstrument = default, Option<ReasonEnum?> reason = default, Option<string?> reference = default, Option<string?> referenceForBeneficiary = default, Option<TransferReview?> review = default, Option<TypeEnum?> type = default, Option<UltimatePartyIdentification?> ultimateParty = default)
        {
            Amount = amount;
            Category = category;
    ...
    /// <summary>
    /// A Json converter for type <see cref="Transfer" />
    /// </summary>
    public class TransferJsonConverter : JsonConverter<Transfer>
    {
        /// <summary>
        ...
        /// <summary>
        /// Deserializes json to <see cref="Transfer"/>.
        /// </summary>
        ...
        public override Transfer Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            Option<Transfer.CategoryEnum?> category = default;
            Option<CounterpartyV3?> counterparty = default;
            Option<Transfer.StatusEnum?> status = default;
                ...
                if (utf8JsonReader.TokenType == JsonTokenType.PropertyName && currentDepth == utf8JsonReader.CurrentDepth - 1)
                {
                    ...
                    switch (jsonPropertyName)
                    {
                        ...
                        case "category":
                            ...
                            category = new Option<Transfer.CategoryEnum?>(Transfer.CategoryEnum.FromStringOrDefault(categoryRawValue));
                            break;
                        case "counterparty":
                            counterparty = new Option<CounterpartyV3?>(JsonSerializer.Deserialize<CounterpartyV3>(ref utf8JsonReader, jsonSerializerOptions)!);
                            break;
                        case "status":
                            string? statusRawValue = utf8JsonReader.GetString();
                            status = new Option<Transfer.StatusEnum?>(Transfer.StatusEnum.FromStringOrDefault(statusRawValue));
                            break;
                        case "accountHolder":
                        ...
                        case "direction":
                            ...
                            direction = new Option<Transfer.DirectionEnum?>(Transfer.DirectionEnum.FromStringOrDefault(directionRawValue));
                            break;
                        case "executionDate":
                        ...
                        case "reason":
                            ...
                            reason = new Option<Transfer.ReasonEnum?>(Transfer.ReasonEnum.FromStringOrDefault(reasonRawValue));
                            break;
                        case "reference":
                        ...
                        case "type":
                            ...
                            type = new Option<Transfer.TypeEnum?>(Transfer.TypeEnum.FromStringOrDefault(typeRawValue));
                            break;
                        case "ultimateParty":
            ...
            return new Transfer(amount.Value!, category.Value!.Value!, counterparty.Value!, status.Value!.Value!, accountHolder, balanceAccount, categoryData, createdAt, creationDate, description, directDebitInformation, direction, executionDate, id, paymentInstrument, reason, reference, referenceForBeneficiary, review, type, ultimateParty);
        }

        /// <summary>
        /// Serializes a <see cref="Transfer"/>.
        /// </summary>
        /// <param name="writer"><see cref="Utf8JsonWriter"/></param>
        /// <param name="transfer"></param>
        /// <param name="jsonSerializerOptions"><see cref="JsonSerializerOptions"/></param>
        public override void Write(Utf8JsonWriter writer, Transfer transfer, JsonSerializerOptions jsonSerializerOptions)
        {
            
            writer.WriteStartObject();
            
            WriteProperties(writer, transfer, jsonSerializerOptions);
        ...
        /// <summary>
        /// Serializes the properties of <see cref="Transfer"/>.
        /// </summary>
        /// <param name="writer"><see cref="Utf8JsonWriter"/></param>
        /// <param name="transfer"></param>
        /// <param name="jsonSerializerOptions"><see cref="JsonSerializerOptions"/></param>
        public void WriteProperties(Utf8JsonWriter writer, Transfer transfer, JsonSerializerOptions jsonSerializerOptions)
        {
            
            writer.WritePropertyName("amount");
            JsonSerializer.Serialize(writer, transfer.Amount, jsonSerializerOptions);
            if (transfer.Category != null) 
            {
                string? categoryRawValue = Transfer.CategoryEnum.ToJsonValue(transfer.Category);
                writer.WriteString("category", categoryRawValue);
            }
            
            writer.WritePropertyName("counterparty");
            JsonSerializer.Serialize(writer, transfer.Counterparty, jsonSerializerOptions);
            if (transfer.Status != null) 
            {
                string? statusRawValue = Transfer.StatusEnum.ToJsonValue(transfer.Status);
                writer.WriteString("status", statusRawValue);
            }
            
            if (transfer._AccountHolderOption.IsSet)
            {
                writer.WritePropertyName("accountHolder");
                JsonSerializer.Serialize(writer, transfer.AccountHolder, jsonSerializerOptions);
            }
            if (transfer._BalanceAccountOption.IsSet)
            {
                writer.WritePropertyName("balanceAccount");
                JsonSerializer.Serialize(writer, transfer.BalanceAccount, jsonSerializerOptions);
            }
            if (transfer._CategoryDataOption.IsSet)
            {
                writer.WritePropertyName("categoryData");
                JsonSerializer.Serialize(writer, transfer.CategoryData, jsonSerializerOptions);
            }
            if (transfer._CreatedAtOption.IsSet)
                if (transfer._CreatedAtOption.Value != null)
                    writer.WriteString("createdAt", transfer._CreatedAtOption.Value!.Value.ToString(CreatedAtFormat));

            if (transfer._CreationDateOption.IsSet)
                if (transfer._CreationDateOption.Value != null)
                    writer.WriteString("creationDate", transfer._CreationDateOption.Value!.Value.ToString(CreationDateFormat));

            if (transfer._DescriptionOption.IsSet)
                if (transfer.Description != null)
                    writer.WriteString("description", transfer.Description);

            if (transfer._DirectDebitInformationOption.IsSet)
            {
                writer.WritePropertyName("directDebitInformation");
                JsonSerializer.Serialize(writer, transfer.DirectDebitInformation, jsonSerializerOptions);
            }
            if (transfer._DirectionOption.IsSet && transfer.Direction != null) 
            {
                string? directionRawValue = Transfer.DirectionEnum.ToJsonValue(transfer._DirectionOption.Value!.Value);
                writer.WriteString("direction", directionRawValue);
            }
            
            if (transfer._ExecutionDateOption.IsSet)
            {
                writer.WritePropertyName("executionDate");
                JsonSerializer.Serialize(writer, transfer.ExecutionDate, jsonSerializerOptions);
            }
            if (transfer._IdOption.IsSet)
                if (transfer.Id != null)
                    writer.WriteString("id", transfer.Id);

            if (transfer._PaymentInstrumentOption.IsSet)
            {
                writer.WritePropertyName("paymentInstrument");
                JsonSerializer.Serialize(writer, transfer.PaymentInstrument, jsonSerializerOptions);
            }
            if (transfer._ReasonOption.IsSet && transfer.Reason != null) 
            {
                string? reasonRawValue = Transfer.ReasonEnum.ToJsonValue(transfer._ReasonOption.Value!.Value);
                writer.WriteString("reason", reasonRawValue);
            }
            
            if (transfer._ReferenceOption.IsSet)
                if (transfer.Reference != null)
                    writer.WriteString("reference", transfer.Reference);

            if (transfer._ReferenceForBeneficiaryOption.IsSet)
                if (transfer.ReferenceForBeneficiary != null)
                    writer.WriteString("referenceForBeneficiary", transfer.ReferenceForBeneficiary);

            if (transfer._ReviewOption.IsSet)
            {
                writer.WritePropertyName("review");
                JsonSerializer.Serialize(writer, transfer.Review, jsonSerializerOptions);
            }
            if (transfer._TypeOption.IsSet && transfer.Type != null) 
            {
                string? typeRawValue = Transfer.TypeEnum.ToJsonValue(transfer._TypeOption.Value!.Value);
                writer.WriteString("type", typeRawValue);
            }
            
            if (transfer._UltimatePartyOption.IsSet)
            {
                writer.WritePropertyName("ultimateParty");
                JsonSerializer.Serialize(writer, transfer.UltimateParty, jsonSerializerOptions);
            }
        }
    }
}
