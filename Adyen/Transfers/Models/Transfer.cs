    ...
    public class TransferJsonConverter : JsonConverter<Transfer>
    {
        ...
        public override Transfer Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (amount.IsSet && amount.Value == null)
                throw new ArgumentNullException(nameof(amount), "Property is not nullable for class Transfer.");

            if (category.IsSet && category.Value == null)
                throw new ArgumentNullException(nameof(category), "Property is not nullable for class Transfer.");

            if (counterparty.IsSet && counterparty.Value == null)
                throw new ArgumentNullException(nameof(counterparty), "Property is not nullable for class Transfer.");

            if (status.IsSet && status.Value == null)
                throw new ArgumentNullException(nameof(status), "Property is not nullable for class Transfer.");

            if (accountHolder.IsSet && accountHolder.Value == null)
                throw new ArgumentNullException(nameof(accountHolder), "Property is not nullable for class Transfer.");

            if (balanceAccount.IsSet && balanceAccount.Value == null)
                throw new ArgumentNullException(nameof(balanceAccount), "Property is not nullable for class Transfer.");

            if (categoryData.IsSet && categoryData.Value == null)
                throw new ArgumentNullException(nameof(categoryData), "Property is not nullable for class Transfer.");

            if (createdAt.IsSet && createdAt.Value == null)
                throw new ArgumentNullException(nameof(createdAt), "Property is not nullable for class Transfer.");

            if (creationDate.IsSet && creationDate.Value == null)
                throw new ArgumentNullException(nameof(creationDate), "Property is not nullable for class Transfer.");

            if (description.IsSet && description.Value == null)
                throw new ArgumentNullException(nameof(description), "Property is not nullable for class Transfer.");

            if (directDebitInformation.IsSet && directDebitInformation.Value == null)
                throw new ArgumentNullException(nameof(directDebitInformation), "Property is not nullable for class Transfer.");

            if (direction.IsSet && direction.Value == null)
                throw new ArgumentNullException(nameof(direction), "Property is not nullable for class Transfer.");

            if (executionDate.IsSet && executionDate.Value == null)
                throw new ArgumentNullException(nameof(executionDate), "Property is not nullable for class Transfer.");

            if (id.IsSet && id.Value == null)
                throw new ArgumentNullException(nameof(id), "Property is not nullable for class Transfer.");

            if (paymentInstrument.IsSet && paymentInstrument.Value == null)
                throw new ArgumentNullException(nameof(paymentInstrument), "Property is not nullable for class Transfer.");

            if (reason.IsSet && reason.Value == null)
                throw new ArgumentNullException(nameof(reason), "Property is not nullable for class Transfer.");

            if (reference.IsSet && reference.Value == null)
                throw new ArgumentNullException(nameof(reference), "Property is not nullable for class Transfer.");

            if (referenceForBeneficiary.IsSet && referenceForBeneficiary.Value == null)
                throw new ArgumentNullException(nameof(referenceForBeneficiary), "Property is not nullable for class Transfer.");

            if (review.IsSet && review.Value == null)
                throw new ArgumentNullException(nameof(review), "Property is not nullable for class Transfer.");

            if (type.IsSet && type.Value == null)
                throw new ArgumentNullException(nameof(type), "Property is not nullable for class Transfer.");
        ...
        public void WriteProperties(Utf8JsonWriter writer, Transfer transfer, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (transfer.Amount == null)
                throw new ArgumentNullException(nameof(transfer.Amount), "Property is required for class Transfer.");

            if (transfer.Counterparty == null)
                throw new ArgumentNullException(nameof(transfer.Counterparty), "Property is required for class Transfer.");

            if (transfer._AccountHolderOption.IsSet && transfer.AccountHolder == null)
                throw new ArgumentNullException(nameof(transfer.AccountHolder), "Property is required for class Transfer.");

            if (transfer._BalanceAccountOption.IsSet && transfer.BalanceAccount == null)
                throw new ArgumentNullException(nameof(transfer.BalanceAccount), "Property is required for class Transfer.");

            if (transfer._CategoryDataOption.IsSet && transfer.CategoryData == null)
                throw new ArgumentNullException(nameof(transfer.CategoryData), "Property is required for class Transfer.");

            if (transfer._DescriptionOption.IsSet && transfer.Description == null)
                throw new ArgumentNullException(nameof(transfer.Description), "Property is required for class Transfer.");

            if (transfer._DirectDebitInformationOption.IsSet && transfer.DirectDebitInformation == null)
                throw new ArgumentNullException(nameof(transfer.DirectDebitInformation), "Property is required for class Transfer.");

            if (transfer._ExecutionDateOption.IsSet && transfer.ExecutionDate == null)
                throw new ArgumentNullException(nameof(transfer.ExecutionDate), "Property is required for class Transfer.");

            if (transfer._IdOption.IsSet && transfer.Id == null)
                throw new ArgumentNullException(nameof(transfer.Id), "Property is required for class Transfer.");

            if (transfer._PaymentInstrumentOption.IsSet && transfer.PaymentInstrument == null)
                throw new ArgumentNullException(nameof(transfer.PaymentInstrument), "Property is required for class Transfer.");

            if (transfer._ReferenceOption.IsSet && transfer.Reference == null)
                throw new ArgumentNullException(nameof(transfer.Reference), "Property is required for class Transfer.");

            if (transfer._ReferenceForBeneficiaryOption.IsSet && transfer.ReferenceForBeneficiary == null)
                throw new ArgumentNullException(nameof(transfer.ReferenceForBeneficiary), "Property is required for class Transfer.");

            if (transfer._ReviewOption.IsSet && transfer.Review == null)
                throw new ArgumentNullException(nameof(transfer.Review), "Property is required for class Transfer.");
