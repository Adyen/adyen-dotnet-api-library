...
namespace Adyen.Transfers.Models
{
    ...
    public partial class UltimatePartyIdentification : IValidatableObject
    {
        ...
        [JsonConstructor]
        public UltimatePartyIdentification(Option<Address?> address = default, Option<DateOnly?> dateOfBirth = default, Option<string?> email = default, Option<string?> firstName = default, Option<string?> fullName = default, Option<string?> lastName = default, Option<string?> reference = default, Option<TypeEnum?> type = default, Option<string?> url = default)
        {
    ...
    public class UltimatePartyIdentificationJsonConverter : JsonConverter<UltimatePartyIdentification>
    {
        ...
        public override UltimatePartyIdentification Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (address.IsSet && address.Value == null)
                throw new ArgumentNullException(nameof(address), "Property is not nullable for class UltimatePartyIdentification.");

            if (dateOfBirth.IsSet && dateOfBirth.Value == null)
                throw new ArgumentNullException(nameof(dateOfBirth), "Property is not nullable for class UltimatePartyIdentification.");

            if (email.IsSet && email.Value == null)
                throw new ArgumentNullException(nameof(email), "Property is not nullable for class UltimatePartyIdentification.");

            if (firstName.IsSet && firstName.Value == null)
                throw new ArgumentNullException(nameof(firstName), "Property is not nullable for class UltimatePartyIdentification.");

            if (fullName.IsSet && fullName.Value == null)
                throw new ArgumentNullException(nameof(fullName), "Property is not nullable for class UltimatePartyIdentification.");

            if (lastName.IsSet && lastName.Value == null)
                throw new ArgumentNullException(nameof(lastName), "Property is not nullable for class UltimatePartyIdentification.");

            if (reference.IsSet && reference.Value == null)
                throw new ArgumentNullException(nameof(reference), "Property is not nullable for class UltimatePartyIdentification.");

            if (type.IsSet && type.Value == null)
                throw new ArgumentNullException(nameof(type), "Property is not nullable for class UltimatePartyIdentification.");

            if (url.IsSet && url.Value == null)
                throw new ArgumentNullException(nameof(url), "Property is not nullable for class UltimatePartyIdentification.");

            return new UltimatePartyIdentification(address, dateOfBirth, email, firstName, fullName, lastName, reference, type, url);
        }
        ...
        {
            /*
            if (ultimatePartyIdentification._AddressOption.IsSet && ultimatePartyIdentification.Address == null)
                throw new ArgumentNullException(nameof(ultimatePartyIdentification.Address), "Property is required for class UltimatePartyIdentification.");

            if (ultimatePartyIdentification._EmailOption.IsSet && ultimatePartyIdentification.Email == null)
                throw new ArgumentNullException(nameof(ultimatePartyIdentification.Email), "Property is required for class UltimatePartyIdentification.");

            if (ultimatePartyIdentification._FirstNameOption.IsSet && ultimatePartyIdentification.FirstName == null)
                throw new ArgumentNullException(nameof(ultimatePartyIdentification.FirstName), "Property is required for class UltimatePartyIdentification.");

            if (ultimatePartyIdentification._FullNameOption.IsSet && ultimatePartyIdentification.FullName == null)
                throw new ArgumentNullException(nameof(ultimatePartyIdentification.FullName), "Property is required for class UltimatePartyIdentification.");

            if (ultimatePartyIdentification._LastNameOption.IsSet && ultimatePartyIdentification.LastName == null)
                throw new ArgumentNullException(nameof(ultimatePartyIdentification.LastName), "Property is required for class UltimatePartyIdentification.");

            if (ultimatePartyIdentification._ReferenceOption.IsSet && ultimatePartyIdentification.Reference == null)
                throw new ArgumentNullException(nameof(ultimatePartyIdentification.Reference), "Property is required for class UltimatePartyIdentification.");

            if (ultimatePartyIdentification._UrlOption.IsSet && ultimatePartyIdentification.Url == null)
                throw new ArgumentNullException(nameof(ultimatePartyIdentification.Url), "Property is required for class UltimatePartyIdentification.");
