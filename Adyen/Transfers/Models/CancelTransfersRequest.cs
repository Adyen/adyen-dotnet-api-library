...
namespace Adyen.Transfers.Models
{
    ...
    /// </summary>
    public partial class CancelTransfersRequest : IValidatableObject
    {
        /// <summary>
    ...
    public class CancelTransfersRequestJsonConverter : JsonConverter<CancelTransfersRequest>
    {
        ...
        public override CancelTransfersRequest Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (transferIds.IsSet && transferIds.Value == null)
                throw new ArgumentNullException(nameof(transferIds), "Property is not nullable for class CancelTransfersRequest.");

            return new CancelTransfersRequest(transferIds);
        }
        ...
        {
            /*
            if (cancelTransfersRequest._TransferIdsOption.IsSet && cancelTransfersRequest.TransferIds == null)
                throw new ArgumentNullException(nameof(cancelTransfersRequest.TransferIds), "Property is required for class CancelTransfersRequest.");
