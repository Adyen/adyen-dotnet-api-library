...
namespace Adyen.Transfers.Models
{
    ...
    public class AirlineJsonConverter : JsonConverter<Airline>
    {
        ...
        public override Airline Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (ticketNumber.IsSet && ticketNumber.Value == null)
                throw new ArgumentNullException(nameof(ticketNumber), "Property is not nullable for class Airline.");
        ...
        public void WriteProperties(Utf8JsonWriter writer, Airline airline, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (airline._TicketNumberOption.IsSet && airline.TicketNumber == null)
                throw new ArgumentNullException(nameof(airline.TicketNumber), "Property is required for class Airline.");
