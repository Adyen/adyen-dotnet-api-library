...
namespace Adyen.Transfers.Models
{
    ...
    public partial class TransferInfo : IValidatableObject
    {
        ...
        /// <summary>
        /// Used to track whether Priority is set or not.
        /// </summary>
        [JsonIgnore]
    ...
    public class TransferInfoJsonConverter : JsonConverter<TransferInfo>
    {
        ...
        public override TransferInfo Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (amount.IsSet && amount.Value == null)
                throw new ArgumentNullException(nameof(amount), "Property is not nullable for class TransferInfo.");

            if (category.IsSet && category.Value == null)
                throw new ArgumentNullException(nameof(category), "Property is not nullable for class TransferInfo.");

            if (counterparty.IsSet && counterparty.Value == null)
                throw new ArgumentNullException(nameof(counterparty), "Property is not nullable for class TransferInfo.");

            if (balanceAccountId.IsSet && balanceAccountId.Value == null)
                throw new ArgumentNullException(nameof(balanceAccountId), "Property is not nullable for class TransferInfo.");

            if (description.IsSet && description.Value == null)
                throw new ArgumentNullException(nameof(description), "Property is not nullable for class TransferInfo.");

            if (executionDate.IsSet && executionDate.Value == null)
                throw new ArgumentNullException(nameof(executionDate), "Property is not nullable for class TransferInfo.");

            if (paymentInstrumentId.IsSet && paymentInstrumentId.Value == null)
                throw new ArgumentNullException(nameof(paymentInstrumentId), "Property is not nullable for class TransferInfo.");

            if (priorities.IsSet && priorities.Value == null)
                throw new ArgumentNullException(nameof(priorities), "Property is not nullable for class TransferInfo.");

            if (priority.IsSet && priority.Value == null)
                throw new ArgumentNullException(nameof(priority), "Property is not nullable for class TransferInfo.");

            if (reference.IsSet && reference.Value == null)
                throw new ArgumentNullException(nameof(reference), "Property is not nullable for class TransferInfo.");

            if (referenceForBeneficiary.IsSet && referenceForBeneficiary.Value == null)
                throw new ArgumentNullException(nameof(referenceForBeneficiary), "Property is not nullable for class TransferInfo.");

            if (review.IsSet && review.Value == null)
                throw new ArgumentNullException(nameof(review), "Property is not nullable for class TransferInfo.");

            if (type.IsSet && type.Value == null)
                throw new ArgumentNullException(nameof(type), "Property is not nullable for class TransferInfo.");

            if (ultimateParty.IsSet && ultimateParty.Value == null)
                throw new ArgumentNullException(nameof(ultimateParty), "Property is not nullable for class TransferInfo.");
        ...
        {
            /*
            if (transferInfo.Amount == null)
                throw new ArgumentNullException(nameof(transferInfo.Amount), "Property is required for class TransferInfo.");

            if (transferInfo.Counterparty == null)
                throw new ArgumentNullException(nameof(transferInfo.Counterparty), "Property is required for class TransferInfo.");

            if (transferInfo._BalanceAccountIdOption.IsSet && transferInfo.BalanceAccountId == null)
                throw new ArgumentNullException(nameof(transferInfo.BalanceAccountId), "Property is required for class TransferInfo.");

            if (transferInfo._DescriptionOption.IsSet && transferInfo.Description == null)
                throw new ArgumentNullException(nameof(transferInfo.Description), "Property is required for class TransferInfo.");

            if (transferInfo._ExecutionDateOption.IsSet && transferInfo.ExecutionDate == null)
                throw new ArgumentNullException(nameof(transferInfo.ExecutionDate), "Property is required for class TransferInfo.");

            if (transferInfo._PaymentInstrumentIdOption.IsSet && transferInfo.PaymentInstrumentId == null)
                throw new ArgumentNullException(nameof(transferInfo.PaymentInstrumentId), "Property is required for class TransferInfo.");

            if (transferInfo._PrioritiesOption.IsSet && transferInfo.Priorities == null)
                throw new ArgumentNullException(nameof(transferInfo.Priorities), "Property is required for class TransferInfo.");

            if (transferInfo._ReferenceOption.IsSet && transferInfo.Reference == null)
                throw new ArgumentNullException(nameof(transferInfo.Reference), "Property is required for class TransferInfo.");

            if (transferInfo._ReferenceForBeneficiaryOption.IsSet && transferInfo.ReferenceForBeneficiary == null)
                throw new ArgumentNullException(nameof(transferInfo.ReferenceForBeneficiary), "Property is required for class TransferInfo.");

            if (transferInfo._ReviewOption.IsSet && transferInfo.Review == null)
                throw new ArgumentNullException(nameof(transferInfo.Review), "Property is required for class TransferInfo.");

            if (transferInfo._UltimatePartyOption.IsSet && transferInfo.UltimateParty == null)
                throw new ArgumentNullException(nameof(transferInfo.UltimateParty), "Property is required for class TransferInfo.");
