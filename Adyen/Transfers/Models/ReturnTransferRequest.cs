...
namespace Adyen.Transfers.Models
{
    ...
    /// </summary>
    public partial class ReturnTransferRequest : IValidatableObject
    {
        /// <summary>
    ...
    public class ReturnTransferRequestJsonConverter : JsonConverter<ReturnTransferRequest>
    {
        ...
        public override ReturnTransferRequest Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (amount.IsSet && amount.Value == null)
                throw new ArgumentNullException(nameof(amount), "Property is not nullable for class ReturnTransferRequest.");

            if (reference.IsSet && reference.Value == null)
                throw new ArgumentNullException(nameof(reference), "Property is not nullable for class ReturnTransferRequest.");
        ...
        {
            /*
            if (returnTransferRequest.Amount == null)
                throw new ArgumentNullException(nameof(returnTransferRequest.Amount), "Property is required for class ReturnTransferRequest.");

            if (returnTransferRequest._ReferenceOption.IsSet && returnTransferRequest.Reference == null)
                throw new ArgumentNullException(nameof(returnTransferRequest.Reference), "Property is required for class ReturnTransferRequest.");
