...
namespace Adyen.Transfers.Models
{
    ...
    /// </summary>
    [JsonConverter(typeof(TransferNotificationCounterPartyJsonConverter))]
    public partial class TransferNotificationCounterParty
    {
        /// <summary>
    ...
    public class TransferNotificationCounterPartyJsonConverter : JsonConverter<TransferNotificationCounterParty>
    {
        ...
        public override TransferNotificationCounterParty Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (bankAccount.IsSet)
                transferNotificationCounterParty.BankAccount = bankAccount.Value;
            if (card.IsSet)
                transferNotificationCounterParty.Card = card.Value;
            if (merchant.IsSet)
                transferNotificationCounterParty.Merchant = merchant.Value;
            if (transferInstrumentId.IsSet)
                transferNotificationCounterParty.TransferInstrumentId = transferInstrumentId.Value;
            return transferNotificationCounterParty;
        }
        ...
        public void WriteProperties(Utf8JsonWriter writer, TransferNotificationCounterParty transferNotificationCounterParty, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (transferNotificationCounterParty._BalanceAccountIdOption.IsSet)
                if (transferNotificationCounterParty.BalanceAccountId != null)
            ...
            if (transferNotificationCounterParty._TransferInstrumentIdOption.IsSet)
                if (transferNotificationCounterParty.TransferInstrumentId != null)
