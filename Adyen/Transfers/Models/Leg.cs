...
namespace Adyen.Transfers.Models
{
    ...
    public class LegJsonConverter : JsonConverter<Leg>
    {
        ...
        public override Leg Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (arrivalAirportCode.IsSet && arrivalAirportCode.Value == null)
                throw new ArgumentNullException(nameof(arrivalAirportCode), "Property is not nullable for class Leg.");

            if (basicFareCode.IsSet && basicFareCode.Value == null)
                throw new ArgumentNullException(nameof(basicFareCode), "Property is not nullable for class Leg.");
            ...
            if (departureDate.IsSet && departureDate.Value == null)
                throw new ArgumentNullException(nameof(departureDate), "Property is not nullable for class Leg.");
        ...
        {
            /*
            if (leg._ArrivalAirportCodeOption.IsSet && leg.ArrivalAirportCode == null)
                throw new ArgumentNullException(nameof(leg.ArrivalAirportCode), "Property is required for class Leg.");

            if (leg._BasicFareCodeOption.IsSet && leg.BasicFareCode == null)
                throw new ArgumentNullException(nameof(leg.BasicFareCode), "Property is required for class Leg.");

            if (leg._CarrierCodeOption.IsSet && leg.CarrierCode == null)
                throw new ArgumentNullException(nameof(leg.CarrierCode), "Property is required for class Leg.");

            if (leg._DepartureAirportCodeOption.IsSet && leg.DepartureAirportCode == null)
                throw new ArgumentNullException(nameof(leg.DepartureAirportCode), "Property is required for class Leg.");

            if (leg._DepartureDateOption.IsSet && leg.DepartureDate == null)
                throw new ArgumentNullException(nameof(leg.DepartureDate), "Property is required for class Leg.");

            if (leg._FlightNumberOption.IsSet && leg.FlightNumber == null)
