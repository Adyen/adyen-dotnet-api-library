...
namespace Adyen.Transfers.Models
{
    ...
    /// </summary>
    public partial class TransactionEventViolation : IValidatableObject
    {
        /// <summary>
    ...
    public class TransactionEventViolationJsonConverter : JsonConverter<TransactionEventViolation>
    {
        ...
        public override TransactionEventViolation Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (reason.IsSet && reason.Value == null)
                throw new ArgumentNullException(nameof(reason), "Property is not nullable for class TransactionEventViolation.");

            if (transactionRule.IsSet && transactionRule.Value == null)
                throw new ArgumentNullException(nameof(transactionRule), "Property is not nullable for class TransactionEventViolation.");

            if (transactionRuleSource.IsSet && transactionRuleSource.Value == null)
                throw new ArgumentNullException(nameof(transactionRuleSource), "Property is not nullable for class TransactionEventViolation.");
        ...
        {
            /*
            if (transactionEventViolation._ReasonOption.IsSet && transactionEventViolation.Reason == null)
                throw new ArgumentNullException(nameof(transactionEventViolation.Reason), "Property is required for class TransactionEventViolation.");

            if (transactionEventViolation._TransactionRuleOption.IsSet && transactionEventViolation.TransactionRule == null)
                throw new ArgumentNullException(nameof(transactionEventViolation.TransactionRule), "Property is required for class TransactionEventViolation.");

            if (transactionEventViolation._TransactionRuleSourceOption.IsSet && transactionEventViolation.TransactionRuleSource == null)
                throw new ArgumentNullException(nameof(transactionEventViolation.TransactionRuleSource), "Property is required for class TransactionEventViolation.");
