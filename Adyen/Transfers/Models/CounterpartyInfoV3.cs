...
namespace Adyen.Transfers.Models
{
    ...
    public partial class CounterpartyInfoV3 : IValidatableObject
    {
        ...
        [JsonConstructor]
        public CounterpartyInfoV3(Option<string?> balanceAccountId = default, Option<BankAccountV3?> bankAccount = default, Option<Card?> card = default, Option<string?> transferInstrumentId = default)
        {
    ...
    public class CounterpartyInfoV3JsonConverter : JsonConverter<CounterpartyInfoV3>
    {
        ...
        public override CounterpartyInfoV3 Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (balanceAccountId.IsSet && balanceAccountId.Value == null)
                throw new ArgumentNullException(nameof(balanceAccountId), "Property is not nullable for class CounterpartyInfoV3.");

            if (bankAccount.IsSet && bankAccount.Value == null)
                throw new ArgumentNullException(nameof(bankAccount), "Property is not nullable for class CounterpartyInfoV3.");

            if (card.IsSet && card.Value == null)
                throw new ArgumentNullException(nameof(card), "Property is not nullable for class CounterpartyInfoV3.");

            if (transferInstrumentId.IsSet && transferInstrumentId.Value == null)
                throw new ArgumentNullException(nameof(transferInstrumentId), "Property is not nullable for class CounterpartyInfoV3.");

            return new CounterpartyInfoV3(balanceAccountId, bankAccount, card, transferInstrumentId);
        }
        ...
        {
            /*
            if (counterpartyInfoV3._BalanceAccountIdOption.IsSet && counterpartyInfoV3.BalanceAccountId == null)
                throw new ArgumentNullException(nameof(counterpartyInfoV3.BalanceAccountId), "Property is required for class CounterpartyInfoV3.");

            if (counterpartyInfoV3._BankAccountOption.IsSet && counterpartyInfoV3.BankAccount == null)
                throw new ArgumentNullException(nameof(counterpartyInfoV3.BankAccount), "Property is required for class CounterpartyInfoV3.");

            if (counterpartyInfoV3._CardOption.IsSet && counterpartyInfoV3.Card == null)
                throw new ArgumentNullException(nameof(counterpartyInfoV3.Card), "Property is required for class CounterpartyInfoV3.");

            if (counterpartyInfoV3._TransferInstrumentIdOption.IsSet && counterpartyInfoV3.TransferInstrumentId == null)
                throw new ArgumentNullException(nameof(counterpartyInfoV3.TransferInstrumentId), "Property is required for class CounterpartyInfoV3.");
