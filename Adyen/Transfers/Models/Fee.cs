    ...
    public class FeeJsonConverter : JsonConverter<Fee>
    {
        ...
        public override Fee Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (amount.IsSet && amount.Value == null)
                throw new ArgumentNullException(nameof(amount), "Property is not nullable for class Fee.");
        ...
        public void WriteProperties(Utf8JsonWriter writer, Fee fee, JsonSerializerOptions jsonSerializerOptions)
        {
            /*
            if (fee.Amount == null)
                throw new ArgumentNullException(nameof(fee.Amount), "Property is required for class Fee.");
