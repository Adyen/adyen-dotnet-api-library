...
namespace Adyen.Transfers.Models
{
    ...
    /// ThresholdRepayment.
    /// </summary>
    public partial class ThresholdRepayment : IValidatableObject
    {
        /// <summary>
    ...
    public class ThresholdRepaymentJsonConverter : JsonConverter<ThresholdRepayment>
    {
        ...
        public override ThresholdRepayment Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (amount.IsSet && amount.Value == null)
                throw new ArgumentNullException(nameof(amount), "Property is not nullable for class ThresholdRepayment.");
        ...
        {
            /*
            if (thresholdRepayment.Amount == null)
                throw new ArgumentNullException(nameof(thresholdRepayment.Amount), "Property is required for class ThresholdRepayment.");
