...
namespace Adyen.Transfers.Models
{
    ...
    public partial class ReturnTransferResponse : IValidatableObject
    {
        ...
        /// <summary>
        /// Used to track the state of TransferId
        /// </summary>
        [JsonIgnore]
        [global::System.ComponentModel.EditorBrowsable(global::System.ComponentModel.EditorBrowsableState.Never)]
    ...
    public class ReturnTransferResponseJsonConverter : JsonConverter<ReturnTransferResponse>
    {
        ...
        public override ReturnTransferResponse Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (id.IsSet && id.Value == null)
                throw new ArgumentNullException(nameof(id), "Property is not nullable for class ReturnTransferResponse.");

            if (reference.IsSet && reference.Value == null)
                throw new ArgumentNullException(nameof(reference), "Property is not nullable for class ReturnTransferResponse.");

            if (status.IsSet && status.Value == null)
                throw new ArgumentNullException(nameof(status), "Property is not nullable for class ReturnTransferResponse.");

            if (transferId.IsSet && transferId.Value == null)
                throw new ArgumentNullException(nameof(transferId), "Property is not nullable for class ReturnTransferResponse.");
        ...
        {
            /*
            if (returnTransferResponse._IdOption.IsSet && returnTransferResponse.Id == null)
                throw new ArgumentNullException(nameof(returnTransferResponse.Id), "Property is required for class ReturnTransferResponse.");

            if (returnTransferResponse._ReferenceOption.IsSet && returnTransferResponse.Reference == null)
                throw new ArgumentNullException(nameof(returnTransferResponse.Reference), "Property is required for class ReturnTransferResponse.");

            if (returnTransferResponse._TransferIdOption.IsSet && returnTransferResponse.TransferId == null)
                throw new ArgumentNullException(nameof(returnTransferResponse.TransferId), "Property is required for class ReturnTransferResponse.");
