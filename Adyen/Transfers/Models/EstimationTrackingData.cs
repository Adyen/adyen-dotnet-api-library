    ...
    public class EstimationTrackingDataJsonConverter : JsonConverter<EstimationTrackingData>
    {
        ...
        public override EstimationTrackingData Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (estimatedArrivalTime.IsSet && estimatedArrivalTime.Value == null)
                throw new ArgumentNullException(nameof(estimatedArrivalTime), "Property is not nullable for class EstimationTrackingData.");

            if (type.IsSet && type.Value == null)
                throw new ArgumentNullException(nameof(type), "Property is not nullable for class EstimationTrackingData.");
