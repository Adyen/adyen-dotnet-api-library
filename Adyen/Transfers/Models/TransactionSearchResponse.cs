    ...
    public class TransactionSearchResponseJsonConverter : JsonConverter<TransactionSearchResponse>
    {
        ...
        public override TransactionSearchResponse Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (links.IsSet && links.Value == null)
                throw new ArgumentNullException(nameof(links), "Property is not nullable for class TransactionSearchResponse.");

            if (data.IsSet && data.Value == null)
                throw new ArgumentNullException(nameof(data), "Property is not nullable for class TransactionSearchResponse.");
        ...
        {
            /*
            if (transactionSearchResponse._LinksOption.IsSet && transactionSearchResponse.Links == null)
                throw new ArgumentNullException(nameof(transactionSearchResponse.Links), "Property is required for class TransactionSearchResponse.");

            if (transactionSearchResponse._DataOption.IsSet && transactionSearchResponse.Data == null)
                throw new ArgumentNullException(nameof(transactionSearchResponse.Data), "Property is required for class TransactionSearchResponse.");
