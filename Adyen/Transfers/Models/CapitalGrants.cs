...
namespace Adyen.Transfers.Models
{
    ...
    /// CapitalGrants.
    /// </summary>
    public partial class CapitalGrants : IValidatableObject
    {
        /// <summary>
    ...
    /// <summary>
    /// A Json converter for type <see cref="CapitalGrants" />
    /// </summary>
    public class CapitalGrantsJsonConverter : JsonConverter<CapitalGrants>
    {
        /// <summary>
        /// Deserializes json to <see cref="CapitalGrants"/>.
        /// </summary>
        ...
        public override CapitalGrants Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            Option<List<CapitalGrant>?> grants = default;
            ...
            while (utf8JsonReader.Read())
            {
                ...
                if (utf8JsonReader.TokenType == JsonTokenType.PropertyName && currentDepth == utf8JsonReader.CurrentDepth - 1)
                {
                    ...
                    {
                        case "grants":
                            grants = new Option<List<CapitalGrant>?>(JsonSerializer.Deserialize<List<CapitalGrant>>(ref utf8JsonReader, jsonSerializerOptions)!);
                            break;
                        default:
                            break;
                    }
            ...
            if (grants.IsSet && grants.Value == null)
                throw new ArgumentNullException(nameof(grants), "Property is not nullable for class CapitalGrants.");

            return new CapitalGrants(grants.Value!);
        }

        /// <summary>
        /// Serializes a <see cref="CapitalGrants"/>.
        /// </summary>
        /// <param name="writer"><see cref="Utf8JsonWriter"/></param>
        /// <param name="capitalGrants"></param>
        /// <param name="jsonSerializerOptions"><see cref="JsonSerializerOptions"/></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, CapitalGrants capitalGrants, JsonSerializerOptions jsonSerializerOptions)
        {
            
            writer.WriteStartObject();
            
            WriteProperties(writer, capitalGrants, jsonSerializerOptions);
        ...
        /// <summary>
        /// Serializes the properties of <see cref="CapitalGrants"/>.
        /// </summary>
        /// <param name="writer"><see creft="Utf8JsonWriter"/></param>
        /// <param name="capitalGrants"></param>
        /// <param name="jsonSerializerOptions"><see cref="JsonSerializerOptions"/></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, CapitalGrants capitalGrants, JsonSerializerOptions jsonSerializerOptions)
        {
            /*
            if (capitalGrants.Grants == null)
                throw new ArgumentNullException(nameof(capitalGrants.Grants), "Property is required for class CapitalGrants.");

            */
            
            writer.WritePropertyName("grants");
            JsonSerializer.Serialize(writer, capitalGrants.Grants, jsonSerializerOptions);
        }
    }
}
