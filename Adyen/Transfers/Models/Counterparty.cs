    ...
    public class CounterpartyJsonConverter : JsonConverter<Counterparty>
    {
        ...
        public override Counterparty Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (accountHolderId.IsSet && accountHolderId.Value == null)
                throw new ArgumentNullException(nameof(accountHolderId), "Property is not nullable for class Counterparty.");

            if (balanceAccountId.IsSet && balanceAccountId.Value == null)
                throw new ArgumentNullException(nameof(balanceAccountId), "Property is not nullable for class Counterparty.");
        ...
        {
            /*
            if (counterparty._AccountHolderIdOption.IsSet && counterparty.AccountHolderId == null)
                throw new ArgumentNullException(nameof(counterparty.AccountHolderId), "Property is required for class Counterparty.");

            if (counterparty._BalanceAccountIdOption.IsSet && counterparty.BalanceAccountId == null)
                throw new ArgumentNullException(nameof(counterparty.BalanceAccountId), "Property is required for class Counterparty.");
