    ...
    public class AuthenticationNotificationDataJsonConverter : JsonConverter<AuthenticationNotificationData>
    {
        ...
        public override AuthenticationNotificationData Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (authentication.IsSet && authentication.Value == null)
                throw new ArgumentNullException(nameof(authentication), "Property is not nullable for class AuthenticationNotificationData.");

            if (id.IsSet && id.Value == null)
                throw new ArgumentNullException(nameof(id), "Property is not nullable for class AuthenticationNotificationData.");

            if (paymentInstrumentId.IsSet && paymentInstrumentId.Value == null)
                throw new ArgumentNullException(nameof(paymentInstrumentId), "Property is not nullable for class AuthenticationNotificationData.");

            if (purchase.IsSet && purchase.Value == null)
                throw new ArgumentNullException(nameof(purchase), "Property is not nullable for class AuthenticationNotificationData.");

            if (status.IsSet && status.Value == null)
                throw new ArgumentNullException(nameof(status), "Property is not nullable for class AuthenticationNotificationData.");

            if (balancePlatform.IsSet && balancePlatform.Value == null)
                throw new ArgumentNullException(nameof(balancePlatform), "Property is not nullable for class AuthenticationNotificationData.");
        ...
        {
            /*
            if (authenticationNotificationData.Authentication == null)
                throw new ArgumentNullException(nameof(authenticationNotificationData.Authentication), "Property is required for class AuthenticationNotificationData.");

            if (authenticationNotificationData.Id == null)
                throw new ArgumentNullException(nameof(authenticationNotificationData.Id), "Property is required for class AuthenticationNotificationData.");

            if (authenticationNotificationData.PaymentInstrumentId == null)
                throw new ArgumentNullException(nameof(authenticationNotificationData.PaymentInstrumentId), "Property is required for class AuthenticationNotificationData.");

            if (authenticationNotificationData.Purchase == null)
                throw new ArgumentNullException(nameof(authenticationNotificationData.Purchase), "Property is required for class AuthenticationNotificationData.");

            if (authenticationNotificationData._BalancePlatformOption.IsSet && authenticationNotificationData.BalancePlatform == null)
                throw new ArgumentNullException(nameof(authenticationNotificationData.BalancePlatform), "Property is required for class AuthenticationNotificationData.");
