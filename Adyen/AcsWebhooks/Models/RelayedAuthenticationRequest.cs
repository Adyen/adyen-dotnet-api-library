    ...
    public class RelayedAuthenticationRequestJsonConverter : JsonConverter<RelayedAuthenticationRequest>
    {
        ...
        public override RelayedAuthenticationRequest Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (environment.IsSet && environment.Value == null)
                throw new ArgumentNullException(nameof(environment), "Property is not nullable for class RelayedAuthenticationRequest.");

            if (id.IsSet && id.Value == null)
                throw new ArgumentNullException(nameof(id), "Property is not nullable for class RelayedAuthenticationRequest.");

            if (paymentInstrumentId.IsSet && paymentInstrumentId.Value == null)
                throw new ArgumentNullException(nameof(paymentInstrumentId), "Property is not nullable for class RelayedAuthenticationRequest.");

            if (purchase.IsSet && purchase.Value == null)
                throw new ArgumentNullException(nameof(purchase), "Property is not nullable for class RelayedAuthenticationRequest.");

            if (type.IsSet && type.Value == null)
                throw new ArgumentNullException(nameof(type), "Property is not nullable for class RelayedAuthenticationRequest.");

            if (threeDSRequestorAppURL.IsSet && threeDSRequestorAppURL.Value == null)
                throw new ArgumentNullException(nameof(threeDSRequestorAppURL), "Property is not nullable for class RelayedAuthenticationRequest.");

            if (timestamp.IsSet && timestamp.Value == null)
                throw new ArgumentNullException(nameof(timestamp), "Property is not nullable for class RelayedAuthenticationRequest.");
        ...
        public void WriteProperties(Utf8JsonWriter writer, RelayedAuthenticationRequest relayedAuthenticationRequest, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (relayedAuthenticationRequest.Environment == null)
                throw new ArgumentNullException(nameof(relayedAuthenticationRequest.Environment), "Property is required for class RelayedAuthenticationRequest.");

            if (relayedAuthenticationRequest.Id == null)
                throw new ArgumentNullException(nameof(relayedAuthenticationRequest.Id), "Property is required for class RelayedAuthenticationRequest.");

            if (relayedAuthenticationRequest.PaymentInstrumentId == null)
                throw new ArgumentNullException(nameof(relayedAuthenticationRequest.PaymentInstrumentId), "Property is required for class RelayedAuthenticationRequest.");

            if (relayedAuthenticationRequest.Purchase == null)
                throw new ArgumentNullException(nameof(relayedAuthenticationRequest.Purchase), "Property is required for class RelayedAuthenticationRequest.");

            if (relayedAuthenticationRequest._ThreeDSRequestorAppURLOption.IsSet && relayedAuthenticationRequest.ThreeDSRequestorAppURL == null)
                throw new ArgumentNullException(nameof(relayedAuthenticationRequest.ThreeDSRequestorAppURL), "Property is required for class RelayedAuthenticationRequest.");
