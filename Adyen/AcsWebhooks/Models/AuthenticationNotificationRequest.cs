    ...
    public class AuthenticationNotificationRequestJsonConverter : JsonConverter<AuthenticationNotificationRequest>
    {
        ...
        public override AuthenticationNotificationRequest Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (data.IsSet && data.Value == null)
                throw new ArgumentNullException(nameof(data), "Property is not nullable for class AuthenticationNotificationRequest.");

            if (environment.IsSet && environment.Value == null)
                throw new ArgumentNullException(nameof(environment), "Property is not nullable for class AuthenticationNotificationRequest.");

            if (type.IsSet && type.Value == null)
                throw new ArgumentNullException(nameof(type), "Property is not nullable for class AuthenticationNotificationRequest.");

            if (timestamp.IsSet && timestamp.Value == null)
                throw new ArgumentNullException(nameof(timestamp), "Property is not nullable for class AuthenticationNotificationRequest.");
        ...
        {
            /*
            if (authenticationNotificationRequest.Data == null)
                throw new ArgumentNullException(nameof(authenticationNotificationRequest.Data), "Property is required for class AuthenticationNotificationRequest.");

            if (authenticationNotificationRequest.Environment == null)
                throw new ArgumentNullException(nameof(authenticationNotificationRequest.Environment), "Property is required for class AuthenticationNotificationRequest.");
