    ...
    public class BalanceAccountBalanceNotificationRequestJsonConverter : JsonConverter<BalanceAccountBalanceNotificationRequest>
    {
        ...
        public override BalanceAccountBalanceNotificationRequest Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (data.IsSet && data.Value == null)
                throw new ArgumentNullException(nameof(data), "Property is not nullable for class BalanceAccountBalanceNotificationRequest.");

            if (environment.IsSet && environment.Value == null)
                throw new ArgumentNullException(nameof(environment), "Property is not nullable for class BalanceAccountBalanceNotificationRequest.");

            if (type.IsSet && type.Value == null)
                throw new ArgumentNullException(nameof(type), "Property is not nullable for class BalanceAccountBalanceNotificationRequest.");

            if (timestamp.IsSet && timestamp.Value == null)
                throw new ArgumentNullException(nameof(timestamp), "Property is not nullable for class BalanceAccountBalanceNotificationRequest.");
        ...
        {
            /*
            if (balanceAccountBalanceNotificationRequest.Data == null)
                throw new ArgumentNullException(nameof(balanceAccountBalanceNotificationRequest.Data), "Property is required for class BalanceAccountBalanceNotificationRequest.");

            if (balanceAccountBalanceNotificationRequest.Environment == null)
                throw new ArgumentNullException(nameof(balanceAccountBalanceNotificationRequest.Environment), "Property is required for class BalanceAccountBalanceNotificationRequest.");
