    ...
    public class BalanceNotificationDataJsonConverter : JsonConverter<BalanceNotificationData>
    {
        ...
        public override BalanceNotificationData Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (balanceAccountId.IsSet && balanceAccountId.Value == null)
                throw new ArgumentNullException(nameof(balanceAccountId), "Property is not nullable for class BalanceNotificationData.");

            if (balances.IsSet && balances.Value == null)
                throw new ArgumentNullException(nameof(balances), "Property is not nullable for class BalanceNotificationData.");

            if (currency.IsSet && currency.Value == null)
                throw new ArgumentNullException(nameof(currency), "Property is not nullable for class BalanceNotificationData.");

            if (settingIds.IsSet && settingIds.Value == null)
                throw new ArgumentNullException(nameof(settingIds), "Property is not nullable for class BalanceNotificationData.");

            if (balancePlatform.IsSet && balancePlatform.Value == null)
                throw new ArgumentNullException(nameof(balancePlatform), "Property is not nullable for class BalanceNotificationData.");

            if (creationDate.IsSet && creationDate.Value == null)
                throw new ArgumentNullException(nameof(creationDate), "Property is not nullable for class BalanceNotificationData.");

            if (id.IsSet && id.Value == null)
                throw new ArgumentNullException(nameof(id), "Property is not nullable for class BalanceNotificationData.");
        ...
        public void WriteProperties(Utf8JsonWriter writer, BalanceNotificationData balanceNotificationData, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (balanceNotificationData.BalanceAccountId == null)
                throw new ArgumentNullException(nameof(balanceNotificationData.BalanceAccountId), "Property is required for class BalanceNotificationData.");

            if (balanceNotificationData.Balances == null)
                throw new ArgumentNullException(nameof(balanceNotificationData.Balances), "Property is required for class BalanceNotificationData.");

            if (balanceNotificationData.Currency == null)
                throw new ArgumentNullException(nameof(balanceNotificationData.Currency), "Property is required for class BalanceNotificationData.");

            if (balanceNotificationData.SettingIds == null)
                throw new ArgumentNullException(nameof(balanceNotificationData.SettingIds), "Property is required for class BalanceNotificationData.");

            if (balanceNotificationData._BalancePlatformOption.IsSet && balanceNotificationData.BalancePlatform == null)
                throw new ArgumentNullException(nameof(balanceNotificationData.BalancePlatform), "Property is required for class BalanceNotificationData.");

            if (balanceNotificationData._IdOption.IsSet && balanceNotificationData.Id == null)
                throw new ArgumentNullException(nameof(balanceNotificationData.Id), "Property is required for class BalanceNotificationData.");
