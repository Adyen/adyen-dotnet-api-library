...
namespace Adyen.BalanceWebhooks.Models
{
    ...
    /// </summary>
    public partial class ReleasedBlockedBalanceNotificationRequest
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ReleasedBlockedBalanceNotificationRequest" /> class.
        /// </summary>
        ...
        [JsonConstructor]
        public ReleasedBlockedBalanceNotificationRequest(ReleaseBlockedBalanceNotificationData data, string environment, TypeEnum type, Option<DateTimeOffset?> timestamp = default)
        {
            Data = data;
        ...
        public class TypeEnum : IEnum
        {
            ...
            /// </summary>
            public static readonly TypeEnum BalancePlatformBalanceAccountBalanceBlockReleased = new("balancePlatform.balanceAccount.balance.block.released");
            ...
            {
                return value switch {
                    "balancePlatform.balanceAccount.balance.block.released" => TypeEnum.BalancePlatformBalanceAccountBalanceBlockReleased,
                    _ => null,
                };
            }
    ...
    /// <summary>
    /// A Json converter for type <see cref="ReleasedBlockedBalanceNotificationRequest" />
    /// </summary>
    public class ReleasedBlockedBalanceNotificationRequestJsonConverter : JsonConverter<ReleasedBlockedBalanceNotificationRequest>
    {
        /// <summary>
        ...
        /// <summary>
        /// Deserializes json to <see cref="ReleasedBlockedBalanceNotificationRequest"/>.
        /// </summary>
        /// <param name="utf8JsonReader"><see cref="Utf8JsonReader"/>.</param>
        /// <param name="typeToConvert"><see cref="Type"/>.</param>
        /// <param name="jsonSerializerOptions">The <see cref="JsonSerializerOptions"/>, initialized from <see cref="HostConfiguration"/>.</param>
        /// <returns><see cref="ReleasedBlockedBalanceNotificationRequest"/>.</returns>
        /// <exception cref="JsonException"></exception>
        public override ReleasedBlockedBalanceNotificationRequest Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            Option<ReleaseBlockedBalanceNotificationData?> data = default;
            Option<string?> environment = default;
            Option<ReleasedBlockedBalanceNotificationRequest.TypeEnum?> type = default;
            ...
            while (utf8JsonReader.Read())
            {
                ...
                if (utf8JsonReader.TokenType == JsonTokenType.PropertyName && currentDepth == utf8JsonReader.CurrentDepth - 1)
                {
                    ...
                    {
                        case "data":
                            data = new Option<ReleaseBlockedBalanceNotificationData?>(JsonSerializer.Deserialize<ReleaseBlockedBalanceNotificationData>(ref utf8JsonReader, jsonSerializerOptions)!);
                            break;
                        case "environment":
            ...
            return new ReleasedBlockedBalanceNotificationRequest(data.Value!, environment.Value!, type.Value!.Value!, timestamp);
        }

        /// <summary>
        /// Serializes a <see cref="ReleasedBlockedBalanceNotificationRequest"/>.
        /// </summary>
        /// <param name="writer"><see cref="Utf8JsonWriter"/></param>
        /// <param name="releasedBlockedBalanceNotificationRequest"></param>
        /// <param name="jsonSerializerOptions"><see cref="JsonSerializerOptions"/></param>
        public override void Write(Utf8JsonWriter writer, ReleasedBlockedBalanceNotificationRequest releasedBlockedBalanceNotificationRequest, JsonSerializerOptions jsonSerializerOptions)
        {
            
            writer.WriteStartObject();
            
            WriteProperties(writer, releasedBlockedBalanceNotificationRequest, jsonSerializerOptions);
        ...
        /// <param name="releasedBlockedBalanceNotificationRequest"></param>
        /// <param name="jsonSerializerOptions"><see cref="JsonSerializerOptions"/></param>
        public void WriteProperties(Utf8JsonWriter writer, ReleasedBlockedBalanceNotificationRequest releasedBlockedBalanceNotificationRequest, JsonSerializerOptions jsonSerializerOptions)
        {
            
            writer.WritePropertyName("data");
            JsonSerializer.Serialize(writer, releasedBlockedBalanceNotificationRequest.Data, jsonSerializerOptions);
            if (releasedBlockedBalanceNotificationRequest.Environment != null)
                writer.WriteString("environment", releasedBlockedBalanceNotificationRequest.Environment);

            if (releasedBlockedBalanceNotificationRequest.Type != null) 
            {
                string? typeRawValue = ReleasedBlockedBalanceNotificationRequest.TypeEnum.ToJsonValue(releasedBlockedBalanceNotificationRequest.Type);
                writer.WriteString("type", typeRawValue);
            }
            
            if (releasedBlockedBalanceNotificationRequest._TimestampOption.IsSet)
                if (releasedBlockedBalanceNotificationRequest._TimestampOption.Value != null)
                    writer.WriteString("timestamp", releasedBlockedBalanceNotificationRequest._TimestampOption.Value!.Value.ToString(TimestampFormat));
        }
    }
}
