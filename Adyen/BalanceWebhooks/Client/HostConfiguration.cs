...
{
    /// <summary>
    /// Provides hosting configuration for BalanceWebhooks
    /// </summary>
    public class HostConfiguration
    {
        ...
        public HostConfiguration(IServiceCollection services)
        {
            ...
            _jsonOptions.Converters.Add(new BalanceAccountBalanceNotificationRequestJsonConverter());
            _jsonOptions.Converters.Add(new BalanceNotificationDataJsonConverter());
            _jsonOptions.Converters.Add(new BalancePlatformNotificationResponseJsonConverter());
            _jsonOptions.Converters.Add(new BalancesJsonConverter());
            _jsonOptions.Converters.Add(new ReleaseBlockedBalanceNotificationDataJsonConverter());
            _jsonOptions.Converters.Add(new ReleasedBlockedBalanceNotificationRequestJsonConverter());
        ...
        public HostConfiguration AddBalanceWebhooksHttpClients(Action<System.Net.Http.HttpClient>? httpClientOptions = null, Action<IHttpClientBuilder>? httpClientBuilderOptions = null)
        {
