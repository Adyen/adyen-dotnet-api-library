...
using Adyen.Core;
#endif
using Models = Adyen.BalanceWebhooks.Models;
...
namespace Adyen.BalanceWebhooks.Client
{
    ...
    public static partial class ClientUtils
    {
        ...
        public static string? ParameterToString(object? obj, string? format = ISO8601_DATETIME_FORMAT)
        {
            ...
            if (obj is Models.BalanceAccountBalanceNotificationRequest.TypeEnum balanceAccountBalanceNotificationRequestTypeEnum)
                return Models.BalanceAccountBalanceNotificationRequest.TypeEnum.ToJsonValue(balanceAccountBalanceNotificationRequestTypeEnum);
            if (obj is Models.ReleasedBlockedBalanceNotificationRequest.TypeEnum releasedBlockedBalanceNotificationRequestTypeEnum)
                return Models.ReleasedBlockedBalanceNotificationRequest.TypeEnum.ToJsonValue(releasedBlockedBalanceNotificationRequestTypeEnum);
