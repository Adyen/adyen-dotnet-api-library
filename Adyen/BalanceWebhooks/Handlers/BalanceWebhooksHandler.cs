...
namespace Adyen.BalanceWebhooks.Handlers
{
    ...
    public interface IBalanceWebhooksHandler
    {
        ...
        /// <summary>
        /// Uses <see cref="Adyen.BalanceWebhooks.Client.JsonSerializerOptionsProvider"/> to attempt to deserialize <see cref="ReleasedBlockedBalanceNotificationRequest"/>.
        /// </summary>
        /// <param name="json">The full webhook payload.</param>
        /// <exception cref="JsonException"></exception>
        ReleasedBlockedBalanceNotificationRequest? DeserializeReleasedBlockedBalanceNotificationRequest(string json);
    ...
    public partial class BalanceWebhooksHandler : IBalanceWebhooksHandler
    {
        ...
        /// <inheritdoc/>
        public ReleasedBlockedBalanceNotificationRequest? DeserializeReleasedBlockedBalanceNotificationRequest(string json)
        {
            return JsonSerializer.Deserialize<ReleasedBlockedBalanceNotificationRequest>(json, JsonSerializerOptionsProvider.Options);
        }
