...
namespace Adyen.Service.Management
{
    ...
    public interface IAllowedOriginsCompanyLevelService
    {
        ...
        Model.Management.AllowedOrigin CreateAllowedOrigin(string companyId, string apiCredentialId, AllowedOrigin allowedOrigin = default, RequestOptions requestOptions = default);
        ...
        Task<Model.Management.AllowedOrigin> CreateAllowedOriginAsync(string companyId, string apiCredentialId, AllowedOrigin allowedOrigin = default, RequestOptions requestOptions = default, CancellationToken cancellationToken = default);
    ...
    public class AllowedOriginsCompanyLevelService : AbstractService, IAllowedOriginsCompanyLevelService
    {
        ...
        public AllowedOriginsCompanyLevelService(AdyenClient adyenClient) : base(adyenClient)
        {
            _baseUrl = CreateBaseUrl("https://management-test.adyen.com/v3");
        }
        
        public Model.Management.AllowedOrigin CreateAllowedOrigin(string companyId, string apiCredentialId, AllowedOrigin allowedOrigin = default, RequestOptions requestOptions = default)
        {
        ...
        public async Task<Model.Management.AllowedOrigin> CreateAllowedOriginAsync(string companyId, string apiCredentialId, AllowedOrigin allowedOrigin = default, RequestOptions requestOptions = default, CancellationToken cancellationToken = default)
        {
