...
namespace Adyen.Service.Management
{
    ...
    public interface IAccountStoreLevelService
    {
        ...
        /// <param name="requestOptions"><see cref="RequestOptions"/> - Additional request options.</param>
        /// <returns><see cref="Store"/>.</returns>
        Store GetStore(string merchantId, string storeId, RequestOptions requestOptions = default);
        ...
        ListStoresResponse ListStores(int? pageNumber = default, int? pageSize = default, string reference = default, string merchantId = default, RequestOptions requestOptions = default);
        ...
        /// <param name="requestOptions"><see cref="RequestOptions"/> - Additional request options.</param>
        /// <returns><see cref="Store"/>.</returns>
        Store UpdateStore(string merchantId, string storeId, UpdateStoreRequest updateStoreRequest, RequestOptions requestOptions = default);
        ...
        /// <param name="cancellationToken"> A CancellationToken enables cooperative cancellation between threads, thread pool work items, or Task objects.</param>
        /// <returns>Task of <see cref="Store"/>.</returns>
        Task<Store> UpdateStoreAsync(string merchantId, string storeId, UpdateStoreRequest updateStoreRequest, RequestOptions requestOptions = default, CancellationToken cancellationToken = default);
        ...
        /// <param name="requestOptions"><see cref="RequestOptions"/> - Additional request options.</param>
        /// <returns><see cref="Store"/>.</returns>
        Store UpdateStoreById(string storeId, UpdateStoreRequest updateStoreRequest, RequestOptions requestOptions = default);
