...
{
    /// <summary>
    /// TransferLimitsBalancePlatformLevelService Interface
    /// </summary>
    public interface ITransferLimitsBalancePlatformLevelService
    {
        /// <summary>
        ...
        /// <param name="id"><see cref="string"/> - The unique identifier of the balance platform.</param>
        /// <param name="requestOptions"><see cref="RequestOptions"/> - Additional request options.</param>
        void DeletePendingTransferLimit(string transferLimitId, string id, RequestOptions requestOptions = default);
        ...
        /// <param name="requestOptions"><see cref="RequestOptions"/> - Additional request options.</param>
        /// <param name="cancellationToken"> A CancellationToken enables cooperative cancellation between threads, thread pool work items, or Task objects.</param>
        Task DeletePendingTransferLimitAsync(string transferLimitId, string id, RequestOptions requestOptions = default, CancellationToken cancellationToken = default);
        ...
        /// <param name="requestOptions"><see cref="RequestOptions"/> - Additional request options.</param>
        /// <returns><see cref="TransferLimit"/>.</returns>
        Model.BalancePlatform.TransferLimit GetSpecificTransferLimit(string transferLimitId, string id, RequestOptions requestOptions = default);
        ...
        /// <param name="cancellationToken"> A CancellationToken enables cooperative cancellation between threads, thread pool work items, or Task objects.</param>
        /// <returns>Task of <see cref="TransferLimit"/>.</returns>
        Task<Model.BalancePlatform.TransferLimit> GetSpecificTransferLimitAsync(string transferLimitId, string id, RequestOptions requestOptions = default, CancellationToken cancellationToken = default);
    ...
    /// <summary>
    /// Represents a collection of functions to interact with the TransferLimitsBalancePlatformLevelService API endpoints
    /// </summary>
    public class TransferLimitsBalancePlatformLevelService : AbstractService, ITransferLimitsBalancePlatformLevelService
    {
        private readonly string _baseUrl;
        
        public TransferLimitsBalancePlatformLevelService(Client client) : base(client)
        {
        ...
        {
            var endpoint = _baseUrl + $"/balancePlatforms/{id}/transferLimits";
        ...
        public void DeletePendingTransferLimit(string transferLimitId, string id, RequestOptions requestOptions = default)
        {
            DeletePendingTransferLimitAsync(transferLimitId, id, requestOptions).ConfigureAwait(false).GetAwaiter().GetResult();
        }

        public async Task DeletePendingTransferLimitAsync(string transferLimitId, string id, RequestOptions requestOptions = default, CancellationToken cancellationToken = default)
        {
            var endpoint = _baseUrl + $"/balancePlatforms/{id}/transferLimits/{transferLimitId}";
            var resource = new ServiceResource(this, endpoint);
            await resource.RequestAsync(null, requestOptions, new HttpMethod("DELETE"), cancellationToken).ConfigureAwait(false);
        }
        
        public Model.BalancePlatform.TransferLimit GetSpecificTransferLimit(string transferLimitId, string id, RequestOptions requestOptions = default)
        {
            return GetSpecificTransferLimitAsync(transferLimitId, id, requestOptions).ConfigureAwait(false).GetAwaiter().GetResult();
        }

        public async Task<Model.BalancePlatform.TransferLimit> GetSpecificTransferLimitAsync(string transferLimitId, string id, RequestOptions requestOptions = default, CancellationToken cancellationToken = default)
        {
            var endpoint = _baseUrl + $"/balancePlatforms/{id}/transferLimits/{transferLimitId}";
            var resource = new ServiceResource(this, endpoint);
        ...
        public async Task<Model.BalancePlatform.TransferLimitListResponse> GetTransferLimitsAsync(string id, Scope scope = default, TransferType transferType = default, LimitStatus status = default, RequestOptions requestOptions = default, CancellationToken cancellationToken = default)
        {
            ...
            var endpoint = _baseUrl + $"/balancePlatforms/{id}/transferLimits" + ToQueryString(queryParams);
            var resource = new ServiceResource(this, endpoint);
