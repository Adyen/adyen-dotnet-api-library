...
namespace Adyen.Service.BalancePlatform
{
    ...
    public interface IPaymentInstrumentsService
    {
        ...
        Model.BalancePlatform.NetworkTokenActivationDataResponse CreateNetworkTokenActivationData(string id, NetworkTokenActivationDataRequest networkTokenActivationDataRequest = default, RequestOptions requestOptions = default);
        ...
        Task<Model.BalancePlatform.NetworkTokenActivationDataResponse> CreateNetworkTokenActivationDataAsync(string id, NetworkTokenActivationDataRequest networkTokenActivationDataRequest = default, RequestOptions requestOptions = default, CancellationToken cancellationToken = default);
    ...
    public class PaymentInstrumentsService : AbstractService, IPaymentInstrumentsService
    {
        ...
        public Model.BalancePlatform.NetworkTokenActivationDataResponse CreateNetworkTokenActivationData(string id, NetworkTokenActivationDataRequest networkTokenActivationDataRequest = default, RequestOptions requestOptions = default)
        {
            return CreateNetworkTokenActivationDataAsync(id, networkTokenActivationDataRequest, requestOptions).ConfigureAwait(false).GetAwaiter().GetResult();
        }

        public async Task<Model.BalancePlatform.NetworkTokenActivationDataResponse> CreateNetworkTokenActivationDataAsync(string id, NetworkTokenActivationDataRequest networkTokenActivationDataRequest = default, RequestOptions requestOptions = default, CancellationToken cancellationToken = default)
        {
