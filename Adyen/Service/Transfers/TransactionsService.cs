...
namespace Adyen.Service.Transfers
{
    ...
    public interface ITransactionsService
    {
        ...
        TransactionSearchResponse GetAllTransactions(string balancePlatform = default, string paymentInstrumentId = default, string accountHolderId = default, string balanceAccountId = default, string cursor = default, DateTime createdSince, DateTime createdUntil, int? limit = default, RequestOptions requestOptions = default);
    ...
    public class TransactionsService : AbstractService, ITransactionsService
    {
        ...
        {
            return GetAllTransactionsAsync(balancePlatform, paymentInstrumentId, accountHolderId, balanceAccountId, cursor, createdSince, createdUntil, limit, requestOptions).ConfigureAwait(false).GetAwaiter().GetResult();
        }

        public async Task<TransactionSearchResponse> GetAllTransactionsAsync(string balancePlatform = default, string paymentInstrumentId = default, string accountHolderId = default, string balanceAccountId = default, string cursor = default, DateTime createdSince, DateTime createdUntil, int? limit = default, RequestOptions requestOptions = default, CancellationToken cancellationToken = default)
        {
            ...
            if (createdSince != null) queryParams.Add("createdSince", createdSince.ToString());
            if (createdUntil != null) queryParams.Add("createdUntil", createdUntil.ToString());
