...
namespace Adyen.Service.Transfers
{
    ...
    public interface ITransactionsService
    {
        ...
        /// <param name="sortOrder"><see cref="string"/> - The transactions sorting order.  Possible values:   - **asc**: Ascending order, from older to most recent.  - **desc**: Descending order, from most recent to older.</param>
