...
namespace Adyen.Service.Transfers
{
    ...
    public interface ITransfersService
    {
        ...
        /// <param name="sortOrder"><see cref="string"/> - The transfers sorting order.  Possible values:   - **asc**: Ascending order, from older to most recent.  - **desc**: Descending order, from most recent to older.</param>
