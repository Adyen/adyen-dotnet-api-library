...
namespace Adyen.Service.LegalEntityManagement
{
    ...
    public class LegalEntitiesService : AbstractService
    {
        ...
        /// <param name="id">The unique identifier of the legal entity.</param>
        /// <param name="requestOptions">Additional request options.</param>
        /// <returns>VerificationErrors</returns>
        ...
        /// <param name="id">The unique identifier of the legal entity.</param>
        /// <param name="requestOptions">Additional request options.</param>
        /// <returns>Task of VerificationErrors</returns>
        public async Task<VerificationErrors> CheckLegalEntitysVerificationErrorsAsync(string id, RequestOptions requestOptions = default)
        {
            var endpoint = _baseUrl + $"/legalEntities/{id}/checkVerificationErrors";
            var resource = new ServiceResource(this, endpoint);
            return await resource.RequestAsync<VerificationErrors>(null, requestOptions, new HttpMethod("POST"));
        }
