...
using Adyen.DocumentCollector.Extensions;
using Adyen.Core;
...
namespace Adyen.DocumentCollector.Client
{
    /// <summary>
    /// Provides hosting configuration for DocumentCollector
    /// </summary>
    public class HostConfiguration
    {
        ...
        public HostConfiguration(IServiceCollection services)
        {
            ...
            _jsonOptions.Converters.Add(new DocumentContext.DocumentContextJsonConverter());
            _jsonOptions.Converters.Add(new DocumentUploadResponseJsonConverter());
