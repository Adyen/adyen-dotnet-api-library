...
namespace Adyen.SessionAuthentication.Models
{
    ...
    /// </summary>
    [JsonConverter(typeof(AuthenticationSessionResponseJsonConverter))]
    public partial class AuthenticationSessionResponse
    {
        /// <summary>
    ...
    public class AuthenticationSessionResponseJsonConverter : JsonConverter<AuthenticationSessionResponse>
    {
        ...
        public override AuthenticationSessionResponse Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (token.IsSet)
                authenticationSessionResponse.Token = token.Value;
