    ...
    public class AuthenticationSessionResponseJsonConverter : JsonConverter<AuthenticationSessionResponse>
    {
        ...
        public override AuthenticationSessionResponse Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (id.IsSet && id.Value == null)
                throw new ArgumentNullException(nameof(id), "Property is not nullable for class AuthenticationSessionResponse.");

            if (token.IsSet && token.Value == null)
                throw new ArgumentNullException(nameof(token), "Property is not nullable for class AuthenticationSessionResponse.");
        ...
        {
            /*
            if (authenticationSessionResponse._IdOption.IsSet && authenticationSessionResponse.Id == null)
                throw new ArgumentNullException(nameof(authenticationSessionResponse.Id), "Property is required for class AuthenticationSessionResponse.");

            if (authenticationSessionResponse._TokenOption.IsSet && authenticationSessionResponse.Token == null)
                throw new ArgumentNullException(nameof(authenticationSessionResponse.Token), "Property is required for class AuthenticationSessionResponse.");
