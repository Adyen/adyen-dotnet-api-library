...
namespace Adyen.SessionAuthentication.Models
{
    ...
    /// </summary>
    public partial class BalanceAccountResource : Resource, IValidatableObject
    {
        /// <summary>
    ...
    /// <summary>
    /// A Json converter for type <see cref="BalanceAccountResource" />
    /// </summary>
    public class BalanceAccountResourceJsonConverter : JsonConverter<BalanceAccountResource>
    {
        /// <summary>
        /// Deserializes json to <see cref="BalanceAccountResource"/>.
        /// </summary>
        /// <param name="utf8JsonReader"><see cref="Utf8JsonReader"/></param>
        /// <param name="typeToConvert"><see cref="Type"/></param>
        /// <param name="jsonSerializerOptions">The <see cref="JsonSerializerOptions"/>, initialized from <see cref="HostConfiguration"/>.</param>
        /// <returns><see cref="BalanceAccountResource"/></returns>
        /// <exception cref="JsonException"></exception>
        public override BalanceAccountResource Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (balanceAccountId.IsSet && balanceAccountId.Value == null)
                throw new ArgumentNullException(nameof(balanceAccountId), "Property is not nullable for class BalanceAccountResource.");

            if (type.IsSet && type.Value == null)
                throw new ArgumentNullException(nameof(type), "Property is not nullable for class BalanceAccountResource.");

            return new BalanceAccountResource(balanceAccountId.Value!);
        }

        /// <summary>
        /// Serializes a <see cref="BalanceAccountResource"/>.
        /// </summary>
        /// <param name="writer"><see cref="Utf8JsonWriter"/></param>
        /// <param name="balanceAccountResource"></param>
        /// <param name="jsonSerializerOptions"><see cref="JsonSerializerOptions"/></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, BalanceAccountResource balanceAccountResource, JsonSerializerOptions jsonSerializerOptions)
        {
            
            writer.WriteStartObject();
            
            WriteProperties(writer, balanceAccountResource, jsonSerializerOptions);
        ...
        /// <summary>
        /// Serializes the properties of <see cref="BalanceAccountResource"/>.
        /// </summary>
        /// <param name="writer"><see creft="Utf8JsonWriter"/></param>
        /// <param name="balanceAccountResource"></param>
        /// <param name="jsonSerializerOptions"><see cref="JsonSerializerOptions"/></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, BalanceAccountResource balanceAccountResource, JsonSerializerOptions jsonSerializerOptions)
        {
            /*
            if (balanceAccountResource.BalanceAccountId == null)
                throw new ArgumentNullException(nameof(balanceAccountResource.BalanceAccountId), "Property is required for class BalanceAccountResource.");

            */
            
            writer.WriteString("balanceAccountId", balanceAccountResource.BalanceAccountId);

            writer.WriteString("type", ResourceTypeValueConverter.ToJsonValue(balanceAccountResource.Type));
        }
    }
}
