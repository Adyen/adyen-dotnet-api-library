...
namespace Adyen.SessionAuthentication.Models
{
    ...
    public class AuthenticationSessionRequestJsonConverter : JsonConverter<AuthenticationSessionRequest>
    {
        ...
        public override AuthenticationSessionRequest Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (allowOrigin.IsSet && allowOrigin.Value == null)
                throw new ArgumentNullException(nameof(allowOrigin), "Property is not nullable for class AuthenticationSessionRequest.");

            if (policy.IsSet && policy.Value == null)
                throw new ArgumentNullException(nameof(policy), "Property is not nullable for class AuthenticationSessionRequest.");

            if (product.IsSet && product.Value == null)
                throw new ArgumentNullException(nameof(product), "Property is not nullable for class AuthenticationSessionRequest.");
        ...
        public void WriteProperties(Utf8JsonWriter writer, AuthenticationSessionRequest authenticationSessionRequest, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (authenticationSessionRequest.AllowOrigin == null)
                throw new ArgumentNullException(nameof(authenticationSessionRequest.AllowOrigin), "Property is required for class AuthenticationSessionRequest.");

            if (authenticationSessionRequest.Policy == null)
                throw new ArgumentNullException(nameof(authenticationSessionRequest.Policy), "Property is required for class AuthenticationSessionRequest.");
