    ...
    public class LegalEntityResourceJsonConverter : JsonConverter<LegalEntityResource>
    {
        ...
        public override LegalEntityResource Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (legalEntityId.IsSet && legalEntityId.Value == null)
                throw new ArgumentNullException(nameof(legalEntityId), "Property is not nullable for class LegalEntityResource.");

            if (type.IsSet && type.Value == null)
                throw new ArgumentNullException(nameof(type), "Property is not nullable for class LegalEntityResource.");
        ...
        public void WriteProperties(Utf8JsonWriter writer, LegalEntityResource legalEntityResource, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (legalEntityResource.LegalEntityId == null)
                throw new ArgumentNullException(nameof(legalEntityResource.LegalEntityId), "Property is required for class LegalEntityResource.");
