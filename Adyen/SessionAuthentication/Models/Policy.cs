    ...
    public class PolicyJsonConverter : JsonConverter<Policy>
    {
        ...
        public override Policy Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (resources.IsSet && resources.Value == null)
                throw new ArgumentNullException(nameof(resources), "Property is not nullable for class Policy.");

            if (roles.IsSet && roles.Value == null)
                throw new ArgumentNullException(nameof(roles), "Property is not nullable for class Policy.");
        ...
        {
            /*
            if (policy._ResourcesOption.IsSet && policy.Resources == null)
                throw new ArgumentNullException(nameof(policy.Resources), "Property is required for class Policy.");

            if (policy._RolesOption.IsSet && policy.Roles == null)
                throw new ArgumentNullException(nameof(policy.Roles), "Property is required for class Policy.");
