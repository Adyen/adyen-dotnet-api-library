...
namespace Adyen.SessionAuthentication.Models
{
    ...
    /// <summary>
    /// A Json converter for type <see cref="AccountHolderResource" />
    /// </summary>
    public class AccountHolderResourceJsonConverter : JsonConverter<AccountHolderResource>
    {
        /// <summary>
        /// Deserializes json to <see cref="AccountHolderResource"/>.
        /// </summary>
        /// <param name="utf8JsonReader"><see cref="Utf8JsonReader"/></param>
        /// <param name="typeToConvert"><see cref="Type"/></param>
        /// <param name="jsonSerializerOptions">The <see cref="JsonSerializerOptions"/>, initialized from <see cref="HostConfiguration"/>.</param>
        /// <returns><see cref="AccountHolderResource"/></returns>
        /// <exception cref="JsonException"></exception>
        public override AccountHolderResource Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (accountHolderId.IsSet && accountHolderId.Value == null)
                throw new ArgumentNullException(nameof(accountHolderId), "Property is not nullable for class AccountHolderResource.");

            if (type.IsSet && type.Value == null)
                throw new ArgumentNullException(nameof(type), "Property is not nullable for class AccountHolderResource.");

            return new AccountHolderResource(accountHolderId.Value!);
        }

        /// <summary>
        /// Serializes a <see cref="AccountHolderResource"/>.
        /// </summary>
        ...
        public override void Write(Utf8JsonWriter writer, AccountHolderResource accountHolderResource, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            WriteProperties(writer, accountHolderResource, jsonSerializerOptions);
        ...
        /// <summary>
        /// Serializes the properties of <see cref="AccountHolderResource"/>.
        /// </summary>
        ...
        {
            /*
            if (accountHolderResource.AccountHolderId == null)
                throw new ArgumentNullException(nameof(accountHolderResource.AccountHolderId), "Property is required for class AccountHolderResource.");
