    ...
    public class MerchantAccountResourceJsonConverter : JsonConverter<MerchantAccountResource>
    {
        ...
        public override MerchantAccountResource Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (type.IsSet && type.Value == null)
                throw new ArgumentNullException(nameof(type), "Property is not nullable for class MerchantAccountResource.");

            if (merchantAccountCode.IsSet && merchantAccountCode.Value == null)
                throw new ArgumentNullException(nameof(merchantAccountCode), "Property is not nullable for class MerchantAccountResource.");
        ...
        {
            /*
            if (merchantAccountResource._MerchantAccountCodeOption.IsSet && merchantAccountResource.MerchantAccountCode == null)
                throw new ArgumentNullException(nameof(merchantAccountResource.MerchantAccountCode), "Property is required for class MerchantAccountResource.");
