    ...
    public class InvalidFieldJsonConverter : JsonConverter<InvalidField>
    {
        ...
        public override InvalidField Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (name.IsSet && name.Value == null)
                throw new ArgumentNullException(nameof(name), "Property is not nullable for class InvalidField.");

            if (value.IsSet && value.Value == null)
                throw new ArgumentNullException(nameof(value), "Property is not nullable for class InvalidField.");

            if (message.IsSet && message.Value == null)
                throw new ArgumentNullException(nameof(message), "Property is not nullable for class InvalidField.");
        ...
        public void WriteProperties(Utf8JsonWriter writer, InvalidField invalidField, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (invalidField.Name == null)
                throw new ArgumentNullException(nameof(invalidField.Name), "Property is required for class InvalidField.");

            if (invalidField.Value == null)
                throw new ArgumentNullException(nameof(invalidField.Value), "Property is required for class InvalidField.");

            if (invalidField.Message == null)
                throw new ArgumentNullException(nameof(invalidField.Message), "Property is required for class InvalidField.");
