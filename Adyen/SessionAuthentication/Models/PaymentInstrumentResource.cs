    ...
    public class PaymentInstrumentResourceJsonConverter : JsonConverter<PaymentInstrumentResource>
    {
        ...
        public override PaymentInstrumentResource Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (paymentInstrumentId.IsSet && paymentInstrumentId.Value == null)
                throw new ArgumentNullException(nameof(paymentInstrumentId), "Property is not nullable for class PaymentInstrumentResource.");

            if (type.IsSet && type.Value == null)
                throw new ArgumentNullException(nameof(type), "Property is not nullable for class PaymentInstrumentResource.");
        ...
        public void WriteProperties(Utf8JsonWriter writer, PaymentInstrumentResource paymentInstrumentResource, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (paymentInstrumentResource.PaymentInstrumentId == null)
                throw new ArgumentNullException(nameof(paymentInstrumentResource.PaymentInstrumentId), "Property is required for class PaymentInstrumentResource.");
