...
namespace Adyen.SessionAuthentication.Models
{
    ...
    /// </summary>
    [JsonConverter(typeof(DefaultErrorResponseEntityJsonConverter))]
    ...
    public class DefaultErrorResponseEntityJsonConverter : JsonConverter<DefaultErrorResponseEntity>
    {
        ...
        public override DefaultErrorResponseEntity Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (errorCode.IsSet)
                defaultErrorResponseEntity.ErrorCode = errorCode.Value;
            if (instance.IsSet)
                defaultErrorResponseEntity.Instance = instance.Value;
            if (invalidFields.IsSet)
                defaultErrorResponseEntity.InvalidFields = invalidFields.Value;
            if (requestId.IsSet)
                defaultErrorResponseEntity.RequestId = requestId.Value;
            if (status.IsSet)
                defaultErrorResponseEntity.Status = status.Value;
            if (title.IsSet)
                defaultErrorResponseEntity.Title = title.Value;
            if (type.IsSet)
                defaultErrorResponseEntity.Type = type.Value;
            return defaultErrorResponseEntity;
        }
