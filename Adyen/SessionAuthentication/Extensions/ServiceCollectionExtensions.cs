...
namespace Adyen.SessionAuthentication.Extensions
{
    ...
    public static class ServiceCollectionExtensions
    {
        ...
        /// <summary>
        /// Add the Adyen SessionAuthentication API services to your host builder.
        /// </summary>
        /// <param name="services"></param>
        /// <param name="options"></param>
        public static void AddSessionAuthenticationServices(this IServiceCollection services, Action<HostConfiguration> options)
        {
            HostConfiguration config = new(services);
            options(config);
            AddSessionAuthenticationServices(services, config);
        }

        internal static void AddSessionAuthenticationServices(IServiceCollection services, HostConfiguration host)
        {
            if (!host.HttpClientsAdded)
                host.AddSessionAuthenticationHttpClients();
