...
namespace Adyen.Model.Checkout
{
    ...
    /// </summary>
    [DataContract(Name = "PaymentCancelResponse")]
    public partial class PaymentCancelResponse : IEquatable<PaymentCancelResponse>, IValidatableObject
    {
        /// <summary>
        ...
        protected PaymentCancelResponse() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="PaymentCancelResponse" /> class.
        /// </summary>
        ...
        {
            return this.Equals(input as PaymentCancelResponse);
        }

        /// <summary>
        /// Returns true if PaymentCancelResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of PaymentCancelResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PaymentCancelResponse input)
        {
            if (input == null)
            {
                return false;
