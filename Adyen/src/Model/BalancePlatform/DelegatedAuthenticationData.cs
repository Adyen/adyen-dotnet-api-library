...
namespace Adyen.Model.BalancePlatform
{
    ...
    public partial class DelegatedAuthenticationData : IEquatable<DelegatedAuthenticationData>, IValidatableObject
    {
        /// <summary>
        ...
        /// Initializes a new instance of the <see cref="DelegatedAuthenticationData" /> class.
        /// </summary>
        /// <param name="sdkOutput">A base64-encoded block with the data required to register the SCA device. You obtain this information by using our authentication SDK. (required).</param>
        ...
        /// </summary>
        /// <param name="input">Instance of DelegatedAuthenticationData to be compared</param>
        /// <returns>Boolean</returns>
