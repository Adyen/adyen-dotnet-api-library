...
namespace Adyen.Model.PlatformsNotificationConfiguration
{
    ...
    /// </summary>
    [DataContract(Name = "GetNotificationConfigurationListResponse")]
    public partial class GetNotificationConfigurationListResponse : IEquatable<GetNotificationConfigurationListResponse>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GetNotificationConfigurationListResponse" /> class.
        /// </summary>
        /// <param name="configurations">Details of the notification subscription configurations..</param>
        ...
        public GetNotificationConfigurationListResponse(List<NotificationConfigurationDetails> configurations = default(List<NotificationConfigurationDetails>), List<ErrorFieldType> invalidFields = default(List<ErrorFieldType>), string pspReference = default(string), string resultCode = default(string))
        {
        ...
        /// </summary>
        /// <value>Details of the notification subscription configurations.</value>
        [DataMember(Name = "configurations", EmitDefaultValue = false)]
        public List<NotificationConfigurationDetails> Configurations { get; set; }
        ...
        {
            return this.Equals(input as GetNotificationConfigurationListResponse);
        }

        /// <summary>
        /// Returns true if GetNotificationConfigurationListResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of GetNotificationConfigurationListResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GetNotificationConfigurationListResponse input)
        {
            if (input == null)
            {
                return false;
