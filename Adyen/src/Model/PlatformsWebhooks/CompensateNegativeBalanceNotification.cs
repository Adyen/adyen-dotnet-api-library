...
namespace Adyen.Model.PlatformsWebhooks
{
    ...
    /// </summary>
    [DataContract(Name = "CompensateNegativeBalanceNotification")]
    public partial class CompensateNegativeBalanceNotification : IEquatable<CompensateNegativeBalanceNotification>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CompensateNegativeBalanceNotification" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected CompensateNegativeBalanceNotification() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="CompensateNegativeBalanceNotification" /> class.
        /// </summary>
        ...
        {
            return this.Equals(input as CompensateNegativeBalanceNotification);
        }

        /// <summary>
        /// Returns true if CompensateNegativeBalanceNotification instances are equal
        /// </summary>
        /// <param name="input">Instance of CompensateNegativeBalanceNotification to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CompensateNegativeBalanceNotification input)
        {
            if (input == null)
            {
                return false;
