...
namespace Adyen.Model.PlatformsWebhooks
{
    ...
    /// </summary>
    [DataContract(Name = "AccountFundsBelowThresholdNotification")]
    public partial class AccountFundsBelowThresholdNotification : IEquatable<AccountFundsBelowThresholdNotification>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AccountFundsBelowThresholdNotification" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected AccountFundsBelowThresholdNotification() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="AccountFundsBelowThresholdNotification" /> class.
        /// </summary>
        ...
        {
            return this.Equals(input as AccountFundsBelowThresholdNotification);
        }

        /// <summary>
        /// Returns true if AccountFundsBelowThresholdNotification instances are equal
        /// </summary>
        /// <param name="input">Instance of AccountFundsBelowThresholdNotification to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AccountFundsBelowThresholdNotification input)
        {
            if (input == null)
            {
                return false;
