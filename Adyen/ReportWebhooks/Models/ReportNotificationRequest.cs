    ...
    public class ReportNotificationRequestJsonConverter : JsonConverter<ReportNotificationRequest>
    {
        ...
        public override ReportNotificationRequest Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (data.IsSet && data.Value == null)
                throw new ArgumentNullException(nameof(data), "Property is not nullable for class ReportNotificationRequest.");

            if (environment.IsSet && environment.Value == null)
                throw new ArgumentNullException(nameof(environment), "Property is not nullable for class ReportNotificationRequest.");

            if (type.IsSet && type.Value == null)
                throw new ArgumentNullException(nameof(type), "Property is not nullable for class ReportNotificationRequest.");

            if (timestamp.IsSet && timestamp.Value == null)
                throw new ArgumentNullException(nameof(timestamp), "Property is not nullable for class ReportNotificationRequest.");
        ...
        {
            /*
            if (reportNotificationRequest.Data == null)
                throw new ArgumentNullException(nameof(reportNotificationRequest.Data), "Property is required for class ReportNotificationRequest.");

            if (reportNotificationRequest.Environment == null)
                throw new ArgumentNullException(nameof(reportNotificationRequest.Environment), "Property is required for class ReportNotificationRequest.");
