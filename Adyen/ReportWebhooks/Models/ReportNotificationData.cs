...
namespace Adyen.ReportWebhooks.Models
{
    ...
    /// </summary>
    public partial class ReportNotificationData : IValidatableObject
    {
        /// <summary>
    ...
    public class ReportNotificationDataJsonConverter : JsonConverter<ReportNotificationData>
    {
        ...
        public override ReportNotificationData Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (downloadUrl.IsSet && downloadUrl.Value == null)
                throw new ArgumentNullException(nameof(downloadUrl), "Property is not nullable for class ReportNotificationData.");

            if (fileName.IsSet && fileName.Value == null)
                throw new ArgumentNullException(nameof(fileName), "Property is not nullable for class ReportNotificationData.");

            if (reportType.IsSet && reportType.Value == null)
                throw new ArgumentNullException(nameof(reportType), "Property is not nullable for class ReportNotificationData.");

            if (accountHolder.IsSet && accountHolder.Value == null)
                throw new ArgumentNullException(nameof(accountHolder), "Property is not nullable for class ReportNotificationData.");

            if (balanceAccount.IsSet && balanceAccount.Value == null)
                throw new ArgumentNullException(nameof(balanceAccount), "Property is not nullable for class ReportNotificationData.");

            if (balancePlatform.IsSet && balancePlatform.Value == null)
                throw new ArgumentNullException(nameof(balancePlatform), "Property is not nullable for class ReportNotificationData.");

            if (creationDate.IsSet && creationDate.Value == null)
                throw new ArgumentNullException(nameof(creationDate), "Property is not nullable for class ReportNotificationData.");

            if (id.IsSet && id.Value == null)
                throw new ArgumentNullException(nameof(id), "Property is not nullable for class ReportNotificationData.");
        ...
        public void WriteProperties(Utf8JsonWriter writer, ReportNotificationData reportNotificationData, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (reportNotificationData.DownloadUrl == null)
                throw new ArgumentNullException(nameof(reportNotificationData.DownloadUrl), "Property is required for class ReportNotificationData.");

            if (reportNotificationData.FileName == null)
                throw new ArgumentNullException(nameof(reportNotificationData.FileName), "Property is required for class ReportNotificationData.");

            if (reportNotificationData.ReportType == null)
                throw new ArgumentNullException(nameof(reportNotificationData.ReportType), "Property is required for class ReportNotificationData.");

            if (reportNotificationData._AccountHolderOption.IsSet && reportNotificationData.AccountHolder == null)
                throw new ArgumentNullException(nameof(reportNotificationData.AccountHolder), "Property is required for class ReportNotificationData.");

            if (reportNotificationData._BalanceAccountOption.IsSet && reportNotificationData.BalanceAccount == null)
                throw new ArgumentNullException(nameof(reportNotificationData.BalanceAccount), "Property is required for class ReportNotificationData.");

            if (reportNotificationData._BalancePlatformOption.IsSet && reportNotificationData.BalancePlatform == null)
                throw new ArgumentNullException(nameof(reportNotificationData.BalancePlatform), "Property is required for class ReportNotificationData.");

            if (reportNotificationData._IdOption.IsSet && reportNotificationData.Id == null)
                throw new ArgumentNullException(nameof(reportNotificationData.Id), "Property is required for class ReportNotificationData.");
