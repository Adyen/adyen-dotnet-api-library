...
using Models = Adyen.ReportWebhooks.Models;
...
namespace Adyen.ReportWebhooks.Client
{
    ...
    public static partial class ClientUtils
    {
        ...
        public static string? ParameterToString(object? obj, string? format = ISO8601_DATETIME_FORMAT)
        {
            ...
            if (obj is Models.ReportNotificationRequest.TypeEnum reportNotificationRequestTypeEnum)
                return Models.ReportNotificationRequest.TypeEnum.ToJsonValue(reportNotificationRequestTypeEnum);
