...
namespace Adyen.Recurring.Models
{
    ...
    /// </summary>
    public partial class RecurringDetailsRequest : IValidatableObject
    {
        /// <summary>
    ...
    public class RecurringDetailsRequestJsonConverter : JsonConverter<RecurringDetailsRequest>
    {
        ...
        public override RecurringDetailsRequest Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (merchantAccount.IsSet && merchantAccount.Value == null)
                throw new ArgumentNullException(nameof(merchantAccount), "Property is not nullable for class RecurringDetailsRequest.");

            if (shopperReference.IsSet && shopperReference.Value == null)
                throw new ArgumentNullException(nameof(shopperReference), "Property is not nullable for class RecurringDetailsRequest.");

            if (recurring.IsSet && recurring.Value == null)
                throw new ArgumentNullException(nameof(recurring), "Property is not nullable for class RecurringDetailsRequest.");
        ...
        public void WriteProperties(Utf8JsonWriter writer, RecurringDetailsRequest recurringDetailsRequest, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (recurringDetailsRequest.MerchantAccount == null)
                throw new ArgumentNullException(nameof(recurringDetailsRequest.MerchantAccount), "Property is required for class RecurringDetailsRequest.");

            if (recurringDetailsRequest.ShopperReference == null)
                throw new ArgumentNullException(nameof(recurringDetailsRequest.ShopperReference), "Property is required for class RecurringDetailsRequest.");

            if (recurringDetailsRequest._RecurringOption.IsSet && recurringDetailsRequest.Recurring == null)
                throw new ArgumentNullException(nameof(recurringDetailsRequest.Recurring), "Property is required for class RecurringDetailsRequest.");
