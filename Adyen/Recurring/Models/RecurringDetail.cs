    ...
    public class RecurringDetailJsonConverter : JsonConverter<RecurringDetail>
    {
        ...
        public override RecurringDetail Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (recurringDetailReference.IsSet && recurringDetailReference.Value == null)
                throw new ArgumentNullException(nameof(recurringDetailReference), "Property is not nullable for class RecurringDetail.");

            if (variant.IsSet && variant.Value == null)
                throw new ArgumentNullException(nameof(variant), "Property is not nullable for class RecurringDetail.");

            if (additionalData.IsSet && additionalData.Value == null)
                throw new ArgumentNullException(nameof(additionalData), "Property is not nullable for class RecurringDetail.");

            if (alias.IsSet && alias.Value == null)
                throw new ArgumentNullException(nameof(alias), "Property is not nullable for class RecurringDetail.");

            if (aliasType.IsSet && aliasType.Value == null)
                throw new ArgumentNullException(nameof(aliasType), "Property is not nullable for class RecurringDetail.");

            if (bank.IsSet && bank.Value == null)
                throw new ArgumentNullException(nameof(bank), "Property is not nullable for class RecurringDetail.");

            if (billingAddress.IsSet && billingAddress.Value == null)
                throw new ArgumentNullException(nameof(billingAddress), "Property is not nullable for class RecurringDetail.");

            if (card.IsSet && card.Value == null)
                throw new ArgumentNullException(nameof(card), "Property is not nullable for class RecurringDetail.");

            if (contractTypes.IsSet && contractTypes.Value == null)
                throw new ArgumentNullException(nameof(contractTypes), "Property is not nullable for class RecurringDetail.");

            if (creationDate.IsSet && creationDate.Value == null)
                throw new ArgumentNullException(nameof(creationDate), "Property is not nullable for class RecurringDetail.");

            if (firstPspReference.IsSet && firstPspReference.Value == null)
                throw new ArgumentNullException(nameof(firstPspReference), "Property is not nullable for class RecurringDetail.");

            if (name.IsSet && name.Value == null)
                throw new ArgumentNullException(nameof(name), "Property is not nullable for class RecurringDetail.");

            if (networkTxReference.IsSet && networkTxReference.Value == null)
                throw new ArgumentNullException(nameof(networkTxReference), "Property is not nullable for class RecurringDetail.");

            if (paymentMethodVariant.IsSet && paymentMethodVariant.Value == null)
                throw new ArgumentNullException(nameof(paymentMethodVariant), "Property is not nullable for class RecurringDetail.");

            if (shopperName.IsSet && shopperName.Value == null)
                throw new ArgumentNullException(nameof(shopperName), "Property is not nullable for class RecurringDetail.");

            if (socialSecurityNumber.IsSet && socialSecurityNumber.Value == null)
                throw new ArgumentNullException(nameof(socialSecurityNumber), "Property is not nullable for class RecurringDetail.");

            if (tokenDetails.IsSet && tokenDetails.Value == null)
                throw new ArgumentNullException(nameof(tokenDetails), "Property is not nullable for class RecurringDetail.");
        ...
        public void WriteProperties(Utf8JsonWriter writer, RecurringDetail recurringDetail, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (recurringDetail.RecurringDetailReference == null)
                throw new ArgumentNullException(nameof(recurringDetail.RecurringDetailReference), "Property is required for class RecurringDetail.");

            if (recurringDetail.Variant == null)
                throw new ArgumentNullException(nameof(recurringDetail.Variant), "Property is required for class RecurringDetail.");

            if (recurringDetail._AdditionalDataOption.IsSet && recurringDetail.AdditionalData == null)
                throw new ArgumentNullException(nameof(recurringDetail.AdditionalData), "Property is required for class RecurringDetail.");

            if (recurringDetail._AliasOption.IsSet && recurringDetail.Alias == null)
                throw new ArgumentNullException(nameof(recurringDetail.Alias), "Property is required for class RecurringDetail.");

            if (recurringDetail._AliasTypeOption.IsSet && recurringDetail.AliasType == null)
                throw new ArgumentNullException(nameof(recurringDetail.AliasType), "Property is required for class RecurringDetail.");

            if (recurringDetail._BankOption.IsSet && recurringDetail.Bank == null)
                throw new ArgumentNullException(nameof(recurringDetail.Bank), "Property is required for class RecurringDetail.");

            if (recurringDetail._BillingAddressOption.IsSet && recurringDetail.BillingAddress == null)
                throw new ArgumentNullException(nameof(recurringDetail.BillingAddress), "Property is required for class RecurringDetail.");

            if (recurringDetail._CardOption.IsSet && recurringDetail.Card == null)
                throw new ArgumentNullException(nameof(recurringDetail.Card), "Property is required for class RecurringDetail.");

            if (recurringDetail._ContractTypesOption.IsSet && recurringDetail.ContractTypes == null)
                throw new ArgumentNullException(nameof(recurringDetail.ContractTypes), "Property is required for class RecurringDetail.");

            if (recurringDetail._FirstPspReferenceOption.IsSet && recurringDetail.FirstPspReference == null)
                throw new ArgumentNullException(nameof(recurringDetail.FirstPspReference), "Property is required for class RecurringDetail.");

            if (recurringDetail._NameOption.IsSet && recurringDetail.Name == null)
                throw new ArgumentNullException(nameof(recurringDetail.Name), "Property is required for class RecurringDetail.");

            if (recurringDetail._NetworkTxReferenceOption.IsSet && recurringDetail.NetworkTxReference == null)
                throw new ArgumentNullException(nameof(recurringDetail.NetworkTxReference), "Property is required for class RecurringDetail.");

            if (recurringDetail._PaymentMethodVariantOption.IsSet && recurringDetail.PaymentMethodVariant == null)
                throw new ArgumentNullException(nameof(recurringDetail.PaymentMethodVariant), "Property is required for class RecurringDetail.");

            if (recurringDetail._ShopperNameOption.IsSet && recurringDetail.ShopperName == null)
                throw new ArgumentNullException(nameof(recurringDetail.ShopperName), "Property is required for class RecurringDetail.");

            if (recurringDetail._SocialSecurityNumberOption.IsSet && recurringDetail.SocialSecurityNumber == null)
                throw new ArgumentNullException(nameof(recurringDetail.SocialSecurityNumber), "Property is required for class RecurringDetail.");

            if (recurringDetail._TokenDetailsOption.IsSet && recurringDetail.TokenDetails == null)
                throw new ArgumentNullException(nameof(recurringDetail.TokenDetails), "Property is required for class RecurringDetail.");
