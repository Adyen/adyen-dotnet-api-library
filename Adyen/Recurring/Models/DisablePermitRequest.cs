    ...
    public class DisablePermitRequestJsonConverter : JsonConverter<DisablePermitRequest>
    {
        ...
        public override DisablePermitRequest Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (merchantAccount.IsSet && merchantAccount.Value == null)
                throw new ArgumentNullException(nameof(merchantAccount), "Property is not nullable for class DisablePermitRequest.");

            if (token.IsSet && token.Value == null)
                throw new ArgumentNullException(nameof(token), "Property is not nullable for class DisablePermitRequest.");
        ...
        public void WriteProperties(Utf8JsonWriter writer, DisablePermitRequest disablePermitRequest, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (disablePermitRequest.MerchantAccount == null)
                throw new ArgumentNullException(nameof(disablePermitRequest.MerchantAccount), "Property is required for class DisablePermitRequest.");

            if (disablePermitRequest.Token == null)
                throw new ArgumentNullException(nameof(disablePermitRequest.Token), "Property is required for class DisablePermitRequest.");
