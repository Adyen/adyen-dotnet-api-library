...
namespace Adyen.Recurring.Models
{
    ...
    /// PermitResult.
    /// </summary>
    public partial class PermitResult : IValidatableObject
    {
        /// <summary>
    ...
    public class PermitResultJsonConverter : JsonConverter<PermitResult>
    {
        ...
        public override PermitResult Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (resultKey.IsSet && resultKey.Value == null)
                throw new ArgumentNullException(nameof(resultKey), "Property is not nullable for class PermitResult.");

            if (token.IsSet && token.Value == null)
                throw new ArgumentNullException(nameof(token), "Property is not nullable for class PermitResult.");
        ...
        {
            /*
            if (permitResult._ResultKeyOption.IsSet && permitResult.ResultKey == null)
                throw new ArgumentNullException(nameof(permitResult.ResultKey), "Property is required for class PermitResult.");

            if (permitResult._TokenOption.IsSet && permitResult.Token == null)
                throw new ArgumentNullException(nameof(permitResult.Token), "Property is required for class PermitResult.");
