...
namespace Adyen.Recurring.Models
{
    ...
    public class RecurringDetailWrapperJsonConverter : JsonConverter<RecurringDetailWrapper>
    {
        ...
        public override RecurringDetailWrapper Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (recurringDetail.IsSet && recurringDetail.Value == null)
                throw new ArgumentNullException(nameof(recurringDetail), "Property is not nullable for class RecurringDetailWrapper.");
        ...
        {
            /*
            if (recurringDetailWrapper._RecurringDetailOption.IsSet && recurringDetailWrapper.RecurringDetail == null)
                throw new ArgumentNullException(nameof(recurringDetailWrapper.RecurringDetail), "Property is required for class RecurringDetailWrapper.");
