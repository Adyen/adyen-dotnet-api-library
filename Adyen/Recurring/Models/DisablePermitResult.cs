...
namespace Adyen.Recurring.Models
{
    ...
    /// DisablePermitResult.
    /// </summary>
    public partial class DisablePermitResult : IValidatableObject
    {
        /// <summary>
    ...
    public class DisablePermitResultJsonConverter : JsonConverter<DisablePermitResult>
    {
        ...
        public override DisablePermitResult Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (pspReference.IsSet && pspReference.Value == null)
                throw new ArgumentNullException(nameof(pspReference), "Property is not nullable for class DisablePermitResult.");

            if (status.IsSet && status.Value == null)
                throw new ArgumentNullException(nameof(status), "Property is not nullable for class DisablePermitResult.");

            return new DisablePermitResult(pspReference, status);
        }
        ...
        {
            /*
            if (disablePermitResult._PspReferenceOption.IsSet && disablePermitResult.PspReference == null)
                throw new ArgumentNullException(nameof(disablePermitResult.PspReference), "Property is required for class DisablePermitResult.");

            if (disablePermitResult._StatusOption.IsSet && disablePermitResult.Status == null)
                throw new ArgumentNullException(nameof(disablePermitResult.Status), "Property is required for class DisablePermitResult.");
