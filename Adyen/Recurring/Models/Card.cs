    ...
    public class CardJsonConverter : JsonConverter<Card>
    {
        ...
        public override Card Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (expiryMonth.IsSet && expiryMonth.Value == null)
                throw new ArgumentNullException(nameof(expiryMonth), "Property is not nullable for class Card.");

            if (expiryYear.IsSet && expiryYear.Value == null)
                throw new ArgumentNullException(nameof(expiryYear), "Property is not nullable for class Card.");

            if (holderName.IsSet && holderName.Value == null)
                throw new ArgumentNullException(nameof(holderName), "Property is not nullable for class Card.");

            if (issueNumber.IsSet && issueNumber.Value == null)
                throw new ArgumentNullException(nameof(issueNumber), "Property is not nullable for class Card.");
            ...
            if (startMonth.IsSet && startMonth.Value == null)
                throw new ArgumentNullException(nameof(startMonth), "Property is not nullable for class Card.");

            if (startYear.IsSet && startYear.Value == null)
                throw new ArgumentNullException(nameof(startYear), "Property is not nullable for class Card.");
        ...
        public void WriteProperties(Utf8JsonWriter writer, Card card, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (card._ExpiryMonthOption.IsSet && card.ExpiryMonth == null)
                throw new ArgumentNullException(nameof(card.ExpiryMonth), "Property is required for class Card.");

            if (card._ExpiryYearOption.IsSet && card.ExpiryYear == null)
                throw new ArgumentNullException(nameof(card.ExpiryYear), "Property is required for class Card.");

            if (card._HolderNameOption.IsSet && card.HolderName == null)
                throw new ArgumentNullException(nameof(card.HolderName), "Property is required for class Card.");

            if (card._IssueNumberOption.IsSet && card.IssueNumber == null)
                throw new ArgumentNullException(nameof(card.IssueNumber), "Property is required for class Card.");

            if (card._NumberOption.IsSet && card.Number == null)
                throw new ArgumentNullException(nameof(card.Number), "Property is required for class Card.");

            if (card._StartMonthOption.IsSet && card.StartMonth == null)
                throw new ArgumentNullException(nameof(card.StartMonth), "Property is required for class Card.");

            if (card._StartYearOption.IsSet && card.StartYear == null)
                throw new ArgumentNullException(nameof(card.StartYear), "Property is required for class Card.");
