...
namespace Adyen.Recurring.Models
{
    ...
    /// CreatePermitResult.
    /// </summary>
    public partial class CreatePermitResult : IValidatableObject
    {
        /// <summary>
    ...
    public class CreatePermitResultJsonConverter : JsonConverter<CreatePermitResult>
    {
        ...
        public override CreatePermitResult Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (permitResultList.IsSet && permitResultList.Value == null)
                throw new ArgumentNullException(nameof(permitResultList), "Property is not nullable for class CreatePermitResult.");

            if (pspReference.IsSet && pspReference.Value == null)
                throw new ArgumentNullException(nameof(pspReference), "Property is not nullable for class CreatePermitResult.");

            return new CreatePermitResult(permitResultList, pspReference);
        }
        ...
        {
            /*
            if (createPermitResult._PermitResultListOption.IsSet && createPermitResult.PermitResultList == null)
                throw new ArgumentNullException(nameof(createPermitResult.PermitResultList), "Property is required for class CreatePermitResult.");

            if (createPermitResult._PspReferenceOption.IsSet && createPermitResult.PspReference == null)
                throw new ArgumentNullException(nameof(createPermitResult.PspReference), "Property is required for class CreatePermitResult.");
