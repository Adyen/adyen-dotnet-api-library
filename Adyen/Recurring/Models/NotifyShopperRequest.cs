...
namespace Adyen.Recurring.Models
{
    ...
    /// </summary>
    [JsonConverter(typeof(NotifyShopperRequestJsonConverter))]
    ...
    public class NotifyShopperRequestJsonConverter : JsonConverter<NotifyShopperRequest>
    {
        ...
        public override NotifyShopperRequest Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (billingSequenceNumber.IsSet)
                notifyShopperRequest.BillingSequenceNumber = billingSequenceNumber.Value;
            if (displayedReference.IsSet)
                notifyShopperRequest.DisplayedReference = displayedReference.Value;
            if (recurringDetailReference.IsSet)
                notifyShopperRequest.RecurringDetailReference = recurringDetailReference.Value;
            if (storedPaymentMethodId.IsSet)
                notifyShopperRequest.StoredPaymentMethodId = storedPaymentMethodId.Value;
