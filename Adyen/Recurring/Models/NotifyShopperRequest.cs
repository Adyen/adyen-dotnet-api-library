    ...
    public class NotifyShopperRequestJsonConverter : JsonConverter<NotifyShopperRequest>
    {
        ...
        public override NotifyShopperRequest Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (amount.IsSet && amount.Value == null)
                throw new ArgumentNullException(nameof(amount), "Property is not nullable for class NotifyShopperRequest.");

            if (merchantAccount.IsSet && merchantAccount.Value == null)
                throw new ArgumentNullException(nameof(merchantAccount), "Property is not nullable for class NotifyShopperRequest.");

            if (reference.IsSet && reference.Value == null)
                throw new ArgumentNullException(nameof(reference), "Property is not nullable for class NotifyShopperRequest.");

            if (shopperReference.IsSet && shopperReference.Value == null)
                throw new ArgumentNullException(nameof(shopperReference), "Property is not nullable for class NotifyShopperRequest.");

            if (billingDate.IsSet && billingDate.Value == null)
                throw new ArgumentNullException(nameof(billingDate), "Property is not nullable for class NotifyShopperRequest.");

            if (billingSequenceNumber.IsSet && billingSequenceNumber.Value == null)
                throw new ArgumentNullException(nameof(billingSequenceNumber), "Property is not nullable for class NotifyShopperRequest.");

            if (displayedReference.IsSet && displayedReference.Value == null)
                throw new ArgumentNullException(nameof(displayedReference), "Property is not nullable for class NotifyShopperRequest.");

            if (recurringDetailReference.IsSet && recurringDetailReference.Value == null)
                throw new ArgumentNullException(nameof(recurringDetailReference), "Property is not nullable for class NotifyShopperRequest.");

            if (storedPaymentMethodId.IsSet && storedPaymentMethodId.Value == null)
                throw new ArgumentNullException(nameof(storedPaymentMethodId), "Property is not nullable for class NotifyShopperRequest.");
        ...
        {
            /*
            if (notifyShopperRequest.Amount == null)
                throw new ArgumentNullException(nameof(notifyShopperRequest.Amount), "Property is required for class NotifyShopperRequest.");

            if (notifyShopperRequest.MerchantAccount == null)
                throw new ArgumentNullException(nameof(notifyShopperRequest.MerchantAccount), "Property is required for class NotifyShopperRequest.");

            if (notifyShopperRequest.Reference == null)
                throw new ArgumentNullException(nameof(notifyShopperRequest.Reference), "Property is required for class NotifyShopperRequest.");

            if (notifyShopperRequest.ShopperReference == null)
                throw new ArgumentNullException(nameof(notifyShopperRequest.ShopperReference), "Property is required for class NotifyShopperRequest.");

            if (notifyShopperRequest._BillingDateOption.IsSet && notifyShopperRequest.BillingDate == null)
                throw new ArgumentNullException(nameof(notifyShopperRequest.BillingDate), "Property is required for class NotifyShopperRequest.");

            if (notifyShopperRequest._BillingSequenceNumberOption.IsSet && notifyShopperRequest.BillingSequenceNumber == null)
                throw new ArgumentNullException(nameof(notifyShopperRequest.BillingSequenceNumber), "Property is required for class NotifyShopperRequest.");

            if (notifyShopperRequest._DisplayedReferenceOption.IsSet && notifyShopperRequest.DisplayedReference == null)
                throw new ArgumentNullException(nameof(notifyShopperRequest.DisplayedReference), "Property is required for class NotifyShopperRequest.");

            if (notifyShopperRequest._RecurringDetailReferenceOption.IsSet && notifyShopperRequest.RecurringDetailReference == null)
                throw new ArgumentNullException(nameof(notifyShopperRequest.RecurringDetailReference), "Property is required for class NotifyShopperRequest.");

            if (notifyShopperRequest._StoredPaymentMethodIdOption.IsSet && notifyShopperRequest.StoredPaymentMethodId == null)
                throw new ArgumentNullException(nameof(notifyShopperRequest.StoredPaymentMethodId), "Property is required for class NotifyShopperRequest.");
