    ...
    public class ScheduleAccountUpdaterResultJsonConverter : JsonConverter<ScheduleAccountUpdaterResult>
    {
        ...
        public override ScheduleAccountUpdaterResult Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (pspReference.IsSet && pspReference.Value == null)
                throw new ArgumentNullException(nameof(pspReference), "Property is not nullable for class ScheduleAccountUpdaterResult.");

            if (result.IsSet && result.Value == null)
                throw new ArgumentNullException(nameof(result), "Property is not nullable for class ScheduleAccountUpdaterResult.");
        ...
        public void WriteProperties(Utf8JsonWriter writer, ScheduleAccountUpdaterResult scheduleAccountUpdaterResult, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (scheduleAccountUpdaterResult.PspReference == null)
                throw new ArgumentNullException(nameof(scheduleAccountUpdaterResult.PspReference), "Property is required for class ScheduleAccountUpdaterResult.");

            if (scheduleAccountUpdaterResult.Result == null)
                throw new ArgumentNullException(nameof(scheduleAccountUpdaterResult.Result), "Property is required for class ScheduleAccountUpdaterResult.");
