...
namespace Adyen.Recurring.Models
{
    ...
    public class TokenDetailsJsonConverter : JsonConverter<TokenDetails>
    {
        ...
        public override TokenDetails Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (tokenData.IsSet && tokenData.Value == null)
                throw new ArgumentNullException(nameof(tokenData), "Property is not nullable for class TokenDetails.");

            if (tokenDataType.IsSet && tokenDataType.Value == null)
                throw new ArgumentNullException(nameof(tokenDataType), "Property is not nullable for class TokenDetails.");
        ...
        {
            /*
            if (tokenDetails._TokenDataOption.IsSet && tokenDetails.TokenData == null)
                throw new ArgumentNullException(nameof(tokenDetails.TokenData), "Property is required for class TokenDetails.");

            if (tokenDetails._TokenDataTypeOption.IsSet && tokenDetails.TokenDataType == null)
                throw new ArgumentNullException(nameof(tokenDetails.TokenDataType), "Property is required for class TokenDetails.");
