    ...
    public class DisableRequestJsonConverter : JsonConverter<DisableRequest>
    {
        ...
        public override DisableRequest Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (merchantAccount.IsSet && merchantAccount.Value == null)
                throw new ArgumentNullException(nameof(merchantAccount), "Property is not nullable for class DisableRequest.");

            if (shopperReference.IsSet && shopperReference.Value == null)
                throw new ArgumentNullException(nameof(shopperReference), "Property is not nullable for class DisableRequest.");

            if (contract.IsSet && contract.Value == null)
                throw new ArgumentNullException(nameof(contract), "Property is not nullable for class DisableRequest.");

            if (recurringDetailReference.IsSet && recurringDetailReference.Value == null)
                throw new ArgumentNullException(nameof(recurringDetailReference), "Property is not nullable for class DisableRequest.");
        ...
        public void WriteProperties(Utf8JsonWriter writer, DisableRequest disableRequest, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (disableRequest.MerchantAccount == null)
                throw new ArgumentNullException(nameof(disableRequest.MerchantAccount), "Property is required for class DisableRequest.");

            if (disableRequest.ShopperReference == null)
                throw new ArgumentNullException(nameof(disableRequest.ShopperReference), "Property is required for class DisableRequest.");

            if (disableRequest._ContractOption.IsSet && disableRequest.Contract == null)
                throw new ArgumentNullException(nameof(disableRequest.Contract), "Property is required for class DisableRequest.");

            if (disableRequest._RecurringDetailReferenceOption.IsSet && disableRequest.RecurringDetailReference == null)
                throw new ArgumentNullException(nameof(disableRequest.RecurringDetailReference), "Property is required for class DisableRequest.");
