...
namespace Adyen.Recurring.Models
{
    ...
    /// DisableResult.
    /// </summary>
    public partial class DisableResult : IValidatableObject
    {
        /// <summary>
    ...
    public class DisableResultJsonConverter : JsonConverter<DisableResult>
    {
        ...
        public override DisableResult Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (response.IsSet && response.Value == null)
                throw new ArgumentNullException(nameof(response), "Property is not nullable for class DisableResult.");

            return new DisableResult(response);
        }
        ...
        {
            /*
            if (disableResult._ResponseOption.IsSet && disableResult.Response == null)
                throw new ArgumentNullException(nameof(disableResult.Response), "Property is required for class DisableResult.");
