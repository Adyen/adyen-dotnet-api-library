...
namespace Adyen.Recurring.Models
{
    ...
    /// CreatePermitRequest.
    /// </summary>
    public partial class CreatePermitRequest : IValidatableObject
    {
        /// <summary>
    ...
    public class CreatePermitRequestJsonConverter : JsonConverter<CreatePermitRequest>
    {
        ...
        public override CreatePermitRequest Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (merchantAccount.IsSet && merchantAccount.Value == null)
                throw new ArgumentNullException(nameof(merchantAccount), "Property is not nullable for class CreatePermitRequest.");

            if (permits.IsSet && permits.Value == null)
                throw new ArgumentNullException(nameof(permits), "Property is not nullable for class CreatePermitRequest.");

            if (recurringDetailReference.IsSet && recurringDetailReference.Value == null)
                throw new ArgumentNullException(nameof(recurringDetailReference), "Property is not nullable for class CreatePermitRequest.");

            if (shopperReference.IsSet && shopperReference.Value == null)
                throw new ArgumentNullException(nameof(shopperReference), "Property is not nullable for class CreatePermitRequest.");
        ...
        public void WriteProperties(Utf8JsonWriter writer, CreatePermitRequest createPermitRequest, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (createPermitRequest.MerchantAccount == null)
                throw new ArgumentNullException(nameof(createPermitRequest.MerchantAccount), "Property is required for class CreatePermitRequest.");

            if (createPermitRequest.Permits == null)
                throw new ArgumentNullException(nameof(createPermitRequest.Permits), "Property is required for class CreatePermitRequest.");

            if (createPermitRequest.RecurringDetailReference == null)
                throw new ArgumentNullException(nameof(createPermitRequest.RecurringDetailReference), "Property is required for class CreatePermitRequest.");

            if (createPermitRequest.ShopperReference == null)
                throw new ArgumentNullException(nameof(createPermitRequest.ShopperReference), "Property is required for class CreatePermitRequest.");
