...
namespace Adyen.Recurring.Extensions
{
    ...
    public static class ServiceCollectionExtensions
    {
        ...
        /// <summary>
        /// Add the Adyen Recurring API services to your host builder.
        /// </summary>
        /// <param name="services"></param>
        /// <param name="options"></param>
        public static void AddRecurringServices(this IServiceCollection services, Action<HostConfiguration> options)
        {
            HostConfiguration config = new(services);
            options(config);
            AddRecurringServices(services, config);
        }

        internal static void AddRecurringServices(IServiceCollection services, HostConfiguration host)
        {
            if (!host.HttpClientsAdded)
                host.AddRecurringHttpClients();
