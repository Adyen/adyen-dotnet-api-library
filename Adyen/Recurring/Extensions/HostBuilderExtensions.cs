...
namespace Adyen.Recurring.Extensions
{
    ...
    public static class HostBuilderExtensions
    {
        ...
        public static IHostBuilder ConfigureRecurring(this IHostBuilder builder, Action<HostBuilderContext, IServiceCollection, HostConfiguration> options)
        {
            builder.ConfigureServices((context, services) => 
            {
                ...
                ServiceCollectionExtensions.AddRecurringServices(services, config);
            });
