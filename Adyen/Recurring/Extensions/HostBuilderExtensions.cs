...
namespace Adyen.Recurring.Extensions
{
    ...
    {
        /// <summary>
        /// Initializes the <see cref="HostConfiguration"/> *without* adding the Recurring API services defaults to the <see cref="IServiceCollection"/>.
        /// Use <see cref="Adyen.Recurring.Extensions.IServiceCollectionExtensions"/> to add the Recurring API services to the <see cref="IServiceCollection"/>.
        /// </summary>
        ...
        /// <summary>
        /// Initializes the <see cref="HostConfiguration"/> *and* adds the Recurring API services defaults to the <see cref="IServiceCollection"/>.
        ...
        public static IHostBuilder ConfigureRecurringDefaults(this IHostBuilder hostBuilder, Action<HostBuilderContext, IServiceCollection, HostConfiguration> hostConfigurationOptions, ServiceLifetime serviceLifetime = ServiceLifetime.Singleton, Action<System.Net.Http.HttpClient>? httpClientOptions = null, Action<IHttpClientBuilder>? httpClientBuilderOptions = null)
        {
            hostBuilder.ConfigureServices((context, services) => 
            {
                ...
                hostConfigurationOptions(context, services, hostConfiguration);
                services.AddAllRecurringServices(serviceLifetime, httpClientOptions, httpClientBuilderOptions);
