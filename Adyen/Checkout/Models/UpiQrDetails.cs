...
namespace Adyen.Checkout.Models
{
    ...
    /// UpiQrDetails.
    /// </summary>
    [JsonConverter(typeof(UpiQrDetailsJsonConverter))]
    ...
    public class UpiQrDetailsJsonConverter : JsonConverter<UpiQrDetails>
    {
        ...
        public override UpiQrDetails Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (billingSequenceNumber.IsSet)
                upiQrDetails.BillingSequenceNumber = billingSequenceNumber.Value;
            if (checkoutAttemptId.IsSet)
                upiQrDetails.CheckoutAttemptId = checkoutAttemptId.Value;
            if (recurringDetailReference.IsSet)
                upiQrDetails.RecurringDetailReference = recurringDetailReference.Value;
            if (sdkData.IsSet)
                upiQrDetails.SdkData = sdkData.Value;
