...
namespace Adyen.Checkout.Models
{
    ...
    /// UpiQrDetails.
    /// </summary>
    public partial class UpiQrDetails : IValidatableObject
    {
        /// <summary>
        ...
        /// <param name="type">**upi_qr** (default to TypeEnum.UpiQr)</param>
        [JsonConstructor]
        public UpiQrDetails(Option<string?> billingSequenceNumber = default, Option<string?> checkoutAttemptId = default, Option<string?> recurringDetailReference = default, Option<string?> shopperNotificationReference = default, Option<string?> storedPaymentMethodId = default, TypeEnum type = default)
        {
    ...
    /// <summary>
    /// A Json converter for type <see cref="UpiQrDetails" />
    /// </summary>
    public class UpiQrDetailsJsonConverter : JsonConverter<UpiQrDetails>
    {
        /// <summary>
        /// Deserializes json to <see cref="UpiQrDetails"/>.
        /// </summary>
        /// <param name="utf8JsonReader"><see cref="Utf8JsonReader"/></param>
        /// <param name="typeToConvert"><see cref="Type"/></param>
        /// <param name="jsonSerializerOptions">The <see cref="JsonSerializerOptions"/>, initialized from <see cref="HostConfiguration"/>.</param>
        /// <returns><see cref="UpiQrDetails"/></returns>
        /// <exception cref="JsonException"></exception>
        public override UpiQrDetails Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            Option<UpiQrDetails.TypeEnum?> type = default;
            ...
            if (billingSequenceNumber.IsSet && billingSequenceNumber.Value == null)
                throw new ArgumentNullException(nameof(billingSequenceNumber), "Property is not nullable for class UpiQrDetails.");

            if (checkoutAttemptId.IsSet && checkoutAttemptId.Value == null)
                throw new ArgumentNullException(nameof(checkoutAttemptId), "Property is not nullable for class UpiQrDetails.");

            if (recurringDetailReference.IsSet && recurringDetailReference.Value == null)
                throw new ArgumentNullException(nameof(recurringDetailReference), "Property is not nullable for class UpiQrDetails.");

            if (shopperNotificationReference.IsSet && shopperNotificationReference.Value == null)
                throw new ArgumentNullException(nameof(shopperNotificationReference), "Property is not nullable for class UpiQrDetails.");

            if (storedPaymentMethodId.IsSet && storedPaymentMethodId.Value == null)
                throw new ArgumentNullException(nameof(storedPaymentMethodId), "Property is not nullable for class UpiQrDetails.");

            if (type.IsSet && type.Value == null)
                throw new ArgumentNullException(nameof(type), "Property is not nullable for class UpiQrDetails.");

            return new UpiQrDetails(billingSequenceNumber, checkoutAttemptId, recurringDetailReference, shopperNotificationReference, storedPaymentMethodId, type.Value!.Value!);
        }

        /// <summary>
        /// Serializes a <see cref="UpiQrDetails"/>.
        /// </summary>
        /// <param name="writer"><see cref="Utf8JsonWriter"/></param>
        /// <param name="upiQrDetails"></param>
        /// <param name="jsonSerializerOptions"><see cref="JsonSerializerOptions"/></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, UpiQrDetails upiQrDetails, JsonSerializerOptions jsonSerializerOptions)
        {
        ...
        /// <summary>
        /// Serializes the properties of <see cref="UpiQrDetails"/>.
        /// </summary>
        /// <param name="writer"><see creft="Utf8JsonWriter"/></param>
        /// <param name="upiQrDetails"></param>
        /// <param name="jsonSerializerOptions"><see cref="JsonSerializerOptions"/></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, UpiQrDetails upiQrDetails, JsonSerializerOptions jsonSerializerOptions)
        {
            /*
            if (upiQrDetails._BillingSequenceNumberOption.IsSet && upiQrDetails.BillingSequenceNumber == null)
                throw new ArgumentNullException(nameof(upiQrDetails.BillingSequenceNumber), "Property is required for class UpiQrDetails.");

            if (upiQrDetails._CheckoutAttemptIdOption.IsSet && upiQrDetails.CheckoutAttemptId == null)
                throw new ArgumentNullException(nameof(upiQrDetails.CheckoutAttemptId), "Property is required for class UpiQrDetails.");

            if (upiQrDetails._RecurringDetailReferenceOption.IsSet && upiQrDetails.RecurringDetailReference == null)
                throw new ArgumentNullException(nameof(upiQrDetails.RecurringDetailReference), "Property is required for class UpiQrDetails.");

            if (upiQrDetails._ShopperNotificationReferenceOption.IsSet && upiQrDetails.ShopperNotificationReference == null)
                throw new ArgumentNullException(nameof(upiQrDetails.ShopperNotificationReference), "Property is required for class UpiQrDetails.");

            if (upiQrDetails._StoredPaymentMethodIdOption.IsSet && upiQrDetails.StoredPaymentMethodId == null)
                throw new ArgumentNullException(nameof(upiQrDetails.StoredPaymentMethodId), "Property is required for class UpiQrDetails.");

            */
            
            if (upiQrDetails._BillingSequenceNumberOption.IsSet)
                writer.WriteString("billingSequenceNumber", upiQrDetails.BillingSequenceNumber);

            if (upiQrDetails._CheckoutAttemptIdOption.IsSet)
                writer.WriteString("checkoutAttemptId", upiQrDetails.CheckoutAttemptId);

            if (upiQrDetails._RecurringDetailReferenceOption.IsSet)
                writer.WriteString("recurringDetailReference", upiQrDetails.RecurringDetailReference);

            if (upiQrDetails._ShopperNotificationReferenceOption.IsSet)
                writer.WriteString("shopperNotificationReference", upiQrDetails.ShopperNotificationReference);

            if (upiQrDetails._StoredPaymentMethodIdOption.IsSet)
                writer.WriteString("storedPaymentMethodId", upiQrDetails.StoredPaymentMethodId);

            if (upiQrDetails.Type != null) 
            {
                string? typeRawValue = UpiQrDetails.TypeEnum.ToJsonValue(upiQrDetails.Type);
