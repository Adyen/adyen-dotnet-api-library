    ...
    public class PaymentResponseJsonConverter : JsonConverter<PaymentResponse>
    {
        ...
        public override PaymentResponse Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (paymentValidations.IsSet && paymentValidations.Value == null)
                throw new ArgumentNullException(nameof(paymentValidations), "Property is not nullable for class PaymentResponse.");
        ...
        public void WriteProperties(Utf8JsonWriter writer, PaymentResponse paymentResponse, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (paymentResponse._ThreeDS2ResultOption.IsSet && paymentResponse.ThreeDS2Result == null)
                throw new ArgumentNullException(nameof(paymentResponse.ThreeDS2Result), "Property is required for class PaymentResponse.");

            if (paymentResponse._ThreeDSPaymentDataOption.IsSet && paymentResponse.ThreeDSPaymentData == null)
