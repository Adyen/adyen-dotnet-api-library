...
namespace Adyen.Checkout.Models
{
    ...
    public class SepaDirectDebitDetailsJsonConverter : JsonConverter<SepaDirectDebitDetails>
    {
        ...
        public void WriteProperties(Utf8JsonWriter writer, SepaDirectDebitDetails sepaDirectDebitDetails, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (sepaDirectDebitDetails._CheckoutAttemptIdOption.IsSet && sepaDirectDebitDetails.CheckoutAttemptId == null)
            ...
            if (sepaDirectDebitDetails._RecurringDetailReferenceOption.IsSet && sepaDirectDebitDetails.RecurringDetailReference == null)
            ...
            if (sepaDirectDebitDetails._StoredPaymentMethodIdOption.IsSet && sepaDirectDebitDetails.StoredPaymentMethodId == null)
            ...
            if (sepaDirectDebitDetails._TransferInstrumentIdOption.IsSet && sepaDirectDebitDetails.TransferInstrumentId == null)
