...
namespace Adyen.Checkout.Models
{
    ...
    /// CashAppDetails.
    /// </summary>
    [JsonConverter(typeof(CashAppDetailsJsonConverter))]
    public partial class CashAppDetails
    {
        /// <summary>
        ...
        /// <summary>
        /// This is used to track if an optional field is set. If set, <see cref="CustomerId"/> will be populated.
        /// </summary>
        [JsonIgnore]
        [global::System.ComponentModel.EditorBrowsable(global::System.ComponentModel.EditorBrowsableState.Never)]
        ...
        /// <summary>
        /// This is used to track if an optional field is set. If set, <see cref="GrantId"/> will be populated.
        /// </summary>
        [JsonIgnore]
        [global::System.ComponentModel.EditorBrowsable(global::System.ComponentModel.EditorBrowsableState.Never)]
        ...
        /// <summary>
        /// This is used to track if an optional field is set. If set, <see cref="OnFileGrantId"/> will be populated.
        /// </summary>
        [JsonIgnore]
        [global::System.ComponentModel.EditorBrowsable(global::System.ComponentModel.EditorBrowsableState.Never)]
    ...
    public class CashAppDetailsJsonConverter : JsonConverter<CashAppDetails>
    {
        ...
        public override CashAppDetails Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
                ...
                if (utf8JsonReader.TokenType == JsonTokenType.PropertyName && currentDepth == utf8JsonReader.CurrentDepth - 1)
                {
                    ...
                    switch (jsonPropertyName)
                    {
                        ...
                        case "type":
                            ...
                            type = new Option<CashAppDetails.TypeEnum?>(CashAppDetails.TypeEnum.FromStringOrDefault(typeRawValue) ?? (CashAppDetails.TypeEnum)typeRawValue);
                            break;
                        default:
                            break;
                    }
            ...
            if (checkoutAttemptId.IsSet)
                cashAppDetails.CheckoutAttemptId = checkoutAttemptId.Value;
            if (customerId.IsSet)
                cashAppDetails.CustomerId = customerId.Value;
            if (grantId.IsSet)
                cashAppDetails.GrantId = grantId.Value;
            if (onFileGrantId.IsSet)
                cashAppDetails.OnFileGrantId = onFileGrantId.Value;
            if (recurringDetailReference.IsSet)
                cashAppDetails.RecurringDetailReference = recurringDetailReference.Value;
            if (requestId.IsSet)
                cashAppDetails.RequestId = requestId.Value;
            if (sdkData.IsSet)
                cashAppDetails.SdkData = sdkData.Value;
            if (storedPaymentMethodId.IsSet)
                cashAppDetails.StoredPaymentMethodId = storedPaymentMethodId.Value;
            if (subtype.IsSet)
                cashAppDetails.Subtype = subtype.Value;
            if (type.IsSet)
                cashAppDetails.Type = type.Value;
        ...
        public void WriteProperties(Utf8JsonWriter writer, CashAppDetails cashAppDetails, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (cashAppDetails._SdkDataOption.IsSet)
                if (cashAppDetails.SdkData != null)
                    writer.WriteString("sdkData", cashAppDetails.SdkData);
