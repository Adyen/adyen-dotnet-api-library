...
namespace Adyen.Checkout.Models
{
    ...
    /// VippsDetails.
    /// </summary>
    public partial class VippsDetails : IValidatableObject
    {
        /// <summary>
        ...
        [JsonConstructor]
        public VippsDetails(string telephoneNumber, Option<string?> checkoutAttemptId = default, Option<string?> recurringDetailReference = default, Option<string?> storedPaymentMethodId = default, Option<TypeEnum?> type = default)
        {
    ...
    public class VippsDetailsJsonConverter : JsonConverter<VippsDetails>
    {
        ...
        public override VippsDetails Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (telephoneNumber.IsSet && telephoneNumber.Value == null)
                throw new ArgumentNullException(nameof(telephoneNumber), "Property is not nullable for class VippsDetails.");

            if (checkoutAttemptId.IsSet && checkoutAttemptId.Value == null)
                throw new ArgumentNullException(nameof(checkoutAttemptId), "Property is not nullable for class VippsDetails.");

            if (recurringDetailReference.IsSet && recurringDetailReference.Value == null)
                throw new ArgumentNullException(nameof(recurringDetailReference), "Property is not nullable for class VippsDetails.");

            if (storedPaymentMethodId.IsSet && storedPaymentMethodId.Value == null)
                throw new ArgumentNullException(nameof(storedPaymentMethodId), "Property is not nullable for class VippsDetails.");

            if (type.IsSet && type.Value == null)
                throw new ArgumentNullException(nameof(type), "Property is not nullable for class VippsDetails.");

            return new VippsDetails(telephoneNumber.Value!, checkoutAttemptId, recurringDetailReference, storedPaymentMethodId, type);
        }
        ...
        public void WriteProperties(Utf8JsonWriter writer, VippsDetails vippsDetails, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (vippsDetails.TelephoneNumber == null)
                throw new ArgumentNullException(nameof(vippsDetails.TelephoneNumber), "Property is required for class VippsDetails.");

            if (vippsDetails._CheckoutAttemptIdOption.IsSet && vippsDetails.CheckoutAttemptId == null)
                throw new ArgumentNullException(nameof(vippsDetails.CheckoutAttemptId), "Property is required for class VippsDetails.");

            if (vippsDetails._RecurringDetailReferenceOption.IsSet && vippsDetails.RecurringDetailReference == null)
                throw new ArgumentNullException(nameof(vippsDetails.RecurringDetailReference), "Property is required for class VippsDetails.");

            if (vippsDetails._StoredPaymentMethodIdOption.IsSet && vippsDetails.StoredPaymentMethodId == null)
                throw new ArgumentNullException(nameof(vippsDetails.StoredPaymentMethodId), "Property is required for class VippsDetails.");
