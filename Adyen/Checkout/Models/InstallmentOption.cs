...
namespace Adyen.Checkout.Models
{
    ...
    /// InstallmentOption.
    /// </summary>
    [JsonConverter(typeof(InstallmentOptionJsonConverter))]
    ...
    public class InstallmentOptionJsonConverter : JsonConverter<InstallmentOption>
    {
        ...
        public override InstallmentOption Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (plans.IsSet)
                installmentOption.Plans = plans.Value;
            if (preselectedValue.IsSet)
                installmentOption.PreselectedValue = preselectedValue.Value;
            if (values.IsSet)
                installmentOption.Values = values.Value;
