...
namespace Adyen.Checkout.Models
{
    ...
    public partial class PaymentRequest : IValidatableObject
    {
        ...
        /// <param name="sdkData">Base64-encoded JSON object containing SDK related parameters required by the SDK     to function optimally. Clients must not     add unrelated or sensitive personal information.</param>
        ...
        /// <summary>
        /// Used to track whether Channel is set or not.
        /// </summary>
        [JsonIgnore]
        ...
        /// <summary>
        /// Used to track whether EntityType is set or not.
        /// </summary>
        [JsonIgnore]
        [global::System.ComponentModel.EditorBrowsable(global::System.ComponentModel.EditorBrowsableState.Never)]
        ...
        /// </summary>
        /// <value>Base64-encoded JSON object containing SDK related parameters required by the SDK     to function optimally. Clients must not     add unrelated or sensitive personal information.</value>
    ...
    public class PaymentRequestJsonConverter : JsonConverter<PaymentRequest>
    {
        ...
        public override PaymentRequest Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (sdkData.IsSet && sdkData.Value == null)
                throw new ArgumentNullException(nameof(sdkData), "Property is not nullable for class PaymentRequest.");
        ...
        public void WriteProperties(Utf8JsonWriter writer, PaymentRequest paymentRequest, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (paymentRequest._MandateOption.IsSet && paymentRequest.Mandate == null)
                throw new ArgumentNullException(nameof(paymentRequest.Mandate), "Property is required for class PaymentRequest.");

            if (paymentRequest._MccOption.IsSet && paymentRequest.Mcc == null)
                throw new ArgumentNullException(nameof(paymentRequest.Mcc), "Property is required for class PaymentRequest.");

            if (paymentRequest._MerchantOrderReferenceOption.IsSet && paymentRequest.MerchantOrderReference == null)
            ...
            if (paymentRequest._MerchantRiskIndicatorOption.IsSet && paymentRequest.MerchantRiskIndicator == null)
            ...
            if (paymentRequest._RecurringExpiryOption.IsSet && paymentRequest.RecurringExpiry == null)
                throw new ArgumentNullException(nameof(paymentRequest.RecurringExpiry), "Property is required for class PaymentRequest.");

            if (paymentRequest._RecurringFrequencyOption.IsSet && paymentRequest.RecurringFrequency == null)
                throw new ArgumentNullException(nameof(paymentRequest.RecurringFrequency), "Property is required for class PaymentRequest.");

            if (paymentRequest._RedirectFromIssuerMethodOption.IsSet && paymentRequest.RedirectFromIssuerMethod == null)
            ...
            if (paymentRequest._RedirectToIssuerMethodOption.IsSet && paymentRequest.RedirectToIssuerMethod == null)
            ...
            */
            ...
            if (paymentRequest._SdkDataOption.IsSet)
                writer.WriteString("sdkData", paymentRequest.SdkData);
