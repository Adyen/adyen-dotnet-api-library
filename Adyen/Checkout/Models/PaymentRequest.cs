...
namespace Adyen.Checkout.Models
{
    ...
    public partial class PaymentRequest
    {
        ...
        public class ChannelEnum : IEnum
        {
            ...
            /// <summary>
            /// Compares two <see cref="ChannelEnum"/> instances for equality.
            /// </summary>
            ...
            /// <summary>
            /// Compares two <see cref="ChannelEnum"/> instances for inequality.
            /// </summary>
            public static bool operator !=(ChannelEnum? left, ChannelEnum? right) => !string.Equals(left?.Value, right?.Value, StringComparison.OrdinalIgnoreCase);

            /// <summary>
            /// Returns true if the given object is equal to this <see cref="ChannelEnum"/> instance.
            /// </summary>
            ...
            /// <summary>
            /// Returns a hash code for this <see cref="ChannelEnum"/> instance.
            /// </summary>
            public override int GetHashCode() => Value?.GetHashCode() ?? 0;

            /// <summary>
            /// Returns the string value of the <see cref="ChannelEnum"/> instance.
            /// </summary>
            ...
            {
                /// <summary>
                /// Deserializes a <see cref="ChannelEnum"/> from JSON.
                /// </summary>
                ...
                /// <summary>
                /// Serializes a <see cref="ChannelEnum"/> to JSON.
                /// </summary>
        ...
        public class EntityTypeEnum : IEnum
        {
            ...
            /// <summary>
            /// Compares two <see cref="EntityTypeEnum"/> instances for equality.
            /// </summary>
            ...
            /// <summary>
            /// Compares two <see cref="EntityTypeEnum"/> instances for inequality.
            /// </summary>
            public static bool operator !=(EntityTypeEnum? left, EntityTypeEnum? right) => !string.Equals(left?.Value, right?.Value, StringComparison.OrdinalIgnoreCase);

            /// <summary>
            /// Returns true if the given object is equal to this <see cref="EntityTypeEnum"/> instance.
            /// </summary>
            ...
            /// <summary>
            /// Returns a hash code for this <see cref="EntityTypeEnum"/> instance.
            /// </summary>
            public override int GetHashCode() => Value?.GetHashCode() ?? 0;

            /// <summary>
            /// Returns the string value of the <see cref="EntityTypeEnum"/> instance.
            /// </summary>
            public override string ToString() => Value ?? string.Empty;
            ...
            {
                /// <summary>
                /// Deserializes a <see cref="EntityTypeEnum"/> from JSON.
                /// </summary>
                ...
                /// <summary>
                /// Serializes a <see cref="EntityTypeEnum"/> to JSON.
                /// </summary>
        ...
        /// </summary>
        /// <value>The [delay between the authorization and automatic capture](https://docs.adyen.com/online-payments/capture?tab=delayed-individual_2#delayed-automatic-capture) of the payment, specified in hours.  Maximum value: **672** (28 days).</value>
        ...
        [Obsolete("Deprecated since Adyen Checkout API v70.")]
        ...
        /// </summary>
        /// <value>The shopper's email address, in valid [RFC-5322](https://www.rfc-editor.org/rfc/rfc5322) format. We recommend that you provide this data, because it is used in velocity fraud checks. > Required for Visa and JCB transactions that require 3D Secure 2 authentication if you did not include the `telephoneNumber`.</value>
        ...
        /// </summary>
        /// <value>The language for the payment. The value combines the two-letter [ISO 639-1](https://en.wikipedia.org/wiki/List_of_ISO_639_language_codes) language code with the [ISO 3166-1 alpha-2](https://en.wikipedia.org/wiki/List_of_ISO_3166_country_codes) country code. For example, **nl-NL**.  When using Drop-in/Components, the specified language appears if your front-end global configuration does not set the `locale`.</value>
        ...
        /// <summary>
        /// This is used to track if an optional field is set. If set, <see cref="ThirdPartyTokenRedundancyInfo"/> will be populated.
        /// </summary>
        [JsonIgnore]
        [global::System.ComponentModel.EditorBrowsable(global::System.ComponentModel.EditorBrowsableState.Never)]
        public Option<ThirdPartyTokenRedundancyInfo?> _ThirdPartyTokenRedundancyInfoOption { get; private set; }

        /// <summary>
        /// <see cref="ThirdPartyTokenRedundancyInfo"/>.
        /// </summary>
        [JsonPropertyName("thirdPartyTokenRedundancyInfo")]
        public ThirdPartyTokenRedundancyInfo? ThirdPartyTokenRedundancyInfo { get { return this._ThirdPartyTokenRedundancyInfoOption; } set { this._ThirdPartyTokenRedundancyInfoOption = new(value); } }
        ...
        public override string ToString()
        {
            ...
            sb.Append("  ThirdPartyTokenRedundancyInfo: ").Append(ThirdPartyTokenRedundancyInfo).Append("\n");
    ...
    public class PaymentRequestJsonConverter : JsonConverter<PaymentRequest>
    {
        ...
        public override PaymentRequest Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            Option<ThirdPartyTokenRedundancyInfo?> thirdPartyTokenRedundancyInfo = default;
                ...
                if (utf8JsonReader.TokenType == JsonTokenType.PropertyName && currentDepth == utf8JsonReader.CurrentDepth - 1)
                {
                    ...
                    switch (jsonPropertyName)
                    {
                        ...
                        case "telephoneNumber":
                            ...
                            break;
                        case "thirdPartyTokenRedundancyInfo":
                            thirdPartyTokenRedundancyInfo = new Option<ThirdPartyTokenRedundancyInfo?>(JsonSerializer.Deserialize<ThirdPartyTokenRedundancyInfo>(ref utf8JsonReader, jsonSerializerOptions)!);
                            break;
            ...
            if (amount.IsSet)
                paymentRequest.Amount = amount.Value!;
            if (merchantAccount.IsSet)
                paymentRequest.MerchantAccount = merchantAccount.Value!;
            if (paymentMethod.IsSet)
                paymentRequest.PaymentMethod = paymentMethod.Value!;
            if (reference.IsSet)
                paymentRequest.Reference = reference.Value!;
            if (returnUrl.IsSet)
                paymentRequest.ReturnUrl = returnUrl.Value!;
            if (accountInfo.IsSet)
                paymentRequest.AccountInfo = accountInfo.Value;
            if (additionalAmount.IsSet)
                paymentRequest.AdditionalAmount = additionalAmount.Value;
            if (additionalData.IsSet)
                paymentRequest.AdditionalData = additionalData.Value;
            if (applicationInfo.IsSet)
                paymentRequest.ApplicationInfo = applicationInfo.Value;
            if (authenticationData.IsSet)
                paymentRequest.AuthenticationData = authenticationData.Value;
            if (bankAccount.IsSet)
                paymentRequest.BankAccount = bankAccount.Value;
            if (billingAddress.IsSet)
                paymentRequest.BillingAddress = billingAddress.Value;
            if (browserInfo.IsSet)
                paymentRequest.BrowserInfo = browserInfo.Value;
            if (captureDelayHours.IsSet)
                paymentRequest.CaptureDelayHours = captureDelayHours.Value;
            if (channel.IsSet)
                paymentRequest.Channel = channel.Value;
            if (checkoutAttemptId.IsSet)
                paymentRequest.CheckoutAttemptId = checkoutAttemptId.Value;
            if (company.IsSet)
                paymentRequest.Company = company.Value;
            if (countryCode.IsSet)
                paymentRequest.CountryCode = countryCode.Value;
            if (dateOfBirth.IsSet)
                paymentRequest.DateOfBirth = dateOfBirth.Value;
            if (dccQuote.IsSet)
                paymentRequest.DccQuote = dccQuote.Value;
            if (deliverAt.IsSet)
                paymentRequest.DeliverAt = deliverAt.Value;
            if (deliveryAddress.IsSet)
                paymentRequest.DeliveryAddress = deliveryAddress.Value;
            if (deliveryDate.IsSet)
                paymentRequest.DeliveryDate = deliveryDate.Value;
            if (deviceFingerprint.IsSet)
                paymentRequest.DeviceFingerprint = deviceFingerprint.Value;
            if (enableOneClick.IsSet)
                paymentRequest.EnableOneClick = enableOneClick.Value;
            if (enablePayOut.IsSet)
                paymentRequest.EnablePayOut = enablePayOut.Value;
            if (enableRecurring.IsSet)
                paymentRequest.EnableRecurring = enableRecurring.Value;
            if (enhancedSchemeData.IsSet)
                paymentRequest.EnhancedSchemeData = enhancedSchemeData.Value;
            if (entityType.IsSet)
                paymentRequest.EntityType = entityType.Value;
            if (fraudOffset.IsSet)
                paymentRequest.FraudOffset = fraudOffset.Value;
            if (fundOrigin.IsSet)
                paymentRequest.FundOrigin = fundOrigin.Value;
            if (fundRecipient.IsSet)
                paymentRequest.FundRecipient = fundRecipient.Value;
            if (industryUsage.IsSet)
                paymentRequest.IndustryUsage = industryUsage.Value;
            if (installments.IsSet)
                paymentRequest.Installments = installments.Value;
            if (lineItems.IsSet)
                paymentRequest.LineItems = lineItems.Value;
            if (localizedShopperStatement.IsSet)
                paymentRequest.LocalizedShopperStatement = localizedShopperStatement.Value;
            if (mandate.IsSet)
                paymentRequest.Mandate = mandate.Value;
            if (mcc.IsSet)
                paymentRequest.Mcc = mcc.Value;
            if (merchantOrderReference.IsSet)
                paymentRequest.MerchantOrderReference = merchantOrderReference.Value;
            if (merchantRiskIndicator.IsSet)
                paymentRequest.MerchantRiskIndicator = merchantRiskIndicator.Value;
            if (metadata.IsSet)
            ...
            if (orderReference.IsSet)
                paymentRequest.OrderReference = orderReference.Value;
            if (origin.IsSet)
                paymentRequest.Origin = origin.Value;
            if (paymentValidations.IsSet)
                paymentRequest.PaymentValidations = paymentValidations.Value;
            if (platformChargebackLogic.IsSet)
                paymentRequest.PlatformChargebackLogic = platformChargebackLogic.Value;
            if (recurringExpiry.IsSet)
                paymentRequest.RecurringExpiry = recurringExpiry.Value;
            if (recurringFrequency.IsSet)
                paymentRequest.RecurringFrequency = recurringFrequency.Value;
            if (recurringProcessingModel.IsSet)
                paymentRequest.RecurringProcessingModel = recurringProcessingModel.Value;
            if (redirectFromIssuerMethod.IsSet)
                paymentRequest.RedirectFromIssuerMethod = redirectFromIssuerMethod.Value;
            if (redirectToIssuerMethod.IsSet)
                paymentRequest.RedirectToIssuerMethod = redirectToIssuerMethod.Value;
            if (riskData.IsSet)
                paymentRequest.RiskData = riskData.Value;
            if (sessionValidity.IsSet)
                paymentRequest.SessionValidity = sessionValidity.Value;
            if (shopperConversionId.IsSet)
                paymentRequest.ShopperConversionId = shopperConversionId.Value;
            if (shopperEmail.IsSet)
                paymentRequest.ShopperEmail = shopperEmail.Value;
            if (shopperIP.IsSet)
                paymentRequest.ShopperIP = shopperIP.Value;
            if (shopperInteraction.IsSet)
                paymentRequest.ShopperInteraction = shopperInteraction.Value;
            if (shopperLocale.IsSet)
                paymentRequest.ShopperLocale = shopperLocale.Value;
            if (shopperName.IsSet)
                paymentRequest.ShopperName = shopperName.Value;
            if (shopperReference.IsSet)
                paymentRequest.ShopperReference = shopperReference.Value;
            if (shopperStatement.IsSet)
                paymentRequest.ShopperStatement = shopperStatement.Value;
            if (shopperTaxInfo.IsSet)
                paymentRequest.ShopperTaxInfo = shopperTaxInfo.Value;
            if (socialSecurityNumber.IsSet)
                paymentRequest.SocialSecurityNumber = socialSecurityNumber.Value;
            if (splits.IsSet)
                paymentRequest.Splits = splits.Value;
            if (store.IsSet)
                paymentRequest.Store = store.Value;
            if (storePaymentMethod.IsSet)
                paymentRequest.StorePaymentMethod = storePaymentMethod.Value;
            if (subMerchants.IsSet)
                paymentRequest.SubMerchants = subMerchants.Value;
            if (surcharge.IsSet)
                paymentRequest.Surcharge = surcharge.Value;
            if (telephoneNumber.IsSet)
                paymentRequest.TelephoneNumber = telephoneNumber.Value;
            if (thirdPartyTokenRedundancyInfo.IsSet)
                paymentRequest.ThirdPartyTokenRedundancyInfo = thirdPartyTokenRedundancyInfo.Value;
            if (threeDS2RequestData.IsSet)
                paymentRequest.ThreeDS2RequestData = threeDS2RequestData.Value;
            if (threeDSAuthenticationOnly.IsSet)
                paymentRequest.ThreeDSAuthenticationOnly = threeDSAuthenticationOnly.Value;
            if (trustedShopper.IsSet)
                paymentRequest.TrustedShopper = trustedShopper.Value;
        ...
        public void WriteProperties(Utf8JsonWriter writer, PaymentRequest paymentRequest, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (paymentRequest._ThirdPartyTokenRedundancyInfoOption.IsSet)
            {
                writer.WritePropertyName("thirdPartyTokenRedundancyInfo");
                JsonSerializer.Serialize(writer, paymentRequest.ThirdPartyTokenRedundancyInfo, jsonSerializerOptions);
            }
