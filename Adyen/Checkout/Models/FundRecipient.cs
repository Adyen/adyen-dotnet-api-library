...
namespace Adyen.Checkout.Models
{
    ...
    /// FundRecipient.
    /// </summary>
    [JsonConverter(typeof(FundRecipientJsonConverter))]
    public partial class FundRecipient
    {
        /// <summary>
        ...
        public class WalletPurposeEnum : IEnum
        {
            ...
            /// <summary>
            /// Compares two <see cref="WalletPurposeEnum"/> instances for equality.
            /// </summary>
            ...
            /// <summary>
            /// Compares two <see cref="WalletPurposeEnum"/> instances for inequality.
            /// </summary>
            public static bool operator !=(WalletPurposeEnum? left, WalletPurposeEnum? right) => !string.Equals(left?.Value, right?.Value, StringComparison.OrdinalIgnoreCase);

            /// <summary>
            /// Returns true if the given object is equal to this <see cref="WalletPurposeEnum"/> instance.
            /// </summary>
            ...
            /// <summary>
            /// Returns a hash code for this <see cref="WalletPurposeEnum"/> instance.
            /// </summary>
            public override int GetHashCode() => Value?.GetHashCode() ?? 0;

            /// <summary>
            /// Returns the string value of the <see cref="WalletPurposeEnum"/> instance.
            /// </summary>
            ...
            {
                /// <summary>
                /// Deserializes a <see cref="WalletPurposeEnum"/> from JSON.
                /// </summary>
                ...
                /// <summary>
                /// Serializes a <see cref="WalletPurposeEnum"/> to JSON.
                /// </summary>
    ...
    public class FundRecipientJsonConverter : JsonConverter<FundRecipient>
    {
        ...
        public override FundRecipient Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (billingAddress.IsSet)
                fundRecipient.BillingAddress = billingAddress.Value;
            if (paymentMethod.IsSet)
                fundRecipient.PaymentMethod = paymentMethod.Value;
            if (shopperEmail.IsSet)
                fundRecipient.ShopperEmail = shopperEmail.Value;
            if (shopperName.IsSet)
                fundRecipient.ShopperName = shopperName.Value;
            if (shopperReference.IsSet)
                fundRecipient.ShopperReference = shopperReference.Value;
            if (storedPaymentMethodId.IsSet)
                fundRecipient.StoredPaymentMethodId = storedPaymentMethodId.Value;
            if (subMerchant.IsSet)
                fundRecipient.SubMerchant = subMerchant.Value;
            if (telephoneNumber.IsSet)
                fundRecipient.TelephoneNumber = telephoneNumber.Value;
            if (walletIdentifier.IsSet)
                fundRecipient.WalletIdentifier = walletIdentifier.Value;
            if (walletOwnerTaxId.IsSet)
                fundRecipient.WalletOwnerTaxId = walletOwnerTaxId.Value;
            if (walletPurpose.IsSet)
                fundRecipient.WalletPurpose = walletPurpose.Value;
