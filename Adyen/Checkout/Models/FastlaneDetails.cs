...
namespace Adyen.Checkout.Models
{
    ...
    public partial class FastlaneDetails : IValidatableObject
    {
        ...
        [JsonConstructor]
        public FastlaneDetails(string fastlaneData, Option<string?> checkoutAttemptId = default, Option<string?> recurringDetailReference = default, Option<string?> storedPaymentMethodId = default, TypeEnum type = default)
        {
    ...
    public class FastlaneDetailsJsonConverter : JsonConverter<FastlaneDetails>
    {
        ...
        public void WriteProperties(Utf8JsonWriter writer, FastlaneDetails fastlaneDetails, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (fastlaneDetails._CheckoutAttemptIdOption.IsSet && fastlaneDetails.CheckoutAttemptId == null)
                throw new ArgumentNullException(nameof(fastlaneDetails.CheckoutAttemptId), "Property is required for class FastlaneDetails.");

            if (fastlaneDetails._RecurringDetailReferenceOption.IsSet && fastlaneDetails.RecurringDetailReference == null)
            ...
            if (fastlaneDetails._StoredPaymentMethodIdOption.IsSet && fastlaneDetails.StoredPaymentMethodId == null)
