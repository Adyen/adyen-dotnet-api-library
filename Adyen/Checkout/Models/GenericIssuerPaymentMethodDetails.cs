...
namespace Adyen.Checkout.Models
{
    ...
    public class GenericIssuerPaymentMethodDetailsJsonConverter : JsonConverter<GenericIssuerPaymentMethodDetails>
    {
        ...
        public void WriteProperties(Utf8JsonWriter writer, GenericIssuerPaymentMethodDetails genericIssuerPaymentMethodDetails, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (genericIssuerPaymentMethodDetails._CheckoutAttemptIdOption.IsSet && genericIssuerPaymentMethodDetails.CheckoutAttemptId == null)
            ...
            if (genericIssuerPaymentMethodDetails._RecurringDetailReferenceOption.IsSet && genericIssuerPaymentMethodDetails.RecurringDetailReference == null)
            ...
            if (genericIssuerPaymentMethodDetails._StoredPaymentMethodIdOption.IsSet && genericIssuerPaymentMethodDetails.StoredPaymentMethodId == null)
