...
namespace Adyen.Checkout.Models
{
    ...
    public class CellulantDetailsJsonConverter : JsonConverter<CellulantDetails>
    {
        ...
        {
            /*
            if (cellulantDetails._CheckoutAttemptIdOption.IsSet && cellulantDetails.CheckoutAttemptId == null)
            ...
            if (cellulantDetails._IssuerOption.IsSet && cellulantDetails.Issuer == null)
