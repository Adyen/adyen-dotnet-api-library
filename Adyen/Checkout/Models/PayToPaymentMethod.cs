...
namespace Adyen.Checkout.Models
{
    ...
    /// PayToPaymentMethod.
    /// </summary>
    public partial class PayToPaymentMethod : ShopperIdPaymentMethod, IValidatableObject
    {
        /// <summary>
    ...
    public class PayToPaymentMethodJsonConverter : JsonConverter<PayToPaymentMethod>
    {
        ...
        public override PayToPaymentMethod Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (type.IsSet && type.Value == null)
                throw new ArgumentNullException(nameof(type), "Property is not nullable for class PayToPaymentMethod.");

            if (shopperReference.IsSet && shopperReference.Value == null)
                throw new ArgumentNullException(nameof(shopperReference), "Property is not nullable for class PayToPaymentMethod.");
        ...
        {
            /*
            if (payToPaymentMethod._ShopperReferenceOption.IsSet && payToPaymentMethod.ShopperReference == null)
                throw new ArgumentNullException(nameof(payToPaymentMethod.ShopperReference), "Property is required for class PayToPaymentMethod.");
