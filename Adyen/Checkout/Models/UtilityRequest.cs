...
namespace Adyen.Checkout.Models
{
    ...
    /// UtilityRequest.
    /// </summary>
    public partial class UtilityRequest : IValidatableObject
    {
        /// <summary>
    ...
    public class UtilityRequestJsonConverter : JsonConverter<UtilityRequest>
    {
        ...
        public override UtilityRequest Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (originDomains.IsSet && originDomains.Value == null)
                throw new ArgumentNullException(nameof(originDomains), "Property is not nullable for class UtilityRequest.");
        ...
        {
            /*
            if (utilityRequest.OriginDomains == null)
                throw new ArgumentNullException(nameof(utilityRequest.OriginDomains), "Property is required for class UtilityRequest.");
