...
namespace Adyen.Checkout.Models
{
    ...
    /// SubMerchant.
    /// </summary>
    [JsonConverter(typeof(SubMerchantJsonConverter))]
    ...
    public class SubMerchantJsonConverter : JsonConverter<SubMerchant>
    {
        ...
        public override SubMerchant Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (country.IsSet)
                subMerchant.Country = country.Value;
            if (mcc.IsSet)
                subMerchant.Mcc = mcc.Value;
            if (name.IsSet)
                subMerchant.Name = name.Value;
            if (taxId.IsSet)
                subMerchant.TaxId = taxId.Value;
            return subMerchant;
        }
