...
namespace Adyen.Checkout.Models
{
    ...
    /// </summary>
    [JsonConverter(typeof(PaymentValidationsNameResultResponseJsonConverter))]
    public partial class PaymentValidationsNameResultResponse
    {
        /// <summary>
        ...
        /// </summary>
        /// <value>Informs you if the first name your shopper provided matches the cardholder first name on file at the issuing bank. The first name is only validated for Visa. Possible values:  **match**, **partialMatch**, **noMatch**</value>
        ...
        /// </summary>
        /// <value>Informs you if the last name your shopper provided matches the cardholder last name on file at the issuing bank. The last name is only validated for Visa. Possible values:  **match**, **partialMatch**, **noMatch**</value>
        ...
        /// </summary>
        /// <value>Informs you if the middle name your shopper provided matches the cardholder middle name on file at the issuing bank. The middle name is only validated for Visa. Possible values:  **match**, **partialMatch**, **noMatch**</value>
    ...
    public class PaymentValidationsNameResultResponseJsonConverter : JsonConverter<PaymentValidationsNameResultResponse>
    {
        ...
        public override PaymentValidationsNameResultResponse Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            var paymentValidationsNameResultResponse = new PaymentValidationsNameResultResponse();
            if (firstName.IsSet)
                paymentValidationsNameResultResponse.FirstName = firstName.Value;
            if (fullName.IsSet)
                paymentValidationsNameResultResponse.FullName = fullName.Value;
            if (lastName.IsSet)
                paymentValidationsNameResultResponse.LastName = lastName.Value;
            if (middleName.IsSet)
                paymentValidationsNameResultResponse.MiddleName = middleName.Value;
            return paymentValidationsNameResultResponse;
        }
        ...
        public void WriteProperties(Utf8JsonWriter writer, PaymentValidationsNameResultResponse paymentValidationsNameResultResponse, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (paymentValidationsNameResultResponse._FullNameOption.IsSet)
                if (paymentValidationsNameResultResponse.FullName != null)
            ...
            if (paymentValidationsNameResultResponse._LastNameOption.IsSet)
                if (paymentValidationsNameResultResponse.LastName != null)
            ...
            if (paymentValidationsNameResultResponse._MiddleNameOption.IsSet)
                if (paymentValidationsNameResultResponse.MiddleName != null)
