...
namespace Adyen.Checkout.Models
{
    ...
    public class CheckoutOrderResponseJsonConverter : JsonConverter<CheckoutOrderResponse>
    {
        ...
        public void WriteProperties(Utf8JsonWriter writer, CheckoutOrderResponse checkoutOrderResponse, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (checkoutOrderResponse._AmountOption.IsSet && checkoutOrderResponse.Amount == null)
                throw new ArgumentNullException(nameof(checkoutOrderResponse.Amount), "Property is required for class CheckoutOrderResponse.");

            if (checkoutOrderResponse._ExpiresAtOption.IsSet && checkoutOrderResponse.ExpiresAt == null)
            ...
            if (checkoutOrderResponse._OrderDataOption.IsSet && checkoutOrderResponse.OrderData == null)
            ...
            if (checkoutOrderResponse._ReferenceOption.IsSet && checkoutOrderResponse.Reference == null)
            ...
            if (checkoutOrderResponse._RemainingAmountOption.IsSet && checkoutOrderResponse.RemainingAmount == null)
