...
namespace Adyen.Checkout.Models
{
    ...
    public class AdditionalDataRetryJsonConverter : JsonConverter<AdditionalDataRetry>
    {
        ...
        {
            /*
            if (additionalDataRetry._RetryChainAttemptNumberOption.IsSet && additionalDataRetry.RetryChainAttemptNumber == null)
            ...
            if (additionalDataRetry._RetryOrderAttemptNumberOption.IsSet && additionalDataRetry.RetryOrderAttemptNumber == null)
            ...
            if (additionalDataRetry._RetrySkipRetryOption.IsSet && additionalDataRetry.RetrySkipRetry == null)
