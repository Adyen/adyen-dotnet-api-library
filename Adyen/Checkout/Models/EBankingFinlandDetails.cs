...
namespace Adyen.Checkout.Models
{
    ...
    public partial class EBankingFinlandDetails : IValidatableObject
    {
        ...
        [JsonConstructor]
        public EBankingFinlandDetails(Option<string?> checkoutAttemptId = default, Option<string?> issuer = default, TypeEnum type = default)
        {
    ...
    public class EBankingFinlandDetailsJsonConverter : JsonConverter<EBankingFinlandDetails>
    {
        ...
        /// <returns><see cref="EBankingFinlandDetails"/></returns>
        ...
        {
            /*
            if (eBankingFinlandDetails._CheckoutAttemptIdOption.IsSet && eBankingFinlandDetails.CheckoutAttemptId == null)
            ...
            if (eBankingFinlandDetails._IssuerOption.IsSet && eBankingFinlandDetails.Issuer == null)
            ...
            */
            ...
            if (eBankingFinlandDetails._CheckoutAttemptIdOption.IsSet)
                writer.WriteString("checkoutAttemptId", eBankingFinlandDetails.CheckoutAttemptId);

            if (eBankingFinlandDetails._IssuerOption.IsSet)
                writer.WriteString("issuer", eBankingFinlandDetails.Issuer);

            if (eBankingFinlandDetails.Type != null) 
            {
                string? typeRawValue = EBankingFinlandDetails.TypeEnum.ToJsonValue(eBankingFinlandDetails.Type);
