    ...
    public class ValidateShopperIdResponseJsonConverter : JsonConverter<ValidateShopperIdResponse>
    {
        ...
        public override ValidateShopperIdResponse Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (reason.IsSet && reason.Value == null)
                throw new ArgumentNullException(nameof(reason), "Property is not nullable for class ValidateShopperIdResponse.");

            if (result.IsSet && result.Value == null)
                throw new ArgumentNullException(nameof(result), "Property is not nullable for class ValidateShopperIdResponse.");
        ...
        {
            /*
            if (validateShopperIdResponse._ReasonOption.IsSet && validateShopperIdResponse.Reason == null)
                throw new ArgumentNullException(nameof(validateShopperIdResponse.Reason), "Property is required for class ValidateShopperIdResponse.");
