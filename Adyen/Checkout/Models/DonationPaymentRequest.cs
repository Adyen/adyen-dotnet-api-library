...
namespace Adyen.Checkout.Models
{
    ...
    /// </summary>
    [JsonConverter(typeof(DonationPaymentRequestJsonConverter))]
    public partial class DonationPaymentRequest
    {
        ...
        /// <summary>
        /// This is used to track if an optional field is set. If set, <see cref="DonationCampaignId"/> will be populated.
        /// </summary>
        [JsonIgnore]
        [global::System.ComponentModel.EditorBrowsable(global::System.ComponentModel.EditorBrowsableState.Never)]
        ...
        /// <summary>
        /// This is used to track if an optional field is set. If set, <see cref="DonationOriginalPspReference"/> will be populated.
        /// </summary>
        [JsonIgnore]
        [global::System.ComponentModel.EditorBrowsable(global::System.ComponentModel.EditorBrowsableState.Never)]
    ...
    public class DonationPaymentRequestJsonConverter : JsonConverter<DonationPaymentRequest>
    {
        ...
        public override DonationPaymentRequest Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            var donationPaymentRequest = new DonationPaymentRequest();
            donationPaymentRequest.Amount = amount.Value!;
            donationPaymentRequest.MerchantAccount = merchantAccount.Value!;
            donationPaymentRequest.Reference = reference.Value!;
            donationPaymentRequest.ReturnUrl = returnUrl.Value!;
            if (accountInfo.IsSet)
                donationPaymentRequest.AccountInfo = accountInfo.Value;
            if (additionalData.IsSet)
                donationPaymentRequest.AdditionalData = additionalData.Value;
            if (applicationInfo.IsSet)
                donationPaymentRequest.ApplicationInfo = applicationInfo.Value;
            if (authenticationData.IsSet)
                donationPaymentRequest.AuthenticationData = authenticationData.Value;
            if (billingAddress.IsSet)
                donationPaymentRequest.BillingAddress = billingAddress.Value;
            if (browserInfo.IsSet)
                donationPaymentRequest.BrowserInfo = browserInfo.Value;
            if (channel.IsSet)
                donationPaymentRequest.Channel = channel.Value;
            if (checkoutAttemptId.IsSet)
                donationPaymentRequest.CheckoutAttemptId = checkoutAttemptId.Value;
            if (conversionId.IsSet)
                donationPaymentRequest.ConversionId = conversionId.Value;
            if (countryCode.IsSet)
                donationPaymentRequest.CountryCode = countryCode.Value;
            if (dateOfBirth.IsSet)
                donationPaymentRequest.DateOfBirth = dateOfBirth.Value;
            if (deliverAt.IsSet)
                donationPaymentRequest.DeliverAt = deliverAt.Value;
            if (deliveryAddress.IsSet)
                donationPaymentRequest.DeliveryAddress = deliveryAddress.Value;
            if (deviceFingerprint.IsSet)
                donationPaymentRequest.DeviceFingerprint = deviceFingerprint.Value;
            if (donationAccount.IsSet)
                donationPaymentRequest.DonationAccount = donationAccount.Value;
            if (donationCampaignId.IsSet)
                donationPaymentRequest.DonationCampaignId = donationCampaignId.Value;
            if (donationOriginalPspReference.IsSet)
                donationPaymentRequest.DonationOriginalPspReference = donationOriginalPspReference.Value;
            if (donationToken.IsSet)
                donationPaymentRequest.DonationToken = donationToken.Value;
            if (lineItems.IsSet)
                donationPaymentRequest.LineItems = lineItems.Value;
            if (merchantRiskIndicator.IsSet)
                donationPaymentRequest.MerchantRiskIndicator = merchantRiskIndicator.Value;
            if (metadata.IsSet)
                donationPaymentRequest.Metadata = metadata.Value;
            if (mpiData.IsSet)
                donationPaymentRequest.MpiData = mpiData.Value;
            if (origin.IsSet)
                donationPaymentRequest.Origin = origin.Value;
            if (paymentMethod.IsSet)
                donationPaymentRequest.PaymentMethod = paymentMethod.Value;
            if (recurringProcessingModel.IsSet)
                donationPaymentRequest.RecurringProcessingModel = recurringProcessingModel.Value;
            if (redirectFromIssuerMethod.IsSet)
                donationPaymentRequest.RedirectFromIssuerMethod = redirectFromIssuerMethod.Value;
            if (redirectToIssuerMethod.IsSet)
                donationPaymentRequest.RedirectToIssuerMethod = redirectToIssuerMethod.Value;
            if (sessionValidity.IsSet)
                donationPaymentRequest.SessionValidity = sessionValidity.Value;
            if (shopperEmail.IsSet)
                donationPaymentRequest.ShopperEmail = shopperEmail.Value;
            if (shopperIP.IsSet)
                donationPaymentRequest.ShopperIP = shopperIP.Value;
            if (shopperInteraction.IsSet)
                donationPaymentRequest.ShopperInteraction = shopperInteraction.Value;
            if (shopperLocale.IsSet)
                donationPaymentRequest.ShopperLocale = shopperLocale.Value;
            if (shopperName.IsSet)
                donationPaymentRequest.ShopperName = shopperName.Value;
            if (shopperReference.IsSet)
                donationPaymentRequest.ShopperReference = shopperReference.Value;
            if (socialSecurityNumber.IsSet)
                donationPaymentRequest.SocialSecurityNumber = socialSecurityNumber.Value;
            if (store.IsSet)
                donationPaymentRequest.Store = store.Value;
            if (telephoneNumber.IsSet)
                donationPaymentRequest.TelephoneNumber = telephoneNumber.Value;
            if (threeDS2RequestData.IsSet)
                donationPaymentRequest.ThreeDS2RequestData = threeDS2RequestData.Value;
            if (threeDSAuthenticationOnly.IsSet)
                donationPaymentRequest.ThreeDSAuthenticationOnly = threeDSAuthenticationOnly.Value;
