...
namespace Adyen.Checkout.Models
{
    ...
    /// </summary>
    public partial class PaymentValidationsResponse : IValidatableObject
    {
        /// <summary>
    ...
    public class PaymentValidationsResponseJsonConverter : JsonConverter<PaymentValidationsResponse>
    {
        ...
        public override PaymentValidationsResponse Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (name.IsSet && name.Value == null)
                throw new ArgumentNullException(nameof(name), "Property is not nullable for class PaymentValidationsResponse.");
        ...
        {
            /*
            if (paymentValidationsResponse._NameOption.IsSet && paymentValidationsResponse.Name == null)
                throw new ArgumentNullException(nameof(paymentValidationsResponse.Name), "Property is required for class PaymentValidationsResponse.");
