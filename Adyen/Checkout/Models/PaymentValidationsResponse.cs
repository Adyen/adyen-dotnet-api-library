...
namespace Adyen.Checkout.Models
{
    ...
    public partial class PaymentValidationsResponse
    {
        ...
        /// </summary>
        /// <param name="name">Object that contains the status and outcomes of the [name validation](https://docs.adyen.com/payment-methods/cards/name-validation).</param>
        [JsonConstructor]
        ...
        /// </summary>
        /// <value>Object that contains the status and outcomes of the [name validation](https://docs.adyen.com/payment-methods/cards/name-validation).</value>
