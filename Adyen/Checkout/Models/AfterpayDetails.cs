...
namespace Adyen.Checkout.Models
{
    ...
    /// AfterpayDetails.
    /// </summary>
    public partial class AfterpayDetails : IValidatableObject
    {
        /// <summary>
        ...
        [JsonConstructor]
        public AfterpayDetails(Option<string?> billingAddress = default, Option<string?> checkoutAttemptId = default, Option<string?> deliveryAddress = default, Option<string?> personalDetails = default, Option<string?> recurringDetailReference = default, Option<string?> storedPaymentMethodId = default, TypeEnum type = default)
        {
    ...
    public class AfterpayDetailsJsonConverter : JsonConverter<AfterpayDetails>
    {
        ...
        public override AfterpayDetails Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (billingAddress.IsSet && billingAddress.Value == null)
                throw new ArgumentNullException(nameof(billingAddress), "Property is not nullable for class AfterpayDetails.");

            if (checkoutAttemptId.IsSet && checkoutAttemptId.Value == null)
                throw new ArgumentNullException(nameof(checkoutAttemptId), "Property is not nullable for class AfterpayDetails.");

            if (deliveryAddress.IsSet && deliveryAddress.Value == null)
                throw new ArgumentNullException(nameof(deliveryAddress), "Property is not nullable for class AfterpayDetails.");

            if (personalDetails.IsSet && personalDetails.Value == null)
                throw new ArgumentNullException(nameof(personalDetails), "Property is not nullable for class AfterpayDetails.");

            if (recurringDetailReference.IsSet && recurringDetailReference.Value == null)
                throw new ArgumentNullException(nameof(recurringDetailReference), "Property is not nullable for class AfterpayDetails.");

            if (storedPaymentMethodId.IsSet && storedPaymentMethodId.Value == null)
                throw new ArgumentNullException(nameof(storedPaymentMethodId), "Property is not nullable for class AfterpayDetails.");

            if (type.IsSet && type.Value == null)
                throw new ArgumentNullException(nameof(type), "Property is not nullable for class AfterpayDetails.");

            return new AfterpayDetails(billingAddress, checkoutAttemptId, deliveryAddress, personalDetails, recurringDetailReference, storedPaymentMethodId, type.Value!.Value!);
        }
        ...
        {
            /*
            if (afterpayDetails._BillingAddressOption.IsSet && afterpayDetails.BillingAddress == null)
                throw new ArgumentNullException(nameof(afterpayDetails.BillingAddress), "Property is required for class AfterpayDetails.");

            if (afterpayDetails._CheckoutAttemptIdOption.IsSet && afterpayDetails.CheckoutAttemptId == null)
                throw new ArgumentNullException(nameof(afterpayDetails.CheckoutAttemptId), "Property is required for class AfterpayDetails.");

            if (afterpayDetails._DeliveryAddressOption.IsSet && afterpayDetails.DeliveryAddress == null)
                throw new ArgumentNullException(nameof(afterpayDetails.DeliveryAddress), "Property is required for class AfterpayDetails.");

            if (afterpayDetails._PersonalDetailsOption.IsSet && afterpayDetails.PersonalDetails == null)
                throw new ArgumentNullException(nameof(afterpayDetails.PersonalDetails), "Property is required for class AfterpayDetails.");

            if (afterpayDetails._RecurringDetailReferenceOption.IsSet && afterpayDetails.RecurringDetailReference == null)
                throw new ArgumentNullException(nameof(afterpayDetails.RecurringDetailReference), "Property is required for class AfterpayDetails.");

            if (afterpayDetails._StoredPaymentMethodIdOption.IsSet && afterpayDetails.StoredPaymentMethodId == null)
                throw new ArgumentNullException(nameof(afterpayDetails.StoredPaymentMethodId), "Property is required for class AfterpayDetails.");
