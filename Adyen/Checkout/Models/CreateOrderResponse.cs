...
namespace Adyen.Checkout.Models
{
    ...
    public class CreateOrderResponseJsonConverter : JsonConverter<CreateOrderResponse>
    {
        ...
        public void WriteProperties(Utf8JsonWriter writer, CreateOrderResponse createOrderResponse, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (createOrderResponse._AdditionalDataOption.IsSet && createOrderResponse.AdditionalData == null)
            ...
            if (createOrderResponse._FraudResultOption.IsSet && createOrderResponse.FraudResult == null)
            ...
            if (createOrderResponse._PspReferenceOption.IsSet && createOrderResponse.PspReference == null)
            ...
            if (createOrderResponse._ReferenceOption.IsSet && createOrderResponse.Reference == null)
                throw new ArgumentNullException(nameof(createOrderResponse.Reference), "Property is required for class CreateOrderResponse.");

            if (createOrderResponse._RefusalReasonOption.IsSet && createOrderResponse.RefusalReason == null)
