...
namespace Adyen.Checkout.Models
{
    ...
    /// CreateOrderResponse.
    /// </summary>
    [JsonConverter(typeof(CreateOrderResponseJsonConverter))]
    ...
    public class CreateOrderResponseJsonConverter : JsonConverter<CreateOrderResponse>
    {
        ...
        public override CreateOrderResponse Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (fraudResult.IsSet)
                createOrderResponse.FraudResult = fraudResult.Value;
            if (pspReference.IsSet)
                createOrderResponse.PspReference = pspReference.Value;
            if (reference.IsSet)
                createOrderResponse.Reference = reference.Value;
            if (refusalReason.IsSet)
                createOrderResponse.RefusalReason = refusalReason.Value;
