...
namespace Adyen.Checkout.Models
{
    ...
    public partial class PayUUpiDetails : IValidatableObject
    {
        ...
        [JsonConstructor]
        public PayUUpiDetails(Option<string?> checkoutAttemptId = default, Option<string?> recurringDetailReference = default, Option<string?> shopperNotificationReference = default, Option<string?> storedPaymentMethodId = default, TypeEnum type = default, Option<string?> virtualPaymentAddress = default)
        {
    ...
    public class PayUUpiDetailsJsonConverter : JsonConverter<PayUUpiDetails>
    {
        ...
        /// <returns><see cref="PayUUpiDetails"/></returns>
        ...
        {
            /*
            if (payUUpiDetails._CheckoutAttemptIdOption.IsSet && payUUpiDetails.CheckoutAttemptId == null)
                throw new ArgumentNullException(nameof(payUUpiDetails.CheckoutAttemptId), "Property is required for class PayUUpiDetails.");

            if (payUUpiDetails._RecurringDetailReferenceOption.IsSet && payUUpiDetails.RecurringDetailReference == null)
            ...
            if (payUUpiDetails._ShopperNotificationReferenceOption.IsSet && payUUpiDetails.ShopperNotificationReference == null)
            ...
            if (payUUpiDetails._StoredPaymentMethodIdOption.IsSet && payUUpiDetails.StoredPaymentMethodId == null)
            ...
            if (payUUpiDetails._VirtualPaymentAddressOption.IsSet && payUUpiDetails.VirtualPaymentAddress == null)
