...
namespace Adyen.Checkout.Models
{
    ...
    /// PayUUpiDetails.
    /// </summary>
    [JsonConverter(typeof(PayUUpiDetailsJsonConverter))]
    public partial class PayUUpiDetails
    {
        /// <summary>
    ...
    public class PayUUpiDetailsJsonConverter : JsonConverter<PayUUpiDetails>
    {
        ...
        public override PayUUpiDetails Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            var payUUpiDetails = new PayUUpiDetails();
            if (checkoutAttemptId.IsSet)
                payUUpiDetails.CheckoutAttemptId = checkoutAttemptId.Value;
            if (recurringDetailReference.IsSet)
                payUUpiDetails.RecurringDetailReference = recurringDetailReference.Value;
            if (sdkData.IsSet)
                payUUpiDetails.SdkData = sdkData.Value;
        ...
        public void WriteProperties(Utf8JsonWriter writer, PayUUpiDetails payUUpiDetails, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (payUUpiDetails._CheckoutAttemptIdOption.IsSet)
                if (payUUpiDetails.CheckoutAttemptId != null)
            ...
            if (payUUpiDetails._RecurringDetailReferenceOption.IsSet)
                if (payUUpiDetails.RecurringDetailReference != null)
                    writer.WriteString("recurringDetailReference", payUUpiDetails.RecurringDetailReference);

            if (payUUpiDetails._SdkDataOption.IsSet)
                if (payUUpiDetails.SdkData != null)
                    writer.WriteString("sdkData", payUUpiDetails.SdkData);

            if (payUUpiDetails._ShopperNotificationReferenceOption.IsSet)
                if (payUUpiDetails.ShopperNotificationReference != null)
            ...
            if (payUUpiDetails._StoredPaymentMethodIdOption.IsSet)
                if (payUUpiDetails.StoredPaymentMethodId != null)
            ...
            if (payUUpiDetails._VirtualPaymentAddressOption.IsSet)
                if (payUUpiDetails.VirtualPaymentAddress != null)
