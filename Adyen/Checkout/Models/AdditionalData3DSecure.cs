...
namespace Adyen.Checkout.Models
{
    ...
    /// </summary>
    [JsonConverter(typeof(AdditionalData3DSecureJsonConverter))]
    public partial class AdditionalData3DSecure
    {
        /// <summary>
    ...
    public class AdditionalData3DSecureJsonConverter : JsonConverter<AdditionalData3DSecure>
    {
        ...
        public override AdditionalData3DSecure Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (challengeWindowSize.IsSet)
                additionalData3DSecure.ChallengeWindowSize = challengeWindowSize.Value;
            if (executeThreeD.IsSet)
                additionalData3DSecure.ExecuteThreeD = executeThreeD.Value;
            if (mpiImplementationType.IsSet)
                additionalData3DSecure.MpiImplementationType = mpiImplementationType.Value;
            if (scaExemption.IsSet)
                additionalData3DSecure.ScaExemption = scaExemption.Value;
            if (threeDSVersion.IsSet)
                additionalData3DSecure.ThreeDSVersion = threeDSVersion.Value;
            return additionalData3DSecure;
        }
