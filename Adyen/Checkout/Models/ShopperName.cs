...
namespace Adyen.Checkout.Models
{
    ...
    /// ShopperName.
    /// </summary>
    public partial class ShopperName : IValidatableObject
    {
        /// <summary>
    ...
    public class ShopperNameJsonConverter : JsonConverter<ShopperName>
    {
        ...
        public override ShopperName Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (firstName.IsSet && firstName.Value == null)
                throw new ArgumentNullException(nameof(firstName), "Property is not nullable for class ShopperName.");

            if (lastName.IsSet && lastName.Value == null)
                throw new ArgumentNullException(nameof(lastName), "Property is not nullable for class ShopperName.");
        ...
        public void WriteProperties(Utf8JsonWriter writer, ShopperName shopperName, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (shopperName.FirstName == null)
                throw new ArgumentNullException(nameof(shopperName.FirstName), "Property is required for class ShopperName.");

            if (shopperName.LastName == null)
                throw new ArgumentNullException(nameof(shopperName.LastName), "Property is required for class ShopperName.");
