...
namespace Adyen.Checkout.Models
{
    ...
    /// </summary>
    [JsonConverter(typeof(ThreeDS2RequestFieldsJsonConverter))]
    public partial class ThreeDS2RequestFields
    {
        /// <summary>
...
- If your version is 70 or later, use `authenticationData.authenticationOnly` instead. */
    ...
    public class ThreeDS2RequestFieldsJsonConverter : JsonConverter<ThreeDS2RequestFields>
    {
        ...
        public override ThreeDS2RequestFields Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (acctType.IsSet)
                threeDS2RequestFields.AcctType = acctType.Value;
            if (acquirerBIN.IsSet)
                threeDS2RequestFields.AcquirerBIN = acquirerBIN.Value;
            if (acquirerMerchantID.IsSet)
                threeDS2RequestFields.AcquirerMerchantID = acquirerMerchantID.Value;
            if (addrMatch.IsSet)
                threeDS2RequestFields.AddrMatch = addrMatch.Value;
            if (authenticationOnly.IsSet)
                threeDS2RequestFields.AuthenticationOnly = authenticationOnly.Value;
            if (challengeIndicator.IsSet)
                threeDS2RequestFields.ChallengeIndicator = challengeIndicator.Value;
            if (deviceRenderOptions.IsSet)
                threeDS2RequestFields.DeviceRenderOptions = deviceRenderOptions.Value;
            if (homePhone.IsSet)
                threeDS2RequestFields.HomePhone = homePhone.Value;
            if (mcc.IsSet)
                threeDS2RequestFields.Mcc = mcc.Value;
            if (merchantName.IsSet)
                threeDS2RequestFields.MerchantName = merchantName.Value;
            if (messageVersion.IsSet)
                threeDS2RequestFields.MessageVersion = messageVersion.Value;
            if (mobilePhone.IsSet)
                threeDS2RequestFields.MobilePhone = mobilePhone.Value;
            if (notificationURL.IsSet)
                threeDS2RequestFields.NotificationURL = notificationURL.Value;
            if (payTokenInd.IsSet)
                threeDS2RequestFields.PayTokenInd = payTokenInd.Value;
            if (paymentAuthenticationUseCase.IsSet)
                threeDS2RequestFields.PaymentAuthenticationUseCase = paymentAuthenticationUseCase.Value;
            if (purchaseInstalData.IsSet)
                threeDS2RequestFields.PurchaseInstalData = purchaseInstalData.Value;
            if (recurringExpiry.IsSet)
                threeDS2RequestFields.RecurringExpiry = recurringExpiry.Value;
            if (recurringFrequency.IsSet)
                threeDS2RequestFields.RecurringFrequency = recurringFrequency.Value;
            if (sdkAppID.IsSet)
                threeDS2RequestFields.SdkAppID = sdkAppID.Value;
            if (sdkEphemPubKey.IsSet)
                threeDS2RequestFields.SdkEphemPubKey = sdkEphemPubKey.Value;
            if (sdkMaxTimeout.IsSet)
                threeDS2RequestFields.SdkMaxTimeout = sdkMaxTimeout.Value;
            if (sdkReferenceNumber.IsSet)
                threeDS2RequestFields.SdkReferenceNumber = sdkReferenceNumber.Value;
            if (sdkTransID.IsSet)
                threeDS2RequestFields.SdkTransID = sdkTransID.Value;
            if (threeDSCompInd.IsSet)
                threeDS2RequestFields.ThreeDSCompInd = threeDSCompInd.Value;
            if (threeDSRequestorAuthenticationInd.IsSet)
                threeDS2RequestFields.ThreeDSRequestorAuthenticationInd = threeDSRequestorAuthenticationInd.Value;
            if (threeDSRequestorAuthenticationInfo.IsSet)
                threeDS2RequestFields.ThreeDSRequestorAuthenticationInfo = threeDSRequestorAuthenticationInfo.Value;
            if (threeDSRequestorChallengeInd.IsSet)
                threeDS2RequestFields.ThreeDSRequestorChallengeInd = threeDSRequestorChallengeInd.Value;
            if (threeDSRequestorID.IsSet)
                threeDS2RequestFields.ThreeDSRequestorID = threeDSRequestorID.Value;
            if (threeDSRequestorName.IsSet)
                threeDS2RequestFields.ThreeDSRequestorName = threeDSRequestorName.Value;
            if (threeDSRequestorPriorAuthenticationInfo.IsSet)
                threeDS2RequestFields.ThreeDSRequestorPriorAuthenticationInfo = threeDSRequestorPriorAuthenticationInfo.Value;
            if (threeDSRequestorURL.IsSet)
                threeDS2RequestFields.ThreeDSRequestorURL = threeDSRequestorURL.Value;
            if (transType.IsSet)
                threeDS2RequestFields.TransType = transType.Value;
            if (transactionType.IsSet)
                threeDS2RequestFields.TransactionType = transactionType.Value;
            if (whiteListStatus.IsSet)
                threeDS2RequestFields.WhiteListStatus = whiteListStatus.Value;
            if (workPhone.IsSet)
                threeDS2RequestFields.WorkPhone = workPhone.Value;
            return threeDS2RequestFields;
        }
        ...
        public void WriteProperties(Utf8JsonWriter writer, ThreeDS2RequestFields threeDS2RequestFields, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (threeDS2RequestFields._NotificationURLOption.IsSet)
                if (threeDS2RequestFields.NotificationURL != null)
            ...
            if (threeDS2RequestFields._PurchaseInstalDataOption.IsSet)
                if (threeDS2RequestFields.PurchaseInstalData != null)
            ...
            if (threeDS2RequestFields._RecurringExpiryOption.IsSet)
                if (threeDS2RequestFields.RecurringExpiry != null)
            ...
            if (threeDS2RequestFields._RecurringFrequencyOption.IsSet)
                if (threeDS2RequestFields.RecurringFrequency != null)
            ...
            if (threeDS2RequestFields._SdkAppIDOption.IsSet)
                if (threeDS2RequestFields.SdkAppID != null)
            ...
            if (threeDS2RequestFields._ThreeDSRequestorAuthenticationIndOption.IsSet)
                if (threeDS2RequestFields.ThreeDSRequestorAuthenticationInd != null)
            ...
            if (threeDS2RequestFields._ThreeDSRequestorNameOption.IsSet)
                if (threeDS2RequestFields.ThreeDSRequestorName != null)
