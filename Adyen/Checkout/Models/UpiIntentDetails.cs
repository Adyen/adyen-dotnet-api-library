...
namespace Adyen.Checkout.Models
{
    ...
    /// UpiIntentDetails.
    /// </summary>
    [JsonConverter(typeof(UpiIntentDetailsJsonConverter))]
    public partial class UpiIntentDetails
    {
        /// <summary>
    ...
    public class UpiIntentDetailsJsonConverter : JsonConverter<UpiIntentDetails>
    {
        ...
        public override UpiIntentDetails Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
                ...
                if (utf8JsonReader.TokenType == JsonTokenType.PropertyName && currentDepth == utf8JsonReader.CurrentDepth - 1)
                {
                    ...
                    switch (jsonPropertyName)
                    {
                        ...
                        case "type":
                            ...
                            type = new Option<UpiIntentDetails.TypeEnum?>(UpiIntentDetails.TypeEnum.FromStringOrDefault(typeRawValue) ?? (UpiIntentDetails.TypeEnum)typeRawValue);
                            break;
                        default:
                            break;
                    }
            ...
            if (appId.IsSet)
                upiIntentDetails.AppId = appId.Value;
            if (billingSequenceNumber.IsSet)
                upiIntentDetails.BillingSequenceNumber = billingSequenceNumber.Value;
            if (checkoutAttemptId.IsSet)
                upiIntentDetails.CheckoutAttemptId = checkoutAttemptId.Value;
            if (recurringDetailReference.IsSet)
                upiIntentDetails.RecurringDetailReference = recurringDetailReference.Value;
            if (sdkData.IsSet)
                upiIntentDetails.SdkData = sdkData.Value;
        ...
        public void WriteProperties(Utf8JsonWriter writer, UpiIntentDetails upiIntentDetails, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (upiIntentDetails._CheckoutAttemptIdOption.IsSet)
                if (upiIntentDetails.CheckoutAttemptId != null)
            ...
            if (upiIntentDetails._RecurringDetailReferenceOption.IsSet)
                if (upiIntentDetails.RecurringDetailReference != null)
                    writer.WriteString("recurringDetailReference", upiIntentDetails.RecurringDetailReference);

            if (upiIntentDetails._SdkDataOption.IsSet)
                if (upiIntentDetails.SdkData != null)
                    writer.WriteString("sdkData", upiIntentDetails.SdkData);

            if (upiIntentDetails._ShopperNotificationReferenceOption.IsSet)
                if (upiIntentDetails.ShopperNotificationReference != null)
            ...
            if (upiIntentDetails._StoredPaymentMethodIdOption.IsSet)
                if (upiIntentDetails.StoredPaymentMethodId != null)
