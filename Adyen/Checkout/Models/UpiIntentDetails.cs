...
namespace Adyen.Checkout.Models
{
    ...
    public partial class UpiIntentDetails : IValidatableObject
    {
        ...
        [JsonConstructor]
        public UpiIntentDetails(Option<string?> appId = default, Option<string?> billingSequenceNumber = default, Option<string?> checkoutAttemptId = default, Option<string?> recurringDetailReference = default, Option<string?> shopperNotificationReference = default, Option<string?> storedPaymentMethodId = default, TypeEnum type = default)
        {
            _AppIdOption = appId;
    ...
    public class UpiIntentDetailsJsonConverter : JsonConverter<UpiIntentDetails>
    {
        ...
        /// <returns><see cref="UpiIntentDetails"/></returns>
        ...
        public override UpiIntentDetails Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
                ...
                if (utf8JsonReader.TokenType == JsonTokenType.PropertyName && currentDepth == utf8JsonReader.CurrentDepth - 1)
                {
                    ...
                    switch (jsonPropertyName)
                    {
                        ...
                        case "type":
                            ...
                            type = new Option<UpiIntentDetails.TypeEnum?>(UpiIntentDetails.TypeEnum.FromStringOrDefault(typeRawValue));
                            break;
                        default:
                            break;
                    }
            ...
            if (billingSequenceNumber.IsSet && billingSequenceNumber.Value == null)
                throw new ArgumentNullException(nameof(billingSequenceNumber), "Property is not nullable for class UpiIntentDetails.");
            ...
            return new UpiIntentDetails(appId, billingSequenceNumber, checkoutAttemptId, recurringDetailReference, shopperNotificationReference, storedPaymentMethodId, type.Value!.Value!);
        }
        ...
        {
            /*
            if (upiIntentDetails._AppIdOption.IsSet && upiIntentDetails.AppId == null)
                throw new ArgumentNullException(nameof(upiIntentDetails.AppId), "Property is required for class UpiIntentDetails.");

            if (upiIntentDetails._BillingSequenceNumberOption.IsSet && upiIntentDetails.BillingSequenceNumber == null)
                throw new ArgumentNullException(nameof(upiIntentDetails.BillingSequenceNumber), "Property is required for class UpiIntentDetails.");

            if (upiIntentDetails._CheckoutAttemptIdOption.IsSet && upiIntentDetails.CheckoutAttemptId == null)
            ...
            if (upiIntentDetails._RecurringDetailReferenceOption.IsSet && upiIntentDetails.RecurringDetailReference == null)
            ...
            if (upiIntentDetails._ShopperNotificationReferenceOption.IsSet && upiIntentDetails.ShopperNotificationReference == null)
            ...
            if (upiIntentDetails._StoredPaymentMethodIdOption.IsSet && upiIntentDetails.StoredPaymentMethodId == null)
            ...
            */
            ...
            if (upiIntentDetails._AppIdOption.IsSet)
                writer.WriteString("appId", upiIntentDetails.AppId);

            if (upiIntentDetails._BillingSequenceNumberOption.IsSet)
                writer.WriteString("billingSequenceNumber", upiIntentDetails.BillingSequenceNumber);

            if (upiIntentDetails._CheckoutAttemptIdOption.IsSet)
                writer.WriteString("checkoutAttemptId", upiIntentDetails.CheckoutAttemptId);

            if (upiIntentDetails._RecurringDetailReferenceOption.IsSet)
                writer.WriteString("recurringDetailReference", upiIntentDetails.RecurringDetailReference);

            if (upiIntentDetails._ShopperNotificationReferenceOption.IsSet)
                writer.WriteString("shopperNotificationReference", upiIntentDetails.ShopperNotificationReference);

            if (upiIntentDetails._StoredPaymentMethodIdOption.IsSet)
                writer.WriteString("storedPaymentMethodId", upiIntentDetails.StoredPaymentMethodId);

            if (upiIntentDetails.Type != null) 
            {
                string? typeRawValue = UpiIntentDetails.TypeEnum.ToJsonValue(upiIntentDetails.Type);
