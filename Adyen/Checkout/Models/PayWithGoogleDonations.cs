...
namespace Adyen.Checkout.Models
{
    ...
    public class PayWithGoogleDonationsJsonConverter : JsonConverter<PayWithGoogleDonations>
    {
        ...
        /// <returns><see cref="PayWithGoogleDonations"/></returns>
        ...
        public void WriteProperties(Utf8JsonWriter writer, PayWithGoogleDonations payWithGoogleDonations, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (payWithGoogleDonations._CheckoutAttemptIdOption.IsSet && payWithGoogleDonations.CheckoutAttemptId == null)
            ...
            if (payWithGoogleDonations._RecurringDetailReferenceOption.IsSet && payWithGoogleDonations.RecurringDetailReference == null)
            ...
            if (payWithGoogleDonations._StoredPaymentMethodIdOption.IsSet && payWithGoogleDonations.StoredPaymentMethodId == null)
            ...
            if (payWithGoogleDonations._ThreeDS2SdkVersionOption.IsSet && payWithGoogleDonations.ThreeDS2SdkVersion == null)
            ...
            */
            ...
            if (payWithGoogleDonations._CheckoutAttemptIdOption.IsSet)
            ...
            if (payWithGoogleDonations._StoredPaymentMethodIdOption.IsSet)
                writer.WriteString("storedPaymentMethodId", payWithGoogleDonations.StoredPaymentMethodId);

            if (payWithGoogleDonations._ThreeDS2SdkVersionOption.IsSet)
