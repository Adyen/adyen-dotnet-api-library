...
namespace Adyen.Checkout.Models
{
    ...
    /// </summary>
    [JsonConverter(typeof(PayWithGoogleDonationsJsonConverter))]
    ...
    public class PayWithGoogleDonationsJsonConverter : JsonConverter<PayWithGoogleDonations>
    {
        ...
        public override PayWithGoogleDonations Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (fundingSource.IsSet)
                payWithGoogleDonations.FundingSource = fundingSource.Value;
            if (recurringDetailReference.IsSet)
                payWithGoogleDonations.RecurringDetailReference = recurringDetailReference.Value;
            if (sdkData.IsSet)
                payWithGoogleDonations.SdkData = sdkData.Value;
            if (storedPaymentMethodId.IsSet)
                payWithGoogleDonations.StoredPaymentMethodId = storedPaymentMethodId.Value;
            if (threeDS2SdkVersion.IsSet)
                payWithGoogleDonations.ThreeDS2SdkVersion = threeDS2SdkVersion.Value;
            if (type.IsSet)
                payWithGoogleDonations.Type = type.Value;
            return payWithGoogleDonations;
        }
        ...
        public void WriteProperties(Utf8JsonWriter writer, PayWithGoogleDonations payWithGoogleDonations, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (payWithGoogleDonations._SdkDataOption.IsSet)
                if (payWithGoogleDonations.SdkData != null)
                    writer.WriteString("sdkData", payWithGoogleDonations.SdkData);

            if (payWithGoogleDonations._StoredPaymentMethodIdOption.IsSet)
                if (payWithGoogleDonations.StoredPaymentMethodId != null)
