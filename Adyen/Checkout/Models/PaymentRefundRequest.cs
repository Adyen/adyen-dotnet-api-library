...
namespace Adyen.Checkout.Models
{
    ...
    public partial class PaymentRefundRequest : IValidatableObject
    {
        ...
        /// <summary>
        /// Used to track whether MerchantRefundReason is set or not.
        /// </summary>
        [JsonIgnore]
    ...
    public class PaymentRefundRequestJsonConverter : JsonConverter<PaymentRefundRequest>
    {
        ...
        public override PaymentRefundRequest Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (capturePspReference.IsSet && capturePspReference.Value == null)
                throw new ArgumentNullException(nameof(capturePspReference), "Property is not nullable for class PaymentRefundRequest.");

            if (enhancedSchemeData.IsSet && enhancedSchemeData.Value == null)
                throw new ArgumentNullException(nameof(enhancedSchemeData), "Property is not nullable for class PaymentRefundRequest.");
        ...
        public void WriteProperties(Utf8JsonWriter writer, PaymentRefundRequest paymentRefundRequest, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (paymentRefundRequest._ApplicationInfoOption.IsSet && paymentRefundRequest.ApplicationInfo == null)
            ...
            if (paymentRefundRequest._CapturePspReferenceOption.IsSet && paymentRefundRequest.CapturePspReference == null)
                throw new ArgumentNullException(nameof(paymentRefundRequest.CapturePspReference), "Property is required for class PaymentRefundRequest.");

            if (paymentRefundRequest._EnhancedSchemeDataOption.IsSet && paymentRefundRequest.EnhancedSchemeData == null)
                throw new ArgumentNullException(nameof(paymentRefundRequest.EnhancedSchemeData), "Property is required for class PaymentRefundRequest.");

            if (paymentRefundRequest._LineItemsOption.IsSet && paymentRefundRequest.LineItems == null)
            ...
            if (paymentRefundRequest._ReferenceOption.IsSet && paymentRefundRequest.Reference == null)
            ...
            if (paymentRefundRequest._SplitsOption.IsSet && paymentRefundRequest.Splits == null)
                throw new ArgumentNullException(nameof(paymentRefundRequest.Splits), "Property is required for class PaymentRefundRequest.");

            if (paymentRefundRequest._StoreOption.IsSet && paymentRefundRequest.Store == null)
