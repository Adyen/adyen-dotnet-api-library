...
namespace Adyen.Checkout.Models
{
    ...
    /// </summary>
    [JsonConverter(typeof(PaymentRefundRequestJsonConverter))]
    public partial class PaymentRefundRequest
    {
        ...
        public class MerchantRefundReasonEnum : IEnum
        {
            ...
            /// <summary>
            /// Compares two <see cref="MerchantRefundReasonEnum"/> instances for equality.
            /// </summary>
            ...
            /// <summary>
            /// Compares two <see cref="MerchantRefundReasonEnum"/> instances for inequality.
            /// </summary>
            public static bool operator !=(MerchantRefundReasonEnum? left, MerchantRefundReasonEnum? right) => !string.Equals(left?.Value, right?.Value, StringComparison.OrdinalIgnoreCase);

            /// <summary>
            /// Returns true if the given object is equal to this <see cref="MerchantRefundReasonEnum"/> instance.
            /// </summary>
            ...
            /// <summary>
            /// Returns a hash code for this <see cref="MerchantRefundReasonEnum"/> instance.
            /// </summary>
            public override int GetHashCode() => Value?.GetHashCode() ?? 0;

            /// <summary>
            /// Returns the string value of the <see cref="MerchantRefundReasonEnum"/> instance.
            /// </summary>
            ...
            {
                /// <summary>
                /// Deserializes a <see cref="MerchantRefundReasonEnum"/> from JSON.
                /// </summary>
                ...
                /// <summary>
                /// Serializes a <see cref="MerchantRefundReasonEnum"/> to JSON.
                /// </summary>
    ...
    public class PaymentRefundRequestJsonConverter : JsonConverter<PaymentRefundRequest>
    {
        ...
        public override PaymentRefundRequest Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (capturePspReference.IsSet)
                paymentRefundRequest.CapturePspReference = capturePspReference.Value;
            if (enhancedSchemeData.IsSet)
                paymentRefundRequest.EnhancedSchemeData = enhancedSchemeData.Value;
            if (lineItems.IsSet)
                paymentRefundRequest.LineItems = lineItems.Value;
            if (merchantRefundReason.IsSet)
                paymentRefundRequest.MerchantRefundReason = merchantRefundReason.Value;
            if (reference.IsSet)
                paymentRefundRequest.Reference = reference.Value;
            if (splits.IsSet)
                paymentRefundRequest.Splits = splits.Value;
            if (store.IsSet)
                paymentRefundRequest.Store = store.Value;
