...
namespace Adyen.Checkout.Models
{
    ...
    public partial class PaymentRefundRequest
    {
        ...
        /// </summary>
        /// <param name="amount">The amount that you want to refund. The &#x60;currency&#x60; must match the currency used in authorisation, the &#x60;value&#x60; must be smaller than or equal to the authorised amount.</param>
        ...
        /// <param name="enhancedSchemeData">Enhanced scheme data that may be required for processing the payment. For example, airline information.</param>
        ...
        /// </summary>
        /// <value>The amount that you want to refund. The `currency` must match the currency used in authorisation, the `value` must be smaller than or equal to the authorised amount.</value>
        ...
        /// </summary>
        /// <value>Enhanced scheme data that may be required for processing the payment. For example, airline information.</value>
    ...
    public class PaymentRefundRequestJsonConverter : JsonConverter<PaymentRefundRequest>
    {
        ...
        public void WriteProperties(Utf8JsonWriter writer, PaymentRefundRequest paymentRefundRequest, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (paymentRefundRequest._MerchantRefundReasonOption.IsSet && paymentRefundRequest.MerchantRefundReason != null) 
            {
                string? merchantRefundReasonRawValue = PaymentRefundRequest.MerchantRefundReasonEnum.ToJsonValue(paymentRefundRequest._MerchantRefundReasonOption.Value!.Value);
