...
namespace Adyen.Checkout.Models
{
    ...
    /// </summary>
    [JsonConverter(typeof(PaymentMethodsRequestJsonConverter))]
    ...
    public class PaymentMethodsRequestJsonConverter : JsonConverter<PaymentMethodsRequest>
    {
        ...
        public override PaymentMethodsRequest Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (allowedPaymentMethods.IsSet)
                paymentMethodsRequest.AllowedPaymentMethods = allowedPaymentMethods.Value;
            if (amount.IsSet)
                paymentMethodsRequest.Amount = amount.Value;
            if (blockedPaymentMethods.IsSet)
                paymentMethodsRequest.BlockedPaymentMethods = blockedPaymentMethods.Value;
            if (browserInfo.IsSet)
                paymentMethodsRequest.BrowserInfo = browserInfo.Value;
            if (channel.IsSet)
                paymentMethodsRequest.Channel = channel.Value;
            if (countryCode.IsSet)
                paymentMethodsRequest.CountryCode = countryCode.Value;
            if (order.IsSet)
                paymentMethodsRequest.Order = order.Value;
            if (shopperConversionId.IsSet)
                paymentMethodsRequest.ShopperConversionId = shopperConversionId.Value;
            if (shopperEmail.IsSet)
                paymentMethodsRequest.ShopperEmail = shopperEmail.Value;
            if (shopperIP.IsSet)
                paymentMethodsRequest.ShopperIP = shopperIP.Value;
            if (shopperLocale.IsSet)
                paymentMethodsRequest.ShopperLocale = shopperLocale.Value;
            if (shopperReference.IsSet)
                paymentMethodsRequest.ShopperReference = shopperReference.Value;
            if (splitCardFundingSources.IsSet)
                paymentMethodsRequest.SplitCardFundingSources = splitCardFundingSources.Value;
            if (store.IsSet)
                paymentMethodsRequest.Store = store.Value;
            if (storeFiltrationMode.IsSet)
                paymentMethodsRequest.StoreFiltrationMode = storeFiltrationMode.Value;
            if (telephoneNumber.IsSet)
                paymentMethodsRequest.TelephoneNumber = telephoneNumber.Value;
