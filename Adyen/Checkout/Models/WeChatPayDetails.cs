...
namespace Adyen.Checkout.Models
{
    ...
    /// WeChatPayDetails.
    /// </summary>
    [JsonConverter(typeof(WeChatPayDetailsJsonConverter))]
    public partial class WeChatPayDetails
    {
        /// <summary>
        ...
        {
            _TypeOption = TypeEnum.Wechatpay;
            OnCreated();
        }
    ...
    public class WeChatPayDetailsJsonConverter : JsonConverter<WeChatPayDetails>
    {
        ...
        public override WeChatPayDetails Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (sdkData.IsSet)
                weChatPayDetails.SdkData = sdkData.Value;
            if (type.IsSet)
                weChatPayDetails.Type = type.Value;
            return weChatPayDetails;
        }
        ...
        public void WriteProperties(Utf8JsonWriter writer, WeChatPayDetails weChatPayDetails, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (weChatPayDetails._SdkDataOption.IsSet)
