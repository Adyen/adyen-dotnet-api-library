...
namespace Adyen.Checkout.Models
{
    ...
    public partial class UpiCollectDetails : IValidatableObject
    {
        ...
        [JsonConstructor]
        public UpiCollectDetails(Option<string?> billingSequenceNumber = default, Option<string?> checkoutAttemptId = default, Option<string?> recurringDetailReference = default, Option<string?> shopperNotificationReference = default, Option<string?> storedPaymentMethodId = default, TypeEnum type = default, Option<string?> virtualPaymentAddress = default)
        {
    ...
    public class UpiCollectDetailsJsonConverter : JsonConverter<UpiCollectDetails>
    {
        ...
        /// <returns><see cref="UpiCollectDetails"/></returns>
        ...
        public override UpiCollectDetails Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
                ...
                if (utf8JsonReader.TokenType == JsonTokenType.PropertyName && currentDepth == utf8JsonReader.CurrentDepth - 1)
                {
                    ...
                    switch (jsonPropertyName)
                    {
                        ...
                        case "type":
                            ...
                            type = new Option<UpiCollectDetails.TypeEnum?>(UpiCollectDetails.TypeEnum.FromStringOrDefault(typeRawValue));
                            break;
            ...
            return new UpiCollectDetails(billingSequenceNumber, checkoutAttemptId, recurringDetailReference, shopperNotificationReference, storedPaymentMethodId, type.Value!.Value!, virtualPaymentAddress);
        }
        ...
        {
            /*
            if (upiCollectDetails._BillingSequenceNumberOption.IsSet && upiCollectDetails.BillingSequenceNumber == null)
            ...
            if (upiCollectDetails._CheckoutAttemptIdOption.IsSet && upiCollectDetails.CheckoutAttemptId == null)
            ...
            if (upiCollectDetails._RecurringDetailReferenceOption.IsSet && upiCollectDetails.RecurringDetailReference == null)
            ...
            if (upiCollectDetails._ShopperNotificationReferenceOption.IsSet && upiCollectDetails.ShopperNotificationReference == null)
            ...
            if (upiCollectDetails._StoredPaymentMethodIdOption.IsSet && upiCollectDetails.StoredPaymentMethodId == null)
            ...
            if (upiCollectDetails._VirtualPaymentAddressOption.IsSet && upiCollectDetails.VirtualPaymentAddress == null)
