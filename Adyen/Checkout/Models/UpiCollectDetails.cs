...
namespace Adyen.Checkout.Models
{
    ...
    /// UpiCollectDetails.
    /// </summary>
    [JsonConverter(typeof(UpiCollectDetailsJsonConverter))]
    public partial class UpiCollectDetails
    {
        /// <summary>
    ...
    public class UpiCollectDetailsJsonConverter : JsonConverter<UpiCollectDetails>
    {
        ...
        public override UpiCollectDetails Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
                ...
                if (utf8JsonReader.TokenType == JsonTokenType.PropertyName && currentDepth == utf8JsonReader.CurrentDepth - 1)
                {
                    ...
                    switch (jsonPropertyName)
                    {
                        ...
                        case "type":
                            ...
                            type = new Option<UpiCollectDetails.TypeEnum?>(UpiCollectDetails.TypeEnum.FromStringOrDefault(typeRawValue) ?? (UpiCollectDetails.TypeEnum)typeRawValue);
                            break;
            ...
            if (billingSequenceNumber.IsSet)
                upiCollectDetails.BillingSequenceNumber = billingSequenceNumber.Value;
            if (checkoutAttemptId.IsSet)
                upiCollectDetails.CheckoutAttemptId = checkoutAttemptId.Value;
            if (recurringDetailReference.IsSet)
                upiCollectDetails.RecurringDetailReference = recurringDetailReference.Value;
            if (sdkData.IsSet)
                upiCollectDetails.SdkData = sdkData.Value;
        ...
        public void WriteProperties(Utf8JsonWriter writer, UpiCollectDetails upiCollectDetails, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (upiCollectDetails._CheckoutAttemptIdOption.IsSet)
                if (upiCollectDetails.CheckoutAttemptId != null)
            ...
            if (upiCollectDetails._RecurringDetailReferenceOption.IsSet)
                if (upiCollectDetails.RecurringDetailReference != null)
                    writer.WriteString("recurringDetailReference", upiCollectDetails.RecurringDetailReference);

            if (upiCollectDetails._SdkDataOption.IsSet)
                if (upiCollectDetails.SdkData != null)
                    writer.WriteString("sdkData", upiCollectDetails.SdkData);

            if (upiCollectDetails._ShopperNotificationReferenceOption.IsSet)
                if (upiCollectDetails.ShopperNotificationReference != null)
