...
namespace Adyen.Checkout.Models
{
    ...
    /// AuPayDetails.
    /// </summary>
    [JsonConverter(typeof(AuPayDetailsJsonConverter))]
    public partial class AuPayDetails
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AuPayDetails" /> class.
        /// </summary>
        public AuPayDetails()
        {
            _TypeOption = TypeEnum.Aupay;
            OnCreated();
        }
    ...
    /// <summary>
    /// A Json converter for type <see cref="AuPayDetails" />
    /// </summary>
    public class AuPayDetailsJsonConverter : JsonConverter<AuPayDetails>
    {
        /// <summary>
        /// Deserializes json to <see cref="AuPayDetails"/>.
        /// </summary>
        /// <param name="utf8JsonReader"><see cref="Utf8JsonReader"/>.</param>
        /// <param name="typeToConvert"><see cref="Type"/>.</param>
        /// <param name="jsonSerializerOptions">The <see cref="JsonSerializerOptions"/>, initialized from <see cref="HostConfiguration"/>.</param>
        /// <returns><see cref="AuPayDetails"/>.</returns>
        /// <exception cref="JsonException"></exception>
        public override AuPayDetails Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            Option<AuPayDetails.TypeEnum?> type = default;
                ...
                if (utf8JsonReader.TokenType == JsonTokenType.PropertyName && currentDepth == utf8JsonReader.CurrentDepth - 1)
                {
                    ...
                    switch (jsonPropertyName)
                    {
                        ...
                        case "type":
                            ...
                            type = new Option<AuPayDetails.TypeEnum?>(AuPayDetails.TypeEnum.FromStringOrDefault(typeRawValue) ?? (AuPayDetails.TypeEnum)typeRawValue);
                            break;
                        default:
                            break;
                    }
            ...
            var auPayDetails = new AuPayDetails();
            if (checkoutAttemptId.IsSet)
                auPayDetails.CheckoutAttemptId = checkoutAttemptId.Value;
            if (recurringDetailReference.IsSet)
                auPayDetails.RecurringDetailReference = recurringDetailReference.Value;
            if (sdkData.IsSet)
                auPayDetails.SdkData = sdkData.Value;
            if (storedPaymentMethodId.IsSet)
                auPayDetails.StoredPaymentMethodId = storedPaymentMethodId.Value;
            if (type.IsSet)
                auPayDetails.Type = type.Value;
            return auPayDetails;
        }

        /// <summary>
        /// Serializes a <see cref="AuPayDetails"/>.
        /// </summary>
        /// <param name="writer"><see cref="Utf8JsonWriter"/></param>
        /// <param name="auPayDetails"></param>
        /// <param name="jsonSerializerOptions"><see cref="JsonSerializerOptions"/></param>
        public override void Write(Utf8JsonWriter writer, AuPayDetails auPayDetails, JsonSerializerOptions jsonSerializerOptions)
        {
            
            writer.WriteStartObject();
            
            WriteProperties(writer, auPayDetails, jsonSerializerOptions);
        ...
        /// <summary>
        /// Serializes the properties of <see cref="AuPayDetails"/>.
        /// </summary>
        /// <param name="writer"><see cref="Utf8JsonWriter"/></param>
        /// <param name="auPayDetails"></param>
        /// <param name="jsonSerializerOptions"><see cref="JsonSerializerOptions"/></param>
        public void WriteProperties(Utf8JsonWriter writer, AuPayDetails auPayDetails, JsonSerializerOptions jsonSerializerOptions)
        {
            
            if (auPayDetails._CheckoutAttemptIdOption.IsSet)
                if (auPayDetails.CheckoutAttemptId != null)
                    writer.WriteString("checkoutAttemptId", auPayDetails.CheckoutAttemptId);

            if (auPayDetails._RecurringDetailReferenceOption.IsSet)
                if (auPayDetails.RecurringDetailReference != null)
                    writer.WriteString("recurringDetailReference", auPayDetails.RecurringDetailReference);

            if (auPayDetails._SdkDataOption.IsSet)
                if (auPayDetails.SdkData != null)
                    writer.WriteString("sdkData", auPayDetails.SdkData);

            if (auPayDetails._StoredPaymentMethodIdOption.IsSet)
                if (auPayDetails.StoredPaymentMethodId != null)
                    writer.WriteString("storedPaymentMethodId", auPayDetails.StoredPaymentMethodId);

            if (auPayDetails._TypeOption.IsSet && auPayDetails.Type != null) 
            {
                string? typeRawValue = AuPayDetails.TypeEnum.ToJsonValue(auPayDetails._TypeOption.Value!.Value);
