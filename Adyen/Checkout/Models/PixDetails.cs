...
namespace Adyen.Checkout.Models
{
    ...
    /// PixDetails.
    /// </summary>
    public partial class PixDetails
    {
        /// <summary>
        ...
        public PixDetails(Option<string?> checkoutAttemptId = default, Option<PixRecurring?> pixRecurring = default, Option<string?> recurringDetailReference = default, Option<string?> sdkData = default, Option<string?> storedPaymentMethodId = default, Option<TypeEnum?> type = default)
        {
        ...
        /// <summary>
        /// This is used to track if an optional field is set. If set, <see cref="PixRecurring"/> will be populated.
        /// </summary>
        [JsonIgnore]
        [global::System.ComponentModel.EditorBrowsable(global::System.ComponentModel.EditorBrowsableState.Never)]
    ...
    public class PixDetailsJsonConverter : JsonConverter<PixDetails>
    {
        ...
        public override PixDetails Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            return new PixDetails(checkoutAttemptId, pixRecurring, recurringDetailReference, sdkData, storedPaymentMethodId, type);
        }
        ...
        public void WriteProperties(Utf8JsonWriter writer, PixDetails pixDetails, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (pixDetails._CheckoutAttemptIdOption.IsSet)
                if (pixDetails.CheckoutAttemptId != null)
            ...
            if (pixDetails._RecurringDetailReferenceOption.IsSet)
                if (pixDetails.RecurringDetailReference != null)
                    writer.WriteString("recurringDetailReference", pixDetails.RecurringDetailReference);

            if (pixDetails._SdkDataOption.IsSet)
                if (pixDetails.SdkData != null)
                    writer.WriteString("sdkData", pixDetails.SdkData);

            if (pixDetails._StoredPaymentMethodIdOption.IsSet)
                if (pixDetails.StoredPaymentMethodId != null)
