...
namespace Adyen.Checkout.Models
{
    ...
    /// TokenMandate.
    /// </summary>
    [JsonConverter(typeof(TokenMandateJsonConverter))]
    public partial class TokenMandate
    {
        ...
        public class AmountRuleEnum : IEnum
        {
            ...
            /// <summary>
            /// Compares two <see cref="AmountRuleEnum"/> instances for equality.
            /// </summary>
            ...
            /// <summary>
            /// Compares two <see cref="AmountRuleEnum"/> instances for inequality.
            /// </summary>
            public static bool operator !=(AmountRuleEnum? left, AmountRuleEnum? right) => !string.Equals(left?.Value, right?.Value, StringComparison.OrdinalIgnoreCase);

            /// <summary>
            /// Returns true if the given object is equal to this <see cref="AmountRuleEnum"/> instance.
            /// </summary>
            ...
            /// <summary>
            /// Returns a hash code for this <see cref="AmountRuleEnum"/> instance.
            /// </summary>
            public override int GetHashCode() => Value?.GetHashCode() ?? 0;

            /// <summary>
            /// Returns the string value of the <see cref="AmountRuleEnum"/> instance.
            /// </summary>
            public override string ToString() => Value ?? string.Empty;
            ...
            {
                /// <summary>
                /// Deserializes a <see cref="AmountRuleEnum"/> from JSON.
                /// </summary>
                ...
                /// <summary>
                /// Serializes a <see cref="AmountRuleEnum"/> to JSON.
                /// </summary>
        ...
        public class BillingAttemptsRuleEnum : IEnum
        {
            ...
            /// <summary>
            /// Compares two <see cref="BillingAttemptsRuleEnum"/> instances for equality.
            /// </summary>
            ...
            /// <summary>
            /// Compares two <see cref="BillingAttemptsRuleEnum"/> instances for inequality.
            /// </summary>
            public static bool operator !=(BillingAttemptsRuleEnum? left, BillingAttemptsRuleEnum? right) => !string.Equals(left?.Value, right?.Value, StringComparison.OrdinalIgnoreCase);

            /// <summary>
            /// Returns true if the given object is equal to this <see cref="BillingAttemptsRuleEnum"/> instance.
            /// </summary>
            ...
            /// <summary>
            /// Returns a hash code for this <see cref="BillingAttemptsRuleEnum"/> instance.
            /// </summary>
            public override int GetHashCode() => Value?.GetHashCode() ?? 0;

            /// <summary>
            /// Returns the string value of the <see cref="BillingAttemptsRuleEnum"/> instance.
            /// </summary>
            public override string ToString() => Value ?? string.Empty;
            ...
            {
                /// <summary>
                /// Deserializes a <see cref="BillingAttemptsRuleEnum"/> from JSON.
                /// </summary>
                ...
                /// <summary>
                /// Serializes a <see cref="BillingAttemptsRuleEnum"/> to JSON.
                /// </summary>
        ...
        public class RetryPolicyEnum : IEnum
        {
            ...
            /// <summary>
            /// Compares two <see cref="RetryPolicyEnum"/> instances for equality.
            /// </summary>
            ...
            /// <summary>
            /// Compares two <see cref="RetryPolicyEnum"/> instances for inequality.
            /// </summary>
            public static bool operator !=(RetryPolicyEnum? left, RetryPolicyEnum? right) => !string.Equals(left?.Value, right?.Value, StringComparison.OrdinalIgnoreCase);

            /// <summary>
            /// Returns true if the given object is equal to this <see cref="RetryPolicyEnum"/> instance.
            /// </summary>
            ...
            /// <summary>
            /// Returns a hash code for this <see cref="RetryPolicyEnum"/> instance.
            /// </summary>
            public override int GetHashCode() => Value?.GetHashCode() ?? 0;

            /// <summary>
            /// Returns the string value of the <see cref="RetryPolicyEnum"/> instance.
            /// </summary>
            public override string ToString() => Value ?? string.Empty;
            ...
            {
                /// <summary>
                /// Deserializes a <see cref="RetryPolicyEnum"/> from JSON.
                /// </summary>
                ...
                /// <summary>
                /// Serializes a <see cref="RetryPolicyEnum"/> to JSON.
                /// </summary>
    ...
    public class TokenMandateJsonConverter : JsonConverter<TokenMandate>
    {
        ...
        public override TokenMandate Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (amountRule.IsSet)
                tokenMandate.AmountRule = amountRule.Value;
            if (billingAttemptsRule.IsSet)
                tokenMandate.BillingAttemptsRule = billingAttemptsRule.Value;
            if (billingDay.IsSet)
                tokenMandate.BillingDay = billingDay.Value;
            if (count.IsSet)
                tokenMandate.Count = count.Value;
            if (maskedAccountId.IsSet)
                tokenMandate.MaskedAccountId = maskedAccountId.Value;
            if (minAmount.IsSet)
                tokenMandate.MinAmount = minAmount.Value;
            if (recurringAmount.IsSet)
                tokenMandate.RecurringAmount = recurringAmount.Value;
            if (recurringStatement.IsSet)
                tokenMandate.RecurringStatement = recurringStatement.Value;
            if (remarks.IsSet)
                tokenMandate.Remarks = remarks.Value;
            if (retryPolicy.IsSet)
                tokenMandate.RetryPolicy = retryPolicy.Value;
            if (startsAt.IsSet)
                tokenMandate.StartsAt = startsAt.Value;
            return tokenMandate;
        }
