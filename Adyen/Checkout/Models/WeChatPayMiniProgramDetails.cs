...
namespace Adyen.Checkout.Models
{
    ...
    /// </summary>
    public partial class WeChatPayMiniProgramDetails : IValidatableObject
    {
        /// <summary>
        ...
        [JsonConstructor]
        public WeChatPayMiniProgramDetails(Option<string?> appId = default, Option<string?> checkoutAttemptId = default, Option<string?> openid = default, Option<string?> recurringDetailReference = default, Option<string?> storedPaymentMethodId = default, Option<TypeEnum?> type = default)
        {
            _AppIdOption = appId;
    ...
    public class WeChatPayMiniProgramDetailsJsonConverter : JsonConverter<WeChatPayMiniProgramDetails>
    {
        ...
        public override WeChatPayMiniProgramDetails Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (appId.IsSet && appId.Value == null)
                throw new ArgumentNullException(nameof(appId), "Property is not nullable for class WeChatPayMiniProgramDetails.");

            if (checkoutAttemptId.IsSet && checkoutAttemptId.Value == null)
                throw new ArgumentNullException(nameof(checkoutAttemptId), "Property is not nullable for class WeChatPayMiniProgramDetails.");

            if (openid.IsSet && openid.Value == null)
                throw new ArgumentNullException(nameof(openid), "Property is not nullable for class WeChatPayMiniProgramDetails.");

            if (recurringDetailReference.IsSet && recurringDetailReference.Value == null)
                throw new ArgumentNullException(nameof(recurringDetailReference), "Property is not nullable for class WeChatPayMiniProgramDetails.");

            if (storedPaymentMethodId.IsSet && storedPaymentMethodId.Value == null)
                throw new ArgumentNullException(nameof(storedPaymentMethodId), "Property is not nullable for class WeChatPayMiniProgramDetails.");

            if (type.IsSet && type.Value == null)
                throw new ArgumentNullException(nameof(type), "Property is not nullable for class WeChatPayMiniProgramDetails.");

            return new WeChatPayMiniProgramDetails(appId, checkoutAttemptId, openid, recurringDetailReference, storedPaymentMethodId, type);
        }
        ...
        {
            /*
            if (weChatPayMiniProgramDetails._AppIdOption.IsSet && weChatPayMiniProgramDetails.AppId == null)
                throw new ArgumentNullException(nameof(weChatPayMiniProgramDetails.AppId), "Property is required for class WeChatPayMiniProgramDetails.");

            if (weChatPayMiniProgramDetails._CheckoutAttemptIdOption.IsSet && weChatPayMiniProgramDetails.CheckoutAttemptId == null)
                throw new ArgumentNullException(nameof(weChatPayMiniProgramDetails.CheckoutAttemptId), "Property is required for class WeChatPayMiniProgramDetails.");

            if (weChatPayMiniProgramDetails._OpenidOption.IsSet && weChatPayMiniProgramDetails.Openid == null)
                throw new ArgumentNullException(nameof(weChatPayMiniProgramDetails.Openid), "Property is required for class WeChatPayMiniProgramDetails.");

            if (weChatPayMiniProgramDetails._RecurringDetailReferenceOption.IsSet && weChatPayMiniProgramDetails.RecurringDetailReference == null)
                throw new ArgumentNullException(nameof(weChatPayMiniProgramDetails.RecurringDetailReference), "Property is required for class WeChatPayMiniProgramDetails.");

            if (weChatPayMiniProgramDetails._StoredPaymentMethodIdOption.IsSet && weChatPayMiniProgramDetails.StoredPaymentMethodId == null)
                throw new ArgumentNullException(nameof(weChatPayMiniProgramDetails.StoredPaymentMethodId), "Property is required for class WeChatPayMiniProgramDetails.");
