    ...
    public class PaymentAmountUpdateRequestJsonConverter : JsonConverter<PaymentAmountUpdateRequest>
    {
        ...
        public override PaymentAmountUpdateRequest Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (enhancedSchemeData.IsSet && enhancedSchemeData.Value == null)
                throw new ArgumentNullException(nameof(enhancedSchemeData), "Property is not nullable for class PaymentAmountUpdateRequest.");
        ...
        public void WriteProperties(Utf8JsonWriter writer, PaymentAmountUpdateRequest paymentAmountUpdateRequest, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (paymentAmountUpdateRequest._ApplicationInfoOption.IsSet && paymentAmountUpdateRequest.ApplicationInfo == null)
            ...
            if (paymentAmountUpdateRequest._EnhancedSchemeDataOption.IsSet && paymentAmountUpdateRequest.EnhancedSchemeData == null)
                throw new ArgumentNullException(nameof(paymentAmountUpdateRequest.EnhancedSchemeData), "Property is required for class PaymentAmountUpdateRequest.");

            if (paymentAmountUpdateRequest._LineItemsOption.IsSet && paymentAmountUpdateRequest.LineItems == null)
            ...
            if (paymentAmountUpdateRequest._ReferenceOption.IsSet && paymentAmountUpdateRequest.Reference == null)
            ...
            if (paymentAmountUpdateRequest._SplitsOption.IsSet && paymentAmountUpdateRequest.Splits == null)
