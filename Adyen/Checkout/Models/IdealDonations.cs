...
namespace Adyen.Checkout.Models
{
    ...
    /// IdealDonations.
    /// </summary>
    public partial class IdealDonations
    {
        /// <summary>
        ...
        public IdealDonations(Option<string?> checkoutAttemptId = default, Option<string?> issuer = default, Option<string?> recurringDetailReference = default, Option<string?> sdkData = default, Option<string?> storedPaymentMethodId = default, Option<TypeEnum?> type = default)
        {
    ...
    public class IdealDonationsJsonConverter : JsonConverter<IdealDonations>
    {
        ...
        public override IdealDonations Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            return new IdealDonations(checkoutAttemptId, issuer, recurringDetailReference, sdkData, storedPaymentMethodId, type);
        }
