...
namespace Adyen.Checkout.Models
{
    ...
    public class IdealDonationsJsonConverter : JsonConverter<IdealDonations>
    {
        ...
        /// <returns><see cref="IdealDonations"/></returns>
        ...
        {
            /*
            if (idealDonations._CheckoutAttemptIdOption.IsSet && idealDonations.CheckoutAttemptId == null)
                throw new ArgumentNullException(nameof(idealDonations.CheckoutAttemptId), "Property is required for class IdealDonations.");

            if (idealDonations._IssuerOption.IsSet && idealDonations.Issuer == null)
                throw new ArgumentNullException(nameof(idealDonations.Issuer), "Property is required for class IdealDonations.");

            if (idealDonations._RecurringDetailReferenceOption.IsSet && idealDonations.RecurringDetailReference == null)
            ...
            if (idealDonations._StoredPaymentMethodIdOption.IsSet && idealDonations.StoredPaymentMethodId == null)
            ...
            */
            ...
            if (idealDonations._CheckoutAttemptIdOption.IsSet)
                writer.WriteString("checkoutAttemptId", idealDonations.CheckoutAttemptId);

            if (idealDonations._IssuerOption.IsSet)
                writer.WriteString("issuer", idealDonations.Issuer);

            if (idealDonations._RecurringDetailReferenceOption.IsSet)
                writer.WriteString("recurringDetailReference", idealDonations.RecurringDetailReference);

            if (idealDonations._StoredPaymentMethodIdOption.IsSet)
                writer.WriteString("storedPaymentMethodId", idealDonations.StoredPaymentMethodId);

            if (idealDonations._TypeOption.IsSet && idealDonations.Type != null) 
            {
                string? typeRawValue = IdealDonations.TypeEnum.ToJsonValue(idealDonations._TypeOption.Value!.Value);
