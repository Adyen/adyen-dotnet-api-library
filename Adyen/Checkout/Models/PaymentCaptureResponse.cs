...
namespace Adyen.Checkout.Models
{
    ...
    /// </summary>
    [JsonConverter(typeof(PaymentCaptureResponseJsonConverter))]
    public partial class PaymentCaptureResponse
    {
        /// <summary>
    ...
    public class PaymentCaptureResponseJsonConverter : JsonConverter<PaymentCaptureResponse>
    {
        ...
        public override PaymentCaptureResponse Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (platformChargebackLogic.IsSet)
                paymentCaptureResponse.PlatformChargebackLogic = platformChargebackLogic.Value;
            if (reference.IsSet)
                paymentCaptureResponse.Reference = reference.Value;
            if (splits.IsSet)
                paymentCaptureResponse.Splits = splits.Value;
            if (subMerchants.IsSet)
                paymentCaptureResponse.SubMerchants = subMerchants.Value;
