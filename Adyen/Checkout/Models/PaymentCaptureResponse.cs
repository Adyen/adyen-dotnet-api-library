...
namespace Adyen.Checkout.Models
{
    ...
    public class PaymentCaptureResponseJsonConverter : JsonConverter<PaymentCaptureResponse>
    {
        ...
        public void WriteProperties(Utf8JsonWriter writer, PaymentCaptureResponse paymentCaptureResponse, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (paymentCaptureResponse._LineItemsOption.IsSet && paymentCaptureResponse.LineItems == null)
            ...
            if (paymentCaptureResponse._PlatformChargebackLogicOption.IsSet && paymentCaptureResponse.PlatformChargebackLogic == null)
            ...
            if (paymentCaptureResponse._ReferenceOption.IsSet && paymentCaptureResponse.Reference == null)
            ...
            if (paymentCaptureResponse._SplitsOption.IsSet && paymentCaptureResponse.Splits == null)
            ...
            if (paymentCaptureResponse._SubMerchantsOption.IsSet && paymentCaptureResponse.SubMerchants == null)
