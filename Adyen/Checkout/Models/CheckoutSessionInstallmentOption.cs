...
namespace Adyen.Checkout.Models
{
    ...
    /// </summary>
    public partial class CheckoutSessionInstallmentOption : IValidatableObject
    {
        /// <summary>
        ...
        [JsonConstructor]
        public CheckoutSessionInstallmentOption(Option<List<CheckoutSessionInstallmentOption.PlansEnum>?> plans = default, Option<int?> preselectedValue = default, Option<List<int>?> values = default)
        {
            _PlansOption = plans;
    ...
    public class CheckoutSessionInstallmentOptionJsonConverter : JsonConverter<CheckoutSessionInstallmentOption>
    {
        ...
        public override CheckoutSessionInstallmentOption Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (plans.IsSet && plans.Value == null)
                throw new ArgumentNullException(nameof(plans), "Property is not nullable for class CheckoutSessionInstallmentOption.");

            if (preselectedValue.IsSet && preselectedValue.Value == null)
                throw new ArgumentNullException(nameof(preselectedValue), "Property is not nullable for class CheckoutSessionInstallmentOption.");

            if (values.IsSet && values.Value == null)
                throw new ArgumentNullException(nameof(values), "Property is not nullable for class CheckoutSessionInstallmentOption.");

            return new CheckoutSessionInstallmentOption(plans, preselectedValue, values);
        }
        ...
        {
            /*
            if (checkoutSessionInstallmentOption._PlansOption.IsSet && checkoutSessionInstallmentOption.Plans == null)
                throw new ArgumentNullException(nameof(checkoutSessionInstallmentOption.Plans), "Property is required for class CheckoutSessionInstallmentOption.");

            if (checkoutSessionInstallmentOption._ValuesOption.IsSet && checkoutSessionInstallmentOption.Values == null)
                throw new ArgumentNullException(nameof(checkoutSessionInstallmentOption.Values), "Property is required for class CheckoutSessionInstallmentOption.");
