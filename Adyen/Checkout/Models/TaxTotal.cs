...
namespace Adyen.Checkout.Models
{
    ...
    /// TaxTotal.
    /// </summary>
    public partial class TaxTotal : IValidatableObject
    {
        /// <summary>
    ...
    public class TaxTotalJsonConverter : JsonConverter<TaxTotal>
    {
        ...
        public override TaxTotal Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (amount.IsSet && amount.Value == null)
                throw new ArgumentNullException(nameof(amount), "Property is not nullable for class TaxTotal.");
        ...
        {
            /*
            if (taxTotal._AmountOption.IsSet && taxTotal.Amount == null)
                throw new ArgumentNullException(nameof(taxTotal.Amount), "Property is required for class TaxTotal.");
