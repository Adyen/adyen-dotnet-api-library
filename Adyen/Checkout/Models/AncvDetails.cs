...
namespace Adyen.Checkout.Models
{
    ...
    /// AncvDetails.
    /// </summary>
    public partial class AncvDetails
    {
        /// <summary>
        ...
        public AncvDetails(Option<string?> beneficiaryId = default, Option<string?> checkoutAttemptId = default, Option<string?> recurringDetailReference = default, Option<string?> sdkData = default, Option<string?> storedPaymentMethodId = default, Option<TypeEnum?> type = default)
        {
        ...
        /// <summary>
        /// This is used to track if an optional field is set. If set, <see cref="BeneficiaryId"/> will be populated.
        /// </summary>
        [JsonIgnore]
        [global::System.ComponentModel.EditorBrowsable(global::System.ComponentModel.EditorBrowsableState.Never)]
    ...
    public class AncvDetailsJsonConverter : JsonConverter<AncvDetails>
    {
        ...
        public override AncvDetails Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            return new AncvDetails(beneficiaryId, checkoutAttemptId, recurringDetailReference, sdkData, storedPaymentMethodId, type);
        }
