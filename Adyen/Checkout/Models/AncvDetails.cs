...
namespace Adyen.Checkout.Models
{
    ...
    /// AncvDetails.
    /// </summary>
    [JsonConverter(typeof(AncvDetailsJsonConverter))]
    ...
    public class AncvDetailsJsonConverter : JsonConverter<AncvDetails>
    {
        ...
        public override AncvDetails Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (checkoutAttemptId.IsSet)
                ancvDetails.CheckoutAttemptId = checkoutAttemptId.Value;
            if (recurringDetailReference.IsSet)
                ancvDetails.RecurringDetailReference = recurringDetailReference.Value;
            if (sdkData.IsSet)
                ancvDetails.SdkData = sdkData.Value;
            if (storedPaymentMethodId.IsSet)
                ancvDetails.StoredPaymentMethodId = storedPaymentMethodId.Value;
            if (type.IsSet)
                ancvDetails.Type = type.Value;
            return ancvDetails;
        }
