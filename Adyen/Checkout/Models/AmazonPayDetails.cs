...
namespace Adyen.Checkout.Models
{
    ...
    public partial class AmazonPayDetails : IValidatableObject
    {
        ...
        public AmazonPayDetails(Option<string?> amazonPayToken = default, Option<string?> checkoutAttemptId = default, Option<string?> checkoutSessionId = default, Option<TypeEnum?> type = default)
        {
            ...
            _CheckoutSessionIdOption = checkoutSessionId;
            _TypeOption = type;
            OnCreated();
        }
    ...
    public class AmazonPayDetailsJsonConverter : JsonConverter<AmazonPayDetails>
    {
        ...
        {
            /*
            if (amazonPayDetails._AmazonPayTokenOption.IsSet && amazonPayDetails.AmazonPayToken == null)
                throw new ArgumentNullException(nameof(amazonPayDetails.AmazonPayToken), "Property is required for class AmazonPayDetails.");

            if (amazonPayDetails._CheckoutAttemptIdOption.IsSet && amazonPayDetails.CheckoutAttemptId == null)
            ...
            if (amazonPayDetails._CheckoutSessionIdOption.IsSet && amazonPayDetails.CheckoutSessionId == null)
