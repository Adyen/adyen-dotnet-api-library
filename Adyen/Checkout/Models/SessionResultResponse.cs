...
namespace Adyen.Checkout.Models
{
    ...
    public class SessionResultResponseJsonConverter : JsonConverter<SessionResultResponse>
    {
        ...
        {
            /*
            if (sessionResultResponse._AdditionalDataOption.IsSet && sessionResultResponse.AdditionalData == null)
            ...
            if (sessionResultResponse._IdOption.IsSet && sessionResultResponse.Id == null)
                throw new ArgumentNullException(nameof(sessionResultResponse.Id), "Property is required for class SessionResultResponse.");

            if (sessionResultResponse._PaymentsOption.IsSet && sessionResultResponse.Payments == null)
            ...
            if (sessionResultResponse._ReferenceOption.IsSet && sessionResultResponse.Reference == null)
