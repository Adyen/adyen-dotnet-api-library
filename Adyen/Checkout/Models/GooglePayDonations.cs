...
namespace Adyen.Checkout.Models
{
    ...
    public class GooglePayDonationsJsonConverter : JsonConverter<GooglePayDonations>
    {
        ...
        /// <returns><see cref="GooglePayDonations"/></returns>
        ...
        public void WriteProperties(Utf8JsonWriter writer, GooglePayDonations googlePayDonations, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (googlePayDonations._CheckoutAttemptIdOption.IsSet && googlePayDonations.CheckoutAttemptId == null)
            ...
            if (googlePayDonations._GooglePayCardNetworkOption.IsSet && googlePayDonations.GooglePayCardNetwork == null)
            ...
            if (googlePayDonations._RecurringDetailReferenceOption.IsSet && googlePayDonations.RecurringDetailReference == null)
            ...
            if (googlePayDonations._StoredPaymentMethodIdOption.IsSet && googlePayDonations.StoredPaymentMethodId == null)
            ...
            if (googlePayDonations._ThreeDS2SdkVersionOption.IsSet && googlePayDonations.ThreeDS2SdkVersion == null)
            ...
            */
            ...
            if (googlePayDonations._CheckoutAttemptIdOption.IsSet)
                writer.WriteString("checkoutAttemptId", googlePayDonations.CheckoutAttemptId);

            if (googlePayDonations._FundingSourceOption.IsSet && googlePayDonations.FundingSource != null) 
            {
                string? fundingSourceRawValue = GooglePayDonations.FundingSourceEnum.ToJsonValue(googlePayDonations._FundingSourceOption.Value!.Value);
                writer.WriteString("fundingSource", fundingSourceRawValue);
            }
            
            if (googlePayDonations._GooglePayCardNetworkOption.IsSet)
                writer.WriteString("googlePayCardNetwork", googlePayDonations.GooglePayCardNetwork);

            if (googlePayDonations._RecurringDetailReferenceOption.IsSet)
                writer.WriteString("recurringDetailReference", googlePayDonations.RecurringDetailReference);

            if (googlePayDonations._StoredPaymentMethodIdOption.IsSet)
                writer.WriteString("storedPaymentMethodId", googlePayDonations.StoredPaymentMethodId);

            if (googlePayDonations._ThreeDS2SdkVersionOption.IsSet)
                writer.WriteString("threeDS2SdkVersion", googlePayDonations.ThreeDS2SdkVersion);

            if (googlePayDonations._TypeOption.IsSet && googlePayDonations.Type != null) 
            {
                string? typeRawValue = GooglePayDonations.TypeEnum.ToJsonValue(googlePayDonations._TypeOption.Value!.Value);
