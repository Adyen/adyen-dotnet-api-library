...
namespace Adyen.Checkout.Models
{
    ...
    /// GooglePayDonations.
    /// </summary>
    [JsonConverter(typeof(GooglePayDonationsJsonConverter))]
    ...
    public class GooglePayDonationsJsonConverter : JsonConverter<GooglePayDonations>
    {
        ...
        public override GooglePayDonations Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            var googlePayDonations = new GooglePayDonations();
            googlePayDonations.GooglePayToken = googlePayToken.Value!;
            if (checkoutAttemptId.IsSet)
                googlePayDonations.CheckoutAttemptId = checkoutAttemptId.Value;
            if (fundingSource.IsSet)
                googlePayDonations.FundingSource = fundingSource.Value;
            if (googlePayCardNetwork.IsSet)
                googlePayDonations.GooglePayCardNetwork = googlePayCardNetwork.Value;
            if (recurringDetailReference.IsSet)
                googlePayDonations.RecurringDetailReference = recurringDetailReference.Value;
            if (sdkData.IsSet)
                googlePayDonations.SdkData = sdkData.Value;
            if (storedPaymentMethodId.IsSet)
                googlePayDonations.StoredPaymentMethodId = storedPaymentMethodId.Value;
            if (threeDS2SdkVersion.IsSet)
                googlePayDonations.ThreeDS2SdkVersion = threeDS2SdkVersion.Value;
            if (type.IsSet)
                googlePayDonations.Type = type.Value;
            return googlePayDonations;
        }
        ...
        public void WriteProperties(Utf8JsonWriter writer, GooglePayDonations googlePayDonations, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (googlePayDonations._CheckoutAttemptIdOption.IsSet)
                if (googlePayDonations.CheckoutAttemptId != null)
            ...
            if (googlePayDonations._GooglePayCardNetworkOption.IsSet)
                if (googlePayDonations.GooglePayCardNetwork != null)
            ...
            if (googlePayDonations._RecurringDetailReferenceOption.IsSet)
                if (googlePayDonations.RecurringDetailReference != null)
                    writer.WriteString("recurringDetailReference", googlePayDonations.RecurringDetailReference);

            if (googlePayDonations._SdkDataOption.IsSet)
                if (googlePayDonations.SdkData != null)
                    writer.WriteString("sdkData", googlePayDonations.SdkData);

            if (googlePayDonations._StoredPaymentMethodIdOption.IsSet)
                if (googlePayDonations.StoredPaymentMethodId != null)
            ...
            if (googlePayDonations._ThreeDS2SdkVersionOption.IsSet)
                if (googlePayDonations.ThreeDS2SdkVersion != null)
