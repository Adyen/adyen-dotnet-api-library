...
namespace Adyen.Checkout.Models
{
    ...
    public class ShopperInteractionDeviceJsonConverter : JsonConverter<ShopperInteractionDevice>
    {
        ...
        {
            /*
            if (shopperInteractionDevice._LocaleOption.IsSet && shopperInteractionDevice.Locale == null)
            ...
            if (shopperInteractionDevice._OsOption.IsSet && shopperInteractionDevice.Os == null)
            ...
            if (shopperInteractionDevice._OsVersionOption.IsSet && shopperInteractionDevice.OsVersion == null)
