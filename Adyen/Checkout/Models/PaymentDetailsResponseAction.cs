...
namespace Adyen.Checkout.Models
{
    ...
    /// </summary>
    public partial class PaymentDetailsResponseAction : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PaymentDetailsResponseAction" /> class.
        /// </summary>
        /// <param name="checkoutThreeDS2Action"></param>
        public PaymentDetailsResponseAction(CheckoutThreeDS2Action checkoutThreeDS2Action)
        {
    ...
    /// <summary>
    /// A Json converter for type <see cref="PaymentDetailsResponseAction" />
    /// </summary>
    public class PaymentDetailsResponseActionJsonConverter : JsonConverter<PaymentDetailsResponseAction>
    {
        /// <summary>
        /// Deserializes json to <see cref="PaymentDetailsResponseAction"/>.
        /// </summary>
        /// <param name="utf8JsonReader"><see cref="Utf8JsonReader"/>.</param>
        /// <param name="typeToConvert"><see cref="Type"/>.</param>
        /// <param name="jsonSerializerOptions">The <see cref="JsonSerializerOptions"/>, initialized from <see cref="HostConfiguration"/>.</param>
        /// <returns><see cref="PaymentDetailsResponseAction"/>.</returns>
        /// <exception cref="JsonException"></exception>
        public override PaymentDetailsResponseAction Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (checkoutThreeDS2Action?.Type != null)
                return new PaymentDetailsResponseAction(checkoutThreeDS2Action);

            throw new JsonException();
        }

        /// <summary>
        /// Serializes a <see cref="PaymentDetailsResponseAction"/>.
        /// </summary>
        /// <param name="writer"><see cref="Utf8JsonWriter"/></param>
        /// <param name="paymentDetailsResponseAction"></param>
        /// <param name="jsonSerializerOptions"><see cref="JsonSerializerOptions"/></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, PaymentDetailsResponseAction paymentDetailsResponseAction, JsonSerializerOptions jsonSerializerOptions)
        {
            if (paymentDetailsResponseAction.CheckoutThreeDS2Action != null)
                JsonSerializer.Serialize(writer, paymentDetailsResponseAction.CheckoutThreeDS2Action, jsonSerializerOptions);
            /* 
            writer.WriteStartObject();
             */
            WriteProperties(writer, paymentDetailsResponseAction, jsonSerializerOptions);
            /* 
        ...
        /// <summary>
        /// Serializes the properties of <see cref="PaymentDetailsResponseAction"/>.
        /// </summary>
        /// <param name="writer"><see creft="Utf8JsonWriter"/></param>
        /// <param name="paymentDetailsResponseAction"></param>
        /// <param name="jsonSerializerOptions"><see cref="JsonSerializerOptions"/></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, PaymentDetailsResponseAction paymentDetailsResponseAction, JsonSerializerOptions jsonSerializerOptions)
        {
