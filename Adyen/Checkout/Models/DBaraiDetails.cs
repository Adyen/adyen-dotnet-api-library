...
namespace Adyen.Checkout.Models
{
    ...
    /// DBaraiDetails.
    /// </summary>
    [JsonConverter(typeof(DBaraiDetailsJsonConverter))]
    public partial class DBaraiDetails
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DBaraiDetails" /> class.
        /// </summary>
        public DBaraiDetails()
        {
            _TypeOption = TypeEnum.Dbarai;
            OnCreated();
        }
    ...
    /// <summary>
    /// A Json converter for type <see cref="DBaraiDetails" />
    /// </summary>
    public class DBaraiDetailsJsonConverter : JsonConverter<DBaraiDetails>
    {
        /// <summary>
        /// Deserializes json to <see cref="DBaraiDetails"/>.
        /// </summary>
        /// <param name="utf8JsonReader"><see cref="Utf8JsonReader"/>.</param>
        /// <param name="typeToConvert"><see cref="Type"/>.</param>
        /// <param name="jsonSerializerOptions">The <see cref="JsonSerializerOptions"/>, initialized from <see cref="HostConfiguration"/>.</param>
        /// <returns><see cref="DBaraiDetails"/>.</returns>
        /// <exception cref="JsonException"></exception>
        public override DBaraiDetails Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            Option<DBaraiDetails.TypeEnum?> type = default;
                ...
                if (utf8JsonReader.TokenType == JsonTokenType.PropertyName && currentDepth == utf8JsonReader.CurrentDepth - 1)
                {
                    ...
                    switch (jsonPropertyName)
                    {
                        ...
                        case "type":
                            ...
                            type = new Option<DBaraiDetails.TypeEnum?>(DBaraiDetails.TypeEnum.FromStringOrDefault(typeRawValue) ?? (DBaraiDetails.TypeEnum)typeRawValue);
                            break;
                        default:
                            break;
                    }
            ...
            var dBaraiDetails = new DBaraiDetails();
            if (checkoutAttemptId.IsSet)
                dBaraiDetails.CheckoutAttemptId = checkoutAttemptId.Value;
            if (recurringDetailReference.IsSet)
                dBaraiDetails.RecurringDetailReference = recurringDetailReference.Value;
            if (sdkData.IsSet)
                dBaraiDetails.SdkData = sdkData.Value;
            if (storedPaymentMethodId.IsSet)
                dBaraiDetails.StoredPaymentMethodId = storedPaymentMethodId.Value;
            if (type.IsSet)
                dBaraiDetails.Type = type.Value;
            return dBaraiDetails;
        }

        /// <summary>
        /// Serializes a <see cref="DBaraiDetails"/>.
        /// </summary>
        /// <param name="writer"><see cref="Utf8JsonWriter"/></param>
        /// <param name="dBaraiDetails"></param>
        /// <param name="jsonSerializerOptions"><see cref="JsonSerializerOptions"/></param>
        public override void Write(Utf8JsonWriter writer, DBaraiDetails dBaraiDetails, JsonSerializerOptions jsonSerializerOptions)
        {
            
            writer.WriteStartObject();
            
            WriteProperties(writer, dBaraiDetails, jsonSerializerOptions);
        ...
        /// <summary>
        /// Serializes the properties of <see cref="DBaraiDetails"/>.
        /// </summary>
        /// <param name="writer"><see cref="Utf8JsonWriter"/></param>
        /// <param name="dBaraiDetails"></param>
        /// <param name="jsonSerializerOptions"><see cref="JsonSerializerOptions"/></param>
        public void WriteProperties(Utf8JsonWriter writer, DBaraiDetails dBaraiDetails, JsonSerializerOptions jsonSerializerOptions)
        {
            
            if (dBaraiDetails._CheckoutAttemptIdOption.IsSet)
                if (dBaraiDetails.CheckoutAttemptId != null)
                    writer.WriteString("checkoutAttemptId", dBaraiDetails.CheckoutAttemptId);

            if (dBaraiDetails._RecurringDetailReferenceOption.IsSet)
                if (dBaraiDetails.RecurringDetailReference != null)
                    writer.WriteString("recurringDetailReference", dBaraiDetails.RecurringDetailReference);

            if (dBaraiDetails._SdkDataOption.IsSet)
                if (dBaraiDetails.SdkData != null)
                    writer.WriteString("sdkData", dBaraiDetails.SdkData);

            if (dBaraiDetails._StoredPaymentMethodIdOption.IsSet)
                if (dBaraiDetails.StoredPaymentMethodId != null)
                    writer.WriteString("storedPaymentMethodId", dBaraiDetails.StoredPaymentMethodId);

            if (dBaraiDetails._TypeOption.IsSet && dBaraiDetails.Type != null) 
            {
                string? typeRawValue = DBaraiDetails.TypeEnum.ToJsonValue(dBaraiDetails._TypeOption.Value!.Value);
