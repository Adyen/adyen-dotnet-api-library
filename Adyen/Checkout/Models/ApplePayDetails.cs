...
namespace Adyen.Checkout.Models
{
    ...
    public partial class ApplePayDetails
    {
        ...
        public ApplePayDetails(string applePayToken, Option<string?> checkoutAttemptId = default, Option<FundingSourceEnum?> fundingSource = default, Option<string?> recurringDetailReference = default, Option<string?> sdkData = default, Option<string?> storedPaymentMethodId = default, Option<TypeEnum?> type = default)
        {
