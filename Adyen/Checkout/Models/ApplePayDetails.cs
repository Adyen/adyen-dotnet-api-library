...
namespace Adyen.Checkout.Models
{
    ...
    /// ApplePayDetails.
    /// </summary>
    [JsonConverter(typeof(ApplePayDetailsJsonConverter))]
    public partial class ApplePayDetails
    {
        /// <summary>
    ...
    public class ApplePayDetailsJsonConverter : JsonConverter<ApplePayDetails>
    {
        ...
        public override ApplePayDetails Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
                ...
                if (utf8JsonReader.TokenType == JsonTokenType.PropertyName && currentDepth == utf8JsonReader.CurrentDepth - 1)
                {
                    ...
                    switch (jsonPropertyName)
                    {
                        ...
                        case "fundingSource":
                            ...
                            fundingSource = new Option<ApplePayDetails.FundingSourceEnum?>(ApplePayDetails.FundingSourceEnum.FromStringOrDefault(fundingSourceRawValue) ?? (ApplePayDetails.FundingSourceEnum)fundingSourceRawValue);
                            break;
                        ...
                        case "type":
                            ...
                            type = new Option<ApplePayDetails.TypeEnum?>(ApplePayDetails.TypeEnum.FromStringOrDefault(typeRawValue) ?? (ApplePayDetails.TypeEnum)typeRawValue);
                            break;
                        default:
                            break;
                    }
            ...
            var applePayDetails = new ApplePayDetails();
            applePayDetails.ApplePayToken = applePayToken.Value!;
            if (checkoutAttemptId.IsSet)
                applePayDetails.CheckoutAttemptId = checkoutAttemptId.Value;
            if (fundingSource.IsSet)
                applePayDetails.FundingSource = fundingSource.Value;
            if (recurringDetailReference.IsSet)
                applePayDetails.RecurringDetailReference = recurringDetailReference.Value;
            if (sdkData.IsSet)
                applePayDetails.SdkData = sdkData.Value;
            if (storedPaymentMethodId.IsSet)
                applePayDetails.StoredPaymentMethodId = storedPaymentMethodId.Value;
            if (type.IsSet)
                applePayDetails.Type = type.Value;
        ...
        public void WriteProperties(Utf8JsonWriter writer, ApplePayDetails applePayDetails, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (applePayDetails._CheckoutAttemptIdOption.IsSet)
                if (applePayDetails.CheckoutAttemptId != null)
            ...
            if (applePayDetails._RecurringDetailReferenceOption.IsSet)
                if (applePayDetails.RecurringDetailReference != null)
                    writer.WriteString("recurringDetailReference", applePayDetails.RecurringDetailReference);

            if (applePayDetails._SdkDataOption.IsSet)
                if (applePayDetails.SdkData != null)
                    writer.WriteString("sdkData", applePayDetails.SdkData);

            if (applePayDetails._StoredPaymentMethodIdOption.IsSet)
                if (applePayDetails.StoredPaymentMethodId != null)
