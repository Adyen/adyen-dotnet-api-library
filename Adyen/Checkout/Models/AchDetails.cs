...
namespace Adyen.Checkout.Models
{
    ...
    /// AchDetails.
    /// </summary>
    [JsonConverter(typeof(AchDetailsJsonConverter))]
    public partial class AchDetails
    {
        ...
        public class AccountHolderTypeEnum : IEnum
        {
            ...
            /// <summary>
            /// Compares two <see cref="AccountHolderTypeEnum"/> instances for equality.
            /// </summary>
            ...
            /// <summary>
            /// Compares two <see cref="AccountHolderTypeEnum"/> instances for inequality.
            /// </summary>
            public static bool operator !=(AccountHolderTypeEnum? left, AccountHolderTypeEnum? right) => !string.Equals(left?.Value, right?.Value, StringComparison.OrdinalIgnoreCase);

            /// <summary>
            /// Returns true if the given object is equal to this <see cref="AccountHolderTypeEnum"/> instance.
            /// </summary>
            ...
            /// <summary>
            /// Returns a hash code for this <see cref="AccountHolderTypeEnum"/> instance.
            /// </summary>
            public override int GetHashCode() => Value?.GetHashCode() ?? 0;

            /// <summary>
            /// Returns the string value of the <see cref="AccountHolderTypeEnum"/> instance.
            /// </summary>
            ...
            {
                /// <summary>
                /// Deserializes a <see cref="AccountHolderTypeEnum"/> from JSON.
                /// </summary>
                ...
                /// <summary>
                /// Serializes a <see cref="AccountHolderTypeEnum"/> to JSON.
                /// </summary>
        ...
        public class BankAccountTypeEnum : IEnum
        {
            ...
            /// <summary>
            /// Compares two <see cref="BankAccountTypeEnum"/> instances for equality.
            /// </summary>
            ...
            /// <summary>
            /// Compares two <see cref="BankAccountTypeEnum"/> instances for inequality.
            /// </summary>
            public static bool operator !=(BankAccountTypeEnum? left, BankAccountTypeEnum? right) => !string.Equals(left?.Value, right?.Value, StringComparison.OrdinalIgnoreCase);

            /// <summary>
            /// Returns true if the given object is equal to this <see cref="BankAccountTypeEnum"/> instance.
            /// </summary>
            ...
            /// <summary>
            /// Returns a hash code for this <see cref="BankAccountTypeEnum"/> instance.
            /// </summary>
            public override int GetHashCode() => Value?.GetHashCode() ?? 0;

            /// <summary>
            /// Returns the string value of the <see cref="BankAccountTypeEnum"/> instance.
            /// </summary>
            public override string ToString() => Value ?? string.Empty;
            ...
            {
                /// <summary>
                /// Deserializes a <see cref="BankAccountTypeEnum"/> from JSON.
                /// </summary>
                ...
                /// <summary>
                /// Serializes a <see cref="BankAccountTypeEnum"/> to JSON.
                /// </summary>
    ...
    public class AchDetailsJsonConverter : JsonConverter<AchDetails>
    {
        ...
        public override AchDetails Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (bankAccountNumber.IsSet)
                achDetails.BankAccountNumber = bankAccountNumber.Value;
            if (bankAccountType.IsSet)
                achDetails.BankAccountType = bankAccountType.Value;
            if (bankLocationId.IsSet)
                achDetails.BankLocationId = bankLocationId.Value;
            if (checkoutAttemptId.IsSet)
                achDetails.CheckoutAttemptId = checkoutAttemptId.Value;
            if (encryptedBankAccountNumber.IsSet)
                achDetails.EncryptedBankAccountNumber = encryptedBankAccountNumber.Value;
            if (encryptedBankLocationId.IsSet)
                achDetails.EncryptedBankLocationId = encryptedBankLocationId.Value;
            if (ownerName.IsSet)
                achDetails.OwnerName = ownerName.Value;
            if (recurringDetailReference.IsSet)
                achDetails.RecurringDetailReference = recurringDetailReference.Value;
            if (sdkData.IsSet)
                achDetails.SdkData = sdkData.Value;
            if (storedPaymentMethodId.IsSet)
                achDetails.StoredPaymentMethodId = storedPaymentMethodId.Value;
            if (transferInstrumentId.IsSet)
                achDetails.TransferInstrumentId = transferInstrumentId.Value;
            if (type.IsSet)
                achDetails.Type = type.Value;
            return achDetails;
        }
