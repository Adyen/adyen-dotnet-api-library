...
namespace Adyen.Checkout.Models
{
    ...
    public class ExternalPlatformJsonConverter : JsonConverter<ExternalPlatform>
    {
        ...
        public override ExternalPlatform Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (integrator.IsSet && integrator.Value == null)
                throw new ArgumentNullException(nameof(integrator), "Property is not nullable for class ExternalPlatform.");

            if (name.IsSet && name.Value == null)
                throw new ArgumentNullException(nameof(name), "Property is not nullable for class ExternalPlatform.");

            if (version.IsSet && version.Value == null)
                throw new ArgumentNullException(nameof(version), "Property is not nullable for class ExternalPlatform.");
        ...
        {
            /*
            if (externalPlatform._IntegratorOption.IsSet && externalPlatform.Integrator == null)
                throw new ArgumentNullException(nameof(externalPlatform.Integrator), "Property is required for class ExternalPlatform.");

            if (externalPlatform._NameOption.IsSet && externalPlatform.Name == null)
                throw new ArgumentNullException(nameof(externalPlatform.Name), "Property is required for class ExternalPlatform.");

            if (externalPlatform._VersionOption.IsSet && externalPlatform.Version == null)
                throw new ArgumentNullException(nameof(externalPlatform.Version), "Property is required for class ExternalPlatform.");
