...
namespace Adyen.Checkout.Models
{
    ...
    /// GooglePayDetails.
    /// </summary>
    [JsonConverter(typeof(GooglePayDetailsJsonConverter))]
    public partial class GooglePayDetails
    {
        ...
        {
            _TypeOption = TypeEnum.Googlepay;
            OnCreated();
        }
        ...
        /// <summary>
        /// This is used to track if an optional field is set. If set, <see cref="GooglePayCardNetwork"/> will be populated.
        /// </summary>
        [JsonIgnore]
        [global::System.ComponentModel.EditorBrowsable(global::System.ComponentModel.EditorBrowsableState.Never)]
    ...
    public class GooglePayDetailsJsonConverter : JsonConverter<GooglePayDetails>
    {
        ...
        public override GooglePayDetails Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
                ...
                if (utf8JsonReader.TokenType == JsonTokenType.PropertyName && currentDepth == utf8JsonReader.CurrentDepth - 1)
                {
                    ...
                    switch (jsonPropertyName)
                    {
                        ...
                        case "fundingSource":
                            ...
                            fundingSource = new Option<GooglePayDetails.FundingSourceEnum?>(GooglePayDetails.FundingSourceEnum.FromStringOrDefault(fundingSourceRawValue) ?? (GooglePayDetails.FundingSourceEnum)fundingSourceRawValue);
                            break;
                        ...
                        case "type":
                            ...
                            type = new Option<GooglePayDetails.TypeEnum?>(GooglePayDetails.TypeEnum.FromStringOrDefault(typeRawValue) ?? (GooglePayDetails.TypeEnum)typeRawValue);
                            break;
                        default:
                            break;
                    }
            ...
            var googlePayDetails = new GooglePayDetails();
            googlePayDetails.GooglePayToken = googlePayToken.Value!;
            if (checkoutAttemptId.IsSet)
                googlePayDetails.CheckoutAttemptId = checkoutAttemptId.Value;
            if (fundingSource.IsSet)
                googlePayDetails.FundingSource = fundingSource.Value;
            if (googlePayCardNetwork.IsSet)
                googlePayDetails.GooglePayCardNetwork = googlePayCardNetwork.Value;
            if (recurringDetailReference.IsSet)
                googlePayDetails.RecurringDetailReference = recurringDetailReference.Value;
            if (sdkData.IsSet)
                googlePayDetails.SdkData = sdkData.Value;
            if (storedPaymentMethodId.IsSet)
                googlePayDetails.StoredPaymentMethodId = storedPaymentMethodId.Value;
            if (threeDS2SdkVersion.IsSet)
                googlePayDetails.ThreeDS2SdkVersion = threeDS2SdkVersion.Value;
            if (type.IsSet)
                googlePayDetails.Type = type.Value;
        ...
        public void WriteProperties(Utf8JsonWriter writer, GooglePayDetails googlePayDetails, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (googlePayDetails._CheckoutAttemptIdOption.IsSet)
                if (googlePayDetails.CheckoutAttemptId != null)
            ...
            if (googlePayDetails._GooglePayCardNetworkOption.IsSet)
                if (googlePayDetails.GooglePayCardNetwork != null)
            ...
            if (googlePayDetails._RecurringDetailReferenceOption.IsSet)
                if (googlePayDetails.RecurringDetailReference != null)
                    writer.WriteString("recurringDetailReference", googlePayDetails.RecurringDetailReference);

            if (googlePayDetails._SdkDataOption.IsSet)
                if (googlePayDetails.SdkData != null)
                    writer.WriteString("sdkData", googlePayDetails.SdkData);

            if (googlePayDetails._StoredPaymentMethodIdOption.IsSet)
                if (googlePayDetails.StoredPaymentMethodId != null)
            ...
            if (googlePayDetails._ThreeDS2SdkVersionOption.IsSet)
                if (googlePayDetails.ThreeDS2SdkVersion != null)
