...
namespace Adyen.Checkout.Models
{
    ...
    public partial class GooglePayDetails
    {
        ...
        public GooglePayDetails(string googlePayToken, Option<string?> checkoutAttemptId = default, Option<FundingSourceEnum?> fundingSource = default, Option<string?> googlePayCardNetwork = default, Option<string?> recurringDetailReference = default, Option<string?> sdkData = default, Option<string?> storedPaymentMethodId = default, Option<string?> threeDS2SdkVersion = default, Option<TypeEnum?> type = default)
        {
            ...
            _TypeOption = type.IsSet ? type : TypeEnum.Googlepay;
            OnCreated();
        }
    ...
    public class GooglePayDetailsJsonConverter : JsonConverter<GooglePayDetails>
    {
        ...
        public override GooglePayDetails Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            return new GooglePayDetails(googlePayToken.Value!, checkoutAttemptId, fundingSource, googlePayCardNetwork, recurringDetailReference, sdkData, storedPaymentMethodId, threeDS2SdkVersion, type);
        }
