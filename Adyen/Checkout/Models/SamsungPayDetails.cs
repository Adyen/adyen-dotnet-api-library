...
namespace Adyen.Checkout.Models
{
    ...
    /// SamsungPayDetails.
    /// </summary>
    public partial class SamsungPayDetails
    {
        /// <summary>
        ...
        public SamsungPayDetails(string samsungPayToken, Option<string?> checkoutAttemptId = default, Option<FundingSourceEnum?> fundingSource = default, Option<string?> recurringDetailReference = default, Option<string?> sdkData = default, Option<string?> storedPaymentMethodId = default, Option<TypeEnum?> type = default)
        {
            ...
            _TypeOption = type.IsSet ? type : TypeEnum.Samsungpay;
            OnCreated();
        }
    ...
    public class SamsungPayDetailsJsonConverter : JsonConverter<SamsungPayDetails>
    {
        ...
        public void WriteProperties(Utf8JsonWriter writer, SamsungPayDetails samsungPayDetails, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (samsungPayDetails._CheckoutAttemptIdOption.IsSet)
                if (samsungPayDetails.CheckoutAttemptId != null)
            ...
            if (samsungPayDetails._RecurringDetailReferenceOption.IsSet)
                if (samsungPayDetails.RecurringDetailReference != null)
                    writer.WriteString("recurringDetailReference", samsungPayDetails.RecurringDetailReference);

            if (samsungPayDetails._SdkDataOption.IsSet)
                if (samsungPayDetails.SdkData != null)
                    writer.WriteString("sdkData", samsungPayDetails.SdkData);

            if (samsungPayDetails._StoredPaymentMethodIdOption.IsSet)
                if (samsungPayDetails.StoredPaymentMethodId != null)
