...
namespace Adyen.Checkout.Models
{
    ...
    /// SamsungPayDetails.
    /// </summary>
    [JsonConverter(typeof(SamsungPayDetailsJsonConverter))]
    public partial class SamsungPayDetails
    {
        ...
        {
            _TypeOption = TypeEnum.Samsungpay;
            OnCreated();
        }
    ...
    public class SamsungPayDetailsJsonConverter : JsonConverter<SamsungPayDetails>
    {
        ...
        public override SamsungPayDetails Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (fundingSource.IsSet)
                samsungPayDetails.FundingSource = fundingSource.Value;
            if (recurringDetailReference.IsSet)
                samsungPayDetails.RecurringDetailReference = recurringDetailReference.Value;
            if (sdkData.IsSet)
                samsungPayDetails.SdkData = sdkData.Value;
            if (storedPaymentMethodId.IsSet)
                samsungPayDetails.StoredPaymentMethodId = storedPaymentMethodId.Value;
            if (type.IsSet)
                samsungPayDetails.Type = type.Value;
            return samsungPayDetails;
        }
