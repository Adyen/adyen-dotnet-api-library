...
namespace Adyen.Checkout.Models
{
    ...
    public class SamsungPayDetailsJsonConverter : JsonConverter<SamsungPayDetails>
    {
        ...
        /// <returns><see cref="SamsungPayDetails"/></returns>
        ...
        public void WriteProperties(Utf8JsonWriter writer, SamsungPayDetails samsungPayDetails, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (samsungPayDetails._CheckoutAttemptIdOption.IsSet && samsungPayDetails.CheckoutAttemptId == null)
            ...
            if (samsungPayDetails._RecurringDetailReferenceOption.IsSet && samsungPayDetails.RecurringDetailReference == null)
            ...
            if (samsungPayDetails._StoredPaymentMethodIdOption.IsSet && samsungPayDetails.StoredPaymentMethodId == null)
            ...
            */
            ...
            if (samsungPayDetails._CheckoutAttemptIdOption.IsSet)
                writer.WriteString("checkoutAttemptId", samsungPayDetails.CheckoutAttemptId);

            if (samsungPayDetails._FundingSourceOption.IsSet && samsungPayDetails.FundingSource != null) 
            {
                string? fundingSourceRawValue = SamsungPayDetails.FundingSourceEnum.ToJsonValue(samsungPayDetails._FundingSourceOption.Value!.Value);
                writer.WriteString("fundingSource", fundingSourceRawValue);
            }
            
            if (samsungPayDetails._RecurringDetailReferenceOption.IsSet)
                writer.WriteString("recurringDetailReference", samsungPayDetails.RecurringDetailReference);

            if (samsungPayDetails._StoredPaymentMethodIdOption.IsSet)
                writer.WriteString("storedPaymentMethodId", samsungPayDetails.StoredPaymentMethodId);

            if (samsungPayDetails._TypeOption.IsSet && samsungPayDetails.Type != null) 
            {
                string? typeRawValue = SamsungPayDetails.TypeEnum.ToJsonValue(samsungPayDetails._TypeOption.Value!.Value);
