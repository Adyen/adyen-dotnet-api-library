...
namespace Adyen.Checkout.Models
{
    ...
    public partial class PaymentValidationsNameResponse
    {
        ...
        /// </summary>
        /// <param name="rawResponse">Contains the raw response(s) returned by the scheme for the name validation.</param>
        /// <param name="result">Contains the scheme-agnostic match values returned by Adyen.</param>
        ...
        /// </summary>
        /// <value>Contains the raw response(s) returned by the scheme for the name validation.</value>
        ...
        /// </summary>
        /// <value>Contains the scheme-agnostic match values returned by Adyen.</value>
