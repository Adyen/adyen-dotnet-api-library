...
namespace Adyen.Checkout.Models
{
    ...
    /// </summary>
    public partial class PaymentValidationsNameResponse : IValidatableObject
    {
        /// <summary>
        ...
        public class StatusEnum: IEnum
        {
            ...
            /// <summary>
            /// StatusEnum.NotPerformed - notPerformed
            /// </summary>
            public static readonly StatusEnum NotPerformed = new("notPerformed");

            /// <summary>
            /// StatusEnum.NotSupported - notSupported
            /// </summary>
            public static readonly StatusEnum NotSupported = new("notSupported");
            ...
            {
                return value switch {
                    "notPerformed" => StatusEnum.NotPerformed,
                    "notSupported" => StatusEnum.NotSupported,
                    "performed" => StatusEnum.Performed,
                    _ => null,
                };
            }
    ...
    /// <summary>
    /// A Json converter for type <see cref="PaymentValidationsNameResponse" />
    /// </summary>
    public class PaymentValidationsNameResponseJsonConverter : JsonConverter<PaymentValidationsNameResponse>
    {
        /// <summary>
        /// Deserializes json to <see cref="PaymentValidationsNameResponse"/>.
        /// </summary>
        /// <param name="utf8JsonReader"><see cref="Utf8JsonReader"/></param>
        /// <param name="typeToConvert"><see cref="Type"/></param>
        /// <param name="jsonSerializerOptions">The <see cref="JsonSerializerOptions"/>, initialized from <see cref="HostConfiguration"/>.</param>
        /// <returns><see cref="PaymentValidationsNameResponse"/></returns>
        /// <exception cref="JsonException"></exception>
        public override PaymentValidationsNameResponse Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            Option<PaymentValidationsNameResultRawResponse?> rawResponse = default;
            Option<PaymentValidationsNameResultResponse?> result = default;
            Option<PaymentValidationsNameResponse.StatusEnum?> status = default;
            ...
            while (utf8JsonReader.Read())
            {
                ...
                if (utf8JsonReader.TokenType == JsonTokenType.PropertyName && currentDepth == utf8JsonReader.CurrentDepth - 1)
                {
                    ...
                    {
                        case "rawResponse":
                            rawResponse = new Option<PaymentValidationsNameResultRawResponse?>(JsonSerializer.Deserialize<PaymentValidationsNameResultRawResponse>(ref utf8JsonReader, jsonSerializerOptions)!);
                            break;
                        case "result":
                            result = new Option<PaymentValidationsNameResultResponse?>(JsonSerializer.Deserialize<PaymentValidationsNameResultResponse>(ref utf8JsonReader, jsonSerializerOptions)!);
                            break;
                        case "status":
            ...
            if (rawResponse.IsSet && rawResponse.Value == null)
                throw new ArgumentNullException(nameof(rawResponse), "Property is not nullable for class PaymentValidationsNameResponse.");

            if (result.IsSet && result.Value == null)
                throw new ArgumentNullException(nameof(result), "Property is not nullable for class PaymentValidationsNameResponse.");

            if (status.IsSet && status.Value == null)
                throw new ArgumentNullException(nameof(status), "Property is not nullable for class PaymentValidationsNameResponse.");

            return new PaymentValidationsNameResponse(rawResponse, result, status);
        }

        /// <summary>
        /// Serializes a <see cref="PaymentValidationsNameResponse"/>.
        /// </summary>
        /// <param name="writer"><see cref="Utf8JsonWriter"/></param>
        /// <param name="paymentValidationsNameResponse"></param>
        ...
        /// <summary>
        /// Serializes the properties of <see cref="PaymentValidationsNameResponse"/>.
        /// </summary>
        ...
        {
            /*
            if (paymentValidationsNameResponse._RawResponseOption.IsSet && paymentValidationsNameResponse.RawResponse == null)
                throw new ArgumentNullException(nameof(paymentValidationsNameResponse.RawResponse), "Property is required for class PaymentValidationsNameResponse.");

            if (paymentValidationsNameResponse._ResultOption.IsSet && paymentValidationsNameResponse.Result == null)
                throw new ArgumentNullException(nameof(paymentValidationsNameResponse.Result), "Property is required for class PaymentValidationsNameResponse.");
            ...
            */
            ...
            if (paymentValidationsNameResponse._RawResponseOption.IsSet)
            {
                ...
                JsonSerializer.Serialize(writer, paymentValidationsNameResponse.RawResponse, jsonSerializerOptions);
            }
            if (paymentValidationsNameResponse._ResultOption.IsSet)
            {
