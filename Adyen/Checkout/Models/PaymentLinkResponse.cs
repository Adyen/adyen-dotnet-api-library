...
namespace Adyen.Checkout.Models
{
    ...
    /// PaymentLinkResponse.
    /// </summary>
    [JsonConverter(typeof(PaymentLinkResponseJsonConverter))]
    public partial class PaymentLinkResponse
    {
        ...
        public class RequiredShopperFieldsEnum : IEnum
        {
            ...
            /// <summary>
            /// Compares two <see cref="RequiredShopperFieldsEnum"/> instances for equality.
            /// </summary>
            ...
            /// <summary>
            /// Compares two <see cref="RequiredShopperFieldsEnum"/> instances for inequality.
            /// </summary>
            public static bool operator !=(RequiredShopperFieldsEnum? left, RequiredShopperFieldsEnum? right) => !string.Equals(left?.Value, right?.Value, StringComparison.OrdinalIgnoreCase);

            /// <summary>
            /// Returns true if the given object is equal to this <see cref="RequiredShopperFieldsEnum"/> instance.
            /// </summary>
            ...
            /// <summary>
            /// Returns a hash code for this <see cref="RequiredShopperFieldsEnum"/> instance.
            /// </summary>
            public override int GetHashCode() => Value?.GetHashCode() ?? 0;

            /// <summary>
            /// Returns the string value of the <see cref="RequiredShopperFieldsEnum"/> instance.
            /// </summary>
            public override string ToString() => Value ?? string.Empty;
            ...
            {
                /// <summary>
                /// Deserializes a <see cref="RequiredShopperFieldsEnum"/> from JSON.
                /// </summary>
                ...
                /// <summary>
                /// Serializes a <see cref="RequiredShopperFieldsEnum"/> to JSON.
                /// </summary>
    ...
    public class PaymentLinkResponseJsonConverter : JsonConverter<PaymentLinkResponse>
    {
        ...
        public override PaymentLinkResponse Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (applicationInfo.IsSet)
                paymentLinkResponse.ApplicationInfo = applicationInfo.Value;
            if (billingAddress.IsSet)
                paymentLinkResponse.BillingAddress = billingAddress.Value;
            if (blockedPaymentMethods.IsSet)
                paymentLinkResponse.BlockedPaymentMethods = blockedPaymentMethods.Value;
            if (captureDelayHours.IsSet)
                paymentLinkResponse.CaptureDelayHours = captureDelayHours.Value;
            if (countryCode.IsSet)
                paymentLinkResponse.CountryCode = countryCode.Value;
            if (dateOfBirth.IsSet)
                paymentLinkResponse.DateOfBirth = dateOfBirth.Value;
            if (deliverAt.IsSet)
                paymentLinkResponse.DeliverAt = deliverAt.Value;
            if (deliveryAddress.IsSet)
                paymentLinkResponse.DeliveryAddress = deliveryAddress.Value;
            if (description.IsSet)
                paymentLinkResponse.Description = description.Value;
            if (expiresAt.IsSet)
                paymentLinkResponse.ExpiresAt = expiresAt.Value;
            if (fundOrigin.IsSet)
                paymentLinkResponse.FundOrigin = fundOrigin.Value;
            if (fundRecipient.IsSet)
                paymentLinkResponse.FundRecipient = fundRecipient.Value;
            if (installmentOptions.IsSet)
                paymentLinkResponse.InstallmentOptions = installmentOptions.Value;
            if (lineItems.IsSet)
                paymentLinkResponse.LineItems = lineItems.Value;
            if (manualCapture.IsSet)
                paymentLinkResponse.ManualCapture = manualCapture.Value;
            if (mcc.IsSet)
                paymentLinkResponse.Mcc = mcc.Value;
            if (merchantOrderReference.IsSet)
                paymentLinkResponse.MerchantOrderReference = merchantOrderReference.Value;
            if (metadata.IsSet)
                paymentLinkResponse.Metadata = metadata.Value;
            if (platformChargebackLogic.IsSet)
                paymentLinkResponse.PlatformChargebackLogic = platformChargebackLogic.Value;
            if (recurringProcessingModel.IsSet)
                paymentLinkResponse.RecurringProcessingModel = recurringProcessingModel.Value;
            if (requiredShopperFields.IsSet)
                paymentLinkResponse.RequiredShopperFields = requiredShopperFields.Value;
            if (returnUrl.IsSet)
                paymentLinkResponse.ReturnUrl = returnUrl.Value;
            if (reusable.IsSet)
                paymentLinkResponse.Reusable = reusable.Value;
            if (riskData.IsSet)
                paymentLinkResponse.RiskData = riskData.Value;
            if (shopperEmail.IsSet)
                paymentLinkResponse.ShopperEmail = shopperEmail.Value;
            if (shopperLocale.IsSet)
                paymentLinkResponse.ShopperLocale = shopperLocale.Value;
            if (shopperName.IsSet)
                paymentLinkResponse.ShopperName = shopperName.Value;
            if (shopperReference.IsSet)
                paymentLinkResponse.ShopperReference = shopperReference.Value;
            if (shopperStatement.IsSet)
                paymentLinkResponse.ShopperStatement = shopperStatement.Value;
            if (showRemovePaymentMethodButton.IsSet)
                paymentLinkResponse.ShowRemovePaymentMethodButton = showRemovePaymentMethodButton.Value;
            if (socialSecurityNumber.IsSet)
                paymentLinkResponse.SocialSecurityNumber = socialSecurityNumber.Value;
            if (splitCardFundingSources.IsSet)
                paymentLinkResponse.SplitCardFundingSources = splitCardFundingSources.Value;
            if (splits.IsSet)
                paymentLinkResponse.Splits = splits.Value;
            if (store.IsSet)
                paymentLinkResponse.Store = store.Value;
            if (storePaymentMethodMode.IsSet)
                paymentLinkResponse.StorePaymentMethodMode = storePaymentMethodMode.Value;
            if (telephoneNumber.IsSet)
                paymentLinkResponse.TelephoneNumber = telephoneNumber.Value;
            if (themeId.IsSet)
                paymentLinkResponse.ThemeId = themeId.Value;
            if (threeDS2RequestData.IsSet)
                paymentLinkResponse.ThreeDS2RequestData = threeDS2RequestData.Value;
            if (updatedAt.IsSet)
                paymentLinkResponse.UpdatedAt = updatedAt.Value;
        ...
        public void WriteProperties(Utf8JsonWriter writer, PaymentLinkResponse paymentLinkResponse, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (paymentLinkResponse._DescriptionOption.IsSet)
                if (paymentLinkResponse.Description != null)
            ...
            if (paymentLinkResponse._MerchantOrderReferenceOption.IsSet)
                if (paymentLinkResponse.MerchantOrderReference != null)
            ...
            if (paymentLinkResponse._ReturnUrlOption.IsSet)
                if (paymentLinkResponse.ReturnUrl != null)
            ...
            if (paymentLinkResponse._ShopperReferenceOption.IsSet)
                if (paymentLinkResponse.ShopperReference != null)
            ...
            if (paymentLinkResponse._ShopperStatementOption.IsSet)
                if (paymentLinkResponse.ShopperStatement != null)
            ...
            if (paymentLinkResponse._ThemeIdOption.IsSet)
                if (paymentLinkResponse.ThemeId != null)
