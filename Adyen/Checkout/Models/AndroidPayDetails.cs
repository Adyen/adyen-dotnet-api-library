...
namespace Adyen.Checkout.Models
{
    ...
    public partial class AndroidPayDetails
    {
        ...
        public AndroidPayDetails(Option<string?> checkoutAttemptId = default, Option<string?> sdkData = default, Option<TypeEnum?> type = default)
        {
            _CheckoutAttemptIdOption = checkoutAttemptId;
            _SdkDataOption = sdkData;
            _TypeOption = type.IsSet ? type : TypeEnum.Androidpay;
            OnCreated();
        }
    ...
    public class AndroidPayDetailsJsonConverter : JsonConverter<AndroidPayDetails>
    {
        ...
        public override AndroidPayDetails Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            return new AndroidPayDetails(checkoutAttemptId, sdkData, type);
        }
