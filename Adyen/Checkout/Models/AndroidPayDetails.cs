...
namespace Adyen.Checkout.Models
{
    ...
    public class AndroidPayDetailsJsonConverter : JsonConverter<AndroidPayDetails>
    {
        ...
        /// <returns><see cref="AndroidPayDetails"/></returns>
        ...
        {
            /*
            if (androidPayDetails._CheckoutAttemptIdOption.IsSet && androidPayDetails.CheckoutAttemptId == null)
            ...
            */
            ...
            if (androidPayDetails._CheckoutAttemptIdOption.IsSet)
                writer.WriteString("checkoutAttemptId", androidPayDetails.CheckoutAttemptId);

            if (androidPayDetails._TypeOption.IsSet && androidPayDetails.Type != null) 
            {
                string? typeRawValue = AndroidPayDetails.TypeEnum.ToJsonValue(androidPayDetails._TypeOption.Value!.Value);
