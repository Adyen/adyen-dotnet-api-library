...
namespace Adyen.Checkout.Models
{
    ...
    /// AndroidPayDetails.
    /// </summary>
    [JsonConverter(typeof(AndroidPayDetailsJsonConverter))]
    public partial class AndroidPayDetails
    {
        /// <summary>
        ...
        {
            _TypeOption = TypeEnum.Androidpay;
            OnCreated();
        }
    ...
    public class AndroidPayDetailsJsonConverter : JsonConverter<AndroidPayDetails>
    {
        ...
        public override AndroidPayDetails Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            var androidPayDetails = new AndroidPayDetails();
            if (checkoutAttemptId.IsSet)
                androidPayDetails.CheckoutAttemptId = checkoutAttemptId.Value;
            if (sdkData.IsSet)
                androidPayDetails.SdkData = sdkData.Value;
            if (type.IsSet)
                androidPayDetails.Type = type.Value;
        ...
        public void WriteProperties(Utf8JsonWriter writer, AndroidPayDetails androidPayDetails, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (androidPayDetails._CheckoutAttemptIdOption.IsSet)
                if (androidPayDetails.CheckoutAttemptId != null)
                    writer.WriteString("checkoutAttemptId", androidPayDetails.CheckoutAttemptId);

            if (androidPayDetails._SdkDataOption.IsSet)
                if (androidPayDetails.SdkData != null)
                    writer.WriteString("sdkData", androidPayDetails.SdkData);
