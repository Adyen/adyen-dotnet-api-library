...
namespace Adyen.Checkout.Models
{
    ...
    /// </summary>
    [JsonConverter(typeof(AdditionalDataCarRentalJsonConverter))]
    ...
    public class AdditionalDataCarRentalJsonConverter : JsonConverter<AdditionalDataCarRental>
    {
        ...
        public override AdditionalDataCarRental Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (carRentalCustomerServiceTollFreeNumber.IsSet)
                additionalDataCarRental.CarRentalCustomerServiceTollFreeNumber = carRentalCustomerServiceTollFreeNumber.Value;
            if (carRentalDaysRented.IsSet)
                additionalDataCarRental.CarRentalDaysRented = carRentalDaysRented.Value;
            if (carRentalFuelCharges.IsSet)
                additionalDataCarRental.CarRentalFuelCharges = carRentalFuelCharges.Value;
            if (carRentalInsuranceCharges.IsSet)
                additionalDataCarRental.CarRentalInsuranceCharges = carRentalInsuranceCharges.Value;
            if (carRentalLocationCity.IsSet)
                additionalDataCarRental.CarRentalLocationCity = carRentalLocationCity.Value;
            if (carRentalLocationCountry.IsSet)
                additionalDataCarRental.CarRentalLocationCountry = carRentalLocationCountry.Value;
            if (carRentalLocationStateProvince.IsSet)
                additionalDataCarRental.CarRentalLocationStateProvince = carRentalLocationStateProvince.Value;
            if (carRentalNoShowIndicator.IsSet)
                additionalDataCarRental.CarRentalNoShowIndicator = carRentalNoShowIndicator.Value;
            if (carRentalOneWayDropOffCharges.IsSet)
                additionalDataCarRental.CarRentalOneWayDropOffCharges = carRentalOneWayDropOffCharges.Value;
            if (carRentalRate.IsSet)
                additionalDataCarRental.CarRentalRate = carRentalRate.Value;
            if (carRentalRateIndicator.IsSet)
                additionalDataCarRental.CarRentalRateIndicator = carRentalRateIndicator.Value;
            if (carRentalRentalAgreementNumber.IsSet)
                additionalDataCarRental.CarRentalRentalAgreementNumber = carRentalRentalAgreementNumber.Value;
            if (carRentalRentalClassId.IsSet)
                additionalDataCarRental.CarRentalRentalClassId = carRentalRentalClassId.Value;
            if (carRentalRenterName.IsSet)
                additionalDataCarRental.CarRentalRenterName = carRentalRenterName.Value;
            if (carRentalReturnCity.IsSet)
                additionalDataCarRental.CarRentalReturnCity = carRentalReturnCity.Value;
            if (carRentalReturnCountry.IsSet)
                additionalDataCarRental.CarRentalReturnCountry = carRentalReturnCountry.Value;
            if (carRentalReturnDate.IsSet)
                additionalDataCarRental.CarRentalReturnDate = carRentalReturnDate.Value;
            if (carRentalReturnLocationId.IsSet)
                additionalDataCarRental.CarRentalReturnLocationId = carRentalReturnLocationId.Value;
            if (carRentalReturnStateProvince.IsSet)
                additionalDataCarRental.CarRentalReturnStateProvince = carRentalReturnStateProvince.Value;
            if (carRentalTaxExemptIndicator.IsSet)
                additionalDataCarRental.CarRentalTaxExemptIndicator = carRentalTaxExemptIndicator.Value;
            if (travelEntertainmentAuthDataDuration.IsSet)
                additionalDataCarRental.TravelEntertainmentAuthDataDuration = travelEntertainmentAuthDataDuration.Value;
            if (travelEntertainmentAuthDataMarket.IsSet)
                additionalDataCarRental.TravelEntertainmentAuthDataMarket = travelEntertainmentAuthDataMarket.Value;
            return additionalDataCarRental;
        }
