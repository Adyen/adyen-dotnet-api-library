...
namespace Adyen.Checkout.Models
{
    ...
    public partial class AffirmDetails : IValidatableObject
    {
        ...
        [JsonConstructor]
        public AffirmDetails(Option<string?> checkoutAttemptId = default, Option<TypeEnum?> type = default)
        {
    ...
    public class AffirmDetailsJsonConverter : JsonConverter<AffirmDetails>
    {
        ...
        public override AffirmDetails Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (checkoutAttemptId.IsSet && checkoutAttemptId.Value == null)
                throw new ArgumentNullException(nameof(checkoutAttemptId), "Property is not nullable for class AffirmDetails.");

            if (type.IsSet && type.Value == null)
                throw new ArgumentNullException(nameof(type), "Property is not nullable for class AffirmDetails.");

            return new AffirmDetails(checkoutAttemptId, type);
        }
        ...
        {
            /*
            if (affirmDetails._CheckoutAttemptIdOption.IsSet && affirmDetails.CheckoutAttemptId == null)
                throw new ArgumentNullException(nameof(affirmDetails.CheckoutAttemptId), "Property is required for class AffirmDetails.");
