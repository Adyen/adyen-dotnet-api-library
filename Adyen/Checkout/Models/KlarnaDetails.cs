...
namespace Adyen.Checkout.Models
{
    ...
    public partial class KlarnaDetails : IValidatableObject
    {
        ...
        [JsonConstructor]
        public KlarnaDetails(Option<string?> billingAddress = default, Option<string?> checkoutAttemptId = default, Option<string?> deliveryAddress = default, Option<string?> personalDetails = default, Option<string?> recurringDetailReference = default, Option<string?> storedPaymentMethodId = default, Option<string?> subtype = default, TypeEnum type = default)
        {
    ...
    public class KlarnaDetailsJsonConverter : JsonConverter<KlarnaDetails>
    {
        ...
        /// <returns><see cref="KlarnaDetails"/></returns>
