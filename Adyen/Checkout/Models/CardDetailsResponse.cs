...
namespace Adyen.Checkout.Models
{
    ...
    public class CardDetailsResponseJsonConverter : JsonConverter<CardDetailsResponse>
    {
        ...
        {
            /*
            if (cardDetailsResponse._BrandsOption.IsSet && cardDetailsResponse.Brands == null)
                throw new ArgumentNullException(nameof(cardDetailsResponse.Brands), "Property is required for class CardDetailsResponse.");

            if (cardDetailsResponse._FundingSourceOption.IsSet && cardDetailsResponse.FundingSource == null)
            ...
            if (cardDetailsResponse._IssuingCountryCodeOption.IsSet && cardDetailsResponse.IssuingCountryCode == null)
