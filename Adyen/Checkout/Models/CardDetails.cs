...
namespace Adyen.Checkout.Models
{
    ...
    public partial class CardDetails
    {
        ...
        /// <summary>
        /// This is used to track if an optional field is set. If set, <see cref="EncryptedPassword"/> will be populated.
        /// </summary>
        [JsonIgnore]
        [global::System.ComponentModel.EditorBrowsable(global::System.ComponentModel.EditorBrowsableState.Never)]
        ...
        /// <summary>
        /// This is used to track if an optional field is set. If set, <see cref="FastlaneData"/> will be populated.
        /// </summary>
        [JsonIgnore]
        [global::System.ComponentModel.EditorBrowsable(global::System.ComponentModel.EditorBrowsableState.Never)]
        ...
        /// <summary>
        /// This is used to track if an optional field is set. If set, <see cref="NetworkPaymentReference"/> will be populated.
        /// </summary>
        [JsonIgnore]
        [global::System.ComponentModel.EditorBrowsable(global::System.ComponentModel.EditorBrowsableState.Never)]
        ...
        /// <summary>
        /// This is used to track if an optional field is set. If set, <see cref="SrcCorrelationId"/> will be populated.
        /// </summary>
        [JsonIgnore]
        [global::System.ComponentModel.EditorBrowsable(global::System.ComponentModel.EditorBrowsableState.Never)]
        ...
        /// <summary>
        /// This is used to track if an optional field is set. If set, <see cref="SrcDigitalCardId"/> will be populated.
        /// </summary>
        [JsonIgnore]
        [global::System.ComponentModel.EditorBrowsable(global::System.ComponentModel.EditorBrowsableState.Never)]
        ...
        /// <summary>
        /// This is used to track if an optional field is set. If set, <see cref="SrcScheme"/> will be populated.
        /// </summary>
        [JsonIgnore]
        [global::System.ComponentModel.EditorBrowsable(global::System.ComponentModel.EditorBrowsableState.Never)]
        ...
        /// <summary>
        /// This is used to track if an optional field is set. If set, <see cref="SrcTokenReference"/> will be populated.
        /// </summary>
        [JsonIgnore]
        [global::System.ComponentModel.EditorBrowsable(global::System.ComponentModel.EditorBrowsableState.Never)]
        ...
        /// <summary>
        /// This is used to track if an optional field is set. If set, <see cref="ThreeDS2SdkVersion"/> will be populated.
        /// </summary>
        [JsonIgnore]
        [global::System.ComponentModel.EditorBrowsable(global::System.ComponentModel.EditorBrowsableState.Never)]
    ...
    public class CardDetailsJsonConverter : JsonConverter<CardDetails>
    {
        ...
        public override CardDetails Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (billingSequenceNumber.IsSet)
                cardDetails.BillingSequenceNumber = billingSequenceNumber.Value;
            if (brand.IsSet)
                cardDetails.Brand = brand.Value;
            if (checkoutAttemptId.IsSet)
                cardDetails.CheckoutAttemptId = checkoutAttemptId.Value;
            if (cupsecureplusSmscode.IsSet)
                cardDetails.CupsecureplusSmscode = cupsecureplusSmscode.Value;
            if (cvc.IsSet)
                cardDetails.Cvc = cvc.Value;
            if (encryptedCard.IsSet)
                cardDetails.EncryptedCard = encryptedCard.Value;
            if (encryptedCardNumber.IsSet)
                cardDetails.EncryptedCardNumber = encryptedCardNumber.Value;
            if (encryptedExpiryMonth.IsSet)
                cardDetails.EncryptedExpiryMonth = encryptedExpiryMonth.Value;
            if (encryptedExpiryYear.IsSet)
                cardDetails.EncryptedExpiryYear = encryptedExpiryYear.Value;
            if (encryptedPassword.IsSet)
                cardDetails.EncryptedPassword = encryptedPassword.Value;
            if (encryptedSecurityCode.IsSet)
                cardDetails.EncryptedSecurityCode = encryptedSecurityCode.Value;
            if (expiryMonth.IsSet)
                cardDetails.ExpiryMonth = expiryMonth.Value;
            if (expiryYear.IsSet)
                cardDetails.ExpiryYear = expiryYear.Value;
            if (fastlaneData.IsSet)
                cardDetails.FastlaneData = fastlaneData.Value;
            if (fundingSource.IsSet)
                cardDetails.FundingSource = fundingSource.Value;
            if (holderName.IsSet)
                cardDetails.HolderName = holderName.Value;
            if (networkPaymentReference.IsSet)
                cardDetails.NetworkPaymentReference = networkPaymentReference.Value;
            if (number.IsSet)
                cardDetails.Number = number.Value;
            if (recurringDetailReference.IsSet)
                cardDetails.RecurringDetailReference = recurringDetailReference.Value;
            if (sdkData.IsSet)
                cardDetails.SdkData = sdkData.Value;
            if (shopperNotificationReference.IsSet)
                cardDetails.ShopperNotificationReference = shopperNotificationReference.Value;
            if (srcCorrelationId.IsSet)
                cardDetails.SrcCorrelationId = srcCorrelationId.Value;
            if (srcDigitalCardId.IsSet)
                cardDetails.SrcDigitalCardId = srcDigitalCardId.Value;
            if (srcScheme.IsSet)
                cardDetails.SrcScheme = srcScheme.Value;
            if (srcTokenReference.IsSet)
                cardDetails.SrcTokenReference = srcTokenReference.Value;
            if (storedPaymentMethodId.IsSet)
                cardDetails.StoredPaymentMethodId = storedPaymentMethodId.Value;
            if (threeDS2SdkVersion.IsSet)
                cardDetails.ThreeDS2SdkVersion = threeDS2SdkVersion.Value;
            if (type.IsSet)
                cardDetails.Type = type.Value;
            return cardDetails;
        }
        ...
        public void WriteProperties(Utf8JsonWriter writer, CardDetails cardDetails, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (cardDetails._BillingSequenceNumberOption.IsSet)
                if (cardDetails.BillingSequenceNumber != null)
            ...
            if (cardDetails._NetworkPaymentReferenceOption.IsSet)
                if (cardDetails.NetworkPaymentReference != null)
            ...
            if (cardDetails._RecurringDetailReferenceOption.IsSet)
                if (cardDetails.RecurringDetailReference != null)
                    writer.WriteString("recurringDetailReference", cardDetails.RecurringDetailReference);

            if (cardDetails._SdkDataOption.IsSet)
                if (cardDetails.SdkData != null)
                    writer.WriteString("sdkData", cardDetails.SdkData);

            if (cardDetails._ShopperNotificationReferenceOption.IsSet)
                if (cardDetails.ShopperNotificationReference != null)
