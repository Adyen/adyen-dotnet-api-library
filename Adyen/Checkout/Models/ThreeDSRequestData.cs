...
namespace Adyen.Checkout.Models
{
    ...
    /// ThreeDSRequestData.
    /// </summary>
    [JsonConverter(typeof(ThreeDSRequestDataJsonConverter))]
    public partial class ThreeDSRequestData
    {
        /// <summary>
        ...
        public class ChallengeWindowSizeEnum : IEnum
        {
            ...
            /// <summary>
            /// Compares two <see cref="ChallengeWindowSizeEnum"/> instances for equality.
            /// </summary>
            ...
            /// <summary>
            /// Compares two <see cref="ChallengeWindowSizeEnum"/> instances for inequality.
            /// </summary>
            public static bool operator !=(ChallengeWindowSizeEnum? left, ChallengeWindowSizeEnum? right) => !string.Equals(left?.Value, right?.Value, StringComparison.OrdinalIgnoreCase);

            /// <summary>
            /// Returns true if the given object is equal to this <see cref="ChallengeWindowSizeEnum"/> instance.
            /// </summary>
            ...
            /// <summary>
            /// Returns a hash code for this <see cref="ChallengeWindowSizeEnum"/> instance.
            /// </summary>
            public override int GetHashCode() => Value?.GetHashCode() ?? 0;

            /// <summary>
            /// Returns the string value of the <see cref="ChallengeWindowSizeEnum"/> instance.
            /// </summary>
            ...
            {
                /// <summary>
                /// Deserializes a <see cref="ChallengeWindowSizeEnum"/> from JSON.
                /// </summary>
                ...
                /// <summary>
                /// Serializes a <see cref="ChallengeWindowSizeEnum"/> to JSON.
                /// </summary>
        ...
        public class DataOnlyEnum : IEnum
        {
            ...
            /// <summary>
            /// Compares two <see cref="DataOnlyEnum"/> instances for equality.
            /// </summary>
            ...
            /// <summary>
            /// Compares two <see cref="DataOnlyEnum"/> instances for inequality.
            /// </summary>
            public static bool operator !=(DataOnlyEnum? left, DataOnlyEnum? right) => !string.Equals(left?.Value, right?.Value, StringComparison.OrdinalIgnoreCase);

            /// <summary>
            /// Returns true if the given object is equal to this <see cref="DataOnlyEnum"/> instance.
            /// </summary>
            ...
            /// <summary>
            /// Returns a hash code for this <see cref="DataOnlyEnum"/> instance.
            /// </summary>
            public override int GetHashCode() => Value?.GetHashCode() ?? 0;

            /// <summary>
            /// Returns the string value of the <see cref="DataOnlyEnum"/> instance.
            /// </summary>
            public override string ToString() => Value ?? string.Empty;
            ...
            {
                /// <summary>
                /// Deserializes a <see cref="DataOnlyEnum"/> from JSON.
                /// </summary>
                ...
                /// <summary>
                /// Serializes a <see cref="DataOnlyEnum"/> to JSON.
                /// </summary>
        ...
        public class NativeThreeDSEnum : IEnum
        {
            ...
            /// <summary>
            /// Compares two <see cref="NativeThreeDSEnum"/> instances for equality.
            /// </summary>
            ...
            /// <summary>
            /// Compares two <see cref="NativeThreeDSEnum"/> instances for inequality.
            /// </summary>
            public static bool operator !=(NativeThreeDSEnum? left, NativeThreeDSEnum? right) => !string.Equals(left?.Value, right?.Value, StringComparison.OrdinalIgnoreCase);

            /// <summary>
            /// Returns true if the given object is equal to this <see cref="NativeThreeDSEnum"/> instance.
            /// </summary>
            ...
            /// <summary>
            /// Returns a hash code for this <see cref="NativeThreeDSEnum"/> instance.
            /// </summary>
            public override int GetHashCode() => Value?.GetHashCode() ?? 0;

            /// <summary>
            /// Returns the string value of the <see cref="NativeThreeDSEnum"/> instance.
            /// </summary>
            public override string ToString() => Value ?? string.Empty;
            ...
            {
                /// <summary>
                /// Deserializes a <see cref="NativeThreeDSEnum"/> from JSON.
                /// </summary>
                ...
                /// <summary>
                /// Serializes a <see cref="NativeThreeDSEnum"/> to JSON.
                /// </summary>
        ...
        public class ThreeDSVersionEnum : IEnum
        {
            ...
            /// <summary>
            /// Compares two <see cref="ThreeDSVersionEnum"/> instances for equality.
            /// </summary>
            ...
            /// <summary>
            /// Compares two <see cref="ThreeDSVersionEnum"/> instances for inequality.
            /// </summary>
            public static bool operator !=(ThreeDSVersionEnum? left, ThreeDSVersionEnum? right) => !string.Equals(left?.Value, right?.Value, StringComparison.OrdinalIgnoreCase);

            /// <summary>
            /// Returns true if the given object is equal to this <see cref="ThreeDSVersionEnum"/> instance.
            /// </summary>
            ...
            /// <summary>
            /// Returns a hash code for this <see cref="ThreeDSVersionEnum"/> instance.
            /// </summary>
            public override int GetHashCode() => Value?.GetHashCode() ?? 0;

            /// <summary>
            /// Returns the string value of the <see cref="ThreeDSVersionEnum"/> instance.
            /// </summary>
            public override string ToString() => Value ?? string.Empty;
            ...
            {
                /// <summary>
                /// Deserializes a <see cref="ThreeDSVersionEnum"/> from JSON.
                /// </summary>
                ...
                /// <summary>
                /// Serializes a <see cref="ThreeDSVersionEnum"/> to JSON.
                /// </summary>
    ...
    public class ThreeDSRequestDataJsonConverter : JsonConverter<ThreeDSRequestData>
    {
        ...
        public override ThreeDSRequestData Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (dataOnly.IsSet)
                threeDSRequestData.DataOnly = dataOnly.Value;
            if (nativeThreeDS.IsSet)
                threeDSRequestData.NativeThreeDS = nativeThreeDS.Value;
            if (threeDSVersion.IsSet)
                threeDSRequestData.ThreeDSVersion = threeDSVersion.Value;
