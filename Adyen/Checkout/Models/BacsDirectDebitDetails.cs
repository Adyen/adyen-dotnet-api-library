...
namespace Adyen.Checkout.Models
{
    ...
    /// </summary>
    [JsonConverter(typeof(BacsDirectDebitDetailsJsonConverter))]
    public partial class BacsDirectDebitDetails
    {
        /// <summary>
        ...
        {
            _TypeOption = TypeEnum.DirectdebitGB;
            OnCreated();
        }
    ...
    public class BacsDirectDebitDetailsJsonConverter : JsonConverter<BacsDirectDebitDetails>
    {
        ...
        public override BacsDirectDebitDetails Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
                ...
                if (utf8JsonReader.TokenType == JsonTokenType.PropertyName && currentDepth == utf8JsonReader.CurrentDepth - 1)
                {
                    ...
                    switch (jsonPropertyName)
                    {
                        ...
                        case "type":
                            ...
                            type = new Option<BacsDirectDebitDetails.TypeEnum?>(BacsDirectDebitDetails.TypeEnum.FromStringOrDefault(typeRawValue) ?? (BacsDirectDebitDetails.TypeEnum)typeRawValue);
                            break;
                        default:
                            break;
                    }
            ...
            if (bankLocationId.IsSet)
                bacsDirectDebitDetails.BankLocationId = bankLocationId.Value;
            if (checkoutAttemptId.IsSet)
                bacsDirectDebitDetails.CheckoutAttemptId = checkoutAttemptId.Value;
            if (holderName.IsSet)
                bacsDirectDebitDetails.HolderName = holderName.Value;
            if (recurringDetailReference.IsSet)
                bacsDirectDebitDetails.RecurringDetailReference = recurringDetailReference.Value;
            if (sdkData.IsSet)
                bacsDirectDebitDetails.SdkData = sdkData.Value;
            if (storedPaymentMethodId.IsSet)
                bacsDirectDebitDetails.StoredPaymentMethodId = storedPaymentMethodId.Value;
            if (transferInstrumentId.IsSet)
                bacsDirectDebitDetails.TransferInstrumentId = transferInstrumentId.Value;
            if (type.IsSet)
                bacsDirectDebitDetails.Type = type.Value;
        ...
        public void WriteProperties(Utf8JsonWriter writer, BacsDirectDebitDetails bacsDirectDebitDetails, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (bacsDirectDebitDetails._BankLocationIdOption.IsSet)
                if (bacsDirectDebitDetails.BankLocationId != null)
            ...
            if (bacsDirectDebitDetails._CheckoutAttemptIdOption.IsSet)
                if (bacsDirectDebitDetails.CheckoutAttemptId != null)
            ...
            if (bacsDirectDebitDetails._HolderNameOption.IsSet)
                if (bacsDirectDebitDetails.HolderName != null)
            ...
            if (bacsDirectDebitDetails._RecurringDetailReferenceOption.IsSet)
                if (bacsDirectDebitDetails.RecurringDetailReference != null)
                    writer.WriteString("recurringDetailReference", bacsDirectDebitDetails.RecurringDetailReference);

            if (bacsDirectDebitDetails._SdkDataOption.IsSet)
                if (bacsDirectDebitDetails.SdkData != null)
                    writer.WriteString("sdkData", bacsDirectDebitDetails.SdkData);

            if (bacsDirectDebitDetails._StoredPaymentMethodIdOption.IsSet)
                if (bacsDirectDebitDetails.StoredPaymentMethodId != null)
