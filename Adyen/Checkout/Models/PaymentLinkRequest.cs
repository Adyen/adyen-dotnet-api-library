...
namespace Adyen.Checkout.Models
{
    ...
    /// PaymentLinkRequest.
    /// </summary>
    [JsonConverter(typeof(PaymentLinkRequestJsonConverter))]
    ...
    public class PaymentLinkRequestJsonConverter : JsonConverter<PaymentLinkRequest>
    {
        ...
        public override PaymentLinkRequest Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (applicationInfo.IsSet)
                paymentLinkRequest.ApplicationInfo = applicationInfo.Value;
            if (billingAddress.IsSet)
                paymentLinkRequest.BillingAddress = billingAddress.Value;
            if (blockedPaymentMethods.IsSet)
                paymentLinkRequest.BlockedPaymentMethods = blockedPaymentMethods.Value;
            if (captureDelayHours.IsSet)
                paymentLinkRequest.CaptureDelayHours = captureDelayHours.Value;
            if (countryCode.IsSet)
                paymentLinkRequest.CountryCode = countryCode.Value;
            if (dateOfBirth.IsSet)
                paymentLinkRequest.DateOfBirth = dateOfBirth.Value;
            if (deliverAt.IsSet)
                paymentLinkRequest.DeliverAt = deliverAt.Value;
            if (deliveryAddress.IsSet)
                paymentLinkRequest.DeliveryAddress = deliveryAddress.Value;
            if (description.IsSet)
                paymentLinkRequest.Description = description.Value;
            if (expiresAt.IsSet)
                paymentLinkRequest.ExpiresAt = expiresAt.Value;
            if (fundOrigin.IsSet)
                paymentLinkRequest.FundOrigin = fundOrigin.Value;
            if (fundRecipient.IsSet)
                paymentLinkRequest.FundRecipient = fundRecipient.Value;
            if (installmentOptions.IsSet)
                paymentLinkRequest.InstallmentOptions = installmentOptions.Value;
            if (lineItems.IsSet)
                paymentLinkRequest.LineItems = lineItems.Value;
            if (manualCapture.IsSet)
                paymentLinkRequest.ManualCapture = manualCapture.Value;
            if (mcc.IsSet)
                paymentLinkRequest.Mcc = mcc.Value;
            if (merchantOrderReference.IsSet)
                paymentLinkRequest.MerchantOrderReference = merchantOrderReference.Value;
            if (metadata.IsSet)
                paymentLinkRequest.Metadata = metadata.Value;
            if (platformChargebackLogic.IsSet)
                paymentLinkRequest.PlatformChargebackLogic = platformChargebackLogic.Value;
            if (recurringProcessingModel.IsSet)
                paymentLinkRequest.RecurringProcessingModel = recurringProcessingModel.Value;
            if (requiredShopperFields.IsSet)
                paymentLinkRequest.RequiredShopperFields = requiredShopperFields.Value;
            if (returnUrl.IsSet)
                paymentLinkRequest.ReturnUrl = returnUrl.Value;
            if (reusable.IsSet)
                paymentLinkRequest.Reusable = reusable.Value;
            if (riskData.IsSet)
                paymentLinkRequest.RiskData = riskData.Value;
            if (shopperEmail.IsSet)
                paymentLinkRequest.ShopperEmail = shopperEmail.Value;
            if (shopperLocale.IsSet)
                paymentLinkRequest.ShopperLocale = shopperLocale.Value;
            if (shopperName.IsSet)
                paymentLinkRequest.ShopperName = shopperName.Value;
            if (shopperReference.IsSet)
                paymentLinkRequest.ShopperReference = shopperReference.Value;
            if (shopperStatement.IsSet)
                paymentLinkRequest.ShopperStatement = shopperStatement.Value;
            if (showRemovePaymentMethodButton.IsSet)
                paymentLinkRequest.ShowRemovePaymentMethodButton = showRemovePaymentMethodButton.Value;
            if (socialSecurityNumber.IsSet)
                paymentLinkRequest.SocialSecurityNumber = socialSecurityNumber.Value;
            if (splitCardFundingSources.IsSet)
                paymentLinkRequest.SplitCardFundingSources = splitCardFundingSources.Value;
            if (splits.IsSet)
                paymentLinkRequest.Splits = splits.Value;
            if (store.IsSet)
                paymentLinkRequest.Store = store.Value;
            if (storePaymentMethodMode.IsSet)
                paymentLinkRequest.StorePaymentMethodMode = storePaymentMethodMode.Value;
            if (telephoneNumber.IsSet)
                paymentLinkRequest.TelephoneNumber = telephoneNumber.Value;
            if (themeId.IsSet)
                paymentLinkRequest.ThemeId = themeId.Value;
            if (threeDS2RequestData.IsSet)
                paymentLinkRequest.ThreeDS2RequestData = threeDS2RequestData.Value;
        ...
        public void WriteProperties(Utf8JsonWriter writer, PaymentLinkRequest paymentLinkRequest, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (paymentLinkRequest._MerchantOrderReferenceOption.IsSet)
                if (paymentLinkRequest.MerchantOrderReference != null)
            ...
            if (paymentLinkRequest._ReturnUrlOption.IsSet)
                if (paymentLinkRequest.ReturnUrl != null)
            ...
            if (paymentLinkRequest._ShopperReferenceOption.IsSet)
                if (paymentLinkRequest.ShopperReference != null)
            ...
            if (paymentLinkRequest._ShopperStatementOption.IsSet)
                if (paymentLinkRequest.ShopperStatement != null)
            ...
            if (paymentLinkRequest._StoreOption.IsSet)
                if (paymentLinkRequest.Store != null)
