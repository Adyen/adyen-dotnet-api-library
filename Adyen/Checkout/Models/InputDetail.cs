...
namespace Adyen.Checkout.Models
{
    ...
    /// InputDetail.
    /// </summary>
    [JsonConverter(typeof(InputDetailJsonConverter))]
    ...
    public class InputDetailJsonConverter : JsonConverter<InputDetail>
    {
        ...
        public override InputDetail Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (details.IsSet)
                inputDetail.Details = details.Value;
            if (inputDetails.IsSet)
                inputDetail.InputDetails = inputDetails.Value;
            if (itemSearchUrl.IsSet)
                inputDetail.ItemSearchUrl = itemSearchUrl.Value;
            if (items.IsSet)
                inputDetail.Items = items.Value;
            if (key.IsSet)
                inputDetail.Key = key.Value;
            if (optional.IsSet)
                inputDetail.Optional = optional.Value;
            if (type.IsSet)
                inputDetail.Type = type.Value;
            if (value.IsSet)
                inputDetail.Value = value.Value;
            return inputDetail;
        }
        ...
        public void WriteProperties(Utf8JsonWriter writer, InputDetail inputDetail, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (inputDetail._ItemSearchUrlOption.IsSet)
                if (inputDetail.ItemSearchUrl != null)
