...
namespace Adyen.Checkout.Models
{
    ...
    public class AdditionalDataWalletsJsonConverter : JsonConverter<AdditionalDataWallets>
    {
        ...
        {
            /*
            if (additionalDataWallets._AndroidpayTokenOption.IsSet && additionalDataWallets.AndroidpayToken == null)
            ...
            if (additionalDataWallets._MasterpassTransactionIdOption.IsSet && additionalDataWallets.MasterpassTransactionId == null)
            ...
            if (additionalDataWallets._PaymentTokenOption.IsSet && additionalDataWallets.PaymentToken == null)
            ...
            if (additionalDataWallets._PaywithgoogleTokenOption.IsSet && additionalDataWallets.PaywithgoogleToken == null)
            ...
            if (additionalDataWallets._SamsungpayTokenOption.IsSet && additionalDataWallets.SamsungpayToken == null)
            ...
            if (additionalDataWallets._VisacheckoutCallIdOption.IsSet && additionalDataWallets.VisacheckoutCallId == null)
