...
namespace Adyen.Checkout.Models
{
    ...
    /// BalanceCheckRequest.
    /// </summary>
    [JsonConverter(typeof(BalanceCheckRequestJsonConverter))]
    ...
    public class BalanceCheckRequestJsonConverter : JsonConverter<BalanceCheckRequest>
    {
        ...
        public override BalanceCheckRequest Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (additionalAmount.IsSet)
                balanceCheckRequest.AdditionalAmount = additionalAmount.Value;
            if (additionalData.IsSet)
                balanceCheckRequest.AdditionalData = additionalData.Value;
            if (applicationInfo.IsSet)
                balanceCheckRequest.ApplicationInfo = applicationInfo.Value;
            if (billingAddress.IsSet)
                balanceCheckRequest.BillingAddress = billingAddress.Value;
            if (browserInfo.IsSet)
                balanceCheckRequest.BrowserInfo = browserInfo.Value;
            if (captureDelayHours.IsSet)
                balanceCheckRequest.CaptureDelayHours = captureDelayHours.Value;
            if (dateOfBirth.IsSet)
                balanceCheckRequest.DateOfBirth = dateOfBirth.Value;
            if (dccQuote.IsSet)
                balanceCheckRequest.DccQuote = dccQuote.Value;
            if (deliveryAddress.IsSet)
                balanceCheckRequest.DeliveryAddress = deliveryAddress.Value;
            if (deliveryDate.IsSet)
                balanceCheckRequest.DeliveryDate = deliveryDate.Value;
            if (deviceFingerprint.IsSet)
                balanceCheckRequest.DeviceFingerprint = deviceFingerprint.Value;
            if (fraudOffset.IsSet)
                balanceCheckRequest.FraudOffset = fraudOffset.Value;
            if (installments.IsSet)
                balanceCheckRequest.Installments = installments.Value;
            if (localizedShopperStatement.IsSet)
                balanceCheckRequest.LocalizedShopperStatement = localizedShopperStatement.Value;
            if (mcc.IsSet)
                balanceCheckRequest.Mcc = mcc.Value;
            if (merchantOrderReference.IsSet)
                balanceCheckRequest.MerchantOrderReference = merchantOrderReference.Value;
            if (merchantRiskIndicator.IsSet)
                balanceCheckRequest.MerchantRiskIndicator = merchantRiskIndicator.Value;
            if (metadata.IsSet)
                balanceCheckRequest.Metadata = metadata.Value;
            if (orderReference.IsSet)
                balanceCheckRequest.OrderReference = orderReference.Value;
            if (recurring.IsSet)
                balanceCheckRequest.Recurring = recurring.Value;
            if (recurringProcessingModel.IsSet)
                balanceCheckRequest.RecurringProcessingModel = recurringProcessingModel.Value;
            if (reference.IsSet)
                balanceCheckRequest.Reference = reference.Value;
            if (selectedBrand.IsSet)
                balanceCheckRequest.SelectedBrand = selectedBrand.Value;
            if (selectedRecurringDetailReference.IsSet)
                balanceCheckRequest.SelectedRecurringDetailReference = selectedRecurringDetailReference.Value;
            if (sessionId.IsSet)
                balanceCheckRequest.SessionId = sessionId.Value;
            if (shopperEmail.IsSet)
                balanceCheckRequest.ShopperEmail = shopperEmail.Value;
            if (shopperIP.IsSet)
                balanceCheckRequest.ShopperIP = shopperIP.Value;
            if (shopperInteraction.IsSet)
                balanceCheckRequest.ShopperInteraction = shopperInteraction.Value;
            if (shopperLocale.IsSet)
                balanceCheckRequest.ShopperLocale = shopperLocale.Value;
            if (shopperName.IsSet)
                balanceCheckRequest.ShopperName = shopperName.Value;
            if (shopperReference.IsSet)
                balanceCheckRequest.ShopperReference = shopperReference.Value;
            if (shopperStatement.IsSet)
                balanceCheckRequest.ShopperStatement = shopperStatement.Value;
            if (socialSecurityNumber.IsSet)
                balanceCheckRequest.SocialSecurityNumber = socialSecurityNumber.Value;
            if (splits.IsSet)
                balanceCheckRequest.Splits = splits.Value;
            if (store.IsSet)
                balanceCheckRequest.Store = store.Value;
            if (telephoneNumber.IsSet)
                balanceCheckRequest.TelephoneNumber = telephoneNumber.Value;
            if (threeDS2RequestData.IsSet)
                balanceCheckRequest.ThreeDS2RequestData = threeDS2RequestData.Value;
            if (threeDSAuthenticationOnly.IsSet)
                balanceCheckRequest.ThreeDSAuthenticationOnly = threeDSAuthenticationOnly.Value;
            if (totalsGroup.IsSet)
                balanceCheckRequest.TotalsGroup = totalsGroup.Value;
            if (trustedShopper.IsSet)
                balanceCheckRequest.TrustedShopper = trustedShopper.Value;
        ...
        public void WriteProperties(Utf8JsonWriter writer, BalanceCheckRequest balanceCheckRequest, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (balanceCheckRequest._OrderReferenceOption.IsSet)
                if (balanceCheckRequest.OrderReference != null)
            ...
            if (balanceCheckRequest._SelectedBrandOption.IsSet)
                if (balanceCheckRequest.SelectedBrand != null)
            ...
            if (balanceCheckRequest._SelectedRecurringDetailReferenceOption.IsSet)
                if (balanceCheckRequest.SelectedRecurringDetailReference != null)
            ...
            if (balanceCheckRequest._ShopperReferenceOption.IsSet)
                if (balanceCheckRequest.ShopperReference != null)
            ...
            if (balanceCheckRequest._ShopperStatementOption.IsSet)
                if (balanceCheckRequest.ShopperStatement != null)
            ...
            if (balanceCheckRequest._SocialSecurityNumberOption.IsSet)
                if (balanceCheckRequest.SocialSecurityNumber != null)
