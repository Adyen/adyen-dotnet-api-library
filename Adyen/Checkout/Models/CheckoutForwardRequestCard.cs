...
namespace Adyen.Checkout.Models
{
    ...
    /// </summary>
    [JsonConverter(typeof(CheckoutForwardRequestCardJsonConverter))]
    public partial class CheckoutForwardRequestCard
    {
        /// <summary>
    ...
    public class CheckoutForwardRequestCardJsonConverter : JsonConverter<CheckoutForwardRequestCard>
    {
        ...
        public override CheckoutForwardRequestCard Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (encryptedCardNumber.IsSet)
                checkoutForwardRequestCard.EncryptedCardNumber = encryptedCardNumber.Value;
            if (encryptedExpiryMonth.IsSet)
                checkoutForwardRequestCard.EncryptedExpiryMonth = encryptedExpiryMonth.Value;
            if (encryptedExpiryYear.IsSet)
                checkoutForwardRequestCard.EncryptedExpiryYear = encryptedExpiryYear.Value;
            if (encryptedSecurityCode.IsSet)
                checkoutForwardRequestCard.EncryptedSecurityCode = encryptedSecurityCode.Value;
            if (expiryMonth.IsSet)
                checkoutForwardRequestCard.ExpiryMonth = expiryMonth.Value;
            if (expiryYear.IsSet)
                checkoutForwardRequestCard.ExpiryYear = expiryYear.Value;
            if (holderName.IsSet)
                checkoutForwardRequestCard.HolderName = holderName.Value;
            if (number.IsSet)
                checkoutForwardRequestCard.Number = number.Value;
            if (type.IsSet)
                checkoutForwardRequestCard.Type = type.Value;
            return checkoutForwardRequestCard;
        }
