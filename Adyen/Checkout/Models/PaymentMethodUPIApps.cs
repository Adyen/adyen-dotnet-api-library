...
namespace Adyen.Checkout.Models
{
    ...
    /// </summary>
    public partial class PaymentMethodUPIApps : IValidatableObject
    {
        /// <summary>
    ...
    public class PaymentMethodUPIAppsJsonConverter : JsonConverter<PaymentMethodUPIApps>
    {
        ...
        public override PaymentMethodUPIApps Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (id.IsSet && id.Value == null)
                throw new ArgumentNullException(nameof(id), "Property is not nullable for class PaymentMethodUPIApps.");

            if (name.IsSet && name.Value == null)
                throw new ArgumentNullException(nameof(name), "Property is not nullable for class PaymentMethodUPIApps.");
        ...
        public void WriteProperties(Utf8JsonWriter writer, PaymentMethodUPIApps paymentMethodUPIApps, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (paymentMethodUPIApps.Id == null)
                throw new ArgumentNullException(nameof(paymentMethodUPIApps.Id), "Property is required for class PaymentMethodUPIApps.");

            if (paymentMethodUPIApps.Name == null)
                throw new ArgumentNullException(nameof(paymentMethodUPIApps.Name), "Property is required for class PaymentMethodUPIApps.");
