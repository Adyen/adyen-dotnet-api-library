...
namespace Adyen.Checkout.Models
{
    ...
    /// BlikDetails.
    /// </summary>
    [JsonConverter(typeof(BlikDetailsJsonConverter))]
    ...
    public class BlikDetailsJsonConverter : JsonConverter<BlikDetails>
    {
        ...
        public override BlikDetails Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (checkoutAttemptId.IsSet)
                blikDetails.CheckoutAttemptId = checkoutAttemptId.Value;
            if (recurringDetailReference.IsSet)
                blikDetails.RecurringDetailReference = recurringDetailReference.Value;
            if (sdkData.IsSet)
                blikDetails.SdkData = sdkData.Value;
            if (storedPaymentMethodId.IsSet)
                blikDetails.StoredPaymentMethodId = storedPaymentMethodId.Value;
            if (type.IsSet)
                blikDetails.Type = type.Value;
            return blikDetails;
        }
