...
namespace Adyen.Checkout.Models
{
    ...
    public class ResponsePaymentMethodJsonConverter : JsonConverter<ResponsePaymentMethod>
    {
        ...
        {
            /*
            if (responsePaymentMethod._BrandOption.IsSet && responsePaymentMethod.Brand == null)
                throw new ArgumentNullException(nameof(responsePaymentMethod.Brand), "Property is required for class ResponsePaymentMethod.");

            if (responsePaymentMethod._TypeOption.IsSet && responsePaymentMethod.Type == null)
