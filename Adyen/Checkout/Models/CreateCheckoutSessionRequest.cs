...
namespace Adyen.Checkout.Models
{
    ...
    /// </summary>
    [JsonConverter(typeof(CreateCheckoutSessionRequestJsonConverter))]
    public partial class CreateCheckoutSessionRequest
    {
        ...
        public class StoreFiltrationModeEnum : IEnum
        {
            ...
            /// <summary>
            /// Compares two <see cref="StoreFiltrationModeEnum"/> instances for equality.
            /// </summary>
            ...
            /// <summary>
            /// Compares two <see cref="StoreFiltrationModeEnum"/> instances for inequality.
            /// </summary>
            public static bool operator !=(StoreFiltrationModeEnum? left, StoreFiltrationModeEnum? right) => !string.Equals(left?.Value, right?.Value, StringComparison.OrdinalIgnoreCase);

            /// <summary>
            /// Returns true if the given object is equal to this <see cref="StoreFiltrationModeEnum"/> instance.
            /// </summary>
            ...
            /// <summary>
            /// Returns a hash code for this <see cref="StoreFiltrationModeEnum"/> instance.
            /// </summary>
            public override int GetHashCode() => Value?.GetHashCode() ?? 0;

            /// <summary>
            /// Returns the string value of the <see cref="StoreFiltrationModeEnum"/> instance.
            /// </summary>
            public override string ToString() => Value ?? string.Empty;
            ...
            {
                /// <summary>
                /// Deserializes a <see cref="StoreFiltrationModeEnum"/> from JSON.
                /// </summary>
                ...
                /// <summary>
                /// Serializes a <see cref="StoreFiltrationModeEnum"/> to JSON.
                /// </summary>
        ...
        public class StorePaymentMethodModeEnum : IEnum
        {
            ...
            /// <summary>
            /// Compares two <see cref="StorePaymentMethodModeEnum"/> instances for equality.
            /// </summary>
            ...
            /// <summary>
            /// Compares two <see cref="StorePaymentMethodModeEnum"/> instances for inequality.
            /// </summary>
            public static bool operator !=(StorePaymentMethodModeEnum? left, StorePaymentMethodModeEnum? right) => !string.Equals(left?.Value, right?.Value, StringComparison.OrdinalIgnoreCase);

            /// <summary>
            /// Returns true if the given object is equal to this <see cref="StorePaymentMethodModeEnum"/> instance.
            /// </summary>
            ...
            /// <summary>
            /// Returns a hash code for this <see cref="StorePaymentMethodModeEnum"/> instance.
            /// </summary>
            public override int GetHashCode() => Value?.GetHashCode() ?? 0;

            /// <summary>
            /// Returns the string value of the <see cref="StorePaymentMethodModeEnum"/> instance.
            /// </summary>
            public override string ToString() => Value ?? string.Empty;
            ...
            {
                /// <summary>
                /// Deserializes a <see cref="StorePaymentMethodModeEnum"/> from JSON.
                /// </summary>
                ...
                /// <summary>
                /// Serializes a <see cref="StorePaymentMethodModeEnum"/> to JSON.
                /// </summary>
        ...
        /// </summary>
        /// <value>Use this if you made a `/paymentMethods` request to get the payment methods for the shopper's checkout session.  A unique ID to [connect the shopper to a single checkout session](https://docs.adyen.com/online-payments/checkout-settings#checkout-shopper-conversion-id) that uses multiple API requests. You can use this to get insights into conversion rates.</value>
    ...
    public class CreateCheckoutSessionRequestJsonConverter : JsonConverter<CreateCheckoutSessionRequest>
    {
        ...
        public override CreateCheckoutSessionRequest Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
                ...
                if (utf8JsonReader.TokenType == JsonTokenType.PropertyName && currentDepth == utf8JsonReader.CurrentDepth - 1)
                {
                    ...
                    switch (jsonPropertyName)
                    {
                        ...
                        case "channel":
                            ...
                            channel = new Option<CreateCheckoutSessionRequest.ChannelEnum?>(CreateCheckoutSessionRequest.ChannelEnum.FromStringOrDefault(channelRawValue) ?? (CreateCheckoutSessionRequest.ChannelEnum)channelRawValue);
                            break;
                        case "company":
                        ...
                        case "mode":
                            ...
                            mode = new Option<CreateCheckoutSessionRequest.ModeEnum?>(CreateCheckoutSessionRequest.ModeEnum.FromStringOrDefault(modeRawValue) ?? (CreateCheckoutSessionRequest.ModeEnum)modeRawValue);
                            break;
                        case "mpiData":
                        ...
                        case "recurringProcessingModel":
                            ...
                            recurringProcessingModel = new Option<CreateCheckoutSessionRequest.RecurringProcessingModelEnum?>(CreateCheckoutSessionRequest.RecurringProcessingModelEnum.FromStringOrDefault(recurringProcessingModelRawValue) ?? (CreateCheckoutSessionRequest.RecurringProcessingModelEnum)recurringProcessingModelRawValue);
                            break;
                        ...
                        case "shopperInteraction":
                            ...
                            shopperInteraction = new Option<CreateCheckoutSessionRequest.ShopperInteractionEnum?>(CreateCheckoutSessionRequest.ShopperInteractionEnum.FromStringOrDefault(shopperInteractionRawValue) ?? (CreateCheckoutSessionRequest.ShopperInteractionEnum)shopperInteractionRawValue);
                            break;
                        case "shopperLocale":
                        ...
                        case "storeFiltrationMode":
                            ...
                            storeFiltrationMode = new Option<CreateCheckoutSessionRequest.StoreFiltrationModeEnum?>(CreateCheckoutSessionRequest.StoreFiltrationModeEnum.FromStringOrDefault(storeFiltrationModeRawValue) ?? (CreateCheckoutSessionRequest.StoreFiltrationModeEnum)storeFiltrationModeRawValue);
                            break;
                        ...
                        case "storePaymentMethodMode":
                            ...
                            storePaymentMethodMode = new Option<CreateCheckoutSessionRequest.StorePaymentMethodModeEnum?>(CreateCheckoutSessionRequest.StorePaymentMethodModeEnum.FromStringOrDefault(storePaymentMethodModeRawValue) ?? (CreateCheckoutSessionRequest.StorePaymentMethodModeEnum)storePaymentMethodModeRawValue);
                            break;
            ...
            if (additionalAmount.IsSet)
                createCheckoutSessionRequest.AdditionalAmount = additionalAmount.Value;
            if (additionalData.IsSet)
                createCheckoutSessionRequest.AdditionalData = additionalData.Value;
            if (allowedPaymentMethods.IsSet)
                createCheckoutSessionRequest.AllowedPaymentMethods = allowedPaymentMethods.Value;
            if (applicationInfo.IsSet)
                createCheckoutSessionRequest.ApplicationInfo = applicationInfo.Value;
            if (authenticationData.IsSet)
                createCheckoutSessionRequest.AuthenticationData = authenticationData.Value;
            if (billingAddress.IsSet)
                createCheckoutSessionRequest.BillingAddress = billingAddress.Value;
            if (blockedPaymentMethods.IsSet)
                createCheckoutSessionRequest.BlockedPaymentMethods = blockedPaymentMethods.Value;
            if (captureDelayHours.IsSet)
                createCheckoutSessionRequest.CaptureDelayHours = captureDelayHours.Value;
            if (channel.IsSet)
                createCheckoutSessionRequest.Channel = channel.Value;
            if (company.IsSet)
                createCheckoutSessionRequest.Company = company.Value;
            if (countryCode.IsSet)
                createCheckoutSessionRequest.CountryCode = countryCode.Value;
            if (dateOfBirth.IsSet)
                createCheckoutSessionRequest.DateOfBirth = dateOfBirth.Value;
            if (deliverAt.IsSet)
                createCheckoutSessionRequest.DeliverAt = deliverAt.Value;
            if (deliveryAddress.IsSet)
                createCheckoutSessionRequest.DeliveryAddress = deliveryAddress.Value;
            if (enableOneClick.IsSet)
                createCheckoutSessionRequest.EnableOneClick = enableOneClick.Value;
            if (enablePayOut.IsSet)
                createCheckoutSessionRequest.EnablePayOut = enablePayOut.Value;
            if (enableRecurring.IsSet)
                createCheckoutSessionRequest.EnableRecurring = enableRecurring.Value;
            if (expiresAt.IsSet)
                createCheckoutSessionRequest.ExpiresAt = expiresAt.Value;
            if (fundOrigin.IsSet)
                createCheckoutSessionRequest.FundOrigin = fundOrigin.Value;
            if (fundRecipient.IsSet)
                createCheckoutSessionRequest.FundRecipient = fundRecipient.Value;
            if (installmentOptions.IsSet)
                createCheckoutSessionRequest.InstallmentOptions = installmentOptions.Value;
            if (lineItems.IsSet)
                createCheckoutSessionRequest.LineItems = lineItems.Value;
            if (mandate.IsSet)
                createCheckoutSessionRequest.Mandate = mandate.Value;
            if (mcc.IsSet)
                createCheckoutSessionRequest.Mcc = mcc.Value;
            if (merchantOrderReference.IsSet)
                createCheckoutSessionRequest.MerchantOrderReference = merchantOrderReference.Value;
            if (metadata.IsSet)
                createCheckoutSessionRequest.Metadata = metadata.Value;
            if (mode.IsSet)
            ...
            if (recurringExpiry.IsSet)
                createCheckoutSessionRequest.RecurringExpiry = recurringExpiry.Value;
            if (recurringFrequency.IsSet)
                createCheckoutSessionRequest.RecurringFrequency = recurringFrequency.Value;
            if (recurringProcessingModel.IsSet)
                createCheckoutSessionRequest.RecurringProcessingModel = recurringProcessingModel.Value;
            if (redirectFromIssuerMethod.IsSet)
                createCheckoutSessionRequest.RedirectFromIssuerMethod = redirectFromIssuerMethod.Value;
            if (redirectToIssuerMethod.IsSet)
                createCheckoutSessionRequest.RedirectToIssuerMethod = redirectToIssuerMethod.Value;
            if (riskData.IsSet)
                createCheckoutSessionRequest.RiskData = riskData.Value;
            if (shopperConversionId.IsSet)
                createCheckoutSessionRequest.ShopperConversionId = shopperConversionId.Value;
            if (shopperEmail.IsSet)
                createCheckoutSessionRequest.ShopperEmail = shopperEmail.Value;
            if (shopperIP.IsSet)
                createCheckoutSessionRequest.ShopperIP = shopperIP.Value;
            if (shopperInteraction.IsSet)
                createCheckoutSessionRequest.ShopperInteraction = shopperInteraction.Value;
            if (shopperLocale.IsSet)
                createCheckoutSessionRequest.ShopperLocale = shopperLocale.Value;
            if (shopperName.IsSet)
                createCheckoutSessionRequest.ShopperName = shopperName.Value;
            if (shopperReference.IsSet)
                createCheckoutSessionRequest.ShopperReference = shopperReference.Value;
            if (shopperStatement.IsSet)
                createCheckoutSessionRequest.ShopperStatement = shopperStatement.Value;
            if (showInstallmentAmount.IsSet)
                createCheckoutSessionRequest.ShowInstallmentAmount = showInstallmentAmount.Value;
            if (showRemovePaymentMethodButton.IsSet)
                createCheckoutSessionRequest.ShowRemovePaymentMethodButton = showRemovePaymentMethodButton.Value;
            if (socialSecurityNumber.IsSet)
                createCheckoutSessionRequest.SocialSecurityNumber = socialSecurityNumber.Value;
            if (splitCardFundingSources.IsSet)
                createCheckoutSessionRequest.SplitCardFundingSources = splitCardFundingSources.Value;
            if (splits.IsSet)
                createCheckoutSessionRequest.Splits = splits.Value;
            if (store.IsSet)
                createCheckoutSessionRequest.Store = store.Value;
            if (storeFiltrationMode.IsSet)
                createCheckoutSessionRequest.StoreFiltrationMode = storeFiltrationMode.Value;
            if (storePaymentMethod.IsSet)
                createCheckoutSessionRequest.StorePaymentMethod = storePaymentMethod.Value;
            if (storePaymentMethodMode.IsSet)
                createCheckoutSessionRequest.StorePaymentMethodMode = storePaymentMethodMode.Value;
            if (telephoneNumber.IsSet)
                createCheckoutSessionRequest.TelephoneNumber = telephoneNumber.Value;
            if (themeId.IsSet)
                createCheckoutSessionRequest.ThemeId = themeId.Value;
            if (thirdPartyTokenRedundancyInfo.IsSet)
                createCheckoutSessionRequest.ThirdPartyTokenRedundancyInfo = thirdPartyTokenRedundancyInfo.Value;
            if (threeDS2RequestData.IsSet)
                createCheckoutSessionRequest.ThreeDS2RequestData = threeDS2RequestData.Value;
            if (threeDSAuthenticationOnly.IsSet)
                createCheckoutSessionRequest.ThreeDSAuthenticationOnly = threeDSAuthenticationOnly.Value;
            if (trustedShopper.IsSet)
                createCheckoutSessionRequest.TrustedShopper = trustedShopper.Value;
        ...
        public void WriteProperties(Utf8JsonWriter writer, CreateCheckoutSessionRequest createCheckoutSessionRequest, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (createCheckoutSessionRequest._ShopperConversionIdOption.IsSet)
                if (createCheckoutSessionRequest.ShopperConversionId != null)
                    writer.WriteString("shopperConversionId", createCheckoutSessionRequest.ShopperConversionId);
            ...
            if (createCheckoutSessionRequest._ThirdPartyTokenRedundancyInfoOption.IsSet)
            {
                writer.WritePropertyName("thirdPartyTokenRedundancyInfo");
                JsonSerializer.Serialize(writer, createCheckoutSessionRequest.ThirdPartyTokenRedundancyInfo, jsonSerializerOptions);
            }
