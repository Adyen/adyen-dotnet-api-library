...
namespace Adyen.Checkout.Models
{
    ...
    public class OpenInvoiceDetailsJsonConverter : JsonConverter<OpenInvoiceDetails>
    {
        ...
        /// <returns><see cref="OpenInvoiceDetails"/></returns>
        ...
        {
            /*
            if (openInvoiceDetails._BillingAddressOption.IsSet && openInvoiceDetails.BillingAddress == null)
            ...
            if (openInvoiceDetails._CheckoutAttemptIdOption.IsSet && openInvoiceDetails.CheckoutAttemptId == null)
            ...
            if (openInvoiceDetails._DeliveryAddressOption.IsSet && openInvoiceDetails.DeliveryAddress == null)
            ...
            if (openInvoiceDetails._PersonalDetailsOption.IsSet && openInvoiceDetails.PersonalDetails == null)
            ...
            if (openInvoiceDetails._RecurringDetailReferenceOption.IsSet && openInvoiceDetails.RecurringDetailReference == null)
            ...
            if (openInvoiceDetails._StoredPaymentMethodIdOption.IsSet && openInvoiceDetails.StoredPaymentMethodId == null)
