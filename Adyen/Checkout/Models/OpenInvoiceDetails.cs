...
namespace Adyen.Checkout.Models
{
    ...
    /// OpenInvoiceDetails.
    /// </summary>
    [JsonConverter(typeof(OpenInvoiceDetailsJsonConverter))]
    public partial class OpenInvoiceDetails
    {
        /// <summary>
        ...
        {
            _TypeOption = TypeEnum.Openinvoice;
            OnCreated();
        }
    ...
    public class OpenInvoiceDetailsJsonConverter : JsonConverter<OpenInvoiceDetails>
    {
        ...
        public override OpenInvoiceDetails Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (checkoutAttemptId.IsSet)
                openInvoiceDetails.CheckoutAttemptId = checkoutAttemptId.Value;
            if (deliveryAddress.IsSet)
                openInvoiceDetails.DeliveryAddress = deliveryAddress.Value;
            if (personalDetails.IsSet)
                openInvoiceDetails.PersonalDetails = personalDetails.Value;
            if (recurringDetailReference.IsSet)
                openInvoiceDetails.RecurringDetailReference = recurringDetailReference.Value;
            if (sdkData.IsSet)
                openInvoiceDetails.SdkData = sdkData.Value;
            if (storedPaymentMethodId.IsSet)
                openInvoiceDetails.StoredPaymentMethodId = storedPaymentMethodId.Value;
            if (type.IsSet)
                openInvoiceDetails.Type = type.Value;
        ...
        public void WriteProperties(Utf8JsonWriter writer, OpenInvoiceDetails openInvoiceDetails, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (openInvoiceDetails._CheckoutAttemptIdOption.IsSet)
                if (openInvoiceDetails.CheckoutAttemptId != null)
            ...
            if (openInvoiceDetails._RecurringDetailReferenceOption.IsSet)
                if (openInvoiceDetails.RecurringDetailReference != null)
                    writer.WriteString("recurringDetailReference", openInvoiceDetails.RecurringDetailReference);

            if (openInvoiceDetails._SdkDataOption.IsSet)
                if (openInvoiceDetails.SdkData != null)
                    writer.WriteString("sdkData", openInvoiceDetails.SdkData);
