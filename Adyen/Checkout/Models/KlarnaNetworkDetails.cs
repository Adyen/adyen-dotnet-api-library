...
namespace Adyen.Checkout.Models
{
    ...
    public partial class KlarnaNetworkDetails
    {
        ...
        /// <param name="klarnaNetworkSessionToken">The token obtained from the Klarna SDK during an Express Checkout flow.</param>
        ...
        public KlarnaNetworkDetails(Option<string?> checkoutAttemptId = default, Option<string?> klarnaNetworkData = default, Option<string?> klarnaNetworkSessionToken = default, Option<string?> recurringDetailReference = default, Option<string?> sdkData = default, Option<string?> storedPaymentMethodId = default, TypeEnum type = default)
        {
            _CheckoutAttemptIdOption = checkoutAttemptId;
            _KlarnaNetworkDataOption = klarnaNetworkData;
            _KlarnaNetworkSessionTokenOption = klarnaNetworkSessionToken;
    ...
    public class KlarnaNetworkDetailsJsonConverter : JsonConverter<KlarnaNetworkDetails>
    {
        ...
        public override KlarnaNetworkDetails Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            return new KlarnaNetworkDetails(checkoutAttemptId, klarnaNetworkData, klarnaNetworkSessionToken, recurringDetailReference, sdkData, storedPaymentMethodId, type.Value!.Value!);
        }
