    ...
    public class PaymentMethodJsonConverter : JsonConverter<PaymentMethod>
    {
        ...
        public override PaymentMethod Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (configuration.IsSet && configuration.Value == null)
                throw new ArgumentNullException(nameof(configuration), "Property is not nullable for class PaymentMethod.");
            ...
            if (promoted.IsSet && promoted.Value == null)
                throw new ArgumentNullException(nameof(promoted), "Property is not nullable for class PaymentMethod.");
