...
namespace Adyen.Checkout.Models
{
    ...
    /// </summary>
    [JsonConverter(typeof(PaymentAmountUpdateResponseJsonConverter))]
    public partial class PaymentAmountUpdateResponse
    {
        ...
        /// </summary>
        /// <value>The status of your request.   If you included &#x60;adjustAuthorisationData&#x60; in your request, possible values are the following:   * **authorised**   * **refused**   Otherwise, the value is **received**.</value>
        ...
        /// </summary>
        /// <value>The data blob for subsequent synchronous adjust authorisation calls. Returned when the synchronous flow is used.</value>
    ...
    public class PaymentAmountUpdateResponseJsonConverter : JsonConverter<PaymentAmountUpdateResponse>
    {
        ...
        public override PaymentAmountUpdateResponse Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (adjustAuthorisationData.IsSet)
                paymentAmountUpdateResponse.AdjustAuthorisationData = adjustAuthorisationData.Value;
            if (industryUsage.IsSet)
                paymentAmountUpdateResponse.IndustryUsage = industryUsage.Value;
            if (lineItems.IsSet)
                paymentAmountUpdateResponse.LineItems = lineItems.Value;
            if (splits.IsSet)
                paymentAmountUpdateResponse.Splits = splits.Value;
        ...
        public void WriteProperties(Utf8JsonWriter writer, PaymentAmountUpdateResponse paymentAmountUpdateResponse, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (paymentAmountUpdateResponse._AdjustAuthorisationDataOption.IsSet)
                if (paymentAmountUpdateResponse.AdjustAuthorisationData != null)
                    writer.WriteString("adjustAuthorisationData", paymentAmountUpdateResponse.AdjustAuthorisationData);
