...
namespace Adyen.Checkout.Models
{
    ...
    public partial class CancelOrderRequest
    {
        ...
        /// <param name="order">The order request object that contains a pspReference that represents the order and the matching encrypted order data.</param>
        [JsonConstructor]
        ...
        /// </summary>
        /// <value>The order request object that contains a pspReference that represents the order and the matching encrypted order data.</value>
