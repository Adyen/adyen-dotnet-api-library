...
namespace Adyen.Checkout.Models
{
    ...
    /// ZipDetails.
    /// </summary>
    [JsonConverter(typeof(ZipDetailsJsonConverter))]
    public partial class ZipDetails
    {
        /// <summary>
        ...
        /// <summary>
        /// This is used to track if an optional field is set. If set, <see cref="ClickAndCollect"/> will be populated.
        /// </summary>
        [JsonIgnore]
        [global::System.ComponentModel.EditorBrowsable(global::System.ComponentModel.EditorBrowsableState.Never)]
    ...
    public class ZipDetailsJsonConverter : JsonConverter<ZipDetails>
    {
        ...
        public override ZipDetails Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (clickAndCollect.IsSet)
                zipDetails.ClickAndCollect = clickAndCollect.Value;
            if (recurringDetailReference.IsSet)
                zipDetails.RecurringDetailReference = recurringDetailReference.Value;
            if (sdkData.IsSet)
                zipDetails.SdkData = sdkData.Value;
            if (storedPaymentMethodId.IsSet)
                zipDetails.StoredPaymentMethodId = storedPaymentMethodId.Value;
            if (type.IsSet)
                zipDetails.Type = type.Value;
            return zipDetails;
        }
