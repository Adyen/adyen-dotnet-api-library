...
namespace Adyen.Checkout.Models
{
    ...
    public partial class ZipDetails
    {
        ...
        public ZipDetails(Option<string?> checkoutAttemptId = default, Option<string?> clickAndCollect = default, Option<string?> recurringDetailReference = default, Option<string?> sdkData = default, Option<string?> storedPaymentMethodId = default, Option<TypeEnum?> type = default)
        {
            ...
            _TypeOption = type.IsSet ? type : TypeEnum.Zip;
            OnCreated();
        }
    ...
    public class ZipDetailsJsonConverter : JsonConverter<ZipDetails>
    {
        ...
        public override ZipDetails Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            return new ZipDetails(checkoutAttemptId, clickAndCollect, recurringDetailReference, sdkData, storedPaymentMethodId, type);
        }
