...
namespace Adyen.Checkout.Models
{
    ...
    /// AuthenticationData.
    /// </summary>
    [JsonConverter(typeof(AuthenticationDataJsonConverter))]
    public partial class AuthenticationData
    {
        ...
        public class AttemptAuthenticationEnum : IEnum
        {
            ...
            /// <summary>
            /// Compares two <see cref="AttemptAuthenticationEnum"/> instances for equality.
            /// </summary>
            ...
            /// <summary>
            /// Compares two <see cref="AttemptAuthenticationEnum"/> instances for inequality.
            /// </summary>
            public static bool operator !=(AttemptAuthenticationEnum? left, AttemptAuthenticationEnum? right) => !string.Equals(left?.Value, right?.Value, StringComparison.OrdinalIgnoreCase);

            /// <summary>
            /// Returns true if the given object is equal to this <see cref="AttemptAuthenticationEnum"/> instance.
            /// </summary>
            ...
            /// <summary>
            /// Returns a hash code for this <see cref="AttemptAuthenticationEnum"/> instance.
            /// </summary>
            public override int GetHashCode() => Value?.GetHashCode() ?? 0;

            /// <summary>
            /// Returns the string value of the <see cref="AttemptAuthenticationEnum"/> instance.
            /// </summary>
            ...
            {
                /// <summary>
                /// Deserializes a <see cref="AttemptAuthenticationEnum"/> from JSON.
                /// </summary>
                ...
                /// <summary>
                /// Serializes a <see cref="AttemptAuthenticationEnum"/> to JSON.
                /// </summary>
    ...
    public class AuthenticationDataJsonConverter : JsonConverter<AuthenticationData>
    {
        ...
        public override AuthenticationData Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (authenticationOnly.IsSet)
                authenticationData.AuthenticationOnly = authenticationOnly.Value;
            if (threeDSRequestData.IsSet)
                authenticationData.ThreeDSRequestData = threeDSRequestData.Value;
