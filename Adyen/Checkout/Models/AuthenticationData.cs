...
namespace Adyen.Checkout.Models
{
    ...
    public partial class AuthenticationData : IValidatableObject
    {
        ...
        /// <summary>
        /// Used to track whether AttemptAuthentication is set or not.
        /// </summary>
        [JsonIgnore]
    ...
    public class AuthenticationDataJsonConverter : JsonConverter<AuthenticationData>
    {
        ...
        {
            /*
            if (authenticationData._ThreeDSRequestDataOption.IsSet && authenticationData.ThreeDSRequestData == null)
