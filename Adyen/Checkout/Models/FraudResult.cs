...
namespace Adyen.Checkout.Models
{
    ...
    public partial class FraudResult : IValidatableObject
    {
        ...
        public Option<List<FraudCheckResult>?> _ResultsOption { get; private set; }
        ...
        public List<FraudCheckResult>? Results { get { return this._ResultsOption; } set { this._ResultsOption = new(value); } }
