...
namespace Adyen.Checkout.Models
{
    ...
    /// AdditionalDataOpi.
    /// </summary>
    [JsonConverter(typeof(AdditionalDataOpiJsonConverter))]
    public partial class AdditionalDataOpi
    {
        /// <summary>
    ...
    public class AdditionalDataOpiJsonConverter : JsonConverter<AdditionalDataOpi>
    {
        ...
        public override AdditionalDataOpi Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            var additionalDataOpi = new AdditionalDataOpi();
            if (opiIncludeTransToken.IsSet)
                additionalDataOpi.OpiIncludeTransToken = opiIncludeTransToken.Value;
            return additionalDataOpi;
        }
