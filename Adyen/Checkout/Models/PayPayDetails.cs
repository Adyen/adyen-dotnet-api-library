...
namespace Adyen.Checkout.Models
{
    ...
    /// PayPayDetails.
    /// </summary>
    [JsonConverter(typeof(PayPayDetailsJsonConverter))]
    ...
    public class PayPayDetailsJsonConverter : JsonConverter<PayPayDetails>
    {
        ...
        public override PayPayDetails Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
                ...
                if (utf8JsonReader.TokenType == JsonTokenType.PropertyName && currentDepth == utf8JsonReader.CurrentDepth - 1)
                {
                    ...
                    switch (jsonPropertyName)
                    {
                        ...
                        case "type":
                            ...
                            type = new Option<PayPayDetails.TypeEnum?>(PayPayDetails.TypeEnum.FromStringOrDefault(typeRawValue) ?? (PayPayDetails.TypeEnum)typeRawValue);
                            break;
                        default:
                            break;
                    }
            ...
            if (recurringDetailReference.IsSet)
                payPayDetails.RecurringDetailReference = recurringDetailReference.Value;
            if (sdkData.IsSet)
                payPayDetails.SdkData = sdkData.Value;
            if (storedPaymentMethodId.IsSet)
                payPayDetails.StoredPaymentMethodId = storedPaymentMethodId.Value;
            if (type.IsSet)
                payPayDetails.Type = type.Value;
            return payPayDetails;
        }
