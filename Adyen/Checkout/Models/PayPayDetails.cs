...
namespace Adyen.Checkout.Models
{
    ...
    /// PayPayDetails.
    /// </summary>
    public partial class PayPayDetails
    {
        /// <summary>
        ...
        public PayPayDetails(Option<string?> checkoutAttemptId = default, Option<string?> recurringDetailReference = default, Option<string?> sdkData = default, Option<string?> storedPaymentMethodId = default, Option<TypeEnum?> type = default)
        {
            ...
            _TypeOption = type.IsSet ? type : TypeEnum.Paypay;
            OnCreated();
        }
    ...
    public class PayPayDetailsJsonConverter : JsonConverter<PayPayDetails>
    {
        ...
        public override PayPayDetails Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            return new PayPayDetails(checkoutAttemptId, recurringDetailReference, sdkData, storedPaymentMethodId, type);
        }
        ...
        public void WriteProperties(Utf8JsonWriter writer, PayPayDetails payPayDetails, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (payPayDetails._CheckoutAttemptIdOption.IsSet)
                if (payPayDetails.CheckoutAttemptId != null)
            ...
            if (payPayDetails._RecurringDetailReferenceOption.IsSet)
                if (payPayDetails.RecurringDetailReference != null)
                    writer.WriteString("recurringDetailReference", payPayDetails.RecurringDetailReference);

            if (payPayDetails._SdkDataOption.IsSet)
                if (payPayDetails.SdkData != null)
                    writer.WriteString("sdkData", payPayDetails.SdkData);

            if (payPayDetails._StoredPaymentMethodIdOption.IsSet)
                if (payPayDetails.StoredPaymentMethodId != null)
