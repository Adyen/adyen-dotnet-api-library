...
namespace Adyen.Checkout.Models
{
    ...
    /// LevelTwoThree.
    /// </summary>
    [JsonConverter(typeof(LevelTwoThreeJsonConverter))]
    public partial class LevelTwoThree
    {
        /// <summary>
        ...
        /// </summary>
        /// <value>The reference number to identify the customer and their order. * Format: ASCII * Max length: 25 characters * Must not start with a space or be all spaces. * Must not be all zeros. * **additionalData key:** `enhancedSchemeData.customerReference`</value>
        ...
        /// </summary>
        /// <value>The duty tax amount, in [minor units](https://docs.adyen.com/development-resources/currency-codes). * For example, 2000 means USD 20.00. * Encoding: Numeric * Max value: 10000000000 * **additionalData key:** `enhancedSchemeData.dutyAmount`</value>
        ...
        /// </summary>
        /// <value>The shipping amount, in [minor units](https://docs.adyen.com/development-resources/currency-codes). * For example, 2000 means USD 20.00. * Encoding: Numeric * Max value: 10000000000 * **additionalData key:** `enhancedSchemeData.freightAmount`</value>
        ...
        /// </summary>
        /// <value>The date of the order. * Min Length: 10 characters * Max Length: 10 characters * Format [ISO 8601](https://www.w3.org/TR/NOTE-datetime): yyyy-MM-dd * **additionalData key:** `enhancedSchemeData.orderDate`</value>
        ...
        /// </summary>
        /// <value>The postal code of the address where the item is shipped from. * Encoding: ASCII * Max length: 10 characters * For the US, it must be in five or nine digits format. For example, 10001 or 10001-0000. * For Canada, it must be in 6 digits format. For example, M4B 1G5. * **additionalData key:** `enhancedSchemeData.shipFromPostalCode`</value>
    ...
    public class LevelTwoThreeJsonConverter : JsonConverter<LevelTwoThree>
    {
        ...
        public override LevelTwoThree Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (destination.IsSet)
                levelTwoThree.Destination = destination.Value;
            if (dutyAmount.IsSet)
                levelTwoThree.DutyAmount = dutyAmount.Value;
            if (freightAmount.IsSet)
                levelTwoThree.FreightAmount = freightAmount.Value;
            if (itemDetailLines.IsSet)
                levelTwoThree.ItemDetailLines = itemDetailLines.Value;
            if (orderDate.IsSet)
                levelTwoThree.OrderDate = orderDate.Value;
            if (shipFromPostalCode.IsSet)
                levelTwoThree.ShipFromPostalCode = shipFromPostalCode.Value;
            if (totalTaxAmount.IsSet)
                levelTwoThree.TotalTaxAmount = totalTaxAmount.Value;
