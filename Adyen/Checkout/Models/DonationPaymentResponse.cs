...
namespace Adyen.Checkout.Models
{
    ...
    /// </summary>
    [JsonConverter(typeof(DonationPaymentResponseJsonConverter))]
    public partial class DonationPaymentResponse
    {
        /// <summary>
    ...
    public class DonationPaymentResponseJsonConverter : JsonConverter<DonationPaymentResponse>
    {
        ...
        public override DonationPaymentResponse Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (donationAccount.IsSet)
                donationPaymentResponse.DonationAccount = donationAccount.Value;
            if (id.IsSet)
                donationPaymentResponse.Id = id.Value;
            if (merchantAccount.IsSet)
                donationPaymentResponse.MerchantAccount = merchantAccount.Value;
            if (payment.IsSet)
                donationPaymentResponse.Payment = payment.Value;
            if (reference.IsSet)
                donationPaymentResponse.Reference = reference.Value;
            if (status.IsSet)
                donationPaymentResponse.Status = status.Value;
