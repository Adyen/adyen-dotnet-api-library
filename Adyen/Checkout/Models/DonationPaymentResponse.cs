...
namespace Adyen.Checkout.Models
{
    ...
    public class DonationPaymentResponseJsonConverter : JsonConverter<DonationPaymentResponse>
    {
        ...
        {
            /*
            if (donationPaymentResponse._AmountOption.IsSet && donationPaymentResponse.Amount == null)
            ...
            if (donationPaymentResponse._DonationAccountOption.IsSet && donationPaymentResponse.DonationAccount == null)
            ...
            if (donationPaymentResponse._IdOption.IsSet && donationPaymentResponse.Id == null)
                throw new ArgumentNullException(nameof(donationPaymentResponse.Id), "Property is required for class DonationPaymentResponse.");

            if (donationPaymentResponse._MerchantAccountOption.IsSet && donationPaymentResponse.MerchantAccount == null)
            ...
            if (donationPaymentResponse._PaymentOption.IsSet && donationPaymentResponse.Payment == null)
            ...
            if (donationPaymentResponse._ReferenceOption.IsSet && donationPaymentResponse.Reference == null)
