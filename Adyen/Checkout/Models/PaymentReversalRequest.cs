    ...
    public class PaymentReversalRequestJsonConverter : JsonConverter<PaymentReversalRequest>
    {
        ...
        public override PaymentReversalRequest Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (merchantAccount.IsSet && merchantAccount.Value == null)
                throw new ArgumentNullException(nameof(merchantAccount), "Property is not nullable for class PaymentReversalRequest.");

            if (applicationInfo.IsSet && applicationInfo.Value == null)
                throw new ArgumentNullException(nameof(applicationInfo), "Property is not nullable for class PaymentReversalRequest.");

            if (enhancedSchemeData.IsSet && enhancedSchemeData.Value == null)
                throw new ArgumentNullException(nameof(enhancedSchemeData), "Property is not nullable for class PaymentReversalRequest.");

            if (reference.IsSet && reference.Value == null)
                throw new ArgumentNullException(nameof(reference), "Property is not nullable for class PaymentReversalRequest.");
        ...
        public void WriteProperties(Utf8JsonWriter writer, PaymentReversalRequest paymentReversalRequest, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (paymentReversalRequest.MerchantAccount == null)
                throw new ArgumentNullException(nameof(paymentReversalRequest.MerchantAccount), "Property is required for class PaymentReversalRequest.");

            if (paymentReversalRequest._ApplicationInfoOption.IsSet && paymentReversalRequest.ApplicationInfo == null)
                throw new ArgumentNullException(nameof(paymentReversalRequest.ApplicationInfo), "Property is required for class PaymentReversalRequest.");

            if (paymentReversalRequest._EnhancedSchemeDataOption.IsSet && paymentReversalRequest.EnhancedSchemeData == null)
                throw new ArgumentNullException(nameof(paymentReversalRequest.EnhancedSchemeData), "Property is required for class PaymentReversalRequest.");

            if (paymentReversalRequest._ReferenceOption.IsSet && paymentReversalRequest.Reference == null)
                throw new ArgumentNullException(nameof(paymentReversalRequest.Reference), "Property is required for class PaymentReversalRequest.");
