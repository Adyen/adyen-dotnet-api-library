...
namespace Adyen.Checkout.Models
{
    ...
    public partial class CheckoutForwardResponse
    {
        ...
        /// </summary>
        /// <param name="response">The details of the response Adyen received from the third party.</param>
        ...
        /// </summary>
        /// <value>The details of the response Adyen received from the third party.</value>
