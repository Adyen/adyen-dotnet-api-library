...
namespace Adyen.Checkout.Models
{
    ...
    /// TwintDetails.
    /// </summary>
    public partial class TwintDetails : IValidatableObject
    {
        /// <summary>
        ...
        [JsonConstructor]
        public TwintDetails(Option<string?> checkoutAttemptId = default, Option<string?> recurringDetailReference = default, Option<string?> storedPaymentMethodId = default, Option<string?> subtype = default, Option<TypeEnum?> type = default)
        {
    ...
    public class TwintDetailsJsonConverter : JsonConverter<TwintDetails>
    {
        ...
        public override TwintDetails Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
                ...
                if (utf8JsonReader.TokenType == JsonTokenType.PropertyName && currentDepth == utf8JsonReader.CurrentDepth - 1)
                {
                    ...
                    switch (jsonPropertyName)
                    {
                        ...
                        case "type":
                            ...
                            type = new Option<TwintDetails.TypeEnum?>(TwintDetails.TypeEnum.FromStringOrDefault(typeRawValue));
                            break;
                        default:
                            break;
                    }
            ...
            if (checkoutAttemptId.IsSet && checkoutAttemptId.Value == null)
                throw new ArgumentNullException(nameof(checkoutAttemptId), "Property is not nullable for class TwintDetails.");

            if (recurringDetailReference.IsSet && recurringDetailReference.Value == null)
                throw new ArgumentNullException(nameof(recurringDetailReference), "Property is not nullable for class TwintDetails.");

            if (storedPaymentMethodId.IsSet && storedPaymentMethodId.Value == null)
                throw new ArgumentNullException(nameof(storedPaymentMethodId), "Property is not nullable for class TwintDetails.");

            if (subtype.IsSet && subtype.Value == null)
                throw new ArgumentNullException(nameof(subtype), "Property is not nullable for class TwintDetails.");

            if (type.IsSet && type.Value == null)
                throw new ArgumentNullException(nameof(type), "Property is not nullable for class TwintDetails.");

            return new TwintDetails(checkoutAttemptId, recurringDetailReference, storedPaymentMethodId, subtype, type);
        }
        ...
        {
            /*
            if (twintDetails._CheckoutAttemptIdOption.IsSet && twintDetails.CheckoutAttemptId == null)
                throw new ArgumentNullException(nameof(twintDetails.CheckoutAttemptId), "Property is required for class TwintDetails.");

            if (twintDetails._RecurringDetailReferenceOption.IsSet && twintDetails.RecurringDetailReference == null)
                throw new ArgumentNullException(nameof(twintDetails.RecurringDetailReference), "Property is required for class TwintDetails.");

            if (twintDetails._StoredPaymentMethodIdOption.IsSet && twintDetails.StoredPaymentMethodId == null)
                throw new ArgumentNullException(nameof(twintDetails.StoredPaymentMethodId), "Property is required for class TwintDetails.");

            if (twintDetails._SubtypeOption.IsSet && twintDetails.Subtype == null)
                throw new ArgumentNullException(nameof(twintDetails.Subtype), "Property is required for class TwintDetails.");
