...
namespace Adyen.Checkout.Models
{
    ...
    /// PayToDetails.
    /// </summary>
    public partial class PayToDetails : IValidatableObject
    {
        /// <summary>
        ...
        [JsonConstructor]
        public PayToDetails(Option<string?> checkoutAttemptId = default, Option<string?> recurringDetailReference = default, Option<string?> shopperAccountIdentifier = default, Option<string?> storedPaymentMethodId = default, Option<TypeEnum?> type = default)
        {
            _CheckoutAttemptIdOption = checkoutAttemptId;
            _RecurringDetailReferenceOption = recurringDetailReference;
            _ShopperAccountIdentifierOption = shopperAccountIdentifier;
        ...
        /// <summary>
        /// Used to track the state of ShopperAccountIdentifier
        /// </summary>
        [JsonIgnore]
        [global::System.ComponentModel.EditorBrowsable(global::System.ComponentModel.EditorBrowsableState.Never)]
    ...
    public class PayToDetailsJsonConverter : JsonConverter<PayToDetails>
    {
        ...
        public override PayToDetails Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
                ...
                if (utf8JsonReader.TokenType == JsonTokenType.PropertyName && currentDepth == utf8JsonReader.CurrentDepth - 1)
                {
                    ...
                    switch (jsonPropertyName)
                    {
                        ...
                        case "type":
                            ...
                            type = new Option<PayToDetails.TypeEnum?>(PayToDetails.TypeEnum.FromStringOrDefault(typeRawValue));
                            break;
                        default:
                            break;
                    }
            ...
            if (checkoutAttemptId.IsSet && checkoutAttemptId.Value == null)
                throw new ArgumentNullException(nameof(checkoutAttemptId), "Property is not nullable for class PayToDetails.");

            if (recurringDetailReference.IsSet && recurringDetailReference.Value == null)
                throw new ArgumentNullException(nameof(recurringDetailReference), "Property is not nullable for class PayToDetails.");

            if (shopperAccountIdentifier.IsSet && shopperAccountIdentifier.Value == null)
                throw new ArgumentNullException(nameof(shopperAccountIdentifier), "Property is not nullable for class PayToDetails.");

            if (storedPaymentMethodId.IsSet && storedPaymentMethodId.Value == null)
                throw new ArgumentNullException(nameof(storedPaymentMethodId), "Property is not nullable for class PayToDetails.");

            if (type.IsSet && type.Value == null)
                throw new ArgumentNullException(nameof(type), "Property is not nullable for class PayToDetails.");

            return new PayToDetails(checkoutAttemptId, recurringDetailReference, shopperAccountIdentifier, storedPaymentMethodId, type);
        }
        ...
        {
            /*
            if (payToDetails._CheckoutAttemptIdOption.IsSet && payToDetails.CheckoutAttemptId == null)
                throw new ArgumentNullException(nameof(payToDetails.CheckoutAttemptId), "Property is required for class PayToDetails.");

            if (payToDetails._RecurringDetailReferenceOption.IsSet && payToDetails.RecurringDetailReference == null)
                throw new ArgumentNullException(nameof(payToDetails.RecurringDetailReference), "Property is required for class PayToDetails.");

            if (payToDetails._ShopperAccountIdentifierOption.IsSet && payToDetails.ShopperAccountIdentifier == null)
                throw new ArgumentNullException(nameof(payToDetails.ShopperAccountIdentifier), "Property is required for class PayToDetails.");

            if (payToDetails._StoredPaymentMethodIdOption.IsSet && payToDetails.StoredPaymentMethodId == null)
                throw new ArgumentNullException(nameof(payToDetails.StoredPaymentMethodId), "Property is required for class PayToDetails.");
