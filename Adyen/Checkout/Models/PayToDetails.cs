...
namespace Adyen.Checkout.Models
{
    ...
    public partial class PayToDetails
    {
        ...
        public PayToDetails(Option<string?> checkoutAttemptId = default, Option<string?> recurringDetailReference = default, Option<string?> sdkData = default, Option<string?> shopperAccountIdentifier = default, Option<string?> storedPaymentMethodId = default, Option<TypeEnum?> type = default)
        {
            ...
            _TypeOption = type.IsSet ? type : TypeEnum.Payto;
            OnCreated();
        }
    ...
    public class PayToDetailsJsonConverter : JsonConverter<PayToDetails>
    {
        ...
        public override PayToDetails Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            return new PayToDetails(checkoutAttemptId, recurringDetailReference, sdkData, shopperAccountIdentifier, storedPaymentMethodId, type);
        }
