...
namespace Adyen.Checkout.Models
{
    ...
    /// </summary>
    [JsonConverter(typeof(StoredPaymentMethodResourceJsonConverter))]
    public partial class StoredPaymentMethodResource
    {
        ...
        /// </summary>
        /// <value>The PSP reference of the first payment that created this recurring detail.</value>
    ...
    public class StoredPaymentMethodResourceJsonConverter : JsonConverter<StoredPaymentMethodResource>
    {
        ...
        public override StoredPaymentMethodResource Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (aliasType.IsSet)
                storedPaymentMethodResource.AliasType = aliasType.Value;
            if (billingAddress.IsSet)
                storedPaymentMethodResource.BillingAddress = billingAddress.Value;
            if (brand.IsSet)
                storedPaymentMethodResource.Brand = brand.Value;
            if (cardBin.IsSet)
                storedPaymentMethodResource.CardBin = cardBin.Value;
            if (createdAt.IsSet)
                storedPaymentMethodResource.CreatedAt = createdAt.Value;
            if (expiryMonth.IsSet)
                storedPaymentMethodResource.ExpiryMonth = expiryMonth.Value;
            if (expiryYear.IsSet)
                storedPaymentMethodResource.ExpiryYear = expiryYear.Value;
            if (externalResponseCode.IsSet)
                storedPaymentMethodResource.ExternalResponseCode = externalResponseCode.Value;
            if (externalTokenReference.IsSet)
                storedPaymentMethodResource.ExternalTokenReference = externalTokenReference.Value;
            if (firstPspReference.IsSet)
                storedPaymentMethodResource.FirstPspReference = firstPspReference.Value;
            if (holderName.IsSet)
                storedPaymentMethodResource.HolderName = holderName.Value;
            if (iban.IsSet)
                storedPaymentMethodResource.Iban = iban.Value;
            if (id.IsSet)
                storedPaymentMethodResource.Id = id.Value;
            if (issuerName.IsSet)
                storedPaymentMethodResource.IssuerName = issuerName.Value;
            if (lastFour.IsSet)
                storedPaymentMethodResource.LastFour = lastFour.Value;
            if (mandate.IsSet)
                storedPaymentMethodResource.Mandate = mandate.Value;
            if (name.IsSet)
            ...
            if (shopperEmail.IsSet)
                storedPaymentMethodResource.ShopperEmail = shopperEmail.Value;
            if (shopperReference.IsSet)
                storedPaymentMethodResource.ShopperReference = shopperReference.Value;
            if (supportedRecurringProcessingModels.IsSet)
                storedPaymentMethodResource.SupportedRecurringProcessingModels = supportedRecurringProcessingModels.Value;
            if (type.IsSet)
                storedPaymentMethodResource.Type = type.Value;
        ...
        public void WriteProperties(Utf8JsonWriter writer, StoredPaymentMethodResource storedPaymentMethodResource, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (storedPaymentMethodResource._BillingAddressOption.IsSet)
            {
                writer.WritePropertyName("billingAddress");
                JsonSerializer.Serialize(writer, storedPaymentMethodResource.BillingAddress, jsonSerializerOptions);
            }
            ...
            if (storedPaymentMethodResource._CreatedAtOption.IsSet)
                if (storedPaymentMethodResource._CreatedAtOption.Value != null)
                    writer.WriteString("createdAt", storedPaymentMethodResource._CreatedAtOption.Value!.Value.ToString(CreatedAtFormat));
            ...
            if (storedPaymentMethodResource._FirstPspReferenceOption.IsSet)
                if (storedPaymentMethodResource.FirstPspReference != null)
                    writer.WriteString("firstPspReference", storedPaymentMethodResource.FirstPspReference);
