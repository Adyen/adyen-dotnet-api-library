...
namespace Adyen.Checkout.Models
{
    ...
    /// VisaCheckoutDetails.
    /// </summary>
    [JsonConverter(typeof(VisaCheckoutDetailsJsonConverter))]
    public partial class VisaCheckoutDetails
    {
        ...
        {
            _TypeOption = TypeEnum.Visacheckout;
            OnCreated();
        }
    ...
    public class VisaCheckoutDetailsJsonConverter : JsonConverter<VisaCheckoutDetails>
    {
        ...
        public override VisaCheckoutDetails Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (fundingSource.IsSet)
                visaCheckoutDetails.FundingSource = fundingSource.Value;
            if (sdkData.IsSet)
                visaCheckoutDetails.SdkData = sdkData.Value;
            if (type.IsSet)
                visaCheckoutDetails.Type = type.Value;
            return visaCheckoutDetails;
        }
