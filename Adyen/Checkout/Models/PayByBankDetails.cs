...
namespace Adyen.Checkout.Models
{
    ...
    public partial class PayByBankDetails : IValidatableObject
    {
        ...
        [JsonConstructor]
        public PayByBankDetails(Option<string?> checkoutAttemptId = default, Option<string?> issuer = default, TypeEnum type = default)
        {
    ...
    public class PayByBankDetailsJsonConverter : JsonConverter<PayByBankDetails>
    {
        ...
        {
            /*
            if (payByBankDetails._CheckoutAttemptIdOption.IsSet && payByBankDetails.CheckoutAttemptId == null)
            ...
            if (payByBankDetails._IssuerOption.IsSet && payByBankDetails.Issuer == null)
