...
namespace Adyen.Checkout.Models
{
    ...
    /// IdealDetails.
    /// </summary>
    public partial class IdealDetails
    {
        /// <summary>
        ...
        public IdealDetails(Option<string?> checkoutAttemptId = default, Option<string?> issuer = default, Option<string?> recurringDetailReference = default, Option<string?> sdkData = default, Option<string?> storedPaymentMethodId = default, Option<TypeEnum?> type = default)
        {
            ...
            _TypeOption = type.IsSet ? type : TypeEnum.Ideal;
            OnCreated();
        }
    ...
    public class IdealDetailsJsonConverter : JsonConverter<IdealDetails>
    {
        ...
        public override IdealDetails Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            return new IdealDetails(checkoutAttemptId, issuer, recurringDetailReference, sdkData, storedPaymentMethodId, type);
        }
