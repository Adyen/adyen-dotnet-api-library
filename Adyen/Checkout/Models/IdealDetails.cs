...
namespace Adyen.Checkout.Models
{
    ...
    /// IdealDetails.
    /// </summary>
    [JsonConverter(typeof(IdealDetailsJsonConverter))]
    ...
    public class IdealDetailsJsonConverter : JsonConverter<IdealDetails>
    {
        ...
        public override IdealDetails Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
                ...
                if (utf8JsonReader.TokenType == JsonTokenType.PropertyName && currentDepth == utf8JsonReader.CurrentDepth - 1)
                {
                    ...
                    switch (jsonPropertyName)
                    {
                        ...
                        case "type":
                            ...
                            type = new Option<IdealDetails.TypeEnum?>(IdealDetails.TypeEnum.FromStringOrDefault(typeRawValue) ?? (IdealDetails.TypeEnum)typeRawValue);
                            break;
                        default:
                            break;
                    }
            ...
            if (issuer.IsSet)
                idealDetails.Issuer = issuer.Value;
            if (recurringDetailReference.IsSet)
                idealDetails.RecurringDetailReference = recurringDetailReference.Value;
            if (sdkData.IsSet)
                idealDetails.SdkData = sdkData.Value;
            if (storedPaymentMethodId.IsSet)
                idealDetails.StoredPaymentMethodId = storedPaymentMethodId.Value;
            if (type.IsSet)
                idealDetails.Type = type.Value;
            return idealDetails;
        }
