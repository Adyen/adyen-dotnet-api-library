...
namespace Adyen.Checkout.Models
{
    ...
    /// IdealDetails.
    /// </summary>
    public partial class IdealDetails : IValidatableObject
    {
        /// <summary>
        ...
        [JsonConstructor]
        public IdealDetails(Option<string?> checkoutAttemptId = default, Option<string?> issuer = default, Option<string?> recurringDetailReference = default, Option<string?> storedPaymentMethodId = default, Option<TypeEnum?> type = default)
        {
    ...
    /// <summary>
    /// A Json converter for type <see cref="IdealDetails" />
    /// </summary>
    public class IdealDetailsJsonConverter : JsonConverter<IdealDetails>
    {
        /// <summary>
        /// Deserializes json to <see cref="IdealDetails"/>.
        /// </summary>
        /// <param name="utf8JsonReader"><see cref="Utf8JsonReader"/></param>
        /// <param name="typeToConvert"><see cref="Type"/></param>
        /// <param name="jsonSerializerOptions">The <see cref="JsonSerializerOptions"/>, initialized from <see cref="HostConfiguration"/>.</param>
        /// <returns><see cref="IdealDetails"/></returns>
        /// <exception cref="JsonException"></exception>
        public override IdealDetails Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            Option<IdealDetails.TypeEnum?> type = default;
                ...
                if (utf8JsonReader.TokenType == JsonTokenType.PropertyName && currentDepth == utf8JsonReader.CurrentDepth - 1)
                {
                    ...
                    switch (jsonPropertyName)
                    {
                        ...
                        case "type":
                            ...
                            type = new Option<IdealDetails.TypeEnum?>(IdealDetails.TypeEnum.FromStringOrDefault(typeRawValue));
                            break;
                        default:
                            break;
                    }
            ...
            if (checkoutAttemptId.IsSet && checkoutAttemptId.Value == null)
                throw new ArgumentNullException(nameof(checkoutAttemptId), "Property is not nullable for class IdealDetails.");

            if (issuer.IsSet && issuer.Value == null)
                throw new ArgumentNullException(nameof(issuer), "Property is not nullable for class IdealDetails.");

            if (recurringDetailReference.IsSet && recurringDetailReference.Value == null)
                throw new ArgumentNullException(nameof(recurringDetailReference), "Property is not nullable for class IdealDetails.");

            if (storedPaymentMethodId.IsSet && storedPaymentMethodId.Value == null)
                throw new ArgumentNullException(nameof(storedPaymentMethodId), "Property is not nullable for class IdealDetails.");

            if (type.IsSet && type.Value == null)
                throw new ArgumentNullException(nameof(type), "Property is not nullable for class IdealDetails.");

            return new IdealDetails(checkoutAttemptId, issuer, recurringDetailReference, storedPaymentMethodId, type);
        }

        /// <summary>
        /// Serializes a <see cref="IdealDetails"/>.
        /// </summary>
        /// <param name="writer"><see cref="Utf8JsonWriter"/></param>
        /// <param name="idealDetails"></param>
        /// <param name="jsonSerializerOptions"><see cref="JsonSerializerOptions"/></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, IdealDetails idealDetails, JsonSerializerOptions jsonSerializerOptions)
        {
            
            writer.WriteStartObject();
            
            WriteProperties(writer, idealDetails, jsonSerializerOptions);
        ...
        /// <summary>
        /// Serializes the properties of <see cref="IdealDetails"/>.
        /// </summary>
        /// <param name="writer"><see creft="Utf8JsonWriter"/></param>
        /// <param name="idealDetails"></param>
        /// <param name="jsonSerializerOptions"><see cref="JsonSerializerOptions"/></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, IdealDetails idealDetails, JsonSerializerOptions jsonSerializerOptions)
        {
            /*
            if (idealDetails._CheckoutAttemptIdOption.IsSet && idealDetails.CheckoutAttemptId == null)
                throw new ArgumentNullException(nameof(idealDetails.CheckoutAttemptId), "Property is required for class IdealDetails.");

            if (idealDetails._IssuerOption.IsSet && idealDetails.Issuer == null)
                throw new ArgumentNullException(nameof(idealDetails.Issuer), "Property is required for class IdealDetails.");

            if (idealDetails._RecurringDetailReferenceOption.IsSet && idealDetails.RecurringDetailReference == null)
                throw new ArgumentNullException(nameof(idealDetails.RecurringDetailReference), "Property is required for class IdealDetails.");

            if (idealDetails._StoredPaymentMethodIdOption.IsSet && idealDetails.StoredPaymentMethodId == null)
                throw new ArgumentNullException(nameof(idealDetails.StoredPaymentMethodId), "Property is required for class IdealDetails.");

            */
            
            if (idealDetails._CheckoutAttemptIdOption.IsSet)
                writer.WriteString("checkoutAttemptId", idealDetails.CheckoutAttemptId);

            if (idealDetails._IssuerOption.IsSet)
                writer.WriteString("issuer", idealDetails.Issuer);

            if (idealDetails._RecurringDetailReferenceOption.IsSet)
                writer.WriteString("recurringDetailReference", idealDetails.RecurringDetailReference);

            if (idealDetails._StoredPaymentMethodIdOption.IsSet)
                writer.WriteString("storedPaymentMethodId", idealDetails.StoredPaymentMethodId);

            if (idealDetails._TypeOption.IsSet && idealDetails.Type != null) 
            {
                string? typeRawValue = IdealDetails.TypeEnum.ToJsonValue(idealDetails._TypeOption.Value!.Value);
