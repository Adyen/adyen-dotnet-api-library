...
namespace Adyen.Checkout.Models
{
    ...
    public class PaymentCaptureRequestJsonConverter : JsonConverter<PaymentCaptureRequest>
    {
        ...
        public void WriteProperties(Utf8JsonWriter writer, PaymentCaptureRequest paymentCaptureRequest, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (paymentCaptureRequest._ApplicationInfoOption.IsSet && paymentCaptureRequest.ApplicationInfo == null)
            ...
            if (paymentCaptureRequest._EnhancedSchemeDataOption.IsSet && paymentCaptureRequest.EnhancedSchemeData == null)
            ...
            if (paymentCaptureRequest._LineItemsOption.IsSet && paymentCaptureRequest.LineItems == null)
            ...
            if (paymentCaptureRequest._PlatformChargebackLogicOption.IsSet && paymentCaptureRequest.PlatformChargebackLogic == null)
            ...
            if (paymentCaptureRequest._ReferenceOption.IsSet && paymentCaptureRequest.Reference == null)
            ...
            if (paymentCaptureRequest._SplitsOption.IsSet && paymentCaptureRequest.Splits == null)
                throw new ArgumentNullException(nameof(paymentCaptureRequest.Splits), "Property is required for class PaymentCaptureRequest.");

            if (paymentCaptureRequest._SubMerchantsOption.IsSet && paymentCaptureRequest.SubMerchants == null)
