...
namespace Adyen.Checkout.Models
{
    ...
    public partial class PaymentCaptureRequest
    {
        ...
        /// </summary>
        /// <param name="amount">The amount that you want to capture. The &#x60;currency&#x60; must match the currency used in authorisation, the &#x60;value&#x60; must be smaller than or equal to the authorised amount.</param>
        ...
        /// </summary>
        /// <value>The amount that you want to capture. The `currency` must match the currency used in authorisation, the `value` must be smaller than or equal to the authorised amount.</value>
