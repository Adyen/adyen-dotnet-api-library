...
namespace Adyen.Checkout.Models
{
    ...
    public class CheckoutBankAccountJsonConverter : JsonConverter<CheckoutBankAccount>
    {
        ...
        {
            /*
            if (checkoutBankAccount._BankAccountNumberOption.IsSet && checkoutBankAccount.BankAccountNumber == null)
            ...
            if (checkoutBankAccount._BankCityOption.IsSet && checkoutBankAccount.BankCity == null)
                throw new ArgumentNullException(nameof(checkoutBankAccount.BankCity), "Property is required for class CheckoutBankAccount.");

            if (checkoutBankAccount._BankLocationIdOption.IsSet && checkoutBankAccount.BankLocationId == null)
