...
namespace Adyen.Checkout.Models
{
    ...
    public partial class ThreeDSRequestorAuthenticationInfo : IValidatableObject
    {
        ...
        /// <summary>
        /// Used to track whether ThreeDSReqAuthMethod is set or not.
        /// </summary>
        [JsonIgnore]
    ...
    public class ThreeDSRequestorAuthenticationInfoJsonConverter : JsonConverter<ThreeDSRequestorAuthenticationInfo>
    {
        ...
        {
            /*
            if (threeDSRequestorAuthenticationInfo._ThreeDSReqAuthDataOption.IsSet && threeDSRequestorAuthenticationInfo.ThreeDSReqAuthData == null)
            ...
            if (threeDSRequestorAuthenticationInfo._ThreeDSReqAuthTimestampOption.IsSet && threeDSRequestorAuthenticationInfo.ThreeDSReqAuthTimestamp == null)
