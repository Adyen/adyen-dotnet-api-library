...
namespace Adyen.Checkout.Models
{
    ...
    /// </summary>
    public partial class StandalonePaymentCancelResponse : IValidatableObject
    {
        /// <summary>
    ...
    public class StandalonePaymentCancelResponseJsonConverter : JsonConverter<StandalonePaymentCancelResponse>
    {
        ...
        public override StandalonePaymentCancelResponse Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (merchantAccount.IsSet && merchantAccount.Value == null)
                throw new ArgumentNullException(nameof(merchantAccount), "Property is not nullable for class StandalonePaymentCancelResponse.");

            if (paymentReference.IsSet && paymentReference.Value == null)
                throw new ArgumentNullException(nameof(paymentReference), "Property is not nullable for class StandalonePaymentCancelResponse.");

            if (pspReference.IsSet && pspReference.Value == null)
                throw new ArgumentNullException(nameof(pspReference), "Property is not nullable for class StandalonePaymentCancelResponse.");

            if (status.IsSet && status.Value == null)
                throw new ArgumentNullException(nameof(status), "Property is not nullable for class StandalonePaymentCancelResponse.");

            if (reference.IsSet && reference.Value == null)
                throw new ArgumentNullException(nameof(reference), "Property is not nullable for class StandalonePaymentCancelResponse.");
        ...
        public void WriteProperties(Utf8JsonWriter writer, StandalonePaymentCancelResponse standalonePaymentCancelResponse, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (standalonePaymentCancelResponse.MerchantAccount == null)
                throw new ArgumentNullException(nameof(standalonePaymentCancelResponse.MerchantAccount), "Property is required for class StandalonePaymentCancelResponse.");

            if (standalonePaymentCancelResponse.PaymentReference == null)
                throw new ArgumentNullException(nameof(standalonePaymentCancelResponse.PaymentReference), "Property is required for class StandalonePaymentCancelResponse.");

            if (standalonePaymentCancelResponse.PspReference == null)
                throw new ArgumentNullException(nameof(standalonePaymentCancelResponse.PspReference), "Property is required for class StandalonePaymentCancelResponse.");

            if (standalonePaymentCancelResponse._ReferenceOption.IsSet && standalonePaymentCancelResponse.Reference == null)
                throw new ArgumentNullException(nameof(standalonePaymentCancelResponse.Reference), "Property is required for class StandalonePaymentCancelResponse.");
