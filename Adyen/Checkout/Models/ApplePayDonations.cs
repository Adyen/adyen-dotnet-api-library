...
namespace Adyen.Checkout.Models
{
    ...
    /// ApplePayDonations.
    /// </summary>
    public partial class ApplePayDonations
    {
        /// <summary>
        ...
        public ApplePayDonations(string applePayToken, Option<string?> checkoutAttemptId = default, Option<FundingSourceEnum?> fundingSource = default, Option<string?> recurringDetailReference = default, Option<string?> sdkData = default, Option<string?> storedPaymentMethodId = default, Option<TypeEnum?> type = default)
        {
            ...
            _TypeOption = type.IsSet ? type : TypeEnum.Applepay;
            OnCreated();
        }
    ...
    public class ApplePayDonationsJsonConverter : JsonConverter<ApplePayDonations>
    {
        ...
        public override ApplePayDonations Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            return new ApplePayDonations(applePayToken.Value!, checkoutAttemptId, fundingSource, recurringDetailReference, sdkData, storedPaymentMethodId, type);
        }
        ...
        public void WriteProperties(Utf8JsonWriter writer, ApplePayDonations applePayDonations, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (applePayDonations._CheckoutAttemptIdOption.IsSet)
                if (applePayDonations.CheckoutAttemptId != null)
            ...
            if (applePayDonations._RecurringDetailReferenceOption.IsSet)
                if (applePayDonations.RecurringDetailReference != null)
                    writer.WriteString("recurringDetailReference", applePayDonations.RecurringDetailReference);

            if (applePayDonations._SdkDataOption.IsSet)
                if (applePayDonations.SdkData != null)
                    writer.WriteString("sdkData", applePayDonations.SdkData);

            if (applePayDonations._StoredPaymentMethodIdOption.IsSet)
                if (applePayDonations.StoredPaymentMethodId != null)
