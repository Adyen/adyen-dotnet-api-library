...
namespace Adyen.Checkout.Models
{
    ...
    /// ApplePayDonations.
    /// </summary>
    public partial class ApplePayDonations : IValidatableObject
    {
        /// <summary>
        ...
        [JsonConstructor]
        public ApplePayDonations(string applePayToken, Option<string?> checkoutAttemptId = default, Option<FundingSourceEnum?> fundingSource = default, Option<string?> recurringDetailReference = default, Option<string?> storedPaymentMethodId = default, Option<TypeEnum?> type = default)
        {
    ...
    /// <summary>
    /// A Json converter for type <see cref="ApplePayDonations" />
    /// </summary>
    public class ApplePayDonationsJsonConverter : JsonConverter<ApplePayDonations>
    {
        /// <summary>
        /// Deserializes json to <see cref="ApplePayDonations"/>.
        /// </summary>
        /// <param name="utf8JsonReader"><see cref="Utf8JsonReader"/></param>
        /// <param name="typeToConvert"><see cref="Type"/></param>
        /// <param name="jsonSerializerOptions">The <see cref="JsonSerializerOptions"/>, initialized from <see cref="HostConfiguration"/>.</param>
        /// <returns><see cref="ApplePayDonations"/></returns>
        /// <exception cref="JsonException"></exception>
        public override ApplePayDonations Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            Option<ApplePayDonations.FundingSourceEnum?> fundingSource = default;
            Option<string?> recurringDetailReference = default;
            Option<string?> storedPaymentMethodId = default;
            Option<ApplePayDonations.TypeEnum?> type = default;
            ...
            if (applePayToken.IsSet && applePayToken.Value == null)
                throw new ArgumentNullException(nameof(applePayToken), "Property is not nullable for class ApplePayDonations.");

            if (checkoutAttemptId.IsSet && checkoutAttemptId.Value == null)
                throw new ArgumentNullException(nameof(checkoutAttemptId), "Property is not nullable for class ApplePayDonations.");

            if (fundingSource.IsSet && fundingSource.Value == null)
                throw new ArgumentNullException(nameof(fundingSource), "Property is not nullable for class ApplePayDonations.");

            if (recurringDetailReference.IsSet && recurringDetailReference.Value == null)
                throw new ArgumentNullException(nameof(recurringDetailReference), "Property is not nullable for class ApplePayDonations.");

            if (storedPaymentMethodId.IsSet && storedPaymentMethodId.Value == null)
                throw new ArgumentNullException(nameof(storedPaymentMethodId), "Property is not nullable for class ApplePayDonations.");

            if (type.IsSet && type.Value == null)
                throw new ArgumentNullException(nameof(type), "Property is not nullable for class ApplePayDonations.");

            return new ApplePayDonations(applePayToken.Value!, checkoutAttemptId, fundingSource, recurringDetailReference, storedPaymentMethodId, type);
        }

        /// <summary>
        /// Serializes a <see cref="ApplePayDonations"/>.
        /// </summary>
        /// <param name="writer"><see cref="Utf8JsonWriter"/></param>
        /// <param name="applePayDonations"></param>
        /// <param name="jsonSerializerOptions"><see cref="JsonSerializerOptions"/></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, ApplePayDonations applePayDonations, JsonSerializerOptions jsonSerializerOptions)
        {
            
            writer.WriteStartObject();
            
            WriteProperties(writer, applePayDonations, jsonSerializerOptions);
        ...
        /// <summary>
        /// Serializes the properties of <see cref="ApplePayDonations"/>.
        /// </summary>
        /// <param name="writer"><see creft="Utf8JsonWriter"/></param>
        /// <param name="applePayDonations"></param>
        /// <param name="jsonSerializerOptions"><see cref="JsonSerializerOptions"/></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, ApplePayDonations applePayDonations, JsonSerializerOptions jsonSerializerOptions)
        {
            /*
            if (applePayDonations.ApplePayToken == null)
                throw new ArgumentNullException(nameof(applePayDonations.ApplePayToken), "Property is required for class ApplePayDonations.");

            if (applePayDonations._CheckoutAttemptIdOption.IsSet && applePayDonations.CheckoutAttemptId == null)
                throw new ArgumentNullException(nameof(applePayDonations.CheckoutAttemptId), "Property is required for class ApplePayDonations.");

            if (applePayDonations._RecurringDetailReferenceOption.IsSet && applePayDonations.RecurringDetailReference == null)
                throw new ArgumentNullException(nameof(applePayDonations.RecurringDetailReference), "Property is required for class ApplePayDonations.");

            if (applePayDonations._StoredPaymentMethodIdOption.IsSet && applePayDonations.StoredPaymentMethodId == null)
                throw new ArgumentNullException(nameof(applePayDonations.StoredPaymentMethodId), "Property is required for class ApplePayDonations.");

            */
            
            writer.WriteString("applePayToken", applePayDonations.ApplePayToken);

            if (applePayDonations._CheckoutAttemptIdOption.IsSet)
                writer.WriteString("checkoutAttemptId", applePayDonations.CheckoutAttemptId);

            if (applePayDonations._FundingSourceOption.IsSet && applePayDonations.FundingSource != null) 
            {
                string? fundingSourceRawValue = ApplePayDonations.FundingSourceEnum.ToJsonValue(applePayDonations._FundingSourceOption.Value!.Value);
                writer.WriteString("fundingSource", fundingSourceRawValue);
            }
            
            if (applePayDonations._RecurringDetailReferenceOption.IsSet)
                writer.WriteString("recurringDetailReference", applePayDonations.RecurringDetailReference);

            if (applePayDonations._StoredPaymentMethodIdOption.IsSet)
                writer.WriteString("storedPaymentMethodId", applePayDonations.StoredPaymentMethodId);

            if (applePayDonations._TypeOption.IsSet && applePayDonations.Type != null) 
            {
                string? typeRawValue = ApplePayDonations.TypeEnum.ToJsonValue(applePayDonations._TypeOption.Value!.Value);
