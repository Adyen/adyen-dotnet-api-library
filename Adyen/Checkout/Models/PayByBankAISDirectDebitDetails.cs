...
namespace Adyen.Checkout.Models
{
    ...
    public partial class PayByBankAISDirectDebitDetails : IValidatableObject
    {
        ...
        [JsonConstructor]
        public PayByBankAISDirectDebitDetails(Option<string?> checkoutAttemptId = default, Option<string?> recurringDetailReference = default, Option<string?> storedPaymentMethodId = default, TypeEnum type = default)
        {
    ...
    public class PayByBankAISDirectDebitDetailsJsonConverter : JsonConverter<PayByBankAISDirectDebitDetails>
    {
        ...
        {
            /*
            if (payByBankAISDirectDebitDetails._CheckoutAttemptIdOption.IsSet && payByBankAISDirectDebitDetails.CheckoutAttemptId == null)
            ...
            if (payByBankAISDirectDebitDetails._RecurringDetailReferenceOption.IsSet && payByBankAISDirectDebitDetails.RecurringDetailReference == null)
            ...
            if (payByBankAISDirectDebitDetails._StoredPaymentMethodIdOption.IsSet && payByBankAISDirectDebitDetails.StoredPaymentMethodId == null)
