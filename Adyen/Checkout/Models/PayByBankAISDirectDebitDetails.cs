...
namespace Adyen.Checkout.Models
{
    ...
    /// </summary>
    [JsonConverter(typeof(PayByBankAISDirectDebitDetailsJsonConverter))]
    ...
    public class PayByBankAISDirectDebitDetailsJsonConverter : JsonConverter<PayByBankAISDirectDebitDetails>
    {
        ...
        public override PayByBankAISDirectDebitDetails Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (checkoutAttemptId.IsSet)
                payByBankAISDirectDebitDetails.CheckoutAttemptId = checkoutAttemptId.Value;
            if (recurringDetailReference.IsSet)
                payByBankAISDirectDebitDetails.RecurringDetailReference = recurringDetailReference.Value;
            if (sdkData.IsSet)
