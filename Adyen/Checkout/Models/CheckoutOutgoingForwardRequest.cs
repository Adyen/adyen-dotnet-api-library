...
namespace Adyen.Checkout.Models
{
    ...
    /// </summary>
    [JsonConverter(typeof(CheckoutOutgoingForwardRequestJsonConverter))]
    public partial class CheckoutOutgoingForwardRequest
    {
        ...
        public class HttpMethodEnum : IEnum
        {
            ...
            /// <summary>
            /// Compares two <see cref="HttpMethodEnum"/> instances for equality.
            /// </summary>
            ...
            /// <summary>
            /// Compares two <see cref="HttpMethodEnum"/> instances for inequality.
            /// </summary>
            public static bool operator !=(HttpMethodEnum? left, HttpMethodEnum? right) => !string.Equals(left?.Value, right?.Value, StringComparison.OrdinalIgnoreCase);

            /// <summary>
            /// Returns true if the given object is equal to this <see cref="HttpMethodEnum"/> instance.
            /// </summary>
            ...
            /// <summary>
            /// Returns a hash code for this <see cref="HttpMethodEnum"/> instance.
            /// </summary>
            public override int GetHashCode() => Value?.GetHashCode() ?? 0;

            /// <summary>
            /// Returns the string value of the <see cref="HttpMethodEnum"/> instance.
            /// </summary>
            ...
            {
                /// <summary>
                /// Deserializes a <see cref="HttpMethodEnum"/> from JSON.
                /// </summary>
                ...
                /// <summary>
                /// Serializes a <see cref="HttpMethodEnum"/> to JSON.
                /// </summary>
    ...
    public class CheckoutOutgoingForwardRequestJsonConverter : JsonConverter<CheckoutOutgoingForwardRequest>
    {
        ...
        public override CheckoutOutgoingForwardRequest Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (headers.IsSet)
                checkoutOutgoingForwardRequest.Headers = headers.Value;
            if (urlSuffix.IsSet)
                checkoutOutgoingForwardRequest.UrlSuffix = urlSuffix.Value;
            return checkoutOutgoingForwardRequest;
        }
