...
namespace Adyen.Checkout.Models
{
    ...
    /// </summary>
    public partial class PaymentCancelRequest : IValidatableObject
    {
        /// <summary>
        ...
        [JsonConstructor]
        public PaymentCancelRequest(string merchantAccount, Option<ApplicationInfo?> applicationInfo = default, Option<EnhancedSchemeData?> enhancedSchemeData = default, Option<string?> reference = default)
        {
    ...
    /// <summary>
    /// A Json converter for type <see cref="PaymentCancelRequest" />
    /// </summary>
    public class PaymentCancelRequestJsonConverter : JsonConverter<PaymentCancelRequest>
    {
        /// <summary>
        /// Deserializes json to <see cref="PaymentCancelRequest"/>.
        /// </summary>
        /// <param name="utf8JsonReader"><see cref="Utf8JsonReader"/></param>
        /// <param name="typeToConvert"><see cref="Type"/></param>
        /// <param name="jsonSerializerOptions">The <see cref="JsonSerializerOptions"/>, initialized from <see cref="HostConfiguration"/>.</param>
        /// <returns><see cref="PaymentCancelRequest"/></returns>
        /// <exception cref="JsonException"></exception>
        public override PaymentCancelRequest Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (merchantAccount.IsSet && merchantAccount.Value == null)
                throw new ArgumentNullException(nameof(merchantAccount), "Property is not nullable for class PaymentCancelRequest.");

            if (applicationInfo.IsSet && applicationInfo.Value == null)
                throw new ArgumentNullException(nameof(applicationInfo), "Property is not nullable for class PaymentCancelRequest.");

            if (enhancedSchemeData.IsSet && enhancedSchemeData.Value == null)
                throw new ArgumentNullException(nameof(enhancedSchemeData), "Property is not nullable for class PaymentCancelRequest.");

            if (reference.IsSet && reference.Value == null)
                throw new ArgumentNullException(nameof(reference), "Property is not nullable for class PaymentCancelRequest.");

            return new PaymentCancelRequest(merchantAccount.Value!, applicationInfo, enhancedSchemeData, reference);
        }

        /// <summary>
        /// Serializes a <see cref="PaymentCancelRequest"/>.
        /// </summary>
        ...
        public override void Write(Utf8JsonWriter writer, PaymentCancelRequest paymentCancelRequest, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            WriteProperties(writer, paymentCancelRequest, jsonSerializerOptions);
        ...
        /// <summary>
        /// Serializes the properties of <see cref="PaymentCancelRequest"/>.
        /// </summary>
        ...
        {
            /*
            if (paymentCancelRequest.MerchantAccount == null)
                throw new ArgumentNullException(nameof(paymentCancelRequest.MerchantAccount), "Property is required for class PaymentCancelRequest.");

            if (paymentCancelRequest._ApplicationInfoOption.IsSet && paymentCancelRequest.ApplicationInfo == null)
                throw new ArgumentNullException(nameof(paymentCancelRequest.ApplicationInfo), "Property is required for class PaymentCancelRequest.");

            if (paymentCancelRequest._EnhancedSchemeDataOption.IsSet && paymentCancelRequest.EnhancedSchemeData == null)
                throw new ArgumentNullException(nameof(paymentCancelRequest.EnhancedSchemeData), "Property is required for class PaymentCancelRequest.");

            if (paymentCancelRequest._ReferenceOption.IsSet && paymentCancelRequest.Reference == null)
                throw new ArgumentNullException(nameof(paymentCancelRequest.Reference), "Property is required for class PaymentCancelRequest.");

            */
            
            writer.WriteString("merchantAccount", paymentCancelRequest.MerchantAccount);

            if (paymentCancelRequest._ApplicationInfoOption.IsSet)
            {
                writer.WritePropertyName("applicationInfo");
                JsonSerializer.Serialize(writer, paymentCancelRequest.ApplicationInfo, jsonSerializerOptions);
            }
            if (paymentCancelRequest._EnhancedSchemeDataOption.IsSet)
            {
                writer.WritePropertyName("enhancedSchemeData");
                JsonSerializer.Serialize(writer, paymentCancelRequest.EnhancedSchemeData, jsonSerializerOptions);
            }
            if (paymentCancelRequest._ReferenceOption.IsSet)
                writer.WriteString("reference", paymentCancelRequest.Reference);
        }
    }
}
