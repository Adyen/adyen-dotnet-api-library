...
namespace Adyen.Checkout.Models
{
    ...
    /// </summary>
    [JsonConverter(typeof(PaymentCancelRequestJsonConverter))]
    ...
    public class PaymentCancelRequestJsonConverter : JsonConverter<PaymentCancelRequest>
    {
        ...
        public override PaymentCancelRequest Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (merchantAccount.IsSet)
                paymentCancelRequest.MerchantAccount = merchantAccount.Value!;
            if (applicationInfo.IsSet)
                paymentCancelRequest.ApplicationInfo = applicationInfo.Value;
            if (enhancedSchemeData.IsSet)
                paymentCancelRequest.EnhancedSchemeData = enhancedSchemeData.Value;
            if (reference.IsSet)
                paymentCancelRequest.Reference = reference.Value;
