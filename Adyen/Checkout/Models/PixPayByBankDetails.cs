...
namespace Adyen.Checkout.Models
{
    ...
    public partial class PixPayByBankDetails
    {
        ...
        /// <param name="riskSignals">riskSignals</param>
        ...
        /// <param name="type">**paybybank_pix** (default to TypeEnum.PaybybankPix)</param>
        public PixPayByBankDetails(Option<string?> checkoutAttemptId = default, Option<string?> deviceId = default, Option<string?> issuer = default, Option<string?> recurringDetailReference = default, Option<PixPayByBankRiskSignals?> riskSignals = default, Option<string?> sdkData = default, Option<string?> storedPaymentMethodId = default, Option<TypeEnum?> type = default)
        {
            ...
            _RiskSignalsOption = riskSignals;
            _SdkDataOption = sdkData;
            _StoredPaymentMethodIdOption = storedPaymentMethodId;
            _TypeOption = type.IsSet ? type : TypeEnum.PaybybankPix;
            OnCreated();
        }
    ...
    public class PixPayByBankDetailsJsonConverter : JsonConverter<PixPayByBankDetails>
    {
        ...
        public override PixPayByBankDetails Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            return new PixPayByBankDetails(checkoutAttemptId, deviceId, issuer, recurringDetailReference, riskSignals, sdkData, storedPaymentMethodId, type);
        }
