    ...
    public class StandalonePaymentCancelRequestJsonConverter : JsonConverter<StandalonePaymentCancelRequest>
    {
        ...
        public override StandalonePaymentCancelRequest Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (merchantAccount.IsSet && merchantAccount.Value == null)
                throw new ArgumentNullException(nameof(merchantAccount), "Property is not nullable for class StandalonePaymentCancelRequest.");

            if (paymentReference.IsSet && paymentReference.Value == null)
                throw new ArgumentNullException(nameof(paymentReference), "Property is not nullable for class StandalonePaymentCancelRequest.");

            if (applicationInfo.IsSet && applicationInfo.Value == null)
                throw new ArgumentNullException(nameof(applicationInfo), "Property is not nullable for class StandalonePaymentCancelRequest.");

            if (enhancedSchemeData.IsSet && enhancedSchemeData.Value == null)
                throw new ArgumentNullException(nameof(enhancedSchemeData), "Property is not nullable for class StandalonePaymentCancelRequest.");

            if (reference.IsSet && reference.Value == null)
                throw new ArgumentNullException(nameof(reference), "Property is not nullable for class StandalonePaymentCancelRequest.");
        ...
        public void WriteProperties(Utf8JsonWriter writer, StandalonePaymentCancelRequest standalonePaymentCancelRequest, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (standalonePaymentCancelRequest.MerchantAccount == null)
                throw new ArgumentNullException(nameof(standalonePaymentCancelRequest.MerchantAccount), "Property is required for class StandalonePaymentCancelRequest.");

            if (standalonePaymentCancelRequest.PaymentReference == null)
                throw new ArgumentNullException(nameof(standalonePaymentCancelRequest.PaymentReference), "Property is required for class StandalonePaymentCancelRequest.");

            if (standalonePaymentCancelRequest._ApplicationInfoOption.IsSet && standalonePaymentCancelRequest.ApplicationInfo == null)
                throw new ArgumentNullException(nameof(standalonePaymentCancelRequest.ApplicationInfo), "Property is required for class StandalonePaymentCancelRequest.");

            if (standalonePaymentCancelRequest._EnhancedSchemeDataOption.IsSet && standalonePaymentCancelRequest.EnhancedSchemeData == null)
                throw new ArgumentNullException(nameof(standalonePaymentCancelRequest.EnhancedSchemeData), "Property is required for class StandalonePaymentCancelRequest.");

            if (standalonePaymentCancelRequest._ReferenceOption.IsSet && standalonePaymentCancelRequest.Reference == null)
                throw new ArgumentNullException(nameof(standalonePaymentCancelRequest.Reference), "Property is required for class StandalonePaymentCancelRequest.");
            ...
            */
            ...
            if (standalonePaymentCancelRequest._EnhancedSchemeDataOption.IsSet)
            {
                writer.WritePropertyName("enhancedSchemeData");
                JsonSerializer.Serialize(writer, standalonePaymentCancelRequest.EnhancedSchemeData, jsonSerializerOptions);
            }
