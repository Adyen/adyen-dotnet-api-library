...
namespace Adyen.Checkout.Models
{
    ...
    public partial class PayWithGoogleDetails
    {
        ...
        public PayWithGoogleDetails(string googlePayToken, Option<string?> checkoutAttemptId = default, Option<FundingSourceEnum?> fundingSource = default, Option<string?> recurringDetailReference = default, Option<string?> sdkData = default, Option<string?> storedPaymentMethodId = default, Option<string?> threeDS2SdkVersion = default, Option<TypeEnum?> type = default)
        {
            ...
            _TypeOption = type.IsSet ? type : TypeEnum.Paywithgoogle;
            OnCreated();
        }
    ...
    public class PayWithGoogleDetailsJsonConverter : JsonConverter<PayWithGoogleDetails>
    {
        ...
        public override PayWithGoogleDetails Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            return new PayWithGoogleDetails(googlePayToken.Value!, checkoutAttemptId, fundingSource, recurringDetailReference, sdkData, storedPaymentMethodId, threeDS2SdkVersion, type);
        }
