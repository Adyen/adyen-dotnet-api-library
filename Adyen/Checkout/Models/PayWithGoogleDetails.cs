...
namespace Adyen.Checkout.Models
{
    ...
    public class PayWithGoogleDetailsJsonConverter : JsonConverter<PayWithGoogleDetails>
    {
        ...
        /// <returns><see cref="PayWithGoogleDetails"/></returns>
                ...
                if (utf8JsonReader.TokenType == JsonTokenType.PropertyName && currentDepth == utf8JsonReader.CurrentDepth - 1)
                {
                    ...
                    switch (jsonPropertyName)
                    {
                        ...
                        case "fundingSource":
                            ...
                            fundingSource = new Option<PayWithGoogleDetails.FundingSourceEnum?>(PayWithGoogleDetails.FundingSourceEnum.FromStringOrDefault(fundingSourceRawValue));
                            break;
                        ...
                        case "type":
                            ...
                            type = new Option<PayWithGoogleDetails.TypeEnum?>(PayWithGoogleDetails.TypeEnum.FromStringOrDefault(typeRawValue));
                            break;
                        default:
                            break;
                    }
        ...
        public void WriteProperties(Utf8JsonWriter writer, PayWithGoogleDetails payWithGoogleDetails, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (payWithGoogleDetails._CheckoutAttemptIdOption.IsSet && payWithGoogleDetails.CheckoutAttemptId == null)
            ...
            if (payWithGoogleDetails._RecurringDetailReferenceOption.IsSet && payWithGoogleDetails.RecurringDetailReference == null)
            ...
            if (payWithGoogleDetails._StoredPaymentMethodIdOption.IsSet && payWithGoogleDetails.StoredPaymentMethodId == null)
            ...
            if (payWithGoogleDetails._ThreeDS2SdkVersionOption.IsSet && payWithGoogleDetails.ThreeDS2SdkVersion == null)
            ...
            */
            ...
            if (payWithGoogleDetails._CheckoutAttemptIdOption.IsSet)
                writer.WriteString("checkoutAttemptId", payWithGoogleDetails.CheckoutAttemptId);

            if (payWithGoogleDetails._FundingSourceOption.IsSet && payWithGoogleDetails.FundingSource != null) 
            {
                string? fundingSourceRawValue = PayWithGoogleDetails.FundingSourceEnum.ToJsonValue(payWithGoogleDetails._FundingSourceOption.Value!.Value);
                writer.WriteString("fundingSource", fundingSourceRawValue);
            }
            
            if (payWithGoogleDetails._RecurringDetailReferenceOption.IsSet)
                writer.WriteString("recurringDetailReference", payWithGoogleDetails.RecurringDetailReference);

            if (payWithGoogleDetails._StoredPaymentMethodIdOption.IsSet)
                writer.WriteString("storedPaymentMethodId", payWithGoogleDetails.StoredPaymentMethodId);

            if (payWithGoogleDetails._ThreeDS2SdkVersionOption.IsSet)
                writer.WriteString("threeDS2SdkVersion", payWithGoogleDetails.ThreeDS2SdkVersion);

            if (payWithGoogleDetails._TypeOption.IsSet && payWithGoogleDetails.Type != null) 
            {
                string? typeRawValue = PayWithGoogleDetails.TypeEnum.ToJsonValue(payWithGoogleDetails._TypeOption.Value!.Value);
