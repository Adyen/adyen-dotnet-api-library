...
namespace Adyen.Checkout.Models
{
    ...
    /// </summary>
    [JsonConverter(typeof(PayWithGoogleDetailsJsonConverter))]
    public partial class PayWithGoogleDetails
    {
        ...
        {
            _TypeOption = TypeEnum.Paywithgoogle;
            OnCreated();
        }
    ...
    public class PayWithGoogleDetailsJsonConverter : JsonConverter<PayWithGoogleDetails>
    {
        ...
        public override PayWithGoogleDetails Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
                ...
                if (utf8JsonReader.TokenType == JsonTokenType.PropertyName && currentDepth == utf8JsonReader.CurrentDepth - 1)
                {
                    ...
                    switch (jsonPropertyName)
                    {
                        ...
                        case "fundingSource":
                            ...
                            fundingSource = new Option<PayWithGoogleDetails.FundingSourceEnum?>(PayWithGoogleDetails.FundingSourceEnum.FromStringOrDefault(fundingSourceRawValue) ?? (PayWithGoogleDetails.FundingSourceEnum)fundingSourceRawValue);
                            break;
                        ...
                        case "type":
                            ...
                            type = new Option<PayWithGoogleDetails.TypeEnum?>(PayWithGoogleDetails.TypeEnum.FromStringOrDefault(typeRawValue) ?? (PayWithGoogleDetails.TypeEnum)typeRawValue);
                            break;
                        default:
                            break;
                    }
            ...
            var payWithGoogleDetails = new PayWithGoogleDetails();
            payWithGoogleDetails.GooglePayToken = googlePayToken.Value!;
            if (checkoutAttemptId.IsSet)
                payWithGoogleDetails.CheckoutAttemptId = checkoutAttemptId.Value;
            if (fundingSource.IsSet)
                payWithGoogleDetails.FundingSource = fundingSource.Value;
            if (recurringDetailReference.IsSet)
                payWithGoogleDetails.RecurringDetailReference = recurringDetailReference.Value;
            if (sdkData.IsSet)
                payWithGoogleDetails.SdkData = sdkData.Value;
            if (storedPaymentMethodId.IsSet)
                payWithGoogleDetails.StoredPaymentMethodId = storedPaymentMethodId.Value;
            if (threeDS2SdkVersion.IsSet)
                payWithGoogleDetails.ThreeDS2SdkVersion = threeDS2SdkVersion.Value;
            if (type.IsSet)
                payWithGoogleDetails.Type = type.Value;
            return payWithGoogleDetails;
        }
        ...
        public void WriteProperties(Utf8JsonWriter writer, PayWithGoogleDetails payWithGoogleDetails, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (payWithGoogleDetails._CheckoutAttemptIdOption.IsSet)
                if (payWithGoogleDetails.CheckoutAttemptId != null)
            ...
            if (payWithGoogleDetails._RecurringDetailReferenceOption.IsSet)
                if (payWithGoogleDetails.RecurringDetailReference != null)
                    writer.WriteString("recurringDetailReference", payWithGoogleDetails.RecurringDetailReference);

            if (payWithGoogleDetails._SdkDataOption.IsSet)
                if (payWithGoogleDetails.SdkData != null)
                    writer.WriteString("sdkData", payWithGoogleDetails.SdkData);

            if (payWithGoogleDetails._StoredPaymentMethodIdOption.IsSet)
                if (payWithGoogleDetails.StoredPaymentMethodId != null)
            ...
            if (payWithGoogleDetails._ThreeDS2SdkVersionOption.IsSet)
                if (payWithGoogleDetails.ThreeDS2SdkVersion != null)
