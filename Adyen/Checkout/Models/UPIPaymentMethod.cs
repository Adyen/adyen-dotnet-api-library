    ...
    public class UPIPaymentMethodJsonConverter : JsonConverter<UPIPaymentMethod>
    {
        ...
        public override UPIPaymentMethod Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (type.IsSet && type.Value == null)
                throw new ArgumentNullException(nameof(type), "Property is not nullable for class UPIPaymentMethod.");

            if (virtualPaymentAddress.IsSet && virtualPaymentAddress.Value == null)
                throw new ArgumentNullException(nameof(virtualPaymentAddress), "Property is not nullable for class UPIPaymentMethod.");
        ...
        {
            /*
            if (uPIPaymentMethod._VirtualPaymentAddressOption.IsSet && uPIPaymentMethod.VirtualPaymentAddress == null)
                throw new ArgumentNullException(nameof(uPIPaymentMethod.VirtualPaymentAddress), "Property is required for class UPIPaymentMethod.");
