    ...
    public class CreateOrderRequestJsonConverter : JsonConverter<CreateOrderRequest>
    {
        ...
        public override CreateOrderRequest Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (merchantAccount.IsSet && merchantAccount.Value == null)
                throw new ArgumentNullException(nameof(merchantAccount), "Property is not nullable for class CreateOrderRequest.");

            if (reference.IsSet && reference.Value == null)
                throw new ArgumentNullException(nameof(reference), "Property is not nullable for class CreateOrderRequest.");

            if (expiresAt.IsSet && expiresAt.Value == null)
                throw new ArgumentNullException(nameof(expiresAt), "Property is not nullable for class CreateOrderRequest.");
        ...
        public void WriteProperties(Utf8JsonWriter writer, CreateOrderRequest createOrderRequest, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (createOrderRequest.Amount == null)
                throw new ArgumentNullException(nameof(createOrderRequest.Amount), "Property is required for class CreateOrderRequest.");

            if (createOrderRequest.MerchantAccount == null)
                throw new ArgumentNullException(nameof(createOrderRequest.MerchantAccount), "Property is required for class CreateOrderRequest.");

            if (createOrderRequest.Reference == null)
                throw new ArgumentNullException(nameof(createOrderRequest.Reference), "Property is required for class CreateOrderRequest.");

            if (createOrderRequest._ExpiresAtOption.IsSet && createOrderRequest.ExpiresAt == null)
                throw new ArgumentNullException(nameof(createOrderRequest.ExpiresAt), "Property is required for class CreateOrderRequest.");
