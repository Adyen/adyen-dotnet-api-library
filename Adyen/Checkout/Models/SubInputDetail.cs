    ...
    public class SubInputDetailJsonConverter : JsonConverter<SubInputDetail>
    {
        ...
        public override SubInputDetail Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (configuration.IsSet && configuration.Value == null)
                throw new ArgumentNullException(nameof(configuration), "Property is not nullable for class SubInputDetail.");
        ...
        {
            /*
            if (subInputDetail._ConfigurationOption.IsSet && subInputDetail.Configuration == null)
                throw new ArgumentNullException(nameof(subInputDetail.Configuration), "Property is required for class SubInputDetail.");

            if (subInputDetail._ItemsOption.IsSet && subInputDetail.Items == null)
                throw new ArgumentNullException(nameof(subInputDetail.Items), "Property is required for class SubInputDetail.");

            if (subInputDetail._KeyOption.IsSet && subInputDetail.Key == null)
                throw new ArgumentNullException(nameof(subInputDetail.Key), "Property is required for class SubInputDetail.");

            if (subInputDetail._TypeOption.IsSet && subInputDetail.Type == null)
                throw new ArgumentNullException(nameof(subInputDetail.Type), "Property is required for class SubInputDetail.");

            if (subInputDetail._ValueOption.IsSet && subInputDetail.Value == null)
