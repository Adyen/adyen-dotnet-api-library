...
namespace Adyen.Checkout.Models
{
    ...
    /// </summary>
    [JsonConverter(typeof(AdditionalDataOpenInvoiceJsonConverter))]
    ...
    public class AdditionalDataOpenInvoiceJsonConverter : JsonConverter<AdditionalDataOpenInvoice>
    {
        ...
        public override AdditionalDataOpenInvoice Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (openinvoicedataNumberOfLines.IsSet)
                additionalDataOpenInvoice.OpeninvoicedataNumberOfLines = openinvoicedataNumberOfLines.Value;
            if (openinvoicedataRecipientFirstName.IsSet)
                additionalDataOpenInvoice.OpeninvoicedataRecipientFirstName = openinvoicedataRecipientFirstName.Value;
            if (openinvoicedataRecipientLastName.IsSet)
                additionalDataOpenInvoice.OpeninvoicedataRecipientLastName = openinvoicedataRecipientLastName.Value;
            if (openinvoicedataLineItemNrCurrencyCode.IsSet)
                additionalDataOpenInvoice.OpeninvoicedataLineItemNrCurrencyCode = openinvoicedataLineItemNrCurrencyCode.Value;
            if (openinvoicedataLineItemNrDescription.IsSet)
                additionalDataOpenInvoice.OpeninvoicedataLineItemNrDescription = openinvoicedataLineItemNrDescription.Value;
            if (openinvoicedataLineItemNrItemAmount.IsSet)
                additionalDataOpenInvoice.OpeninvoicedataLineItemNrItemAmount = openinvoicedataLineItemNrItemAmount.Value;
            if (openinvoicedataLineItemNrItemId.IsSet)
                additionalDataOpenInvoice.OpeninvoicedataLineItemNrItemId = openinvoicedataLineItemNrItemId.Value;
            if (openinvoicedataLineItemNrItemVatAmount.IsSet)
                additionalDataOpenInvoice.OpeninvoicedataLineItemNrItemVatAmount = openinvoicedataLineItemNrItemVatAmount.Value;
            if (openinvoicedataLineItemNrItemVatPercentage.IsSet)
                additionalDataOpenInvoice.OpeninvoicedataLineItemNrItemVatPercentage = openinvoicedataLineItemNrItemVatPercentage.Value;
            if (openinvoicedataLineItemNrNumberOfItems.IsSet)
                additionalDataOpenInvoice.OpeninvoicedataLineItemNrNumberOfItems = openinvoicedataLineItemNrNumberOfItems.Value;
            if (openinvoicedataLineItemNrReturnShippingCompany.IsSet)
                additionalDataOpenInvoice.OpeninvoicedataLineItemNrReturnShippingCompany = openinvoicedataLineItemNrReturnShippingCompany.Value;
            if (openinvoicedataLineItemNrReturnTrackingNumber.IsSet)
                additionalDataOpenInvoice.OpeninvoicedataLineItemNrReturnTrackingNumber = openinvoicedataLineItemNrReturnTrackingNumber.Value;
            if (openinvoicedataLineItemNrReturnTrackingUri.IsSet)
                additionalDataOpenInvoice.OpeninvoicedataLineItemNrReturnTrackingUri = openinvoicedataLineItemNrReturnTrackingUri.Value;
            if (openinvoicedataLineItemNrShippingCompany.IsSet)
                additionalDataOpenInvoice.OpeninvoicedataLineItemNrShippingCompany = openinvoicedataLineItemNrShippingCompany.Value;
            if (openinvoicedataLineItemNrShippingMethod.IsSet)
                additionalDataOpenInvoice.OpeninvoicedataLineItemNrShippingMethod = openinvoicedataLineItemNrShippingMethod.Value;
            if (openinvoicedataLineItemNrTrackingNumber.IsSet)
                additionalDataOpenInvoice.OpeninvoicedataLineItemNrTrackingNumber = openinvoicedataLineItemNrTrackingNumber.Value;
            if (openinvoicedataLineItemNrTrackingUri.IsSet)
                additionalDataOpenInvoice.OpeninvoicedataLineItemNrTrackingUri = openinvoicedataLineItemNrTrackingUri.Value;
            return additionalDataOpenInvoice;
        }
