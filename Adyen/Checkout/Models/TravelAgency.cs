...
namespace Adyen.Checkout.Models
{
    ...
    /// TravelAgency.
    /// </summary>
    public partial class TravelAgency : IValidatableObject
    {
        /// <summary>
    ...
    public class TravelAgencyJsonConverter : JsonConverter<TravelAgency>
    {
        ...
        public override TravelAgency Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (code.IsSet && code.Value == null)
                throw new ArgumentNullException(nameof(code), "Property is not nullable for class TravelAgency.");

            if (name.IsSet && name.Value == null)
                throw new ArgumentNullException(nameof(name), "Property is not nullable for class TravelAgency.");
        ...
        {
            /*
            if (travelAgency._CodeOption.IsSet && travelAgency.Code == null)
                throw new ArgumentNullException(nameof(travelAgency.Code), "Property is required for class TravelAgency.");

            if (travelAgency._NameOption.IsSet && travelAgency.Name == null)
                throw new ArgumentNullException(nameof(travelAgency.Name), "Property is required for class TravelAgency.");
