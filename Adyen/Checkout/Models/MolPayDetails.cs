...
namespace Adyen.Checkout.Models
{
    ...
    /// MolPayDetails.
    /// </summary>
    public partial class MolPayDetails : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MolPayDetails" /> class.
        /// </summary>
        /// <param name="issuer">The shopper&#39;s bank. Specify this with the issuer value that corresponds to this bank.</param>
        /// <param name="type">**molpay**</param>
        /// <param name="checkoutAttemptId">The checkout attempt identifier.</param>
        [JsonConstructor]
        public MolPayDetails(string issuer, TypeEnum type, Option<string?> checkoutAttemptId = default)
        {
            Issuer = issuer;
            Type = type;
    ...
    public class MolPayDetailsJsonConverter : JsonConverter<MolPayDetails>
    {
        ...
        public override MolPayDetails Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (issuer.IsSet && issuer.Value == null)
                throw new ArgumentNullException(nameof(issuer), "Property is not nullable for class MolPayDetails.");

            if (type.IsSet && type.Value == null)
                throw new ArgumentNullException(nameof(type), "Property is not nullable for class MolPayDetails.");

            if (checkoutAttemptId.IsSet && checkoutAttemptId.Value == null)
                throw new ArgumentNullException(nameof(checkoutAttemptId), "Property is not nullable for class MolPayDetails.");

            return new MolPayDetails(issuer.Value!, type.Value!.Value!, checkoutAttemptId);
        }
        ...
        public void WriteProperties(Utf8JsonWriter writer, MolPayDetails molPayDetails, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (molPayDetails.Issuer == null)
                throw new ArgumentNullException(nameof(molPayDetails.Issuer), "Property is required for class MolPayDetails.");

            if (molPayDetails._CheckoutAttemptIdOption.IsSet && molPayDetails.CheckoutAttemptId == null)
                throw new ArgumentNullException(nameof(molPayDetails.CheckoutAttemptId), "Property is required for class MolPayDetails.");
