...
namespace Adyen.Checkout.Models
{
    ...
    public class PaymentRefundResponseJsonConverter : JsonConverter<PaymentRefundResponse>
    {
        ...
        public void WriteProperties(Utf8JsonWriter writer, PaymentRefundResponse paymentRefundResponse, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (paymentRefundResponse._MerchantRefundReasonOption.IsSet && paymentRefundResponse.MerchantRefundReason != null) 
            {
                string? merchantRefundReasonRawValue = PaymentRefundResponse.MerchantRefundReasonEnum.ToJsonValue(paymentRefundResponse._MerchantRefundReasonOption.Value!.Value);
