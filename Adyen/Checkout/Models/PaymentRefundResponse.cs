...
namespace Adyen.Checkout.Models
{
    ...
    public class PaymentRefundResponseJsonConverter : JsonConverter<PaymentRefundResponse>
    {
        ...
        public void WriteProperties(Utf8JsonWriter writer, PaymentRefundResponse paymentRefundResponse, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (paymentRefundResponse._CapturePspReferenceOption.IsSet && paymentRefundResponse.CapturePspReference == null)
            ...
            if (paymentRefundResponse._LineItemsOption.IsSet && paymentRefundResponse.LineItems == null)
            ...
            if (paymentRefundResponse._ReferenceOption.IsSet && paymentRefundResponse.Reference == null)
            ...
            if (paymentRefundResponse._SplitsOption.IsSet && paymentRefundResponse.Splits == null)
                throw new ArgumentNullException(nameof(paymentRefundResponse.Splits), "Property is required for class PaymentRefundResponse.");

            if (paymentRefundResponse._StoreOption.IsSet && paymentRefundResponse.Store == null)
            ...
            */
            ...
            var merchantRefundReasonRawValue = PaymentRefundResponse.MerchantRefundReasonEnum.ToJsonValue(paymentRefundResponse._MerchantRefundReasonOption.Value!.Value);
