...
namespace Adyen.Checkout.Models
{
    ...
    /// </summary>
    [JsonConverter(typeof(PaymentRefundResponseJsonConverter))]
    public partial class PaymentRefundResponse
    {
        /// <summary>
    ...
    public class PaymentRefundResponseJsonConverter : JsonConverter<PaymentRefundResponse>
    {
        ...
        public override PaymentRefundResponse Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            var paymentRefundResponse = new PaymentRefundResponse();
            paymentRefundResponse.Amount = amount.Value!;
            ...
            if (lineItems.IsSet)
                paymentRefundResponse.LineItems = lineItems.Value;
            if (merchantRefundReason.IsSet)
                paymentRefundResponse.MerchantRefundReason = merchantRefundReason.Value;
            if (reference.IsSet)
                paymentRefundResponse.Reference = reference.Value;
            if (splits.IsSet)
                paymentRefundResponse.Splits = splits.Value;
            if (store.IsSet)
                paymentRefundResponse.Store = store.Value;
        ...
        public void WriteProperties(Utf8JsonWriter writer, PaymentRefundResponse paymentRefundResponse, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (paymentRefundResponse.Status != null) 
            {
                string? statusRawValue = PaymentRefundResponse.StatusEnum.ToJsonValue(paymentRefundResponse.Status);
                writer.WriteString("status", statusRawValue);
            }
            
            if (paymentRefundResponse._CapturePspReferenceOption.IsSet)
                if (paymentRefundResponse.CapturePspReference != null)
                    writer.WriteString("capturePspReference", paymentRefundResponse.CapturePspReference);

            if (paymentRefundResponse._LineItemsOption.IsSet)
            {
                writer.WritePropertyName("lineItems");
                JsonSerializer.Serialize(writer, paymentRefundResponse.LineItems, jsonSerializerOptions);
            }
            if (paymentRefundResponse._MerchantRefundReasonOption.IsSet) {
                var merchantRefundReasonRawValue = PaymentRefundResponse.MerchantRefundReasonEnum.ToJsonValue(paymentRefundResponse._MerchantRefundReasonOption.Value);
            ...
            if (paymentRefundResponse._ReferenceOption.IsSet)
                if (paymentRefundResponse.Reference != null)
                    writer.WriteString("reference", paymentRefundResponse.Reference);

            if (paymentRefundResponse._SplitsOption.IsSet)
            {
                writer.WritePropertyName("splits");
                JsonSerializer.Serialize(writer, paymentRefundResponse.Splits, jsonSerializerOptions);
            }
            if (paymentRefundResponse._StoreOption.IsSet)
                if (paymentRefundResponse.Store != null)
