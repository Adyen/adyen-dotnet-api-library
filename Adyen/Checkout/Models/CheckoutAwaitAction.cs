...
namespace Adyen.Checkout.Models
{
    ...
    public class CheckoutAwaitActionJsonConverter : JsonConverter<CheckoutAwaitAction>
    {
        ...
        {
            /*
            if (checkoutAwaitAction._PaymentDataOption.IsSet && checkoutAwaitAction.PaymentData == null)
            ...
            if (checkoutAwaitAction._PaymentMethodTypeOption.IsSet && checkoutAwaitAction.PaymentMethodType == null)
            ...
            if (checkoutAwaitAction._UrlOption.IsSet && checkoutAwaitAction.Url == null)
