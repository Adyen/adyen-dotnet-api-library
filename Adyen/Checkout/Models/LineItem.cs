...
namespace Adyen.Checkout.Models
{
    ...
    public partial class LineItem
    {
        ...
        /// <summary>
        /// This is used to track if an optional field is set. If set, <see cref="ReturnShippingCompany"/> will be populated.
        /// </summary>
        [JsonIgnore]
        [global::System.ComponentModel.EditorBrowsable(global::System.ComponentModel.EditorBrowsableState.Never)]
        public Option<string?> _ReturnShippingCompanyOption { get; private set; }

        /// <summary>
        /// Shipping company handling the return of the item.
        /// </summary>
        /// <value>Shipping company handling the return of the item.</value>
        [JsonPropertyName("returnShippingCompany")]
        public string? ReturnShippingCompany { get { return this._ReturnShippingCompanyOption; } set { this._ReturnShippingCompanyOption = new(value); } }

        /// <summary>
        /// This is used to track if an optional field is set. If set, <see cref="ReturnTrackingNumber"/> will be populated.
        /// </summary>
        [JsonIgnore]
        [global::System.ComponentModel.EditorBrowsable(global::System.ComponentModel.EditorBrowsableState.Never)]
        public Option<string?> _ReturnTrackingNumberOption { get; private set; }

        /// <summary>
        /// Tracking number for the return of the item.
        /// </summary>
        /// <value>Tracking number for the return of the item.</value>
        [JsonPropertyName("returnTrackingNumber")]
        public string? ReturnTrackingNumber { get { return this._ReturnTrackingNumberOption; } set { this._ReturnTrackingNumberOption = new(value); } }

        /// <summary>
        /// This is used to track if an optional field is set. If set, <see cref="ReturnTrackingUri"/> will be populated.
        /// </summary>
        [JsonIgnore]
        [global::System.ComponentModel.EditorBrowsable(global::System.ComponentModel.EditorBrowsableState.Never)]
        public Option<string?> _ReturnTrackingUriOption { get; private set; }

        /// <summary>
        /// Tracking URI for the return of the item.
        /// </summary>
        /// <value>Tracking URI for the return of the item.</value>
        [JsonPropertyName("returnTrackingUri")]
        ...
        [JsonIgnore]
        [global::System.ComponentModel.EditorBrowsable(global::System.ComponentModel.EditorBrowsableState.Never)]
        public Option<string?> _ShippingCompanyOption { get; private set; }

        /// <summary>
        /// Shipping company handling the delivery of the item.
        /// </summary>
        /// <value>Shipping company handling the delivery of the item.</value>
        [JsonPropertyName("shippingCompany")]
        public string? ShippingCompany { get { return this._ShippingCompanyOption; } set { this._ShippingCompanyOption = new(value); } }
        ...
        /// </summary>
        /// <value>Shipping method used to deliver the item.</value>
        ...
        /// </summary>
        /// <value>Tracking number for the delivery of the item.</value>
        [JsonPropertyName("trackingNumber")]
        public string? TrackingNumber { get { return this._TrackingNumberOption; } set { this._TrackingNumberOption = new(value); } }

        /// <summary>
        /// This is used to track if an optional field is set. If set, <see cref="TrackingUri"/> will be populated.
        /// </summary>
        [JsonIgnore]
        [global::System.ComponentModel.EditorBrowsable(global::System.ComponentModel.EditorBrowsableState.Never)]
        public Option<string?> _TrackingUriOption { get; private set; }

        /// <summary>
        /// Tracking URI for the delivery of the item.
        /// </summary>
        /// <value>Tracking URI for the delivery of the item.</value>
        [JsonPropertyName("trackingUri")]
        public string? TrackingUri { get { return this._TrackingUriOption; } set { this._TrackingUriOption = new(value); } }
    ...
    public class LineItemJsonConverter : JsonConverter<LineItem>
    {
        ...
        public override LineItem Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            Option<string?> trackingUri = default;
                ...
                if (utf8JsonReader.TokenType == JsonTokenType.PropertyName && currentDepth == utf8JsonReader.CurrentDepth - 1)
                {
                    ...
                    switch (jsonPropertyName)
                    {
                        ...
                        case "receiverEmail":
                            ...
                            break;
                        case "returnShippingCompany":
                            returnShippingCompany = new Option<string?>(utf8JsonReader.GetString()!);
                            break;
                        case "returnTrackingNumber":
                            returnTrackingNumber = new Option<string?>(utf8JsonReader.GetString()!);
                            break;
                        ...
                        case "trackingNumber":
                            ...
                            break;
                        case "trackingUri":
                            trackingUri = new Option<string?>(utf8JsonReader.GetString()!);
                            break;
                        case "upc":
            ...
            if (amountIncludingTax.IsSet)
                lineItem.AmountIncludingTax = amountIncludingTax.Value;
            if (brand.IsSet)
                lineItem.Brand = brand.Value;
            if (color.IsSet)
                lineItem.Color = color.Value;
            if (description.IsSet)
                lineItem.Description = description.Value;
            if (id.IsSet)
                lineItem.Id = id.Value;
            if (imageUrl.IsSet)
                lineItem.ImageUrl = imageUrl.Value;
            if (itemCategory.IsSet)
                lineItem.ItemCategory = itemCategory.Value;
            if (manufacturer.IsSet)
                lineItem.Manufacturer = manufacturer.Value;
            if (marketplaceSellerId.IsSet)
                lineItem.MarketplaceSellerId = marketplaceSellerId.Value;
            if (productUrl.IsSet)
                lineItem.ProductUrl = productUrl.Value;
            if (quantity.IsSet)
                lineItem.Quantity = quantity.Value;
            if (receiverEmail.IsSet)
                lineItem.ReceiverEmail = receiverEmail.Value;
            if (returnShippingCompany.IsSet)
                lineItem.ReturnShippingCompany = returnShippingCompany.Value;
            if (returnTrackingNumber.IsSet)
            ...
            if (shippingMethod.IsSet)
                lineItem.ShippingMethod = shippingMethod.Value;
            if (size.IsSet)
                lineItem.Size = size.Value;
            if (sku.IsSet)
                lineItem.Sku = sku.Value;
            if (taxAmount.IsSet)
                lineItem.TaxAmount = taxAmount.Value;
            if (taxPercentage.IsSet)
                lineItem.TaxPercentage = taxPercentage.Value;
            if (trackingNumber.IsSet)
                lineItem.TrackingNumber = trackingNumber.Value;
            if (trackingUri.IsSet)
                lineItem.TrackingUri = trackingUri.Value;
            if (upc.IsSet)
                lineItem.Upc = upc.Value;
            return lineItem;
        }
        ...
        public void WriteProperties(Utf8JsonWriter writer, LineItem lineItem, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (lineItem._ReturnShippingCompanyOption.IsSet)
                if (lineItem.ReturnShippingCompany != null)
                    writer.WriteString("returnShippingCompany", lineItem.ReturnShippingCompany);

            if (lineItem._ReturnTrackingNumberOption.IsSet)
                if (lineItem.ReturnTrackingNumber != null)
                    writer.WriteString("returnTrackingNumber", lineItem.ReturnTrackingNumber);
            ...
            if (lineItem._ShippingCompanyOption.IsSet)
                if (lineItem.ShippingCompany != null)
                    writer.WriteString("shippingCompany", lineItem.ShippingCompany);

            if (lineItem._ShippingMethodOption.IsSet)
                if (lineItem.ShippingMethod != null)
                    writer.WriteString("shippingMethod", lineItem.ShippingMethod);
            ...
            if (lineItem._TrackingNumberOption.IsSet)
                if (lineItem.TrackingNumber != null)
                    writer.WriteString("trackingNumber", lineItem.TrackingNumber);

            if (lineItem._TrackingUriOption.IsSet)
                if (lineItem.TrackingUri != null)
                    writer.WriteString("trackingUri", lineItem.TrackingUri);
