...
namespace Adyen.Checkout.Models
{
    ...
    public class AdditionalDataLevel23JsonConverter : JsonConverter<AdditionalDataLevel23>
    {
        ...
        public override AdditionalDataLevel23 Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            var result = new AdditionalDataLevel23();
            ...
            if (enhancedSchemeDataDestinationCountryCode.IsSet)
                result.EnhancedSchemeDataDestinationCountryCode = enhancedSchemeDataDestinationCountryCode.Value;
            if (enhancedSchemeDataDestinationPostalCode.IsSet)
                result.EnhancedSchemeDataDestinationPostalCode = enhancedSchemeDataDestinationPostalCode.Value;
            if (enhancedSchemeDataDestinationStateProvinceCode.IsSet)
                result.EnhancedSchemeDataDestinationStateProvinceCode = enhancedSchemeDataDestinationStateProvinceCode.Value;
            if (enhancedSchemeDataDutyAmount.IsSet)
                result.EnhancedSchemeDataDutyAmount = enhancedSchemeDataDutyAmount.Value;
            if (enhancedSchemeDataFreightAmount.IsSet)
                result.EnhancedSchemeDataFreightAmount = enhancedSchemeDataFreightAmount.Value;
            if (enhancedSchemeDataItemDetailLineItemNrCommodityCode.IsSet)
                result.EnhancedSchemeDataItemDetailLineItemNrCommodityCode = enhancedSchemeDataItemDetailLineItemNrCommodityCode.Value;
            if (enhancedSchemeDataItemDetailLineItemNrDescription.IsSet)
                result.EnhancedSchemeDataItemDetailLineItemNrDescription = enhancedSchemeDataItemDetailLineItemNrDescription.Value;
            if (enhancedSchemeDataItemDetailLineItemNrDiscountAmount.IsSet)
                result.EnhancedSchemeDataItemDetailLineItemNrDiscountAmount = enhancedSchemeDataItemDetailLineItemNrDiscountAmount.Value;
            if (enhancedSchemeDataItemDetailLineItemNrProductCode.IsSet)
                result.EnhancedSchemeDataItemDetailLineItemNrProductCode = enhancedSchemeDataItemDetailLineItemNrProductCode.Value;
            if (enhancedSchemeDataItemDetailLineItemNrQuantity.IsSet)
                result.EnhancedSchemeDataItemDetailLineItemNrQuantity = enhancedSchemeDataItemDetailLineItemNrQuantity.Value;
            if (enhancedSchemeDataItemDetailLineItemNrTotalAmount.IsSet)
                result.EnhancedSchemeDataItemDetailLineItemNrTotalAmount = enhancedSchemeDataItemDetailLineItemNrTotalAmount.Value;
            if (enhancedSchemeDataItemDetailLineItemNrUnitOfMeasure.IsSet)
                result.EnhancedSchemeDataItemDetailLineItemNrUnitOfMeasure = enhancedSchemeDataItemDetailLineItemNrUnitOfMeasure.Value;
            if (enhancedSchemeDataItemDetailLineItemNrUnitPrice.IsSet)
                result.EnhancedSchemeDataItemDetailLineItemNrUnitPrice = enhancedSchemeDataItemDetailLineItemNrUnitPrice.Value;
            if (enhancedSchemeDataOrderDate.IsSet)
                result.EnhancedSchemeDataOrderDate = enhancedSchemeDataOrderDate.Value;
            if (enhancedSchemeDataShipFromPostalCode.IsSet)
                result.EnhancedSchemeDataShipFromPostalCode = enhancedSchemeDataShipFromPostalCode.Value;
