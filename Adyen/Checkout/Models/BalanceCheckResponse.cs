...
namespace Adyen.Checkout.Models
{
    ...
    /// </summary>
    [JsonConverter(typeof(BalanceCheckResponseJsonConverter))]
    ...
    public class BalanceCheckResponseJsonConverter : JsonConverter<BalanceCheckResponse>
    {
        ...
        public override BalanceCheckResponse Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (fraudResult.IsSet)
                balanceCheckResponse.FraudResult = fraudResult.Value;
            if (pspReference.IsSet)
                balanceCheckResponse.PspReference = pspReference.Value;
            if (refusalReason.IsSet)
                balanceCheckResponse.RefusalReason = refusalReason.Value;
            if (transactionLimit.IsSet)
                balanceCheckResponse.TransactionLimit = transactionLimit.Value;
