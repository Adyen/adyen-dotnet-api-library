...
namespace Adyen.Checkout.Models
{
    ...
    /// </summary>
    [JsonConverter(typeof(PaymentDetailsResponseJsonConverter))]
    ...
    public class PaymentDetailsResponseJsonConverter : JsonConverter<PaymentDetailsResponse>
    {
        ...
        public override PaymentDetailsResponse Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (action.IsSet)
                paymentDetailsResponse.Action = action.Value;
            if (additionalData.IsSet)
                paymentDetailsResponse.AdditionalData = additionalData.Value;
            if (amount.IsSet)
                paymentDetailsResponse.Amount = amount.Value;
            if (donationToken.IsSet)
                paymentDetailsResponse.DonationToken = donationToken.Value;
            ...
            if (paymentMethod.IsSet)
                paymentDetailsResponse.PaymentMethod = paymentMethod.Value;
            if (paymentValidations.IsSet)
                paymentDetailsResponse.PaymentValidations = paymentValidations.Value;
            if (pspReference.IsSet)
                paymentDetailsResponse.PspReference = pspReference.Value;
            if (refusalReason.IsSet)
                paymentDetailsResponse.RefusalReason = refusalReason.Value;
            if (refusalReasonCode.IsSet)
                paymentDetailsResponse.RefusalReasonCode = refusalReasonCode.Value;
            if (resultCode.IsSet)
                paymentDetailsResponse.ResultCode = resultCode.Value;
            if (shopperLocale.IsSet)
                paymentDetailsResponse.ShopperLocale = shopperLocale.Value;
            if (threeDS2ResponseData.IsSet)
                paymentDetailsResponse.ThreeDS2ResponseData = threeDS2ResponseData.Value;
            if (threeDS2Result.IsSet)
                paymentDetailsResponse.ThreeDS2Result = threeDS2Result.Value;
            if (threeDSPaymentData.IsSet)
                paymentDetailsResponse.ThreeDSPaymentData = threeDSPaymentData.Value;
