...
namespace Adyen.Checkout.Models
{
    ...
    /// </summary>
    [JsonConverter(typeof(AdditionalDataCommonJsonConverter))]
    ...
    public class AdditionalDataCommonJsonConverter : JsonConverter<AdditionalDataCommon>
    {
        ...
        public override AdditionalDataCommon Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (requestedTestErrorResponseCode.IsSet)
                additionalDataCommon.RequestedTestErrorResponseCode = requestedTestErrorResponseCode.Value;
            if (allowPartialAuth.IsSet)
                additionalDataCommon.AllowPartialAuth = allowPartialAuth.Value;
            if (authorisationType.IsSet)
                additionalDataCommon.AuthorisationType = authorisationType.Value;
            if (autoRescue.IsSet)
                additionalDataCommon.AutoRescue = autoRescue.Value;
            if (customRoutingFlag.IsSet)
                additionalDataCommon.CustomRoutingFlag = customRoutingFlag.Value;
            if (industryUsage.IsSet)
                additionalDataCommon.IndustryUsage = industryUsage.Value;
            if (manualCapture.IsSet)
                additionalDataCommon.ManualCapture = manualCapture.Value;
            if (maxDaysToRescue.IsSet)
                additionalDataCommon.MaxDaysToRescue = maxDaysToRescue.Value;
            if (networkTxReference.IsSet)
                additionalDataCommon.NetworkTxReference = networkTxReference.Value;
            if (overwriteBrand.IsSet)
                additionalDataCommon.OverwriteBrand = overwriteBrand.Value;
            if (subMerchantCity.IsSet)
                additionalDataCommon.SubMerchantCity = subMerchantCity.Value;
            if (subMerchantCountry.IsSet)
                additionalDataCommon.SubMerchantCountry = subMerchantCountry.Value;
            if (subMerchantEmail.IsSet)
                additionalDataCommon.SubMerchantEmail = subMerchantEmail.Value;
            if (subMerchantID.IsSet)
                additionalDataCommon.SubMerchantID = subMerchantID.Value;
            if (subMerchantName.IsSet)
                additionalDataCommon.SubMerchantName = subMerchantName.Value;
            if (subMerchantPhoneNumber.IsSet)
                additionalDataCommon.SubMerchantPhoneNumber = subMerchantPhoneNumber.Value;
            if (subMerchantPostalCode.IsSet)
                additionalDataCommon.SubMerchantPostalCode = subMerchantPostalCode.Value;
            if (subMerchantState.IsSet)
                additionalDataCommon.SubMerchantState = subMerchantState.Value;
