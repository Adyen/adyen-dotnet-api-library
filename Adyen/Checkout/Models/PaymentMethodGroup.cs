...
namespace Adyen.Checkout.Models
{
    ...
    public class PaymentMethodGroupJsonConverter : JsonConverter<PaymentMethodGroup>
    {
        ...
        {
            /*
            if (paymentMethodGroup._NameOption.IsSet && paymentMethodGroup.Name == null)
                throw new ArgumentNullException(nameof(paymentMethodGroup.Name), "Property is required for class PaymentMethodGroup.");

            if (paymentMethodGroup._PaymentMethodDataOption.IsSet && paymentMethodGroup.PaymentMethodData == null)
            ...
            if (paymentMethodGroup._TypeOption.IsSet && paymentMethodGroup.Type == null)
