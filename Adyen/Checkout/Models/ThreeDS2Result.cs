...
namespace Adyen.Checkout.Models
{
    ...
    /// ThreeDS2Result.
    /// </summary>
    [JsonConverter(typeof(ThreeDS2ResultJsonConverter))]
    public partial class ThreeDS2Result
    {
        ...
        public class ChallengeCancelEnum : IEnum
        {
            ...
            /// <summary>
            /// Compares two <see cref="ChallengeCancelEnum"/> instances for equality.
            /// </summary>
            ...
            /// <summary>
            /// Compares two <see cref="ChallengeCancelEnum"/> instances for inequality.
            /// </summary>
            public static bool operator !=(ChallengeCancelEnum? left, ChallengeCancelEnum? right) => !string.Equals(left?.Value, right?.Value, StringComparison.OrdinalIgnoreCase);

            /// <summary>
            /// Returns true if the given object is equal to this <see cref="ChallengeCancelEnum"/> instance.
            /// </summary>
            ...
            /// <summary>
            /// Returns a hash code for this <see cref="ChallengeCancelEnum"/> instance.
            /// </summary>
            public override int GetHashCode() => Value?.GetHashCode() ?? 0;

            /// <summary>
            /// Returns the string value of the <see cref="ChallengeCancelEnum"/> instance.
            /// </summary>
            ...
            {
                /// <summary>
                /// Deserializes a <see cref="ChallengeCancelEnum"/> from JSON.
                /// </summary>
                ...
                /// <summary>
                /// Serializes a <see cref="ChallengeCancelEnum"/> to JSON.
                /// </summary>
    ...
    public class ThreeDS2ResultJsonConverter : JsonConverter<ThreeDS2Result>
    {
        ...
        public override ThreeDS2Result Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (cavvAlgorithm.IsSet)
                threeDS2Result.CavvAlgorithm = cavvAlgorithm.Value;
            if (challengeCancel.IsSet)
                threeDS2Result.ChallengeCancel = challengeCancel.Value;
            if (dsTransID.IsSet)
                threeDS2Result.DsTransID = dsTransID.Value;
            if (eci.IsSet)
                threeDS2Result.Eci = eci.Value;
            if (exemptionIndicator.IsSet)
                threeDS2Result.ExemptionIndicator = exemptionIndicator.Value;
            if (messageVersion.IsSet)
                threeDS2Result.MessageVersion = messageVersion.Value;
            if (riskScore.IsSet)
                threeDS2Result.RiskScore = riskScore.Value;
            if (threeDSRequestorChallengeInd.IsSet)
                threeDS2Result.ThreeDSRequestorChallengeInd = threeDSRequestorChallengeInd.Value;
            if (threeDSServerTransID.IsSet)
                threeDS2Result.ThreeDSServerTransID = threeDSServerTransID.Value;
            if (timestamp.IsSet)
                threeDS2Result.Timestamp = timestamp.Value;
            if (transStatus.IsSet)
                threeDS2Result.TransStatus = transStatus.Value;
            if (transStatusReason.IsSet)
                threeDS2Result.TransStatusReason = transStatusReason.Value;
            if (whiteListStatus.IsSet)
                threeDS2Result.WhiteListStatus = whiteListStatus.Value;
