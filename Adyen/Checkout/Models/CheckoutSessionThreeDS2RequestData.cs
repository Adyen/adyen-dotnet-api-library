...
namespace Adyen.Checkout.Models
{
    ...
    /// </summary>
    [JsonConverter(typeof(CheckoutSessionThreeDS2RequestDataJsonConverter))]
    ...
    public class CheckoutSessionThreeDS2RequestDataJsonConverter : JsonConverter<CheckoutSessionThreeDS2RequestData>
    {
        ...
        public override CheckoutSessionThreeDS2RequestData Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (mobilePhone.IsSet)
                checkoutSessionThreeDS2RequestData.MobilePhone = mobilePhone.Value;
            if (threeDSRequestorChallengeInd.IsSet)
                checkoutSessionThreeDS2RequestData.ThreeDSRequestorChallengeInd = threeDSRequestorChallengeInd.Value;
            if (workPhone.IsSet)
                checkoutSessionThreeDS2RequestData.WorkPhone = workPhone.Value;
