...
namespace Adyen.Checkout.Models
{
    ...
    /// RivertyDetails.
    /// </summary>
    [JsonConverter(typeof(RivertyDetailsJsonConverter))]
    public partial class RivertyDetails
    {
        ...
        [JsonIgnore]
        [global::System.ComponentModel.EditorBrowsable(global::System.ComponentModel.EditorBrowsableState.Never)]
        public Option<string?> _MerchantDataOption { get; private set; }

        /// <summary>
        /// Base64-encoded merchant metadata (Extra Merchant Data) forwarded to Riverty at authorization.
        /// </summary>
        /// <value>Base64-encoded merchant metadata (Extra Merchant Data) forwarded to Riverty at authorization.</value>
        [JsonPropertyName("merchantData")]
        public string? MerchantData { get { return this._MerchantDataOption; } set { this._MerchantDataOption = new(value); } }
    ...
    public class RivertyDetailsJsonConverter : JsonConverter<RivertyDetails>
    {
        ...
        public override RivertyDetails Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            Option<string?> merchantData = default;
                ...
                if (utf8JsonReader.TokenType == JsonTokenType.PropertyName && currentDepth == utf8JsonReader.CurrentDepth - 1)
                {
                    ...
                    switch (jsonPropertyName)
                    {
                        ...
                        case "iban":
                            ...
                            break;
                        case "merchantData":
                            merchantData = new Option<string?>(utf8JsonReader.GetString()!);
                            break;
            ...
            if (billingAddress.IsSet)
                rivertyDetails.BillingAddress = billingAddress.Value;
            if (checkoutAttemptId.IsSet)
                rivertyDetails.CheckoutAttemptId = checkoutAttemptId.Value;
            if (deliveryAddress.IsSet)
                rivertyDetails.DeliveryAddress = deliveryAddress.Value;
            if (deviceFingerprint.IsSet)
                rivertyDetails.DeviceFingerprint = deviceFingerprint.Value;
            if (iban.IsSet)
                rivertyDetails.Iban = iban.Value;
            if (merchantData.IsSet)
                rivertyDetails.MerchantData = merchantData.Value;
            if (personalDetails.IsSet)
                rivertyDetails.PersonalDetails = personalDetails.Value;
            if (recurringDetailReference.IsSet)
                rivertyDetails.RecurringDetailReference = recurringDetailReference.Value;
            if (sdkData.IsSet)
                rivertyDetails.SdkData = sdkData.Value;
        ...
        public void WriteProperties(Utf8JsonWriter writer, RivertyDetails rivertyDetails, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (rivertyDetails._MerchantDataOption.IsSet)
                if (rivertyDetails.MerchantData != null)
                    writer.WriteString("merchantData", rivertyDetails.MerchantData);
