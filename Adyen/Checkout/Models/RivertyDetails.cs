...
namespace Adyen.Checkout.Models
{
    ...
    public partial class RivertyDetails : IValidatableObject
    {
        ...
        [JsonConstructor]
        public RivertyDetails(Option<string?> billingAddress = default, Option<string?> checkoutAttemptId = default, Option<string?> deliveryAddress = default, Option<string?> deviceFingerprint = default, Option<string?> iban = default, Option<string?> personalDetails = default, Option<string?> recurringDetailReference = default, Option<string?> storedPaymentMethodId = default, Option<string?> subtype = default, TypeEnum type = default)
        {
    ...
    public class RivertyDetailsJsonConverter : JsonConverter<RivertyDetails>
    {
        ...
        public override RivertyDetails Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (subtype.IsSet && subtype.Value == null)
                throw new ArgumentNullException(nameof(subtype), "Property is not nullable for class RivertyDetails.");

            if (type.IsSet && type.Value == null)
                throw new ArgumentNullException(nameof(type), "Property is not nullable for class RivertyDetails.");

            return new RivertyDetails(billingAddress, checkoutAttemptId, deliveryAddress, deviceFingerprint, iban, personalDetails, recurringDetailReference, storedPaymentMethodId, subtype, type.Value!.Value!);
        }
        ...
        public void WriteProperties(Utf8JsonWriter writer, RivertyDetails rivertyDetails, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (rivertyDetails._StoredPaymentMethodIdOption.IsSet && rivertyDetails.StoredPaymentMethodId == null)
            ...
            if (rivertyDetails._SubtypeOption.IsSet && rivertyDetails.Subtype == null)
                throw new ArgumentNullException(nameof(rivertyDetails.Subtype), "Property is required for class RivertyDetails.");
