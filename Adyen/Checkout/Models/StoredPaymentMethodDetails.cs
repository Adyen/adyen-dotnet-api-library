...
namespace Adyen.Checkout.Models
{
    ...
    /// </summary>
    [JsonConverter(typeof(StoredPaymentMethodDetailsJsonConverter))]
    ...
    public class StoredPaymentMethodDetailsJsonConverter : JsonConverter<StoredPaymentMethodDetails>
    {
        ...
        public override StoredPaymentMethodDetails Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (recurringDetailReference.IsSet)
                storedPaymentMethodDetails.RecurringDetailReference = recurringDetailReference.Value;
            if (sdkData.IsSet)
                storedPaymentMethodDetails.SdkData = sdkData.Value;
            if (storedPaymentMethodId.IsSet)
                storedPaymentMethodDetails.StoredPaymentMethodId = storedPaymentMethodId.Value;
            if (type.IsSet)
                storedPaymentMethodDetails.Type = type.Value;
            return storedPaymentMethodDetails;
        }
