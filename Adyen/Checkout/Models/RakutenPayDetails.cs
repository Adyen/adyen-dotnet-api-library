...
namespace Adyen.Checkout.Models
{
    ...
    public class RakutenPayDetailsJsonConverter : JsonConverter<RakutenPayDetails>
    {
        ...
        {
            /*
            if (rakutenPayDetails._CheckoutAttemptIdOption.IsSet && rakutenPayDetails.CheckoutAttemptId == null)
            ...
            if (rakutenPayDetails._RecurringDetailReferenceOption.IsSet && rakutenPayDetails.RecurringDetailReference == null)
            ...
            if (rakutenPayDetails._StoredPaymentMethodIdOption.IsSet && rakutenPayDetails.StoredPaymentMethodId == null)
