...
namespace Adyen.Checkout.Models
{
    ...
    /// AdditionalDataRisk.
    /// </summary>
    [JsonConverter(typeof(AdditionalDataRiskJsonConverter))]
    ...
    public class AdditionalDataRiskJsonConverter : JsonConverter<AdditionalDataRisk>
    {
        ...
        public override AdditionalDataRisk Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (riskdataBasketItemItemNrAmountPerItem.IsSet)
                additionalDataRisk.RiskdataBasketItemItemNrAmountPerItem = riskdataBasketItemItemNrAmountPerItem.Value;
            if (riskdataBasketItemItemNrBrand.IsSet)
                additionalDataRisk.RiskdataBasketItemItemNrBrand = riskdataBasketItemItemNrBrand.Value;
            if (riskdataBasketItemItemNrCategory.IsSet)
                additionalDataRisk.RiskdataBasketItemItemNrCategory = riskdataBasketItemItemNrCategory.Value;
            if (riskdataBasketItemItemNrColor.IsSet)
                additionalDataRisk.RiskdataBasketItemItemNrColor = riskdataBasketItemItemNrColor.Value;
            if (riskdataBasketItemItemNrCurrency.IsSet)
                additionalDataRisk.RiskdataBasketItemItemNrCurrency = riskdataBasketItemItemNrCurrency.Value;
            if (riskdataBasketItemItemNrItemID.IsSet)
                additionalDataRisk.RiskdataBasketItemItemNrItemID = riskdataBasketItemItemNrItemID.Value;
            if (riskdataBasketItemItemNrManufacturer.IsSet)
                additionalDataRisk.RiskdataBasketItemItemNrManufacturer = riskdataBasketItemItemNrManufacturer.Value;
            if (riskdataBasketItemItemNrProductTitle.IsSet)
                additionalDataRisk.RiskdataBasketItemItemNrProductTitle = riskdataBasketItemItemNrProductTitle.Value;
            if (riskdataBasketItemItemNrQuantity.IsSet)
                additionalDataRisk.RiskdataBasketItemItemNrQuantity = riskdataBasketItemItemNrQuantity.Value;
            if (riskdataBasketItemItemNrReceiverEmail.IsSet)
                additionalDataRisk.RiskdataBasketItemItemNrReceiverEmail = riskdataBasketItemItemNrReceiverEmail.Value;
            if (riskdataBasketItemItemNrSize.IsSet)
                additionalDataRisk.RiskdataBasketItemItemNrSize = riskdataBasketItemItemNrSize.Value;
            if (riskdataBasketItemItemNrSku.IsSet)
                additionalDataRisk.RiskdataBasketItemItemNrSku = riskdataBasketItemItemNrSku.Value;
            if (riskdataBasketItemItemNrUpc.IsSet)
                additionalDataRisk.RiskdataBasketItemItemNrUpc = riskdataBasketItemItemNrUpc.Value;
            if (riskdataPromotionsPromotionItemNrPromotionCode.IsSet)
                additionalDataRisk.RiskdataPromotionsPromotionItemNrPromotionCode = riskdataPromotionsPromotionItemNrPromotionCode.Value;
            if (riskdataPromotionsPromotionItemNrPromotionDiscountAmount.IsSet)
                additionalDataRisk.RiskdataPromotionsPromotionItemNrPromotionDiscountAmount = riskdataPromotionsPromotionItemNrPromotionDiscountAmount.Value;
            if (riskdataPromotionsPromotionItemNrPromotionDiscountCurrency.IsSet)
                additionalDataRisk.RiskdataPromotionsPromotionItemNrPromotionDiscountCurrency = riskdataPromotionsPromotionItemNrPromotionDiscountCurrency.Value;
            if (riskdataPromotionsPromotionItemNrPromotionDiscountPercentage.IsSet)
                additionalDataRisk.RiskdataPromotionsPromotionItemNrPromotionDiscountPercentage = riskdataPromotionsPromotionItemNrPromotionDiscountPercentage.Value;
            if (riskdataPromotionsPromotionItemNrPromotionName.IsSet)
                additionalDataRisk.RiskdataPromotionsPromotionItemNrPromotionName = riskdataPromotionsPromotionItemNrPromotionName.Value;
            if (riskdataRiskProfileReference.IsSet)
                additionalDataRisk.RiskdataRiskProfileReference = riskdataRiskProfileReference.Value;
            if (riskdataSkipRisk.IsSet)
                additionalDataRisk.RiskdataSkipRisk = riskdataSkipRisk.Value;
            return additionalDataRisk;
        }
