...
namespace Adyen.Checkout.Services
{
    ...
    public sealed partial class PaymentLinksService : IPaymentLinksService
    {
        ...
        /// <param name="linkId"></param>
        private void AfterGetPaymentLinkDefaultImplementation(IGetPaymentLinkApiResponse apiResponse, string linkId)
        {
            bool suppressDefaultLog = false;
            AfterGetPaymentLink(ref suppressDefaultLog, apiResponse, linkId);
        ...
        /// <param name="apiResponse"></param>
        /// <param name="linkId"></param>
        partial void AfterGetPaymentLink(ref bool suppressDefaultLog, IGetPaymentLinkApiResponse apiResponse, string linkId);
        ...
        /// <param name="linkId"></param>
        private void OnErrorGetPaymentLinkDefaultImplementation(Exception exception, string pathFormat, string path, string linkId)
        {
            bool suppressDefaultLog = false;
            OnErrorGetPaymentLink(ref suppressDefaultLog, exception, pathFormat, path, linkId);
            if (!suppressDefaultLog)
        ...
        /// <param name="path"></param>
        /// <param name="linkId"></param>
        partial void OnErrorGetPaymentLink(ref bool suppressDefaultLog, Exception exception, string pathFormat, string path, string linkId);
        ...
        public async Task<IGetPaymentLinkApiResponse> GetPaymentLinkAsync(string linkId, System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                using (HttpRequestMessage httpRequestMessage = new HttpRequestMessage())
                {
                    ...
                    using (HttpResponseMessage httpResponseMessage = await HttpClient.SendAsync(httpRequestMessage, cancellationToken).ConfigureAwait(false))
                    {
                        ...
                        AfterGetPaymentLinkDefaultImplementation(apiResponse, linkId);
            ...
            {
                OnErrorGetPaymentLinkDefaultImplementation(e, "/paymentLinks/{linkId}", uriBuilder.Path, linkId);
        ...
        partial void FormatPaymentLinks(ref Option<string> idempotencyKey, Option<PaymentLinkRequest> paymentLinkRequest);
        ...
        /// <returns></returns>
        private void ValidatePaymentLinks(Option<string> idempotencyKey, Option<PaymentLinkRequest> paymentLinkRequest)
        {
        ...
        /// <param name="idempotencyKey"></param>
        /// <param name="paymentLinkRequest"></param>
        private void AfterPaymentLinksDefaultImplementation(IPaymentLinksApiResponse apiResponse, Option<string> idempotencyKey, Option<PaymentLinkRequest> paymentLinkRequest)
        {
            bool suppressDefaultLog = false;
            AfterPaymentLinks(ref suppressDefaultLog, apiResponse, idempotencyKey, paymentLinkRequest);
            if (!suppressDefaultLog)
                Logger.LogInformation("{0,-9} | {1} | {3}", (apiResponse.DownloadedAt - apiResponse.RequestedAt).TotalSeconds, apiResponse.StatusCode, apiResponse.Path);
        }
        ...
        /// <param name="idempotencyKey"></param>
        /// <param name="paymentLinkRequest"></param>
        partial void AfterPaymentLinks(ref bool suppressDefaultLog, IPaymentLinksApiResponse apiResponse, Option<string> idempotencyKey, Option<PaymentLinkRequest> paymentLinkRequest);
        ...
        /// <param name="idempotencyKey"></param>
        /// <param name="paymentLinkRequest"></param>
        private void OnErrorPaymentLinksDefaultImplementation(Exception exception, string pathFormat, string path, Option<string> idempotencyKey, Option<PaymentLinkRequest> paymentLinkRequest)
        {
            bool suppressDefaultLog = false;
            OnErrorPaymentLinks(ref suppressDefaultLog, exception, pathFormat, path, idempotencyKey, paymentLinkRequest);
            if (!suppressDefaultLog)
                Logger.LogError(exception, "An error occurred while sending the request to the server.");
        }
        ...
        /// <param name="idempotencyKey"></param>
        /// <param name="paymentLinkRequest"></param>
        partial void OnErrorPaymentLinks(ref bool suppressDefaultLog, Exception exception, string pathFormat, string path, Option<string> idempotencyKey, Option<PaymentLinkRequest> paymentLinkRequest);
        ...
        public async Task<IPaymentLinksApiResponse> PaymentLinksAsync(Option<string> idempotencyKey = default, Option<PaymentLinkRequest> paymentLinkRequest = default, System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                using (HttpRequestMessage httpRequestMessage = new HttpRequestMessage())
                {
                    ...
                    using (HttpResponseMessage httpResponseMessage = await HttpClient.SendAsync(httpRequestMessage, cancellationToken).ConfigureAwait(false))
                    {
                        ...
                        AfterPaymentLinksDefaultImplementation(apiResponse, idempotencyKey, paymentLinkRequest);
            ...
            {
                OnErrorPaymentLinksDefaultImplementation(e, "/paymentLinks", uriBuilder.Path, idempotencyKey, paymentLinkRequest);
        ...
        partial void FormatUpdatePaymentLink(ref string linkId, Option<UpdatePaymentLinkRequest> updatePaymentLinkRequest);
        ...
        /// <returns></returns>
        private void ValidateUpdatePaymentLink(string linkId, Option<UpdatePaymentLinkRequest> updatePaymentLinkRequest)
        {
            if (linkId == null)
                throw new ArgumentNullException(nameof(linkId));
        ...
        /// <param name="linkId"></param>
        /// <param name="updatePaymentLinkRequest"></param>
        private void AfterUpdatePaymentLinkDefaultImplementation(IUpdatePaymentLinkApiResponse apiResponse, string linkId, Option<UpdatePaymentLinkRequest> updatePaymentLinkRequest)
        {
            bool suppressDefaultLog = false;
            AfterUpdatePaymentLink(ref suppressDefaultLog, apiResponse, linkId, updatePaymentLinkRequest);
            if (!suppressDefaultLog)
                Logger.LogInformation("{0,-9} | {1} | {3}", (apiResponse.DownloadedAt - apiResponse.RequestedAt).TotalSeconds, apiResponse.StatusCode, apiResponse.Path);
        }
        ...
        /// <param name="linkId"></param>
        /// <param name="updatePaymentLinkRequest"></param>
        partial void AfterUpdatePaymentLink(ref bool suppressDefaultLog, IUpdatePaymentLinkApiResponse apiResponse, string linkId, Option<UpdatePaymentLinkRequest> updatePaymentLinkRequest);
        ...
        /// <param name="linkId"></param>
        /// <param name="updatePaymentLinkRequest"></param>
        private void OnErrorUpdatePaymentLinkDefaultImplementation(Exception exception, string pathFormat, string path, string linkId, Option<UpdatePaymentLinkRequest> updatePaymentLinkRequest)
        {
            bool suppressDefaultLog = false;
            OnErrorUpdatePaymentLink(ref suppressDefaultLog, exception, pathFormat, path, linkId, updatePaymentLinkRequest);
            if (!suppressDefaultLog)
                Logger.LogError(exception, "An error occurred while sending the request to the server.");
        }
        ...
        /// <param name="linkId"></param>
        /// <param name="updatePaymentLinkRequest"></param>
        partial void OnErrorUpdatePaymentLink(ref bool suppressDefaultLog, Exception exception, string pathFormat, string path, string linkId, Option<UpdatePaymentLinkRequest> updatePaymentLinkRequest);
        ...
        public async Task<IUpdatePaymentLinkApiResponse> UpdatePaymentLinkAsync(string linkId, Option<UpdatePaymentLinkRequest> updatePaymentLinkRequest = default, System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                using (HttpRequestMessage httpRequestMessage = new HttpRequestMessage())
                {
                    ...
                    using (HttpResponseMessage httpResponseMessage = await HttpClient.SendAsync(httpRequestMessage, cancellationToken).ConfigureAwait(false))
                    {
                        ...
                        AfterUpdatePaymentLinkDefaultImplementation(apiResponse, linkId, updatePaymentLinkRequest);
            ...
            {
                OnErrorUpdatePaymentLinkDefaultImplementation(e, "/paymentLinks/{linkId}", uriBuilder.Path, linkId, updatePaymentLinkRequest);
