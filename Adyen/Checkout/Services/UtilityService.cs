...
namespace Adyen.Checkout.Services
{
    ...
    public interface IUtilityService : IAdyenApiService
    {
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns><see cref="Task"/>&lt;<see cref="IValidateShopperIdApiResponse"/>&gt;</returns>
    ...
    public sealed partial class UtilityService : IUtilityService
    {
        ...
        partial void FormatGetApplePaySession(ref Option<string> idempotencyKey, Option<ApplePaySessionRequest> applePaySessionRequest);
        ...
        /// <returns></returns>
        private void ValidateGetApplePaySession(Option<string> idempotencyKey, Option<ApplePaySessionRequest> applePaySessionRequest)
        {
        ...
        /// <param name="idempotencyKey"></param>
        /// <param name="applePaySessionRequest"></param>
        private void AfterGetApplePaySessionDefaultImplementation(IGetApplePaySessionApiResponse apiResponse, Option<string> idempotencyKey, Option<ApplePaySessionRequest> applePaySessionRequest)
        {
            bool suppressDefaultLog = false;
            AfterGetApplePaySession(ref suppressDefaultLog, apiResponse, idempotencyKey, applePaySessionRequest);
        ...
        /// <param name="idempotencyKey"></param>
        /// <param name="applePaySessionRequest"></param>
        partial void AfterGetApplePaySession(ref bool suppressDefaultLog, IGetApplePaySessionApiResponse apiResponse, Option<string> idempotencyKey, Option<ApplePaySessionRequest> applePaySessionRequest);
        ...
        /// <param name="idempotencyKey"></param>
        /// <param name="applePaySessionRequest"></param>
        private void OnErrorGetApplePaySessionDefaultImplementation(Exception exception, string pathFormat, string path, Option<string> idempotencyKey, Option<ApplePaySessionRequest> applePaySessionRequest)
        {
            bool suppressDefaultLog = false;
            OnErrorGetApplePaySession(ref suppressDefaultLog, exception, pathFormat, path, idempotencyKey, applePaySessionRequest);
            if (!suppressDefaultLog)
        ...
        /// <param name="idempotencyKey"></param>
        /// <param name="applePaySessionRequest"></param>
        partial void OnErrorGetApplePaySession(ref bool suppressDefaultLog, Exception exception, string pathFormat, string path, Option<string> idempotencyKey, Option<ApplePaySessionRequest> applePaySessionRequest);
        ...
        public async Task<IGetApplePaySessionApiResponse> GetApplePaySessionAsync(Option<string> idempotencyKey = default, Option<ApplePaySessionRequest> applePaySessionRequest = default, System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                using (HttpRequestMessage httpRequestMessage = new HttpRequestMessage())
                {
                    ...
                    using (HttpResponseMessage httpResponseMessage = await HttpClient.SendAsync(httpRequestMessage, cancellationToken).ConfigureAwait(false))
                    {
                        ...
                        AfterGetApplePaySessionDefaultImplementation(apiResponse, idempotencyKey, applePaySessionRequest);
            ...
            {
                OnErrorGetApplePaySessionDefaultImplementation(e, "/applePay/sessions", uriBuilder.Path, idempotencyKey, applePaySessionRequest);
        ...
        partial void FormatOriginKeys(ref Option<string> idempotencyKey, Option<UtilityRequest> utilityRequest);
        ...
        /// <returns></returns>
        private void ValidateOriginKeys(Option<string> idempotencyKey, Option<UtilityRequest> utilityRequest)
        {
            if (idempotencyKey.IsSet && idempotencyKey.Value == null)
                throw new ArgumentNullException(nameof(idempotencyKey));
        ...
        /// <param name="idempotencyKey"></param>
        /// <param name="utilityRequest"></param>
        private void AfterOriginKeysDefaultImplementation(IOriginKeysApiResponse apiResponse, Option<string> idempotencyKey, Option<UtilityRequest> utilityRequest)
        {
            bool suppressDefaultLog = false;
            AfterOriginKeys(ref suppressDefaultLog, apiResponse, idempotencyKey, utilityRequest);
            if (!suppressDefaultLog)
                Logger.LogInformation("{0,-9} | {1} | {3}", (apiResponse.DownloadedAt - apiResponse.RequestedAt).TotalSeconds, apiResponse.StatusCode, apiResponse.Path);
        }
        ...
        /// <param name="idempotencyKey"></param>
        /// <param name="utilityRequest"></param>
        partial void AfterOriginKeys(ref bool suppressDefaultLog, IOriginKeysApiResponse apiResponse, Option<string> idempotencyKey, Option<UtilityRequest> utilityRequest);
        ...
        /// <param name="idempotencyKey"></param>
        /// <param name="utilityRequest"></param>
        private void OnErrorOriginKeysDefaultImplementation(Exception exception, string pathFormat, string path, Option<string> idempotencyKey, Option<UtilityRequest> utilityRequest)
        {
            bool suppressDefaultLog = false;
            OnErrorOriginKeys(ref suppressDefaultLog, exception, pathFormat, path, idempotencyKey, utilityRequest);
            if (!suppressDefaultLog)
                Logger.LogError(exception, "An error occurred while sending the request to the server.");
        }
        ...
        /// <param name="idempotencyKey"></param>
        /// <param name="utilityRequest"></param>
        partial void OnErrorOriginKeys(ref bool suppressDefaultLog, Exception exception, string pathFormat, string path, Option<string> idempotencyKey, Option<UtilityRequest> utilityRequest);
        ...
        public async Task<IOriginKeysApiResponse> OriginKeysAsync(Option<string> idempotencyKey = default, Option<UtilityRequest> utilityRequest = default, System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                using (HttpRequestMessage httpRequestMessage = new HttpRequestMessage())
                {
                    ...
                    using (HttpResponseMessage httpResponseMessage = await HttpClient.SendAsync(httpRequestMessage, cancellationToken).ConfigureAwait(false))
                    {
                        ...
                        AfterOriginKeysDefaultImplementation(apiResponse, idempotencyKey, utilityRequest);
            ...
            {
                OnErrorOriginKeysDefaultImplementation(e, "/originKeys", uriBuilder.Path, idempotencyKey, utilityRequest);
        ...
        partial void FormatUpdatesOrderForPaypalExpressCheckout(ref Option<string> idempotencyKey, Option<PaypalUpdateOrderRequest> paypalUpdateOrderRequest);
        ...
        /// <returns></returns>
        private void ValidateUpdatesOrderForPaypalExpressCheckout(Option<string> idempotencyKey, Option<PaypalUpdateOrderRequest> paypalUpdateOrderRequest)
        {
            if (idempotencyKey.IsSet && idempotencyKey.Value == null)
                throw new ArgumentNullException(nameof(idempotencyKey));
        ...
        /// <param name="idempotencyKey"></param>
        /// <param name="paypalUpdateOrderRequest"></param>
        private void AfterUpdatesOrderForPaypalExpressCheckoutDefaultImplementation(IUpdatesOrderForPaypalExpressCheckoutApiResponse apiResponse, Option<string> idempotencyKey, Option<PaypalUpdateOrderRequest> paypalUpdateOrderRequest)
        {
            bool suppressDefaultLog = false;
            AfterUpdatesOrderForPaypalExpressCheckout(ref suppressDefaultLog, apiResponse, idempotencyKey, paypalUpdateOrderRequest);
            if (!suppressDefaultLog)
                Logger.LogInformation("{0,-9} | {1} | {3}", (apiResponse.DownloadedAt - apiResponse.RequestedAt).TotalSeconds, apiResponse.StatusCode, apiResponse.Path);
        }
        ...
        /// <param name="idempotencyKey"></param>
        /// <param name="paypalUpdateOrderRequest"></param>
        partial void AfterUpdatesOrderForPaypalExpressCheckout(ref bool suppressDefaultLog, IUpdatesOrderForPaypalExpressCheckoutApiResponse apiResponse, Option<string> idempotencyKey, Option<PaypalUpdateOrderRequest> paypalUpdateOrderRequest);
        ...
        /// <param name="idempotencyKey"></param>
        /// <param name="paypalUpdateOrderRequest"></param>
        private void OnErrorUpdatesOrderForPaypalExpressCheckoutDefaultImplementation(Exception exception, string pathFormat, string path, Option<string> idempotencyKey, Option<PaypalUpdateOrderRequest> paypalUpdateOrderRequest)
        {
            bool suppressDefaultLog = false;
            OnErrorUpdatesOrderForPaypalExpressCheckout(ref suppressDefaultLog, exception, pathFormat, path, idempotencyKey, paypalUpdateOrderRequest);
            if (!suppressDefaultLog)
                Logger.LogError(exception, "An error occurred while sending the request to the server.");
        }
        ...
        /// <param name="idempotencyKey"></param>
        /// <param name="paypalUpdateOrderRequest"></param>
        partial void OnErrorUpdatesOrderForPaypalExpressCheckout(ref bool suppressDefaultLog, Exception exception, string pathFormat, string path, Option<string> idempotencyKey, Option<PaypalUpdateOrderRequest> paypalUpdateOrderRequest);
        ...
        public async Task<IUpdatesOrderForPaypalExpressCheckoutApiResponse> UpdatesOrderForPaypalExpressCheckoutAsync(Option<string> idempotencyKey = default, Option<PaypalUpdateOrderRequest> paypalUpdateOrderRequest = default, System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                using (HttpRequestMessage httpRequestMessage = new HttpRequestMessage())
                {
                    ...
                    using (HttpResponseMessage httpResponseMessage = await HttpClient.SendAsync(httpRequestMessage, cancellationToken).ConfigureAwait(false))
                    {
                        ...
                        AfterUpdatesOrderForPaypalExpressCheckoutDefaultImplementation(apiResponse, idempotencyKey, paypalUpdateOrderRequest);
            ...
            {
                OnErrorUpdatesOrderForPaypalExpressCheckoutDefaultImplementation(e, "/paypal/updateOrder", uriBuilder.Path, idempotencyKey, paypalUpdateOrderRequest);
        ...
        partial void FormatValidateShopperId(ValidateShopperIdRequest validateShopperIdRequest);
        ...
        /// <param name="validateShopperIdRequest"></param>
        /// <returns></returns>
        private void ValidateValidateShopperId(ValidateShopperIdRequest validateShopperIdRequest)
        {
            if (validateShopperIdRequest == null)
                throw new ArgumentNullException(nameof(validateShopperIdRequest));
        }
        ...
        /// <param name="apiResponse"></param>
        /// <param name="validateShopperIdRequest"></param>
        private void AfterValidateShopperIdDefaultImplementation(IValidateShopperIdApiResponse apiResponse, ValidateShopperIdRequest validateShopperIdRequest)
        {
            bool suppressDefaultLog = false;
            AfterValidateShopperId(ref suppressDefaultLog, apiResponse, validateShopperIdRequest);
            if (!suppressDefaultLog)
                Logger.LogInformation("{0,-9} | {1} | {3}", (apiResponse.DownloadedAt - apiResponse.RequestedAt).TotalSeconds, apiResponse.StatusCode, apiResponse.Path);
        }
        ...
        /// <param name="apiResponse"></param>
        /// <param name="validateShopperIdRequest"></param>
        partial void AfterValidateShopperId(ref bool suppressDefaultLog, IValidateShopperIdApiResponse apiResponse, ValidateShopperIdRequest validateShopperIdRequest);
        ...
        /// <param name="path"></param>
        /// <param name="validateShopperIdRequest"></param>
        private void OnErrorValidateShopperIdDefaultImplementation(Exception exception, string pathFormat, string path, ValidateShopperIdRequest validateShopperIdRequest)
        {
            bool suppressDefaultLog = false;
            OnErrorValidateShopperId(ref suppressDefaultLog, exception, pathFormat, path, validateShopperIdRequest);
            if (!suppressDefaultLog)
                Logger.LogError(exception, "An error occurred while sending the request to the server.");
        }
        ...
        /// <param name="path"></param>
        /// <param name="validateShopperIdRequest"></param>
        partial void OnErrorValidateShopperId(ref bool suppressDefaultLog, Exception exception, string pathFormat, string path, ValidateShopperIdRequest validateShopperIdRequest);
        ...
        public async Task<IValidateShopperIdApiResponse> ValidateShopperIdAsync(ValidateShopperIdRequest validateShopperIdRequest, System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ValidateValidateShopperId(validateShopperIdRequest);

                FormatValidateShopperId(validateShopperIdRequest);
                ...
                using (HttpRequestMessage httpRequestMessage = new HttpRequestMessage())
                {
                    ...
                    using (HttpResponseMessage httpResponseMessage = await HttpClient.SendAsync(httpRequestMessage, cancellationToken).ConfigureAwait(false))
                    {
                        ...
                        AfterValidateShopperIdDefaultImplementation(apiResponse, validateShopperIdRequest);
            ...
            {
                OnErrorValidateShopperIdDefaultImplementation(e, "/validateShopperId", uriBuilder.Path, validateShopperIdRequest);
                Events.ExecuteOnErrorValidateShopperId(e);
                throw;
            }
        }
