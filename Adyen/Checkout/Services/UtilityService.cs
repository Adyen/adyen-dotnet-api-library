...
namespace Adyen.Checkout.Services
{
    ...
    /// </summary>
    public interface IValidateShopperIdApiResponse : Adyen.Core.Client.IApiResponse, IOk<Adyen.Checkout.Models.ValidateShopperIdResponse?>, IBadRequest<Adyen.Checkout.Models.CheckoutErrorResponseEntity?>, IUnauthorized<Adyen.Checkout.Models.CheckoutErrorResponseEntity?>, IForbidden<Adyen.Checkout.Models.CheckoutErrorResponseEntity?>, IUnprocessableContent<Adyen.Checkout.Models.CheckoutErrorResponseEntity?>, IInternalServerError<Adyen.Checkout.Models.CheckoutErrorResponseEntity?>
    {
        /// <summary>
        /// Returns true if the response is 200 Ok.
        /// </summary>
    ...
    public sealed partial class UtilityService : IUtilityService
    {
        ...
        /// </summary>
        public UtilityService(AdyenOptionsProvider adyenOptionsProvider, ILogger<UtilityService> logger, ILoggerFactory loggerFactory, System.Net.Http.HttpClient httpClient, JsonSerializerOptionsProvider jsonSerializerOptionsProvider, ITokenProvider<ApiKeyToken> apiKeyProvider, UtilityServiceEvents utilityServiceEvents = null)
        {
            _jsonSerializerOptions = jsonSerializerOptionsProvider.Options;
            LoggerFactory = loggerFactory;
            Logger = logger ?? Microsoft.Extensions.Logging.Abstractions.NullLogger<UtilityService>.Instance;
        ...
        public partial class ValidateShopperIdApiResponse : Adyen.Core.Client.ApiResponse, IValidateShopperIdApiResponse
        {
            ...
            /// </summary>
            /// <returns></returns>
            public Adyen.Checkout.Models.CheckoutErrorResponseEntity? BadRequest()
            {
                return IsBadRequest
                    ? System.Text.Json.JsonSerializer.Deserialize<Adyen.Checkout.Models.CheckoutErrorResponseEntity>(RawContent, _jsonSerializerOptions)
                    : null;
            }
            ...
            /// <param name="result"></param>
            /// <returns></returns>
            public bool TryDeserializeBadRequestResponse([NotNullWhen(true)]out Adyen.Checkout.Models.CheckoutErrorResponseEntity? result)
            {
                result = null;
            ...
            /// </summary>
            /// <returns></returns>
            public Adyen.Checkout.Models.CheckoutErrorResponseEntity? Unauthorized()
            {
                return IsUnauthorized
                    ? System.Text.Json.JsonSerializer.Deserialize<Adyen.Checkout.Models.CheckoutErrorResponseEntity>(RawContent, _jsonSerializerOptions)
                    : null;
            ...
            /// <param name="result"></param>
            /// <returns></returns>
            public bool TryDeserializeUnauthorizedResponse([NotNullWhen(true)]out Adyen.Checkout.Models.CheckoutErrorResponseEntity? result)
            {
                result = null;
            ...
            /// </summary>
            /// <returns></returns>
            public Adyen.Checkout.Models.CheckoutErrorResponseEntity? Forbidden()
            {
                return IsForbidden
                    ? System.Text.Json.JsonSerializer.Deserialize<Adyen.Checkout.Models.CheckoutErrorResponseEntity>(RawContent, _jsonSerializerOptions)
                    : null;
            ...
            /// <param name="result"></param>
            /// <returns></returns>
            public bool TryDeserializeForbiddenResponse([NotNullWhen(true)]out Adyen.Checkout.Models.CheckoutErrorResponseEntity? result)
            {
                result = null;
            ...
            /// </summary>
            /// <returns></returns>
            public Adyen.Checkout.Models.CheckoutErrorResponseEntity? UnprocessableContent()
            {
                return IsUnprocessableContent
                    ? System.Text.Json.JsonSerializer.Deserialize<Adyen.Checkout.Models.CheckoutErrorResponseEntity>(RawContent, _jsonSerializerOptions)
                    : null;
            ...
            /// <param name="result"></param>
            /// <returns></returns>
            public bool TryDeserializeUnprocessableContentResponse([NotNullWhen(true)]out Adyen.Checkout.Models.CheckoutErrorResponseEntity? result)
            {
                result = null;
            ...
            /// </summary>
            /// <returns></returns>
            public Adyen.Checkout.Models.CheckoutErrorResponseEntity? InternalServerError()
            {
                return IsInternalServerError
                    ? System.Text.Json.JsonSerializer.Deserialize<Adyen.Checkout.Models.CheckoutErrorResponseEntity>(RawContent, _jsonSerializerOptions)
                    : null;
            ...
            /// <param name="result"></param>
            /// <returns></returns>
            public bool TryDeserializeInternalServerErrorResponse([NotNullWhen(true)]out Adyen.Checkout.Models.CheckoutErrorResponseEntity? result)
            {
                result = null;
