...
namespace Adyen.Checkout.Extensions
{
    ...
    public static class HostBuilderExtensions
    {
        ...
        public static IHostBuilder ConfigureCheckout(this IHostBuilder builder, Action<HostBuilderContext, IServiceCollection, HostConfiguration> options)
        {
            builder.ConfigureServices((context, services) => 
            {
                ...
                ServiceCollectionExtensions.AddCheckoutServices(services, config);
            });
