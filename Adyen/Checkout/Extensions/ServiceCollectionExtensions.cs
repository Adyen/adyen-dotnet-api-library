...
namespace Adyen.Checkout.Extensions
{
    ...
    public static class ServiceCollectionExtensions
    {
        ...
        /// <summary>
        /// Add the Adyen Checkout API services to your host builder.
        /// </summary>
        /// <param name="services"></param>
        /// <param name="options"></param>
        public static void AddCheckoutServices(this IServiceCollection services, Action<HostConfiguration> options)
        {
            HostConfiguration config = new(services);
            options(config);
            AddCheckoutServices(services, config);
        }

        internal static void AddCheckoutServices(IServiceCollection services, HostConfiguration host)
        {
            if (!host.HttpClientsAdded)
                host.AddCheckoutHttpClients();
