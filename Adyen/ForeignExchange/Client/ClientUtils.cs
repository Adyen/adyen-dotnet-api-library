...
using Adyen.Core;
#endif
using Models = Adyen.ForeignExchange.Models;
...
namespace Adyen.ForeignExchange.Client
{
    ...
    public static partial class ClientUtils
    {
        ...
        public static string? ParameterToString(object? obj, string? format = ISO8601_DATETIME_FORMAT)
        {
            ...
            if (obj is Models.ExchangeSide exchangeSide)
                return ExchangeSide.ToJsonValue(exchangeSide);
            if (obj is Models.RateType rateType)
                return RateType.ToJsonValue(rateType);
