...
using Adyen.ForeignExchange.Extensions;
using Adyen.Core;
...
namespace Adyen.ForeignExchange.Client
{
    /// <summary>
    /// Provides hosting configuration for ForeignExchange
    /// </summary>
    public class HostConfiguration
    {
        ...
        public HostConfiguration(IServiceCollection services)
        {
            ...
            _jsonOptions.Converters.Add(new CalculateRateRequestJsonConverter());
            _jsonOptions.Converters.Add(new CalculateRateRequestItemJsonConverter());
            _jsonOptions.Converters.Add(new CalculateRateResponseJsonConverter());
            _jsonOptions.Converters.Add(new CalculateRateResponseItemJsonConverter());
            _jsonOptions.Converters.Add(new DefaultErrorResponseEntityJsonConverter());
            _jsonOptions.Converters.Add(new ExchangeSide.ExchangeSideJsonConverter());
            _jsonOptions.Converters.Add(new InvalidFieldJsonConverter());
            _jsonOptions.Converters.Add(new RateType.RateTypeJsonConverter());
