...
using Adyen.Core;
#endif
using Models = Adyen.BinLookup.Models;
...
namespace Adyen.BinLookup.Client
{
    ...
    public static partial class ClientUtils
    {
        ...
        public static string? ParameterToString(object? obj, string? format = ISO8601_DATETIME_FORMAT)
        {
            ...
            if (obj is Models.CostEstimateRequest.ShopperInteractionEnum costEstimateRequestShopperInteractionEnum)
                return Models.CostEstimateRequest.ShopperInteractionEnum.ToJsonValue(costEstimateRequestShopperInteractionEnum);
