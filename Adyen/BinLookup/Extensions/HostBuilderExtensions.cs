...
namespace Adyen.BinLookup.Extensions
{
    ...
    public static class HostBuilderExtensions
    {
        ...
        public static IHostBuilder ConfigureBinLookup(this IHostBuilder builder, Action<HostBuilderContext, IServiceCollection, HostConfiguration> options)
        {
            builder.ConfigureServices((context, services) => 
            {
                ...
                ServiceCollectionExtensions.AddBinLookupServices(services, config);
            });
