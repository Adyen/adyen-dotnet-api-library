...
namespace Adyen.BinLookup.Extensions
{
    ...
    {
        /// <summary>
        /// Initializes the <see cref="HostConfiguration"/> *without* adding the BinLookup API services defaults to the <see cref="IServiceCollection"/>.
        /// Use <see cref="Adyen.BinLookup.Extensions.IServiceCollectionExtensions"/> to add the BinLookup API services to the <see cref="IServiceCollection"/>.
        /// </summary>
        ...
        /// <summary>
        /// Initializes the <see cref="HostConfiguration"/> *and* adds the BinLookup API services defaults to the <see cref="IServiceCollection"/>.
        ...
        public static IHostBuilder ConfigureBinLookupDefaults(this IHostBuilder hostBuilder, Action<HostBuilderContext, IServiceCollection, HostConfiguration> hostConfigurationOptions, ServiceLifetime serviceLifetime = ServiceLifetime.Singleton, Action<System.Net.Http.HttpClient>? httpClientOptions = null, Action<IHttpClientBuilder>? httpClientBuilderOptions = null)
        {
            hostBuilder.ConfigureServices((context, services) => 
            {
                HostConfiguration hostConfiguration = new HostConfiguration(services);
                ...
                hostConfigurationOptions(context, services, hostConfiguration);
                services.AddAllBinLookupServices(serviceLifetime, httpClientOptions, httpClientBuilderOptions);
