...
namespace Adyen.BinLookup.Models
{
    ...
    /// </summary>
    [JsonConverter(typeof(ThreeDSAvailabilityRequestJsonConverter))]
    ...
    public class ThreeDSAvailabilityRequestJsonConverter : JsonConverter<ThreeDSAvailabilityRequest>
    {
        ...
        public override ThreeDSAvailabilityRequest Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (brands.IsSet)
                threeDSAvailabilityRequest.Brands = brands.Value;
            if (cardNumber.IsSet)
                threeDSAvailabilityRequest.CardNumber = cardNumber.Value;
            if (recurringDetailReference.IsSet)
                threeDSAvailabilityRequest.RecurringDetailReference = recurringDetailReference.Value;
            if (shopperReference.IsSet)
                threeDSAvailabilityRequest.ShopperReference = shopperReference.Value;
