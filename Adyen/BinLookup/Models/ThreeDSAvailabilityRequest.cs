...
namespace Adyen.BinLookup.Models
{
    ...
    /// </summary>
    public partial class ThreeDSAvailabilityRequest : IValidatableObject
    {
        /// <summary>
    ...
    public class ThreeDSAvailabilityRequestJsonConverter : JsonConverter<ThreeDSAvailabilityRequest>
    {
        ...
        public override ThreeDSAvailabilityRequest Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (merchantAccount.IsSet && merchantAccount.Value == null)
                throw new ArgumentNullException(nameof(merchantAccount), "Property is not nullable for class ThreeDSAvailabilityRequest.");

            if (additionalData.IsSet && additionalData.Value == null)
                throw new ArgumentNullException(nameof(additionalData), "Property is not nullable for class ThreeDSAvailabilityRequest.");

            if (brands.IsSet && brands.Value == null)
                throw new ArgumentNullException(nameof(brands), "Property is not nullable for class ThreeDSAvailabilityRequest.");

            if (cardNumber.IsSet && cardNumber.Value == null)
                throw new ArgumentNullException(nameof(cardNumber), "Property is not nullable for class ThreeDSAvailabilityRequest.");

            if (recurringDetailReference.IsSet && recurringDetailReference.Value == null)
                throw new ArgumentNullException(nameof(recurringDetailReference), "Property is not nullable for class ThreeDSAvailabilityRequest.");

            if (shopperReference.IsSet && shopperReference.Value == null)
                throw new ArgumentNullException(nameof(shopperReference), "Property is not nullable for class ThreeDSAvailabilityRequest.");
        ...
        public void WriteProperties(Utf8JsonWriter writer, ThreeDSAvailabilityRequest threeDSAvailabilityRequest, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (threeDSAvailabilityRequest.MerchantAccount == null)
                throw new ArgumentNullException(nameof(threeDSAvailabilityRequest.MerchantAccount), "Property is required for class ThreeDSAvailabilityRequest.");

            if (threeDSAvailabilityRequest._AdditionalDataOption.IsSet && threeDSAvailabilityRequest.AdditionalData == null)
                throw new ArgumentNullException(nameof(threeDSAvailabilityRequest.AdditionalData), "Property is required for class ThreeDSAvailabilityRequest.");

            if (threeDSAvailabilityRequest._BrandsOption.IsSet && threeDSAvailabilityRequest.Brands == null)
                throw new ArgumentNullException(nameof(threeDSAvailabilityRequest.Brands), "Property is required for class ThreeDSAvailabilityRequest.");

            if (threeDSAvailabilityRequest._CardNumberOption.IsSet && threeDSAvailabilityRequest.CardNumber == null)
                throw new ArgumentNullException(nameof(threeDSAvailabilityRequest.CardNumber), "Property is required for class ThreeDSAvailabilityRequest.");

            if (threeDSAvailabilityRequest._RecurringDetailReferenceOption.IsSet && threeDSAvailabilityRequest.RecurringDetailReference == null)
                throw new ArgumentNullException(nameof(threeDSAvailabilityRequest.RecurringDetailReference), "Property is required for class ThreeDSAvailabilityRequest.");

            if (threeDSAvailabilityRequest._ShopperReferenceOption.IsSet && threeDSAvailabilityRequest.ShopperReference == null)
                throw new ArgumentNullException(nameof(threeDSAvailabilityRequest.ShopperReference), "Property is required for class ThreeDSAvailabilityRequest.");
