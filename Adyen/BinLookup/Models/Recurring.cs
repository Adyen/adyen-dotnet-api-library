...
namespace Adyen.BinLookup.Models
{
    ...
    /// Recurring.
    /// </summary>
    [JsonConverter(typeof(RecurringJsonConverter))]
    public partial class Recurring
    {
        ...
        public class ContractEnum : IEnum
        {
            ...
            /// <summary>
            /// Compares two <see cref="ContractEnum"/> instances for equality.
            /// </summary>
            ...
            /// <summary>
            /// Compares two <see cref="ContractEnum"/> instances for inequality.
            /// </summary>
            public static bool operator !=(ContractEnum? left, ContractEnum? right) => !string.Equals(left?.Value, right?.Value, StringComparison.OrdinalIgnoreCase);

            /// <summary>
            /// Returns true if the given object is equal to this <see cref="ContractEnum"/> instance.
            /// </summary>
            ...
            /// <summary>
            /// Returns a hash code for this <see cref="ContractEnum"/> instance.
            /// </summary>
            public override int GetHashCode() => Value?.GetHashCode() ?? 0;

            /// <summary>
            /// Returns the string value of the <see cref="ContractEnum"/> instance.
            /// </summary>
            ...
            {
                /// <summary>
                /// Deserializes a <see cref="ContractEnum"/> from JSON.
                /// </summary>
                ...
                /// <summary>
                /// Serializes a <see cref="ContractEnum"/> to JSON.
                /// </summary>
        ...
        public class TokenServiceEnum : IEnum
        {
            ...
            /// <summary>
            /// Compares two <see cref="TokenServiceEnum"/> instances for equality.
            /// </summary>
            ...
            /// <summary>
            /// Compares two <see cref="TokenServiceEnum"/> instances for inequality.
            /// </summary>
            public static bool operator !=(TokenServiceEnum? left, TokenServiceEnum? right) => !string.Equals(left?.Value, right?.Value, StringComparison.OrdinalIgnoreCase);

            /// <summary>
            /// Returns true if the given object is equal to this <see cref="TokenServiceEnum"/> instance.
            /// </summary>
            ...
            /// <summary>
            /// Returns a hash code for this <see cref="TokenServiceEnum"/> instance.
            /// </summary>
            public override int GetHashCode() => Value?.GetHashCode() ?? 0;

            /// <summary>
            /// Returns the string value of the <see cref="TokenServiceEnum"/> instance.
            /// </summary>
            public override string ToString() => Value ?? string.Empty;
            ...
            {
                /// <summary>
                /// Deserializes a <see cref="TokenServiceEnum"/> from JSON.
                /// </summary>
                ...
                /// <summary>
                /// Serializes a <see cref="TokenServiceEnum"/> to JSON.
                /// </summary>
    ...
    public class RecurringJsonConverter : JsonConverter<Recurring>
    {
        ...
        public override Recurring Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (recurringDetailName.IsSet)
                recurring.RecurringDetailName = recurringDetailName.Value;
            if (recurringExpiry.IsSet)
                recurring.RecurringExpiry = recurringExpiry.Value;
            if (recurringFrequency.IsSet)
                recurring.RecurringFrequency = recurringFrequency.Value;
            if (tokenService.IsSet)
                recurring.TokenService = tokenService.Value;
            return recurring;
        }
