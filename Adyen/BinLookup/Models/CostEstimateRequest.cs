...
namespace Adyen.BinLookup.Models
{
    ...
    /// CostEstimateRequest.
    /// </summary>
    [JsonConverter(typeof(CostEstimateRequestJsonConverter))]
    public partial class CostEstimateRequest
    {
        ...
        /// <summary>
        /// This is used to track if an optional field is set. If set, <see cref="MerchantDetails"/> will be populated.
        /// </summary>
        [JsonIgnore]
        [global::System.ComponentModel.EditorBrowsable(global::System.ComponentModel.EditorBrowsableState.Never)]
    ...
    public class CostEstimateRequestJsonConverter : JsonConverter<CostEstimateRequest>
    {
        ...
        public override CostEstimateRequest Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (cardNumber.IsSet)
                costEstimateRequest.CardNumber = cardNumber.Value;
            if (encryptedCardNumber.IsSet)
                costEstimateRequest.EncryptedCardNumber = encryptedCardNumber.Value;
            if (merchantDetails.IsSet)
                costEstimateRequest.MerchantDetails = merchantDetails.Value;
            if (recurring.IsSet)
                costEstimateRequest.Recurring = recurring.Value;
            if (selectedRecurringDetailReference.IsSet)
                costEstimateRequest.SelectedRecurringDetailReference = selectedRecurringDetailReference.Value;
            if (shopperInteraction.IsSet)
                costEstimateRequest.ShopperInteraction = shopperInteraction.Value;
            if (shopperReference.IsSet)
                costEstimateRequest.ShopperReference = shopperReference.Value;
        ...
        public void WriteProperties(Utf8JsonWriter writer, CostEstimateRequest costEstimateRequest, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (costEstimateRequest._SelectedRecurringDetailReferenceOption.IsSet)
                if (costEstimateRequest.SelectedRecurringDetailReference != null)
            ...
            if (costEstimateRequest._ShopperReferenceOption.IsSet)
                if (costEstimateRequest.ShopperReference != null)
