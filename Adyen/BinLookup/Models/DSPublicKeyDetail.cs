...
namespace Adyen.BinLookup.Models
{
    ...
    public class DSPublicKeyDetailJsonConverter : JsonConverter<DSPublicKeyDetail>
    {
        ...
        public override DSPublicKeyDetail Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (directoryServerId.IsSet)
                dSPublicKeyDetail.DirectoryServerId = directoryServerId.Value;
            if (fromSDKVersion.IsSet)
                dSPublicKeyDetail.FromSDKVersion = fromSDKVersion.Value;
            if (publicKey.IsSet)
                dSPublicKeyDetail.PublicKey = publicKey.Value;
            if (rootCertificates.IsSet)
                dSPublicKeyDetail.RootCertificates = rootCertificates.Value;
            return dSPublicKeyDetail;
        }
