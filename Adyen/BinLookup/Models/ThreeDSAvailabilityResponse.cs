...
namespace Adyen.BinLookup.Models
{
    ...
    /// </summary>
    [JsonConverter(typeof(ThreeDSAvailabilityResponseJsonConverter))]
    public partial class ThreeDSAvailabilityResponse
    {
        /// <summary>
    ...
    public class ThreeDSAvailabilityResponseJsonConverter : JsonConverter<ThreeDSAvailabilityResponse>
    {
        ...
        public override ThreeDSAvailabilityResponse Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (dsPublicKeys.IsSet)
                threeDSAvailabilityResponse.DsPublicKeys = dsPublicKeys.Value;
            if (threeDS1Supported.IsSet)
                threeDSAvailabilityResponse.ThreeDS1Supported = threeDS1Supported.Value;
            if (threeDS2CardRangeDetails.IsSet)
                threeDSAvailabilityResponse.ThreeDS2CardRangeDetails = threeDS2CardRangeDetails.Value;
            if (threeDS2supported.IsSet)
                threeDSAvailabilityResponse.ThreeDS2supported = threeDS2supported.Value;
