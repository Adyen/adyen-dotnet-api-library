    ...
    public class BinDetailJsonConverter : JsonConverter<BinDetail>
    {
        ...
        public override BinDetail Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (issuerCountry.IsSet && issuerCountry.Value == null)
                throw new ArgumentNullException(nameof(issuerCountry), "Property is not nullable for class BinDetail.");
        ...
        {
            /*
            if (binDetail._IssuerCountryOption.IsSet && binDetail.IssuerCountry == null)
                throw new ArgumentNullException(nameof(binDetail.IssuerCountry), "Property is required for class BinDetail.");
