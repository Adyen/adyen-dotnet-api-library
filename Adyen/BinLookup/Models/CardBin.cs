...
namespace Adyen.BinLookup.Models
{
    ...
    /// CardBin.
    /// </summary>
    public partial class CardBin : IValidatableObject
    {
        /// <summary>
    ...
    public class CardBinJsonConverter : JsonConverter<CardBin>
    {
        ...
        public override CardBin Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (bin.IsSet && bin.Value == null)
                throw new ArgumentNullException(nameof(bin), "Property is not nullable for class CardBin.");

            if (commercial.IsSet && commercial.Value == null)
                throw new ArgumentNullException(nameof(commercial), "Property is not nullable for class CardBin.");

            if (fundingSource.IsSet && fundingSource.Value == null)
                throw new ArgumentNullException(nameof(fundingSource), "Property is not nullable for class CardBin.");

            if (fundsAvailability.IsSet && fundsAvailability.Value == null)
                throw new ArgumentNullException(nameof(fundsAvailability), "Property is not nullable for class CardBin.");

            if (issuerBin.IsSet && issuerBin.Value == null)
                throw new ArgumentNullException(nameof(issuerBin), "Property is not nullable for class CardBin.");

            if (issuingBank.IsSet && issuingBank.Value == null)
                throw new ArgumentNullException(nameof(issuingBank), "Property is not nullable for class CardBin.");

            if (issuingCountry.IsSet && issuingCountry.Value == null)
                throw new ArgumentNullException(nameof(issuingCountry), "Property is not nullable for class CardBin.");

            if (issuingCurrency.IsSet && issuingCurrency.Value == null)
                throw new ArgumentNullException(nameof(issuingCurrency), "Property is not nullable for class CardBin.");

            if (paymentMethod.IsSet && paymentMethod.Value == null)
                throw new ArgumentNullException(nameof(paymentMethod), "Property is not nullable for class CardBin.");

            if (payoutEligible.IsSet && payoutEligible.Value == null)
                throw new ArgumentNullException(nameof(payoutEligible), "Property is not nullable for class CardBin.");

            if (summary.IsSet && summary.Value == null)
                throw new ArgumentNullException(nameof(summary), "Property is not nullable for class CardBin.");
        ...
        {
            /*
            if (cardBin._BinOption.IsSet && cardBin.Bin == null)
                throw new ArgumentNullException(nameof(cardBin.Bin), "Property is required for class CardBin.");

            if (cardBin._FundingSourceOption.IsSet && cardBin.FundingSource == null)
                throw new ArgumentNullException(nameof(cardBin.FundingSource), "Property is required for class CardBin.");

            if (cardBin._FundsAvailabilityOption.IsSet && cardBin.FundsAvailability == null)
                throw new ArgumentNullException(nameof(cardBin.FundsAvailability), "Property is required for class CardBin.");

            if (cardBin._IssuerBinOption.IsSet && cardBin.IssuerBin == null)
                throw new ArgumentNullException(nameof(cardBin.IssuerBin), "Property is required for class CardBin.");

            if (cardBin._IssuingBankOption.IsSet && cardBin.IssuingBank == null)
                throw new ArgumentNullException(nameof(cardBin.IssuingBank), "Property is required for class CardBin.");

            if (cardBin._IssuingCountryOption.IsSet && cardBin.IssuingCountry == null)
                throw new ArgumentNullException(nameof(cardBin.IssuingCountry), "Property is required for class CardBin.");

            if (cardBin._IssuingCurrencyOption.IsSet && cardBin.IssuingCurrency == null)
                throw new ArgumentNullException(nameof(cardBin.IssuingCurrency), "Property is required for class CardBin.");

            if (cardBin._PaymentMethodOption.IsSet && cardBin.PaymentMethod == null)
                throw new ArgumentNullException(nameof(cardBin.PaymentMethod), "Property is required for class CardBin.");

            if (cardBin._PayoutEligibleOption.IsSet && cardBin.PayoutEligible == null)
                throw new ArgumentNullException(nameof(cardBin.PayoutEligible), "Property is required for class CardBin.");

            if (cardBin._SummaryOption.IsSet && cardBin.Summary == null)
                throw new ArgumentNullException(nameof(cardBin.Summary), "Property is required for class CardBin.");
