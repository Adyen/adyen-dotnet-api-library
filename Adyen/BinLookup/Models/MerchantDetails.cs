...
namespace Adyen.BinLookup.Models
{
    ...
    /// MerchantDetails.
    /// </summary>
    [JsonConverter(typeof(MerchantDetailsJsonConverter))]
    ...
    public class MerchantDetailsJsonConverter : JsonConverter<MerchantDetails>
    {
        ...
        public override MerchantDetails Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (enrolledIn3DSecure.IsSet)
                merchantDetails.EnrolledIn3DSecure = enrolledIn3DSecure.Value;
            if (mcc.IsSet)
                merchantDetails.Mcc = mcc.Value;
