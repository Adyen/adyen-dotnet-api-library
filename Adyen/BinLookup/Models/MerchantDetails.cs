    ...
    public class MerchantDetailsJsonConverter : JsonConverter<MerchantDetails>
    {
        ...
        public override MerchantDetails Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (countryCode.IsSet && countryCode.Value == null)
                throw new ArgumentNullException(nameof(countryCode), "Property is not nullable for class MerchantDetails.");

            if (enrolledIn3DSecure.IsSet && enrolledIn3DSecure.Value == null)
                throw new ArgumentNullException(nameof(enrolledIn3DSecure), "Property is not nullable for class MerchantDetails.");

            if (mcc.IsSet && mcc.Value == null)
                throw new ArgumentNullException(nameof(mcc), "Property is not nullable for class MerchantDetails.");
        ...
        {
            /*
            if (merchantDetails._CountryCodeOption.IsSet && merchantDetails.CountryCode == null)
                throw new ArgumentNullException(nameof(merchantDetails.CountryCode), "Property is required for class MerchantDetails.");

            if (merchantDetails._MccOption.IsSet && merchantDetails.Mcc == null)
                throw new ArgumentNullException(nameof(merchantDetails.Mcc), "Property is required for class MerchantDetails.");
