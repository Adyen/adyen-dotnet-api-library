...
namespace Adyen.Payout.Extensions
{
    ...
    public static class HostBuilderExtensions
    {
        ...
        public static IHostBuilder ConfigurePayout(this IHostBuilder builder, Action<HostBuilderContext, IServiceCollection, HostConfiguration> options)
        {
            builder.ConfigureServices((context, services) => 
            {
                ...
                ServiceCollectionExtensions.AddPayoutServices(services, config);
            });
