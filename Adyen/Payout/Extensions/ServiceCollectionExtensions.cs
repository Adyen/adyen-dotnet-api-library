...
namespace Adyen.Payout.Extensions
{
    ...
    public static class ServiceCollectionExtensions
    {
        ...
        /// <summary>
        /// Add the Adyen Payout API services to your host builder.
        /// </summary>
        /// <param name="services"></param>
        /// <param name="options"></param>
        public static void AddPayoutServices(this IServiceCollection services, Action<HostConfiguration> options)
        {
            HostConfiguration config = new(services);
            options(config);
            AddPayoutServices(services, config);
        }

        internal static void AddPayoutServices(IServiceCollection services, HostConfiguration host)
        {
            if (!host.HttpClientsAdded)
                host.AddPayoutHttpClients();
