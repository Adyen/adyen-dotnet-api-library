...
using Models = Adyen.Payout.Models;
...
namespace Adyen.Payout.Client
{
    ...
    public static partial class ClientUtils
    {
        ...
        public static string? ParameterToString(object? obj, string? format = ISO8601_DATETIME_FORMAT)
        {
            ...
            if (obj is Models.PayoutRequest.ShopperInteractionEnum payoutRequestShopperInteractionEnum)
                return Models.PayoutRequest.ShopperInteractionEnum.ToJsonValue(payoutRequestShopperInteractionEnum);
            if (obj is Models.PayoutResponse.ResultCodeEnum payoutResponseResultCodeEnum)
                return Models.PayoutResponse.ResultCodeEnum.ToJsonValue(payoutResponseResultCodeEnum);
            ...
            if (obj is Models.StoreDetailAndSubmitRequest.EntityTypeEnum storeDetailAndSubmitRequestEntityTypeEnum)
                return Models.StoreDetailAndSubmitRequest.EntityTypeEnum.ToJsonValue(storeDetailAndSubmitRequestEntityTypeEnum);
            if (obj is Models.StoreDetailRequest.EntityTypeEnum storeDetailRequestEntityTypeEnum)
                return Models.StoreDetailRequest.EntityTypeEnum.ToJsonValue(storeDetailRequestEntityTypeEnum);
            if (obj is Models.SubmitRequest.EntityTypeEnum submitRequestEntityTypeEnum)
                return Models.SubmitRequest.EntityTypeEnum.ToJsonValue(submitRequestEntityTypeEnum);
