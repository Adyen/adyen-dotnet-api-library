...
namespace Adyen.Payout.Services
{
    ...
    public interface IInstantPayoutsService : IAdyenApiService
    {
        ...
        /// <returns><see cref="Task"/>&lt;<see cref="IPayoutApiResponse"/>&gt;</returns>
        Task<IPayoutApiResponse> PayoutAsync(Option<PayoutRequest> payoutRequest = default, System.Threading.CancellationToken cancellationToken = default);
    ...
    public sealed partial class InstantPayoutsService : IInstantPayoutsService
    {
            ...
            ITokenProvider<ApiKeyToken> apiKeyProvider)
        {
            ...
            Logger = LoggerFactory.CreateLogger<InstantPayoutsService>();
            HttpClient = httpClient;
            Events = instantPayoutsServiceEvents;
            ApiKeyProvider = apiKeyProvider;
        }

        partial void FormatPayout(Option<PayoutRequest> payoutRequest);
        ...
        /// <returns></returns>
        private void ValidatePayout(Option<PayoutRequest> payoutRequest)
        {
            if (payoutRequest.IsSet && payoutRequest.Value == null)
                throw new ArgumentNullException(nameof(payoutRequest));
        }
        ...
        /// <param name="payoutRequest"></param>
        private void AfterPayoutDefaultImplementation(IPayoutApiResponse apiResponse, Option<PayoutRequest> payoutRequest)
        {
            bool suppressDefaultLog = false;
            AfterPayout(ref suppressDefaultLog, apiResponse, payoutRequest);
        ...
        /// <param name="apiResponse"></param>
        /// <param name="payoutRequest"></param>
        partial void AfterPayout(ref bool suppressDefaultLog, IPayoutApiResponse apiResponse, Option<PayoutRequest> payoutRequest);
        ...
        /// <param name="payoutRequest"></param>
        private void OnErrorPayoutDefaultImplementation(Exception exception, string pathFormat, string path, Option<PayoutRequest> payoutRequest)
        {
            bool suppressDefaultLog = false;
            OnErrorPayout(ref suppressDefaultLog, exception, pathFormat, path, payoutRequest);
            if (!suppressDefaultLog)
        ...
        /// <param name="path"></param>
        /// <param name="payoutRequest"></param>
        partial void OnErrorPayout(ref bool suppressDefaultLog, Exception exception, string pathFormat, string path, Option<PayoutRequest> payoutRequest);
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns><see cref="Task"/>&lt;<see cref="IPayoutApiResponse"/>&gt;</returns>
        public async Task<IPayoutApiResponse> PayoutAsync(Option<PayoutRequest> payoutRequest = default, System.Threading.CancellationToken cancellationToken = default)
        {
            UriBuilder uriBuilder = new UriBuilder();

            try
            {
                ValidatePayout(payoutRequest);

                FormatPayout(payoutRequest);
                ...
                using (HttpRequestMessage httpRequestMessage = new HttpRequestMessage())
                {
                    ...
                    using (HttpResponseMessage httpResponseMessage = await HttpClient.SendAsync(httpRequestMessage, cancellationToken).ConfigureAwait(false))
                    {
                        ...
                        AfterPayoutDefaultImplementation(apiResponse, payoutRequest);
            ...
            {
                OnErrorPayoutDefaultImplementation(e, "/payout", uriBuilder.Path, payoutRequest);
                Events.ExecuteOnErrorPayout(e);
                throw;
            }
        }
