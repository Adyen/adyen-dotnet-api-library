    ...
    public class FundSourceJsonConverter : JsonConverter<FundSource>
    {
        ...
        public override FundSource Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (additionalData.IsSet && additionalData.Value == null)
                throw new ArgumentNullException(nameof(additionalData), "Property is not nullable for class FundSource.");

            if (billingAddress.IsSet && billingAddress.Value == null)
                throw new ArgumentNullException(nameof(billingAddress), "Property is not nullable for class FundSource.");

            if (card.IsSet && card.Value == null)
                throw new ArgumentNullException(nameof(card), "Property is not nullable for class FundSource.");

            if (shopperEmail.IsSet && shopperEmail.Value == null)
                throw new ArgumentNullException(nameof(shopperEmail), "Property is not nullable for class FundSource.");

            if (shopperName.IsSet && shopperName.Value == null)
                throw new ArgumentNullException(nameof(shopperName), "Property is not nullable for class FundSource.");

            if (telephoneNumber.IsSet && telephoneNumber.Value == null)
                throw new ArgumentNullException(nameof(telephoneNumber), "Property is not nullable for class FundSource.");
        ...
        {
            /*
            if (fundSource._AdditionalDataOption.IsSet && fundSource.AdditionalData == null)
                throw new ArgumentNullException(nameof(fundSource.AdditionalData), "Property is required for class FundSource.");

            if (fundSource._BillingAddressOption.IsSet && fundSource.BillingAddress == null)
                throw new ArgumentNullException(nameof(fundSource.BillingAddress), "Property is required for class FundSource.");

            if (fundSource._CardOption.IsSet && fundSource.Card == null)
                throw new ArgumentNullException(nameof(fundSource.Card), "Property is required for class FundSource.");

            if (fundSource._ShopperEmailOption.IsSet && fundSource.ShopperEmail == null)
                throw new ArgumentNullException(nameof(fundSource.ShopperEmail), "Property is required for class FundSource.");

            if (fundSource._ShopperNameOption.IsSet && fundSource.ShopperName == null)
                throw new ArgumentNullException(nameof(fundSource.ShopperName), "Property is required for class FundSource.");

            if (fundSource._TelephoneNumberOption.IsSet && fundSource.TelephoneNumber == null)
                throw new ArgumentNullException(nameof(fundSource.TelephoneNumber), "Property is required for class FundSource.");
