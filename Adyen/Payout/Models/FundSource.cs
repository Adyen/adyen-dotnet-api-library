...
namespace Adyen.Payout.Models
{
    ...
    /// FundSource.
    /// </summary>
    [JsonConverter(typeof(FundSourceJsonConverter))]
    ...
    public class FundSourceJsonConverter : JsonConverter<FundSource>
    {
        ...
        public override FundSource Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (billingAddress.IsSet)
                fundSource.BillingAddress = billingAddress.Value;
            if (card.IsSet)
                fundSource.Card = card.Value;
            if (shopperEmail.IsSet)
                fundSource.ShopperEmail = shopperEmail.Value;
            if (shopperName.IsSet)
                fundSource.ShopperName = shopperName.Value;
            if (telephoneNumber.IsSet)
                fundSource.TelephoneNumber = telephoneNumber.Value;
            return fundSource;
        }
