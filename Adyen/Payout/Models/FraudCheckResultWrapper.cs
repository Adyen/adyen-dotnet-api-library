...
namespace Adyen.Payout.Models
{
    ...
    public class FraudCheckResultWrapperJsonConverter : JsonConverter<FraudCheckResultWrapper>
    {
        ...
        public override FraudCheckResultWrapper Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (fraudCheckResult.IsSet && fraudCheckResult.Value == null)
                throw new ArgumentNullException(nameof(fraudCheckResult), "Property is not nullable for class FraudCheckResultWrapper.");
        ...
        {
            /*
            if (fraudCheckResultWrapper._FraudCheckResultOption.IsSet && fraudCheckResultWrapper.FraudCheckResult == null)
                throw new ArgumentNullException(nameof(fraudCheckResultWrapper.FraudCheckResult), "Property is required for class FraudCheckResultWrapper.");
