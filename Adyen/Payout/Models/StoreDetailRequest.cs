    ...
    public class StoreDetailRequestJsonConverter : JsonConverter<StoreDetailRequest>
    {
        ...
        public override StoreDetailRequest Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (dateOfBirth.IsSet && dateOfBirth.Value == null)
                throw new ArgumentNullException(nameof(dateOfBirth), "Property is not nullable for class StoreDetailRequest.");

            if (entityType.IsSet && entityType.Value == null)
                throw new ArgumentNullException(nameof(entityType), "Property is not nullable for class StoreDetailRequest.");

            if (merchantAccount.IsSet && merchantAccount.Value == null)
                throw new ArgumentNullException(nameof(merchantAccount), "Property is not nullable for class StoreDetailRequest.");

            if (nationality.IsSet && nationality.Value == null)
                throw new ArgumentNullException(nameof(nationality), "Property is not nullable for class StoreDetailRequest.");

            if (recurring.IsSet && recurring.Value == null)
                throw new ArgumentNullException(nameof(recurring), "Property is not nullable for class StoreDetailRequest.");

            if (shopperEmail.IsSet && shopperEmail.Value == null)
                throw new ArgumentNullException(nameof(shopperEmail), "Property is not nullable for class StoreDetailRequest.");

            if (shopperReference.IsSet && shopperReference.Value == null)
                throw new ArgumentNullException(nameof(shopperReference), "Property is not nullable for class StoreDetailRequest.");

            if (additionalData.IsSet && additionalData.Value == null)
                throw new ArgumentNullException(nameof(additionalData), "Property is not nullable for class StoreDetailRequest.");

            if (bank.IsSet && bank.Value == null)
                throw new ArgumentNullException(nameof(bank), "Property is not nullable for class StoreDetailRequest.");

            if (billingAddress.IsSet && billingAddress.Value == null)
                throw new ArgumentNullException(nameof(billingAddress), "Property is not nullable for class StoreDetailRequest.");

            if (card.IsSet && card.Value == null)
                throw new ArgumentNullException(nameof(card), "Property is not nullable for class StoreDetailRequest.");

            if (fraudOffset.IsSet && fraudOffset.Value == null)
                throw new ArgumentNullException(nameof(fraudOffset), "Property is not nullable for class StoreDetailRequest.");

            if (selectedBrand.IsSet && selectedBrand.Value == null)
                throw new ArgumentNullException(nameof(selectedBrand), "Property is not nullable for class StoreDetailRequest.");

            if (shopperName.IsSet && shopperName.Value == null)
                throw new ArgumentNullException(nameof(shopperName), "Property is not nullable for class StoreDetailRequest.");

            if (socialSecurityNumber.IsSet && socialSecurityNumber.Value == null)
                throw new ArgumentNullException(nameof(socialSecurityNumber), "Property is not nullable for class StoreDetailRequest.");

            if (telephoneNumber.IsSet && telephoneNumber.Value == null)
                throw new ArgumentNullException(nameof(telephoneNumber), "Property is not nullable for class StoreDetailRequest.");
        ...
        public void WriteProperties(Utf8JsonWriter writer, StoreDetailRequest storeDetailRequest, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (storeDetailRequest.MerchantAccount == null)
                throw new ArgumentNullException(nameof(storeDetailRequest.MerchantAccount), "Property is required for class StoreDetailRequest.");

            if (storeDetailRequest.Nationality == null)
                throw new ArgumentNullException(nameof(storeDetailRequest.Nationality), "Property is required for class StoreDetailRequest.");

            if (storeDetailRequest.Recurring == null)
                throw new ArgumentNullException(nameof(storeDetailRequest.Recurring), "Property is required for class StoreDetailRequest.");

            if (storeDetailRequest.ShopperEmail == null)
                throw new ArgumentNullException(nameof(storeDetailRequest.ShopperEmail), "Property is required for class StoreDetailRequest.");

            if (storeDetailRequest.ShopperReference == null)
                throw new ArgumentNullException(nameof(storeDetailRequest.ShopperReference), "Property is required for class StoreDetailRequest.");

            if (storeDetailRequest._AdditionalDataOption.IsSet && storeDetailRequest.AdditionalData == null)
                throw new ArgumentNullException(nameof(storeDetailRequest.AdditionalData), "Property is required for class StoreDetailRequest.");

            if (storeDetailRequest._BankOption.IsSet && storeDetailRequest.Bank == null)
                throw new ArgumentNullException(nameof(storeDetailRequest.Bank), "Property is required for class StoreDetailRequest.");

            if (storeDetailRequest._BillingAddressOption.IsSet && storeDetailRequest.BillingAddress == null)
                throw new ArgumentNullException(nameof(storeDetailRequest.BillingAddress), "Property is required for class StoreDetailRequest.");

            if (storeDetailRequest._CardOption.IsSet && storeDetailRequest.Card == null)
                throw new ArgumentNullException(nameof(storeDetailRequest.Card), "Property is required for class StoreDetailRequest.");

            if (storeDetailRequest._SelectedBrandOption.IsSet && storeDetailRequest.SelectedBrand == null)
                throw new ArgumentNullException(nameof(storeDetailRequest.SelectedBrand), "Property is required for class StoreDetailRequest.");

            if (storeDetailRequest._ShopperNameOption.IsSet && storeDetailRequest.ShopperName == null)
                throw new ArgumentNullException(nameof(storeDetailRequest.ShopperName), "Property is required for class StoreDetailRequest.");

            if (storeDetailRequest._SocialSecurityNumberOption.IsSet && storeDetailRequest.SocialSecurityNumber == null)
                throw new ArgumentNullException(nameof(storeDetailRequest.SocialSecurityNumber), "Property is required for class StoreDetailRequest.");

            if (storeDetailRequest._TelephoneNumberOption.IsSet && storeDetailRequest.TelephoneNumber == null)
                throw new ArgumentNullException(nameof(storeDetailRequest.TelephoneNumber), "Property is required for class StoreDetailRequest.");
