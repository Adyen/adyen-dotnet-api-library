...
namespace Adyen.Payout.Models
{
    ...
    /// StoreDetailRequest.
    /// </summary>
    [JsonConverter(typeof(StoreDetailRequestJsonConverter))]
    ...
    public class StoreDetailRequestJsonConverter : JsonConverter<StoreDetailRequest>
    {
        ...
        public override StoreDetailRequest Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
                ...
                if (utf8JsonReader.TokenType == JsonTokenType.PropertyName && currentDepth == utf8JsonReader.CurrentDepth - 1)
                {
                    ...
                    switch (jsonPropertyName)
                    {
                        ...
                        case "entityType":
                            ...
                            entityType = new Option<StoreDetailRequest.EntityTypeEnum?>(StoreDetailRequest.EntityTypeEnum.FromStringOrDefault(entityTypeRawValue) ?? (StoreDetailRequest.EntityTypeEnum)entityTypeRawValue);
                            break;
            ...
            if (bank.IsSet)
                storeDetailRequest.Bank = bank.Value;
            if (billingAddress.IsSet)
                storeDetailRequest.BillingAddress = billingAddress.Value;
            if (card.IsSet)
                storeDetailRequest.Card = card.Value;
            if (fraudOffset.IsSet)
                storeDetailRequest.FraudOffset = fraudOffset.Value;
            if (selectedBrand.IsSet)
                storeDetailRequest.SelectedBrand = selectedBrand.Value;
            if (shopperName.IsSet)
                storeDetailRequest.ShopperName = shopperName.Value;
            if (socialSecurityNumber.IsSet)
                storeDetailRequest.SocialSecurityNumber = socialSecurityNumber.Value;
            if (telephoneNumber.IsSet)
                storeDetailRequest.TelephoneNumber = telephoneNumber.Value;
