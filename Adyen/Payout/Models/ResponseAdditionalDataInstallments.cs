...
namespace Adyen.Payout.Models
{
    ...
    /// </summary>
    [JsonConverter(typeof(ResponseAdditionalDataInstallmentsJsonConverter))]
    ...
    public class ResponseAdditionalDataInstallmentsJsonConverter : JsonConverter<ResponseAdditionalDataInstallments>
    {
        ...
        public override ResponseAdditionalDataInstallments Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (installmentPaymentDataOptionItemNrAnnualPercentageRate.IsSet)
                responseAdditionalDataInstallments.InstallmentPaymentDataOptionItemNrAnnualPercentageRate = installmentPaymentDataOptionItemNrAnnualPercentageRate.Value;
            if (installmentPaymentDataOptionItemNrFirstInstallmentAmount.IsSet)
                responseAdditionalDataInstallments.InstallmentPaymentDataOptionItemNrFirstInstallmentAmount = installmentPaymentDataOptionItemNrFirstInstallmentAmount.Value;
            if (installmentPaymentDataOptionItemNrInstallmentFee.IsSet)
                responseAdditionalDataInstallments.InstallmentPaymentDataOptionItemNrInstallmentFee = installmentPaymentDataOptionItemNrInstallmentFee.Value;
            if (installmentPaymentDataOptionItemNrInterestRate.IsSet)
                responseAdditionalDataInstallments.InstallmentPaymentDataOptionItemNrInterestRate = installmentPaymentDataOptionItemNrInterestRate.Value;
            if (installmentPaymentDataOptionItemNrMaximumNumberOfInstallments.IsSet)
                responseAdditionalDataInstallments.InstallmentPaymentDataOptionItemNrMaximumNumberOfInstallments = installmentPaymentDataOptionItemNrMaximumNumberOfInstallments.Value;
            if (installmentPaymentDataOptionItemNrMinimumNumberOfInstallments.IsSet)
                responseAdditionalDataInstallments.InstallmentPaymentDataOptionItemNrMinimumNumberOfInstallments = installmentPaymentDataOptionItemNrMinimumNumberOfInstallments.Value;
            if (installmentPaymentDataOptionItemNrNumberOfInstallments.IsSet)
                responseAdditionalDataInstallments.InstallmentPaymentDataOptionItemNrNumberOfInstallments = installmentPaymentDataOptionItemNrNumberOfInstallments.Value;
            if (installmentPaymentDataOptionItemNrSubsequentInstallmentAmount.IsSet)
                responseAdditionalDataInstallments.InstallmentPaymentDataOptionItemNrSubsequentInstallmentAmount = installmentPaymentDataOptionItemNrSubsequentInstallmentAmount.Value;
            if (installmentPaymentDataOptionItemNrTotalAmountDue.IsSet)
                responseAdditionalDataInstallments.InstallmentPaymentDataOptionItemNrTotalAmountDue = installmentPaymentDataOptionItemNrTotalAmountDue.Value;
            if (installmentPaymentDataPaymentOptions.IsSet)
                responseAdditionalDataInstallments.InstallmentPaymentDataPaymentOptions = installmentPaymentDataPaymentOptions.Value;
            if (installmentsValue.IsSet)
                responseAdditionalDataInstallments.InstallmentsValue = installmentsValue.Value;
            return responseAdditionalDataInstallments;
        }
