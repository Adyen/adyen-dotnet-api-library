...
namespace Adyen.Payout.Models
{
    ...
    /// SubmitRequest.
    /// </summary>
    public partial class SubmitRequest : IValidatableObject
    {
        /// <summary>
    ...
    public class SubmitRequestJsonConverter : JsonConverter<SubmitRequest>
    {
        ...
        public override SubmitRequest Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (amount.IsSet && amount.Value == null)
                throw new ArgumentNullException(nameof(amount), "Property is not nullable for class SubmitRequest.");

            if (merchantAccount.IsSet && merchantAccount.Value == null)
                throw new ArgumentNullException(nameof(merchantAccount), "Property is not nullable for class SubmitRequest.");

            if (recurring.IsSet && recurring.Value == null)
                throw new ArgumentNullException(nameof(recurring), "Property is not nullable for class SubmitRequest.");

            if (reference.IsSet && reference.Value == null)
                throw new ArgumentNullException(nameof(reference), "Property is not nullable for class SubmitRequest.");

            if (selectedRecurringDetailReference.IsSet && selectedRecurringDetailReference.Value == null)
                throw new ArgumentNullException(nameof(selectedRecurringDetailReference), "Property is not nullable for class SubmitRequest.");

            if (shopperEmail.IsSet && shopperEmail.Value == null)
                throw new ArgumentNullException(nameof(shopperEmail), "Property is not nullable for class SubmitRequest.");

            if (shopperReference.IsSet && shopperReference.Value == null)
                throw new ArgumentNullException(nameof(shopperReference), "Property is not nullable for class SubmitRequest.");

            if (additionalData.IsSet && additionalData.Value == null)
                throw new ArgumentNullException(nameof(additionalData), "Property is not nullable for class SubmitRequest.");

            if (dateOfBirth.IsSet && dateOfBirth.Value == null)
                throw new ArgumentNullException(nameof(dateOfBirth), "Property is not nullable for class SubmitRequest.");

            if (entityType.IsSet && entityType.Value == null)
                throw new ArgumentNullException(nameof(entityType), "Property is not nullable for class SubmitRequest.");

            if (fraudOffset.IsSet && fraudOffset.Value == null)
                throw new ArgumentNullException(nameof(fraudOffset), "Property is not nullable for class SubmitRequest.");

            if (nationality.IsSet && nationality.Value == null)
                throw new ArgumentNullException(nameof(nationality), "Property is not nullable for class SubmitRequest.");

            if (shopperName.IsSet && shopperName.Value == null)
                throw new ArgumentNullException(nameof(shopperName), "Property is not nullable for class SubmitRequest.");

            if (shopperStatement.IsSet && shopperStatement.Value == null)
                throw new ArgumentNullException(nameof(shopperStatement), "Property is not nullable for class SubmitRequest.");

            if (socialSecurityNumber.IsSet && socialSecurityNumber.Value == null)
                throw new ArgumentNullException(nameof(socialSecurityNumber), "Property is not nullable for class SubmitRequest.");
        ...
        {
            /*
            if (submitRequest.Amount == null)
                throw new ArgumentNullException(nameof(submitRequest.Amount), "Property is required for class SubmitRequest.");

            if (submitRequest.MerchantAccount == null)
                throw new ArgumentNullException(nameof(submitRequest.MerchantAccount), "Property is required for class SubmitRequest.");

            if (submitRequest.Recurring == null)
                throw new ArgumentNullException(nameof(submitRequest.Recurring), "Property is required for class SubmitRequest.");

            if (submitRequest.Reference == null)
                throw new ArgumentNullException(nameof(submitRequest.Reference), "Property is required for class SubmitRequest.");

            if (submitRequest.SelectedRecurringDetailReference == null)
                throw new ArgumentNullException(nameof(submitRequest.SelectedRecurringDetailReference), "Property is required for class SubmitRequest.");

            if (submitRequest.ShopperEmail == null)
                throw new ArgumentNullException(nameof(submitRequest.ShopperEmail), "Property is required for class SubmitRequest.");

            if (submitRequest.ShopperReference == null)
                throw new ArgumentNullException(nameof(submitRequest.ShopperReference), "Property is required for class SubmitRequest.");

            if (submitRequest._AdditionalDataOption.IsSet && submitRequest.AdditionalData == null)
                throw new ArgumentNullException(nameof(submitRequest.AdditionalData), "Property is required for class SubmitRequest.");

            if (submitRequest._NationalityOption.IsSet && submitRequest.Nationality == null)
                throw new ArgumentNullException(nameof(submitRequest.Nationality), "Property is required for class SubmitRequest.");

            if (submitRequest._ShopperNameOption.IsSet && submitRequest.ShopperName == null)
                throw new ArgumentNullException(nameof(submitRequest.ShopperName), "Property is required for class SubmitRequest.");

            if (submitRequest._ShopperStatementOption.IsSet && submitRequest.ShopperStatement == null)
                throw new ArgumentNullException(nameof(submitRequest.ShopperStatement), "Property is required for class SubmitRequest.");

            if (submitRequest._SocialSecurityNumberOption.IsSet && submitRequest.SocialSecurityNumber == null)
                throw new ArgumentNullException(nameof(submitRequest.SocialSecurityNumber), "Property is required for class SubmitRequest.");
