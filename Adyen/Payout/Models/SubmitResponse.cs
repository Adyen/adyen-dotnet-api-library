...
namespace Adyen.Payout.Models
{
    ...
    /// SubmitResponse.
    /// </summary>
    public partial class SubmitResponse : IValidatableObject
    {
        /// <summary>
        ...
        /// <param name="resultCode">The response: * In case of success, it is &#x60;payout-submit-received&#x60;. * In case of an error, an informational message is returned.</param>
        ...
        [JsonConstructor]
        public SubmitResponse(string pspReference, string resultCode, Option<Dictionary<string, string>?> additionalData = default, Option<string?> refusalReason = default)
        {
    ...
    public class SubmitResponseJsonConverter : JsonConverter<SubmitResponse>
    {
        ...
        public override SubmitResponse Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (!pspReference.IsSet)
                throw new ArgumentException("Property is required for class SubmitResponse.", nameof(pspReference));

            if (!resultCode.IsSet)
                throw new ArgumentException("Property is required for class SubmitResponse.", nameof(resultCode));

            if (pspReference.IsSet && pspReference.Value == null)
                throw new ArgumentNullException(nameof(pspReference), "Property is not nullable for class SubmitResponse.");

            if (resultCode.IsSet && resultCode.Value == null)
                throw new ArgumentNullException(nameof(resultCode), "Property is not nullable for class SubmitResponse.");

            if (additionalData.IsSet && additionalData.Value == null)
                throw new ArgumentNullException(nameof(additionalData), "Property is not nullable for class SubmitResponse.");

            if (refusalReason.IsSet && refusalReason.Value == null)
                throw new ArgumentNullException(nameof(refusalReason), "Property is not nullable for class SubmitResponse.");

            return new SubmitResponse(pspReference.Value!, resultCode.Value!, additionalData, refusalReason);
        }
        ...
        public void WriteProperties(Utf8JsonWriter writer, SubmitResponse submitResponse, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (submitResponse.PspReference == null)
                throw new ArgumentNullException(nameof(submitResponse.PspReference), "Property is required for class SubmitResponse.");

            if (submitResponse.ResultCode == null)
                throw new ArgumentNullException(nameof(submitResponse.ResultCode), "Property is required for class SubmitResponse.");

            if (submitResponse._AdditionalDataOption.IsSet && submitResponse.AdditionalData == null)
                throw new ArgumentNullException(nameof(submitResponse.AdditionalData), "Property is required for class SubmitResponse.");

            if (submitResponse._RefusalReasonOption.IsSet && submitResponse.RefusalReason == null)
                throw new ArgumentNullException(nameof(submitResponse.RefusalReason), "Property is required for class SubmitResponse.");
