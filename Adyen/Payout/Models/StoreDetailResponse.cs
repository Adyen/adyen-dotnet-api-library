    ...
    public class StoreDetailResponseJsonConverter : JsonConverter<StoreDetailResponse>
    {
        ...
        public override StoreDetailResponse Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (pspReference.IsSet && pspReference.Value == null)
                throw new ArgumentNullException(nameof(pspReference), "Property is not nullable for class StoreDetailResponse.");

            if (recurringDetailReference.IsSet && recurringDetailReference.Value == null)
                throw new ArgumentNullException(nameof(recurringDetailReference), "Property is not nullable for class StoreDetailResponse.");

            if (resultCode.IsSet && resultCode.Value == null)
                throw new ArgumentNullException(nameof(resultCode), "Property is not nullable for class StoreDetailResponse.");

            if (additionalData.IsSet && additionalData.Value == null)
                throw new ArgumentNullException(nameof(additionalData), "Property is not nullable for class StoreDetailResponse.");
        ...
        public void WriteProperties(Utf8JsonWriter writer, StoreDetailResponse storeDetailResponse, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (storeDetailResponse.PspReference == null)
                throw new ArgumentNullException(nameof(storeDetailResponse.PspReference), "Property is required for class StoreDetailResponse.");

            if (storeDetailResponse.RecurringDetailReference == null)
                throw new ArgumentNullException(nameof(storeDetailResponse.RecurringDetailReference), "Property is required for class StoreDetailResponse.");

            if (storeDetailResponse.ResultCode == null)
                throw new ArgumentNullException(nameof(storeDetailResponse.ResultCode), "Property is required for class StoreDetailResponse.");

            if (storeDetailResponse._AdditionalDataOption.IsSet && storeDetailResponse.AdditionalData == null)
                throw new ArgumentNullException(nameof(storeDetailResponse.AdditionalData), "Property is required for class StoreDetailResponse.");
