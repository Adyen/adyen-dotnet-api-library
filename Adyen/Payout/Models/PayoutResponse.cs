...
namespace Adyen.Payout.Models
{
    ...
    /// PayoutResponse.
    /// </summary>
    public partial class PayoutResponse : IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Used to track the state of DccAmount
        /// </summary>
        [JsonIgnore]
        [global::System.ComponentModel.EditorBrowsable(global::System.ComponentModel.EditorBrowsableState.Never)]
        ...
        /// <summary>
        /// Used to track the state of DccSignature
        /// </summary>
        [JsonIgnore]
        [global::System.ComponentModel.EditorBrowsable(global::System.ComponentModel.EditorBrowsableState.Never)]
        ...
        /// <summary>
        /// Used to track the state of PaRequest
        /// </summary>
        [JsonIgnore]
        [global::System.ComponentModel.EditorBrowsable(global::System.ComponentModel.EditorBrowsableState.Never)]
    ...
    public class PayoutResponseJsonConverter : JsonConverter<PayoutResponse>
    {
        ...
        public override PayoutResponse Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (additionalData.IsSet && additionalData.Value == null)
                throw new ArgumentNullException(nameof(additionalData), "Property is not nullable for class PayoutResponse.");

            if (authCode.IsSet && authCode.Value == null)
                throw new ArgumentNullException(nameof(authCode), "Property is not nullable for class PayoutResponse.");

            if (dccAmount.IsSet && dccAmount.Value == null)
                throw new ArgumentNullException(nameof(dccAmount), "Property is not nullable for class PayoutResponse.");

            if (dccSignature.IsSet && dccSignature.Value == null)
                throw new ArgumentNullException(nameof(dccSignature), "Property is not nullable for class PayoutResponse.");

            if (fraudResult.IsSet && fraudResult.Value == null)
                throw new ArgumentNullException(nameof(fraudResult), "Property is not nullable for class PayoutResponse.");

            if (issuerUrl.IsSet && issuerUrl.Value == null)
                throw new ArgumentNullException(nameof(issuerUrl), "Property is not nullable for class PayoutResponse.");

            if (md.IsSet && md.Value == null)
                throw new ArgumentNullException(nameof(md), "Property is not nullable for class PayoutResponse.");

            if (paRequest.IsSet && paRequest.Value == null)
                throw new ArgumentNullException(nameof(paRequest), "Property is not nullable for class PayoutResponse.");

            if (pspReference.IsSet && pspReference.Value == null)
                throw new ArgumentNullException(nameof(pspReference), "Property is not nullable for class PayoutResponse.");

            if (refusalReason.IsSet && refusalReason.Value == null)
                throw new ArgumentNullException(nameof(refusalReason), "Property is not nullable for class PayoutResponse.");

            if (resultCode.IsSet && resultCode.Value == null)
                throw new ArgumentNullException(nameof(resultCode), "Property is not nullable for class PayoutResponse.");
        ...
        {
            /*
            if (payoutResponse._AdditionalDataOption.IsSet && payoutResponse.AdditionalData == null)
                throw new ArgumentNullException(nameof(payoutResponse.AdditionalData), "Property is required for class PayoutResponse.");

            if (payoutResponse._AuthCodeOption.IsSet && payoutResponse.AuthCode == null)
                throw new ArgumentNullException(nameof(payoutResponse.AuthCode), "Property is required for class PayoutResponse.");

            if (payoutResponse._DccAmountOption.IsSet && payoutResponse.DccAmount == null)
                throw new ArgumentNullException(nameof(payoutResponse.DccAmount), "Property is required for class PayoutResponse.");

            if (payoutResponse._DccSignatureOption.IsSet && payoutResponse.DccSignature == null)
                throw new ArgumentNullException(nameof(payoutResponse.DccSignature), "Property is required for class PayoutResponse.");

            if (payoutResponse._FraudResultOption.IsSet && payoutResponse.FraudResult == null)
                throw new ArgumentNullException(nameof(payoutResponse.FraudResult), "Property is required for class PayoutResponse.");

            if (payoutResponse._IssuerUrlOption.IsSet && payoutResponse.IssuerUrl == null)
                throw new ArgumentNullException(nameof(payoutResponse.IssuerUrl), "Property is required for class PayoutResponse.");

            if (payoutResponse._MdOption.IsSet && payoutResponse.Md == null)
                throw new ArgumentNullException(nameof(payoutResponse.Md), "Property is required for class PayoutResponse.");

            if (payoutResponse._PaRequestOption.IsSet && payoutResponse.PaRequest == null)
                throw new ArgumentNullException(nameof(payoutResponse.PaRequest), "Property is required for class PayoutResponse.");

            if (payoutResponse._PspReferenceOption.IsSet && payoutResponse.PspReference == null)
                throw new ArgumentNullException(nameof(payoutResponse.PspReference), "Property is required for class PayoutResponse.");

            if (payoutResponse._RefusalReasonOption.IsSet && payoutResponse.RefusalReason == null)
                throw new ArgumentNullException(nameof(payoutResponse.RefusalReason), "Property is required for class PayoutResponse.");
