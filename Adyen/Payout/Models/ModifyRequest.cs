...
namespace Adyen.Payout.Models
{
    ...
    /// ModifyRequest.
    /// </summary>
    public partial class ModifyRequest : IValidatableObject
    {
        /// <summary>
    ...
    public class ModifyRequestJsonConverter : JsonConverter<ModifyRequest>
    {
        ...
        public override ModifyRequest Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (merchantAccount.IsSet && merchantAccount.Value == null)
                throw new ArgumentNullException(nameof(merchantAccount), "Property is not nullable for class ModifyRequest.");

            if (originalReference.IsSet && originalReference.Value == null)
                throw new ArgumentNullException(nameof(originalReference), "Property is not nullable for class ModifyRequest.");

            if (additionalData.IsSet && additionalData.Value == null)
                throw new ArgumentNullException(nameof(additionalData), "Property is not nullable for class ModifyRequest.");
        ...
        public void WriteProperties(Utf8JsonWriter writer, ModifyRequest modifyRequest, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (modifyRequest.MerchantAccount == null)
                throw new ArgumentNullException(nameof(modifyRequest.MerchantAccount), "Property is required for class ModifyRequest.");

            if (modifyRequest.OriginalReference == null)
                throw new ArgumentNullException(nameof(modifyRequest.OriginalReference), "Property is required for class ModifyRequest.");

            if (modifyRequest._AdditionalDataOption.IsSet && modifyRequest.AdditionalData == null)
                throw new ArgumentNullException(nameof(modifyRequest.AdditionalData), "Property is required for class ModifyRequest.");
