...
namespace Adyen.Payout.Models
{
    ...
    /// </summary>
    [JsonConverter(typeof(ResponseAdditionalData3DSecureJsonConverter))]
    ...
    public class ResponseAdditionalData3DSecureJsonConverter : JsonConverter<ResponseAdditionalData3DSecure>
    {
        ...
        public override ResponseAdditionalData3DSecure Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (cavv.IsSet)
                responseAdditionalData3DSecure.Cavv = cavv.Value;
            if (cavvAlgorithm.IsSet)
                responseAdditionalData3DSecure.CavvAlgorithm = cavvAlgorithm.Value;
            if (scaExemptionRequested.IsSet)
                responseAdditionalData3DSecure.ScaExemptionRequested = scaExemptionRequested.Value;
            if (threeds2CardEnrolled.IsSet)
                responseAdditionalData3DSecure.Threeds2CardEnrolled = threeds2CardEnrolled.Value;
            return responseAdditionalData3DSecure;
        }
