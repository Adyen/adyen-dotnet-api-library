...
namespace Adyen.Payout.Models
{
    ...
    /// </summary>
    [JsonConverter(typeof(ResponseAdditionalDataDomesticErrorJsonConverter))]
    public partial class ResponseAdditionalDataDomesticError
    {
        /// <summary>
    ...
    public class ResponseAdditionalDataDomesticErrorJsonConverter : JsonConverter<ResponseAdditionalDataDomesticError>
    {
        ...
        public override ResponseAdditionalDataDomesticError Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (domesticShopperAdvice.IsSet)
                responseAdditionalDataDomesticError.DomesticShopperAdvice = domesticShopperAdvice.Value;
            return responseAdditionalDataDomesticError;
        }
