...
namespace Adyen.Payout.Models
{
    ...
    /// </summary>
    [JsonConverter(typeof(ResponseAdditionalDataNetworkTokensJsonConverter))]
    ...
    public class ResponseAdditionalDataNetworkTokensJsonConverter : JsonConverter<ResponseAdditionalDataNetworkTokens>
    {
        ...
        public override ResponseAdditionalDataNetworkTokens Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (networkTokenBin.IsSet)
                responseAdditionalDataNetworkTokens.NetworkTokenBin = networkTokenBin.Value;
            if (networkTokenTokenSummary.IsSet)
                responseAdditionalDataNetworkTokens.NetworkTokenTokenSummary = networkTokenTokenSummary.Value;
            return responseAdditionalDataNetworkTokens;
        }
