...
namespace Adyen.Payout.Models
{
    ...
    /// </summary>
    [JsonConverter(typeof(ResponseAdditionalDataSepaJsonConverter))]
    ...
    public class ResponseAdditionalDataSepaJsonConverter : JsonConverter<ResponseAdditionalDataSepa>
    {
        ...
        public override ResponseAdditionalDataSepa Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (sepadirectdebitMandateId.IsSet)
                responseAdditionalDataSepa.SepadirectdebitMandateId = sepadirectdebitMandateId.Value;
            if (sepadirectdebitSepadirectdebitDueDate.IsSet)
                responseAdditionalDataSepa.SepadirectdebitSepadirectdebitDueDate = sepadirectdebitSepadirectdebitDueDate.Value;
            if (sepadirectdebitSequenceType.IsSet)
                responseAdditionalDataSepa.SepadirectdebitSequenceType = sepadirectdebitSequenceType.Value;
            return responseAdditionalDataSepa;
        }
