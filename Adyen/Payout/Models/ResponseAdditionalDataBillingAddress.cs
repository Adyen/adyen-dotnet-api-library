...
namespace Adyen.Payout.Models
{
    ...
    /// </summary>
    [JsonConverter(typeof(ResponseAdditionalDataBillingAddressJsonConverter))]
    ...
    public class ResponseAdditionalDataBillingAddressJsonConverter : JsonConverter<ResponseAdditionalDataBillingAddress>
    {
        ...
        public override ResponseAdditionalDataBillingAddress Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (billingAddressCountry.IsSet)
                responseAdditionalDataBillingAddress.BillingAddressCountry = billingAddressCountry.Value;
            if (billingAddressHouseNumberOrName.IsSet)
                responseAdditionalDataBillingAddress.BillingAddressHouseNumberOrName = billingAddressHouseNumberOrName.Value;
            if (billingAddressPostalCode.IsSet)
                responseAdditionalDataBillingAddress.BillingAddressPostalCode = billingAddressPostalCode.Value;
            if (billingAddressStateOrProvince.IsSet)
                responseAdditionalDataBillingAddress.BillingAddressStateOrProvince = billingAddressStateOrProvince.Value;
            if (billingAddressStreet.IsSet)
                responseAdditionalDataBillingAddress.BillingAddressStreet = billingAddressStreet.Value;
            return responseAdditionalDataBillingAddress;
        }
