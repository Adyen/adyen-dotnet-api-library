...
using Models = Adyen.PosTerminalManagement.Models;
...
namespace Adyen.PosTerminalManagement.Client
{
    ...
    public static partial class ClientUtils
    {
        ...
        public static string? ParameterToString(object? obj, string? format = ISO8601_DATETIME_FORMAT)
        {
            ...
            if (obj is Models.GetTerminalDetailsResponse.TerminalStatusEnum getTerminalDetailsResponseTerminalStatusEnum)
                return Models.GetTerminalDetailsResponse.TerminalStatusEnum.ToJsonValue(getTerminalDetailsResponseTerminalStatusEnum);
