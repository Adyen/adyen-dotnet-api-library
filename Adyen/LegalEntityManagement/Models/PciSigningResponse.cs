...
namespace Adyen.LegalEntityManagement.Models
{
    ...
    public partial class PciSigningResponse : IValidatableObject
    {
        ...
        /// <summary>
        /// This is used to track if an optional field is set. If set, <see cref="PciQuestionnaireIds"/> will be populated.
        /// </summary>
        [JsonIgnore]
        ...
        /// <summary>
        /// This is used to track if an optional field is set. If set, <see cref="SignedBy"/> will be populated.
        /// </summary>
        [JsonIgnore]
        [global::System.ComponentModel.EditorBrowsable(global::System.ComponentModel.EditorBrowsableState.Never)]
    ...
    public class PciSigningResponseJsonConverter : JsonConverter<PciSigningResponse>
    {
        ...
        public void WriteProperties(Utf8JsonWriter writer, PciSigningResponse pciSigningResponse, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (pciSigningResponse._SignedByOption.IsSet)
                if (pciSigningResponse.SignedBy != null)
