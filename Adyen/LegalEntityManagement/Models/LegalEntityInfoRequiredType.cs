    ...
    public class LegalEntityInfoRequiredTypeJsonConverter : JsonConverter<LegalEntityInfoRequiredType>
    {
        ...
        public override LegalEntityInfoRequiredType Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (type.IsSet && type.Value == null)
                throw new ArgumentNullException(nameof(type), "Property is not nullable for class LegalEntityInfoRequiredType.");

            if (capabilities.IsSet && capabilities.Value == null)
                throw new ArgumentNullException(nameof(capabilities), "Property is not nullable for class LegalEntityInfoRequiredType.");

            if (entityAssociations.IsSet && entityAssociations.Value == null)
                throw new ArgumentNullException(nameof(entityAssociations), "Property is not nullable for class LegalEntityInfoRequiredType.");

            if (individual.IsSet && individual.Value == null)
                throw new ArgumentNullException(nameof(individual), "Property is not nullable for class LegalEntityInfoRequiredType.");

            if (organization.IsSet && organization.Value == null)
                throw new ArgumentNullException(nameof(organization), "Property is not nullable for class LegalEntityInfoRequiredType.");

            if (reference.IsSet && reference.Value == null)
                throw new ArgumentNullException(nameof(reference), "Property is not nullable for class LegalEntityInfoRequiredType.");

            if (soleProprietorship.IsSet && soleProprietorship.Value == null)
                throw new ArgumentNullException(nameof(soleProprietorship), "Property is not nullable for class LegalEntityInfoRequiredType.");

            if (trust.IsSet && trust.Value == null)
                throw new ArgumentNullException(nameof(trust), "Property is not nullable for class LegalEntityInfoRequiredType.");

            if (unincorporatedPartnership.IsSet && unincorporatedPartnership.Value == null)
                throw new ArgumentNullException(nameof(unincorporatedPartnership), "Property is not nullable for class LegalEntityInfoRequiredType.");

            if (verificationPlan.IsSet && verificationPlan.Value == null)
                throw new ArgumentNullException(nameof(verificationPlan), "Property is not nullable for class LegalEntityInfoRequiredType.");
        ...
        {
            /*
            if (legalEntityInfoRequiredType._CapabilitiesOption.IsSet && legalEntityInfoRequiredType.Capabilities == null)
                throw new ArgumentNullException(nameof(legalEntityInfoRequiredType.Capabilities), "Property is required for class LegalEntityInfoRequiredType.");

            if (legalEntityInfoRequiredType._EntityAssociationsOption.IsSet && legalEntityInfoRequiredType.EntityAssociations == null)
                throw new ArgumentNullException(nameof(legalEntityInfoRequiredType.EntityAssociations), "Property is required for class LegalEntityInfoRequiredType.");

            if (legalEntityInfoRequiredType._IndividualOption.IsSet && legalEntityInfoRequiredType.Individual == null)
                throw new ArgumentNullException(nameof(legalEntityInfoRequiredType.Individual), "Property is required for class LegalEntityInfoRequiredType.");

            if (legalEntityInfoRequiredType._OrganizationOption.IsSet && legalEntityInfoRequiredType.Organization == null)
                throw new ArgumentNullException(nameof(legalEntityInfoRequiredType.Organization), "Property is required for class LegalEntityInfoRequiredType.");

            if (legalEntityInfoRequiredType._ReferenceOption.IsSet && legalEntityInfoRequiredType.Reference == null)
                throw new ArgumentNullException(nameof(legalEntityInfoRequiredType.Reference), "Property is required for class LegalEntityInfoRequiredType.");

            if (legalEntityInfoRequiredType._SoleProprietorshipOption.IsSet && legalEntityInfoRequiredType.SoleProprietorship == null)
                throw new ArgumentNullException(nameof(legalEntityInfoRequiredType.SoleProprietorship), "Property is required for class LegalEntityInfoRequiredType.");

            if (legalEntityInfoRequiredType._TrustOption.IsSet && legalEntityInfoRequiredType.Trust == null)
                throw new ArgumentNullException(nameof(legalEntityInfoRequiredType.Trust), "Property is required for class LegalEntityInfoRequiredType.");

            if (legalEntityInfoRequiredType._UnincorporatedPartnershipOption.IsSet && legalEntityInfoRequiredType.UnincorporatedPartnership == null)
                throw new ArgumentNullException(nameof(legalEntityInfoRequiredType.UnincorporatedPartnership), "Property is required for class LegalEntityInfoRequiredType.");

            if (legalEntityInfoRequiredType._VerificationPlanOption.IsSet && legalEntityInfoRequiredType.VerificationPlan == null)
                throw new ArgumentNullException(nameof(legalEntityInfoRequiredType.VerificationPlan), "Property is required for class LegalEntityInfoRequiredType.");
