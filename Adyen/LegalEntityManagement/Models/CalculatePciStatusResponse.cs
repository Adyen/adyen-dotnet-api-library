...
namespace Adyen.LegalEntityManagement.Models
{
    ...
    /// </summary>
    public partial class CalculatePciStatusResponse : IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Used to track the state of SigningRequired
        /// </summary>
        [JsonIgnore]
    ...
    public class CalculatePciStatusResponseJsonConverter : JsonConverter<CalculatePciStatusResponse>
    {
        ...
        public override CalculatePciStatusResponse Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (signingRequired.IsSet && signingRequired.Value == null)
                throw new ArgumentNullException(nameof(signingRequired), "Property is not nullable for class CalculatePciStatusResponse.");

            return new CalculatePciStatusResponse(signingRequired);
        }
