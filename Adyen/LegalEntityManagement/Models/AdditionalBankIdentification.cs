    ...
    public class AdditionalBankIdentificationJsonConverter : JsonConverter<AdditionalBankIdentification>
    {
        ...
        public override AdditionalBankIdentification Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (code.IsSet && code.Value == null)
                throw new ArgumentNullException(nameof(code), "Property is not nullable for class AdditionalBankIdentification.");

            if (type.IsSet && type.Value == null)
                throw new ArgumentNullException(nameof(type), "Property is not nullable for class AdditionalBankIdentification.");
        ...
        {
            /*
            if (additionalBankIdentification._CodeOption.IsSet && additionalBankIdentification.Code == null)
                throw new ArgumentNullException(nameof(additionalBankIdentification.Code), "Property is required for class AdditionalBankIdentification.");
