...
namespace Adyen.LegalEntityManagement.Models
{
    ...
    public class EntityReferenceJsonConverter : JsonConverter<EntityReference>
    {
        ...
        /// <returns><see cref="EntityReference"/></returns>
        ...
        {
            /*
            if (entityReference._IdOption.IsSet && entityReference.Id == null)
                throw new ArgumentNullException(nameof(entityReference.Id), "Property is required for class EntityReference.");

            */
            
            if (entityReference._IdOption.IsSet)
                writer.WriteString("id", entityReference.Id);
        }
    }
}
