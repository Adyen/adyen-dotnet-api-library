...
namespace Adyen.LegalEntityManagement.Models
{
    ...
    /// VerificationErrors.
    /// </summary>
    public partial class VerificationErrors : IValidatableObject
    {
        /// <summary>
    ...
    public class VerificationErrorsJsonConverter : JsonConverter<VerificationErrors>
    {
        ...
        public override VerificationErrors Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (problems.IsSet && problems.Value == null)
                throw new ArgumentNullException(nameof(problems), "Property is not nullable for class VerificationErrors.");

            return new VerificationErrors(problems);
        }
        ...
        {
            /*
            if (verificationErrors._ProblemsOption.IsSet && verificationErrors.Problems == null)
                throw new ArgumentNullException(nameof(verificationErrors.Problems), "Property is required for class VerificationErrors.");
