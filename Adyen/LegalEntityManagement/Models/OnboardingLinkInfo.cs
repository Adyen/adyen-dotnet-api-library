...
namespace Adyen.LegalEntityManagement.Models
{
    ...
    /// OnboardingLinkInfo.
    /// </summary>
    [JsonConverter(typeof(OnboardingLinkInfoJsonConverter))]
    ...
    public class OnboardingLinkInfoJsonConverter : JsonConverter<OnboardingLinkInfo>
    {
        ...
        public override OnboardingLinkInfo Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (redirectUrl.IsSet)
                onboardingLinkInfo.RedirectUrl = redirectUrl.Value;
            if (settings.IsSet)
                onboardingLinkInfo.Settings = settings.Value;
            if (themeId.IsSet)
                onboardingLinkInfo.ThemeId = themeId.Value;
