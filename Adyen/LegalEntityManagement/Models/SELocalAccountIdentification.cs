    ...
    public class SELocalAccountIdentificationJsonConverter : JsonConverter<SELocalAccountIdentification>
    {
        ...
        public override SELocalAccountIdentification Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (accountNumber.IsSet && accountNumber.Value == null)
                throw new ArgumentNullException(nameof(accountNumber), "Property is not nullable for class SELocalAccountIdentification.");

            if (clearingNumber.IsSet && clearingNumber.Value == null)
                throw new ArgumentNullException(nameof(clearingNumber), "Property is not nullable for class SELocalAccountIdentification.");

            if (type.IsSet && type.Value == null)
                throw new ArgumentNullException(nameof(type), "Property is not nullable for class SELocalAccountIdentification.");
        ...
        public void WriteProperties(Utf8JsonWriter writer, SELocalAccountIdentification sELocalAccountIdentification, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (sELocalAccountIdentification.AccountNumber == null)
                throw new ArgumentNullException(nameof(sELocalAccountIdentification.AccountNumber), "Property is required for class SELocalAccountIdentification.");

            if (sELocalAccountIdentification.ClearingNumber == null)
                throw new ArgumentNullException(nameof(sELocalAccountIdentification.ClearingNumber), "Property is required for class SELocalAccountIdentification.");
