...
namespace Adyen.LegalEntityManagement.Models
{
    ...
    /// </summary>
    public partial class UndefinedBeneficiary : IValidatableObject
    {
        /// <summary>
    ...
    /// <summary>
    /// A Json converter for type <see cref="UndefinedBeneficiary" />
    /// </summary>
    public class UndefinedBeneficiaryJsonConverter : JsonConverter<UndefinedBeneficiary>
    {
        /// <summary>
        /// Deserializes json to <see cref="UndefinedBeneficiary"/>.
        /// </summary>
        /// <param name="utf8JsonReader"><see cref="Utf8JsonReader"/></param>
        /// <param name="typeToConvert"><see cref="Type"/></param>
        /// <param name="jsonSerializerOptions">The <see cref="JsonSerializerOptions"/>, initialized from <see cref="HostConfiguration"/>.</param>
        /// <returns><see cref="UndefinedBeneficiary"/></returns>
        /// <exception cref="JsonException"></exception>
        public override UndefinedBeneficiary Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (description.IsSet && description.Value == null)
                throw new ArgumentNullException(nameof(description), "Property is not nullable for class UndefinedBeneficiary.");

            if (reference.IsSet && reference.Value == null)
                throw new ArgumentNullException(nameof(reference), "Property is not nullable for class UndefinedBeneficiary.");

            return new UndefinedBeneficiary(description, reference);
        }

        /// <summary>
        /// Serializes a <see cref="UndefinedBeneficiary"/>.
        /// </summary>
        /// <param name="writer"><see cref="Utf8JsonWriter"/></param>
        /// <param name="undefinedBeneficiary"></param>
        /// <param name="jsonSerializerOptions"><see cref="JsonSerializerOptions"/></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, UndefinedBeneficiary undefinedBeneficiary, JsonSerializerOptions jsonSerializerOptions)
        {
            
            writer.WriteStartObject();
            
            WriteProperties(writer, undefinedBeneficiary, jsonSerializerOptions);
        ...
        /// <summary>
        /// Serializes the properties of <see cref="UndefinedBeneficiary"/>.
        /// </summary>
        /// <param name="writer"><see creft="Utf8JsonWriter"/></param>
        /// <param name="undefinedBeneficiary"></param>
        /// <param name="jsonSerializerOptions"><see cref="JsonSerializerOptions"/></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, UndefinedBeneficiary undefinedBeneficiary, JsonSerializerOptions jsonSerializerOptions)
        {
            /*
            if (undefinedBeneficiary._DescriptionOption.IsSet && undefinedBeneficiary.Description == null)
                throw new ArgumentNullException(nameof(undefinedBeneficiary.Description), "Property is required for class UndefinedBeneficiary.");

            if (undefinedBeneficiary._ReferenceOption.IsSet && undefinedBeneficiary.Reference == null)
                throw new ArgumentNullException(nameof(undefinedBeneficiary.Reference), "Property is required for class UndefinedBeneficiary.");

            */
            
            if (undefinedBeneficiary._DescriptionOption.IsSet)
                writer.WriteString("description", undefinedBeneficiary.Description);

            if (undefinedBeneficiary._ReferenceOption.IsSet)
                writer.WriteString("reference", undefinedBeneficiary.Reference);
        }
    }
}
