...
namespace Adyen.LegalEntityManagement.Models
{
    ...
    public class GetTermsOfServiceDocumentResponseJsonConverter : JsonConverter<GetTermsOfServiceDocumentResponse>
    {
        ...
        public override GetTermsOfServiceDocumentResponse Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
                ...
                if (utf8JsonReader.TokenType == JsonTokenType.PropertyName && currentDepth == utf8JsonReader.CurrentDepth - 1)
                {
                    ...
                    switch (jsonPropertyName)
                    {
                        ...
                        case "type":
                            ...
                            type = new Option<GetTermsOfServiceDocumentResponse.TypeEnum?>(GetTermsOfServiceDocumentResponse.TypeEnum.FromStringOrDefault(typeRawValue) ?? (GetTermsOfServiceDocumentResponse.TypeEnum)typeRawValue);
                            break;
                        default:
                            break;
                    }
            ...
            if (id.IsSet)
                getTermsOfServiceDocumentResponse.Id = id.Value;
            if (language.IsSet)
                getTermsOfServiceDocumentResponse.Language = language.Value;
            if (termsOfServiceDocumentFormat.IsSet)
                getTermsOfServiceDocumentResponse.TermsOfServiceDocumentFormat = termsOfServiceDocumentFormat.Value;
            if (termsOfServiceDocumentId.IsSet)
                getTermsOfServiceDocumentResponse.TermsOfServiceDocumentId = termsOfServiceDocumentId.Value;
            if (type.IsSet)
                getTermsOfServiceDocumentResponse.Type = type.Value;
        ...
        public void WriteProperties(Utf8JsonWriter writer, GetTermsOfServiceDocumentResponse getTermsOfServiceDocumentResponse, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (getTermsOfServiceDocumentResponse._DocumentOption.IsSet)
            {
                ...
                ByteArrayConverter.Instance.Write(writer, getTermsOfServiceDocumentResponse.Document, jsonSerializerOptions);
            }
