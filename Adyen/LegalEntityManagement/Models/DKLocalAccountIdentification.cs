    ...
    public class DKLocalAccountIdentificationJsonConverter : JsonConverter<DKLocalAccountIdentification>
    {
        ...
        public override DKLocalAccountIdentification Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (accountNumber.IsSet && accountNumber.Value == null)
                throw new ArgumentNullException(nameof(accountNumber), "Property is not nullable for class DKLocalAccountIdentification.");

            if (bankCode.IsSet && bankCode.Value == null)
                throw new ArgumentNullException(nameof(bankCode), "Property is not nullable for class DKLocalAccountIdentification.");

            if (type.IsSet && type.Value == null)
                throw new ArgumentNullException(nameof(type), "Property is not nullable for class DKLocalAccountIdentification.");
        ...
        public void WriteProperties(Utf8JsonWriter writer, DKLocalAccountIdentification dKLocalAccountIdentification, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (dKLocalAccountIdentification.AccountNumber == null)
                throw new ArgumentNullException(nameof(dKLocalAccountIdentification.AccountNumber), "Property is required for class DKLocalAccountIdentification.");

            if (dKLocalAccountIdentification.BankCode == null)
                throw new ArgumentNullException(nameof(dKLocalAccountIdentification.BankCode), "Property is required for class DKLocalAccountIdentification.");
