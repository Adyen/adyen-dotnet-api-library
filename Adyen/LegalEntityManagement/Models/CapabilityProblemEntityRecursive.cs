...
namespace Adyen.LegalEntityManagement.Models
{
    ...
    public partial class CapabilityProblemEntityRecursive : IValidatableObject
    {
        ...
        public class TypeEnum: IEnum
        {
            ...
            /// </summary>
            public static readonly TypeEnum Product = new("product");
    ...
    public class CapabilityProblemEntityRecursiveJsonConverter : JsonConverter<CapabilityProblemEntityRecursive>
    {
        ...
        public override CapabilityProblemEntityRecursive Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (documents.IsSet && documents.Value == null)
                throw new ArgumentNullException(nameof(documents), "Property is not nullable for class CapabilityProblemEntityRecursive.");

            if (id.IsSet && id.Value == null)
                throw new ArgumentNullException(nameof(id), "Property is not nullable for class CapabilityProblemEntityRecursive.");

            if (type.IsSet && type.Value == null)
                throw new ArgumentNullException(nameof(type), "Property is not nullable for class CapabilityProblemEntityRecursive.");
        ...
        {
            /*
            if (capabilityProblemEntityRecursive._DocumentsOption.IsSet && capabilityProblemEntityRecursive.Documents == null)
                throw new ArgumentNullException(nameof(capabilityProblemEntityRecursive.Documents), "Property is required for class CapabilityProblemEntityRecursive.");

            if (capabilityProblemEntityRecursive._IdOption.IsSet && capabilityProblemEntityRecursive.Id == null)
                throw new ArgumentNullException(nameof(capabilityProblemEntityRecursive.Id), "Property is required for class CapabilityProblemEntityRecursive.");
