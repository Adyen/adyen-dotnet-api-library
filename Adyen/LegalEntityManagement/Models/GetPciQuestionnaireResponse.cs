...
namespace Adyen.LegalEntityManagement.Models
{
    ...
    public class GetPciQuestionnaireResponseJsonConverter : JsonConverter<GetPciQuestionnaireResponse>
    {
        ...
        public override GetPciQuestionnaireResponse Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (createdAt.IsSet)
                getPciQuestionnaireResponse.CreatedAt = createdAt.Value;
            if (id.IsSet)
                getPciQuestionnaireResponse.Id = id.Value;
            if (validUntil.IsSet)
                getPciQuestionnaireResponse.ValidUntil = validUntil.Value;
        ...
        public void WriteProperties(Utf8JsonWriter writer, GetPciQuestionnaireResponse getPciQuestionnaireResponse, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (getPciQuestionnaireResponse._ContentOption.IsSet)
            {
                ...
                ByteArrayConverter.Instance.Write(writer, getPciQuestionnaireResponse.Content, jsonSerializerOptions);
            }
