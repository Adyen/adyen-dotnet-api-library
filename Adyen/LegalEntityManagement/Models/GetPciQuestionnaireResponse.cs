    ...
    public class GetPciQuestionnaireResponseJsonConverter : JsonConverter<GetPciQuestionnaireResponse>
    {
        ...
        public override GetPciQuestionnaireResponse Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (content.IsSet && content.Value == null)
                throw new ArgumentNullException(nameof(content), "Property is not nullable for class GetPciQuestionnaireResponse.");

            if (createdAt.IsSet && createdAt.Value == null)
                throw new ArgumentNullException(nameof(createdAt), "Property is not nullable for class GetPciQuestionnaireResponse.");

            if (id.IsSet && id.Value == null)
                throw new ArgumentNullException(nameof(id), "Property is not nullable for class GetPciQuestionnaireResponse.");

            if (validUntil.IsSet && validUntil.Value == null)
                throw new ArgumentNullException(nameof(validUntil), "Property is not nullable for class GetPciQuestionnaireResponse.");
        ...
        {
            /*
            if (getPciQuestionnaireResponse._ContentOption.IsSet && getPciQuestionnaireResponse.Content == null)
                throw new ArgumentNullException(nameof(getPciQuestionnaireResponse.Content), "Property is required for class GetPciQuestionnaireResponse.");

            if (getPciQuestionnaireResponse._IdOption.IsSet && getPciQuestionnaireResponse.Id == null)
                throw new ArgumentNullException(nameof(getPciQuestionnaireResponse.Id), "Property is required for class GetPciQuestionnaireResponse.");
