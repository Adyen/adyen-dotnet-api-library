    ...
    public class DocumentJsonConverter : JsonConverter<Document>
    {
        ...
        public override Document Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (description.IsSet && description.Value == null)
                throw new ArgumentNullException(nameof(description), "Property is not nullable for class Document.");

            if (type.IsSet && type.Value == null)
                throw new ArgumentNullException(nameof(type), "Property is not nullable for class Document.");

            if (attachment.IsSet && attachment.Value == null)
                throw new ArgumentNullException(nameof(attachment), "Property is not nullable for class Document.");

            if (attachments.IsSet && attachments.Value == null)
                throw new ArgumentNullException(nameof(attachments), "Property is not nullable for class Document.");

            if (creationDate.IsSet && creationDate.Value == null)
                throw new ArgumentNullException(nameof(creationDate), "Property is not nullable for class Document.");

            if (expiryDate.IsSet && expiryDate.Value == null)
                throw new ArgumentNullException(nameof(expiryDate), "Property is not nullable for class Document.");

            if (fileName.IsSet && fileName.Value == null)
                throw new ArgumentNullException(nameof(fileName), "Property is not nullable for class Document.");

            if (id.IsSet && id.Value == null)
                throw new ArgumentNullException(nameof(id), "Property is not nullable for class Document.");

            if (issuerCountry.IsSet && issuerCountry.Value == null)
                throw new ArgumentNullException(nameof(issuerCountry), "Property is not nullable for class Document.");

            if (issuerState.IsSet && issuerState.Value == null)
                throw new ArgumentNullException(nameof(issuerState), "Property is not nullable for class Document.");

            if (modificationDate.IsSet && modificationDate.Value == null)
                throw new ArgumentNullException(nameof(modificationDate), "Property is not nullable for class Document.");

            if (number.IsSet && number.Value == null)
                throw new ArgumentNullException(nameof(number), "Property is not nullable for class Document.");

            if (owner.IsSet && owner.Value == null)
                throw new ArgumentNullException(nameof(owner), "Property is not nullable for class Document.");
        ...
        public void WriteProperties(Utf8JsonWriter writer, Document document, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (document.Description == null)
                throw new ArgumentNullException(nameof(document.Description), "Property is required for class Document.");

            if (document._AttachmentOption.IsSet && document.Attachment == null)
                throw new ArgumentNullException(nameof(document.Attachment), "Property is required for class Document.");

            if (document._AttachmentsOption.IsSet && document.Attachments == null)
                throw new ArgumentNullException(nameof(document.Attachments), "Property is required for class Document.");

            if (document._ExpiryDateOption.IsSet && document.ExpiryDate == null)
                throw new ArgumentNullException(nameof(document.ExpiryDate), "Property is required for class Document.");

            if (document._FileNameOption.IsSet && document.FileName == null)
                throw new ArgumentNullException(nameof(document.FileName), "Property is required for class Document.");

            if (document._IdOption.IsSet && document.Id == null)
                throw new ArgumentNullException(nameof(document.Id), "Property is required for class Document.");

            if (document._IssuerCountryOption.IsSet && document.IssuerCountry == null)
                throw new ArgumentNullException(nameof(document.IssuerCountry), "Property is required for class Document.");

            if (document._IssuerStateOption.IsSet && document.IssuerState == null)
                throw new ArgumentNullException(nameof(document.IssuerState), "Property is required for class Document.");

            if (document._NumberOption.IsSet && document.Number == null)
                throw new ArgumentNullException(nameof(document.Number), "Property is required for class Document.");

            if (document._OwnerOption.IsSet && document.Owner == null)
                throw new ArgumentNullException(nameof(document.Owner), "Property is required for class Document.");
