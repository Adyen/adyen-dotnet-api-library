    ...
    public class DocumentJsonConverter : JsonConverter<Document>
    {
        ...
        public override Document Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (attachments.IsSet)
                document.Attachments = attachments.Value;
            if (creationDate.IsSet)
                document.CreationDate = creationDate.Value;
            if (expiryDate.IsSet)
            ...
            if (issuerCountry.IsSet)
                document.IssuerCountry = issuerCountry.Value;
            if (issuerState.IsSet)
                document.IssuerState = issuerState.Value;
            if (modificationDate.IsSet)
                document.ModificationDate = modificationDate.Value;
            if (number.IsSet)
                document.Number = number.Value;
            if (owner.IsSet)
                document.Owner = owner.Value;
            return document;
        }
