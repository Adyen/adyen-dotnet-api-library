    ...
    public class OwnerEntityJsonConverter : JsonConverter<OwnerEntity>
    {
        ...
        public override OwnerEntity Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (id.IsSet && id.Value == null)
                throw new ArgumentNullException(nameof(id), "Property is not nullable for class OwnerEntity.");

            if (type.IsSet && type.Value == null)
                throw new ArgumentNullException(nameof(type), "Property is not nullable for class OwnerEntity.");
        ...
        public void WriteProperties(Utf8JsonWriter writer, OwnerEntity ownerEntity, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (ownerEntity.Id == null)
                throw new ArgumentNullException(nameof(ownerEntity.Id), "Property is required for class OwnerEntity.");

            if (ownerEntity.Type == null)
                throw new ArgumentNullException(nameof(ownerEntity.Type), "Property is required for class OwnerEntity.");
