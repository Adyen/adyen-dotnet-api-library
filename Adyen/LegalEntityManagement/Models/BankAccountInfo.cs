...
namespace Adyen.LegalEntityManagement.Models
{
    ...
    /// BankAccountInfo.
    /// </summary>
    [JsonConverter(typeof(BankAccountInfoJsonConverter))]
    ...
    public class BankAccountInfoJsonConverter : JsonConverter<BankAccountInfo>
    {
        ...
        public override BankAccountInfo Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (accountType.IsSet)
                bankAccountInfo.AccountType = accountType.Value;
            if (bankName.IsSet)
                bankAccountInfo.BankName = bankName.Value;
            if (countryCode.IsSet)
                bankAccountInfo.CountryCode = countryCode.Value;
            if (trustedSource.IsSet)
                bankAccountInfo.TrustedSource = trustedSource.Value;
