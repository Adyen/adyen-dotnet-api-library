...
namespace Adyen.LegalEntityManagement.Models
{
    ...
    /// BankAccountInfo.
    /// </summary>
    public partial class BankAccountInfo : IValidatableObject
    {
        /// <summary>
    ...
    public class BankAccountInfoJsonConverter : JsonConverter<BankAccountInfo>
    {
        ...
        public override BankAccountInfo Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (accountIdentification.IsSet && accountIdentification.Value == null)
                throw new ArgumentNullException(nameof(accountIdentification), "Property is not nullable for class BankAccountInfo.");

            if (accountType.IsSet && accountType.Value == null)
                throw new ArgumentNullException(nameof(accountType), "Property is not nullable for class BankAccountInfo.");

            if (bankName.IsSet && bankName.Value == null)
                throw new ArgumentNullException(nameof(bankName), "Property is not nullable for class BankAccountInfo.");

            if (countryCode.IsSet && countryCode.Value == null)
                throw new ArgumentNullException(nameof(countryCode), "Property is not nullable for class BankAccountInfo.");

            if (trustedSource.IsSet && trustedSource.Value == null)
                throw new ArgumentNullException(nameof(trustedSource), "Property is not nullable for class BankAccountInfo.");
        ...
        {
            /*
            if (bankAccountInfo._AccountIdentificationOption.IsSet && bankAccountInfo.AccountIdentification == null)
                throw new ArgumentNullException(nameof(bankAccountInfo.AccountIdentification), "Property is required for class BankAccountInfo.");

            if (bankAccountInfo._AccountTypeOption.IsSet && bankAccountInfo.AccountType == null)
                throw new ArgumentNullException(nameof(bankAccountInfo.AccountType), "Property is required for class BankAccountInfo.");

            if (bankAccountInfo._BankNameOption.IsSet && bankAccountInfo.BankName == null)
                throw new ArgumentNullException(nameof(bankAccountInfo.BankName), "Property is required for class BankAccountInfo.");

            if (bankAccountInfo._CountryCodeOption.IsSet && bankAccountInfo.CountryCode == null)
                throw new ArgumentNullException(nameof(bankAccountInfo.CountryCode), "Property is required for class BankAccountInfo.");
