...
namespace Adyen.LegalEntityManagement.Models
{
    ...
    /// </summary>
    public partial class LegalEntityAssociation : IValidatableObject
    {
        /// <summary>
    ...
    public class LegalEntityAssociationJsonConverter : JsonConverter<LegalEntityAssociation>
    {
        ...
        public override LegalEntityAssociation Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (legalEntityId.IsSet && legalEntityId.Value == null)
                throw new ArgumentNullException(nameof(legalEntityId), "Property is not nullable for class LegalEntityAssociation.");

            if (type.IsSet && type.Value == null)
                throw new ArgumentNullException(nameof(type), "Property is not nullable for class LegalEntityAssociation.");

            if (associatorId.IsSet && associatorId.Value == null)
                throw new ArgumentNullException(nameof(associatorId), "Property is not nullable for class LegalEntityAssociation.");

            if (entityType.IsSet && entityType.Value == null)
                throw new ArgumentNullException(nameof(entityType), "Property is not nullable for class LegalEntityAssociation.");

            if (jobTitle.IsSet && jobTitle.Value == null)
                throw new ArgumentNullException(nameof(jobTitle), "Property is not nullable for class LegalEntityAssociation.");

            if (name.IsSet && name.Value == null)
                throw new ArgumentNullException(nameof(name), "Property is not nullable for class LegalEntityAssociation.");

            if (nominee.IsSet && nominee.Value == null)
                throw new ArgumentNullException(nameof(nominee), "Property is not nullable for class LegalEntityAssociation.");

            if (relationship.IsSet && relationship.Value == null)
                throw new ArgumentNullException(nameof(relationship), "Property is not nullable for class LegalEntityAssociation.");

            if (settlorExemptionReason.IsSet && settlorExemptionReason.Value == null)
                throw new ArgumentNullException(nameof(settlorExemptionReason), "Property is not nullable for class LegalEntityAssociation.");
        ...
        public void WriteProperties(Utf8JsonWriter writer, LegalEntityAssociation legalEntityAssociation, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (legalEntityAssociation.LegalEntityId == null)
                throw new ArgumentNullException(nameof(legalEntityAssociation.LegalEntityId), "Property is required for class LegalEntityAssociation.");

            if (legalEntityAssociation._AssociatorIdOption.IsSet && legalEntityAssociation.AssociatorId == null)
                throw new ArgumentNullException(nameof(legalEntityAssociation.AssociatorId), "Property is required for class LegalEntityAssociation.");

            if (legalEntityAssociation._EntityTypeOption.IsSet && legalEntityAssociation.EntityType == null)
                throw new ArgumentNullException(nameof(legalEntityAssociation.EntityType), "Property is required for class LegalEntityAssociation.");

            if (legalEntityAssociation._JobTitleOption.IsSet && legalEntityAssociation.JobTitle == null)
                throw new ArgumentNullException(nameof(legalEntityAssociation.JobTitle), "Property is required for class LegalEntityAssociation.");

            if (legalEntityAssociation._NameOption.IsSet && legalEntityAssociation.Name == null)
                throw new ArgumentNullException(nameof(legalEntityAssociation.Name), "Property is required for class LegalEntityAssociation.");

            if (legalEntityAssociation._RelationshipOption.IsSet && legalEntityAssociation.Relationship == null)
                throw new ArgumentNullException(nameof(legalEntityAssociation.Relationship), "Property is required for class LegalEntityAssociation.");

            if (legalEntityAssociation._SettlorExemptionReasonOption.IsSet && legalEntityAssociation.SettlorExemptionReason == null)
                throw new ArgumentNullException(nameof(legalEntityAssociation.SettlorExemptionReason), "Property is required for class LegalEntityAssociation.");
