...
namespace Adyen.LegalEntityManagement.Models
{
    ...
    /// </summary>
    [JsonConverter(typeof(LegalEntityAssociationJsonConverter))]
    public partial class LegalEntityAssociation
    {
        ...
        public Option<string?> _AssociatorIdOption { get; private set; }
        ...
        [JsonIgnore]
        [global::System.ComponentModel.EditorBrowsable(global::System.ComponentModel.EditorBrowsableState.Never)]
        public Option<string?> _EntityTypeOption { get; private set; }
    ...
    public class LegalEntityAssociationJsonConverter : JsonConverter<LegalEntityAssociation>
    {
        ...
        public override LegalEntityAssociation Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (entityType.IsSet)
                legalEntityAssociation.EntityType = entityType.Value;
            if (jobTitle.IsSet)
                legalEntityAssociation.JobTitle = jobTitle.Value;
            if (name.IsSet)
                legalEntityAssociation.Name = name.Value;
            if (nominee.IsSet)
                legalEntityAssociation.Nominee = nominee.Value;
            if (relationship.IsSet)
                legalEntityAssociation.Relationship = relationship.Value;
            if (settlorExemptionReason.IsSet)
                legalEntityAssociation.SettlorExemptionReason = settlorExemptionReason.Value;
