...
namespace Adyen.LegalEntityManagement.Models
{
    ...
    /// </summary>
    [JsonConverter(typeof(GetTermsOfServiceAcceptanceInfosResponseJsonConverter))]
    public partial class GetTermsOfServiceAcceptanceInfosResponse
    {
        /// <summary>
    ...
    public class GetTermsOfServiceAcceptanceInfosResponseJsonConverter : JsonConverter<GetTermsOfServiceAcceptanceInfosResponse>
    {
        ...
        public override GetTermsOfServiceAcceptanceInfosResponse Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            var getTermsOfServiceAcceptanceInfosResponse = new GetTermsOfServiceAcceptanceInfosResponse();
            if (data.IsSet)
                getTermsOfServiceAcceptanceInfosResponse.Data = data.Value;
