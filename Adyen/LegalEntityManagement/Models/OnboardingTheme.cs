    ...
    public class OnboardingThemeJsonConverter : JsonConverter<OnboardingTheme>
    {
        ...
        public override OnboardingTheme Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (createdAt.IsSet && createdAt.Value == null)
                throw new ArgumentNullException(nameof(createdAt), "Property is not nullable for class OnboardingTheme.");

            if (id.IsSet && id.Value == null)
                throw new ArgumentNullException(nameof(id), "Property is not nullable for class OnboardingTheme.");

            if (properties.IsSet && properties.Value == null)
                throw new ArgumentNullException(nameof(properties), "Property is not nullable for class OnboardingTheme.");

            if (description.IsSet && description.Value == null)
                throw new ArgumentNullException(nameof(description), "Property is not nullable for class OnboardingTheme.");

            if (updatedAt.IsSet && updatedAt.Value == null)
                throw new ArgumentNullException(nameof(updatedAt), "Property is not nullable for class OnboardingTheme.");
        ...
        public void WriteProperties(Utf8JsonWriter writer, OnboardingTheme onboardingTheme, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (onboardingTheme.Id == null)
                throw new ArgumentNullException(nameof(onboardingTheme.Id), "Property is required for class OnboardingTheme.");

            if (onboardingTheme.Properties == null)
                throw new ArgumentNullException(nameof(onboardingTheme.Properties), "Property is required for class OnboardingTheme.");

            if (onboardingTheme._DescriptionOption.IsSet && onboardingTheme.Description == null)
                throw new ArgumentNullException(nameof(onboardingTheme.Description), "Property is required for class OnboardingTheme.");
