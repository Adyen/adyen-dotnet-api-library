    ...
    public class CapabilityProblemEntityJsonConverter : JsonConverter<CapabilityProblemEntity>
    {
        ...
        public override CapabilityProblemEntity Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (documents.IsSet && documents.Value == null)
                throw new ArgumentNullException(nameof(documents), "Property is not nullable for class CapabilityProblemEntity.");

            if (id.IsSet && id.Value == null)
                throw new ArgumentNullException(nameof(id), "Property is not nullable for class CapabilityProblemEntity.");

            if (owner.IsSet && owner.Value == null)
                throw new ArgumentNullException(nameof(owner), "Property is not nullable for class CapabilityProblemEntity.");

            if (type.IsSet && type.Value == null)
                throw new ArgumentNullException(nameof(type), "Property is not nullable for class CapabilityProblemEntity.");
        ...
        {
            /*
            if (capabilityProblemEntity._DocumentsOption.IsSet && capabilityProblemEntity.Documents == null)
                throw new ArgumentNullException(nameof(capabilityProblemEntity.Documents), "Property is required for class CapabilityProblemEntity.");

            if (capabilityProblemEntity._IdOption.IsSet && capabilityProblemEntity.Id == null)
                throw new ArgumentNullException(nameof(capabilityProblemEntity.Id), "Property is required for class CapabilityProblemEntity.");

            if (capabilityProblemEntity._OwnerOption.IsSet && capabilityProblemEntity.Owner == null)
                throw new ArgumentNullException(nameof(capabilityProblemEntity.Owner), "Property is required for class CapabilityProblemEntity.");
