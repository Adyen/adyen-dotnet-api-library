    ...
    public class NumberAndBicAccountIdentificationJsonConverter : JsonConverter<NumberAndBicAccountIdentification>
    {
        ...
        public override NumberAndBicAccountIdentification Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (accountNumber.IsSet && accountNumber.Value == null)
                throw new ArgumentNullException(nameof(accountNumber), "Property is not nullable for class NumberAndBicAccountIdentification.");

            if (bic.IsSet && bic.Value == null)
                throw new ArgumentNullException(nameof(bic), "Property is not nullable for class NumberAndBicAccountIdentification.");

            if (additionalBankIdentification.IsSet && additionalBankIdentification.Value == null)
                throw new ArgumentNullException(nameof(additionalBankIdentification), "Property is not nullable for class NumberAndBicAccountIdentification.");

            if (type.IsSet && type.Value == null)
                throw new ArgumentNullException(nameof(type), "Property is not nullable for class NumberAndBicAccountIdentification.");
        ...
        public void WriteProperties(Utf8JsonWriter writer, NumberAndBicAccountIdentification numberAndBicAccountIdentification, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (numberAndBicAccountIdentification.AccountNumber == null)
                throw new ArgumentNullException(nameof(numberAndBicAccountIdentification.AccountNumber), "Property is required for class NumberAndBicAccountIdentification.");

            if (numberAndBicAccountIdentification.Bic == null)
                throw new ArgumentNullException(nameof(numberAndBicAccountIdentification.Bic), "Property is required for class NumberAndBicAccountIdentification.");

            if (numberAndBicAccountIdentification._AdditionalBankIdentificationOption.IsSet && numberAndBicAccountIdentification.AdditionalBankIdentification == null)
                throw new ArgumentNullException(nameof(numberAndBicAccountIdentification.AdditionalBankIdentification), "Property is required for class NumberAndBicAccountIdentification.");
