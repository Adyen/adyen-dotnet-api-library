...
namespace Adyen.LegalEntityManagement.Models
{
    ...
    /// </summary>
    [JsonConverter(typeof(OnboardingLinkSettingsJsonConverter))]
    public partial class OnboardingLinkSettings
    {
        /// <summary>
    ...
    public class OnboardingLinkSettingsJsonConverter : JsonConverter<OnboardingLinkSettings>
    {
        ...
        public override OnboardingLinkSettings Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (allowBankAccountFormatSelection.IsSet)
                onboardingLinkSettings.AllowBankAccountFormatSelection = allowBankAccountFormatSelection.Value;
            if (allowDebugUi.IsSet)
                onboardingLinkSettings.AllowDebugUi = allowDebugUi.Value;
            if (allowIntraRegionCrossBorderPayout.IsSet)
                onboardingLinkSettings.AllowIntraRegionCrossBorderPayout = allowIntraRegionCrossBorderPayout.Value;
            if (changeLegalEntityType.IsSet)
                onboardingLinkSettings.ChangeLegalEntityType = changeLegalEntityType.Value;
            if (editPrefilledCountry.IsSet)
                onboardingLinkSettings.EditPrefilledCountry = editPrefilledCountry.Value;
            if (enforceLegalAge.IsSet)
                onboardingLinkSettings.EnforceLegalAge = enforceLegalAge.Value;
            if (hideOnboardingIntroductionIndividual.IsSet)
                onboardingLinkSettings.HideOnboardingIntroductionIndividual = hideOnboardingIntroductionIndividual.Value;
            if (hideOnboardingIntroductionOrganization.IsSet)
                onboardingLinkSettings.HideOnboardingIntroductionOrganization = hideOnboardingIntroductionOrganization.Value;
            if (hideOnboardingIntroductionSoleProprietor.IsSet)
                onboardingLinkSettings.HideOnboardingIntroductionSoleProprietor = hideOnboardingIntroductionSoleProprietor.Value;
            if (hideOnboardingIntroductionTrust.IsSet)
                onboardingLinkSettings.HideOnboardingIntroductionTrust = hideOnboardingIntroductionTrust.Value;
            if (instantBankVerification.IsSet)
                onboardingLinkSettings.InstantBankVerification = instantBankVerification.Value;
            if (requirePciSignEcomMoto.IsSet)
                onboardingLinkSettings.RequirePciSignEcomMoto = requirePciSignEcomMoto.Value;
            if (requirePciSignEcommerce.IsSet)
                onboardingLinkSettings.RequirePciSignEcommerce = requirePciSignEcommerce.Value;
            if (requirePciSignPos.IsSet)
                onboardingLinkSettings.RequirePciSignPos = requirePciSignPos.Value;
            if (requirePciSignPosMoto.IsSet)
                onboardingLinkSettings.RequirePciSignPosMoto = requirePciSignPosMoto.Value;
            if (transferInstrumentLimit.IsSet)
                onboardingLinkSettings.TransferInstrumentLimit = transferInstrumentLimit.Value;
            return onboardingLinkSettings;
        }
