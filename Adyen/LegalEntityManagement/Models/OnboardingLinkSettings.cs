...
namespace Adyen.LegalEntityManagement.Models
{
    ...
    public class OnboardingLinkSettingsJsonConverter : JsonConverter<OnboardingLinkSettings>
    {
        ...
        public override OnboardingLinkSettings Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (acceptedCountries.IsSet && acceptedCountries.Value == null)
                throw new ArgumentNullException(nameof(acceptedCountries), "Property is not nullable for class OnboardingLinkSettings.");

            if (allowBankAccountFormatSelection.IsSet && allowBankAccountFormatSelection.Value == null)
                throw new ArgumentNullException(nameof(allowBankAccountFormatSelection), "Property is not nullable for class OnboardingLinkSettings.");

            if (allowDebugUi.IsSet && allowDebugUi.Value == null)
                throw new ArgumentNullException(nameof(allowDebugUi), "Property is not nullable for class OnboardingLinkSettings.");

            if (allowIntraRegionCrossBorderPayout.IsSet && allowIntraRegionCrossBorderPayout.Value == null)
                throw new ArgumentNullException(nameof(allowIntraRegionCrossBorderPayout), "Property is not nullable for class OnboardingLinkSettings.");

            if (changeLegalEntityType.IsSet && changeLegalEntityType.Value == null)
                throw new ArgumentNullException(nameof(changeLegalEntityType), "Property is not nullable for class OnboardingLinkSettings.");

            if (editPrefilledCountry.IsSet && editPrefilledCountry.Value == null)
                throw new ArgumentNullException(nameof(editPrefilledCountry), "Property is not nullable for class OnboardingLinkSettings.");

            if (enforceLegalAge.IsSet && enforceLegalAge.Value == null)
                throw new ArgumentNullException(nameof(enforceLegalAge), "Property is not nullable for class OnboardingLinkSettings.");

            if (hideOnboardingIntroductionIndividual.IsSet && hideOnboardingIntroductionIndividual.Value == null)
                throw new ArgumentNullException(nameof(hideOnboardingIntroductionIndividual), "Property is not nullable for class OnboardingLinkSettings.");

            if (hideOnboardingIntroductionOrganization.IsSet && hideOnboardingIntroductionOrganization.Value == null)
                throw new ArgumentNullException(nameof(hideOnboardingIntroductionOrganization), "Property is not nullable for class OnboardingLinkSettings.");

            if (hideOnboardingIntroductionSoleProprietor.IsSet && hideOnboardingIntroductionSoleProprietor.Value == null)
                throw new ArgumentNullException(nameof(hideOnboardingIntroductionSoleProprietor), "Property is not nullable for class OnboardingLinkSettings.");

            if (hideOnboardingIntroductionTrust.IsSet && hideOnboardingIntroductionTrust.Value == null)
                throw new ArgumentNullException(nameof(hideOnboardingIntroductionTrust), "Property is not nullable for class OnboardingLinkSettings.");

            if (instantBankVerification.IsSet && instantBankVerification.Value == null)
                throw new ArgumentNullException(nameof(instantBankVerification), "Property is not nullable for class OnboardingLinkSettings.");

            if (requirePciSignEcomMoto.IsSet && requirePciSignEcomMoto.Value == null)
                throw new ArgumentNullException(nameof(requirePciSignEcomMoto), "Property is not nullable for class OnboardingLinkSettings.");

            if (requirePciSignEcommerce.IsSet && requirePciSignEcommerce.Value == null)
                throw new ArgumentNullException(nameof(requirePciSignEcommerce), "Property is not nullable for class OnboardingLinkSettings.");

            if (requirePciSignPos.IsSet && requirePciSignPos.Value == null)
                throw new ArgumentNullException(nameof(requirePciSignPos), "Property is not nullable for class OnboardingLinkSettings.");

            if (requirePciSignPosMoto.IsSet && requirePciSignPosMoto.Value == null)
                throw new ArgumentNullException(nameof(requirePciSignPosMoto), "Property is not nullable for class OnboardingLinkSettings.");

            if (transferInstrumentLimit.IsSet && transferInstrumentLimit.Value == null)
                throw new ArgumentNullException(nameof(transferInstrumentLimit), "Property is not nullable for class OnboardingLinkSettings.");
        ...
        {
            /*
            if (onboardingLinkSettings._AcceptedCountriesOption.IsSet && onboardingLinkSettings.AcceptedCountries == null)
                throw new ArgumentNullException(nameof(onboardingLinkSettings.AcceptedCountries), "Property is required for class OnboardingLinkSettings.");
