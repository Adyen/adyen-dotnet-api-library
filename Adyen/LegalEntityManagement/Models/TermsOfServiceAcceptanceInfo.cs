...
namespace Adyen.LegalEntityManagement.Models
{
    ...
    /// </summary>
    [JsonConverter(typeof(TermsOfServiceAcceptanceInfoJsonConverter))]
    public partial class TermsOfServiceAcceptanceInfo
    {
        ...
        /// <summary>
        /// This is used to track if an optional field is set. If set, <see cref="AcceptedFor"/> will be populated.
        /// </summary>
        [JsonIgnore]
        [global::System.ComponentModel.EditorBrowsable(global::System.ComponentModel.EditorBrowsableState.Never)]
        ...
        /// <summary>
        /// This is used to track if an optional field is set. If set, <see cref="ValidTo"/> will be populated.
        /// </summary>
        [JsonIgnore]
        [global::System.ComponentModel.EditorBrowsable(global::System.ComponentModel.EditorBrowsableState.Never)]
    ...
    public class TermsOfServiceAcceptanceInfoJsonConverter : JsonConverter<TermsOfServiceAcceptanceInfo>
    {
        ...
        public override TermsOfServiceAcceptanceInfo Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
                ...
                if (utf8JsonReader.TokenType == JsonTokenType.PropertyName && currentDepth == utf8JsonReader.CurrentDepth - 1)
                {
                    ...
                    switch (jsonPropertyName)
                    {
                        ...
                        case "type":
                            ...
                            type = new Option<TermsOfServiceAcceptanceInfo.TypeEnum?>(TermsOfServiceAcceptanceInfo.TypeEnum.FromStringOrDefault(typeRawValue) ?? (TermsOfServiceAcceptanceInfo.TypeEnum)typeRawValue);
                            break;
                        case "validTo":
            ...
            var termsOfServiceAcceptanceInfo = new TermsOfServiceAcceptanceInfo();
            if (acceptedBy.IsSet)
                termsOfServiceAcceptanceInfo.AcceptedBy = acceptedBy.Value;
            if (acceptedFor.IsSet)
                termsOfServiceAcceptanceInfo.AcceptedFor = acceptedFor.Value;
            if (createdAt.IsSet)
                termsOfServiceAcceptanceInfo.CreatedAt = createdAt.Value;
            if (id.IsSet)
                termsOfServiceAcceptanceInfo.Id = id.Value;
            if (type.IsSet)
                termsOfServiceAcceptanceInfo.Type = type.Value;
            if (validTo.IsSet)
                termsOfServiceAcceptanceInfo.ValidTo = validTo.Value;
            return termsOfServiceAcceptanceInfo;
        }
        ...
        public void WriteProperties(Utf8JsonWriter writer, TermsOfServiceAcceptanceInfo termsOfServiceAcceptanceInfo, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (termsOfServiceAcceptanceInfo._AcceptedByOption.IsSet)
                if (termsOfServiceAcceptanceInfo.AcceptedBy != null)
            ...
            if (termsOfServiceAcceptanceInfo._AcceptedForOption.IsSet)
                if (termsOfServiceAcceptanceInfo.AcceptedFor != null)
