...
namespace Adyen.LegalEntityManagement.Models
{
    ...
    /// LegalEntityInfo.
    /// </summary>
    public partial class LegalEntityInfo : IValidatableObject
    {
        /// <summary>
    ...
    /// <summary>
    /// A Json converter for type <see cref="LegalEntityInfo" />
    /// </summary>
    public class LegalEntityInfoJsonConverter : JsonConverter<LegalEntityInfo>
    {
        /// <summary>
        /// Deserializes json to <see cref="LegalEntityInfo"/>.
        /// </summary>
        /// <param name="utf8JsonReader"><see cref="Utf8JsonReader"/></param>
        /// <param name="typeToConvert"><see cref="Type"/></param>
        /// <param name="jsonSerializerOptions">The <see cref="JsonSerializerOptions"/>, initialized from <see cref="HostConfiguration"/>.</param>
        /// <returns><see cref="LegalEntityInfo"/></returns>
        /// <exception cref="JsonException"></exception>
        public override LegalEntityInfo Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            Option<LegalEntityInfo.TypeEnum?> type = default;
            ...
            if (capabilities.IsSet && capabilities.Value == null)
                throw new ArgumentNullException(nameof(capabilities), "Property is not nullable for class LegalEntityInfo.");

            if (entityAssociations.IsSet && entityAssociations.Value == null)
                throw new ArgumentNullException(nameof(entityAssociations), "Property is not nullable for class LegalEntityInfo.");

            if (individual.IsSet && individual.Value == null)
                throw new ArgumentNullException(nameof(individual), "Property is not nullable for class LegalEntityInfo.");

            if (organization.IsSet && organization.Value == null)
                throw new ArgumentNullException(nameof(organization), "Property is not nullable for class LegalEntityInfo.");

            if (reference.IsSet && reference.Value == null)
                throw new ArgumentNullException(nameof(reference), "Property is not nullable for class LegalEntityInfo.");

            if (soleProprietorship.IsSet && soleProprietorship.Value == null)
                throw new ArgumentNullException(nameof(soleProprietorship), "Property is not nullable for class LegalEntityInfo.");

            if (trust.IsSet && trust.Value == null)
                throw new ArgumentNullException(nameof(trust), "Property is not nullable for class LegalEntityInfo.");

            if (type.IsSet && type.Value == null)
                throw new ArgumentNullException(nameof(type), "Property is not nullable for class LegalEntityInfo.");

            if (unincorporatedPartnership.IsSet && unincorporatedPartnership.Value == null)
                throw new ArgumentNullException(nameof(unincorporatedPartnership), "Property is not nullable for class LegalEntityInfo.");

            if (verificationPlan.IsSet && verificationPlan.Value == null)
                throw new ArgumentNullException(nameof(verificationPlan), "Property is not nullable for class LegalEntityInfo.");

            return new LegalEntityInfo(capabilities, entityAssociations, individual, organization, reference, soleProprietorship, trust, type, unincorporatedPartnership, verificationPlan);
        }

        /// <summary>
        /// Serializes a <see cref="LegalEntityInfo"/>.
        /// </summary>
        /// <param name="writer"><see cref="Utf8JsonWriter"/></param>
        /// <param name="legalEntityInfo"></param>
        /// <param name="jsonSerializerOptions"><see cref="JsonSerializerOptions"/></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, LegalEntityInfo legalEntityInfo, JsonSerializerOptions jsonSerializerOptions)
        {
        ...
        /// <summary>
        /// Serializes the properties of <see cref="LegalEntityInfo"/>.
        /// </summary>
        /// <param name="writer"><see creft="Utf8JsonWriter"/></param>
        /// <param name="legalEntityInfo"></param>
        /// <param name="jsonSerializerOptions"><see cref="JsonSerializerOptions"/></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, LegalEntityInfo legalEntityInfo, JsonSerializerOptions jsonSerializerOptions)
        {
            /*
            if (legalEntityInfo._CapabilitiesOption.IsSet && legalEntityInfo.Capabilities == null)
                throw new ArgumentNullException(nameof(legalEntityInfo.Capabilities), "Property is required for class LegalEntityInfo.");

            if (legalEntityInfo._EntityAssociationsOption.IsSet && legalEntityInfo.EntityAssociations == null)
                throw new ArgumentNullException(nameof(legalEntityInfo.EntityAssociations), "Property is required for class LegalEntityInfo.");

            if (legalEntityInfo._IndividualOption.IsSet && legalEntityInfo.Individual == null)
                throw new ArgumentNullException(nameof(legalEntityInfo.Individual), "Property is required for class LegalEntityInfo.");

            if (legalEntityInfo._OrganizationOption.IsSet && legalEntityInfo.Organization == null)
                throw new ArgumentNullException(nameof(legalEntityInfo.Organization), "Property is required for class LegalEntityInfo.");

            if (legalEntityInfo._ReferenceOption.IsSet && legalEntityInfo.Reference == null)
                throw new ArgumentNullException(nameof(legalEntityInfo.Reference), "Property is required for class LegalEntityInfo.");

            if (legalEntityInfo._SoleProprietorshipOption.IsSet && legalEntityInfo.SoleProprietorship == null)
                throw new ArgumentNullException(nameof(legalEntityInfo.SoleProprietorship), "Property is required for class LegalEntityInfo.");

            if (legalEntityInfo._TrustOption.IsSet && legalEntityInfo.Trust == null)
                throw new ArgumentNullException(nameof(legalEntityInfo.Trust), "Property is required for class LegalEntityInfo.");

            if (legalEntityInfo._UnincorporatedPartnershipOption.IsSet && legalEntityInfo.UnincorporatedPartnership == null)
                throw new ArgumentNullException(nameof(legalEntityInfo.UnincorporatedPartnership), "Property is required for class LegalEntityInfo.");

            if (legalEntityInfo._VerificationPlanOption.IsSet && legalEntityInfo.VerificationPlan == null)
                throw new ArgumentNullException(nameof(legalEntityInfo.VerificationPlan), "Property is required for class LegalEntityInfo.");

            */
            
            if (legalEntityInfo._CapabilitiesOption.IsSet)
            {
                writer.WritePropertyName("capabilities");
                JsonSerializer.Serialize(writer, legalEntityInfo.Capabilities, jsonSerializerOptions);
            }
            if (legalEntityInfo._EntityAssociationsOption.IsSet)
            {
            ...
            if (legalEntityInfo._IndividualOption.IsSet)
            {
                writer.WritePropertyName("individual");
                JsonSerializer.Serialize(writer, legalEntityInfo.Individual, jsonSerializerOptions);
            }
            if (legalEntityInfo._OrganizationOption.IsSet)
            {
                writer.WritePropertyName("organization");
                JsonSerializer.Serialize(writer, legalEntityInfo.Organization, jsonSerializerOptions);
            }
            if (legalEntityInfo._ReferenceOption.IsSet)
                writer.WriteString("reference", legalEntityInfo.Reference);

            if (legalEntityInfo._SoleProprietorshipOption.IsSet)
            {
                writer.WritePropertyName("soleProprietorship");
                JsonSerializer.Serialize(writer, legalEntityInfo.SoleProprietorship, jsonSerializerOptions);
            }
            if (legalEntityInfo._TrustOption.IsSet)
            {
                writer.WritePropertyName("trust");
                JsonSerializer.Serialize(writer, legalEntityInfo.Trust, jsonSerializerOptions);
            }
            if (legalEntityInfo._TypeOption.IsSet && legalEntityInfo.Type != null) 
            {
                string? typeRawValue = LegalEntityInfo.TypeEnum.ToJsonValue(legalEntityInfo._TypeOption.Value!.Value);
                writer.WriteString("type", typeRawValue);
            }
            
            if (legalEntityInfo._UnincorporatedPartnershipOption.IsSet)
            {
                writer.WritePropertyName("unincorporatedPartnership");
                JsonSerializer.Serialize(writer, legalEntityInfo.UnincorporatedPartnership, jsonSerializerOptions);
            }
            if (legalEntityInfo._VerificationPlanOption.IsSet)
                writer.WriteString("verificationPlan", legalEntityInfo.VerificationPlan);
        }
    }
}
