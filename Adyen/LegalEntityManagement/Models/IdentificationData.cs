...
namespace Adyen.LegalEntityManagement.Models
{
    ...
    /// IdentificationData.
    /// </summary>
    [JsonConverter(typeof(IdentificationDataJsonConverter))]
    ...
    public class IdentificationDataJsonConverter : JsonConverter<IdentificationData>
    {
        ...
        public override IdentificationData Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (expiryDate.IsSet)
                identificationData.ExpiryDate = expiryDate.Value;
            if (issuerCountry.IsSet)
                identificationData.IssuerCountry = issuerCountry.Value;
            if (issuerState.IsSet)
                identificationData.IssuerState = issuerState.Value;
            if (nationalIdExempt.IsSet)
                identificationData.NationalIdExempt = nationalIdExempt.Value;
            if (number.IsSet)
                identificationData.Number = number.Value;
