    ...
    public class UKLocalAccountIdentificationJsonConverter : JsonConverter<UKLocalAccountIdentification>
    {
        ...
        public override UKLocalAccountIdentification Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (accountNumber.IsSet && accountNumber.Value == null)
                throw new ArgumentNullException(nameof(accountNumber), "Property is not nullable for class UKLocalAccountIdentification.");

            if (sortCode.IsSet && sortCode.Value == null)
                throw new ArgumentNullException(nameof(sortCode), "Property is not nullable for class UKLocalAccountIdentification.");

            if (type.IsSet && type.Value == null)
                throw new ArgumentNullException(nameof(type), "Property is not nullable for class UKLocalAccountIdentification.");
        ...
        public void WriteProperties(Utf8JsonWriter writer, UKLocalAccountIdentification uKLocalAccountIdentification, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (uKLocalAccountIdentification.AccountNumber == null)
                throw new ArgumentNullException(nameof(uKLocalAccountIdentification.AccountNumber), "Property is required for class UKLocalAccountIdentification.");

            if (uKLocalAccountIdentification.SortCode == null)
                throw new ArgumentNullException(nameof(uKLocalAccountIdentification.SortCode), "Property is required for class UKLocalAccountIdentification.");
