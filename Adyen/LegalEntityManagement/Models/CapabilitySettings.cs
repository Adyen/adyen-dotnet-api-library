...
namespace Adyen.LegalEntityManagement.Models
{
    ...
    public partial class CapabilitySettings : IValidatableObject
    {
        ...
        /// <summary>
        /// Used to track whether Interval is set or not.
        /// </summary>
        [JsonIgnore]
    ...
    public class CapabilitySettingsJsonConverter : JsonConverter<CapabilitySettings>
    {
        ...
        public override CapabilitySettings Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (amountPerIndustry.IsSet && amountPerIndustry.Value == null)
                throw new ArgumentNullException(nameof(amountPerIndustry), "Property is not nullable for class CapabilitySettings.");

            if (authorizedCardUsers.IsSet && authorizedCardUsers.Value == null)
                throw new ArgumentNullException(nameof(authorizedCardUsers), "Property is not nullable for class CapabilitySettings.");

            if (fundingSource.IsSet && fundingSource.Value == null)
                throw new ArgumentNullException(nameof(fundingSource), "Property is not nullable for class CapabilitySettings.");

            if (interval.IsSet && interval.Value == null)
                throw new ArgumentNullException(nameof(interval), "Property is not nullable for class CapabilitySettings.");

            if (maxAmount.IsSet && maxAmount.Value == null)
                throw new ArgumentNullException(nameof(maxAmount), "Property is not nullable for class CapabilitySettings.");
        ...
        {
            /*
            if (capabilitySettings._AmountPerIndustryOption.IsSet && capabilitySettings.AmountPerIndustry == null)
                throw new ArgumentNullException(nameof(capabilitySettings.AmountPerIndustry), "Property is required for class CapabilitySettings.");

            if (capabilitySettings._FundingSourceOption.IsSet && capabilitySettings.FundingSource == null)
                throw new ArgumentNullException(nameof(capabilitySettings.FundingSource), "Property is required for class CapabilitySettings.");

            if (capabilitySettings._MaxAmountOption.IsSet && capabilitySettings.MaxAmount == null)
                throw new ArgumentNullException(nameof(capabilitySettings.MaxAmount), "Property is required for class CapabilitySettings.");
