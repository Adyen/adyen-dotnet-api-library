...
namespace Adyen.LegalEntityManagement.Models
{
    ...
    /// WebData.
    /// </summary>
    public partial class WebData : IValidatableObject
    {
        /// <summary>
        ...
        public WebData(Option<string?> webAddress = default, Option<string?> webAddressId = default)
        {
            ...
            _WebAddressIdOption = webAddressId;
            OnCreated();
        }
        ...
        /// <summary>
        /// Used to track the state of WebAddressId
        /// </summary>
        [JsonIgnore]
        [global::System.ComponentModel.EditorBrowsable(global::System.ComponentModel.EditorBrowsableState.Never)]
    ...
    public class WebDataJsonConverter : JsonConverter<WebData>
    {
        ...
        public override WebData Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (webAddress.IsSet && webAddress.Value == null)
                throw new ArgumentNullException(nameof(webAddress), "Property is not nullable for class WebData.");

            if (webAddressId.IsSet && webAddressId.Value == null)
                throw new ArgumentNullException(nameof(webAddressId), "Property is not nullable for class WebData.");

            return new WebData(webAddress, webAddressId);
        }
        ...
        {
            /*
            if (webData._WebAddressOption.IsSet && webData.WebAddress == null)
                throw new ArgumentNullException(nameof(webData.WebAddress), "Property is required for class WebData.");

            if (webData._WebAddressIdOption.IsSet && webData.WebAddressId == null)
                throw new ArgumentNullException(nameof(webData.WebAddressId), "Property is required for class WebData.");
