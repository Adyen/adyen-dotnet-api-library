    ...
    public class HULocalAccountIdentificationJsonConverter : JsonConverter<HULocalAccountIdentification>
    {
        ...
        public override HULocalAccountIdentification Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (accountNumber.IsSet && accountNumber.Value == null)
                throw new ArgumentNullException(nameof(accountNumber), "Property is not nullable for class HULocalAccountIdentification.");

            if (type.IsSet && type.Value == null)
                throw new ArgumentNullException(nameof(type), "Property is not nullable for class HULocalAccountIdentification.");
        ...
        public void WriteProperties(Utf8JsonWriter writer, HULocalAccountIdentification hULocalAccountIdentification, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (hULocalAccountIdentification.AccountNumber == null)
                throw new ArgumentNullException(nameof(hULocalAccountIdentification.AccountNumber), "Property is required for class HULocalAccountIdentification.");
