...
namespace Adyen.LegalEntityManagement.Models
{
    ...
    /// DocumentPage.
    /// </summary>
    public partial class DocumentPage : IValidatableObject
    {
        /// <summary>
    ...
    public class DocumentPageJsonConverter : JsonConverter<DocumentPage>
    {
        ...
        public override DocumentPage Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (pageName.IsSet && pageName.Value == null)
                throw new ArgumentNullException(nameof(pageName), "Property is not nullable for class DocumentPage.");

            if (pageNumber.IsSet && pageNumber.Value == null)
                throw new ArgumentNullException(nameof(pageNumber), "Property is not nullable for class DocumentPage.");

            if (type.IsSet && type.Value == null)
                throw new ArgumentNullException(nameof(type), "Property is not nullable for class DocumentPage.");
        ...
        {
            /*
            if (documentPage._PageNameOption.IsSet && documentPage.PageName == null)
                throw new ArgumentNullException(nameof(documentPage.PageName), "Property is required for class DocumentPage.");
