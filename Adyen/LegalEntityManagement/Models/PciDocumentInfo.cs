...
namespace Adyen.LegalEntityManagement.Models
{
    ...
    /// PciDocumentInfo.
    /// </summary>
    public partial class PciDocumentInfo : IValidatableObject
    {
        /// <summary>
    ...
    public class PciDocumentInfoJsonConverter : JsonConverter<PciDocumentInfo>
    {
        ...
        public override PciDocumentInfo Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (createdAt.IsSet && createdAt.Value == null)
                throw new ArgumentNullException(nameof(createdAt), "Property is not nullable for class PciDocumentInfo.");

            if (id.IsSet && id.Value == null)
                throw new ArgumentNullException(nameof(id), "Property is not nullable for class PciDocumentInfo.");

            if (validUntil.IsSet && validUntil.Value == null)
                throw new ArgumentNullException(nameof(validUntil), "Property is not nullable for class PciDocumentInfo.");

            return new PciDocumentInfo(createdAt, id, validUntil);
        }
        ...
        {
            /*
            if (pciDocumentInfo._IdOption.IsSet && pciDocumentInfo.Id == null)
                throw new ArgumentNullException(nameof(pciDocumentInfo.Id), "Property is required for class PciDocumentInfo.");
