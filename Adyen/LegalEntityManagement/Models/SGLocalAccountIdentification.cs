    ...
    public class SGLocalAccountIdentificationJsonConverter : JsonConverter<SGLocalAccountIdentification>
    {
        ...
        public override SGLocalAccountIdentification Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (accountNumber.IsSet && accountNumber.Value == null)
                throw new ArgumentNullException(nameof(accountNumber), "Property is not nullable for class SGLocalAccountIdentification.");

            if (bic.IsSet && bic.Value == null)
                throw new ArgumentNullException(nameof(bic), "Property is not nullable for class SGLocalAccountIdentification.");

            if (type.IsSet && type.Value == null)
                throw new ArgumentNullException(nameof(type), "Property is not nullable for class SGLocalAccountIdentification.");
        ...
        public void WriteProperties(Utf8JsonWriter writer, SGLocalAccountIdentification sGLocalAccountIdentification, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (sGLocalAccountIdentification.AccountNumber == null)
                throw new ArgumentNullException(nameof(sGLocalAccountIdentification.AccountNumber), "Property is required for class SGLocalAccountIdentification.");

            if (sGLocalAccountIdentification.Bic == null)
                throw new ArgumentNullException(nameof(sGLocalAccountIdentification.Bic), "Property is required for class SGLocalAccountIdentification.");
