...
namespace Adyen.LegalEntityManagement.Models
{
    ...
    /// BusinessLines.
    /// </summary>
    public partial class BusinessLines : IValidatableObject
    {
        /// <summary>
    ...
    /// <summary>
    /// A Json converter for type <see cref="BusinessLines" />
    /// </summary>
    public class BusinessLinesJsonConverter : JsonConverter<BusinessLines>
    {
        /// <summary>
        /// Deserializes json to <see cref="BusinessLines"/>.
        /// </summary>
        ...
        public override BusinessLines Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            Option<List<BusinessLine>?> varBusinessLines = default;
            ...
            while (utf8JsonReader.Read())
            {
                ...
                if (utf8JsonReader.TokenType == JsonTokenType.PropertyName && currentDepth == utf8JsonReader.CurrentDepth - 1)
                {
                    ...
                    {
                        case "businessLines":
                            varBusinessLines = new Option<List<BusinessLine>?>(JsonSerializer.Deserialize<List<BusinessLine>>(ref utf8JsonReader, jsonSerializerOptions)!);
                            break;
                        default:
                            break;
                    }
            ...
            if (varBusinessLines.IsSet && varBusinessLines.Value == null)
                throw new ArgumentNullException(nameof(varBusinessLines), "Property is not nullable for class BusinessLines.");

            return new BusinessLines(varBusinessLines.Value!);
        }

        /// <summary>
        /// Serializes a <see cref="BusinessLines"/>.
        /// </summary>
        /// <param name="writer"><see cref="Utf8JsonWriter"/></param>
        /// <param name="businessLines"></param>
        /// <param name="jsonSerializerOptions"><see cref="JsonSerializerOptions"/></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, BusinessLines businessLines, JsonSerializerOptions jsonSerializerOptions)
        {
            
            writer.WriteStartObject();
            
            WriteProperties(writer, businessLines, jsonSerializerOptions);
        ...
        /// <summary>
        /// Serializes the properties of <see cref="BusinessLines"/>.
        /// </summary>
        /// <param name="writer"><see creft="Utf8JsonWriter"/></param>
        /// <param name="businessLines"></param>
        /// <param name="jsonSerializerOptions"><see cref="JsonSerializerOptions"/></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, BusinessLines businessLines, JsonSerializerOptions jsonSerializerOptions)
        {
            /*
            if (businessLines.VarBusinessLines == null)
                throw new ArgumentNullException(nameof(businessLines.VarBusinessLines), "Property is required for class BusinessLines.");

            */
            
            writer.WritePropertyName("businessLines");
            JsonSerializer.Serialize(writer, businessLines.VarBusinessLines, jsonSerializerOptions);
        }
    }
}
