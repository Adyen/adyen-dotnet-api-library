    ...
    public class USLocalAccountIdentificationJsonConverter : JsonConverter<USLocalAccountIdentification>
    {
        ...
        public override USLocalAccountIdentification Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (accountNumber.IsSet && accountNumber.Value == null)
                throw new ArgumentNullException(nameof(accountNumber), "Property is not nullable for class USLocalAccountIdentification.");

            if (routingNumber.IsSet && routingNumber.Value == null)
                throw new ArgumentNullException(nameof(routingNumber), "Property is not nullable for class USLocalAccountIdentification.");

            if (accountType.IsSet && accountType.Value == null)
                throw new ArgumentNullException(nameof(accountType), "Property is not nullable for class USLocalAccountIdentification.");

            if (type.IsSet && type.Value == null)
                throw new ArgumentNullException(nameof(type), "Property is not nullable for class USLocalAccountIdentification.");
        ...
        public void WriteProperties(Utf8JsonWriter writer, USLocalAccountIdentification uSLocalAccountIdentification, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (uSLocalAccountIdentification.AccountNumber == null)
                throw new ArgumentNullException(nameof(uSLocalAccountIdentification.AccountNumber), "Property is required for class USLocalAccountIdentification.");

            if (uSLocalAccountIdentification.RoutingNumber == null)
                throw new ArgumentNullException(nameof(uSLocalAccountIdentification.RoutingNumber), "Property is required for class USLocalAccountIdentification.");
