    ...
    public class NameJsonConverter : JsonConverter<Name>
    {
        ...
        public override Name Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (infix.IsSet && infix.Value == null)
                throw new ArgumentNullException(nameof(infix), "Property is not nullable for class Name.");
        ...
        public void WriteProperties(Utf8JsonWriter writer, Name name, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (name._InfixOption.IsSet && name.Infix == null)
                throw new ArgumentNullException(nameof(name.Infix), "Property is required for class Name.");
            ...
            */
            ...
            if (name._InfixOption.IsSet)
                writer.WriteString("infix", name.Infix);
        }
    }
}
