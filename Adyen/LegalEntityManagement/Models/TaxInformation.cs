...
namespace Adyen.LegalEntityManagement.Models
{
    ...
    public partial class TaxInformation : IValidatableObject
    {
        ...
        [JsonConstructor]
        public TaxInformation(Option<string?> country = default, Option<string?> number = default, Option<string?> type = default)
        {
    ...
    public class TaxInformationJsonConverter : JsonConverter<TaxInformation>
    {
        ...
        public override TaxInformation Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (country.IsSet && country.Value == null)
                throw new ArgumentNullException(nameof(country), "Property is not nullable for class TaxInformation.");

            if (number.IsSet && number.Value == null)
                throw new ArgumentNullException(nameof(number), "Property is not nullable for class TaxInformation.");

            if (type.IsSet && type.Value == null)
                throw new ArgumentNullException(nameof(type), "Property is not nullable for class TaxInformation.");

            return new TaxInformation(country, number, type);
        }
        ...
        {
            /*
            if (taxInformation._CountryOption.IsSet && taxInformation.Country == null)
                throw new ArgumentNullException(nameof(taxInformation.Country), "Property is required for class TaxInformation.");

            if (taxInformation._NumberOption.IsSet && taxInformation.Number == null)
                throw new ArgumentNullException(nameof(taxInformation.Number), "Property is required for class TaxInformation.");

            if (taxInformation._TypeOption.IsSet && taxInformation.Type == null)
                throw new ArgumentNullException(nameof(taxInformation.Type), "Property is required for class TaxInformation.");
