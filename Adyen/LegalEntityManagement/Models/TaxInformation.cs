...
namespace Adyen.LegalEntityManagement.Models
{
    ...
    /// TaxInformation.
    /// </summary>
    [JsonConverter(typeof(TaxInformationJsonConverter))]
    public partial class TaxInformation
    {
        ...
        /// <summary>
        /// This is used to track if an optional field is set. If set, <see cref="NumberAbsent"/> will be populated.
        /// </summary>
        [JsonIgnore]
        [global::System.ComponentModel.EditorBrowsable(global::System.ComponentModel.EditorBrowsableState.Never)]
    ...
    public class TaxInformationJsonConverter : JsonConverter<TaxInformation>
    {
        ...
        public override TaxInformation Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (number.IsSet)
                taxInformation.Number = number.Value;
            if (numberAbsent.IsSet)
                taxInformation.NumberAbsent = numberAbsent.Value;
            if (type.IsSet)
                taxInformation.Type = type.Value;
