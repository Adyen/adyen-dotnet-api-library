    ...
    public class AULocalAccountIdentificationJsonConverter : JsonConverter<AULocalAccountIdentification>
    {
        ...
        public override AULocalAccountIdentification Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (accountNumber.IsSet && accountNumber.Value == null)
                throw new ArgumentNullException(nameof(accountNumber), "Property is not nullable for class AULocalAccountIdentification.");

            if (bsbCode.IsSet && bsbCode.Value == null)
                throw new ArgumentNullException(nameof(bsbCode), "Property is not nullable for class AULocalAccountIdentification.");

            if (type.IsSet && type.Value == null)
                throw new ArgumentNullException(nameof(type), "Property is not nullable for class AULocalAccountIdentification.");
        ...
        public void WriteProperties(Utf8JsonWriter writer, AULocalAccountIdentification aULocalAccountIdentification, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (aULocalAccountIdentification.AccountNumber == null)
                throw new ArgumentNullException(nameof(aULocalAccountIdentification.AccountNumber), "Property is required for class AULocalAccountIdentification.");

            if (aULocalAccountIdentification.BsbCode == null)
                throw new ArgumentNullException(nameof(aULocalAccountIdentification.BsbCode), "Property is required for class AULocalAccountIdentification.");
