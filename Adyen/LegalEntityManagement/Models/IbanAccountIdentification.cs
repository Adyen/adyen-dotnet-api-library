    ...
    public class IbanAccountIdentificationJsonConverter : JsonConverter<IbanAccountIdentification>
    {
        ...
        public override IbanAccountIdentification Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (iban.IsSet && iban.Value == null)
                throw new ArgumentNullException(nameof(iban), "Property is not nullable for class IbanAccountIdentification.");

            if (type.IsSet && type.Value == null)
                throw new ArgumentNullException(nameof(type), "Property is not nullable for class IbanAccountIdentification.");
        ...
        public void WriteProperties(Utf8JsonWriter writer, IbanAccountIdentification ibanAccountIdentification, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (ibanAccountIdentification.Iban == null)
                throw new ArgumentNullException(nameof(ibanAccountIdentification.Iban), "Property is required for class IbanAccountIdentification.");
