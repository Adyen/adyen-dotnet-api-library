...
namespace Adyen.LegalEntityManagement.Models
{
    ...
    /// </summary>
    [JsonConverter(typeof(SetTaxElectronicDeliveryConsentRequestJsonConverter))]
    ...
    public class SetTaxElectronicDeliveryConsentRequestJsonConverter : JsonConverter<SetTaxElectronicDeliveryConsentRequest>
    {
        ...
        public override SetTaxElectronicDeliveryConsentRequest Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            var setTaxElectronicDeliveryConsentRequest = new SetTaxElectronicDeliveryConsentRequest();
            if (uS1099k.IsSet)
                setTaxElectronicDeliveryConsentRequest.US1099k = uS1099k.Value;
            return setTaxElectronicDeliveryConsentRequest;
        }
