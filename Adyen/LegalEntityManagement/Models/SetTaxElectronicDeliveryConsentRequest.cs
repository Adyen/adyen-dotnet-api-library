...
namespace Adyen.LegalEntityManagement.Models
{
    ...
    public partial class SetTaxElectronicDeliveryConsentRequest : IValidatableObject
    {
        ...
        [JsonConstructor]
        public SetTaxElectronicDeliveryConsentRequest(Option<bool?> uS1099k = default)
        {
    ...
    /// <summary>
    /// A Json converter for type <see cref="SetTaxElectronicDeliveryConsentRequest" />
    /// </summary>
    public class SetTaxElectronicDeliveryConsentRequestJsonConverter : JsonConverter<SetTaxElectronicDeliveryConsentRequest>
    {
        /// <summary>
        /// Deserializes json to <see cref="SetTaxElectronicDeliveryConsentRequest"/>.
        /// </summary>
        /// <param name="utf8JsonReader"><see cref="Utf8JsonReader"/></param>
        /// <param name="typeToConvert"><see cref="Type"/></param>
        /// <param name="jsonSerializerOptions">The <see cref="JsonSerializerOptions"/>, initialized from <see cref="HostConfiguration"/>.</param>
        /// <returns><see cref="SetTaxElectronicDeliveryConsentRequest"/></returns>
        /// <exception cref="JsonException"></exception>
        public override SetTaxElectronicDeliveryConsentRequest Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (uS1099k.IsSet && uS1099k.Value == null)
                throw new ArgumentNullException(nameof(uS1099k), "Property is not nullable for class SetTaxElectronicDeliveryConsentRequest.");

            return new SetTaxElectronicDeliveryConsentRequest(uS1099k);
        }

        /// <summary>
        /// Serializes a <see cref="SetTaxElectronicDeliveryConsentRequest"/>.
        /// </summary>
        /// <param name="writer"><see cref="Utf8JsonWriter"/></param>
        /// <param name="setTaxElectronicDeliveryConsentRequest"></param>
        /// <param name="jsonSerializerOptions"><see cref="JsonSerializerOptions"/></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, SetTaxElectronicDeliveryConsentRequest setTaxElectronicDeliveryConsentRequest, JsonSerializerOptions jsonSerializerOptions)
        {
            
            writer.WriteStartObject();
            
            WriteProperties(writer, setTaxElectronicDeliveryConsentRequest, jsonSerializerOptions);
        ...
        /// <summary>
        /// Serializes the properties of <see cref="SetTaxElectronicDeliveryConsentRequest"/>.
        /// </summary>
        /// <param name="writer"><see creft="Utf8JsonWriter"/></param>
        /// <param name="setTaxElectronicDeliveryConsentRequest"></param>
        /// <param name="jsonSerializerOptions"><see cref="JsonSerializerOptions"/></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, SetTaxElectronicDeliveryConsentRequest setTaxElectronicDeliveryConsentRequest, JsonSerializerOptions jsonSerializerOptions)
        {
            /*
            */
