    ...
    public class OnboardingLinkJsonConverter : JsonConverter<OnboardingLink>
    {
        ...
        public override OnboardingLink Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (url.IsSet && url.Value == null)
                throw new ArgumentNullException(nameof(url), "Property is not nullable for class OnboardingLink.");
        ...
        {
            /*
            if (onboardingLink._UrlOption.IsSet && onboardingLink.Url == null)
                throw new ArgumentNullException(nameof(onboardingLink.Url), "Property is required for class OnboardingLink.");
