...
namespace Adyen.LegalEntityManagement.Models
{
    ...
    /// BirthData.
    /// </summary>
    public partial class BirthData : IValidatableObject
    {
        /// <summary>
    ...
    public class BirthDataJsonConverter : JsonConverter<BirthData>
    {
        ...
        public override BirthData Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (dateOfBirth.IsSet && dateOfBirth.Value == null)
                throw new ArgumentNullException(nameof(dateOfBirth), "Property is not nullable for class BirthData.");

            return new BirthData(dateOfBirth);
        }
        ...
        {
            /*
            if (birthData._DateOfBirthOption.IsSet && birthData.DateOfBirth == null)
                throw new ArgumentNullException(nameof(birthData.DateOfBirth), "Property is required for class BirthData.");
