...
namespace Adyen.LegalEntityManagement.Models
{
    ...
    /// </summary>
    public partial class CheckTaxElectronicDeliveryConsentResponse : IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Used to track the state of US1099k
        /// </summary>
        [JsonIgnore]
    ...
    public class CheckTaxElectronicDeliveryConsentResponseJsonConverter : JsonConverter<CheckTaxElectronicDeliveryConsentResponse>
    {
        ...
        public override CheckTaxElectronicDeliveryConsentResponse Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (uS1099k.IsSet && uS1099k.Value == null)
                throw new ArgumentNullException(nameof(uS1099k), "Property is not nullable for class CheckTaxElectronicDeliveryConsentResponse.");

            return new CheckTaxElectronicDeliveryConsentResponse(uS1099k);
        }
