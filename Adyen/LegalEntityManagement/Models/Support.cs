...
namespace Adyen.LegalEntityManagement.Models
{
    ...
    /// <summary>
    /// A Json converter for type <see cref="Support" />
    /// </summary>
    public class SupportJsonConverter : JsonConverter<Support>
    {
        /// <summary>
        /// Deserializes json to <see cref="Support"/>.
        /// </summary>
        /// <param name="utf8JsonReader"><see cref="Utf8JsonReader"/>.</param>
        /// <param name="typeToConvert"><see cref="Type"/>.</param>
        /// <param name="jsonSerializerOptions">The <see cref="JsonSerializerOptions"/>, initialized from <see cref="HostConfiguration"/>.</param>
        /// <returns><see cref="Support"/>.</returns>
        /// <exception cref="JsonException"></exception>
        public override Support Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (phone.IsSet)
                support.Phone = phone.Value;
            return support;
        }

        /// <summary>
        /// Serializes a <see cref="Support"/>.
        /// </summary>
        /// <param name="writer"><see cref="Utf8JsonWriter"/></param>
        /// <param name="support"></param>
        /// <param name="jsonSerializerOptions"><see cref="JsonSerializerOptions"/></param>
        public override void Write(Utf8JsonWriter writer, Support support, JsonSerializerOptions jsonSerializerOptions)
        {
            
            writer.WriteStartObject();
            
            WriteProperties(writer, support, jsonSerializerOptions);
        ...
        /// <summary>
        /// Serializes the properties of <see cref="Support"/>.
        /// </summary>
        /// <param name="writer"><see cref="Utf8JsonWriter"/></param>
        /// <param name="support"></param>
        /// <param name="jsonSerializerOptions"><see cref="JsonSerializerOptions"/></param>
        public void WriteProperties(Utf8JsonWriter writer, Support support, JsonSerializerOptions jsonSerializerOptions)
        {
            
            if (support._EmailOption.IsSet)
                if (support.Email != null)
                    writer.WriteString("email", support.Email);

            if (support._PhoneOption.IsSet)
            {
                writer.WritePropertyName("phone");
                JsonSerializer.Serialize(writer, support.Phone, jsonSerializerOptions);
            }
        }
    }
}
