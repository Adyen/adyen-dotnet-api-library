...
namespace Adyen.LegalEntityManagement.Models
{
    ...
    /// </summary>
    [JsonConverter(typeof(TransferInstrumentInfoJsonConverter))]
    public partial class TransferInstrumentInfo
    {
        /// <summary>
                ...
                if (utf8JsonReader.TokenType == JsonTokenType.PropertyName && currentDepth == utf8JsonReader.CurrentDepth - 1)
                {
                    ...
                    switch (jsonPropertyName)
                    {
                        ...
                        case "type":
                            ...
                            type = new Option<TransferInstrumentInfo.TypeEnum?>(TransferInstrumentInfo.TypeEnum.FromStringOrDefault(typeRawValue) ?? (TransferInstrumentInfo.TypeEnum)typeRawValue);
                            break;
                        default:
                            break;
                    }
