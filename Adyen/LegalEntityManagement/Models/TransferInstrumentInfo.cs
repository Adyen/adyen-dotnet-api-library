    ...
    public class TransferInstrumentInfoJsonConverter : JsonConverter<TransferInstrumentInfo>
    {
        ...
        public override TransferInstrumentInfo Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (bankAccount.IsSet && bankAccount.Value == null)
                throw new ArgumentNullException(nameof(bankAccount), "Property is not nullable for class TransferInstrumentInfo.");

            if (legalEntityId.IsSet && legalEntityId.Value == null)
                throw new ArgumentNullException(nameof(legalEntityId), "Property is not nullable for class TransferInstrumentInfo.");

            if (type.IsSet && type.Value == null)
                throw new ArgumentNullException(nameof(type), "Property is not nullable for class TransferInstrumentInfo.");
        ...
        {
            /*
            if (transferInstrumentInfo.BankAccount == null)
                throw new ArgumentNullException(nameof(transferInstrumentInfo.BankAccount), "Property is required for class TransferInstrumentInfo.");

            if (transferInstrumentInfo.LegalEntityId == null)
                throw new ArgumentNullException(nameof(transferInstrumentInfo.LegalEntityId), "Property is required for class TransferInstrumentInfo.");
