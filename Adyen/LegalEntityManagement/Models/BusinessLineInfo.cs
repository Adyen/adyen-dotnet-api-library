...
namespace Adyen.LegalEntityManagement.Models
{
    ...
    /// BusinessLineInfo.
    /// </summary>
    [JsonConverter(typeof(BusinessLineInfoJsonConverter))]
    public partial class BusinessLineInfo
    {
        /// <summary>
    ...
    public class BusinessLineInfoJsonConverter : JsonConverter<BusinessLineInfo>
    {
        ...
        public override BusinessLineInfo Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (salesChannels.IsSet)
                businessLineInfo.SalesChannels = salesChannels.Value;
            if (sourceOfFunds.IsSet)
                businessLineInfo.SourceOfFunds = sourceOfFunds.Value;
            if (webData.IsSet)
                businessLineInfo.WebData = webData.Value;
            if (webDataExemption.IsSet)
                businessLineInfo.WebDataExemption = webDataExemption.Value;
            return businessLineInfo;
        }
