    ...
    public class AcceptTermsOfServiceRequestJsonConverter : JsonConverter<AcceptTermsOfServiceRequest>
    {
        ...
        public override AcceptTermsOfServiceRequest Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (acceptedBy.IsSet && acceptedBy.Value == null)
                throw new ArgumentNullException(nameof(acceptedBy), "Property is not nullable for class AcceptTermsOfServiceRequest.");

            if (ipAddress.IsSet && ipAddress.Value == null)
                throw new ArgumentNullException(nameof(ipAddress), "Property is not nullable for class AcceptTermsOfServiceRequest.");
        ...
        public void WriteProperties(Utf8JsonWriter writer, AcceptTermsOfServiceRequest acceptTermsOfServiceRequest, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (acceptTermsOfServiceRequest.AcceptedBy == null)
                throw new ArgumentNullException(nameof(acceptTermsOfServiceRequest.AcceptedBy), "Property is required for class AcceptTermsOfServiceRequest.");

            if (acceptTermsOfServiceRequest._IpAddressOption.IsSet && acceptTermsOfServiceRequest.IpAddress == null)
                throw new ArgumentNullException(nameof(acceptTermsOfServiceRequest.IpAddress), "Property is required for class AcceptTermsOfServiceRequest.");
