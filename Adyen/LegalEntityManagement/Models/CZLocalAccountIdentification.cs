    ...
    public class CZLocalAccountIdentificationJsonConverter : JsonConverter<CZLocalAccountIdentification>
    {
        ...
        public override CZLocalAccountIdentification Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (accountNumber.IsSet && accountNumber.Value == null)
                throw new ArgumentNullException(nameof(accountNumber), "Property is not nullable for class CZLocalAccountIdentification.");

            if (bankCode.IsSet && bankCode.Value == null)
                throw new ArgumentNullException(nameof(bankCode), "Property is not nullable for class CZLocalAccountIdentification.");

            if (type.IsSet && type.Value == null)
                throw new ArgumentNullException(nameof(type), "Property is not nullable for class CZLocalAccountIdentification.");
        ...
        public void WriteProperties(Utf8JsonWriter writer, CZLocalAccountIdentification cZLocalAccountIdentification, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (cZLocalAccountIdentification.AccountNumber == null)
                throw new ArgumentNullException(nameof(cZLocalAccountIdentification.AccountNumber), "Property is required for class CZLocalAccountIdentification.");

            if (cZLocalAccountIdentification.BankCode == null)
                throw new ArgumentNullException(nameof(cZLocalAccountIdentification.BankCode), "Property is required for class CZLocalAccountIdentification.");
