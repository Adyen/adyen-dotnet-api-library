...
namespace Adyen.LegalEntityManagement.Models
{
    ...
    public class GeneratePciDescriptionResponseJsonConverter : JsonConverter<GeneratePciDescriptionResponse>
    {
        ...
        public override GeneratePciDescriptionResponse Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            var generatePciDescriptionResponse = new GeneratePciDescriptionResponse();
            if (content.IsSet)
                generatePciDescriptionResponse.Content = content.Value;
            if (language.IsSet)
                generatePciDescriptionResponse.Language = language.Value;
            if (pciTemplateReferences.IsSet)
                generatePciDescriptionResponse.PciTemplateReferences = pciTemplateReferences.Value;
