...
namespace Adyen.LegalEntityManagement.Models
{
    ...
    /// </summary>
    [JsonConverter(typeof(AcceptTermsOfServiceResponseJsonConverter))]
    ...
    public class AcceptTermsOfServiceResponseJsonConverter : JsonConverter<AcceptTermsOfServiceResponse>
    {
        ...
        public override AcceptTermsOfServiceResponse Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (id.IsSet)
                acceptTermsOfServiceResponse.Id = id.Value;
            if (ipAddress.IsSet)
                acceptTermsOfServiceResponse.IpAddress = ipAddress.Value;
            if (language.IsSet)
                acceptTermsOfServiceResponse.Language = language.Value;
            if (termsOfServiceDocumentId.IsSet)
                acceptTermsOfServiceResponse.TermsOfServiceDocumentId = termsOfServiceDocumentId.Value;
            if (type.IsSet)
                acceptTermsOfServiceResponse.Type = type.Value;
