...
namespace Adyen.LegalEntityManagement.Models
{
    ...
    /// </summary>
    public partial class AcceptTermsOfServiceResponse : IValidatableObject
    {
        /// <summary>
    ...
    public class AcceptTermsOfServiceResponseJsonConverter : JsonConverter<AcceptTermsOfServiceResponse>
    {
        ...
        public override AcceptTermsOfServiceResponse Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (acceptedBy.IsSet && acceptedBy.Value == null)
                throw new ArgumentNullException(nameof(acceptedBy), "Property is not nullable for class AcceptTermsOfServiceResponse.");

            if (id.IsSet && id.Value == null)
                throw new ArgumentNullException(nameof(id), "Property is not nullable for class AcceptTermsOfServiceResponse.");

            if (ipAddress.IsSet && ipAddress.Value == null)
                throw new ArgumentNullException(nameof(ipAddress), "Property is not nullable for class AcceptTermsOfServiceResponse.");

            if (language.IsSet && language.Value == null)
                throw new ArgumentNullException(nameof(language), "Property is not nullable for class AcceptTermsOfServiceResponse.");

            if (termsOfServiceDocumentId.IsSet && termsOfServiceDocumentId.Value == null)
                throw new ArgumentNullException(nameof(termsOfServiceDocumentId), "Property is not nullable for class AcceptTermsOfServiceResponse.");

            if (type.IsSet && type.Value == null)
                throw new ArgumentNullException(nameof(type), "Property is not nullable for class AcceptTermsOfServiceResponse.");
        ...
        {
            /*
            if (acceptTermsOfServiceResponse._AcceptedByOption.IsSet && acceptTermsOfServiceResponse.AcceptedBy == null)
                throw new ArgumentNullException(nameof(acceptTermsOfServiceResponse.AcceptedBy), "Property is required for class AcceptTermsOfServiceResponse.");

            if (acceptTermsOfServiceResponse._IdOption.IsSet && acceptTermsOfServiceResponse.Id == null)
                throw new ArgumentNullException(nameof(acceptTermsOfServiceResponse.Id), "Property is required for class AcceptTermsOfServiceResponse.");

            if (acceptTermsOfServiceResponse._IpAddressOption.IsSet && acceptTermsOfServiceResponse.IpAddress == null)
                throw new ArgumentNullException(nameof(acceptTermsOfServiceResponse.IpAddress), "Property is required for class AcceptTermsOfServiceResponse.");

            if (acceptTermsOfServiceResponse._LanguageOption.IsSet && acceptTermsOfServiceResponse.Language == null)
                throw new ArgumentNullException(nameof(acceptTermsOfServiceResponse.Language), "Property is required for class AcceptTermsOfServiceResponse.");

            if (acceptTermsOfServiceResponse._TermsOfServiceDocumentIdOption.IsSet && acceptTermsOfServiceResponse.TermsOfServiceDocumentId == null)
                throw new ArgumentNullException(nameof(acceptTermsOfServiceResponse.TermsOfServiceDocumentId), "Property is required for class AcceptTermsOfServiceResponse.");
