    ...
    public class RemediatingActionJsonConverter : JsonConverter<RemediatingAction>
    {
        ...
        public override RemediatingAction Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (code.IsSet && code.Value == null)
                throw new ArgumentNullException(nameof(code), "Property is not nullable for class RemediatingAction.");

            if (message.IsSet && message.Value == null)
                throw new ArgumentNullException(nameof(message), "Property is not nullable for class RemediatingAction.");
        ...
        {
            /*
            if (remediatingAction._CodeOption.IsSet && remediatingAction.Code == null)
                throw new ArgumentNullException(nameof(remediatingAction.Code), "Property is required for class RemediatingAction.");

            if (remediatingAction._MessageOption.IsSet && remediatingAction.Message == null)
                throw new ArgumentNullException(nameof(remediatingAction.Message), "Property is required for class RemediatingAction.");
