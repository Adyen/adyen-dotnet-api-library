...
namespace Adyen.LegalEntityManagement.Models
{
    ...
    /// <summary>
    /// A Json converter for type <see cref="NOLocalAccountIdentification" />
    /// </summary>
    public class NOLocalAccountIdentificationJsonConverter : JsonConverter<NOLocalAccountIdentification>
    {
        /// <summary>
        /// Deserializes json to <see cref="NOLocalAccountIdentification"/>.
        /// </summary>
        /// <param name="utf8JsonReader"><see cref="Utf8JsonReader"/></param>
        /// <param name="typeToConvert"><see cref="Type"/></param>
        /// <param name="jsonSerializerOptions">The <see cref="JsonSerializerOptions"/>, initialized from <see cref="HostConfiguration"/>.</param>
        /// <returns><see cref="NOLocalAccountIdentification"/></returns>
        /// <exception cref="JsonException"></exception>
        public override NOLocalAccountIdentification Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            Option<NOLocalAccountIdentification.TypeEnum?> type = default;
                ...
                if (utf8JsonReader.TokenType == JsonTokenType.PropertyName && currentDepth == utf8JsonReader.CurrentDepth - 1)
                {
                    ...
                    switch (jsonPropertyName)
                    {
                        ...
                        case "type":
                            ...
                            type = new Option<NOLocalAccountIdentification.TypeEnum?>(NOLocalAccountIdentification.TypeEnum.FromStringOrDefault(typeRawValue));
                            break;
                        default:
                            break;
                    }
            ...
            if (accountNumber.IsSet && accountNumber.Value == null)
                throw new ArgumentNullException(nameof(accountNumber), "Property is not nullable for class NOLocalAccountIdentification.");

            if (type.IsSet && type.Value == null)
                throw new ArgumentNullException(nameof(type), "Property is not nullable for class NOLocalAccountIdentification.");

            return new NOLocalAccountIdentification(accountNumber.Value!, type.Value!.Value!);
        }

        /// <summary>
        /// Serializes a <see cref="NOLocalAccountIdentification"/>.
        /// </summary>
        ...
        public override void Write(Utf8JsonWriter writer, NOLocalAccountIdentification nOLocalAccountIdentification, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            WriteProperties(writer, nOLocalAccountIdentification, jsonSerializerOptions);
        ...
        /// <summary>
        /// Serializes the properties of <see cref="NOLocalAccountIdentification"/>.
        /// </summary>
        ...
        {
            /*
            if (nOLocalAccountIdentification.AccountNumber == null)
                throw new ArgumentNullException(nameof(nOLocalAccountIdentification.AccountNumber), "Property is required for class NOLocalAccountIdentification.");

            */
            
            writer.WriteString("accountNumber", nOLocalAccountIdentification.AccountNumber);

            if (nOLocalAccountIdentification.Type != null) 
            {
                string? typeRawValue = NOLocalAccountIdentification.TypeEnum.ToJsonValue(nOLocalAccountIdentification.Type);
