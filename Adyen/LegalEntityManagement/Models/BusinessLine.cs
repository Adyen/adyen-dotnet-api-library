...
namespace Adyen.LegalEntityManagement.Models
{
    ...
    public partial class BusinessLine
    {
        ...
        public BusinessLine(string id, string industryCode, string legalEntityId, ServiceEnum service, Option<string?> industryCodeDescription = default, Option<List<CapabilityProblem>?> problems = default, Option<List<string>?> salesChannels = default, Option<SourceOfFunds?> sourceOfFunds = default, Option<List<WebData>?> webData = default, Option<WebDataExemption?> webDataExemption = default)
        {
            Id = id;
        ...
        public class ServiceEnum : IEnum
        {
            ...
            /// <summary>
            /// Compares two <see cref="ServiceEnum"/> instances for equality.
            /// </summary>
            ...
            /// <summary>
            /// Compares two <see cref="ServiceEnum"/> instances for inequality.
            /// </summary>
            public static bool operator !=(ServiceEnum? left, ServiceEnum? right) => !string.Equals(left?.Value, right?.Value, StringComparison.OrdinalIgnoreCase);

            /// <summary>
            /// Returns true if the given object is equal to this <see cref="ServiceEnum"/> instance.
            /// </summary>
            ...
            /// <summary>
            /// Returns a hash code for this <see cref="ServiceEnum"/> instance.
            /// </summary>
            public override int GetHashCode() => Value?.GetHashCode() ?? 0;

            /// <summary>
            /// Returns the string value of the <see cref="ServiceEnum"/> instance.
            /// </summary>
            ...
            {
                /// <summary>
                /// Deserializes a <see cref="ServiceEnum"/> from JSON.
                /// </summary>
                ...
                /// <summary>
                /// Serializes a <see cref="ServiceEnum"/> to JSON.
                /// </summary>
    ...
    public class BusinessLineJsonConverter : JsonConverter<BusinessLine>
    {
        ...
        public override BusinessLine Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            return new BusinessLine(id.Value!, industryCode.Value!, legalEntityId.Value!, service.Value!.Value!, industryCodeDescription, problems, salesChannels, sourceOfFunds, webData, webDataExemption);
        }
        ...
        public void WriteProperties(Utf8JsonWriter writer, BusinessLine businessLine, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (businessLine._IndustryCodeDescriptionOption.IsSet)
                if (businessLine.IndustryCodeDescription != null)
                    writer.WriteString("industryCodeDescription", businessLine.IndustryCodeDescription);
