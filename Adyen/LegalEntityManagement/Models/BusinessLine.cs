...
namespace Adyen.LegalEntityManagement.Models
{
    ...
    /// BusinessLine.
    /// </summary>
    [JsonConverter(typeof(BusinessLineJsonConverter))]
    ...
    public class BusinessLineJsonConverter : JsonConverter<BusinessLine>
    {
        ...
        public override BusinessLine Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (problems.IsSet)
                businessLine.Problems = problems.Value;
            if (salesChannels.IsSet)
                businessLine.SalesChannels = salesChannels.Value;
            if (sourceOfFunds.IsSet)
                businessLine.SourceOfFunds = sourceOfFunds.Value;
            if (webData.IsSet)
                businessLine.WebData = webData.Value;
            if (webDataExemption.IsSet)
                businessLine.WebDataExemption = webDataExemption.Value;
            return businessLine;
        }
