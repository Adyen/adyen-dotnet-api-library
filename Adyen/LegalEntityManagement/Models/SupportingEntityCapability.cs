    ...
    public class SupportingEntityCapabilityJsonConverter : JsonConverter<SupportingEntityCapability>
    {
        ...
        public override SupportingEntityCapability Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (allowed.IsSet && allowed.Value == null)
                throw new ArgumentNullException(nameof(allowed), "Property is not nullable for class SupportingEntityCapability.");

            if (id.IsSet && id.Value == null)
                throw new ArgumentNullException(nameof(id), "Property is not nullable for class SupportingEntityCapability.");

            if (requested.IsSet && requested.Value == null)
                throw new ArgumentNullException(nameof(requested), "Property is not nullable for class SupportingEntityCapability.");

            if (verificationStatus.IsSet && verificationStatus.Value == null)
                throw new ArgumentNullException(nameof(verificationStatus), "Property is not nullable for class SupportingEntityCapability.");
        ...
        {
            /*
            if (supportingEntityCapability._IdOption.IsSet && supportingEntityCapability.Id == null)
                throw new ArgumentNullException(nameof(supportingEntityCapability.Id), "Property is required for class SupportingEntityCapability.");

            if (supportingEntityCapability._VerificationStatusOption.IsSet && supportingEntityCapability.VerificationStatus == null)
                throw new ArgumentNullException(nameof(supportingEntityCapability.VerificationStatus), "Property is required for class SupportingEntityCapability.");
