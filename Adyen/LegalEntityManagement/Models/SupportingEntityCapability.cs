...
namespace Adyen.LegalEntityManagement.Models
{
    ...
    /// </summary>
    [JsonConverter(typeof(SupportingEntityCapabilityJsonConverter))]
    ...
    public class SupportingEntityCapabilityJsonConverter : JsonConverter<SupportingEntityCapability>
    {
        ...
        public override SupportingEntityCapability Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (id.IsSet)
                supportingEntityCapability.Id = id.Value;
            if (requested.IsSet)
                supportingEntityCapability.Requested = requested.Value;
            if (verificationStatus.IsSet)
                supportingEntityCapability.VerificationStatus = verificationStatus.Value;
            return supportingEntityCapability;
        }
