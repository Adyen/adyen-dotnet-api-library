...
namespace Adyen.LegalEntityManagement.Models
{
    ...
    public class AddressJsonConverter : JsonConverter<Address>
    {
        ...
        public override Address Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (street2.IsSet && street2.Value == null)
                throw new ArgumentNullException(nameof(street2), "Property is not nullable for class Address.");
        ...
        public void WriteProperties(Utf8JsonWriter writer, Address address, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (address._StreetOption.IsSet && address.Street == null)
                throw new ArgumentNullException(nameof(address.Street), "Property is required for class Address.");

            if (address._Street2Option.IsSet && address.Street2 == null)
                throw new ArgumentNullException(nameof(address.Street2), "Property is required for class Address.");
