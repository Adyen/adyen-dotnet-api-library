    ...
    public class CapabilityProblemJsonConverter : JsonConverter<CapabilityProblem>
    {
        ...
        public override CapabilityProblem Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (entity.IsSet && entity.Value == null)
                throw new ArgumentNullException(nameof(entity), "Property is not nullable for class CapabilityProblem.");

            if (verificationErrors.IsSet && verificationErrors.Value == null)
                throw new ArgumentNullException(nameof(verificationErrors), "Property is not nullable for class CapabilityProblem.");
        ...
        {
            /*
            if (capabilityProblem._EntityOption.IsSet && capabilityProblem.Entity == null)
                throw new ArgumentNullException(nameof(capabilityProblem.Entity), "Property is required for class CapabilityProblem.");

            if (capabilityProblem._VerificationErrorsOption.IsSet && capabilityProblem.VerificationErrors == null)
                throw new ArgumentNullException(nameof(capabilityProblem.VerificationErrors), "Property is required for class CapabilityProblem.");
