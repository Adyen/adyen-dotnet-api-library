...
namespace Adyen.LegalEntityManagement.Models
{
    ...
    /// </summary>
    [JsonConverter(typeof(GetPciQuestionnaireInfosResponseJsonConverter))]
    ...
    public class GetPciQuestionnaireInfosResponseJsonConverter : JsonConverter<GetPciQuestionnaireInfosResponse>
    {
        ...
        public override GetPciQuestionnaireInfosResponse Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            var getPciQuestionnaireInfosResponse = new GetPciQuestionnaireInfosResponse();
            if (data.IsSet)
                getPciQuestionnaireInfosResponse.Data = data.Value;
