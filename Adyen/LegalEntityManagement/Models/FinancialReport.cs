...
namespace Adyen.LegalEntityManagement.Models
{
    ...
    public class FinancialReportJsonConverter : JsonConverter<FinancialReport>
    {
        ...
        public override FinancialReport Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (balanceSheetTotal.IsSet)
                financialReport.BalanceSheetTotal = balanceSheetTotal.Value;
            if (currencyOfFinancialData.IsSet)
                financialReport.CurrencyOfFinancialData = currencyOfFinancialData.Value;
            if (dateOfFinancialData.IsSet)
                financialReport.DateOfFinancialData = dateOfFinancialData.Value;
            if (employeeCount.IsSet)
                financialReport.EmployeeCount = employeeCount.Value;
            if (netAssets.IsSet)
                financialReport.NetAssets = netAssets.Value;
