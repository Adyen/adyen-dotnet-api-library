...
namespace Adyen.LegalEntityManagement.Models
{
    ...
    /// </summary>
    [JsonConverter(typeof(BusinessLineInfoUpdateJsonConverter))]
    ...
    public class BusinessLineInfoUpdateJsonConverter : JsonConverter<BusinessLineInfoUpdate>
    {
        ...
        public override BusinessLineInfoUpdate Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (industryCodeDescription.IsSet)
                businessLineInfoUpdate.IndustryCodeDescription = industryCodeDescription.Value;
            if (salesChannels.IsSet)
                businessLineInfoUpdate.SalesChannels = salesChannels.Value;
            if (sourceOfFunds.IsSet)
                businessLineInfoUpdate.SourceOfFunds = sourceOfFunds.Value;
            if (webData.IsSet)
                businessLineInfoUpdate.WebData = webData.Value;
            if (webDataExemption.IsSet)
                businessLineInfoUpdate.WebDataExemption = webDataExemption.Value;
            return businessLineInfoUpdate;
        }
