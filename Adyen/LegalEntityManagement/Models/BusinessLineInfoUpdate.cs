    ...
    public class BusinessLineInfoUpdateJsonConverter : JsonConverter<BusinessLineInfoUpdate>
    {
        ...
        public override BusinessLineInfoUpdate Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (industryCode.IsSet && industryCode.Value == null)
                throw new ArgumentNullException(nameof(industryCode), "Property is not nullable for class BusinessLineInfoUpdate.");

            if (salesChannels.IsSet && salesChannels.Value == null)
                throw new ArgumentNullException(nameof(salesChannels), "Property is not nullable for class BusinessLineInfoUpdate.");

            if (sourceOfFunds.IsSet && sourceOfFunds.Value == null)
                throw new ArgumentNullException(nameof(sourceOfFunds), "Property is not nullable for class BusinessLineInfoUpdate.");

            if (webData.IsSet && webData.Value == null)
                throw new ArgumentNullException(nameof(webData), "Property is not nullable for class BusinessLineInfoUpdate.");

            if (webDataExemption.IsSet && webDataExemption.Value == null)
                throw new ArgumentNullException(nameof(webDataExemption), "Property is not nullable for class BusinessLineInfoUpdate.");
        ...
        {
            /*
            if (businessLineInfoUpdate._IndustryCodeOption.IsSet && businessLineInfoUpdate.IndustryCode == null)
                throw new ArgumentNullException(nameof(businessLineInfoUpdate.IndustryCode), "Property is required for class BusinessLineInfoUpdate.");

            if (businessLineInfoUpdate._SalesChannelsOption.IsSet && businessLineInfoUpdate.SalesChannels == null)
                throw new ArgumentNullException(nameof(businessLineInfoUpdate.SalesChannels), "Property is required for class BusinessLineInfoUpdate.");

            if (businessLineInfoUpdate._SourceOfFundsOption.IsSet && businessLineInfoUpdate.SourceOfFunds == null)
                throw new ArgumentNullException(nameof(businessLineInfoUpdate.SourceOfFunds), "Property is required for class BusinessLineInfoUpdate.");

            if (businessLineInfoUpdate._WebDataOption.IsSet && businessLineInfoUpdate.WebData == null)
                throw new ArgumentNullException(nameof(businessLineInfoUpdate.WebData), "Property is required for class BusinessLineInfoUpdate.");

            if (businessLineInfoUpdate._WebDataExemptionOption.IsSet && businessLineInfoUpdate.WebDataExemption == null)
                throw new ArgumentNullException(nameof(businessLineInfoUpdate.WebDataExemption), "Property is required for class BusinessLineInfoUpdate.");
