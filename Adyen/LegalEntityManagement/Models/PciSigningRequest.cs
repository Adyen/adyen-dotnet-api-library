    ...
    public class PciSigningRequestJsonConverter : JsonConverter<PciSigningRequest>
    {
        ...
        public override PciSigningRequest Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (pciTemplateReferences.IsSet && pciTemplateReferences.Value == null)
                throw new ArgumentNullException(nameof(pciTemplateReferences), "Property is not nullable for class PciSigningRequest.");

            if (signedBy.IsSet && signedBy.Value == null)
                throw new ArgumentNullException(nameof(signedBy), "Property is not nullable for class PciSigningRequest.");
        ...
        {
            /*
            if (pciSigningRequest.PciTemplateReferences == null)
                throw new ArgumentNullException(nameof(pciSigningRequest.PciTemplateReferences), "Property is required for class PciSigningRequest.");

            if (pciSigningRequest.SignedBy == null)
                throw new ArgumentNullException(nameof(pciSigningRequest.SignedBy), "Property is required for class PciSigningRequest.");
