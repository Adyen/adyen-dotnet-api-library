    ...
    public class GetTermsOfServiceDocumentRequestJsonConverter : JsonConverter<GetTermsOfServiceDocumentRequest>
    {
        ...
        public override GetTermsOfServiceDocumentRequest Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (language.IsSet && language.Value == null)
                throw new ArgumentNullException(nameof(language), "Property is not nullable for class GetTermsOfServiceDocumentRequest.");

            if (type.IsSet && type.Value == null)
                throw new ArgumentNullException(nameof(type), "Property is not nullable for class GetTermsOfServiceDocumentRequest.");

            if (termsOfServiceDocumentFormat.IsSet && termsOfServiceDocumentFormat.Value == null)
                throw new ArgumentNullException(nameof(termsOfServiceDocumentFormat), "Property is not nullable for class GetTermsOfServiceDocumentRequest.");
        ...
        public void WriteProperties(Utf8JsonWriter writer, GetTermsOfServiceDocumentRequest getTermsOfServiceDocumentRequest, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (getTermsOfServiceDocumentRequest.Language == null)
                throw new ArgumentNullException(nameof(getTermsOfServiceDocumentRequest.Language), "Property is required for class GetTermsOfServiceDocumentRequest.");

            if (getTermsOfServiceDocumentRequest._TermsOfServiceDocumentFormatOption.IsSet && getTermsOfServiceDocumentRequest.TermsOfServiceDocumentFormat == null)
                throw new ArgumentNullException(nameof(getTermsOfServiceDocumentRequest.TermsOfServiceDocumentFormat), "Property is required for class GetTermsOfServiceDocumentRequest.");
