...
namespace Adyen.LegalEntityManagement.Client
{
    ...
    public class HostConfiguration
    {
        ...
        /// </summary>
        public static string BASE_URL = "https://kyc-test.adyen.com/lem/v3";

        /// <summary>
        /// The relative path of the API after the `.com`.
        /// </summary>
        public static string RELATIVE_URL = "/lem/v3";
        ...
        public HostConfiguration AddLegalEntityManagementHttpClients(Action<System.Net.Http.HttpClient>? clientAction = null, Action<IHttpClientBuilder>? builderAction = null)
        {
            ...
            builders.Add(_services.AddHttpClient<IBusinessLinesService, BusinessLinesService>(clientAction));
            builders.Add(_services.AddHttpClient<IDocumentsService, DocumentsService>(clientAction));
            builders.Add(_services.AddHttpClient<IHostedOnboardingService, HostedOnboardingService>(clientAction));
            builders.Add(_services.AddHttpClient<ILegalEntitiesService, LegalEntitiesService>(clientAction));
            builders.Add(_services.AddHttpClient<IPCIQuestionnairesService, PCIQuestionnairesService>(clientAction));
            builders.Add(_services.AddHttpClient<ITaxEDeliveryConsentService, TaxEDeliveryConsentService>(clientAction));
            builders.Add(_services.AddHttpClient<ITermsOfServiceService, TermsOfServiceService>(clientAction));
            builders.Add(_services.AddHttpClient<ITransferInstrumentsService, TransferInstrumentsService>(clientAction));
