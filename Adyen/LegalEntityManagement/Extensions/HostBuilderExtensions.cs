...
namespace Adyen.LegalEntityManagement.Extensions
{
    ...
    {
        /// <summary>
        /// Initializes the <see cref="HostConfiguration"/> *without* adding the LegalEntityManagement API services defaults to the <see cref="IServiceCollection"/>.
        /// Use <see cref="Adyen.LegalEntityManagement.Extensions.IServiceCollectionExtensions"/> to add the LegalEntityManagement API services to the <see cref="IServiceCollection"/>.
        /// </summary>
        ...
        /// <summary>
        /// Initializes the <see cref="HostConfiguration"/> *and* adds the LegalEntityManagement API services defaults to the <see cref="IServiceCollection"/>.
        ...
        public static IHostBuilder ConfigureLegalEntityManagementDefaults(this IHostBuilder hostBuilder, Action<HostBuilderContext, IServiceCollection, HostConfiguration> hostConfigurationOptions, ServiceLifetime serviceLifetime = ServiceLifetime.Singleton, Action<System.Net.Http.HttpClient>? httpClientOptions = null, Action<IHttpClientBuilder>? httpClientBuilderOptions = null)
        {
            hostBuilder.ConfigureServices((context, services) => 
            {
                ...
                hostConfigurationOptions(context, services, hostConfiguration);
                services.AddAllLegalEntityManagementServices(serviceLifetime, httpClientOptions, httpClientBuilderOptions);
