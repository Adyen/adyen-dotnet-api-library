...
namespace Adyen.Capital.Client
{
    ...
    public class HostConfiguration
    {
        ...
        /// </summary>
        public static string BASE_URL = "https://balanceplatform-api-test.adyen.com/capital/v1";
        ...
        public HostConfiguration(IServiceCollection services)
        {
            ...
            _services.AddSingleton<GrantsServiceEvents>();
        }
        ...
        public HostConfiguration AddCapitalHttpClients(Action<System.Net.Http.HttpClient>? httpClientOptions = null, Action<IHttpClientBuilder>? httpClientBuilderOptions = null)
        {
            ...
            builders.Add(_services.AddHttpClient<IGrantsService, GrantsService>(httpClientAction));
