...
namespace Adyen.Capital.Models
{
    ...
    public partial class CALocalAccountIdentification : BankAccountIdentification
    {
        ...
        /// </summary>
        public CALocalAccountIdentification() : base()
        {
            OnCreated();
        }
                ...
                if (utf8JsonReader.TokenType == JsonTokenType.PropertyName && currentDepth == utf8JsonReader.CurrentDepth - 1)
                {
                    ...
                    switch (jsonPropertyName)
                    {
                        ...
                        case "accountType":
                            ...
                            accountType = new Option<CALocalBankAccountType?>(CALocalBankAccountType.FromStringOrDefault(accountTypeRawValue) ?? (CALocalBankAccountType)accountTypeRawValue);
                            break;
                        default:
                            break;
                    }
    ...
    writer.WriteString("type", cALocalAccountIdentification.Type);
            ...
            {
                var accountTypeRawValue = CALocalBankAccountType.ToJsonValue(cALocalAccountIdentification.AccountType);
