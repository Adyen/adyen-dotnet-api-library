...
namespace Adyen.Capital.Models
{
    ...
    /// </summary>
    [JsonConverter(typeof(CalculatedGrantOfferJsonConverter))]
                ...
                if (utf8JsonReader.TokenType == JsonTokenType.PropertyName && currentDepth == utf8JsonReader.CurrentDepth - 1)
                {
                    ...
                    switch (jsonPropertyName)
                    {
                        ...
                        case "contractType":
                            ...
                            contractType = new Option<CalculatedGrantOffer.ContractTypeEnum?>(CalculatedGrantOffer.ContractTypeEnum.FromStringOrDefault(contractTypeRawValue) ?? (CalculatedGrantOffer.ContractTypeEnum)contractTypeRawValue);
                            break;
                        case "expiresAt":
