...
namespace Adyen.Capital.Models
{
    ...
    /// </summary>
    [JsonConverter(typeof(CreateGrantOfferRequestJsonConverter))]
    public partial class CreateGrantOfferRequest
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CreateGrantOfferRequest" /> class.
        /// </summary>
    ...
    /// <summary>
    /// A Json converter for type <see cref="CreateGrantOfferRequest" />
    /// </summary>
    public class CreateGrantOfferRequestJsonConverter : JsonConverter<CreateGrantOfferRequest>
    {
        /// <summary>
        /// Deserializes json to <see cref="CreateGrantOfferRequest"/>.
        /// </summary>
        /// <param name="utf8JsonReader"><see cref="Utf8JsonReader"/>.</param>
        /// <param name="typeToConvert"><see cref="Type"/>.</param>
        /// <param name="jsonSerializerOptions">The <see cref="JsonSerializerOptions"/>, initialized from <see cref="HostConfiguration"/>.</param>
        /// <returns><see cref="CreateGrantOfferRequest"/>.</returns>
        /// <exception cref="JsonException"></exception>
        public override CreateGrantOfferRequest Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (!amount.IsSet)
                throw new ArgumentException("Property is required for class CreateGrantOfferRequest.", nameof(amount));

            var createGrantOfferRequest = new CreateGrantOfferRequest();
            createGrantOfferRequest.Amount = amount.Value!;
            return createGrantOfferRequest;
        }

        /// <summary>
        /// Serializes a <see cref="CreateGrantOfferRequest"/>.
        /// </summary>
        /// <param name="writer"><see cref="Utf8JsonWriter"/></param>
        /// <param name="createGrantOfferRequest"></param>
        /// <param name="jsonSerializerOptions"><see cref="JsonSerializerOptions"/></param>
        public override void Write(Utf8JsonWriter writer, CreateGrantOfferRequest createGrantOfferRequest, JsonSerializerOptions jsonSerializerOptions)
        {
        ...
        /// <summary>
        /// Serializes the properties of <see cref="CreateGrantOfferRequest"/>.
        /// </summary>
        /// <param name="writer"><see cref="Utf8JsonWriter"/></param>
        /// <param name="createGrantOfferRequest"></param>
        /// <param name="jsonSerializerOptions"><see cref="JsonSerializerOptions"/></param>
        public void WriteProperties(Utf8JsonWriter writer, CreateGrantOfferRequest createGrantOfferRequest, JsonSerializerOptions jsonSerializerOptions)
        {
            
            writer.WritePropertyName("amount");
            JsonSerializer.Serialize(writer, createGrantOfferRequest.Amount, jsonSerializerOptions);
        }
    }
}
