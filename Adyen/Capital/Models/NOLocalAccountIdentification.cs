...
namespace Adyen.Capital.Models
{
    ...
    /// </summary>
    public partial class NOLocalAccountIdentification : BankAccountIdentification, IValidatableObject
    {
        /// <summary>
        ...
        [JsonConstructor]
        public NOLocalAccountIdentification(string accountNumber) : base()
        {
