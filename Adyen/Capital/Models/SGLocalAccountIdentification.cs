...
namespace Adyen.Capital.Models
{
    ...
    /// </summary>
    public partial class SGLocalAccountIdentification : BankAccountIdentification, IValidatableObject
    {
        /// <summary>
        ...
        [JsonConstructor]
        public SGLocalAccountIdentification(string accountNumber, string bic) : base()
        {
    ...
    public class SGLocalAccountIdentificationJsonConverter : JsonConverter<SGLocalAccountIdentification>
    {
        ...
        public override SGLocalAccountIdentification Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            return new SGLocalAccountIdentification(accountNumber.Value!, bic.Value!);
        }
    ...
    writer.WriteString("type", sGLocalAccountIdentification.Type);
        }
    }
}
