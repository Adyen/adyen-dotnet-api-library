...
namespace Adyen.Capital.Models
{
    ...
    /// </summary>
    [JsonConverter(typeof(DisbursementInfoUpdateJsonConverter))]
    public partial class DisbursementInfoUpdate
    {
        /// <summary>
        ...
        public Option<DisbursementRepaymentInfoUpdate?> _RepaymentOption { get; private set; }

        /// <summary>
        /// <see cref="Repayment"/>.
        /// </summary>
        [JsonPropertyName("repayment")]
        public DisbursementRepaymentInfoUpdate? Repayment { get { return this._RepaymentOption; } set { this._RepaymentOption = new(value); } }
    ...
    /// <summary>
    /// A Json converter for type <see cref="DisbursementInfoUpdate" />
    /// </summary>
    public class DisbursementInfoUpdateJsonConverter : JsonConverter<DisbursementInfoUpdate>
    {
        /// <summary>
        /// Deserializes json to <see cref="DisbursementInfoUpdate"/>.
        /// </summary>
        /// <param name="utf8JsonReader"><see cref="Utf8JsonReader"/>.</param>
        /// <param name="typeToConvert"><see cref="Type"/>.</param>
        /// <param name="jsonSerializerOptions">The <see cref="JsonSerializerOptions"/>, initialized from <see cref="HostConfiguration"/>.</param>
        /// <returns><see cref="DisbursementInfoUpdate"/>.</returns>
        /// <exception cref="JsonException"></exception>
        public override DisbursementInfoUpdate Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            Option<DisbursementRepaymentInfoUpdate?> repayment = default;
            ...
            while (utf8JsonReader.Read())
            {
                ...
                if (utf8JsonReader.TokenType == JsonTokenType.PropertyName && currentDepth == utf8JsonReader.CurrentDepth - 1)
                {
                    ...
                    {
                        case "repayment":
                            repayment = new Option<DisbursementRepaymentInfoUpdate?>(JsonSerializer.Deserialize<DisbursementRepaymentInfoUpdate>(ref utf8JsonReader, jsonSerializerOptions)!);
                            break;
                        default:
                            break;
                    }
            ...
            return disbursementInfoUpdate;
        }

        /// <summary>
        /// Serializes a <see cref="DisbursementInfoUpdate"/>.
        /// </summary>
        /// <param name="writer"><see cref="Utf8JsonWriter"/></param>
        /// <param name="disbursementInfoUpdate"></param>
        /// <param name="jsonSerializerOptions"><see cref="JsonSerializerOptions"/></param>
        public override void Write(Utf8JsonWriter writer, DisbursementInfoUpdate disbursementInfoUpdate, JsonSerializerOptions jsonSerializerOptions)
        {
            
            writer.WriteStartObject();
            
            WriteProperties(writer, disbursementInfoUpdate, jsonSerializerOptions);
        ...
        /// <summary>
        /// Serializes the properties of <see cref="DisbursementInfoUpdate"/>.
        /// </summary>
        /// <param name="writer"><see cref="Utf8JsonWriter"/></param>
        /// <param name="disbursementInfoUpdate"></param>
        /// <param name="jsonSerializerOptions"><see cref="JsonSerializerOptions"/></param>
        public void WriteProperties(Utf8JsonWriter writer, DisbursementInfoUpdate disbursementInfoUpdate, JsonSerializerOptions jsonSerializerOptions)
        {
            
            if (disbursementInfoUpdate._RepaymentOption.IsSet)
            {
                writer.WritePropertyName("repayment");
                JsonSerializer.Serialize(writer, disbursementInfoUpdate.Repayment, jsonSerializerOptions);
            }
        }
    }
}
