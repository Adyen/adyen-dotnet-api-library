...
namespace Adyen.Capital.Models
{
    ...
    /// GrantInfo.
    /// </summary>
    [JsonConverter(typeof(GrantInfoJsonConverter))]
    ...
    public class GrantInfoJsonConverter : JsonConverter<GrantInfo>
    {
        ...
        public override GrantInfo Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            grantInfo.GrantAccountId = grantAccountId.Value!;
            grantInfo.GrantOfferId = grantOfferId.Value!;
            if (counterparty.IsSet)
                grantInfo.Counterparty = counterparty.Value;
            return grantInfo;
        }
