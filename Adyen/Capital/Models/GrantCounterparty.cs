...
namespace Adyen.Capital.Models
{
    ...
    /// GrantCounterparty.
    /// </summary>
    [JsonConverter(typeof(GrantCounterpartyJsonConverter))]
    public partial class GrantCounterparty
    {
        ...
        /// </summary>
        /// <value>The unique identifier of the account holder that receives the grant.</value>
    ...
    public class GrantCounterpartyJsonConverter : JsonConverter<GrantCounterparty>
    {
        ...
        public override GrantCounterparty Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (balanceAccountId.IsSet)
                grantCounterparty.BalanceAccountId = balanceAccountId.Value;
            if (transferInstrumentId.IsSet)
                grantCounterparty.TransferInstrumentId = transferInstrumentId.Value;
            return grantCounterparty;
        }
