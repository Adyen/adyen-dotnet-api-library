...
namespace Adyen.Capital.Models
{
    ...
    public partial class USLocalAccountIdentification : BankAccountIdentification
    {
        ...
        /// </summary>
        public USLocalAccountIdentification() : base()
        {
            OnCreated();
        }
                ...
                if (utf8JsonReader.TokenType == JsonTokenType.PropertyName && currentDepth == utf8JsonReader.CurrentDepth - 1)
                {
                    ...
                    switch (jsonPropertyName)
                    {
                        ...
                        case "accountType":
                            ...
                            accountType = new Option<USLocalBankAccountType?>(USLocalBankAccountType.FromStringOrDefault(accountTypeRawValue) ?? (USLocalBankAccountType)accountTypeRawValue);
                            break;
                        default:
                            break;
                    }
    ...
    writer.WriteString("type", uSLocalAccountIdentification.Type);
            ...
            {
                var accountTypeRawValue = USLocalBankAccountType.ToJsonValue(uSLocalAccountIdentification.AccountType);
