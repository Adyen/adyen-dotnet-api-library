...
namespace Adyen.Capital.Models
{
    ...
    /// </summary>
    [JsonConverter(typeof(UKLocalAccountIdentificationJsonConverter))]
    public partial class UKLocalAccountIdentification : BankAccountIdentification
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="UKLocalAccountIdentification" /> class.
        /// </summary>
        public UKLocalAccountIdentification() : base()
        {
            OnCreated();
        }
