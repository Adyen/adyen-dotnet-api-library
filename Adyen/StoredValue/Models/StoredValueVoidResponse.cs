...
namespace Adyen.StoredValue.Models
{
    ...
    /// </summary>
    public partial class StoredValueVoidResponse : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="StoredValueVoidResponse" /> class.
        /// </summary>
        ...
        [JsonConstructor]
        public StoredValueVoidResponse(Option<Amount?> currentBalance = default, Option<string?> pspReference = default, Option<string?> refusalReason = default, Option<ResultCodeEnum?> resultCode = default, Option<string?> thirdPartyRefusalReason = default)
        {
    ...
    /// <summary>
    /// A Json converter for type <see cref="StoredValueVoidResponse" />
    /// </summary>
    public class StoredValueVoidResponseJsonConverter : JsonConverter<StoredValueVoidResponse>
    {
        /// <summary>
        /// Deserializes json to <see cref="StoredValueVoidResponse"/>.
        /// </summary>
        ...
        public override StoredValueVoidResponse Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            Option<StoredValueVoidResponse.ResultCodeEnum?> resultCode = default;
                ...
                if (utf8JsonReader.TokenType == JsonTokenType.PropertyName && currentDepth == utf8JsonReader.CurrentDepth - 1)
                {
                    ...
                    switch (jsonPropertyName)
                    {
                        ...
                        case "resultCode":
                            ...
                            resultCode = new Option<StoredValueVoidResponse.ResultCodeEnum?>(StoredValueVoidResponse.ResultCodeEnum.FromStringOrDefault(resultCodeRawValue));
                            break;
            ...
            if (currentBalance.IsSet && currentBalance.Value == null)
                throw new ArgumentNullException(nameof(currentBalance), "Property is not nullable for class StoredValueVoidResponse.");

            if (pspReference.IsSet && pspReference.Value == null)
                throw new ArgumentNullException(nameof(pspReference), "Property is not nullable for class StoredValueVoidResponse.");

            if (refusalReason.IsSet && refusalReason.Value == null)
                throw new ArgumentNullException(nameof(refusalReason), "Property is not nullable for class StoredValueVoidResponse.");

            if (resultCode.IsSet && resultCode.Value == null)
                throw new ArgumentNullException(nameof(resultCode), "Property is not nullable for class StoredValueVoidResponse.");

            if (thirdPartyRefusalReason.IsSet && thirdPartyRefusalReason.Value == null)
                throw new ArgumentNullException(nameof(thirdPartyRefusalReason), "Property is not nullable for class StoredValueVoidResponse.");

            return new StoredValueVoidResponse(currentBalance, pspReference, refusalReason, resultCode, thirdPartyRefusalReason);
        }

        /// <summary>
        /// Serializes a <see cref="StoredValueVoidResponse"/>.
        /// </summary>
        /// <param name="writer"><see cref="Utf8JsonWriter"/></param>
        /// <param name="storedValueVoidResponse"></param>
        /// <param name="jsonSerializerOptions"><see cref="JsonSerializerOptions"/></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, StoredValueVoidResponse storedValueVoidResponse, JsonSerializerOptions jsonSerializerOptions)
        {
            
            writer.WriteStartObject();
            
            WriteProperties(writer, storedValueVoidResponse, jsonSerializerOptions);
        ...
        /// <summary>
        /// Serializes the properties of <see cref="StoredValueVoidResponse"/>.
        /// </summary>
        /// <param name="writer"><see creft="Utf8JsonWriter"/></param>
        /// <param name="storedValueVoidResponse"></param>
        /// <param name="jsonSerializerOptions"><see cref="JsonSerializerOptions"/></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, StoredValueVoidResponse storedValueVoidResponse, JsonSerializerOptions jsonSerializerOptions)
        {
            /*
            if (storedValueVoidResponse._CurrentBalanceOption.IsSet && storedValueVoidResponse.CurrentBalance == null)
                throw new ArgumentNullException(nameof(storedValueVoidResponse.CurrentBalance), "Property is required for class StoredValueVoidResponse.");

            if (storedValueVoidResponse._PspReferenceOption.IsSet && storedValueVoidResponse.PspReference == null)
                throw new ArgumentNullException(nameof(storedValueVoidResponse.PspReference), "Property is required for class StoredValueVoidResponse.");

            if (storedValueVoidResponse._RefusalReasonOption.IsSet && storedValueVoidResponse.RefusalReason == null)
                throw new ArgumentNullException(nameof(storedValueVoidResponse.RefusalReason), "Property is required for class StoredValueVoidResponse.");

            if (storedValueVoidResponse._ThirdPartyRefusalReasonOption.IsSet && storedValueVoidResponse.ThirdPartyRefusalReason == null)
                throw new ArgumentNullException(nameof(storedValueVoidResponse.ThirdPartyRefusalReason), "Property is required for class StoredValueVoidResponse.");

            */
            
            if (storedValueVoidResponse._CurrentBalanceOption.IsSet)
            {
                writer.WritePropertyName("currentBalance");
                JsonSerializer.Serialize(writer, storedValueVoidResponse.CurrentBalance, jsonSerializerOptions);
            }
            if (storedValueVoidResponse._PspReferenceOption.IsSet)
                writer.WriteString("pspReference", storedValueVoidResponse.PspReference);

            if (storedValueVoidResponse._RefusalReasonOption.IsSet)
                writer.WriteString("refusalReason", storedValueVoidResponse.RefusalReason);

            if (storedValueVoidResponse._ResultCodeOption.IsSet && storedValueVoidResponse.ResultCode != null) 
            {
                string? resultCodeRawValue = StoredValueVoidResponse.ResultCodeEnum.ToJsonValue(storedValueVoidResponse._ResultCodeOption.Value!.Value);
                writer.WriteString("resultCode", resultCodeRawValue);
            }
            
            if (storedValueVoidResponse._ThirdPartyRefusalReasonOption.IsSet)
                writer.WriteString("thirdPartyRefusalReason", storedValueVoidResponse.ThirdPartyRefusalReason);
        }
    }
}
