...
namespace Adyen.StoredValue.Models
{
    ...
    /// </summary>
    [JsonConverter(typeof(StoredValueVoidResponseJsonConverter))]
    public partial class StoredValueVoidResponse
    {
        /// <summary>
    ...
    public class StoredValueVoidResponseJsonConverter : JsonConverter<StoredValueVoidResponse>
    {
        ...
        public override StoredValueVoidResponse Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
                ...
                if (utf8JsonReader.TokenType == JsonTokenType.PropertyName && currentDepth == utf8JsonReader.CurrentDepth - 1)
                {
                    ...
                    switch (jsonPropertyName)
                    {
                        ...
                        case "resultCode":
                            ...
                            resultCode = new Option<StoredValueVoidResponse.ResultCodeEnum?>(StoredValueVoidResponse.ResultCodeEnum.FromStringOrDefault(resultCodeRawValue) ?? (StoredValueVoidResponse.ResultCodeEnum)resultCodeRawValue);
                            break;
            ...
            if (pspReference.IsSet)
                storedValueVoidResponse.PspReference = pspReference.Value;
            if (refusalReason.IsSet)
                storedValueVoidResponse.RefusalReason = refusalReason.Value;
            if (resultCode.IsSet)
                storedValueVoidResponse.ResultCode = resultCode.Value;
            if (thirdPartyRefusalReason.IsSet)
                storedValueVoidResponse.ThirdPartyRefusalReason = thirdPartyRefusalReason.Value;
        ...
        public void WriteProperties(Utf8JsonWriter writer, StoredValueVoidResponse storedValueVoidResponse, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (storedValueVoidResponse._PspReferenceOption.IsSet)
                if (storedValueVoidResponse.PspReference != null)
            ...
            if (storedValueVoidResponse._RefusalReasonOption.IsSet)
                if (storedValueVoidResponse.RefusalReason != null)
            ...
            if (storedValueVoidResponse._ThirdPartyRefusalReasonOption.IsSet)
                if (storedValueVoidResponse.ThirdPartyRefusalReason != null)
