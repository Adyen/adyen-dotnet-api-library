...
namespace Adyen.StoredValue.Models
{
    ...
    /// </summary>
    [JsonConverter(typeof(StoredValueStatusChangeRequestJsonConverter))]
    ...
    public class StoredValueStatusChangeRequestJsonConverter : JsonConverter<StoredValueStatusChangeRequest>
    {
        ...
        public override StoredValueStatusChangeRequest Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (recurringDetailReference.IsSet)
                storedValueStatusChangeRequest.RecurringDetailReference = recurringDetailReference.Value;
            if (shopperInteraction.IsSet)
                storedValueStatusChangeRequest.ShopperInteraction = shopperInteraction.Value;
            if (shopperReference.IsSet)
                storedValueStatusChangeRequest.ShopperReference = shopperReference.Value;
            if (store.IsSet)
                storedValueStatusChangeRequest.Store = store.Value;
            return storedValueStatusChangeRequest;
        }
