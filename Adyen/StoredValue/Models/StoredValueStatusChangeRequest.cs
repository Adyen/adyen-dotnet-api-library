    ...
    public class StoredValueStatusChangeRequestJsonConverter : JsonConverter<StoredValueStatusChangeRequest>
    {
        ...
        public override StoredValueStatusChangeRequest Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (merchantAccount.IsSet && merchantAccount.Value == null)
                throw new ArgumentNullException(nameof(merchantAccount), "Property is not nullable for class StoredValueStatusChangeRequest.");

            if (paymentMethod.IsSet && paymentMethod.Value == null)
                throw new ArgumentNullException(nameof(paymentMethod), "Property is not nullable for class StoredValueStatusChangeRequest.");

            if (reference.IsSet && reference.Value == null)
                throw new ArgumentNullException(nameof(reference), "Property is not nullable for class StoredValueStatusChangeRequest.");

            if (status.IsSet && status.Value == null)
                throw new ArgumentNullException(nameof(status), "Property is not nullable for class StoredValueStatusChangeRequest.");

            if (amount.IsSet && amount.Value == null)
                throw new ArgumentNullException(nameof(amount), "Property is not nullable for class StoredValueStatusChangeRequest.");

            if (recurringDetailReference.IsSet && recurringDetailReference.Value == null)
                throw new ArgumentNullException(nameof(recurringDetailReference), "Property is not nullable for class StoredValueStatusChangeRequest.");

            if (shopperInteraction.IsSet && shopperInteraction.Value == null)
                throw new ArgumentNullException(nameof(shopperInteraction), "Property is not nullable for class StoredValueStatusChangeRequest.");

            if (shopperReference.IsSet && shopperReference.Value == null)
                throw new ArgumentNullException(nameof(shopperReference), "Property is not nullable for class StoredValueStatusChangeRequest.");

            if (store.IsSet && store.Value == null)
                throw new ArgumentNullException(nameof(store), "Property is not nullable for class StoredValueStatusChangeRequest.");
        ...
        public void WriteProperties(Utf8JsonWriter writer, StoredValueStatusChangeRequest storedValueStatusChangeRequest, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (storedValueStatusChangeRequest.MerchantAccount == null)
                throw new ArgumentNullException(nameof(storedValueStatusChangeRequest.MerchantAccount), "Property is required for class StoredValueStatusChangeRequest.");

            if (storedValueStatusChangeRequest.PaymentMethod == null)
                throw new ArgumentNullException(nameof(storedValueStatusChangeRequest.PaymentMethod), "Property is required for class StoredValueStatusChangeRequest.");

            if (storedValueStatusChangeRequest.Reference == null)
                throw new ArgumentNullException(nameof(storedValueStatusChangeRequest.Reference), "Property is required for class StoredValueStatusChangeRequest.");

            if (storedValueStatusChangeRequest._AmountOption.IsSet && storedValueStatusChangeRequest.Amount == null)
                throw new ArgumentNullException(nameof(storedValueStatusChangeRequest.Amount), "Property is required for class StoredValueStatusChangeRequest.");

            if (storedValueStatusChangeRequest._RecurringDetailReferenceOption.IsSet && storedValueStatusChangeRequest.RecurringDetailReference == null)
                throw new ArgumentNullException(nameof(storedValueStatusChangeRequest.RecurringDetailReference), "Property is required for class StoredValueStatusChangeRequest.");

            if (storedValueStatusChangeRequest._ShopperReferenceOption.IsSet && storedValueStatusChangeRequest.ShopperReference == null)
                throw new ArgumentNullException(nameof(storedValueStatusChangeRequest.ShopperReference), "Property is required for class StoredValueStatusChangeRequest.");

            if (storedValueStatusChangeRequest._StoreOption.IsSet && storedValueStatusChangeRequest.Store == null)
                throw new ArgumentNullException(nameof(storedValueStatusChangeRequest.Store), "Property is required for class StoredValueStatusChangeRequest.");
