...
namespace Adyen.StoredValue.Models
{
    ...
    /// </summary>
    [JsonConverter(typeof(StoredValueVoidRequestJsonConverter))]
    ...
    public class StoredValueVoidRequestJsonConverter : JsonConverter<StoredValueVoidRequest>
    {
        ...
        public override StoredValueVoidRequest Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (store.IsSet)
                storedValueVoidRequest.Store = store.Value;
            if (tenderReference.IsSet)
                storedValueVoidRequest.TenderReference = tenderReference.Value;
            if (uniqueTerminalId.IsSet)
                storedValueVoidRequest.UniqueTerminalId = uniqueTerminalId.Value;
            return storedValueVoidRequest;
        }
