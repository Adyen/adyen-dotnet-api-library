...
namespace Adyen.StoredValue.Models
{
    ...
    /// </summary>
    [JsonConverter(typeof(StoredValueIssueRequestJsonConverter))]
    ...
    public class StoredValueIssueRequestJsonConverter : JsonConverter<StoredValueIssueRequest>
    {
        ...
        public override StoredValueIssueRequest Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
                ...
                if (utf8JsonReader.TokenType == JsonTokenType.PropertyName && currentDepth == utf8JsonReader.CurrentDepth - 1)
                {
                    ...
                    switch (jsonPropertyName)
                    {
                        ...
                        case "shopperInteraction":
                            ...
                            shopperInteraction = new Option<StoredValueIssueRequest.ShopperInteractionEnum?>(StoredValueIssueRequest.ShopperInteractionEnum.FromStringOrDefault(shopperInteractionRawValue) ?? (StoredValueIssueRequest.ShopperInteractionEnum)shopperInteractionRawValue);
                            break;
            ...
            var storedValueIssueRequest = new StoredValueIssueRequest();
            if (merchantAccount.IsSet)
                storedValueIssueRequest.MerchantAccount = merchantAccount.Value!;
            if (paymentMethod.IsSet)
                storedValueIssueRequest.PaymentMethod = paymentMethod.Value!;
            if (reference.IsSet)
                storedValueIssueRequest.Reference = reference.Value!;
            if (amount.IsSet)
                storedValueIssueRequest.Amount = amount.Value;
            if (recurringDetailReference.IsSet)
                storedValueIssueRequest.RecurringDetailReference = recurringDetailReference.Value;
            if (shopperInteraction.IsSet)
                storedValueIssueRequest.ShopperInteraction = shopperInteraction.Value;
            if (shopperReference.IsSet)
                storedValueIssueRequest.ShopperReference = shopperReference.Value;
            if (store.IsSet)
                storedValueIssueRequest.Store = store.Value;
            return storedValueIssueRequest;
        }
        ...
        public void WriteProperties(Utf8JsonWriter writer, StoredValueIssueRequest storedValueIssueRequest, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (storedValueIssueRequest._RecurringDetailReferenceOption.IsSet)
                if (storedValueIssueRequest.RecurringDetailReference != null)
            ...
            if (storedValueIssueRequest._ShopperReferenceOption.IsSet)
                if (storedValueIssueRequest.ShopperReference != null)
            ...
            if (storedValueIssueRequest._StoreOption.IsSet)
                if (storedValueIssueRequest.Store != null)
