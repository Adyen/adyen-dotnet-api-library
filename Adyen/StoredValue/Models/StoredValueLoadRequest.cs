...
namespace Adyen.StoredValue.Models
{
    ...
    /// </summary>
    [JsonConverter(typeof(StoredValueLoadRequestJsonConverter))]
    ...
    public class StoredValueLoadRequestJsonConverter : JsonConverter<StoredValueLoadRequest>
    {
        ...
        public override StoredValueLoadRequest Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (recurringDetailReference.IsSet)
                storedValueLoadRequest.RecurringDetailReference = recurringDetailReference.Value;
            if (shopperInteraction.IsSet)
                storedValueLoadRequest.ShopperInteraction = shopperInteraction.Value;
            if (shopperReference.IsSet)
                storedValueLoadRequest.ShopperReference = shopperReference.Value;
            if (store.IsSet)
                storedValueLoadRequest.Store = store.Value;
