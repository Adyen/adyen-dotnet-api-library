...
namespace Adyen.StoredValue.Models
{
    ...
    public partial class StoredValueLoadRequest : IValidatableObject
    {
        ...
        /// <summary>
        /// Used to track whether LoadType is set or not.
        /// </summary>
        [JsonIgnore]
    ...
    public class StoredValueLoadRequestJsonConverter : JsonConverter<StoredValueLoadRequest>
    {
        ...
        public override StoredValueLoadRequest Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (amount.IsSet && amount.Value == null)
                throw new ArgumentNullException(nameof(amount), "Property is not nullable for class StoredValueLoadRequest.");

            if (merchantAccount.IsSet && merchantAccount.Value == null)
                throw new ArgumentNullException(nameof(merchantAccount), "Property is not nullable for class StoredValueLoadRequest.");

            if (paymentMethod.IsSet && paymentMethod.Value == null)
                throw new ArgumentNullException(nameof(paymentMethod), "Property is not nullable for class StoredValueLoadRequest.");

            if (reference.IsSet && reference.Value == null)
                throw new ArgumentNullException(nameof(reference), "Property is not nullable for class StoredValueLoadRequest.");

            if (loadType.IsSet && loadType.Value == null)
                throw new ArgumentNullException(nameof(loadType), "Property is not nullable for class StoredValueLoadRequest.");

            if (recurringDetailReference.IsSet && recurringDetailReference.Value == null)
                throw new ArgumentNullException(nameof(recurringDetailReference), "Property is not nullable for class StoredValueLoadRequest.");

            if (shopperInteraction.IsSet && shopperInteraction.Value == null)
                throw new ArgumentNullException(nameof(shopperInteraction), "Property is not nullable for class StoredValueLoadRequest.");

            if (shopperReference.IsSet && shopperReference.Value == null)
                throw new ArgumentNullException(nameof(shopperReference), "Property is not nullable for class StoredValueLoadRequest.");

            if (store.IsSet && store.Value == null)
                throw new ArgumentNullException(nameof(store), "Property is not nullable for class StoredValueLoadRequest.");
        ...
        {
            /*
            if (storedValueLoadRequest.Amount == null)
                throw new ArgumentNullException(nameof(storedValueLoadRequest.Amount), "Property is required for class StoredValueLoadRequest.");

            if (storedValueLoadRequest.MerchantAccount == null)
                throw new ArgumentNullException(nameof(storedValueLoadRequest.MerchantAccount), "Property is required for class StoredValueLoadRequest.");

            if (storedValueLoadRequest.PaymentMethod == null)
                throw new ArgumentNullException(nameof(storedValueLoadRequest.PaymentMethod), "Property is required for class StoredValueLoadRequest.");

            if (storedValueLoadRequest.Reference == null)
                throw new ArgumentNullException(nameof(storedValueLoadRequest.Reference), "Property is required for class StoredValueLoadRequest.");

            if (storedValueLoadRequest._RecurringDetailReferenceOption.IsSet && storedValueLoadRequest.RecurringDetailReference == null)
                throw new ArgumentNullException(nameof(storedValueLoadRequest.RecurringDetailReference), "Property is required for class StoredValueLoadRequest.");

            if (storedValueLoadRequest._ShopperReferenceOption.IsSet && storedValueLoadRequest.ShopperReference == null)
                throw new ArgumentNullException(nameof(storedValueLoadRequest.ShopperReference), "Property is required for class StoredValueLoadRequest.");

            if (storedValueLoadRequest._StoreOption.IsSet && storedValueLoadRequest.Store == null)
                throw new ArgumentNullException(nameof(storedValueLoadRequest.Store), "Property is required for class StoredValueLoadRequest.");
