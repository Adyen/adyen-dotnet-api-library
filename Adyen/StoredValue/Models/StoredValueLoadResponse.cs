...
namespace Adyen.StoredValue.Models
{
    ...
    /// <summary>
    /// A Json converter for type <see cref="StoredValueLoadResponse" />
    /// </summary>
    public class StoredValueLoadResponseJsonConverter : JsonConverter<StoredValueLoadResponse>
    {
        /// <summary>
        /// Deserializes json to <see cref="StoredValueLoadResponse"/>.
        /// </summary>
        ...
        public override StoredValueLoadResponse Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            Option<StoredValueLoadResponse.ResultCodeEnum?> resultCode = default;
                ...
                if (utf8JsonReader.TokenType == JsonTokenType.PropertyName && currentDepth == utf8JsonReader.CurrentDepth - 1)
                {
                    ...
                    switch (jsonPropertyName)
                    {
                        ...
                        case "resultCode":
                            ...
                            resultCode = new Option<StoredValueLoadResponse.ResultCodeEnum?>(StoredValueLoadResponse.ResultCodeEnum.FromStringOrDefault(resultCodeRawValue));
                            break;
            ...
            if (authCode.IsSet && authCode.Value == null)
                throw new ArgumentNullException(nameof(authCode), "Property is not nullable for class StoredValueLoadResponse.");

            if (currentBalance.IsSet && currentBalance.Value == null)
                throw new ArgumentNullException(nameof(currentBalance), "Property is not nullable for class StoredValueLoadResponse.");

            if (pspReference.IsSet && pspReference.Value == null)
                throw new ArgumentNullException(nameof(pspReference), "Property is not nullable for class StoredValueLoadResponse.");

            if (refusalReason.IsSet && refusalReason.Value == null)
                throw new ArgumentNullException(nameof(refusalReason), "Property is not nullable for class StoredValueLoadResponse.");

            if (resultCode.IsSet && resultCode.Value == null)
                throw new ArgumentNullException(nameof(resultCode), "Property is not nullable for class StoredValueLoadResponse.");

            if (thirdPartyRefusalReason.IsSet && thirdPartyRefusalReason.Value == null)
                throw new ArgumentNullException(nameof(thirdPartyRefusalReason), "Property is not nullable for class StoredValueLoadResponse.");

            return new StoredValueLoadResponse(authCode, currentBalance, pspReference, refusalReason, resultCode, thirdPartyRefusalReason);
        }

        /// <summary>
        /// Serializes a <see cref="StoredValueLoadResponse"/>.
        /// </summary>
        ...
        {
            /*
            if (storedValueLoadResponse._AuthCodeOption.IsSet && storedValueLoadResponse.AuthCode == null)
                throw new ArgumentNullException(nameof(storedValueLoadResponse.AuthCode), "Property is required for class StoredValueLoadResponse.");

            if (storedValueLoadResponse._CurrentBalanceOption.IsSet && storedValueLoadResponse.CurrentBalance == null)
                throw new ArgumentNullException(nameof(storedValueLoadResponse.CurrentBalance), "Property is required for class StoredValueLoadResponse.");

            if (storedValueLoadResponse._PspReferenceOption.IsSet && storedValueLoadResponse.PspReference == null)
                throw new ArgumentNullException(nameof(storedValueLoadResponse.PspReference), "Property is required for class StoredValueLoadResponse.");

            if (storedValueLoadResponse._RefusalReasonOption.IsSet && storedValueLoadResponse.RefusalReason == null)
                throw new ArgumentNullException(nameof(storedValueLoadResponse.RefusalReason), "Property is required for class StoredValueLoadResponse.");

            if (storedValueLoadResponse._ThirdPartyRefusalReasonOption.IsSet && storedValueLoadResponse.ThirdPartyRefusalReason == null)
                throw new ArgumentNullException(nameof(storedValueLoadResponse.ThirdPartyRefusalReason), "Property is required for class StoredValueLoadResponse.");

            */
            
            if (storedValueLoadResponse._AuthCodeOption.IsSet)
                writer.WriteString("authCode", storedValueLoadResponse.AuthCode);

            if (storedValueLoadResponse._CurrentBalanceOption.IsSet)
            {
                writer.WritePropertyName("currentBalance");
                JsonSerializer.Serialize(writer, storedValueLoadResponse.CurrentBalance, jsonSerializerOptions);
            }
            if (storedValueLoadResponse._PspReferenceOption.IsSet)
                writer.WriteString("pspReference", storedValueLoadResponse.PspReference);

            if (storedValueLoadResponse._RefusalReasonOption.IsSet)
                writer.WriteString("refusalReason", storedValueLoadResponse.RefusalReason);

            if (storedValueLoadResponse._ResultCodeOption.IsSet && storedValueLoadResponse.ResultCode != null) 
            {
                string? resultCodeRawValue = StoredValueLoadResponse.ResultCodeEnum.ToJsonValue(storedValueLoadResponse._ResultCodeOption.Value!.Value);
                writer.WriteString("resultCode", resultCodeRawValue);
            }
            
            if (storedValueLoadResponse._ThirdPartyRefusalReasonOption.IsSet)
                writer.WriteString("thirdPartyRefusalReason", storedValueLoadResponse.ThirdPartyRefusalReason);
        }
    }
}
