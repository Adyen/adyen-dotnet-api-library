...
namespace Adyen.StoredValue.Models
{
    ...
    /// </summary>
    [JsonConverter(typeof(StoredValueLoadResponseJsonConverter))]
    ...
    public class StoredValueLoadResponseJsonConverter : JsonConverter<StoredValueLoadResponse>
    {
        ...
        public override StoredValueLoadResponse Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
                ...
                if (utf8JsonReader.TokenType == JsonTokenType.PropertyName && currentDepth == utf8JsonReader.CurrentDepth - 1)
                {
                    ...
                    switch (jsonPropertyName)
                    {
                        ...
                        case "resultCode":
                            ...
                            resultCode = new Option<StoredValueLoadResponse.ResultCodeEnum?>(StoredValueLoadResponse.ResultCodeEnum.FromStringOrDefault(resultCodeRawValue) ?? (StoredValueLoadResponse.ResultCodeEnum)resultCodeRawValue);
                            break;
            ...
            if (currentBalance.IsSet)
                storedValueLoadResponse.CurrentBalance = currentBalance.Value;
            if (pspReference.IsSet)
                storedValueLoadResponse.PspReference = pspReference.Value;
            if (refusalReason.IsSet)
                storedValueLoadResponse.RefusalReason = refusalReason.Value;
            if (resultCode.IsSet)
                storedValueLoadResponse.ResultCode = resultCode.Value;
            if (thirdPartyRefusalReason.IsSet)
                storedValueLoadResponse.ThirdPartyRefusalReason = thirdPartyRefusalReason.Value;
        ...
        public void WriteProperties(Utf8JsonWriter writer, StoredValueLoadResponse storedValueLoadResponse, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (storedValueLoadResponse._AuthCodeOption.IsSet)
                if (storedValueLoadResponse.AuthCode != null)
            ...
            if (storedValueLoadResponse._PspReferenceOption.IsSet)
                if (storedValueLoadResponse.PspReference != null)
            ...
            if (storedValueLoadResponse._RefusalReasonOption.IsSet)
                if (storedValueLoadResponse.RefusalReason != null)
            ...
            if (storedValueLoadResponse._ThirdPartyRefusalReasonOption.IsSet)
                if (storedValueLoadResponse.ThirdPartyRefusalReason != null)
