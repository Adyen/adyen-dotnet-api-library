...
namespace Adyen.StoredValue.Models
{
    ...
    /// </summary>
    [JsonConverter(typeof(StoredValueStatusChangeResponseJsonConverter))]
    public partial class StoredValueStatusChangeResponse
    {
        /// <summary>
    ...
    public class StoredValueStatusChangeResponseJsonConverter : JsonConverter<StoredValueStatusChangeResponse>
    {
        ...
        public override StoredValueStatusChangeResponse Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
                ...
                if (utf8JsonReader.TokenType == JsonTokenType.PropertyName && currentDepth == utf8JsonReader.CurrentDepth - 1)
                {
                    ...
                    switch (jsonPropertyName)
                    {
                        ...
                        case "resultCode":
                            ...
                            resultCode = new Option<StoredValueStatusChangeResponse.ResultCodeEnum?>(StoredValueStatusChangeResponse.ResultCodeEnum.FromStringOrDefault(resultCodeRawValue) ?? (StoredValueStatusChangeResponse.ResultCodeEnum)resultCodeRawValue);
                            break;
            ...
            var storedValueStatusChangeResponse = new StoredValueStatusChangeResponse();
            if (authCode.IsSet)
                storedValueStatusChangeResponse.AuthCode = authCode.Value;
            if (currentBalance.IsSet)
                storedValueStatusChangeResponse.CurrentBalance = currentBalance.Value;
            if (pspReference.IsSet)
                storedValueStatusChangeResponse.PspReference = pspReference.Value;
            if (refusalReason.IsSet)
                storedValueStatusChangeResponse.RefusalReason = refusalReason.Value;
            if (resultCode.IsSet)
                storedValueStatusChangeResponse.ResultCode = resultCode.Value;
            if (thirdPartyRefusalReason.IsSet)
                storedValueStatusChangeResponse.ThirdPartyRefusalReason = thirdPartyRefusalReason.Value;
        ...
        public void WriteProperties(Utf8JsonWriter writer, StoredValueStatusChangeResponse storedValueStatusChangeResponse, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (storedValueStatusChangeResponse._AuthCodeOption.IsSet)
                if (storedValueStatusChangeResponse.AuthCode != null)
            ...
            if (storedValueStatusChangeResponse._PspReferenceOption.IsSet)
                if (storedValueStatusChangeResponse.PspReference != null)
            ...
            if (storedValueStatusChangeResponse._RefusalReasonOption.IsSet)
                if (storedValueStatusChangeResponse.RefusalReason != null)
            ...
            if (storedValueStatusChangeResponse._ThirdPartyRefusalReasonOption.IsSet)
                if (storedValueStatusChangeResponse.ThirdPartyRefusalReason != null)
