...
namespace Adyen.StoredValue.Models
{
    ...
    /// </summary>
    public partial class StoredValueStatusChangeResponse : IValidatableObject
    {
        /// <summary>
        ...
        [JsonConstructor]
        public StoredValueStatusChangeResponse(Option<string?> authCode = default, Option<Amount?> currentBalance = default, Option<string?> pspReference = default, Option<string?> refusalReason = default, Option<ResultCodeEnum?> resultCode = default, Option<string?> thirdPartyRefusalReason = default)
        {
    ...
    /// <summary>
    /// A Json converter for type <see cref="StoredValueStatusChangeResponse" />
    /// </summary>
    public class StoredValueStatusChangeResponseJsonConverter : JsonConverter<StoredValueStatusChangeResponse>
    {
        /// <summary>
        /// Deserializes json to <see cref="StoredValueStatusChangeResponse"/>.
        /// </summary>
        ...
        public override StoredValueStatusChangeResponse Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            Option<StoredValueStatusChangeResponse.ResultCodeEnum?> resultCode = default;
                ...
                if (utf8JsonReader.TokenType == JsonTokenType.PropertyName && currentDepth == utf8JsonReader.CurrentDepth - 1)
                {
                    ...
                    switch (jsonPropertyName)
                    {
                        ...
                        case "resultCode":
                            ...
                            resultCode = new Option<StoredValueStatusChangeResponse.ResultCodeEnum?>(StoredValueStatusChangeResponse.ResultCodeEnum.FromStringOrDefault(resultCodeRawValue));
                            break;
            ...
            if (authCode.IsSet && authCode.Value == null)
                throw new ArgumentNullException(nameof(authCode), "Property is not nullable for class StoredValueStatusChangeResponse.");

            if (currentBalance.IsSet && currentBalance.Value == null)
                throw new ArgumentNullException(nameof(currentBalance), "Property is not nullable for class StoredValueStatusChangeResponse.");

            if (pspReference.IsSet && pspReference.Value == null)
                throw new ArgumentNullException(nameof(pspReference), "Property is not nullable for class StoredValueStatusChangeResponse.");

            if (refusalReason.IsSet && refusalReason.Value == null)
                throw new ArgumentNullException(nameof(refusalReason), "Property is not nullable for class StoredValueStatusChangeResponse.");

            if (resultCode.IsSet && resultCode.Value == null)
                throw new ArgumentNullException(nameof(resultCode), "Property is not nullable for class StoredValueStatusChangeResponse.");

            if (thirdPartyRefusalReason.IsSet && thirdPartyRefusalReason.Value == null)
                throw new ArgumentNullException(nameof(thirdPartyRefusalReason), "Property is not nullable for class StoredValueStatusChangeResponse.");

            return new StoredValueStatusChangeResponse(authCode, currentBalance, pspReference, refusalReason, resultCode, thirdPartyRefusalReason);
        }

        /// <summary>
        /// Serializes a <see cref="StoredValueStatusChangeResponse"/>.
        /// </summary>
        /// <param name="writer"><see cref="Utf8JsonWriter"/></param>
        /// <param name="storedValueStatusChangeResponse"></param>
        /// <param name="jsonSerializerOptions"><see cref="JsonSerializerOptions"/></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, StoredValueStatusChangeResponse storedValueStatusChangeResponse, JsonSerializerOptions jsonSerializerOptions)
        {
            
            writer.WriteStartObject();
            
            WriteProperties(writer, storedValueStatusChangeResponse, jsonSerializerOptions);
        ...
        /// <summary>
        /// Serializes the properties of <see cref="StoredValueStatusChangeResponse"/>.
        /// </summary>
        /// <param name="writer"><see creft="Utf8JsonWriter"/></param>
        /// <param name="storedValueStatusChangeResponse"></param>
        /// <param name="jsonSerializerOptions"><see cref="JsonSerializerOptions"/></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, StoredValueStatusChangeResponse storedValueStatusChangeResponse, JsonSerializerOptions jsonSerializerOptions)
        {
            /*
            if (storedValueStatusChangeResponse._AuthCodeOption.IsSet && storedValueStatusChangeResponse.AuthCode == null)
                throw new ArgumentNullException(nameof(storedValueStatusChangeResponse.AuthCode), "Property is required for class StoredValueStatusChangeResponse.");

            if (storedValueStatusChangeResponse._CurrentBalanceOption.IsSet && storedValueStatusChangeResponse.CurrentBalance == null)
                throw new ArgumentNullException(nameof(storedValueStatusChangeResponse.CurrentBalance), "Property is required for class StoredValueStatusChangeResponse.");

            if (storedValueStatusChangeResponse._PspReferenceOption.IsSet && storedValueStatusChangeResponse.PspReference == null)
                throw new ArgumentNullException(nameof(storedValueStatusChangeResponse.PspReference), "Property is required for class StoredValueStatusChangeResponse.");

            if (storedValueStatusChangeResponse._RefusalReasonOption.IsSet && storedValueStatusChangeResponse.RefusalReason == null)
                throw new ArgumentNullException(nameof(storedValueStatusChangeResponse.RefusalReason), "Property is required for class StoredValueStatusChangeResponse.");

            if (storedValueStatusChangeResponse._ThirdPartyRefusalReasonOption.IsSet && storedValueStatusChangeResponse.ThirdPartyRefusalReason == null)
                throw new ArgumentNullException(nameof(storedValueStatusChangeResponse.ThirdPartyRefusalReason), "Property is required for class StoredValueStatusChangeResponse.");

            */
            
            if (storedValueStatusChangeResponse._AuthCodeOption.IsSet)
                writer.WriteString("authCode", storedValueStatusChangeResponse.AuthCode);

            if (storedValueStatusChangeResponse._CurrentBalanceOption.IsSet)
            {
                writer.WritePropertyName("currentBalance");
                JsonSerializer.Serialize(writer, storedValueStatusChangeResponse.CurrentBalance, jsonSerializerOptions);
            }
            if (storedValueStatusChangeResponse._PspReferenceOption.IsSet)
                writer.WriteString("pspReference", storedValueStatusChangeResponse.PspReference);

            if (storedValueStatusChangeResponse._RefusalReasonOption.IsSet)
                writer.WriteString("refusalReason", storedValueStatusChangeResponse.RefusalReason);

            if (storedValueStatusChangeResponse._ResultCodeOption.IsSet && storedValueStatusChangeResponse.ResultCode != null) 
            {
                string? resultCodeRawValue = StoredValueStatusChangeResponse.ResultCodeEnum.ToJsonValue(storedValueStatusChangeResponse._ResultCodeOption.Value!.Value);
                writer.WriteString("resultCode", resultCodeRawValue);
            }
            
            if (storedValueStatusChangeResponse._ThirdPartyRefusalReasonOption.IsSet)
                writer.WriteString("thirdPartyRefusalReason", storedValueStatusChangeResponse.ThirdPartyRefusalReason);
        }
    }
}
