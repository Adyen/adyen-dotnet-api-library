    ...
    public class StoredValueBalanceCheckRequestJsonConverter : JsonConverter<StoredValueBalanceCheckRequest>
    {
        ...
        public override StoredValueBalanceCheckRequest Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (merchantAccount.IsSet && merchantAccount.Value == null)
                throw new ArgumentNullException(nameof(merchantAccount), "Property is not nullable for class StoredValueBalanceCheckRequest.");

            if (paymentMethod.IsSet && paymentMethod.Value == null)
                throw new ArgumentNullException(nameof(paymentMethod), "Property is not nullable for class StoredValueBalanceCheckRequest.");

            if (reference.IsSet && reference.Value == null)
                throw new ArgumentNullException(nameof(reference), "Property is not nullable for class StoredValueBalanceCheckRequest.");

            if (amount.IsSet && amount.Value == null)
                throw new ArgumentNullException(nameof(amount), "Property is not nullable for class StoredValueBalanceCheckRequest.");

            if (recurringDetailReference.IsSet && recurringDetailReference.Value == null)
                throw new ArgumentNullException(nameof(recurringDetailReference), "Property is not nullable for class StoredValueBalanceCheckRequest.");

            if (shopperInteraction.IsSet && shopperInteraction.Value == null)
                throw new ArgumentNullException(nameof(shopperInteraction), "Property is not nullable for class StoredValueBalanceCheckRequest.");

            if (shopperReference.IsSet && shopperReference.Value == null)
                throw new ArgumentNullException(nameof(shopperReference), "Property is not nullable for class StoredValueBalanceCheckRequest.");

            if (store.IsSet && store.Value == null)
                throw new ArgumentNullException(nameof(store), "Property is not nullable for class StoredValueBalanceCheckRequest.");
        ...
        public void WriteProperties(Utf8JsonWriter writer, StoredValueBalanceCheckRequest storedValueBalanceCheckRequest, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (storedValueBalanceCheckRequest.MerchantAccount == null)
                throw new ArgumentNullException(nameof(storedValueBalanceCheckRequest.MerchantAccount), "Property is required for class StoredValueBalanceCheckRequest.");

            if (storedValueBalanceCheckRequest.PaymentMethod == null)
                throw new ArgumentNullException(nameof(storedValueBalanceCheckRequest.PaymentMethod), "Property is required for class StoredValueBalanceCheckRequest.");

            if (storedValueBalanceCheckRequest.Reference == null)
                throw new ArgumentNullException(nameof(storedValueBalanceCheckRequest.Reference), "Property is required for class StoredValueBalanceCheckRequest.");

            if (storedValueBalanceCheckRequest._AmountOption.IsSet && storedValueBalanceCheckRequest.Amount == null)
                throw new ArgumentNullException(nameof(storedValueBalanceCheckRequest.Amount), "Property is required for class StoredValueBalanceCheckRequest.");

            if (storedValueBalanceCheckRequest._RecurringDetailReferenceOption.IsSet && storedValueBalanceCheckRequest.RecurringDetailReference == null)
                throw new ArgumentNullException(nameof(storedValueBalanceCheckRequest.RecurringDetailReference), "Property is required for class StoredValueBalanceCheckRequest.");

            if (storedValueBalanceCheckRequest._ShopperReferenceOption.IsSet && storedValueBalanceCheckRequest.ShopperReference == null)
                throw new ArgumentNullException(nameof(storedValueBalanceCheckRequest.ShopperReference), "Property is required for class StoredValueBalanceCheckRequest.");

            if (storedValueBalanceCheckRequest._StoreOption.IsSet && storedValueBalanceCheckRequest.Store == null)
                throw new ArgumentNullException(nameof(storedValueBalanceCheckRequest.Store), "Property is required for class StoredValueBalanceCheckRequest.");
