...
namespace Adyen.StoredValue.Models
{
    ...
    /// </summary>
    [JsonConverter(typeof(StoredValueBalanceCheckRequestJsonConverter))]
    public partial class StoredValueBalanceCheckRequest
    {
        /// <summary>
    ...
    public class StoredValueBalanceCheckRequestJsonConverter : JsonConverter<StoredValueBalanceCheckRequest>
    {
        ...
        public override StoredValueBalanceCheckRequest Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            var storedValueBalanceCheckRequest = new StoredValueBalanceCheckRequest();
            storedValueBalanceCheckRequest.MerchantAccount = merchantAccount.Value!;
            storedValueBalanceCheckRequest.PaymentMethod = paymentMethod.Value!;
            storedValueBalanceCheckRequest.Reference = reference.Value!;
            if (amount.IsSet)
                storedValueBalanceCheckRequest.Amount = amount.Value;
            if (recurringDetailReference.IsSet)
                storedValueBalanceCheckRequest.RecurringDetailReference = recurringDetailReference.Value;
            if (shopperInteraction.IsSet)
                storedValueBalanceCheckRequest.ShopperInteraction = shopperInteraction.Value;
            if (shopperReference.IsSet)
                storedValueBalanceCheckRequest.ShopperReference = shopperReference.Value;
            if (store.IsSet)
                storedValueBalanceCheckRequest.Store = store.Value;
            return storedValueBalanceCheckRequest;
        }
