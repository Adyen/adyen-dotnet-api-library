    ...
    public class StoredValueBalanceMergeRequestJsonConverter : JsonConverter<StoredValueBalanceMergeRequest>
    {
        ...
        public override StoredValueBalanceMergeRequest Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (merchantAccount.IsSet && merchantAccount.Value == null)
                throw new ArgumentNullException(nameof(merchantAccount), "Property is not nullable for class StoredValueBalanceMergeRequest.");

            if (paymentMethod.IsSet && paymentMethod.Value == null)
                throw new ArgumentNullException(nameof(paymentMethod), "Property is not nullable for class StoredValueBalanceMergeRequest.");

            if (reference.IsSet && reference.Value == null)
                throw new ArgumentNullException(nameof(reference), "Property is not nullable for class StoredValueBalanceMergeRequest.");

            if (sourcePaymentMethod.IsSet && sourcePaymentMethod.Value == null)
                throw new ArgumentNullException(nameof(sourcePaymentMethod), "Property is not nullable for class StoredValueBalanceMergeRequest.");

            if (amount.IsSet && amount.Value == null)
                throw new ArgumentNullException(nameof(amount), "Property is not nullable for class StoredValueBalanceMergeRequest.");

            if (recurringDetailReference.IsSet && recurringDetailReference.Value == null)
                throw new ArgumentNullException(nameof(recurringDetailReference), "Property is not nullable for class StoredValueBalanceMergeRequest.");

            if (shopperInteraction.IsSet && shopperInteraction.Value == null)
                throw new ArgumentNullException(nameof(shopperInteraction), "Property is not nullable for class StoredValueBalanceMergeRequest.");

            if (shopperReference.IsSet && shopperReference.Value == null)
                throw new ArgumentNullException(nameof(shopperReference), "Property is not nullable for class StoredValueBalanceMergeRequest.");

            if (store.IsSet && store.Value == null)
                throw new ArgumentNullException(nameof(store), "Property is not nullable for class StoredValueBalanceMergeRequest.");
        ...
        public void WriteProperties(Utf8JsonWriter writer, StoredValueBalanceMergeRequest storedValueBalanceMergeRequest, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (storedValueBalanceMergeRequest.MerchantAccount == null)
                throw new ArgumentNullException(nameof(storedValueBalanceMergeRequest.MerchantAccount), "Property is required for class StoredValueBalanceMergeRequest.");

            if (storedValueBalanceMergeRequest.PaymentMethod == null)
                throw new ArgumentNullException(nameof(storedValueBalanceMergeRequest.PaymentMethod), "Property is required for class StoredValueBalanceMergeRequest.");

            if (storedValueBalanceMergeRequest.Reference == null)
                throw new ArgumentNullException(nameof(storedValueBalanceMergeRequest.Reference), "Property is required for class StoredValueBalanceMergeRequest.");

            if (storedValueBalanceMergeRequest.SourcePaymentMethod == null)
                throw new ArgumentNullException(nameof(storedValueBalanceMergeRequest.SourcePaymentMethod), "Property is required for class StoredValueBalanceMergeRequest.");

            if (storedValueBalanceMergeRequest._AmountOption.IsSet && storedValueBalanceMergeRequest.Amount == null)
                throw new ArgumentNullException(nameof(storedValueBalanceMergeRequest.Amount), "Property is required for class StoredValueBalanceMergeRequest.");

            if (storedValueBalanceMergeRequest._RecurringDetailReferenceOption.IsSet && storedValueBalanceMergeRequest.RecurringDetailReference == null)
                throw new ArgumentNullException(nameof(storedValueBalanceMergeRequest.RecurringDetailReference), "Property is required for class StoredValueBalanceMergeRequest.");

            if (storedValueBalanceMergeRequest._ShopperReferenceOption.IsSet && storedValueBalanceMergeRequest.ShopperReference == null)
                throw new ArgumentNullException(nameof(storedValueBalanceMergeRequest.ShopperReference), "Property is required for class StoredValueBalanceMergeRequest.");

            if (storedValueBalanceMergeRequest._StoreOption.IsSet && storedValueBalanceMergeRequest.Store == null)
                throw new ArgumentNullException(nameof(storedValueBalanceMergeRequest.Store), "Property is required for class StoredValueBalanceMergeRequest.");
