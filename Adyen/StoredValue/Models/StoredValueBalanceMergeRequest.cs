...
namespace Adyen.StoredValue.Models
{
    ...
    /// </summary>
    [JsonConverter(typeof(StoredValueBalanceMergeRequestJsonConverter))]
    ...
    public class StoredValueBalanceMergeRequestJsonConverter : JsonConverter<StoredValueBalanceMergeRequest>
    {
        ...
        public override StoredValueBalanceMergeRequest Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
                ...
                if (utf8JsonReader.TokenType == JsonTokenType.PropertyName && currentDepth == utf8JsonReader.CurrentDepth - 1)
                {
                    ...
                    switch (jsonPropertyName)
                    {
                        ...
                        case "shopperInteraction":
                            ...
                            shopperInteraction = new Option<StoredValueBalanceMergeRequest.ShopperInteractionEnum?>(StoredValueBalanceMergeRequest.ShopperInteractionEnum.FromStringOrDefault(shopperInteractionRawValue) ?? (StoredValueBalanceMergeRequest.ShopperInteractionEnum)shopperInteractionRawValue);
                            break;
            ...
            if (recurringDetailReference.IsSet)
                storedValueBalanceMergeRequest.RecurringDetailReference = recurringDetailReference.Value;
            if (shopperInteraction.IsSet)
                storedValueBalanceMergeRequest.ShopperInteraction = shopperInteraction.Value;
            if (shopperReference.IsSet)
                storedValueBalanceMergeRequest.ShopperReference = shopperReference.Value;
            if (store.IsSet)
                storedValueBalanceMergeRequest.Store = store.Value;
            return storedValueBalanceMergeRequest;
        }
