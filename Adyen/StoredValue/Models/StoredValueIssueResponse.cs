...
namespace Adyen.StoredValue.Models
{
    ...
    /// </summary>
    public partial class StoredValueIssueResponse : IValidatableObject
    {
        /// <summary>
    ...
    public class StoredValueIssueResponseJsonConverter : JsonConverter<StoredValueIssueResponse>
    {
        ...
        public override StoredValueIssueResponse Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (authCode.IsSet && authCode.Value == null)
                throw new ArgumentNullException(nameof(authCode), "Property is not nullable for class StoredValueIssueResponse.");

            if (currentBalance.IsSet && currentBalance.Value == null)
                throw new ArgumentNullException(nameof(currentBalance), "Property is not nullable for class StoredValueIssueResponse.");

            if (paymentMethod.IsSet && paymentMethod.Value == null)
                throw new ArgumentNullException(nameof(paymentMethod), "Property is not nullable for class StoredValueIssueResponse.");

            if (pspReference.IsSet && pspReference.Value == null)
                throw new ArgumentNullException(nameof(pspReference), "Property is not nullable for class StoredValueIssueResponse.");

            if (refusalReason.IsSet && refusalReason.Value == null)
                throw new ArgumentNullException(nameof(refusalReason), "Property is not nullable for class StoredValueIssueResponse.");

            if (resultCode.IsSet && resultCode.Value == null)
                throw new ArgumentNullException(nameof(resultCode), "Property is not nullable for class StoredValueIssueResponse.");

            if (thirdPartyRefusalReason.IsSet && thirdPartyRefusalReason.Value == null)
                throw new ArgumentNullException(nameof(thirdPartyRefusalReason), "Property is not nullable for class StoredValueIssueResponse.");
        ...
        {
            /*
            if (storedValueIssueResponse._AuthCodeOption.IsSet && storedValueIssueResponse.AuthCode == null)
                throw new ArgumentNullException(nameof(storedValueIssueResponse.AuthCode), "Property is required for class StoredValueIssueResponse.");

            if (storedValueIssueResponse._CurrentBalanceOption.IsSet && storedValueIssueResponse.CurrentBalance == null)
                throw new ArgumentNullException(nameof(storedValueIssueResponse.CurrentBalance), "Property is required for class StoredValueIssueResponse.");

            if (storedValueIssueResponse._PaymentMethodOption.IsSet && storedValueIssueResponse.PaymentMethod == null)
                throw new ArgumentNullException(nameof(storedValueIssueResponse.PaymentMethod), "Property is required for class StoredValueIssueResponse.");

            if (storedValueIssueResponse._PspReferenceOption.IsSet && storedValueIssueResponse.PspReference == null)
                throw new ArgumentNullException(nameof(storedValueIssueResponse.PspReference), "Property is required for class StoredValueIssueResponse.");

            if (storedValueIssueResponse._RefusalReasonOption.IsSet && storedValueIssueResponse.RefusalReason == null)
                throw new ArgumentNullException(nameof(storedValueIssueResponse.RefusalReason), "Property is required for class StoredValueIssueResponse.");

            if (storedValueIssueResponse._ThirdPartyRefusalReasonOption.IsSet && storedValueIssueResponse.ThirdPartyRefusalReason == null)
                throw new ArgumentNullException(nameof(storedValueIssueResponse.ThirdPartyRefusalReason), "Property is required for class StoredValueIssueResponse.");
