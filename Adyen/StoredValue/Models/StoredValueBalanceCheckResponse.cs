...
namespace Adyen.StoredValue.Models
{
    ...
    /// </summary>
    [JsonConverter(typeof(StoredValueBalanceCheckResponseJsonConverter))]
    public partial class StoredValueBalanceCheckResponse
    {
        /// <summary>
    ...
    public class StoredValueBalanceCheckResponseJsonConverter : JsonConverter<StoredValueBalanceCheckResponse>
    {
        ...
        public override StoredValueBalanceCheckResponse Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
                ...
                if (utf8JsonReader.TokenType == JsonTokenType.PropertyName && currentDepth == utf8JsonReader.CurrentDepth - 1)
                {
                    ...
                    switch (jsonPropertyName)
                    {
                        ...
                        case "resultCode":
                            ...
                            resultCode = new Option<StoredValueBalanceCheckResponse.ResultCodeEnum?>(StoredValueBalanceCheckResponse.ResultCodeEnum.FromStringOrDefault(resultCodeRawValue) ?? (StoredValueBalanceCheckResponse.ResultCodeEnum)resultCodeRawValue);
                            break;
            ...
            var storedValueBalanceCheckResponse = new StoredValueBalanceCheckResponse();
            if (currentBalance.IsSet)
                storedValueBalanceCheckResponse.CurrentBalance = currentBalance.Value;
            if (pspReference.IsSet)
                storedValueBalanceCheckResponse.PspReference = pspReference.Value;
            if (refusalReason.IsSet)
                storedValueBalanceCheckResponse.RefusalReason = refusalReason.Value;
            if (resultCode.IsSet)
                storedValueBalanceCheckResponse.ResultCode = resultCode.Value;
            if (thirdPartyRefusalReason.IsSet)
                storedValueBalanceCheckResponse.ThirdPartyRefusalReason = thirdPartyRefusalReason.Value;
        ...
        public void WriteProperties(Utf8JsonWriter writer, StoredValueBalanceCheckResponse storedValueBalanceCheckResponse, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (storedValueBalanceCheckResponse._PspReferenceOption.IsSet)
                if (storedValueBalanceCheckResponse.PspReference != null)
            ...
            if (storedValueBalanceCheckResponse._RefusalReasonOption.IsSet)
                if (storedValueBalanceCheckResponse.RefusalReason != null)
            ...
            if (storedValueBalanceCheckResponse._ThirdPartyRefusalReasonOption.IsSet)
                if (storedValueBalanceCheckResponse.ThirdPartyRefusalReason != null)
