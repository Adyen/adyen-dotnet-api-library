...
namespace Adyen.StoredValue.Models
{
    ...
    /// </summary>
    [JsonConverter(typeof(StoredValueBalanceMergeResponseJsonConverter))]
    public partial class StoredValueBalanceMergeResponse
    {
        /// <summary>
    ...
    public class StoredValueBalanceMergeResponseJsonConverter : JsonConverter<StoredValueBalanceMergeResponse>
    {
        ...
        public override StoredValueBalanceMergeResponse Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
                ...
                if (utf8JsonReader.TokenType == JsonTokenType.PropertyName && currentDepth == utf8JsonReader.CurrentDepth - 1)
                {
                    ...
                    switch (jsonPropertyName)
                    {
                        ...
                        case "resultCode":
                            ...
                            resultCode = new Option<StoredValueBalanceMergeResponse.ResultCodeEnum?>(StoredValueBalanceMergeResponse.ResultCodeEnum.FromStringOrDefault(resultCodeRawValue) ?? (StoredValueBalanceMergeResponse.ResultCodeEnum)resultCodeRawValue);
                            break;
            ...
            if (currentBalance.IsSet)
                storedValueBalanceMergeResponse.CurrentBalance = currentBalance.Value;
            if (pspReference.IsSet)
                storedValueBalanceMergeResponse.PspReference = pspReference.Value;
            if (refusalReason.IsSet)
                storedValueBalanceMergeResponse.RefusalReason = refusalReason.Value;
            if (resultCode.IsSet)
                storedValueBalanceMergeResponse.ResultCode = resultCode.Value;
            if (thirdPartyRefusalReason.IsSet)
                storedValueBalanceMergeResponse.ThirdPartyRefusalReason = thirdPartyRefusalReason.Value;
        ...
        public void WriteProperties(Utf8JsonWriter writer, StoredValueBalanceMergeResponse storedValueBalanceMergeResponse, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (storedValueBalanceMergeResponse._AuthCodeOption.IsSet)
                if (storedValueBalanceMergeResponse.AuthCode != null)
            ...
            if (storedValueBalanceMergeResponse._PspReferenceOption.IsSet)
                if (storedValueBalanceMergeResponse.PspReference != null)
            ...
            if (storedValueBalanceMergeResponse._RefusalReasonOption.IsSet)
                if (storedValueBalanceMergeResponse.RefusalReason != null)
            ...
            if (storedValueBalanceMergeResponse._ThirdPartyRefusalReasonOption.IsSet)
                if (storedValueBalanceMergeResponse.ThirdPartyRefusalReason != null)
