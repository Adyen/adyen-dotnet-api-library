    ...
    public class ResourceJsonConverter : JsonConverter<Resource>
    {
        ...
        public override Resource Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (balancePlatform.IsSet && balancePlatform.Value == null)
                throw new ArgumentNullException(nameof(balancePlatform), "Property is not nullable for class Resource.");

            if (creationDate.IsSet && creationDate.Value == null)
                throw new ArgumentNullException(nameof(creationDate), "Property is not nullable for class Resource.");
        ...
        {
            /*
            if (resource._BalancePlatformOption.IsSet && resource.BalancePlatform == null)
                throw new ArgumentNullException(nameof(resource.BalancePlatform), "Property is required for class Resource.");

            if (resource._IdOption.IsSet && resource.Id == null)
                throw new ArgumentNullException(nameof(resource.Id), "Property is required for class Resource.");
