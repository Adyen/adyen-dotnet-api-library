    ...
    public class TransactionJsonConverter : JsonConverter<Transaction>
    {
        ...
        public override Transaction Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (paymentInstrument.IsSet)
                transaction.PaymentInstrument = paymentInstrument.Value;
            if (referenceForBeneficiary.IsSet)
                transaction.ReferenceForBeneficiary = referenceForBeneficiary.Value;
            if (transfer.IsSet)
                transaction.Transfer = transfer.Value;
            return transaction;
        }
