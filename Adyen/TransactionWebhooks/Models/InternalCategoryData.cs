    ...
    public class InternalCategoryDataJsonConverter : JsonConverter<InternalCategoryData>
    {
        ...
        public override InternalCategoryData Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (modificationMerchantReference.IsSet && modificationMerchantReference.Value == null)
                throw new ArgumentNullException(nameof(modificationMerchantReference), "Property is not nullable for class InternalCategoryData.");

            if (modificationPspReference.IsSet && modificationPspReference.Value == null)
                throw new ArgumentNullException(nameof(modificationPspReference), "Property is not nullable for class InternalCategoryData.");

            if (type.IsSet && type.Value == null)
                throw new ArgumentNullException(nameof(type), "Property is not nullable for class InternalCategoryData.");
        ...
        {
            /*
            if (internalCategoryData._ModificationMerchantReferenceOption.IsSet && internalCategoryData.ModificationMerchantReference == null)
                throw new ArgumentNullException(nameof(internalCategoryData.ModificationMerchantReference), "Property is required for class InternalCategoryData.");

            if (internalCategoryData._ModificationPspReferenceOption.IsSet && internalCategoryData.ModificationPspReference == null)
                throw new ArgumentNullException(nameof(internalCategoryData.ModificationPspReference), "Property is required for class InternalCategoryData.");
