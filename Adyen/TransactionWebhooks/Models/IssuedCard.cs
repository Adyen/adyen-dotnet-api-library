...
namespace Adyen.TransactionWebhooks.Models
{
    ...
    public partial class IssuedCard
    {
        ...
        public IssuedCard()
        {
            _TypeOption = TypeEnum.IssuedCard;
            OnCreated();
        }
        ...
        public class PanEntryModeEnum : IEnum
        {
            ...
            /// <summary>
            /// Compares two <see cref="PanEntryModeEnum"/> instances for equality.
            /// </summary>
            ...
            /// <summary>
            /// Compares two <see cref="PanEntryModeEnum"/> instances for inequality.
            /// </summary>
            public static bool operator !=(PanEntryModeEnum? left, PanEntryModeEnum? right) => !string.Equals(left?.Value, right?.Value, StringComparison.OrdinalIgnoreCase);

            /// <summary>
            /// Returns true if the given object is equal to this <see cref="PanEntryModeEnum"/> instance.
            /// </summary>
            ...
            /// <summary>
            /// Returns a hash code for this <see cref="PanEntryModeEnum"/> instance.
            /// </summary>
            public override int GetHashCode() => Value?.GetHashCode() ?? 0;

            /// <summary>
            /// Returns the string value of the <see cref="PanEntryModeEnum"/> instance.
            /// </summary>
            ...
            {
                /// <summary>
                /// Deserializes a <see cref="PanEntryModeEnum"/> from JSON.
                /// </summary>
                ...
                /// <summary>
                /// Serializes a <see cref="PanEntryModeEnum"/> to JSON.
                /// </summary>
    ...
    public class IssuedCardJsonConverter : JsonConverter<IssuedCard>
    {
        ...
        public override IssuedCard Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (processingType.IsSet)
                issuedCard.ProcessingType = processingType.Value;
            if (relayedAuthorisationData.IsSet)
                issuedCard.RelayedAuthorisationData = relayedAuthorisationData.Value;
            if (schemeTraceId.IsSet)
                issuedCard.SchemeTraceId = schemeTraceId.Value;
            if (schemeUniqueTransactionId.IsSet)
                issuedCard.SchemeUniqueTransactionId = schemeUniqueTransactionId.Value;
            if (threeDSecure.IsSet)
                issuedCard.ThreeDSecure = threeDSecure.Value;
            if (type.IsSet)
                issuedCard.Type = type.Value;
            if (validationFacts.IsSet)
                issuedCard.ValidationFacts = validationFacts.Value;
            return issuedCard;
        }
