...
namespace Adyen.TransactionWebhooks.Models
{
    ...
    public partial class IssuedCard : IValidatableObject
    {
        ...
        /// <summary>
        /// Used to track whether PanEntryMode is set or not.
        /// </summary>
        [JsonIgnore]
        ...
        /// <summary>
        /// Used to track whether ProcessingType is set or not.
        /// </summary>
        [JsonIgnore]
        [global::System.ComponentModel.EditorBrowsable(global::System.ComponentModel.EditorBrowsableState.Never)]
    ...
    public class IssuedCardJsonConverter : JsonConverter<IssuedCard>
    {
        ...
        public override IssuedCard Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (authorisationType.IsSet && authorisationType.Value == null)
                throw new ArgumentNullException(nameof(authorisationType), "Property is not nullable for class IssuedCard.");

            if (panEntryMode.IsSet && panEntryMode.Value == null)
                throw new ArgumentNullException(nameof(panEntryMode), "Property is not nullable for class IssuedCard.");

            if (processingType.IsSet && processingType.Value == null)
                throw new ArgumentNullException(nameof(processingType), "Property is not nullable for class IssuedCard.");

            if (relayedAuthorisationData.IsSet && relayedAuthorisationData.Value == null)
                throw new ArgumentNullException(nameof(relayedAuthorisationData), "Property is not nullable for class IssuedCard.");

            if (schemeTraceId.IsSet && schemeTraceId.Value == null)
                throw new ArgumentNullException(nameof(schemeTraceId), "Property is not nullable for class IssuedCard.");

            if (schemeUniqueTransactionId.IsSet && schemeUniqueTransactionId.Value == null)
                throw new ArgumentNullException(nameof(schemeUniqueTransactionId), "Property is not nullable for class IssuedCard.");

            if (threeDSecure.IsSet && threeDSecure.Value == null)
                throw new ArgumentNullException(nameof(threeDSecure), "Property is not nullable for class IssuedCard.");

            if (type.IsSet && type.Value == null)
                throw new ArgumentNullException(nameof(type), "Property is not nullable for class IssuedCard.");

            if (validationFacts.IsSet && validationFacts.Value == null)
                throw new ArgumentNullException(nameof(validationFacts), "Property is not nullable for class IssuedCard.");
        ...
        {
            /*
            if (issuedCard._AuthorisationTypeOption.IsSet && issuedCard.AuthorisationType == null)
                throw new ArgumentNullException(nameof(issuedCard.AuthorisationType), "Property is required for class IssuedCard.");

            if (issuedCard._RelayedAuthorisationDataOption.IsSet && issuedCard.RelayedAuthorisationData == null)
                throw new ArgumentNullException(nameof(issuedCard.RelayedAuthorisationData), "Property is required for class IssuedCard.");

            if (issuedCard._SchemeTraceIdOption.IsSet && issuedCard.SchemeTraceId == null)
                throw new ArgumentNullException(nameof(issuedCard.SchemeTraceId), "Property is required for class IssuedCard.");

            if (issuedCard._SchemeUniqueTransactionIdOption.IsSet && issuedCard.SchemeUniqueTransactionId == null)
                throw new ArgumentNullException(nameof(issuedCard.SchemeUniqueTransactionId), "Property is required for class IssuedCard.");

            if (issuedCard._ThreeDSecureOption.IsSet && issuedCard.ThreeDSecure == null)
                throw new ArgumentNullException(nameof(issuedCard.ThreeDSecure), "Property is required for class IssuedCard.");

            if (issuedCard._ValidationFactsOption.IsSet && issuedCard.ValidationFacts == null)
                throw new ArgumentNullException(nameof(issuedCard.ValidationFacts), "Property is required for class IssuedCard.");
