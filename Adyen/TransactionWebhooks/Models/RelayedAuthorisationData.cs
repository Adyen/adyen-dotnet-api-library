    ...
    public class RelayedAuthorisationDataJsonConverter : JsonConverter<RelayedAuthorisationData>
    {
        ...
        public override RelayedAuthorisationData Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (metadata.IsSet && metadata.Value == null)
                throw new ArgumentNullException(nameof(metadata), "Property is not nullable for class RelayedAuthorisationData.");

            if (reference.IsSet && reference.Value == null)
                throw new ArgumentNullException(nameof(reference), "Property is not nullable for class RelayedAuthorisationData.");
        ...
        {
            /*
            if (relayedAuthorisationData._MetadataOption.IsSet && relayedAuthorisationData.Metadata == null)
                throw new ArgumentNullException(nameof(relayedAuthorisationData.Metadata), "Property is required for class RelayedAuthorisationData.");

            if (relayedAuthorisationData._ReferenceOption.IsSet && relayedAuthorisationData.Reference == null)
                throw new ArgumentNullException(nameof(relayedAuthorisationData.Reference), "Property is required for class RelayedAuthorisationData.");
