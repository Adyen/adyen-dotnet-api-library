...
namespace Adyen.TransactionWebhooks.Models
{
    ...
    /// </summary>
    public partial class TransactionNotificationRequestV4 : IValidatableObject
    {
        /// <summary>
    ...
    public class TransactionNotificationRequestV4JsonConverter : JsonConverter<TransactionNotificationRequestV4>
    {
        ...
        public override TransactionNotificationRequestV4 Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (data.IsSet && data.Value == null)
                throw new ArgumentNullException(nameof(data), "Property is not nullable for class TransactionNotificationRequestV4.");

            if (environment.IsSet && environment.Value == null)
                throw new ArgumentNullException(nameof(environment), "Property is not nullable for class TransactionNotificationRequestV4.");

            if (timestamp.IsSet && timestamp.Value == null)
                throw new ArgumentNullException(nameof(timestamp), "Property is not nullable for class TransactionNotificationRequestV4.");

            if (type.IsSet && type.Value == null)
                throw new ArgumentNullException(nameof(type), "Property is not nullable for class TransactionNotificationRequestV4.");
        ...
        {
            /*
            if (transactionNotificationRequestV4.Data == null)
                throw new ArgumentNullException(nameof(transactionNotificationRequestV4.Data), "Property is required for class TransactionNotificationRequestV4.");

            if (transactionNotificationRequestV4.Environment == null)
                throw new ArgumentNullException(nameof(transactionNotificationRequestV4.Environment), "Property is required for class TransactionNotificationRequestV4.");
