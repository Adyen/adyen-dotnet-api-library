...
namespace Adyen.Payment.Services
{
    ...
    public interface IModificationsService : IAdyenApiService
    {
        ...
        /// </summary>
        /// <remarks>
        /// Allows you to increase or decrease the authorised amount after the initial authorisation has taken place. This functionality enables for example tipping, improving the chances your authorisation will be valid, or charging the shopper when they have already left the merchant premises.  &gt; This endpoint is [inactive](https://docs.adyen.com/online-payments/upgrade-your-integration#checkout-api-lifecycle) and is no longer supported for new integrations. &gt; * If you are building a new integration, use the Checkout API [&#x60;/payments/{paymentPspReference}/amountUpdates&#x60;](https://docs.adyen.com/api-explorer/Checkout/latest/post/payments/(paymentPspReference)/amountUpdates) endpoint instead. &gt; * If you have an existing integration using this endpoint, reach out to your Adyen contact and [migrate to the Checkout API](https://docs.adyen.com/online-payments/upgrade-your-integration/migrate-to-checkout-api).  &gt;The Checkout API enables your [online payments](https://docs.adyen.com/online-payments) integration to accept all supported payment methods, use the latest features, and access more benefits.
        /// </remarks>
        ...
        Task<IAdjustAuthorisationApiResponse> AdjustAuthorisationAsync(AdjustAuthorisationRequest adjustAuthorisationRequest,  RequestOptions? requestOptions = default, System.Threading.CancellationToken cancellationToken = default);
        ...
        Task<ICancelOrRefundApiResponse> CancelOrRefundAsync(CancelOrRefundRequest cancelOrRefundRequest,  RequestOptions? requestOptions = default, System.Threading.CancellationToken cancellationToken = default);

        /// <summary>
        /// Capture an authorisation
        /// </summary>
        /// <remarks>
        /// Captures the authorisation hold on a payment, returning a unique reference for this request. Usually the full authorisation amount is captured, however it&#39;s also possible to capture a smaller amount, which results in cancelling the remaining authorisation balance.  Payment methods that are captured automatically after authorisation don&#39;t need to be captured. However, submitting a capture request on these transactions will not result in double charges. If immediate or delayed auto-capture is enabled, calling the capture method is not necessary.  For more information refer to [Capture](https://docs.adyen.com/online-payments/classic-integrations/modify-payments/capture).  &gt; This endpoint is [inactive](https://docs.adyen.com/online-payments/upgrade-your-integration#checkout-api-lifecycle) and is no longer supported for new integrations. &gt; * If you are building a new integration, use the Checkout API [&#x60;/payments/{paymentPspReference}/captures&#x60;](https://docs.adyen.com/api-explorer/Checkout/latest/post/payments/(paymentPspReference)/captures) endpoint instead. &gt; * If you have an existing integration using this endpoint, reach out to your Adyen contact and [migrate to the Checkout API](https://docs.adyen.com/online-payments/upgrade-your-integration/migrate-to-checkout-api).  &gt; The Checkout API enables your [online payments](https://docs.adyen.com/online-payments) integration to accept all supported payment methods, use the latest features, and access more benefits.
        /// </remarks>
        /// <exception cref="ApiException">Thrown when fails to make API call.</exception>
        ...
        Task<ICaptureApiResponse> CaptureAsync(CaptureRequest captureRequest,  RequestOptions? requestOptions = default, System.Threading.CancellationToken cancellationToken = default);
        ...
        /* Deprecated */
        [Obsolete("")]
        Task<IDonateApiResponse> DonateAsync(DonationRequest donationRequest,  RequestOptions? requestOptions = default, System.Threading.CancellationToken cancellationToken = default);

        /// <summary>
        /// Refund a captured payment
        /// </summary>
        /// <remarks>
        /// Refunds a payment that has previously been captured, returning a unique reference for this request. Refunding can be done on the full captured amount or a partial amount. Multiple (partial) refunds will be accepted as long as their sum doesn&#39;t exceed the captured amount. Payments which have been authorised, but not captured, cannot be refunded, use the /cancel method instead.  Some payment methods/gateways do not support partial/multiple refunds. A margin above the captured limit can be configured to cover shipping/handling costs.  For more information, refer to [Refund](https://docs.adyen.com/online-payments/classic-integrations/modify-payments/refund).  &gt; This endpoint is [inactive](https://docs.adyen.com/online-payments/upgrade-your-integration#checkout-api-lifecycle) and is no longer supported for new integrations. &gt; * If you are building a new integration, use the Checkout API [&#x60;/payments/{paymentPspReference}/refunds&#x60;](https://docs.adyen.com/api-explorer/Checkout/latest/post/payments/(paymentPspReference)/refunds) endpoint instead. &gt; * If you have an existing integration using this endpoint, reach out to your Adyen contact and [migrate to the Checkout API](https://docs.adyen.com/online-payments/upgrade-your-integration/migrate-to-checkout-api).  &gt; The Checkout API enables your [online payments](https://docs.adyen.com/online-payments) integration to accept all supported payment methods, use the latest features, and access more benefits.
        /// </remarks>
        /// <exception cref="ApiException">Thrown when fails to make API call.</exception>
        ...
        Task<IRefundApiResponse> RefundAsync(RefundRequest refundRequest,  RequestOptions? requestOptions = default, System.Threading.CancellationToken cancellationToken = default);

        /// <summary>
        /// Cancel an authorisation using your reference
        /// </summary>
        /// <remarks>
        /// This endpoint allows you to cancel a payment if you do not have the PSP reference of the original payment request available.  In your call, refer to the original payment by using the &#x60;reference&#x60; that you specified in your payment request.  For more information, see [Technical cancel](https://docs.adyen.com/online-payments/classic-integrations/modify-payments/cancel#technical-cancel).   &gt; This endpoint is [inactive](https://docs.adyen.com/online-payments/upgrade-your-integration#checkout-api-lifecycle) and is no longer supported for new integrations. &gt; * If you are building a new integration, use the Checkout API [&#x60;/cancels&#x60;](https://docs.adyen.com/api-explorer/Checkout/latest/post/cancels) endpoint instead. &gt; * If you have an existing integration using this endpoint, reach out to your Adyen contact and [migrate to the Checkout API](https://docs.adyen.com/online-payments/upgrade-your-integration/migrate-to-checkout-api).  &gt; The Checkout API enables your [online payments](https://docs.adyen.com/online-payments) integration to accept all supported payment methods, use the latest features, and access more benefits.
        /// </remarks>
        /// <exception cref="ApiException">Thrown when fails to make API call.</exception>
        ...
        Task<ITechnicalCancelApiResponse> TechnicalCancelAsync(TechnicalCancelRequest technicalCancelRequest,  RequestOptions? requestOptions = default, System.Threading.CancellationToken cancellationToken = default);
        ...
        Task<IVoidPendingRefundApiResponse> VoidPendingRefundAsync(VoidPendingRefundRequest voidPendingRefundRequest,  RequestOptions? requestOptions = default, System.Threading.CancellationToken cancellationToken = default);

    }

    /// <summary>
    /// The <see cref="IAdjustAuthorisationApiResponse"/>, wraps <see cref="Adyen.Payment.Models.ModificationResult"/>.
    /// </summary>
    ...
    /// <summary>
    /// The <see cref="ICancelApiResponse"/>, wraps <see cref="Adyen.Payment.Models.ModificationResult"/>.
    /// </summary>
    ...
    /// <summary>
    /// The <see cref="ICancelOrRefundApiResponse"/>, wraps <see cref="Adyen.Payment.Models.ModificationResult"/>.
    /// </summary>
    ...
    /// <summary>
    /// The <see cref="ICaptureApiResponse"/>, wraps <see cref="Adyen.Payment.Models.ModificationResult"/>.
    /// </summary>
    ...
    /// <summary>
    /// The <see cref="IDonateApiResponse"/>, wraps <see cref="Adyen.Payment.Models.ModificationResult"/>.
    /// </summary>
    ...
    /// <summary>
    /// The <see cref="IRefundApiResponse"/>, wraps <see cref="Adyen.Payment.Models.ModificationResult"/>.
    /// </summary>
    ...
    /// <summary>
    /// The <see cref="ITechnicalCancelApiResponse"/>, wraps <see cref="Adyen.Payment.Models.ModificationResult"/>.
    /// </summary>
    ...
    /// <summary>
    /// The <see cref="IVoidPendingRefundApiResponse"/>, wraps <see cref="Adyen.Payment.Models.ModificationResult"/>.
    /// </summary>
    ...
    public sealed partial class ModificationsService : IModificationsService
    {
        ...
        /// </summary>
        private const string BASE_URL = "https://pal-test.adyen.com/pal/servlet/Payment/v68";
        ...
        /// <summary>
        /// Change the authorised amount Allows you to increase or decrease the authorised amount after the initial authorisation has taken place. This functionality enables for example tipping, improving the chances your authorisation will be valid, or charging the shopper when they have already left the merchant premises.  &gt; This endpoint is [inactive](https://docs.adyen.com/online-payments/upgrade-your-integration#checkout-api-lifecycle) and is no longer supported for new integrations. &gt; * If you are building a new integration, use the Checkout API [&#x60;/payments/{paymentPspReference}/amountUpdates&#x60;](https://docs.adyen.com/api-explorer/Checkout/latest/post/payments/(paymentPspReference)/amountUpdates) endpoint instead. &gt; * If you have an existing integration using this endpoint, reach out to your Adyen contact and [migrate to the Checkout API](https://docs.adyen.com/online-payments/upgrade-your-integration/migrate-to-checkout-api).  &gt;The Checkout API enables your [online payments](https://docs.adyen.com/online-payments) integration to accept all supported payment methods, use the latest features, and access more benefits.
        /// </summary>
        /// <exception cref="ApiException">Thrown when fails to make API call.</exception>
        ...
        public async Task<IAdjustAuthorisationApiResponse> AdjustAuthorisationAsync(AdjustAuthorisationRequest adjustAuthorisationRequest,  RequestOptions? requestOptions = default, System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                using (HttpRequestMessage httpRequestMessage = new HttpRequestMessage())
                {
                    ...
                    httpRequestMessage.Content = (adjustAuthorisationRequest as object) is System.IO.Stream stream
                        ? httpRequestMessage.Content = new StreamContent(stream)
                        : httpRequestMessage.Content = new StringContent(JsonSerializer.Serialize(adjustAuthorisationRequest, _jsonSerializerOptions));
        ...
        public async Task<ICancelApiResponse> CancelAsync(CancelRequest cancelRequest,  RequestOptions? requestOptions = default, System.Threading.CancellationToken cancellationToken = default)
        {
            UriBuilder uriBuilder = new UriBuilder();
            ...
            try
            {
                using (HttpRequestMessage httpRequestMessage = new HttpRequestMessage())
                {
                    ...
                    // Adds headers to the HttpRequestMessage header, these can be set in the RequestOptions (Idempotency-Key etc.)
                    requestOptions?.AddHeadersToHttpRequestMessage(httpRequestMessage);
                    httpRequestMessage.Content = (cancelRequest as object) is System.IO.Stream stream
                        ? httpRequestMessage.Content = new StreamContent(stream)
                        : httpRequestMessage.Content = new StringContent(JsonSerializer.Serialize(cancelRequest, _jsonSerializerOptions));
        ...
        public async Task<ICancelOrRefundApiResponse> CancelOrRefundAsync(CancelOrRefundRequest cancelOrRefundRequest,  RequestOptions? requestOptions = default, System.Threading.CancellationToken cancellationToken = default)
        {
            UriBuilder uriBuilder = new UriBuilder();
            ...
            try
            {
                using (HttpRequestMessage httpRequestMessage = new HttpRequestMessage())
                {
                    ...
                    // Adds headers to the HttpRequestMessage header, these can be set in the RequestOptions (Idempotency-Key etc.)
                    requestOptions?.AddHeadersToHttpRequestMessage(httpRequestMessage);
                    httpRequestMessage.Content = (cancelOrRefundRequest as object) is System.IO.Stream stream
                        ? httpRequestMessage.Content = new StreamContent(stream)
                        : httpRequestMessage.Content = new StringContent(JsonSerializer.Serialize(cancelOrRefundRequest, _jsonSerializerOptions));
        ...
        public async Task<ICaptureApiResponse> CaptureAsync(CaptureRequest captureRequest,  RequestOptions? requestOptions = default, System.Threading.CancellationToken cancellationToken = default)
        {
            UriBuilder uriBuilder = new UriBuilder();
            ...
            try
            {
                using (HttpRequestMessage httpRequestMessage = new HttpRequestMessage())
                {
                    ...
                    // Adds headers to the HttpRequestMessage header, these can be set in the RequestOptions (Idempotency-Key etc.)
                    requestOptions?.AddHeadersToHttpRequestMessage(httpRequestMessage);
                    httpRequestMessage.Content = (captureRequest as object) is System.IO.Stream stream
                        ? httpRequestMessage.Content = new StreamContent(stream)
                        : httpRequestMessage.Content = new StringContent(JsonSerializer.Serialize(captureRequest, _jsonSerializerOptions));
        ...
        /// <summary>
        /// Create a donation Schedules a new payment to be created (including a new authorisation request) for the specified donation using the payment details of the original payment.  &gt; This endpoint is [inactive](https://docs.adyen.com/online-payments/upgrade-your-integration#checkout-api-lifecycle) and is no longer supported for new integrations. &gt; * If you are building a new integration, use the Checkout API [&#x60;/donations&#x60;](https://docs.adyen.com/api-explorer/Checkout/latest/post/donations) endpoint instead. &gt; * If you have an existing integration using this endpoint, reach out to your Adyen contact and [migrate to the Checkout API](https://docs.adyen.com/online-payments/upgrade-your-integration/migrate-to-checkout-api).  &gt; The Checkout API enables your [online payments](https://docs.adyen.com/online-payments) integration to accept all supported payment methods, use the latest features, and access more benefits.
        /// </summary>
        /// <exception cref="ApiException">Thrown when fails to make API call.</exception>
        ...
        public async Task<IDonateApiResponse> DonateAsync(DonationRequest donationRequest,  RequestOptions? requestOptions = default, System.Threading.CancellationToken cancellationToken = default)
        {
            UriBuilder uriBuilder = new UriBuilder();
            ...
            try
            {
                using (HttpRequestMessage httpRequestMessage = new HttpRequestMessage())
                {
                    ...
                    // Adds headers to the HttpRequestMessage header, these can be set in the RequestOptions (Idempotency-Key etc.)
                    requestOptions?.AddHeadersToHttpRequestMessage(httpRequestMessage);
                    httpRequestMessage.Content = (donationRequest as object) is System.IO.Stream stream
                        ? httpRequestMessage.Content = new StreamContent(stream)
                        : httpRequestMessage.Content = new StringContent(JsonSerializer.Serialize(donationRequest, _jsonSerializerOptions));
        ...
        public async Task<IRefundApiResponse> RefundAsync(RefundRequest refundRequest,  RequestOptions? requestOptions = default, System.Threading.CancellationToken cancellationToken = default)
        {
            UriBuilder uriBuilder = new UriBuilder();
            ...
            try
            {
                using (HttpRequestMessage httpRequestMessage = new HttpRequestMessage())
                {
                    ...
                    // Adds headers to the HttpRequestMessage header, these can be set in the RequestOptions (Idempotency-Key etc.)
                    requestOptions?.AddHeadersToHttpRequestMessage(httpRequestMessage);
                    httpRequestMessage.Content = (refundRequest as object) is System.IO.Stream stream
                        ? httpRequestMessage.Content = new StreamContent(stream)
                        : httpRequestMessage.Content = new StringContent(JsonSerializer.Serialize(refundRequest, _jsonSerializerOptions));
        ...
        public async Task<ITechnicalCancelApiResponse> TechnicalCancelAsync(TechnicalCancelRequest technicalCancelRequest,  RequestOptions? requestOptions = default, System.Threading.CancellationToken cancellationToken = default)
        {
            UriBuilder uriBuilder = new UriBuilder();
            ...
            try
            {
                using (HttpRequestMessage httpRequestMessage = new HttpRequestMessage())
                {
                    ...
                    // Adds headers to the HttpRequestMessage header, these can be set in the RequestOptions (Idempotency-Key etc.)
                    requestOptions?.AddHeadersToHttpRequestMessage(httpRequestMessage);
                    httpRequestMessage.Content = (technicalCancelRequest as object) is System.IO.Stream stream
                        ? httpRequestMessage.Content = new StreamContent(stream)
                        : httpRequestMessage.Content = new StringContent(JsonSerializer.Serialize(technicalCancelRequest, _jsonSerializerOptions));
        ...
        public async Task<IVoidPendingRefundApiResponse> VoidPendingRefundAsync(VoidPendingRefundRequest voidPendingRefundRequest,  RequestOptions? requestOptions = default, System.Threading.CancellationToken cancellationToken = default)
        {
            UriBuilder uriBuilder = new UriBuilder();
            ...
            try
            {
                using (HttpRequestMessage httpRequestMessage = new HttpRequestMessage())
                {
                    ...
                    // Adds headers to the HttpRequestMessage header, these can be set in the RequestOptions (Idempotency-Key etc.)
                    requestOptions?.AddHeadersToHttpRequestMessage(httpRequestMessage);
                    httpRequestMessage.Content = (voidPendingRefundRequest as object) is System.IO.Stream stream
                        ? httpRequestMessage.Content = new StreamContent(stream)
                        : httpRequestMessage.Content = new StringContent(JsonSerializer.Serialize(voidPendingRefundRequest, _jsonSerializerOptions));
