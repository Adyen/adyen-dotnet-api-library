...
namespace Adyen.Payment.Models
{
    ...
    public partial class CancelRequest : IValidatableObject
    {
        ...
        [JsonConstructor]
        public CancelRequest(string merchantAccount, string originalReference, Option<Dictionary<string, string>?> additionalData = default, Option<ThreeDSecureData?> mpiData = default, Option<string?> originalMerchantReference = default, Option<PlatformChargebackLogic?> platformChargebackLogic = default, Option<string?> reference = default, Option<List<Split>?> splits = default, Option<string?> tenderReference = default, Option<string?> uniqueTerminalId = default)
        {
    ...
    /// <summary>
    /// A Json converter for type <see cref="CancelRequest" />
    /// </summary>
    public class CancelRequestJsonConverter : JsonConverter<CancelRequest>
    {
        /// <summary>
        /// Deserializes json to <see cref="CancelRequest"/>.
        /// </summary>
        /// <param name="utf8JsonReader"><see cref="Utf8JsonReader"/></param>
        /// <param name="typeToConvert"><see cref="Type"/></param>
        /// <param name="jsonSerializerOptions">The <see cref="JsonSerializerOptions"/>, initialized from <see cref="HostConfiguration"/>.</param>
        /// <returns><see cref="CancelRequest"/></returns>
        /// <exception cref="JsonException"></exception>
        public override CancelRequest Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (merchantAccount.IsSet && merchantAccount.Value == null)
                throw new ArgumentNullException(nameof(merchantAccount), "Property is not nullable for class CancelRequest.");

            if (originalReference.IsSet && originalReference.Value == null)
                throw new ArgumentNullException(nameof(originalReference), "Property is not nullable for class CancelRequest.");

            if (additionalData.IsSet && additionalData.Value == null)
                throw new ArgumentNullException(nameof(additionalData), "Property is not nullable for class CancelRequest.");

            if (mpiData.IsSet && mpiData.Value == null)
                throw new ArgumentNullException(nameof(mpiData), "Property is not nullable for class CancelRequest.");

            if (originalMerchantReference.IsSet && originalMerchantReference.Value == null)
                throw new ArgumentNullException(nameof(originalMerchantReference), "Property is not nullable for class CancelRequest.");

            if (platformChargebackLogic.IsSet && platformChargebackLogic.Value == null)
                throw new ArgumentNullException(nameof(platformChargebackLogic), "Property is not nullable for class CancelRequest.");

            if (reference.IsSet && reference.Value == null)
                throw new ArgumentNullException(nameof(reference), "Property is not nullable for class CancelRequest.");

            if (splits.IsSet && splits.Value == null)
                throw new ArgumentNullException(nameof(splits), "Property is not nullable for class CancelRequest.");

            if (tenderReference.IsSet && tenderReference.Value == null)
                throw new ArgumentNullException(nameof(tenderReference), "Property is not nullable for class CancelRequest.");

            if (uniqueTerminalId.IsSet && uniqueTerminalId.Value == null)
                throw new ArgumentNullException(nameof(uniqueTerminalId), "Property is not nullable for class CancelRequest.");
        ...
        /// <summary>
        /// Serializes a <see cref="CancelRequest"/>.
        /// </summary>
        /// <param name="writer"><see cref="Utf8JsonWriter"/></param>
        /// <param name="cancelRequest"></param>
        /// <param name="jsonSerializerOptions"><see cref="JsonSerializerOptions"/></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, CancelRequest cancelRequest, JsonSerializerOptions jsonSerializerOptions)
        {
            
            writer.WriteStartObject();
            
            WriteProperties(writer, cancelRequest, jsonSerializerOptions);
        ...
        /// <summary>
        /// Serializes the properties of <see cref="CancelRequest"/>.
        /// </summary>
        /// <param name="writer"><see creft="Utf8JsonWriter"/></param>
        /// <param name="cancelRequest"></param>
        /// <param name="jsonSerializerOptions"><see cref="JsonSerializerOptions"/></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, CancelRequest cancelRequest, JsonSerializerOptions jsonSerializerOptions)
        {
            /*
            if (cancelRequest.MerchantAccount == null)
                throw new ArgumentNullException(nameof(cancelRequest.MerchantAccount), "Property is required for class CancelRequest.");

            if (cancelRequest.OriginalReference == null)
                throw new ArgumentNullException(nameof(cancelRequest.OriginalReference), "Property is required for class CancelRequest.");

            if (cancelRequest._AdditionalDataOption.IsSet && cancelRequest.AdditionalData == null)
                throw new ArgumentNullException(nameof(cancelRequest.AdditionalData), "Property is required for class CancelRequest.");

            if (cancelRequest._MpiDataOption.IsSet && cancelRequest.MpiData == null)
                throw new ArgumentNullException(nameof(cancelRequest.MpiData), "Property is required for class CancelRequest.");

            if (cancelRequest._OriginalMerchantReferenceOption.IsSet && cancelRequest.OriginalMerchantReference == null)
                throw new ArgumentNullException(nameof(cancelRequest.OriginalMerchantReference), "Property is required for class CancelRequest.");

            if (cancelRequest._PlatformChargebackLogicOption.IsSet && cancelRequest.PlatformChargebackLogic == null)
                throw new ArgumentNullException(nameof(cancelRequest.PlatformChargebackLogic), "Property is required for class CancelRequest.");

            if (cancelRequest._ReferenceOption.IsSet && cancelRequest.Reference == null)
                throw new ArgumentNullException(nameof(cancelRequest.Reference), "Property is required for class CancelRequest.");

            if (cancelRequest._SplitsOption.IsSet && cancelRequest.Splits == null)
                throw new ArgumentNullException(nameof(cancelRequest.Splits), "Property is required for class CancelRequest.");

            if (cancelRequest._TenderReferenceOption.IsSet && cancelRequest.TenderReference == null)
                throw new ArgumentNullException(nameof(cancelRequest.TenderReference), "Property is required for class CancelRequest.");

            if (cancelRequest._UniqueTerminalIdOption.IsSet && cancelRequest.UniqueTerminalId == null)
                throw new ArgumentNullException(nameof(cancelRequest.UniqueTerminalId), "Property is required for class CancelRequest.");

            */
            
            writer.WriteString("merchantAccount", cancelRequest.MerchantAccount);

            writer.WriteString("originalReference", cancelRequest.OriginalReference);

            if (cancelRequest._AdditionalDataOption.IsSet)
            {
                writer.WritePropertyName("additionalData");
                JsonSerializer.Serialize(writer, cancelRequest.AdditionalData, jsonSerializerOptions);
            }
            if (cancelRequest._MpiDataOption.IsSet)
            {
                writer.WritePropertyName("mpiData");
                JsonSerializer.Serialize(writer, cancelRequest.MpiData, jsonSerializerOptions);
            }
            if (cancelRequest._OriginalMerchantReferenceOption.IsSet)
                writer.WriteString("originalMerchantReference", cancelRequest.OriginalMerchantReference);

            if (cancelRequest._PlatformChargebackLogicOption.IsSet)
            {
                writer.WritePropertyName("platformChargebackLogic");
                JsonSerializer.Serialize(writer, cancelRequest.PlatformChargebackLogic, jsonSerializerOptions);
            }
            if (cancelRequest._ReferenceOption.IsSet)
                writer.WriteString("reference", cancelRequest.Reference);

            if (cancelRequest._SplitsOption.IsSet)
            {
                writer.WritePropertyName("splits");
                JsonSerializer.Serialize(writer, cancelRequest.Splits, jsonSerializerOptions);
            }
            if (cancelRequest._TenderReferenceOption.IsSet)
                writer.WriteString("tenderReference", cancelRequest.TenderReference);

            if (cancelRequest._UniqueTerminalIdOption.IsSet)
                writer.WriteString("uniqueTerminalId", cancelRequest.UniqueTerminalId);
        }
    }
}
