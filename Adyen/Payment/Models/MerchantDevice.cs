...
namespace Adyen.Payment.Models
{
    ...
    /// MerchantDevice.
    /// </summary>
    [JsonConverter(typeof(MerchantDeviceJsonConverter))]
    public partial class MerchantDevice
    {
        /// <summary>
    ...
    public class MerchantDeviceJsonConverter : JsonConverter<MerchantDevice>
    {
        ...
        public override MerchantDevice Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (osVersion.IsSet)
                merchantDevice.OsVersion = osVersion.Value;
            if (reference.IsSet)
                merchantDevice.Reference = reference.Value;
