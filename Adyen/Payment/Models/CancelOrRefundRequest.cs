    ...
    public class CancelOrRefundRequestJsonConverter : JsonConverter<CancelOrRefundRequest>
    {
        ...
        public override CancelOrRefundRequest Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (merchantAccount.IsSet && merchantAccount.Value == null)
                throw new ArgumentNullException(nameof(merchantAccount), "Property is not nullable for class CancelOrRefundRequest.");

            if (originalReference.IsSet && originalReference.Value == null)
                throw new ArgumentNullException(nameof(originalReference), "Property is not nullable for class CancelOrRefundRequest.");

            if (additionalData.IsSet && additionalData.Value == null)
                throw new ArgumentNullException(nameof(additionalData), "Property is not nullable for class CancelOrRefundRequest.");

            if (mpiData.IsSet && mpiData.Value == null)
                throw new ArgumentNullException(nameof(mpiData), "Property is not nullable for class CancelOrRefundRequest.");

            if (originalMerchantReference.IsSet && originalMerchantReference.Value == null)
                throw new ArgumentNullException(nameof(originalMerchantReference), "Property is not nullable for class CancelOrRefundRequest.");

            if (platformChargebackLogic.IsSet && platformChargebackLogic.Value == null)
                throw new ArgumentNullException(nameof(platformChargebackLogic), "Property is not nullable for class CancelOrRefundRequest.");

            if (reference.IsSet && reference.Value == null)
                throw new ArgumentNullException(nameof(reference), "Property is not nullable for class CancelOrRefundRequest.");

            if (tenderReference.IsSet && tenderReference.Value == null)
                throw new ArgumentNullException(nameof(tenderReference), "Property is not nullable for class CancelOrRefundRequest.");

            if (uniqueTerminalId.IsSet && uniqueTerminalId.Value == null)
                throw new ArgumentNullException(nameof(uniqueTerminalId), "Property is not nullable for class CancelOrRefundRequest.");
        ...
        public void WriteProperties(Utf8JsonWriter writer, CancelOrRefundRequest cancelOrRefundRequest, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (cancelOrRefundRequest.MerchantAccount == null)
                throw new ArgumentNullException(nameof(cancelOrRefundRequest.MerchantAccount), "Property is required for class CancelOrRefundRequest.");

            if (cancelOrRefundRequest.OriginalReference == null)
                throw new ArgumentNullException(nameof(cancelOrRefundRequest.OriginalReference), "Property is required for class CancelOrRefundRequest.");

            if (cancelOrRefundRequest._AdditionalDataOption.IsSet && cancelOrRefundRequest.AdditionalData == null)
                throw new ArgumentNullException(nameof(cancelOrRefundRequest.AdditionalData), "Property is required for class CancelOrRefundRequest.");

            if (cancelOrRefundRequest._MpiDataOption.IsSet && cancelOrRefundRequest.MpiData == null)
                throw new ArgumentNullException(nameof(cancelOrRefundRequest.MpiData), "Property is required for class CancelOrRefundRequest.");

            if (cancelOrRefundRequest._OriginalMerchantReferenceOption.IsSet && cancelOrRefundRequest.OriginalMerchantReference == null)
                throw new ArgumentNullException(nameof(cancelOrRefundRequest.OriginalMerchantReference), "Property is required for class CancelOrRefundRequest.");

            if (cancelOrRefundRequest._PlatformChargebackLogicOption.IsSet && cancelOrRefundRequest.PlatformChargebackLogic == null)
                throw new ArgumentNullException(nameof(cancelOrRefundRequest.PlatformChargebackLogic), "Property is required for class CancelOrRefundRequest.");

            if (cancelOrRefundRequest._ReferenceOption.IsSet && cancelOrRefundRequest.Reference == null)
                throw new ArgumentNullException(nameof(cancelOrRefundRequest.Reference), "Property is required for class CancelOrRefundRequest.");

            if (cancelOrRefundRequest._TenderReferenceOption.IsSet && cancelOrRefundRequest.TenderReference == null)
                throw new ArgumentNullException(nameof(cancelOrRefundRequest.TenderReference), "Property is required for class CancelOrRefundRequest.");

            if (cancelOrRefundRequest._UniqueTerminalIdOption.IsSet && cancelOrRefundRequest.UniqueTerminalId == null)
                throw new ArgumentNullException(nameof(cancelOrRefundRequest.UniqueTerminalId), "Property is required for class CancelOrRefundRequest.");
