...
namespace Adyen.Payment.Models
{
    ...
    /// </summary>
    [JsonConverter(typeof(CancelOrRefundRequestJsonConverter))]
    public partial class CancelOrRefundRequest
    {
        /// <summary>
    ...
    public class CancelOrRefundRequestJsonConverter : JsonConverter<CancelOrRefundRequest>
    {
        ...
        public override CancelOrRefundRequest Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (mpiData.IsSet)
                cancelOrRefundRequest.MpiData = mpiData.Value;
            if (originalMerchantReference.IsSet)
                cancelOrRefundRequest.OriginalMerchantReference = originalMerchantReference.Value;
            if (platformChargebackLogic.IsSet)
                cancelOrRefundRequest.PlatformChargebackLogic = platformChargebackLogic.Value;
            if (reference.IsSet)
                cancelOrRefundRequest.Reference = reference.Value;
            if (tenderReference.IsSet)
                cancelOrRefundRequest.TenderReference = tenderReference.Value;
            if (uniqueTerminalId.IsSet)
                cancelOrRefundRequest.UniqueTerminalId = uniqueTerminalId.Value;
