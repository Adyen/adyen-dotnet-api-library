...
namespace Adyen.Payment.Models
{
    ...
    /// </summary>
    [JsonConverter(typeof(AdditionalDataWalletsJsonConverter))]
    ...
    public class AdditionalDataWalletsJsonConverter : JsonConverter<AdditionalDataWallets>
    {
        ...
        public override AdditionalDataWallets Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (masterpassTransactionId.IsSet)
                additionalDataWallets.MasterpassTransactionId = masterpassTransactionId.Value;
            if (paymentToken.IsSet)
                additionalDataWallets.PaymentToken = paymentToken.Value;
            if (paywithgoogleToken.IsSet)
                additionalDataWallets.PaywithgoogleToken = paywithgoogleToken.Value;
            if (samsungpayToken.IsSet)
                additionalDataWallets.SamsungpayToken = samsungpayToken.Value;
            if (visacheckoutCallId.IsSet)
                additionalDataWallets.VisacheckoutCallId = visacheckoutCallId.Value;
            return additionalDataWallets;
        }
