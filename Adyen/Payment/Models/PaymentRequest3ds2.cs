...
namespace Adyen.Payment.Models
{
    ...
    /// PaymentRequest3ds2.
    /// </summary>
    [JsonConverter(typeof(PaymentRequest3ds2JsonConverter))]
    public partial class PaymentRequest3ds2
    {
        ...
        /// <summary>
        /// This is used to track if an optional field is set. If set, <see cref="ThreeDS2Token"/> will be populated.
        /// </summary>
        [JsonIgnore]
        [global::System.ComponentModel.EditorBrowsable(global::System.ComponentModel.EditorBrowsableState.Never)]
    ...
    public class PaymentRequest3ds2JsonConverter : JsonConverter<PaymentRequest3ds2>
    {
        ...
        public override PaymentRequest3ds2 Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (additionalAmount.IsSet)
                paymentRequest3ds2.AdditionalAmount = additionalAmount.Value;
            if (additionalData.IsSet)
                paymentRequest3ds2.AdditionalData = additionalData.Value;
            if (applicationInfo.IsSet)
                paymentRequest3ds2.ApplicationInfo = applicationInfo.Value;
            if (billingAddress.IsSet)
                paymentRequest3ds2.BillingAddress = billingAddress.Value;
            if (browserInfo.IsSet)
                paymentRequest3ds2.BrowserInfo = browserInfo.Value;
            if (captureDelayHours.IsSet)
                paymentRequest3ds2.CaptureDelayHours = captureDelayHours.Value;
            if (dateOfBirth.IsSet)
                paymentRequest3ds2.DateOfBirth = dateOfBirth.Value;
            if (dccQuote.IsSet)
                paymentRequest3ds2.DccQuote = dccQuote.Value;
            if (deliveryAddress.IsSet)
                paymentRequest3ds2.DeliveryAddress = deliveryAddress.Value;
            if (deliveryDate.IsSet)
                paymentRequest3ds2.DeliveryDate = deliveryDate.Value;
            if (deviceFingerprint.IsSet)
                paymentRequest3ds2.DeviceFingerprint = deviceFingerprint.Value;
            if (fraudOffset.IsSet)
                paymentRequest3ds2.FraudOffset = fraudOffset.Value;
            if (installments.IsSet)
                paymentRequest3ds2.Installments = installments.Value;
            if (localizedShopperStatement.IsSet)
                paymentRequest3ds2.LocalizedShopperStatement = localizedShopperStatement.Value;
            if (mcc.IsSet)
                paymentRequest3ds2.Mcc = mcc.Value;
            if (merchantOrderReference.IsSet)
                paymentRequest3ds2.MerchantOrderReference = merchantOrderReference.Value;
            if (merchantRiskIndicator.IsSet)
                paymentRequest3ds2.MerchantRiskIndicator = merchantRiskIndicator.Value;
            if (metadata.IsSet)
                paymentRequest3ds2.Metadata = metadata.Value;
            if (orderReference.IsSet)
                paymentRequest3ds2.OrderReference = orderReference.Value;
            if (recurring.IsSet)
                paymentRequest3ds2.Recurring = recurring.Value;
            if (recurringProcessingModel.IsSet)
                paymentRequest3ds2.RecurringProcessingModel = recurringProcessingModel.Value;
            if (selectedBrand.IsSet)
                paymentRequest3ds2.SelectedBrand = selectedBrand.Value;
            if (selectedRecurringDetailReference.IsSet)
                paymentRequest3ds2.SelectedRecurringDetailReference = selectedRecurringDetailReference.Value;
            if (sessionId.IsSet)
                paymentRequest3ds2.SessionId = sessionId.Value;
            if (shopperEmail.IsSet)
                paymentRequest3ds2.ShopperEmail = shopperEmail.Value;
            if (shopperIP.IsSet)
                paymentRequest3ds2.ShopperIP = shopperIP.Value;
            if (shopperInteraction.IsSet)
                paymentRequest3ds2.ShopperInteraction = shopperInteraction.Value;
            if (shopperLocale.IsSet)
                paymentRequest3ds2.ShopperLocale = shopperLocale.Value;
            if (shopperName.IsSet)
                paymentRequest3ds2.ShopperName = shopperName.Value;
            if (shopperReference.IsSet)
                paymentRequest3ds2.ShopperReference = shopperReference.Value;
            if (shopperStatement.IsSet)
                paymentRequest3ds2.ShopperStatement = shopperStatement.Value;
            if (socialSecurityNumber.IsSet)
                paymentRequest3ds2.SocialSecurityNumber = socialSecurityNumber.Value;
            if (splits.IsSet)
                paymentRequest3ds2.Splits = splits.Value;
            if (store.IsSet)
                paymentRequest3ds2.Store = store.Value;
            if (telephoneNumber.IsSet)
                paymentRequest3ds2.TelephoneNumber = telephoneNumber.Value;
            if (threeDS2RequestData.IsSet)
                paymentRequest3ds2.ThreeDS2RequestData = threeDS2RequestData.Value;
            if (threeDS2Result.IsSet)
                paymentRequest3ds2.ThreeDS2Result = threeDS2Result.Value;
            if (threeDS2Token.IsSet)
                paymentRequest3ds2.ThreeDS2Token = threeDS2Token.Value;
            if (threeDSAuthenticationOnly.IsSet)
                paymentRequest3ds2.ThreeDSAuthenticationOnly = threeDSAuthenticationOnly.Value;
            if (totalsGroup.IsSet)
                paymentRequest3ds2.TotalsGroup = totalsGroup.Value;
            if (trustedShopper.IsSet)
                paymentRequest3ds2.TrustedShopper = trustedShopper.Value;
        ...
        public void WriteProperties(Utf8JsonWriter writer, PaymentRequest3ds2 paymentRequest3ds2, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (paymentRequest3ds2._OrderReferenceOption.IsSet)
                if (paymentRequest3ds2.OrderReference != null)
            ...
            if (paymentRequest3ds2._SelectedBrandOption.IsSet)
                if (paymentRequest3ds2.SelectedBrand != null)
            ...
            if (paymentRequest3ds2._SelectedRecurringDetailReferenceOption.IsSet)
                if (paymentRequest3ds2.SelectedRecurringDetailReference != null)
            ...
            if (paymentRequest3ds2._ShopperLocaleOption.IsSet)
                if (paymentRequest3ds2.ShopperLocale != null)
            ...
            if (paymentRequest3ds2._ShopperReferenceOption.IsSet)
                if (paymentRequest3ds2.ShopperReference != null)
            ...
            if (paymentRequest3ds2._ShopperStatementOption.IsSet)
                if (paymentRequest3ds2.ShopperStatement != null)
            ...
            if (paymentRequest3ds2._SocialSecurityNumberOption.IsSet)
                if (paymentRequest3ds2.SocialSecurityNumber != null)
            ...
            if (paymentRequest3ds2._ThreeDS2TokenOption.IsSet)
                if (paymentRequest3ds2.ThreeDS2Token != null)
