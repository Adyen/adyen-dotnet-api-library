...
namespace Adyen.Payment.Models
{
    ...
    public partial class PaymentRequest3ds2 : IValidatableObject
    {
        ...
        /// <param name="threeDS2Token">The ThreeDS2Token that was returned in the /authorise call.</param>
        ...
        [JsonConstructor]
        public PaymentRequest3ds2(Amount amount, string merchantAccount, string reference, Option<AccountInfo?> accountInfo = default, Option<Amount?> additionalAmount = default, Option<Dictionary<string, string>?> additionalData = default, Option<ApplicationInfo?> applicationInfo = default, Option<Address?> billingAddress = default, Option<BrowserInfo?> browserInfo = default, Option<int?> captureDelayHours = default, Option<DateOnly?> dateOfBirth = default, Option<ForexQuote?> dccQuote = default, Option<Address?> deliveryAddress = default, Option<DateTimeOffset?> deliveryDate = default, Option<string?> deviceFingerprint = default, Option<int?> fraudOffset = default, Option<Installments?> installments = default, Option<Dictionary<string, string>?> localizedShopperStatement = default, Option<string?> mcc = default, Option<string?> merchantOrderReference = default, Option<MerchantRiskIndicator?> merchantRiskIndicator = default, Option<Dictionary<string, string>?> metadata = default, Option<string?> orderReference = default, Option<Recurring?> recurring = default, Option<RecurringProcessingModelEnum?> recurringProcessingModel = default, Option<string?> selectedBrand = default, Option<string?> selectedRecurringDetailReference = default, Option<string?> sessionId = default, Option<string?> shopperEmail = default, Option<string?> shopperIP = default, Option<ShopperInteractionEnum?> shopperInteraction = default, Option<string?> shopperLocale = default, Option<Name?> shopperName = default, Option<string?> shopperReference = default, Option<string?> shopperStatement = default, Option<string?> socialSecurityNumber = default, Option<List<Split>?> splits = default, Option<string?> store = default, Option<string?> telephoneNumber = default, Option<ThreeDS2RequestData?> threeDS2RequestData = default, Option<ThreeDS2Result?> threeDS2Result = default, Option<string?> threeDS2Token = default, Option<bool?> threeDSAuthenticationOnly = default, Option<string?> totalsGroup = default, Option<bool?> trustedShopper = default)
        {
            Amount = amount;
            ...
            _ThreeDS2TokenOption = threeDS2Token;
        ...
        /// <summary>
        /// Used to track the state of ThreeDS2Token
        /// </summary>
        [JsonIgnore]
        [global::System.ComponentModel.EditorBrowsable(global::System.ComponentModel.EditorBrowsableState.Never)]
        public Option<string?> _ThreeDS2TokenOption { get; private set; }

        /// <summary>
        /// The ThreeDS2Token that was returned in the /authorise call.
        /// </summary>
        /// <value>The ThreeDS2Token that was returned in the /authorise call.</value>
        [JsonPropertyName("threeDS2Token")]
        public string? ThreeDS2Token { get { return this._ThreeDS2TokenOption; } set { this._ThreeDS2TokenOption = new(value); } }
    ...
    /// <summary>
    /// A Json converter for type <see cref="PaymentRequest3ds2" />
    /// </summary>
    public class PaymentRequest3ds2JsonConverter : JsonConverter<PaymentRequest3ds2>
    {
        /// <summary>
        ...
        /// <summary>
        /// Deserializes json to <see cref="PaymentRequest3ds2"/>.
        /// </summary>
        /// <param name="utf8JsonReader"><see cref="Utf8JsonReader"/></param>
        /// <param name="typeToConvert"><see cref="Type"/></param>
        /// <param name="jsonSerializerOptions">The <see cref="JsonSerializerOptions"/>, initialized from <see cref="HostConfiguration"/>.</param>
        /// <returns><see cref="PaymentRequest3ds2"/></returns>
        /// <exception cref="JsonException"></exception>
        public override PaymentRequest3ds2 Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            Option<PaymentRequest3ds2.RecurringProcessingModelEnum?> recurringProcessingModel = default;
            ...
            Option<PaymentRequest3ds2.ShopperInteractionEnum?> shopperInteraction = default;
            ...
            Option<string?> threeDS2Token = default;
                ...
                if (utf8JsonReader.TokenType == JsonTokenType.PropertyName && currentDepth == utf8JsonReader.CurrentDepth - 1)
                {
                    ...
                    switch (jsonPropertyName)
                    {
                        ...
                        case "threeDS2Result":
                            ...
                            break;
                        case "threeDS2Token":
                            threeDS2Token = new Option<string?>(utf8JsonReader.GetString()!);
                            break;
            ...
            if (amount.IsSet && amount.Value == null)
                throw new ArgumentNullException(nameof(amount), "Property is not nullable for class PaymentRequest3ds2.");

            if (merchantAccount.IsSet && merchantAccount.Value == null)
                throw new ArgumentNullException(nameof(merchantAccount), "Property is not nullable for class PaymentRequest3ds2.");

            if (reference.IsSet && reference.Value == null)
                throw new ArgumentNullException(nameof(reference), "Property is not nullable for class PaymentRequest3ds2.");

            if (accountInfo.IsSet && accountInfo.Value == null)
                throw new ArgumentNullException(nameof(accountInfo), "Property is not nullable for class PaymentRequest3ds2.");

            if (additionalAmount.IsSet && additionalAmount.Value == null)
                throw new ArgumentNullException(nameof(additionalAmount), "Property is not nullable for class PaymentRequest3ds2.");

            if (additionalData.IsSet && additionalData.Value == null)
                throw new ArgumentNullException(nameof(additionalData), "Property is not nullable for class PaymentRequest3ds2.");

            if (applicationInfo.IsSet && applicationInfo.Value == null)
                throw new ArgumentNullException(nameof(applicationInfo), "Property is not nullable for class PaymentRequest3ds2.");

            if (billingAddress.IsSet && billingAddress.Value == null)
                throw new ArgumentNullException(nameof(billingAddress), "Property is not nullable for class PaymentRequest3ds2.");

            if (browserInfo.IsSet && browserInfo.Value == null)
                throw new ArgumentNullException(nameof(browserInfo), "Property is not nullable for class PaymentRequest3ds2.");

            if (captureDelayHours.IsSet && captureDelayHours.Value == null)
                throw new ArgumentNullException(nameof(captureDelayHours), "Property is not nullable for class PaymentRequest3ds2.");

            if (dateOfBirth.IsSet && dateOfBirth.Value == null)
                throw new ArgumentNullException(nameof(dateOfBirth), "Property is not nullable for class PaymentRequest3ds2.");

            if (dccQuote.IsSet && dccQuote.Value == null)
                throw new ArgumentNullException(nameof(dccQuote), "Property is not nullable for class PaymentRequest3ds2.");

            if (deliveryAddress.IsSet && deliveryAddress.Value == null)
                throw new ArgumentNullException(nameof(deliveryAddress), "Property is not nullable for class PaymentRequest3ds2.");

            if (deliveryDate.IsSet && deliveryDate.Value == null)
                throw new ArgumentNullException(nameof(deliveryDate), "Property is not nullable for class PaymentRequest3ds2.");

            if (deviceFingerprint.IsSet && deviceFingerprint.Value == null)
                throw new ArgumentNullException(nameof(deviceFingerprint), "Property is not nullable for class PaymentRequest3ds2.");

            if (fraudOffset.IsSet && fraudOffset.Value == null)
                throw new ArgumentNullException(nameof(fraudOffset), "Property is not nullable for class PaymentRequest3ds2.");

            if (installments.IsSet && installments.Value == null)
                throw new ArgumentNullException(nameof(installments), "Property is not nullable for class PaymentRequest3ds2.");

            if (localizedShopperStatement.IsSet && localizedShopperStatement.Value == null)
                throw new ArgumentNullException(nameof(localizedShopperStatement), "Property is not nullable for class PaymentRequest3ds2.");

            if (mcc.IsSet && mcc.Value == null)
                throw new ArgumentNullException(nameof(mcc), "Property is not nullable for class PaymentRequest3ds2.");

            if (merchantOrderReference.IsSet && merchantOrderReference.Value == null)
                throw new ArgumentNullException(nameof(merchantOrderReference), "Property is not nullable for class PaymentRequest3ds2.");

            if (merchantRiskIndicator.IsSet && merchantRiskIndicator.Value == null)
                throw new ArgumentNullException(nameof(merchantRiskIndicator), "Property is not nullable for class PaymentRequest3ds2.");

            if (metadata.IsSet && metadata.Value == null)
                throw new ArgumentNullException(nameof(metadata), "Property is not nullable for class PaymentRequest3ds2.");

            if (orderReference.IsSet && orderReference.Value == null)
                throw new ArgumentNullException(nameof(orderReference), "Property is not nullable for class PaymentRequest3ds2.");

            if (recurring.IsSet && recurring.Value == null)
                throw new ArgumentNullException(nameof(recurring), "Property is not nullable for class PaymentRequest3ds2.");

            if (recurringProcessingModel.IsSet && recurringProcessingModel.Value == null)
                throw new ArgumentNullException(nameof(recurringProcessingModel), "Property is not nullable for class PaymentRequest3ds2.");

            if (selectedBrand.IsSet && selectedBrand.Value == null)
                throw new ArgumentNullException(nameof(selectedBrand), "Property is not nullable for class PaymentRequest3ds2.");

            if (selectedRecurringDetailReference.IsSet && selectedRecurringDetailReference.Value == null)
                throw new ArgumentNullException(nameof(selectedRecurringDetailReference), "Property is not nullable for class PaymentRequest3ds2.");

            if (sessionId.IsSet && sessionId.Value == null)
                throw new ArgumentNullException(nameof(sessionId), "Property is not nullable for class PaymentRequest3ds2.");

            if (shopperEmail.IsSet && shopperEmail.Value == null)
                throw new ArgumentNullException(nameof(shopperEmail), "Property is not nullable for class PaymentRequest3ds2.");

            if (shopperIP.IsSet && shopperIP.Value == null)
                throw new ArgumentNullException(nameof(shopperIP), "Property is not nullable for class PaymentRequest3ds2.");

            if (shopperInteraction.IsSet && shopperInteraction.Value == null)
                throw new ArgumentNullException(nameof(shopperInteraction), "Property is not nullable for class PaymentRequest3ds2.");

            if (shopperLocale.IsSet && shopperLocale.Value == null)
                throw new ArgumentNullException(nameof(shopperLocale), "Property is not nullable for class PaymentRequest3ds2.");

            if (shopperName.IsSet && shopperName.Value == null)
                throw new ArgumentNullException(nameof(shopperName), "Property is not nullable for class PaymentRequest3ds2.");

            if (shopperReference.IsSet && shopperReference.Value == null)
                throw new ArgumentNullException(nameof(shopperReference), "Property is not nullable for class PaymentRequest3ds2.");

            if (shopperStatement.IsSet && shopperStatement.Value == null)
                throw new ArgumentNullException(nameof(shopperStatement), "Property is not nullable for class PaymentRequest3ds2.");

            if (socialSecurityNumber.IsSet && socialSecurityNumber.Value == null)
                throw new ArgumentNullException(nameof(socialSecurityNumber), "Property is not nullable for class PaymentRequest3ds2.");

            if (splits.IsSet && splits.Value == null)
                throw new ArgumentNullException(nameof(splits), "Property is not nullable for class PaymentRequest3ds2.");

            if (store.IsSet && store.Value == null)
                throw new ArgumentNullException(nameof(store), "Property is not nullable for class PaymentRequest3ds2.");

            if (telephoneNumber.IsSet && telephoneNumber.Value == null)
                throw new ArgumentNullException(nameof(telephoneNumber), "Property is not nullable for class PaymentRequest3ds2.");

            if (threeDS2RequestData.IsSet && threeDS2RequestData.Value == null)
                throw new ArgumentNullException(nameof(threeDS2RequestData), "Property is not nullable for class PaymentRequest3ds2.");

            if (threeDS2Result.IsSet && threeDS2Result.Value == null)
                throw new ArgumentNullException(nameof(threeDS2Result), "Property is not nullable for class PaymentRequest3ds2.");

            if (threeDS2Token.IsSet && threeDS2Token.Value == null)
                throw new ArgumentNullException(nameof(threeDS2Token), "Property is not nullable for class PaymentRequest3ds2.");

            if (threeDSAuthenticationOnly.IsSet && threeDSAuthenticationOnly.Value == null)
                throw new ArgumentNullException(nameof(threeDSAuthenticationOnly), "Property is not nullable for class PaymentRequest3ds2.");

            if (totalsGroup.IsSet && totalsGroup.Value == null)
                throw new ArgumentNullException(nameof(totalsGroup), "Property is not nullable for class PaymentRequest3ds2.");

            if (trustedShopper.IsSet && trustedShopper.Value == null)
                throw new ArgumentNullException(nameof(trustedShopper), "Property is not nullable for class PaymentRequest3ds2.");
        ...
        /// <summary>
        /// Serializes a <see cref="PaymentRequest3ds2"/>.
        /// </summary>
        /// <param name="writer"><see cref="Utf8JsonWriter"/></param>
        /// <param name="paymentRequest3ds2"></param>
        /// <param name="jsonSerializerOptions"><see cref="JsonSerializerOptions"/></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, PaymentRequest3ds2 paymentRequest3ds2, JsonSerializerOptions jsonSerializerOptions)
        {
            
            writer.WriteStartObject();
            
            WriteProperties(writer, paymentRequest3ds2, jsonSerializerOptions);
        ...
        /// <summary>
        /// Serializes the properties of <see cref="PaymentRequest3ds2"/>.
        /// </summary>
        /// <param name="writer"><see creft="Utf8JsonWriter"/></param>
        /// <param name="paymentRequest3ds2"></param>
        /// <param name="jsonSerializerOptions"><see cref="JsonSerializerOptions"/></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, PaymentRequest3ds2 paymentRequest3ds2, JsonSerializerOptions jsonSerializerOptions)
        {
            /*
            if (paymentRequest3ds2.Amount == null)
                throw new ArgumentNullException(nameof(paymentRequest3ds2.Amount), "Property is required for class PaymentRequest3ds2.");

            if (paymentRequest3ds2.MerchantAccount == null)
                throw new ArgumentNullException(nameof(paymentRequest3ds2.MerchantAccount), "Property is required for class PaymentRequest3ds2.");

            if (paymentRequest3ds2.Reference == null)
                throw new ArgumentNullException(nameof(paymentRequest3ds2.Reference), "Property is required for class PaymentRequest3ds2.");

            if (paymentRequest3ds2._AccountInfoOption.IsSet && paymentRequest3ds2.AccountInfo == null)
                throw new ArgumentNullException(nameof(paymentRequest3ds2.AccountInfo), "Property is required for class PaymentRequest3ds2.");

            if (paymentRequest3ds2._AdditionalAmountOption.IsSet && paymentRequest3ds2.AdditionalAmount == null)
                throw new ArgumentNullException(nameof(paymentRequest3ds2.AdditionalAmount), "Property is required for class PaymentRequest3ds2.");

            if (paymentRequest3ds2._AdditionalDataOption.IsSet && paymentRequest3ds2.AdditionalData == null)
                throw new ArgumentNullException(nameof(paymentRequest3ds2.AdditionalData), "Property is required for class PaymentRequest3ds2.");

            if (paymentRequest3ds2._ApplicationInfoOption.IsSet && paymentRequest3ds2.ApplicationInfo == null)
                throw new ArgumentNullException(nameof(paymentRequest3ds2.ApplicationInfo), "Property is required for class PaymentRequest3ds2.");

            if (paymentRequest3ds2._BillingAddressOption.IsSet && paymentRequest3ds2.BillingAddress == null)
                throw new ArgumentNullException(nameof(paymentRequest3ds2.BillingAddress), "Property is required for class PaymentRequest3ds2.");

            if (paymentRequest3ds2._BrowserInfoOption.IsSet && paymentRequest3ds2.BrowserInfo == null)
                throw new ArgumentNullException(nameof(paymentRequest3ds2.BrowserInfo), "Property is required for class PaymentRequest3ds2.");

            if (paymentRequest3ds2._DccQuoteOption.IsSet && paymentRequest3ds2.DccQuote == null)
                throw new ArgumentNullException(nameof(paymentRequest3ds2.DccQuote), "Property is required for class PaymentRequest3ds2.");

            if (paymentRequest3ds2._DeliveryAddressOption.IsSet && paymentRequest3ds2.DeliveryAddress == null)
                throw new ArgumentNullException(nameof(paymentRequest3ds2.DeliveryAddress), "Property is required for class PaymentRequest3ds2.");

            if (paymentRequest3ds2._DeviceFingerprintOption.IsSet && paymentRequest3ds2.DeviceFingerprint == null)
                throw new ArgumentNullException(nameof(paymentRequest3ds2.DeviceFingerprint), "Property is required for class PaymentRequest3ds2.");

            if (paymentRequest3ds2._InstallmentsOption.IsSet && paymentRequest3ds2.Installments == null)
                throw new ArgumentNullException(nameof(paymentRequest3ds2.Installments), "Property is required for class PaymentRequest3ds2.");

            if (paymentRequest3ds2._LocalizedShopperStatementOption.IsSet && paymentRequest3ds2.LocalizedShopperStatement == null)
                throw new ArgumentNullException(nameof(paymentRequest3ds2.LocalizedShopperStatement), "Property is required for class PaymentRequest3ds2.");

            if (paymentRequest3ds2._MccOption.IsSet && paymentRequest3ds2.Mcc == null)
                throw new ArgumentNullException(nameof(paymentRequest3ds2.Mcc), "Property is required for class PaymentRequest3ds2.");

            if (paymentRequest3ds2._MerchantOrderReferenceOption.IsSet && paymentRequest3ds2.MerchantOrderReference == null)
                throw new ArgumentNullException(nameof(paymentRequest3ds2.MerchantOrderReference), "Property is required for class PaymentRequest3ds2.");

            if (paymentRequest3ds2._MerchantRiskIndicatorOption.IsSet && paymentRequest3ds2.MerchantRiskIndicator == null)
                throw new ArgumentNullException(nameof(paymentRequest3ds2.MerchantRiskIndicator), "Property is required for class PaymentRequest3ds2.");

            if (paymentRequest3ds2._MetadataOption.IsSet && paymentRequest3ds2.Metadata == null)
                throw new ArgumentNullException(nameof(paymentRequest3ds2.Metadata), "Property is required for class PaymentRequest3ds2.");

            if (paymentRequest3ds2._OrderReferenceOption.IsSet && paymentRequest3ds2.OrderReference == null)
                throw new ArgumentNullException(nameof(paymentRequest3ds2.OrderReference), "Property is required for class PaymentRequest3ds2.");

            if (paymentRequest3ds2._RecurringOption.IsSet && paymentRequest3ds2.Recurring == null)
                throw new ArgumentNullException(nameof(paymentRequest3ds2.Recurring), "Property is required for class PaymentRequest3ds2.");

            if (paymentRequest3ds2._SelectedBrandOption.IsSet && paymentRequest3ds2.SelectedBrand == null)
                throw new ArgumentNullException(nameof(paymentRequest3ds2.SelectedBrand), "Property is required for class PaymentRequest3ds2.");

            if (paymentRequest3ds2._SelectedRecurringDetailReferenceOption.IsSet && paymentRequest3ds2.SelectedRecurringDetailReference == null)
                throw new ArgumentNullException(nameof(paymentRequest3ds2.SelectedRecurringDetailReference), "Property is required for class PaymentRequest3ds2.");

            if (paymentRequest3ds2._SessionIdOption.IsSet && paymentRequest3ds2.SessionId == null)
                throw new ArgumentNullException(nameof(paymentRequest3ds2.SessionId), "Property is required for class PaymentRequest3ds2.");

            if (paymentRequest3ds2._ShopperEmailOption.IsSet && paymentRequest3ds2.ShopperEmail == null)
                throw new ArgumentNullException(nameof(paymentRequest3ds2.ShopperEmail), "Property is required for class PaymentRequest3ds2.");

            if (paymentRequest3ds2._ShopperIPOption.IsSet && paymentRequest3ds2.ShopperIP == null)
                throw new ArgumentNullException(nameof(paymentRequest3ds2.ShopperIP), "Property is required for class PaymentRequest3ds2.");

            if (paymentRequest3ds2._ShopperLocaleOption.IsSet && paymentRequest3ds2.ShopperLocale == null)
                throw new ArgumentNullException(nameof(paymentRequest3ds2.ShopperLocale), "Property is required for class PaymentRequest3ds2.");

            if (paymentRequest3ds2._ShopperNameOption.IsSet && paymentRequest3ds2.ShopperName == null)
                throw new ArgumentNullException(nameof(paymentRequest3ds2.ShopperName), "Property is required for class PaymentRequest3ds2.");

            if (paymentRequest3ds2._ShopperReferenceOption.IsSet && paymentRequest3ds2.ShopperReference == null)
                throw new ArgumentNullException(nameof(paymentRequest3ds2.ShopperReference), "Property is required for class PaymentRequest3ds2.");

            if (paymentRequest3ds2._ShopperStatementOption.IsSet && paymentRequest3ds2.ShopperStatement == null)
                throw new ArgumentNullException(nameof(paymentRequest3ds2.ShopperStatement), "Property is required for class PaymentRequest3ds2.");

            if (paymentRequest3ds2._SocialSecurityNumberOption.IsSet && paymentRequest3ds2.SocialSecurityNumber == null)
                throw new ArgumentNullException(nameof(paymentRequest3ds2.SocialSecurityNumber), "Property is required for class PaymentRequest3ds2.");

            if (paymentRequest3ds2._SplitsOption.IsSet && paymentRequest3ds2.Splits == null)
                throw new ArgumentNullException(nameof(paymentRequest3ds2.Splits), "Property is required for class PaymentRequest3ds2.");

            if (paymentRequest3ds2._StoreOption.IsSet && paymentRequest3ds2.Store == null)
                throw new ArgumentNullException(nameof(paymentRequest3ds2.Store), "Property is required for class PaymentRequest3ds2.");

            if (paymentRequest3ds2._TelephoneNumberOption.IsSet && paymentRequest3ds2.TelephoneNumber == null)
                throw new ArgumentNullException(nameof(paymentRequest3ds2.TelephoneNumber), "Property is required for class PaymentRequest3ds2.");

            if (paymentRequest3ds2._ThreeDS2RequestDataOption.IsSet && paymentRequest3ds2.ThreeDS2RequestData == null)
                throw new ArgumentNullException(nameof(paymentRequest3ds2.ThreeDS2RequestData), "Property is required for class PaymentRequest3ds2.");

            if (paymentRequest3ds2._ThreeDS2ResultOption.IsSet && paymentRequest3ds2.ThreeDS2Result == null)
                throw new ArgumentNullException(nameof(paymentRequest3ds2.ThreeDS2Result), "Property is required for class PaymentRequest3ds2.");

            if (paymentRequest3ds2._ThreeDS2TokenOption.IsSet && paymentRequest3ds2.ThreeDS2Token == null)
                throw new ArgumentNullException(nameof(paymentRequest3ds2.ThreeDS2Token), "Property is required for class PaymentRequest3ds2.");

            if (paymentRequest3ds2._TotalsGroupOption.IsSet && paymentRequest3ds2.TotalsGroup == null)
                throw new ArgumentNullException(nameof(paymentRequest3ds2.TotalsGroup), "Property is required for class PaymentRequest3ds2.");

            */
            
            writer.WritePropertyName("amount");
            JsonSerializer.Serialize(writer, paymentRequest3ds2.Amount, jsonSerializerOptions);
            writer.WriteString("merchantAccount", paymentRequest3ds2.MerchantAccount);

            writer.WriteString("reference", paymentRequest3ds2.Reference);

            if (paymentRequest3ds2._AccountInfoOption.IsSet)
            {
                writer.WritePropertyName("accountInfo");
                JsonSerializer.Serialize(writer, paymentRequest3ds2.AccountInfo, jsonSerializerOptions);
            }
            if (paymentRequest3ds2._AdditionalAmountOption.IsSet)
            {
                writer.WritePropertyName("additionalAmount");
                JsonSerializer.Serialize(writer, paymentRequest3ds2.AdditionalAmount, jsonSerializerOptions);
            }
            if (paymentRequest3ds2._AdditionalDataOption.IsSet)
            {
                writer.WritePropertyName("additionalData");
                JsonSerializer.Serialize(writer, paymentRequest3ds2.AdditionalData, jsonSerializerOptions);
            }
            if (paymentRequest3ds2._ApplicationInfoOption.IsSet)
            {
                writer.WritePropertyName("applicationInfo");
                JsonSerializer.Serialize(writer, paymentRequest3ds2.ApplicationInfo, jsonSerializerOptions);
            }
            if (paymentRequest3ds2._BillingAddressOption.IsSet)
            {
                writer.WritePropertyName("billingAddress");
                JsonSerializer.Serialize(writer, paymentRequest3ds2.BillingAddress, jsonSerializerOptions);
            }
            if (paymentRequest3ds2._BrowserInfoOption.IsSet)
            {
            ...
            if (paymentRequest3ds2._DccQuoteOption.IsSet)
            {
                ...
                JsonSerializer.Serialize(writer, paymentRequest3ds2.DccQuote, jsonSerializerOptions);
            }
            if (paymentRequest3ds2._DeliveryAddressOption.IsSet)
            {
            ...
            if (paymentRequest3ds2._InstallmentsOption.IsSet)
            {
                ...
                JsonSerializer.Serialize(writer, paymentRequest3ds2.Installments, jsonSerializerOptions);
            }
            if (paymentRequest3ds2._LocalizedShopperStatementOption.IsSet)
            {
                writer.WritePropertyName("localizedShopperStatement");
                JsonSerializer.Serialize(writer, paymentRequest3ds2.LocalizedShopperStatement, jsonSerializerOptions);
            }
            if (paymentRequest3ds2._MccOption.IsSet)
                writer.WriteString("mcc", paymentRequest3ds2.Mcc);

            if (paymentRequest3ds2._MerchantOrderReferenceOption.IsSet)
                writer.WriteString("merchantOrderReference", paymentRequest3ds2.MerchantOrderReference);

            if (paymentRequest3ds2._MerchantRiskIndicatorOption.IsSet)
            {
                writer.WritePropertyName("merchantRiskIndicator");
                JsonSerializer.Serialize(writer, paymentRequest3ds2.MerchantRiskIndicator, jsonSerializerOptions);
            }
            if (paymentRequest3ds2._MetadataOption.IsSet)
            {
                writer.WritePropertyName("metadata");
                JsonSerializer.Serialize(writer, paymentRequest3ds2.Metadata, jsonSerializerOptions);
            }
            if (paymentRequest3ds2._OrderReferenceOption.IsSet)
                writer.WriteString("orderReference", paymentRequest3ds2.OrderReference);

            if (paymentRequest3ds2._RecurringOption.IsSet)
            {
                writer.WritePropertyName("recurring");
                JsonSerializer.Serialize(writer, paymentRequest3ds2.Recurring, jsonSerializerOptions);
            }
            if (paymentRequest3ds2._RecurringProcessingModelOption.IsSet && paymentRequest3ds2.RecurringProcessingModel != null) 
            {
                string? recurringProcessingModelRawValue = PaymentRequest3ds2.RecurringProcessingModelEnum.ToJsonValue(paymentRequest3ds2._RecurringProcessingModelOption.Value!.Value);
                writer.WriteString("recurringProcessingModel", recurringProcessingModelRawValue);
            }
            
            if (paymentRequest3ds2._SelectedBrandOption.IsSet)
                writer.WriteString("selectedBrand", paymentRequest3ds2.SelectedBrand);

            if (paymentRequest3ds2._SelectedRecurringDetailReferenceOption.IsSet)
                writer.WriteString("selectedRecurringDetailReference", paymentRequest3ds2.SelectedRecurringDetailReference);

            if (paymentRequest3ds2._SessionIdOption.IsSet)
                writer.WriteString("sessionId", paymentRequest3ds2.SessionId);

            if (paymentRequest3ds2._ShopperEmailOption.IsSet)
                writer.WriteString("shopperEmail", paymentRequest3ds2.ShopperEmail);

            if (paymentRequest3ds2._ShopperIPOption.IsSet)
                writer.WriteString("shopperIP", paymentRequest3ds2.ShopperIP);

            if (paymentRequest3ds2._ShopperInteractionOption.IsSet && paymentRequest3ds2.ShopperInteraction != null) 
            {
                string? shopperInteractionRawValue = PaymentRequest3ds2.ShopperInteractionEnum.ToJsonValue(paymentRequest3ds2._ShopperInteractionOption.Value!.Value);
                writer.WriteString("shopperInteraction", shopperInteractionRawValue);
            }
            
            if (paymentRequest3ds2._ShopperLocaleOption.IsSet)
                writer.WriteString("shopperLocale", paymentRequest3ds2.ShopperLocale);

            if (paymentRequest3ds2._ShopperNameOption.IsSet)
            {
                writer.WritePropertyName("shopperName");
                JsonSerializer.Serialize(writer, paymentRequest3ds2.ShopperName, jsonSerializerOptions);
            }
            if (paymentRequest3ds2._ShopperReferenceOption.IsSet)
                writer.WriteString("shopperReference", paymentRequest3ds2.ShopperReference);

            if (paymentRequest3ds2._ShopperStatementOption.IsSet)
                writer.WriteString("shopperStatement", paymentRequest3ds2.ShopperStatement);

            if (paymentRequest3ds2._SocialSecurityNumberOption.IsSet)
                writer.WriteString("socialSecurityNumber", paymentRequest3ds2.SocialSecurityNumber);

            if (paymentRequest3ds2._SplitsOption.IsSet)
            {
                writer.WritePropertyName("splits");
                JsonSerializer.Serialize(writer, paymentRequest3ds2.Splits, jsonSerializerOptions);
            }
            if (paymentRequest3ds2._StoreOption.IsSet)
                writer.WriteString("store", paymentRequest3ds2.Store);

            if (paymentRequest3ds2._TelephoneNumberOption.IsSet)
                writer.WriteString("telephoneNumber", paymentRequest3ds2.TelephoneNumber);

            if (paymentRequest3ds2._ThreeDS2RequestDataOption.IsSet)
            {
                writer.WritePropertyName("threeDS2RequestData");
                JsonSerializer.Serialize(writer, paymentRequest3ds2.ThreeDS2RequestData, jsonSerializerOptions);
            }
            if (paymentRequest3ds2._ThreeDS2ResultOption.IsSet)
            {
                writer.WritePropertyName("threeDS2Result");
                JsonSerializer.Serialize(writer, paymentRequest3ds2.ThreeDS2Result, jsonSerializerOptions);
            }
            if (paymentRequest3ds2._ThreeDS2TokenOption.IsSet)
