...
namespace Adyen.Payment.Models
{
    ...
    /// </summary>
    [JsonConverter(typeof(AdditionalDataLodgingJsonConverter))]
    ...
    public class AdditionalDataLodgingJsonConverter : JsonConverter<AdditionalDataLodging>
    {
        ...
        public override AdditionalDataLodging Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (lodgingCheckInDate.IsSet)
                additionalDataLodging.LodgingCheckInDate = lodgingCheckInDate.Value;
            if (lodgingCheckOutDate.IsSet)
                additionalDataLodging.LodgingCheckOutDate = lodgingCheckOutDate.Value;
            if (lodgingCustomerServiceTollFreeNumber.IsSet)
                additionalDataLodging.LodgingCustomerServiceTollFreeNumber = lodgingCustomerServiceTollFreeNumber.Value;
            if (lodgingFireSafetyActIndicator.IsSet)
                additionalDataLodging.LodgingFireSafetyActIndicator = lodgingFireSafetyActIndicator.Value;
            if (lodgingFolioCashAdvances.IsSet)
                additionalDataLodging.LodgingFolioCashAdvances = lodgingFolioCashAdvances.Value;
            if (lodgingFolioNumber.IsSet)
                additionalDataLodging.LodgingFolioNumber = lodgingFolioNumber.Value;
            if (lodgingFoodBeverageCharges.IsSet)
                additionalDataLodging.LodgingFoodBeverageCharges = lodgingFoodBeverageCharges.Value;
            if (lodgingNoShowIndicator.IsSet)
                additionalDataLodging.LodgingNoShowIndicator = lodgingNoShowIndicator.Value;
            if (lodgingPrepaidExpenses.IsSet)
                additionalDataLodging.LodgingPrepaidExpenses = lodgingPrepaidExpenses.Value;
            if (lodgingPropertyPhoneNumber.IsSet)
                additionalDataLodging.LodgingPropertyPhoneNumber = lodgingPropertyPhoneNumber.Value;
            if (lodgingRoom1NumberOfNights.IsSet)
                additionalDataLodging.LodgingRoom1NumberOfNights = lodgingRoom1NumberOfNights.Value;
            if (lodgingRoom1Rate.IsSet)
                additionalDataLodging.LodgingRoom1Rate = lodgingRoom1Rate.Value;
            if (lodgingTotalRoomTax.IsSet)
                additionalDataLodging.LodgingTotalRoomTax = lodgingTotalRoomTax.Value;
            if (lodgingTotalTax.IsSet)
                additionalDataLodging.LodgingTotalTax = lodgingTotalTax.Value;
            if (travelEntertainmentAuthDataDuration.IsSet)
                additionalDataLodging.TravelEntertainmentAuthDataDuration = travelEntertainmentAuthDataDuration.Value;
            if (travelEntertainmentAuthDataMarket.IsSet)
                additionalDataLodging.TravelEntertainmentAuthDataMarket = travelEntertainmentAuthDataMarket.Value;
            return additionalDataLodging;
        }
