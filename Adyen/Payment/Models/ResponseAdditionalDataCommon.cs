...
namespace Adyen.Payment.Models
{
    ...
    public partial class ResponseAdditionalDataCommon
    {
        ...
        /// </summary>
        /// <value>Indicates the processing flow.  Possible values: * **sale**: no separate capture required, funds are captured as part of the transaction  * **auth**: separate capture is required. This might be automatic, depending on your [capture settings](https://docs.adyen.com/online-payments/capture#types-of-capture).</value>
