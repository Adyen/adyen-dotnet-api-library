...
namespace Adyen.Payment.Models
{
    ...
    public partial class ThreeDSecureData
    {
        ...
        public class AuthenticationResponseEnum : IEnum
        {
            ...
            /// <summary>
            /// Compares two <see cref="AuthenticationResponseEnum"/> instances for equality.
            /// </summary>
            ...
            /// <summary>
            /// Compares two <see cref="AuthenticationResponseEnum"/> instances for inequality.
            /// </summary>
            public static bool operator !=(AuthenticationResponseEnum? left, AuthenticationResponseEnum? right) => !string.Equals(left?.Value, right?.Value, StringComparison.OrdinalIgnoreCase);

            /// <summary>
            /// Returns true if the given object is equal to this <see cref="AuthenticationResponseEnum"/> instance.
            /// </summary>
            ...
            /// <summary>
            /// Returns a hash code for this <see cref="AuthenticationResponseEnum"/> instance.
            /// </summary>
            public override int GetHashCode() => Value?.GetHashCode() ?? 0;

            /// <summary>
            /// Returns the string value of the <see cref="AuthenticationResponseEnum"/> instance.
            /// </summary>
            ...
            {
                /// <summary>
                /// Deserializes a <see cref="AuthenticationResponseEnum"/> from JSON.
                /// </summary>
                ...
                /// <summary>
                /// Serializes a <see cref="AuthenticationResponseEnum"/> to JSON.
                /// </summary>
        ...
        public class DirectoryResponseEnum : IEnum
        {
            ...
            /// <summary>
            /// Compares two <see cref="DirectoryResponseEnum"/> instances for equality.
            /// </summary>
            ...
            /// <summary>
            /// Compares two <see cref="DirectoryResponseEnum"/> instances for inequality.
            /// </summary>
            public static bool operator !=(DirectoryResponseEnum? left, DirectoryResponseEnum? right) => !string.Equals(left?.Value, right?.Value, StringComparison.OrdinalIgnoreCase);

            /// <summary>
            /// Returns true if the given object is equal to this <see cref="DirectoryResponseEnum"/> instance.
            /// </summary>
            ...
            /// <summary>
            /// Returns a hash code for this <see cref="DirectoryResponseEnum"/> instance.
            /// </summary>
            public override int GetHashCode() => Value?.GetHashCode() ?? 0;

            /// <summary>
            /// Returns the string value of the <see cref="DirectoryResponseEnum"/> instance.
            /// </summary>
            public override string ToString() => Value ?? string.Empty;
            ...
            {
                /// <summary>
                /// Deserializes a <see cref="DirectoryResponseEnum"/> from JSON.
                /// </summary>
                ...
                /// <summary>
                /// Serializes a <see cref="DirectoryResponseEnum"/> to JSON.
                /// </summary>
    ...
    public class ThreeDSecureDataJsonConverter : JsonConverter<ThreeDSecureData>
    {
        ...
        public override ThreeDSecureData Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
                ...
                if (utf8JsonReader.TokenType == JsonTokenType.PropertyName && currentDepth == utf8JsonReader.CurrentDepth - 1)
                {
                    ...
                    switch (jsonPropertyName)
                    {
                        case "authenticationResponse":
                            ...
                            break;
                        case "cavv":
                            cavv = new Option<byte[]?>(ByteArrayConverter.Instance.Read(ref utf8JsonReader, typeof(byte[]), jsonSerializerOptions));
                            break;
                        case "cavvAlgorithm":
                        ...
                        case "tokenAuthenticationVerificationValue":
                            tokenAuthenticationVerificationValue = new Option<byte[]?>(ByteArrayConverter.Instance.Read(ref utf8JsonReader, typeof(byte[]), jsonSerializerOptions));
                            break;
                        case "transStatusReason":
                            transStatusReason = new Option<string?>(utf8JsonReader.GetString()!);
                            break;
                        case "xid":
                            xid = new Option<byte[]?>(ByteArrayConverter.Instance.Read(ref utf8JsonReader, typeof(byte[]), jsonSerializerOptions));
                            break;
                        default:
                            break;
                    }
            ...
            if (cavv.IsSet)
                threeDSecureData.Cavv = cavv.Value;
            if (cavvAlgorithm.IsSet)
                threeDSecureData.CavvAlgorithm = cavvAlgorithm.Value;
            if (challengeCancel.IsSet)
                threeDSecureData.ChallengeCancel = challengeCancel.Value;
            if (directoryResponse.IsSet)
                threeDSecureData.DirectoryResponse = directoryResponse.Value;
            if (dsTransID.IsSet)
                threeDSecureData.DsTransID = dsTransID.Value;
            if (eci.IsSet)
                threeDSecureData.Eci = eci.Value;
            if (riskScore.IsSet)
                threeDSecureData.RiskScore = riskScore.Value;
            if (threeDSVersion.IsSet)
                threeDSecureData.ThreeDSVersion = threeDSVersion.Value;
            if (tokenAuthenticationVerificationValue.IsSet)
                threeDSecureData.TokenAuthenticationVerificationValue = tokenAuthenticationVerificationValue.Value;
            if (transStatusReason.IsSet)
                threeDSecureData.TransStatusReason = transStatusReason.Value;
            if (xid.IsSet)
                threeDSecureData.Xid = xid.Value;
        ...
        public void WriteProperties(Utf8JsonWriter writer, ThreeDSecureData threeDSecureData, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (threeDSecureData._CavvOption.IsSet)
            {
                ...
                ByteArrayConverter.Instance.Write(writer, threeDSecureData.Cavv, jsonSerializerOptions);
            }
            ...
            if (threeDSecureData._TokenAuthenticationVerificationValueOption.IsSet)
            {
                ...
                ByteArrayConverter.Instance.Write(writer, threeDSecureData.TokenAuthenticationVerificationValue, jsonSerializerOptions);
            }
            ...
            if (threeDSecureData._XidOption.IsSet)
            {
                ...
                ByteArrayConverter.Instance.Write(writer, threeDSecureData.Xid, jsonSerializerOptions);
            }
        }
    }
}
