...
namespace Adyen.Payment.Models
{
    ...
    /// </summary>
    [JsonConverter(typeof(AdjustAuthorisationRequestJsonConverter))]
    public partial class AdjustAuthorisationRequest
    {
        /// <summary>
    ...
    public class AdjustAuthorisationRequestJsonConverter : JsonConverter<AdjustAuthorisationRequest>
    {
        ...
        public override AdjustAuthorisationRequest Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (mpiData.IsSet)
                adjustAuthorisationRequest.MpiData = mpiData.Value;
            if (originalMerchantReference.IsSet)
                adjustAuthorisationRequest.OriginalMerchantReference = originalMerchantReference.Value;
            if (platformChargebackLogic.IsSet)
                adjustAuthorisationRequest.PlatformChargebackLogic = platformChargebackLogic.Value;
            if (reference.IsSet)
                adjustAuthorisationRequest.Reference = reference.Value;
            if (splits.IsSet)
                adjustAuthorisationRequest.Splits = splits.Value;
            if (tenderReference.IsSet)
                adjustAuthorisationRequest.TenderReference = tenderReference.Value;
            if (uniqueTerminalId.IsSet)
                adjustAuthorisationRequest.UniqueTerminalId = uniqueTerminalId.Value;
        ...
        public void WriteProperties(Utf8JsonWriter writer, AdjustAuthorisationRequest adjustAuthorisationRequest, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (adjustAuthorisationRequest._OriginalMerchantReferenceOption.IsSet)
                if (adjustAuthorisationRequest.OriginalMerchantReference != null)
            ...
            if (adjustAuthorisationRequest._ReferenceOption.IsSet)
                if (adjustAuthorisationRequest.Reference != null)
            ...
            if (adjustAuthorisationRequest._TenderReferenceOption.IsSet)
                if (adjustAuthorisationRequest.TenderReference != null)
            ...
            if (adjustAuthorisationRequest._UniqueTerminalIdOption.IsSet)
                if (adjustAuthorisationRequest.UniqueTerminalId != null)
