    ...
    public class AuthenticationResultRequestJsonConverter : JsonConverter<AuthenticationResultRequest>
    {
        ...
        public override AuthenticationResultRequest Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (merchantAccount.IsSet && merchantAccount.Value == null)
                throw new ArgumentNullException(nameof(merchantAccount), "Property is not nullable for class AuthenticationResultRequest.");

            if (pspReference.IsSet && pspReference.Value == null)
                throw new ArgumentNullException(nameof(pspReference), "Property is not nullable for class AuthenticationResultRequest.");
        ...
        public void WriteProperties(Utf8JsonWriter writer, AuthenticationResultRequest authenticationResultRequest, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (authenticationResultRequest.MerchantAccount == null)
                throw new ArgumentNullException(nameof(authenticationResultRequest.MerchantAccount), "Property is required for class AuthenticationResultRequest.");

            if (authenticationResultRequest.PspReference == null)
                throw new ArgumentNullException(nameof(authenticationResultRequest.PspReference), "Property is required for class AuthenticationResultRequest.");
