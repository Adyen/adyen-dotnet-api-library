...
namespace Adyen.Payment.Models
{
    ...
    /// DonationRequest.
    /// </summary>
    [JsonConverter(typeof(DonationRequestJsonConverter))]
    ...
    public class DonationRequestJsonConverter : JsonConverter<DonationRequest>
    {
        ...
        public override DonationRequest Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (platformChargebackLogic.IsSet)
                donationRequest.PlatformChargebackLogic = platformChargebackLogic.Value;
            if (reference.IsSet)
                donationRequest.Reference = reference.Value;
