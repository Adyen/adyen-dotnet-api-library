...
namespace Adyen.Payment.Models
{
    ...
    /// DonationRequest.
    /// </summary>
    public partial class DonationRequest : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DonationRequest" /> class.
        /// </summary>
        /// <param name="donationAccount">The Adyen account name of the charity.</param>
    ...
    /// <summary>
    /// A Json converter for type <see cref="DonationRequest" />
    /// </summary>
    public class DonationRequestJsonConverter : JsonConverter<DonationRequest>
    {
        /// <summary>
        /// Deserializes json to <see cref="DonationRequest"/>.
        /// </summary>
        /// <param name="utf8JsonReader"><see cref="Utf8JsonReader"/></param>
        /// <param name="typeToConvert"><see cref="Type"/></param>
        /// <param name="jsonSerializerOptions">The <see cref="JsonSerializerOptions"/>, initialized from <see cref="HostConfiguration"/>.</param>
        /// <returns><see cref="DonationRequest"/></returns>
        /// <exception cref="JsonException"></exception>
        public override DonationRequest Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (donationAccount.IsSet && donationAccount.Value == null)
                throw new ArgumentNullException(nameof(donationAccount), "Property is not nullable for class DonationRequest.");

            if (merchantAccount.IsSet && merchantAccount.Value == null)
                throw new ArgumentNullException(nameof(merchantAccount), "Property is not nullable for class DonationRequest.");

            if (modificationAmount.IsSet && modificationAmount.Value == null)
                throw new ArgumentNullException(nameof(modificationAmount), "Property is not nullable for class DonationRequest.");

            if (originalReference.IsSet && originalReference.Value == null)
                throw new ArgumentNullException(nameof(originalReference), "Property is not nullable for class DonationRequest.");

            if (platformChargebackLogic.IsSet && platformChargebackLogic.Value == null)
                throw new ArgumentNullException(nameof(platformChargebackLogic), "Property is not nullable for class DonationRequest.");

            if (reference.IsSet && reference.Value == null)
                throw new ArgumentNullException(nameof(reference), "Property is not nullable for class DonationRequest.");
        ...
        /// <summary>
        /// Serializes a <see cref="DonationRequest"/>.
        /// </summary>
        /// <param name="writer"><see cref="Utf8JsonWriter"/></param>
        /// <param name="donationRequest"></param>
        /// <param name="jsonSerializerOptions"><see cref="JsonSerializerOptions"/></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, DonationRequest donationRequest, JsonSerializerOptions jsonSerializerOptions)
        {
            
            writer.WriteStartObject();
            
            WriteProperties(writer, donationRequest, jsonSerializerOptions);
        ...
        /// <summary>
        /// Serializes the properties of <see cref="DonationRequest"/>.
        /// </summary>
        /// <param name="writer"><see creft="Utf8JsonWriter"/></param>
        /// <param name="donationRequest"></param>
        /// <param name="jsonSerializerOptions"><see cref="JsonSerializerOptions"/></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, DonationRequest donationRequest, JsonSerializerOptions jsonSerializerOptions)
        {
            /*
            if (donationRequest.DonationAccount == null)
                throw new ArgumentNullException(nameof(donationRequest.DonationAccount), "Property is required for class DonationRequest.");

            if (donationRequest.MerchantAccount == null)
                throw new ArgumentNullException(nameof(donationRequest.MerchantAccount), "Property is required for class DonationRequest.");

            if (donationRequest.ModificationAmount == null)
                throw new ArgumentNullException(nameof(donationRequest.ModificationAmount), "Property is required for class DonationRequest.");

            if (donationRequest._OriginalReferenceOption.IsSet && donationRequest.OriginalReference == null)
                throw new ArgumentNullException(nameof(donationRequest.OriginalReference), "Property is required for class DonationRequest.");

            if (donationRequest._PlatformChargebackLogicOption.IsSet && donationRequest.PlatformChargebackLogic == null)
                throw new ArgumentNullException(nameof(donationRequest.PlatformChargebackLogic), "Property is required for class DonationRequest.");

            if (donationRequest._ReferenceOption.IsSet && donationRequest.Reference == null)
                throw new ArgumentNullException(nameof(donationRequest.Reference), "Property is required for class DonationRequest.");

            */
            
            writer.WriteString("donationAccount", donationRequest.DonationAccount);

            writer.WriteString("merchantAccount", donationRequest.MerchantAccount);

            writer.WritePropertyName("modificationAmount");
            JsonSerializer.Serialize(writer, donationRequest.ModificationAmount, jsonSerializerOptions);
            if (donationRequest._OriginalReferenceOption.IsSet)
                writer.WriteString("originalReference", donationRequest.OriginalReference);

            if (donationRequest._PlatformChargebackLogicOption.IsSet)
            {
                writer.WritePropertyName("platformChargebackLogic");
                JsonSerializer.Serialize(writer, donationRequest.PlatformChargebackLogic, jsonSerializerOptions);
            }
            if (donationRequest._ReferenceOption.IsSet)
                writer.WriteString("reference", donationRequest.Reference);
        }
    }
}
