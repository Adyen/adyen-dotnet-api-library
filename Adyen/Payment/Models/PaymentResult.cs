    ...
    public class PaymentResultJsonConverter : JsonConverter<PaymentResult>
    {
        ...
        public void WriteProperties(Utf8JsonWriter writer, PaymentResult paymentResult, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (paymentResult._AuthCodeOption.IsSet)
                if (paymentResult.AuthCode != null)
            ...
            if (paymentResult._DccSignatureOption.IsSet)
                if (paymentResult.DccSignature != null)
            ...
            if (paymentResult._RefusalReasonOption.IsSet)
                if (paymentResult.RefusalReason != null)
