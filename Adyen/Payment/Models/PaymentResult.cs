...
namespace Adyen.Payment.Models
{
    ...
    /// <summary>
    /// A Json converter for type <see cref="PaymentResult" />
    /// </summary>
    public class PaymentResultJsonConverter : JsonConverter<PaymentResult>
    {
        /// <summary>
        /// Deserializes json to <see cref="PaymentResult"/>.
        /// </summary>
        ...
        public override PaymentResult Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            Option<PaymentResult.ResultCodeEnum?> resultCode = default;
                ...
                if (utf8JsonReader.TokenType == JsonTokenType.PropertyName && currentDepth == utf8JsonReader.CurrentDepth - 1)
                {
                    ...
                    switch (jsonPropertyName)
                    {
                        ...
                        case "resultCode":
                            ...
                            resultCode = new Option<PaymentResult.ResultCodeEnum?>(PaymentResult.ResultCodeEnum.FromStringOrDefault(resultCodeRawValue));
                            break;
                        default:
                            break;
                    }
            ...
            if (additionalData.IsSet && additionalData.Value == null)
                throw new ArgumentNullException(nameof(additionalData), "Property is not nullable for class PaymentResult.");

            if (authCode.IsSet && authCode.Value == null)
                throw new ArgumentNullException(nameof(authCode), "Property is not nullable for class PaymentResult.");

            if (dccAmount.IsSet && dccAmount.Value == null)
                throw new ArgumentNullException(nameof(dccAmount), "Property is not nullable for class PaymentResult.");

            if (dccSignature.IsSet && dccSignature.Value == null)
                throw new ArgumentNullException(nameof(dccSignature), "Property is not nullable for class PaymentResult.");

            if (fraudResult.IsSet && fraudResult.Value == null)
                throw new ArgumentNullException(nameof(fraudResult), "Property is not nullable for class PaymentResult.");

            if (issuerUrl.IsSet && issuerUrl.Value == null)
                throw new ArgumentNullException(nameof(issuerUrl), "Property is not nullable for class PaymentResult.");

            if (md.IsSet && md.Value == null)
                throw new ArgumentNullException(nameof(md), "Property is not nullable for class PaymentResult.");

            if (paRequest.IsSet && paRequest.Value == null)
                throw new ArgumentNullException(nameof(paRequest), "Property is not nullable for class PaymentResult.");

            if (pspReference.IsSet && pspReference.Value == null)
                throw new ArgumentNullException(nameof(pspReference), "Property is not nullable for class PaymentResult.");

            if (refusalReason.IsSet && refusalReason.Value == null)
                throw new ArgumentNullException(nameof(refusalReason), "Property is not nullable for class PaymentResult.");

            if (resultCode.IsSet && resultCode.Value == null)
                throw new ArgumentNullException(nameof(resultCode), "Property is not nullable for class PaymentResult.");

            return new PaymentResult(additionalData, authCode, dccAmount, dccSignature, fraudResult, issuerUrl, md, paRequest, pspReference, refusalReason, resultCode);
        }

        /// <summary>
        /// Serializes a <see cref="PaymentResult"/>.
        /// </summary>
        /// <param name="writer"><see cref="Utf8JsonWriter"/></param>
        /// <param name="paymentResult"></param>
        /// <param name="jsonSerializerOptions"><see cref="JsonSerializerOptions"/></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, PaymentResult paymentResult, JsonSerializerOptions jsonSerializerOptions)
        {
            
            writer.WriteStartObject();
            
            WriteProperties(writer, paymentResult, jsonSerializerOptions);
        ...
        /// <summary>
        /// Serializes the properties of <see cref="PaymentResult"/>.
        /// </summary>
        /// <param name="writer"><see creft="Utf8JsonWriter"/></param>
        /// <param name="paymentResult"></param>
        /// <param name="jsonSerializerOptions"><see cref="JsonSerializerOptions"/></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, PaymentResult paymentResult, JsonSerializerOptions jsonSerializerOptions)
        {
            /*
            if (paymentResult._AdditionalDataOption.IsSet && paymentResult.AdditionalData == null)
                throw new ArgumentNullException(nameof(paymentResult.AdditionalData), "Property is required for class PaymentResult.");

            if (paymentResult._AuthCodeOption.IsSet && paymentResult.AuthCode == null)
                throw new ArgumentNullException(nameof(paymentResult.AuthCode), "Property is required for class PaymentResult.");

            if (paymentResult._DccAmountOption.IsSet && paymentResult.DccAmount == null)
                throw new ArgumentNullException(nameof(paymentResult.DccAmount), "Property is required for class PaymentResult.");

            if (paymentResult._DccSignatureOption.IsSet && paymentResult.DccSignature == null)
                throw new ArgumentNullException(nameof(paymentResult.DccSignature), "Property is required for class PaymentResult.");

            if (paymentResult._FraudResultOption.IsSet && paymentResult.FraudResult == null)
                throw new ArgumentNullException(nameof(paymentResult.FraudResult), "Property is required for class PaymentResult.");

            if (paymentResult._IssuerUrlOption.IsSet && paymentResult.IssuerUrl == null)
                throw new ArgumentNullException(nameof(paymentResult.IssuerUrl), "Property is required for class PaymentResult.");

            if (paymentResult._MdOption.IsSet && paymentResult.Md == null)
                throw new ArgumentNullException(nameof(paymentResult.Md), "Property is required for class PaymentResult.");

            if (paymentResult._PaRequestOption.IsSet && paymentResult.PaRequest == null)
                throw new ArgumentNullException(nameof(paymentResult.PaRequest), "Property is required for class PaymentResult.");

            if (paymentResult._PspReferenceOption.IsSet && paymentResult.PspReference == null)
                throw new ArgumentNullException(nameof(paymentResult.PspReference), "Property is required for class PaymentResult.");

            if (paymentResult._RefusalReasonOption.IsSet && paymentResult.RefusalReason == null)
                throw new ArgumentNullException(nameof(paymentResult.RefusalReason), "Property is required for class PaymentResult.");

            */
            
            if (paymentResult._AdditionalDataOption.IsSet)
            {
                writer.WritePropertyName("additionalData");
                JsonSerializer.Serialize(writer, paymentResult.AdditionalData, jsonSerializerOptions);
            }
            if (paymentResult._AuthCodeOption.IsSet)
                writer.WriteString("authCode", paymentResult.AuthCode);

            if (paymentResult._DccAmountOption.IsSet)
            {
                writer.WritePropertyName("dccAmount");
                JsonSerializer.Serialize(writer, paymentResult.DccAmount, jsonSerializerOptions);
            }
            if (paymentResult._DccSignatureOption.IsSet)
                writer.WriteString("dccSignature", paymentResult.DccSignature);

            if (paymentResult._FraudResultOption.IsSet)
            {
                writer.WritePropertyName("fraudResult");
                JsonSerializer.Serialize(writer, paymentResult.FraudResult, jsonSerializerOptions);
            }
            if (paymentResult._IssuerUrlOption.IsSet)
                writer.WriteString("issuerUrl", paymentResult.IssuerUrl);

            if (paymentResult._MdOption.IsSet)
                writer.WriteString("md", paymentResult.Md);

            if (paymentResult._PaRequestOption.IsSet)
                writer.WriteString("paRequest", paymentResult.PaRequest);

            if (paymentResult._PspReferenceOption.IsSet)
                writer.WriteString("pspReference", paymentResult.PspReference);

            if (paymentResult._RefusalReasonOption.IsSet)
                writer.WriteString("refusalReason", paymentResult.RefusalReason);

            if (paymentResult._ResultCodeOption.IsSet && paymentResult.ResultCode != null) 
            {
                string? resultCodeRawValue = PaymentResult.ResultCodeEnum.ToJsonValue(paymentResult._ResultCodeOption.Value!.Value);
