...
namespace Adyen.Payment.Models
{
    ...
    /// </summary>
    [JsonConverter(typeof(AdditionalDataRiskStandaloneJsonConverter))]
    ...
    public class AdditionalDataRiskStandaloneJsonConverter : JsonConverter<AdditionalDataRiskStandalone>
    {
        ...
        public override AdditionalDataRiskStandalone Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (payPalEmailId.IsSet)
                additionalDataRiskStandalone.PayPalEmailId = payPalEmailId.Value;
            if (payPalFirstName.IsSet)
                additionalDataRiskStandalone.PayPalFirstName = payPalFirstName.Value;
            if (payPalLastName.IsSet)
                additionalDataRiskStandalone.PayPalLastName = payPalLastName.Value;
            if (payPalPayerId.IsSet)
                additionalDataRiskStandalone.PayPalPayerId = payPalPayerId.Value;
            if (payPalPhone.IsSet)
                additionalDataRiskStandalone.PayPalPhone = payPalPhone.Value;
            if (payPalProtectionEligibility.IsSet)
                additionalDataRiskStandalone.PayPalProtectionEligibility = payPalProtectionEligibility.Value;
            if (payPalTransactionId.IsSet)
                additionalDataRiskStandalone.PayPalTransactionId = payPalTransactionId.Value;
            if (avsResultRaw.IsSet)
                additionalDataRiskStandalone.AvsResultRaw = avsResultRaw.Value;
            if (bin.IsSet)
                additionalDataRiskStandalone.Bin = bin.Value;
            if (cvcResultRaw.IsSet)
                additionalDataRiskStandalone.CvcResultRaw = cvcResultRaw.Value;
            if (riskToken.IsSet)
                additionalDataRiskStandalone.RiskToken = riskToken.Value;
            if (threeDAuthenticated.IsSet)
                additionalDataRiskStandalone.ThreeDAuthenticated = threeDAuthenticated.Value;
            if (threeDOffered.IsSet)
                additionalDataRiskStandalone.ThreeDOffered = threeDOffered.Value;
            if (tokenDataType.IsSet)
                additionalDataRiskStandalone.TokenDataType = tokenDataType.Value;
            return additionalDataRiskStandalone;
        }
