    ...
    public class FundDestinationJsonConverter : JsonConverter<FundDestination>
    {
        ...
        public override FundDestination Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (iBAN.IsSet && iBAN.Value == null)
                throw new ArgumentNullException(nameof(iBAN), "Property is not nullable for class FundDestination.");

            if (additionalData.IsSet && additionalData.Value == null)
                throw new ArgumentNullException(nameof(additionalData), "Property is not nullable for class FundDestination.");

            if (billingAddress.IsSet && billingAddress.Value == null)
                throw new ArgumentNullException(nameof(billingAddress), "Property is not nullable for class FundDestination.");

            if (card.IsSet && card.Value == null)
                throw new ArgumentNullException(nameof(card), "Property is not nullable for class FundDestination.");

            if (selectedRecurringDetailReference.IsSet && selectedRecurringDetailReference.Value == null)
                throw new ArgumentNullException(nameof(selectedRecurringDetailReference), "Property is not nullable for class FundDestination.");

            if (shopperEmail.IsSet && shopperEmail.Value == null)
                throw new ArgumentNullException(nameof(shopperEmail), "Property is not nullable for class FundDestination.");

            if (shopperName.IsSet && shopperName.Value == null)
                throw new ArgumentNullException(nameof(shopperName), "Property is not nullable for class FundDestination.");

            if (shopperReference.IsSet && shopperReference.Value == null)
                throw new ArgumentNullException(nameof(shopperReference), "Property is not nullable for class FundDestination.");

            if (subMerchant.IsSet && subMerchant.Value == null)
                throw new ArgumentNullException(nameof(subMerchant), "Property is not nullable for class FundDestination.");

            if (telephoneNumber.IsSet && telephoneNumber.Value == null)
                throw new ArgumentNullException(nameof(telephoneNumber), "Property is not nullable for class FundDestination.");

            if (walletPurpose.IsSet && walletPurpose.Value == null)
                throw new ArgumentNullException(nameof(walletPurpose), "Property is not nullable for class FundDestination.");
        ...
        {
            /*
            if (fundDestination._IBANOption.IsSet && fundDestination.IBAN == null)
                throw new ArgumentNullException(nameof(fundDestination.IBAN), "Property is required for class FundDestination.");

            if (fundDestination._AdditionalDataOption.IsSet && fundDestination.AdditionalData == null)
                throw new ArgumentNullException(nameof(fundDestination.AdditionalData), "Property is required for class FundDestination.");

            if (fundDestination._BillingAddressOption.IsSet && fundDestination.BillingAddress == null)
                throw new ArgumentNullException(nameof(fundDestination.BillingAddress), "Property is required for class FundDestination.");

            if (fundDestination._CardOption.IsSet && fundDestination.Card == null)
                throw new ArgumentNullException(nameof(fundDestination.Card), "Property is required for class FundDestination.");

            if (fundDestination._SelectedRecurringDetailReferenceOption.IsSet && fundDestination.SelectedRecurringDetailReference == null)
                throw new ArgumentNullException(nameof(fundDestination.SelectedRecurringDetailReference), "Property is required for class FundDestination.");

            if (fundDestination._ShopperEmailOption.IsSet && fundDestination.ShopperEmail == null)
                throw new ArgumentNullException(nameof(fundDestination.ShopperEmail), "Property is required for class FundDestination.");

            if (fundDestination._ShopperNameOption.IsSet && fundDestination.ShopperName == null)
                throw new ArgumentNullException(nameof(fundDestination.ShopperName), "Property is required for class FundDestination.");

            if (fundDestination._ShopperReferenceOption.IsSet && fundDestination.ShopperReference == null)
                throw new ArgumentNullException(nameof(fundDestination.ShopperReference), "Property is required for class FundDestination.");

            if (fundDestination._SubMerchantOption.IsSet && fundDestination.SubMerchant == null)
                throw new ArgumentNullException(nameof(fundDestination.SubMerchant), "Property is required for class FundDestination.");

            if (fundDestination._TelephoneNumberOption.IsSet && fundDestination.TelephoneNumber == null)
                throw new ArgumentNullException(nameof(fundDestination.TelephoneNumber), "Property is required for class FundDestination.");

            if (fundDestination._WalletPurposeOption.IsSet && fundDestination.WalletPurpose == null)
                throw new ArgumentNullException(nameof(fundDestination.WalletPurpose), "Property is required for class FundDestination.");
