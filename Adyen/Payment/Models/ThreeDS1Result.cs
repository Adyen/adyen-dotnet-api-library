...
namespace Adyen.Payment.Models
{
    ...
    /// ThreeDS1Result.
    /// </summary>
    public partial class ThreeDS1Result : IValidatableObject
    {
        /// <summary>
    ...
    public class ThreeDS1ResultJsonConverter : JsonConverter<ThreeDS1Result>
    {
        ...
        public override ThreeDS1Result Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (cavv.IsSet && cavv.Value == null)
                throw new ArgumentNullException(nameof(cavv), "Property is not nullable for class ThreeDS1Result.");

            if (cavvAlgorithm.IsSet && cavvAlgorithm.Value == null)
                throw new ArgumentNullException(nameof(cavvAlgorithm), "Property is not nullable for class ThreeDS1Result.");

            if (eci.IsSet && eci.Value == null)
                throw new ArgumentNullException(nameof(eci), "Property is not nullable for class ThreeDS1Result.");

            if (threeDAuthenticatedResponse.IsSet && threeDAuthenticatedResponse.Value == null)
                throw new ArgumentNullException(nameof(threeDAuthenticatedResponse), "Property is not nullable for class ThreeDS1Result.");

            if (threeDOfferedResponse.IsSet && threeDOfferedResponse.Value == null)
                throw new ArgumentNullException(nameof(threeDOfferedResponse), "Property is not nullable for class ThreeDS1Result.");

            if (xid.IsSet && xid.Value == null)
                throw new ArgumentNullException(nameof(xid), "Property is not nullable for class ThreeDS1Result.");
        ...
        {
            /*
            if (threeDS1Result._CavvOption.IsSet && threeDS1Result.Cavv == null)
                throw new ArgumentNullException(nameof(threeDS1Result.Cavv), "Property is required for class ThreeDS1Result.");

            if (threeDS1Result._CavvAlgorithmOption.IsSet && threeDS1Result.CavvAlgorithm == null)
                throw new ArgumentNullException(nameof(threeDS1Result.CavvAlgorithm), "Property is required for class ThreeDS1Result.");

            if (threeDS1Result._EciOption.IsSet && threeDS1Result.Eci == null)
                throw new ArgumentNullException(nameof(threeDS1Result.Eci), "Property is required for class ThreeDS1Result.");

            if (threeDS1Result._ThreeDAuthenticatedResponseOption.IsSet && threeDS1Result.ThreeDAuthenticatedResponse == null)
                throw new ArgumentNullException(nameof(threeDS1Result.ThreeDAuthenticatedResponse), "Property is required for class ThreeDS1Result.");

            if (threeDS1Result._ThreeDOfferedResponseOption.IsSet && threeDS1Result.ThreeDOfferedResponse == null)
                throw new ArgumentNullException(nameof(threeDS1Result.ThreeDOfferedResponse), "Property is required for class ThreeDS1Result.");

            if (threeDS1Result._XidOption.IsSet && threeDS1Result.Xid == null)
                throw new ArgumentNullException(nameof(threeDS1Result.Xid), "Property is required for class ThreeDS1Result.");
