...
namespace Adyen.Payment.Models
{
    ...
    /// ThreeDS1Result.
    /// </summary>
    [JsonConverter(typeof(ThreeDS1ResultJsonConverter))]
    ...
    public class ThreeDS1ResultJsonConverter : JsonConverter<ThreeDS1Result>
    {
        ...
        public override ThreeDS1Result Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (cavvAlgorithm.IsSet)
                threeDS1Result.CavvAlgorithm = cavvAlgorithm.Value;
            if (eci.IsSet)
                threeDS1Result.Eci = eci.Value;
            if (threeDAuthenticatedResponse.IsSet)
                threeDS1Result.ThreeDAuthenticatedResponse = threeDAuthenticatedResponse.Value;
            if (threeDOfferedResponse.IsSet)
                threeDS1Result.ThreeDOfferedResponse = threeDOfferedResponse.Value;
            if (xid.IsSet)
                threeDS1Result.Xid = xid.Value;
