...
namespace Adyen.Payment.Models
{
    ...
    /// </summary>
    [JsonConverter(typeof(AdditionalDataTemporaryServicesJsonConverter))]
    public partial class AdditionalDataTemporaryServices
    {
        /// <summary>
    ...
    public class AdditionalDataTemporaryServicesJsonConverter : JsonConverter<AdditionalDataTemporaryServices>
    {
        ...
        public override AdditionalDataTemporaryServices Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (enhancedSchemeDataEmployeeName.IsSet)
                additionalDataTemporaryServices.EnhancedSchemeDataEmployeeName = enhancedSchemeDataEmployeeName.Value;
            if (enhancedSchemeDataJobDescription.IsSet)
                additionalDataTemporaryServices.EnhancedSchemeDataJobDescription = enhancedSchemeDataJobDescription.Value;
            if (enhancedSchemeDataRegularHoursRate.IsSet)
                additionalDataTemporaryServices.EnhancedSchemeDataRegularHoursRate = enhancedSchemeDataRegularHoursRate.Value;
            if (enhancedSchemeDataRegularHoursWorked.IsSet)
                additionalDataTemporaryServices.EnhancedSchemeDataRegularHoursWorked = enhancedSchemeDataRegularHoursWorked.Value;
            if (enhancedSchemeDataRequestName.IsSet)
                additionalDataTemporaryServices.EnhancedSchemeDataRequestName = enhancedSchemeDataRequestName.Value;
            if (enhancedSchemeDataTempStartDate.IsSet)
                additionalDataTemporaryServices.EnhancedSchemeDataTempStartDate = enhancedSchemeDataTempStartDate.Value;
            if (enhancedSchemeDataTempWeekEnding.IsSet)
                additionalDataTemporaryServices.EnhancedSchemeDataTempWeekEnding = enhancedSchemeDataTempWeekEnding.Value;
            if (enhancedSchemeDataTotalTaxAmount.IsSet)
                additionalDataTemporaryServices.EnhancedSchemeDataTotalTaxAmount = enhancedSchemeDataTotalTaxAmount.Value;
            return additionalDataTemporaryServices;
        }
