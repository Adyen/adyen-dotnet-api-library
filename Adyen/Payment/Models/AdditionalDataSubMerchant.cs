...
namespace Adyen.Payment.Models
{
    ...
    /// </summary>
    [JsonConverter(typeof(AdditionalDataSubMerchantJsonConverter))]
    ...
    public class AdditionalDataSubMerchantJsonConverter : JsonConverter<AdditionalDataSubMerchant>
    {
        ...
        public override AdditionalDataSubMerchant Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (subMerchantSubSellerSubSellerNrCity.IsSet)
                additionalDataSubMerchant.SubMerchantSubSellerSubSellerNrCity = subMerchantSubSellerSubSellerNrCity.Value;
            if (subMerchantSubSellerSubSellerNrCountry.IsSet)
                additionalDataSubMerchant.SubMerchantSubSellerSubSellerNrCountry = subMerchantSubSellerSubSellerNrCountry.Value;
            if (subMerchantSubSellerSubSellerNrEmail.IsSet)
                additionalDataSubMerchant.SubMerchantSubSellerSubSellerNrEmail = subMerchantSubSellerSubSellerNrEmail.Value;
            if (subMerchantSubSellerSubSellerNrId.IsSet)
                additionalDataSubMerchant.SubMerchantSubSellerSubSellerNrId = subMerchantSubSellerSubSellerNrId.Value;
            if (subMerchantSubSellerSubSellerNrMcc.IsSet)
                additionalDataSubMerchant.SubMerchantSubSellerSubSellerNrMcc = subMerchantSubSellerSubSellerNrMcc.Value;
            if (subMerchantSubSellerSubSellerNrName.IsSet)
                additionalDataSubMerchant.SubMerchantSubSellerSubSellerNrName = subMerchantSubSellerSubSellerNrName.Value;
            if (subMerchantSubSellerSubSellerNrPhoneNumber.IsSet)
                additionalDataSubMerchant.SubMerchantSubSellerSubSellerNrPhoneNumber = subMerchantSubSellerSubSellerNrPhoneNumber.Value;
            if (subMerchantSubSellerSubSellerNrPostalCode.IsSet)
                additionalDataSubMerchant.SubMerchantSubSellerSubSellerNrPostalCode = subMerchantSubSellerSubSellerNrPostalCode.Value;
            if (subMerchantSubSellerSubSellerNrState.IsSet)
                additionalDataSubMerchant.SubMerchantSubSellerSubSellerNrState = subMerchantSubSellerSubSellerNrState.Value;
            if (subMerchantSubSellerSubSellerNrStreet.IsSet)
                additionalDataSubMerchant.SubMerchantSubSellerSubSellerNrStreet = subMerchantSubSellerSubSellerNrStreet.Value;
            if (subMerchantSubSellerSubSellerNrTaxId.IsSet)
                additionalDataSubMerchant.SubMerchantSubSellerSubSellerNrTaxId = subMerchantSubSellerSubSellerNrTaxId.Value;
            return additionalDataSubMerchant;
        }
