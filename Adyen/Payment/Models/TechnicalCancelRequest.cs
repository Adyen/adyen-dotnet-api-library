...
namespace Adyen.Payment.Models
{
    ...
    /// </summary>
    [JsonConverter(typeof(TechnicalCancelRequestJsonConverter))]
    ...
    public class TechnicalCancelRequestJsonConverter : JsonConverter<TechnicalCancelRequest>
    {
        ...
        public override TechnicalCancelRequest Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (modificationAmount.IsSet)
                technicalCancelRequest.ModificationAmount = modificationAmount.Value;
            if (mpiData.IsSet)
                technicalCancelRequest.MpiData = mpiData.Value;
            if (platformChargebackLogic.IsSet)
                technicalCancelRequest.PlatformChargebackLogic = platformChargebackLogic.Value;
            if (reference.IsSet)
                technicalCancelRequest.Reference = reference.Value;
            if (splits.IsSet)
                technicalCancelRequest.Splits = splits.Value;
            if (tenderReference.IsSet)
                technicalCancelRequest.TenderReference = tenderReference.Value;
            if (uniqueTerminalId.IsSet)
                technicalCancelRequest.UniqueTerminalId = uniqueTerminalId.Value;
            return technicalCancelRequest;
        }
        ...
        public void WriteProperties(Utf8JsonWriter writer, TechnicalCancelRequest technicalCancelRequest, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (technicalCancelRequest._ReferenceOption.IsSet)
                if (technicalCancelRequest.Reference != null)
            ...
            if (technicalCancelRequest._TenderReferenceOption.IsSet)
                if (technicalCancelRequest.TenderReference != null)
            ...
            if (technicalCancelRequest._UniqueTerminalIdOption.IsSet)
                if (technicalCancelRequest.UniqueTerminalId != null)
