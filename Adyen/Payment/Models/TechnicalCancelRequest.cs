...
namespace Adyen.Payment.Models
{
    ...
    /// <summary>
    /// A Json converter for type <see cref="TechnicalCancelRequest" />
    /// </summary>
    public class TechnicalCancelRequestJsonConverter : JsonConverter<TechnicalCancelRequest>
    {
        /// <summary>
        /// Deserializes json to <see cref="TechnicalCancelRequest"/>.
        /// </summary>
        /// <param name="utf8JsonReader"><see cref="Utf8JsonReader"/></param>
        /// <param name="typeToConvert"><see cref="Type"/></param>
        /// <param name="jsonSerializerOptions">The <see cref="JsonSerializerOptions"/>, initialized from <see cref="HostConfiguration"/>.</param>
        /// <returns><see cref="TechnicalCancelRequest"/></returns>
        /// <exception cref="JsonException"></exception>
        public override TechnicalCancelRequest Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (merchantAccount.IsSet && merchantAccount.Value == null)
                throw new ArgumentNullException(nameof(merchantAccount), "Property is not nullable for class TechnicalCancelRequest.");

            if (originalMerchantReference.IsSet && originalMerchantReference.Value == null)
                throw new ArgumentNullException(nameof(originalMerchantReference), "Property is not nullable for class TechnicalCancelRequest.");

            if (additionalData.IsSet && additionalData.Value == null)
                throw new ArgumentNullException(nameof(additionalData), "Property is not nullable for class TechnicalCancelRequest.");

            if (modificationAmount.IsSet && modificationAmount.Value == null)
                throw new ArgumentNullException(nameof(modificationAmount), "Property is not nullable for class TechnicalCancelRequest.");

            if (mpiData.IsSet && mpiData.Value == null)
                throw new ArgumentNullException(nameof(mpiData), "Property is not nullable for class TechnicalCancelRequest.");

            if (platformChargebackLogic.IsSet && platformChargebackLogic.Value == null)
                throw new ArgumentNullException(nameof(platformChargebackLogic), "Property is not nullable for class TechnicalCancelRequest.");

            if (reference.IsSet && reference.Value == null)
                throw new ArgumentNullException(nameof(reference), "Property is not nullable for class TechnicalCancelRequest.");

            if (splits.IsSet && splits.Value == null)
                throw new ArgumentNullException(nameof(splits), "Property is not nullable for class TechnicalCancelRequest.");

            if (tenderReference.IsSet && tenderReference.Value == null)
                throw new ArgumentNullException(nameof(tenderReference), "Property is not nullable for class TechnicalCancelRequest.");

            if (uniqueTerminalId.IsSet && uniqueTerminalId.Value == null)
                throw new ArgumentNullException(nameof(uniqueTerminalId), "Property is not nullable for class TechnicalCancelRequest.");

            return new TechnicalCancelRequest(merchantAccount.Value!, originalMerchantReference.Value!, additionalData, modificationAmount, mpiData, platformChargebackLogic, reference, splits, tenderReference, uniqueTerminalId);
        }

        /// <summary>
        /// Serializes a <see cref="TechnicalCancelRequest"/>.
        /// </summary>
        /// <param name="writer"><see cref="Utf8JsonWriter"/></param>
        /// <param name="technicalCancelRequest"></param>
        /// <param name="jsonSerializerOptions"><see cref="JsonSerializerOptions"/></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, TechnicalCancelRequest technicalCancelRequest, JsonSerializerOptions jsonSerializerOptions)
        {
            
            writer.WriteStartObject();
            
            WriteProperties(writer, technicalCancelRequest, jsonSerializerOptions);
        ...
        /// <summary>
        /// Serializes the properties of <see cref="TechnicalCancelRequest"/>.
        /// </summary>
        /// <param name="writer"><see creft="Utf8JsonWriter"/></param>
        /// <param name="technicalCancelRequest"></param>
        /// <param name="jsonSerializerOptions"><see cref="JsonSerializerOptions"/></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, TechnicalCancelRequest technicalCancelRequest, JsonSerializerOptions jsonSerializerOptions)
        {
            /*
            if (technicalCancelRequest.MerchantAccount == null)
                throw new ArgumentNullException(nameof(technicalCancelRequest.MerchantAccount), "Property is required for class TechnicalCancelRequest.");

            if (technicalCancelRequest.OriginalMerchantReference == null)
                throw new ArgumentNullException(nameof(technicalCancelRequest.OriginalMerchantReference), "Property is required for class TechnicalCancelRequest.");

            if (technicalCancelRequest._AdditionalDataOption.IsSet && technicalCancelRequest.AdditionalData == null)
                throw new ArgumentNullException(nameof(technicalCancelRequest.AdditionalData), "Property is required for class TechnicalCancelRequest.");

            if (technicalCancelRequest._ModificationAmountOption.IsSet && technicalCancelRequest.ModificationAmount == null)
                throw new ArgumentNullException(nameof(technicalCancelRequest.ModificationAmount), "Property is required for class TechnicalCancelRequest.");

            if (technicalCancelRequest._MpiDataOption.IsSet && technicalCancelRequest.MpiData == null)
                throw new ArgumentNullException(nameof(technicalCancelRequest.MpiData), "Property is required for class TechnicalCancelRequest.");

            if (technicalCancelRequest._PlatformChargebackLogicOption.IsSet && technicalCancelRequest.PlatformChargebackLogic == null)
                throw new ArgumentNullException(nameof(technicalCancelRequest.PlatformChargebackLogic), "Property is required for class TechnicalCancelRequest.");

            if (technicalCancelRequest._ReferenceOption.IsSet && technicalCancelRequest.Reference == null)
                throw new ArgumentNullException(nameof(technicalCancelRequest.Reference), "Property is required for class TechnicalCancelRequest.");

            if (technicalCancelRequest._SplitsOption.IsSet && technicalCancelRequest.Splits == null)
                throw new ArgumentNullException(nameof(technicalCancelRequest.Splits), "Property is required for class TechnicalCancelRequest.");

            if (technicalCancelRequest._TenderReferenceOption.IsSet && technicalCancelRequest.TenderReference == null)
                throw new ArgumentNullException(nameof(technicalCancelRequest.TenderReference), "Property is required for class TechnicalCancelRequest.");

            if (technicalCancelRequest._UniqueTerminalIdOption.IsSet && technicalCancelRequest.UniqueTerminalId == null)
                throw new ArgumentNullException(nameof(technicalCancelRequest.UniqueTerminalId), "Property is required for class TechnicalCancelRequest.");

            */
            
            writer.WriteString("merchantAccount", technicalCancelRequest.MerchantAccount);

            writer.WriteString("originalMerchantReference", technicalCancelRequest.OriginalMerchantReference);

            if (technicalCancelRequest._AdditionalDataOption.IsSet)
            {
                writer.WritePropertyName("additionalData");
                JsonSerializer.Serialize(writer, technicalCancelRequest.AdditionalData, jsonSerializerOptions);
            }
            if (technicalCancelRequest._ModificationAmountOption.IsSet)
            {
                writer.WritePropertyName("modificationAmount");
                JsonSerializer.Serialize(writer, technicalCancelRequest.ModificationAmount, jsonSerializerOptions);
            }
            if (technicalCancelRequest._MpiDataOption.IsSet)
            {
                writer.WritePropertyName("mpiData");
                JsonSerializer.Serialize(writer, technicalCancelRequest.MpiData, jsonSerializerOptions);
            }
            if (technicalCancelRequest._PlatformChargebackLogicOption.IsSet)
            {
                writer.WritePropertyName("platformChargebackLogic");
                JsonSerializer.Serialize(writer, technicalCancelRequest.PlatformChargebackLogic, jsonSerializerOptions);
            }
            if (technicalCancelRequest._ReferenceOption.IsSet)
                writer.WriteString("reference", technicalCancelRequest.Reference);

            if (technicalCancelRequest._SplitsOption.IsSet)
            {
                writer.WritePropertyName("splits");
                JsonSerializer.Serialize(writer, technicalCancelRequest.Splits, jsonSerializerOptions);
            }
            if (technicalCancelRequest._TenderReferenceOption.IsSet)
                writer.WriteString("tenderReference", technicalCancelRequest.TenderReference);

            if (technicalCancelRequest._UniqueTerminalIdOption.IsSet)
                writer.WriteString("uniqueTerminalId", technicalCancelRequest.UniqueTerminalId);
        }
    }
}
