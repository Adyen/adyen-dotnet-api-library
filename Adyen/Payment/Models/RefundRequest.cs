    ...
    public class RefundRequestJsonConverter : JsonConverter<RefundRequest>
    {
        ...
        public override RefundRequest Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (merchantAccount.IsSet && merchantAccount.Value == null)
                throw new ArgumentNullException(nameof(merchantAccount), "Property is not nullable for class RefundRequest.");

            if (modificationAmount.IsSet && modificationAmount.Value == null)
                throw new ArgumentNullException(nameof(modificationAmount), "Property is not nullable for class RefundRequest.");

            if (originalReference.IsSet && originalReference.Value == null)
                throw new ArgumentNullException(nameof(originalReference), "Property is not nullable for class RefundRequest.");

            if (additionalData.IsSet && additionalData.Value == null)
                throw new ArgumentNullException(nameof(additionalData), "Property is not nullable for class RefundRequest.");

            if (mpiData.IsSet && mpiData.Value == null)
                throw new ArgumentNullException(nameof(mpiData), "Property is not nullable for class RefundRequest.");

            if (originalMerchantReference.IsSet && originalMerchantReference.Value == null)
                throw new ArgumentNullException(nameof(originalMerchantReference), "Property is not nullable for class RefundRequest.");

            if (platformChargebackLogic.IsSet && platformChargebackLogic.Value == null)
                throw new ArgumentNullException(nameof(platformChargebackLogic), "Property is not nullable for class RefundRequest.");

            if (reference.IsSet && reference.Value == null)
                throw new ArgumentNullException(nameof(reference), "Property is not nullable for class RefundRequest.");

            if (splits.IsSet && splits.Value == null)
                throw new ArgumentNullException(nameof(splits), "Property is not nullable for class RefundRequest.");

            if (tenderReference.IsSet && tenderReference.Value == null)
                throw new ArgumentNullException(nameof(tenderReference), "Property is not nullable for class RefundRequest.");

            if (uniqueTerminalId.IsSet && uniqueTerminalId.Value == null)
                throw new ArgumentNullException(nameof(uniqueTerminalId), "Property is not nullable for class RefundRequest.");
        ...
        public void WriteProperties(Utf8JsonWriter writer, RefundRequest refundRequest, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (refundRequest.MerchantAccount == null)
                throw new ArgumentNullException(nameof(refundRequest.MerchantAccount), "Property is required for class RefundRequest.");

            if (refundRequest.ModificationAmount == null)
                throw new ArgumentNullException(nameof(refundRequest.ModificationAmount), "Property is required for class RefundRequest.");

            if (refundRequest.OriginalReference == null)
                throw new ArgumentNullException(nameof(refundRequest.OriginalReference), "Property is required for class RefundRequest.");

            if (refundRequest._AdditionalDataOption.IsSet && refundRequest.AdditionalData == null)
                throw new ArgumentNullException(nameof(refundRequest.AdditionalData), "Property is required for class RefundRequest.");

            if (refundRequest._MpiDataOption.IsSet && refundRequest.MpiData == null)
                throw new ArgumentNullException(nameof(refundRequest.MpiData), "Property is required for class RefundRequest.");

            if (refundRequest._OriginalMerchantReferenceOption.IsSet && refundRequest.OriginalMerchantReference == null)
                throw new ArgumentNullException(nameof(refundRequest.OriginalMerchantReference), "Property is required for class RefundRequest.");

            if (refundRequest._PlatformChargebackLogicOption.IsSet && refundRequest.PlatformChargebackLogic == null)
                throw new ArgumentNullException(nameof(refundRequest.PlatformChargebackLogic), "Property is required for class RefundRequest.");

            if (refundRequest._ReferenceOption.IsSet && refundRequest.Reference == null)
                throw new ArgumentNullException(nameof(refundRequest.Reference), "Property is required for class RefundRequest.");

            if (refundRequest._SplitsOption.IsSet && refundRequest.Splits == null)
                throw new ArgumentNullException(nameof(refundRequest.Splits), "Property is required for class RefundRequest.");

            if (refundRequest._TenderReferenceOption.IsSet && refundRequest.TenderReference == null)
                throw new ArgumentNullException(nameof(refundRequest.TenderReference), "Property is required for class RefundRequest.");

            if (refundRequest._UniqueTerminalIdOption.IsSet && refundRequest.UniqueTerminalId == null)
                throw new ArgumentNullException(nameof(refundRequest.UniqueTerminalId), "Property is required for class RefundRequest.");
