...
namespace Adyen.Payment.Models
{
    ...
    /// AdditionalDataRetry.
    /// </summary>
    [JsonConverter(typeof(AdditionalDataRetryJsonConverter))]
    public partial class AdditionalDataRetry
    {
        /// <summary>
    ...
    public class AdditionalDataRetryJsonConverter : JsonConverter<AdditionalDataRetry>
    {
        ...
        public override AdditionalDataRetry Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (retryOrderAttemptNumber.IsSet)
                additionalDataRetry.RetryOrderAttemptNumber = retryOrderAttemptNumber.Value;
            if (retrySkipRetry.IsSet)
                additionalDataRetry.RetrySkipRetry = retrySkipRetry.Value;
            return additionalDataRetry;
        }
