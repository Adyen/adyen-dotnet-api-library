...
namespace Adyen.Payment.Models
{
    ...
    public partial class PlatformChargebackLogic : IValidatableObject
    {
        ...
        /// <summary>
        /// Used to track whether Behavior is set or not.
        /// </summary>
        [JsonIgnore]
    ...
    public class PlatformChargebackLogicJsonConverter : JsonConverter<PlatformChargebackLogic>
    {
        ...
        {
            /*
            if (platformChargebackLogic._CostAllocationAccountOption.IsSet && platformChargebackLogic.CostAllocationAccount == null)
            ...
            if (platformChargebackLogic._TargetAccountOption.IsSet && platformChargebackLogic.TargetAccount == null)
