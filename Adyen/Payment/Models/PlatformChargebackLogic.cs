...
namespace Adyen.Payment.Models
{
    ...
    /// </summary>
    [JsonConverter(typeof(PlatformChargebackLogicJsonConverter))]
    public partial class PlatformChargebackLogic
    {
        /// <summary>
        ...
        public class BehaviorEnum : IEnum
        {
            ...
            /// <summary>
            /// Compares two <see cref="BehaviorEnum"/> instances for equality.
            /// </summary>
            ...
            /// <summary>
            /// Compares two <see cref="BehaviorEnum"/> instances for inequality.
            /// </summary>
            public static bool operator !=(BehaviorEnum? left, BehaviorEnum? right) => !string.Equals(left?.Value, right?.Value, StringComparison.OrdinalIgnoreCase);

            /// <summary>
            /// Returns true if the given object is equal to this <see cref="BehaviorEnum"/> instance.
            /// </summary>
            ...
            /// <summary>
            /// Returns a hash code for this <see cref="BehaviorEnum"/> instance.
            /// </summary>
            public override int GetHashCode() => Value?.GetHashCode() ?? 0;

            /// <summary>
            /// Returns the string value of the <see cref="BehaviorEnum"/> instance.
            /// </summary>
            ...
            {
                /// <summary>
                /// Deserializes a <see cref="BehaviorEnum"/> from JSON.
                /// </summary>
                ...
                /// <summary>
                /// Serializes a <see cref="BehaviorEnum"/> to JSON.
                /// </summary>
    ...
    public class PlatformChargebackLogicJsonConverter : JsonConverter<PlatformChargebackLogic>
    {
        ...
        public override PlatformChargebackLogic Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (costAllocationAccount.IsSet)
                platformChargebackLogic.CostAllocationAccount = costAllocationAccount.Value;
            if (targetAccount.IsSet)
                platformChargebackLogic.TargetAccount = targetAccount.Value;
