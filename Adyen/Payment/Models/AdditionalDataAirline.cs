...
namespace Adyen.Payment.Models
{
    ...
    /// </summary>
    [JsonConverter(typeof(AdditionalDataAirlineJsonConverter))]
    public partial class AdditionalDataAirline
    {
        /// <summary>
    ...
    public class AdditionalDataAirlineJsonConverter : JsonConverter<AdditionalDataAirline>
    {
        ...
        public override AdditionalDataAirline Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (airlineAgencyPlanName.IsSet)
                additionalDataAirline.AirlineAgencyPlanName = airlineAgencyPlanName.Value;
            if (airlineAirlineCode.IsSet)
                additionalDataAirline.AirlineAirlineCode = airlineAirlineCode.Value;
            if (airlineAirlineDesignatorCode.IsSet)
                additionalDataAirline.AirlineAirlineDesignatorCode = airlineAirlineDesignatorCode.Value;
            if (airlineBoardingFee.IsSet)
                additionalDataAirline.AirlineBoardingFee = airlineBoardingFee.Value;
            if (airlineComputerizedReservationSystem.IsSet)
                additionalDataAirline.AirlineComputerizedReservationSystem = airlineComputerizedReservationSystem.Value;
            if (airlineCustomerReferenceNumber.IsSet)
                additionalDataAirline.AirlineCustomerReferenceNumber = airlineCustomerReferenceNumber.Value;
            if (airlineDocumentType.IsSet)
                additionalDataAirline.AirlineDocumentType = airlineDocumentType.Value;
            if (airlineFlightDate.IsSet)
                additionalDataAirline.AirlineFlightDate = airlineFlightDate.Value;
            if (airlineIssueDate.IsSet)
                additionalDataAirline.AirlineIssueDate = airlineIssueDate.Value;
            if (airlineLegCarrierCode.IsSet)
                additionalDataAirline.AirlineLegCarrierCode = airlineLegCarrierCode.Value;
            if (airlineLegClassOfTravel.IsSet)
                additionalDataAirline.AirlineLegClassOfTravel = airlineLegClassOfTravel.Value;
            if (airlineLegDateOfTravel.IsSet)
                additionalDataAirline.AirlineLegDateOfTravel = airlineLegDateOfTravel.Value;
            if (airlineLegDepartAirport.IsSet)
                additionalDataAirline.AirlineLegDepartAirport = airlineLegDepartAirport.Value;
            if (airlineLegDepartTax.IsSet)
                additionalDataAirline.AirlineLegDepartTax = airlineLegDepartTax.Value;
            if (airlineLegDestinationCode.IsSet)
                additionalDataAirline.AirlineLegDestinationCode = airlineLegDestinationCode.Value;
            if (airlineLegFareBaseCode.IsSet)
                additionalDataAirline.AirlineLegFareBaseCode = airlineLegFareBaseCode.Value;
            if (airlineLegFlightNumber.IsSet)
                additionalDataAirline.AirlineLegFlightNumber = airlineLegFlightNumber.Value;
            if (airlineLegStopOverCode.IsSet)
                additionalDataAirline.AirlineLegStopOverCode = airlineLegStopOverCode.Value;
            if (airlinePassengerDateOfBirth.IsSet)
                additionalDataAirline.AirlinePassengerDateOfBirth = airlinePassengerDateOfBirth.Value;
            if (airlinePassengerFirstName.IsSet)
                additionalDataAirline.AirlinePassengerFirstName = airlinePassengerFirstName.Value;
            if (airlinePassengerLastName.IsSet)
                additionalDataAirline.AirlinePassengerLastName = airlinePassengerLastName.Value;
            if (airlinePassengerPhoneNumber.IsSet)
                additionalDataAirline.AirlinePassengerPhoneNumber = airlinePassengerPhoneNumber.Value;
            if (airlinePassengerTravellerType.IsSet)
                additionalDataAirline.AirlinePassengerTravellerType = airlinePassengerTravellerType.Value;
            if (airlineTicketIssueAddress.IsSet)
                additionalDataAirline.AirlineTicketIssueAddress = airlineTicketIssueAddress.Value;
            if (airlineTicketNumber.IsSet)
                additionalDataAirline.AirlineTicketNumber = airlineTicketNumber.Value;
            if (airlineTravelAgencyCode.IsSet)
                additionalDataAirline.AirlineTravelAgencyCode = airlineTravelAgencyCode.Value;
            if (airlineTravelAgencyName.IsSet)
                additionalDataAirline.AirlineTravelAgencyName = airlineTravelAgencyName.Value;
            return additionalDataAirline;
        }
