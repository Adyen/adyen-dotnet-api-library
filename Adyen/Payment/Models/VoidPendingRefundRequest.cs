...
namespace Adyen.Payment.Models
{
    ...
    /// </summary>
    [JsonConverter(typeof(VoidPendingRefundRequestJsonConverter))]
    public partial class VoidPendingRefundRequest
    {
        /// <summary>
        ...
        /// <summary>
        /// This is used to track if an optional field is set. If set, <see cref="ModificationAmount"/> will be populated.
        /// </summary>
        [JsonIgnore]
        [global::System.ComponentModel.EditorBrowsable(global::System.ComponentModel.EditorBrowsableState.Never)]
    ...
    public class VoidPendingRefundRequestJsonConverter : JsonConverter<VoidPendingRefundRequest>
    {
        ...
        public override VoidPendingRefundRequest Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (modificationAmount.IsSet)
                voidPendingRefundRequest.ModificationAmount = modificationAmount.Value;
            if (mpiData.IsSet)
                voidPendingRefundRequest.MpiData = mpiData.Value;
            if (originalMerchantReference.IsSet)
                voidPendingRefundRequest.OriginalMerchantReference = originalMerchantReference.Value;
            if (originalReference.IsSet)
                voidPendingRefundRequest.OriginalReference = originalReference.Value;
            if (platformChargebackLogic.IsSet)
                voidPendingRefundRequest.PlatformChargebackLogic = platformChargebackLogic.Value;
            if (reference.IsSet)
                voidPendingRefundRequest.Reference = reference.Value;
            if (splits.IsSet)
                voidPendingRefundRequest.Splits = splits.Value;
            if (tenderReference.IsSet)
                voidPendingRefundRequest.TenderReference = tenderReference.Value;
            if (uniqueTerminalId.IsSet)
                voidPendingRefundRequest.UniqueTerminalId = uniqueTerminalId.Value;
            return voidPendingRefundRequest;
        }
