...
namespace Adyen.Payment.Models
{
    ...
    /// </summary>
    [JsonConverter(typeof(AdditionalDataRatepayJsonConverter))]
    public partial class AdditionalDataRatepay
    {
        /// <summary>
    ...
    public class AdditionalDataRatepayJsonConverter : JsonConverter<AdditionalDataRatepay>
    {
        ...
        public override AdditionalDataRatepay Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (ratepayInterestRate.IsSet)
                additionalDataRatepay.RatepayInterestRate = ratepayInterestRate.Value;
            if (ratepayLastInstallmentAmount.IsSet)
                additionalDataRatepay.RatepayLastInstallmentAmount = ratepayLastInstallmentAmount.Value;
            if (ratepayPaymentFirstday.IsSet)
                additionalDataRatepay.RatepayPaymentFirstday = ratepayPaymentFirstday.Value;
            if (ratepaydataDeliveryDate.IsSet)
                additionalDataRatepay.RatepaydataDeliveryDate = ratepaydataDeliveryDate.Value;
            if (ratepaydataDueDate.IsSet)
                additionalDataRatepay.RatepaydataDueDate = ratepaydataDueDate.Value;
            if (ratepaydataInvoiceDate.IsSet)
                additionalDataRatepay.RatepaydataInvoiceDate = ratepaydataInvoiceDate.Value;
            if (ratepaydataInvoiceId.IsSet)
                additionalDataRatepay.RatepaydataInvoiceId = ratepaydataInvoiceId.Value;
            return additionalDataRatepay;
        }
