...
namespace Adyen.Payment.Models
{
    ...
    /// PaymentRequest3d.
    /// </summary>
    [JsonConverter(typeof(PaymentRequest3dJsonConverter))]
    ...
    public class PaymentRequest3dJsonConverter : JsonConverter<PaymentRequest3d>
    {
        ...
        public override PaymentRequest3d Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
                ...
                if (utf8JsonReader.TokenType == JsonTokenType.PropertyName && currentDepth == utf8JsonReader.CurrentDepth - 1)
                {
                    ...
                    switch (jsonPropertyName)
                    {
                        ...
                        case "recurringProcessingModel":
                            ...
                            recurringProcessingModel = new Option<PaymentRequest3d.RecurringProcessingModelEnum?>(PaymentRequest3d.RecurringProcessingModelEnum.FromStringOrDefault(recurringProcessingModelRawValue) ?? (PaymentRequest3d.RecurringProcessingModelEnum)recurringProcessingModelRawValue);
                            break;
                        case "reference":
                        ...
                        case "shopperInteraction":
                            ...
                            shopperInteraction = new Option<PaymentRequest3d.ShopperInteractionEnum?>(PaymentRequest3d.ShopperInteractionEnum.FromStringOrDefault(shopperInteractionRawValue) ?? (PaymentRequest3d.ShopperInteractionEnum)shopperInteractionRawValue);
                            break;
                        case "shopperLocale":
            ...
            if (additionalAmount.IsSet)
                paymentRequest3d.AdditionalAmount = additionalAmount.Value;
            if (additionalData.IsSet)
                paymentRequest3d.AdditionalData = additionalData.Value;
            if (amount.IsSet)
                paymentRequest3d.Amount = amount.Value;
            if (applicationInfo.IsSet)
                paymentRequest3d.ApplicationInfo = applicationInfo.Value;
            if (billingAddress.IsSet)
                paymentRequest3d.BillingAddress = billingAddress.Value;
            if (browserInfo.IsSet)
                paymentRequest3d.BrowserInfo = browserInfo.Value;
            if (captureDelayHours.IsSet)
                paymentRequest3d.CaptureDelayHours = captureDelayHours.Value;
            if (dateOfBirth.IsSet)
                paymentRequest3d.DateOfBirth = dateOfBirth.Value;
            if (dccQuote.IsSet)
                paymentRequest3d.DccQuote = dccQuote.Value;
            if (deliveryAddress.IsSet)
                paymentRequest3d.DeliveryAddress = deliveryAddress.Value;
            if (deliveryDate.IsSet)
                paymentRequest3d.DeliveryDate = deliveryDate.Value;
            if (deviceFingerprint.IsSet)
                paymentRequest3d.DeviceFingerprint = deviceFingerprint.Value;
            if (fraudOffset.IsSet)
                paymentRequest3d.FraudOffset = fraudOffset.Value;
            if (installments.IsSet)
                paymentRequest3d.Installments = installments.Value;
            if (localizedShopperStatement.IsSet)
                paymentRequest3d.LocalizedShopperStatement = localizedShopperStatement.Value;
            if (mcc.IsSet)
                paymentRequest3d.Mcc = mcc.Value;
            if (merchantOrderReference.IsSet)
                paymentRequest3d.MerchantOrderReference = merchantOrderReference.Value;
            if (merchantRiskIndicator.IsSet)
                paymentRequest3d.MerchantRiskIndicator = merchantRiskIndicator.Value;
            if (metadata.IsSet)
                paymentRequest3d.Metadata = metadata.Value;
            if (orderReference.IsSet)
                paymentRequest3d.OrderReference = orderReference.Value;
            if (recurring.IsSet)
                paymentRequest3d.Recurring = recurring.Value;
            if (recurringProcessingModel.IsSet)
                paymentRequest3d.RecurringProcessingModel = recurringProcessingModel.Value;
            if (reference.IsSet)
                paymentRequest3d.Reference = reference.Value;
            if (selectedBrand.IsSet)
                paymentRequest3d.SelectedBrand = selectedBrand.Value;
            if (selectedRecurringDetailReference.IsSet)
                paymentRequest3d.SelectedRecurringDetailReference = selectedRecurringDetailReference.Value;
            if (sessionId.IsSet)
                paymentRequest3d.SessionId = sessionId.Value;
            if (shopperEmail.IsSet)
                paymentRequest3d.ShopperEmail = shopperEmail.Value;
            if (shopperIP.IsSet)
                paymentRequest3d.ShopperIP = shopperIP.Value;
            if (shopperInteraction.IsSet)
                paymentRequest3d.ShopperInteraction = shopperInteraction.Value;
            if (shopperLocale.IsSet)
                paymentRequest3d.ShopperLocale = shopperLocale.Value;
            if (shopperName.IsSet)
                paymentRequest3d.ShopperName = shopperName.Value;
            if (shopperReference.IsSet)
                paymentRequest3d.ShopperReference = shopperReference.Value;
            if (shopperStatement.IsSet)
                paymentRequest3d.ShopperStatement = shopperStatement.Value;
            if (socialSecurityNumber.IsSet)
                paymentRequest3d.SocialSecurityNumber = socialSecurityNumber.Value;
            if (splits.IsSet)
                paymentRequest3d.Splits = splits.Value;
            if (store.IsSet)
                paymentRequest3d.Store = store.Value;
            if (telephoneNumber.IsSet)
                paymentRequest3d.TelephoneNumber = telephoneNumber.Value;
            if (threeDS2RequestData.IsSet)
                paymentRequest3d.ThreeDS2RequestData = threeDS2RequestData.Value;
            if (threeDSAuthenticationOnly.IsSet)
                paymentRequest3d.ThreeDSAuthenticationOnly = threeDSAuthenticationOnly.Value;
            if (totalsGroup.IsSet)
                paymentRequest3d.TotalsGroup = totalsGroup.Value;
            if (trustedShopper.IsSet)
                paymentRequest3d.TrustedShopper = trustedShopper.Value;
        ...
        public void WriteProperties(Utf8JsonWriter writer, PaymentRequest3d paymentRequest3d, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (paymentRequest3d._CaptureDelayHoursOption.IsSet)
                if (paymentRequest3d._CaptureDelayHoursOption.Value != null)
            ...
            if (paymentRequest3d._DateOfBirthOption.IsSet)
                if (paymentRequest3d._DateOfBirthOption.Value != null)
            ...
            if (paymentRequest3d._DeliveryDateOption.IsSet)
                if (paymentRequest3d._DeliveryDateOption.Value != null)
            ...
            if (paymentRequest3d._FraudOffsetOption.IsSet)
                if (paymentRequest3d._FraudOffsetOption.Value != null)
            ...
            if (paymentRequest3d._ThreeDSAuthenticationOnlyOption.IsSet)
                if (paymentRequest3d._ThreeDSAuthenticationOnlyOption.Value != null)
            ...
            if (paymentRequest3d._TrustedShopperOption.IsSet)
                if (paymentRequest3d._TrustedShopperOption.Value != null)
