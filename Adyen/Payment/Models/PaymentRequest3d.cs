    ...
    public class PaymentRequest3dJsonConverter : JsonConverter<PaymentRequest3d>
    {
        ...
        public override PaymentRequest3d Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (md.IsSet && md.Value == null)
                throw new ArgumentNullException(nameof(md), "Property is not nullable for class PaymentRequest3d.");

            if (merchantAccount.IsSet && merchantAccount.Value == null)
                throw new ArgumentNullException(nameof(merchantAccount), "Property is not nullable for class PaymentRequest3d.");

            if (paResponse.IsSet && paResponse.Value == null)
                throw new ArgumentNullException(nameof(paResponse), "Property is not nullable for class PaymentRequest3d.");

            if (accountInfo.IsSet && accountInfo.Value == null)
                throw new ArgumentNullException(nameof(accountInfo), "Property is not nullable for class PaymentRequest3d.");

            if (additionalAmount.IsSet && additionalAmount.Value == null)
                throw new ArgumentNullException(nameof(additionalAmount), "Property is not nullable for class PaymentRequest3d.");

            if (additionalData.IsSet && additionalData.Value == null)
                throw new ArgumentNullException(nameof(additionalData), "Property is not nullable for class PaymentRequest3d.");

            if (amount.IsSet && amount.Value == null)
                throw new ArgumentNullException(nameof(amount), "Property is not nullable for class PaymentRequest3d.");

            if (applicationInfo.IsSet && applicationInfo.Value == null)
                throw new ArgumentNullException(nameof(applicationInfo), "Property is not nullable for class PaymentRequest3d.");

            if (billingAddress.IsSet && billingAddress.Value == null)
                throw new ArgumentNullException(nameof(billingAddress), "Property is not nullable for class PaymentRequest3d.");

            if (browserInfo.IsSet && browserInfo.Value == null)
                throw new ArgumentNullException(nameof(browserInfo), "Property is not nullable for class PaymentRequest3d.");

            if (captureDelayHours.IsSet && captureDelayHours.Value == null)
                throw new ArgumentNullException(nameof(captureDelayHours), "Property is not nullable for class PaymentRequest3d.");

            if (dateOfBirth.IsSet && dateOfBirth.Value == null)
                throw new ArgumentNullException(nameof(dateOfBirth), "Property is not nullable for class PaymentRequest3d.");

            if (dccQuote.IsSet && dccQuote.Value == null)
                throw new ArgumentNullException(nameof(dccQuote), "Property is not nullable for class PaymentRequest3d.");

            if (deliveryAddress.IsSet && deliveryAddress.Value == null)
                throw new ArgumentNullException(nameof(deliveryAddress), "Property is not nullable for class PaymentRequest3d.");

            if (deliveryDate.IsSet && deliveryDate.Value == null)
                throw new ArgumentNullException(nameof(deliveryDate), "Property is not nullable for class PaymentRequest3d.");

            if (deviceFingerprint.IsSet && deviceFingerprint.Value == null)
                throw new ArgumentNullException(nameof(deviceFingerprint), "Property is not nullable for class PaymentRequest3d.");

            if (fraudOffset.IsSet && fraudOffset.Value == null)
                throw new ArgumentNullException(nameof(fraudOffset), "Property is not nullable for class PaymentRequest3d.");

            if (installments.IsSet && installments.Value == null)
                throw new ArgumentNullException(nameof(installments), "Property is not nullable for class PaymentRequest3d.");

            if (localizedShopperStatement.IsSet && localizedShopperStatement.Value == null)
                throw new ArgumentNullException(nameof(localizedShopperStatement), "Property is not nullable for class PaymentRequest3d.");

            if (mcc.IsSet && mcc.Value == null)
                throw new ArgumentNullException(nameof(mcc), "Property is not nullable for class PaymentRequest3d.");

            if (merchantOrderReference.IsSet && merchantOrderReference.Value == null)
                throw new ArgumentNullException(nameof(merchantOrderReference), "Property is not nullable for class PaymentRequest3d.");

            if (merchantRiskIndicator.IsSet && merchantRiskIndicator.Value == null)
                throw new ArgumentNullException(nameof(merchantRiskIndicator), "Property is not nullable for class PaymentRequest3d.");

            if (metadata.IsSet && metadata.Value == null)
                throw new ArgumentNullException(nameof(metadata), "Property is not nullable for class PaymentRequest3d.");

            if (orderReference.IsSet && orderReference.Value == null)
                throw new ArgumentNullException(nameof(orderReference), "Property is not nullable for class PaymentRequest3d.");

            if (recurring.IsSet && recurring.Value == null)
                throw new ArgumentNullException(nameof(recurring), "Property is not nullable for class PaymentRequest3d.");

            if (recurringProcessingModel.IsSet && recurringProcessingModel.Value == null)
                throw new ArgumentNullException(nameof(recurringProcessingModel), "Property is not nullable for class PaymentRequest3d.");

            if (reference.IsSet && reference.Value == null)
                throw new ArgumentNullException(nameof(reference), "Property is not nullable for class PaymentRequest3d.");

            if (selectedBrand.IsSet && selectedBrand.Value == null)
                throw new ArgumentNullException(nameof(selectedBrand), "Property is not nullable for class PaymentRequest3d.");

            if (selectedRecurringDetailReference.IsSet && selectedRecurringDetailReference.Value == null)
                throw new ArgumentNullException(nameof(selectedRecurringDetailReference), "Property is not nullable for class PaymentRequest3d.");

            if (sessionId.IsSet && sessionId.Value == null)
                throw new ArgumentNullException(nameof(sessionId), "Property is not nullable for class PaymentRequest3d.");

            if (shopperEmail.IsSet && shopperEmail.Value == null)
                throw new ArgumentNullException(nameof(shopperEmail), "Property is not nullable for class PaymentRequest3d.");

            if (shopperIP.IsSet && shopperIP.Value == null)
                throw new ArgumentNullException(nameof(shopperIP), "Property is not nullable for class PaymentRequest3d.");

            if (shopperInteraction.IsSet && shopperInteraction.Value == null)
                throw new ArgumentNullException(nameof(shopperInteraction), "Property is not nullable for class PaymentRequest3d.");

            if (shopperLocale.IsSet && shopperLocale.Value == null)
                throw new ArgumentNullException(nameof(shopperLocale), "Property is not nullable for class PaymentRequest3d.");

            if (shopperName.IsSet && shopperName.Value == null)
                throw new ArgumentNullException(nameof(shopperName), "Property is not nullable for class PaymentRequest3d.");

            if (shopperReference.IsSet && shopperReference.Value == null)
                throw new ArgumentNullException(nameof(shopperReference), "Property is not nullable for class PaymentRequest3d.");

            if (shopperStatement.IsSet && shopperStatement.Value == null)
                throw new ArgumentNullException(nameof(shopperStatement), "Property is not nullable for class PaymentRequest3d.");

            if (socialSecurityNumber.IsSet && socialSecurityNumber.Value == null)
                throw new ArgumentNullException(nameof(socialSecurityNumber), "Property is not nullable for class PaymentRequest3d.");

            if (splits.IsSet && splits.Value == null)
                throw new ArgumentNullException(nameof(splits), "Property is not nullable for class PaymentRequest3d.");

            if (store.IsSet && store.Value == null)
                throw new ArgumentNullException(nameof(store), "Property is not nullable for class PaymentRequest3d.");

            if (telephoneNumber.IsSet && telephoneNumber.Value == null)
                throw new ArgumentNullException(nameof(telephoneNumber), "Property is not nullable for class PaymentRequest3d.");

            if (threeDS2RequestData.IsSet && threeDS2RequestData.Value == null)
                throw new ArgumentNullException(nameof(threeDS2RequestData), "Property is not nullable for class PaymentRequest3d.");

            if (threeDSAuthenticationOnly.IsSet && threeDSAuthenticationOnly.Value == null)
                throw new ArgumentNullException(nameof(threeDSAuthenticationOnly), "Property is not nullable for class PaymentRequest3d.");

            if (totalsGroup.IsSet && totalsGroup.Value == null)
                throw new ArgumentNullException(nameof(totalsGroup), "Property is not nullable for class PaymentRequest3d.");

            if (trustedShopper.IsSet && trustedShopper.Value == null)
                throw new ArgumentNullException(nameof(trustedShopper), "Property is not nullable for class PaymentRequest3d.");
        ...
        public void WriteProperties(Utf8JsonWriter writer, PaymentRequest3d paymentRequest3d, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (paymentRequest3d.Md == null)
                throw new ArgumentNullException(nameof(paymentRequest3d.Md), "Property is required for class PaymentRequest3d.");

            if (paymentRequest3d.MerchantAccount == null)
                throw new ArgumentNullException(nameof(paymentRequest3d.MerchantAccount), "Property is required for class PaymentRequest3d.");

            if (paymentRequest3d.PaResponse == null)
                throw new ArgumentNullException(nameof(paymentRequest3d.PaResponse), "Property is required for class PaymentRequest3d.");

            if (paymentRequest3d._AccountInfoOption.IsSet && paymentRequest3d.AccountInfo == null)
                throw new ArgumentNullException(nameof(paymentRequest3d.AccountInfo), "Property is required for class PaymentRequest3d.");

            if (paymentRequest3d._AdditionalAmountOption.IsSet && paymentRequest3d.AdditionalAmount == null)
                throw new ArgumentNullException(nameof(paymentRequest3d.AdditionalAmount), "Property is required for class PaymentRequest3d.");

            if (paymentRequest3d._AdditionalDataOption.IsSet && paymentRequest3d.AdditionalData == null)
                throw new ArgumentNullException(nameof(paymentRequest3d.AdditionalData), "Property is required for class PaymentRequest3d.");

            if (paymentRequest3d._AmountOption.IsSet && paymentRequest3d.Amount == null)
                throw new ArgumentNullException(nameof(paymentRequest3d.Amount), "Property is required for class PaymentRequest3d.");

            if (paymentRequest3d._ApplicationInfoOption.IsSet && paymentRequest3d.ApplicationInfo == null)
                throw new ArgumentNullException(nameof(paymentRequest3d.ApplicationInfo), "Property is required for class PaymentRequest3d.");

            if (paymentRequest3d._BillingAddressOption.IsSet && paymentRequest3d.BillingAddress == null)
                throw new ArgumentNullException(nameof(paymentRequest3d.BillingAddress), "Property is required for class PaymentRequest3d.");

            if (paymentRequest3d._BrowserInfoOption.IsSet && paymentRequest3d.BrowserInfo == null)
                throw new ArgumentNullException(nameof(paymentRequest3d.BrowserInfo), "Property is required for class PaymentRequest3d.");

            if (paymentRequest3d._DccQuoteOption.IsSet && paymentRequest3d.DccQuote == null)
                throw new ArgumentNullException(nameof(paymentRequest3d.DccQuote), "Property is required for class PaymentRequest3d.");

            if (paymentRequest3d._DeliveryAddressOption.IsSet && paymentRequest3d.DeliveryAddress == null)
                throw new ArgumentNullException(nameof(paymentRequest3d.DeliveryAddress), "Property is required for class PaymentRequest3d.");

            if (paymentRequest3d._DeviceFingerprintOption.IsSet && paymentRequest3d.DeviceFingerprint == null)
                throw new ArgumentNullException(nameof(paymentRequest3d.DeviceFingerprint), "Property is required for class PaymentRequest3d.");

            if (paymentRequest3d._InstallmentsOption.IsSet && paymentRequest3d.Installments == null)
                throw new ArgumentNullException(nameof(paymentRequest3d.Installments), "Property is required for class PaymentRequest3d.");

            if (paymentRequest3d._LocalizedShopperStatementOption.IsSet && paymentRequest3d.LocalizedShopperStatement == null)
                throw new ArgumentNullException(nameof(paymentRequest3d.LocalizedShopperStatement), "Property is required for class PaymentRequest3d.");

            if (paymentRequest3d._MccOption.IsSet && paymentRequest3d.Mcc == null)
                throw new ArgumentNullException(nameof(paymentRequest3d.Mcc), "Property is required for class PaymentRequest3d.");

            if (paymentRequest3d._MerchantOrderReferenceOption.IsSet && paymentRequest3d.MerchantOrderReference == null)
                throw new ArgumentNullException(nameof(paymentRequest3d.MerchantOrderReference), "Property is required for class PaymentRequest3d.");

            if (paymentRequest3d._MerchantRiskIndicatorOption.IsSet && paymentRequest3d.MerchantRiskIndicator == null)
                throw new ArgumentNullException(nameof(paymentRequest3d.MerchantRiskIndicator), "Property is required for class PaymentRequest3d.");

            if (paymentRequest3d._MetadataOption.IsSet && paymentRequest3d.Metadata == null)
                throw new ArgumentNullException(nameof(paymentRequest3d.Metadata), "Property is required for class PaymentRequest3d.");

            if (paymentRequest3d._OrderReferenceOption.IsSet && paymentRequest3d.OrderReference == null)
                throw new ArgumentNullException(nameof(paymentRequest3d.OrderReference), "Property is required for class PaymentRequest3d.");

            if (paymentRequest3d._RecurringOption.IsSet && paymentRequest3d.Recurring == null)
                throw new ArgumentNullException(nameof(paymentRequest3d.Recurring), "Property is required for class PaymentRequest3d.");

            if (paymentRequest3d._ReferenceOption.IsSet && paymentRequest3d.Reference == null)
                throw new ArgumentNullException(nameof(paymentRequest3d.Reference), "Property is required for class PaymentRequest3d.");

            if (paymentRequest3d._SelectedBrandOption.IsSet && paymentRequest3d.SelectedBrand == null)
                throw new ArgumentNullException(nameof(paymentRequest3d.SelectedBrand), "Property is required for class PaymentRequest3d.");

            if (paymentRequest3d._SelectedRecurringDetailReferenceOption.IsSet && paymentRequest3d.SelectedRecurringDetailReference == null)
                throw new ArgumentNullException(nameof(paymentRequest3d.SelectedRecurringDetailReference), "Property is required for class PaymentRequest3d.");

            if (paymentRequest3d._SessionIdOption.IsSet && paymentRequest3d.SessionId == null)
                throw new ArgumentNullException(nameof(paymentRequest3d.SessionId), "Property is required for class PaymentRequest3d.");

            if (paymentRequest3d._ShopperEmailOption.IsSet && paymentRequest3d.ShopperEmail == null)
                throw new ArgumentNullException(nameof(paymentRequest3d.ShopperEmail), "Property is required for class PaymentRequest3d.");

            if (paymentRequest3d._ShopperIPOption.IsSet && paymentRequest3d.ShopperIP == null)
                throw new ArgumentNullException(nameof(paymentRequest3d.ShopperIP), "Property is required for class PaymentRequest3d.");

            if (paymentRequest3d._ShopperLocaleOption.IsSet && paymentRequest3d.ShopperLocale == null)
                throw new ArgumentNullException(nameof(paymentRequest3d.ShopperLocale), "Property is required for class PaymentRequest3d.");

            if (paymentRequest3d._ShopperNameOption.IsSet && paymentRequest3d.ShopperName == null)
                throw new ArgumentNullException(nameof(paymentRequest3d.ShopperName), "Property is required for class PaymentRequest3d.");

            if (paymentRequest3d._ShopperReferenceOption.IsSet && paymentRequest3d.ShopperReference == null)
                throw new ArgumentNullException(nameof(paymentRequest3d.ShopperReference), "Property is required for class PaymentRequest3d.");

            if (paymentRequest3d._ShopperStatementOption.IsSet && paymentRequest3d.ShopperStatement == null)
                throw new ArgumentNullException(nameof(paymentRequest3d.ShopperStatement), "Property is required for class PaymentRequest3d.");

            if (paymentRequest3d._SocialSecurityNumberOption.IsSet && paymentRequest3d.SocialSecurityNumber == null)
                throw new ArgumentNullException(nameof(paymentRequest3d.SocialSecurityNumber), "Property is required for class PaymentRequest3d.");

            if (paymentRequest3d._SplitsOption.IsSet && paymentRequest3d.Splits == null)
                throw new ArgumentNullException(nameof(paymentRequest3d.Splits), "Property is required for class PaymentRequest3d.");

            if (paymentRequest3d._StoreOption.IsSet && paymentRequest3d.Store == null)
                throw new ArgumentNullException(nameof(paymentRequest3d.Store), "Property is required for class PaymentRequest3d.");

            if (paymentRequest3d._TelephoneNumberOption.IsSet && paymentRequest3d.TelephoneNumber == null)
                throw new ArgumentNullException(nameof(paymentRequest3d.TelephoneNumber), "Property is required for class PaymentRequest3d.");

            if (paymentRequest3d._ThreeDS2RequestDataOption.IsSet && paymentRequest3d.ThreeDS2RequestData == null)
                throw new ArgumentNullException(nameof(paymentRequest3d.ThreeDS2RequestData), "Property is required for class PaymentRequest3d.");

            if (paymentRequest3d._TotalsGroupOption.IsSet && paymentRequest3d.TotalsGroup == null)
                throw new ArgumentNullException(nameof(paymentRequest3d.TotalsGroup), "Property is required for class PaymentRequest3d.");
