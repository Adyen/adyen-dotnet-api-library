...
namespace Adyen.Payment.Models
{
    ...
    public class PaymentRequestJsonConverter : JsonConverter<PaymentRequest>
    {
        ...
        public override PaymentRequest Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (card.IsSet)
                paymentRequest.Card = card.Value;
            ...
            if (fundDestination.IsSet)
                paymentRequest.FundDestination = fundDestination.Value;
            if (fundSource.IsSet)
                paymentRequest.FundSource = fundSource.Value;
            if (fundingSource.IsSet)
                paymentRequest.FundingSource = fundingSource.Value;
            ...
            if (nationality.IsSet)
                paymentRequest.Nationality = nationality.Value;
            ...
            if (recurring.IsSet)
                paymentRequest.Recurring = recurring.Value;
            if (recurringProcessingModel.IsSet)
                paymentRequest.RecurringProcessingModel = recurringProcessingModel.Value;
            if (secureRemoteCommerceCheckoutData.IsSet)
                paymentRequest.SecureRemoteCommerceCheckoutData = secureRemoteCommerceCheckoutData.Value;
            if (selectedBrand.IsSet)
                paymentRequest.SelectedBrand = selectedBrand.Value;
            if (selectedRecurringDetailReference.IsSet)
                paymentRequest.SelectedRecurringDetailReference = selectedRecurringDetailReference.Value;
            if (sessionId.IsSet)
                paymentRequest.SessionId = sessionId.Value;
            ...
            if (totalsGroup.IsSet)
                paymentRequest.TotalsGroup = totalsGroup.Value;
