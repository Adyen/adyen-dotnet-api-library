...
namespace Adyen.Payment.Models
{
    ...
    public partial class SecureRemoteCommerceCheckoutData : IValidatableObject
    {
        ...
        /// <summary>
        /// Used to track whether Scheme is set or not.
        /// </summary>
        [JsonIgnore]
    ...
    public class SecureRemoteCommerceCheckoutDataJsonConverter : JsonConverter<SecureRemoteCommerceCheckoutData>
    {
        ...
        public override SecureRemoteCommerceCheckoutData Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (checkoutPayload.IsSet && checkoutPayload.Value == null)
                throw new ArgumentNullException(nameof(checkoutPayload), "Property is not nullable for class SecureRemoteCommerceCheckoutData.");

            if (correlationId.IsSet && correlationId.Value == null)
                throw new ArgumentNullException(nameof(correlationId), "Property is not nullable for class SecureRemoteCommerceCheckoutData.");

            if (cvc.IsSet && cvc.Value == null)
                throw new ArgumentNullException(nameof(cvc), "Property is not nullable for class SecureRemoteCommerceCheckoutData.");

            if (digitalCardId.IsSet && digitalCardId.Value == null)
                throw new ArgumentNullException(nameof(digitalCardId), "Property is not nullable for class SecureRemoteCommerceCheckoutData.");

            if (scheme.IsSet && scheme.Value == null)
                throw new ArgumentNullException(nameof(scheme), "Property is not nullable for class SecureRemoteCommerceCheckoutData.");

            if (tokenReference.IsSet && tokenReference.Value == null)
                throw new ArgumentNullException(nameof(tokenReference), "Property is not nullable for class SecureRemoteCommerceCheckoutData.");
        ...
        {
            /*
            if (secureRemoteCommerceCheckoutData._CheckoutPayloadOption.IsSet && secureRemoteCommerceCheckoutData.CheckoutPayload == null)
                throw new ArgumentNullException(nameof(secureRemoteCommerceCheckoutData.CheckoutPayload), "Property is required for class SecureRemoteCommerceCheckoutData.");

            if (secureRemoteCommerceCheckoutData._CorrelationIdOption.IsSet && secureRemoteCommerceCheckoutData.CorrelationId == null)
                throw new ArgumentNullException(nameof(secureRemoteCommerceCheckoutData.CorrelationId), "Property is required for class SecureRemoteCommerceCheckoutData.");

            if (secureRemoteCommerceCheckoutData._CvcOption.IsSet && secureRemoteCommerceCheckoutData.Cvc == null)
                throw new ArgumentNullException(nameof(secureRemoteCommerceCheckoutData.Cvc), "Property is required for class SecureRemoteCommerceCheckoutData.");

            if (secureRemoteCommerceCheckoutData._DigitalCardIdOption.IsSet && secureRemoteCommerceCheckoutData.DigitalCardId == null)
                throw new ArgumentNullException(nameof(secureRemoteCommerceCheckoutData.DigitalCardId), "Property is required for class SecureRemoteCommerceCheckoutData.");

            if (secureRemoteCommerceCheckoutData._TokenReferenceOption.IsSet && secureRemoteCommerceCheckoutData.TokenReference == null)
                throw new ArgumentNullException(nameof(secureRemoteCommerceCheckoutData.TokenReference), "Property is required for class SecureRemoteCommerceCheckoutData.");
