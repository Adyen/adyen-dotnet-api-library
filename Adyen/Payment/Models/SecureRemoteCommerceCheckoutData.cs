...
namespace Adyen.Payment.Models
{
    ...
    /// </summary>
    [JsonConverter(typeof(SecureRemoteCommerceCheckoutDataJsonConverter))]
    public partial class SecureRemoteCommerceCheckoutData
    {
        ...
        public class SchemeEnum : IEnum
        {
            ...
            /// <summary>
            /// Compares two <see cref="SchemeEnum"/> instances for equality.
            /// </summary>
            ...
            /// <summary>
            /// Compares two <see cref="SchemeEnum"/> instances for inequality.
            /// </summary>
            public static bool operator !=(SchemeEnum? left, SchemeEnum? right) => !string.Equals(left?.Value, right?.Value, StringComparison.OrdinalIgnoreCase);

            /// <summary>
            /// Returns true if the given object is equal to this <see cref="SchemeEnum"/> instance.
            /// </summary>
            ...
            /// <summary>
            /// Returns a hash code for this <see cref="SchemeEnum"/> instance.
            /// </summary>
            public override int GetHashCode() => Value?.GetHashCode() ?? 0;

            /// <summary>
            /// Returns the string value of the <see cref="SchemeEnum"/> instance.
            /// </summary>
            ...
            {
                /// <summary>
                /// Deserializes a <see cref="SchemeEnum"/> from JSON.
                /// </summary>
                ...
                /// <summary>
                /// Serializes a <see cref="SchemeEnum"/> to JSON.
                /// </summary>
    ...
    public class SecureRemoteCommerceCheckoutDataJsonConverter : JsonConverter<SecureRemoteCommerceCheckoutData>
    {
        ...
        public override SecureRemoteCommerceCheckoutData Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (correlationId.IsSet)
                secureRemoteCommerceCheckoutData.CorrelationId = correlationId.Value;
            if (cvc.IsSet)
                secureRemoteCommerceCheckoutData.Cvc = cvc.Value;
            if (digitalCardId.IsSet)
                secureRemoteCommerceCheckoutData.DigitalCardId = digitalCardId.Value;
            if (scheme.IsSet)
                secureRemoteCommerceCheckoutData.Scheme = scheme.Value;
            if (tokenReference.IsSet)
                secureRemoteCommerceCheckoutData.TokenReference = tokenReference.Value;
