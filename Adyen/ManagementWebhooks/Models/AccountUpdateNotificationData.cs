    ...
    public class AccountUpdateNotificationDataJsonConverter : JsonConverter<AccountUpdateNotificationData>
    {
        ...
        public override AccountUpdateNotificationData Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (capabilities.IsSet && capabilities.Value == null)
                throw new ArgumentNullException(nameof(capabilities), "Property is not nullable for class AccountUpdateNotificationData.");

            if (merchantId.IsSet && merchantId.Value == null)
                throw new ArgumentNullException(nameof(merchantId), "Property is not nullable for class AccountUpdateNotificationData.");

            if (status.IsSet && status.Value == null)
                throw new ArgumentNullException(nameof(status), "Property is not nullable for class AccountUpdateNotificationData.");

            if (legalEntityId.IsSet && legalEntityId.Value == null)
                throw new ArgumentNullException(nameof(legalEntityId), "Property is not nullable for class AccountUpdateNotificationData.");
        ...
        {
            /*
            if (accountUpdateNotificationData.Capabilities == null)
                throw new ArgumentNullException(nameof(accountUpdateNotificationData.Capabilities), "Property is required for class AccountUpdateNotificationData.");

            if (accountUpdateNotificationData.MerchantId == null)
                throw new ArgumentNullException(nameof(accountUpdateNotificationData.MerchantId), "Property is required for class AccountUpdateNotificationData.");

            if (accountUpdateNotificationData.Status == null)
                throw new ArgumentNullException(nameof(accountUpdateNotificationData.Status), "Property is required for class AccountUpdateNotificationData.");

            if (accountUpdateNotificationData._LegalEntityIdOption.IsSet && accountUpdateNotificationData.LegalEntityId == null)
                throw new ArgumentNullException(nameof(accountUpdateNotificationData.LegalEntityId), "Property is required for class AccountUpdateNotificationData.");
