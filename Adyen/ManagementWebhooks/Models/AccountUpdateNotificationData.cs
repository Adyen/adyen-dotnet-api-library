...
namespace Adyen.ManagementWebhooks.Models
{
    ...
    /// </summary>
    [JsonConverter(typeof(AccountUpdateNotificationDataJsonConverter))]
    ...
    public class AccountUpdateNotificationDataJsonConverter : JsonConverter<AccountUpdateNotificationData>
    {
        ...
        public override AccountUpdateNotificationData Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            var accountUpdateNotificationData = new AccountUpdateNotificationData();
            if (capabilities.IsSet)
                accountUpdateNotificationData.Capabilities = capabilities.Value!;
            if (merchantId.IsSet)
                accountUpdateNotificationData.MerchantId = merchantId.Value!;
            if (status.IsSet)
                accountUpdateNotificationData.Status = status.Value!;
            if (legalEntityId.IsSet)
                accountUpdateNotificationData.LegalEntityId = legalEntityId.Value;
            return accountUpdateNotificationData;
        }
