...
namespace Adyen.ManagementWebhooks.Models
{
    ...
    /// </summary>
    [JsonConverter(typeof(PaymentMethodScheduledForRemovalNotificationRequestJsonConverter))]
    ...
    public class PaymentMethodScheduledForRemovalNotificationRequestJsonConverter : JsonConverter<PaymentMethodScheduledForRemovalNotificationRequest>
    {
        ...
        public override PaymentMethodScheduledForRemovalNotificationRequest Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            var paymentMethodScheduledForRemovalNotificationRequest = new PaymentMethodScheduledForRemovalNotificationRequest();
            if (createdAt.IsSet)
