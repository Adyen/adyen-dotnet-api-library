    ...
    public class PaymentMethodScheduledForRemovalNotificationRequestJsonConverter : JsonConverter<PaymentMethodScheduledForRemovalNotificationRequest>
    {
        ...
        public override PaymentMethodScheduledForRemovalNotificationRequest Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (createdAt.IsSet && createdAt.Value == null)
                throw new ArgumentNullException(nameof(createdAt), "Property is not nullable for class PaymentMethodScheduledForRemovalNotificationRequest.");

            if (data.IsSet && data.Value == null)
                throw new ArgumentNullException(nameof(data), "Property is not nullable for class PaymentMethodScheduledForRemovalNotificationRequest.");

            if (environment.IsSet && environment.Value == null)
                throw new ArgumentNullException(nameof(environment), "Property is not nullable for class PaymentMethodScheduledForRemovalNotificationRequest.");

            if (type.IsSet && type.Value == null)
                throw new ArgumentNullException(nameof(type), "Property is not nullable for class PaymentMethodScheduledForRemovalNotificationRequest.");
        ...
        {
            /*
            if (paymentMethodScheduledForRemovalNotificationRequest.Data == null)
                throw new ArgumentNullException(nameof(paymentMethodScheduledForRemovalNotificationRequest.Data), "Property is required for class PaymentMethodScheduledForRemovalNotificationRequest.");

            if (paymentMethodScheduledForRemovalNotificationRequest.Environment == null)
                throw new ArgumentNullException(nameof(paymentMethodScheduledForRemovalNotificationRequest.Environment), "Property is required for class PaymentMethodScheduledForRemovalNotificationRequest.");
