...
namespace Adyen.ManagementWebhooks.Models
{
    ...
    /// </summary>
    public partial class TerminalBoardingNotificationRequest : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TerminalBoardingNotificationRequest" /> class.
        /// </summary>
        ...
        [JsonConstructor]
        public TerminalBoardingNotificationRequest(DateTimeOffset createdAt, TerminalBoardingData data, string environment, TypeEnum type)
        {
            CreatedAt = createdAt;
            Data = data;
        ...
        public class TypeEnum: IEnum
        {
            ...
            /// </summary>
            public static readonly TypeEnum TerminalBoardingTriggered = new("terminalBoarding.triggered");
            ...
            {
                return value switch {
                    "terminalBoarding.triggered" => TypeEnum.TerminalBoardingTriggered,
                    _ => null,
                };
            }
    ...
    /// <summary>
    /// A Json converter for type <see cref="TerminalBoardingNotificationRequest" />
    /// </summary>
    public class TerminalBoardingNotificationRequestJsonConverter : JsonConverter<TerminalBoardingNotificationRequest>
    {
        /// <summary>
        ...
        /// <summary>
        /// Deserializes json to <see cref="TerminalBoardingNotificationRequest"/>.
        /// </summary>
        /// <param name="utf8JsonReader"><see cref="Utf8JsonReader"/></param>
        /// <param name="typeToConvert"><see cref="Type"/></param>
        /// <param name="jsonSerializerOptions">The <see cref="JsonSerializerOptions"/>, initialized from <see cref="HostConfiguration"/>.</param>
        /// <returns><see cref="TerminalBoardingNotificationRequest"/></returns>
        /// <exception cref="JsonException"></exception>
        public override TerminalBoardingNotificationRequest Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            Option<TerminalBoardingData?> data = default;
            Option<string?> environment = default;
            Option<TerminalBoardingNotificationRequest.TypeEnum?> type = default;
                ...
                if (utf8JsonReader.TokenType == JsonTokenType.PropertyName && currentDepth == utf8JsonReader.CurrentDepth - 1)
                {
                    ...
                    switch (jsonPropertyName)
                    {
                        case "createdAt":
                            ...
                            break;
                        case "data":
                            data = new Option<TerminalBoardingData?>(JsonSerializer.Deserialize<TerminalBoardingData>(ref utf8JsonReader, jsonSerializerOptions)!);
                            break;
                        case "environment":
            ...
            if (createdAt.IsSet && createdAt.Value == null)
                throw new ArgumentNullException(nameof(createdAt), "Property is not nullable for class TerminalBoardingNotificationRequest.");

            if (data.IsSet && data.Value == null)
                throw new ArgumentNullException(nameof(data), "Property is not nullable for class TerminalBoardingNotificationRequest.");

            if (environment.IsSet && environment.Value == null)
                throw new ArgumentNullException(nameof(environment), "Property is not nullable for class TerminalBoardingNotificationRequest.");

            if (type.IsSet && type.Value == null)
                throw new ArgumentNullException(nameof(type), "Property is not nullable for class TerminalBoardingNotificationRequest.");

            return new TerminalBoardingNotificationRequest(createdAt.Value!.Value!, data.Value!, environment.Value!, type.Value!.Value!);
        }

        /// <summary>
        /// Serializes a <see cref="TerminalBoardingNotificationRequest"/>.
        /// </summary>
        /// <param name="writer"><see cref="Utf8JsonWriter"/></param>
        /// <param name="terminalBoardingNotificationRequest"></param>
        /// <param name="jsonSerializerOptions"><see cref="JsonSerializerOptions"/></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, TerminalBoardingNotificationRequest terminalBoardingNotificationRequest, JsonSerializerOptions jsonSerializerOptions)
        {
        ...
        /// <summary>
        /// Serializes the properties of <see cref="TerminalBoardingNotificationRequest"/>.
        /// </summary>
        /// <param name="writer"><see creft="Utf8JsonWriter"/></param>
        /// <param name="terminalBoardingNotificationRequest"></param>
        /// <param name="jsonSerializerOptions"><see cref="JsonSerializerOptions"/></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, TerminalBoardingNotificationRequest terminalBoardingNotificationRequest, JsonSerializerOptions jsonSerializerOptions)
        {
            /*
            if (terminalBoardingNotificationRequest.Data == null)
                throw new ArgumentNullException(nameof(terminalBoardingNotificationRequest.Data), "Property is required for class TerminalBoardingNotificationRequest.");

            if (terminalBoardingNotificationRequest.Environment == null)
                throw new ArgumentNullException(nameof(terminalBoardingNotificationRequest.Environment), "Property is required for class TerminalBoardingNotificationRequest.");

            */
            
            writer.WriteString("createdAt", terminalBoardingNotificationRequest.CreatedAt.ToString(CreatedAtFormat));

            writer.WritePropertyName("data");
            JsonSerializer.Serialize(writer, terminalBoardingNotificationRequest.Data, jsonSerializerOptions);
            writer.WriteString("environment", terminalBoardingNotificationRequest.Environment);

            if (terminalBoardingNotificationRequest.Type != null) 
            {
                string? typeRawValue = TerminalBoardingNotificationRequest.TypeEnum.ToJsonValue(terminalBoardingNotificationRequest.Type);
