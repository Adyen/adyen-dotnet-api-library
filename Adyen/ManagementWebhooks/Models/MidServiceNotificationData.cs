...
namespace Adyen.ManagementWebhooks.Models
{
    ...
    /// </summary>
    [JsonConverter(typeof(MidServiceNotificationDataJsonConverter))]
    ...
    public class MidServiceNotificationDataJsonConverter : JsonConverter<MidServiceNotificationData>
    {
        ...
        public override MidServiceNotificationData Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (enabled.IsSet)
                midServiceNotificationData.Enabled = enabled.Value;
            if (reference.IsSet)
                midServiceNotificationData.Reference = reference.Value;
            if (storeId.IsSet)
                midServiceNotificationData.StoreId = storeId.Value;
            if (verificationStatus.IsSet)
                midServiceNotificationData.VerificationStatus = verificationStatus.Value;
            return midServiceNotificationData;
        }
