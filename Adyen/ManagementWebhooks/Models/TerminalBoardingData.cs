    ...
    public class TerminalBoardingDataJsonConverter : JsonConverter<TerminalBoardingData>
    {
        ...
        public override TerminalBoardingData Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (companyId.IsSet && companyId.Value == null)
                throw new ArgumentNullException(nameof(companyId), "Property is not nullable for class TerminalBoardingData.");

            if (uniqueTerminalId.IsSet && uniqueTerminalId.Value == null)
                throw new ArgumentNullException(nameof(uniqueTerminalId), "Property is not nullable for class TerminalBoardingData.");

            if (merchantId.IsSet && merchantId.Value == null)
                throw new ArgumentNullException(nameof(merchantId), "Property is not nullable for class TerminalBoardingData.");

            if (storeId.IsSet && storeId.Value == null)
                throw new ArgumentNullException(nameof(storeId), "Property is not nullable for class TerminalBoardingData.");
        ...
        public void WriteProperties(Utf8JsonWriter writer, TerminalBoardingData terminalBoardingData, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (terminalBoardingData.CompanyId == null)
                throw new ArgumentNullException(nameof(terminalBoardingData.CompanyId), "Property is required for class TerminalBoardingData.");

            if (terminalBoardingData.UniqueTerminalId == null)
                throw new ArgumentNullException(nameof(terminalBoardingData.UniqueTerminalId), "Property is required for class TerminalBoardingData.");

            if (terminalBoardingData._MerchantIdOption.IsSet && terminalBoardingData.MerchantId == null)
                throw new ArgumentNullException(nameof(terminalBoardingData.MerchantId), "Property is required for class TerminalBoardingData.");

            if (terminalBoardingData._StoreIdOption.IsSet && terminalBoardingData.StoreId == null)
                throw new ArgumentNullException(nameof(terminalBoardingData.StoreId), "Property is required for class TerminalBoardingData.");
