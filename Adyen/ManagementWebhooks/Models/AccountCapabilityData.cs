    ...
    public class AccountCapabilityDataJsonConverter : JsonConverter<AccountCapabilityData>
    {
        ...
        public override AccountCapabilityData Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (requested.IsSet && requested.Value == null)
                throw new ArgumentNullException(nameof(requested), "Property is not nullable for class AccountCapabilityData.");

            if (requestedLevel.IsSet && requestedLevel.Value == null)
                throw new ArgumentNullException(nameof(requestedLevel), "Property is not nullable for class AccountCapabilityData.");

            if (allowed.IsSet && allowed.Value == null)
                throw new ArgumentNullException(nameof(allowed), "Property is not nullable for class AccountCapabilityData.");

            if (allowedLevel.IsSet && allowedLevel.Value == null)
                throw new ArgumentNullException(nameof(allowedLevel), "Property is not nullable for class AccountCapabilityData.");

            if (capability.IsSet && capability.Value == null)
                throw new ArgumentNullException(nameof(capability), "Property is not nullable for class AccountCapabilityData.");

            if (problems.IsSet && problems.Value == null)
                throw new ArgumentNullException(nameof(problems), "Property is not nullable for class AccountCapabilityData.");

            if (verificationDeadline.IsSet && verificationDeadline.Value == null)
                throw new ArgumentNullException(nameof(verificationDeadline), "Property is not nullable for class AccountCapabilityData.");

            if (verificationStatus.IsSet && verificationStatus.Value == null)
                throw new ArgumentNullException(nameof(verificationStatus), "Property is not nullable for class AccountCapabilityData.");
        ...
        public void WriteProperties(Utf8JsonWriter writer, AccountCapabilityData accountCapabilityData, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (accountCapabilityData.RequestedLevel == null)
                throw new ArgumentNullException(nameof(accountCapabilityData.RequestedLevel), "Property is required for class AccountCapabilityData.");

            if (accountCapabilityData._AllowedLevelOption.IsSet && accountCapabilityData.AllowedLevel == null)
                throw new ArgumentNullException(nameof(accountCapabilityData.AllowedLevel), "Property is required for class AccountCapabilityData.");

            if (accountCapabilityData._CapabilityOption.IsSet && accountCapabilityData.Capability == null)
                throw new ArgumentNullException(nameof(accountCapabilityData.Capability), "Property is required for class AccountCapabilityData.");

            if (accountCapabilityData._ProblemsOption.IsSet && accountCapabilityData.Problems == null)
                throw new ArgumentNullException(nameof(accountCapabilityData.Problems), "Property is required for class AccountCapabilityData.");

            if (accountCapabilityData._VerificationStatusOption.IsSet && accountCapabilityData.VerificationStatus == null)
                throw new ArgumentNullException(nameof(accountCapabilityData.VerificationStatus), "Property is required for class AccountCapabilityData.");
