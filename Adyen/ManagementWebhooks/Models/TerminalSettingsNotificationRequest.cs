...
namespace Adyen.ManagementWebhooks.Models
{
    ...
    /// </summary>
    public partial class TerminalSettingsNotificationRequest : IValidatableObject
    {
        /// <summary>
        ...
        [JsonConstructor]
        public TerminalSettingsNotificationRequest(DateTimeOffset createdAt, TerminalSettingsData data, string environment, TypeEnum type)
        {
            CreatedAt = createdAt;
            Data = data;
        ...
        public class TypeEnum: IEnum
        {
            ...
            /// </summary>
            public static readonly TypeEnum TerminalSettingsModified = new("terminalSettings.modified");
            ...
            {
                return value switch {
                    "terminalSettings.modified" => TypeEnum.TerminalSettingsModified,
                    _ => null,
                };
            }
    ...
    /// <summary>
    /// A Json converter for type <see cref="TerminalSettingsNotificationRequest" />
    /// </summary>
    public class TerminalSettingsNotificationRequestJsonConverter : JsonConverter<TerminalSettingsNotificationRequest>
    {
        /// <summary>
        ...
        /// <summary>
        /// Deserializes json to <see cref="TerminalSettingsNotificationRequest"/>.
        /// </summary>
        /// <param name="utf8JsonReader"><see cref="Utf8JsonReader"/></param>
        /// <param name="typeToConvert"><see cref="Type"/></param>
        /// <param name="jsonSerializerOptions">The <see cref="JsonSerializerOptions"/>, initialized from <see cref="HostConfiguration"/>.</param>
        /// <returns><see cref="TerminalSettingsNotificationRequest"/></returns>
        /// <exception cref="JsonException"></exception>
        public override TerminalSettingsNotificationRequest Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            Option<TerminalSettingsData?> data = default;
            Option<string?> environment = default;
            Option<TerminalSettingsNotificationRequest.TypeEnum?> type = default;
                ...
                if (utf8JsonReader.TokenType == JsonTokenType.PropertyName && currentDepth == utf8JsonReader.CurrentDepth - 1)
                {
                    ...
                    switch (jsonPropertyName)
                    {
                        case "createdAt":
                            ...
                            break;
                        case "data":
                            data = new Option<TerminalSettingsData?>(JsonSerializer.Deserialize<TerminalSettingsData>(ref utf8JsonReader, jsonSerializerOptions)!);
                            break;
                        case "environment":
            ...
            if (createdAt.IsSet && createdAt.Value == null)
                throw new ArgumentNullException(nameof(createdAt), "Property is not nullable for class TerminalSettingsNotificationRequest.");

            if (data.IsSet && data.Value == null)
                throw new ArgumentNullException(nameof(data), "Property is not nullable for class TerminalSettingsNotificationRequest.");

            if (environment.IsSet && environment.Value == null)
                throw new ArgumentNullException(nameof(environment), "Property is not nullable for class TerminalSettingsNotificationRequest.");

            if (type.IsSet && type.Value == null)
                throw new ArgumentNullException(nameof(type), "Property is not nullable for class TerminalSettingsNotificationRequest.");

            return new TerminalSettingsNotificationRequest(createdAt.Value!.Value!, data.Value!, environment.Value!, type.Value!.Value!);
        }

        /// <summary>
        /// Serializes a <see cref="TerminalSettingsNotificationRequest"/>.
        /// </summary>
        /// <param name="writer"><see cref="Utf8JsonWriter"/></param>
        /// <param name="terminalSettingsNotificationRequest"></param>
        /// <param name="jsonSerializerOptions"><see cref="JsonSerializerOptions"/></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, TerminalSettingsNotificationRequest terminalSettingsNotificationRequest, JsonSerializerOptions jsonSerializerOptions)
        {
            
            writer.WriteStartObject();
            
            WriteProperties(writer, terminalSettingsNotificationRequest, jsonSerializerOptions);
        ...
        /// <summary>
        /// Serializes the properties of <see cref="TerminalSettingsNotificationRequest"/>.
        /// </summary>
        /// <param name="writer"><see creft="Utf8JsonWriter"/></param>
        /// <param name="terminalSettingsNotificationRequest"></param>
        /// <param name="jsonSerializerOptions"><see cref="JsonSerializerOptions"/></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, TerminalSettingsNotificationRequest terminalSettingsNotificationRequest, JsonSerializerOptions jsonSerializerOptions)
        {
            /*
            if (terminalSettingsNotificationRequest.Data == null)
                throw new ArgumentNullException(nameof(terminalSettingsNotificationRequest.Data), "Property is required for class TerminalSettingsNotificationRequest.");

            if (terminalSettingsNotificationRequest.Environment == null)
                throw new ArgumentNullException(nameof(terminalSettingsNotificationRequest.Environment), "Property is required for class TerminalSettingsNotificationRequest.");

            */
            
            writer.WriteString("createdAt", terminalSettingsNotificationRequest.CreatedAt.ToString(CreatedAtFormat));

            writer.WritePropertyName("data");
            JsonSerializer.Serialize(writer, terminalSettingsNotificationRequest.Data, jsonSerializerOptions);
            writer.WriteString("environment", terminalSettingsNotificationRequest.Environment);

            if (terminalSettingsNotificationRequest.Type != null) 
            {
                string? typeRawValue = TerminalSettingsNotificationRequest.TypeEnum.ToJsonValue(terminalSettingsNotificationRequest.Type);
