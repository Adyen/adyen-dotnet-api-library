...
namespace Adyen.ManagementWebhooks.Models
{
    ...
    /// </summary>
    public partial class MerchantCreatedNotificationRequest : IValidatableObject
    {
        /// <summary>
    ...
    public class MerchantCreatedNotificationRequestJsonConverter : JsonConverter<MerchantCreatedNotificationRequest>
    {
        ...
        public override MerchantCreatedNotificationRequest Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (createdAt.IsSet && createdAt.Value == null)
                throw new ArgumentNullException(nameof(createdAt), "Property is not nullable for class MerchantCreatedNotificationRequest.");

            if (data.IsSet && data.Value == null)
                throw new ArgumentNullException(nameof(data), "Property is not nullable for class MerchantCreatedNotificationRequest.");

            if (environment.IsSet && environment.Value == null)
                throw new ArgumentNullException(nameof(environment), "Property is not nullable for class MerchantCreatedNotificationRequest.");

            if (type.IsSet && type.Value == null)
                throw new ArgumentNullException(nameof(type), "Property is not nullable for class MerchantCreatedNotificationRequest.");
        ...
        {
            /*
            if (merchantCreatedNotificationRequest.Data == null)
                throw new ArgumentNullException(nameof(merchantCreatedNotificationRequest.Data), "Property is required for class MerchantCreatedNotificationRequest.");

            if (merchantCreatedNotificationRequest.Environment == null)
                throw new ArgumentNullException(nameof(merchantCreatedNotificationRequest.Environment), "Property is required for class MerchantCreatedNotificationRequest.");
