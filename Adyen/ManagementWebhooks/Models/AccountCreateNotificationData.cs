...
namespace Adyen.ManagementWebhooks.Models
{
    ...
    /// </summary>
    public partial class AccountCreateNotificationData : IValidatableObject
    {
        /// <summary>
        ...
        [JsonConstructor]
        public AccountCreateNotificationData(Dictionary<string, AccountCapabilityData> capabilities, string companyId, string merchantId, string status, Option<string?> legalEntityId = default)
        {
    ...
    /// <summary>
    /// A Json converter for type <see cref="AccountCreateNotificationData" />
    /// </summary>
    public class AccountCreateNotificationDataJsonConverter : JsonConverter<AccountCreateNotificationData>
    {
        /// <summary>
        /// Deserializes json to <see cref="AccountCreateNotificationData"/>.
        /// </summary>
        /// <param name="utf8JsonReader"><see cref="Utf8JsonReader"/></param>
        /// <param name="typeToConvert"><see cref="Type"/></param>
        /// <param name="jsonSerializerOptions">The <see cref="JsonSerializerOptions"/>, initialized from <see cref="HostConfiguration"/>.</param>
        /// <returns><see cref="AccountCreateNotificationData"/></returns>
        /// <exception cref="JsonException"></exception>
        public override AccountCreateNotificationData Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (capabilities.IsSet && capabilities.Value == null)
                throw new ArgumentNullException(nameof(capabilities), "Property is not nullable for class AccountCreateNotificationData.");

            if (companyId.IsSet && companyId.Value == null)
                throw new ArgumentNullException(nameof(companyId), "Property is not nullable for class AccountCreateNotificationData.");

            if (merchantId.IsSet && merchantId.Value == null)
                throw new ArgumentNullException(nameof(merchantId), "Property is not nullable for class AccountCreateNotificationData.");

            if (status.IsSet && status.Value == null)
                throw new ArgumentNullException(nameof(status), "Property is not nullable for class AccountCreateNotificationData.");

            if (legalEntityId.IsSet && legalEntityId.Value == null)
                throw new ArgumentNullException(nameof(legalEntityId), "Property is not nullable for class AccountCreateNotificationData.");

            return new AccountCreateNotificationData(capabilities.Value!, companyId.Value!, merchantId.Value!, status.Value!, legalEntityId);
        }

        /// <summary>
        /// Serializes a <see cref="AccountCreateNotificationData"/>.
        /// </summary>
        /// <param name="writer"><see cref="Utf8JsonWriter"/></param>
        /// <param name="accountCreateNotificationData"></param>
        /// <param name="jsonSerializerOptions"><see cref="JsonSerializerOptions"/></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, AccountCreateNotificationData accountCreateNotificationData, JsonSerializerOptions jsonSerializerOptions)
        {
            
            writer.WriteStartObject();
            
            WriteProperties(writer, accountCreateNotificationData, jsonSerializerOptions);
        ...
        /// <param name="jsonSerializerOptions"><see cref="JsonSerializerOptions"/></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, AccountCreateNotificationData accountCreateNotificationData, JsonSerializerOptions jsonSerializerOptions)
        {
            /*
            if (accountCreateNotificationData.Capabilities == null)
                throw new ArgumentNullException(nameof(accountCreateNotificationData.Capabilities), "Property is required for class AccountCreateNotificationData.");

            if (accountCreateNotificationData.CompanyId == null)
                throw new ArgumentNullException(nameof(accountCreateNotificationData.CompanyId), "Property is required for class AccountCreateNotificationData.");

            if (accountCreateNotificationData.MerchantId == null)
                throw new ArgumentNullException(nameof(accountCreateNotificationData.MerchantId), "Property is required for class AccountCreateNotificationData.");

            if (accountCreateNotificationData.Status == null)
                throw new ArgumentNullException(nameof(accountCreateNotificationData.Status), "Property is required for class AccountCreateNotificationData.");

            if (accountCreateNotificationData._LegalEntityIdOption.IsSet && accountCreateNotificationData.LegalEntityId == null)
                throw new ArgumentNullException(nameof(accountCreateNotificationData.LegalEntityId), "Property is required for class AccountCreateNotificationData.");

            */
            
            writer.WritePropertyName("capabilities");
            JsonSerializer.Serialize(writer, accountCreateNotificationData.Capabilities, jsonSerializerOptions);
            writer.WriteString("companyId", accountCreateNotificationData.CompanyId);

            writer.WriteString("merchantId", accountCreateNotificationData.MerchantId);

            writer.WriteString("status", accountCreateNotificationData.Status);

            if (accountCreateNotificationData._LegalEntityIdOption.IsSet)
                writer.WriteString("legalEntityId", accountCreateNotificationData.LegalEntityId);
        }
    }
}
