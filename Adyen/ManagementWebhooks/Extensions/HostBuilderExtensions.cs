...
namespace Adyen.ManagementWebhooks.Extensions
{
    ...
    {
        /// <summary>
        /// Initializes the <see cref="HostConfiguration"/> *without* adding the ManagementWebhooks API services defaults to the <see cref="IServiceCollection"/>.
        /// Use <see cref="Adyen.ManagementWebhooks.Extensions.IServiceCollectionExtensions"/> to add the ManagementWebhooks API services to the <see cref="IServiceCollection"/>.
        /// </summary>
        ...
        public static IHostBuilder ConfigureManagementWebhooksDefaults(this IHostBuilder hostBuilder, Action<HostBuilderContext, IServiceCollection, HostConfiguration> hostConfigurationOptions, ServiceLifetime serviceLifetime = ServiceLifetime.Singleton, Action<System.Net.Http.HttpClient>? httpClientOptions = null, Action<IHttpClientBuilder>? httpClientBuilderOptions = null)
        {
            hostBuilder.ConfigureServices((context, services) => 
            {
                ...
                services.AddManagementWebhooksHandler(serviceLifetime);
