...
namespace Adyen.BalanceControl.Client
{
    ...
    public static partial class ClientUtils
    {
        ...
        public static string? ParameterToString(object? obj, string? format = ISO8601_DATETIME_FORMAT)
        {
            ...
            if (obj is Models.BalanceTransferRequest.TypeEnum balanceTransferRequestTypeEnum)
                return Models.BalanceTransferRequest.TypeEnum.ToJsonValue(balanceTransferRequestTypeEnum);
            if (obj is Models.BalanceTransferResponse.StatusEnum balanceTransferResponseStatusEnum)
                return Models.BalanceTransferResponse.StatusEnum.ToJsonValue(balanceTransferResponseStatusEnum);
            if (obj is Models.BalanceTransferResponse.TypeEnum balanceTransferResponseTypeEnum)
                return Models.BalanceTransferResponse.TypeEnum.ToJsonValue(balanceTransferResponseTypeEnum);
