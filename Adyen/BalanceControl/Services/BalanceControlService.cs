...
namespace Adyen.BalanceControl.Services
{
    ...
    public interface IBalanceControlService : IAdyenApiService
    {
        ...
        /// <param name="balanceTransferRequest"> (optional)</param>
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns><see cref="Task"/>&lt;<see cref="IBalanceTransferApiResponse"/>&gt;</returns>
        [Obsolete("Deprecated since Adyen Balance Control API v1.")]
        Task<IBalanceTransferApiResponse> BalanceTransferAsync(Option<BalanceTransferRequest> balanceTransferRequest = default, System.Threading.CancellationToken cancellationToken = default);
    ...
    public sealed partial class BalanceControlService : IBalanceControlService
    {
            ...
            ITokenProvider<ApiKeyToken> apiKeyProvider)
        {
            ...
            Logger = LoggerFactory.CreateLogger<BalanceControlService>();
            HttpClient = httpClient;
            Events = balanceControlServiceEvents;
            ApiKeyProvider = apiKeyProvider;
        }

        partial void FormatBalanceTransfer(Option<BalanceTransferRequest> balanceTransferRequest);
        ...
        /// <returns></returns>
        private void ValidateBalanceTransfer(Option<BalanceTransferRequest> balanceTransferRequest)
        {
            if (balanceTransferRequest.IsSet && balanceTransferRequest.Value == null)
                throw new ArgumentNullException(nameof(balanceTransferRequest));
        }
        ...
        /// <param name="balanceTransferRequest"></param>
        private void AfterBalanceTransferDefaultImplementation(IBalanceTransferApiResponse apiResponse, Option<BalanceTransferRequest> balanceTransferRequest)
        {
            bool suppressDefaultLog = false;
            AfterBalanceTransfer(ref suppressDefaultLog, apiResponse, balanceTransferRequest);
        ...
        /// <param name="apiResponse"></param>
        /// <param name="balanceTransferRequest"></param>
        partial void AfterBalanceTransfer(ref bool suppressDefaultLog, IBalanceTransferApiResponse apiResponse, Option<BalanceTransferRequest> balanceTransferRequest);
        ...
        /// <param name="balanceTransferRequest"></param>
        private void OnErrorBalanceTransferDefaultImplementation(Exception exception, string pathFormat, string path, Option<BalanceTransferRequest> balanceTransferRequest)
        {
            bool suppressDefaultLog = false;
            OnErrorBalanceTransfer(ref suppressDefaultLog, exception, pathFormat, path, balanceTransferRequest);
            if (!suppressDefaultLog)
        ...
        /// <param name="path"></param>
        /// <param name="balanceTransferRequest"></param>
        partial void OnErrorBalanceTransfer(ref bool suppressDefaultLog, Exception exception, string pathFormat, string path, Option<BalanceTransferRequest> balanceTransferRequest);
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns><see cref="Task"/>&lt;<see cref="IBalanceTransferApiResponse"/>&gt;</returns>
        public async Task<IBalanceTransferApiResponse> BalanceTransferAsync(Option<BalanceTransferRequest> balanceTransferRequest = default, System.Threading.CancellationToken cancellationToken = default)
        {
            UriBuilder uriBuilder = new UriBuilder();

            try
            {
                ValidateBalanceTransfer(balanceTransferRequest);

                FormatBalanceTransfer(balanceTransferRequest);
                ...
                using (HttpRequestMessage httpRequestMessage = new HttpRequestMessage())
                {
                    ...
                    using (HttpResponseMessage httpResponseMessage = await HttpClient.SendAsync(httpRequestMessage, cancellationToken).ConfigureAwait(false))
                    {
                        ...
                        AfterBalanceTransferDefaultImplementation(apiResponse, balanceTransferRequest);
            ...
            {
                OnErrorBalanceTransferDefaultImplementation(e, "/balanceTransfer", uriBuilder.Path, balanceTransferRequest);
                Events.ExecuteOnErrorBalanceTransfer(e);
                throw;
            }
        }
