    ...
    public class InternalReviewTrackingDataJsonConverter : JsonConverter<InternalReviewTrackingData>
    {
        ...
        public override InternalReviewTrackingData Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (status.IsSet && status.Value == null)
                throw new ArgumentNullException(nameof(status), "Property is not nullable for class InternalReviewTrackingData.");

            if (reason.IsSet && reason.Value == null)
                throw new ArgumentNullException(nameof(reason), "Property is not nullable for class InternalReviewTrackingData.");

            if (type.IsSet && type.Value == null)
                throw new ArgumentNullException(nameof(type), "Property is not nullable for class InternalReviewTrackingData.");
