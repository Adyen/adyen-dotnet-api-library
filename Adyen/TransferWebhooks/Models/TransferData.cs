...
namespace Adyen.TransferWebhooks.Models
{
    ...
    public partial class TransferData : IValidatableObject
    {
        ...
        /// <summary>
        /// Used to track whether Direction is set or not.
        /// </summary>
        [JsonIgnore]
    ...
    public class TransferDataJsonConverter : JsonConverter<TransferData>
    {
        ...
        public override TransferData Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (amount.IsSet && amount.Value == null)
                throw new ArgumentNullException(nameof(amount), "Property is not nullable for class TransferData.");

            if (category.IsSet && category.Value == null)
                throw new ArgumentNullException(nameof(category), "Property is not nullable for class TransferData.");

            if (status.IsSet && status.Value == null)
                throw new ArgumentNullException(nameof(status), "Property is not nullable for class TransferData.");

            if (accountHolder.IsSet && accountHolder.Value == null)
                throw new ArgumentNullException(nameof(accountHolder), "Property is not nullable for class TransferData.");

            if (balanceAccount.IsSet && balanceAccount.Value == null)
                throw new ArgumentNullException(nameof(balanceAccount), "Property is not nullable for class TransferData.");

            if (balancePlatform.IsSet && balancePlatform.Value == null)
                throw new ArgumentNullException(nameof(balancePlatform), "Property is not nullable for class TransferData.");

            if (balances.IsSet && balances.Value == null)
                throw new ArgumentNullException(nameof(balances), "Property is not nullable for class TransferData.");

            if (categoryData.IsSet && categoryData.Value == null)
                throw new ArgumentNullException(nameof(categoryData), "Property is not nullable for class TransferData.");

            if (counterparty.IsSet && counterparty.Value == null)
                throw new ArgumentNullException(nameof(counterparty), "Property is not nullable for class TransferData.");

            if (createdAt.IsSet && createdAt.Value == null)
                throw new ArgumentNullException(nameof(createdAt), "Property is not nullable for class TransferData.");

            if (creationDate.IsSet && creationDate.Value == null)
                throw new ArgumentNullException(nameof(creationDate), "Property is not nullable for class TransferData.");

            if (description.IsSet && description.Value == null)
                throw new ArgumentNullException(nameof(description), "Property is not nullable for class TransferData.");

            if (directDebitInformation.IsSet && directDebitInformation.Value == null)
                throw new ArgumentNullException(nameof(directDebitInformation), "Property is not nullable for class TransferData.");

            if (direction.IsSet && direction.Value == null)
                throw new ArgumentNullException(nameof(direction), "Property is not nullable for class TransferData.");

            if (eventId.IsSet && eventId.Value == null)
                throw new ArgumentNullException(nameof(eventId), "Property is not nullable for class TransferData.");

            if (events.IsSet && events.Value == null)
                throw new ArgumentNullException(nameof(events), "Property is not nullable for class TransferData.");

            if (executionDate.IsSet && executionDate.Value == null)
                throw new ArgumentNullException(nameof(executionDate), "Property is not nullable for class TransferData.");

            if (externalReason.IsSet && externalReason.Value == null)
                throw new ArgumentNullException(nameof(externalReason), "Property is not nullable for class TransferData.");

            if (id.IsSet && id.Value == null)
                throw new ArgumentNullException(nameof(id), "Property is not nullable for class TransferData.");

            if (paymentInstrument.IsSet && paymentInstrument.Value == null)
                throw new ArgumentNullException(nameof(paymentInstrument), "Property is not nullable for class TransferData.");

            if (reason.IsSet && reason.Value == null)
                throw new ArgumentNullException(nameof(reason), "Property is not nullable for class TransferData.");

            if (reference.IsSet && reference.Value == null)
                throw new ArgumentNullException(nameof(reference), "Property is not nullable for class TransferData.");

            if (referenceForBeneficiary.IsSet && referenceForBeneficiary.Value == null)
                throw new ArgumentNullException(nameof(referenceForBeneficiary), "Property is not nullable for class TransferData.");

            if (review.IsSet && review.Value == null)
                throw new ArgumentNullException(nameof(review), "Property is not nullable for class TransferData.");

            if (sequenceNumber.IsSet && sequenceNumber.Value == null)
                throw new ArgumentNullException(nameof(sequenceNumber), "Property is not nullable for class TransferData.");

            if (tracking.IsSet && tracking.Value == null)
                throw new ArgumentNullException(nameof(tracking), "Property is not nullable for class TransferData.");

            if (transactionRulesResult.IsSet && transactionRulesResult.Value == null)
                throw new ArgumentNullException(nameof(transactionRulesResult), "Property is not nullable for class TransferData.");

            if (type.IsSet && type.Value == null)
                throw new ArgumentNullException(nameof(type), "Property is not nullable for class TransferData.");

            if (updatedAt.IsSet && updatedAt.Value == null)
                throw new ArgumentNullException(nameof(updatedAt), "Property is not nullable for class TransferData.");
        ...
        public void WriteProperties(Utf8JsonWriter writer, TransferData transferData, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (transferData.Amount == null)
                throw new ArgumentNullException(nameof(transferData.Amount), "Property is required for class TransferData.");

            if (transferData._AccountHolderOption.IsSet && transferData.AccountHolder == null)
                throw new ArgumentNullException(nameof(transferData.AccountHolder), "Property is required for class TransferData.");

            if (transferData._BalanceAccountOption.IsSet && transferData.BalanceAccount == null)
                throw new ArgumentNullException(nameof(transferData.BalanceAccount), "Property is required for class TransferData.");

            if (transferData._BalancePlatformOption.IsSet && transferData.BalancePlatform == null)
                throw new ArgumentNullException(nameof(transferData.BalancePlatform), "Property is required for class TransferData.");

            if (transferData._BalancesOption.IsSet && transferData.Balances == null)
                throw new ArgumentNullException(nameof(transferData.Balances), "Property is required for class TransferData.");

            if (transferData._CategoryDataOption.IsSet && transferData.CategoryData == null)
                throw new ArgumentNullException(nameof(transferData.CategoryData), "Property is required for class TransferData.");

            if (transferData._CounterpartyOption.IsSet && transferData.Counterparty == null)
                throw new ArgumentNullException(nameof(transferData.Counterparty), "Property is required for class TransferData.");

            if (transferData._DescriptionOption.IsSet && transferData.Description == null)
                throw new ArgumentNullException(nameof(transferData.Description), "Property is required for class TransferData.");

            if (transferData._DirectDebitInformationOption.IsSet && transferData.DirectDebitInformation == null)
                throw new ArgumentNullException(nameof(transferData.DirectDebitInformation), "Property is required for class TransferData.");

            if (transferData._EventIdOption.IsSet && transferData.EventId == null)
                throw new ArgumentNullException(nameof(transferData.EventId), "Property is required for class TransferData.");

            if (transferData._EventsOption.IsSet && transferData.Events == null)
                throw new ArgumentNullException(nameof(transferData.Events), "Property is required for class TransferData.");

            if (transferData._ExecutionDateOption.IsSet && transferData.ExecutionDate == null)
                throw new ArgumentNullException(nameof(transferData.ExecutionDate), "Property is required for class TransferData.");

            if (transferData._ExternalReasonOption.IsSet && transferData.ExternalReason == null)
                throw new ArgumentNullException(nameof(transferData.ExternalReason), "Property is required for class TransferData.");

            if (transferData._IdOption.IsSet && transferData.Id == null)
                throw new ArgumentNullException(nameof(transferData.Id), "Property is required for class TransferData.");

            if (transferData._PaymentInstrumentOption.IsSet && transferData.PaymentInstrument == null)
                throw new ArgumentNullException(nameof(transferData.PaymentInstrument), "Property is required for class TransferData.");

            if (transferData._ReferenceOption.IsSet && transferData.Reference == null)
                throw new ArgumentNullException(nameof(transferData.Reference), "Property is required for class TransferData.");

            if (transferData._ReferenceForBeneficiaryOption.IsSet && transferData.ReferenceForBeneficiary == null)
                throw new ArgumentNullException(nameof(transferData.ReferenceForBeneficiary), "Property is required for class TransferData.");

            if (transferData._ReviewOption.IsSet && transferData.Review == null)
                throw new ArgumentNullException(nameof(transferData.Review), "Property is required for class TransferData.");

            if (transferData._TrackingOption.IsSet && transferData.Tracking == null)
                throw new ArgumentNullException(nameof(transferData.Tracking), "Property is required for class TransferData.");

            if (transferData._TransactionRulesResultOption.IsSet && transferData.TransactionRulesResult == null)
                throw new ArgumentNullException(nameof(transferData.TransactionRulesResult), "Property is required for class TransferData.");
