    ...
    public class AddressJsonConverter : JsonConverter<Address>
    {
        ...
        public override Address Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (line1.IsSet && line1.Value == null)
                throw new ArgumentNullException(nameof(line1), "Property is not nullable for class Address.");

            if (line2.IsSet && line2.Value == null)
                throw new ArgumentNullException(nameof(line2), "Property is not nullable for class Address.");
        ...
        public void WriteProperties(Utf8JsonWriter writer, Address address, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (address._Line1Option.IsSet && address.Line1 == null)
                throw new ArgumentNullException(nameof(address.Line1), "Property is required for class Address.");

            if (address._Line2Option.IsSet && address.Line2 == null)
                throw new ArgumentNullException(nameof(address.Line2), "Property is required for class Address.");
