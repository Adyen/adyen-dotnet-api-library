    ...
    public class BRLocalAccountIdentificationJsonConverter : JsonConverter<BRLocalAccountIdentification>
    {
        ...
        public override BRLocalAccountIdentification Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (accountNumber.IsSet && accountNumber.Value == null)
                throw new ArgumentNullException(nameof(accountNumber), "Property is not nullable for class BRLocalAccountIdentification.");

            if (bankCode.IsSet && bankCode.Value == null)
                throw new ArgumentNullException(nameof(bankCode), "Property is not nullable for class BRLocalAccountIdentification.");

            if (branchNumber.IsSet && branchNumber.Value == null)
                throw new ArgumentNullException(nameof(branchNumber), "Property is not nullable for class BRLocalAccountIdentification.");

            if (ispb.IsSet && ispb.Value == null)
                throw new ArgumentNullException(nameof(ispb), "Property is not nullable for class BRLocalAccountIdentification.");

            if (type.IsSet && type.Value == null)
                throw new ArgumentNullException(nameof(type), "Property is not nullable for class BRLocalAccountIdentification.");
        ...
        public void WriteProperties(Utf8JsonWriter writer, BRLocalAccountIdentification bRLocalAccountIdentification, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (bRLocalAccountIdentification.AccountNumber == null)
                throw new ArgumentNullException(nameof(bRLocalAccountIdentification.AccountNumber), "Property is required for class BRLocalAccountIdentification.");

            if (bRLocalAccountIdentification.BankCode == null)
                throw new ArgumentNullException(nameof(bRLocalAccountIdentification.BankCode), "Property is required for class BRLocalAccountIdentification.");

            if (bRLocalAccountIdentification.BranchNumber == null)
                throw new ArgumentNullException(nameof(bRLocalAccountIdentification.BranchNumber), "Property is required for class BRLocalAccountIdentification.");

            if (bRLocalAccountIdentification._IspbOption.IsSet && bRLocalAccountIdentification.Ispb == null)
                throw new ArgumentNullException(nameof(bRLocalAccountIdentification.Ispb), "Property is required for class BRLocalAccountIdentification.");
