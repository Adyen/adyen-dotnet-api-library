    ...
    public class ExecutionDateJsonConverter : JsonConverter<ExecutionDate>
    {
        ...
        public override ExecutionDate Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (date.IsSet && date.Value == null)
                throw new ArgumentNullException(nameof(date), "Property is not nullable for class ExecutionDate.");

            if (timezone.IsSet && timezone.Value == null)
                throw new ArgumentNullException(nameof(timezone), "Property is not nullable for class ExecutionDate.");
        ...
        {
            /*
            if (executionDate._TimezoneOption.IsSet && executionDate.Timezone == null)
                throw new ArgumentNullException(nameof(executionDate.Timezone), "Property is required for class ExecutionDate.");
