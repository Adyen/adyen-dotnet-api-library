...
namespace Adyen.TransferWebhooks.Models
{
    ...
    /// CounterpartyV3.
    /// </summary>
    [JsonConverter(typeof(CounterpartyV3JsonConverter))]
    ...
    public class CounterpartyV3JsonConverter : JsonConverter<CounterpartyV3>
    {
        ...
        public override CounterpartyV3 Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (bankAccount.IsSet)
                counterpartyV3.BankAccount = bankAccount.Value;
            if (card.IsSet)
                counterpartyV3.Card = card.Value;
            if (merchant.IsSet)
                counterpartyV3.Merchant = merchant.Value;
            if (transferInstrumentId.IsSet)
                counterpartyV3.TransferInstrumentId = transferInstrumentId.Value;
            return counterpartyV3;
        }
