    ...
    public class ConfirmationTrackingDataJsonConverter : JsonConverter<ConfirmationTrackingData>
    {
        ...
        public override ConfirmationTrackingData Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (status.IsSet && status.Value == null)
                throw new ArgumentNullException(nameof(status), "Property is not nullable for class ConfirmationTrackingData.");

            if (type.IsSet && type.Value == null)
                throw new ArgumentNullException(nameof(type), "Property is not nullable for class ConfirmationTrackingData.");
