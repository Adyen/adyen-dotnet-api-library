    ...
    public class DisputeNotificationRequestJsonConverter : JsonConverter<DisputeNotificationRequest>
    {
        ...
        public override DisputeNotificationRequest Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (data.IsSet && data.Value == null)
                throw new ArgumentNullException(nameof(data), "Property is not nullable for class DisputeNotificationRequest.");

            if (type.IsSet && type.Value == null)
                throw new ArgumentNullException(nameof(type), "Property is not nullable for class DisputeNotificationRequest.");
        ...
        {
            /*
            if (disputeNotificationRequest.Data == null)
                throw new ArgumentNullException(nameof(disputeNotificationRequest.Data), "Property is required for class DisputeNotificationRequest.");
