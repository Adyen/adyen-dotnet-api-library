    ...
    public class DisputeEventNotificationJsonConverter : JsonConverter<DisputeEventNotification>
    {
        ...
        public override DisputeEventNotification Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (arn.IsSet && arn.Value == null)
                throw new ArgumentNullException(nameof(arn), "Property is not nullable for class DisputeEventNotification.");

            if (balancePlatform.IsSet && balancePlatform.Value == null)
                throw new ArgumentNullException(nameof(balancePlatform), "Property is not nullable for class DisputeEventNotification.");

            if (creationDate.IsSet && creationDate.Value == null)
                throw new ArgumentNullException(nameof(creationDate), "Property is not nullable for class DisputeEventNotification.");

            if (description.IsSet && description.Value == null)
                throw new ArgumentNullException(nameof(description), "Property is not nullable for class DisputeEventNotification.");

            if (disputedAmount.IsSet && disputedAmount.Value == null)
                throw new ArgumentNullException(nameof(disputedAmount), "Property is not nullable for class DisputeEventNotification.");

            if (id.IsSet && id.Value == null)
                throw new ArgumentNullException(nameof(id), "Property is not nullable for class DisputeEventNotification.");

            if (status.IsSet && status.Value == null)
                throw new ArgumentNullException(nameof(status), "Property is not nullable for class DisputeEventNotification.");

            if (statusDetail.IsSet && statusDetail.Value == null)
                throw new ArgumentNullException(nameof(statusDetail), "Property is not nullable for class DisputeEventNotification.");

            if (transactionId.IsSet && transactionId.Value == null)
                throw new ArgumentNullException(nameof(transactionId), "Property is not nullable for class DisputeEventNotification.");

            if (type.IsSet && type.Value == null)
                throw new ArgumentNullException(nameof(type), "Property is not nullable for class DisputeEventNotification.");
        ...
        {
            /*
            if (disputeEventNotification._ArnOption.IsSet && disputeEventNotification.Arn == null)
                throw new ArgumentNullException(nameof(disputeEventNotification.Arn), "Property is required for class DisputeEventNotification.");

            if (disputeEventNotification._BalancePlatformOption.IsSet && disputeEventNotification.BalancePlatform == null)
                throw new ArgumentNullException(nameof(disputeEventNotification.BalancePlatform), "Property is required for class DisputeEventNotification.");

            if (disputeEventNotification._DescriptionOption.IsSet && disputeEventNotification.Description == null)
                throw new ArgumentNullException(nameof(disputeEventNotification.Description), "Property is required for class DisputeEventNotification.");

            if (disputeEventNotification._DisputedAmountOption.IsSet && disputeEventNotification.DisputedAmount == null)
                throw new ArgumentNullException(nameof(disputeEventNotification.DisputedAmount), "Property is required for class DisputeEventNotification.");

            if (disputeEventNotification._IdOption.IsSet && disputeEventNotification.Id == null)
                throw new ArgumentNullException(nameof(disputeEventNotification.Id), "Property is required for class DisputeEventNotification.");

            if (disputeEventNotification._StatusOption.IsSet && disputeEventNotification.Status == null)
                throw new ArgumentNullException(nameof(disputeEventNotification.Status), "Property is required for class DisputeEventNotification.");

            if (disputeEventNotification._StatusDetailOption.IsSet && disputeEventNotification.StatusDetail == null)
                throw new ArgumentNullException(nameof(disputeEventNotification.StatusDetail), "Property is required for class DisputeEventNotification.");

            if (disputeEventNotification._TransactionIdOption.IsSet && disputeEventNotification.TransactionId == null)
                throw new ArgumentNullException(nameof(disputeEventNotification.TransactionId), "Property is required for class DisputeEventNotification.");
