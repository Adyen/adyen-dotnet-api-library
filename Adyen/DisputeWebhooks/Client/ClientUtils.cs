...
using Adyen.Core;
#endif
using Models = Adyen.DisputeWebhooks.Models;
...
namespace Adyen.DisputeWebhooks.Client
{
    ...
    public static partial class ClientUtils
    {
        ...
        public static string? ParameterToString(object? obj, string? format = ISO8601_DATETIME_FORMAT)
        {
            ...
            if (obj is Models.DisputeEventNotification.TypeEnum disputeEventNotificationTypeEnum)
                return Models.DisputeEventNotification.TypeEnum.ToJsonValue(disputeEventNotificationTypeEnum);
            if (obj is Models.DisputeNotificationRequest.TypeEnum disputeNotificationRequestTypeEnum)
                return Models.DisputeNotificationRequest.TypeEnum.ToJsonValue(disputeNotificationRequestTypeEnum);
