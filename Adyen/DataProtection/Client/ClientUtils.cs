...
using Adyen.Core;
#endif
using Models = Adyen.DataProtection.Models;
...
namespace Adyen.DataProtection.Client
{
    ...
    public static partial class ClientUtils
    {
        ...
        public static string? ParameterToString(object? obj, string? format = ISO8601_DATETIME_FORMAT)
        {
            ...
            if (obj is Models.SubjectErasureResponse.ResultEnum subjectErasureResponseResultEnum)
                return Models.SubjectErasureResponse.ResultEnum.ToJsonValue(subjectErasureResponseResultEnum);
