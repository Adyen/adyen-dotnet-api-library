...
namespace Adyen.PaymentsApp.Client
{
    ...
    public class HostConfiguration
    {
        ...
        /// </summary>
        public static string BASE_URL = "https://management-live.adyen.com/v1";

        /// <summary>
        /// The relative path of the API after the `.com`.
        /// </summary>
        public static string RELATIVE_URL = "/v1";
        ...
        public HostConfiguration(IServiceCollection services)
        {
            ...
            _services.AddSingleton<PaymentsAppServiceEvents>();
        }
        ...
        public HostConfiguration AddPaymentsAppHttpClients(Action<System.Net.Http.HttpClient>? clientAction = null, Action<IHttpClientBuilder>? builderAction = null)
        {
            ...
            builders.Add(_services.AddHttpClient<IPaymentsAppService, PaymentsAppService>(clientAction));
