...
namespace Adyen.PaymentsApp.Models
{
    ...
    public partial class PaymentsAppDto : IValidatableObject
    {
        ...
        /// <summary>
        /// Used to track the state of MerchantStoreCode
        /// </summary>
        [JsonIgnore]
    ...
    public class PaymentsAppDtoJsonConverter : JsonConverter<PaymentsAppDto>
    {
        ...
        public override PaymentsAppDto Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (installationId.IsSet && installationId.Value == null)
                throw new ArgumentNullException(nameof(installationId), "Property is not nullable for class PaymentsAppDto.");

            if (merchantAccountCode.IsSet && merchantAccountCode.Value == null)
                throw new ArgumentNullException(nameof(merchantAccountCode), "Property is not nullable for class PaymentsAppDto.");

            if (status.IsSet && status.Value == null)
                throw new ArgumentNullException(nameof(status), "Property is not nullable for class PaymentsAppDto.");

            if (merchantStoreCode.IsSet && merchantStoreCode.Value == null)
                throw new ArgumentNullException(nameof(merchantStoreCode), "Property is not nullable for class PaymentsAppDto.");
        ...
        public void WriteProperties(Utf8JsonWriter writer, PaymentsAppDto paymentsAppDto, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (paymentsAppDto.InstallationId == null)
                throw new ArgumentNullException(nameof(paymentsAppDto.InstallationId), "Property is required for class PaymentsAppDto.");

            if (paymentsAppDto.MerchantAccountCode == null)
                throw new ArgumentNullException(nameof(paymentsAppDto.MerchantAccountCode), "Property is required for class PaymentsAppDto.");

            if (paymentsAppDto.Status == null)
                throw new ArgumentNullException(nameof(paymentsAppDto.Status), "Property is required for class PaymentsAppDto.");

            if (paymentsAppDto._MerchantStoreCodeOption.IsSet && paymentsAppDto.MerchantStoreCode == null)
                throw new ArgumentNullException(nameof(paymentsAppDto.MerchantStoreCode), "Property is required for class PaymentsAppDto.");
