...
namespace Adyen.PaymentsApp.Models
{
    ...
    /// </summary>
    public partial class BoardingTokenResponse : IValidatableObject
    {
        /// <summary>
    ...
    public class BoardingTokenResponseJsonConverter : JsonConverter<BoardingTokenResponse>
    {
        ...
        public override BoardingTokenResponse Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (boardingToken.IsSet && boardingToken.Value == null)
                throw new ArgumentNullException(nameof(boardingToken), "Property is not nullable for class BoardingTokenResponse.");

            if (installationId.IsSet && installationId.Value == null)
                throw new ArgumentNullException(nameof(installationId), "Property is not nullable for class BoardingTokenResponse.");
        ...
        public void WriteProperties(Utf8JsonWriter writer, BoardingTokenResponse boardingTokenResponse, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (boardingTokenResponse.BoardingToken == null)
                throw new ArgumentNullException(nameof(boardingTokenResponse.BoardingToken), "Property is required for class BoardingTokenResponse.");

            if (boardingTokenResponse.InstallationId == null)
                throw new ArgumentNullException(nameof(boardingTokenResponse.InstallationId), "Property is required for class BoardingTokenResponse.");
