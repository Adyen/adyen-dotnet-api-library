    ...
    public partial class Card : IEquatable<Card>, IValidatableObject
    {
        ...
        public bool Equals(Card input)
        {
            ...
            return
                (
                    Cvc == input.Cvc ||
                    Cvc != null &&
                    Cvc.Equals(input.Cvc)
                ) &&
                (
                    ExpiryMonth == input.ExpiryMonth ||
                    ExpiryMonth != null &&
                    ExpiryMonth.Equals(input.ExpiryMonth)
                ) &&
                (
                    ExpiryYear == input.ExpiryYear ||
                    ExpiryYear != null &&
                    ExpiryYear.Equals(input.ExpiryYear)
                ) &&
                (
                    HolderName == input.HolderName ||
                    HolderName != null &&
                    HolderName.Equals(input.HolderName)
                ) &&
                (
                    IssueNumber == input.IssueNumber ||
                    IssueNumber != null &&
                    IssueNumber.Equals(input.IssueNumber)
                ) &&
                (
                    Number == input.Number ||
                    Number != null &&
                ...
                (
                    ...
                    StartMonth != null &&
                    StartMonth.Equals(input.StartMonth)
                ) &&
                (
                    StartYear == input.StartYear ||
                    StartYear != null &&
                    StartYear.Equals(input.StartYear)
                );
        }
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (HolderName != null)
                    hashCode = hashCode * 59 + HolderName.GetHashCode();
                if (IssueNumber != null)
