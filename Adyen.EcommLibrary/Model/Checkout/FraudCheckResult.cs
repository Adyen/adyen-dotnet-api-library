...
namespace Adyen.EcommLibrary.Model.Checkout
{
    ...
    public partial class FraudCheckResult : IEquatable<FraudCheckResult>, IValidatableObject
    {
        ...
        public FraudCheckResult(int? AccountScore = default(int?), int? CheckId = default(int?),
            string Name = default(string))
        {
            // to ensure "AccountScore" is required (not null)
            if (AccountScore == null)
                throw new InvalidDataException(
                    "AccountScore is a required property for FraudCheckResult and cannot be null");
            else
                this.AccountScore = AccountScore;
            // to ensure "CheckId" is required (not null)
            if (CheckId == null)
                throw new InvalidDataException(
                    "CheckId is a required property for FraudCheckResult and cannot be null");
            else
        ...
        {
            return Equals(input as FraudCheckResult);
        }
        ...
        public bool Equals(FraudCheckResult input)
        {
            ...
            return
                (
                    AccountScore == input.AccountScore ||
                    AccountScore != null &&
                    AccountScore.Equals(input.AccountScore)
                ) &&
                (
                    CheckId == input.CheckId ||
                    CheckId != null &&
                    CheckId.Equals(input.CheckId)
                ) &&
                (
                    Name == input.Name ||
                    Name != null &&
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                var hashCode = 41;
                if (AccountScore != null)
                    hashCode = hashCode * 59 + AccountScore.GetHashCode();
                if (CheckId != null)
