...
namespace Adyen.EcommLibrary.Model.Checkout
{
    ...
    public partial class FraudResult : IEquatable<FraudResult>, IValidatableObject
    {
        ...
        public FraudResult(int? AccountScore = default(int?),
            List<FraudCheckResult> Results = default(List<FraudCheckResult>))
        {
            // to ensure "AccountScore" is required (not null)
            if (AccountScore == null)
                throw new InvalidDataException(
                    "AccountScore is a required property for FraudResult and cannot be null");
            else
        ...
        {
            return Equals(input as FraudResult);
        }
