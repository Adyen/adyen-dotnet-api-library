...
namespace Adyen.EcommLibrary.Model.Checkout
{
    ...
    public partial class Split : IEquatable<Split>, IValidatableObject
    {
        ...
        public enum TypeEnum
        {
            ...
            /// </summary>
            [EnumMember(Value = "Commission")] Commission = 1,
            ...
            /// </summary>
            [EnumMember(Value = "MarketPlace")] MarketPlace = 3,

            /// <summary>
            /// Enum PaymentFee for value: PaymentFee
            /// </summary>
            [EnumMember(Value = "PaymentFee")] PaymentFee = 4,

            /// <summary>
            /// Enum VAT for value: VAT
            /// </summary>
            [EnumMember(Value = "VAT")] VAT = 5,

            /// <summary>
            /// Enum Verification for value: Verification
            /// </summary>
            [EnumMember(Value = "Verification")] Verification = 6
        }
