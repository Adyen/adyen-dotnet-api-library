...
namespace Adyen.EcommLibrary.Model.Checkout
{
    ...
    public partial class ForexQuote : IEquatable<ForexQuote>, IValidatableObject
    {
        ...
        {
            return Equals(input as ForexQuote);
        }
        ...
        public bool Equals(ForexQuote input)
        {
            ...
            return
                ...
                (
                    ...
                    BaseAmount != null &&
                    BaseAmount.Equals(input.BaseAmount)
                ) &&
                (
                    BasePoints == input.BasePoints ||
                    BasePoints != null &&
                    BasePoints.Equals(input.BasePoints)
                ) &&
                (
                    Buy == input.Buy ||
                    Buy != null &&
                    Buy.Equals(input.Buy)
                ) &&
                (
                    Interbank == input.Interbank ||
                    Interbank != null &&
                    Interbank.Equals(input.Interbank)
                ) &&
                (
                ...
                (
                    ...
                    ValidTill != null &&
                    ValidTill.Equals(input.ValidTill)
                );
        }
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (BasePoints != null)
                    hashCode = hashCode * 59 + BasePoints.GetHashCode();
                if (Buy != null)
                    hashCode = hashCode * 59 + Buy.GetHashCode();
                if (Interbank != null)
                    hashCode = hashCode * 59 + Interbank.GetHashCode();
                if (Reference != null)
