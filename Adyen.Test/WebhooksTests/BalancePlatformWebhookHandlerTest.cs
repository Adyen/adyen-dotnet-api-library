...
namespace Adyen.Webhooks.Test
{
    ...
    public class BalancePlatformWebhookHandlerTest : BaseTest
    {
        ...
        public void POC_Integration()
        {
            ...
            try
            {
                if (_target.GetPaymentNotificationRequest(jsonPayload, out var paymentInstrumentNotificationRequest))
                {
                ...
                if (_target.GetReportNotificationRequest(jsonPayload, out var reportNotificationRequest))
                {
                    // Do work, valid hmac etc.
                ...
                if (_target.GetTransferNotificationRequest(jsonPayload, out var transferNotificationRequest))
                {
                    // Do work, valid hmac etc.
                ...
                if (_target.GetAccountHolderNotificationRequest(jsonPayload, out var accountHolderNotificationRequest))
                {
                    // Do work, valid hmac etc.
                ...
                if (_target.GetBalanceAccountNotificationRequest(jsonPayload, out var balanceAccountNotificationRequest))
                {
                    // Do work, valid hmac etc.
                ...
                if (_target.GetCardOrderNotificationRequest(jsonPayload, out var cardOrderNotificationRequest))
                {
                    // Do work, valid hmac etc.
                ...
                if (_target.GetSweepConfigurationNotificationRequest(jsonPayload, out var sweepConfigurationNotificationRequest))
                {
                    // Do work, valid hmac etc.
