...
";
        ...
        //         }
        //     );
        //     string result = JsonSerializer.Serialize(checkoutSessionRequest);
        //     
        //     // Assert that Long parameters set to zero are actually serialised (just like Int)
        //     Assert.IsTrue(result.Contains("amountExcludingTax\": 0,"));
        //     Assert.IsTrue(result.Contains("taxAmount\": 0"));
        // }
        
        // [TestMethod]
        // public void Given_CreateCheckoutSessionResponse_When_Deserialize_Returns_Correctly()
        // {
        ...
        //     
        //     var response = JsonConvert.DeserializeObject<CreateCheckoutSessionResponse>(json);
