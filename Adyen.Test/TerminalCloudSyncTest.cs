...
{
    [TestClass]
    public class TerminalCloudSyncTest : BaseTest
    {
        private readonly ITerminalCloudSyncApi _terminalCloudSyncApi;
        
        public TerminalCloudSyncTest()
        {
        ...
        public async Task TestPaymentSuccess() {
            ...
            var response = await _terminalCloudSyncApi.RequestEncryptedAsync(saleToPoiRequest, encryptionCredentialDetails); // create mock from this message
            var paymentResponse = response.MessagePayload as PaymentResponse;
