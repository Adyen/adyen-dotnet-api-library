...
namespace Adyen.Test
{
    ...
    public class StoredValueTest : BaseTest
    {
        ...
        public void StoredValueIssueTest()
        {
            ...
            var response = service.IssueSync(new StoredValueIssueRequest());
        ...
        public void StoredValueChangeStatusTest()
        {
            ...
            var service = new StoredValue(client);
            var response = service.ChangeStatusSync(new StoredValueStatusChangeRequest());
        ...
        public void StoredValueLoadTest()
        {
            ...
            var service = new StoredValue(client);
            var response = service.LoadSync(new StoredValueLoadRequest());
        ...
        public void StoredValueCheckBalanceTest()
        {
            ...
            var service = new StoredValue(client);
            var response = service.CheckBalanceSync(new StoredValueBalanceCheckRequest());
        ...
        public void StoredValueMergeBalanceTest()
        {
            ...
            var service = new StoredValue(client);
            var response = service.MergeBalanceSync(new StoredValueBalanceMergeRequest());
        ...
        public void StoredValueVoidTransactionTest()
        {
            var client = CreateMockTestClientApiKeyBasedRequestAsync("Mocks/storedvalue/mergeBalance-success.json");
            var service = new StoredValue(client);
            var response = service.VoidTransactionSync(new StoredValueVoidRequest());
