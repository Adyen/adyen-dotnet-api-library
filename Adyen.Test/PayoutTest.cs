...
namespace Adyen.Test
{
    ...
    public class PayoutTest : BaseTest
    {
        ...
        {
            Client client = CreateAsyncMockTestClientForErrors(403, "Mocks/payout/payout-error-403.json");
            Payout payout = new Payout(client);
            PayoutRequest request = new PayoutRequest();
            try
            {
        ...
        {
            Client client = CreateAsyncMockTestClientForErrors(422, "Mocks/payout/payout-error-422.json");
            Payout payout = new Payout(client);
            PayoutRequest request = new PayoutRequest();
            try
            {
