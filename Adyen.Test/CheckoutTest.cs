...
namespace Adyen.Test
{
    ...
    public class CheckoutTest : BaseTest
    {
        ...
        public void PaymentsTest()
        {
            ...
            Assert.AreEqual(PaymentsResponse.ResultCodeEnum.Authorised, paymentResponse.ResultCode);
        ...
        public void Payments3DS2Test()
        {
            ...
            Assert.AreEqual(paymentResponse.ResultCode, PaymentsResponse.ResultCodeEnum.IdentifyShopper);
