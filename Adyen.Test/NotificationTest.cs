...
namespace Adyen.Test
{
    ...
    public class NotificationTest : BaseTest
    {
        ...
        public void TestPOSDisplayNotification()
        {
            ...
            var thing = serializer.DeserializeTerminalNotification(notification);
            var displayRequest = (DisplayRequest)thing.MessagePayload;
        ...
        public void TestPOSEventNotification()
        {
            ...
            var serializer = new SaleToPoiMessageSerializer();
            var thing = serializer.DeserializeTerminalNotification(notification);
            var eventNotification = (EventNotification)thing.MessagePayload;
