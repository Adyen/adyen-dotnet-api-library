...
namespace Adyen.Test
{
    ...
    public class TerminalApiAsyncServiceTest : BaseTest
    {
        ...
        public async Task RequestEncryptedAsync_Success()
        {
            ...
            AdyenClient adyenClient = CreateMockTestClientPosCloudApiRequest("mocks/terminalapi/pospayment-async-success.json");
            ITerminalApiAsyncService asyncService = new TerminalApiAsyncService(adyenClient, new SaleToPoiMessageSerializer(), new SaleToPoiMessageSecuredEncryptor(), new SaleToPoiMessageSecuredSerializer());
