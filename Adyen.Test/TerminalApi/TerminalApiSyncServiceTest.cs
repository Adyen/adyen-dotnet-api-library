...
namespace Adyen.Test
{
    ...
    public class TerminalApiSyncClientTest : BaseTest
    {
        ...
        public async Task RequestEncryptedAsync_Success()
        {
            ...
            AdyenClient adyenClient = CreateMockTestClientPosCloudApiRequest("mocks/terminalapi/pospayment-encrypted-success.json");
            ITerminalApiSyncService syncService = new TerminalApiSyncService(adyenClient, new SaleToPoiMessageSerializer(), new SaleToPoiMessageSecuredEncryptor(), new SaleToPoiMessageSecuredSerializer());
        ...
        {
            SaleToPOIRequest saleToPoiRequest = MockPosApiRequest.CreatePosPaymentRequest();
            AdyenClient adyenClient = CreateMockTestClientPosCloudApiRequest("mocks/terminalapi/pospayment-success.json");
            ITerminalApiSyncService syncService = new TerminalApiSyncService(adyenClient, new SaleToPoiMessageSerializer(), new SaleToPoiMessageSecuredEncryptor(), new SaleToPoiMessageSecuredSerializer());
