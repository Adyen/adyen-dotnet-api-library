...
namespace Adyen.IntegrationTest
{
    ...
    public class RecurringTest : BaseTest
    {
        ...
        {
            var paymentResult = base.CreatePaymentResultWithRecurring(Model.ClassicPayments.Recurring.ContractEnum.RECURRING);
        ...
        {
            var paymentResult = base.CreatePaymentResultWithRecurring(Model.ClassicPayments.Recurring.ContractEnum.ONECLICK);
            var client = CreateApiKeyTestClient();
            var recurring = new Service.Recurring(client);
