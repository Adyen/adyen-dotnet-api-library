...
| [**RequestPeriodicReview**](LegalEntitiesService.md#requestperiodicreview) | **POST** /legalEntities/{id}/requestPeriodicReview | Request periodic data review. |
...
<a id="requestperiodicreview"></a>
### **POST** **/legalEntities/{id}/requestPeriodicReview**
...
// Example `LegalEntitiesService.RequestPeriodicReview` usage:
// Provide the following values: id
await legalEntitiesService.RequestPeriodicReviewAsync(
    string id, 
    RequestOptions requestOptions = default, 
    CancellationToken cancellationToken = default);
